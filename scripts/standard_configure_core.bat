...
if not defined BOOST_ROOT set BOOST_ROOT=C:\Kratos\external_libraries\boost
set PYTHON_EXECUTABLE=C:\Perforce\Insp2022.1\hw\third_party\python\python3.8.10\win64\python
