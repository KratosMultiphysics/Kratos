%% ControlMethod_MinNorm Class
% This class inherits from the base class 'ControlMethod' to implement
% the minimum norm control method for solving nonlinear systems.
%
%% Authors
...
% 
%% Class definition
classdef ControlMethod_MinNorm < ControlMethod
    %% Constructor method
    methods
        %------------------------------------------------------------------
        function this = ControlMethod_MinNorm()
    ...
    methods
        ...
        function d_lbd = correctedIncrement(~,~,mdl,~,~,~,~,d_Up,d_Ur,~,~,~)
