%% ControlMethod_ArcUNP Class
% This class inherits from the base class 'ControlMethod' to implement
% the arc length (updated normal plane version) control method for solving nonlinear systems.
%
%% Authors
...
% 
%% Class definition
classdef ControlMethod_ArcUNP < ControlMethod
    %% Constructor method
    methods
        %------------------------------------------------------------------
        function this = ControlMethod_ArcUNP()
