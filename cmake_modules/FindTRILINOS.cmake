...
# TRILINOS_LIBRARY_EXTENSION
IF (NOT DEFINED TRILINOS_DYNAMIC_LIBRARY)
    IF (NOT DEFINED TRILINOS_LIBRARY_EXTENSION)
        SET(TRILINOS_LIBRARY_EXTENSION ".so")
    ENDIF (NOT DEFINED TRILINOS_LIBRARY_EXTENSION)
ELSE (NOT DEFINED TRILINOS_DYNAMIC_LIBRARY)
    IF (TRILINOS_DYNAMIC_LIBRARY)
        SET(TRILINOS_LIBRARY_EXTENSION ".so")
    ELSE (TRILINOS_DYNAMIC_LIBRARY)
        IF (NOT DEFINED TRILINOS_LIBRARY_EXTENSION)
            SET(TRILINOS_LIBRARY_EXTENSION ".a")
        ENDIF (NOT DEFINED TRILINOS_LIBRARY_EXTENSION)
    ENDIF (TRILINOS_DYNAMIC_LIBRARY)
ENDIF (NOT DEFINED TRILINOS_DYNAMIC_LIBRARY)
...
IF(NOT EPETRA_LIBRARY)
    FIND_LIBRARY(EPETRA_LIBRARY         "${TRILINOS_LIBRARY_PREFIX}epetra${TRILINOS_LIBRARY_EXTENSION}"           ${TRILINOS_LIB_SEARCH_PATH}  NO_DEFAULT_PATH)
...
IF(NOT TEUCHOS_LIBRARY)
    ...
    IF(NOT TEUCHOSCOMM_LIBRARY)
        FIND_LIBRARY(TEUCHOSCOMM_LIBRARY         "${TRILINOS_LIBRARY_PREFIX}teuchoscomm${TRILINOS_LIBRARY_EXTENSION}"           ${TRILINOS_LIB_SEARCH_PATH}  NO_DEFAULT_PATH)
    ...
    IF(NOT TEUCHOSCORE_LIBRARY)
        FIND_LIBRARY(TEUCHOSCORE_LIBRARY         "${TRILINOS_LIBRARY_PREFIX}teuchoscore${TRILINOS_LIBRARY_EXTENSION}"           ${TRILINOS_LIB_SEARCH_PATH}  NO_DEFAULT_PATH)
    ...
    IF(NOT TEUCHOSNUMERICS_LIBRARY)
        FIND_LIBRARY(TEUCHOSNUMERICS_LIBRARY         "${TRILINOS_LIBRARY_PREFIX}teuchosnumerics${TRILINOS_LIBRARY_EXTENSION}"           ${TRILINOS_LIB_SEARCH_PATH}  NO_DEFAULT_PATH)
    ...
    IF(NOT TEUCHOSPARAMETERLIST_LIBRARY)
        FIND_LIBRARY(TEUCHOSPARAMETERLIST_LIBRARY         "${TRILINOS_LIBRARY_PREFIX}teuchosparameterlist${TRILINOS_LIBRARY_EXTENSION}"           ${TRILINOS_LIB_SEARCH_PATH}  NO_DEFAULT_PATH)
    ...
    IF(NOT TEUCHOSREMAINDER_LIBRARY)
        FIND_LIBRARY(TEUCHOSREMAINDER_LIBRARY         "${TRILINOS_LIBRARY_PREFIX}teuchosremainder${TRILINOS_LIBRARY_EXTENSION}"           ${TRILINOS_LIB_SEARCH_PATH}  NO_DEFAULT_PATH)
...
IF(NOT TRIUTILS_LIBRARY)
    FIND_LIBRARY(TRIUTILS_LIBRARY         "${TRILINOS_LIBRARY_PREFIX}triutils${TRILINOS_LIBRARY_EXTENSION}"           ${TRILINOS_LIB_SEARCH_PATH}  NO_DEFAULT_PATH)
