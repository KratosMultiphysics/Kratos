...
macro(kratos_python_install_tests)
    ...
    if(${INSTALL_PYTHON_USING_LINKS} MATCHES ON )
        foreach(f ${SRC_FILES})
            get_filename_component(barename ${f} NAME)
            get_filename_component(relpath ${f} DIRECTORY)
            install_symlink(${TEST_DIRECTORY}/${f} ${CMAKE_INSTALL_PREFIX}/${TEST_DESTINATION}/${relpath} ${barename} )
        endforeach(f ${SRC_FILES})
    else()
        foreach(f ${SRC_FILES})
            get_filename_component(relpath ${f} DIRECTORY)
            install(FILES ${TEST_DIRECTORY}/${f} DESTINATION ${CMAKE_INSTALL_PREFIX}/${TEST_DESTINATION}/${relpath} )
        endforeach(f ${SRC_FILES})
    endif()
