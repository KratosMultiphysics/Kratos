...
get_filename_component(application_name ${application_path} NAME )
    IF(NOT TARGET Kratos${application_name})
        ...
        get_property(tmp GLOBAL PROPERTY LIST_OF_APPLICATIONS_ADDED_THOUGH_DEPENDENCIES)
        list(APPEND tmp ${application_name})
        set_property(GLOBAL PROPERTY LIST_OF_APPLICATIONS_ADDED_THOUGH_DEPENDENCIES ${tmp})
