...
macro(kratos_add_gtests)
	...
	if(KRATOS_ADD_GTEST_SOURCES)
		...
		if(NOT KRATOS_ADD_GTEST_USE_CUSTOM_MAIN)
			set(KRATOS_GTEST_MAIN_SOURCE ${CMAKE_SOURCE_DIR}/kratos/testing/testing.cpp)
		endif()
		...
		if(KRATOS_ADD_GTEST_USE_MPI)
			...
			if(NOT KRATOS_ADD_GTEST_USE_CUSTOM_MAIN)
				set(KRATOS_GTEST_MAIN_SOURCE ${CMAKE_SOURCE_DIR}/kratos/mpi/testing/mpi_testing.cpp)
			endif()
		endif()
