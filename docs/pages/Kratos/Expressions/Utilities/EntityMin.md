...
<p align="center">$$ EntityMin\left(\underline{\mathbf{u}}\right) = \left\lbrace v_i, \text{where} \quad v_i = \min_{j\in\left[0, N\right)} {u_{ij}} \quad  \forall i\in\left[0, M\right)\right\rbrace$$</p>
