...
<p align="center">$$ EntityMax\left(\underline{\mathbb{u}}\right) = \left\lbrace v_i, \text{where} \quad v_i = \max_{j\in\left[0, N\right)} {u_{ij}} \quad  \forall i\in\left[0, M\right)\right\rbrace$$</p>
...
max_nodal_expression = Kratos.Expression.Utils.EntityMax(nodal_expression)

# now write it to PRESSURE for checking.
Kratos.Expression.VariableExpressionIO.Write(max_nodal_expression, Kratos.PRESSURE, False)
