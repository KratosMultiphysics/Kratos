...
The mesh ordering can be consulted in [here](pages/Mesh-node-ordering). Remember that the *Kratos* mesh does not contain directly any geometry, but elements and conditions defined by that geometry.
