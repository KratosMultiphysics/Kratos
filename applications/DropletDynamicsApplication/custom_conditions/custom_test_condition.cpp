 ...
 */
void CustomTestCondition::EquationIdVector(EquationIdVectorType& rResult, const ProcessInfo& CurrentProcessInfo) const
{
 ...
 * @param rCurrentProcessInfo: the current process info instance
 */
void CustomTestCondition::GetDofList(DofsVectorType& rConditionDofList, const ProcessInfo& CurrentProcessInfo) const
{
    unsigned int number_of_nodes = GetGeometry().PointsNumber();
 ...
 * @param rCurrentProcessInfo: the current process info instance
 */
void CustomTestCondition::CalculateLeftHandSide(MatrixType& rLeftHandSideMatrix, const ProcessInfo& rCurrentProcessInfo)
{
}
 ...
 * @param rCurrentProcessInfo: the current process info instance
 */
void CustomTestCondition::CalculateRightHandSide(VectorType& rRightHandSideVector, const ProcessInfo& rCurrentProcessInfo)
{
}
 ...
 * @param rCurrentProcessInfo: the current process info instance
 */
void CustomTestCondition::CalculateFirstDerivativesLHS(MatrixType& rLeftHandSideMatrix, const ProcessInfo& rCurrentProcessInfo)
{
    if (rLeftHandSideMatrix.size1() != 0)
        rLeftHandSideMatrix.resize(0, 0, false);
}
 ...
 * @param rCurrentProcessInfo: the current process info instance
 */
void CustomTestCondition::CalculateFirstDerivativesRHS(VectorType& rRightHandSideVector, const ProcessInfo& rCurrentProcessInfo)
{
    if (rRightHandSideVector.size() != 0)
    rRightHandSideVector.resize(0, false);
}
 ...
 * @param rCurrentProcessInfo: the current process info instance
 */
void CustomTestCondition::CalculateMassMatrix(MatrixType& rMassMatrix, const ProcessInfo& rCurrentProcessInfo)
{
 ...
 * @param rCurrentProcessInfo: the current process info instance
 */
void CustomTestCondition::CalculateDampingMatrix(MatrixType& rDampingMatrix, const ProcessInfo& rCurrentProcessInfo)
{
 ...
 */
int CustomTestCondition::Check(const ProcessInfo& rCurrentProcessInfo) const
{
    KRATOS_TRY
