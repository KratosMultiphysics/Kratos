...
// Project includes
// #include "custom_ausas_modified_shape_functions.h"
#include "custom_ausas_modified_shape_functions.h"
...
/// Default constructor
CustomAusasModifiedShapeFunctions::CustomAusasModifiedShapeFunctions(const GeometryPointerType pInputGeometry, const Vector& rNodalDistances) :
    CustomModifiedShapeFunctions(pInputGeometry, rNodalDistances) {
};

/// Destructor
CustomAusasModifiedShapeFunctions::~CustomAusasModifiedShapeFunctions() {};

/// Turn back information as a string.
std::string CustomAusasModifiedShapeFunctions::Info() const {
    return "Ausas modified shape functions computation base class.";
};

/// Print information about this object.
void CustomAusasModifiedShapeFunctions::PrintInfo(std::ostream& rOStream) const {
    rOStream << "Ausas modified shape functions computation base class.";
};

/// Print object's data.
void CustomAusasModifiedShapeFunctions::PrintData(std::ostream& rOStream) const {
...
void CustomAusasModifiedShapeFunctions::SetPositiveSideCondensationMatrix(
...
void CustomAusasModifiedShapeFunctions::SetNegativeSideCondensationMatrix(
