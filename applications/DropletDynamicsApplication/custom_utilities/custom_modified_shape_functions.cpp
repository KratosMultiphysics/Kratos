...
// Project includes
#include "custom_modified_shape_functions.h"
...
namespace Kratos
{
    ...
    /// Default constructor
    CustomModifiedShapeFunctions::CustomModifiedShapeFunctions(const GeometryPointerType pInputGeometry, const Vector& rNodalDistances) :
        mpInputGeometry(pInputGeometry), mNodalDistances(rNodalDistances) {};

    /// Destructor
    CustomModifiedShapeFunctions::~CustomModifiedShapeFunctions() {};

    /// Turn back information as a string.
    std::string CustomModifiedShapeFunctions::Info() const {
        return "Modified shape functions computation base class.";
    };

    /// Print information about this object.
    void CustomModifiedShapeFunctions::PrintInfo(std::ostream& rOStream) const {
        rOStream << "Modified shape functions computation base class.";
    };

    /// Print object's data.
    void CustomModifiedShapeFunctions::PrintData(std::ostream& rOStream) const {
    ...
    const ContactLineDivideGeometry<Node>::Pointer CustomModifiedShapeFunctions::pGetSplittingUtil() const {
    ...
    const CustomModifiedShapeFunctions::GeometryPointerType CustomModifiedShapeFunctions::GetInputGeometry() const {
        return mpInputGeometry;
    };

    // Returns the nodal distances vector.
    const Vector& CustomModifiedShapeFunctions::GetNodalDistances() const {
        return mNodalDistances;
    };

    double CustomModifiedShapeFunctions::ComputePositiveSideDomainSize() const
    {
    ...
    double CustomModifiedShapeFunctions::ComputeNegativeSideDomainSize() const
    {
        auto p_splitting_util = this->pGetSplittingUtil();
    ...
    void CustomModifiedShapeFunctions::ComputePositiveSideShapeFunctionsAndWeights(
    ...
    void CustomModifiedShapeFunctions::ComputeNegativeSideShapeFunctionsAndWeights(
    ...
    void CustomModifiedShapeFunctions::ComputePositiveSideShapeFunctionsAndGradientsValues(
        Matrix &rPositiveSideShapeFunctionsValues,
    ...
    void CustomModifiedShapeFunctions::ComputeNegativeSideShapeFunctionsAndGradientsValues(
        Matrix &rNegativeSideShapeFunctionsValues,
    ...
    void CustomModifiedShapeFunctions::ComputeInterfacePositiveSideShapeFunctionsAndGradientsValues(
    ...
    void CustomModifiedShapeFunctions::ComputeInterfaceNegativeSideShapeFunctionsAndGradientsValues(
    ...
    void CustomModifiedShapeFunctions::ComputePositiveExteriorFaceShapeFunctionsAndGradientsValues(
    ...
    // Given a face id, computes the positive side subdivision shape function values in that face.
    void CustomModifiedShapeFunctions::ComputeNegativeExteriorFaceShapeFunctionsAndGradientsValues(
    ...
    void CustomModifiedShapeFunctions::ComputePositiveSideInterfaceAreaNormals(
    ...
    // Compute the positive side interface outwards area normal vector values.
    void CustomModifiedShapeFunctions::ComputeNegativeSideInterfaceAreaNormals(
    ...
    void CustomModifiedShapeFunctions::ComputePositiveExteriorFaceAreaNormals(
    ...
    // For a given face, computes the positive side face outwards area normal vector values.
    void CustomModifiedShapeFunctions::ComputeNegativeExteriorFaceAreaNormals(
    ...
    void CustomModifiedShapeFunctions::ComputeShapeFunctionsOnPositiveEdgeIntersections(Matrix &rPositiveEdgeIntersectionsShapeFunctionsValues)
    {
        if (this->IsSplit()) {
            // Get the interface condensation matrix
            Matrix p_matrix;
    ...
    void CustomModifiedShapeFunctions::ComputeShapeFunctionsOnNegativeEdgeIntersections(Matrix &rNegativeEdgeIntersectionsShapeFunctionsValues)
    {
        if (this->IsSplit()) {
            // Get the interface condensation matrix
            Matrix p_matrix;
    ...
    void CustomModifiedShapeFunctions::ComputeValuesOnOneSide(
    ...
    void CustomModifiedShapeFunctions::ComputeFaceValuesOnOneSide(
    ...
    void CustomModifiedShapeFunctions::ComputeFaceNormalOnOneSide(
    ...
    void CustomModifiedShapeFunctions::ComputeEdgeIntersectionValuesOnOneSide(
        const Matrix &rPmatrix,
    ...
    double CustomModifiedShapeFunctions::ComputeDomainSizeOnOneSide(const std::vector<IndexedPointGeometryPointerType> &rSubdivisionsVector) const
    {
        double volume = 0.0;
