...
#if !defined(CUSTOM_TETRAHEDRA_3D_4_MODIFIED_SHAPE_FUNCTIONS)
#define CUSTOM_TETRAHEDRA_3D_4_MODIFIED_SHAPE_FUNCTIONS
...
class KRATOS_API(DROPLET_DYNAMICS_APPLICATION) CustomTetrahedra3D4ModifiedShapeFunctions : public CustomModifiedShapeFunctions
{
public:
    ...
    /// Pointer definition of CustomTetrahedra3D4ModifiedShapeFunctions
    KRATOS_CLASS_POINTER_DEFINITION(CustomTetrahedra3D4ModifiedShapeFunctions);

    // General type definitions
    typedef CustomModifiedShapeFunctions                       BaseType;
    ...
    /// Default constructor
    CustomTetrahedra3D4ModifiedShapeFunctions(const GeometryPointerType rpInputGeometry, const Vector& rNodalDistances);

    CustomTetrahedra3D4ModifiedShapeFunctions(const GeometryPointerType rpInputGeometry, const Vector& rNodalDistances, const std::vector<int> rStructureNodes);

    /// Destructor
    ~CustomTetrahedra3D4ModifiedShapeFunctions() override;
    ...
    */
    const ContactLineDivideGeometry<Node>::Pointer pGetSplittingUtil() const override;
...
private:
    ...
    ContactLineDivideTetrahedra3D4<Node>::Pointer mpTetrahedraSplitter;
    ...
    /// Assignment operator.
    CustomTetrahedra3D4ModifiedShapeFunctions& operator=(CustomTetrahedra3D4ModifiedShapeFunctions const& rOther);

    /// Copy constructor.
    CustomTetrahedra3D4ModifiedShapeFunctions(CustomTetrahedra3D4ModifiedShapeFunctions const& rOther) :
        CustomModifiedShapeFunctions(rOther.GetInputGeometry(), rOther.GetNodalDistances()),
        mpTetrahedraSplitter(new ContactLineDivideTetrahedra3D4<Node>(*rOther.GetInputGeometry(), rOther.GetNodalDistances())) {
