...
#if !defined(CUSTOM_MODIFIED_SHAPE_FUNCTIONS)
#define CUSTOM_MODIFIED_SHAPE_FUNCTIONS
...
class KRATOS_API(DROPLET_DYNAMICS_APPLICATION) CustomModifiedShapeFunctions
{
public:
    ...
    /// Pointer definition of CustomModifiedShapeFunctions
    KRATOS_CLASS_POINTER_DEFINITION(CustomModifiedShapeFunctions);
    ...
    typedef ContactLineDivideGeometry<Node>::IndexedPointGeometryType                            IndexedPointGeometryType;
    typedef ContactLineDivideGeometry<Node>::IndexedPointGeometryPointerType                     IndexedPointGeometryPointerType;
    ...
    /// Default constructor
    CustomModifiedShapeFunctions(const GeometryPointerType pInputGeometry, const Vector& rNodalDistances);

    /// Destructor
    virtual ~CustomModifiedShapeFunctions();
    ...
    */
    virtual const ContactLineDivideGeometry<Node>::Pointer pGetSplittingUtil() const;
...
protected:
    ...
    */
    ...
    /// Assignment operator.
    CustomModifiedShapeFunctions& operator=(CustomModifiedShapeFunctions const& rOther);

    /// Copy constructor.
    CustomModifiedShapeFunctions(CustomModifiedShapeFunctions const& rOther)
        : mpInputGeometry(rOther.mpInputGeometry) , mNodalDistances(rOther.mNodalDistances) {};

    ///@}

};// class CustomModifiedShapeFunctions

}
#endif /* CUSTOM_MODIFIED_SHAPE_FUNCTIONS defined */
