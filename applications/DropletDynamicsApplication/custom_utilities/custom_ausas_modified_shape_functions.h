...
#if !defined(CUSTOM_AUSAS_MODIFIED_SHAPE_FUNCTIONS)
#define CUSTOM_AUSAS_MODIFIED_SHAPE_FUNCTIONS
...
class KRATOS_API(DROPLET_DYNAMICS_APPLICATION) CustomAusasModifiedShapeFunctions : public CustomModifiedShapeFunctions
{
public:
    ...
    KRATOS_CLASS_POINTER_DEFINITION(CustomAusasModifiedShapeFunctions);
    ...
    /// Default constructor
    CustomAusasModifiedShapeFunctions(const GeometryPointerType rpInputGeometry, const Vector& rNodalDistances);

    /// Destructor
    ~CustomAusasModifiedShapeFunctions();
...
private:
    ...
    /// Assignment operator.
    CustomAusasModifiedShapeFunctions& operator=(CustomAusasModifiedShapeFunctions const& rOther);

    /// Copy constructor.
    CustomAusasModifiedShapeFunctions(CustomAusasModifiedShapeFunctions const& rOther) :
        CustomModifiedShapeFunctions(rOther.GetInputGeometry(), rOther.GetNodalDistances()) {
    };

    ///@}

};// class CustomAusasModifiedShapeFunctions

}
#endif /* CUSTOM_AUSAS_MODIFIED_SHAPE_FUNCTIONS defined */
