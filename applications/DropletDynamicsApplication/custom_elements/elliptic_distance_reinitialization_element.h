...
#if !defined(KRATOS_ED_REINITIALIZATION_ELEMENT_H_INCLUDED )
#define KRATOS_ED_REINITIALIZATION_ELEMENT_H_INCLUDED
...
class EDReinitializationElement : public Element
{
public:
    ...
    /// Pointer definition of EllipticDistanceReinitializationElement
    KRATOS_CLASS_INTRUSIVE_POINTER_DEFINITION(EDReinitializationElement);
     ...
     * Constructor.
     */
    EDReinitializationElement(IndexType NewId = 0);

    /**
     * Constructor using an array of nodes
     */
    EDReinitializationElement(IndexType NewId, const NodesArrayType& ThisNodes);

    /**
     * Constructor using Geometry
     */
    EDReinitializationElement(IndexType NewId, GeometryType::Pointer pGeometry);

    /**
     * Constructor using Properties
     */
    EDReinitializationElement(IndexType NewId, GeometryType::Pointer pGeometry, PropertiesType::Pointer pProperties);

    /**
     * Copy Constructor
     */
    EDReinitializationElement(EDReinitializationElement const& rOther);

    /**
     * Destructor
     */
    ~EDReinitializationElement() override;
    ...
    /// Assignment operator.
    EDReinitializationElement & operator=(EDReinitializationElement const& rOther);
...
#endif // KRATOS_ED_REINITIALIZATION_ELEMENT_H_INCLUDED
