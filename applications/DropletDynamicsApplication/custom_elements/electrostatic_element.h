...
#if !defined(KRATOS_ELECTROSTATIC_ELEMENT_H_INCLUDED )
#define KRATOS_ELECTROSTATIC_ELEMENT_H_INCLUDED
...
public:
    ...
    KRATOS_CLASS_INTRUSIVE_POINTER_DEFINITION(ElectrostaticElement);
     ...
     * Constructor.
     */
    ElectrostaticElement(IndexType NewId = 0);

    /**
     * Constructor using an array of nodes
     */
    ElectrostaticElement(IndexType NewId, const NodesArrayType& ThisNodes);

    /**
     * Constructor using Geometry
     */
    ElectrostaticElement(IndexType NewId, GeometryType::Pointer pGeometry);

    /**
     * Constructor using Properties
     */
    ElectrostaticElement(IndexType NewId, GeometryType::Pointer pGeometry, PropertiesType::Pointer pProperties);

    /**
     * Copy Constructor
     */
    ElectrostaticElement(ElectrostaticElement const& rOther);

    /**
     * Destructor
     */
    ~ElectrostaticElement() override;
    ...
    /// Assignment operator.
    ElectrostaticElement & operator=(ElectrostaticElement const& rOther);
...
#endif // KRATOS_ENRICHEDT_ELEMENT_H_INCLUDED  defined
