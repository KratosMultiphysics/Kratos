 ...
 * Constructor.
 */
ElectrostaticElement::ElectrostaticElement(IndexType NewId)
    : Element(NewId) 
{
}
 ...
 */
ElectrostaticElement::ElectrostaticElement(IndexType NewId, const NodesArrayType& ThisNodes)
 ...
 */
ElectrostaticElement::ElectrostaticElement(IndexType NewId, GeometryType::Pointer pGeometry)
 ...
 */
ElectrostaticElement::ElectrostaticElement(IndexType NewId, GeometryType::Pointer pGeometry, PropertiesType::Pointer pProperties)
 ...
 * Copy Constructor
 */
ElectrostaticElement::ElectrostaticElement(ElectrostaticElement const& rOther)
    : Element(rOther) 
{
}
 ...
 * Destructor
 */
ElectrostaticElement::~ElectrostaticElement()
{
}
...
/// Assignment operator.
ElectrostaticElement & ElectrostaticElement::operator=(ElectrostaticElement const& rOther)
{
 ...
 */
Element::Pointer ElectrostaticElement::Create(
    IndexType NewId,
 ...
 * @return a Pointer to the new element
 */
Element::Pointer ElectrostaticElement::Clone(IndexType NewId, NodesArrayType const& ThisNodes) const
{
    KRATOS_TRY
 ...
 */
void ElectrostaticElement::EquationIdVector(EquationIdVectorType& rResult, const ProcessInfo& CurrentProcessInfo) const
{
 ...
 * @param rCurrentProcessInfo: the current process info instance
 */
void ElectrostaticElement::GetDofList(DofsVectorType& rElementalDofList, const ProcessInfo& CurrentProcessInfo) const
{
    unsigned int number_of_nodes = GetGeometry().PointsNumber();
 ...
 * @param rCurrentProcessInfo: the current process info instance
 */
void ElectrostaticElement::CalculateLocalSystem(
...
/*                                 K_enrich(0,0) -= permittivity_neg*neg_weights(neg_e)
        ...
        for (unsigned int i = 0; i < num_nodes; ++i){
            (this->GetValue(BIJ_ENRICH_ROW))(i) = Bij_flux_enrich(0,i);//Bij_flux_enrich(0,i);
            (this->GetValue(BJI_ENRICH_ROW))(i) = B_enrich(0,i);//B_enrich(0,i);
        }
...
void ElectrostaticElement::GetValueOnIntegrationPoints(const Variable<array_1d<double,3>>& rVariable, 
...
void ElectrostaticElement::CalculateOnIntegrationPoints(const Variable<array_1d<double,3>>& rVariable, 
...
{ 
    ...
    if (nneg == num_nodes || npos == num_nodes){
        ...
        /*         for (unsigned int i = 0 ; i < num_dim ; ++i){
            ...
            n_Fe[i] = (- permittivity_neg * efield_neg_side(i)*normal_efield(i) + permittivity_pos * efield_pos_side(i)*normal_efield(i)) -
                         0.5 * ( - permittivity_neg*(efield_neg_side(i)*efield_neg_side(i)*normal_efield(i)) + permittivity_pos*(efield_pos_side(i)*efield_pos_side(i)*normal_efield(i)) );
        } */
    ...
    /* KRATOS_WATCH(this->GetValue(EFORCE))
    KRATOS_WATCH(Output)  */
}

void ElectrostaticElement::Calculate(const Variable<array_1d<double, 3 > >& rVariable,
 ...
 * @param rCurrentProcessInfo: the current process info instance
 */
void ElectrostaticElement::CalculateLeftHandSide(MatrixType& rLeftHandSideMatrix, const ProcessInfo& rCurrentProcessInfo)
{
}
 ...
 * @param rCurrentProcessInfo: the current process info instance
 */
void ElectrostaticElement::CalculateRightHandSide(VectorType& rRightHandSideVector, const ProcessInfo& rCurrentProcessInfo)
{
}
 ...
 * @param rCurrentProcessInfo: the current process info instance
 */
void ElectrostaticElement::CalculateFirstDerivativesContributions(
    MatrixType& rLeftHandSideMatrix,
    VectorType& rRightHandSideVector,
    const ProcessInfo& rCurrentProcessInfo)
{
 ...
 * @param rCurrentProcessInfo: the current process info instance
 */
void ElectrostaticElement::CalculateFirstDerivativesLHS(MatrixType& rLeftHandSideMatrix, const ProcessInfo& rCurrentProcessInfo)
{
    if (rLeftHandSideMatrix.size1() != 0)
        rLeftHandSideMatrix.resize(0, 0, false);
}
 ...
 * @param rCurrentProcessInfo: the current process info instance
 */
void ElectrostaticElement::CalculateFirstDerivativesRHS(VectorType& rRightHandSideVector, const ProcessInfo& rCurrentProcessInfo)
{
    if (rRightHandSideVector.size() != 0)
        rRightHandSideVector.resize(0, false);
}
 ...
 * @param rCurrentProcessInfo: the current process info instance
 */
void ElectrostaticElement::CalculateSecondDerivativesContributions(
    MatrixType& rLeftHandSideMatrix,
    VectorType& rRightHandSideVector,
    const ProcessInfo& rCurrentProcessInfo)
{
 ...
 * @param rCurrentProcessInfo: the current process info instance
 */
void ElectrostaticElement::CalculateSecondDerivativesLHS(
    MatrixType& rLeftHandSideMatrix,
    const ProcessInfo& rCurrentProcessInfo)
{
    if (rLeftHandSideMatrix.size1() != 0)
 ...
 * @param rCurrentProcessInfo: the current process info instance
 */
void ElectrostaticElement::CalculateSecondDerivativesRHS(
    VectorType& rRightHandSideVector,
    const ProcessInfo& rCurrentProcessInfo)
{
    if (rRightHandSideVector.size() != 0)
 ...
 * @param rCurrentProcessInfo: the current process info instance
 */
void ElectrostaticElement::CalculateMassMatrix(MatrixType& rMassMatrix, const ProcessInfo& rCurrentProcessInfo)
{
 ...
 * @param rCurrentProcessInfo: the current process info instance
 */
void ElectrostaticElement::CalculateDampingMatrix(MatrixType& rDampingMatrix, const ProcessInfo& rCurrentProcessInfo)
{
 ...
 */
int ElectrostaticElement::Check(const ProcessInfo& rCurrentProcessInfo) const
{
    KRATOS_TRY
...
std::string ElectrostaticElement::Info() const {
...
void ElectrostaticElement::PrintInfo(std::ostream& rOStream) const {
    rOStream << "ElectricEnrichedElement #" << Id();
}

/// Print object's data.

void ElectrostaticElement::PrintData(std::ostream& rOStream) const {
...
void ElectrostaticElement::save(Serializer& rSerializer) const
{
...
void ElectrostaticElement::load(Serializer& rSerializer)
{
...
inline std::istream & operator >> (std::istream& rIStream, ElectrostaticElement& rThis);

/// output stream function
inline std::ostream & operator << (std::ostream& rOStream, const ElectrostaticElement& rThis)
{
