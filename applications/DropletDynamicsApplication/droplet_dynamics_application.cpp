...
KratosDropletDynamicsApplication::KratosDropletDynamicsApplication():
    ...
    mEDReinitializationElement(0, Element::GeometryType::Pointer(new Tetrahedra3D4<Node>(Element::GeometryType::PointsArrayType(4))))
    {}
...
void KratosDropletDynamicsApplication::Register()
{
    ...
    KRATOS_REGISTER_ELEMENT("EDReinitializationElement", mEDReinitializationElement);
}
}  // namespace Kratos.
