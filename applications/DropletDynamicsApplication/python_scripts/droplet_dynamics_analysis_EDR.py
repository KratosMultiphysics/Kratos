...
class DropletDynamicsAnalysisEDR(AnalysisStage): #FluidDynamicsAnalysis):
    ...
    def _CreateSolver(self):
        ...
        module_full_name = 'KratosMultiphysics.DropletDynamicsApplication.droplet_dynamics_EDR_solver'
...
if __name__ == '__main__':
    ...
    simulation = DropletDynamicsAnalysisEDR(model,parameters)
    simulation.Run()
