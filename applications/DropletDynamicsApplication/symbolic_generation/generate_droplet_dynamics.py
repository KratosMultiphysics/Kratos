...
if time_integration == "bdf2":
    output_filename = "droplet_dynamics_element.cpp"
    template_filename = "droplet_dynamics_template.cpp"
else:
    err_msg = "Wrong time_integration. Given \'" + time_integration + "\'. Available option is \'bdf2\'."
...
for dim in dim_vector:
    ...
    if (divide_by_rho):
        rv_galerkin += q_gauss*(- div_v[0,0])
    else:
        rv_galerkin += rho*q_gauss*(- div_v[0,0])
