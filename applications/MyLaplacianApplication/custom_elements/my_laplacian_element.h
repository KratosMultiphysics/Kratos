...
#if !defined(KRATOS_MY_LAPLACIAN_ELEMENT_H_INCLUDED )
#define KRATOS_MY_LAPLACIAN_ELEMENT_H_INCLUDED
...
class MyLaplacianElement : public Element {
public:

  KRATOS_DEFINE_LOCAL_FLAG(FLAG_1)
  ...
  /// Pointer definition of MyLaplacianElement
  KRATOS_CLASS_POINTER_DEFINITION(MyLaplacianElement);
   ...
   * Constructor.
   */
  MyLaplacianElement(IndexType NewId = 0);

  /**
   * Constructor using an array of nodes
   */
  MyLaplacianElement(IndexType NewId, const NodesArrayType& ThisNodes);

  /**
   * Constructor using Geometry
   */
  MyLaplacianElement(IndexType NewId, GeometryType::Pointer pGeometry);

  /**
   * Constructor using Properties
   */
  MyLaplacianElement(IndexType NewId, GeometryType::Pointer pGeometry, PropertiesType::Pointer pProperties);

  /**
   * Copy Constructor
   */
  MyLaplacianElement(MyLaplacianElement const& rOther);

  /**
   * Destructor
   */
  virtual ~MyLaplacianElement();
  ...
  /// Assignment operator.
  MyLaplacianElement & operator=(MyLaplacianElement const& rOther);
...
#endif // KRATOS_MY_LAPLACIAN_ELEMENT_H_INCLUDED  defined
