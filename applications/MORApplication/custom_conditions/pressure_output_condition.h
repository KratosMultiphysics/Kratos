...
#if !defined(KRATOS_PRESSURE_OUTPUT_CONDITION_H_INCLUDED )
#define  KRATOS_PRESSURE_OUTPUT_CONDITION_H_INCLUDED
...
/**
 * @class PressureOutputCondition
 * @ingroup MORApplication
 * @brief This defines output on pressure dofs
...
public:
    ...
    // Counted pointer of PressureOutputCondition
    KRATOS_CLASS_INTRUSIVE_POINTER_DEFINITION( PressureOutputCondition );
    ...
    // Constructor void
    PressureOutputCondition()
    {};

    // Constructor using an array of nodes
    PressureOutputCondition( IndexType NewId, GeometryType::Pointer pGeometry ):Condition(NewId,pGeometry)
    {};

    // Constructor using an array of nodes with properties
    PressureOutputCondition( IndexType NewId, GeometryType::Pointer pGeometry, PropertiesType::Pointer pProperties ):Condition(NewId,pGeometry,pProperties)
    {};

    ///Copy constructor
    PressureOutputCondition(PressureOutputCondition const& rOther);

    // Destructor
    ~PressureOutputCondition() override
    {};
    ...
    /// Assignment operator.
    PressureOutputCondition& operator=(PressureOutputCondition const& rOther);
...
#endif // KRATOS_PRESSURE_OUTPUT_CONDITION_H_INCLUDED  defined
