...
ComponentOutputCondition::ComponentOutputCondition(ComponentOutputCondition const& rOther)
    : BaseType(rOther)
{
}
...
// ComponentOutputCondition<TVariable>& ComponentOutputCondition<TVariable>::operator=(ComponentOutputCondition const& rOther)
// {
...
// Condition::Pointer ComponentOutputCondition::Create(
//     IndexType NewId,
...
// {
//     KRATOS_TRY
//     return Kratos::make_intrusive<ComponentOutputCondition>(NewId, GetGeometry().Create(ThisNodes), pProperties);
//     KRATOS_CATCH("");
// }
...
// {
//     KRATOS_TRY
//     return Kratos::make_intrusive<ComponentOutputCondition>(NewId, pGeom, pProperties);
//     KRATOS_CATCH("");
// }
...
// Condition::Pointer ComponentOutputCondition::Clone (
//     IndexType NewId,
//     NodesArrayType const& ThisNodes
//     ) const
// {
...
//     Condition::Pointer p_new_cond = Kratos::make_intrusive<ComponentOutputCondition>(NewId, GetGeometry().Create(ThisNodes), pGetProperties());
...
// void ComponentOutputCondition::EquationIdVector(
...
// /***********************************************************************************/
// /***********************************************************************************/
// void ComponentOutputCondition::GetDofList(
...
// void ComponentOutputCondition::GetValuesVector(
//     Vector& rValues,
//     int Step
//     )
// {
...
// // void ComponentOutputCondition::GetFirstDerivativesVector(
// //     Vector& rValues,
// //     int Step
// //     )
// // {
...
// // void ComponentOutputCondition::GetSecondDerivativesVector(
// //     Vector& rValues,
// //     int Step
// //     )
// // {
...
// void ComponentOutputCondition::CalculateRightHandSide(
...
// /***********************************************************************************/
// /***********************************************************************************/
// void ComponentOutputCondition::CalculateLocalSystem(
...
// void ComponentOutputCondition::CalculateMassMatrix(
...
// void ComponentOutputCondition::CalculateDampingMatrix(
...
// void ComponentOutputCondition::CalculateAll(
...
// template< class TVariableType, TVariableType& TVariable >
int ComponentOutputCondition::Check( const ProcessInfo& rCurrentProcessInfo )
{
    // Base check
...
// // double ComponentOutputCondition::GetIntegrationWeight(
...
// // void ComponentOutputCondition::AddExplicitContribution(
...
// void ComponentOutputCondition::save( Serializer& rSerializer ) const
// {
...
// void ComponentOutputCondition::load( Serializer& rSerializer )
// {
