...
#if !defined(KRATOS_BASE_DISPLACEMENT_CONDITION_3D_H_INCLUDED )
#define  KRATOS_BASE_DISPLACEMENT_CONDITION_3D_H_INCLUDED
 ...
 * @ingroup MORMechanicsApplication
 * @brief This is the base class of all the load conditions on MORMechanicsApplication
 * @author Riccardo Rossi
 * @author Vicente Mataix Ferrandiz
 */
class KRATOS_API(MOR_MECHANICS_APPLICATION)  BaseDisplacementCondition
    : public Condition
{
public:
    ...
    KRATOS_CLASS_INTRUSIVE_POINTER_DEFINITION( BaseDisplacementCondition );
    ...
    // Constructor void
    BaseDisplacementCondition()
    {};

    // Constructor using an array of nodes
    BaseDisplacementCondition( IndexType NewId, GeometryType::Pointer pGeometry ):Condition(NewId,pGeometry)
    {};

    // Constructor using an array of nodes with properties
    BaseDisplacementCondition( IndexType NewId, GeometryType::Pointer pGeometry, PropertiesType::Pointer pProperties ):Condition(NewId,pGeometry,pProperties)
    {};

    ///Copy constructor
    BaseDisplacementCondition(BaseDisplacementCondition const& rOther);

    // Destructor
    ~BaseDisplacementCondition() override
    {};
    ...
    /// Assignment operator.
    BaseDisplacementCondition& operator=(BaseDisplacementCondition const& rOther);
...
#endif // KRATOS_BASE_PRESSURE_CONDITION_3D_H_INCLUDED  defined
