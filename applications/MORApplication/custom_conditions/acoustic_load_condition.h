...
// System includes
#if !defined(KRATOS_ACOUSTIC_LOAD_CONDITION_H_INCLUDED )
#define  KRATOS_ACOUSTIC_LOAD_CONDITION_H_INCLUDED
...
public:
    ...
    /// Counted pointer of AcousticLoadCondition
    KRATOS_CLASS_INTRUSIVE_POINTER_DEFINITION( AcousticLoadCondition );
    ...
    /// Destructor.
    ~AcousticLoadCondition() override;
    ...
    std::string Info() const override
    {
        ...
        buffer << "AcousticLoadCondition #" << Id();
        return buffer.str();
    }
    ...
    {
        rOStream << "AcousticLoadCondition #" << Id();
    }
...
private:
    ...
    {
        KRATOS_SERIALIZE_SAVE_BASE_CLASS( rSerializer, AcousticLoadCondition );
    }

    void load( Serializer& rSerializer ) override
    {
        KRATOS_SERIALIZE_LOAD_BASE_CLASS( rSerializer, AcousticLoadCondition );
    }
    ...
    /// Assignment operator.
    //AcousticLoadCondition& operator=(const AcousticLoadCondition& rOther);

    /// Copy constructor.
    //AcousticLoadCondition(const AcousticLoadCondition& rOther);
...
inline std::istream& operator >> (std::istream& rIStream,
        AcousticLoadCondition& rThis);
/// output stream function

inline std::ostream& operator << (std::ostream& rOStream,
        const AcousticLoadCondition& rThis)
{
...
#endif // KRATOS_ACOUSTIC_LOAD_CONDITION_H_INCLUDED  defined
