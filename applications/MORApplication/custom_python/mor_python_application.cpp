...
PYBIND11_MODULE(KratosMORApplication,m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, PARAMETER_EXPONENT )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, PARAMETER_SPATIAL )
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, PRESCRIBED_POTENTIAL )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, IMAG_DISTANCE )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, LOCAL_PML_WIDTH )
    ...
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, ABSORBTION_VECTOR)
