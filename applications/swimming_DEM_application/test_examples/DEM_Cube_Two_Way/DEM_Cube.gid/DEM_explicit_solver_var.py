...
laplacian_calculation_type             = 0 # (Not calculated (0), Finite element projection (1), Superconvergent recovery(2))
...
print_DISPERSE_FRACTION_option                = 1
