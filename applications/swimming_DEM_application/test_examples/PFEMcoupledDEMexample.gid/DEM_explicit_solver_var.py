...
pick_individual_forces_option          = 1
...
drag_force_type                        = 2 # null drag (0), Stokes (1), Weatherford (2), Ganser (3), Ishii (4), Newtonian Regime (5)
...
print_FLUID_VEL_PROJECTED_option           = 0
print_FLUID_ACCEL_PROJECTED_option         = 0
print_BUOYANCY_option                      = 0
print_DRAG_FORCE_option                    = 0
print_VIRTUAL_MASS_FORCE_option            = 0
print_BASSET_FORCE_option                  = 0
print_LIFT_FORCE_option                    = 0
print_FLUID_VEL_PROJECTED_RATE_option      = 0
...
print_HYDRODYNAMIC_FORCE_option            = 0
