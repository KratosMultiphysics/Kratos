...
protected:
    ...
    void AddIntegrationPointRHSContribution(VectorType& F, const array_1d<double,TNumNodes>& rShapeFunc, const bounded_matrix<double, TNumNodes, TDim>& rShapeDeriv, const double Weight) override;
