 ...
 */
template <>
void MonolithicDEMCoupled<2>::GetFirstDerivativesVector(Vector& Values, int Step)
{
    const unsigned int NumNodes(3),LocalSize(9);
    unsigned int LocalIndex = 0;
 ...
 */
template <>
void MonolithicDEMCoupled<3>::GetFirstDerivativesVector(Vector& Values, int Step)
{
    const unsigned int NumNodes(4),LocalSize(16);
    unsigned int LocalIndex = 0;
 ...
 */
template <>
void MonolithicDEMCoupled<2>::GetSecondDerivativesVector(Vector& Values, int Step)
{
    const unsigned int NumNodes(3),LocalSize(9);
    unsigned int LocalIndex = 0;
 ...
 */
template <>
void MonolithicDEMCoupled<3>::GetSecondDerivativesVector(Vector& Values, int Step)
{
    const unsigned int NumNodes(4),LocalSize(16);
    unsigned int LocalIndex = 0;
 ...
 */
template <>
double MonolithicDEMCoupled<2,3>::FilterWidth(const bounded_matrix<double,3,2>& DN_DX)
{
 ...
 */
template <>
double MonolithicDEMCoupled<3,4>::FilterWidth(const bounded_matrix<double,4,3>& DN_DX)
{
    double inv_h_max = 0.0;
 ...
 */
template <>
void MonolithicDEMCoupled<2,3>::CalculateB( bounded_matrix<double, 3, 6 >& rB,
 ...
 */
template <>
void MonolithicDEMCoupled<3,4>::CalculateB( bounded_matrix<double, 6, 12 >& rB,
 ...
 */
template <>
void MonolithicDEMCoupled<2,3>::CalculateC(bounded_matrix<double, 3, 3 > & rC,
 ...
 */
template <>
void MonolithicDEMCoupled<3,4>::CalculateC(bounded_matrix<double, 6,6 > & rC,
                          const double Viscosity)
{
