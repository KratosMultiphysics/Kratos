...
template <>
void ComputeComponentGradientSimplex<2,3>::CalculateWeights(ShapeFunctionDerivativesArrayType& rDN_DX,
        Matrix& rNContainer,
...
template <>
void ComputeComponentGradientSimplex<3,4>::CalculateWeights(ShapeFunctionDerivativesArrayType& rDN_DX,
        Matrix& rNContainer,
        Vector& rGaussWeights)
{
    const GeometryType& rGeom = this->GetGeometry();
...
template <>
void ComputeComponentGradientSimplex<2,3>::EvaluateInPoint(array_1d< double, 3 > & rResult,
...
template <>
void ComputeComponentGradientSimplex<3,4>::EvaluateInPoint(array_1d< double, 3 > & rResult,
                             const Variable< array_1d< double, 3 > >& rVariable,
...
template <>
void ComputeComponentGradientSimplex<2,3>::AddRHSGradient(VectorType& F,
                             const array_1d<double,3>& rShapeFunc,
...
template <>
void ComputeComponentGradientSimplex<3,4>::AddRHSGradient(VectorType& F,
                             const array_1d<double,4>& rShapeFunc,
