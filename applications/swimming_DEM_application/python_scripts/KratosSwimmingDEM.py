...
pp.project_at_every_substep_option        = 0
...
pp.make_results_directories_option        = 0 # results are written into a folder (../results) inside the problem folder
...
pp.coupling_level_type                    = 1 # one way coupling (0), two way coupling (1)
pp.coupling_scheme_type                   = "UpdatedFluid" # "UpdatedFluid", "UpdatedDEM"
pp.coupling_weighing_type                 = 3 # {fluid_to_DEM, DEM_to_fluid, fluid_fraction} = {lin, lin, imposed} (-1), {lin, const, const} (0), {lin, lin, const} (1), {lin, lin, lin} (2), averaging method (3)
...
pp.lift_force_type                        = 1 # null lift force (0)
pp.drag_modifier_type                     = 3 # Hayder (2), Chien (3) # problemtype option
