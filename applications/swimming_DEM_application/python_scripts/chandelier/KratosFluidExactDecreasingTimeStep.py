...
#G
print(sys.argv)
file_name, j_var, k_var, method, current_run_path = sys.argv
print(j_var, k_var)
M = int(j_var)
pp.CFD_DEM.MaxTimeStep = pp.CFD_DEM.MaxTimeStep / 2 ** int(k_var)
...
pp.CFD_DEM.basset_force_type = int(method)
...
store_coors_counter          = swim_proc.Counter(100 * 2 ** int(k_var), 
                                                 1, 
                                                 1)
#G
...
swim_proc.PrintPositionsToFile(coordinates, method, j_var, k_var, main_path)
