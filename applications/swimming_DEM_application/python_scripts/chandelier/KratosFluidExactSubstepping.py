...
#G
file_name, i, j, method, current_run_path = sys.argv
M = int(i)
TIME_STEPS_PER_QUADRATURE_TIME_STEP = 2 ** int(j)
...
pp.CFD_DEM.time_steps_per_quadrature_step = TIME_STEPS_PER_QUADRATURE_TIME_STEP
