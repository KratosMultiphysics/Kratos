    ...
    bool Compute(Eigen::Map<const SparseMatrix> rLhs)
    {
        ...
        switch (report) {
            ...
            case Eigen::ComputationInfo::NumericalIssue:
                KRATOS_ERROR << "UMFPACK factorization ran into a numerical issue";
            case Eigen::ComputationInfo::NoConvergence:
                KRATOS_ERROR << "UMFPACK factorization failed to converge";
            case Eigen::ComputationInfo::InvalidInput:
                KRATOS_ERROR << "invalid input was provided for UMFPACK";
        } // switch report
        return true;
    ...
    bool Solve(Eigen::Ref<const Vector> rRhs, Eigen::Ref<Vector> rSolution) const
    {
        ...
        switch (report) {
            case Eigen::ComputationInfo::Success:
                break;
            case Eigen::ComputationInfo::NumericalIssue:
                KRATOS_ERROR << "UMFPACK solver ran into a numerical issue";
            case Eigen::ComputationInfo::NoConvergence:
                KRATOS_ERROR << "UMFPACK solver failed to converge";
            case Eigen::ComputationInfo::InvalidInput:
                KRATOS_ERROR << "invalid input was provided for UMFPACK";
        } // switch report
        return true;
...
private:
    Eigen::UmfPackLU<SparseMatrix> mDecomposition;
};
