...
namespace Kratos::Testing
{
    ...
    */
    ...
    //     TrilinosCPPTestExperimentalUtilities::GenerateSparseMatrixIndexAndValuesVectors(rA, row_indexes, column_indexes, values, true, 0.99);
    // }

    /**
    * Checks if the block builder and solver performs correctly the assemble of the system
    */
    KRATOS_TEST_CASE_IN_SUITE(TrilinosExperimentalBasicDisplacementBlockBuilderAndSolver, KratosTrilinosApplicationMPITestSuite)
    {
        // The base model part
        Model current_model;
        ...
        // Check assembly
        TrilinosCPPTestExperimentalUtilities::CheckSparseMatrix(rA_scale, row_indexes, column_indexes, values);
    }

    /**
    * Checks if the block builder and solver performs correctly the assemble of the system
    */
    KRATOS_TEST_CASE_IN_SUITE(TrilinosExperimentalDynamicAllocationBasicDisplacementBlockBuilderAndSolver, KratosTrilinosApplicationMPITestSuite)
    {
        // The base model part
        Model current_model;
        ModelPart& r_model_part = current_model.CreateModelPart("Main", 3);
    ...
    */
    KRATOS_TEST_CASE_IN_SUITE(TrilinosExperimentalBasicDisplacementBlockBuilderAndSolverWithZeroContribution, KratosTrilinosApplicationMPITestSuite)
    {
        // The base model part
        Model current_model;
        ModelPart& r_model_part = current_model.CreateModelPart("Main", 3);
    ...
    */
    KRATOS_TEST_CASE_IN_SUITE(TrilinosExperimentalBasicDisplacementBlockBuilderAndSolverWithConstraints, KratosTrilinosApplicationMPITestSuite)
    {
        // The base model part
        Model current_model;
        ModelPart& r_model_part = current_model.CreateModelPart("Main", 3);
    ...
    * Checks if the block builder and solver with constraints performs correctly the assemble of the system
    */
    KRATOS_TEST_CASE_IN_SUITE(TrilinosExperimentalBasicDisplacementBlockBuilderAndSolverWithInactiveConstraints, KratosTrilinosApplicationMPITestSuite)
    {
        // The base model part
        Model current_model;
        ModelPart& r_model_part = current_model.CreateModelPart("Main", 3);
    ...
    * Checks if the block builder and solver performs correctly the assemble of the system
    */
    KRATOS_TEST_CASE_IN_SUITE(TrilinosExperimentalDynamicAllocationBasicDisplacementBlockBuilderAndSolverWithConstraints, KratosTrilinosApplicationMPITestSuite)
    {
        // The base model part
        Model current_model;
        ModelPart& r_model_part = current_model.CreateModelPart("Main", 3);
    ...
    */
    KRATOS_TEST_CASE_IN_SUITE(TrilinosExperimentalBasicDisplacementBlockBuilderAndSolverWithConstraintsAuxiliarNode, KratosTrilinosApplicationMPITestSuite)
    {
        // The base model part
        Model current_model;
        ModelPart& r_model_part = current_model.CreateModelPart("Main", 3);
    ...
    */
    KRATOS_TEST_CASE_IN_SUITE(TrilinosExperimentalBasicDisplacementBlockBuilderAndSolverWithConstraintsAuxiliarNodeInverted, KratosTrilinosApplicationMPITestSuite)
    {
        // The base model part
        Model current_model;
        ModelPart& r_model_part = current_model.CreateModelPart("Main", 3);
    ...
    * Checks if the block builder and solver performs correctly the assemble of the system
    */
    KRATOS_TEST_CASE_IN_SUITE(TrilinosExperimentalBasicDisplacementBlockBuilderAndSolverAllDoFsMaster, KratosTrilinosApplicationMPITestSuite)
    {
        // The base model part
        Model current_model;
        ModelPart& r_model_part = current_model.CreateModelPart("Main", 3);
    ...
    * Checks if the block builder and solver performs correctly the assemble of the system
    */
    KRATOS_TEST_CASE_IN_SUITE(TrilinosExperimentalBasicDisplacementBlockBuilderAndSolverAllDoFsMasterFromStructureSide, KratosTrilinosApplicationMPITestSuite)
    {
        // The base model part
        Model current_model;
        ModelPart& r_model_part = current_model.CreateModelPart("Main", 3);
    ...
    */
    KRATOS_TEST_CASE_IN_SUITE(TrilinosExperimentalExtendedDisplacementBlockBuilderAndSolver, KratosTrilinosApplicationMPITestSuite)
    {
        // The base model part
        Model current_model;
        ModelPart& r_model_part = current_model.CreateModelPart("Main", 3);
    ...
    */
    KRATOS_TEST_CASE_IN_SUITE(TrilinosExperimentalExtendedDisplacementBlockBuilderAndSolverWithConstraints, KratosTrilinosApplicationMPITestSuite)
    {
        // The base model part
        Model current_model;
        ModelPart& r_model_part = current_model.CreateModelPart("Main", 3);
    ...
    // */
    // KRATOS_TEST_CASE_IN_SUITE(TrilinosExperimentalExtendedDisplacementEliminationBuilderAndSolver, KratosTrilinosApplicationMPITestSuite)
    // {
    //     // The base model part
    //     Model current_model;
    //     ModelPart& r_model_part = current_model.CreateModelPart("Main", 3);
    ...
    * Checks if the block builder and solver performs correctly the assemble of the extended system with constraints
    */
    KRATOS_TEST_CASE_IN_SUITE(TrilinosExperimentalStructuralDisplacementBlockBuilderAndSolver, KratosTrilinosApplicationMPITestSuite)
    {
        // The base model part
        Model current_model;
        ModelPart& r_model_part = current_model.CreateModelPart("Main", 3);
    ...
    * Checks if the block builder and solver performs correctly the assemble of the extended system with constraints
    */
    KRATOS_TEST_CASE_IN_SUITE(TrilinosExperimentalStructuralDisplacementBlockBuilderAndSolverInverted, KratosTrilinosApplicationMPITestSuite)
    {
        // The base model part
        Model current_model;
        ModelPart& r_model_part = current_model.CreateModelPart("Main", 3);
