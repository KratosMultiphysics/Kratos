...
#if !defined(KRATOS_TRILINOS_RESIDUALBASED_SIMPLE_STEADY_SCHEME )
#define  KRATOS_TRILINOS_RESIDUALBASED_SIMPLE_STEADY_SCHEME
...
class TrilinosResidualBasedSimpleSteadyScheme : public Scheme<TSparseSpace, TDenseSpace> {
public:
  ///@name Type Definitions
  ///@{

  KRATOS_CLASS_POINTER_DEFINITION(TrilinosResidualBasedSimpleSteadyScheme);
  ...
  TrilinosResidualBasedSimpleSteadyScheme(double VelocityRelaxationFactor,
  ...
  TrilinosResidualBasedSimpleSteadyScheme(
  ...
  ~TrilinosResidualBasedSimpleSteadyScheme() override {}
                                       ...
                                       TSystemVectorType &rb) override
  {
    ...
    if (CurrentProcessInfo[OSS_SWITCH] == 1.0) {
      ...
      KRATOS_INFO_IF("TrilinosResidualBasedSimpleSteadyScheme", rModelPart.GetCommunicator().MyPID() == 0)
...
#endif /* KRATOS_TRILINOS_RESIDUALBASED_SIMPLE_STEADY_SCHEME defined */
