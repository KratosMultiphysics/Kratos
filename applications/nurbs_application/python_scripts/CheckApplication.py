...
from KratosMultiphysics.NurbsTestcaseApplication import *        #and now our application. note that we can import as many as we need to solve our specific problem
from KratosMultiphysics.FluidDynamicsApplication import *        #and now our application. note that we can import as many as we need to solve our specific problem
...
print time.clock()
#Read in the ModelPart "FluidMesh.mdpa" which has to be in the same working direction as this file
...
OutModelPart = ModelPart("OutModelPart") #Only needed for visualization of Pure-Difusion-Problem
...
weights = [ 1.0,0.92677669529663687,0.85355339059327373,0.85355339059327395,0.92677669529663698,1.0,
...
NurbsModeler.ClosestPoint(FluidMesh,NurbsModelPart)
...
gid_io = GidIO("control_points",gid_mode,multifile,deformed_mesh_flag,write_conditions)
