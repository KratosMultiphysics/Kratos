...
namespace Kratos
{
      ...
      KRATOS_DEFINE_VARIABLE(double,  DEM_FEM_TIME_STEP)
      KRATOS_DEFINE_VARIABLE(int,     DEM_FEM_DAMP_TYPE)
      KRATOS_DEFINE_VARIABLE(double,  DEM_FEM_DAMP_RATIO)
      KRATOS_DEFINE_VARIABLE(int,     DEM_FEM_DIMENSION)
      KRATOS_DEFINE_VARIABLE(double,  DEM_FEM_CONVERGENCE_RATIO)
      KRATOS_DEFINE_VARIABLE(int, PARTICLE_IF_CAL_ROTATE)
      KRATOS_DEFINE_VARIABLE(int, PARTICLE_IF_CAL_ROTATE_SPRING)

      KRATOS_DEFINE_VARIABLE(Vector,     PARTICLE_CONTACT_FORCE)
      KRATOS_DEFINE_VARIABLE(Vector,     PARTICLE_IF_INITIAL_CONTACT)
      KRATOS_DEFINE_VARIABLE(WeakPointerVector<Element >,     NEIGHBOUR_PARTICLE_ELEMENTS)
