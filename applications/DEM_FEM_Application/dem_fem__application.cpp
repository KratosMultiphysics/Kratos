...
namespace Kratos
{
    ...
    KRATOS_CREATE_VARIABLE(double,  DEM_FEM_TIME_STEP)
    KRATOS_CREATE_VARIABLE(int,     DEM_FEM_DAMP_TYPE)
    KRATOS_CREATE_VARIABLE(double,  DEM_FEM_DAMP_RATIO)
    KRATOS_CREATE_VARIABLE(int,     DEM_FEM_DIMENSION)
    KRATOS_CREATE_VARIABLE(double,  DEM_FEM_CONVERGENCE_RATIO)
    KRATOS_CREATE_VARIABLE(int, PARTICLE_IF_CAL_ROTATE)
    KRATOS_CREATE_VARIABLE(int, PARTICLE_IF_CAL_ROTATE_SPRING)


    KRATOS_CREATE_VARIABLE(Vector,     PARTICLE_CONTACT_FORCE)
    KRATOS_CREATE_VARIABLE(Vector,     PARTICLE_IF_INITIAL_CONTACT)
    KRATOS_CREATE_VARIABLE(WeakPointerVector<Element >,     NEIGHBOUR_PARTICLE_ELEMENTS)
...
*/
    ...
    void KratosDEM_FEM_Application::Register()
    {
       ...
       KRATOS_REGISTER_VARIABLE(DEM_FEM_TIME_STEP)
       KRATOS_REGISTER_VARIABLE(DEM_FEM_DAMP_TYPE)
       KRATOS_REGISTER_VARIABLE(DEM_FEM_DAMP_RATIO)

       KRATOS_REGISTER_VARIABLE(DEM_FEM_DIMENSION)
       KRATOS_REGISTER_VARIABLE(DEM_FEM_CONVERGENCE_RATIO)
       KRATOS_REGISTER_VARIABLE(PARTICLE_IF_CAL_ROTATE)
       KRATOS_REGISTER_VARIABLE(PARTICLE_IF_CAL_ROTATE_SPRING)



       KRATOS_REGISTER_VARIABLE(PARTICLE_CONTACT_FORCE)
       KRATOS_REGISTER_VARIABLE(PARTICLE_IF_INITIAL_CONTACT)
       KRATOS_REGISTER_VARIABLE(NEIGHBOUR_PARTICLE_ELEMENTS)
