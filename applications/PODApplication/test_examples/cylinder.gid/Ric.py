...
Reduced_Pods_Read('VH_Pressure_reduced.txt',POD_PRESSURE,nnodes,npods,PRESSURE)
Reduced_Pods_Read('VH_VY_reduced.txt',POD_VELOCITY_Y,nnodes,npods,VELOCITY_Y)
Reduced_Pods_Read('VH_VX_reduced.txt',POD_VELOCITY_X,nnodes,npods,VELOCITY_X)
