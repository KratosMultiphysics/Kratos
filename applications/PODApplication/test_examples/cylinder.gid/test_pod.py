...
if(SolverType == "FractionalStep"):
    ...
    import monolithic_solver_eulerian_POD
    monolithic_solver_eulerian_POD.AddVariables(fluid_model_part)
...
if(SolverType == "FractionalStep"):
    ...
    monolithic_solver_eulerian_POD.AddDofs(fluid_model_part)
elif(SolverType == "monolithic_solver_eulerian_compressible"):
