...
class KRATOS_API(MAPPING_APPLICATION) NearestElementMapper : public InterpolativeMapperBase<TIsDistributed>
{
public:
    ...
    {
        return Kratos::make_unique<NearestElementMapper<TIsDistributed>>(
            rModelPartOrigin,
            rModelPartDestination,
            JsonParameters);
    }
