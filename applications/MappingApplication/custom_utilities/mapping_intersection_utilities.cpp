    ...
    double Tolerance)
{
        ...
        ++condition_a_itr)
    {
            ...
            ++condition_b_itr)
        {
            ...
            {
                rModelPartResult.AddGeometry(Kratos::make_intrusive<CouplingGeometry<NodeType>>(
        ...
        ++geometry_itr)
    {
        ...
        for (IndexType i = 0; i < IntegrationPointsPerSpan; ++i) {
            rModelPartCoupling.AddCondition(Kratos::make_intrusive<Condition>(
                id + i, Kratos::make_intrusive<CouplingGeometry<Node>>(quadrature_point_geometries_master(i), quadrature_point_geometries_slave(i))));
        }
    }
}
