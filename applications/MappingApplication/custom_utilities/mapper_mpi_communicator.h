...
public:
    ...
    void TransferVariableData(std::function<double(InterfaceObject::Pointer, const std::vector<double>&)> FunctionPointerOrigin,
    ...
    void TransferVariableData(std::function<array_1d<double, 3>(InterfaceObject::Pointer, const std::vector<double>&)> FunctionPointerOrigin,
...
private:
    ...
    template <typename T>
    void ExchangeDataRemote(std::function<T(InterfaceObject::Pointer, const std::vector<double>&)> FunctionPointerOrigin,
