...
KRATOS_TEST_CASE_IN_SUITE(NearestNeighborInterfaceInfo_NeighborsFound, KratosMappingApplicationSerialTestSuite)
{
    ...
    auto node_1(Kratos::make_intrusive<Node>(1, 1.0, 2.5, 30.0));
    auto node_2(Kratos::make_intrusive<Node>(3, 10.5, 20.0, 96.8));
    auto node_3(Kratos::make_intrusive<Node>(15, 2.3, 1.9, -2.5));
...
KRATOS_TEST_CASE_IN_SUITE(NearestNeighborInterfaceInfo_MatchingNeighborFound, KratosMappingApplicationSerialTestSuite)
{
    ...
    auto node_1(Kratos::make_intrusive<Node>(1, 18.0, 2.7, 30.0));
    auto node_2(Kratos::make_intrusive<Node>(3, 1.0, 2.5, -3.0));
...
KRATOS_TEST_CASE_IN_SUITE(MapperLocalSystem_BasicTests, KratosMappingApplicationSerialTestSuite)
{
    ...
    Point coords_1(1.0, 2.45, -23.8);
    auto node_local_sys(Kratos::make_intrusive<Node>(5, coords_1));
...
{
    auto node_local_sys(Kratos::make_intrusive<Node>(8, 1.0, 2.5, -5.0));
...
KRATOS_TEST_CASE_IN_SUITE(NearestNeighborLocalSystem_ComputeLocalSystem, KratosMappingApplicationSerialTestSuite)
{
    ...
    auto node_local_sys(Kratos::make_intrusive<Node>(5, 1.0, 2.5, -5.0));
    ...
    auto node_1(Kratos::make_intrusive<Node>(1, 18.0, 2.7, 30.0));
    auto node_2(Kratos::make_intrusive<Node>(3, 1.0, 2.5, -3.0)); // this is the nearest neighbor
