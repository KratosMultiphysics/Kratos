...
class TestPatchTestMappers(KratosUnittest.TestCase):
    ...
    def _create_mapper(self, mapper_name):
        ...
        mapper_settings.AddEmptyValue("echo_level")
        mapper_settings["echo_level"].SetInt(3)
    ...
    def _test_nearest_element_mapper(self):
        mapper_name = "NearestElement"
        ...
        # Test conservative Mapping => Not yet implemented for this Mapper!
        # self._execute_non_constant_value_test(results_conservative, KratosMapping.Mapper.CONSERVATIVE)
