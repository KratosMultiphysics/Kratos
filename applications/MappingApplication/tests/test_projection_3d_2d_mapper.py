...
class Projection3D2DMapperBase(mapper_test_case.MapperTestCase):
    ...
    def test_Projection3D2DMapper_Map_non_constant_scalar(self):
        ...
        self.CheckHistoricalNonUniformValues(self.model_part_destination, KM.TEMPERATURE, GetFilePath(self._GetFileName("map_scalar")), True)
        self.VtkOutputNodesHistorical(self.model_part_destination, KM.TEMPERATURE)
    ...
    #     self.CheckHistoricalNonUniformValues(self.model_part_origin, KM.PRESSURE, GetFilePath(self._GetFileName("inverse_map_scalar")))
    ...
    #     self.CheckHistoricalNonUniformValues(self.model_part_destination, KM.VELOCITY, GetFilePath(self._GetFileName("map_vector")))
    ...
    #     self.CheckHistoricalNonUniformValues(self.model_part_origin, KM.FORCE, GetFilePath(self._GetFileName("inverse_map_vector")))
...
class Projection3D2DMapper(Projection3D2DMapperBase):
    @classmethod
    def setUpClass(cls):
