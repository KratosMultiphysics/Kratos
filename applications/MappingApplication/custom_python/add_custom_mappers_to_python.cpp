...
void  AddCustomMappersToPython(pybind11::module& m)
{
    ...
    py::class_< BeamMapperType, typename BeamMapperType::Pointer, Mapper<MapperDefinitions::SparseSpaceType, MapperDefinitions::DenseSpaceType>>(m, beam_mapper_name.c_str())
        ...
        .def("InverseMap", py::overload_cast<const Variable<array_1d<double, 3>>&, const Variable<array_1d<double, 3>>&, const Variable<array_1d<double, 3>>&, Flags>(&BeamMapperType::Map), py::arg("origin_force_variable"), py::arg("origin_moment_variable"), py::arg("destination_force_variable"), py::arg("mapping_options") = Kratos::Flags())
        ;
}
