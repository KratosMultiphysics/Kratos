...
private:
    ...
    static Vector AveragingPrincipalStressComponents(const Vector& rPrincipalStressVector, int MappingType);
    static int FindMappingType(const Vector& rMappedPrincipalStressVector);
