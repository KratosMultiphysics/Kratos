...
private:
    ...
    Vector AveragingPrincipalStressComponents(const Vector& rPrincipalStressVector, int MappingType);
    int FindMappingType(const Vector& rMappedPrincipalStressVector);
