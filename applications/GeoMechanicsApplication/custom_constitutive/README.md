...
The constitutive law for an interface linearly element relates tractions $\tau$ to relative displacement $\Delta u$.
...
gives shear. Similar to the continuum, the normal behavior is placed first in the relative displacement and traction vector. The shear behavior
