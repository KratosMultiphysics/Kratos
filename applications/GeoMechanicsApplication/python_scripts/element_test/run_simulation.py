...
def set_material_constitutive_law(json_file_path, dll_path, umat_parameters, index):
...
def run_simulation(test_type, dll_path, index, umat_parameters, num_steps, end_time, maximum_strain,
    ...
    try:
        ...
        set_material_constitutive_law(json_path, dll_path, umat_parameters, index)
        ...
        cohesion, friction_angle = get_cohesion_phi(umat_parameters, cohesion_phi_indices)
