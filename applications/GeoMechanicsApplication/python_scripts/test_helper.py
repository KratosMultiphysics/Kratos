...
def get_on_integration_points(model_obj, kratos_variable, element_ids=None):
    """
    ...
    if isinstance(element_ids, list) :
        elements = [element for element in model_part.Elements if element.Id in element_ids]
