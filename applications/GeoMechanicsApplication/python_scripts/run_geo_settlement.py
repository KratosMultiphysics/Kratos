...
def _main() -> int:
    ...
    parser.add_argument("-w", "--working-dir", help="working directory of the app", default=".")
    parser.add_argument("project_parameters_file", help="'ProjectParameters.json' files of the stages", nargs="+")
