...
class GeoIntegrationValuesExtrapolationToNodesProcess(KratosMultiphysics.Process):
    ...
    def ExecuteBeforeSolutionLoop(self):
        ...
        self -- It signifies an instance of a class.
        """
        self.geo_integration_values_extrapolation_to_nodes_process.ExecuteBeforeSolutionLoop()
    ...
    def ExecuteFinalizeSolutionStep(self):
        ...
        self -- It signifies an instance of a class.
        """
        self.geo_integration_values_extrapolation_to_nodes_process.ExecuteFinalizeSolutionStep()
    ...
    def ExecuteFinalize(self):
        ...
        self -- It signifies an instance of a class.
        """
        self.geo_integration_values_extrapolation_to_nodes_process.ExecuteFinalize()
