...
KRATOS_CREATE_VARIABLE(bool, GEO_ENABLE_TENSION_CUT_OFF)
KRATOS_CREATE_VARIABLE(bool, GEO_USE_NUMERICAL_TANGENT_OPERATOR)
...
KRATOS_CREATE_VARIABLE(double, GEO_MAX_RELATIVE_OVERSHOOT)
KRATOS_CREATE_VARIABLE(int, GEO_MAX_NUMBER_OF_SUB_STEPS)
...
KRATOS_CREATE_VARIABLE(std::string, GEO_YOUNGS_MODULUS_FORMULATION)
KRATOS_CREATE_VARIABLE(double, GEO_PRESSURE_REFERENCE)
KRATOS_CREATE_VARIABLE(double, GEO_STRESS_DEPENDENCY_EXPONENT)
...
KRATOS_CREATE_VARIABLE(double, GEO_POISSON_UNDRAINED)
KRATOS_CREATE_VARIABLE(double, GEO_SKEMPTON_B)
...
KRATOS_CREATE_VARIABLE(std::vector<Vector>, GEO_PIECEWISE_LINEAR_MOMENT_LAW)
KRATOS_CREATE_VARIABLE(double, GEO_UNLOADING_RELOADING_MODULUS)
