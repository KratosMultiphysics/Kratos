...
KRATOS_CREATE_VARIABLE(double, AIR_ENTRY_PRESSURE )
...
KRATOS_CREATE_VARIABLE(double, BROOKS_COREY_PORE_SIZE_INDEX )
KRATOS_CREATE_VARIABLE(double, BROOKS_COREY_FITTING_PARAMETER )
KRATOS_CREATE_VARIABLE(double, AIR_EXPULSION_PRESSURE )
KRATOS_CREATE_VARIABLE(double, LAST_STEP_PRESSURE )
KRATOS_CREATE_VARIABLE(double, BROOKS_COREY_PORE_SIZE_INDEX_WET )
KRATOS_CREATE_VARIABLE(double, BROOKS_COREY_FITTING_PARAMETER_WET )
KRATOS_CREATE_VARIABLE(double, RELPERM_POWER )
...
KRATOS_CREATE_VARIABLE(double,      INCREMENT_OF_SUCTION )
