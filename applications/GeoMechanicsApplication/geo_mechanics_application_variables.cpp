...
KRATOS_CREATE_VARIABLE( int, INDEX_2D_THERMAL_FLUX_X )
KRATOS_CREATE_VARIABLE( int, INDEX_2D_THERMAL_FLUX_Y )
KRATOS_CREATE_VARIABLE( int, INDEX_2D_THERMAL_FLUX_Z )
