...
KRATOS_CREATE_VARIABLE(bool, PIPE_SECONDARY_EROSION)
KRATOS_CREATE_VARIABLE(bool, PIPE_PRIMARY_EROSION_ENABLED)
KRATOS_CREATE_VARIABLE(bool, PIPE_PRIMARY_EROSION)
KRATOS_CREATE_VARIABLE(double, PIPE_CRITICAL_GRADIENT)
