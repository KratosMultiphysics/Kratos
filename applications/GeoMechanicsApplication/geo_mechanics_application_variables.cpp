...
KRATOS_CREATE_VARIABLE(Vector, KAPPA_PIECEWISE_LINEAR_LAW)
KRATOS_CREATE_VARIABLE(Vector, MOMENTUM_PIECEWISE_LINEAR_LAW)
KRATOS_CREATE_VARIABLE(double, MAX_AXIAL_LOAD_OF_CONSTRUCTION_ELEMENT)
KRATOS_CREATE_VARIABLE(double, MOMENT_CAPACITY_REDUCTION_FACTOR)
KRATOS_CREATE_VARIABLE(double, MINIMUM_MOMENT_CAPACITY_FACTOR)
KRATOS_CREATE_VARIABLE(double, UNRELOAD_MODULUS)
