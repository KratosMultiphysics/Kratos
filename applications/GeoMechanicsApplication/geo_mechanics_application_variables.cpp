...
KRATOS_CREATE_VARIABLE(double, GEO_COHESION_STRENGTH_FACTOR)
KRATOS_CREATE_VARIABLE(double, GEO_FRICTION_ANGLE_STRENGTH_FACTOR)
KRATOS_CREATE_VARIABLE(double, GEO_DILATANCY_ANGLE_STRENGTH_FACTOR)
