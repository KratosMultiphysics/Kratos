...
KRATOS_CREATE_VARIABLE( double, THERMAL_CONDUCTIVITY_SOLID_ZZ )
KRATOS_CREATE_VARIABLE( double, THERMAL_CONDUCTIVITY_SOLID_XY )
KRATOS_CREATE_VARIABLE( double, THERMAL_CONDUCTIVITY_SOLID_YZ )
KRATOS_CREATE_VARIABLE( double, THERMAL_CONDUCTIVITY_SOLID_ZX )
