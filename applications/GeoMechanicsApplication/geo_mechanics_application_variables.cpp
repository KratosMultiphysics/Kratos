...
KRATOS_CREATE_VARIABLE( UnivariatePhaseLaw::Pointer,        SWCC_LAW )
KRATOS_CREATE_VARIABLE( UnivariatePhaseLaw::Pointer,        GAS_LAW )
KRATOS_CREATE_VARIABLE( UnivariatePhaseLaw::Pointer,        WATER_LAW )
KRATOS_CREATE_VARIABLE( UnivariatePhaseLaw::Pointer,        RELATIVE_PERMEABILITY_WATER_LAW )
KRATOS_CREATE_VARIABLE( UnivariatePhaseLaw::Pointer,        RELATIVE_PERMEABILITY_AIR_LAW )
