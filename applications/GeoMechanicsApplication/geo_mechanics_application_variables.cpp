...
KRATOS_CREATE_VARIABLE( double, HEAT_CAPACITY_WATER )
KRATOS_CREATE_VARIABLE( double, HEAT_CAPACITY_SOLID )
KRATOS_CREATE_VARIABLE( double, THERMAL_CONDUCTIVITY_WATER )
KRATOS_CREATE_VARIABLE( double, THERMAL_CONDUCTIVITY_SOLID_XX )
KRATOS_CREATE_VARIABLE( double, THERMAL_CONDUCTIVITY_SOLID_YY )
KRATOS_CREATE_VARIABLE( double, THERMAL_CONDUCTIVITY_SOLID_XY )
KRATOS_CREATE_VARIABLE( double, THERMAL_CONDUCTIVITY_SOLID_YX )
...
KRATOS_CREATE_VARIABLE( double, RELATIVE_LENGTH )
