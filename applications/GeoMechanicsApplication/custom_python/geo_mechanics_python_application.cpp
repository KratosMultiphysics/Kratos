...
PYBIND11_MODULE(KratosGeoMechanicsApplication, m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, PIPE_SECONDARY_EROSION)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, PIPE_PRIMARY_EROSION_ENABLED)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, PIPE_PRIMARY_EROSION)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, PIPE_CRITICAL_GRADIENT)
