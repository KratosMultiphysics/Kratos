...
PYBIND11_MODULE(KratosGeoMechanicsApplication, m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, MAX_AXIAL_LOAD_OF_CONSTRUCTION_ELEMENT)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, MOMENT_CAPACITY_REDUCTION_FACTOR)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, MINIMUM_MOMENT_CAPACITY_FACTOR)
}
