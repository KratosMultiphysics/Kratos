...
PYBIND11_MODULE(KratosGeoMechanicsApplication, m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, GEO_COHESION)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, GEO_FRICTION_ANGLE)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, GEO_DILATANCY_ANGLE)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, GEO_TENSILE_STRENGTH)

    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, INTERFACE_NORMAL_STIFFNESS)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, INTERFACE_SHEAR_STIFFNESS)
}
