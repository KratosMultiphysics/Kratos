...
#if !defined(KRATOS_NEWMARK_DYNAMIC_U_PA_PW_SCHEME )
#define  KRATOS_NEWMARK_DYNAMIC_U_PA_PW_SCHEME
...
class NewmarkDynamicUPaPwScheme : public NewmarkQuasistaticUPaPwScheme<TSparseSpace,TDenseSpace>
{

public:

    KRATOS_CLASS_POINTER_DEFINITION( NewmarkDynamicUPaPwScheme );
    ...
    using NewmarkQuasistaticUPaPwScheme<TSparseSpace,TDenseSpace>::mDeltaTime;
    using NewmarkQuasistaticUPaPwScheme<TSparseSpace,TDenseSpace>::mBeta;
    using NewmarkQuasistaticUPaPwScheme<TSparseSpace,TDenseSpace>::mGamma;
    using NewmarkQuasistaticUPaPwScheme<TSparseSpace,TDenseSpace>::mTheta;

//----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

    ///Constructor
    NewmarkDynamicUPaPwScheme(double beta, double gamma, double theta)
        : NewmarkQuasistaticUPaPwScheme<TSparseSpace,TDenseSpace>(beta, gamma, theta)
    {
    ...
    ///Destructor
    ~NewmarkDynamicUPaPwScheme() override {}
...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        TSystemVectorType& b) override
    {
        ...
        block_for_each(rModelPart.Nodes(), [&](Node<3>& rNode){
            ...
            rNode.FastGetSolutionStepValue(DT_AIR_PRESSURE) =  1.0/(mTheta*mDeltaTime)
                                                              * ( DeltaAirPressure
                                                                 - (1.0-mTheta) * mDeltaTime
...
}; // Class NewmarkDynamicUPaPwScheme
}  // namespace Kratos

#endif // KRATOS_NEWMARK_DYNAMIC_U_PA_PW_SCHEME defined
