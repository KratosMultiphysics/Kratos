...
private:
    ...
    const UPwSmallStrainElement<2, 3> mUPwUpdatedLagrangianElement2D3N{
        0, Kratos::make_shared<Triangle2D3<NodeType>>(Element::GeometryType::PointsArrayType(3)),
        std::make_unique<PlaneStrainStressState>()};
    const UPwSmallStrainElement<2, 4> mUPwUpdatedLagrangianElement2D4N{
        0, Kratos::make_shared<Quadrilateral2D4<NodeType>>(Element::GeometryType::PointsArrayType(4)),
        std::make_unique<PlaneStrainStressState>()};
    const UPwSmallStrainElement<2, 6> mUPwUpdatedLagrangianElement2D6N{
        0, Kratos::make_shared<Triangle2D6<NodeType>>(Element::GeometryType::PointsArrayType(6)),
        std::make_unique<PlaneStrainStressState>()};
    const UPwSmallStrainElement<2, 8> mUPwUpdatedLagrangianElement2D8N{
        0, Kratos::make_shared<Quadrilateral2D8<NodeType>>(Element::GeometryType::PointsArrayType(8)),
        std::make_unique<PlaneStrainStressState>()};
    const UPwSmallStrainElement<2, 9> mUPwUpdatedLagrangianElement2D9N{
        0, Kratos::make_shared<Quadrilateral2D9<NodeType>>(Element::GeometryType::PointsArrayType(9)),
        std::make_unique<PlaneStrainStressState>()};
    const UPwSmallStrainElement<2, 10> mUPwUpdatedLagrangianElement2D10N{
        0, Kratos::make_shared<Triangle2D10<NodeType>>(Element::GeometryType::PointsArrayType(10)),
        std::make_unique<PlaneStrainStressState>()};
    const UPwSmallStrainElement<2, 15> mUPwUpdatedLagrangianElement2D15N{
        0, Kratos::make_shared<Triangle2D15<NodeType>>(Element::GeometryType::PointsArrayType(15)),
        std::make_unique<PlaneStrainStressState>()};
    const UPwSmallStrainElement<3, 4> mUPwUpdatedLagrangianElement3D4N{
        0, Kratos::make_shared<Tetrahedra3D4<NodeType>>(Element::GeometryType::PointsArrayType(4)),
        std::make_unique<ThreeDimensionalStressState>()};
    const UPwSmallStrainElement<3, 8> mUPwUpdatedLagrangianElement3D8N{
        0, Kratos::make_shared<Hexahedra3D8<NodeType>>(Element::GeometryType::PointsArrayType(8)),
        std::make_unique<ThreeDimensionalStressState>()};
    const UPwSmallStrainElement<3, 10> mUPwUpdatedLagrangianElement3D10N{
        0, Kratos::make_shared<Tetrahedra3D10<NodeType>>(Element::GeometryType::PointsArrayType(10)),
        std::make_unique<ThreeDimensionalStressState>()};
    const UPwSmallStrainElement<3, 20> mUPwUpdatedLagrangianElement3D20N{
        0, Kratos::make_shared<Hexahedra3D20<NodeType>>(Element::GeometryType::PointsArrayType(20)),
        std::make_unique<ThreeDimensionalStressState>()};
    const UPwSmallStrainElement<3, 27> mUPwUpdatedLagrangianElement3D27N{
        0, Kratos::make_shared<Hexahedra3D27<NodeType>>(Element::GeometryType::PointsArrayType(27)),
        std::make_unique<ThreeDimensionalStressState>()};
    ...
    const SmallStrainUPwDiffOrderElement mUpdatedLagrangianUPwDiffOrderElement2D6N{
        0, Kratos::make_shared<Triangle2D6<NodeType>>(Element::GeometryType::PointsArrayType(6)),
        std::make_unique<PlaneStrainStressState>()};
    const SmallStrainUPwDiffOrderElement mUpdatedLagrangianUPwDiffOrderElement2D8N{
        0, Kratos::make_shared<Quadrilateral2D8<NodeType>>(Element::GeometryType::PointsArrayType(8)),
        std::make_unique<PlaneStrainStressState>()};
    const SmallStrainUPwDiffOrderElement mUpdatedLagrangianUPwDiffOrderElement2D9N{
        0, Kratos::make_shared<Quadrilateral2D9<NodeType>>(Element::GeometryType::PointsArrayType(9)),
        std::make_unique<PlaneStrainStressState>()};
    const SmallStrainUPwDiffOrderElement mUpdatedLagrangianUPwDiffOrderElement2D10N{
        0, Kratos::make_shared<Triangle2D10<NodeType>>(Element::GeometryType::PointsArrayType(10)),
        std::make_unique<PlaneStrainStressState>()};
    const SmallStrainUPwDiffOrderElement mUpdatedLagrangianUPwDiffOrderElement2D15N{
        0, Kratos::make_shared<Triangle2D15<NodeType>>(Element::GeometryType::PointsArrayType(15)),
        std::make_unique<PlaneStrainStressState>()};
    const SmallStrainUPwDiffOrderElement mUpdatedLagrangianUPwDiffOrderElement3D10N{
        0, Kratos::make_shared<Tetrahedra3D10<NodeType>>(Element::GeometryType::PointsArrayType(10)),
        std::make_unique<ThreeDimensionalStressState>()};
    const SmallStrainUPwDiffOrderElement mUpdatedLagrangianUPwDiffOrderElement3D20N{
        0, Kratos::make_shared<Hexahedra3D20<NodeType>>(Element::GeometryType::PointsArrayType(20)),
        std::make_unique<ThreeDimensionalStressState>()};
    const SmallStrainUPwDiffOrderElement mUpdatedLagrangianUPwDiffOrderElement3D27N{
        0, Kratos::make_shared<Hexahedra3D27<NodeType>>(Element::GeometryType::PointsArrayType(27)),
        std::make_unique<ThreeDimensionalStressState>()};

    // Updated-Lagrangian axisymmetric elements
    const UPwSmallStrainElement<2, 3> mUPwUpdatedLagrangianAxisymmetricElement2D3N{
        0, Kratos::make_shared<Triangle2D3<NodeType>>(Element::GeometryType::PointsArrayType(3)),
        std::make_unique<AxisymmetricStressState>(),
        std::make_unique<IntegrationCoefficientModifierForAxisymmetricElement>()};
    const UPwSmallStrainElement<2, 4> mUPwUpdatedLagrangianAxisymmetricElement2D4N{
        0, Kratos::make_shared<Quadrilateral2D4<NodeType>>(Element::GeometryType::PointsArrayType(4)),
        std::make_unique<AxisymmetricStressState>(),
        std::make_unique<IntegrationCoefficientModifierForAxisymmetricElement>()};
    const UPwSmallStrainElement<2, 6> mUPwUpdatedLagrangianAxisymmetricElement2D6N{
        0, Kratos::make_shared<Triangle2D6<NodeType>>(Element::GeometryType::PointsArrayType(6)),
        std::make_unique<AxisymmetricStressState>(),
        std::make_unique<IntegrationCoefficientModifierForAxisymmetricElement>()};
    const UPwSmallStrainElement<2, 8> mUPwUpdatedLagrangianAxisymmetricElement2D8N{
        0, Kratos::make_shared<Quadrilateral2D8<NodeType>>(Element::GeometryType::PointsArrayType(8)),
        std::make_unique<AxisymmetricStressState>(),
        std::make_unique<IntegrationCoefficientModifierForAxisymmetricElement>()};
    const UPwSmallStrainElement<2, 9> mUPwUpdatedLagrangianAxisymmetricElement2D9N{
        0, Kratos::make_shared<Quadrilateral2D9<NodeType>>(Element::GeometryType::PointsArrayType(9)),
        std::make_unique<AxisymmetricStressState>(),
        std::make_unique<IntegrationCoefficientModifierForAxisymmetricElement>()};
    const UPwSmallStrainElement<2, 10> mUPwUpdatedLagrangianAxisymmetricElement2D10N{
        0, Kratos::make_shared<Triangle2D10<NodeType>>(Element::GeometryType::PointsArrayType(10)),
        std::make_unique<AxisymmetricStressState>(),
        std::make_unique<IntegrationCoefficientModifierForAxisymmetricElement>()};
    const UPwSmallStrainElement<2, 15> mUPwUpdatedLagrangianAxisymmetricElement2D15N{
        0, Kratos::make_shared<Triangle2D15<NodeType>>(Element::GeometryType::PointsArrayType(15)),
        std::make_unique<AxisymmetricStressState>(),
        std::make_unique<IntegrationCoefficientModifierForAxisymmetricElement>()};

    const SmallStrainUPwDiffOrderElement mUpdatedLagrangianUPwDiffOrderAxisymmetricElement2D6N{
        0, Kratos::make_shared<Triangle2D6<NodeType>>(Element::GeometryType::PointsArrayType(6)),
        std::make_unique<AxisymmetricStressState>(),
        std::make_unique<IntegrationCoefficientModifierForAxisymmetricElement>()};
    const SmallStrainUPwDiffOrderElement mUpdatedLagrangianUPwDiffOrderAxisymmetricElement2D8N{
        0, Kratos::make_shared<Quadrilateral2D8<NodeType>>(Element::GeometryType::PointsArrayType(8)),
        std::make_unique<AxisymmetricStressState>(),
        std::make_unique<IntegrationCoefficientModifierForAxisymmetricElement>()};
    const SmallStrainUPwDiffOrderElement mUpdatedLagrangianUPwDiffOrderAxisymmetricElement2D9N{
        0, Kratos::make_shared<Quadrilateral2D9<NodeType>>(Element::GeometryType::PointsArrayType(9)),
        std::make_unique<AxisymmetricStressState>(),
        std::make_unique<IntegrationCoefficientModifierForAxisymmetricElement>()};
    const SmallStrainUPwDiffOrderElement mUpdatedLagrangianUPwDiffOrderAxisymmetricElement2D10N{
        0, Kratos::make_shared<Triangle2D10<NodeType>>(Element::GeometryType::PointsArrayType(10)),
        std::make_unique<AxisymmetricStressState>(),
        std::make_unique<IntegrationCoefficientModifierForAxisymmetricElement>()};
    const SmallStrainUPwDiffOrderElement mUpdatedLagrangianUPwDiffOrderAxisymmetricElement2D15N{
        0, Kratos::make_shared<Triangle2D15<NodeType>>(Element::GeometryType::PointsArrayType(15)),
        std::make_unique<AxisymmetricStressState>(),
        std::make_unique<IntegrationCoefficientModifierForAxisymmetricElement>()};
    ...
    const UPwNormalFaceLoadCondition<2, 2> mUPwNormalFaceLoadCondition2D2N{
        0, Kratos::make_shared<Line2D2<NodeType>>(Condition::GeometryType::PointsArrayType(2))};
    const UPwNormalFaceLoadCondition<2, 3> mUPwNormalFaceLoadCondition2D3N{
        0, Kratos::make_shared<Line2D3<NodeType>>(Condition::GeometryType::PointsArrayType(3))};
    const UPwNormalFaceLoadCondition<2, 4> mUPwNormalFaceLoadCondition2D4N{
        0, Kratos::make_shared<Line2D4<NodeType>>(Condition::GeometryType::PointsArrayType(4))};
    const UPwNormalFaceLoadCondition<2, 5> mUPwNormalFaceLoadCondition2D5N{
        0, Kratos::make_shared<Line2D5<NodeType>>(Condition::GeometryType::PointsArrayType(5))};
    ...
    const UPwNormalFluxCondition<2, 2> mUPwNormalFluxCondition2D2N{
        0, Kratos::make_shared<Line2D2<NodeType>>(Condition::GeometryType::PointsArrayType(2))};
    const UPwNormalFluxCondition<2, 3> mUPwNormalFluxCondition2D3N{
        0, Kratos::make_shared<Line2D3<NodeType>>(Condition::GeometryType::PointsArrayType(3))};
    const UPwNormalFluxCondition<2, 4> mUPwNormalFluxCondition2D4N{
        0, Kratos::make_shared<Line2D4<NodeType>>(Condition::GeometryType::PointsArrayType(4))};
    const UPwNormalFluxCondition<2, 5> mUPwNormalFluxCondition2D5N{
        0, Kratos::make_shared<Line2D5<NodeType>>(Condition::GeometryType::PointsArrayType(5))};
    ...
    const PwNormalFluxCondition<2, 2> mPwNormalFluxCondition2D2N{
        0, Kratos::make_shared<Line2D2<NodeType>>(Condition::GeometryType::PointsArrayType(2))};
    const PwNormalFluxCondition<2, 3> mPwNormalFluxCondition2D3N{
        0, Kratos::make_shared<Line2D3<NodeType>>(Condition::GeometryType::PointsArrayType(3))};
    const PwNormalFluxCondition<2, 4> mPwNormalFluxCondition2D4N{
        0, Kratos::make_shared<Line2D4<NodeType>>(Condition::GeometryType::PointsArrayType(4))};
    const PwNormalFluxCondition<2, 5> mPwNormalFluxCondition2D5N{
        0, Kratos::make_shared<Line2D5<NodeType>>(Condition::GeometryType::PointsArrayType(5))};
    ...
    const PwPointFluxCondition<2, 1> mPwPointFluxCondition2D1N{
        0, Kratos::make_shared<Point2D<NodeType>>(Condition::GeometryType::PointsArrayType(1))};
    ...
    const AxisymmetricUPwNormalFaceLoadCondition<2, 2> mAxisymmetricUPwNormalFaceLoadCondition2D2N{
        0, Kratos::make_shared<Line2D2<NodeType>>(Condition::GeometryType::PointsArrayType(2))};
    const AxisymmetricUPwNormalFaceLoadCondition<2, 3> mAxisymmetricUPwNormalFaceLoadCondition2D3N{
        0, Kratos::make_shared<Line2D3<NodeType>>(Condition::GeometryType::PointsArrayType(3))};
    const AxisymmetricUPwNormalFaceLoadCondition<2, 4> mAxisymmetricUPwNormalFaceLoadCondition2D4N{
        0, Kratos::make_shared<Line2D4<NodeType>>(Condition::GeometryType::PointsArrayType(4))};
    const AxisymmetricUPwNormalFaceLoadCondition<2, 5> mAxisymmetricUPwNormalFaceLoadCondition2D5N{
        0, Kratos::make_shared<Line2D5<NodeType>>(Condition::GeometryType::PointsArrayType(5))};

    const AxisymmetricLineNormalLoad2DDiffOrderCondition mAxisymmetricLineNormalLoadDiffOrderCondition2D3N{
        0, Kratos::make_shared<Line2D3<NodeType>>(Condition::GeometryType::PointsArrayType(3))};
    const AxisymmetricLineNormalLoad2DDiffOrderCondition mAxisymmetricLineNormalLoadDiffOrderCondition2D4N{
        0, Kratos::make_shared<Line2D4<NodeType>>(Condition::GeometryType::PointsArrayType(4))};
    const AxisymmetricLineNormalLoad2DDiffOrderCondition mAxisymmetricLineNormalLoadDiffOrderCondition2D5N{
        0, Kratos::make_shared<Line2D5<NodeType>>(Condition::GeometryType::PointsArrayType(5))};
    ...
    const GeoThermalPointFluxCondition<2, 1> mGeoThermalPointFluxCondition2D1N{
        0, Kratos::make_shared<Point2D<NodeType>>(Condition::GeometryType::PointsArrayType(1))};
    const GeoThermalPointFluxCondition<3, 1> mGeoThermalPointFluxCondition3D1N{
        0, Kratos::make_shared<Point3D<NodeType>>(Condition::GeometryType::PointsArrayType(1))};
