...
#include "custom_elements/drained_case.hpp"
#include "custom_elements/plane_strain_stress_state.h"
#include "custom_elements/steady_state_Pw_drainage_case.hpp"
#include "custom_elements/three_dimensional_stress_state.h"
#include "custom_elements/time_dependent_Pw_drainage_case.hpp"
#include "custom_elements/time_dependent_drainage_case.hpp"
#include "custom_elements/undrained_case.hpp"
...
public:
    ...
    std::string Info() const override { return "KratosGeoMechanicsApplication"; }
...
private:
    ...
    const TransientPwElement<2, 3> mTransientPwElement2D3N{
        ...
        std::make_unique<PlaneStrainStressState>(), std::make_unique<TimeDependentPwDrainageCase<2, 3>>()};
    const TransientPwElement<2, 4> mTransientPwElement2D4N{
        ...
        std::make_unique<PlaneStrainStressState>(), std::make_unique<TimeDependentPwDrainageCase<2, 4>>()};
    const TransientPwElement<2, 6> mTransientPwElement2D6N{
        ...
        std::make_unique<PlaneStrainStressState>(), std::make_unique<TimeDependentPwDrainageCase<2, 6>>()};
    const TransientPwElement<2, 8> mTransientPwElement2D8N{
        ...
        std::make_unique<PlaneStrainStressState>(), std::make_unique<TimeDependentPwDrainageCase<2, 8>>()};
    const TransientPwElement<2, 9> mTransientPwElement2D9N{
        ...
        std::make_unique<PlaneStrainStressState>(), std::make_unique<TimeDependentPwDrainageCase<2, 9>>()};
    const TransientPwElement<2, 10> mTransientPwElement2D10N{
        ...
        std::make_unique<PlaneStrainStressState>(), std::make_unique<TimeDependentPwDrainageCase<2, 10>>()};
    const TransientPwElement<2, 15> mTransientPwElement2D15N{
        ...
        std::make_unique<PlaneStrainStressState>(), std::make_unique<TimeDependentPwDrainageCase<2, 15>>()};
    const TransientPwElement<3, 4> mTransientPwElement3D4N{
        ...
        std::make_unique<TimeDependentPwDrainageCase<3, 4>>()};
    const TransientPwElement<3, 8> mTransientPwElement3D8N{
        ...
        std::make_unique<ThreeDimensionalStressState>(),
        std::make_unique<TimeDependentPwDrainageCase<3, 8>>()};
    const TransientPwElement<3, 10> mTransientPwElement3D10N{
        ...
        std::make_unique<ThreeDimensionalStressState>(),
        std::make_unique<TimeDependentPwDrainageCase<3, 10>>()};
    const TransientPwElement<3, 20> mTransientPwElement3D20N{
        ...
        std::make_unique<ThreeDimensionalStressState>(),
        std::make_unique<TimeDependentPwDrainageCase<3, 20>>()};
    const TransientPwElement<3, 27> mTransientPwElement3D27N{
        ...
        std::make_unique<ThreeDimensionalStressState>(),
        std::make_unique<TimeDependentPwDrainageCase<3, 27>>()};
    ...
    const SteadyStatePwElement<2, 3> mSteadyStatePwElement2D3N{
        0, Kratos::make_shared<Triangle2D3<NodeType>>(Element::GeometryType::PointsArrayType(3)),
        std::make_unique<PlaneStrainStressState>(), std::make_unique<SteadyStatePwDrainageCase<2, 3>>()};
    const SteadyStatePwElement<2, 4> mSteadyStatePwElement2D4N{
        0, Kratos::make_shared<Quadrilateral2D4<NodeType>>(Element::GeometryType::PointsArrayType(4)),
        std::make_unique<PlaneStrainStressState>(), std::make_unique<SteadyStatePwDrainageCase<2, 4>>()};
    const SteadyStatePwElement<2, 6> mSteadyStatePwElement2D6N{
        0, Kratos::make_shared<Triangle2D6<NodeType>>(Element::GeometryType::PointsArrayType(6)),
        std::make_unique<PlaneStrainStressState>(), std::make_unique<SteadyStatePwDrainageCase<2, 6>>()};
    const SteadyStatePwElement<2, 8> mSteadyStatePwElement2D8N{
        0, Kratos::make_shared<Quadrilateral2D8<NodeType>>(Element::GeometryType::PointsArrayType(8)),
        std::make_unique<PlaneStrainStressState>(), std::make_unique<SteadyStatePwDrainageCase<2, 8>>()};
    const SteadyStatePwElement<2, 9> mSteadyStatePwElement2D9N{
        0, Kratos::make_shared<Quadrilateral2D9<NodeType>>(Element::GeometryType::PointsArrayType(9)),
        std::make_unique<PlaneStrainStressState>(), std::make_unique<SteadyStatePwDrainageCase<2, 9>>()};
    const SteadyStatePwElement<2, 10> mSteadyStatePwElement2D10N{
        0, Kratos::make_shared<Triangle2D10<NodeType>>(Element::GeometryType::PointsArrayType(10)),
        std::make_unique<PlaneStrainStressState>(), std::make_unique<SteadyStatePwDrainageCase<2, 10>>()};
    const SteadyStatePwElement<2, 15> mSteadyStatePwElement2D15N{
        0, Kratos::make_shared<Triangle2D15<NodeType>>(Element::GeometryType::PointsArrayType(15)),
        std::make_unique<PlaneStrainStressState>(), std::make_unique<SteadyStatePwDrainageCase<2, 15>>()};
    const SteadyStatePwElement<3, 4> mSteadyStatePwElement3D4N{
        0, Kratos::make_shared<Tetrahedra3D4<NodeType>>(Element::GeometryType::PointsArrayType(4)),
        std::make_unique<ThreeDimensionalStressState>(),
        std::make_unique<SteadyStatePwDrainageCase<3, 4>>()};
    const SteadyStatePwElement<3, 8> mSteadyStatePwElement3D8N{
        0, Kratos::make_shared<Hexahedra3D8<NodeType>>(Element::GeometryType::PointsArrayType(8)),
        std::make_unique<ThreeDimensionalStressState>(),
        std::make_unique<SteadyStatePwDrainageCase<3, 8>>()};
    const SteadyStatePwElement<3, 10> mSteadyStatePwElement3D10N{
        0, Kratos::make_shared<Tetrahedra3D10<NodeType>>(Element::GeometryType::PointsArrayType(10)),
        std::make_unique<ThreeDimensionalStressState>(),
        std::make_unique<SteadyStatePwDrainageCase<3, 10>>()};
    const SteadyStatePwElement<3, 20> mSteadyStatePwElement3D20N{
        0, Kratos::make_shared<Hexahedra3D20<NodeType>>(Element::GeometryType::PointsArrayType(20)),
        std::make_unique<ThreeDimensionalStressState>(),
        std::make_unique<SteadyStatePwDrainageCase<3, 20>>()};
    const SteadyStatePwElement<3, 27> mSteadyStatePwElement3D27N{
        0, Kratos::make_shared<Hexahedra3D27<NodeType>>(Element::GeometryType::PointsArrayType(27)),
        std::make_unique<ThreeDimensionalStressState>(),
        std::make_unique<SteadyStatePwDrainageCase<3, 27>>()};
    ...
    const UPwSmallStrainElement<2, 3> mUPwSmallStrainElement2D3N{
        0, Kratos::make_shared<Triangle2D3<NodeType>>(Element::GeometryType::PointsArrayType(3)),
        std::make_unique<PlaneStrainStressState>(), std::make_unique<TimeDependentDrainageCase<2, 3>>()};
    const UPwSmallStrainElement<2, 4> mUPwSmallStrainElement2D4N{
        0, Kratos::make_shared<Quadrilateral2D4<NodeType>>(Element::GeometryType::PointsArrayType(4)),
        std::make_unique<PlaneStrainStressState>(), std::make_unique<TimeDependentDrainageCase<2, 4>>()};
    const UPwSmallStrainElement<2, 6> mUPwSmallStrainElement2D6N{
        0, Kratos::make_shared<Triangle2D6<NodeType>>(Element::GeometryType::PointsArrayType(6)),
        std::make_unique<PlaneStrainStressState>(), std::make_unique<TimeDependentDrainageCase<2, 6>>()};
    const UPwSmallStrainElement<2, 8> mUPwSmallStrainElement2D8N{
        0, Kratos::make_shared<Quadrilateral2D8<NodeType>>(Element::GeometryType::PointsArrayType(8)),
        std::make_unique<PlaneStrainStressState>(), std::make_unique<TimeDependentDrainageCase<2, 8>>()};
    const UPwSmallStrainElement<2, 9> mUPwSmallStrainElement2D9N{
        0, Kratos::make_shared<Quadrilateral2D9<NodeType>>(Element::GeometryType::PointsArrayType(9)),
        std::make_unique<PlaneStrainStressState>(), std::make_unique<TimeDependentDrainageCase<2, 9>>()};
    const UPwSmallStrainElement<2, 10> mUPwSmallStrainElement2D10N{
        0, Kratos::make_shared<Triangle2D10<NodeType>>(Element::GeometryType::PointsArrayType(10)),
        std::make_unique<PlaneStrainStressState>(), std::make_unique<TimeDependentDrainageCase<2, 10>>()};
    const UPwSmallStrainElement<2, 15> mUPwSmallStrainElement2D15N{
        0, Kratos::make_shared<Triangle2D15<NodeType>>(Element::GeometryType::PointsArrayType(15)),
        std::make_unique<PlaneStrainStressState>(), std::make_unique<TimeDependentDrainageCase<2, 15>>()};
    const UPwSmallStrainElement<3, 4> mUPwSmallStrainElement3D4N{
        0, Kratos::make_shared<Tetrahedra3D4<NodeType>>(Element::GeometryType::PointsArrayType(4)),
        std::make_unique<ThreeDimensionalStressState>(),
        std::make_unique<TimeDependentDrainageCase<3, 4>>()};
    const UPwSmallStrainElement<3, 8> mUPwSmallStrainElement3D8N{
        0, Kratos::make_shared<Hexahedra3D8<NodeType>>(Element::GeometryType::PointsArrayType(8)),
        std::make_unique<ThreeDimensionalStressState>(),
        std::make_unique<TimeDependentDrainageCase<3, 8>>()};
    const UPwSmallStrainElement<3, 10> mUPwSmallStrainElement3D10N{
        0, Kratos::make_shared<Tetrahedra3D10<NodeType>>(Element::GeometryType::PointsArrayType(10)),
        std::make_unique<ThreeDimensionalStressState>(),
        std::make_unique<TimeDependentDrainageCase<3, 10>>()};
    const UPwSmallStrainElement<3, 20> mUPwSmallStrainElement3D20N{
        0, Kratos::make_shared<Hexahedra3D20<NodeType>>(Element::GeometryType::PointsArrayType(20)),
        std::make_unique<ThreeDimensionalStressState>(),
        std::make_unique<TimeDependentDrainageCase<3, 20>>()};
    const UPwSmallStrainElement<3, 27> mUPwSmallStrainElement3D27N{
        0, Kratos::make_shared<Hexahedra3D27<NodeType>>(Element::GeometryType::PointsArrayType(27)),
        std::make_unique<ThreeDimensionalStressState>(),
        std::make_unique<TimeDependentDrainageCase<3, 27>>()};

    // small strain drained elements:
    const DrainedUPwSmallStrainElement<2, 3> mDrainedUPwSmallStrainElement2D3N{
        0, Kratos::make_shared<Triangle2D3<NodeType>>(Element::GeometryType::PointsArrayType(3)),
        std::make_unique<PlaneStrainStressState>(), std::make_unique<DrainedCase<2, 3>>()};
    const DrainedUPwSmallStrainElement<2, 4> mDrainedUPwSmallStrainElement2D4N{
        0, Kratos::make_shared<Quadrilateral2D4<NodeType>>(Element::GeometryType::PointsArrayType(4)),
        std::make_unique<PlaneStrainStressState>(), std::make_unique<DrainedCase<2, 4>>()};
    const DrainedUPwSmallStrainElement<3, 4> mDrainedUPwSmallStrainElement3D4N{
        0, Kratos::make_shared<Tetrahedra3D4<NodeType>>(Element::GeometryType::PointsArrayType(4)),
        std::make_unique<ThreeDimensionalStressState>(), std::make_unique<DrainedCase<3, 4>>()};
    const DrainedUPwSmallStrainElement<3, 8> mDrainedUPwSmallStrainElement3D8N{
        0, Kratos::make_shared<Hexahedra3D8<NodeType>>(Element::GeometryType::PointsArrayType(8)),
        std::make_unique<ThreeDimensionalStressState>(), std::make_unique<DrainedCase<3, 8>>()};

    // small strain undrained elements:
    const UndrainedUPwSmallStrainElement<2, 3> mUndrainedUPwSmallStrainElement2D3N{
        0, Kratos::make_shared<Triangle2D3<NodeType>>(Element::GeometryType::PointsArrayType(3)),
        std::make_unique<PlaneStrainStressState>(), std::make_unique<UndrainedCase<2, 3>>()};
    const UndrainedUPwSmallStrainElement<2, 4> mUndrainedUPwSmallStrainElement2D4N{
        0, Kratos::make_shared<Quadrilateral2D4<NodeType>>(Element::GeometryType::PointsArrayType(4)),
        std::make_unique<PlaneStrainStressState>(), std::make_unique<UndrainedCase<2, 4>>()};
    const UndrainedUPwSmallStrainElement<3, 4> mUndrainedUPwSmallStrainElement3D4N{
        0, Kratos::make_shared<Tetrahedra3D4<NodeType>>(Element::GeometryType::PointsArrayType(4)),
        std::make_unique<ThreeDimensionalStressState>(), std::make_unique<UndrainedCase<3, 4>>()};
    const UndrainedUPwSmallStrainElement<3, 8> mUndrainedUPwSmallStrainElement3D8N{
        0, Kratos::make_shared<Hexahedra3D8<NodeType>>(Element::GeometryType::PointsArrayType(8)),
        std::make_unique<ThreeDimensionalStressState>(), std::make_unique<UndrainedCase<3, 8>>()};
    ...
    const UPwSmallStrainElement<2, 3> mUPwSmallStrainAxisymmetricElement2D3N{
        0, Kratos::make_shared<Triangle2D3<NodeType>>(Element::GeometryType::PointsArrayType(3)),
        std::make_unique<AxisymmetricStressState>(), std::make_unique<TimeDependentDrainageCase<2, 3>>()};
    const UPwSmallStrainElement<2, 4> mUPwSmallStrainAxisymmetricElement2D4N{
        0, Kratos::make_shared<Quadrilateral2D4<NodeType>>(Element::GeometryType::PointsArrayType(4)),
        std::make_unique<AxisymmetricStressState>(), std::make_unique<TimeDependentDrainageCase<2, 4>>()};
    const UPwSmallStrainElement<2, 6> mUPwSmallStrainAxisymmetricElement2D6N{
        0, Kratos::make_shared<Triangle2D6<NodeType>>(Element::GeometryType::PointsArrayType(6)),
        std::make_unique<AxisymmetricStressState>(), std::make_unique<TimeDependentDrainageCase<2, 6>>()};
    const UPwSmallStrainElement<2, 8> mUPwSmallStrainAxisymmetricElement2D8N{
        0, Kratos::make_shared<Quadrilateral2D8<NodeType>>(Element::GeometryType::PointsArrayType(8)),
        std::make_unique<AxisymmetricStressState>(), std::make_unique<TimeDependentDrainageCase<2, 8>>()};
    const UPwSmallStrainElement<2, 9> mUPwSmallStrainAxisymmetricElement2D9N{
        0, Kratos::make_shared<Quadrilateral2D9<NodeType>>(Element::GeometryType::PointsArrayType(9)),
        std::make_unique<AxisymmetricStressState>(), std::make_unique<TimeDependentDrainageCase<2, 9>>()};
    const UPwSmallStrainElement<2, 10> mUPwSmallStrainAxisymmetricElement2D10N{
        0, Kratos::make_shared<Triangle2D10<NodeType>>(Element::GeometryType::PointsArrayType(10)),
        std::make_unique<AxisymmetricStressState>(), std::make_unique<TimeDependentDrainageCase<2, 10>>()};
    const UPwSmallStrainElement<2, 15> mUPwSmallStrainAxisymmetricElement2D15N{
        0, Kratos::make_shared<Triangle2D15<NodeType>>(Element::GeometryType::PointsArrayType(15)),
        std::make_unique<AxisymmetricStressState>(), std::make_unique<TimeDependentDrainageCase<2, 15>>()};
    ...
    const TransientThermalElement<2, 6> mTransientThermalElement2D6N{
        0, Kratos::make_shared<Triangle2D6<NodeType>>(Element::GeometryType::PointsArrayType(6))};
    const TransientThermalElement<2, 10> mTransientThermalElement2D10N{
        0, Kratos::make_shared<Triangle2D10<NodeType>>(Element::GeometryType::PointsArrayType(10))};
    const TransientThermalElement<2, 15> mTransientThermalElement2D15N{
        0, Kratos::make_shared<Triangle2D15<NodeType>>(Element::GeometryType::PointsArrayType(15))};
    ...
    const UPwFaceLoadCondition<2, 4> mUPwFaceLoadCondition2D4N{
        0, Kratos::make_shared<Line2D4<NodeType>>(Condition::GeometryType::PointsArrayType(4))};
    const UPwFaceLoadCondition<2, 5> mUPwFaceLoadCondition2D5N{
        0, Kratos::make_shared<Line2D5<NodeType>>(Condition::GeometryType::PointsArrayType(5))};
    ...
    const UPwFaceLoadInterfaceCondition<3, 4> mUPwFaceLoadInterfaceCondition3D4N{
        0, Kratos::make_shared<QuadrilateralInterface3D4<NodeType>>(Condition::GeometryType::PointsArrayType(4))};
    ...
    const GeoTNormalFluxCondition<2, 2> mGeoTNormalFluxCondition2D2N{
        0, Kratos::make_shared<Line2D2<NodeType>>(Condition::GeometryType::PointsArrayType(2))};
    const GeoTNormalFluxCondition<2, 3> mGeoTNormalFluxCondition2D3N{
        0, Kratos::make_shared<Line2D3<NodeType>>(Condition::GeometryType::PointsArrayType(3))};
    const GeoTNormalFluxCondition<2, 4> mGeoTNormalFluxCondition2D4N{
        0, Kratos::make_shared<Line2D4<NodeType>>(Condition::GeometryType::PointsArrayType(4))};
    const GeoTNormalFluxCondition<2, 5> mGeoTNormalFluxCondition2D5N{
        0, Kratos::make_shared<Line2D5<NodeType>>(Condition::GeometryType::PointsArrayType(5))};
    const GeoTNormalFluxCondition<3, 3> mGeoTNormalFluxCondition3D3N{
        0, Kratos::make_shared<Triangle3D3<NodeType>>(Condition::GeometryType::PointsArrayType(3))};
    const GeoTNormalFluxCondition<3, 6> mGeoTNormalFluxCondition3D6N{
        0, Kratos::make_shared<Triangle3D6<NodeType>>(Condition::GeometryType::PointsArrayType(6))};
    const GeoTNormalFluxCondition<3, 4> mGeoTNormalFluxCondition3D4N{
        0, Kratos::make_shared<Quadrilateral3D4<NodeType>>(Condition::GeometryType::PointsArrayType(4))};
    const GeoTNormalFluxCondition<3, 8> mGeoTNormalFluxCondition3D8N{
        0, Kratos::make_shared<Quadrilateral3D8<NodeType>>(Condition::GeometryType::PointsArrayType(8))};
    const GeoTNormalFluxCondition<3, 9> mGeoTNormalFluxCondition3D9N{
        0, Kratos::make_shared<Quadrilateral3D9<NodeType>>(Condition::GeometryType::PointsArrayType(9))};

    const GeoTMicroClimateFluxCondition<2, 2> mGeoTMicroClimateFluxCondition2D2N{
        0, Kratos::make_shared<Line2D2<NodeType>>(Condition::GeometryType::PointsArrayType(2))};
    const GeoTMicroClimateFluxCondition<2, 3> mGeoTMicroClimateFluxCondition2D3N{
        0, Kratos::make_shared<Line2D3<NodeType>>(Condition::GeometryType::PointsArrayType(3))};
    const GeoTMicroClimateFluxCondition<2, 4> mGeoTMicroClimateFluxCondition2D4N{
        0, Kratos::make_shared<Line2D4<NodeType>>(Condition::GeometryType::PointsArrayType(4))};
    const GeoTMicroClimateFluxCondition<2, 5> mGeoTMicroClimateFluxCondition2D5N{
        0, Kratos::make_shared<Line2D5<NodeType>>(Condition::GeometryType::PointsArrayType(5))};
    const GeoTMicroClimateFluxCondition<3, 3> mGeoTMicroClimateFluxCondition3D3N{
        0, Kratos::make_shared<Triangle3D3<NodeType>>(Condition::GeometryType::PointsArrayType(3))};
    const GeoTMicroClimateFluxCondition<3, 6> mGeoTMicroClimateFluxCondition3D6N{
        0, Kratos::make_shared<Triangle3D6<NodeType>>(Condition::GeometryType::PointsArrayType(6))};
    const GeoTMicroClimateFluxCondition<3, 4> mGeoTMicroClimateFluxCondition3D4N{
        0, Kratos::make_shared<Quadrilateral3D4<NodeType>>(Condition::GeometryType::PointsArrayType(4))};
    const GeoTMicroClimateFluxCondition<3, 8> mGeoTMicroClimateFluxCondition3D8N{
        0, Kratos::make_shared<Quadrilateral3D8<NodeType>>(Condition::GeometryType::PointsArrayType(8))};
    const GeoTMicroClimateFluxCondition<3, 9> mGeoTMicroClimateFluxCondition3D9N{
        0, Kratos::make_shared<Quadrilateral3D9<NodeType>>(Condition::GeometryType::PointsArrayType(9))};
