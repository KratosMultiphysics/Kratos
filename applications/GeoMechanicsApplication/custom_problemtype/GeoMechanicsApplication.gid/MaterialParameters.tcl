proc WriteMaterialParameters {basename dir problemtypedir TableDict} {
    ...
    for {set i 0} {$i < [llength $Groups]} {incr i} {
        ...
        puts $FileVar "             \"BROOKS_COREY_PORE_SIZE_INDEX_WET\"  :  [lindex [lindex $Groups $i] 150],"
        puts $FileVar "             \"BROOKS_COREY_FITTING_PARAMETER_WET\":  [lindex [lindex $Groups $i] 151],"
        puts $FileVar "             \"RELPERM_POWER\"                     :  [lindex [lindex $Groups $i] 152]"
   ...
   if {[lindex [lindex $Groups $i] 31] eq true} {
        ...
        puts $FileVar "             \"BROOKS_COREY_PORE_SIZE_INDEX_WET\"  :  [lindex [lindex $Groups $i] 28],"
        puts $FileVar "             \"BROOKS_COREY_FITTING_PARAMETER_WET\":  [lindex [lindex $Groups $i] 29],"
        puts $FileVar "             \"RELPERM_POWER\"                     :  [lindex [lindex $Groups $i] 30]"
    ...
    for {set i 0} {$i < [llength $Groups]} {incr i} {
        if {$SolutionType eq "K0-Procedure"} {
            ...
            puts $FileVar "             \"BROOKS_COREY_PORE_SIZE_INDEX_WET\"  :  [lindex [lindex $Groups $i] 138],"
            puts $FileVar "             \"BROOKS_COREY_FITTING_PARAMETER_WET\":  [lindex [lindex $Groups $i] 139],"
            puts $FileVar "             \"RELPERM_POWER\"                     :  [lindex [lindex $Groups $i] 140]"
    ...
    for {set i 0} {$i < [llength $Groups]} {incr i} {
        ...
        puts $FileVar "             \"BROOKS_COREY_PORE_SIZE_INDEX_WET\"  :  [lindex [lindex $Groups $i] 26],"
        puts $FileVar "             \"BROOKS_COREY_FITTING_PARAMETER_WET\":  [lindex [lindex $Groups $i] 27],"
        puts $FileVar "             \"RELPERM_POWER\"                     :  [lindex [lindex $Groups $i] 28]"
