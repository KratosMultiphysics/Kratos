...
GeoApplyConstantScalarValueProcess::GeoApplyConstantScalarValueProcess(
    Model& rModel,
    Parameters ThisParameters
    ) : GeoApplyConstantScalarValueProcess(rModel.GetModelPart(ThisParameters["model_part_name"].GetString()), ThisParameters)
{
...
void GeoApplyConstantScalarValueProcess::InternalApplyValue(
...
template void GeoApplyConstantScalarValueProcess::InternalApplyValue<Variable<int>>(
    const Variable<int>& rVariable,
    const bool ToBeFixed,
    const int Value
    );
...
template<class TVarType>
void GeoApplyConstantScalarValueProcess::InternalApplyValueWithoutFixing(
    const TVarType& rVariable,
    const typename TVarType::Type Value
    )
{
