...
ApplyNormalLoadTableProcess::ApplyNormalLoadTableProcess(ModelPart& rModelPart, const Parameters& rProcessSettings)
...
{
    auto normal_parameters =
        ParametersUtilities::CopyRequiredParameters(rProcessSettings, NamesOfSettingsToCopy);
                                                                             ...
                                                                             std::vector<std::string> NamesOfSettingsToCopy)
{
    ...
    if (ParametersUtilities::HasTableAttached(rProcessSettings, normalComponentNumber)) {
        auto normal_parameters =
            ParametersUtilities::CopyRequiredParameters(rProcessSettings, NamesOfSettingsToCopy);
        normal_parameters.AddValue("table", rProcessSettings["table"][normalComponentNumber]);
        mProcesses.push_back(std::make_unique<ApplyBoundaryHydrostaticPressureTableProcess>(
            mrModelPart, normal_parameters));
    } else {
        mProcesses.push_back(std::make_unique<ApplyConstantBoundaryHydrostaticPressureProcess>(
                                                                              ...
                                                                              std::vector<std::string> NamesOfSettingsToCopy)
{
    ...
    if (ParametersUtilities::HasTableAttached(rProcessSettings)) {
        ...
        mProcesses.push_back(std::make_unique<ApplyBoundaryPhreaticLinePressureTableProcess>(
            mrModelPart, ParametersUtilities::CopyRequiredParameters(rProcessSettings, NamesOfSettingsToCopy)));
    } else {
        mProcesses.push_back(std::make_unique<ApplyConstantBoundaryPhreaticLinePressureProcess>(
            mrModelPart, ParametersUtilities::CopyRequiredParameters(rProcessSettings, NamesOfSettingsToCopy)));
    }
}
                                                                                 ...
                                                                                 std::vector<std::string> NamesOfSettingsToCopy)
{
    ...
    if (ParametersUtilities::HasTableAttached(rProcessSettings)) {
        NamesOfSettingsToCopy.emplace_back("table");
        mProcesses.push_back(std::make_unique<ApplyBoundaryPhreaticSurfacePressureTableProcess>(
            mrModelPart, ParametersUtilities::CopyRequiredParameters(rProcessSettings, NamesOfSettingsToCopy)));
    } else {
        mProcesses.push_back(std::make_unique<ApplyConstantBoundaryPhreaticSurfacePressureProcess>(
            mrModelPart, ParametersUtilities::CopyRequiredParameters(rProcessSettings, NamesOfSettingsToCopy)));
    }
}
