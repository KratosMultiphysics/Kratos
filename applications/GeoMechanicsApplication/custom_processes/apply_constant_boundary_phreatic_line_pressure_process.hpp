...
public:
        ...
        : Process(Flags()), mrModelPart(model_part)
    {
        ...
        KRATOS_ERROR_IF(mGravityDirection == mOutOfPlaneDirection)
            << "Gravity direction cannot be the same as Out-of-Plane directions " << rParameters
            << std::endl;
    ...
    std::string Info() const override { return "ApplyConstantBoundaryPhreaticLinePressureProcess"; }
