...
void KratosGeoMechanicsApplication::Register() {
    ...
    KRATOS_REGISTER_VARIABLE( THERMAL_CONDUCTIVITY_SOLID_ZZ )
    KRATOS_REGISTER_VARIABLE( THERMAL_CONDUCTIVITY_SOLID_XY )
    KRATOS_REGISTER_VARIABLE( THERMAL_CONDUCTIVITY_SOLID_YZ )
    KRATOS_REGISTER_VARIABLE( THERMAL_CONDUCTIVITY_SOLID_ZX )
