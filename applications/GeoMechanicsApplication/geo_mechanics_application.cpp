...
void KratosGeoMechanicsApplication::Register() {
    ...
    KRATOS_REGISTER_VARIABLE( AIR_ENTRY_PRESSURE )
    ...
    KRATOS_REGISTER_VARIABLE( BROOKS_COREY_PORE_SIZE_INDEX )
    KRATOS_REGISTER_VARIABLE( BROOKS_COREY_FITTING_PARAMETER )
    KRATOS_REGISTER_VARIABLE( AIR_EXPULSION_PRESSURE )
    KRATOS_REGISTER_VARIABLE( BROOKS_COREY_PORE_SIZE_INDEX_WET )
    KRATOS_REGISTER_VARIABLE( BROOKS_COREY_FITTING_PARAMETER_WET )
    KRATOS_REGISTER_VARIABLE( RELPERM_POWER )
    ...
    KRATOS_REGISTER_VARIABLE( INCREMENT_OF_SUCTION )
