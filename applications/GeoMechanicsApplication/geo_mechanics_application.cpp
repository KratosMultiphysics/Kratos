...
KratosGeoMechanicsApplication::KratosGeoMechanicsApplication():
    ...
    mTransientPwElement2D3N (0, Kratos::make_shared< Triangle2D3      <NodeType>>(Element::GeometryType::PointsArrayType(3))),
    mTransientPwElement2D4N (0, Kratos::make_shared< Quadrilateral2D4 <NodeType>>(Element::GeometryType::PointsArrayType(4))),
    mTransientPwElement3D4N (0, Kratos::make_shared< Tetrahedra3D4    <NodeType>>(Element::GeometryType::PointsArrayType(4))),
    mTransientPwElement3D8N (0, Kratos::make_shared< Hexahedra3D8     <NodeType>>(Element::GeometryType::PointsArrayType(8))),
    mTransientPwElement2D6N (0, Kratos::make_shared< Triangle2D6      <NodeType>>(Element::GeometryType::PointsArrayType(6 ))),
    mTransientPwElement2D8N (0, Kratos::make_shared< Quadrilateral2D8 <NodeType>>(Element::GeometryType::PointsArrayType(8 ))),
    mTransientPwElement2D9N (0, Kratos::make_shared< Quadrilateral2D9 <NodeType>>(Element::GeometryType::PointsArrayType(9 ))),
    mTransientPwElement2D10N(0, Kratos::make_shared< Triangle2D10     <NodeType>>(Element::GeometryType::PointsArrayType(10))),
    mTransientPwElement2D15N(0, Kratos::make_shared< Triangle2D15     <NodeType>>(Element::GeometryType::PointsArrayType(15))),
    mTransientPwElement3D10N(0, Kratos::make_shared< Tetrahedra3D10   <NodeType>>(Element::GeometryType::PointsArrayType(10))),
    mTransientPwElement3D20N(0, Kratos::make_shared< Hexahedra3D20    <NodeType>>(Element::GeometryType::PointsArrayType(20))),
    mTransientPwElement3D27N(0, Kratos::make_shared< Hexahedra3D27    <NodeType>>(Element::GeometryType::PointsArrayType(27))),

    mTransientPwInterfaceElement2D4N(0, Kratos::make_shared< QuadrilateralInterface2D4 <NodeType>>(Element::GeometryType::PointsArrayType(4))),
    mTransientPwInterfaceElement3D6N(0, Kratos::make_shared< PrismInterface3D6         <NodeType>>(Element::GeometryType::PointsArrayType(6))),
    mTransientPwInterfaceElement3D8N(0, Kratos::make_shared< HexahedraInterface3D8     <NodeType>>(Element::GeometryType::PointsArrayType(8))),

    // Steady-State one-phase flow elements:
    mSteadyStatePwElement2D3N (0, Kratos::make_shared< Triangle2D3      <NodeType>>(Element::GeometryType::PointsArrayType(3))),
    mSteadyStatePwElement2D4N (0, Kratos::make_shared< Quadrilateral2D4 <NodeType>>(Element::GeometryType::PointsArrayType(4))),
    mSteadyStatePwElement3D4N (0, Kratos::make_shared< Tetrahedra3D4    <NodeType>>(Element::GeometryType::PointsArrayType(4))),
    mSteadyStatePwElement3D8N (0, Kratos::make_shared< Hexahedra3D8     <NodeType>>(Element::GeometryType::PointsArrayType(8))),
    mSteadyStatePwElement2D6N (0, Kratos::make_shared< Triangle2D6      <NodeType>>(Element::GeometryType::PointsArrayType(6))),
    mSteadyStatePwElement2D8N (0, Kratos::make_shared< Quadrilateral2D8 <NodeType>>(Element::GeometryType::PointsArrayType(8))),
    mSteadyStatePwElement2D9N (0, Kratos::make_shared< Quadrilateral2D9 <NodeType>>(Element::GeometryType::PointsArrayType(9))),
    mSteadyStatePwElement2D10N(0, Kratos::make_shared< Triangle2D10     <NodeType>>(Element::GeometryType::PointsArrayType(10))),
    mSteadyStatePwElement2D15N(0, Kratos::make_shared< Triangle2D15     <NodeType>>(Element::GeometryType::PointsArrayType(15))),
    mSteadyStatePwElement3D10N(0, Kratos::make_shared< Tetrahedra3D10   <NodeType>>(Element::GeometryType::PointsArrayType(10))),
    mSteadyStatePwElement3D20N(0, Kratos::make_shared< Hexahedra3D20    <NodeType>>(Element::GeometryType::PointsArrayType(20))),
    mSteadyStatePwElement3D27N(0, Kratos::make_shared< Hexahedra3D27    <NodeType>>(Element::GeometryType::PointsArrayType(27))),

    mSteadyStatePwInterfaceElement2D4N(0, Kratos::make_shared< QuadrilateralInterface2D4 <NodeType>>(Element::GeometryType::PointsArrayType(4))),
    mSteadyStatePwInterfaceElement3D6N(0, Kratos::make_shared< PrismInterface3D6         <NodeType>>(Element::GeometryType::PointsArrayType(6))),
    mSteadyStatePwInterfaceElement3D8N(0, Kratos::make_shared< HexahedraInterface3D8     <NodeType>>(Element::GeometryType::PointsArrayType(8))),

    mSteadyStatePwPipingElement2D4N(0, Kratos::make_shared< QuadrilateralInterface2D4 <NodeType>>(Element::GeometryType::PointsArrayType(4))),
    mSteadyStatePwPipingElement3D6N(0, Kratos::make_shared< PrismInterface3D6         <NodeType>>(Element::GeometryType::PointsArrayType(6))),
    mSteadyStatePwPipingElement3D8N(0, Kratos::make_shared< HexahedraInterface3D8     <NodeType>>(Element::GeometryType::PointsArrayType(8))),

    // small strain elements
    mUPwSmallStrainElement2D3N (0, Kratos::make_shared< Triangle2D3      <NodeType>>(Element::GeometryType::PointsArrayType(3))),
    mUPwSmallStrainElement2D4N (0, Kratos::make_shared< Quadrilateral2D4 <NodeType>>(Element::GeometryType::PointsArrayType(4))),
    mUPwSmallStrainElement3D4N (0, Kratos::make_shared< Tetrahedra3D4    <NodeType>>(Element::GeometryType::PointsArrayType(4))),
    mUPwSmallStrainElement3D8N (0, Kratos::make_shared< Hexahedra3D8     <NodeType>>(Element::GeometryType::PointsArrayType(8))),
    mUPwSmallStrainElement2D6N (0, Kratos::make_shared< Triangle2D6      <NodeType>>(Element::GeometryType::PointsArrayType(6))),
    mUPwSmallStrainElement2D8N (0, Kratos::make_shared< Quadrilateral2D8 <NodeType>>(Element::GeometryType::PointsArrayType(8))),
    mUPwSmallStrainElement2D9N (0, Kratos::make_shared< Quadrilateral2D9 <NodeType>>(Element::GeometryType::PointsArrayType(9))),
    mUPwSmallStrainElement2D10N(0, Kratos::make_shared< Triangle2D10     <NodeType>>(Element::GeometryType::PointsArrayType(10))),
    mUPwSmallStrainElement2D15N(0, Kratos::make_shared< Triangle2D15     <NodeType>>(Element::GeometryType::PointsArrayType(15))),
    mUPwSmallStrainElement3D10N(0, Kratos::make_shared< Tetrahedra3D10   <NodeType>>(Element::GeometryType::PointsArrayType(10))),
    mUPwSmallStrainElement3D20N(0, Kratos::make_shared< Hexahedra3D20    <NodeType>>(Element::GeometryType::PointsArrayType(20))),
    mUPwSmallStrainElement3D27N(0, Kratos::make_shared< Hexahedra3D27    <NodeType>>(Element::GeometryType::PointsArrayType(27))),

    // drained small strain elements
    mDrainedUPwSmallStrainElement2D3N(0, Kratos::make_shared< Triangle2D3      <NodeType>>(Element::GeometryType::PointsArrayType(3))),
    mDrainedUPwSmallStrainElement2D4N(0, Kratos::make_shared< Quadrilateral2D4 <NodeType>>(Element::GeometryType::PointsArrayType(4))),
    mDrainedUPwSmallStrainElement3D4N(0, Kratos::make_shared< Tetrahedra3D4    <NodeType>>(Element::GeometryType::PointsArrayType(4))),
    mDrainedUPwSmallStrainElement3D8N(0, Kratos::make_shared< Hexahedra3D8     <NodeType>>(Element::GeometryType::PointsArrayType(8))),

    // undrained small strain elements
    mUndrainedUPwSmallStrainElement2D3N(0, Kratos::make_shared< Triangle2D3      <NodeType>>(Element::GeometryType::PointsArrayType(3))),
    mUndrainedUPwSmallStrainElement2D4N(0, Kratos::make_shared< Quadrilateral2D4 <NodeType>>(Element::GeometryType::PointsArrayType(4))),
    mUndrainedUPwSmallStrainElement3D4N(0, Kratos::make_shared< Tetrahedra3D4    <NodeType>>(Element::GeometryType::PointsArrayType(4))),
    mUndrainedUPwSmallStrainElement3D8N(0, Kratos::make_shared< Hexahedra3D8     <NodeType>>(Element::GeometryType::PointsArrayType(8))),

    // small strain FIC elements
    mUPwSmallStrainFICElement2D3N(0, Kratos::make_shared< Triangle2D3      <NodeType>>(Element::GeometryType::PointsArrayType(3))),
    mUPwSmallStrainFICElement2D4N(0, Kratos::make_shared< Quadrilateral2D4 <NodeType>>(Element::GeometryType::PointsArrayType(4))),
    mUPwSmallStrainFICElement3D4N(0, Kratos::make_shared< Tetrahedra3D4    <NodeType>>(Element::GeometryType::PointsArrayType(4))),
    mUPwSmallStrainFICElement3D8N(0, Kratos::make_shared< Hexahedra3D8     <NodeType>>(Element::GeometryType::PointsArrayType(8))),

    // small strain different order elements
    mSmallStrainUPwDiffOrderElement2D6N (0, Kratos::make_shared< Triangle2D6      <NodeType>>(Element::GeometryType::PointsArrayType(6))),
    mSmallStrainUPwDiffOrderElement2D8N (0, Kratos::make_shared< Quadrilateral2D8 <NodeType>>(Element::GeometryType::PointsArrayType(8))),
    mSmallStrainUPwDiffOrderElement2D9N (0, Kratos::make_shared< Quadrilateral2D9 <NodeType>>(Element::GeometryType::PointsArrayType(9))),
    mSmallStrainUPwDiffOrderElement2D10N(0, Kratos::make_shared< Triangle2D10     <NodeType>>(Element::GeometryType::PointsArrayType(10))),
    mSmallStrainUPwDiffOrderElement2D15N(0, Kratos::make_shared< Triangle2D15     <NodeType>>(Element::GeometryType::PointsArrayType(15))),
    mSmallStrainUPwDiffOrderElement3D10N(0, Kratos::make_shared< Tetrahedra3D10   <NodeType>>(Element::GeometryType::PointsArrayType(10))),
    mSmallStrainUPwDiffOrderElement3D20N(0, Kratos::make_shared< Hexahedra3D20    <NodeType>>(Element::GeometryType::PointsArrayType(20))),
    mSmallStrainUPwDiffOrderElement3D27N(0, Kratos::make_shared< Hexahedra3D27    <NodeType>>(Element::GeometryType::PointsArrayType(27))),

    // small strain axisymmtric elements:
    mUPwSmallStrainAxisymmetricElement2D3N (0, Kratos::make_shared< Triangle2D3      <NodeType>>(Element::GeometryType::PointsArrayType(3))),
    mUPwSmallStrainAxisymmetricElement2D4N (0, Kratos::make_shared< Quadrilateral2D4 <NodeType>>(Element::GeometryType::PointsArrayType(4))),
    mUPwSmallStrainAxisymmetricElement2D6N (0, Kratos::make_shared< Triangle2D6      <NodeType>>(Element::GeometryType::PointsArrayType(6))),
    mUPwSmallStrainAxisymmetricElement2D8N (0, Kratos::make_shared< Quadrilateral2D8 <NodeType>>(Element::GeometryType::PointsArrayType(8))),
    mUPwSmallStrainAxisymmetricElement2D9N (0, Kratos::make_shared< Quadrilateral2D9 <NodeType>>(Element::GeometryType::PointsArrayType(9))),
    mUPwSmallStrainAxisymmetricElement2D10N(0, Kratos::make_shared< Triangle2D10     <NodeType>>(Element::GeometryType::PointsArrayType(10))),
    mUPwSmallStrainAxisymmetricElement2D15N(0, Kratos::make_shared< Triangle2D15     <NodeType>>(Element::GeometryType::PointsArrayType(15))),

    mUPwSmallStrainAxisymmetricFICElement2D3N(0, Kratos::make_shared< Triangle2D3      <NodeType>>(Element::GeometryType::PointsArrayType(3))),
    mUPwSmallStrainAxisymmetricFICElement2D4N(0, Kratos::make_shared< Quadrilateral2D4 <NodeType>>(Element::GeometryType::PointsArrayType(4))),

    mSmallStrainUPwDiffOrderAxisymmetricElement2D6N (0, Kratos::make_shared< Triangle2D6      <NodeType>>(Element::GeometryType::PointsArrayType(6))),
    mSmallStrainUPwDiffOrderAxisymmetricElement2D8N (0, Kratos::make_shared< Quadrilateral2D8 <NodeType>>(Element::GeometryType::PointsArrayType(8))),
    mSmallStrainUPwDiffOrderAxisymmetricElement2D9N (0, Kratos::make_shared< Quadrilateral2D9 <NodeType>>(Element::GeometryType::PointsArrayType(9))),
    mSmallStrainUPwDiffOrderAxisymmetricElement2D10N(0, Kratos::make_shared< Triangle2D10     <NodeType>>(Element::GeometryType::PointsArrayType(10))),
    mSmallStrainUPwDiffOrderAxisymmetricElement2D15N(0, Kratos::make_shared< Triangle2D15     <NodeType>>(Element::GeometryType::PointsArrayType(15))),

    // small strain interface elements
    mUPwSmallStrainInterfaceElement2D4N(0, Kratos::make_shared< QuadrilateralInterface2D4 <NodeType>>(Element::GeometryType::PointsArrayType(4))),
    mUPwSmallStrainInterfaceElement3D6N(0, Kratos::make_shared< PrismInterface3D6         <NodeType>>(Element::GeometryType::PointsArrayType(6))),
    mUPwSmallStrainInterfaceElement3D8N(0, Kratos::make_shared< HexahedraInterface3D8     <NodeType>>(Element::GeometryType::PointsArrayType(8))),

    mUPwSmallStrainLinkInterfaceElement2D4N(0, Kratos::make_shared< QuadrilateralInterface2D4 <NodeType>>(Element::GeometryType::PointsArrayType(4))),
    mUPwSmallStrainLinkInterfaceElement3D6N(0, Kratos::make_shared< PrismInterface3D6         <NodeType>>(Element::GeometryType::PointsArrayType(6))),
    mUPwSmallStrainLinkInterfaceElement3D8N(0, Kratos::make_shared< HexahedraInterface3D8     <NodeType>>(Element::GeometryType::PointsArrayType(8))),

    // Updated-Lagrangian elements
    mUPwUpdatedLagrangianElement2D3N (0, Kratos::make_shared< Triangle2D3      <NodeType>>(Element::GeometryType::PointsArrayType(3))),
    mUPwUpdatedLagrangianElement2D4N (0, Kratos::make_shared< Quadrilateral2D4 <NodeType>>(Element::GeometryType::PointsArrayType(4))),
    mUPwUpdatedLagrangianElement3D4N (0, Kratos::make_shared< Tetrahedra3D4    <NodeType>>(Element::GeometryType::PointsArrayType(4))),
    mUPwUpdatedLagrangianElement3D8N (0, Kratos::make_shared< Hexahedra3D8     <NodeType>>(Element::GeometryType::PointsArrayType(8))),
    mUPwUpdatedLagrangianElement2D6N (0, Kratos::make_shared< Triangle2D6      <NodeType>>(Element::GeometryType::PointsArrayType(6))),
    mUPwUpdatedLagrangianElement2D8N (0, Kratos::make_shared< Quadrilateral2D8 <NodeType>>(Element::GeometryType::PointsArrayType(8))),
    mUPwUpdatedLagrangianElement2D9N (0, Kratos::make_shared< Quadrilateral2D9 <NodeType>>(Element::GeometryType::PointsArrayType(9))),
    mUPwUpdatedLagrangianElement2D10N(0, Kratos::make_shared< Triangle2D10     <NodeType>>(Element::GeometryType::PointsArrayType(10))),
    mUPwUpdatedLagrangianElement2D15N(0, Kratos::make_shared< Triangle2D15     <NodeType>>(Element::GeometryType::PointsArrayType(15))),
    mUPwUpdatedLagrangianElement3D10N(0, Kratos::make_shared< Tetrahedra3D10   <NodeType>>(Element::GeometryType::PointsArrayType(10))),
    mUPwUpdatedLagrangianElement3D20N(0, Kratos::make_shared< Hexahedra3D20    <NodeType>>(Element::GeometryType::PointsArrayType(20))),
    mUPwUpdatedLagrangianElement3D27N(0, Kratos::make_shared< Hexahedra3D27    <NodeType>>(Element::GeometryType::PointsArrayType(27))),

    mUPwUpdatedLagrangianFICElement2D3N(0, Kratos::make_shared< Triangle2D3      <NodeType>>(Element::GeometryType::PointsArrayType(3))),
    mUPwUpdatedLagrangianFICElement2D4N(0, Kratos::make_shared< Quadrilateral2D4 <NodeType>>(Element::GeometryType::PointsArrayType(4))),
    mUPwUpdatedLagrangianFICElement3D4N(0, Kratos::make_shared< Tetrahedra3D4    <NodeType>>(Element::GeometryType::PointsArrayType(4))),
    mUPwUpdatedLagrangianFICElement3D8N(0, Kratos::make_shared< Hexahedra3D8     <NodeType>>(Element::GeometryType::PointsArrayType(8))),

    mUpdatedLagrangianUPwDiffOrderElement2D6N (0, Kratos::make_shared< Triangle2D6      <NodeType>>(Element::GeometryType::PointsArrayType(6))),
    mUpdatedLagrangianUPwDiffOrderElement2D8N (0, Kratos::make_shared< Quadrilateral2D8 <NodeType>>(Element::GeometryType::PointsArrayType(8))),
    mUpdatedLagrangianUPwDiffOrderElement2D9N (0, Kratos::make_shared< Quadrilateral2D9 <NodeType>>(Element::GeometryType::PointsArrayType(9))),
    mUpdatedLagrangianUPwDiffOrderElement2D10N(0, Kratos::make_shared< Triangle2D10     <NodeType>>(Element::GeometryType::PointsArrayType(10))),
    mUpdatedLagrangianUPwDiffOrderElement2D15N(0, Kratos::make_shared< Triangle2D15     <NodeType>>(Element::GeometryType::PointsArrayType(15))),
    mUpdatedLagrangianUPwDiffOrderElement3D10N(0, Kratos::make_shared< Tetrahedra3D10   <NodeType>>(Element::GeometryType::PointsArrayType(10))),
    mUpdatedLagrangianUPwDiffOrderElement3D20N(0, Kratos::make_shared< Hexahedra3D20    <NodeType>>(Element::GeometryType::PointsArrayType(20))),
    mUpdatedLagrangianUPwDiffOrderElement3D27N(0, Kratos::make_shared< Hexahedra3D27    <NodeType>>(Element::GeometryType::PointsArrayType(27))),

    // Updated-Lagrangian axisymmetric elements:
    mUPwUpdatedLagrangianAxisymmetricElement2D3N (0, Kratos::make_shared< Triangle2D3      <NodeType>>(Element::GeometryType::PointsArrayType(3))),
    mUPwUpdatedLagrangianAxisymmetricElement2D4N (0, Kratos::make_shared< Quadrilateral2D4 <NodeType>>(Element::GeometryType::PointsArrayType(4))),
    mUPwUpdatedLagrangianAxisymmetricElement2D6N (0, Kratos::make_shared< Triangle2D6      <NodeType>>(Element::GeometryType::PointsArrayType(6))),
    mUPwUpdatedLagrangianAxisymmetricElement2D8N (0, Kratos::make_shared< Quadrilateral2D8 <NodeType>>(Element::GeometryType::PointsArrayType(8))),
    mUPwUpdatedLagrangianAxisymmetricElement2D9N (0, Kratos::make_shared< Quadrilateral2D9 <NodeType>>(Element::GeometryType::PointsArrayType(9))),
    mUPwUpdatedLagrangianAxisymmetricElement2D10N(0, Kratos::make_shared< Triangle2D10     <NodeType>>(Element::GeometryType::PointsArrayType(10))),
    mUPwUpdatedLagrangianAxisymmetricElement2D15N(0, Kratos::make_shared< Triangle2D15     <NodeType>>(Element::GeometryType::PointsArrayType(15))),

    mUpdatedLagrangianUPwDiffOrderAxisymmetricElement2D6N (0, Kratos::make_shared< Triangle2D6      <NodeType>>(Element::GeometryType::PointsArrayType(6))),
    mUpdatedLagrangianUPwDiffOrderAxisymmetricElement2D8N (0, Kratos::make_shared< Quadrilateral2D8 <NodeType>>(Element::GeometryType::PointsArrayType(8))),
    mUpdatedLagrangianUPwDiffOrderAxisymmetricElement2D9N (0, Kratos::make_shared< Quadrilateral2D9 <NodeType>>(Element::GeometryType::PointsArrayType(9))),
    mUpdatedLagrangianUPwDiffOrderAxisymmetricElement2D10N(0, Kratos::make_shared< Triangle2D10     <NodeType>>(Element::GeometryType::PointsArrayType(10))),
    mUpdatedLagrangianUPwDiffOrderAxisymmetricElement2D15N(0, Kratos::make_shared< Triangle2D15     <NodeType>>(Element::GeometryType::PointsArrayType(15))),

    mUPwUpdatedLagrangianAxisymmetricFICElement2D3N(0, Kratos::make_shared< Triangle2D3      <NodeType>>(Element::GeometryType::PointsArrayType(3))),
    mUPwUpdatedLagrangianAxisymmetricFICElement2D4N(0, Kratos::make_shared< Quadrilateral2D4 <NodeType>>(Element::GeometryType::PointsArrayType(4))),

    // geo structural elements
    mGeoCrBeamElement2D2N      (0, Kratos::make_shared< Line2D2 <NodeType>>(Element::GeometryType::PointsArrayType(2))),
    mGeoCrBeamElement3D2N      (0, Kratos::make_shared< Line3D2 <NodeType>>(Element::GeometryType::PointsArrayType(2))),
    mGeoCrBeamElementLinear2D2N(0, Kratos::make_shared< Line2D2 <NodeType>>(Element::GeometryType::PointsArrayType(2))),
    mGeoCrBeamElementLinear3D2N(0, Kratos::make_shared< Line3D2 <NodeType>>(Element::GeometryType::PointsArrayType(2))),
    mGeoTrussElement2D2N       (0, Kratos::make_shared< Line2D2 <NodeType>>(Element::GeometryType::PointsArrayType(2))),
    mGeoTrussElement3D2N       (0, Kratos::make_shared< Line3D2 <NodeType>>(Element::GeometryType::PointsArrayType(2))),
    mGeoLinearTrussElement2D2N (0, Kratos::make_shared< Line2D2 <NodeType>>(Element::GeometryType::PointsArrayType(2))),
    mGeoLinearTrussElement3D2N (0, Kratos::make_shared< Line3D2 <NodeType>>(Element::GeometryType::PointsArrayType(2))),
    mGeoCableElement2D2N       (0, Kratos::make_shared< Line2D2 <NodeType>>(Element::GeometryType::PointsArrayType(2))),
    mGeoCableElement3D2N       (0, Kratos::make_shared< Line3D2 <NodeType>>(Element::GeometryType::PointsArrayType(2))),
    mGeoCurvedBeamElement2D3N  (0, Kratos::make_shared< Line2D3 <NodeType>>(Element::GeometryType::PointsArrayType(3))),

    // conditions
    mUPwForceCondition2D1N(0, Kratos::make_shared< Point2D          <NodeType>>(Condition::GeometryType::PointsArrayType(1))),
    mUPwForceCondition3D1N(0, Kratos::make_shared< Point3D          <NodeType>>(Condition::GeometryType::PointsArrayType(1))),

    mUPwFaceLoadCondition2D2N(0, Kratos::make_shared< Line2D2          <NodeType>>(Condition::GeometryType::PointsArrayType(2))),
    mUPwFaceLoadCondition3D3N(0, Kratos::make_shared< Triangle3D3      <NodeType>>(Condition::GeometryType::PointsArrayType(3))),
    mUPwFaceLoadCondition3D4N(0, Kratos::make_shared< Quadrilateral3D4 <NodeType>>(Condition::GeometryType::PointsArrayType(4))),

    mUPwNormalFaceLoadCondition2D2N(0, Kratos::make_shared< Line2D2          <NodeType>>(Condition::GeometryType::PointsArrayType(2))),
    mUPwNormalFaceLoadCondition3D3N(0, Kratos::make_shared< Triangle3D3      <NodeType>>(Condition::GeometryType::PointsArrayType(3))),
    mUPwNormalFaceLoadCondition3D4N(0, Kratos::make_shared< Quadrilateral3D4 <NodeType>>(Condition::GeometryType::PointsArrayType(4))),

    mUPwNormalFluxCondition2D2N(0, Kratos::make_shared< Line2D2          <NodeType>>(Condition::GeometryType::PointsArrayType(2))),
    mUPwNormalFluxCondition3D3N(0, Kratos::make_shared< Triangle3D3      <NodeType>>(Condition::GeometryType::PointsArrayType(3))),
    mUPwNormalFluxCondition3D4N(0, Kratos::make_shared< Quadrilateral3D4 <NodeType>>(Condition::GeometryType::PointsArrayType(4))),

    mPwNormalFluxCondition2D2N(0, Kratos::make_shared< Line2D2          <NodeType>>(Condition::GeometryType::PointsArrayType(2))),
    mPwNormalFluxCondition3D3N(0, Kratos::make_shared< Triangle3D3      <NodeType>>(Condition::GeometryType::PointsArrayType(3))),
    mPwNormalFluxCondition3D4N(0, Kratos::make_shared< Quadrilateral3D4 <NodeType>>(Condition::GeometryType::PointsArrayType(4))),

    mUPwFaceLoadCondition2D3N(0, Kratos::make_shared< Line2D3 <NodeType>>(Condition::GeometryType::PointsArrayType(3))),
    mUPwFaceLoadCondition2D4N(0, Kratos::make_shared< Line2D4 <NodeType>>(Condition::GeometryType::PointsArrayType(4))),
    mUPwFaceLoadCondition2D5N(0, Kratos::make_shared< Line2D5 <NodeType>>(Condition::GeometryType::PointsArrayType(5))),

    mUPwFaceLoadInterfaceCondition2D2N(0, Kratos::make_shared< Line2D2                   <NodeType>>(Condition::GeometryType::PointsArrayType(2))),
    mUPwFaceLoadInterfaceCondition3D4N(0, Kratos::make_shared< QuadrilateralInterface3D4 <NodeType>>(Condition::GeometryType::PointsArrayType(4))),

    mUPwNormalFluxInterfaceCondition2D2N(0, Kratos::make_shared< Line2D2                   <NodeType>>(Condition::GeometryType::PointsArrayType(2))),
    mUPwNormalFluxInterfaceCondition3D4N(0, Kratos::make_shared< QuadrilateralInterface3D4 <NodeType>>(Condition::GeometryType::PointsArrayType(4))),

    mUPwNormalFluxFICCondition2D2N(0, Kratos::make_shared< Line2D2          <NodeType>>(Condition::GeometryType::PointsArrayType(2))),
    mUPwNormalFluxFICCondition3D3N(0, Kratos::make_shared< Triangle3D3      <NodeType>>(Condition::GeometryType::PointsArrayType(3))),
    mUPwNormalFluxFICCondition3D4N(0, Kratos::make_shared< Quadrilateral3D4 <NodeType>>(Condition::GeometryType::PointsArrayType(4))),

    mLineLoadDiffOrderCondition2D3N(0, Kratos::make_shared< Line2D3 <NodeType>>(Condition::GeometryType::PointsArrayType(3))),
    mLineLoadDiffOrderCondition2D4N(0, Kratos::make_shared< Line2D4 <NodeType>>(Condition::GeometryType::PointsArrayType(4))),
    mLineLoadDiffOrderCondition2D5N(0, Kratos::make_shared< Line2D5 <NodeType>>(Condition::GeometryType::PointsArrayType(5))),

    mLineNormalLoadDiffOrderCondition2D3N(0, Kratos::make_shared< Line2D3 <NodeType>>(Condition::GeometryType::PointsArrayType(3))),
    mLineNormalLoadDiffOrderCondition2D4N(0, Kratos::make_shared< Line2D4 <NodeType>>(Condition::GeometryType::PointsArrayType(4))),
    mLineNormalLoadDiffOrderCondition2D5N(0, Kratos::make_shared< Line2D5 <NodeType>>(Condition::GeometryType::PointsArrayType(5))),

    mLineNormalFluidFluxDiffOrderCondition2D3N(0, Kratos::make_shared< Line2D3 <NodeType>>(Condition::GeometryType::PointsArrayType(3))),
    mLineNormalFluidFluxDiffOrderCondition2D4N(0, Kratos::make_shared< Line2D4 <NodeType>>(Condition::GeometryType::PointsArrayType(4))),
    mLineNormalFluidFluxDiffOrderCondition2D5N(0, Kratos::make_shared< Line2D5 <NodeType>>(Condition::GeometryType::PointsArrayType(5))),

    mSurfaceLoadDiffOrderCondition3D6N(0, Kratos::make_shared< Triangle3D6      <NodeType>>(Condition::GeometryType::PointsArrayType(6))),
    mSurfaceLoadDiffOrderCondition3D8N(0, Kratos::make_shared< Quadrilateral3D8 <NodeType>>(Condition::GeometryType::PointsArrayType(8))),
    mSurfaceLoadDiffOrderCondition3D9N(0, Kratos::make_shared< Quadrilateral3D9 <NodeType>>(Condition::GeometryType::PointsArrayType(9))),

    mSurfaceNormalLoadDiffOrderCondition3D6N(0, Kratos::make_shared< Triangle3D6      <NodeType>>(Condition::GeometryType::PointsArrayType(6))),
    mSurfaceNormalLoadDiffOrderCondition3D8N(0, Kratos::make_shared< Quadrilateral3D8 <NodeType>>(Condition::GeometryType::PointsArrayType(8))),
    mSurfaceNormalLoadDiffOrderCondition3D9N(0, Kratos::make_shared< Quadrilateral3D9 <NodeType>>(Condition::GeometryType::PointsArrayType(9))),

    mSurfaceNormalFluidFluxDiffOrderCondition3D6N(0, Kratos::make_shared< Triangle3D6      <NodeType>>(Condition::GeometryType::PointsArrayType(6))),
    mSurfaceNormalFluidFluxDiffOrderCondition3D8N(0, Kratos::make_shared< Quadrilateral3D8 <NodeType>>(Condition::GeometryType::PointsArrayType(8))),
    mSurfaceNormalFluidFluxDiffOrderCondition3D9N(0, Kratos::make_shared< Quadrilateral3D9 <NodeType>>(Condition::GeometryType::PointsArrayType(9))),

    mAxisymmetricUPwNormalFaceLoadCondition2D2N(0, Kratos::make_shared< Line2D2 <NodeType>>(Condition::GeometryType::PointsArrayType(2))),

    mAxisymmetricLineNormalLoadDiffOrderCondition2D3N(0, Kratos::make_shared< Line2D3<NodeType>>(Condition::GeometryType::PointsArrayType(3))),

    mAxisymmetricLineNormalFluidFluxDiffOrderCondition2D3N(0, Kratos::make_shared< Line2D3<NodeType>>(Condition::GeometryType::PointsArrayType(3))),

    mUPwLysmerAbsorbingCondition2D2N(0, Kratos::make_shared< Line2D2          <NodeType>>(Condition::GeometryType::PointsArrayType(2))),
    mUPwLysmerAbsorbingCondition2D3N(0, Kratos::make_shared< Line2D3          <NodeType>>(Condition::GeometryType::PointsArrayType(3))),
    mUPwLysmerAbsorbingCondition3D3N(0, Kratos::make_shared< Triangle3D3      <NodeType>>(Condition::GeometryType::PointsArrayType(3))),
    mUPwLysmerAbsorbingCondition3D4N(0, Kratos::make_shared< Quadrilateral3D4 <NodeType>>(Condition::GeometryType::PointsArrayType(4)))
