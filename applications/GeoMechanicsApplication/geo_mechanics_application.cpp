...
void KratosGeoMechanicsApplication::Register()
{
    ...
    KRATOS_REGISTER_VARIABLE(PIPE_PRIMARY_EROSION)
    KRATOS_REGISTER_VARIABLE(PIPE_PRIMARY_EROSION_ENABLED)
    KRATOS_REGISTER_VARIABLE(PIPE_SECONDARY_EROSION)
    KRATOS_REGISTER_VARIABLE(PIPE_CRITICAL_GRADIENT)
