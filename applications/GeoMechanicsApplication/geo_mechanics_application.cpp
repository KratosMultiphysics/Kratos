...
void KratosGeoMechanicsApplication::Register() {
    ...
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS( VELOCITY_NULL )
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS( VELOCITY_EINS )
    ...
    KRATOS_REGISTER_VARIABLE( DT_AIR_PRESSURE )
    ...
    KRATOS_REGISTER_VARIABLE( G_CONSTANT )
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS( AIR_FLOW )
