...
void KratosGeoMechanicsApplication::Register()
{
    ...
    KRATOS_REGISTER_VARIABLE(GEO_COHESION_STRENGTH_FACTOR)
    KRATOS_REGISTER_VARIABLE(GEO_FRICTION_ANGLE_STRENGTH_FACTOR)
    KRATOS_REGISTER_VARIABLE(GEO_DILATANCY_ANGLE_STRENGTH_FACTOR)
