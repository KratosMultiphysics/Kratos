...
void KratosGeoMechanicsApplication::Register()
{
    ...
    KRATOS_REGISTER_ELEMENT("GeoLinearTimoshenkoBeamElement2D2N", mGeoLinearTimoshenkoBeamElement2D2N)
    ...
    KRATOS_REGISTER_CONDITION("UPwLysmerAbsorbingCondition3D6N", mUPwLysmerAbsorbingCondition3D6N)
    KRATOS_REGISTER_CONDITION("UPwLysmerAbsorbingCondition3D8N", mUPwLysmerAbsorbingCondition3D8N)
    ...
    KRATOS_REGISTER_CONSTITUTIVE_LAW("GeoInterfaceCoulombWithTensionCutOff", mInterfaceCoulombWithTensionCutOff)
    ...
    KRATOS_REGISTER_VARIABLE(GEO_POISSON_UNDRAINED)
    KRATOS_REGISTER_VARIABLE(GEO_SKEMPTON_B)
    ...
    KRATOS_REGISTER_VARIABLE(KAPPA_PIECEWISE_LINEAR_LAW)
    KRATOS_REGISTER_VARIABLE(MOMENTUM_PIECEWISE_LINEAR_LAW)
    KRATOS_REGISTER_VARIABLE(MAX_AXIAL_LOAD_OF_CONSTRUCTION_ELEMENT)
    KRATOS_REGISTER_VARIABLE(MOMENT_CAPACITY_REDUCTION_FACTOR)
    KRATOS_REGISTER_VARIABLE(MINIMUM_MOMENT_CAPACITY_FACTOR)
    KRATOS_REGISTER_VARIABLE(UNRELOAD_MODULUS)
