...
void KratosGeoMechanicsApplication::Register()
{
    ...
    KRATOS_REGISTER_VARIABLE(GEO_KAPPA_PIECEWISE_LINEAR_LAW)
    KRATOS_REGISTER_VARIABLE(GEO_MOMENT_PIECEWISE_LINEAR_LAW)
    KRATOS_REGISTER_VARIABLE(GEO_UNRELOAD_MODULUS)
