...
#if !defined (KRATOS_LIAKOPOLOUS_LAW_H_INCLUDED)
#define  KRATOS_LIAKOPOLOUS_LAW_H_INCLUDED
...
/**
 * @class LiakopolousLaw
 * @ingroup GeoMechanicsApplication
 * @brief This class defines a saturated Soil Water Characteristic Curve (retention curve) for Liakopolous testing of partially saturated soil
 * @details This class derives from the base retention law
 * @author Vahid Galavi
 */
class KRATOS_API(GEO_MECHANICS_APPLICATION) LiakopolousLaw
    : public RetentionLaw
{
public:
    ...
    /// Counted pointer of LiakopolousLaw
    KRATOS_CLASS_POINTER_DEFINITION( LiakopolousLaw );
     ...
     * Copy constructor.
     */
    LiakopolousLaw(const LiakopolousLaw& rOther);

    /**
     * @brief Destructor.
     */
    ~LiakopolousLaw() override;
...
#endif // KRATOS_LIAKOPOLOUS_LAW_H_INCLUDED  defined
