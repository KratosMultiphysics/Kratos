...
#define  KRATOS_Brooks_Corey_LAW_H_INCLUDED
...
/**
 * @class BrooksCoreyLaw
 * @ingroup GeoMechanicsApplication
 * @brief This class defines The Brooks_Corey Soil Water Characteristic Curve (retention curve)
 * @details This class derives from the base retention law
 * @author Vahid Galavi
 */
class KRATOS_API(GEO_MECHANICS_APPLICATION) BrooksCoreyLaw
    : public RetentionLaw
{
public:
    ...
    /// Counted pointer of BrooksCoreyLaw
    KRATOS_CLASS_POINTER_DEFINITION( BrooksCoreyLaw );
     ...
     * Copy constructor.
     */
    BrooksCoreyLaw(const BrooksCoreyLaw& rOther);

    /**
     * @brief Destructor.
     */
    ~BrooksCoreyLaw() override;
...
#endif // KRATOS_Brooks_Corey_LAW_H_INCLUDED  defined