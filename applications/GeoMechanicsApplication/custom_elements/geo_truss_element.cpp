...
GeoTrussElement<TDim,TNumNodes>::
...
//----------------------------------------------------------------------------------------
template< unsigned int TDim, unsigned int TNumNodes >
Element::Pointer GeoTrussElement<TDim,TNumNodes>::
...
//----------------------------------------------------------------------------------------
template< unsigned int TDim, unsigned int TNumNodes >
void GeoTrussElement<TDim,TNumNodes>::
                                 ...
                                 const ProcessInfo& rCurrentProcessInfo)
{
    ...
    const GeometryType::IntegrationPointsArrayType& 
        integration_points = this->GetGeometry().IntegrationPoints();
...
template< unsigned int TDim, unsigned int TNumNodes >
void GeoTrussElement<TDim,TNumNodes>::
    UpdateInternalForces(BoundedVector<double, TDim*TNumNodes>& rInternalForces,
                         const ProcessInfo& rCurrentProcessInfo)
{
    KRATOS_TRY
    BoundedMatrix<double, TDim*TNumNodes, TDim*TNumNodes> 
    transformation_matrix = ZeroMatrix(TDim*TNumNodes, TDim*TNumNodes);
    ...
    InitializeSolutionStep(const ProcessInfo& rCurrentProcessInfo)
{
    ...
    GeoTrussElementBase<TDim,TNumNodes>::InitializeSolutionStep(rCurrentProcessInfo);
