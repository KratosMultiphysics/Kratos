...
namespace Kratos {
    ...
    public:
        ...
        Element::Pointer Create(IndexType NewId, const NodesArrayType &rThisNodes,
                                PropertiesType::Pointer pProperties) const override {
            return this->Create(NewId, GetGeometry().Create(rThisNodes), pProperties);
        }

        Element::Pointer Create(IndexType NewId, GeometryType::Pointer pGeometry,
                                PropertiesType::Pointer pProperties) const override {
        ...
        array_1d<double, TNumNodes> CalculateFluidBodyVector(const Matrix &rNContainer,
            ...
            for (unsigned int integration_point_index = 0;
                ...
                fluid_body_vector +=
                        ...
                        prod(prod(rShapeFunctionGradients[integration_point_index], constitutive_matrix),
                             projected_gravity) *
