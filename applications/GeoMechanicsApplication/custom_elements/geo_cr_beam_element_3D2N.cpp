                                              ...
                                              PropertiesType::Pointer pProperties) const
{
    ...
    return Kratos::make_intrusive<GeoCrBeamElement3D2N>(
                                                       ...
                                                       const ProcessInfo& rCurrentProcessInfo) const
{
    ...
    Vector internal_previous_force =
        prod(total_rotation_matrix, mLocalForcesFinalizedPrevious);
...
//-------------------------------------------------------------------------------------------------
void GeoCrBeamElement3D2N::CalculateOnIntegrationPoints(
    ...
    const ProcessInfo& rCurrentProcessInfo)
{
    ...
    if (rVariable == MOMENT)
    {
        ...
        rOutput[0][0] =
            -1.0 * nodal_forces_local_qe[3] * 0.75 + nodal_forces_local_qe[9] * 0.25;
        rOutput[1][0] =
            -1.0 * nodal_forces_local_qe[3] * 0.50 + nodal_forces_local_qe[9] * 0.50;
        rOutput[2][0] =
            -1.0 * nodal_forces_local_qe[3] * 0.25 + nodal_forces_local_qe[9] * 0.75;

        rOutput[0][1] =
            -1.0 * nodal_forces_local_qe[4] * 0.75 + nodal_forces_local_qe[10] * 0.25;
        rOutput[1][1] =
            -1.0 * nodal_forces_local_qe[4] * 0.50 + nodal_forces_local_qe[10] * 0.50;
        rOutput[2][1] =
            -1.0 * nodal_forces_local_qe[4] * 0.25 + nodal_forces_local_qe[10] * 0.75;

        rOutput[0][2] =
            1.0 * nodal_forces_local_qe[5] * 0.75 - nodal_forces_local_qe[11] * 0.25;
        rOutput[1][2] =
    ...
    else if (rVariable == FORCE)
    {
        ...
        nodal_forces_local_qe += mLocalForcesFinalizedPrevious;
        rOutput[0][0] =
            -1.0 * nodal_forces_local_qe[0] * 0.75 + nodal_forces_local_qe[6] * 0.25;
        rOutput[1][0] =
            -1.0 * nodal_forces_local_qe[0] * 0.50 + nodal_forces_local_qe[6] * 0.50;
        rOutput[2][0] =
            -1.0 * nodal_forces_local_qe[0] * 0.25 + nodal_forces_local_qe[6] * 0.75;

        rOutput[0][1] =
            -1.0 * nodal_forces_local_qe[1] * 0.75 + nodal_forces_local_qe[7] * 0.25;
        rOutput[1][1] =
            -1.0 * nodal_forces_local_qe[1] * 0.50 + nodal_forces_local_qe[7] * 0.50;
        rOutput[2][1] =
            -1.0 * nodal_forces_local_qe[1] * 0.25 + nodal_forces_local_qe[7] * 0.75;

        rOutput[0][2] =
            -1.0 * nodal_forces_local_qe[2] * 0.75 + nodal_forces_local_qe[8] * 0.25;
        rOutput[1][2] =
