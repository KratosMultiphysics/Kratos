...
public:
    ...
    std::string Info() const override
    {
        ...
        buffer << "Updated-Lagrangian axisymmetric U-Pw element with different "
                  "order #"
               << this->Id()
    ...
    {
        rOStream << "Updated-Lagrangian axisymmetric U-Pw element with "
                    "different order #"
                 << this->Id()
                 << "\nConstitutive law: " << mConstitutiveLawVector[0]->Info();
    }
...
private:
    ...
    // Assignment operator.
    UpdatedLagrangianUPwDiffOrderAxisymmetricElement&
    operator=(UpdatedLagrangianUPwDiffOrderAxisymmetricElement const& rOther);

    // Copy constructor.
    UpdatedLagrangianUPwDiffOrderAxisymmetricElement(
        UpdatedLagrangianUPwDiffOrderAxisymmetricElement const& rOther);
