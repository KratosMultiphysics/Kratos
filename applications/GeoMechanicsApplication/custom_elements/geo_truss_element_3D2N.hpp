...
namespace Kratos
{
    ...
    class KRATOS_API(GEO_MECHANICS_APPLICATION) GeoTrussElement3D2N : public Element
    {
    protected:
        //const values
        ...
        Vector mInternalStresses = ZeroVector(msLocalSize);
        Vector mInternalStressesFinalized = ZeroVector(msLocalSize);
        Vector mInternalStressesFinalizedPrevious = ZeroVector(msLocalSize);
