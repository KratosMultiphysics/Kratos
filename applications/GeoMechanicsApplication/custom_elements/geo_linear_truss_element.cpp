...
template <>
void GeoLinearTrussElement<3, 2>::WriteTransformationCoordinates(FullDofVectorType& rReferenceCoordinates)
{
    KRATOS_TRY
...
template <>
void GeoLinearTrussElement<2, 2>::WriteTransformationCoordinates(FullDofVectorType& rReferenceCoordinates)
{
    KRATOS_TRY
...
template <unsigned int TDim, unsigned int TNumNodes>
double GeoLinearTrussElement<TDim, TNumNodes>::CalculateLinearStrain()
{
    ...
    return (current_disp[TDim] - current_disp[0]) / length_0;
}

template <unsigned int TDim, unsigned int TNumNodes>
void GeoLinearTrussElement<TDim, TNumNodes>::AddPrestressLinear(VectorType& rRightHandSideVector)
{
    KRATOS_TRY
