...
class TimeDependentPwDrainageCase : public DrainagePolicy<TDim, TNumNodes>
{
public:
protected:
    ...
    [[nodiscard]] std::unique_ptr<DrainagePolicy<TDim, TNumNodes>> Clone() const
    {
        return std::make_unique<TimeDependentPwDrainageCase<TDim, TNumNodes>>();
    }
};
