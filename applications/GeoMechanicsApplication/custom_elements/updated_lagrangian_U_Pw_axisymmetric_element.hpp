...
public:
    ...
    std::string Info() const override
    {
        ...
        buffer << "Updated-Lagrangian axisymmetric U-Pw Element #" << this->Id()
    ...
    {
        rOStream << "Updated-Lagrangian axisymmetric U-Pw Element #" << this->Id()
                 << "\nConstitutive law: " << mConstitutiveLawVector[0]->Info();
    }
...
private:
    ...
    operator=(UPwUpdatedLagrangianAxisymmetricElement const& rOther);
