...
#include "../StructuralMechanicsApplication/custom_elements/truss_element_linear_3D2N.hpp"
...
namespace Kratos
{
    ...
    class KRATOS_API(GEO_MECHANICS_APPLICATION) GeoTrussElementLinear3D2N : public TrussElementLinear3D2N
    {
    protected:
        //const values
