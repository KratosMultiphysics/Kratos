...
#if !defined(KRATOS_GEO_TRUSS_ELEMENT_LINEAR_3D2N_H_INCLUDED )
#define  KRATOS_GEO_TRUSS_ELEMENT_LINEAR_3D2N_H_INCLUDED
...
namespace Kratos {
/**
 * @class GeoTrussElementLinear3D2N
 *
 * @brief This is a linear 3D-2node truss element with 3 translational dofs per node inheriting from GeoTrussElement3D2N
 *
 * @author Klaus B Sautter
 */

class KRATOS_API(GEO_MECHANICS_APPLICATION) GeoTrussElementLinear3D2N : public GeoTrussElement3D2N
{
public:
    KRATOS_CLASS_INTRUSIVE_POINTER_DEFINITION(GeoTrussElementLinear3D2N);
    ...
    ~GeoTrussElementLinear3D2N() override;
