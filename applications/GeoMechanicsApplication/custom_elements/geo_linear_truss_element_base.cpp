...
GeoTrussElementLinearBase<TDim,TNumNodes>::
...
//----------------------------------------------------------------------------------------
template< unsigned int TDim, unsigned int TNumNodes >
Element::Pointer GeoTrussElementLinearBase<TDim,TNumNodes>::
    Create(IndexType NewId,
           NodesArrayType const& rThisNodes,
           PropertiesType::Pointer pProperties) const
{
    const GeometryType& rGeom = this->GetGeometry();
    return Kratos::make_intrusive<GeoTrussElementLinearBase>(NewId,
...

{
    ...
    this->CalculateElasticStiffnessMatrix(rLocalStiffnessMatrix,
                                          rCurrentProcessInfo);
...
//----------------------------------------------------------------------------------------
template< >
void GeoTrussElementLinearBase<3,2>::
...
//----------------------------------------------------------------------------------------
template< >
void GeoTrussElementLinearBase<2,2>::
    WriteTransformationCoordinates(FullDofVectorType& rReferenceCoordinates)
{
    KRATOS_TRY
