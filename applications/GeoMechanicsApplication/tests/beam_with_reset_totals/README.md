...
1.  A point load of 1e10 N is applied to node 11 in the negative y-direction. The 'reset_totals' option is set to false. The beam is expected to bend downwards.
