...
KRATOS_TEST_CASE_IN_SUITE(NeighbouringEntityFinder_ReturnsEmptyListWhenNoNeighbouringElements, KratosGeoMechanicsFastSuiteWithoutKernel)
{
    Model model;
    ...
    auto& r_model_part_for_entities_for_finding = ModelSetupUtilities::CreateModelPartWithASingle2D3NElement(model);
    ...
    finder.FindConditionNeighboursBasedOnBoundaryType(generate_generic_boundaries, r_model_part_for_neighbouring_elements.Elements());
