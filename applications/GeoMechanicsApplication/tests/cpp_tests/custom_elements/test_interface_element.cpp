                          ...
                          KratosGeoMechanicsFastSuiteWithoutKernel)
{
    ...
    // Assert
    const auto expected_left_hand_side = CreateExpectedLeftHandSideForTriangleElement(18,normal_stiffness,shear_stiffness);
    KRATOS_EXPECT_MATRIX_RELATIVE_NEAR(actual_left_hand_side, expected_left_hand_side, Defaults::relative_tolerance)
}
                          ...
                          KratosGeoMechanicsFastSuiteWithoutKernel)
{
    ...
    // Assert
    const auto expected_left_hand_side =
        CreateExpectedLeftHandSideForTriangleElement(18, normal_stiffness, shear_stiffness);
    KRATOS_EXPECT_MATRIX_RELATIVE_NEAR(actual_left_hand_side, expected_left_hand_side, Defaults::relative_tolerance)
                          ...
                          KratosGeoMechanicsFastSuiteWithoutKernel)
{
    ...
    const auto expected_left_hand_side = CreateExpectedLeftHandSideForTriangleElement(
        36, normal_stiffness, shear_stiffness, 30.42857142, 3.328125);
