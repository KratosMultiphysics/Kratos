...
namespace Kratos
{
    namespace Testing
    {
        ...
        KRATOS_TEST_CASE_IN_SUITE(ErosionProcessStrategy, KratosGeoMechanicsFastSuite)
        {
            ...
            int status = execute.execute_flow_analysis(workingDirectory, projectFile, 0, 4, 0.1, "PorousDomain.Left_head", &emptyLog, &emptyProgress, &emptyLog, &emptyCancel);
        ...
        KRATOS_TEST_CASE_IN_SUITE(ErosionProcessStrategyTextualProgressReport, KratosGeoMechanicsFastSuite)
        {
            ...
            int status = execute.execute_flow_analysis(workingDirectory, projectFile, 0, 4, 0.1, "PorousDomain.Left_head", &emptyLog, &emptyProgress, reportTextualProgress, &emptyCancel);
        ...
        KRATOS_TEST_CASE_IN_SUITE(ErosionProcessStrategyProgressReport, KratosGeoMechanicsFastSuite)
        {
            ...
            int status = execute.execute_flow_analysis(workingDirectory, projectFile, 0, 4, 0.1, "PorousDomain.Left_head", &emptyLog, reportProgress, &emptyLog, &emptyCancel);
