...
namespace Kratos
{
	namespace Testing
    {
        ...
        inline ConvergenceCriteriaType::Pointer setup_criteria_dgeoflow()
        {
        ...
        inline LinearSolverType::Pointer setup_solver_dgeoflow()
        {
    	...
    	inline GeoMechanicsNewtonRaphsonErosionProcessStrategyType::Pointer setup_strategy_dgeoflow(ModelPart& model_part)
        {
        ...
        inline void parseMesh(ModelPart& model_part, string filepath)
        {
        ...
        inline void parseMaterial(Model& model, string filepath)
        {
        ...
        inline Parameters openProjectParamsFile(string filepath)
        {
		...
		inline std::vector<std::shared_ptr<Process>> parseProcess(ModelPart& model_part, Parameters projFile)
        {
        ...
        inline void outputGiD(Model& model, ModelPart& model_part, Parameters parameters)
        {
