...
namespace Kratos::Testing {
    ...
    public:
        ...
        ModelPart::ConditionType::Pointer SetUpUPwLysmerAbsorbingCondition2D2NCondition(ModelPart& rModelPart)
        {
            ...
            ModelPart::ConditionType::Pointer cond = rModelPart.CreateNewCondition("UPwLysmerAbsorbingCondition2D2N", 1, cond_nodes, cond_prop);
            ...
            KRATOS_REGISTER_ELEMENT("MockElement", mock_element)
            ...
            vector_of_neighbours.push_back(Kratos::GlobalPointer<Kratos::Element>(neighbour_element.get()));
        ...
        KRATOS_TEST_CASE_IN_SUITE(CalculateLocalSystemUPwNormalLysmerAbsorbingCondition, KratosGeoMechanicsFastSuite)
        {
            ...
            {
                // compare lhs
                for (unsigned int j = 0; j < condition_size; ++j)
                {
                    KRATOS_EXPECT_NEAR(
                        rLeftHandSideMatrix(i, j),
                        expected_matrix(i, j),
