...
class TestMeshDependencyPiping(KratosUnittest.TestCase):
    ...
    def test_piping_mesh_dependency(self):
        test_files = ["PipeRefinementD10L30M1.gid",
                      "PipeRefinementD10L30M2.gid",
                      "PipeRefinementD10L30M3.gid",
                      "PipeRefinementD10L30M4.gid",
                      "PipeRefinementD10L30M5.gid",
                      "PipeRefinementD10L30M6.gid"]
        result_dict = {}
        for test_file in test_files:
            test_name = f'test_piping_mesh_dependency/{test_file}'
