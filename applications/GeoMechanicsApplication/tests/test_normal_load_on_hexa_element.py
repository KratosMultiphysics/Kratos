...
class KratosGeoMechanicsNormalLoadHexaTests(KratosUnittest.TestCase):
    ...
    def test_hexa_8n_normal_load(self):
        ...
        total_stress_vectors = \
            GiDOutputFileReader.element_integration_point_values_at_time("TOTAL_STRESS_TENSOR", 1.0,
        ...
        displacements_at_top = GiDOutputFileReader.nodal_values_at_time("DISPLACEMENT", 1.0, output_data,
                                                                                    node_ids=top_node_nbrs)
        bottom_node_nbrs = [1, 2, 3, 4]
        displacements_at_bottom = GiDOutputFileReader.nodal_values_at_time("DISPLACEMENT", 1.0, output_data,
