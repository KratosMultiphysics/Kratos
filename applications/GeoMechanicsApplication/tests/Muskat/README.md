...
The fluid flux profile at x = 1.52 is visualized below:

![Fluid flux on the right boundary](van_genuchten_hydrostatic/fluxes_for_x_1_52.svg)
...
- At three representative nodes (see figure at the bottom of the file), the water pressures and fluid flux vectors are checked for regressions.
