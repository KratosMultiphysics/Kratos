...
class KratosGeoMechanicsTransientThermalTests(KratosUnittest.TestCase):
    ...
    def test_thermal_heat_flux_3D8N(self):
        test_name = 'test_thermal_heat_flux_3D8N'
        file_path = test_helper.get_file_path(os.path.join('test_thermal_element', 'test_thermal_heat_flux', test_name))
        simulation = test_helper.run_kratos(file_path)
        temperature = test_helper.get_temperature(simulation)
        temp = temperature[38]
        self.assertAlmostEqual(self.etalon_value4, temp)

    def test_thermal_heat_flux_3D20N(self):
        test_name = 'test_thermal_heat_flux_3D20N'
        file_path = test_helper.get_file_path(os.path.join('test_thermal_element', 'test_thermal_heat_flux', test_name))
        simulation = test_helper.run_kratos(file_path)
        temperature = test_helper.get_temperature(simulation)
    ...
    def test_thermal_line_element_2D2N(self):
        test_name = 'test_thermal_line_element_2D2N'
    ...
    def test_thermal_line_element_2D3N(self):
        test_name = 'test_thermal_line_element_2D3N'
        file_path = test_helper.get_file_path(os.path.join('test_thermal_element', 'test_thermal_line_element', test_name))
        simulation = test_helper.run_kratos(file_path)
        temperature = test_helper.get_temperature(simulation)
        self.assertAlmostEqual(self.etalon_value5, temperature[2])
    ...
    def test_thermal_line_element_2D4N(self):
        test_name = 'test_thermal_line_element_2D4N'
        file_path = test_helper.get_file_path(os.path.join('test_thermal_element', 'test_thermal_line_element', test_name))
        simulation = test_helper.run_kratos(file_path)
        temperature = test_helper.get_temperature(simulation)
        self.assertAlmostEqual(self.etalon_value5, temperature[2])
    ...
    def test_thermal_line_element_2D5N(self):
        test_name = 'test_thermal_line_element_2D5N'
        file_path = test_helper.get_file_path(os.path.join('test_thermal_element', 'test_thermal_line_element', test_name))
        simulation = test_helper.run_kratos(file_path)
        temperature = test_helper.get_temperature(simulation)
        self.assertAlmostEqual(self.etalon_value5, temperature[2])
    ...
    def test_thermal_point_flux_2D2N(self):
        test_name = 'test_thermal_point_flux_2D2N'
        file_path = test_helper.get_file_path(os.path.join('test_thermal_element', 'test_thermal_heat_flux_line_element', test_name))
        simulation = test_helper.run_kratos(file_path)
        temperature = test_helper.get_temperature(simulation)
        self.assertAlmostEqual(self.etalon_value6, temperature[0])
        
    def test_thermal_point_flux_2D3N(self):
        test_name = 'test_thermal_point_flux_2D3N'
        file_path = test_helper.get_file_path(os.path.join('test_thermal_element', 'test_thermal_heat_flux_line_element', test_name))
        simulation = test_helper.run_kratos(file_path)
        temperature = test_helper.get_temperature(simulation)
        self.assertAlmostEqual(self.etalon_value6, temperature[0])
    ...
    def test_thermal_point_flux_2D4N(self):
        test_name = 'test_thermal_point_flux_2D4N'
        file_path = test_helper.get_file_path(os.path.join('test_thermal_element', 'test_thermal_heat_flux_line_element', test_name))
        simulation = test_helper.run_kratos(file_path)
        temperature = test_helper.get_temperature(simulation)
        self.assertAlmostEqual(self.etalon_value6, temperature[0])
    ...
    def test_thermal_point_flux_2D5N(self):
        test_name = 'test_thermal_point_flux_2D5N'
        file_path = test_helper.get_file_path(os.path.join('test_thermal_element', 'test_thermal_heat_flux_line_element', test_name))
        simulation = test_helper.run_kratos(file_path)
        temperature = test_helper.get_temperature(simulation)
        self.assertAlmostEqual(self.etalon_value6, temperature[0])
    ...
    def test_thermal_point_flux_3D2N(self):
        test_name = 'test_thermal_point_flux_3D2N'
        file_path = test_helper.get_file_path(os.path.join('test_thermal_element', 'test_thermal_heat_flux_line_element', test_name))
        simulation = test_helper.run_kratos(file_path)
        temperature = test_helper.get_temperature(simulation)
        self.assertAlmostEqual(self.etalon_value6, temperature[0])
    ...
    def test_thermal_point_flux_3D3N(self):
        test_name = 'test_thermal_point_flux_3D3N'
        file_path = test_helper.get_file_path(os.path.join('test_thermal_element', 'test_thermal_heat_flux_line_element', test_name))
        simulation = test_helper.run_kratos(file_path)
        temperature = test_helper.get_temperature(simulation)
        self.assertAlmostEqual(self.etalon_value6, temperature[0])
