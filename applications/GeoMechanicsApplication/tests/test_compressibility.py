...
class KratosGeoMechanicsCompressibilityTests(KratosUnittest.TestCase):
    ...
    def test_compressibility_upw_small_strain_diff_order(self):
        ...
        self.run_and_assert_water_pressures_diff_order([-49.1441, -49.1899, -49.1899, -49.1441], test_name)

    def test_compressibility_upw_small_strain_diff_order_updated_lagrange(self):
        test_name = 'compressibility_tests/upw_small_strain_diff_order_updated_lagrange'
        self.run_and_assert_water_pressures_diff_order([-49.1441, -49.1899, -49.1899, -49.1441], test_name)
