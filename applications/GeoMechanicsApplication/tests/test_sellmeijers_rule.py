...
class TestSellmeijersRule(KratosUnittest.TestCase):
    ...
    @parameterized.expand(
        [('7.1', 1.00E-04, 1.157E-12, 3.43, 3.7, 6, 'test_compare_sellmeijer/HeightAquiferD10L30.gid'),
         (
                 '7.2', 1.00E-04, 1.157E-12, 6.37, 7.4, 12,
                 'test_compare_sellmeijer/HeightAquiferD10L60.gid'),
         ('7.3', 1.00E-04, 1.157E-12, 9.18, 11.2, 13.5,
         ...
         ('7.12', 3.00E-04, 1.157E-12, 27.54, 32.8, 15,
          'test_compare_sellmeijer/HeightAquiferD10L90.gid'),
         ('7.13', 3.00E-04, 1.157E-12, 9.01, 9.9, 10.5,
         ...
         (
                 ...
                 'test_compare_sellmeijer/HeightAquiferD30L30.gid'),
         ('7.17', 3.00E-04, 1.157E-12, 15.05, 16.8, 22.5,
          'test_compare_sellmeijer/HeightAquiferD30L60.gid'),
         ('7.18', 3.00E-04, 1.157E-12, 21.4, 24.1, 28.5,
          'test_compare_sellmeijer/HeightAquiferD30L90.gid'),
         (
                 '7.19', 1.00E-04, 1.157E-10, 0.74, 0.8, 6,
                 'test_compare_sellmeijer/HeightAquiferD10L30.gid'),
         ('7.20', 1.00E-04, 1.157E-10, 1.37, 1.6, 10.5,
          'test_compare_sellmeijer/HeightAquiferD10L60.gid'),
         ('7.21', 1.00E-04, 1.157E-10, 1.98, 2.4, 12,
          'test_compare_sellmeijer/HeightAquiferD10L90.gid'),
         (
                 '7.22', 1.00E-04, 1.157E-10, 0.65, 0.7, 9,
                 'test_compare_sellmeijer/HeightAquiferD20L30.gid'),
         ('7.23', 1.00E-04, 1.157E-10, 1.17, 1.3, 13.5,
          'test_compare_sellmeijer/HeightAquiferD20L60.gid'),
         ('7.24', 1.00E-04, 1.157E-10, 1.68, 1.9, 15,
          'test_compare_sellmeijer/HeightAquiferD20L90.gid'),
         (
                 '7.25', 1.00E-04, 1.157E-10, 0.56, 0.6, 6,
                 'test_compare_sellmeijer/HeightAquiferD30L30.gid'),
         ('7.26', 1.00E-04, 1.157E-10, 1.08, 1.2, 16.5,
          'test_compare_sellmeijer/HeightAquiferD30L60.gid'),
         ('7.27', 1.00E-04, 1.157E-10, 1.54, 1.7, 18,
          'test_compare_sellmeijer/HeightAquiferD30L90.gid'),
         (
                 '7.28', 3.00E-04, 1.157E-10, 2.22, 2.4, 6,
                 'test_compare_sellmeijer/HeightAquiferD10L30.gid'),
         ('7.29', 3.00E-04, 1.157E-10, 4.12, 4.8, 10.5,
          'test_compare_sellmeijer/HeightAquiferD10L60.gid'),
         ('7.30', 3.00E-04, 1.157E-10, 5.93, 7.2, 12,
          'test_compare_sellmeijer/HeightAquiferD10L90.gid'),
         (
         ...
         ('7.35', 3.00E-04, 1.157E-10, 3.24, 3.7, 22.5,
          'test_compare_sellmeijer/HeightAquiferD30L60.gid'),
         ('7.36', 3.00E-04, 1.157E-10, 4.61, 5.3, 27,
          'test_compare_sellmeijer/HeightAquiferD30L90.gid')])
