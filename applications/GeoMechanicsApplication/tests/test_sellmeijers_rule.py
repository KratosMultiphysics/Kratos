...
class TestSellmeijersRule(KratosUnittest.TestCase):
    ...
    def test_sellmeijers_rule_height(self):
        sellmeijer_test_data = [('7.1', 1.00E-04, 1.157E-12, 3.43, 3.7, 6, 'test_compare_sellmeijer/HeightAquiferD10L30.gid'),
        ...
        for name, d70, kappa, Hc, Hn, length_n, test_name_gid in sellmeijer_test_data:
            with self.subTest(msg=f"Sellmeijer case {name}"):
