...
class KratosGeoMechanicsUDSMSerializationTest(KratosUnittest.TestCase):
    ...
    def _compare_node_values(
        ...
        if isinstance(lhs_value, list):
            return self._compare_vector_values(
                node_id, lhs_value, rhs_value, abs_tol, rel_tol
            )

        return self._compare_scalar_values(
            node_id, lhs_value, rhs_value, abs_tol, rel_tol
        )
    ...
    def _compare_nodal_series_at_time(
        ...
        key_mismatch_error = self._node_key_mismatch_error(lhs_nodes, rhs_nodes, time)
