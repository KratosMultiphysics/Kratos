...
public:
    ...
    static void CondenseLeftHandSide(ElementType&            rTheElement,
                                     ...
                                     const std::vector<int>& rDofList)
    {
        ...
        std::vector<MatrixType> sub_matrices =
            CalculateSchurComplements(rTheElement, rLeftHandSideMatrix, rDofList);
        // 1.) inverse K22
    ...
    static std::vector<MatrixType> CalculateSchurComplements(ElementType&      rTheElement,
    ...
    static void FillSchurComplements(MatrixType&             Submatrix,
                                     const MatrixType&       rLeftHandSideMatrix,
    ...
    static void ConvertingCondensation(ElementType&            rTheElement,
