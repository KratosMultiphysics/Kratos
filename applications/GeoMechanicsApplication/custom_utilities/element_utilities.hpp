...
public:
    ...
    static inline void CalculateExtrapolationMatrixTriangle(Matrix& rExtrapolationMatrix,
    ...
    static inline void CalculateExtrapolationMatrixQuad(Matrix& rExtrapolationMatrix,
                                                        const GeometryData::IntegrationMethod& rIntegrationMethod)
    {
        if (rIntegrationMethod == GeometryData::IntegrationMethod::GI_GAUSS_1) {
    ...
    static inline void CalculateExtrapolationMatrixTetra(Matrix& rExtrapolationMatrix,
                                                         const GeometryData::IntegrationMethod& rIntegrationMethod)
    {
        if (rIntegrationMethod == GeometryData::IntegrationMethod::GI_GAUSS_1) {
            if ((rExtrapolationMatrix.size1() != 4) || (rExtrapolationMatrix.size2() != 1)) {
