...
public:
     ...
     * @param rParameters The constitutive-law parameters
     * @param rConstitutiveLaw The constitutive law used to calculate the perturbed stresses
     */
...
private:
    ...
    /**
     * @brief This method computes the perturbation
     * @param rStrainVector The vector of strains
     * @return The resulting perturbation
     */
