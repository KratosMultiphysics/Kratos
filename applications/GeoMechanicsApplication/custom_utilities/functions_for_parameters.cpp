...
namespace Kratos {
    ...
    Parameters FunctonsForParameters::ExtractParameters(const Parameters& rSourceParameters,
    ...
    void FunctonsForParameters::AppendParameterNameIfExists(const std::string& rParameterName,
    ...
    bool FunctonsForParameters::HasTableAttached(const Parameters& rSettings)
    {
