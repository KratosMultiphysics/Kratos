...
public:
    ...
    static Geo::PQTheta TransformPrincipalStressesToPQandTheta(const Geo::PrincipalStresses& rPrincipalStresses);
    static Geo::PrincipalStresses TransformPQThetaToPrincipalStresses(const Geo::PQTheta& rPQTheta);
