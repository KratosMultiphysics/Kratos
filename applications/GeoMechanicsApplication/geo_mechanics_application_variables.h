...
KRATOS_DEFINE_APPLICATION_VARIABLE(GEO_MECHANICS_APPLICATION, Vector, GEO_KAPPA_PIECEWISE_LINEAR_LAW)
KRATOS_DEFINE_APPLICATION_VARIABLE(GEO_MECHANICS_APPLICATION, Vector, GEO_MOMENT_PIECEWISE_LINEAR_LAW)
