...
namespace Kratos
{
    ...
    KRATOS_DEFINE_APPLICATION_VARIABLE( GEO_MECHANICS_APPLICATION, int, INDEX_2D_THERMAL_FLUX_X )
    KRATOS_DEFINE_APPLICATION_VARIABLE( GEO_MECHANICS_APPLICATION, int, INDEX_2D_THERMAL_FLUX_Y )
    KRATOS_DEFINE_APPLICATION_VARIABLE( GEO_MECHANICS_APPLICATION, int, INDEX_2D_THERMAL_FLUX_Z )
