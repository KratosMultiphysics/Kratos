...
namespace Kratos
{
    ...
    KRATOS_DEFINE_APPLICATION_VARIABLE( GEO_MECHANICS_APPLICATION, double, HEAT_CAPACITY_WATER )
    KRATOS_DEFINE_APPLICATION_VARIABLE( GEO_MECHANICS_APPLICATION, double, HEAT_CAPACITY_SOLID )
    KRATOS_DEFINE_APPLICATION_VARIABLE( GEO_MECHANICS_APPLICATION, double, THERMAL_CONDUCTIVITY_WATER )
    KRATOS_DEFINE_APPLICATION_VARIABLE( GEO_MECHANICS_APPLICATION, double, THERMAL_CONDUCTIVITY_SOLID_XX )
    KRATOS_DEFINE_APPLICATION_VARIABLE( GEO_MECHANICS_APPLICATION, double, THERMAL_CONDUCTIVITY_SOLID_YY )
    KRATOS_DEFINE_APPLICATION_VARIABLE( GEO_MECHANICS_APPLICATION, double, THERMAL_CONDUCTIVITY_SOLID_XY )
    KRATOS_DEFINE_APPLICATION_VARIABLE( GEO_MECHANICS_APPLICATION, double, THERMAL_CONDUCTIVITY_SOLID_YX )
	...
	KRATOS_DEFINE_APPLICATION_VARIABLE( GEO_MECHANICS_APPLICATION, double, RELATIVE_LENGTH )
