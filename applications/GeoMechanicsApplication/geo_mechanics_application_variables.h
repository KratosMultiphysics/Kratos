...
KRATOS_DEFINE_APPLICATION_VARIABLE(GEO_MECHANICS_APPLICATION, double, MOHR_COULOMB_YIELD_INDICATOR)
KRATOS_DEFINE_APPLICATION_VARIABLE(GEO_MECHANICS_APPLICATION, double, GEO_MOHR_COULOMB_PLASTIC_FLAG)
