...
KRATOS_DEFINE_APPLICATION_VARIABLE(GEO_MECHANICS_APPLICATION, unsigned int, GEO_COULOMB_HARDENING_MAX_ITERATIONS)
KRATOS_DEFINE_APPLICATION_VARIABLE(GEO_MECHANICS_APPLICATION, double, GEO_COULOMB_HARDENING_CONVERGENCE_TOLERANCE)
