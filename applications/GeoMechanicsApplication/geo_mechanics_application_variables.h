...
// Aliases for piecewise-linear law naming conventions
KRATOS_DEFINE_APPLICATION_VARIABLE(GEO_MECHANICS_APPLICATION, Vector, KAPPA_PIECEWISE_LINEAR_LAW)
KRATOS_DEFINE_APPLICATION_VARIABLE(GEO_MECHANICS_APPLICATION, Vector, MOMENTUM_PIECEWISE_LINEAR_LAW)
KRATOS_DEFINE_APPLICATION_VARIABLE(GEO_MECHANICS_APPLICATION, double, MAX_AXIAL_LOAD_OF_CONSTRUCTION_ELEMENT)
KRATOS_DEFINE_APPLICATION_VARIABLE(GEO_MECHANICS_APPLICATION, double, MOMENT_CAPACITY_REDUCTION_FACTOR)
KRATOS_DEFINE_APPLICATION_VARIABLE(GEO_MECHANICS_APPLICATION, double, MINIMUM_MOMENT_CAPACITY_FACTOR)
KRATOS_DEFINE_APPLICATION_VARIABLE(GEO_MECHANICS_APPLICATION, double, UNRELOAD_MODULUS)
