...
#if !defined(KRATOS_PLANE_STRESS_2D_TC_PLASTIC_DAMAGE_LAW_H_INCLUDED)
#define KRATOS_PLANE_STRESS_2D_TC_PLASTIC_DAMAGE_LAW_H_INCLUDED
...
class KRATOS_API(IGA_STRUCTURAL_MECHANICS_APPLICATION) PlaneStress2dTCPlasticDamageLaw
    : public ConstitutiveLaw
{
  public:
    ...
    KRATOS_CLASS_POINTER_DEFINITION(PlaneStress2dTCPlasticDamageLaw);
    ...
    * Default constructor.
    */
    PlaneStress2dTCPlasticDamageLaw()
    {
    }
    ...
    */
    ...
    {
        return Kratos::make_shared<PlaneStress2dTCPlasticDamageLaw>(*this);
    }

    /**
    * Copy constructor.
    */
    PlaneStress2dTCPlasticDamageLaw(const PlaneStress2dTCPlasticDamageLaw& rOther)
    ...
    * Destructor.
    */
    ~PlaneStress2dTCPlasticDamageLaw() override
    {
    }
  ...
  private:
    ...
    void CalculateUniqueDamageCriterion(
    ...
    void CalculateTresholdCompression(
        const Vector& rStressVector,
