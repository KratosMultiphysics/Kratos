...
#if !defined(KRATOS_PLANE_STRESS_2D_TC_DAMAGE_LAW_H_INCLUDED)
#define KRATOS_PLANE_STRESS_2D_TC_DAMAGE_LAW_H_INCLUDED
...
class KRATOS_API(IGA_STRUCTURAL_MECHANICS_APPLICATION) PlaneStress2dTCDamageLaw
    : public ConstitutiveLaw
{
  public:
    ...
    KRATOS_CLASS_POINTER_DEFINITION(PlaneStress2dTCDamageLaw);
    ...
    */
    ...
    {
        return Kratos::make_shared<PlaneStress2dTCDamageLaw>(*this);
    }

    /**
    * Copy constructor.
    */
    PlaneStress2dTCDamageLaw(const PlaneStress2dTCDamageLaw& rOther)
    ...
    * Destructor.
    */
    ~PlaneStress2dTCDamageLaw() override
    {
    }
