...
for i = 1:length(Variable_Solution1)
    ...
    Y1_analytical(end+1) = displacement(Variable_Solution1{i}(1));
...
ylabel('displacement [m], velocity [m/s]') % y-axis label
% plot(X1, Y1_analytical, 'color', [0,101,189]/255)
plot(X1, Y1, 'color', [217,218,219]/255)
% plot(X2, Y2_analytical, 'color', [0.0,82,147]/255)
plot(X2, Y2, 'color', [156,157,159]/255)
