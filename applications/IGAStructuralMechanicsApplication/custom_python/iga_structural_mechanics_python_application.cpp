...
namespace Python
{
  ...
  BOOST_PYTHON_MODULE(KratosIGAStructuralMechanicsApplication)
  {
	...
	KRATOS_REGISTER_IN_PYTHON_VARIABLE(DAMAGE_T_INSIDE)
	KRATOS_REGISTER_IN_PYTHON_VARIABLE(DAMAGE_T_OUTSIDE)
	KRATOS_REGISTER_IN_PYTHON_VARIABLE(DAMAGE_C)
	KRATOS_REGISTER_IN_PYTHON_VARIABLE(DAMAGE_C_INSIDE)
	KRATOS_REGISTER_IN_PYTHON_VARIABLE(DAMAGE_C_OUTSIDE)
