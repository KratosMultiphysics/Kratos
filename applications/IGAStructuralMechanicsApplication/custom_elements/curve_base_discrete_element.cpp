...
namespace Kratos
{
	...
	//************************************************************************************
	//************************************************************************************
	void CurveBaseDiscreteElement::InitializeMaterial()
	{
		KRATOS_TRY

			KRATOS_ERROR << "You have called the InitializeMaterial from the base class for discrete curve elements" << std::endl;

		KRATOS_CATCH("");
	}
	//************************************************************************************
	//************************************************************************************
	void CurveBaseDiscreteElement::FinalizeSolutionStep(
		ProcessInfo& rCurrentProcessInfo)
	{
		KRATOS_ERROR << "You have called the FinalizeSolutionStep from the base class for discrete curve elements" << std::endl;
	}

	//************************************************************************************
	//************************************************************************************
	void CurveBaseDiscreteElement::CalculateAll(
	...
	{
		KRATOS_ERROR << "You have called the CalculateAll from the base class for discrete curve elements" << std::endl;
	}

	//************************************************************************************
	//************************************************************************************
	void CurveBaseDiscreteElement::CalculateRightHandSide(
		VectorType& rRightHandSideVector,
		ProcessInfo& rCurrentProcessInfo
	)
	{
	...
	//************************************************************************************
	//************************************************************************************
	void CurveBaseDiscreteElement::CalculateLocalSystem(
		MatrixType& rLeftHandSideMatrix,
		VectorType& rRightHandSideVector,
		ProcessInfo& rCurrentProcessInfo
	)
