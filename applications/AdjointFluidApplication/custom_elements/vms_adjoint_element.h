...
public:
    ...
    typedef bounded_matrix<double, TNumNodes, TDim>
...
protected:
            ...
            const ProcessInfo& rCurrentProcessInfo)
    {
        ...
        bounded_matrix<double, TNumNodes, TDim> TauOneDeriv;
        bounded_matrix<double, TNumNodes, TDim> TauTwoDeriv;
            ...
            const ProcessInfo& rCurrentProcessInfo)
    {
        ...
        for (IndexType iCoord = 0; iCoord < TCoordLocalSize; ++iCoord)
        {
            ...
            // DN_DX'
            bounded_matrix< double, TNumNodes, TDim > DN_DX_Deriv;
            for (IndexType i = 0; i < TNumNodes; ++i)
            {
                for (IndexType d = 0; d < TDim; ++d)
                {
            ...
            bounded_matrix< double, TFluidLocalSize, TFluidLocalSize > LHS;
            ...
            const ProcessInfo& rCurrentProcessInfo)
    {
        ...
        // Grad(u)
        bounded_matrix< double, TDim, TDim > DensityGradVel;
        ...
        // ( Grad(u) * Grad(N) )^T
        bounded_matrix< double, TNumNodes, TDim > DN_DX_DensityGradVel;
    ...
    void CalculateVelocityGradient(
            bounded_matrix< double, TDim, TDim >& rGradVel,
    ...
    void AddViscousTermDerivative(
            bounded_matrix< double, TFluidLocalSize, TFluidLocalSize >& rResult,
            const ShapeFunctionDerivativesType& rDN_DX,
