...
namespace Kratos {
    ...
    class KRATOS_API(SWIMMING_DEM_APPLICATION) SchillerAndNaumann : public StokesDragLaw {

    public:
        typedef Node <3> NodeType;
        KRATOS_CLASS_POINTER_DEFINITION(SchillerAndNaumann);

        SchillerAndNaumann(): StokesDragLaw(){}
