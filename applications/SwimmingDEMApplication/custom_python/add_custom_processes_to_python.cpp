...
void  AddCustomProcessesToPython(pybind11::module& m)
{
    ...
    .def(py::init< ModelPart&, const double, const double, const double, const double, const double, const double, const double, const double, const double, const double>())
    .def(py::init< ModelPart&, Parameters& >())
    ;
