...
#include "skrzypacz_homogeneous_porosity_solution_and_body_force_process.h"
...
/* Public functions *******************************************************/
SkrzypaczHomogeneousPorositySolutionAndBodyForceProcess::SkrzypaczHomogeneousPorositySolutionAndBodyForceProcess(
...
void SkrzypaczHomogeneousPorositySolutionAndBodyForceProcess::CheckDefaultsAndProcessSettings(Parameters &rParameters)
{
...
const Parameters SkrzypaczHomogeneousPorositySolutionAndBodyForceProcess::GetDefaultParameters() const
{
...
void SkrzypaczHomogeneousPorositySolutionAndBodyForceProcess::Execute()
{
    this->ExecuteInitialize();
    this->ExecuteInitializeSolutionStep();
}

void SkrzypaczHomogeneousPorositySolutionAndBodyForceProcess::ExecuteInitialize()
{}

void SkrzypaczHomogeneousPorositySolutionAndBodyForceProcess::ExecuteBeforeSolutionLoop()
{
...
void SkrzypaczHomogeneousPorositySolutionAndBodyForceProcess::ExecuteInitializeSolutionStep()
{}

void SkrzypaczHomogeneousPorositySolutionAndBodyForceProcess::ExecuteFinalizeSolutionStep() {}

/* Protected functions ****************************************************/

void SkrzypaczHomogeneousPorositySolutionAndBodyForceProcess::SetInitialBodyForceAndPorosityField()
{
    ...
    for (auto it_node = mrModelPart.NodesBegin(); it_node != mrModelPart.NodesEnd(); it_node++){
        ...
        r_u1 = std::sin(Globals::Pi*x1)*std::sin(Globals::Pi*x2)/alpha;

        r_u2 = std::cos(Globals::Pi*x1)*std::cos(Globals::Pi*x2)/alpha;
        ...
        du11 = Globals::Pi*std::sin(Globals::Pi*x2)*std::cos(Globals::Pi*x1)/alpha;

        du12 = Globals::Pi*std::sin(Globals::Pi*x1)*std::cos(Globals::Pi*x2)/alpha;

        du111 = -std::pow(Globals::Pi,2)*std::sin(Globals::Pi*x1)*std::sin(Globals::Pi*x2)/alpha;

        du112 = std::pow(Globals::Pi,2)*std::cos(Globals::Pi*x1)*std::cos(Globals::Pi*x2)/alpha;

        du121 = std::pow(Globals::Pi,2)*std::cos(Globals::Pi*x1)*std::cos(Globals::Pi*x2)/alpha;

        du122 = -std::pow(Globals::Pi,2)*std::sin(Globals::Pi*x1)*std::sin(Globals::Pi*x2)/alpha;

        du21 = -Globals::Pi*std::sin(Globals::Pi*x1)*std::cos(Globals::Pi*x2)/alpha;

        du22 = -Globals::Pi*std::sin(Globals::Pi*x2)*std::cos(Globals::Pi*x1)/alpha;

        du211 = -std::pow(Globals::Pi,2)*std::cos(Globals::Pi*x1)*std::cos(Globals::Pi*x2)/alpha;

        du212 = std::pow(Globals::Pi,2)*std::sin(Globals::Pi*x1)*std::sin(Globals::Pi*x2)/alpha;

        du221 = std::pow(Globals::Pi,2)*std::sin(Globals::Pi*x1)*std::sin(Globals::Pi*x2)/alpha;

        du222 = -std::pow(Globals::Pi,2)*std::cos(Globals::Pi*x1)*std::cos(Globals::Pi*x2)/alpha;
...
void SkrzypaczHomogeneousPorositySolutionAndBodyForceProcess::SetFluidProperties()
{
