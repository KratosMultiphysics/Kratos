...
void HyperbolicTangentialPorositySolutionAndBodyForceProcess::SetInitialBodyForceAndPorosityField()
{
    ...
    for (auto it_node = mrModelPart.NodesBegin(); it_node != mrModelPart.NodesEnd(); it_node++){
        ...
        r_u1 = -u_char*std::pow(x1,2)*std::pow((1 - x1),2)*(u_char*std::pow(x2,2)*(2*x2 - 2) + 2*u_char*x2*std::pow((1 - x2),2))/(-c + mean_alpha*(height*std::tanh(b*(x1 - 0.5)) + 1));

        r_u2 = -u_char*std::pow(x2,2)*std::pow((1 - x2),2)*(-u_char*std::pow(x1,2)*(2*x1 - 2) - 2*u_char*x1*std::pow((1 - x1),2))/(-c + mean_alpha*(height*std::tanh(b*(x1 - 0.5)) + 1));
        ...
        du11 = b*height*mean_alpha*u_char*std::pow(x1,2)*std::pow((1 - x1),2)*(1 - std::pow(std::tanh(b*(x1 - 0.5)),2))*(u_char*std::pow(x2,2)*(2*x2 - 2) + 2*u_char*x2*std::pow((1 - x2),2))/std::pow((-c + mean_alpha*(height*std::tanh(b*(x1 - 0.5)) + 1)),2) - u_char*std::pow(x1,2)*(2*x1 - 2)*(u_char*std::pow(x2,2)*(2*x2 - 2) + 2*u_char*x2*std::pow((1 - x2),2))/(-c + mean_alpha*(height*std::tanh(b*(x1 - 0.5)) + 1)) - 2*u_char*x1*std::pow((1 - x1),2)*(u_char*std::pow(x2,2)*(2*x2 - 2) + 2*u_char*x2*std::pow((1 - x2),2))/(-c + mean_alpha*(height*std::tanh(b*(x1 - 0.5)) + 1));

        du12 = -u_char*std::pow(x1,2)*std::pow((1 - x1),2)*(2*u_char*std::pow(x2,2) + 4*u_char*x2*(2*x2 - 2) + 2*u_char*std::pow((1 - x2),2))/(-c + mean_alpha*(height*std::tanh(b*(x1 - 0.5)) + 1));

        du111 = -2*std::pow(b,2)*std::pow(height,2)*std::pow(mean_alpha,2)*u_char*std::pow(x1,2)*std::pow((1 - x1),2)*std::pow((1 - std::pow(std::tanh(b*(x1 - 0.5)),2)),2)*(u_char*std::pow(x2,2)*(2*x2 - 2) + 2*u_char*x2*std::pow((1 - x2),2))/std::pow((-c + mean_alpha*(height*std::tanh(b*(x1 - 0.5)) + 1)),3) - 2*std::pow(b,2)*height*mean_alpha*u_char*std::pow(x1,2)*std::pow((1 - x1),2)*(1 - std::pow(std::tanh(b*(x1 - 0.5)),2))*(u_char*std::pow(x2,2)*(2*x2 - 2) + 2*u_char*x2*std::pow((1 - x2),2))*std::tanh(b*(x1 - 0.5))/std::pow((-c + mean_alpha*(height*std::tanh(b*(x1 - 0.5)) + 1)),2) + 2*b*height*mean_alpha*u_char*std::pow(x1,2)*(1 - std::pow(std::tanh(b*(x1 - 0.5)),2))*(2*x1 - 2)*(u_char*std::pow(x2,2)*(2*x2 - 2) + 2*u_char*x2*std::pow((1 - x2),2))/std::pow((-c + mean_alpha*(height*std::tanh(b*(x1 - 0.5)) + 1)),2) + 4*b*height*mean_alpha*u_char*x1*std::pow((1 - x1),2)*(1 - std::pow(std::tanh(b*(x1 - 0.5)),2))*(u_char*std::pow(x2,2)*(2*x2 - 2) + 2*u_char*x2*std::pow((1 - x2),2))/std::pow((-c + mean_alpha*(height*std::tanh(b*(x1 - 0.5)) + 1)),2) - 2*u_char*std::pow(x1,2)*(u_char*std::pow(x2,2)*(2*x2 - 2) + 2*u_char*x2*std::pow((1 - x2),2))/(-c + mean_alpha*(height*std::tanh(b*(x1 - 0.5)) + 1)) - 4*u_char*x1*(2*x1 - 2)*(u_char*std::pow(x2,2)*(2*x2 - 2) + 2*u_char*x2*std::pow((1 - x2),2))/(-c + mean_alpha*(height*std::tanh(b*(x1 - 0.5)) + 1)) - 2*u_char*std::pow((1 - x1),2)*(u_char*std::pow(x2,2)*(2*x2 - 2) + 2*u_char*x2*std::pow((1 - x2),2))/(-c + mean_alpha*(height*std::tanh(b*(x1 - 0.5)) + 1));

        du112 = b*height*mean_alpha*u_char*std::pow(x1,2)*std::pow((1 - x1),2)*(1 - std::pow(std::tanh(b*(x1 - 0.5)),2))*(2*u_char*std::pow(x2,2) + 4*u_char*x2*(2*x2 - 2) + 2*u_char*std::pow((1 - x2),2))/std::pow((-c + mean_alpha*(height*std::tanh(b*(x1 - 0.5)) + 1)),2) - u_char*std::pow(x1,2)*(2*x1 - 2)*(2*u_char*std::pow(x2,2) + 4*u_char*x2*(2*x2 - 2) + 2*u_char*std::pow((1 - x2),2))/(-c + mean_alpha*(height*std::tanh(b*(x1 - 0.5)) + 1)) - 2*u_char*x1*std::pow((1 - x1),2)*(2*u_char*std::pow(x2,2) + 4*u_char*x2*(2*x2 - 2) + 2*u_char*std::pow((1 - x2),2))/(-c + mean_alpha*(height*std::tanh(b*(x1 - 0.5)) + 1));

        du121 = b*height*mean_alpha*u_char*std::pow(x1,2)*std::pow((1 - x1),2)*(1 - std::pow(std::tanh(b*(x1 - 0.5)),2))*(2*u_char*std::pow(x2,2) + 4*u_char*x2*(2*x2 - 2) + 2*u_char*std::pow((1 - x2),2))/std::pow((-c + mean_alpha*(height*std::tanh(b*(x1 - 0.5)) + 1)),2) - u_char*std::pow(x1,2)*(2*x1 - 2)*(2*u_char*std::pow(x2,2) + 4*u_char*x2*(2*x2 - 2) + 2*u_char*std::pow((1 - x2),2))/(-c + mean_alpha*(height*std::tanh(b*(x1 - 0.5)) + 1)) - 2*u_char*x1*std::pow((1 - x1),2)*(2*u_char*std::pow(x2,2) + 4*u_char*x2*(2*x2 - 2) + 2*u_char*std::pow((1 - x2),2))/(-c + mean_alpha*(height*std::tanh(b*(x1 - 0.5)) + 1));

        du122 = -u_char*std::pow(x1,2)*std::pow((1 - x1),2)*(12*u_char*x2 + 6*u_char*(2*x2 - 2))/(-c + mean_alpha*(height*std::tanh(b*(x1 - 0.5)) + 1));

        du21 = b*height*mean_alpha*u_char*std::pow(x2,2)*std::pow((1 - x2),2)*(1 - std::pow(std::tanh(b*(x1 - 0.5)),2))*(-u_char*std::pow(x1,2)*(2*x1 - 2) - 2*u_char*x1*std::pow((1 - x1),2))/std::pow((-c + mean_alpha*(height*std::tanh(b*(x1 - 0.5)) + 1)),2) - u_char*std::pow(x2,2)*std::pow((1 - x2),2)*(-2*u_char*std::pow(x1,2) - 4*u_char*x1*(2*x1 - 2) - 2*u_char*std::pow((1 - x1),2))/(-c + mean_alpha*(height*std::tanh(b*(x1 - 0.5)) + 1));

        du22 = -u_char*std::pow(x2,2)*(2*x2 - 2)*(-u_char*std::pow(x1,2)*(2*x1 - 2) - 2*u_char*x1*std::pow((1 - x1),2))/(-c + mean_alpha*(height*std::tanh(b*(x1 - 0.5)) + 1)) - 2*u_char*x2*std::pow((1 - x2),2)*(-u_char*std::pow(x1,2)*(2*x1 - 2) - 2*u_char*x1*std::pow((1 - x1),2))/(-c + mean_alpha*(height*std::tanh(b*(x1 - 0.5)) + 1));

        du211 = -2*std::pow(b,2)*std::pow(height,2)*std::pow(mean_alpha,2)*u_char*std::pow(x2,2)*std::pow((1 - x2),2)*std::pow((1 - std::pow(std::tanh(b*(x1 - 0.5)),2)),2)*(-u_char*std::pow(x1,2)*(2*x1 - 2) - 2*u_char*x1*std::pow((1 - x1),2))/std::pow((-c + mean_alpha*(height*std::tanh(b*(x1 - 0.5)) + 1)),3) - 2*std::pow(b,2)*height*mean_alpha*u_char*std::pow(x2,2)*std::pow((1 - x2),2)*(1 - std::pow(std::tanh(b*(x1 - 0.5)),2))*(-u_char*std::pow(x1,2)*(2*x1 - 2) - 2*u_char*x1*std::pow((1 - x1),2))*std::tanh(b*(x1 - 0.5))/std::pow((-c + mean_alpha*(height*std::tanh(b*(x1 - 0.5)) + 1)),2) + 2*b*height*mean_alpha*u_char*std::pow(x2,2)*std::pow((1 - x2),2)*(1 - std::pow(std::tanh(b*(x1 - 0.5)),2))*(-2*u_char*std::pow(x1,2) - 4*u_char*x1*(2*x1 - 2) - 2*u_char*std::pow((1 - x1),2))/std::pow((-c + mean_alpha*(height*std::tanh(b*(x1 - 0.5)) + 1)),2) - u_char*std::pow(x2,2)*std::pow((1 - x2),2)*(-12*u_char*x1 - 6*u_char*(2*x1 - 2))/(-c + mean_alpha*(height*std::tanh(b*(x1 - 0.5)) + 1));

        du212 = b*height*mean_alpha*u_char*std::pow(x2,2)*(1 - std::pow(std::tanh(b*(x1 - 0.5)),2))*(2*x2 - 2)*(-u_char*std::pow(x1,2)*(2*x1 - 2) - 2*u_char*x1*std::pow((1 - x1),2))/std::pow((-c + mean_alpha*(height*std::tanh(b*(x1 - 0.5)) + 1)),2) + 2*b*height*mean_alpha*u_char*x2*std::pow((1 - x2),2)*(1 - std::pow(std::tanh(b*(x1 - 0.5)),2))*(-u_char*std::pow(x1,2)*(2*x1 - 2) - 2*u_char*x1*std::pow((1 - x1),2))/std::pow((-c + mean_alpha*(height*std::tanh(b*(x1 - 0.5)) + 1)),2) - u_char*std::pow(x2,2)*(2*x2 - 2)*(-2*u_char*std::pow(x1,2) - 4*u_char*x1*(2*x1 - 2) - 2*u_char*std::pow((1 - x1),2))/(-c + mean_alpha*(height*std::tanh(b*(x1 - 0.5)) + 1)) - 2*u_char*x2*std::pow((1 - x2),2)*(-2*u_char*std::pow(x1,2) - 4*u_char*x1*(2*x1 - 2) - 2*u_char*std::pow((1 - x1),2))/(-c + mean_alpha*(height*std::tanh(b*(x1 - 0.5)) + 1));

        du221 = b*height*mean_alpha*u_char*std::pow(x2,2)*(1 - std::pow(std::tanh(b*(x1 - 0.5)),2))*(2*x2 - 2)*(-u_char*std::pow(x1,2)*(2*x1 - 2) - 2*u_char*x1*std::pow((1 - x1),2))/std::pow((-c + mean_alpha*(height*std::tanh(b*(x1 - 0.5)) + 1)),2) + 2*b*height*mean_alpha*u_char*x2*std::pow((1 - x2),2)*(1 - std::pow(std::tanh(b*(x1 - 0.5)),2))*(-u_char*std::pow(x1,2)*(2*x1 - 2) - 2*u_char*x1*std::pow((1 - x1),2))/std::pow((-c + mean_alpha*(height*std::tanh(b*(x1 - 0.5)) + 1)),2) - u_char*std::pow(x2,2)*(2*x2 - 2)*(-2*u_char*std::pow(x1,2) - 4*u_char*x1*(2*x1 - 2) - 2*u_char*std::pow((1 - x1),2))/(-c + mean_alpha*(height*std::tanh(b*(x1 - 0.5)) + 1)) - 2*u_char*x2*std::pow((1 - x2),2)*(-2*u_char*std::pow(x1,2) - 4*u_char*x1*(2*x1 - 2) - 2*u_char*std::pow((1 - x1),2))/(-c + mean_alpha*(height*std::tanh(b*(x1 - 0.5)) + 1));

        du222 = -2*u_char*std::pow(x2,2)*(-u_char*std::pow(x1,2)*(2*x1 - 2) - 2*u_char*x1*std::pow((1 - x1),2))/(-c + mean_alpha*(height*std::tanh(b*(x1 - 0.5)) + 1)) - 4*u_char*x2*(2*x2 - 2)*(-u_char*std::pow(x1,2)*(2*x1 - 2) - 2*u_char*x1*std::pow((1 - x1),2))/(-c + mean_alpha*(height*std::tanh(b*(x1 - 0.5)) + 1)) - 2*u_char*std::pow((1 - x2),2)*(-u_char*std::pow(x1,2)*(2*x1 - 2) - 2*u_char*x1*std::pow((1 - x1),2))/(-c + mean_alpha*(height*std::tanh(b*(x1 - 0.5)) + 1));
