...
#include "porosity_solution_and_sinusoidal_body_force_process.h"
...
/* Public functions *******************************************************/
PorositySolutionAndSinusoidalBodyForceProcess::PorositySolutionAndSinusoidalBodyForceProcess(
...
void PorositySolutionAndSinusoidalBodyForceProcess::CheckDefaultsAndProcessSettings(Parameters &rParameters)
{
...
void PorositySolutionAndSinusoidalBodyForceProcess::CalculateKinematicViscosity()
{
    mViscosity = mUchar * mLength / mReynoldsNumber;
}

void PorositySolutionAndSinusoidalBodyForceProcess::CalculatePermeability(double &dynamic_viscosity)
{
    mPermeability = dynamic_viscosity * mUchar / (mDamKohlerNumber * (2 * mViscosity * (mUchar/std::pow(mLength,2))));
}

const Parameters PorositySolutionAndSinusoidalBodyForceProcess::GetDefaultParameters() const
{
...
void PorositySolutionAndSinusoidalBodyForceProcess::Execute()
{
    this->ExecuteInitialize();
    this->ExecuteInitializeSolutionStep();
}

void PorositySolutionAndSinusoidalBodyForceProcess::ExecuteInitialize()
{}

void PorositySolutionAndSinusoidalBodyForceProcess::ExecuteBeforeSolutionLoop()
{
...
void PorositySolutionAndSinusoidalBodyForceProcess::ExecuteInitializeSolutionStep()
{}

void PorositySolutionAndSinusoidalBodyForceProcess::ExecuteFinalizeSolutionStep() {}

/* Protected functions ****************************************************/

void PorositySolutionAndSinusoidalBodyForceProcess::SetInitialBodyForceAndPorosityField()
{
...
void PorositySolutionAndSinusoidalBodyForceProcess::SetFluidProperties()
{
...
bool PorositySolutionAndSinusoidalBodyForceProcess::IsInsideEllipticalSupport(
    const double x1,
    const double x2,
    const double c,
    const double R)
