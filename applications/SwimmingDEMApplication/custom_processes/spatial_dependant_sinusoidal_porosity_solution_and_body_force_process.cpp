...
void SpatialDependantSinusoidalPorositySolutionAndBodyForceProcess::CheckDefaultsAndProcessSettings(Parameters &rParameters)
{
    ...
    this->CalculateWaveNumber(mMaxGradAlpha, mDeltaAlpha, mWaveNumber);
...
void SpatialDependantSinusoidalPorositySolutionAndBodyForceProcess::CalculateWaveNumber(
    ...
    double &mWaveNumber)
{
    mWaveNumber = mMaxGradAlpha / mDeltaAlpha;
...
void SpatialDependantSinusoidalPorositySolutionAndBodyForceProcess::SetInitialBodyForceAndPorosityField()
{
    ...
    for (auto it_node = mrModelPart.NodesBegin(); it_node != mrModelPart.NodesEnd(); it_node++){
        ...
        r_u1 = -u_char*std::pow(x1,2)*std::pow((1-x1),2)*(u_char*std::pow(x2,2)*(2*x2 - 2) + 2*u_char*x2*std::pow((1-x2),2))*std::exp(-1)/(delta_alpha*std::sin(k*x1)*std::cos(k*x2) + 0.5);

        r_u2 = -u_char*std::pow(x2,2)*std::pow((1-x2),2)*(-u_char*std::pow(x1,2)*(2*x1 - 2) - 2*u_char*x1*std::pow((1-x1),2))*std::exp(-1)/(delta_alpha*std::sin(k*x1)*std::cos(k*x2) + 0.5);
        ...
        du11 = delta_alpha*k*u_char*std::pow(x1,2)*std::pow((1-x1),2)*(u_char*std::pow(x2,2)*(2*x2 - 2) + 2*u_char*x2*std::pow((1-x2),2))*std::exp(-1)*std::cos(k*x1)*std::cos(k*x2)/std::pow((delta_alpha*std::sin(k*x1)*std::cos(k*x2) + 0.5),2) - u_char*std::pow(x1,2)*(2*x1 - 2)*(u_char*std::pow(x2,2)*(2*x2 - 2) + 2*u_char*x2*std::pow((1-x2),2))*std::exp(-1)/(delta_alpha*std::sin(k*x1)*std::cos(k*x2) + 0.5) - 2*u_char*x1*std::pow((1-x1),2)*(u_char*std::pow(x2,2)*(2*x2 - 2) + 2*u_char*x2*std::pow((1-x2),2))*std::exp(-1)/(delta_alpha*std::sin(k*x1)*std::cos(k*x2) + 0.5);

        du12 = -delta_alpha*k*u_char*std::pow(x1,2)*std::pow((1-x1),2)*(u_char*std::pow(x2,2)*(2*x2 - 2) + 2*u_char*x2*std::pow((1-x2),2))*std::exp(-1)*std::sin(k*x1)*std::sin(k*x2)/std::pow((delta_alpha*std::sin(k*x1)*std::cos(k*x2) + 0.5),2) - u_char*std::pow(x1,2)*std::pow((1-x1),2)*(2*u_char*std::pow(x2,2) + 4*u_char*x2*(2*x2 - 2) + 2*u_char*std::pow((1-x2),2))*std::exp(-1)/(delta_alpha*std::sin(k*x1)*std::cos(k*x2) + 0.5);

        du111 = -2*std::pow(delta_alpha,2)*std::pow(k,2)*u_char*std::pow(x1,2)*std::pow((1-x1),2)*(u_char*std::pow(x2,2)*(2*x2 - 2) + 2*u_char*x2*std::pow((1-x2),2))*std::exp(-1)*std::pow(std::cos(k*x1),2)*std::pow(std::cos(k*x2),2)/std::pow((delta_alpha*std::sin(k*x1)*std::cos(k*x2) + 0.5),3) - delta_alpha*std::pow(k,2)*u_char*std::pow(x1,2)*std::pow((1-x1),2)*(u_char*std::pow(x2,2)*(2*x2 - 2) + 2*u_char*x2*std::pow((1-x2),2))*std::exp(-1)*std::sin(k*x1)*std::cos(k*x2)/std::pow((delta_alpha*std::sin(k*x1)*std::cos(k*x2) + 0.5),2) + 2*delta_alpha*k*u_char*std::pow(x1,2)*(2*x1 - 2)*(u_char*std::pow(x2,2)*(2*x2 - 2) + 2*u_char*x2*std::pow((1-x2),2))*std::exp(-1)*std::cos(k*x1)*std::cos(k*x2)/std::pow((delta_alpha*std::sin(k*x1)*std::cos(k*x2) + 0.5),2) + 4*delta_alpha*k*u_char*x1*std::pow((1-x1),2)*(u_char*std::pow(x2,2)*(2*x2 - 2) + 2*u_char*x2*std::pow((1-x2),2))*std::exp(-1)*std::cos(k*x1)*std::cos(k*x2)/std::pow((delta_alpha*std::sin(k*x1)*std::cos(k*x2) + 0.5),2) - 2*u_char*std::pow(x1,2)*(u_char*std::pow(x2,2)*(2*x2 - 2) + 2*u_char*x2*std::pow((1-x2),2))*std::exp(-1)/(delta_alpha*std::sin(k*x1)*std::cos(k*x2) + 0.5) - 4*u_char*x1*(2*x1 - 2)*(u_char*std::pow(x2,2)*(2*x2 - 2) + 2*u_char*x2*std::pow((1-x2),2))*std::exp(-1)/(delta_alpha*std::sin(k*x1)*std::cos(k*x2) + 0.5) - 2*u_char*std::pow((1-x1),2)*(u_char*std::pow(x2,2)*(2*x2 - 2) + 2*u_char*x2*std::pow((1-x2),2))*std::exp(-1)/(delta_alpha*std::sin(k*x1)*std::cos(k*x2) + 0.5);

        du112 = 2*std::pow(delta_alpha,2)*std::pow(k,2)*u_char*std::pow(x1,2)*std::pow((1-x1),2)*(u_char*std::pow(x2,2)*(2*x2 - 2) + 2*u_char*x2*std::pow((1-x2),2))*std::exp(-1)*std::sin(k*x1)*std::sin(k*x2)*std::cos(k*x1)*std::cos(k*x2)/std::pow((delta_alpha*std::sin(k*x1)*std::cos(k*x2) + 0.5),3) - delta_alpha*std::pow(k,2)*u_char*std::pow(x1,2)*std::pow((1-x1),2)*(u_char*std::pow(x2,2)*(2*x2 - 2) + 2*u_char*x2*std::pow((1-x2),2))*std::exp(-1)*std::sin(k*x2)*std::cos(k*x1)/std::pow((delta_alpha*std::sin(k*x1)*std::cos(k*x2) + 0.5),2) + delta_alpha*k*u_char*std::pow(x1,2)*std::pow((1-x1),2)*(2*u_char*std::pow(x2,2) + 4*u_char*x2*(2*x2 - 2) + 2*u_char*std::pow((1-x2),2))*std::exp(-1)*std::cos(k*x1)*std::cos(k*x2)/std::pow((delta_alpha*std::sin(k*x1)*std::cos(k*x2) + 0.5),2) - delta_alpha*k*u_char*std::pow(x1,2)*(2*x1 - 2)*(u_char*std::pow(x2,2)*(2*x2 - 2) + 2*u_char*x2*std::pow((1-x2),2))*std::exp(-1)*std::sin(k*x1)*std::sin(k*x2)/std::pow((delta_alpha*std::sin(k*x1)*std::cos(k*x2) + 0.5),2) - 2*delta_alpha*k*u_char*x1*std::pow((1-x1),2)*(u_char*std::pow(x2,2)*(2*x2 - 2) + 2*u_char*x2*std::pow((1-x2),2))*std::exp(-1)*std::sin(k*x1)*std::sin(k*x2)/std::pow((delta_alpha*std::sin(k*x1)*std::cos(k*x2) + 0.5),2) - u_char*std::pow(x1,2)*(2*x1 - 2)*(2*u_char*std::pow(x2,2) + 4*u_char*x2*(2*x2 - 2) + 2*u_char*std::pow((1-x2),2))*std::exp(-1)/(delta_alpha*std::sin(k*x1)*std::cos(k*x2) + 0.5) - 2*u_char*x1*std::pow((1-x1),2)*(2*u_char*std::pow(x2,2) + 4*u_char*x2*(2*x2 - 2) + 2*u_char*std::pow((1-x2),2))*std::exp(-1)/(delta_alpha*std::sin(k*x1)*std::cos(k*x2) + 0.5);

        du121 = 2*std::pow(delta_alpha,2)*std::pow(k,2)*u_char*std::pow(x1,2)*std::pow((1-x1),2)*(u_char*std::pow(x2,2)*(2*x2 - 2) + 2*u_char*x2*std::pow((1-x2),2))*std::exp(-1)*std::sin(k*x1)*std::sin(k*x2)*std::cos(k*x1)*std::cos(k*x2)/std::pow((delta_alpha*std::sin(k*x1)*std::cos(k*x2) + 0.5),3) - delta_alpha*std::pow(k,2)*u_char*std::pow(x1,2)*std::pow((1-x1),2)*(u_char*std::pow(x2,2)*(2*x2 - 2) + 2*u_char*x2*std::pow((1-x2),2))*std::exp(-1)*std::sin(k*x2)*std::cos(k*x1)/std::pow((delta_alpha*std::sin(k*x1)*std::cos(k*x2) + 0.5),2) + delta_alpha*k*u_char*std::pow(x1,2)*std::pow((1-x1),2)*(2*u_char*std::pow(x2,2) + 4*u_char*x2*(2*x2 - 2) + 2*u_char*std::pow((1-x2),2))*std::exp(-1)*std::cos(k*x1)*std::cos(k*x2)/std::pow((delta_alpha*std::sin(k*x1)*std::cos(k*x2) + 0.5),2) - delta_alpha*k*u_char*std::pow(x1,2)*(2*x1 - 2)*(u_char*std::pow(x2,2)*(2*x2 - 2) + 2*u_char*x2*std::pow((1-x2),2))*std::exp(-1)*std::sin(k*x1)*std::sin(k*x2)/std::pow((delta_alpha*std::sin(k*x1)*std::cos(k*x2) + 0.5),2) - 2*delta_alpha*k*u_char*x1*std::pow((1-x1),2)*(u_char*std::pow(x2,2)*(2*x2 - 2) + 2*u_char*x2*std::pow((1-x2),2))*std::exp(-1)*std::sin(k*x1)*std::sin(k*x2)/std::pow((delta_alpha*std::sin(k*x1)*std::cos(k*x2) + 0.5),2) - u_char*std::pow(x1,2)*(2*x1 - 2)*(2*u_char*std::pow(x2,2) + 4*u_char*x2*(2*x2 - 2) + 2*u_char*std::pow((1-x2),2))*std::exp(-1)/(delta_alpha*std::sin(k*x1)*std::cos(k*x2) + 0.5) - 2*u_char*x1*std::pow((1-x1),2)*(2*u_char*std::pow(x2,2) + 4*u_char*x2*(2*x2 - 2) + 2*u_char*std::pow((1-x2),2))*std::exp(-1)/(delta_alpha*std::sin(k*x1)*std::cos(k*x2) + 0.5);

        du122 = -2*std::pow(delta_alpha,2)*std::pow(k,2)*u_char*std::pow(x1,2)*std::pow((1-x1),2)*(u_char*std::pow(x2,2)*(2*x2 - 2) + 2*u_char*x2*std::pow((1-x2),2))*std::exp(-1)*std::pow(std::sin(k*x1),2)*std::pow(std::sin(k*x2),2)/std::pow((delta_alpha*std::sin(k*x1)*std::cos(k*x2) + 0.5),3) - delta_alpha*std::pow(k,2)*u_char*std::pow(x1,2)*std::pow((1-x1),2)*(u_char*std::pow(x2,2)*(2*x2 - 2) + 2*u_char*x2*std::pow((1-x2),2))*std::exp(-1)*std::sin(k*x1)*std::cos(k*x2)/std::pow((delta_alpha*std::sin(k*x1)*std::cos(k*x2) + 0.5),2) - 2*delta_alpha*k*u_char*std::pow(x1,2)*std::pow((1-x1),2)*(2*u_char*std::pow(x2,2) + 4*u_char*x2*(2*x2 - 2) + 2*u_char*std::pow((1-x2),2))*std::exp(-1)*std::sin(k*x1)*std::sin(k*x2)/std::pow((delta_alpha*std::sin(k*x1)*std::cos(k*x2) + 0.5),2) - u_char*std::pow(x1,2)*std::pow((1-x1),2)*(12*u_char*x2 + 6*u_char*(2*x2 - 2))*std::exp(-1)/(delta_alpha*std::sin(k*x1)*std::cos(k*x2) + 0.5);

        du21 = delta_alpha*k*u_char*std::pow(x2,2)*std::pow((1-x2),2)*(-u_char*std::pow(x1,2)*(2*x1 - 2) - 2*u_char*x1*std::pow((1-x1),2))*std::exp(-1)*std::cos(k*x1)*std::cos(k*x2)/std::pow((delta_alpha*std::sin(k*x1)*std::cos(k*x2) + 0.5),2) - u_char*std::pow(x2,2)*std::pow((1-x2),2)*(-2*u_char*std::pow(x1,2) - 4*u_char*x1*(2*x1 - 2) - 2*u_char*std::pow((1-x1),2))*std::exp(-1)/(delta_alpha*std::sin(k*x1)*std::cos(k*x2) + 0.5);

        du22 = -delta_alpha*k*u_char*std::pow(x2,2)*std::pow((1-x2),2)*(-u_char*std::pow(x1,2)*(2*x1 - 2) - 2*u_char*x1*std::pow((1-x1),2))*std::exp(-1)*std::sin(k*x1)*std::sin(k*x2)/std::pow((delta_alpha*std::sin(k*x1)*std::cos(k*x2) + 0.5),2) - u_char*std::pow(x2,2)*(2*x2 - 2)*(-u_char*std::pow(x1,2)*(2*x1 - 2) - 2*u_char*x1*std::pow((1-x1),2))*std::exp(-1)/(delta_alpha*std::sin(k*x1)*std::cos(k*x2) + 0.5) - 2*u_char*x2*std::pow((1-x2),2)*(-u_char*std::pow(x1,2)*(2*x1 - 2) - 2*u_char*x1*std::pow((1-x1),2))*std::exp(-1)/(delta_alpha*std::sin(k*x1)*std::cos(k*x2) + 0.5);

        du211 = -2*std::pow(delta_alpha,2)*std::pow(k,2)*u_char*std::pow(x2,2)*std::pow((1-x2),2)*(-u_char*std::pow(x1,2)*(2*x1 - 2) - 2*u_char*x1*std::pow((1-x1),2))*std::exp(-1)*std::pow(std::cos(k*x1),2)*std::pow(std::cos(k*x2),2)/std::pow((delta_alpha*std::sin(k*x1)*std::cos(k*x2) + 0.5),3) - delta_alpha*std::pow(k,2)*u_char*std::pow(x2,2)*std::pow((1-x2),2)*(-u_char*std::pow(x1,2)*(2*x1 - 2) - 2*u_char*x1*std::pow((1-x1),2))*std::exp(-1)*std::sin(k*x1)*std::cos(k*x2)/std::pow((delta_alpha*std::sin(k*x1)*std::cos(k*x2) + 0.5),2) + 2*delta_alpha*k*u_char*std::pow(x2,2)*std::pow((1-x2),2)*(-2*u_char*std::pow(x1,2) - 4*u_char*x1*(2*x1 - 2) - 2*u_char*std::pow((1-x1),2))*std::exp(-1)*std::cos(k*x1)*std::cos(k*x2)/std::pow((delta_alpha*std::sin(k*x1)*std::cos(k*x2) + 0.5),2) - u_char*std::pow(x2,2)*std::pow((1-x2),2)*(-12*u_char*x1 - 6*u_char*(2*x1 - 2))*std::exp(-1)/(delta_alpha*std::sin(k*x1)*std::cos(k*x2) + 0.5);

        du212 = 2*std::pow(delta_alpha,2)*std::pow(k,2)*u_char*std::pow(x2,2)*std::pow((1-x2),2)*(-u_char*std::pow(x1,2)*(2*x1 - 2) - 2*u_char*x1*std::pow((1-x1),2))*std::exp(-1)*std::sin(k*x1)*std::sin(k*x2)*std::cos(k*x1)*std::cos(k*x2)/std::pow((delta_alpha*std::sin(k*x1)*std::cos(k*x2) + 0.5),3) - delta_alpha*std::pow(k,2)*u_char*std::pow(x2,2)*std::pow((1-x2),2)*(-u_char*std::pow(x1,2)*(2*x1 - 2) - 2*u_char*x1*std::pow((1-x1),2))*std::exp(-1)*std::sin(k*x2)*std::cos(k*x1)/std::pow((delta_alpha*std::sin(k*x1)*std::cos(k*x2) + 0.5),2) - delta_alpha*k*u_char*std::pow(x2,2)*std::pow((1-x2),2)*(-2*u_char*std::pow(x1,2) - 4*u_char*x1*(2*x1 - 2) - 2*u_char*std::pow((1-x1),2))*std::exp(-1)*std::sin(k*x1)*std::sin(k*x2)/std::pow((delta_alpha*std::sin(k*x1)*std::cos(k*x2) + 0.5),2) + delta_alpha*k*u_char*std::pow(x2,2)*(2*x2 - 2)*(-u_char*std::pow(x1,2)*(2*x1 - 2) - 2*u_char*x1*std::pow((1-x1),2))*std::exp(-1)*std::cos(k*x1)*std::cos(k*x2)/std::pow((delta_alpha*std::sin(k*x1)*std::cos(k*x2) + 0.5),2) + 2*delta_alpha*k*u_char*x2*std::pow((1-x2),2)*(-u_char*std::pow(x1,2)*(2*x1 - 2) - 2*u_char*x1*std::pow((1-x1),2))*std::exp(-1)*std::cos(k*x1)*std::cos(k*x2)/std::pow((delta_alpha*std::sin(k*x1)*std::cos(k*x2) + 0.5),2) - u_char*std::pow(x2,2)*(2*x2 - 2)*(-2*u_char*std::pow(x1,2) - 4*u_char*x1*(2*x1 - 2) - 2*u_char*std::pow((1-x1),2))*std::exp(-1)/(delta_alpha*std::sin(k*x1)*std::cos(k*x2) + 0.5) - 2*u_char*x2*std::pow((1-x2),2)*(-2*u_char*std::pow(x1,2) - 4*u_char*x1*(2*x1 - 2) - 2*u_char*std::pow((1-x1),2))*std::exp(-1)/(delta_alpha*std::sin(k*x1)*std::cos(k*x2) + 0.5);

        du221 = 2*std::pow(delta_alpha,2)*std::pow(k,2)*u_char*std::pow(x2,2)*std::pow((1-x2),2)*(-u_char*std::pow(x1,2)*(2*x1 - 2) - 2*u_char*x1*std::pow((1-x1),2))*std::exp(-1)*std::sin(k*x1)*std::sin(k*x2)*std::cos(k*x1)*std::cos(k*x2)/std::pow((delta_alpha*std::sin(k*x1)*std::cos(k*x2) + 0.5),3) - delta_alpha*std::pow(k,2)*u_char*std::pow(x2,2)*std::pow((1-x2),2)*(-u_char*std::pow(x1,2)*(2*x1 - 2) - 2*u_char*x1*std::pow((1-x1),2))*std::exp(-1)*std::sin(k*x2)*std::cos(k*x1)/std::pow((delta_alpha*std::sin(k*x1)*std::cos(k*x2) + 0.5),2) - delta_alpha*k*u_char*std::pow(x2,2)*std::pow((1-x2),2)*(-2*u_char*std::pow(x1,2) - 4*u_char*x1*(2*x1 - 2) - 2*u_char*std::pow((1-x1),2))*std::exp(-1)*std::sin(k*x1)*std::sin(k*x2)/std::pow((delta_alpha*std::sin(k*x1)*std::cos(k*x2) + 0.5),2) + delta_alpha*k*u_char*std::pow(x2,2)*(2*x2 - 2)*(-u_char*std::pow(x1,2)*(2*x1 - 2) - 2*u_char*x1*std::pow((1-x1),2))*std::exp(-1)*std::cos(k*x1)*std::cos(k*x2)/std::pow((delta_alpha*std::sin(k*x1)*std::cos(k*x2) + 0.5),2) + 2*delta_alpha*k*u_char*x2*std::pow((1-x2),2)*(-u_char*std::pow(x1,2)*(2*x1 - 2) - 2*u_char*x1*std::pow((1-x1),2))*std::exp(-1)*std::cos(k*x1)*std::cos(k*x2)/std::pow((delta_alpha*std::sin(k*x1)*std::cos(k*x2) + 0.5),2) - u_char*std::pow(x2,2)*(2*x2 - 2)*(-2*u_char*std::pow(x1,2) - 4*u_char*x1*(2*x1 - 2) - 2*u_char*std::pow((1-x1),2))*std::exp(-1)/(delta_alpha*std::sin(k*x1)*std::cos(k*x2) + 0.5) - 2*u_char*x2*std::pow((1-x2),2)*(-2*u_char*std::pow(x1,2) - 4*u_char*x1*(2*x1 - 2) - 2*u_char*std::pow((1-x1),2))*std::exp(-1)/(delta_alpha*std::sin(k*x1)*std::cos(k*x2) + 0.5);

        du222 = -2*std::pow(delta_alpha,2)*std::pow(k,2)*u_char*std::pow(x2,2)*std::pow((1-x2),2)*(-u_char*std::pow(x1,2)*(2*x1 - 2) - 2*u_char*x1*std::pow((1-x1),2))*std::exp(-1)*std::pow(std::sin(k*x1),2)*std::pow(std::sin(k*x2),2)/std::pow((delta_alpha*std::sin(k*x1)*std::cos(k*x2) + 0.5),3) - delta_alpha*std::pow(k,2)*u_char*std::pow(x2,2)*std::pow((1-x2),2)*(-u_char*std::pow(x1,2)*(2*x1 - 2) - 2*u_char*x1*std::pow((1-x1),2))*std::exp(-1)*std::sin(k*x1)*std::cos(k*x2)/std::pow((delta_alpha*std::sin(k*x1)*std::cos(k*x2) + 0.5),2) - 2*delta_alpha*k*u_char*std::pow(x2,2)*(2*x2 - 2)*(-u_char*std::pow(x1,2)*(2*x1 - 2) - 2*u_char*x1*std::pow((1-x1),2))*std::exp(-1)*std::sin(k*x1)*std::sin(k*x2)/std::pow((delta_alpha*std::sin(k*x1)*std::cos(k*x2) + 0.5),2) - 4*delta_alpha*k*u_char*x2*std::pow((1-x2),2)*(-u_char*std::pow(x1,2)*(2*x1 - 2) - 2*u_char*x1*std::pow((1-x1),2))*std::exp(-1)*std::sin(k*x1)*std::sin(k*x2)/std::pow((delta_alpha*std::sin(k*x1)*std::cos(k*x2) + 0.5),2) - 2*u_char*std::pow(x2,2)*(-u_char*std::pow(x1,2)*(2*x1 - 2) - 2*u_char*x1*std::pow((1-x1),2))*std::exp(-1)/(delta_alpha*std::sin(k*x1)*std::cos(k*x2) + 0.5) - 4*u_char*x2*(2*x2 - 2)*(-u_char*std::pow(x1,2)*(2*x1 - 2) - 2*u_char*x1*std::pow((1-x1),2))*std::exp(-1)/(delta_alpha*std::sin(k*x1)*std::cos(k*x2) + 0.5) - 2*u_char*std::pow((1-x2),2)*(-u_char*std::pow(x1,2)*(2*x1 - 2) - 2*u_char*x1*std::pow((1-x1),2))*std::exp(-1)/(delta_alpha*std::sin(k*x1)*std::cos(k*x2) + 0.5);
