...
void NonDivergenceFreeTransientPorositySolutionTransientBodyForceProcess::SetBodyForceAndPorosityField()
{
    ...
    for (auto it_node = mrModelPart.NodesBegin(); it_node != mrModelPart.NodesEnd(); it_node++){
        ...
        if (step == 0){
            ...
            r_u11 = -0.25*omega*x2*(1 - alpha_min)*(2*x1*(x1 + std::sin(2*x1 + 2*x2)) + std::cos(2*x1 + 2*x2))*std::sin(omega*(time-delta_time))*std::cos(omega*(time-delta_time))/(alpha_min + x1*x2*(1 - alpha_min)*std::pow(std::sin(omega*(time-delta_time)),2));

            r_u21 = 0.25*omega*x1*(1 - alpha_min)*(2*x2*(-x2 + std::sin(2*x1 + 2*x2)) + std::cos(2*x1 + 2*x2))*std::sin(omega*(time-delta_time))*std::cos(omega*(time-delta_time))/(alpha_min + x1*x2*(1 - alpha_min)*std::pow(std::sin(omega*(time-delta_time)),2));

            r_u12 = -0.25*omega*x2*(1 - alpha_min)*(2*x1*(x1 + std::sin(2*x1 + 2*x2)) + std::cos(2*x1 + 2*x2))*std::sin(omega*(time-2.0*delta_time))*std::cos(omega*(time-2.0*delta_time))/(alpha_min + x1*x2*(1 - alpha_min)*std::pow(std::sin(omega*(time-2.0*delta_time)),2));

            r_u22 = 0.25*omega*x1*(1 - alpha_min)*(2*x2*(-x2 + std::sin(2*x1 + 2*x2)) + std::cos(2*x1 + 2*x2))*std::sin(omega*(time-2.0*delta_time))*std::cos(omega*(time-2.0*delta_time))/(alpha_min + x1*x2*(1 - alpha_min)*std::pow(std::sin(omega*(time-2.0*delta_time)),2));

        }

        r_alpha = alpha_min + x1*x2*(1 - alpha_min)*std::pow(std::sin(omega*time),2);

        r_u1 = -0.25*omega*x2*(1 - alpha_min)*(2*x1*(x1 + std::sin(2*x1 + 2*x2)) + std::cos(2*x1 + 2*x2))*std::sin(omega*time)*std::cos(omega*time)/(alpha_min + x1*x2*(1 - alpha_min)*std::pow(std::sin(omega*time),2));

        r_u2 = 0.25*omega*x1*(1 - alpha_min)*(2*x2*(-x2 + std::sin(2*x1 + 2*x2)) + std::cos(2*x1 + 2*x2))*std::sin(omega*time)*std::cos(omega*time)/(alpha_min + x1*x2*(1 - alpha_min)*std::pow(std::sin(omega*time),2));

        du1dt = 0.5*std::pow(omega,2)*x1*std::pow(x2,2)*std::pow((1 - alpha_min),2)*(2*x1*(x1 + std::sin(2*x1 + 2*x2)) + std::cos(2*x1 + 2*x2))*std::pow(std::sin(omega*time),2)*std::pow(std::cos(omega*time),2)/std::pow((alpha_min + x1*x2*(1 - alpha_min)*std::pow(std::sin(omega*time),2)),2) + 0.25*std::pow(omega,2)*x2*(1 - alpha_min)*(2*x1*(x1 + std::sin(2*x1 + 2*x2)) + std::cos(2*x1 + 2*x2))*std::pow(std::sin(omega*time),2)/(alpha_min + x1*x2*(1 - alpha_min)*std::pow(std::sin(omega*time),2)) - 0.25*std::pow(omega,2)*x2*(1 - alpha_min)*(2*x1*(x1 + std::sin(2*x1 + 2*x2)) + std::cos(2*x1 + 2*x2))*std::pow(std::cos(omega*time),2)/(alpha_min + x1*x2*(1 - alpha_min)*std::pow(std::sin(omega*time),2));

        du2dt = -0.5*std::pow(omega,2)*std::pow(x1,2)*x2*std::pow((1 - alpha_min),2)*(2*x2*(-x2 + std::sin(2*x1 + 2*x2)) + std::cos(2*x1 + 2*x2))*std::pow(std::sin(omega*time),2)*std::pow(std::cos(omega*time),2)/std::pow((alpha_min + x1*x2*(1 - alpha_min)*std::pow(std::sin(omega*time),2)),2) - 0.25*std::pow(omega,2)*x1*(1 - alpha_min)*(2*x2*(-x2 + std::sin(2*x1 + 2*x2)) + std::cos(2*x1 + 2*x2))*std::pow(std::sin(omega*time),2)/(alpha_min + x1*x2*(1 - alpha_min)*std::pow(std::sin(omega*time),2)) + 0.25*std::pow(omega,2)*x1*(1 - alpha_min)*(2*x2*(-x2 + std::sin(2*x1 + 2*x2)) + std::cos(2*x1 + 2*x2))*std::pow(std::cos(omega*time),2)/(alpha_min + x1*x2*(1 - alpha_min)*std::pow(std::sin(omega*time),2));

        r_dalphat = 2*omega*x1*x2*(1 - alpha_min)*std::sin(omega*time)*std::cos(omega*time);

        r_alpha1 = x2*(1 - alpha_min)*std::pow(std::sin(omega*time),2);

        r_alpha2 = x1*(1 - alpha_min)*std::pow(std::sin(omega*time),2);

        du11 = 0.25*omega*std::pow(x2,2)*std::pow((1 - alpha_min),2)*(2*x1*(x1 + std::sin(2*x1 + 2*x2)) + std::cos(2*x1 + 2*x2))*std::pow(std::sin(omega*time),3)*std::cos(omega*time)/std::pow((alpha_min + x1*x2*(1 - alpha_min)*std::pow(std::sin(omega*time),2)),2) - 0.25*omega*x2*(1 - alpha_min)*(2*x1*(2*std::cos(2*x1 + 2*x2) + 1) + 2*x1)*std::sin(omega*time)*std::cos(omega*time)/(alpha_min + x1*x2*(1 - alpha_min)*std::pow(std::sin(omega*time),2));

        du12 = 0.25*omega*x1*x2*std::pow((1 - alpha_min),2)*(2*x1*(x1 + std::sin(2*x1 + 2*x2)) + std::cos(2*x1 + 2*x2))*std::pow(std::sin(omega*time),3)*std::cos(omega*time)/std::pow((alpha_min + x1*x2*(1 - alpha_min)*std::pow(std::sin(omega*time),2)),2) - 0.25*omega*x2*(1 - alpha_min)*(4*x1*std::cos(2*x1 + 2*x2) - 2*std::sin(2*x1 + 2*x2))*std::sin(omega*time)*std::cos(omega*time)/(alpha_min + x1*x2*(1 - alpha_min)*std::pow(std::sin(omega*time),2)) - 0.25*omega*(1 - alpha_min)*(2*x1*(x1 + std::sin(2*x1 + 2*x2)) + std::cos(2*x1 + 2*x2))*std::sin(omega*time)*std::cos(omega*time)/(alpha_min + x1*x2*(1 - alpha_min)*std::pow(std::sin(omega*time),2));

        du111 = -0.5*omega*std::pow(x2,3)*std::pow((1 - alpha_min),3)*(2*x1*(x1 + std::sin(2*x1 + 2*x2)) + std::cos(2*x1 + 2*x2))*std::pow(std::sin(omega*time),5)*std::cos(omega*time)/std::pow((alpha_min + x1*x2*(1 - alpha_min)*std::pow(std::sin(omega*time),2)),3) + 0.5*omega*std::pow(x2,2)*std::pow((1 - alpha_min),2)*(2*x1*(2*std::cos(2*x1 + 2*x2) + 1) + 2*x1)*std::pow(std::sin(omega*time),3)*std::cos(omega*time)/std::pow((alpha_min + x1*x2*(1 - alpha_min)*std::pow(std::sin(omega*time),2)),2) - 0.25*omega*x2*(1 - alpha_min)*(-8*x1*std::sin(2*x1 + 2*x2) + 4*std::cos(2*x1 + 2*x2) + 4)*std::sin(omega*time)*std::cos(omega*time)/(alpha_min + x1*x2*(1 - alpha_min)*std::pow(std::sin(omega*time),2));

        du112 = -0.5*omega*x1*std::pow(x2,2)*std::pow((1 - alpha_min),3)*(2*x1*(x1 + std::sin(2*x1 + 2*x2)) + std::cos(2*x1 + 2*x2))*std::pow(std::sin(omega*time),5)*std::cos(omega*time)/std::pow((alpha_min + x1*x2*(1 - alpha_min)*std::pow(std::sin(omega*time),2)),3) + 0.25*omega*x1*x2*std::pow((1 - alpha_min),2)*(2*x1*(2*std::cos(2*x1 + 2*x2) + 1) + 2*x1)*std::pow(std::sin(omega*time),3)*std::cos(omega*time)/std::pow((alpha_min + x1*x2*(1 - alpha_min)*std::pow(std::sin(omega*time),2)),2) + 2.0*omega*x1*x2*(1 - alpha_min)*std::sin(omega*time)*std::sin(2*x1 + 2*x2)*std::cos(omega*time)/(alpha_min + x1*x2*(1 - alpha_min)*std::pow(std::sin(omega*time),2)) + 0.25*omega*std::pow(x2,2)*std::pow((1 - alpha_min),2)*(4*x1*std::cos(2*x1 + 2*x2) - 2*std::sin(2*x1 + 2*x2))*std::pow(std::sin(omega*time),3)*std::cos(omega*time)/std::pow((alpha_min + x1*x2*(1 - alpha_min)*std::pow(std::sin(omega*time),2)),2) + 0.5*omega*x2*std::pow((1 - alpha_min),2)*(2*x1*(x1 + std::sin(2*x1 + 2*x2)) + std::cos(2*x1 + 2*x2))*std::pow(std::sin(omega*time),3)*std::cos(omega*time)/std::pow((alpha_min + x1*x2*(1 - alpha_min)*std::pow(std::sin(omega*time),2)),2) - 0.25*omega*(1 - alpha_min)*(2*x1*(2*std::cos(2*x1 + 2*x2) + 1) + 2*x1)*std::sin(omega*time)*std::cos(omega*time)/(alpha_min + x1*x2*(1 - alpha_min)*std::pow(std::sin(omega*time),2));

        du121 = -0.5*omega*x1*std::pow(x2,2)*std::pow((1 - alpha_min),3)*(2*x1*(x1 + std::sin(2*x1 + 2*x2)) + std::cos(2*x1 + 2*x2))*std::pow(std::sin(omega*time),5)*std::cos(omega*time)/std::pow((alpha_min + x1*x2*(1 - alpha_min)*std::pow(std::sin(omega*time),2)),3) + 0.25*omega*x1*x2*std::pow((1 - alpha_min),2)*(2*x1*(2*std::cos(2*x1 + 2*x2) + 1) + 2*x1)*std::pow(std::sin(omega*time),3)*std::cos(omega*time)/std::pow((alpha_min + x1*x2*(1 - alpha_min)*std::pow(std::sin(omega*time),2)),2) + 2.0*omega*x1*x2*(1 - alpha_min)*std::sin(omega*time)*std::sin(2*x1 + 2*x2)*std::cos(omega*time)/(alpha_min + x1*x2*(1 - alpha_min)*std::pow(std::sin(omega*time),2)) + 0.25*omega*std::pow(x2,2)*std::pow((1 - alpha_min),2)*(4*x1*std::cos(2*x1 + 2*x2) - 2*std::sin(2*x1 + 2*x2))*std::pow(std::sin(omega*time),3)*std::cos(omega*time)/std::pow((alpha_min + x1*x2*(1 - alpha_min)*std::pow(std::sin(omega*time),2)),2) + 0.5*omega*x2*std::pow((1 - alpha_min),2)*(2*x1*(x1 + std::sin(2*x1 + 2*x2)) + std::cos(2*x1 + 2*x2))*std::pow(std::sin(omega*time),3)*std::cos(omega*time)/std::pow((alpha_min + x1*x2*(1 - alpha_min)*std::pow(std::sin(omega*time),2)),2) - 0.25*omega*(1 - alpha_min)*(2*x1*(2*std::cos(2*x1 + 2*x2) + 1) + 2*x1)*std::sin(omega*time)*std::cos(omega*time)/(alpha_min + x1*x2*(1 - alpha_min)*std::pow(std::sin(omega*time),2));

        du122 = -0.5*omega*std::pow(x1,2)*x2*std::pow((1 - alpha_min),3)*(2*x1*(x1 + std::sin(2*x1 + 2*x2)) + std::cos(2*x1 + 2*x2))*std::pow(std::sin(omega*time),5)*std::cos(omega*time)/std::pow((alpha_min + x1*x2*(1 - alpha_min)*std::pow(std::sin(omega*time),2)),3) + 0.5*omega*x1*x2*std::pow((1 - alpha_min),2)*(4*x1*std::cos(2*x1 + 2*x2) - 2*std::sin(2*x1 + 2*x2))*std::pow(std::sin(omega*time),3)*std::cos(omega*time)/std::pow((alpha_min + x1*x2*(1 - alpha_min)*std::pow(std::sin(omega*time),2)),2) + 0.5*omega*x1*std::pow((1 - alpha_min),2)*(2*x1*(x1 + std::sin(2*x1 + 2*x2)) + std::cos(2*x1 + 2*x2))*std::pow(std::sin(omega*time),3)*std::cos(omega*time)/std::pow((alpha_min + x1*x2*(1 - alpha_min)*std::pow(std::sin(omega*time),2)),2) - 0.25*omega*x2*(1 - alpha_min)*(-8*x1*std::sin(2*x1 + 2*x2) - 4*std::cos(2*x1 + 2*x2))*std::sin(omega*time)*std::cos(omega*time)/(alpha_min + x1*x2*(1 - alpha_min)*std::pow(std::sin(omega*time),2)) - 0.5*omega*(1 - alpha_min)*(4*x1*std::cos(2*x1 + 2*x2) - 2*std::sin(2*x1 + 2*x2))*std::sin(omega*time)*std::cos(omega*time)/(alpha_min + x1*x2*(1 - alpha_min)*std::pow(std::sin(omega*time),2));

        du21 = -0.25*omega*x1*x2*std::pow((1 - alpha_min),2)*(2*x2*(-x2 + std::sin(2*x1 + 2*x2)) + std::cos(2*x1 + 2*x2))*std::pow(std::sin(omega*time),3)*std::cos(omega*time)/std::pow((alpha_min + x1*x2*(1 - alpha_min)*std::pow(std::sin(omega*time),2)),2) + 0.25*omega*x1*(1 - alpha_min)*(4*x2*std::cos(2*x1 + 2*x2) - 2*std::sin(2*x1 + 2*x2))*std::sin(omega*time)*std::cos(omega*time)/(alpha_min + x1*x2*(1 - alpha_min)*std::pow(std::sin(omega*time),2)) + 0.25*omega*(1 - alpha_min)*(2*x2*(-x2 + std::sin(2*x1 + 2*x2)) + std::cos(2*x1 + 2*x2))*std::sin(omega*time)*std::cos(omega*time)/(alpha_min + x1*x2*(1 - alpha_min)*std::pow(std::sin(omega*time),2));

        du22 = -0.25*omega*std::pow(x1,2)*std::pow((1 - alpha_min),2)*(2*x2*(-x2 + std::sin(2*x1 + 2*x2)) + std::cos(2*x1 + 2*x2))*std::pow(std::sin(omega*time),3)*std::cos(omega*time)/std::pow((alpha_min + x1*x2*(1 - alpha_min)*std::pow(std::sin(omega*time),2)),2) + 0.25*omega*x1*(1 - alpha_min)*(2*x2*(2*std::cos(2*x1 + 2*x2) - 1) - 2*x2)*std::sin(omega*time)*std::cos(omega*time)/(alpha_min + x1*x2*(1 - alpha_min)*std::pow(std::sin(omega*time),2));

        du211 = 0.5*omega*x1*std::pow(x2,2)*std::pow((1 - alpha_min),3)*(2*x2*(-x2 + std::sin(2*x1 + 2*x2)) + std::cos(2*x1 + 2*x2))*std::pow(std::sin(omega*time),5)*std::cos(omega*time)/std::pow((alpha_min + x1*x2*(1 - alpha_min)*std::pow(std::sin(omega*time),2)),3) - 0.5*omega*x1*x2*std::pow((1 - alpha_min),2)*(4*x2*std::cos(2*x1 + 2*x2) - 2*std::sin(2*x1 + 2*x2))*std::pow(std::sin(omega*time),3)*std::cos(omega*time)/std::pow((alpha_min + x1*x2*(1 - alpha_min)*std::pow(std::sin(omega*time),2)),2) + 0.25*omega*x1*(1 - alpha_min)*(-8*x2*std::sin(2*x1 + 2*x2) - 4*std::cos(2*x1 + 2*x2))*std::sin(omega*time)*std::cos(omega*time)/(alpha_min + x1*x2*(1 - alpha_min)*std::pow(std::sin(omega*time),2)) - 0.5*omega*x2*std::pow((1 - alpha_min),2)*(2*x2*(-x2 + std::sin(2*x1 + 2*x2)) + std::cos(2*x1 + 2*x2))*std::pow(std::sin(omega*time),3)*std::cos(omega*time)/std::pow((alpha_min + x1*x2*(1 - alpha_min)*std::pow(std::sin(omega*time),2)),2) + 0.5*omega*(1 - alpha_min)*(4*x2*std::cos(2*x1 + 2*x2) - 2*std::sin(2*x1 + 2*x2))*std::sin(omega*time)*std::cos(omega*time)/(alpha_min + x1*x2*(1 - alpha_min)*std::pow(std::sin(omega*time),2));

        du212 = 0.5*omega*std::pow(x1,2)*x2*std::pow((1 - alpha_min),3)*(2*x2*(-x2 + std::sin(2*x1 + 2*x2)) + std::cos(2*x1 + 2*x2))*std::pow(std::sin(omega*time),5)*std::cos(omega*time)/std::pow((alpha_min + x1*x2*(1 - alpha_min)*std::pow(std::sin(omega*time),2)),3) - 0.25*omega*std::pow(x1,2)*std::pow((1 - alpha_min),2)*(4*x2*std::cos(2*x1 + 2*x2) - 2*std::sin(2*x1 + 2*x2))*std::pow(std::sin(omega*time),3)*std::cos(omega*time)/std::pow((alpha_min + x1*x2*(1 - alpha_min)*std::pow(std::sin(omega*time),2)),2) - 0.25*omega*x1*x2*std::pow((1 - alpha_min),2)*(2*x2*(2*std::cos(2*x1 + 2*x2) - 1) - 2*x2)*std::pow(std::sin(omega*time),3)*std::cos(omega*time)/std::pow((alpha_min + x1*x2*(1 - alpha_min)*std::pow(std::sin(omega*time),2)),2) - 2.0*omega*x1*x2*(1 - alpha_min)*std::sin(omega*time)*std::sin(2*x1 + 2*x2)*std::cos(omega*time)/(alpha_min + x1*x2*(1 - alpha_min)*std::pow(std::sin(omega*time),2)) - 0.5*omega*x1*std::pow((1 - alpha_min),2)*(2*x2*(-x2 + std::sin(2*x1 + 2*x2)) + std::cos(2*x1 + 2*x2))*std::pow(std::sin(omega*time),3)*std::cos(omega*time)/std::pow((alpha_min + x1*x2*(1 - alpha_min)*std::pow(std::sin(omega*time),2)),2) + 0.25*omega*(1 - alpha_min)*(2*x2*(2*std::cos(2*x1 + 2*x2) - 1) - 2*x2)*std::sin(omega*time)*std::cos(omega*time)/(alpha_min + x1*x2*(1 - alpha_min)*std::pow(std::sin(omega*time),2));

        du221 = 0.5*omega*std::pow(x1,2)*x2*std::pow((1 - alpha_min),3)*(2*x2*(-x2 + std::sin(2*x1 + 2*x2)) + std::cos(2*x1 + 2*x2))*std::pow(std::sin(omega*time),5)*std::cos(omega*time)/std::pow((alpha_min + x1*x2*(1 - alpha_min)*std::pow(std::sin(omega*time),2)),3) - 0.25*omega*std::pow(x1,2)*std::pow((1 - alpha_min),2)*(4*x2*std::cos(2*x1 + 2*x2) - 2*std::sin(2*x1 + 2*x2))*std::pow(std::sin(omega*time),3)*std::cos(omega*time)/std::pow((alpha_min + x1*x2*(1 - alpha_min)*std::pow(std::sin(omega*time),2)),2) - 0.25*omega*x1*x2*std::pow((1 - alpha_min),2)*(2*x2*(2*std::cos(2*x1 + 2*x2) - 1) - 2*x2)*std::pow(std::sin(omega*time),3)*std::cos(omega*time)/std::pow((alpha_min + x1*x2*(1 - alpha_min)*std::pow(std::sin(omega*time),2)),2) - 2.0*omega*x1*x2*(1 - alpha_min)*std::sin(omega*time)*std::sin(2*x1 + 2*x2)*std::cos(omega*time)/(alpha_min + x1*x2*(1 - alpha_min)*std::pow(std::sin(omega*time),2)) - 0.5*omega*x1*std::pow((1 - alpha_min),2)*(2*x2*(-x2 + std::sin(2*x1 + 2*x2)) + std::cos(2*x1 + 2*x2))*std::pow(std::sin(omega*time),3)*std::cos(omega*time)/std::pow((alpha_min + x1*x2*(1 - alpha_min)*std::pow(std::sin(omega*time),2)),2) + 0.25*omega*(1 - alpha_min)*(2*x2*(2*std::cos(2*x1 + 2*x2) - 1) - 2*x2)*std::sin(omega*time)*std::cos(omega*time)/(alpha_min + x1*x2*(1 - alpha_min)*std::pow(std::sin(omega*time),2));

        du222 = 0.5*omega*std::pow(x1,3)*std::pow((1 - alpha_min),3)*(2*x2*(-x2 + std::sin(2*x1 + 2*x2)) + std::cos(2*x1 + 2*x2))*std::pow(std::sin(omega*time),5)*std::cos(omega*time)/std::pow((alpha_min + x1*x2*(1 - alpha_min)*std::pow(std::sin(omega*time),2)),3) - 0.5*omega*std::pow(x1,2)*std::pow((1 - alpha_min),2)*(2*x2*(2*std::cos(2*x1 + 2*x2) - 1) - 2*x2)*std::pow(std::sin(omega*time),3)*std::cos(omega*time)/std::pow((alpha_min + x1*x2*(1 - alpha_min)*std::pow(std::sin(omega*time),2)),2) + 0.25*omega*x1*(1 - alpha_min)*(-8*x2*std::sin(2*x1 + 2*x2) + 4*std::cos(2*x1 + 2*x2) - 4)*std::sin(omega*time)*std::cos(omega*time)/(alpha_min + x1*x2*(1 - alpha_min)*std::pow(std::sin(omega*time),2));
        ...
        //r_mass_source = 0.25*omega*std::pow(x1,2)*std::pow((1 - alpha_min),2)*(2*x2*(-x2 + std::sin(2*x1 + 2*x2)) + std::cos(2*x1 + 2*x2))*std::pow(std::sin(omega*time),3)*std::cos(omega*time)/(alpha_min + x1*x2*(1 - alpha_min)*std::pow(std::sin(omega*time),2)) + 2*omega*x1*x2*(1 - alpha_min)*std::sin(omega*time)*std::cos(omega*time) - 0.25*omega*std::pow(x2,2)*std::pow((1 - alpha_min),2)*(2*x1*(x1 + std::sin(2*x1 + 2*x2)) + std::cos(2*x1 + 2*x2))*std::pow(std::sin(omega*time),3)*std::cos(omega*time)/(alpha_min + x1*x2*(1 - alpha_min)*std::pow(std::sin(omega*time),2)) + (alpha_min + x1*x2*(1 - alpha_min)*std::pow(std::sin(omega*time),2))*(-0.25*omega*std::pow(x1,2)*std::pow((1 - alpha_min),2)*(2*x2*(-x2 + std::sin(2*x1 + 2*x2)) + std::cos(2*x1 + 2*x2))*std::pow(std::sin(omega*time),3)*std::cos(omega*time)/std::pow((alpha_min + x1*x2*(1 - alpha_min)*std::pow(std::sin(omega*time),2)),2) + 0.25*omega*x1*(1 - alpha_min)*(2*x2*(2*std::cos(2*x1 + 2*x2) - 1) - 2*x2)*std::sin(omega*time)*std::cos(omega*time)/(alpha_min + x1*x2*(1 - alpha_min)*std::pow(std::sin(omega*time),2)) + 0.25*omega*std::pow(x2,2)*std::pow((1 - alpha_min),2)*(2*x1*(x1 + std::sin(2*x1 + 2*x2)) + std::cos(2*x1 + 2*x2))*std::pow(std::sin(omega*time),3)*std::cos(omega*time)/std::pow((alpha_min + x1*x2*(1 - alpha_min)*std::pow(std::sin(omega*time),2)),2) - 0.25*omega*x2*(1 - alpha_min)*(2*x1*(2*std::cos(2*x1 + 2*x2) + 1) + 2*x1)*std::sin(omega*time)*std::cos(omega*time)/(alpha_min + x1*x2*(1 - alpha_min)*std::pow(std::sin(omega*time),2)));
;
...
void NonDivergenceFreeTransientPorositySolutionTransientBodyForceProcess::SetValuesOnIntegrationPoints()
{
    ...
    for (int i_elem = 0; i_elem < static_cast<int>(mrModelPart.NumberOfElements()); ++i_elem){
        ...
        for (unsigned int g = 0; g < r_number_integration_points; g++){
            ...
            alpha = alpha_min + x1*x2*(1 - alpha_min)*std::pow(std::sin(omega*time),2);

            u1 = -0.25*omega*x2*(1 - alpha_min)*(2*x1*(x1 + std::sin(2*x1 + 2*x2)) + std::cos(2*x1 + 2*x2))*std::sin(omega*time)*std::cos(omega*time)/(alpha_min + x1*x2*(1 - alpha_min)*std::pow(std::sin(omega*time),2));

            u2 = 0.25*omega*x1*(1 - alpha_min)*(2*x2*(-x2 + std::sin(2*x1 + 2*x2)) + std::cos(2*x1 + 2*x2))*std::sin(omega*time)*std::cos(omega*time)/(alpha_min + x1*x2*(1 - alpha_min)*std::pow(std::sin(omega*time),2));

            du1dt = 0.5*std::pow(omega,2)*x1*std::pow(x2,2)*std::pow((1 - alpha_min),2)*(2*x1*(x1 + std::sin(2*x1 + 2*x2)) + std::cos(2*x1 + 2*x2))*std::pow(std::sin(omega*time),2)*std::pow(std::cos(omega*time),2)/std::pow((alpha_min + x1*x2*(1 - alpha_min)*std::pow(std::sin(omega*time),2)),2) + 0.25*std::pow(omega,2)*x2*(1 - alpha_min)*(2*x1*(x1 + std::sin(2*x1 + 2*x2)) + std::cos(2*x1 + 2*x2))*std::pow(std::sin(omega*time),2)/(alpha_min + x1*x2*(1 - alpha_min)*std::pow(std::sin(omega*time),2)) - 0.25*std::pow(omega,2)*x2*(1 - alpha_min)*(2*x1*(x1 + std::sin(2*x1 + 2*x2)) + std::cos(2*x1 + 2*x2))*std::pow(std::cos(omega*time),2)/(alpha_min + x1*x2*(1 - alpha_min)*std::pow(std::sin(omega*time),2));

            du2dt = -0.5*std::pow(omega,2)*std::pow(x1,2)*x2*std::pow((1 - alpha_min),2)*(2*x2*(-x2 + std::sin(2*x1 + 2*x2)) + std::cos(2*x1 + 2*x2))*std::pow(std::sin(omega*time),2)*std::pow(std::cos(omega*time),2)/std::pow((alpha_min + x1*x2*(1 - alpha_min)*std::pow(std::sin(omega*time),2)),2) - 0.25*std::pow(omega,2)*x1*(1 - alpha_min)*(2*x2*(-x2 + std::sin(2*x1 + 2*x2)) + std::cos(2*x1 + 2*x2))*std::pow(std::sin(omega*time),2)/(alpha_min + x1*x2*(1 - alpha_min)*std::pow(std::sin(omega*time),2)) + 0.25*std::pow(omega,2)*x1*(1 - alpha_min)*(2*x2*(-x2 + std::sin(2*x1 + 2*x2)) + std::cos(2*x1 + 2*x2))*std::pow(std::cos(omega*time),2)/(alpha_min + x1*x2*(1 - alpha_min)*std::pow(std::sin(omega*time),2));

            dalphat = 2*omega*x1*x2*(1 - alpha_min)*std::sin(omega*time)*std::cos(omega*time);

            alpha1 = x2*(1 - alpha_min)*std::pow(std::sin(omega*time),2);

            alpha2 = x1*(1 - alpha_min)*std::pow(std::sin(omega*time),2);
