...
void NonDivergenceFreeTransientPorositySolutionTransientBodyForceProcess::SetBodyForceAndPorosityField()
{
    ...
    for (auto it_node = mrModelPart.NodesBegin(); it_node != mrModelPart.NodesEnd(); it_node++){
        ...
        if (step == 0){
            ...
            r_u11 = (omega*(0.125*alpha_min - 0.125)*(-std::cos(2*omega*(time-delta_time) + (2*k + 2)*(x1 + x2))/(k + 1) - std::cos(2*omega*(time-delta_time) + (2*k - 2)*(x1 + x2))/(k - 1) - 2*std::cos(2*omega*(time-delta_time) + 2*k*(x1 + x2))/k) + x1*std::cos(omega*(time-delta_time)))/(alpha_min + (1 - alpha_min)*std::pow(std::sin(omega*(time-delta_time) + k*(x1 + x2)),2));

            r_u21 = (omega*(0.125*alpha_min - 0.125)*(std::cos(2*omega*(time-delta_time) + (2*k + 2)*(x1 + x2))/(k + 1) + std::cos(2*omega*(time-delta_time) + (2*k - 2)*(x1 + x2))/(k - 1) - 2*std::cos(2*omega*(time-delta_time) + 2*k*(x1 + x2))/k) - x2*std::cos(omega*(time-delta_time)))/(alpha_min + (1 - alpha_min)*std::pow(std::sin(omega*(time-delta_time) + k*(x1 + x2)),2));

            r_u12 = (omega*(0.125*alpha_min - 0.125)*(-std::cos(2*omega*(time-2.0*delta_time) + (2*k + 2)*(x1 + x2))/(k + 1) - std::cos(2*omega*(time-2.0*delta_time) + (2*k - 2)*(x1 + x2))/(k - 1) - 2*std::cos(2*omega*(time-2.0*delta_time) + 2*k*(x1 + x2))/k) + x1*std::cos(omega*(time-2.0*delta_time)))/(alpha_min + (1 - alpha_min)*std::pow(std::sin(omega*(time-2.0*delta_time) + k*(x1 + x2)),2));

            r_u22 = (omega*(0.125*alpha_min - 0.125)*(std::cos(2*omega*(time-2.0*delta_time) + (2*k + 2)*(x1 + x2))/(k + 1) + std::cos(2*omega*(time-2.0*delta_time) + (2*k - 2)*(x1 + x2))/(k - 1) - 2*std::cos(2*omega*(time-2.0*delta_time) + 2*k*(x1 + x2))/k) - x2*std::cos(omega*(time-2.0*delta_time)))/(alpha_min + (1 - alpha_min)*std::pow(std::sin(omega*(time-2.0*delta_time) + k*(x1 + x2)),2));

        }

        r_alpha = alpha_min + (1 - alpha_min)*std::pow(std::sin(omega*time + k*(x1 + x2)),2);

        r_u1 = (omega*(0.125*alpha_min - 0.125)*(-std::cos(2*omega*time + (2*k + 2)*(x1 + x2))/(k + 1) - std::cos(2*omega*time + (2*k - 2)*(x1 + x2))/(k - 1) - 2*std::cos(2*omega*time + 2*k*(x1 + x2))/k) + x1*std::cos(omega*time))/(alpha_min + (1 - alpha_min)*std::pow(std::sin(omega*time + k*(x1 + x2)),2));

        r_u2 = (omega*(0.125*alpha_min - 0.125)*(std::cos(2*omega*time + (2*k + 2)*(x1 + x2))/(k + 1) + std::cos(2*omega*time + (2*k - 2)*(x1 + x2))/(k - 1) - 2*std::cos(2*omega*time + 2*k*(x1 + x2))/k) - x2*std::cos(omega*time))/(alpha_min + (1 - alpha_min)*std::pow(std::sin(omega*time + k*(x1 + x2)),2));

        du1dt = -2*omega*(1 - alpha_min)*(omega*(0.125*alpha_min - 0.125)*(-std::cos(2*omega*time + (2*k + 2)*(x1 + x2))/(k + 1) - std::cos(2*omega*time + (2*k - 2)*(x1 + x2))/(k - 1) - 2*std::cos(2*omega*time + 2*k*(x1 + x2))/k) + x1*std::cos(omega*time))*std::sin(omega*time + k*(x1 + x2))*std::cos(omega*time + k*(x1 + x2))/std::pow((alpha_min + (1 - alpha_min)*std::pow(std::sin(omega*time + k*(x1 + x2)),2)),2) + (-omega*x1*std::sin(omega*time) + omega*(0.125*alpha_min - 0.125)*(2*omega*std::sin(2*omega*time + (2*k + 2)*(x1 + x2))/(k + 1) + 2*omega*std::sin(2*omega*time + (2*k - 2)*(x1 + x2))/(k - 1) + 4*omega*std::sin(2*omega*time + 2*k*(x1 + x2))/k))/(alpha_min + (1 - alpha_min)*std::pow(std::sin(omega*time + k*(x1 + x2)),2));

        du2dt = -2*omega*(1 - alpha_min)*(omega*(0.125*alpha_min - 0.125)*(std::cos(2*omega*time + (2*k + 2)*(x1 + x2))/(k + 1) + std::cos(2*omega*time + (2*k - 2)*(x1 + x2))/(k - 1) - 2*std::cos(2*omega*time + 2*k*(x1 + x2))/k) - x2*std::cos(omega*time))*std::sin(omega*time + k*(x1 + x2))*std::cos(omega*time + k*(x1 + x2))/std::pow((alpha_min + (1 - alpha_min)*std::pow(std::sin(omega*time + k*(x1 + x2)),2)),2) + (omega*x2*std::sin(omega*time) + omega*(0.125*alpha_min - 0.125)*(-2*omega*std::sin(2*omega*time + (2*k + 2)*(x1 + x2))/(k + 1) - 2*omega*std::sin(2*omega*time + (2*k - 2)*(x1 + x2))/(k - 1) + 4*omega*std::sin(2*omega*time + 2*k*(x1 + x2))/k))/(alpha_min + (1 - alpha_min)*std::pow(std::sin(omega*time + k*(x1 + x2)),2));
        ...
        du11 = -2*k*(1 - alpha_min)*(omega*(0.125*alpha_min - 0.125)*(-std::cos(2*omega*time + (2*k + 2)*(x1 + x2))/(k + 1) - std::cos(2*omega*time + (2*k - 2)*(x1 + x2))/(k - 1) - 2*std::cos(2*omega*time + 2*k*(x1 + x2))/k) + x1*std::cos(omega*time))*std::sin(omega*time + k*(x1 + x2))*std::cos(omega*time + k*(x1 + x2))/std::pow((alpha_min + (1 - alpha_min)*std::pow(std::sin(omega*time + k*(x1 + x2)),2)),2) + (omega*(0.125*alpha_min - 0.125)*(4*std::sin(2*omega*time + 2*k*(x1 + x2)) + (2*k + 2)*std::sin(2*omega*time + (2*k + 2)*(x1 + x2))/(k + 1) + (2*k - 2)*std::sin(2*omega*time + (2*k - 2)*(x1 + x2))/(k - 1)) + std::cos(omega*time))/(alpha_min + (1 - alpha_min)*std::pow(std::sin(omega*time + k*(x1 + x2)),2));

        du12 = omega*(0.125*alpha_min - 0.125)*(4*std::sin(2*omega*time + 2*k*(x1 + x2)) + (2*k + 2)*std::sin(2*omega*time + (2*k + 2)*(x1 + x2))/(k + 1) + (2*k - 2)*std::sin(2*omega*time + (2*k - 2)*(x1 + x2))/(k - 1))/(alpha_min + (1 - alpha_min)*std::pow(std::sin(omega*time + k*(x1 + x2)),2)) - 2*k*(1 - alpha_min)*(omega*(0.125*alpha_min - 0.125)*(-std::cos(2*omega*time + (2*k + 2)*(x1 + x2))/(k + 1) - std::cos(2*omega*time + (2*k - 2)*(x1 + x2))/(k - 1) - 2*std::cos(2*omega*time + 2*k*(x1 + x2))/k) + x1*std::cos(omega*time))*std::sin(omega*time + k*(x1 + x2))*std::cos(omega*time + k*(x1 + x2))/std::pow((alpha_min + (1 - alpha_min)*std::pow(std::sin(omega*time + k*(x1 + x2)),2)),2);

        du111 = omega*(0.125*alpha_min - 0.125)*(8*k*std::cos(2*omega*time + 2*k*(x1 + x2)) + std::pow((2*k + 2),2)*std::cos(2*omega*time + (2*k + 2)*(x1 + x2))/(k + 1) + std::pow((2*k - 2),2)*std::cos(2*omega*time + (2*k - 2)*(x1 + x2))/(k - 1))/(alpha_min + (1 - alpha_min)*std::pow(std::sin(omega*time + k*(x1 + x2)),2)) + 8*std::pow(k,2)*std::pow((1 - alpha_min),2)*(omega*(0.125*alpha_min - 0.125)*(-std::cos(2*omega*time + (2*k + 2)*(x1 + x2))/(k + 1) - std::cos(2*omega*time + (2*k - 2)*(x1 + x2))/(k - 1) - 2*std::cos(2*omega*time + 2*k*(x1 + x2))/k) + x1*std::cos(omega*time))*std::pow(std::sin(omega*time + k*(x1 + x2)),2)*std::pow(std::cos(omega*time + k*(x1 + x2)),2)/std::pow((alpha_min + (1 - alpha_min)*std::pow(std::sin(omega*time + k*(x1 + x2)),2)),3) + 2*std::pow(k,2)*(1 - alpha_min)*(omega*(0.125*alpha_min - 0.125)*(-std::cos(2*omega*time + (2*k + 2)*(x1 + x2))/(k + 1) - std::cos(2*omega*time + (2*k - 2)*(x1 + x2))/(k - 1) - 2*std::cos(2*omega*time + 2*k*(x1 + x2))/k) + x1*std::cos(omega*time))*std::pow(std::sin(omega*time + k*(x1 + x2)),2)/std::pow((alpha_min + (1 - alpha_min)*std::pow(std::sin(omega*time + k*(x1 + x2)),2)),2) - 2*std::pow(k,2)*(1 - alpha_min)*(omega*(0.125*alpha_min - 0.125)*(-std::cos(2*omega*time + (2*k + 2)*(x1 + x2))/(k + 1) - std::cos(2*omega*time + (2*k - 2)*(x1 + x2))/(k - 1) - 2*std::cos(2*omega*time + 2*k*(x1 + x2))/k) + x1*std::cos(omega*time))*std::pow(std::cos(omega*time + k*(x1 + x2)),2)/std::pow((alpha_min + (1 - alpha_min)*std::pow(std::sin(omega*time + k*(x1 + x2)),2)),2) - 4*k*(1 - alpha_min)*(omega*(0.125*alpha_min - 0.125)*(4*std::sin(2*omega*time + 2*k*(x1 + x2)) + (2*k + 2)*std::sin(2*omega*time + (2*k + 2)*(x1 + x2))/(k + 1) + (2*k - 2)*std::sin(2*omega*time + (2*k - 2)*(x1 + x2))/(k - 1)) + std::cos(omega*time))*std::sin(omega*time + k*(x1 + x2))*std::cos(omega*time + k*(x1 + x2))/std::pow((alpha_min + (1 - alpha_min)*std::pow(std::sin(omega*time + k*(x1 + x2)),2)),2);

        du112 = -2*omega*k*(1 - alpha_min)*(0.125*alpha_min - 0.125)*(4*std::sin(2*omega*time + 2*k*(x1 + x2)) + (2*k + 2)*std::sin(2*omega*time + (2*k + 2)*(x1 + x2))/(k + 1) + (2*k - 2)*std::sin(2*omega*time + (2*k - 2)*(x1 + x2))/(k - 1))*std::sin(omega*time + k*(x1 + x2))*std::cos(omega*time + k*(x1 + x2))/std::pow((alpha_min + (1 - alpha_min)*std::pow(std::sin(omega*time + k*(x1 + x2)),2)),2) + omega*(0.125*alpha_min - 0.125)*(8*k*std::cos(2*omega*time + 2*k*(x1 + x2)) + std::pow((2*k + 2),2)*std::cos(2*omega*time + (2*k + 2)*(x1 + x2))/(k + 1) + std::pow((2*k - 2),2)*std::cos(2*omega*time + (2*k - 2)*(x1 + x2))/(k - 1))/(alpha_min + (1 - alpha_min)*std::pow(std::sin(omega*time + k*(x1 + x2)),2)) + 8*std::pow(k,2)*std::pow((1 - alpha_min),2)*(omega*(0.125*alpha_min - 0.125)*(-std::cos(2*omega*time + (2*k + 2)*(x1 + x2))/(k + 1) - std::cos(2*omega*time + (2*k - 2)*(x1 + x2))/(k - 1) - 2*std::cos(2*omega*time + 2*k*(x1 + x2))/k) + x1*std::cos(omega*time))*std::pow(std::sin(omega*time + k*(x1 + x2)),2)*std::pow(std::cos(omega*time + k*(x1 + x2)),2)/std::pow((alpha_min + (1 - alpha_min)*std::pow(std::sin(omega*time + k*(x1 + x2)),2)),3) + 2*std::pow(k,2)*(1 - alpha_min)*(omega*(0.125*alpha_min - 0.125)*(-std::cos(2*omega*time + (2*k + 2)*(x1 + x2))/(k + 1) - std::cos(2*omega*time + (2*k - 2)*(x1 + x2))/(k - 1) - 2*std::cos(2*omega*time + 2*k*(x1 + x2))/k) + x1*std::cos(omega*time))*std::pow(std::sin(omega*time + k*(x1 + x2)),2)/std::pow((alpha_min + (1 - alpha_min)*std::pow(std::sin(omega*time + k*(x1 + x2)),2)),2) - 2*std::pow(k,2)*(1 - alpha_min)*(omega*(0.125*alpha_min - 0.125)*(-std::cos(2*omega*time + (2*k + 2)*(x1 + x2))/(k + 1) - std::cos(2*omega*time + (2*k - 2)*(x1 + x2))/(k - 1) - 2*std::cos(2*omega*time + 2*k*(x1 + x2))/k) + x1*std::cos(omega*time))*std::pow(std::cos(omega*time + k*(x1 + x2)),2)/std::pow((alpha_min + (1 - alpha_min)*std::pow(std::sin(omega*time + k*(x1 + x2)),2)),2) - 2*k*(1 - alpha_min)*(omega*(0.125*alpha_min - 0.125)*(4*std::sin(2*omega*time + 2*k*(x1 + x2)) + (2*k + 2)*std::sin(2*omega*time + (2*k + 2)*(x1 + x2))/(k + 1) + (2*k - 2)*std::sin(2*omega*time + (2*k - 2)*(x1 + x2))/(k - 1)) + std::cos(omega*time))*std::sin(omega*time + k*(x1 + x2))*std::cos(omega*time + k*(x1 + x2))/std::pow((alpha_min + (1 - alpha_min)*std::pow(std::sin(omega*time + k*(x1 + x2)),2)),2);

        du121 = -2*omega*k*(1 - alpha_min)*(0.125*alpha_min - 0.125)*(4*std::sin(2*omega*time + 2*k*(x1 + x2)) + (2*k + 2)*std::sin(2*omega*time + (2*k + 2)*(x1 + x2))/(k + 1) + (2*k - 2)*std::sin(2*omega*time + (2*k - 2)*(x1 + x2))/(k - 1))*std::sin(omega*time + k*(x1 + x2))*std::cos(omega*time + k*(x1 + x2))/std::pow((alpha_min + (1 - alpha_min)*std::pow(std::sin(omega*time + k*(x1 + x2)),2)),2) + omega*(0.125*alpha_min - 0.125)*(8*k*std::cos(2*omega*time + 2*k*(x1 + x2)) + std::pow((2*k + 2),2)*std::cos(2*omega*time + (2*k + 2)*(x1 + x2))/(k + 1) + std::pow((2*k - 2),2)*std::cos(2*omega*time + (2*k - 2)*(x1 + x2))/(k - 1))/(alpha_min + (1 - alpha_min)*std::pow(std::sin(omega*time + k*(x1 + x2)),2)) + 8*std::pow(k,2)*std::pow((1 - alpha_min),2)*(omega*(0.125*alpha_min - 0.125)*(-std::cos(2*omega*time + (2*k + 2)*(x1 + x2))/(k + 1) - std::cos(2*omega*time + (2*k - 2)*(x1 + x2))/(k - 1) - 2*std::cos(2*omega*time + 2*k*(x1 + x2))/k) + x1*std::cos(omega*time))*std::pow(std::sin(omega*time + k*(x1 + x2)),2)*std::pow(std::cos(omega*time + k*(x1 + x2)),2)/std::pow((alpha_min + (1 - alpha_min)*std::pow(std::sin(omega*time + k*(x1 + x2)),2)),3) + 2*std::pow(k,2)*(1 - alpha_min)*(omega*(0.125*alpha_min - 0.125)*(-std::cos(2*omega*time + (2*k + 2)*(x1 + x2))/(k + 1) - std::cos(2*omega*time + (2*k - 2)*(x1 + x2))/(k - 1) - 2*std::cos(2*omega*time + 2*k*(x1 + x2))/k) + x1*std::cos(omega*time))*std::pow(std::sin(omega*time + k*(x1 + x2)),2)/std::pow((alpha_min + (1 - alpha_min)*std::pow(std::sin(omega*time + k*(x1 + x2)),2)),2) - 2*std::pow(k,2)*(1 - alpha_min)*(omega*(0.125*alpha_min - 0.125)*(-std::cos(2*omega*time + (2*k + 2)*(x1 + x2))/(k + 1) - std::cos(2*omega*time + (2*k - 2)*(x1 + x2))/(k - 1) - 2*std::cos(2*omega*time + 2*k*(x1 + x2))/k) + x1*std::cos(omega*time))*std::pow(std::cos(omega*time + k*(x1 + x2)),2)/std::pow((alpha_min + (1 - alpha_min)*std::pow(std::sin(omega*time + k*(x1 + x2)),2)),2) - 2*k*(1 - alpha_min)*(omega*(0.125*alpha_min - 0.125)*(4*std::sin(2*omega*time + 2*k*(x1 + x2)) + (2*k + 2)*std::sin(2*omega*time + (2*k + 2)*(x1 + x2))/(k + 1) + (2*k - 2)*std::sin(2*omega*time + (2*k - 2)*(x1 + x2))/(k - 1)) + std::cos(omega*time))*std::sin(omega*time + k*(x1 + x2))*std::cos(omega*time + k*(x1 + x2))/std::pow((alpha_min + (1 - alpha_min)*std::pow(std::sin(omega*time + k*(x1 + x2)),2)),2);

        du122 = -4*omega*k*(1 - alpha_min)*(0.125*alpha_min - 0.125)*(4*std::sin(2*omega*time + 2*k*(x1 + x2)) + (2*k + 2)*std::sin(2*omega*time + (2*k + 2)*(x1 + x2))/(k + 1) + (2*k - 2)*std::sin(2*omega*time + (2*k - 2)*(x1 + x2))/(k - 1))*std::sin(omega*time + k*(x1 + x2))*std::cos(omega*time + k*(x1 + x2))/std::pow((alpha_min + (1 - alpha_min)*std::pow(std::sin(omega*time + k*(x1 + x2)),2)),2) + omega*(0.125*alpha_min - 0.125)*(8*k*std::cos(2*omega*time + 2*k*(x1 + x2)) + std::pow((2*k + 2),2)*std::cos(2*omega*time + (2*k + 2)*(x1 + x2))/(k + 1) + std::pow((2*k - 2),2)*std::cos(2*omega*time + (2*k - 2)*(x1 + x2))/(k - 1))/(alpha_min + (1 - alpha_min)*std::pow(std::sin(omega*time + k*(x1 + x2)),2)) + 8*std::pow(k,2)*std::pow((1 - alpha_min),2)*(omega*(0.125*alpha_min - 0.125)*(-std::cos(2*omega*time + (2*k + 2)*(x1 + x2))/(k + 1) - std::cos(2*omega*time + (2*k - 2)*(x1 + x2))/(k - 1) - 2*std::cos(2*omega*time + 2*k*(x1 + x2))/k) + x1*std::cos(omega*time))*std::pow(std::sin(omega*time + k*(x1 + x2)),2)*std::pow(std::cos(omega*time + k*(x1 + x2)),2)/std::pow((alpha_min + (1 - alpha_min)*std::pow(std::sin(omega*time + k*(x1 + x2)),2)),3) + 2*std::pow(k,2)*(1 - alpha_min)*(omega*(0.125*alpha_min - 0.125)*(-std::cos(2*omega*time + (2*k + 2)*(x1 + x2))/(k + 1) - std::cos(2*omega*time + (2*k - 2)*(x1 + x2))/(k - 1) - 2*std::cos(2*omega*time + 2*k*(x1 + x2))/k) + x1*std::cos(omega*time))*std::pow(std::sin(omega*time + k*(x1 + x2)),2)/std::pow((alpha_min + (1 - alpha_min)*std::pow(std::sin(omega*time + k*(x1 + x2)),2)),2) - 2*std::pow(k,2)*(1 - alpha_min)*(omega*(0.125*alpha_min - 0.125)*(-std::cos(2*omega*time + (2*k + 2)*(x1 + x2))/(k + 1) - std::cos(2*omega*time + (2*k - 2)*(x1 + x2))/(k - 1) - 2*std::cos(2*omega*time + 2*k*(x1 + x2))/k) + x1*std::cos(omega*time))*std::pow(std::cos(omega*time + k*(x1 + x2)),2)/std::pow((alpha_min + (1 - alpha_min)*std::pow(std::sin(omega*time + k*(x1 + x2)),2)),2);

        du21 = omega*(0.125*alpha_min - 0.125)*(4*std::sin(2*omega*time + 2*k*(x1 + x2)) - (2*k + 2)*std::sin(2*omega*time + (2*k + 2)*(x1 + x2))/(k + 1) - (2*k - 2)*std::sin(2*omega*time + (2*k - 2)*(x1 + x2))/(k - 1))/(alpha_min + (1 - alpha_min)*std::pow(std::sin(omega*time + k*(x1 + x2)),2)) - 2*k*(1 - alpha_min)*(omega*(0.125*alpha_min - 0.125)*(std::cos(2*omega*time + (2*k + 2)*(x1 + x2))/(k + 1) + std::cos(2*omega*time + (2*k - 2)*(x1 + x2))/(k - 1) - 2*std::cos(2*omega*time + 2*k*(x1 + x2))/k) - x2*std::cos(omega*time))*std::sin(omega*time + k*(x1 + x2))*std::cos(omega*time + k*(x1 + x2))/std::pow((alpha_min + (1 - alpha_min)*std::pow(std::sin(omega*time + k*(x1 + x2)),2)),2);

        du22 = -2*k*(1 - alpha_min)*(omega*(0.125*alpha_min - 0.125)*(std::cos(2*omega*time + (2*k + 2)*(x1 + x2))/(k + 1) + std::cos(2*omega*time + (2*k - 2)*(x1 + x2))/(k - 1) - 2*std::cos(2*omega*time + 2*k*(x1 + x2))/k) - x2*std::cos(omega*time))*std::sin(omega*time + k*(x1 + x2))*std::cos(omega*time + k*(x1 + x2))/std::pow((alpha_min + (1 - alpha_min)*std::pow(std::sin(omega*time + k*(x1 + x2)),2)),2) + (omega*(0.125*alpha_min - 0.125)*(4*std::sin(2*omega*time + 2*k*(x1 + x2)) - (2*k + 2)*std::sin(2*omega*time + (2*k + 2)*(x1 + x2))/(k + 1) - (2*k - 2)*std::sin(2*omega*time + (2*k - 2)*(x1 + x2))/(k - 1)) - std::cos(omega*time))/(alpha_min + (1 - alpha_min)*std::pow(std::sin(omega*time + k*(x1 + x2)),2));

        du211 = -4*omega*k*(1 - alpha_min)*(0.125*alpha_min - 0.125)*(4*std::sin(2*omega*time + 2*k*(x1 + x2)) - (2*k + 2)*std::sin(2*omega*time + (2*k + 2)*(x1 + x2))/(k + 1) - (2*k - 2)*std::sin(2*omega*time + (2*k - 2)*(x1 + x2))/(k - 1))*std::sin(omega*time + k*(x1 + x2))*std::cos(omega*time + k*(x1 + x2))/std::pow((alpha_min + (1 - alpha_min)*std::pow(std::sin(omega*time + k*(x1 + x2)),2)),2) + omega*(0.125*alpha_min - 0.125)*(8*k*std::cos(2*omega*time + 2*k*(x1 + x2)) - std::pow((2*k + 2),2)*std::cos(2*omega*time + (2*k + 2)*(x1 + x2))/(k + 1) - std::pow((2*k - 2),2)*std::cos(2*omega*time + (2*k - 2)*(x1 + x2))/(k - 1))/(alpha_min + (1 - alpha_min)*std::pow(std::sin(omega*time + k*(x1 + x2)),2)) + 8*std::pow(k,2)*std::pow((1 - alpha_min),2)*(omega*(0.125*alpha_min - 0.125)*(std::cos(2*omega*time + (2*k + 2)*(x1 + x2))/(k + 1) + std::cos(2*omega*time + (2*k - 2)*(x1 + x2))/(k - 1) - 2*std::cos(2*omega*time + 2*k*(x1 + x2))/k) - x2*std::cos(omega*time))*std::pow(std::sin(omega*time + k*(x1 + x2)),2)*std::pow(std::cos(omega*time + k*(x1 + x2)),2)/std::pow((alpha_min + (1 - alpha_min)*std::pow(std::sin(omega*time + k*(x1 + x2)),2)),3) + 2*std::pow(k,2)*(1 - alpha_min)*(omega*(0.125*alpha_min - 0.125)*(std::cos(2*omega*time + (2*k + 2)*(x1 + x2))/(k + 1) + std::cos(2*omega*time + (2*k - 2)*(x1 + x2))/(k - 1) - 2*std::cos(2*omega*time + 2*k*(x1 + x2))/k) - x2*std::cos(omega*time))*std::pow(std::sin(omega*time + k*(x1 + x2)),2)/std::pow((alpha_min + (1 - alpha_min)*std::pow(std::sin(omega*time + k*(x1 + x2)),2)),2) - 2*std::pow(k,2)*(1 - alpha_min)*(omega*(0.125*alpha_min - 0.125)*(std::cos(2*omega*time + (2*k + 2)*(x1 + x2))/(k + 1) + std::cos(2*omega*time + (2*k - 2)*(x1 + x2))/(k - 1) - 2*std::cos(2*omega*time + 2*k*(x1 + x2))/k) - x2*std::cos(omega*time))*std::pow(std::cos(omega*time + k*(x1 + x2)),2)/std::pow((alpha_min + (1 - alpha_min)*std::pow(std::sin(omega*time + k*(x1 + x2)),2)),2);

        du212 = -2*omega*k*(1 - alpha_min)*(0.125*alpha_min - 0.125)*(4*std::sin(2*omega*time + 2*k*(x1 + x2)) - (2*k + 2)*std::sin(2*omega*time + (2*k + 2)*(x1 + x2))/(k + 1) - (2*k - 2)*std::sin(2*omega*time + (2*k - 2)*(x1 + x2))/(k - 1))*std::sin(omega*time + k*(x1 + x2))*std::cos(omega*time + k*(x1 + x2))/std::pow((alpha_min + (1 - alpha_min)*std::pow(std::sin(omega*time + k*(x1 + x2)),2)),2) + omega*(0.125*alpha_min - 0.125)*(8*k*std::cos(2*omega*time + 2*k*(x1 + x2)) - std::pow((2*k + 2),2)*std::cos(2*omega*time + (2*k + 2)*(x1 + x2))/(k + 1) - std::pow((2*k - 2),2)*std::cos(2*omega*time + (2*k - 2)*(x1 + x2))/(k - 1))/(alpha_min + (1 - alpha_min)*std::pow(std::sin(omega*time + k*(x1 + x2)),2)) + 8*std::pow(k,2)*std::pow((1 - alpha_min),2)*(omega*(0.125*alpha_min - 0.125)*(std::cos(2*omega*time + (2*k + 2)*(x1 + x2))/(k + 1) + std::cos(2*omega*time + (2*k - 2)*(x1 + x2))/(k - 1) - 2*std::cos(2*omega*time + 2*k*(x1 + x2))/k) - x2*std::cos(omega*time))*std::pow(std::sin(omega*time + k*(x1 + x2)),2)*std::pow(std::cos(omega*time + k*(x1 + x2)),2)/std::pow((alpha_min + (1 - alpha_min)*std::pow(std::sin(omega*time + k*(x1 + x2)),2)),3) + 2*std::pow(k,2)*(1 - alpha_min)*(omega*(0.125*alpha_min - 0.125)*(std::cos(2*omega*time + (2*k + 2)*(x1 + x2))/(k + 1) + std::cos(2*omega*time + (2*k - 2)*(x1 + x2))/(k - 1) - 2*std::cos(2*omega*time + 2*k*(x1 + x2))/k) - x2*std::cos(omega*time))*std::pow(std::sin(omega*time + k*(x1 + x2)),2)/std::pow((alpha_min + (1 - alpha_min)*std::pow(std::sin(omega*time + k*(x1 + x2)),2)),2) - 2*std::pow(k,2)*(1 - alpha_min)*(omega*(0.125*alpha_min - 0.125)*(std::cos(2*omega*time + (2*k + 2)*(x1 + x2))/(k + 1) + std::cos(2*omega*time + (2*k - 2)*(x1 + x2))/(k - 1) - 2*std::cos(2*omega*time + 2*k*(x1 + x2))/k) - x2*std::cos(omega*time))*std::pow(std::cos(omega*time + k*(x1 + x2)),2)/std::pow((alpha_min + (1 - alpha_min)*std::pow(std::sin(omega*time + k*(x1 + x2)),2)),2) - 2*k*(1 - alpha_min)*(omega*(0.125*alpha_min - 0.125)*(4*std::sin(2*omega*time + 2*k*(x1 + x2)) - (2*k + 2)*std::sin(2*omega*time + (2*k + 2)*(x1 + x2))/(k + 1) - (2*k - 2)*std::sin(2*omega*time + (2*k - 2)*(x1 + x2))/(k - 1)) - std::cos(omega*time))*std::sin(omega*time + k*(x1 + x2))*std::cos(omega*time + k*(x1 + x2))/std::pow((alpha_min + (1 - alpha_min)*std::pow(std::sin(omega*time + k*(x1 + x2)),2)),2);

        du221 = -2*omega*k*(1 - alpha_min)*(0.125*alpha_min - 0.125)*(4*std::sin(2*omega*time + 2*k*(x1 + x2)) - (2*k + 2)*std::sin(2*omega*time + (2*k + 2)*(x1 + x2))/(k + 1) - (2*k - 2)*std::sin(2*omega*time + (2*k - 2)*(x1 + x2))/(k - 1))*std::sin(omega*time + k*(x1 + x2))*std::cos(omega*time + k*(x1 + x2))/std::pow((alpha_min + (1 - alpha_min)*std::pow(std::sin(omega*time + k*(x1 + x2)),2)),2) + omega*(0.125*alpha_min - 0.125)*(8*k*std::cos(2*omega*time + 2*k*(x1 + x2)) - std::pow((2*k + 2),2)*std::cos(2*omega*time + (2*k + 2)*(x1 + x2))/(k + 1) - std::pow((2*k - 2),2)*std::cos(2*omega*time + (2*k - 2)*(x1 + x2))/(k - 1))/(alpha_min + (1 - alpha_min)*std::pow(std::sin(omega*time + k*(x1 + x2)),2)) + 8*std::pow(k,2)*std::pow((1 - alpha_min),2)*(omega*(0.125*alpha_min - 0.125)*(std::cos(2*omega*time + (2*k + 2)*(x1 + x2))/(k + 1) + std::cos(2*omega*time + (2*k - 2)*(x1 + x2))/(k - 1) - 2*std::cos(2*omega*time + 2*k*(x1 + x2))/k) - x2*std::cos(omega*time))*std::pow(std::sin(omega*time + k*(x1 + x2)),2)*std::pow(std::cos(omega*time + k*(x1 + x2)),2)/std::pow((alpha_min + (1 - alpha_min)*std::pow(std::sin(omega*time + k*(x1 + x2)),2)),3) + 2*std::pow(k,2)*(1 - alpha_min)*(omega*(0.125*alpha_min - 0.125)*(std::cos(2*omega*time + (2*k + 2)*(x1 + x2))/(k + 1) + std::cos(2*omega*time + (2*k - 2)*(x1 + x2))/(k - 1) - 2*std::cos(2*omega*time + 2*k*(x1 + x2))/k) - x2*std::cos(omega*time))*std::pow(std::sin(omega*time + k*(x1 + x2)),2)/std::pow((alpha_min + (1 - alpha_min)*std::pow(std::sin(omega*time + k*(x1 + x2)),2)),2) - 2*std::pow(k,2)*(1 - alpha_min)*(omega*(0.125*alpha_min - 0.125)*(std::cos(2*omega*time + (2*k + 2)*(x1 + x2))/(k + 1) + std::cos(2*omega*time + (2*k - 2)*(x1 + x2))/(k - 1) - 2*std::cos(2*omega*time + 2*k*(x1 + x2))/k) - x2*std::cos(omega*time))*std::pow(std::cos(omega*time + k*(x1 + x2)),2)/std::pow((alpha_min + (1 - alpha_min)*std::pow(std::sin(omega*time + k*(x1 + x2)),2)),2) - 2*k*(1 - alpha_min)*(omega*(0.125*alpha_min - 0.125)*(4*std::sin(2*omega*time + 2*k*(x1 + x2)) - (2*k + 2)*std::sin(2*omega*time + (2*k + 2)*(x1 + x2))/(k + 1) - (2*k - 2)*std::sin(2*omega*time + (2*k - 2)*(x1 + x2))/(k - 1)) - std::cos(omega*time))*std::sin(omega*time + k*(x1 + x2))*std::cos(omega*time + k*(x1 + x2))/std::pow((alpha_min + (1 - alpha_min)*std::pow(std::sin(omega*time + k*(x1 + x2)),2)),2);

        du222 = omega*(0.125*alpha_min - 0.125)*(8*k*std::cos(2*omega*time + 2*k*(x1 + x2)) - std::pow((2*k + 2),2)*std::cos(2*omega*time + (2*k + 2)*(x1 + x2))/(k + 1) - std::pow((2*k - 2),2)*std::cos(2*omega*time + (2*k - 2)*(x1 + x2))/(k - 1))/(alpha_min + (1 - alpha_min)*std::pow(std::sin(omega*time + k*(x1 + x2)),2)) + 8*std::pow(k,2)*std::pow((1 - alpha_min),2)*(omega*(0.125*alpha_min - 0.125)*(std::cos(2*omega*time + (2*k + 2)*(x1 + x2))/(k + 1) + std::cos(2*omega*time + (2*k - 2)*(x1 + x2))/(k - 1) - 2*std::cos(2*omega*time + 2*k*(x1 + x2))/k) - x2*std::cos(omega*time))*std::pow(std::sin(omega*time + k*(x1 + x2)),2)*std::pow(std::cos(omega*time + k*(x1 + x2)),2)/std::pow((alpha_min + (1 - alpha_min)*std::pow(std::sin(omega*time + k*(x1 + x2)),2)),3) + 2*std::pow(k,2)*(1 - alpha_min)*(omega*(0.125*alpha_min - 0.125)*(std::cos(2*omega*time + (2*k + 2)*(x1 + x2))/(k + 1) + std::cos(2*omega*time + (2*k - 2)*(x1 + x2))/(k - 1) - 2*std::cos(2*omega*time + 2*k*(x1 + x2))/k) - x2*std::cos(omega*time))*std::pow(std::sin(omega*time + k*(x1 + x2)),2)/std::pow((alpha_min + (1 - alpha_min)*std::pow(std::sin(omega*time + k*(x1 + x2)),2)),2) - 2*std::pow(k,2)*(1 - alpha_min)*(omega*(0.125*alpha_min - 0.125)*(std::cos(2*omega*time + (2*k + 2)*(x1 + x2))/(k + 1) + std::cos(2*omega*time + (2*k - 2)*(x1 + x2))/(k - 1) - 2*std::cos(2*omega*time + 2*k*(x1 + x2))/k) - x2*std::cos(omega*time))*std::pow(std::cos(omega*time + k*(x1 + x2)),2)/std::pow((alpha_min + (1 - alpha_min)*std::pow(std::sin(omega*time + k*(x1 + x2)),2)),2) - 4*k*(1 - alpha_min)*(omega*(0.125*alpha_min - 0.125)*(4*std::sin(2*omega*time + 2*k*(x1 + x2)) - (2*k + 2)*std::sin(2*omega*time + (2*k + 2)*(x1 + x2))/(k + 1) - (2*k - 2)*std::sin(2*omega*time + (2*k - 2)*(x1 + x2))/(k - 1)) - std::cos(omega*time))*std::sin(omega*time + k*(x1 + x2))*std::cos(omega*time + k*(x1 + x2))/std::pow((alpha_min + (1 - alpha_min)*std::pow(std::sin(omega*time + k*(x1 + x2)),2)),2);
...
void NonDivergenceFreeTransientPorositySolutionTransientBodyForceProcess::SetValuesOnIntegrationPoints()
{
    ...
    for (int i_elem = 0; i_elem < static_cast<int>(mrModelPart.NumberOfElements()); ++i_elem){
        ...
        for (unsigned int g = 0; g < r_number_integration_points; g++){
            ...
            u1 = (omega*(0.125*alpha_min - 0.125)*(-std::cos(2*omega*time + (2*k + 2)*(x1 + x2))/(k + 1) - std::cos(2*omega*time + (2*k - 2)*(x1 + x2))/(k - 1) - 2*std::cos(2*omega*time + 2*k*(x1 + x2))/k) + x1*std::cos(omega*time))/(alpha_min + (1 - alpha_min)*std::pow(std::sin(omega*time + k*(x1 + x2)),2));

            u2 = (omega*(0.125*alpha_min - 0.125)*(std::cos(2*omega*time + (2*k + 2)*(x1 + x2))/(k + 1) + std::cos(2*omega*time + (2*k - 2)*(x1 + x2))/(k - 1) - 2*std::cos(2*omega*time + 2*k*(x1 + x2))/k) - x2*std::cos(omega*time))/(alpha_min + (1 - alpha_min)*std::pow(std::sin(omega*time + k*(x1 + x2)),2));
