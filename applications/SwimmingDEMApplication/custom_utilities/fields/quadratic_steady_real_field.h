#if !defined(KRATOS_QUADRATIC_STEADY_REAL_FLOW_FIELD_H)
#define KRATOS_QUADRATIC_STEADY_REAL_FLOW_FIELD_H
...
namespace Kratos
{
class KRATOS_API(SWIMMING_DEM_APPLICATION) QuadraticSteadyRealFlowField : public VelocityField
{
public:

KRATOS_CLASS_POINTER_DEFINITION(QuadraticSteadyRealFlowField);

/// Default constructor.

QuadraticSteadyRealFlowField(const array_1d<double, 9>& uxCoeffs, const array_1d<double, 9>& uyCoeffs, const array_1d<double, 9>& uzCoeffs, const array_1d<double, 3>& x0)
...
virtual ~QuadraticSteadyRealFlowField(){}
...
const array_1d<double, 9> mUxCoefficients;
...
/// Assignment operator.
QuadraticSteadyRealFlowField & operator=(QuadraticSteadyRealFlowField const& rOther);


///@}

}; // Class QuadraticSteadyRealFlowField
...
#endif // KRATOS_QUADRATIC_STEADY_REAL_FLOW_FIELD_H defined
