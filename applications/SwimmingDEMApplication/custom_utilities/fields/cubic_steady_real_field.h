#if !defined(KRATOS_CUBIC_STEADY_REAL_FLOW_FIELD_H)
#define KRATOS_CUBIC_STEADY_REAL_FLOW_FIELD_H
...
namespace Kratos
{
class KRATOS_API(SWIMMING_DEM_APPLICATION) CubicSteadyRealFlowField : public VelocityField
{
public:

KRATOS_CLASS_POINTER_DEFINITION(CubicSteadyRealFlowField);

/// Default constructor.

CubicSteadyRealFlowField(const std::array<double, 19>& uxCoeffs, const std::array<double, 19>& uyCoeffs, const std::array<double, 19>& uzCoeffs, const std::array<double, 3>& x0)
    :VelocityField(), mUxCoefficients(uxCoeffs), mUyCoefficients(uyCoeffs), mUzCoefficients(uzCoeffs), mX0(x0)
{
...
virtual ~CubicSteadyRealFlowField(){}
...
const std::array<double, 19> mUxCoefficients;
const std::array<double, 19> mUyCoefficients;
const std::array<double, 19> mUzCoefficients;
const std::array<double, 3> mX0;
array_1d<std::vector<double>, 19> mVars;
...
/// Assignment operator.
CubicSteadyRealFlowField & operator=(CubicSteadyRealFlowField const& rOther);


///@}

}; // Class CubicSteadyRealFlowField
...
#endif // KRATOS_CUBIC_STEADY_REAL_FLOW_FIELD_H defined
