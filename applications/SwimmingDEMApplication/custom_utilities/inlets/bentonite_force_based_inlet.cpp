...
array_1d<double, 3> Bentonite_Force_Based_Inlet::GetInjectionForce(Element* p_element)
{
    ...
    DEM_D_Bentonite_Colloid* p_law = dynamic_cast<DEM_D_Bentonite_Colloid*>(&*(p_spheric_particle->pCloneDiscontinuumConstitutiveLawWithNeighbour(p_spheric_particle)));
