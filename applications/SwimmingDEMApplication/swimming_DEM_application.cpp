...
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(BETA_GRADIENT)
...
KRATOS_CREATE_VARIABLE(double, FLUID_FRACTION_OLDEST)
...
void KratosSwimmingDEMApplication::Register()
{
  ...
  KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(BETA_GRADIENT)
  ...
  KRATOS_REGISTER_VARIABLE(FLUID_FRACTION_OLDEST)
