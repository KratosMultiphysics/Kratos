...
KRATOS_CREATE_VARIABLE(double, VELOCITY_DIVERGENCE_ERROR)
KRATOS_CREATE_VARIABLE(double, SCALAR_LAPLACIAN)
KRATOS_CREATE_VARIABLE(double, SCALAR_LAPLACIAN_ERROR)
...
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(VORTICITY_ERROR)
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(PRESSURE_GRADIENT_ERROR)
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(VELOCITY_LAPLACIAN_ERROR)
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(SCALAR_GRADIENT)
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(SCALAR_GRADIENT_ERROR)
KRATOS_CREATE_3D_TENSOR_VARIABLE_WITH_COMPONENTS(VECTOR_GRADIENT)
KRATOS_CREATE_3D_TENSOR_VARIABLE_WITH_COMPONENTS(VECTOR_GRADIENT_ERROR)
KRATOS_CREATE_3D_TENSOR_VARIABLE_WITH_COMPONENTS(VELOCITY_GRADIENT)
KRATOS_CREATE_3D_TENSOR_VARIABLE_WITH_COMPONENTS(VELOCITY_GRADIENT_ERROR)
...
void KratosSwimmingDEMApplication::Register()
{
  ...
  KRATOS_REGISTER_VARIABLE(VELOCITY_DIVERGENCE_ERROR)
  KRATOS_REGISTER_VARIABLE(SCALAR_LAPLACIAN)
  KRATOS_REGISTER_VARIABLE(SCALAR_LAPLACIAN_ERROR)
  ...
  KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(VORTICITY_ERROR)
  KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(PRESSURE_GRADIENT_ERROR)
  KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(VELOCITY_LAPLACIAN_ERROR)
  KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(SCALAR_GRADIENT)
  KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(SCALAR_GRADIENT_ERROR)
  KRATOS_REGISTER_3D_TENSOR_VARIABLE_WITH_COMPONENTS(VECTOR_GRADIENT)
  KRATOS_REGISTER_3D_TENSOR_VARIABLE_WITH_COMPONENTS(VECTOR_GRADIENT_ERROR)
  KRATOS_REGISTER_3D_TENSOR_VARIABLE_WITH_COMPONENTS(VELOCITY_GRADIENT)
  KRATOS_REGISTER_3D_TENSOR_VARIABLE_WITH_COMPONENTS(VELOCITY_GRADIENT_ERROR)
