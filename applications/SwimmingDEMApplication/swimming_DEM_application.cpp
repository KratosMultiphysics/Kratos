...
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(GRANULAR_TEMPERATURE)
KRATOS_CREATE_VARIABLE(double, WEIGHTED_SUM)
KRATOS_CREATE_VARIABLE(double, BED_GRANULAR_TEMPERATURE)
...
void KratosSwimmingDEMApplication::Register()
{
  ...
  KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(GRANULAR_TEMPERATURE)
  KRATOS_REGISTER_VARIABLE(WEIGHTED_SUM)
  KRATOS_REGISTER_VARIABLE(BED_GRANULAR_TEMPERATURE)
