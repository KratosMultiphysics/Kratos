...
KRATOS_CREATE_VARIABLE(double, TRUNC_SOLUTION_SDEM)
KRATOS_CREATE_VARIABLE(double, TRUNC_SOLUTION_PROJECTED)
...
void KratosSwimmingDEMApplication::Register()
{
  ...
  KRATOS_REGISTER_VARIABLE(TRUNC_SOLUTION_SDEM)
  KRATOS_REGISTER_VARIABLE(TRUNC_SOLUTION_PROJECTED)
