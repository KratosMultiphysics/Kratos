...
namespace Kratos
{
  ...
  class KRATOS_API(SWIMMING_DEM_APPLICATION) SwimmingParticle : public TBaseElement
    ...
    public:
      ...
      KRATOS_CLASS_POINTER_DEFINITION(SwimmingParticle);
      ...
      SwimmingParticle(IndexType NewId, GeometryType::Pointer pGeometry,  PropertiesType::Pointer pProperties):TBaseElement(NewId, pGeometry, pProperties){}
