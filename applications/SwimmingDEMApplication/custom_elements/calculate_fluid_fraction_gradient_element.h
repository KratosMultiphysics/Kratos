...
#if !defined(KRATOS_COMPUTE_FLUID_FRACTION_GRADIENT_ELEMENT_H_INCLUDED )
#define  KRATOS_COMPUTE_FLUID_FRACTION_GRADIENT_ELEMENT_H_INCLUDED
...
class KRATOS_API(SWIMMING_DEM_APPLICATION) ComputeFluidFractionGradient : public Element
{
public:
    ///@name Type Definitions
    ///@{

    /// Pointer definition of ComputeFluidFractionGradient
    KRATOS_CLASS_INTRUSIVE_POINTER_DEFINITION(ComputeFluidFractionGradient);
     ...
     */
    ComputeFluidFractionGradient(IndexType NewId = 0) :
        Element(NewId)
    {}
     ...
     */
    ComputeFluidFractionGradient(IndexType NewId, const NodesArrayType& ThisNodes) :
     ...
     */
    ComputeFluidFractionGradient(IndexType NewId, GeometryType::Pointer pGeometry) :
     ...
     */
    ComputeFluidFractionGradient(IndexType NewId, GeometryType::Pointer pGeometry, PropertiesType::Pointer pProperties) :
        Element(NewId, pGeometry, pProperties)
    {}

    /// Destructor.
    virtual ~ComputeFluidFractionGradient()
    {}
    ...
    /**
     * Returns a pointer to a new FluidFraction element, created using given input
    ...
    virtual std::string Info() const override
    {
        ...
        buffer << "ComputeFluidFractionGradient #" << Id();
        return buffer.str();
    }
    ...
    {
        rOStream << "ComputeFluidFractionGradient" << TDim << "D" << TNumNodes << "N";
    }
...
protected:
    ...
    void EvaluateInPoint(double & rResult, const Variable< double >& rVariable, const array_1d< double, TNumNodes >& rShapeFunc);
...
private:
    ...
    /// Assignment operator.
    ComputeFluidFractionGradient & operator=(ComputeFluidFractionGradient const& rOther);

    /// Copy constructor.
    ComputeFluidFractionGradient(ComputeFluidFractionGradient const& rOther);

    ///@}

}; // Class ComputeFluidFractionGradient
...
inline std::istream& operator >>(std::istream& rIStream,
                                 ComputeFluidFractionGradient<TDim,TNumNodes>& rThis)
{
    return rIStream;
}
...
inline std::ostream& operator <<(std::ostream& rOStream,
                                 const ComputeFluidFractionGradient<TDim,TNumNodes>& rThis)
{
...
#endif // KRATOS_COMPUTE_FLUID_FRACTION_GRADIENT_ELEMENT_H_INCLUDED  defined
