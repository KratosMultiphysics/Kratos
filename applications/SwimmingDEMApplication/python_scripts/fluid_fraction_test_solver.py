...
class FluidFractionTestSolver(BaseSolver):
    ...
    def CalculateL2Error(self):
        self.velocity_error_norm, self.pressure_error_norm, self.error_model_part, self.reynolds_number = self.L2_error_calculator.CalculateL2()
        return self.velocity_error_norm, self.pressure_error_norm, self.error_model_part, self.reynolds_number
