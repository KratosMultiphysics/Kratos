...
class FluidFractionTestSolver(BaseSolver):
    ...
    def CalculateL2ErrorNorm(self):
        self.velocity_L2_error_norm, self.pressure_L2_error_norm, self.error_model_part = self.error_norm_calculator.CalculateL2Norm(self.fluid_solver.main_model_part)
