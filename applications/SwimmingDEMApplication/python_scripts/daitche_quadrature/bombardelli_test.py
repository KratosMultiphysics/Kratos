...
old_correction = 2 * (sqrt(end_time) - sqrt(end_time - t)) * f(t)
...
print("EXACT_old", ExactIntegrationOfSinusKernel(end_time, 0., t_win))
print("EXACT_recent", ExactIntegrationOfSinusKernel(end_time, t_win, end_time))
print("EXACT all", ExactIntegrationOfSinusKernel(end_time))
