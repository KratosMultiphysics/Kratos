...
class ErrorNormCalculatorUtility:
    def __init__(self, model, parameters):
        ...
        alpha_max = parameters["fluid_parameters"]["processes"]["initial_conditions_process_list"][0]["Parameters"]["benchmark_parameters"]["alpha_max"].GetDouble()
        ...
        Da = sigma/(self.nu * alpha_max)
        #self.p_characteristic = self.u_characteristic * self.nu * (1 + omega/self.nu + Re + Da)
        self.p_characteristic = self.u_characteristic * self.nu * (1 + Re + Da)
