...
class ZhangGuoGradientRecoverer(recoverer.GradientRecoverer):
    def __init__(self,  project_parameters, pp, model_part):
        recoverer.GradientRecoverer.__init__(self,  project_parameters, pp, model_part)
...
class ZhangGuoMaterialAccelerationRecoverer(recoverer.MaterialAccelerationRecoverer, ZhangGuoGradientRecoverer):
    def __init__(self,  project_parameters, pp, model_part):
        recoverer.MaterialAccelerationRecoverer.__init__(self,  project_parameters, pp, model_part)
...
class ZhangGuoDirectLaplacianRecoverer(recoverer.LaplacianRecoverer):
    def __init__(self,  project_parameters, pp, model_part):
        recoverer.LaplacianRecoverer.__init__(self,  project_parameters, pp, model_part)
