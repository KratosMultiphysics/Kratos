...
class Pouliot2012GradientRecoverer(L2_projection_recoverer.L2ProjectionGradientRecoverer):
    def __init__(self,  project_parameters, pp, model_part):
        L2_projection_recoverer.L2ProjectionGradientRecoverer.__init__(self,  project_parameters, pp, model_part)
...
class Pouliot2012MaterialAccelerationRecoverer(Pouliot2012GradientRecoverer, L2_projection_recoverer.L2ProjectionMaterialAccelerationRecoverer):
    def __init__(self, pp, model_part, do_pre_recovery = False):
        L2_projection_recoverer.L2ProjectionMaterialAccelerationRecoverer.__init__(self,  project_parameters, pp, model_part)
        Pouliot2012GradientRecoverer.__init__(self,  project_parameters, pp, model_part)
...
class Pouliot2012LaplacianRecoverer(L2_projection_recoverer.L2ProjectionDerivativesRecoverer, recoverer.LaplacianRecoverer):
    def __init__(self,  project_parameters, pp, model_part):
        ...
        Pouliot2012DerivativesRecoverer.__init__(self,  project_parameters, pp, model_part)
