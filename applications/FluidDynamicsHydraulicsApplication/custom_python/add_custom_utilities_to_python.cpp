...
void AddCustomUtilitiesToPython(pybind11::module& m)
{
    ...
    py::class_<HydraulicFluidAuxiliaryUtilities>(m, "HydraulicFluidAuxiliaryUtilities")
        ...
        .def_static("FixCornerNodeVelocity", [](ModelPart &rModelPart, double angle_corner)
                    { return HydraulicFluidAuxiliaryUtilities::FixCornerNodeVelocity(rModelPart, angle_corner); })
