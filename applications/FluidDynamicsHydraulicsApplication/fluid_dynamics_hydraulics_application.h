...
*/
class KRATOS_API(FLUID_DYNAMICS_HYDRAULICS_APPLICATION) KratosFluidDynamicsHydraulicsApplication : public KratosApplication {
public:
    ///@name Type Definitions
    ///@{
    ...
    {
        return "KratosFluidDynamicsHydraulicsApplication";
    }
