...
void KratosRANSApplication::Register()
{
    ...
    KRATOS_REGISTER_VARIABLE( RANS_GAUSS_STABILIZATION_TAU )
    KRATOS_REGISTER_VARIABLE( RANS_GAUSS_SCALAR_CONSISTENCY_MULTIPLIER )
    KRATOS_REGISTER_VARIABLE( RANS_GAUSS_K_OMEGA_SST_F1 )
    KRATOS_REGISTER_VARIABLE( RANS_GAUSS_K_OMEGA_SST_BLENDED_GAMMA )
    KRATOS_REGISTER_VARIABLE( RANS_GAUSS_K_OMEGA_SST_F1_ARG_1 )
    KRATOS_REGISTER_VARIABLE( RANS_GAUSS_K_OMEGA_SST_F1_ARG_2 )
    KRATOS_REGISTER_VARIABLE( RANS_GAUSS_K_OMEGA_SST_F1_ARG_3 )
    KRATOS_REGISTER_VARIABLE( RANS_GAUSS_K_OMEGA_SST_F1_ARG_4 )
    ...
    KRATOS_REGISTER_VARIABLE( RANS_GAUSS_SYMMETRIC_VELOCITY_GRADIENT )
    KRATOS_REGISTER_VARIABLE( RANS_GAUSS_REYNOLDS_STRESS_TENSOR )
    KRATOS_REGISTER_VARIABLE( RANS_GAUSS_TURBULENT_KINEMATIC_VISCOSITY )
    KRATOS_REGISTER_VARIABLE( RANS_GAUSS_K_OMEGA_SST_BLENDED_SIGMA_OMEGA )
    KRATOS_REGISTER_VARIABLE( RANS_GAUSS_K_OMEGA_SST_TKE_OLD )
    KRATOS_REGISTER_VARIABLE( RANS_GAUSS_K_OMEGA_SST_OMEGA_OLD )
    KRATOS_REGISTER_VARIABLE( RANS_GAUSS_K_OMEGA_SST_VORTICITY_NORM )
    KRATOS_REGISTER_VARIABLE( RANS_GAUSS_K_OMEGA_SST_F2 )
