...
#include "custom_elements/convection_diffusion_reaction_element_data/evm_k_omega_sst/element_data_utilities.h"
...
double RansNutKOmegaSSTUpdateProcess::CalculateElementNuT(const Element& rElement) const
{
    ...
    for (int g = 0; g < num_gauss_points; ++g)
    {
        ...
        const double f_2 =
            EvmKOmegaSSTElementData::CalculateF2(tke, omega, nu, y, mBetaStar);
        ...
        nut += EvmKOmegaSSTElementData::CalculateTurbulentKinematicViscosity(
            tke, omega, t, f_2, mA1);
    }
