...
#if !defined(KRATOS_RANS_K_OMEGA_SST_NEWTONIAN_LAW_H_INCLUDED)
#define KRATOS_RANS_K_OMEGA_SST_NEWTONIAN_LAW_H_INCLUDED
...
#endif // KRATOS_RANS_K_OMEGA_SST_NEWTONIAN_LAW_H_INCLUDED  defined
