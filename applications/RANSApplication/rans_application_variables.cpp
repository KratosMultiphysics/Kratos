...
namespace Kratos
{
    ...
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(RANS_GAUSS_EFFECTIVE_VELOCITY);
    KRATOS_CREATE_VARIABLE(double, RANS_GAUSS_EFFECTIVE_KINEMATIC_VISCOSITY);
    KRATOS_CREATE_VARIABLE(double, RANS_GAUSS_REACTION_TERM);
    KRATOS_CREATE_VARIABLE(double, RANS_GAUSS_SOURCE_TERM);
    KRATOS_CREATE_VARIABLE(double, RANS_GAUSS_STABILIZATION_TAU);
    KRATOS_CREATE_VARIABLE(double, RANS_GAUSS_SCALAR_CONSISTENCY_MULTIPLIER);
    KRATOS_CREATE_VARIABLE(double, RANS_GAUSS_K_OMEGA_SST_F1);
    KRATOS_CREATE_VARIABLE(double, RANS_GAUSS_K_OMEGA_SST_BLENDED_GAMMA);
    KRATOS_CREATE_VARIABLE(double, RANS_GAUSS_K_OMEGA_SST_F1_ARG_1);
    KRATOS_CREATE_VARIABLE(double, RANS_GAUSS_K_OMEGA_SST_F1_ARG_2);
    KRATOS_CREATE_VARIABLE(double, RANS_GAUSS_K_OMEGA_SST_F1_ARG_3);
    KRATOS_CREATE_VARIABLE(double, RANS_GAUSS_K_OMEGA_SST_F1_ARG_4);
    KRATOS_CREATE_VARIABLE(double, RANS_GAUSS_K_OMEGA_SST_F1_ARG_5);
    KRATOS_CREATE_VARIABLE(double, RANS_GAUSS_K_OMEGA_SST_F1_ARG_6);
    KRATOS_CREATE_VARIABLE(double, RANS_GAUSS_PRODUCTION_TERM);
    KRATOS_CREATE_VARIABLE(Matrix, RANS_GAUSS_VELOCITY_GRADIENT);
    KRATOS_CREATE_VARIABLE(Matrix, RANS_GAUSS_SYMMETRIC_VELOCITY_GRADIENT);
    KRATOS_CREATE_VARIABLE(Matrix, RANS_GAUSS_REYNOLDS_STRESS_TENSOR);
    KRATOS_CREATE_VARIABLE(double, RANS_GAUSS_TURBULENT_KINEMATIC_VISCOSITY);
    KRATOS_CREATE_VARIABLE(double, RANS_GAUSS_K_OMEGA_SST_BLENDED_SIGMA_OMEGA);
    KRATOS_CREATE_VARIABLE(double, RANS_GAUSS_K_OMEGA_SST_TKE_OLD);
    KRATOS_CREATE_VARIABLE(double, RANS_GAUSS_K_OMEGA_SST_OMEGA_OLD);
    KRATOS_CREATE_VARIABLE(double, RANS_GAUSS_K_OMEGA_SST_VORTICITY_NORM);
    KRATOS_CREATE_VARIABLE(double, RANS_GAUSS_K_OMEGA_SST_F2);
}
