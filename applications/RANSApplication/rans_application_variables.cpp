...
namespace Kratos
{
    ...
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(VELOCITY_SENSITIVITY)
    KRATOS_CREATE_VARIABLE(double, TURBULENT_KINETIC_ENERGY_SENSITIVITY);
    KRATOS_CREATE_VARIABLE(double, TURBULENT_SPECIFIC_ENERGY_DISSIPATION_RATE_SENSITIVITY);
    KRATOS_CREATE_VARIABLE(double, LOW_FIDELITY_INLET_1);
    KRATOS_CREATE_VARIABLE(double, LOW_FIDELITY_INLET_2);
    KRATOS_CREATE_VARIABLE(double, LOW_FIDELITY_INLET_3);
    KRATOS_CREATE_VARIABLE(double, LOW_FIDELITY_INLET_4);
    
    KRATOS_CREATE_VARIABLE(double, LOW_FIDELITY_INLET_1_SENSITIVITY);
    KRATOS_CREATE_VARIABLE(double, LOW_FIDELITY_INLET_2_SENSITIVITY);
    KRATOS_CREATE_VARIABLE(double, LOW_FIDELITY_INLET_3_SENSITIVITY);
    KRATOS_CREATE_VARIABLE(double, LOW_FIDELITY_INLET_4_SENSITIVITY);

    KRATOS_CREATE_VARIABLE(double, TURBULENT_INTENSITY);
    KRATOS_CREATE_VARIABLE(double, TURBULENT_INTENSITY_SENSITIVITY);
    KRATOS_CREATE_VARIABLE(double, TURBULENT_MIXING_LENGTH);
    KRATOS_CREATE_VARIABLE(double, TURBULENT_MIXING_LENGTH_SENSITIVITY);
}
