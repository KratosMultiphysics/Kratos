...
namespace Kratos
{
    ...
    KRATOS_CREATE_VARIABLE( Matrix, TURBULENT_KINETIC_ENERGY_PARTIAL_DERIVATIVE )
    KRATOS_CREATE_VARIABLE( Matrix, TURBULENT_ENERGY_DISSIPATION_RATE_PARTIAL_DERIVATIVE )
    KRATOS_CREATE_VARIABLE( Matrix, TURBULENT_SPECIFIC_ENERGY_DISSIPATION_RATE_PARTIAL_DERIVATIVE )
    KRATOS_CREATE_VARIABLE( Matrix, VELOCITY_PARTIAL_DERIVATIVE )
