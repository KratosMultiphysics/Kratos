...
KRATOS_CREATE_VARIABLE( double, SPECTRAL_CONSTANT_U)
KRATOS_CREATE_VARIABLE( double, SPECTRAL_CONSTANT_V)
KRATOS_CREATE_VARIABLE( double, SPECTRAL_CONSTANT_W)
KRATOS_CREATE_VARIABLE( double, EFFECTIVE_WAVE_NUMBER)
KRATOS_CREATE_VARIABLE( int, TOTAL_WAVE_NUMBER)
KRATOS_CREATE_VARIABLE( double, TURBULENT_KINETIC_ENERGY_U)
KRATOS_CREATE_VARIABLE( double, TURBULENT_KINETIC_ENERGY_V)
KRATOS_CREATE_VARIABLE( double, TURBULENT_KINETIC_ENERGY_W)
