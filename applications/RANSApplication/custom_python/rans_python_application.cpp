...
PYBIND11_MODULE(KratosRANSApplication,m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, VELOCITY_SENSITIVITY)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, TURBULENT_KINETIC_ENERGY_SENSITIVITY)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, TURBULENT_SPECIFIC_ENERGY_DISSIPATION_RATE_SENSITIVITY)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, LOW_FIDELITY_INLET_1)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, LOW_FIDELITY_INLET_2)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, LOW_FIDELITY_INLET_3)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, LOW_FIDELITY_INLET_4)

    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, LOW_FIDELITY_INLET_1_SENSITIVITY)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, LOW_FIDELITY_INLET_2_SENSITIVITY)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, LOW_FIDELITY_INLET_3_SENSITIVITY)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, LOW_FIDELITY_INLET_4_SENSITIVITY)

    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, TURBULENT_INTENSITY)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, TURBULENT_INTENSITY_SENSITIVITY)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, TURBULENT_MIXING_LENGTH)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, TURBULENT_MIXING_LENGTH_SENSITIVITY)
