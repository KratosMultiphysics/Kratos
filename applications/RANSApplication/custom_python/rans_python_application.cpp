...
PYBIND11_MODULE(KratosRANSApplication,m)
{
    ...
    //registering kinematic simulation variables in python
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, SPECTRAL_CONSTANT_U)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, SPECTRAL_CONSTANT_V)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, SPECTRAL_CONSTANT_W)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, EFFECTIVE_WAVE_NUMBER)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, TOTAL_WAVE_NUMBER)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, TURBULENT_KINETIC_ENERGY_U)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, TURBULENT_KINETIC_ENERGY_V)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, TURBULENT_KINETIC_ENERGY_W)
