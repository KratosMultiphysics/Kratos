...
PYBIND11_MODULE(KratosRANSApplication,m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, RANS_GAUSS_SYMMETRIC_VELOCITY_GRADIENT )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, RANS_GAUSS_REYNOLDS_STRESS_TENSOR )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, RANS_GAUSS_TURBULENT_KINEMATIC_VISCOSITY )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, RANS_GAUSS_K_OMEGA_SST_BLENDED_SIGMA_OMEGA )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, RANS_GAUSS_K_OMEGA_SST_TKE_OLD )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, RANS_GAUSS_K_OMEGA_SST_OMEGA_OLD )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, RANS_GAUSS_K_OMEGA_SST_VORTICITY_NORM )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, RANS_GAUSS_K_OMEGA_SST_F2 )
}
