...
PYBIND11_MODULE(KratosRANSApplication,m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, RANS_Y_PLUS_LIMIT )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, RANS_Y_PLUS_LOWER_LIMIT )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, WALL_MODEL_PART_NAME)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, FRICTION_VELOCITY)

    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, TURBULENCE_RANS_BETA_ZERO)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, TURBULENCE_RANS_GAMMA)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, TURBULENCE_RANS_K_C1)
