...
#define KRATOS_KINEMATIC_SIMULATION_SPECTRAL_CONSTANT_W_H_INCLUDED
...
public:
    ...
    KRATOS_CLASS_POINTER_DEFINITION(KinematicSimulationSpectralConstantWElement);
     ...
     */
    KinematicSimulationSpectralConstantWElement(IndexType NewId, const NodesArrayType& ThisNodes)
     ...
     */
    KinematicSimulationSpectralConstantWElement(IndexType NewId, GeometryType::Pointer pGeometry)
     ...
     */
    KinematicSimulationSpectralConstantWElement(IndexType NewId, GeometryType::Pointer pGeometry, PropertiesType::Pointer pProperties)
     ...
     * Copy Constructor
     */
    KinematicSimulationSpectralConstantWElement(KinematicSimulationSpectralConstantWElement const& rOther)
        : BaseType(rOther)
    {
    }
     ...
     * Destructor
     */
    ~KinematicSimulationSpectralConstantWElement() override = default;
    ...
    std::string Info() const override
    {
        ...
        buffer << "KinematicSimulationSpectralConstantWElement #" << this->Id();
        return buffer.str();
    }
    /// Print information about this object.
    void PrintInfo(std::ostream& rOStream) const override
    {
        rOStream << "KinematicSimulationSpectralConstantWElement #" << this->Id();
    }
