...
#if !defined(KRATOS_RANS_EVM_K_OMEGA_SST_ELEMENT_DATA_UTILITIES_OMEGA_ELEMENT_DATA_H_INCLUDED)
#define KRATOS_RANS_EVM_K_OMEGA_SST_ELEMENT_DATA_UTILITIES_OMEGA_ELEMENT_DATA_H_INCLUDED
