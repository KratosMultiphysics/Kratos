...
#if !defined(KRATOS_RANS_EVM_K_EPSILON_ADJOINT_ELEMENT_DATA_UTILITIES_H_INCLUDED)
#define KRATOS_RANS_EVM_K_EPSILON_ADJOINT_ELEMENT_DATA_UTILITIES_H_INCLUDED
...
template <unsigned int TNumNodes>
void CalculateGaussThetaTkeSensitivity(BoundedVector<double, TNumNodes>& rOutput,
                                       const double Cmu,
                                       const double Theta,
...
template <unsigned int TNumNodes>
void CalculateGaussThetaEpsilonSensitivity(BoundedVector<double, TNumNodes>& rOutput,
                                           const double Theta,
                                           const double TurbulentKinematicViscosity,
