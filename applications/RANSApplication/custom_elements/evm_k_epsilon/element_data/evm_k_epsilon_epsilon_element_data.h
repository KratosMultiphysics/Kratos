...
#if !defined(KRATOS_RANS_EVM_K_EPSILON_ELEMENT_DATA_UTILITIES_EPSILON_ELEMENT_DATA_H_INCLUDED)
#define KRATOS_RANS_EVM_K_EPSILON_ELEMENT_DATA_UTILITIES_EPSILON_ELEMENT_DATA_H_INCLUDED
