...
#if !defined(KRATOS_EVM_K_EPSILON_HIGH_RE_ELEMENT_DATA_EPSILON_ELEMENT_DATA_H_INCLUDED)
#define KRATOS_EVM_K_EPSILON_HIGH_RE_ELEMENT_DATA_EPSILON_ELEMENT_DATA_H_INCLUDED
...
public:
    ...
    EpsilonElementData(const GeomtryType& rGeometry) : BaseType(rGeometry)
    {
    }
