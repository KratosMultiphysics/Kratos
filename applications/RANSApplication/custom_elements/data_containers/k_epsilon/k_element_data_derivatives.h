...
#if !defined(KRATOS_K_ELEMENT_DATA_DERIVATIVES_H)
#define KRATOS_K_ELEMENT_DATA_DERIVATIVES_H
...
public:
    ...
    public:
        ...
        static const std::string GetName() { return "KEpsilonKAdjointElementData"; }
...
#endif // KRATOS_K_ELEMENT_DATA_DERIVATIVES_H