...
template double GetSourceTerm<2>(const BoundedMatrix<double, 2, 2>&, const double);
template double GetSourceTerm<3>(const BoundedMatrix<double, 3, 3>&, const double);
