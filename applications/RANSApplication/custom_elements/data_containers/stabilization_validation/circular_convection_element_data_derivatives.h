...
#if !defined(KRATOS_STABILIZATION_VALIDATION_CIRCULAR_CONVECTION_ELEMENT_DATA_DERIVATIVES_H)
#define KRATOS_STABILIZATION_VALIDATION_CIRCULAR_CONVECTION_ELEMENT_DATA_DERIVATIVES_H
...
class CircularConvectionElementDataDerivatives
{
public:
    ...
    class Data : public CircularConvectionElementData
    {
    public:
        ///@name Type Definitions
        ///@{

        using BaseType = CircularConvectionElementData;
...
#endif // KRATOS_STABILIZATION_VALIDATION_CIRCULAR_CONVECTION_ELEMENT_DATA_DERIVATIVES_H