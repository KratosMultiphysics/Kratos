...
#if !defined(KRATOS_STABILIZATION_VALIDATION_CIRCULAR_CONVECTION_RFC_ADJOINT_ELEMENT_DATA_H)
#define KRATOS_STABILIZATION_VALIDATION_CIRCULAR_CONVECTION_RFC_ADJOINT_ELEMENT_DATA_H
...
class CircularConvectionRFCAdjointElementData
{
public:
    ...
    public:
        ...
        using EquationDataType = StabilizationValidationElementData::CircularConvectionElementDataDerivatives;
...
#endif // KRATOS_STABILIZATION_VALIDATION_CIRCULAR_CONVECTION_RFC_ADJOINT_ELEMENT_DATA_H