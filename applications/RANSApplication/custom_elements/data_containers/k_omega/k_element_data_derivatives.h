...
#if !defined(KRATOS_K_OMEGA_K_ELEMENT_DATA_DERIVATIVES_H)
#define KRATOS_K_OMEGA_K_ELEMENT_DATA_DERIVATIVES_H
...
#endif // KRATOS_K_OMEGA_K_ELEMENT_DATA_DERIVATIVES_H