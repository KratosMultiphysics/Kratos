...
#if !defined(KRATOS_K_OMEGA_OMEGA_ELEMENT_DATA_DERIVATIVES_H)
#define KRATOS_K_OMEGA_OMEGA_ELEMENT_DATA_DERIVATIVES_H
...
public:
    ...
    public:
        ...
        static const std::string GetName() { return "KOmegaOmegaAdjointElementData"; }
...
#endif // KRATOS_K_OMEGA_OMEGA_ELEMENT_DATA_DERIVATIVES_H