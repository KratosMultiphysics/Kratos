...
// Include base h
#include "rans_vms_monolithic_hybrid_wall_condition.h"

namespace Kratos
{
template <unsigned int TDim, unsigned int TNumNodes>
RansVMSMonolithicHybridWallCondition<TDim, TNumNodes>& RansVMSMonolithicHybridWallCondition<TDim, TNumNodes>::operator=(
    RansVMSMonolithicHybridWallCondition<TDim, TNumNodes> const& rOther)
{
...
template <unsigned int TDim, unsigned int TNumNodes>
Condition::Pointer RansVMSMonolithicHybridWallCondition<TDim, TNumNodes>::Create(
    IndexType NewId, NodesArrayType const& ThisNodes, PropertiesType::Pointer pProperties) const
{
    return Kratos::make_intrusive<RansVMSMonolithicHybridWallCondition>(
...
template <unsigned int TDim, unsigned int TNumNodes>
Condition::Pointer RansVMSMonolithicHybridWallCondition<TDim, TNumNodes>::Clone(
...
template <unsigned int TDim, unsigned int TNumNodes>
int RansVMSMonolithicHybridWallCondition<TDim, TNumNodes>::Check(const ProcessInfo& rCurrentProcessInfo)
{
    KRATOS_TRY;
...
template <unsigned int TDim, unsigned int TNumNodes>
void RansVMSMonolithicHybridWallCondition<TDim, TNumNodes>::Initialize()
{
    KRATOS_TRY;
...
template <unsigned int TDim, unsigned int TNumNodes>
std::string RansVMSMonolithicHybridWallCondition<TDim, TNumNodes>::Info() const
{
    std::stringstream buffer;
    buffer << "RansVMSMonolithicHybridWallCondition" << TDim << "D";
    return buffer.str();
}

template <unsigned int TDim, unsigned int TNumNodes>
void RansVMSMonolithicHybridWallCondition<TDim, TNumNodes>::PrintInfo(std::ostream& rOStream) const
{
    rOStream << "RansVMSMonolithicHybridWallCondition";
}

template <unsigned int TDim, unsigned int TNumNodes>
void RansVMSMonolithicHybridWallCondition<TDim, TNumNodes>::PrintData(std::ostream& rOStream) const
{
}

template <unsigned int TDim, unsigned int TNumNodes>
void RansVMSMonolithicHybridWallCondition<TDim, TNumNodes>::ApplyWallLaw(
...
template <unsigned int TDim, unsigned int TNumNodes>
void RansVMSMonolithicHybridWallCondition<TDim, TNumNodes>::save(Serializer& rSerializer) const
{
    KRATOS_SERIALIZE_SAVE_BASE_CLASS(rSerializer, Condition);
}

template <unsigned int TDim, unsigned int TNumNodes>
void RansVMSMonolithicHybridWallCondition<TDim, TNumNodes>::load(Serializer& rSerializer)
{
...
template class RansVMSMonolithicHybridWallCondition<2, 2>;
template class RansVMSMonolithicHybridWallCondition<3, 3>;
