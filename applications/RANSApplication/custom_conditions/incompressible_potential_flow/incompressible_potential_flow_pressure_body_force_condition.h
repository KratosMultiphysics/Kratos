...
#if !defined(KRATOS_INCOMPRESSIBLE_POTENTIAL_FLOW_PRESSURE_BODY_FORCE_CONDITION_H_INCLUDED)
#define KRATOS_INCOMPRESSIBLE_POTENTIAL_FLOW_PRESSURE_BODY_FORCE_CONDITION_H_INCLUDED
...
public:
    ...
    /// Pointer definition of IncompressiblePotentialFlowPressureBodyForceCondition
    KRATOS_CLASS_INTRUSIVE_POINTER_DEFINITION(IncompressiblePotentialFlowPressureBodyForceCondition);
    ...
    /// Destructor.
    ~IncompressiblePotentialFlowPressureBodyForceCondition() override = default;
    ...
    /// Create a new IncompressiblePotentialFlowPressureBodyForceCondition object.
    /**
      @param NewId Index of the new condition
      @param ThisNodes An array containing the nodes of the new condition
      @param pProperties Pointer to the element's properties
...
}; // Class IncompressiblePotentialFlowPressureBodyForceCondition
...
inline std::ostream& operator<<(
    ...
    const IncompressiblePotentialFlowPressureBodyForceCondition<TDim, TNumNodes>& rThis)
{
...
#endif // KRATOS_INCOMPRESSIBLE_POTENTIAL_FLOW_PRESSURE_BODY_FORCE_CONDITION_H_INCLUDED
