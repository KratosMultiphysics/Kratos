...
#if !defined(KRATOS_EVM_K_EPSILON_WALL_CONDITION_DATA_EPSILON_U_BASED_CONDITION_DATA_H_INCLUDED)
#define KRATOS_EVM_K_EPSILON_WALL_CONDITION_DATA_EPSILON_U_BASED_CONDITION_DATA_H_INCLUDED
...
namespace EvmKEpsilonHighReWallConditionData
{
...
public:
    ...
    {
        return "KEpsilonHighReEpsilonUBasedConditionData";
    }

    EpsilonUBasedWallConditionData(const GeomtryType& rGeometry)
        : BaseType(rGeometry)
    {
    }
