...
#if !defined(KRATOS_EVM_K_OMEGA_WALL_CONDITION_DATA_OMEGA_U_BASED_CONDITION_DATA_H_INCLUDED)
#define KRATOS_EVM_K_OMEGA_WALL_CONDITION_DATA_OMEGA_U_BASED_CONDITION_DATA_H_INCLUDED
...
namespace EvmKOmegaWallConditionData
{
...
public:
    ...
    OmegaUBasedWallConditionData(const GeomtryType& rGeometry)
        : BaseType(rGeometry)
    {
    }
