...
#ifndef KRATOS_RANS_EVM_K_EPSILON_EPSILON_K_BASED_RHS_WALL_CONDITION_H
#define KRATOS_RANS_EVM_K_EPSILON_EPSILON_K_BASED_RHS_WALL_CONDITION_H
...
class RansEvmKEpsilonEpsilonKBasedRHSWallCondition : public Condition
{
public:
    ///@name Type Definitions
    ///@{

    /// Pointer definition of RansEvmKEpsilonEpsilonKBasedRHSWallCondition
    KRATOS_CLASS_INTRUSIVE_POINTER_DEFINITION(RansEvmKEpsilonEpsilonKBasedRHSWallCondition);
    ...
    /** Admits an Id as a parameter.
      ...
      */
    explicit RansEvmKEpsilonEpsilonKBasedRHSWallCondition(IndexType NewId = 0)
        : Condition(NewId)
    {
    }
     ...
     */
    RansEvmKEpsilonEpsilonKBasedRHSWallCondition(IndexType NewId, const NodesArrayType& ThisNodes)
     ...
     */
    RansEvmKEpsilonEpsilonKBasedRHSWallCondition(IndexType NewId, GeometryType::Pointer pGeometry)
     ...
     */
    RansEvmKEpsilonEpsilonKBasedRHSWallCondition(IndexType NewId,
    ...
    /// Copy constructor.
    RansEvmKEpsilonEpsilonKBasedRHSWallCondition(RansEvmKEpsilonEpsilonKBasedRHSWallCondition const& rOther)
        : Condition(rOther)
    {
    }

    /// Destructor.
    ~RansEvmKEpsilonEpsilonKBasedRHSWallCondition() override = default;
    ...
    /// Assignment operator
    RansEvmKEpsilonEpsilonKBasedRHSWallCondition& operator=(
        RansEvmKEpsilonEpsilonKBasedRHSWallCondition const& rOther);

    ///@}
    ///@name Operations
    ///@{

    /// Create a new RansEvmKEpsilonEpsilonKBasedRHSWallCondition object.
    /**
      @param NewId Index of the new condition
      @param ThisNodes An array containing the nodes of the new condition
      @param pProperties Pointer to the element's properties
...
}; // Class RansEvmKEpsilonEpsilonKBasedRHSWallCondition
...
inline std::istream& operator>>(std::istream& rIStream,
                                RansEvmKEpsilonEpsilonKBasedRHSWallCondition<TNumNodes>& rThis)
{
    return rIStream;
}
...
inline std::ostream& operator<<(std::ostream& rOStream,
                                const RansEvmKEpsilonEpsilonKBasedRHSWallCondition<TNumNodes>& rThis)
{
...
#endif // KRATOS_RANS_EVM_K_EPSILON_EPSILON_K_BASED_RHS_WALL_CONDITION_H
