...
/**
 * @see FSHighReKWallCondition::EquationIdVector
 */
template <>
...
/**
 * @see FSHighReKWallCondition::GetDofList
 */
template <>
void FSHighReKWallCondition<2, 2>::GetDofList(DofsVectorType& rElementalDofList,
                                              ProcessInfo& rCurrentProcessInfo)
{
    const ProcessInfo& r_process_info = rCurrentProcessInfo;
    int step = r_process_info[FRACTIONAL_STEP];
 ...
 */
template <>
void FSHighReKWallCondition<3, 3>::GetDofList(DofsVectorType& rElementalDofList,
                                              ProcessInfo& rCurrentProcessInfo)
{
    const ProcessInfo& r_process_info = rCurrentProcessInfo;
    int step = r_process_info[FRACTIONAL_STEP];
...
template <>
void FSHighReKWallCondition<2, 2>::CalculateNormal(array_1d<double, 3>& An)
{
...
template <>
void FSHighReKWallCondition<3, 3>::CalculateNormal(array_1d<double, 3>& An)
{
    Geometry<Node<3>>& pGeometry = this->GetGeometry();
...
void FSHighReKWallCondition<TDim, TNumNodes>::ApplyNeumannCondition(MatrixType& rLocalMatrix,
                                                                    VectorType& rLocalVector)
{
    const FSHighReKWallCondition<TDim, TNumNodes>& rConstThis = *this;
...
///////////////////////////////////////////////////////////////////////////////////////////////////
template class FSHighReKWallCondition<2, 2>;
template class FSHighReKWallCondition<3, 3>;
