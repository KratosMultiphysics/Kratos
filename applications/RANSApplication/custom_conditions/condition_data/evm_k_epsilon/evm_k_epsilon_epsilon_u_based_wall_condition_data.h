...
#if !defined(KRATOS_RANS_EVM_K_EPSILON_WALL_CONDITION_DATA_UTILITIES_EPSILON_U_BASED_CONDITION_DATA_H_INCLUDED)
#define KRATOS_RANS_EVM_K_EPSILON_WALL_CONDITION_DATA_UTILITIES_EPSILON_U_BASED_CONDITION_DATA_H_INCLUDED
...
public:
    ...
    EpsilonUBasedWallConditionData(const GeomtryType& rGeometry) : BaseType(rGeometry)
    {
    }
