...
#if !defined(KRATOS_RANS_EVM_K_OMEGA_WALL_CONDITION_DATA_UTILITIES_OMEGA_U_BASED_CONDITION_DATA_H_INCLUDED)
#define KRATOS_RANS_EVM_K_OMEGA_WALL_CONDITION_DATA_UTILITIES_OMEGA_U_BASED_CONDITION_DATA_H_INCLUDED
