...
#if !defined(KRATOS_K_OMEGA_VMS_MONOLITHIC_U_BASED_OMEGA_K_BASED_WALL_CONDITION_DATA_H)
#define KRATOS_K_OMEGA_VMS_MONOLITHIC_U_BASED_OMEGA_K_BASED_WALL_CONDITION_DATA_H
...
public:
    ...
    public:
        ...
        using EquationDataType = KOmegaWallConditionData::OmegaUBasedWallConditionDataDerivatives<TDim>;
...
#endif // KRATOS_K_OMEGA_VMS_MONOLITHIC_U_BASED_OMEGA_K_BASED_WALL_CONDITION_DATA_H