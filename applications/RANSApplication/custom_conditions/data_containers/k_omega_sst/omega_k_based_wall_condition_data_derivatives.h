...
#if !defined(KRATOS_K_OMEGA_SST_OMEGA_K_BASED_WALL_CONDITION_DATA_DERIVATIVES_H)
#define KRATOS_K_OMEGA_SST_OMEGA_K_BASED_WALL_CONDITION_DATA_DERIVATIVES_H
...
class OmegaKBasedWallConditionDataDerivatives
{
public:
    ...
    class Data : public OmegaKBasedWallConditionData
    {
    public:
        ///@name Type Definitions
        ///@{

        using BaseType = OmegaKBasedWallConditionData;
...
#endif // KRATOS_K_OMEGA_SST_OMEGA_K_BASED_WALL_CONDITION_DATA_DERIVATIVES_H