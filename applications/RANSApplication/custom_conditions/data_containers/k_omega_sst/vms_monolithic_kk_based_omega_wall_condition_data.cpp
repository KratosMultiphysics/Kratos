...
// Include base h
#include "vms_monolithic_kk_based_omega_wall_condition_data.h"
...
void VMSMonolithicKBasedOmegaKBasedWallConditionData<TDim, TNumNodes>::Check(
...
template <unsigned int TDim, unsigned int TNumNodes>
void VMSMonolithicKBasedOmegaKBasedWallConditionData<TDim, TNumNodes>::InitializeCondition(
...
template <unsigned int TDim, unsigned int TNumNodes>
std::vector<const Variable<double>*> VMSMonolithicKBasedOmegaKBasedWallConditionData<TDim, TNumNodes>::GetDofVariablesList()
{
...
template class VMSMonolithicKBasedOmegaKBasedWallConditionData<2, 2>;
template class VMSMonolithicKBasedOmegaKBasedWallConditionData<3, 3>;
