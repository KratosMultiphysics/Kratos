...
void OmegaKBasedWallConditionDataDerivatives<TDim>::Data::Check(
...
template <unsigned int TDim>
OmegaKBasedWallConditionDataDerivatives<TDim>::Data::Data(
...
template <unsigned int TDim>
const Variable<double>& OmegaKBasedWallConditionDataDerivatives<TDim>::Data::GetAdjointScalarVariable()
{
    return RANS_SCALAR_2_ADJOINT_1;
}

template <unsigned int TDim>
void OmegaKBasedWallConditionDataDerivatives<TDim>::Data::CalculateGaussPointData(
    const Vector& rN,
    const int Step)
{
...
template <unsigned int TDim>
double OmegaKBasedWallConditionDataDerivatives<TDim>::UDerivative::CalculateWallFluxDerivative(
...
template <unsigned int TDim>
double OmegaKBasedWallConditionDataDerivatives<TDim>::KDerivative::CalculateWallFluxDerivative(
    const IndexType ConditionNodeIndex,
    const IndexType DirectionIndex,
    const double W,
    const Vector& rN,
...
template <unsigned int TDim>
double OmegaKBasedWallConditionDataDerivatives<TDim>::OmegaDerivative::CalculateWallFluxDerivative(
    const IndexType ConditionNodeIndex,
    const IndexType DirectionIndex,
    const double W,
    const Vector& rN,
...
template <unsigned int TDim>
double OmegaKBasedWallConditionDataDerivatives<TDim>::ShapeDerivative::CalculateWallFluxDerivative(
    const IndexType ConditionNodeIndex,
    const IndexType DirectionIndex,
    const double W,
    const Vector& rN,
...
template class OmegaKBasedWallConditionDataDerivatives<2>;
template class OmegaKBasedWallConditionDataDerivatives<3>;
