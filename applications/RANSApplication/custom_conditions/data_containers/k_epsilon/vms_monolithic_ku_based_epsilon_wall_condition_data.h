...
#if !defined(KRATOS_K_EPSILON_VMS_MONOLITHIC_U_BASED_EPSILON_K_BASED_WALL_CONDITION_DATA_H)
#define KRATOS_K_EPSILON_VMS_MONOLITHIC_U_BASED_EPSILON_K_BASED_WALL_CONDITION_DATA_H
...
class VMSMonolithicKBasedEpsilonUBasedWallConditionData
{
public:
    ...
    public:
        ...
        using EquationDataType = KEpsilonWallConditionData::EpsilonUBasedWallConditionDataDerivatives<TDim>;
...
#endif // KRATOS_K_EPSILON_VMS_MONOLITHIC_U_BASED_EPSILON_K_BASED_WALL_CONDITION_DATA_H