...
class KOmegaOmegaFormulation(Formulation):
    def __init__(self, model_part, settings):
        super(KOmegaOmegaFormulation,
    ...
    def SetStabilizationMethod(self, stabilization_method):
        if (stabilization_method == "algebraic_flux_corrected"):
            self.element_name = "RansEvmKOmegaOmegaAFC"
            ...
            self.element_name = "RansEvmKOmegaOmegaResidualBasedFC"
            self.scheme_type = CreateSteadyScalarScheme
        elif (stabilization_method == "non_linear_cross_wind_dissipation"):
            self.element_name = "RansEvmKOmegaOmegaCrossWindStabilized"
            self.scheme_type = CreateSteadyScalarScheme
        else:
