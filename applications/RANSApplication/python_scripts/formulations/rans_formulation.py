...
class RansFormulation:
    ...
    def GetComputingModelPart(self):
        """Returns computational model part used in the formulation

        Computational model part only includes nodes which belong to elements, and conditions which are
        specified in the skin_parts.

        Returns:
            Kratos.ModelPart: Computational model part used in the formulation
        """
        return self.GetBaseModelPart().GetSubModelPart("fluid_computational_model_part")
