...
if (IsDistributedRun()
    ...
    from KratosMultiphysics.RANSApplication.TrilinosExtension import MPIBossakRelaxationScalarScheme as bossak_scheme
    ...
    from KratosMultiphysics.RANSApplication import BossakRelaxationScalarScheme as bossak_scheme
...
def CreateBossakRelaxationScalarScheme(bossak_value, relaxation_factor, scalar_variable,
