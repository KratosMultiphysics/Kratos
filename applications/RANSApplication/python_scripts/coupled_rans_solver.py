...
class CoupledRANSSolver(PythonSolver):
    def __init__(self, model, custom_settings):
        ...
        if (scheme_type == "steady"):
            ...
            for variable_tolerance_data in self.settings["steady_coupling_tolerances"].values():
    ...
    def Initialize(self):
        Kratos.VariableUtils().SetNonHistoricalVariableToZero(Kratos.RELAXED_ACCELERATION, self.GetComputingModelPart().Nodes)
        if (IsDistributedRun()):
