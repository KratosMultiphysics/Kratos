...
namespace Kratos
{
    ...
    KRATOS_DEFINE_APPLICATION_VARIABLE(RANS_APPLICATION, double, RANS_GAUSS_STABILIZATION_TAU )
    KRATOS_DEFINE_APPLICATION_VARIABLE(RANS_APPLICATION, double, RANS_GAUSS_SCALAR_CONSISTENCY_MULTIPLIER )
    KRATOS_DEFINE_APPLICATION_VARIABLE(RANS_APPLICATION, double, RANS_GAUSS_K_OMEGA_SST_F1 )
    KRATOS_DEFINE_APPLICATION_VARIABLE(RANS_APPLICATION, double, RANS_GAUSS_K_OMEGA_SST_BLENDED_GAMMA )
    KRATOS_DEFINE_APPLICATION_VARIABLE(RANS_APPLICATION, double, RANS_GAUSS_K_OMEGA_SST_F1_ARG_1 )
    KRATOS_DEFINE_APPLICATION_VARIABLE(RANS_APPLICATION, double, RANS_GAUSS_K_OMEGA_SST_F1_ARG_2 )
    KRATOS_DEFINE_APPLICATION_VARIABLE(RANS_APPLICATION, double, RANS_GAUSS_K_OMEGA_SST_F1_ARG_3 )
    KRATOS_DEFINE_APPLICATION_VARIABLE(RANS_APPLICATION, double, RANS_GAUSS_K_OMEGA_SST_F1_ARG_4 )
    KRATOS_DEFINE_APPLICATION_VARIABLE(RANS_APPLICATION, double, RANS_GAUSS_K_OMEGA_SST_F1_ARG_5 )
    KRATOS_DEFINE_APPLICATION_VARIABLE(RANS_APPLICATION, double, RANS_GAUSS_K_OMEGA_SST_F1_ARG_6 )
    KRATOS_DEFINE_APPLICATION_VARIABLE(RANS_APPLICATION, double, RANS_GAUSS_PRODUCTION_TERM )
    KRATOS_DEFINE_APPLICATION_VARIABLE(RANS_APPLICATION, Matrix, RANS_GAUSS_VELOCITY_GRADIENT )
    KRATOS_DEFINE_APPLICATION_VARIABLE(RANS_APPLICATION, Matrix, RANS_GAUSS_SYMMETRIC_VELOCITY_GRADIENT )
    KRATOS_DEFINE_APPLICATION_VARIABLE(RANS_APPLICATION, Matrix, RANS_GAUSS_REYNOLDS_STRESS_TENSOR )
    KRATOS_DEFINE_APPLICATION_VARIABLE(RANS_APPLICATION, double, RANS_GAUSS_TURBULENT_KINEMATIC_VISCOSITY )
    KRATOS_DEFINE_APPLICATION_VARIABLE(RANS_APPLICATION, double, RANS_GAUSS_K_OMEGA_SST_BLENDED_SIGMA_OMEGA )
    KRATOS_DEFINE_APPLICATION_VARIABLE(RANS_APPLICATION, double, RANS_GAUSS_K_OMEGA_SST_TKE_OLD )
    KRATOS_DEFINE_APPLICATION_VARIABLE(RANS_APPLICATION, double, RANS_GAUSS_K_OMEGA_SST_OMEGA_OLD )
    KRATOS_DEFINE_APPLICATION_VARIABLE(RANS_APPLICATION, double, RANS_GAUSS_K_OMEGA_SST_VORTICITY_NORM )
    KRATOS_DEFINE_APPLICATION_VARIABLE(RANS_APPLICATION, double, RANS_GAUSS_K_OMEGA_SST_F2 )
