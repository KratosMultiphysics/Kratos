...
KRATOS_DEFINE_APPLICATION_VARIABLE(RANS_APPLICATION, double, RANS_Y_PLUS_LOWER_LIMIT)
...
KRATOS_DEFINE_APPLICATION_VARIABLE(RANS_APPLICATION, double, TURBULENCE_RANS_K_C1)
