...
namespace Kratos
{
    ...
    KRATOS_DEFINE_APPLICATION_VARIABLE_WITH_TIME_DERIVATIVE( RANS_APPLICATION, double, VELOCITY_POTENTIAL_RATE, RANS_AUXILIARY_VARIABLE_1)
    KRATOS_DEFINE_APPLICATION_VARIABLE_WITH_TIME_DERIVATIVE( RANS_APPLICATION, double, VELOCITY_POTENTIAL, VELOCITY_POTENTIAL_RATE)
    ...
    KRATOS_DEFINE_APPLICATION_VARIABLE( RANS_APPLICATION, std::string, ANALYSIS_STEPS )
    ...
    KRATOS_DEFINE_VARIABLE_WITH_TIME_DERIVATIVE(double, RANS_SCALAR_1_ADJOINT_3, RANS_AUX_ADJOINT_SCALAR_1);
    KRATOS_DEFINE_VARIABLE_WITH_TIME_DERIVATIVE(double, RANS_SCALAR_1_ADJOINT_2, RANS_SCALAR_1_ADJOINT_3);
    KRATOS_DEFINE_VARIABLE_WITH_TIME_DERIVATIVE(double, RANS_SCALAR_1_ADJOINT_1, RANS_SCALAR_1_ADJOINT_2);

    KRATOS_DEFINE_APPLICATION_VARIABLE(RANS_APPLICATION, double, RANS_AUX_ADJOINT_SCALAR_2 )
    KRATOS_DEFINE_VARIABLE_WITH_TIME_DERIVATIVE(double, RANS_SCALAR_2_ADJOINT_3, RANS_AUX_ADJOINT_SCALAR_2);
    KRATOS_DEFINE_VARIABLE_WITH_TIME_DERIVATIVE(double, RANS_SCALAR_2_ADJOINT_2, RANS_SCALAR_2_ADJOINT_3);
    KRATOS_DEFINE_VARIABLE_WITH_TIME_DERIVATIVE(double, RANS_SCALAR_2_ADJOINT_1, RANS_SCALAR_2_ADJOINT_2);
    ...
    KRATOS_DEFINE_APPLICATION_VARIABLE( RANS_APPLICATION, Vector, RESPONSE_FUNCTION_INTERPOLATION_ERROR)
    KRATOS_DEFINE_APPLICATION_VARIABLE( RANS_APPLICATION, Vector, RESPONSE_FUNCTION_INTERPOLATION_ERROR_AUXILIARY_1)
    KRATOS_DEFINE_APPLICATION_VARIABLE( RANS_APPLICATION, Vector, RESPONSE_FUNCTION_INTERPOLATION_ERROR_AUXILIARY_2)

    KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS( RANS_APPLICATION, VELOCITY_SENSITIVITY)
    KRATOS_DEFINE_APPLICATION_VARIABLE( RANS_APPLICATION, double, TURBULENT_KINETIC_ENERGY_SENSITIVITY )
    KRATOS_DEFINE_APPLICATION_VARIABLE( RANS_APPLICATION, double, TURBULENT_SPECIFIC_ENERGY_DISSIPATION_RATE_SENSITIVITY )
    KRATOS_DEFINE_APPLICATION_VARIABLE( RANS_APPLICATION, double, LOW_FIDELITY_INLET_1 )
    KRATOS_DEFINE_APPLICATION_VARIABLE( RANS_APPLICATION, double, LOW_FIDELITY_INLET_2 )
    KRATOS_DEFINE_APPLICATION_VARIABLE( RANS_APPLICATION, double, LOW_FIDELITY_INLET_3 )
    KRATOS_DEFINE_APPLICATION_VARIABLE( RANS_APPLICATION, double, LOW_FIDELITY_INLET_4 )
    KRATOS_DEFINE_APPLICATION_VARIABLE( RANS_APPLICATION, double, LOW_FIDELITY_INLET_1_SENSITIVITY )
    KRATOS_DEFINE_APPLICATION_VARIABLE( RANS_APPLICATION, double, LOW_FIDELITY_INLET_2_SENSITIVITY )
    KRATOS_DEFINE_APPLICATION_VARIABLE( RANS_APPLICATION, double, LOW_FIDELITY_INLET_3_SENSITIVITY )
    KRATOS_DEFINE_APPLICATION_VARIABLE( RANS_APPLICATION, double, LOW_FIDELITY_INLET_4_SENSITIVITY )

    KRATOS_DEFINE_APPLICATION_VARIABLE( RANS_APPLICATION, double, TURBULENT_INTENSITY );
    KRATOS_DEFINE_APPLICATION_VARIABLE( RANS_APPLICATION, double, TURBULENT_INTENSITY_SENSITIVITY );
    KRATOS_DEFINE_APPLICATION_VARIABLE( RANS_APPLICATION, double, TURBULENT_MIXING_LENGTH );
    KRATOS_DEFINE_APPLICATION_VARIABLE( RANS_APPLICATION, double, TURBULENT_MIXING_LENGTH_SENSITIVITY );
