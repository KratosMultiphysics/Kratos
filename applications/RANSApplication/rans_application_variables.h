...
KRATOS_DEFINE_APPLICATION_VARIABLE(RANS_APPLICATION, double, TURBULENT_VISCOSITY_MIN)
KRATOS_DEFINE_APPLICATION_VARIABLE(RANS_APPLICATION, double, TURBULENT_VISCOSITY_MAX)
