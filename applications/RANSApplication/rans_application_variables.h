...
namespace Kratos
{
    ...
    KRATOS_DEFINE_APPLICATION_VARIABLE_WITH_TIME_DERIVATIVE( RANS_APPLICATION, TURBULENT_KINETIC_ENERGY_RATE, RANS_AUXILIARY_VARIABLE_1)
    KRATOS_DEFINE_APPLICATION_VARIABLE_WITH_TIME_DERIVATIVE( RANS_APPLICATION, TURBULENT_KINETIC_ENERGY, TURBULENT_KINETIC_ENERGY_RATE)
    KRATOS_DEFINE_APPLICATION_VARIABLE_WITH_TIME_DERIVATIVE( RANS_APPLICATION, TURBULENT_ENERGY_DISSIPATION_RATE_2, RANS_AUXILIARY_VARIABLE_2)
    KRATOS_DEFINE_APPLICATION_VARIABLE_WITH_TIME_DERIVATIVE( RANS_APPLICATION, TURBULENT_ENERGY_DISSIPATION_RATE, TURBULENT_ENERGY_DISSIPATION_RATE_2)
    ...
    KRATOS_DEFINE_APPLICATION_VARIABLE_WITH_TIME_DERIVATIVE( RANS_APPLICATION, TURBULENT_SPECIFIC_ENERGY_DISSIPATION_RATE_2, RANS_AUXILIARY_VARIABLE_2)
    KRATOS_DEFINE_APPLICATION_VARIABLE_WITH_TIME_DERIVATIVE( RANS_APPLICATION, TURBULENT_SPECIFIC_ENERGY_DISSIPATION_RATE, TURBULENT_SPECIFIC_ENERGY_DISSIPATION_RATE_2)
