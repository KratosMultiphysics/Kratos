...
namespace Kratos
{
    ...
    KRATOS_DEFINE_APPLICATION_VARIABLE(RANS_APPLICATION, double, SPECTRAL_CONSTANT_U)
    KRATOS_DEFINE_APPLICATION_VARIABLE(RANS_APPLICATION, double, SPECTRAL_CONSTANT_V)
    KRATOS_DEFINE_APPLICATION_VARIABLE(RANS_APPLICATION, double, SPECTRAL_CONSTANT_W)
    KRATOS_DEFINE_APPLICATION_VARIABLE(RANS_APPLICATION, double, EFFECTIVE_WAVE_NUMBER)
    KRATOS_DEFINE_APPLICATION_VARIABLE(RANS_APPLICATION, int, TOTAL_WAVE_NUMBER)
    KRATOS_DEFINE_APPLICATION_VARIABLE(RANS_APPLICATION, double, TURBULENT_KINETIC_ENERGY_U)
    KRATOS_DEFINE_APPLICATION_VARIABLE(RANS_APPLICATION, double, TURBULENT_KINETIC_ENERGY_V)
    KRATOS_DEFINE_APPLICATION_VARIABLE(RANS_APPLICATION, double, TURBULENT_KINETIC_ENERGY_W)
