...
namespace Kratos
{
    ...
    KRATOS_DEFINE_APPLICATION_VARIABLE(RANS_APPLICATION, Matrix, TURBULENT_KINETIC_ENERGY_PARTIAL_DERIVATIVE )
    KRATOS_DEFINE_APPLICATION_VARIABLE(RANS_APPLICATION, Matrix, TURBULENT_ENERGY_DISSIPATION_RATE_PARTIAL_DERIVATIVE )
    KRATOS_DEFINE_APPLICATION_VARIABLE(RANS_APPLICATION, Matrix, TURBULENT_SPECIFIC_ENERGY_DISSIPATION_RATE_PARTIAL_DERIVATIVE )
    KRATOS_DEFINE_APPLICATION_VARIABLE(RANS_APPLICATION, Matrix, VELOCITY_PARTIAL_DERIVATIVE )
