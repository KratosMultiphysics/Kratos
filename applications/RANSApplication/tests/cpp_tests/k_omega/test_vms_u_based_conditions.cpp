...
ModelPart& CreateRansKOmegaVMSKBasedOmegaUBased2D2NModelPart(
    Model& rModel,
    ...
    const double Tolerance)
{
    ...
    auto& r_primal_model_part = CreateRansKOmegaVMSKBasedOmegaUBased2D2NModelPart(model, "primal", rPrimalConditionName, rVelocitySettingMethod);

    // prepare adjoint model part
    auto& r_adjoint_model_part = CreateRansKOmegaVMSKBasedOmegaUBased2D2NModelPart(model, "adjoint", "RansKOmegaVMSKBasedOmegaUBasedWallAdjoint2D2N", rVelocitySettingMethod);
...
/********************************************************************************************************/
/************** RansKOmegaVMSMonolithicKBasedOmegaUBasedWallCondition Derivative Tests **************/
/********************************************************************************************************/

KRATOS_TEST_CASE_IN_SUITE(RansKOmegaVMSMonolithicKBasedOmegaUBasedWallConditionFirstDerivativesLHS_UU_1, KratosRansFastSuite)
{
...
KRATOS_TEST_CASE_IN_SUITE(RansKOmegaVMSMonolithicKBasedOmegaUBasedWallConditionFirstDerivativesLHS_UU_2, KratosRansFastSuite)
{
    const auto& derivatives_method = [](Matrix& rMatrix, ModelPart::ConditionType& rCondition,
                                        const ProcessInfo& rProcessInfo) {
        rCondition.CalculateFirstDerivativesLHS(rMatrix, rProcessInfo);
...
KRATOS_TEST_CASE_IN_SUITE(RansKOmegaVMSMonolithicKBasedOmegaUBasedWallConditionFirstDerivativesLHS_UU_3, KratosRansFastSuite)
{
    const auto& derivatives_method = [](Matrix& rMatrix, ModelPart::ConditionType& rCondition,
                                        const ProcessInfo& rProcessInfo) {
        rCondition.CalculateFirstDerivativesLHS(rMatrix, rProcessInfo);
...
KRATOS_TEST_CASE_IN_SUITE(RansKOmegaVMSMonolithicKBasedOmegaUBasedWallConditionFirstDerivativesLHS_UP_1, KratosRansFastSuite)
{
    const auto& derivatives_method = [](Matrix& rMatrix, ModelPart::ConditionType& rCondition,
                                        const ProcessInfo& rProcessInfo) {
        rCondition.CalculateFirstDerivativesLHS(rMatrix, rProcessInfo);
...
KRATOS_TEST_CASE_IN_SUITE(RansKOmegaVMSMonolithicKBasedOmegaUBasedWallConditionFirstDerivativesLHS_UP_2, KratosRansFastSuite)
{
    const auto& derivatives_method = [](Matrix& rMatrix, ModelPart::ConditionType& rCondition,
                                        const ProcessInfo& rProcessInfo) {
        rCondition.CalculateFirstDerivativesLHS(rMatrix, rProcessInfo);
...
KRATOS_TEST_CASE_IN_SUITE(RansKOmegaVMSMonolithicKBasedOmegaUBasedWallConditionFirstDerivativesLHS_UP_3, KratosRansFastSuite)
{
    const auto& derivatives_method = [](Matrix& rMatrix, ModelPart::ConditionType& rCondition,
                                        const ProcessInfo& rProcessInfo) {
        rCondition.CalculateFirstDerivativesLHS(rMatrix, rProcessInfo);
...
KRATOS_TEST_CASE_IN_SUITE(RansKOmegaVMSMonolithicKBasedOmegaUBasedWallConditionFirstDerivativesLHS_UK_1, KratosRansFastSuite)
{
    const auto& derivatives_method = [](Matrix& rMatrix, ModelPart::ConditionType& rCondition,
                                        const ProcessInfo& rProcessInfo) {
        rCondition.CalculateFirstDerivativesLHS(rMatrix, rProcessInfo);
...
KRATOS_TEST_CASE_IN_SUITE(RansKOmegaVMSMonolithicKBasedOmegaUBasedWallConditionFirstDerivativesLHS_UK_2, KratosRansFastSuite)
{
    const auto& derivatives_method = [](Matrix& rMatrix, ModelPart::ConditionType& rCondition,
                                        const ProcessInfo& rProcessInfo) {
        rCondition.CalculateFirstDerivativesLHS(rMatrix, rProcessInfo);
...
KRATOS_TEST_CASE_IN_SUITE(RansKOmegaVMSMonolithicKBasedOmegaUBasedWallConditionFirstDerivativesLHS_UK_3, KratosRansFastSuite)
{
    const auto& derivatives_method = [](Matrix& rMatrix, ModelPart::ConditionType& rCondition,
                                        const ProcessInfo& rProcessInfo) {
        rCondition.CalculateFirstDerivativesLHS(rMatrix, rProcessInfo);
...
KRATOS_TEST_CASE_IN_SUITE(RansKOmegaVMSMonolithicKBasedOmegaUBasedWallConditionFirstDerivativesLHS_UE_1, KratosRansFastSuite)
{
    const auto& derivatives_method = [](Matrix& rMatrix, ModelPart::ConditionType& rCondition,
                                        const ProcessInfo& rProcessInfo) {
        rCondition.CalculateFirstDerivativesLHS(rMatrix, rProcessInfo);
...
KRATOS_TEST_CASE_IN_SUITE(RansKOmegaVMSMonolithicKBasedOmegaUBasedWallConditionFirstDerivativesLHS_UE_2, KratosRansFastSuite)
{
    const auto& derivatives_method = [](Matrix& rMatrix, ModelPart::ConditionType& rCondition,
                                        const ProcessInfo& rProcessInfo) {
        rCondition.CalculateFirstDerivativesLHS(rMatrix, rProcessInfo);
...
KRATOS_TEST_CASE_IN_SUITE(RansKOmegaVMSMonolithicKBasedOmegaUBasedWallConditionFirstDerivativesLHS_UE_3, KratosRansFastSuite)
{
    const auto& derivatives_method = [](Matrix& rMatrix, ModelPart::ConditionType& rCondition,
                                        const ProcessInfo& rProcessInfo) {
        rCondition.CalculateFirstDerivativesLHS(rMatrix, rProcessInfo);
...
KRATOS_TEST_CASE_IN_SUITE(RansKOmegaVMSMonolithicKBasedOmegaUBasedWallConditionFirstDerivativesLHS_UX_1, KratosRansFastSuite)
{
    const auto& derivatives_method = [](Matrix& rMatrix, ModelPart::ConditionType& rCondition,
                                        const ProcessInfo& rProcessInfo) {
...
KRATOS_TEST_CASE_IN_SUITE(RansKOmegaVMSMonolithicKBasedOmegaUBasedWallConditionFirstDerivativesLHS_UX_2, KratosRansFastSuite)
{
    const auto& derivatives_method = [](Matrix& rMatrix, ModelPart::ConditionType& rCondition,
                                        const ProcessInfo& rProcessInfo) {
        rCondition.CalculateSensitivityMatrix(SHAPE_SENSITIVITY, rMatrix, rProcessInfo);
...
KRATOS_TEST_CASE_IN_SUITE(RansKOmegaVMSMonolithicKBasedOmegaUBasedWallConditionFirstDerivativesLHS_UX_3, KratosRansFastSuite)
{
    const auto& derivatives_method = [](Matrix& rMatrix, ModelPart::ConditionType& rCondition,
                                        const ProcessInfo& rProcessInfo) {
        rCondition.CalculateSensitivityMatrix(SHAPE_SENSITIVITY, rMatrix, rProcessInfo);
...
KRATOS_TEST_CASE_IN_SUITE(RansKOmegaVMSMonolithicKBasedOmegaUBasedWallConditionSecondDerivativesLHS_U_1, KratosRansFastSuite)
{
    const auto& derivatives_method = [](Matrix& rMatrix, ModelPart::ConditionType& rCondition,
                                        const ProcessInfo& rProcessInfo) {
...
KRATOS_TEST_CASE_IN_SUITE(RansKOmegaVMSMonolithicKBasedOmegaUBasedWallConditionSecondDerivativesLHS_U_2, KratosRansFastSuite)
{
    const auto& derivatives_method = [](Matrix& rMatrix, ModelPart::ConditionType& rCondition,
                                        const ProcessInfo& rProcessInfo) {
        rCondition.CalculateSecondDerivativesLHS(rMatrix, rProcessInfo);
...
KRATOS_TEST_CASE_IN_SUITE(RansKOmegaVMSMonolithicKBasedOmegaUBasedWallConditionSecondDerivativesLHS_U_3, KratosRansFastSuite)
{
    const auto& derivatives_method = [](Matrix& rMatrix, ModelPart::ConditionType& rCondition,
                                        const ProcessInfo& rProcessInfo) {
        rCondition.CalculateSecondDerivativesLHS(rMatrix, rProcessInfo);
...
KRATOS_TEST_CASE_IN_SUITE(RansKOmegaVMSMonolithicKBasedOmegaUBasedWallConditionFirstDerivativesLHS_EU_1, KratosRansFastSuite)
{
    const auto& derivatives_method = [](Matrix& rMatrix, ModelPart::ConditionType& rCondition,
                                        const ProcessInfo& rProcessInfo) {
        rCondition.CalculateFirstDerivativesLHS(rMatrix, rProcessInfo);
    ...
    RunRansKOmegaQSVMSRFCAdjointTest("RansKOmegaOmegaUBasedWall2D2N", VELOCITY, derivatives_method, SetUBasedUtauLinear, 4, 0, 1e-5, 1e-5);
}

KRATOS_TEST_CASE_IN_SUITE(RansKOmegaVMSMonolithicKBasedOmegaUBasedWallConditionFirstDerivativesLHS_EU_2, KratosRansFastSuite)
{
    const auto& derivatives_method = [](Matrix& rMatrix, ModelPart::ConditionType& rCondition,
                                        const ProcessInfo& rProcessInfo) {
        rCondition.CalculateFirstDerivativesLHS(rMatrix, rProcessInfo);
    ...
    RunRansKOmegaQSVMSRFCAdjointTest("RansKOmegaOmegaUBasedWall2D2N", VELOCITY, derivatives_method, SetUBasedUtauLogarithmic, 4, 0, 1e-5, 1e-5);
}

KRATOS_TEST_CASE_IN_SUITE(RansKOmegaVMSMonolithicKBasedOmegaUBasedWallConditionFirstDerivativesLHS_EU_3, KratosRansFastSuite)
{
    const auto& derivatives_method = [](Matrix& rMatrix, ModelPart::ConditionType& rCondition,
                                        const ProcessInfo& rProcessInfo) {
        rCondition.CalculateFirstDerivativesLHS(rMatrix, rProcessInfo);
    ...
    RunRansKOmegaQSVMSRFCAdjointTest("RansKOmegaOmegaUBasedWall2D2N", VELOCITY, derivatives_method, SetTkeBasedUtau, 4, 0, 1e-5, 1e-5);
}

KRATOS_TEST_CASE_IN_SUITE(RansKOmegaVMSMonolithicKBasedOmegaUBasedWallConditionFirstDerivativesLHS_EP_1, KratosRansFastSuite)
{
    const auto& derivatives_method = [](Matrix& rMatrix, ModelPart::ConditionType& rCondition,
                                        const ProcessInfo& rProcessInfo) {
        rCondition.CalculateFirstDerivativesLHS(rMatrix, rProcessInfo);
    ...
    RunRansKOmegaQSVMSRFCAdjointTest("RansKOmegaOmegaUBasedWall2D2N", PRESSURE, derivatives_method, SetUBasedUtauLinear, 4, 2, 1e-5, 1e-5);
}

KRATOS_TEST_CASE_IN_SUITE(RansKOmegaVMSMonolithicKBasedOmegaUBasedWallConditionFirstDerivativesLHS_EP_2, KratosRansFastSuite)
{
    const auto& derivatives_method = [](Matrix& rMatrix, ModelPart::ConditionType& rCondition,
                                        const ProcessInfo& rProcessInfo) {
        rCondition.CalculateFirstDerivativesLHS(rMatrix, rProcessInfo);
    ...
    RunRansKOmegaQSVMSRFCAdjointTest("RansKOmegaOmegaUBasedWall2D2N", PRESSURE, derivatives_method, SetUBasedUtauLogarithmic, 4, 2, 1e-5, 1e-5);
}

KRATOS_TEST_CASE_IN_SUITE(RansKOmegaVMSMonolithicKBasedOmegaUBasedWallConditionFirstDerivativesLHS_EP_3, KratosRansFastSuite)
{
    const auto& derivatives_method = [](Matrix& rMatrix, ModelPart::ConditionType& rCondition,
                                        const ProcessInfo& rProcessInfo) {
        rCondition.CalculateFirstDerivativesLHS(rMatrix, rProcessInfo);
    ...
    RunRansKOmegaQSVMSRFCAdjointTest("RansKOmegaOmegaUBasedWall2D2N", PRESSURE, derivatives_method, SetTkeBasedUtau, 4, 2, 1e-5, 1e-5);
}

KRATOS_TEST_CASE_IN_SUITE(RansKOmegaVMSMonolithicKBasedOmegaUBasedWallConditionFirstDerivativesLHS_EK_1, KratosRansFastSuite)
{
    const auto& derivatives_method = [](Matrix& rMatrix, ModelPart::ConditionType& rCondition,
                                        const ProcessInfo& rProcessInfo) {
        rCondition.CalculateFirstDerivativesLHS(rMatrix, rProcessInfo);
    ...
    RunRansKOmegaQSVMSRFCAdjointTest("RansKOmegaOmegaUBasedWall2D2N", TURBULENT_KINETIC_ENERGY, derivatives_method, SetUBasedUtauLinear, 4, 3, 1e-7, 1e-5);
}

KRATOS_TEST_CASE_IN_SUITE(RansKOmegaVMSMonolithicKBasedOmegaUBasedWallConditionFirstDerivativesLHS_EK_2, KratosRansFastSuite)
{
    const auto& derivatives_method = [](Matrix& rMatrix, ModelPart::ConditionType& rCondition,
                                        const ProcessInfo& rProcessInfo) {
        rCondition.CalculateFirstDerivativesLHS(rMatrix, rProcessInfo);
    ...
    RunRansKOmegaQSVMSRFCAdjointTest("RansKOmegaOmegaUBasedWall2D2N", TURBULENT_KINETIC_ENERGY, derivatives_method, SetUBasedUtauLogarithmic, 4, 3, 1e-7, 1e-5);
}

KRATOS_TEST_CASE_IN_SUITE(RansKOmegaVMSMonolithicKBasedOmegaUBasedWallConditionFirstDerivativesLHS_EK_3, KratosRansFastSuite)
{
    const auto& derivatives_method = [](Matrix& rMatrix, ModelPart::ConditionType& rCondition,
                                        const ProcessInfo& rProcessInfo) {
        rCondition.CalculateFirstDerivativesLHS(rMatrix, rProcessInfo);
    ...
    RunRansKOmegaQSVMSRFCAdjointTest("RansKOmegaOmegaUBasedWall2D2N", TURBULENT_KINETIC_ENERGY, derivatives_method, SetTkeBasedUtau, 4, 3, 1e-7, 1e-5);
}

KRATOS_TEST_CASE_IN_SUITE(RansKOmegaVMSMonolithicKBasedOmegaUBasedWallConditionFirstDerivativesLHS_EE_1, KratosRansFastSuite)
{
    const auto& derivatives_method = [](Matrix& rMatrix, ModelPart::ConditionType& rCondition,
                                        const ProcessInfo& rProcessInfo) {
        rCondition.CalculateFirstDerivativesLHS(rMatrix, rProcessInfo);
    ...
    RunRansKOmegaQSVMSRFCAdjointTest("RansKOmegaOmegaUBasedWall2D2N", TURBULENT_SPECIFIC_ENERGY_DISSIPATION_RATE, derivatives_method, SetUBasedUtauLinear, 4, 4, 1e-7, 1e-5);
}

KRATOS_TEST_CASE_IN_SUITE(RansKOmegaVMSMonolithicKBasedOmegaUBasedWallConditionFirstDerivativesLHS_EE_2, KratosRansFastSuite)
{
    const auto& derivatives_method = [](Matrix& rMatrix, ModelPart::ConditionType& rCondition,
                                        const ProcessInfo& rProcessInfo) {
        rCondition.CalculateFirstDerivativesLHS(rMatrix, rProcessInfo);
    ...
    RunRansKOmegaQSVMSRFCAdjointTest("RansKOmegaOmegaUBasedWall2D2N", TURBULENT_SPECIFIC_ENERGY_DISSIPATION_RATE, derivatives_method, SetUBasedUtauLogarithmic, 4, 4, 1e-7, 1e-5);
}

KRATOS_TEST_CASE_IN_SUITE(RansKOmegaVMSMonolithicKBasedOmegaUBasedWallConditionFirstDerivativesLHS_EE_3, KratosRansFastSuite)
{
    const auto& derivatives_method = [](Matrix& rMatrix, ModelPart::ConditionType& rCondition,
                                        const ProcessInfo& rProcessInfo) {
        rCondition.CalculateFirstDerivativesLHS(rMatrix, rProcessInfo);
    ...
    RunRansKOmegaQSVMSRFCAdjointTest("RansKOmegaOmegaUBasedWall2D2N", TURBULENT_SPECIFIC_ENERGY_DISSIPATION_RATE, derivatives_method, SetTkeBasedUtau, 4, 4, 1e-7, 1e-5);
}

KRATOS_TEST_CASE_IN_SUITE(RansKOmegaVMSMonolithicKBasedOmegaUBasedWallConditionFirstDerivativesLHS_EX_1, KratosRansFastSuite)
{
    const auto& derivatives_method = [](Matrix& rMatrix, ModelPart::ConditionType& rCondition,
                                        const ProcessInfo& rProcessInfo) {
        rCondition.CalculateSensitivityMatrix(SHAPE_SENSITIVITY, rMatrix, rProcessInfo);
    ...
    RunRansKOmegaQSVMSRFCAdjointTest("RansKOmegaOmegaUBasedWall2D2N", SHAPE_SENSITIVITY, derivatives_method, SetUBasedUtauLinear, 4, 0, 1e-10, 1e-5);
}

KRATOS_TEST_CASE_IN_SUITE(RansKOmegaVMSMonolithicKBasedOmegaUBasedWallConditionFirstDerivativesLHS_EX_2, KratosRansFastSuite)
{
    const auto& derivatives_method = [](Matrix& rMatrix, ModelPart::ConditionType& rCondition,
                                        const ProcessInfo& rProcessInfo) {
        rCondition.CalculateSensitivityMatrix(SHAPE_SENSITIVITY, rMatrix, rProcessInfo);
    ...
    RunRansKOmegaQSVMSRFCAdjointTest("RansKOmegaOmegaUBasedWall2D2N", SHAPE_SENSITIVITY, derivatives_method, SetUBasedUtauLogarithmic, 4, 0, 1e-10, 1e-5);
}

KRATOS_TEST_CASE_IN_SUITE(RansKOmegaVMSMonolithicKBasedOmegaUBasedWallConditionFirstDerivativesLHS_EX_3, KratosRansFastSuite)
{
    const auto& derivatives_method = [](Matrix& rMatrix, ModelPart::ConditionType& rCondition,
                                        const ProcessInfo& rProcessInfo) {
        rCondition.CalculateSensitivityMatrix(SHAPE_SENSITIVITY, rMatrix, rProcessInfo);
    ...
    RunRansKOmegaQSVMSRFCAdjointTest("RansKOmegaOmegaUBasedWall2D2N", SHAPE_SENSITIVITY, derivatives_method, SetTkeBasedUtau, 4, 0, 1e-10, 1e-5);
}
