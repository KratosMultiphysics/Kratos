...
KRATOS_TEST_CASE_IN_SUITE(StabilizationValidationCircularConvectionPhiDerivative, KratosRansFastSuite)
{
    Model model;

    AdjointTestUtilities::RunElementDataDerivativeTest<
        StabilizationValidationElementData::CircularConvectionElementData, StabilizationValidationElementData::CircularConvectionElementDataDerivatives::PhiDerivative>(
...
KRATOS_TEST_CASE_IN_SUITE(StabilizationValidationCircularConvectionShapeDerivative, KratosRansFastSuite)
{
    Model model;

    AdjointTestUtilities::RunElementDataDerivativeTest<
        StabilizationValidationElementData::CircularConvectionElementData, StabilizationValidationElementData::CircularConvectionElementDataDerivatives::ShapeDerivative>(
        model, StabilizationValidationAddVariables, StabilizationValidationSetVariables,
        StabilizationValidationSetProperties, [](ModelPart&){}, 2, 1e-6, 1e-5);
}
