...
namespace
{
ModelPart& RansEvmKOmegaKCWD2D3N_SetUp(Model& rModel)
{
    ModelPart& r_model_part = EvmKOmegaTestUtilities::RansEvmKOmegaK2D3N_SetUp(
        rModel, "RansEvmKOmegaKCWD2D3N");
...
ModelPart& RansEvmKOmegaOmegaCWD2D3N_SetUp(Model& rModel)
{
    ModelPart& r_model_part = EvmKOmegaTestUtilities::RansEvmKOmegaOmega2D3N_SetUp(
        rModel, "RansEvmKOmegaOmegaCWD2D3N");
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKOmegaKCWD2D3N_EquationIdVector, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKOmegaKCWD2D3N_SetUp(model);

    // Test:
    RansApplicationTestUtilities::TestEquationIdVector(r_model_part);
}

KRATOS_TEST_CASE_IN_SUITE(RansEvmKOmegaKCWD2D3N_GetDofList, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKOmegaKCWD2D3N_SetUp(model);
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKOmegaKCWD2D3N_CalculateLocalSystem, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKOmegaKCWD2D3N_SetUp(model);
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKOmegaKCWD2D3N_CalculateRightHandSide, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKOmegaKCWD2D3N_SetUp(model);
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKOmegaKCWD2D3N_CalculateLocalVelocityContribution, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKOmegaKCWD2D3N_SetUp(model);
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKOmegaKCWD2D3N_CalculateMassMatrix, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKOmegaKCWD2D3N_SetUp(model);
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKOmegaKCWD2D3N_CalculateDampingMatrix, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKOmegaKCWD2D3N_SetUp(model);
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKOmegaOmegaCWD2D3N_EquationIdVector, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKOmegaOmegaCWD2D3N_SetUp(model);

    // Test:
    RansApplicationTestUtilities::TestEquationIdVector(r_model_part);
}

KRATOS_TEST_CASE_IN_SUITE(RansEvmKOmegaOmegaCWD2D3N_GetDofList, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKOmegaOmegaCWD2D3N_SetUp(model);
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKOmegaOmegaCWD2D3N_CalculateLocalSystem, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKOmegaOmegaCWD2D3N_SetUp(model);
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKOmegaOmegaCWD2D3N_CalculateRightHandSide, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKOmegaOmegaCWD2D3N_SetUp(model);
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKOmegaOmegaCWD2D3N_CalculateLocalVelocityContribution, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKOmegaOmegaCWD2D3N_SetUp(model);
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKOmegaOmegaCWD2D3N_CalculateMassMatrix, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKOmegaOmegaCWD2D3N_SetUp(model);
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKOmegaOmegaCWD2D3N_CalculateDampingMatrix, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKOmegaOmegaCWD2D3N_SetUp(model);
