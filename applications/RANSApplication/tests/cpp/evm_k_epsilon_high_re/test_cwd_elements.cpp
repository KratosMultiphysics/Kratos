...
namespace
{
ModelPart& RansEvmKEpsilonHighReKCWD2D3N_SetUp(Model& rModel)
{
    ModelPart& r_model_part = EvmKEpsilonHighReTestUtilities::RansEvmKEpsilonHighReK2D3N_SetUp(
        rModel, "RansEvmKEpsilonHighReKCWD2D3N");
...
ModelPart& RansEvmKEpsilonHighReEpsilonCWD2D3N_SetUp(Model& rModel)
{
    ModelPart& r_model_part =
        EvmKEpsilonHighReTestUtilities::RansEvmKEpsilonHighReEpsilon2D3N_SetUp(
            rModel, "RansEvmKEpsilonHighReEpsilonCWD2D3N");
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKEpsilonHighReKCWD2D3N_EquationIdVector, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKEpsilonHighReKCWD2D3N_SetUp(model);

    // Test:
    RansApplicationTestUtilities::TestEquationIdVector(r_model_part);
}

KRATOS_TEST_CASE_IN_SUITE(RansEvmKEpsilonHighReKCWD2D3N_GetDofList, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKEpsilonHighReKCWD2D3N_SetUp(model);
    ...
    // Test:
    RansApplicationTestUtilities::TestGetDofList(r_model_part, TURBULENT_KINETIC_ENERGY);
}

KRATOS_TEST_CASE_IN_SUITE(RansEvmKEpsilonHighReKCWD2D3N_CalculateLocalSystem, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKEpsilonHighReKCWD2D3N_SetUp(model);
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKEpsilonHighReKCWD2D3N_CalculateRightHandSide, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKEpsilonHighReKCWD2D3N_SetUp(model);
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKEpsilonHighReKCWD2D3N_CalculateLocalVelocityContribution,
                          KratosRansFastSuite)
{
    // Setup:
    Model model;
    ...
    // setting reference values
    ref_LHS(0, 0) = 4.28930381657884390734e+03;
    ref_LHS(0, 1) = -3.88525378845462455502e+03;
    ref_LHS(0, 2) = 1.62018597810960670813e+02;
    ref_LHS(1, 0) = -3.88409108103458356709e+03;
    ref_LHS(1, 1) = 8.46660469175607795478e+03;
    ref_LHS(1, 2) = -3.85623285104481601593e+03;
    ref_LHS(2, 0) = 1.62289207415342730201e+02;
    ref_LHS(2, 1) = -3.85636810752153451176e+03;
    ref_LHS(2, 2) = 4.44110252285800561367e+03;

    ref_RHS[0] = 5.69858143375562212896e+04;
    ref_RHS[1] = -2.70857955132563714869e+05;
    ref_RHS[2] = 1.10122414206304732943e+05;
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKEpsilonHighReKCWD2D3N_CalculateMassMatrix, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKEpsilonHighReKCWD2D3N_SetUp(model);
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKEpsilonHighReKCWD2D3N_CalculateDampingMatrix, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKEpsilonHighReKCWD2D3N_SetUp(model);
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKEpsilonHighReEpsilonCWD2D3N_EquationIdVector, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKEpsilonHighReEpsilonCWD2D3N_SetUp(model);

    // Test:
    RansApplicationTestUtilities::TestEquationIdVector(r_model_part);
}

KRATOS_TEST_CASE_IN_SUITE(RansEvmKEpsilonHighReEpsilonCWD2D3N_GetDofList, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKEpsilonHighReEpsilonCWD2D3N_SetUp(model);
    ...
    // Test:
    RansApplicationTestUtilities::TestGetDofList(r_model_part, TURBULENT_ENERGY_DISSIPATION_RATE);
}

KRATOS_TEST_CASE_IN_SUITE(RansEvmKEpsilonHighReEpsilonCWD2D3N_CalculateLocalSystem, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKEpsilonHighReEpsilonCWD2D3N_SetUp(model);
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKEpsilonHighReEpsilonCWD2D3N_CalculateRightHandSide, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKEpsilonHighReEpsilonCWD2D3N_SetUp(model);
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKEpsilonHighReEpsilonCWD2D3N_CalculateLocalVelocityContribution,
                          KratosRansFastSuite)
{
    // Setup:
    Model model;
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKEpsilonHighReEpsilonCWD2D3N_CalculateMassMatrix, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKEpsilonHighReEpsilonCWD2D3N_SetUp(model);
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKEpsilonHighReEpsilonCWD2D3N_CalculateDampingMatrix, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKEpsilonHighReEpsilonCWD2D3N_SetUp(model);
