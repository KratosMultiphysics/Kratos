...
namespace
{
ModelPart& RansEvmKEpsilonHighReKAFC2D3N_SetUp(Model& rModel)
{
    ModelPart& r_model_part = EvmKEpsilonHighReTestUtilities::RansEvmKEpsilonHighReK2D3N_SetUp(
        rModel, "RansEvmKEpsilonHighReKAFC2D3N");

    return r_model_part;
}

ModelPart& RansEvmKEpsilonHighReEpsilonAFC2D3N_SetUp(Model& rModel)
{
    ModelPart& r_model_part =
        EvmKEpsilonHighReTestUtilities::RansEvmKEpsilonHighReEpsilon2D3N_SetUp(
            rModel, "RansEvmKEpsilonHighReEpsilonAFC2D3N");
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKEpsilonHighReKAFC2D3N_EquationIdVector, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKEpsilonHighReKAFC2D3N_SetUp(model);

    // Test:
    RansApplicationTestUtilities::TestEquationIdVector(r_model_part);
}

KRATOS_TEST_CASE_IN_SUITE(RansEvmKEpsilonHighReKAFC2D3N_GetDofList, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKEpsilonHighReKAFC2D3N_SetUp(model);
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKEpsilonHighReKAFC2D3N_CalculateLocalSystem, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKEpsilonHighReKAFC2D3N_SetUp(model);
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKEpsilonHighReKAFC2D3N_CalculateRightHandSide, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKEpsilonHighReKAFC2D3N_SetUp(model);
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKEpsilonHighReKAFC2D3N_CalculateLocalVelocityContribution,
                          KratosRansFastSuite)
{
    // Setup:
    Model model;
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKEpsilonHighReKAFC2D3N_CalculateMassMatrix, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKEpsilonHighReKAFC2D3N_SetUp(model);
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKEpsilonHighReKAFC2D3N_CalculateDampingMatrix, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKEpsilonHighReKAFC2D3N_SetUp(model);
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKEpsilonHighReEpsilonAFC2D3N_EquationIdVector, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKEpsilonHighReEpsilonAFC2D3N_SetUp(model);

    // Test:
    RansApplicationTestUtilities::TestEquationIdVector(r_model_part);
}

KRATOS_TEST_CASE_IN_SUITE(RansEvmKEpsilonHighReEpsilonAFC2D3N_GetDofList, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKEpsilonHighReEpsilonAFC2D3N_SetUp(model);
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKEpsilonHighReEpsilonAFC2D3N_CalculateLocalSystem, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKEpsilonHighReEpsilonAFC2D3N_SetUp(model);
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKEpsilonHighReEpsilonAFC2D3N_CalculateRightHandSide, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKEpsilonHighReEpsilonAFC2D3N_SetUp(model);
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKEpsilonHighReEpsilonAFC2D3N_CalculateLocalVelocityContribution,
                          KratosRansFastSuite)
{
    // Setup:
    Model model;
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKEpsilonHighReEpsilonAFC2D3N_CalculateMassMatrix, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKEpsilonHighReEpsilonAFC2D3N_SetUp(model);
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKEpsilonHighReEpsilonAFC2D3N_CalculateDampingMatrix, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKEpsilonHighReEpsilonAFC2D3N_SetUp(model);
