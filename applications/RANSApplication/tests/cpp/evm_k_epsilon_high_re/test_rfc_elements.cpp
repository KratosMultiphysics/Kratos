...
namespace
{
ModelPart& RansEvmKEpsilonHighReKRFC2D3N_SetUp(Model& rModel)
{
    ModelPart& r_model_part = EvmKEpsilonHighReTestUtilities::RansEvmKEpsilonHighReK2D3N_SetUp(
        rModel, "RansEvmKEpsilonHighReKRFC2D3N");
...
ModelPart& RansEvmKEpsilonHighReEpsilonRFC2D3N_SetUp(Model& rModel)
{
    ModelPart& r_model_part =
        EvmKEpsilonHighReTestUtilities::RansEvmKEpsilonHighReEpsilon2D3N_SetUp(
            rModel, "RansEvmKEpsilonHighReEpsilonRFC2D3N");
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKEpsilonHighReKRFC2D3N_EquationIdVector, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKEpsilonHighReKRFC2D3N_SetUp(model);

    // Test:
    RansApplicationTestUtilities::TestEquationIdVector(r_model_part);
}

KRATOS_TEST_CASE_IN_SUITE(RansEvmKEpsilonHighReKRFC2D3N_GetDofList, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKEpsilonHighReKRFC2D3N_SetUp(model);
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKEpsilonHighReKRFC2D3N_CalculateLocalSystem, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKEpsilonHighReKRFC2D3N_SetUp(model);
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKEpsilonHighReKRFC2D3N_CalculateRightHandSide, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKEpsilonHighReKRFC2D3N_SetUp(model);
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKEpsilonHighReKRFC2D3N_CalculateLocalVelocityContribution,
                          KratosRansFastSuite)
{
    // Setup:
    Model model;
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKEpsilonHighReKRFC2D3N_CalculateMassMatrix, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKEpsilonHighReKRFC2D3N_SetUp(model);
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKEpsilonHighReKRFC2D3N_CalculateDampingMatrix, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKEpsilonHighReKRFC2D3N_SetUp(model);
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKEpsilonHighReEpsilonRFC2D3N_EquationIdVector, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKEpsilonHighReEpsilonRFC2D3N_SetUp(model);

    // Test:
    RansApplicationTestUtilities::TestEquationIdVector(r_model_part);
}

KRATOS_TEST_CASE_IN_SUITE(RansEvmKEpsilonHighReEpsilonRFC2D3N_GetDofList, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKEpsilonHighReEpsilonRFC2D3N_SetUp(model);
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKEpsilonHighReEpsilonRFC2D3N_CalculateLocalSystem, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKEpsilonHighReEpsilonRFC2D3N_SetUp(model);
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKEpsilonHighReEpsilonRFC2D3N_CalculateRightHandSide, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKEpsilonHighReEpsilonRFC2D3N_SetUp(model);
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKEpsilonHighReEpsilonRFC2D3N_CalculateLocalVelocityContribution,
                          KratosRansFastSuite)
{
    // Setup:
    Model model;
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKEpsilonHighReEpsilonRFC2D3N_CalculateMassMatrix, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKEpsilonHighReEpsilonRFC2D3N_SetUp(model);
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKEpsilonHighReEpsilonRFC2D3N_CalculateDampingMatrix, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKEpsilonHighReEpsilonRFC2D3N_SetUp(model);
