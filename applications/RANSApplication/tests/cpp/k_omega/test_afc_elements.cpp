...
namespace
{
ModelPart& RansKOmegaKAFC2D3N_SetUp(Model& rModel)
{
...
ModelPart& RansKOmegaOmegaAFC2D3N_SetUp(Model& rModel)
{
...
KRATOS_TEST_CASE_IN_SUITE(RansKOmegaKAFC2D3N_EquationIdVector, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansKOmegaKAFC2D3N_SetUp(model);
...
KRATOS_TEST_CASE_IN_SUITE(RansKOmegaOmegaAFC2D3N_EquationIdVector, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansKOmegaOmegaAFC2D3N_SetUp(model);
