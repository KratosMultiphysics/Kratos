...
namespace
{
ModelPart& RansKOmegaKRFC2D3N_SetUp(Model& rModel)
{
...
ModelPart& RansKOmegaOmegaRFC2D3N_SetUp(Model& rModel)
{
...
KRATOS_TEST_CASE_IN_SUITE(RansKOmegaKRFC2D3N_EquationIdVector, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansKOmegaKRFC2D3N_SetUp(model);
...
KRATOS_TEST_CASE_IN_SUITE(RansKOmegaOmegaRFC2D3N_EquationIdVector, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansKOmegaOmegaRFC2D3N_SetUp(model);
