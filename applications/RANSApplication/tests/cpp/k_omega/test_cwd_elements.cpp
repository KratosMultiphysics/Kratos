...
namespace
{
ModelPart& RansKOmegaKCWD2D3N_SetUp(Model& rModel)
{
...
ModelPart& RansKOmegaOmegaCWD2D3N_SetUp(Model& rModel)
{
...
KRATOS_TEST_CASE_IN_SUITE(RansKOmegaKCWD2D3N_EquationIdVector, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansKOmegaKCWD2D3N_SetUp(model);
...
KRATOS_TEST_CASE_IN_SUITE(RansKOmegaOmegaCWD2D3N_EquationIdVector, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansKOmegaOmegaCWD2D3N_SetUp(model);
