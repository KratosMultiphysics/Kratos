...
namespace
{
ModelPart& RansEvmKEpsilonKRFC2D3N_SetUp(Model& rModel)
{
    ModelPart& r_model_part = EvmKEpsilonTestUtilities::RansEvmKEpsilonK2D3N_SetUp(
        rModel, "RansEvmKEpsilonKRFC2D3N");
...
ModelPart& RansEvmKEpsilonEpsilonRFC2D3N_SetUp(Model& rModel)
{
    ModelPart& r_model_part =
        EvmKEpsilonTestUtilities::RansEvmKEpsilonEpsilon2D3N_SetUp(
            rModel, "RansEvmKEpsilonEpsilonRFC2D3N");
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKEpsilonKRFC2D3N_EquationIdVector, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKEpsilonKRFC2D3N_SetUp(model);

    // Test:
    RansApplicationTestUtilities::TestEquationIdVector<ModelPart::ElementsContainerType>(r_model_part);
}

KRATOS_TEST_CASE_IN_SUITE(RansEvmKEpsilonKRFC2D3N_GetDofList, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKEpsilonKRFC2D3N_SetUp(model);
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKEpsilonKRFC2D3N_CalculateLocalSystem, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKEpsilonKRFC2D3N_SetUp(model);
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKEpsilonKRFC2D3N_CalculateRightHandSide, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKEpsilonKRFC2D3N_SetUp(model);
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKEpsilonKRFC2D3N_CalculateLocalVelocityContribution,
                          KratosRansFastSuite)
{
    // Setup:
    Model model;
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKEpsilonKRFC2D3N_CalculateMassMatrix, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKEpsilonKRFC2D3N_SetUp(model);
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKEpsilonKRFC2D3N_CalculateDampingMatrix, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKEpsilonKRFC2D3N_SetUp(model);
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKEpsilonEpsilonRFC2D3N_EquationIdVector, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKEpsilonEpsilonRFC2D3N_SetUp(model);

    // Test:
    RansApplicationTestUtilities::TestEquationIdVector<ModelPart::ElementsContainerType>(r_model_part);
}

KRATOS_TEST_CASE_IN_SUITE(RansEvmKEpsilonEpsilonRFC2D3N_GetDofList, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKEpsilonEpsilonRFC2D3N_SetUp(model);
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKEpsilonEpsilonRFC2D3N_CalculateLocalSystem, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKEpsilonEpsilonRFC2D3N_SetUp(model);
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKEpsilonEpsilonRFC2D3N_CalculateRightHandSide, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKEpsilonEpsilonRFC2D3N_SetUp(model);
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKEpsilonEpsilonRFC2D3N_CalculateLocalVelocityContribution,
                          KratosRansFastSuite)
{
    // Setup:
    Model model;
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKEpsilonEpsilonRFC2D3N_CalculateMassMatrix, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKEpsilonEpsilonRFC2D3N_SetUp(model);
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKEpsilonEpsilonRFC2D3N_CalculateDampingMatrix, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKEpsilonEpsilonRFC2D3N_SetUp(model);
