...
namespace
{
ModelPart& RansKOmegaSSTKRFC2D3N_SetUp(Model& rModel)
{
...
ModelPart& RansKOmegaSSTOmegaRFC2D3N_SetUp(Model& rModel)
{
...
KRATOS_TEST_CASE_IN_SUITE(RansKOmegaSSTOmegaRFC2D3N_CalculateLocalVelocityContribution,
                          KratosRansFastSuite)
{
    // Setup:
    Model model;
