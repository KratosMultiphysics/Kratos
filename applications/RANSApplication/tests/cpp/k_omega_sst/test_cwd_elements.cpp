...
namespace
{
ModelPart& RansKOmegaSSTKCWD2D3N_SetUp(Model& rModel)
{
...
ModelPart& RansKOmegaSSTOmegaCWD2D3N_SetUp(Model& rModel)
{
...
KRATOS_TEST_CASE_IN_SUITE(RansKOmegaSSTOmegaCWD2D3N_CalculateLocalVelocityContribution,
                          KratosRansFastSuite)
{
    // Setup:
    Model model;
