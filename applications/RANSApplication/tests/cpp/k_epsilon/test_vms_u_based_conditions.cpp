    ...
    const std::function<void(ModelPart&)>& rVelocitySetMethod)
{
    ...
    auto& r_model_part = FluidTestUtilities::CreateTestModelPart(
        rModel, rModelPartName, "RansKEpsilonQSVMSRFCAdjoint2D3N", rConditionName, set_element_properties,
    ...
    const double Tolerance)
{
    ...
    auto& r_primal_model_part = CreateRansKEpsilonVMSKBasedEpsilonUBased2D2NModelPart(model, "primal", rPrimalConditionName, rVelocitySettingMethod);
    RansVariableUtilities::SetElementConstitutiveLaws(r_primal_model_part.Elements());

    // prepare adjoint model part
    auto& r_adjoint_model_part = CreateRansKEpsilonVMSKBasedEpsilonUBased2D2NModelPart(model, "adjoint", "RansKEpsilonVMSKBasedEpsilonUBasedWallAdjoint2D2N", rVelocitySettingMethod);
...
/********************************************************************************************************/
/************** RansKEpsilonVMSMonolithicKBasedEpsilonUBasedWallCondition Derivative Tests **************/
/********************************************************************************************************/

KRATOS_TEST_CASE_IN_SUITE(RansKEpsilonVMSMonolithicKBasedEpsilonUBasedWallConditionFirstDerivativesLHS_UU_1, KratosRansFastSuite)
{
...
KRATOS_TEST_CASE_IN_SUITE(RansKEpsilonVMSMonolithicKBasedEpsilonUBasedWallConditionFirstDerivativesLHS_UU_2, KratosRansFastSuite)
{
    const auto& derivatives_method = [](Matrix& rMatrix, ModelPart::ConditionType& rCondition,
                                        const ProcessInfo& rProcessInfo) {
        rCondition.CalculateFirstDerivativesLHS(rMatrix, rProcessInfo);
...
KRATOS_TEST_CASE_IN_SUITE(RansKEpsilonVMSMonolithicKBasedEpsilonUBasedWallConditionFirstDerivativesLHS_UU_3, KratosRansFastSuite)
{
    const auto& derivatives_method = [](Matrix& rMatrix, ModelPart::ConditionType& rCondition,
                                        const ProcessInfo& rProcessInfo) {
        rCondition.CalculateFirstDerivativesLHS(rMatrix, rProcessInfo);
...
KRATOS_TEST_CASE_IN_SUITE(RansKEpsilonVMSMonolithicKBasedEpsilonUBasedWallConditionFirstDerivativesLHS_UP_1, KratosRansFastSuite)
{
    const auto& derivatives_method = [](Matrix& rMatrix, ModelPart::ConditionType& rCondition,
                                        const ProcessInfo& rProcessInfo) {
        rCondition.CalculateFirstDerivativesLHS(rMatrix, rProcessInfo);
...
KRATOS_TEST_CASE_IN_SUITE(RansKEpsilonVMSMonolithicKBasedEpsilonUBasedWallConditionFirstDerivativesLHS_UP_2, KratosRansFastSuite)
{
    const auto& derivatives_method = [](Matrix& rMatrix, ModelPart::ConditionType& rCondition,
                                        const ProcessInfo& rProcessInfo) {
        rCondition.CalculateFirstDerivativesLHS(rMatrix, rProcessInfo);
...
KRATOS_TEST_CASE_IN_SUITE(RansKEpsilonVMSMonolithicKBasedEpsilonUBasedWallConditionFirstDerivativesLHS_UP_3, KratosRansFastSuite)
{
    const auto& derivatives_method = [](Matrix& rMatrix, ModelPart::ConditionType& rCondition,
                                        const ProcessInfo& rProcessInfo) {
        rCondition.CalculateFirstDerivativesLHS(rMatrix, rProcessInfo);
...
KRATOS_TEST_CASE_IN_SUITE(RansKEpsilonVMSMonolithicKBasedEpsilonUBasedWallConditionFirstDerivativesLHS_UK_1, KratosRansFastSuite)
{
    const auto& derivatives_method = [](Matrix& rMatrix, ModelPart::ConditionType& rCondition,
                                        const ProcessInfo& rProcessInfo) {
        rCondition.CalculateFirstDerivativesLHS(rMatrix, rProcessInfo);
...
KRATOS_TEST_CASE_IN_SUITE(RansKEpsilonVMSMonolithicKBasedEpsilonUBasedWallConditionFirstDerivativesLHS_UK_2, KratosRansFastSuite)
{
    const auto& derivatives_method = [](Matrix& rMatrix, ModelPart::ConditionType& rCondition,
                                        const ProcessInfo& rProcessInfo) {
        rCondition.CalculateFirstDerivativesLHS(rMatrix, rProcessInfo);
...
KRATOS_TEST_CASE_IN_SUITE(RansKEpsilonVMSMonolithicKBasedEpsilonUBasedWallConditionFirstDerivativesLHS_UK_3, KratosRansFastSuite)
{
    const auto& derivatives_method = [](Matrix& rMatrix, ModelPart::ConditionType& rCondition,
                                        const ProcessInfo& rProcessInfo) {
        rCondition.CalculateFirstDerivativesLHS(rMatrix, rProcessInfo);
...
KRATOS_TEST_CASE_IN_SUITE(RansKEpsilonVMSMonolithicKBasedEpsilonUBasedWallConditionFirstDerivativesLHS_UE_1, KratosRansFastSuite)
{
    const auto& derivatives_method = [](Matrix& rMatrix, ModelPart::ConditionType& rCondition,
                                        const ProcessInfo& rProcessInfo) {
        rCondition.CalculateFirstDerivativesLHS(rMatrix, rProcessInfo);
...
KRATOS_TEST_CASE_IN_SUITE(RansKEpsilonVMSMonolithicKBasedEpsilonUBasedWallConditionFirstDerivativesLHS_UE_2, KratosRansFastSuite)
{
    const auto& derivatives_method = [](Matrix& rMatrix, ModelPart::ConditionType& rCondition,
                                        const ProcessInfo& rProcessInfo) {
        rCondition.CalculateFirstDerivativesLHS(rMatrix, rProcessInfo);
...
KRATOS_TEST_CASE_IN_SUITE(RansKEpsilonVMSMonolithicKBasedEpsilonUBasedWallConditionFirstDerivativesLHS_UE_3, KratosRansFastSuite)
{
    const auto& derivatives_method = [](Matrix& rMatrix, ModelPart::ConditionType& rCondition,
                                        const ProcessInfo& rProcessInfo) {
        rCondition.CalculateFirstDerivativesLHS(rMatrix, rProcessInfo);
...
KRATOS_TEST_CASE_IN_SUITE(RansKEpsilonVMSMonolithicKBasedEpsilonUBasedWallConditionFirstDerivativesLHS_UX_1, KratosRansFastSuite)
{
    const auto& derivatives_method = [](Matrix& rMatrix, ModelPart::ConditionType& rCondition,
                                        const ProcessInfo& rProcessInfo) {
...
KRATOS_TEST_CASE_IN_SUITE(RansKEpsilonVMSMonolithicKBasedEpsilonUBasedWallConditionFirstDerivativesLHS_UX_2, KratosRansFastSuite)
{
    const auto& derivatives_method = [](Matrix& rMatrix, ModelPart::ConditionType& rCondition,
                                        const ProcessInfo& rProcessInfo) {
        rCondition.CalculateSensitivityMatrix(SHAPE_SENSITIVITY, rMatrix, rProcessInfo);
...
KRATOS_TEST_CASE_IN_SUITE(RansKEpsilonVMSMonolithicKBasedEpsilonUBasedWallConditionFirstDerivativesLHS_UX_3, KratosRansFastSuite)
{
    const auto& derivatives_method = [](Matrix& rMatrix, ModelPart::ConditionType& rCondition,
                                        const ProcessInfo& rProcessInfo) {
        rCondition.CalculateSensitivityMatrix(SHAPE_SENSITIVITY, rMatrix, rProcessInfo);
...
KRATOS_TEST_CASE_IN_SUITE(RansKEpsilonVMSMonolithicKBasedEpsilonUBasedWallConditionSecondDerivativesLHS_U_1, KratosRansFastSuite)
{
    const auto& derivatives_method = [](Matrix& rMatrix, ModelPart::ConditionType& rCondition,
                                        const ProcessInfo& rProcessInfo) {
...
KRATOS_TEST_CASE_IN_SUITE(RansKEpsilonVMSMonolithicKBasedEpsilonUBasedWallConditionSecondDerivativesLHS_U_2, KratosRansFastSuite)
{
    const auto& derivatives_method = [](Matrix& rMatrix, ModelPart::ConditionType& rCondition,
                                        const ProcessInfo& rProcessInfo) {
        rCondition.CalculateSecondDerivativesLHS(rMatrix, rProcessInfo);
...
KRATOS_TEST_CASE_IN_SUITE(RansKEpsilonVMSMonolithicKBasedEpsilonUBasedWallConditionSecondDerivativesLHS_U_3, KratosRansFastSuite)
{
    const auto& derivatives_method = [](Matrix& rMatrix, ModelPart::ConditionType& rCondition,
                                        const ProcessInfo& rProcessInfo) {
        rCondition.CalculateSecondDerivativesLHS(rMatrix, rProcessInfo);
...
KRATOS_TEST_CASE_IN_SUITE(RansKEpsilonVMSMonolithicKBasedEpsilonUBasedWallConditionFirstDerivativesLHS_EU_1, KratosRansFastSuite)
{
    const auto& derivatives_method = [](Matrix& rMatrix, ModelPart::ConditionType& rCondition,
                                        const ProcessInfo& rProcessInfo) {
        rCondition.CalculateFirstDerivativesLHS(rMatrix, rProcessInfo);
    ...
    RunRansKEpsilonQSVMSRFCAdjointTest("RansKEpsilonEpsilonUBasedWall2D2N", VELOCITY, derivatives_method, SetUBasedUtauLinear, 4, 0, 1e-5, 1e-5);
}

KRATOS_TEST_CASE_IN_SUITE(RansKEpsilonVMSMonolithicKBasedEpsilonUBasedWallConditionFirstDerivativesLHS_EU_2, KratosRansFastSuite)
{
    const auto& derivatives_method = [](Matrix& rMatrix, ModelPart::ConditionType& rCondition,
                                        const ProcessInfo& rProcessInfo) {
        rCondition.CalculateFirstDerivativesLHS(rMatrix, rProcessInfo);
    ...
    RunRansKEpsilonQSVMSRFCAdjointTest("RansKEpsilonEpsilonUBasedWall2D2N", VELOCITY, derivatives_method, SetUBasedUtauLogarithmic, 4, 0, 1e-5, 1e-5);
}

KRATOS_TEST_CASE_IN_SUITE(RansKEpsilonVMSMonolithicKBasedEpsilonUBasedWallConditionFirstDerivativesLHS_EU_3, KratosRansFastSuite)
{
    const auto& derivatives_method = [](Matrix& rMatrix, ModelPart::ConditionType& rCondition,
                                        const ProcessInfo& rProcessInfo) {
        rCondition.CalculateFirstDerivativesLHS(rMatrix, rProcessInfo);
    ...
    RunRansKEpsilonQSVMSRFCAdjointTest("RansKEpsilonEpsilonUBasedWall2D2N", VELOCITY, derivatives_method, SetTkeBasedUtau, 4, 0, 1e-5, 1e-5);
}

KRATOS_TEST_CASE_IN_SUITE(RansKEpsilonVMSMonolithicKBasedEpsilonUBasedWallConditionFirstDerivativesLHS_EP_1, KratosRansFastSuite)
{
    const auto& derivatives_method = [](Matrix& rMatrix, ModelPart::ConditionType& rCondition,
                                        const ProcessInfo& rProcessInfo) {
        rCondition.CalculateFirstDerivativesLHS(rMatrix, rProcessInfo);
    ...
    RunRansKEpsilonQSVMSRFCAdjointTest("RansKEpsilonEpsilonUBasedWall2D2N", PRESSURE, derivatives_method, SetUBasedUtauLinear, 4, 2, 1e-5, 1e-5);
}

KRATOS_TEST_CASE_IN_SUITE(RansKEpsilonVMSMonolithicKBasedEpsilonUBasedWallConditionFirstDerivativesLHS_EP_2, KratosRansFastSuite)
{
    const auto& derivatives_method = [](Matrix& rMatrix, ModelPart::ConditionType& rCondition,
                                        const ProcessInfo& rProcessInfo) {
        rCondition.CalculateFirstDerivativesLHS(rMatrix, rProcessInfo);
    ...
    RunRansKEpsilonQSVMSRFCAdjointTest("RansKEpsilonEpsilonUBasedWall2D2N", PRESSURE, derivatives_method, SetUBasedUtauLogarithmic, 4, 2, 1e-5, 1e-5);
}

KRATOS_TEST_CASE_IN_SUITE(RansKEpsilonVMSMonolithicKBasedEpsilonUBasedWallConditionFirstDerivativesLHS_EP_3, KratosRansFastSuite)
{
    const auto& derivatives_method = [](Matrix& rMatrix, ModelPart::ConditionType& rCondition,
                                        const ProcessInfo& rProcessInfo) {
        rCondition.CalculateFirstDerivativesLHS(rMatrix, rProcessInfo);
    ...
    RunRansKEpsilonQSVMSRFCAdjointTest("RansKEpsilonEpsilonUBasedWall2D2N", PRESSURE, derivatives_method, SetTkeBasedUtau, 4, 2, 1e-5, 1e-5);
}

KRATOS_TEST_CASE_IN_SUITE(RansKEpsilonVMSMonolithicKBasedEpsilonUBasedWallConditionFirstDerivativesLHS_EK_1, KratosRansFastSuite)
{
    const auto& derivatives_method = [](Matrix& rMatrix, ModelPart::ConditionType& rCondition,
                                        const ProcessInfo& rProcessInfo) {
        rCondition.CalculateFirstDerivativesLHS(rMatrix, rProcessInfo);
    ...
    RunRansKEpsilonQSVMSRFCAdjointTest("RansKEpsilonEpsilonUBasedWall2D2N", TURBULENT_KINETIC_ENERGY, derivatives_method, SetUBasedUtauLinear, 4, 3, 1e-7, 1e-5);
}

KRATOS_TEST_CASE_IN_SUITE(RansKEpsilonVMSMonolithicKBasedEpsilonUBasedWallConditionFirstDerivativesLHS_EK_2, KratosRansFastSuite)
{
    const auto& derivatives_method = [](Matrix& rMatrix, ModelPart::ConditionType& rCondition,
                                        const ProcessInfo& rProcessInfo) {
        rCondition.CalculateFirstDerivativesLHS(rMatrix, rProcessInfo);
    ...
    RunRansKEpsilonQSVMSRFCAdjointTest("RansKEpsilonEpsilonUBasedWall2D2N", TURBULENT_KINETIC_ENERGY, derivatives_method, SetUBasedUtauLogarithmic, 4, 3, 1e-7, 1e-5);
}

KRATOS_TEST_CASE_IN_SUITE(RansKEpsilonVMSMonolithicKBasedEpsilonUBasedWallConditionFirstDerivativesLHS_EK_3, KratosRansFastSuite)
{
    const auto& derivatives_method = [](Matrix& rMatrix, ModelPart::ConditionType& rCondition,
                                        const ProcessInfo& rProcessInfo) {
        rCondition.CalculateFirstDerivativesLHS(rMatrix, rProcessInfo);
    ...
    RunRansKEpsilonQSVMSRFCAdjointTest("RansKEpsilonEpsilonUBasedWall2D2N", TURBULENT_KINETIC_ENERGY, derivatives_method, SetTkeBasedUtau, 4, 3, 1e-7, 1e-5);
}

KRATOS_TEST_CASE_IN_SUITE(RansKEpsilonVMSMonolithicKBasedEpsilonUBasedWallConditionFirstDerivativesLHS_EE_1, KratosRansFastSuite)
{
    const auto& derivatives_method = [](Matrix& rMatrix, ModelPart::ConditionType& rCondition,
                                        const ProcessInfo& rProcessInfo) {
        rCondition.CalculateFirstDerivativesLHS(rMatrix, rProcessInfo);
    ...
    RunRansKEpsilonQSVMSRFCAdjointTest("RansKEpsilonEpsilonUBasedWall2D2N", TURBULENT_ENERGY_DISSIPATION_RATE, derivatives_method, SetUBasedUtauLinear, 4, 4, 1e-7, 1e-5);
}

KRATOS_TEST_CASE_IN_SUITE(RansKEpsilonVMSMonolithicKBasedEpsilonUBasedWallConditionFirstDerivativesLHS_EE_2, KratosRansFastSuite)
{
    const auto& derivatives_method = [](Matrix& rMatrix, ModelPart::ConditionType& rCondition,
                                        const ProcessInfo& rProcessInfo) {
        rCondition.CalculateFirstDerivativesLHS(rMatrix, rProcessInfo);
    ...
    RunRansKEpsilonQSVMSRFCAdjointTest("RansKEpsilonEpsilonUBasedWall2D2N", TURBULENT_ENERGY_DISSIPATION_RATE, derivatives_method, SetUBasedUtauLogarithmic, 4, 4, 1e-7, 1e-5);
}

KRATOS_TEST_CASE_IN_SUITE(RansKEpsilonVMSMonolithicKBasedEpsilonUBasedWallConditionFirstDerivativesLHS_EE_3, KratosRansFastSuite)
{
    const auto& derivatives_method = [](Matrix& rMatrix, ModelPart::ConditionType& rCondition,
                                        const ProcessInfo& rProcessInfo) {
        rCondition.CalculateFirstDerivativesLHS(rMatrix, rProcessInfo);
    ...
    RunRansKEpsilonQSVMSRFCAdjointTest("RansKEpsilonEpsilonUBasedWall2D2N", TURBULENT_ENERGY_DISSIPATION_RATE, derivatives_method, SetTkeBasedUtau, 4, 4, 1e-7, 1e-5);
}

KRATOS_TEST_CASE_IN_SUITE(RansKEpsilonVMSMonolithicKBasedEpsilonUBasedWallConditionFirstDerivativesLHS_EX_1, KratosRansFastSuite)
{
    const auto& derivatives_method = [](Matrix& rMatrix, ModelPart::ConditionType& rCondition,
                                        const ProcessInfo& rProcessInfo) {
        rCondition.CalculateSensitivityMatrix(SHAPE_SENSITIVITY, rMatrix, rProcessInfo);
    ...
    RunRansKEpsilonQSVMSRFCAdjointTest("RansKEpsilonEpsilonUBasedWall2D2N", SHAPE_SENSITIVITY, derivatives_method, SetUBasedUtauLinear, 4, 0, 1e-10, 1e-5);
}

KRATOS_TEST_CASE_IN_SUITE(RansKEpsilonVMSMonolithicKBasedEpsilonUBasedWallConditionFirstDerivativesLHS_EX_2, KratosRansFastSuite)
{
    const auto& derivatives_method = [](Matrix& rMatrix, ModelPart::ConditionType& rCondition,
                                        const ProcessInfo& rProcessInfo) {
        rCondition.CalculateSensitivityMatrix(SHAPE_SENSITIVITY, rMatrix, rProcessInfo);
    ...
    RunRansKEpsilonQSVMSRFCAdjointTest("RansKEpsilonEpsilonUBasedWall2D2N", SHAPE_SENSITIVITY, derivatives_method, SetUBasedUtauLogarithmic, 4, 0, 1e-10, 1e-5);
}

KRATOS_TEST_CASE_IN_SUITE(RansKEpsilonVMSMonolithicKBasedEpsilonUBasedWallConditionFirstDerivativesLHS_EX_3, KratosRansFastSuite)
{
    const auto& derivatives_method = [](Matrix& rMatrix, ModelPart::ConditionType& rCondition,
                                        const ProcessInfo& rProcessInfo) {
        rCondition.CalculateSensitivityMatrix(SHAPE_SENSITIVITY, rMatrix, rProcessInfo);
    ...
    RunRansKEpsilonQSVMSRFCAdjointTest("RansKEpsilonEpsilonUBasedWall2D2N", SHAPE_SENSITIVITY, derivatives_method, SetTkeBasedUtau, 4, 0, 1e-10, 1e-5);
}
