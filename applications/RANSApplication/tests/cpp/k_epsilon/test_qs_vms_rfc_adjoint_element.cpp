...
KRATOS_TEST_CASE_IN_SUITE(QSVMSKEpsilonRFCAdjointCalculateFirstDerivativesLHSVelocity, KratosRansFastSuite)
{
...
KRATOS_TEST_CASE_IN_SUITE(QSVMSKEpsilonRFCAdjointCalculateFirstDerivativesLHSPressure, KratosRansFastSuite)
{
    const auto& derivatives_method = [](Matrix& rMatrix, ModelPart::ElementType& rElement,
                                        const ProcessInfo& rProcessInfo) {
        rElement.CalculateFirstDerivativesLHS(rMatrix, rProcessInfo);
...
KRATOS_TEST_CASE_IN_SUITE(QSVMSKEpsilonRFCAdjointCalculateSensitivityMatrixShape, KratosRansFastSuite)
{
    const auto& derivatives_method = [](Matrix& rMatrix, ModelPart::ElementType& rElement,
                                        const ProcessInfo& rProcessInfo) {
...
KRATOS_TEST_CASE_IN_SUITE(QSVMSKEpsilonRFCAdjointCalculateSecondDerivativesLHS, KratosRansFastSuite)
{
    const auto& derivatives_method = [](Matrix& rMatrix, ModelPart::ElementType& rElement,
                                        const ProcessInfo& rProcessInfo) {
