...
namespace
{
ModelPart& RansEvmKOmegaSSTKCWD2D3N_SetUp(Model& rModel)
{
    ModelPart& r_model_part = EvmKOmegaSSTTestUtilities::RansEvmKOmegaSSTK2D3N_SetUp(
        rModel, "RansEvmKOmegaSSTKCWD2D3N");
...
ModelPart& RansEvmKOmegaSSTOmegaCWD2D3N_SetUp(Model& rModel)
{
    ModelPart& r_model_part = EvmKOmegaSSTTestUtilities::RansEvmKOmegaSSTOmega2D3N_SetUp(
        rModel, "RansEvmKOmegaSSTOmegaCWD2D3N");
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKOmegaSSTKCWD2D3N_EquationIdVector, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKOmegaSSTKCWD2D3N_SetUp(model);

    // Test:
    RansApplicationTestUtilities::TestEquationIdVector(r_model_part);
}

KRATOS_TEST_CASE_IN_SUITE(RansEvmKOmegaSSTKCWD2D3N_GetDofList, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKOmegaSSTKCWD2D3N_SetUp(model);
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKOmegaSSTKCWD2D3N_CalculateLocalSystem, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKOmegaSSTKCWD2D3N_SetUp(model);
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKOmegaSSTKCWD2D3N_CalculateRightHandSide, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKOmegaSSTKCWD2D3N_SetUp(model);
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKOmegaSSTKCWD2D3N_CalculateLocalVelocityContribution, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKOmegaSSTKCWD2D3N_SetUp(model);
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKOmegaSSTKCWD2D3N_CalculateMassMatrix, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKOmegaSSTKCWD2D3N_SetUp(model);
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKOmegaSSTKCWD2D3N_CalculateDampingMatrix, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKOmegaSSTKCWD2D3N_SetUp(model);
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKOmegaSSTOmegaCWD2D3N_EquationIdVector, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKOmegaSSTOmegaCWD2D3N_SetUp(model);

    // Test:
    RansApplicationTestUtilities::TestEquationIdVector(r_model_part);
}

KRATOS_TEST_CASE_IN_SUITE(RansEvmKOmegaSSTOmegaCWD2D3N_GetDofList, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKOmegaSSTOmegaCWD2D3N_SetUp(model);
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKOmegaSSTOmegaCWD2D3N_CalculateLocalSystem, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKOmegaSSTOmegaCWD2D3N_SetUp(model);
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKOmegaSSTOmegaCWD2D3N_CalculateRightHandSide, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKOmegaSSTOmegaCWD2D3N_SetUp(model);
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKOmegaSSTOmegaCWD2D3N_CalculateLocalVelocityContribution,
                          KratosRansFastSuite)
{
    // Setup:
    Model model;
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKOmegaSSTOmegaCWD2D3N_CalculateMassMatrix, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKOmegaSSTOmegaCWD2D3N_SetUp(model);
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKOmegaSSTOmegaCWD2D3N_CalculateDampingMatrix, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKOmegaSSTOmegaCWD2D3N_SetUp(model);
