...
class MonolithicKOmegaTest(UnitTest.TestCase):
    ...
    def testMonolithicKOmegaAfcTke(self):
    ...
    @UnitTest.skipUnless(not km.IsDistributedRun(), "Running with MPI")
    def testMonolithicKOmegaAfcVelocity(self):
        work_folder = "BackwardFacingStepTest"
        settings_file_name = "backward_facing_step_monolithic_k_omega_parameters.json"
    ...
    @UnitTest.skipUnless(not km.IsDistributedRun(), "Running with MPI")
    def testMonolithicKOmegaRfcTke(self):
        work_folder = "BackwardFacingStepTest"
        settings_file_name = "backward_facing_step_monolithic_k_omega_parameters.json"
    ...
    @UnitTest.skipUnless(not km.IsDistributedRun(), "Running with MPI")
    def testMonolithicKOmegaRfcVelocity(self):
        work_folder = "BackwardFacingStepTest"
        settings_file_name = "backward_facing_step_monolithic_k_omega_parameters.json"
    ...
    def testMonolithicKOmegaAfcTkeMPI(self):
        work_folder = "BackwardFacingStepTest"
        settings_file_name = "backward_facing_step_monolithic_k_omega_parameters.json"
    ...
    @UnitTest.skipUnless(km.IsDistributedRun(), "Running without MPI")
    def testMonolithicKOmegaAfcVelocityMPI(self):
        work_folder = "BackwardFacingStepTest"
        settings_file_name = "backward_facing_step_monolithic_k_omega_parameters.json"
    ...
    @UnitTest.skipUnless(km.IsDistributedRun(), "Running without MPI")
    def testMonolithicKOmegaRfcTkeMPI(self):
        work_folder = "BackwardFacingStepTest"
        settings_file_name = "backward_facing_step_monolithic_k_omega_parameters.json"
    ...
    @UnitTest.skipUnless(km.IsDistributedRun(), "Running without MPI")
    def testMonolithicKOmegaRfcVelocityMPI(self):
        work_folder = "BackwardFacingStepTest"
        settings_file_name = "backward_facing_step_monolithic_k_omega_parameters.json"
