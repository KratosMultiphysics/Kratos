...
class MonolithicKOmegaTest(UnitTest.TestCase):
    ...
    def testMonolithicKOmegaAfcTkeSteady(self):
        work_folder = "BackwardFacingStepTest"
        settings_file_name = "backward_facing_step_monolithic_k_omega_parameters.json"
    ...
    @UnitTest.skipUnless(not km.IsDistributedRun(), "Running with MPI")
    def testMonolithicKOmegaAfcVelocitySteady(self):
        work_folder = "BackwardFacingStepTest"
        settings_file_name = "backward_facing_step_monolithic_k_omega_parameters.json"
    ...
    @UnitTest.skipUnless(not km.IsDistributedRun(), "Running with MPI")
    def testMonolithicKOmegaRfcTkeSteady(self):
        work_folder = "BackwardFacingStepTest"
        settings_file_name = "backward_facing_step_monolithic_k_omega_parameters.json"
    ...
    @UnitTest.skipUnless(not km.IsDistributedRun(), "Running with MPI")
    def testMonolithicKOmegaRfcVelocitySteady(self):
        work_folder = "BackwardFacingStepTest"
        settings_file_name = "backward_facing_step_monolithic_k_omega_parameters.json"
    ...
    @UnitTest.skipUnless(not km.IsDistributedRun(), "Running with MPI")
    def testMonolithicKOmegaRfcTkeTransient(self):
        work_folder = "BackwardFacingStepTest"
        settings_file_name = "backward_facing_step_monolithic_k_omega_parameters.json"
    ...
    @UnitTest.skipUnless(not km.IsDistributedRun(), "Running with MPI")
    def testMonolithicKOmegaRfcVelocityTransient(self):
        work_folder = "BackwardFacingStepTest"
        settings_file_name = "backward_facing_step_monolithic_k_omega_parameters.json"
    ...
    def testMonolithicKOmegaAfcTkeSteadyMPI(self):
        work_folder = "BackwardFacingStepTest"
        settings_file_name = "backward_facing_step_monolithic_k_omega_parameters.json"
    ...
    @UnitTest.skipUnless(km.IsDistributedRun(), "Running without MPI")
    def testMonolithicKOmegaAfcVelocitySteadyMPI(self):
        work_folder = "BackwardFacingStepTest"
        settings_file_name = "backward_facing_step_monolithic_k_omega_parameters.json"
    ...
    @UnitTest.skipUnless(km.IsDistributedRun(), "Running without MPI")
    def testMonolithicKOmegaRfcTkeSteadyMPI(self):
        work_folder = "BackwardFacingStepTest"
        settings_file_name = "backward_facing_step_monolithic_k_omega_parameters.json"
    ...
    @UnitTest.skipUnless(km.IsDistributedRun(), "Running without MPI")
    def testMonolithicKOmegaRfcVelocitySteadyMPI(self):
        work_folder = "BackwardFacingStepTest"
        settings_file_name = "backward_facing_step_monolithic_k_omega_parameters.json"
    ...
    @UnitTest.skipUnless(km.IsDistributedRun(), "Running without MPI")
    def testMonolithicKOmegaRfcTkeTransientMPI(self):
        work_folder = "BackwardFacingStepTest"
        settings_file_name = "backward_facing_step_monolithic_k_omega_parameters.json"
    ...
    @UnitTest.skipUnless(km.IsDistributedRun(), "Running without MPI")
    def testMonolithicKOmegaRfcVelocityTransientMPI(self):
        work_folder = "BackwardFacingStepTest"
        settings_file_name = "backward_facing_step_monolithic_k_omega_parameters.json"
