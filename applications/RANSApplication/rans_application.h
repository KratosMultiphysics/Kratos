...
// constitutive laws
#include "custom_constitutive/rans_constitutive_law_extension.h"
...
private:
    ...
    // constitutive laws
    const RansConstitutiveLawExtension<Newtonian2DLaw> mRansNewtonian2DLaw;
    const RansConstitutiveLawExtension<Newtonian3DLaw> mRansNewtonian3DLaw;
