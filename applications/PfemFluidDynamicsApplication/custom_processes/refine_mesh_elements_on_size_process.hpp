...
public:
    ...
    {
      KRATOS_TRY
      std::cout<<"--------- RefineMeshElementsOnSizeProcess.Execute() in PfemFluid"<<std::endl;
	...
	//std::cout<<"   refine selection "<<std::endl;
	 ...
	 && (mrRemesh.Refine->RefiningOptions.Is(ModelerUtilities::REFINE_ADD_NODES) || mrRemesh.Refine->RefiningOptions.Is(ModelerUtilities::REFINE_INSERT_NODES)) )
	{
