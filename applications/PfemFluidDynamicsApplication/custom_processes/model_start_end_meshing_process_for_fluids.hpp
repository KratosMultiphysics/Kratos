...
#if !defined(KRATOS_MODEL_START_END_MESHING_PROCESS_FOR_FLUIDS_H_INCLUDED )
#define  KRATOS_MODEL_START_END_MESHING_PROCESS_FOR_FLUIDS_H_INCLUDED
...
namespace Kratos
{
   ...
   */
  class ModelStartEndMeshingProcessForFluids
    : public Process
  {
  public:
    ///@name Type Definitions
    ...
    /// Pointer definition of ModelStartEndMeshingProcessForFluids
    KRATOS_CLASS_POINTER_DEFINITION( ModelStartEndMeshingProcessForFluids );
    ...
    /// Default constructor.
    ModelStartEndMeshingProcessForFluids(ModelPart& rModelPart,
				Flags Options,
				int EchoLevel = 0)
    ...
    /// Destructor.
    virtual ~ModelStartEndMeshingProcessForFluids()
    {
    }
    ...
    {
      KRATOS_TRY
	std::cout<<" ------------------   BEGIN ExecuteFinalize()  ---------------------------"<<std::endl;
	...
	// BuildMeshBoundaryProcessForFluids BuildBoundaryProcessForFluids(mrModelPart,2);
	BuildMeshBoundaryProcessForFluids BuildBoundaryProcessForFluids(mrModelPart,2);
	for(unsigned int MeshId=start; MeshId<NumberOfMeshes; MeshId++)
	  {
	    BuildBoundaryProcessForFluids.SearchConditionMasters(MeshId);
	  }
	...
	std::cout<<"-----------------------     END ExecuteFinalize()    ------------------------"<<std::endl;
    ...
    {
      return "ModelStartEndMeshingProcessForFluids";
    }

    /// Print information about this object.
    virtual void PrintInfo(std::ostream& rOStream) const
    {
      rOStream << "ModelStartEndMeshingProcessForFluids";
    }
  ...
  private:
    ...
    /// Assignment operator.
    ModelStartEndMeshingProcessForFluids& operator=(ModelStartEndMeshingProcessForFluids const& rOther);

    /// Copy constructor.
    //ModelStartEndMeshingProcessForFluids(ModelStartEndMeshingProcessForFluids const& rOther);
  ...
  inline std::istream& operator >> (std::istream& rIStream,
				    ModelStartEndMeshingProcessForFluids& rThis);

  /// output stream function
  inline std::ostream& operator << (std::ostream& rOStream,
				    const ModelStartEndMeshingProcessForFluids& rThis)
  {
...
#endif // KRATOS_MODEL_START_END_MESHING_PROCESS_FOR_FLUIDS_H_INCLUDED  defined 
