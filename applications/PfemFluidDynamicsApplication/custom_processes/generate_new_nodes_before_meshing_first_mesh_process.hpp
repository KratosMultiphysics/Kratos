...
#if !defined(KRATOS_GENERATE_NEW_NODES_BEFORE_MESHING_FIRST_MESH_PROCESS_H_INCLUDED)
#define KRATOS_GENERATE_NEW_NODES_BEFORE_MESHING_FIRST_MESH_PROCESS_H_INCLUDED
...
*/
	...
	class GenerateNewNodesBeforeMeshingFirstMeshProcess
	...
	public:
		...
		KRATOS_CLASS_POINTER_DEFINITION(GenerateNewNodesBeforeMeshingFirstMeshProcess);
		...
		/// Default constructor.
		GenerateNewNodesBeforeMeshingFirstMeshProcess(ModelPart &rModelPart,
		...
		/// Destructor.
		virtual ~GenerateNewNodesBeforeMeshingFirstMeshProcess() {}
		...
		void Execute() override
		{
			...
			std::cout << " FIRST MESH: GENERATE NEW NODES" << std::endl;
		...
		{
			return "GenerateNewNodesBeforeMeshingFirstMeshProcess";
		}

		/// Print information about this object.
		void PrintInfo(std::ostream &rOStream) const override
		{
			rOStream << "GenerateNewNodesBeforeMeshingFirstMeshProcess";
		}
	...
	private:
		...
		/// Assignment operator.
		GenerateNewNodesBeforeMeshingFirstMeshProcess &operator=(GenerateNewNodesBeforeMeshingFirstMeshProcess const &rOther);
	...
	inline std::istream &operator>>(std::istream &rIStream,
									GenerateNewNodesBeforeMeshingFirstMeshProcess &rThis);

	/// output stream function
	inline std::ostream &operator<<(std::ostream &rOStream,
									const GenerateNewNodesBeforeMeshingFirstMeshProcess &rThis)
	{
...
#endif // KRATOS_GENERATE_NEW_NODES_BEFORE_MESHING_FIRST_MESH_PROCESS_H_INCLUDED  defined
