...
#if !defined(KRATOS_TRANSFER_ENTITIES_BETWEEN_PFEM_FLUID_MODEL_PARTS_PROCESS_H_INCLUDED)
#define  KRATOS_TRANSFER_ENTITIES_BETWEEN_PFEM_FLUID_MODEL_PARTS_PROCESS_H_INCLUDED
...
*/
class TransferEntitiesBetweenPfemFluidModelPartsProcess : public Process
{
public:
    ///@name Type Definitions
    ///@{

    /// Pointer definition of TransferEntitiesBetweenPfemFluidModelPartsProcess
    KRATOS_CLASS_POINTER_DEFINITION(TransferEntitiesBetweenPfemFluidModelPartsProcess);

    ///@}
    ///@name Life Cycle
    ///@{

    TransferEntitiesBetweenPfemFluidModelPartsProcess(ModelPart& rDestinationModelPart,
    ...
    /// Destructor.
    ~TransferEntitiesBetweenPfemFluidModelPartsProcess() override {}
    ...
    /// Execute method is used to execute the TransferEntitiesBetweenPfemFluidModelPartsProcess algorithms.
    ...
    {
        return "TransferEntitiesBetweenPfemFluidModelPartsProcess";
    }

    /// Print information about this object.
    void PrintInfo(std::ostream& rOStream) const override
    {
        rOStream << "TransferEntitiesBetweenPfemFluidModelPartsProcess";
    }
...
protected:
    ...
    /// Copy constructor.
    TransferEntitiesBetweenPfemFluidModelPartsProcess(TransferEntitiesBetweenPfemFluidModelPartsProcess const& rOther);
...
private:
    ...
    /// Assignment operator.
    TransferEntitiesBetweenPfemFluidModelPartsProcess& operator=(TransferEntitiesBetweenPfemFluidModelPartsProcess const& rOther);
...
}; // Class TransferEntitiesBetweenPfemFluidModelPartsProcess
...
inline std::istream& operator >> (std::istream& rIStream,
                                  TransferEntitiesBetweenPfemFluidModelPartsProcess& rThis);

/// output stream function
inline std::ostream& operator << (std::ostream& rOStream,
                                  const TransferEntitiesBetweenPfemFluidModelPartsProcess& rThis)
{
...
#endif // KRATOS_TRANSFER_ENTITIES_BETWEEN_PFEM_FLUID_MODEL_PARTS_PROCESS_H_INCLUDED  defined
