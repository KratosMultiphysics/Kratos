...
#if !defined(KRATOS_ELEMENTAL_NEIGHBOURS_SEARCH_FLUID_PROCESS_H_INCLUDED )
#define  KRATOS_ELEMENTAL_NEIGHBOURS_SEARCH_FLUID_PROCESS_H_INCLUDED
...
namespace Kratos
{
   ...
   */
  class ElementalNeighboursSearchFluidProcess
  ...
  public:
    ...
    /// Pointer definition of ElementalNeighboursSearchFluidProcess
    KRATOS_CLASS_POINTER_DEFINITION( ElementalNeighboursSearchFluidProcess );
    ...
    ElementalNeighboursSearchFluidProcess(ModelPart& rModelPart,
				     int Dimension,
				     int EchoLevel = 0,
    ...
    /// Destructor.
    virtual ~ElementalNeighboursSearchFluidProcess()
    {
    }
    ...
    {
      return "ElementalNeighboursSearchFluidProcess";
    }

    /// Print information about this object.
    void PrintInfo(std::ostream& rOStream) const override
    {
      rOStream << "ElementalNeighboursSearchFluidProcess";
    }
...
#pragma omp parallel for reduction(+:nface) private(el,ipoin,nnofa,jelem,icoun,jpoin,nnofj) firstprivate(lhelp,lpoin)
    ...
    /// Assignment operator.
    ElementalNeighboursSearchFluidProcess& operator=(ElementalNeighboursSearchFluidProcess const& rOther);

    /// Copy constructor.
    //ElementalNeighboursSearchFluidProcess(ElementalNeighboursSearchFluidProcess const& rOther);
  ...
  inline std::istream& operator >> (std::istream& rIStream,
				    ElementalNeighboursSearchFluidProcess& rThis);

  /// output stream function
  inline std::ostream& operator << (std::ostream& rOStream,
				    const ElementalNeighboursSearchFluidProcess& rThis)
  {
...
#endif // KRATOS_ELEMENTAL_NEIGHBOURS_SEARCH_FLUID_PROCESS_H_INCLUDED  defined 
