...
#if !defined(KRATOS_REMOVE_MESH_NODES_FOR_FLUIDS_FIRST_MESH_PROCESS_H_INCLUDED)
#define KRATOS_REMOVE_MESH_NODES_FOR_FLUIDS_FIRST_MESH_PROCESS_H_INCLUDED
...
*/
	...
	class RemoveMeshNodesForFluidsFirstMeshProcess
	...
	public:
		...
		KRATOS_CLASS_POINTER_DEFINITION(RemoveMeshNodesForFluidsFirstMeshProcess);
		...
		/// Default constructor.
		RemoveMeshNodesForFluidsFirstMeshProcess(ModelPart &rModelPart,
												 MesherUtilities::MeshingParameters &rRemeshingParameters,
												 int EchoLevel)
			: mrModelPart(rModelPart),
			  mrRemesh(rRemeshingParameters)
		{
			KRATOS_INFO("RemoveMeshNodesForFluidsFirstMeshProcess") << " activated " << std::endl;

			mEchoLevel = EchoLevel;
		}

		/// Destructor.
		virtual ~RemoveMeshNodesForFluidsFirstMeshProcess() {}
		...
		{
			return "RemoveMeshNodesForFluidsFirstMeshProcess";
		}

		/// Print information about this object.
		void PrintInfo(std::ostream &rOStream) const override
		{
			rOStream << "RemoveMeshNodesForFluidsFirstMeshProcess";
		}
	...
	private:
		...
		/// Assignment operator.
		RemoveMeshNodesForFluidsFirstMeshProcess &operator=(RemoveMeshNodesForFluidsFirstMeshProcess const &rOther);
	...
	inline std::istream &operator>>(std::istream &rIStream,
									RemoveMeshNodesForFluidsFirstMeshProcess &rThis);

	/// output stream function
	inline std::ostream &operator<<(std::ostream &rOStream,
									const RemoveMeshNodesForFluidsFirstMeshProcess &rThis)
	{
...
#endif // KRATOS_REMOVE_MESH_NODES_FOR_FLUIDS_FIRST_MESH_PROCESS_H_INCLUDED  defined
