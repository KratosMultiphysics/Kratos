...
#if !defined(KRATOS_SELECT_MESH_ELEMENTS_FOR_FLUIDS_FIRST_MESH_PROCESS_H_INCLUDED)
#define KRATOS_SELECT_MESH_ELEMENTS_FOR_FLUIDS_FIRST_MESH_PROCESS_H_INCLUDED
...
*/
    class SelectMeshElementsForFluidsFirstMeshProcess
    ...
    public:
        ...
        KRATOS_CLASS_POINTER_DEFINITION(SelectMeshElementsForFluidsFirstMeshProcess);
        ...
        /// Default constructor.
        SelectMeshElementsForFluidsFirstMeshProcess(ModelPart &rModelPart,
        ...
        /// Destructor.
        virtual ~SelectMeshElementsForFluidsFirstMeshProcess() {}
        ...
        {
            return "SelectMeshElementsForFluidsFirstMeshProcess";
        }

        /// Print information about this object.
        void PrintInfo(std::ostream &rOStream) const override
        {
            rOStream << "SelectMeshElementsForFluidsFirstMeshProcess";
        }
    ...
    private:
        ...
        /// Assignment operator.
        SelectMeshElementsForFluidsFirstMeshProcess &operator=(SelectMeshElementsForFluidsFirstMeshProcess const &rOther);
    ...
    inline std::istream &operator>>(std::istream &rIStream,
                                    SelectMeshElementsForFluidsFirstMeshProcess &rThis);

    /// output stream function
    inline std::ostream &operator<<(std::ostream &rOStream,
                                    const SelectMeshElementsForFluidsFirstMeshProcess &rThis)
    {
...
#endif // KRATOS_SELECT_MESH_ELEMENTS_FOR_FLUIDS_FIRST_MESH_PROCESS_H_INCLUDED defined
