...
#if !defined(KRATOS_GENERATE_NEW_NODES_BEFORE_MESHING_SECOND_MESH_PROCESS_H_INCLUDED)
#define KRATOS_GENERATE_NEW_NODES_BEFORE_MESHING_SECOND_MESH_PROCESS_H_INCLUDED
...
*/
	...
	class GenerateNewNodesBeforeMeshingSecondMeshProcess
	...
	public:
		...
		KRATOS_CLASS_POINTER_DEFINITION(GenerateNewNodesBeforeMeshingSecondMeshProcess);
		...
		/// Default constructor.
		GenerateNewNodesBeforeMeshingSecondMeshProcess(ModelPart &rModelPart,
		...
		/// Destructor.
		virtual ~GenerateNewNodesBeforeMeshingSecondMeshProcess() {}
		...
		void Execute() override
		{
			...
			std::cout << " SECOND MESH: GENERATE NEW NODES" << std::endl;
		...
		{
			return "GenerateNewNodesBeforeMeshingSecondMeshProcess";
		}

		/// Print information about this object.
		void PrintInfo(std::ostream &rOStream) const override
		{
			rOStream << "GenerateNewNodesBeforeMeshingSecondMeshProcess";
		}
	...
	private:
		...
		/// Assignment operator.
		GenerateNewNodesBeforeMeshingSecondMeshProcess &operator=(GenerateNewNodesBeforeMeshingSecondMeshProcess const &rOther);
	...
	inline std::istream &operator>>(std::istream &rIStream,
									GenerateNewNodesBeforeMeshingSecondMeshProcess &rThis);

	/// output stream function
	inline std::ostream &operator<<(std::ostream &rOStream,
									const GenerateNewNodesBeforeMeshingSecondMeshProcess &rThis)
	{
...
#endif // KRATOS_GENERATE_NEW_NODES_BEFORE_MESHING_SECOND_MESH_PROCESS_H_INCLUDED  defined
