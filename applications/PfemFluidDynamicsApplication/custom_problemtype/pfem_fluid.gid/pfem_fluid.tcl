...
proc InitGIDProject {dir} {
	...
	GiDMenu::Create "Pfem fluid" PRE
	GiDMenu::InsertOption "Pfem fluid" [list "Nodal Values"] 0 PRE "GidOpenConditions \"Nodal Values\"" "" ""
	GiDMenu::InsertOption "Pfem fluid" [list "Elements"] 1 PRE "GidOpenConditions \"Elements\"" "" ""
	GiDMenu::InsertOption "Pfem fluid" [list "Conditional Data"] 2 PRE "GidOpenConditions \"Conditional Data\"" "" ""
	GiDMenu::InsertOption "Pfem fluid" [list "Problem Parameters"] 3 PRE "GidOpenProblemData \"Problem Parameters\"" "" ""
	GiDMenu::InsertOption "Pfem fluid" [list "---"] 4 PRE "" "" ""
	GiDMenu::InsertOption "Pfem fluid" [list "Model Status"] 5 PRE "cond_report" "" ""
	if { [string match "unix" $::tcl_platform(platform)] } {
		GiDMenu::InsertOption "Pfem fluid" [list "Change Kratos Path"] 6 PRE "GetKratosPath" "" ""
	}
	GiDMenu::UpdateMenus
	# Custom Menu
}
...
check_elemtype WallCondition2D line None
check_elemtype WallCondition3D surface None
check_elemtype TwoStepUpdatedLagrangianVPElement2D surface None
check_elemtype TwoStepUpdatedLagrangianVPElement3D volume None
check_elemtype FractionalStep2D surface None
check_elemtype FractionalStep3D volume None
...
meshtype WallCondition2D line None
meshtype WallCondition3D surface None
meshtype TwoStepUpdatedLagrangianVPElement2D surface None
meshtype TwoStepUpdatedLagrangianVPElement3D volume None
meshtype FractionalStep2D surface None
meshtype FractionalStep3D volume None
# End Meshing Block
