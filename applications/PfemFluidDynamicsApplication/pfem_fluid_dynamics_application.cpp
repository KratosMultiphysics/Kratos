...
namespace Kratos
{
  ...
  void KratosPfemFluidDynamicsApplication::Register()
  {
    ...
    KRATOS_REGISTER_VARIABLE(FREESURFACE_NEIGHBOURS);
    KRATOS_REGISTER_VARIABLE(NODAL_FREESURFACE_AREA);
    KRATOS_REGISTER_VARIABLE(FIRST_LAME_TYPE_COEFFICIENT);
    KRATOS_REGISTER_VARIABLE(SECOND_LAME_TYPE_COEFFICIENT);
