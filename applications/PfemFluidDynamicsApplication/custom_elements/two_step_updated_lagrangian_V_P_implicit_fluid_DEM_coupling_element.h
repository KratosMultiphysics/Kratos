...
namespace Kratos
{
  ...
  template< unsigned int TDim >
    ...
    public:
       ...
       */
    TwoStepUpdatedLagrangianVPImplicitFluidDEMcouplingElement(IndexType NewId = 0) :
      BaseType(NewId)
      {}
       ...
       */
    TwoStepUpdatedLagrangianVPImplicitFluidDEMcouplingElement(IndexType NewId, const NodesArrayType& ThisNodes) :
	...
	{}
       ...
       */
    TwoStepUpdatedLagrangianVPImplicitFluidDEMcouplingElement(IndexType NewId, GeometryType::Pointer pGeometry) :
	...
	{}
       ...
       */
    TwoStepUpdatedLagrangianVPImplicitFluidDEMcouplingElement(IndexType NewId, GeometryType::Pointer pGeometry, pPropertiesType pProperties) :
