...
public:
  ...
  /**
       ...
       */
  TwoStepUpdatedLagrangianVPExplicitSolidElement(IndexType NewId = 0) : BaseType(NewId)
  {
  }
  ...
  /**
       ...
       */
  TwoStepUpdatedLagrangianVPExplicitSolidElement(IndexType NewId, const NodesArrayType &ThisNodes) : BaseType(NewId, ThisNodes)
  {
  }
  ...
  /**
       ...
       */
  TwoStepUpdatedLagrangianVPExplicitSolidElement(IndexType NewId, GeometryType::Pointer pGeometry) : BaseType(NewId, pGeometry)
  {
  }
  ...
  TwoStepUpdatedLagrangianVPExplicitSolidElement(TwoStepUpdatedLagrangianVPExplicitSolidElement const &rOther) : BaseType(rOther)
  {
  }
