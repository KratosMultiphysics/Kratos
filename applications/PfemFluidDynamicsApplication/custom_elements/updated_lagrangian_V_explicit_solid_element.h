...
public:
  ...
  /**
       ...
       */
  UpdatedLagrangianVExplicitSolidElement(IndexType NewId = 0) : BaseType(NewId)
  {
  }
  ...
  /**
       ...
       */
  UpdatedLagrangianVExplicitSolidElement(IndexType NewId, const NodesArrayType &ThisNodes) : BaseType(NewId, ThisNodes)
  {
  }
  ...
  /**
       ...
       */
  UpdatedLagrangianVExplicitSolidElement(IndexType NewId, GeometryType::Pointer pGeometry) : BaseType(NewId, pGeometry)
  {
  }
  ...
  UpdatedLagrangianVExplicitSolidElement(UpdatedLagrangianVExplicitSolidElement const &rOther) : BaseType(rOther)
  {
  }
