...
namespace Kratos
{
  ...
  Element::Pointer ThreeStepSecondOrderUpdatedLagrangianElement<TDim>::Clone(IndexType NewId, NodesArrayType const &rThisNodes) const
  {
    KRATOS_TRY;
  ...
  template <unsigned int TDim>
  void ThreeStepSecondOrderUpdatedLagrangianElement<TDim>::CalculateLocalSystem(MatrixType &rLeftHandSideMatrix,
  ...
  template <unsigned int TDim>
  void ThreeStepSecondOrderUpdatedLagrangianElement<TDim>::CalculateSecondVelocitySystem(MatrixType &rLeftHandSideMatrix,
                                                                                         VectorType &rRightHandSideVector,
                                                                                         const ProcessInfo &rCurrentProcessInfo)
  {
    ...
    double theta_velocity = 0.5;
    double gamma_pressure = 1.0;
  ...
  template <unsigned int TDim>
  void ThreeStepSecondOrderUpdatedLagrangianElement<TDim>::Calculate(const Variable<array_1d<double, 3>> &rVariable,
  ...
  template <unsigned int TDim>
  void ThreeStepSecondOrderUpdatedLagrangianElement<TDim>::CalculateStandardFSPressureSystem(MatrixType &rLeftHandSideMatrix,
                                                                                             VectorType &rRightHandSideVector,
                                                                                             const ProcessInfo &rCurrentProcessInfo)
  {
    GeometryType &rGeom = this->GetGeometry();
  ...
  template class ThreeStepSecondOrderUpdatedLagrangianElement<2>;
  template class ThreeStepSecondOrderUpdatedLagrangianElement<3>;
