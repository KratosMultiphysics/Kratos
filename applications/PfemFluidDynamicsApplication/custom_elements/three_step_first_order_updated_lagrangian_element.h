...
#if !defined(KRATOS_THREE_STEP_FIRST_ORDER_UPDATED_LAGRANGIAN_ELEMENT_H_INCLUDED)
#define KRATOS_THREE_STEP_FIRST_ORDER_UPDATED_LAGRANGIAN_ELEMENT_H_INCLUDED
...
namespace Kratos
{
  ...
  class ThreeStepFirstOrderUpdatedLagrangianElement : public ThreeStepUpdatedLagrangianElement<TDim>
  {
  public:
    ///@name Type Definitions
    ///@{
    ...
    /**
       ...
       */
    ThreeStepFirstOrderUpdatedLagrangianElement(IndexType NewId = 0) : BaseType(NewId)
    {
    }
    ...
    /**
       ...
       */
    ThreeStepFirstOrderUpdatedLagrangianElement(IndexType NewId, const NodesArrayType &ThisNodes) : BaseType(NewId, ThisNodes)
    {
    }
    ...
    /**
       ...
       */
    ThreeStepFirstOrderUpdatedLagrangianElement(IndexType NewId, GeometryType::Pointer pGeometry) : BaseType(NewId, pGeometry)
    {
    }
    ...
    /**
       ...
       */
    ThreeStepFirstOrderUpdatedLagrangianElement(IndexType NewId, GeometryType::Pointer pGeometry, pPropertiesType pProperties) : BaseType(NewId, pGeometry, pProperties)
    {
    }

    /// copy constructor

    ThreeStepFirstOrderUpdatedLagrangianElement(ThreeStepFirstOrderUpdatedLagrangianElement const &rOther) : BaseType(rOther){};
    ...
    {
      return Element::Pointer(new ThreeStepFirstOrderUpdatedLagrangianElement(NewId, this->GetGeometry().Create(ThisNodes), pProperties));
    }
    ...
    std::string Info() const override
    {
      ...
      buffer << "ThreeStepFirstOrderUpdatedLagrangianElement #" << this->Id();
      return buffer.str();
    }
  ...
  private:
    ...
    /// Assignment operator.
    ThreeStepFirstOrderUpdatedLagrangianElement &operator=(ThreeStepFirstOrderUpdatedLagrangianElement const &rOther);
