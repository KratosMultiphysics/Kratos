...
namespace Kratos
{
  ...
  template <>
  void TwoStepUpdatedLagrangianElement<2>::CalcMeanVelocityNorm(double &meanVelocity,
                                                                const int Step)
  {
  ...
  template <>
  void TwoStepUpdatedLagrangianElement<3>::CalcMeanVelocityNorm(double &meanVelocity,
                                                                const int Step)
  {
