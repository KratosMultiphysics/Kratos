...
namespace Kratos {
  ...
  template< unsigned int TDim>
  double TwoStepUpdatedLagrangianVPImplicitNodallyIntegratedFluidElement<TDim>::ComputePapanastasiouMuIrheologyViscosity(ElementalVariables & rElementalVariables)
  {
    double FluidViscosity=0;
    double staticFrictionCoefficient=0;
    double dynamicFrictionCoefficient=0;
