...
#if !defined(KRATOS_FLUID_RESIDUAL_BASED_UwP_STATIC_SCHEME )
#define  KRATOS_FLUID_RESIDUAL_BASED_UwP_STATIC_SCHEME
...
namespace Kratos
{
   ...
   template<class TSparseSpace, class TDenseSpace > //= DenseSpace<double>
      class FluidResidualBasedUwPStaticScheme: public ResidualBasedStaticScheme<TSparseSpace,TDenseSpace>
   {
      ...
      public:
         ...
         KRATOS_CLASS_POINTER_DEFINITION( FluidResidualBasedUwPStaticScheme );
         ...
         /** Constructor.
          */
         FluidResidualBasedUwPStaticScheme()
         ...
         /** Destructor.
          */
         virtual ~FluidResidualBasedUwPStaticScheme() {}
...
#endif /* KRATOS_FLUID_RESIDUAL_BASED_STATIC_SCHEME  defined */
