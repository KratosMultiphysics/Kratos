...
public:
            ...
            TSystemMatrixType& A)
    {
	  ...
	  std::cout<<"BuildLHS in exp 2 vp builder and solver "<<std::endl;
	  ...
	  std::cout<<"Calculate and assemble Mass Matrix on nodes" <<std::endl;
        ...
        TSystemVectorType& b)
    {
	  ...
	  std::cout<<"BuildRHS in exp 2 vp builder and solver "<<std::endl;

	std::cout<<"CalculateAndAddConditionsRHS "<<std::endl;
    ...
    void CalculateAndAddElementsRHS(typename TSchemeType::Pointer pScheme, ModelPart& r_model_part )
    {
	  ...
	  std::cout<<"CalculateAndAddElementsRHS "<<pScheme<<std::endl;
        ProcessInfo& rCurrentProcessInfo    = r_model_part.GetProcessInfo();
        ElementsArrayType& pElements        = r_model_part.Elements();
