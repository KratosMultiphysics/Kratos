...
#include "custom_utilities/calculate_closest_wave_height_utility.h"
...
void AddCustomUtilitiesToPython(pybind11::module &m)
{
    ...
    py::class_<CalculateClosestWaveHeightUtility, CalculateClosestWaveHeightUtility::Pointer>(m, "CalculateClosestWaveHeightUtility")
        .def(py::init<ModelPart&, Parameters>())
        .def("Calculate", &CalculateClosestWaveHeightUtility::Calculate)
        ;
}
