...
namespace Kratos
{
  ...
  namespace Python
  {
    ...
    PYBIND11_MODULE(KratosPfemFluidDynamicsApplication, m)
    {
      ...
      KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, FREESURFACE_NEIGHBOURS);
      KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, NODAL_FREESURFACE_AREA);
      KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, FIRST_LAME_TYPE_COEFFICIENT);
      KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, SECOND_LAME_TYPE_COEFFICIENT);
