...
namespace Kratos
{
  ...
  namespace Python
  {
    ...
    PYBIND11_MODULE(KratosPfemFluidDynamicsApplication, m)
    {
      ...
      KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, NODAL_SHAPE_FUNCTION_DERIVATIVE);
      KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, NODAL_SFD_NEIGHBOURS);
      KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, NODAL_SFD_NEIGHBOURS_ORDER);
      KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, NODAL_SFD_NEIGHBOURS_COMMON_ELEMENTS);
      KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, NODAL_SFD_NEIGHBOURS_VOLUME_COMMON_ELEMENTS);
      KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, NODAL_SFD_X);
      KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, NODAL_SFD_Y);
      KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, NODAL_SFD_Z);
