...
HypoElasticPlastic3DLaw::HypoElasticPlastic3DLaw()
    : HypoElastic3DLaw()
{
...
HypoElasticPlastic3DLaw::HypoElasticPlastic3DLaw(FlowRulePointer pFlowRule, YieldCriterionPointer pYieldCriterion, HardeningLawPointer pHardeningLaw)
    : HypoElastic3DLaw()
{
...
HypoElasticPlastic3DLaw::HypoElasticPlastic3DLaw(const HypoElasticPlastic3DLaw& rOther)
...
ConstitutiveLaw::Pointer HypoElasticPlastic3DLaw::Clone() const
{
    ConstitutiveLaw::Pointer p_clone(new HypoElasticPlastic3DLaw(*this));
    return p_clone;
}
...
bool HypoElasticPlastic3DLaw::Has( const Variable<double>& rThisVariable )
{
    return false;
}

bool HypoElasticPlastic3DLaw::Has( const Variable<Vector>& rThisVariable )
{
    return false;
}

bool HypoElasticPlastic3DLaw::Has( const Variable<Matrix>& rThisVariable )
{
    return false;
}
...
double& HypoElasticPlastic3DLaw::GetValue( const Variable<double>& rThisVariable, double& rValue )
{
...
Vector& HypoElasticPlastic3DLaw::GetValue( const Variable<Vector>& rThisVariable, Vector& rValue )
{
    return( rValue );
}

Matrix& HypoElasticPlastic3DLaw::GetValue( const Variable<Matrix>& rThisVariable, Matrix& rValue )
{
    return( rValue );
}
...
void HypoElasticPlastic3DLaw::SetValue( const Variable<double>& rThisVariable, const double& rValue,
...
void HypoElasticPlastic3DLaw::SetValue( const Variable<Vector>& rThisVariable, const Vector& rValue,
                                  const ProcessInfo& rCurrentProcessInfo )
{

}

void HypoElasticPlastic3DLaw::SetValue( const Variable<Matrix>& rThisVariable, const Matrix& rValue,
                                  const ProcessInfo& rCurrentProcessInfo )
{
...
void HypoElasticPlastic3DLaw::InitializeMaterial( const Properties& rMaterialProperties,
						   const GeometryType& rElementGeometry,
						   const Vector& rShapeFunctionsValues )
{

  HypoElastic3DLaw::InitializeMaterial(rMaterialProperties,rElementGeometry,rShapeFunctionsValues);
...
void HypoElasticPlastic3DLaw::InitializeSolutionStep( const Properties& rMaterialProperties,
...
void HypoElasticPlastic3DLaw::FinalizeSolutionStep( const Properties& rMaterialProperties,
        const GeometryType& rElementGeometry, //this is just to give the array of nodes
        const Vector& rShapeFunctionsValues,
        const ProcessInfo& rCurrentProcessInfo)
{
...
void  HypoElasticPlastic3DLaw::CalculateMaterialResponsePK2 (Parameters& rValues)
{
...
void HypoElasticPlastic3DLaw::CalculateMaterialResponseKirchhoff (Parameters& rValues)
{
...
void HypoElasticPlastic3DLaw::CalculatePlasticIsochoricStress( MaterialResponseVariables & rElasticVariables,
...
void HypoElasticPlastic3DLaw::CalculatePlasticConstitutiveMatrix (const MaterialResponseVariables & rElasticVariables,
								   FlowRule::RadialReturnVariables & rReturnMappingVariables,
...
double& HypoElasticPlastic3DLaw::PlasticConstitutiveComponent(double & rCabcd,
...
void HypoElasticPlastic3DLaw::GetLawFeatures(Features& rFeatures)
{
    	//Set the type of law
...
bool HypoElasticPlastic3DLaw::CheckParameters(Parameters& rValues)
{
...
int HypoElasticPlastic3DLaw::Check(const Properties& rMaterialProperties,
                             const GeometryType& rElementGeometry,
                             const ProcessInfo& rCurrentProcessInfo)
{
