...
HypoElastic3DLaw::HypoElastic3DLaw(const HypoElastic3DLaw& rOther)
...
ConstitutiveLaw::Pointer HypoElastic3DLaw::Clone() const
{
    HypoElastic3DLaw::Pointer p_clone(new HypoElastic3DLaw(*this));
    return p_clone;
}
...
bool HypoElastic3DLaw::Has( const Variable<double>& rThisVariable )
{
    return false;
}

bool HypoElastic3DLaw::Has( const Variable<Vector>& rThisVariable )
{
    return false;
}

bool HypoElastic3DLaw::Has( const Variable<Matrix>& rThisVariable )
{
    return false;
}
...
double& HypoElastic3DLaw::GetValue( const Variable<double>& rThisVariable, double& rValue )
{
...
Vector& HypoElastic3DLaw::GetValue( const Variable<Vector>& rThisVariable, Vector& rValue )
{
    return( rValue );
}

Matrix& HypoElastic3DLaw::GetValue( const Variable<Matrix>& rThisVariable, Matrix& rValue )
{
    return( rValue );
}
...
void HypoElastic3DLaw::SetValue( const Variable<double>& rThisVariable, const double& rValue,
...
void HypoElastic3DLaw::SetValue( const Variable<Vector>& rThisVariable, const Vector& rValue,
                                  const ProcessInfo& rCurrentProcessInfo )
{

}

void HypoElastic3DLaw::SetValue( const Variable<Matrix>& rThisVariable, const Matrix& rValue,
                                  const ProcessInfo& rCurrentProcessInfo )
{
...
void HypoElastic3DLaw::InitializeMaterial( const Properties& rMaterialProperties,
...
void HypoElastic3DLaw::InitializeSolutionStep( const Properties& rMaterialProperties,
...
void HypoElastic3DLaw::FinalizeSolutionStep( const Properties& rMaterialProperties,
        const GeometryType& rElementGeometry, //this is just to give the array of nodes
        const Vector& rShapeFunctionsValues,
        const ProcessInfo& rCurrentProcessInfo)
{
...
void  HypoElastic3DLaw::CalculateMaterialResponsePK2 (Parameters& rValues)
{
...
void HypoElastic3DLaw::CalculateMaterialResponsePK1 (Parameters& rValues)
{
...
void HypoElastic3DLaw::CalculateMaterialResponseKirchhoff (Parameters& rValues)
{
...
void HypoElastic3DLaw::CalculateMaterialResponseCauchy (Parameters& rValues)
{
...
void HypoElastic3DLaw::FinalizeMaterialResponsePK2 (Parameters& rValues)
{
...
void HypoElastic3DLaw::FinalizeMaterialResponsePK1 (Parameters& rValues)
{
...
void HypoElastic3DLaw::FinalizeMaterialResponseKirchhoff (Parameters& rValues)
{
...
void HypoElastic3DLaw::FinalizeMaterialResponseCauchy (Parameters& rValues)
{
    rValues.Set(ConstitutiveLaw::FINALIZE_MATERIAL_RESPONSE);
...
void HypoElastic3DLaw::UpdateInternalVariables(Parameters& rValues)
{
    const Matrix& DeformationGradientF    = rValues.GetDeformationGradientF();
    const double& DeterminantF            = rValues.GetDeterminantF();
...
void HypoElastic3DLaw::CalculateGreenLagrangeStrain( const Matrix & rRightCauchyGreen,
...
// void HypoElastic3DLaw::CalculateAlmansiStrain( const Matrix & rRightCauchyGreen,
...
void HypoElastic3DLaw::CalculateAlmansiStrain( const Matrix & rLeftCauchyGreen,
						Vector& rStrainVector )
{
...
double &  HypoElastic3DLaw::CalculateDomainTemperature (const MaterialResponseVariables & rElasticVariables,
								double & rTemperature)
{
...
double & HypoElastic3DLaw::CalculateVolumetricFactor (const MaterialResponseVariables & rElasticVariables,
						       double & rFactor)
{
  //(J²-1)/2
...
double & HypoElastic3DLaw::CalculateVolumetricPressure (const MaterialResponseVariables & rElasticVariables,
							 double & rPressure)
{
...
Vector&  HypoElastic3DLaw::CalculateVolumetricPressureFactors (const MaterialResponseVariables & rElasticVariables,
							       Vector & rFactors)
...
void HypoElastic3DLaw::CalculateStress( const MaterialResponseVariables & rElasticVariables,
...
//************************************************************************************
void HypoElastic3DLaw::CalculateIsochoricStress( const MaterialResponseVariables & rElasticVariables,
						  StressMeasure rStressMeasure,
...
void HypoElastic3DLaw::CalculateVolumetricStress(const MaterialResponseVariables & rElasticVariables,
...
void HypoElastic3DLaw::CalculateConstitutiveMatrix ( const MaterialResponseVariables& rElasticVariables,
...
void HypoElastic3DLaw::CalculateIsochoricConstitutiveMatrix (const MaterialResponseVariables & rElasticVariables,
...
void HypoElastic3DLaw::CalculateVolumetricConstitutiveMatrix ( const MaterialResponseVariables & rElasticVariables,
								Matrix& rConstitutiveMatrix)
{
...
double& HypoElastic3DLaw::ConstitutiveComponent(double & rCabcd,
...
double& HypoElastic3DLaw::IsochoricConstitutiveComponent(double & rCabcd,
							  const MaterialResponseVariables & rElasticVariables,
							  const Matrix & rIsoStressMatrix,
							  const unsigned int& a, const unsigned int& b,
							  const unsigned int& c, const unsigned int& d)
...
double& HypoElastic3DLaw::VolumetricConstitutiveComponent(double & rCabcd,
							   const MaterialResponseVariables & rElasticVariables,
 ...
 */
Matrix& HypoElastic3DLaw::Transform2DTo3D (Matrix& rMatrix)
{
...
void HypoElastic3DLaw::GetLawFeatures(Features& rFeatures)
{
    	//Set the type of law
...
bool HypoElastic3DLaw::CheckParameters(Parameters& rValues)
{
...
int HypoElastic3DLaw::Check(const Properties& rMaterialProperties,
                             const GeometryType& rElementGeometry,
                             const ProcessInfo& rCurrentProcessInfo)
{
