...
namespace Kratos
{
    ...
    ConstitutiveLaw::SizeType Newtonian2DLaw::GetStrainSize() const { return 3; }
    ...
    double Newtonian2DLaw::GetEffectiveMaterialParameter(ConstitutiveLaw::Parameters &rParameters, const Variable<double> &rVariable) const
    {
