...
#if !defined(KRATOS_BARKER_MU_I_RHEOLOGY_LAW_3D_H_INCLUDED)
...
namespace Kratos {
/**
 * Defines a 3D Barker mu(I) rheology constitutive law
 ...
 * 4) GRAIN_DIAMETER
 * 5) GRAIN_DENSITY
 * 6) INERTIAL_NUMBER_ONE
 * 7) INFINITE_FRICTION
 * 8) ALPHA_PARAMETER
 */

class KRATOS_API(PFEM_FLUID_DYNAMICS_APPLICATION) BarkerMuIRheology3DLaw : public PfemFluidConstitutiveLaw {
   public:
    /**
     * Type Definitions
     */
    ...
    /**
     * Counted pointer of BarkerMuIRheology3DLaw
     */
     ...
     * Copy constructor.
     */
    BarkerMuIRheology3DLaw(const BarkerMuIRheology3DLaw& rOther);

    /**
     * Destructor.
     */
    ~BarkerMuIRheology3DLaw() override;
...
};  // Class BarkerMuIRheology3DLaw

}  // namespace Kratos.

#endif  // KRATOS_BARKER_MU_I_RHEOLOGY_LAW_3D_H_INCLUDED  defined
