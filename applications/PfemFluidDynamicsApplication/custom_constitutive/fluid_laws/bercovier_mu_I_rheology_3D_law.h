...
#if !defined(KRATOS_BERCOVIER_MU_I_RHEOLOGY_LAW_3D_H_INCLUDED)
...
namespace Kratos {
/**
 * Defines a 3D Bercovier mu(I) non-Newtonian constitutive law
...
class KRATOS_API(PFEM_FLUID_DYNAMICS_APPLICATION) BercovierMuIRheology3DLaw : public PfemFluidConstitutiveLaw {
   public:
    /**
     * Type Definitions
     */
    ...
    /**
     * Counted pointer of BercovierMuIRheology3DLaw
     */

    KRATOS_CLASS_POINTER_DEFINITION(BercovierMuIRheology3DLaw);
     ...
     * Copy constructor.
     */
    BercovierMuIRheology3DLaw(const BercovierMuIRheology3DLaw& rOther);

    /**
     * Destructor.
     */
    ~BercovierMuIRheology3DLaw() override;
...
};  // Class BercovierMuIRheology3DLaw

}  // namespace Kratos.

#endif  // KRATOS_BERCOVIER_MU_I_RHEOLOGY_LAW_3D_H_INCLUDED  defined
