...
#if !defined(KRATOS_BARKER_BERCOVIER_MU_I_RHEOLOGY_LAW_3D_H_INCLUDED)
...
namespace Kratos {
/**
 * Defines a 3D Barker-Bercovier mu(I) rheology constitutive law
...
class KRATOS_API(PFEM_FLUID_DYNAMICS_APPLICATION) BarkerBercovierMuIRheology3DLaw : public PfemFluidConstitutiveLaw {
   public:
    /**
     * Type Definitions
     */
    ...
    /**
     * Counted pointer of BarkerBercovierMuIRheology3DLaw
     */
    KRATOS_CLASS_POINTER_DEFINITION(BarkerBercovierMuIRheology3DLaw);
     ...
     * Copy constructor.
     */
    BarkerBercovierMuIRheology3DLaw(const BarkerBercovierMuIRheology3DLaw& rOther);

    /**
     * Destructor.
     */
    ~BarkerBercovierMuIRheology3DLaw() override;
...
};  // Class BarkerBercovierMuIRheology3DLaw

}  // namespace Kratos.

#endif  // KRATOS_BARKER_BERCOVIER_MU_I_RHEOLOGY_LAW_3D_H_INCLUDED  defined
