...
#if !defined (KRATOS_HYPOELASTIC_3D_LAW_H_INCLUDED)
#define  KRATOS_HYPOELASTIC_3D_LAW_H_INCLUDED
...
class HypoElastic3DLaw : public ConstitutiveLaw
{
protected:
...
public:
    ...
    //HypoElastic3DLaw& operator=(const HypoElastic3DLaw& rOther);


    /**
     * Destructor.
     */
    virtual ~HypoElastic3DLaw();
...
protected:
   ...
   /**
    ...
    /**
     * Calculates HypoElasticLaw Factor for the Neo-Hookean model
     * @param rElasticResponseVariables the material variables
...
#endif // KRATOS_HYPOELASTIC_3D_LAW_H_INCLUDED  defined 
