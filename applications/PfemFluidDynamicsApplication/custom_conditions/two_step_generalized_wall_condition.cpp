#include "two_step_generalized_wall_condition.h"
...
/**
 * @see TwoStepGeneralizedWallCondition::EquationIdVector
 */
template<>
void TwoStepGeneralizedWallCondition<2, 2>::EquationIdVector(
 ...
 */
template<>
void TwoStepGeneralizedWallCondition<3, 3>::EquationIdVector(
		EquationIdVectorType& rResult, ProcessInfo& rCurrentProcessInfo)
{
	if (rCurrentProcessInfo[FRACTIONAL_STEP] == 1)
	{
...
/**
 * @see TwoStepGeneralizedWallCondition::GetDofList
 */
template<>
void TwoStepGeneralizedWallCondition<2, 2>::GetDofList(
 ...
 */
template<>
void TwoStepGeneralizedWallCondition<3, 3>::GetDofList(
		DofsVectorType& rConditionDofList, ProcessInfo& rCurrentProcessInfo)
{
	if (rCurrentProcessInfo[FRACTIONAL_STEP] == 1)
	{
...
/**
 * @see TwoStepGeneralizedWallCondition::CalculateWallParameters
 */
template<>
void TwoStepGeneralizedWallCondition<2, 2>::CalculateWallParameters(
 ...
 */
template<>
void TwoStepGeneralizedWallCondition<3, 3>::CalculateWallParameters(
		double& rWallHeight, array_1d<double, 3>& rWallVel, double& rWallGradP,
		double& rArea)
{
	KRATOS_TRY;
