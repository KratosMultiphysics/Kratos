...
namespace Kratos
{
  ...
  KRATOS_CREATE_VARIABLE(Vector, NODAL_SHAPE_FUNCTION_DERIVATIVE )
  KRATOS_CREATE_VARIABLE(Vector, NODAL_SFD_NEIGHBOURS )
  KRATOS_CREATE_VARIABLE(Vector, NODAL_SFD_NEIGHBOURS_ORDER )
  KRATOS_CREATE_VARIABLE(Vector, NODAL_SFD_NEIGHBOURS_COMMON_ELEMENTS )
  KRATOS_CREATE_VARIABLE(Vector, NODAL_SFD_NEIGHBOURS_VOLUME_COMMON_ELEMENTS )
  KRATOS_CREATE_VARIABLE(double, NODAL_SFD_X )
  KRATOS_CREATE_VARIABLE(double, NODAL_SFD_Y )
  KRATOS_CREATE_VARIABLE(double, NODAL_SFD_Z )
