...
namespace Kratos
{
  ...
  // KRATOS_CREATE_VARIABLE(Vector, NODAL_SFD_NEIGHBOURS_PRESSURE )
  // KRATOS_CREATE_VARIABLE(Vector, NODAL_SFD_NEIGHBOURS_PRESSURE_ID )
  // KRATOS_CREATE_VARIABLE(Vector, NODAL_SFD_NEIGHBOURS_VELOCITY_X_ID )
  // KRATOS_CREATE_VARIABLE(Vector, NODAL_SFD_NEIGHBOURS_VELOCITY_Y_ID )
  // KRATOS_CREATE_VARIABLE(Vector, NODAL_SFD_NEIGHBOURS_VELOCITY_Z_ID )
  ...
  KRATOS_CREATE_VARIABLE(Vector, NODAL_SPATIAL_DEF_RATE_BIS )
  ...
  KRATOS_CREATE_VARIABLE(int, FREESURFACE_NEIGHBOURS )
  KRATOS_CREATE_VARIABLE(double, NODAL_FREESURFACE_AREA )
  KRATOS_CREATE_VARIABLE(double, FIRST_LAME_TYPE_COEFFICIENT )
  KRATOS_CREATE_VARIABLE(double, SECOND_LAME_TYPE_COEFFICIENT )
