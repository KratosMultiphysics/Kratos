...
def CreateSolver(main_model_part, custom_settings):
    return PfemFluidDEMcouplingSolver(main_model_part, custom_settings)

class PfemFluidDEMcouplingSolver(BaseSolver.PfemFluidSolver):
    ...
    def __init__(self, main_model_part, custom_settings):
        ...
        print("Construction of 2-step Pfem Fluid DEM coupling Solver finished.")
