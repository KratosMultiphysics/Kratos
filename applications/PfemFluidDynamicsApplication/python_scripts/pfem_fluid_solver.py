...
class PfemFluidSolver(PythonSolver):
    ...
    def Initialize(self):
        ...
        self.computing_model_part.ProcessInfo[KratosMultiphysics.PENALTY_COEFFICIENT] = self.settings["penalty_coefficient"].GetDouble()
    ...
    def AddVariables(self):
        ...
        if self.settings.Has("constitutive_laws_list"):
            self.constitutive_laws_names = self.settings["constitutive_laws_list"]
