...
#define DEM_DETERMINANT_3x3(a0, a1, a2)            (a0[0] * (a1[1] * a2[2] - a1[2] * a2[1]) - a0[1] * (a1[0] * a2[2] - a1[2] * a2[0]) + a0[2] * (a1[0] * a2[1] - a1[1] * a2[0]))
  ...
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, int, BOND_TRANSIENT_DAMPING_STEPS)
  ...
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double, BOND_VOLUME)
  ...
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, bool, SHIFT_PARTICLES_OPTION)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, bool, USE_INITIAL_BOND_CONTACT_AREA)
  ...
  KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS(DEM_APPLICATION, GLOBAL_CONTACT_FORCE_TANGENTIAL)
  ...
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double, MAX_SHEAR_STRAIN)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double, INITIAL_BOND_NUMBER)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, bool, ADJUST_BOND_CONTACT_AREA_OPTION)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double, BOND_CONTACT_AREA_LOGNORMAL_MEDIAN)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double, BOND_CONTACT_AREA_LOGNORMAL_STD_DEV)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double, BOND_CONTACT_AREA_UPPER_BOUND)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double, BOND_GENERATE_PERCENTAGE)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, std::string, BOND_CONTACT_AREA_DISTRIBUTION_TYPE)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double, BOND_CONTACT_AREA_CONSTANT_VALUE)
