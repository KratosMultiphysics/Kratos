...
#define DEM_DETERMINANT_3x3(a0, a1, a2)            (a0[0] * (a1[1] * a2[2] - a1[2] * a2[1]) - a0[1] * (a1[0] * a2[2] - a1[2] * a2[0]) + a0[2] * (a1[0] * a2[1] - a1[1] * a2[0]))
  ...
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, std::string, DEM_ROLLING_FRICTION_MODEL_NAME)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, std::string, DEM_GLOBAL_DAMPING_MODEL_NAME)
  ...
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, int, GLOBAL_DAMPING_OPTION)
  ...
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, int, GROUP_ID)
  ...
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double, INITIAL_COHESION)
  ...
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double, K_ALPHA) // for DEM_D_Quadratic_LAW
  ...
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, bool, IS_UNBREAKABLE)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double, STIFFNESS_FACTOR)

  // ****** for parallel bond model BEGIN ***
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double, BOND_YOUNG_MODULUS)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double, BOND_KNKS_RATIO)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double, BOND_SIGMA_MAX)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double, BOND_SIGMA_MAX_DEVIATION)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double, BOND_TAU_ZERO)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double, BOND_TAU_ZERO_DEVIATION)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double, BOND_INTERNAL_FRICC)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double, BOND_ROTATIONAL_MOMENT_COEFFICIENT_NORMAL)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double, BOND_ROTATIONAL_MOMENT_COEFFICIENT_TANGENTIAL)
  ...
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, bool, IS_RADIUS_EXPANSION_RATE_CHANGE)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double, RADIUS_EXPANSION_ACCELERATION)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double, RADIUS_EXPANSION_RATE_MIN)
  ...
  KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS(DEM_APPLICATION, GLOBAL_CONTACT_FORCE)
  KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS(DEM_APPLICATION, ELASTIC_LOCAL_ROTATIONAL_MOMENT)
  ...
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double, DAMAGE_RATIO)
  ...
  KRATOS_DEFINE_APPLICATION_VARIABLE( DEM_APPLICATION, Matrix, DEM_STRESS_TENSOR_RAW )
  KRATOS_DEFINE_APPLICATION_VARIABLE( DEM_APPLICATION, Matrix, DEM_STRAIN_TENSOR )
  KRATOS_DEFINE_APPLICATION_VARIABLE( DEM_APPLICATION, Matrix, DEM_DIFFERENTIAL_STRAIN_TENSOR )
  ...
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double, RADIAL_NORMAL_STRESS_COMPONENT)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double, OLD_RADIAL_NORMAL_STRESS_COMPONENT)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double, SMOOTHED_SCALAR_RADIAL_VELOCITY)
  ...
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, int,    RVE_EVAL_FREQ)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, int,    RVE_WRITE_FREQ)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, int,    RVE_WRITE_COORDINATES_FREQ)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, std::string, RVE_CONSOLIDATION_STOP_CRITERION)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double, LIMIT_CONSOLIDATION_TIME)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double, LIMIT_CONSOLIDATION_STRESS)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double, LIMIT_CONSOLIDATION_POROSITY)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double, INNER_CONSOLIDATION_POROSITY_OFFSET)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, bool,   INNER_CONSOLIDATION_POROSITY)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, bool,   POST_WRITE_COORDINATES_HISTORY)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, bool,   POST_WRITE_COORDINATES_LAST)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, bool,   POST_WRITE_POROSITY)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, bool,   POST_WRITE_CONTACT_NUMBER)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, bool,   POST_WRITE_COORD_NUMBER)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, bool,   POST_WRITE_INNER_VOLUME_PARTICLES)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, bool,   POST_WRITE_FORCE_CHAIN)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, bool,   POST_WRITE_ELASTIC_CONTACT_FORCES)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, bool,   POST_WRITE_ROSE_DIAGRAM)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, bool,   POST_WRITE_ROSE_DIAGRAM_INNER)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, bool,   POST_WRITE_ROSE_DIAGRAM_UNIFORMITY)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, bool,   POST_WRITE_ANISOTROPY)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, bool,   POST_WRITE_FABRIC_TENSOR)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, bool,   POST_WRITE_FABRIC_TENSOR_INNER)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, bool,   POST_WRITE_STRESS)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, bool,   POST_WRITE_CAUCHY_TENSOR)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, bool,   POST_WRITE_CAUCHY_TENSOR_INNER)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, bool,   POST_WRITE_TANGENT_TENSOR)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, bool,   POST_WRITE_TANGENT_TENSOR_INNER)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, bool,   POST_WRITE_CONDUCTIVITY_TENSOR)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, bool,   POST_WRITE_CONDUCTIVITY_TENSOR_INNER)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, bool,   POST_WRITE_FKS)
...
class DEMFlags
  ...
  public:
    ...
    KRATOS_DEFINE_LOCAL_APPLICATION_FLAG(DEM_APPLICATION, HAS_GLOBAL_DAMPING);
