...
#define DEM_DETERMINANT_3x3(a0, a1, a2)            (a0[0] * (a1[1] * a2[2] - a1[2] * a2[1]) - a0[1] * (a1[0] * a2[2] - a1[2] * a2[0]) + a0[2] * (a1[0] * a2[1] - a1[1] * a2[0]))
  ...
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double, LIMIT_CONSOLIDATION_VALUE)
  ...
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, bool,   RVE_POST_WRITE_RESULTS_GLOBAL)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, bool,   RVE_POST_WRITE_RESULTS_PARTICLES)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, bool,   RVE_POST_WRITE_RESULTS_CONTACTS)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, bool,   RVE_POST_WRITE_RESULTS_TENSORS)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, bool,   RVE_POST_WRITE_RESULTS_ROSE)
