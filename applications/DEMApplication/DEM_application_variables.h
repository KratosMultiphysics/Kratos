...
#define DEM_DETERMINANT_3x3(a0, a1, a2)            (a0[0] * (a1[1] * a2[2] - a1[2] * a2[1]) - a0[1] * (a1[0] * a2[2] - a1[2] * a2[0]) + a0[2] * (a1[0] * a2[1] - a1[1] * a2[0]))
  ...
  KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS(DEM_APPLICATION, VELOCITY_PROJECTED)
  KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS(DEM_APPLICATION, DISPLACEMENT_PROJECTED)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double, VOLUME_SOLID_FRACTION)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double, MASS_SOLID_FRACTION)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double, POROSITY_PROJECTED)
