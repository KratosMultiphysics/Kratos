...
#define DEM_DETERMINANT_3x3(a0, a1, a2)            (a0[0] * (a1[1] * a2[2] - a1[2] * a2[1]) - a0[1] * (a1[0] * a2[2] - a1[2] * a2[0]) + a0[2] * (a1[0] * a2[1] - a1[1] * a2[0]))
  ...
  // *************** Thermal only BEGIN *************
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, std::string, DIRECT_CONDUCTION_MODEL)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, std::string, INDIRECT_CONDUCTION_MODEL)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, std::string, CONVECTION_MODEL)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, std::string, RADIATION_MODEL)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, std::string, ADJUSTED_CONTACT_MODEL)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, std::string, VORONOI_METHOD)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, std::string, POSORITY_METHOD)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, bool,        MOTION_OPTION)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, bool,        DIRECT_CONDUCTION_OPTION)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, bool,        INDIRECT_CONDUCTION_OPTION)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, bool,        CONVECTION_OPTION)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, bool,        RADIATION_OPTION)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, bool,        FRICTION_HEAT_OPTION)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, bool,        ADJUSTED_CONTACT_OPTION)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, bool,        TEMPERATURE_DEPENDENT_RADIUS_OPTION)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, bool,        FIXED_TEMPERATURE)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, bool,        ADIABATIC)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, int,         THERMAL_FREQUENCY)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double,      THERMAL_CONDUCTIVITY)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double,      REAL_YOUNG_MODULUS_RATIO)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double,      HEATFLUX)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double,      HEATSOURCE)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double,      MIN_CONDUCTION_DISTANCE)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double,      MAX_CONDUCTION_DISTANCE)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double,      ISOTHERMAL_CORE_RADIUS)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double,      MAX_RADIATION_DISTANCE)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double,      AVERAGE_POROSITY)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double,      ALPHA_SHAPE_PARAMETER)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double,      INTEGRAL_TOLERANCE)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double,      FLUID_LAYER_THICKNESS)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double,      FLUID_DENSITY)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double,      FLUID_VISCOSITY)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double,      FLUID_THERMAL_CONDUCTIVITY)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double,      FLUID_HEAT_CAPACITY)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double,      FLUID_TEMPERATURE)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, Vector,      FLUID_VELOCITY)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, bool,        GRAPH_PARTICLE_TEMP_MIN)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, bool,        GRAPH_PARTICLE_TEMP_MAX)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, bool,        GRAPH_PARTICLE_TEMP_AVG)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, bool,        GRAPH_PARTICLE_TEMP_DEV)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, bool,        GRAPH_MODEL_TEMP_AVG)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, bool,        GRAPH_PARTICLE_HEAT_FLUX_CONTRIBUTIONS)
  // *************** Thermal only END ***************
...
class DEMFlags
  ...
  public:
    ...
    // *************** Thermal only BEGIN *************
    KRATOS_DEFINE_LOCAL_APPLICATION_FLAG(DEM_APPLICATION, IS_ADIABATIC);
    KRATOS_DEFINE_LOCAL_APPLICATION_FLAG(DEM_APPLICATION, HAS_MOTION);
    KRATOS_DEFINE_LOCAL_APPLICATION_FLAG(DEM_APPLICATION, HAS_FIXED_TEMPERATURE);
    KRATOS_DEFINE_LOCAL_APPLICATION_FLAG(DEM_APPLICATION, HAS_DIRECT_CONDUCTION);
    KRATOS_DEFINE_LOCAL_APPLICATION_FLAG(DEM_APPLICATION, HAS_INDIRECT_CONDUCTION);
    KRATOS_DEFINE_LOCAL_APPLICATION_FLAG(DEM_APPLICATION, HAS_CONVECTION);
    KRATOS_DEFINE_LOCAL_APPLICATION_FLAG(DEM_APPLICATION, HAS_RADIATION);
    KRATOS_DEFINE_LOCAL_APPLICATION_FLAG(DEM_APPLICATION, HAS_FRICTION_HEAT);
    KRATOS_DEFINE_LOCAL_APPLICATION_FLAG(DEM_APPLICATION, HAS_ADJUSTED_CONTACT);
    KRATOS_DEFINE_LOCAL_APPLICATION_FLAG(DEM_APPLICATION, HAS_TEMPERATURE_DEPENDENT_RADIUS);
    // *************** Thermal only END ***************
  };
}
