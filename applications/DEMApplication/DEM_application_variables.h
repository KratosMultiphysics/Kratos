...
#define DEM_DETERMINANT_3x3(a0, a1, a2)            (a0[0] * (a1[1] * a2[2] - a1[2] * a2[1]) - a0[1] * (a1[0] * a2[2] - a1[2] * a2[0]) + a0[2] * (a1[0] * a2[1] - a1[1] * a2[0]))
  ...
  // RVE analysis
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, int,         RVE_EVALUATION_FREQUENCY)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, int,         RVE_WRITE_FREQUENCY)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, std::string, RVE_CONSOLIDATION_STOP_CRITERION)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double,      RVE_CONSOLIDATION_LIMIT_VALUE)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double,      RVE_INNER_VOLUME_OFFSET)
