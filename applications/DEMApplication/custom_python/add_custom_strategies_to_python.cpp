...
void  AddCustomStrategiesToPython(pybind11::module& m)
{
    ...
    py::class_<ExplicitSolverStrategy, ExplicitSolverStrategy::Pointer>(m, "ExplicitSolverStrategy")
        ...
        .def("SolveSolutionStepStatic", &ExplicitSolverStrategy::SolveSolutionStepStatic)
        .def("Initialize", &ExplicitSolverStrategy::Initialize)
        .def("InitializeSolutionStep", &ExplicitSolverStrategy::InitializeSolutionStep)
        .def("InitializeThermalDataInSubModelParts", &ExplicitSolverStrategy::InitializeThermalDataInSubModelParts)
        .def("InitializeGraphOutput", &ExplicitSolverStrategy::InitializeGraphOutput)
        .def("WriteGraphOutput", &ExplicitSolverStrategy::WriteGraphOutput)
        .def("TesselationTasks", &ExplicitSolverStrategy::TesselationTasks)
