...
PYBIND11_MODULE(KratosDEMApplication,m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, DEM_ROLLING_FRICTION_MODEL_NAME)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, DEM_GLOBAL_DAMPING_MODEL_NAME)
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, DEM_BEAM_CONSTITUTIVE_LAW_POINTER)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, DEM_ROLLING_FRICTION_MODEL_POINTER)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, DEM_GLOBAL_DAMPING_MODEL_POINTER)
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, IS_STICKY)
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, CONTACT_IMPULSE)
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, LOCAL_COORDINATION_NUMBER_OPTION)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, GLOBAL_COORDINATION_NUMBER_OPTION)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, CLEAN_INDENT_OPTION)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, CLEAN_INDENT_V2_OPTION)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, TRIHEDRON_OPTION)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, ROLLING_FRICTION_OPTION)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, GLOBAL_DAMPING_OPTION)
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, ENERGY_CALCULATION_OPTION)
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, GROUP_ID)
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, INITIAL_COHESION)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, AMOUNT_OF_COHESION_FROM_STRESS)
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, BEAM_PARTICLES_DISTANCE)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, BEAM_LENGTH)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, I22) // Planar moment of inertia 22
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, I33) // Planar moment of inertia 33
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, BEAM_INERTIA_ROT_UNIT_LENGHT_X) // Moment of inertia X / (mass * beam length)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, BEAM_INERTIA_ROT_UNIT_LENGHT_Y) // Moment of inertia Y / (mass * beam length)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, BEAM_INERTIA_ROT_UNIT_LENGHT_Z) // Moment of inertia Z / (mass * beam length)
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, FRICTION) //deprecated since April 6th, 2020
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, STATIC_FRICTION)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, DYNAMIC_FRICTION)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, FRICTION_DECAY)
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, CONICAL_DAMAGE_CONTACT_RADIUS)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, CONICAL_DAMAGE_MAX_STRESS)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, CONICAL_DAMAGE_ALPHA)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, CONICAL_DAMAGE_ALPHA_FUNCTION)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, CONICAL_DAMAGE_GAMMA)
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, ROTATIONAL_MOMENT_COEFFICIENT)
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, KDEM_STANDARD_DEVIATION_TAU_ZERO)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, KDEM_STANDARD_DEVIATION_FRICTION)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, PERTURBED_TAU_ZERO)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, PERTURBED_INTERNAL_FRICTION)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, SIGMA_3_AVERAGE)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, LOOSE_MATERIAL_YOUNG_MODULUS)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, BONDED_MATERIAL_YOUNG_MODULUS)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, DEBUG_PRINTING_OPTION)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, DEBUG_PRINTING_ID_1)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, DEBUG_PRINTING_ID_2)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, FRACTURE_ENERGY)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, FRACTURE_ENERGY_NORMAL)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, FRACTURE_ENERGY_TANGENTIAL)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, FRACTURE_ENERGY_EXPONENT)
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, SEARCH_RADIUS_INCREMENT_FOR_BONDS_CREATION)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, IS_UNBREAKABLE)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, STIFFNESS_FACTOR)
    // *************** Continuum only END *************
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, DEVIATION)
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, MAXIMUM_RADIUS)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, MINIMUM_RADIUS)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, INITIAL_RADIUS)
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, RIGID_BODY_OPTION)
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, IS_RADIUS_EXPANSION_RATE_CHANGE)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, RADIUS_EXPANSION_ACCELERATION)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, RADIUS_EXPANSION_RATE_MIN)
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, PARTICLE_INELASTIC_ROLLING_RESISTANCE_ENERGY)
    ...
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, GLOBAL_CONTACT_FORCE)
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, ELASTIC_LOCAL_ROTATIONAL_MOMENT)
    //KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, PARTICLE_CONTACT_FORCES )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, NEIGHBOUR_SIZE)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, DAMAGE_RATIO)
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, DEM_STRESS_TENSOR_RAW)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, DEM_STRAIN_TENSOR)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, DEM_DIFFERENTIAL_STRAIN_TENSOR)
    ...
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, SMOOTHED_REACTION_STRESS)
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, ELASTIC_REACTION_STRESS)
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, SMOOTHED_ELASTIC_REACTION_STRESS)
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, LOADING_VELOCITY)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, RADIAL_NORMAL_STRESS_COMPONENT)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, OLD_RADIAL_NORMAL_STRESS_COMPONENT)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, SMOOTHED_SCALAR_RADIAL_VELOCITY)

    // for DEM-FEM 2D
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, IMPOSED_Z_STRAIN_OPTION)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, IMPOSED_Z_STRAIN_VALUE)

    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, RVE_EVAL_FREQ)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, RVE_WRITE_FREQ)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, RVE_WRITE_COORDINATES_FREQ)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, RVE_CONSOLIDATION_STOP_CRITERION)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, LIMIT_CONSOLIDATION_TIME)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, LIMIT_CONSOLIDATION_STRESS)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, LIMIT_CONSOLIDATION_POROSITY)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, INNER_CONSOLIDATION_POROSITY_OFFSET)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, INNER_CONSOLIDATION_POROSITY)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, POST_WRITE_COORDINATES_HISTORY)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, POST_WRITE_COORDINATES_LAST)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, POST_WRITE_POROSITY)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, POST_WRITE_CONTACT_NUMBER)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, POST_WRITE_COORD_NUMBER)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, POST_WRITE_INNER_VOLUME_PARTICLES)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, POST_WRITE_FORCE_CHAIN)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, POST_WRITE_ELASTIC_CONTACT_FORCES)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, POST_WRITE_ROSE_DIAGRAM)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, POST_WRITE_ROSE_DIAGRAM_INNER)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, POST_WRITE_ROSE_DIAGRAM_UNIFORMITY)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, POST_WRITE_ANISOTROPY)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, POST_WRITE_FABRIC_TENSOR)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, POST_WRITE_FABRIC_TENSOR_INNER)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, POST_WRITE_STRESS)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, POST_WRITE_CAUCHY_TENSOR)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, POST_WRITE_CAUCHY_TENSOR_INNER)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, POST_WRITE_TANGENT_TENSOR)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, POST_WRITE_TANGENT_TENSOR_INNER)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, POST_WRITE_CONDUCTIVITY_TENSOR)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, POST_WRITE_CONDUCTIVITY_TENSOR_INNER)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, POST_WRITE_FKS)
}
