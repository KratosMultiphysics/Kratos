...
PYBIND11_MODULE(KratosDEMApplication,m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, BOND_CONTACT_AREA_SMALL_PERCENTAGE)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, BOND_CONTACT_AREA_SMALL_MINIMUM)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, BOND_CONTACT_AREA_SMALL_MAXIMUM)
