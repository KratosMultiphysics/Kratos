...
PYBIND11_MODULE(KratosDEMApplication,m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, USE_MESH_REPAIR_OPTION)
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, BOND_VOLUME)
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, SHIFT_PARTICLES_OPTION)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, USE_INITIAL_BOND_CONTACT_AREA)
    ...
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, GLOBAL_CONTACT_FORCE_TANGENTIAL)
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, MAX_SHEAR_STRAIN)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, INITIAL_BOND_NUMBER)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, ADJUST_BOND_CONTACT_AREA_OPTION)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, BOND_CONTACT_AREA_LOGNORMAL_MEDIAN)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, BOND_CONTACT_AREA_LOGNORMAL_STD_DEV)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, BOND_CONTACT_AREA_UPPER_BOUND)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, BOND_GENERATE_PERCENTAGE)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, BOND_CONTACT_AREA_DISTRIBUTION_TYPE)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, BOND_CONTACT_AREA_CONSTANT_VALUE)
