...
PYBIND11_MODULE(KratosDEMApplication,m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, PARTICLE_INITIAL_COHESION)
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, WALL_INITIAL_COHESION)
    ...
    //DEM HOMOGENIZATION UTILITIES
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, VELOCITY_PROJECTED)
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, DISPLACEMENT_PROJECTED)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, VOLUME_SOLID_FRACTION)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, MASS_SOLID_FRACTION)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, POROSITY_PROJECTED)
}
