...
PYBIND11_MODULE(KratosDEMApplication,m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, BEAM_ELEMENTS_DISTANCE)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, BEAM_LENGTH)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, BEAM_PLANAR_MOMENT_OF_INERTIA_XX)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, BEAM_PLANAR_MOMENT_OF_INERTIA_YY)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, BEAM_MOMENT_OF_INERTIA_PER_METER_X)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, BEAM_MOMENT_OF_INERTIA_PER_METER_Y)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, BEAM_MOMENT_OF_INERTIA_PER_METER_Z)
