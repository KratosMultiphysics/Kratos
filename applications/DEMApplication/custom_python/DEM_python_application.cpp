...
PYBIND11_MODULE(KratosDEMApplication,m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, COMPUTE_REACTIONS_OPTION)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, COMPUTE_FORCES_ON_THIS_RIGID_ELEMENT)
    ...
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, RIGID_BODY_CENTER_OF_ROTATION)
