...
PYBIND11_MODULE(KratosDEMApplication,m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, GRAPH_PARTICLE_TEMP_MIN)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, GRAPH_PARTICLE_TEMP_MAX)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, GRAPH_PARTICLE_TEMP_AVG)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, GRAPH_PARTICLE_TEMP_DEV)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, GRAPH_MODEL_TEMP_AVG)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, GRAPH_PARTICLE_HEAT_FLUX_CONTRIBUTIONS)
    // *************** Thermal only END ***************
