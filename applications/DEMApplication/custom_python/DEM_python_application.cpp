...
PYBIND11_MODULE(KratosDEMApplication,m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, LIMIT_CONSOLIDATION_VALUE)
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, RVE_POST_WRITE_RESULTS_GLOBAL)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, RVE_POST_WRITE_RESULTS_PARTICLES)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, RVE_POST_WRITE_RESULTS_CONTACTS)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, RVE_POST_WRITE_RESULTS_TENSORS)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, RVE_POST_WRITE_RESULTS_ROSE)
}
