...
PYBIND11_MODULE(KratosDEMApplication,m)
{
    ...
    // RVE analysis
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, RVE_EVALUATION_FREQUENCY)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, RVE_WRITE_FREQUENCY)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, RVE_CONSOLIDATION_STOP_CRITERION)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, RVE_CONSOLIDATION_LIMIT_VALUE)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, RVE_INNER_VOLUME_OFFSET)
}
