...
class DEMAnalysisStage2DSpRigidFem(DEMAnalysisStage):
    ...
    def AdditionalFinalizeOperations(self):
        ...
        if self.write_mdpa_from_results:
            mesh_creator_sphere.WriteSphereMdpaFromResults(self.problem_name + 'DEM', self.main_path, spheres_mp_filename_post, self.file_msh, self.file_res, self.post_path)
