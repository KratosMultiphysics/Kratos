...
class Procedures():
    ...
    def AddSpheresVariables(self, model_part, DEM_parameters):
        ...
        model_part.AddNodalSolutionStepVariable(MAX_SHEAR_STRAIN)
...
class DEMIo():
    ...
    def AddSpheresVariables(self):
        ...
        if "PostMaxShearStrain" in self.DEM_parameters.keys():
            if self.DEM_parameters["PostMaxShearStrain"].GetBool():
                self.PushPrintVar(self.PostMaxShearStrain, MAX_SHEAR_STRAIN, self.spheres_variables)
