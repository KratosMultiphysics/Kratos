...
class ExplicitStrategy():
    ...
    def __init__(self, all_model_parts, creator_destructor, dem_fem_search, DEM_parameters, procedures):
        ...
        self.limit_consolidation_time             = DEM_parameters["LimitConsolidationTime"].GetDouble()
    ...
    def SetVariablesAndOptions(self):
        ...
        self.spheres_model_part.ProcessInfo.SetValue(LIMIT_CONSOLIDATION_TIME, self.limit_consolidation_time)
