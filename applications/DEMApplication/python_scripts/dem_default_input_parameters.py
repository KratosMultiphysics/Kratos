    ...
    default_settings = KratosMultiphysics.Parameters("""
        {
            ...
            "LimitConsolidationTime"           : 0.0,
            "InnerConsolidationPorosityOffset" : 0.7,
            "InnerConsolidationPorosity"       : false,
            "PostWriteCoordinatesHistory"      : true,
            "PostWriteCoordinatesHistoryFreq"  : 1000,
            "PostWriteCoordinatesLast"         : true,
            "PostWritePorosity"                : true,
            "PostWriteContactNumber"           : true,
            "PostWriteCoordNumber"             : true,
            "PostWriteInnerVolumeParticles"    : true,
            "PostWriteForceChain"              : true,
            "PostWriteElasticContactForces"    : true,
            "PostWriteRoseDiagram"             : true,
            "PostWriteRoseDiagramInner"        : true,
            "PostWriteRoseDiagramUniformity"   : true,
            "PostWriteAnisotropy"              : true,
            "PostWriteFabricTensor"            : true,
            "PostWriteFabricTensorInner"       : true,
            "PostWriteStress"                  : true,
            "PostWriteCauchyTensor"            : true,
            "PostWriteCauchyTensorInner"       : true,
            "PostWriteTangentTensor"           : true,
            "PostWriteTangentTensorInner"      : true,
            "PostWriteConductivityTensor"      : true,
            "PostWriteConductivityTensorInner" : true,
            "PostWriteFKS"                     : true
        }""")
