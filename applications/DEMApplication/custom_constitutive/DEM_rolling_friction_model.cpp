...
namespace Kratos{
    ...
    void DEMRollingFrictionModel::ComputeRollingFriction(double& RollingResistance, double dt, SphericParticle* p_element, SphericParticle* p_neighbor, double LocalContactForce[3], array_1d<double, 3>& mContactMoment){
