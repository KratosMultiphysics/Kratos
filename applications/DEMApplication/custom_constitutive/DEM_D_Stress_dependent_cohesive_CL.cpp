...
namespace Kratos {
    ...
    DEMDiscontinuumConstitutiveLaw* DEM_D_Stress_Dependent_Cohesive::CloneRaw() const{
        DEMDiscontinuumConstitutiveLaw*cloned_law(new DEM_D_Stress_Dependent_Cohesive(*this));
        return cloned_law;
    }
