...
namespace Kratos {
    ...
    DEMDiscontinuumConstitutiveLaw* DEM_D_Hertz_viscous_Coulomb_Nestle::CloneRaw() const{
        DEMDiscontinuumConstitutiveLaw*cloned_law(new DEM_D_Hertz_viscous_Coulomb_Nestle(*this));
        return cloned_law;
    }
