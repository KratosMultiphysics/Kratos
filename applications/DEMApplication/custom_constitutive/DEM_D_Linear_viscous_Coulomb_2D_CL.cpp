...
namespace Kratos {
    ...
    DEMDiscontinuumConstitutiveLaw* DEM_D_Linear_viscous_Coulomb2D::CloneRaw() const{
        DEMDiscontinuumConstitutiveLaw*cloned_law(new DEM_D_Linear_viscous_Coulomb2D(*this));
        return cloned_law;
    }
