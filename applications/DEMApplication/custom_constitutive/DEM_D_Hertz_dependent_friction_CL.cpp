...
namespace Kratos {
    ...
    void DEM_D_Hertz_dependent_friction::InitializeDependentContact(double equiv_radius,
    ...
    void DEM_D_Hertz_dependent_friction::DamageContact(SphericParticle* const element1,
