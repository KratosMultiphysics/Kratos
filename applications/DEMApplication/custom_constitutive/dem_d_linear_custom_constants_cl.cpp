...
namespace Kratos {
    ...
    DEMDiscontinuumConstitutiveLaw* DEM_D_Linear_Custom_Constants::CloneRaw() const{
        DEMDiscontinuumConstitutiveLaw*cloned_law(new DEM_D_Linear_Custom_Constants(*this));
        return cloned_law;
    }
