...
// OPTIONS AND FLAGS
KRATOS_CREATE_VARIABLE(bool, FORCE_INTEGRATION_GROUP)
...
KRATOS_CREATE_VARIABLE(bool, TOP)
KRATOS_CREATE_VARIABLE(bool, BOTTOM)
KRATOS_CREATE_VARIABLE(bool, BOUNDING_BOX_OPTION)
KRATOS_CREATE_VARIABLE(bool, ROTATION_OPTION)
KRATOS_CREATE_VARIABLE(bool, CRITICAL_TIME_OPTION)
KRATOS_CREATE_VARIABLE(bool, VIRTUAL_MASS_OPTION)
...
KRATOS_CREATE_VARIABLE(bool, CLEAN_INDENT_OPTION)
KRATOS_CREATE_VARIABLE(bool, TRIHEDRON_OPTION)
KRATOS_CREATE_VARIABLE(bool, ROLLING_FRICTION_OPTION)
KRATOS_CREATE_VARIABLE(bool, POISSON_EFFECT_OPTION)
KRATOS_CREATE_VARIABLE(bool, SHEAR_STRAIN_PARALLEL_TO_BOND_OPTION)
KRATOS_CREATE_VARIABLE(bool, NEIGH_INITIALIZED)
KRATOS_CREATE_VARIABLE(bool, TRIAXIAL_TEST_OPTION)
KRATOS_CREATE_VARIABLE(int, FIX_VELOCITIES_FLAG)
KRATOS_CREATE_VARIABLE(bool, COMPUTE_STRESS_TENSOR_OPTION)
KRATOS_CREATE_VARIABLE(bool, COMPUTE_REACTIONS_OPTION)
KRATOS_CREATE_VARIABLE(bool, COMPUTE_FORCES_ON_THIS_RIGID_ELEMENT)
...
KRATOS_CREATE_VARIABLE(bool, COMPUTE_FEM_RESULTS_OPTION)
...
KRATOS_CREATE_VARIABLE(bool, CONTACT_MESH_OPTION)
...
KRATOS_CREATE_VARIABLE(bool, CONCRETE_TEST_OPTION)
...
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(RIGID_BODY_CENTER_OF_ROTATION)
...
KRATOS_CREATE_VARIABLE(bool, RIGID_BODY_MOTION)
...
KRATOS_CREATE_VARIABLE(bool, COMPUTE_ENERGY_OPTION)
...
KRATOS_CREATE_VARIABLE(bool, PRINT_EXPORT_ID)
KRATOS_CREATE_VARIABLE(bool, PRINT_STRESS_TENSOR_OPTION)
...
KRATOS_CREATE_VARIABLE(bool, RIGID_FACE_FLAG)
...
KRATOS_CREATE_LOCAL_FLAG(DEMFlags, COMPUTE_REACTIONS, 19);
KRATOS_CREATE_LOCAL_FLAG(DEMFlags, INTEGRATE_FORCES_AND_MOMENTS, 20);
...
KratosDEMApplication::KratosDEMApplication() : KratosApplication("DEMApplication"),
    ...
    mInletElement3D(0, Element::GeometryType::Pointer(new Point3D<Node<3> >(Element::GeometryType::PointsArrayType(1)))),
...
void KratosDEMApplication::Register() {
    ...
    KRATOS_REGISTER_VARIABLE(COMPUTE_REACTIONS_OPTION)
    KRATOS_REGISTER_VARIABLE(COMPUTE_FORCES_ON_THIS_RIGID_ELEMENT)
    ...
    KRATOS_REGISTER_VARIABLE(RIGID_BODY_CENTER_OF_ROTATION)
    ...
    KRATOS_REGISTER_ELEMENT("InletElement3D", mInletElement3D)
