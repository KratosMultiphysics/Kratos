...
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(VELOCITY_PROJECTED)
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(DISPLACEMENT_PROJECTED)
KRATOS_CREATE_VARIABLE(double, VOLUME_SOLID_FRACTION)
KRATOS_CREATE_VARIABLE(double, MASS_SOLID_FRACTION)
...
void KratosDEMApplication::Register() {
    ...
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(DISPLACEMENT_PROJECTED)
    KRATOS_REGISTER_VARIABLE(VOLUME_SOLID_FRACTION)
    KRATOS_REGISTER_VARIABLE(MASS_SOLID_FRACTION)
