...
KRATOS_CREATE_VARIABLE(double, PARTICLE_INELASTIC_DAMPING_NORMAL_ENERGY)
KRATOS_CREATE_VARIABLE(double, PARTICLE_INELASTIC_DAMPING_TANGENT_ENERGY)
...
void KratosDEMApplication::Register() {
    ...
    KRATOS_REGISTER_VARIABLE(PARTICLE_INELASTIC_DAMPING_NORMAL_ENERGY)
    KRATOS_REGISTER_VARIABLE(PARTICLE_INELASTIC_DAMPING_TANGENT_ENERGY)
