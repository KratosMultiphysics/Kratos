...
KRATOS_CREATE_VARIABLE(double, MAX_SHEAR_STRESS)
...
KRATOS_CREATE_VARIABLE(double, BOND_CONTACT_AREA_SMALL_PERCENTAGE)
KRATOS_CREATE_VARIABLE(double, BOND_CONTACT_AREA_SMALL_MINIMUM)
KRATOS_CREATE_VARIABLE(double, BOND_CONTACT_AREA_SMALL_MAXIMUM)
...
void KratosDEMApplication::Register() {
    ...
    KRATOS_REGISTER_VARIABLE(MAX_SHEAR_STRESS)
    ...
    KRATOS_REGISTER_VARIABLE(BOND_CONTACT_AREA_SMALL_PERCENTAGE)
    KRATOS_REGISTER_VARIABLE(BOND_CONTACT_AREA_SMALL_MINIMUM)
    KRATOS_REGISTER_VARIABLE(BOND_CONTACT_AREA_SMALL_MAXIMUM)
