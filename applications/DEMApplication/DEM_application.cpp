...
// RVE analysis
KRATOS_CREATE_VARIABLE(int,         RVE_EVALUATION_FREQUENCY)
KRATOS_CREATE_VARIABLE(int,         RVE_WRITE_FREQUENCY)
KRATOS_CREATE_VARIABLE(std::string, RVE_CONSOLIDATION_STOP_CRITERION)
KRATOS_CREATE_VARIABLE(double,      RVE_CONSOLIDATION_LIMIT_VALUE)
KRATOS_CREATE_VARIABLE(double,      RVE_INNER_VOLUME_OFFSET)
...
void KratosDEMApplication::Register() {
    ...
    // RVE analysis
    KRATOS_REGISTER_VARIABLE(RVE_EVALUATION_FREQUENCY)
    KRATOS_REGISTER_VARIABLE(RVE_WRITE_FREQUENCY)
    KRATOS_REGISTER_VARIABLE(RVE_CONSOLIDATION_STOP_CRITERION)
    KRATOS_REGISTER_VARIABLE(RVE_CONSOLIDATION_LIMIT_VALUE)
    KRATOS_REGISTER_VARIABLE(RVE_INNER_VOLUME_OFFSET)
