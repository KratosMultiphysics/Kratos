...
KRATOS_CREATE_VARIABLE(double,      PRESCRIBED_GLOBAL_POROSITY)
...
KRATOS_CREATE_VARIABLE(bool,        GRAPH_PARTICLE_TEMP_MIN)
KRATOS_CREATE_VARIABLE(bool,        GRAPH_PARTICLE_TEMP_MAX)
KRATOS_CREATE_VARIABLE(bool,        GRAPH_PARTICLE_TEMP_AVG)
KRATOS_CREATE_VARIABLE(bool,        GRAPH_PARTICLE_TEMP_DEV)
KRATOS_CREATE_VARIABLE(bool,        GRAPH_MODEL_TEMP_AVG)
KRATOS_CREATE_VARIABLE(bool,        GRAPH_PARTICLE_HEAT_FLUX_CONTRIBUTIONS)
// *************** Thermal only END ***************
...
KRATOS_CREATE_LOCAL_FLAG(DEMFlags, IS_ADIABATIC, 19);
KRATOS_CREATE_LOCAL_FLAG(DEMFlags, HAS_MOTION, 20);
KRATOS_CREATE_LOCAL_FLAG(DEMFlags, HAS_FIXED_TEMPERATURE, 21);
KRATOS_CREATE_LOCAL_FLAG(DEMFlags, HAS_DIRECT_CONDUCTION, 22);
KRATOS_CREATE_LOCAL_FLAG(DEMFlags, HAS_INDIRECT_CONDUCTION, 23);
KRATOS_CREATE_LOCAL_FLAG(DEMFlags, HAS_CONVECTION, 24);
KRATOS_CREATE_LOCAL_FLAG(DEMFlags, HAS_RADIATION, 25);
KRATOS_CREATE_LOCAL_FLAG(DEMFlags, HAS_FRICTION_HEAT, 26);
KRATOS_CREATE_LOCAL_FLAG(DEMFlags, HAS_ADJUSTED_CONTACT, 27);
KRATOS_CREATE_LOCAL_FLAG(DEMFlags, HAS_TEMPERATURE_DEPENDENT_RADIUS, 28);
...
void KratosDEMApplication::Register() {
    ...
    KRATOS_REGISTER_VARIABLE(RADIATION_MODEL)
    KRATOS_REGISTER_VARIABLE(ADJUSTED_CONTACT_MODEL)
    ...
    KRATOS_REGISTER_VARIABLE(FRICTION_HEAT_OPTION)
    KRATOS_REGISTER_VARIABLE(ADJUSTED_CONTACT_OPTION)
    KRATOS_REGISTER_VARIABLE(TEMPERATURE_DEPENDENT_RADIUS_OPTION)
    ...
    KRATOS_REGISTER_VARIABLE(PRESCRIBED_GLOBAL_POROSITY)
    ...
    KRATOS_REGISTER_VARIABLE(GRAPH_PARTICLE_TEMP_MIN)
    KRATOS_REGISTER_VARIABLE(GRAPH_PARTICLE_TEMP_MAX)
    KRATOS_REGISTER_VARIABLE(GRAPH_PARTICLE_TEMP_AVG)
    KRATOS_REGISTER_VARIABLE(GRAPH_PARTICLE_TEMP_DEV)
    KRATOS_REGISTER_VARIABLE(GRAPH_MODEL_TEMP_AVG)
    KRATOS_REGISTER_VARIABLE(GRAPH_PARTICLE_HEAT_FLUX_CONTRIBUTIONS)
    // *************** Thermal only END ***************
