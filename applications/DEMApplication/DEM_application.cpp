...
KRATOS_CREATE_VARIABLE(double,      RADIATION_RADIUS_FACTOR)
...
KRATOS_CREATE_LOCAL_FLAG(DEMFlags, HAS_FIXED_TEMPERATURE, 19);
KRATOS_CREATE_LOCAL_FLAG(DEMFlags, IS_ADIABATIC, 20);
...
void KratosDEMApplication::Register() {
    ...
    KRATOS_REGISTER_VARIABLE(RADIATION_RADIUS_FACTOR)
