...
KRATOS_CREATE_LOCAL_FLAG(DEMFlags, HAS_DIRECT_CONDUCTION, 19);
KRATOS_CREATE_LOCAL_FLAG(DEMFlags, HAS_INDIRECT_CONDUCTION, 20);
KRATOS_CREATE_LOCAL_FLAG(DEMFlags, HAS_CONVECTION, 21);
KRATOS_CREATE_LOCAL_FLAG(DEMFlags, HAS_RADIATION, 22);
