...
KRATOS_CREATE_VARIABLE(int, BOND_TRANSIENT_DAMPING_STEPS)
// Smooth joint model variables
...
KRATOS_CREATE_VARIABLE(double, BOND_VOLUME)
...
KRATOS_CREATE_VARIABLE(bool, SHIFT_PARTICLES_OPTION)
KRATOS_CREATE_VARIABLE(bool, USE_INITIAL_BOND_CONTACT_AREA)
...
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(GLOBAL_CONTACT_FORCE_TANGENTIAL)
...
KRATOS_CREATE_VARIABLE(double, MAX_SHEAR_STRAIN)
KRATOS_CREATE_VARIABLE(double, INITIAL_BOND_NUMBER)
KRATOS_CREATE_VARIABLE(bool, ADJUST_BOND_CONTACT_AREA_OPTION)
KRATOS_CREATE_VARIABLE(double, BOND_CONTACT_AREA_LOGNORMAL_MEDIAN)
KRATOS_CREATE_VARIABLE(double, BOND_CONTACT_AREA_LOGNORMAL_STD_DEV)
KRATOS_CREATE_VARIABLE(double, BOND_CONTACT_AREA_UPPER_BOUND)
KRATOS_CREATE_VARIABLE(double, BOND_GENERATE_PERCENTAGE)
KRATOS_CREATE_VARIABLE(std::string, BOND_CONTACT_AREA_DISTRIBUTION_TYPE)
KRATOS_CREATE_VARIABLE(double, BOND_CONTACT_AREA_CONSTANT_VALUE)
...
void KratosDEMApplication::Register() {
    ...
    KRATOS_REGISTER_VARIABLE(BOND_TRANSIENT_DAMPING_STEPS)
    ...
    KRATOS_REGISTER_VARIABLE(BOND_VOLUME)
    ...
    KRATOS_REGISTER_VARIABLE(MAX_SHEAR_STRAIN)
    KRATOS_REGISTER_VARIABLE(INITIAL_BOND_NUMBER)
    KRATOS_REGISTER_VARIABLE(ADJUST_BOND_CONTACT_AREA_OPTION)
    KRATOS_REGISTER_VARIABLE(BOND_CONTACT_AREA_LOGNORMAL_MEDIAN)
    KRATOS_REGISTER_VARIABLE(BOND_CONTACT_AREA_LOGNORMAL_STD_DEV)
    KRATOS_REGISTER_VARIABLE(BOND_CONTACT_AREA_UPPER_BOUND)
    KRATOS_REGISTER_VARIABLE(BOND_GENERATE_PERCENTAGE)
    KRATOS_REGISTER_VARIABLE(BOND_CONTACT_AREA_DISTRIBUTION_TYPE)
    KRATOS_REGISTER_VARIABLE(BOND_CONTACT_AREA_CONSTANT_VALUE)
    ...
    KRATOS_REGISTER_VARIABLE(SHIFT_PARTICLES_OPTION)
    KRATOS_REGISTER_VARIABLE(USE_INITIAL_BOND_CONTACT_AREA)
    ...
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(GLOBAL_CONTACT_FORCE_TANGENTIAL)
