...
KRATOS_CREATE_LOCAL_FLAG(DEMFlags, HAS_FIXED_TEMPERATURE, 20);
KRATOS_CREATE_LOCAL_FLAG(DEMFlags, HAS_DIRECT_CONDUCTION, 21);
KRATOS_CREATE_LOCAL_FLAG(DEMFlags, HAS_INDIRECT_CONDUCTION, 22);
KRATOS_CREATE_LOCAL_FLAG(DEMFlags, HAS_CONVECTION, 23);
KRATOS_CREATE_LOCAL_FLAG(DEMFlags, HAS_RADIATION, 24);
KRATOS_CREATE_LOCAL_FLAG(DEMFlags, HAS_ADJUSTED_CONTACT, 25);
