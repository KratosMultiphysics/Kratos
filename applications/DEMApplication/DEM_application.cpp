...
#include "custom_constitutive/DEM_D_Linear_Simple_Coulomb.h"
...
KRATOS_CREATE_VARIABLE(int,    RVE_EVAL_FREQ)
KRATOS_CREATE_VARIABLE(int,    RVE_WRITE_FREQ)
KRATOS_CREATE_VARIABLE(int,    RVE_WRITE_COORDINATES_FREQ)
KRATOS_CREATE_VARIABLE(std::string, RVE_CONSOLIDATION_STOP_CRITERION)
KRATOS_CREATE_VARIABLE(double, LIMIT_CONSOLIDATION_TIME)
KRATOS_CREATE_VARIABLE(double, LIMIT_CONSOLIDATION_STRESS)
KRATOS_CREATE_VARIABLE(double, LIMIT_CONSOLIDATION_POROSITY)
KRATOS_CREATE_VARIABLE(double, INNER_CONSOLIDATION_POROSITY_OFFSET)
KRATOS_CREATE_VARIABLE(bool,   INNER_CONSOLIDATION_POROSITY)
KRATOS_CREATE_VARIABLE(bool,   POST_WRITE_COORDINATES_HISTORY)
KRATOS_CREATE_VARIABLE(bool,   POST_WRITE_COORDINATES_LAST)
KRATOS_CREATE_VARIABLE(bool,   POST_WRITE_POROSITY)
KRATOS_CREATE_VARIABLE(bool,   POST_WRITE_CONTACT_NUMBER)
KRATOS_CREATE_VARIABLE(bool,   POST_WRITE_COORD_NUMBER)
KRATOS_CREATE_VARIABLE(bool,   POST_WRITE_INNER_VOLUME_PARTICLES)
KRATOS_CREATE_VARIABLE(bool,   POST_WRITE_FORCE_CHAIN)
KRATOS_CREATE_VARIABLE(bool,   POST_WRITE_ELASTIC_CONTACT_FORCES)
KRATOS_CREATE_VARIABLE(bool,   POST_WRITE_ROSE_DIAGRAM)
KRATOS_CREATE_VARIABLE(bool,   POST_WRITE_ROSE_DIAGRAM_INNER)
KRATOS_CREATE_VARIABLE(bool,   POST_WRITE_ROSE_DIAGRAM_UNIFORMITY)
KRATOS_CREATE_VARIABLE(bool,   POST_WRITE_ANISOTROPY)
KRATOS_CREATE_VARIABLE(bool,   POST_WRITE_FABRIC_TENSOR)
KRATOS_CREATE_VARIABLE(bool,   POST_WRITE_FABRIC_TENSOR_INNER)
KRATOS_CREATE_VARIABLE(bool,   POST_WRITE_STRESS)
KRATOS_CREATE_VARIABLE(bool,   POST_WRITE_CAUCHY_TENSOR)
KRATOS_CREATE_VARIABLE(bool,   POST_WRITE_CAUCHY_TENSOR_INNER)
KRATOS_CREATE_VARIABLE(bool,   POST_WRITE_TANGENT_TENSOR)
KRATOS_CREATE_VARIABLE(bool,   POST_WRITE_TANGENT_TENSOR_INNER)
KRATOS_CREATE_VARIABLE(bool,   POST_WRITE_CONDUCTIVITY_TENSOR)
KRATOS_CREATE_VARIABLE(bool,   POST_WRITE_CONDUCTIVITY_TENSOR_INNER)
KRATOS_CREATE_VARIABLE(bool,   POST_WRITE_FKS)
...
void KratosDEMApplication::Register() {
    ...
    KRATOS_REGISTER_VARIABLE(RVE_EVAL_FREQ)
    KRATOS_REGISTER_VARIABLE(RVE_WRITE_FREQ)
    KRATOS_REGISTER_VARIABLE(RVE_WRITE_COORDINATES_FREQ)
    KRATOS_REGISTER_VARIABLE(RVE_CONSOLIDATION_STOP_CRITERION)
    KRATOS_REGISTER_VARIABLE(LIMIT_CONSOLIDATION_TIME)
    KRATOS_REGISTER_VARIABLE(LIMIT_CONSOLIDATION_STRESS)
    KRATOS_REGISTER_VARIABLE(LIMIT_CONSOLIDATION_POROSITY)
    KRATOS_REGISTER_VARIABLE(INNER_CONSOLIDATION_POROSITY_OFFSET)
    KRATOS_REGISTER_VARIABLE(INNER_CONSOLIDATION_POROSITY)
    KRATOS_REGISTER_VARIABLE(POST_WRITE_COORDINATES_HISTORY)
    KRATOS_REGISTER_VARIABLE(POST_WRITE_COORDINATES_LAST)
    KRATOS_REGISTER_VARIABLE(POST_WRITE_POROSITY)
    KRATOS_REGISTER_VARIABLE(POST_WRITE_CONTACT_NUMBER)
    KRATOS_REGISTER_VARIABLE(POST_WRITE_COORD_NUMBER)
    KRATOS_REGISTER_VARIABLE(POST_WRITE_INNER_VOLUME_PARTICLES)
    KRATOS_REGISTER_VARIABLE(POST_WRITE_FORCE_CHAIN)
    KRATOS_REGISTER_VARIABLE(POST_WRITE_ELASTIC_CONTACT_FORCES)
    KRATOS_REGISTER_VARIABLE(POST_WRITE_ROSE_DIAGRAM)
    KRATOS_REGISTER_VARIABLE(POST_WRITE_ROSE_DIAGRAM_INNER)
    KRATOS_REGISTER_VARIABLE(POST_WRITE_ROSE_DIAGRAM_UNIFORMITY)
    KRATOS_REGISTER_VARIABLE(POST_WRITE_ANISOTROPY)
    KRATOS_REGISTER_VARIABLE(POST_WRITE_FABRIC_TENSOR)
    KRATOS_REGISTER_VARIABLE(POST_WRITE_FABRIC_TENSOR_INNER)
    KRATOS_REGISTER_VARIABLE(POST_WRITE_STRESS)
    KRATOS_REGISTER_VARIABLE(POST_WRITE_CAUCHY_TENSOR)
    KRATOS_REGISTER_VARIABLE(POST_WRITE_CAUCHY_TENSOR_INNER)
    KRATOS_REGISTER_VARIABLE(POST_WRITE_TANGENT_TENSOR)
    KRATOS_REGISTER_VARIABLE(POST_WRITE_TANGENT_TENSOR_INNER)
    KRATOS_REGISTER_VARIABLE(POST_WRITE_CONDUCTIVITY_TENSOR)
    KRATOS_REGISTER_VARIABLE(POST_WRITE_CONDUCTIVITY_TENSOR_INNER)
    KRATOS_REGISTER_VARIABLE(POST_WRITE_FKS)
