...
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(PARTICLE_ROTATION_ANGLE_OLD)
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(PARTICLE_INTERNAL_MOMENT)
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(PARTICLE_INTERNAL_MOMENT_OLD)
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(PARTICLE_EXTERNAL_MOMENT)
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(PARTICLE_EXTERNAL_MOMENT_OLD)
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(EXTERNAL_FORCE_OLD)
...
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(NODAL_MASS_ARRAY)
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(PARTICLE_MOMENT_OF_INERTIA_ARRAY)
...
void KratosDEMApplication::Register() {
    ...
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(PARTICLE_ROTATION_ANGLE_OLD)
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(PARTICLE_INTERNAL_MOMENT)
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(PARTICLE_INTERNAL_MOMENT_OLD)
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(PARTICLE_EXTERNAL_MOMENT)
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(PARTICLE_EXTERNAL_MOMENT_OLD)
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(EXTERNAL_FORCE_OLD)
    ...
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(PARTICLE_MOMENT_OF_INERTIA_ARRAY)
