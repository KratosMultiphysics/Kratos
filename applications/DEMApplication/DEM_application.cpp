...
KRATOS_CREATE_VARIABLE(double, LIMIT_CONSOLIDATION_VALUE)
...
KRATOS_CREATE_VARIABLE(bool,   RVE_POST_WRITE_RESULTS_GLOBAL)
KRATOS_CREATE_VARIABLE(bool,   RVE_POST_WRITE_RESULTS_PARTICLES)
KRATOS_CREATE_VARIABLE(bool,   RVE_POST_WRITE_RESULTS_CONTACTS)
KRATOS_CREATE_VARIABLE(bool,   RVE_POST_WRITE_RESULTS_TENSORS)
KRATOS_CREATE_VARIABLE(bool,   RVE_POST_WRITE_RESULTS_ROSE)
...
void KratosDEMApplication::Register() {
    ...
    KRATOS_REGISTER_VARIABLE(LIMIT_CONSOLIDATION_VALUE)
    KRATOS_REGISTER_VARIABLE(INNER_CONSOLIDATION_POROSITY_OFFSET)
    KRATOS_REGISTER_VARIABLE(INNER_CONSOLIDATION_POROSITY)
    KRATOS_REGISTER_VARIABLE(RVE_POST_WRITE_RESULTS_GLOBAL)
    KRATOS_REGISTER_VARIABLE(RVE_POST_WRITE_RESULTS_PARTICLES)
    KRATOS_REGISTER_VARIABLE(RVE_POST_WRITE_RESULTS_CONTACTS)
    KRATOS_REGISTER_VARIABLE(RVE_POST_WRITE_RESULTS_TENSORS)
    KRATOS_REGISTER_VARIABLE(RVE_POST_WRITE_RESULTS_ROSE)
