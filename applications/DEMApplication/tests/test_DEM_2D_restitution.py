...
class TestDEM2DRestitution(KratosUnittest.TestCase):
    ...
    def tearDown():
        ...
        files_to_delete_list.append(os.path.join("DEM2D_restitution_tests_files", "DEM2D_restitution.post.lst"))
        files_to_delete_list.append(os.path.join("DEM2D_restitution_tests_files", "flux_data_new.hdf5"))
        ...
        folders_to_delete_list.append(os.path.join("DEM2D_restitution_tests_files", "DEM2D_restitution_Graphs"))
        folders_to_delete_list.append(os.path.join("DEM2D_restitution_tests_files", "DEM2D_restitution_MPI_results"))
        folders_to_delete_list.append(os.path.join("DEM2D_restitution_tests_files", "DEM2D_restitution_Post_Files"))
        folders_to_delete_list.append(os.path.join("DEM2D_restitution_tests_files", "DEM2D_restitution_Results_and_Data"))
