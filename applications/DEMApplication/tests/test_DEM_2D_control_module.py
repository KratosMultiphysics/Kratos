...
class TestDEM2DControlModule(KratosUnittest.TestCase):
    ...
    def test_DEM2D_control_module(self):
        ...
        auxiliary_functions_for_tests.CreateAndRunStageInSelectedNumberOfOpenMPThreads(DEM2D_ControlModuleTestSolution, model, parameters_file_name, materials_file_name, 1)
