...
namespace Kratos {
                                                                 ...
                                                                 double& RollingResistance)
    {
        ...
        for (int i = 0; data_buffer.SetNextNeighbourOrExit(i); ++i) {
            ...
            const bool time_to_print = true;

            if (time_to_print /*r_process_info[IS_TIME_TO_PRINT]*/ && r_process_info[CONTACT_MESH_OPTION] == 1 && (i < (int)mContinuumInitialNeighborsSize) && this->Id() < neighbour_iterator_id) {
