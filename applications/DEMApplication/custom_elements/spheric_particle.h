...
virtual void CalculateOnContactElements(size_t i_neighbour_count, double LocalContactForce[3], double GlobalContactForce[3], double GlobalContactForceTangential[3]);
