                                                    ...
                                                    array_1d<double, 3>& r_contact_force)
{
    ...
    for (int i = 0; data_buffer.SetNextNeighbourOrExit(i); ++i){
        ...
        if (CalculateRelativePositionsOrSkipContact(data_buffer)) {
            ...
            StoreBallToBallContactInfo(r_process_info, data_buffer, GlobalContactForce, LocalContactForce, ViscoDampingLocalContactForce);
                                                        ...
                                                        const ProcessInfo& r_process_info)
{
    ...
    for (unsigned int i = 0; i < rNeighbours.size(); i++) {
        ...
        if (ContactType == 1 || ContactType == 2 || ContactType == 3) {
            ...
            // Store contact information needed for later processes
            StoreBallToRigidFaceContactInfo(r_process_info, data_buffer, GlobalContactForce, LocalContactForce, ViscoDampingLocalContactForce);
...
void SphericParticle::StoreBallToBallContactInfo(const ProcessInfo& r_process_info, SphericParticle::ParticleDataBuffer& data_buffer, double GlobalContactForceTotal[3], double LocalContactForceTotal[3], double LocalContactForceDamping[3]) {}

void SphericParticle::StoreBallToRigidFaceContactInfo(const ProcessInfo& r_process_info, SphericParticle::ParticleDataBuffer& data_buffer, double GlobalContactForceTotal[3], double LocalContactForceTotal[3], double LocalContactForceDamping[3]) {}
