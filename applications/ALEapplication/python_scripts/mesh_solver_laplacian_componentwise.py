...
class MeshSolver:
    ...
    def Initialize(self):
        ...
        self.solver = LaplacianComponentwiseMeshMovingStrategy(self.model_part, self.linear_solver, self.domain_size, self.time_order, self.reform_dof_at_every_step)
