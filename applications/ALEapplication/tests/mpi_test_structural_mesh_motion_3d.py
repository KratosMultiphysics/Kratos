...
class TestCase(KratosUnittest.TestCase):
    ...
    def test_Rectangle_3D8N(self):
        with ControlledExecutionScope(os.path.dirname(os.path.realpath(__file__))):
            ...
            self.removeFile("./test_structural_mesh_motion_3d/rectangle_3D8N_test_" + str(rank) + ".time")
            self.removeFile("./test_structural_mesh_motion_3d/rectangle_3D8N_test_" + str(rank) + ".mdpa")
