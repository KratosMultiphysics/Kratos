...
class DynamicStructuralSolver:
    ...
    def Initialize(self):
        ...
        self.solver = ResidualBasedUzawaNewtonRaphsonStrategyNewmark(self.model_part,self.time_scheme,self.structure_linear_solver,self.conv_criteria,30,True,True,True)
