...
class TrilinosMeshSolverComponentwise:
    ...
    def Initialize(self):
        self.solver = TrilinosLaplacianComponentwiseMeshMovingStrategy(self.Comm, self.model_part, self.linear_solver, self.domain_size, self.time_order, self.reform_dof_at_every_step)
