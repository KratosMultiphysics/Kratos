...
#if !defined(KRATOS_AMGCL_NS_MPI_SOLVER_H_INCLUDED )
#define  KRATOS_AMGCL_NS_MPI_SOLVER_H_INCLUDED
...
class AmgclMPI_NS_Solver : public LinearSolver< TSparseSpaceType,
    TDenseSpaceType, TReordererType>
{
public:
    /**
     * Counted pointer of AmgclMPI_NS_Solver
     */
    KRATOS_CLASS_POINTER_DEFINITION ( AmgclMPI_NS_Solver );
...
KRATOS_WATCH(__LINE__)
        ...
        for (ModelPart::DofsArrayType::iterator it = rdof_set.begin(); it!=rdof_set.end(); it++)
        {
            ...
            {
                mp[counter]  = (it->GetVariable().Key() == PRESSURE);
                counter++;
            }
        }
KRATOS_WATCH(__LINE__)
...
private:
    ...
    std::vector< char > mp; //pressure mask
     ...
     * Assignment operator.
     */
    AmgclMPI_NS_Solver& operator= ( const AmgclMPI_NS_Solver& Other );

    /**
     * Copy constructor.
     */
    AmgclMPI_NS_Solver ( const AmgclMPI_NS_Solver& Other );
...
inline std::istream& operator >> ( std::istream& rIStream, AmgclMPI_NS_Solver< TSparseSpaceType,
...
inline std::ostream& operator << ( std::ostream& rOStream,
                                   const AmgclMPI_NS_Solver<TSparseSpaceType,
                                   TDenseSpaceType, TReordererType>& rThis )
{
...
#endif // KRATOS_AMGCL_NS_MPI_SOLVER_H_INCLUDED  defined 
