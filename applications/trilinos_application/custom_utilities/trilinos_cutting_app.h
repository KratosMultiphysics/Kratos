...
public:
    ...
    void AddSkinConditions(ModelPart& mr_model_part, ModelPart& mr_new_model_part, int plane_number )
    {
	  ...
	  std::cout <<"Adding Skin Conditions to the new model part, added in layer:"<<std::endl;
        ...
        Kratos::shared_ptr<Epetra_FEVector > aux_non_overlapping_graph(new Epetra_FEVector(*pmy_map,1,false)); //, guess_row_size
...
//         NodesArrayType::iterator it_begin_node_new = rNodes_new.ptr_begin();
        ...
        Kratos::shared_ptr<Epetra_FEVector > IDs_non_overlapping_graph(new Epetra_FEVector(*pmy_map,1,false)); //name self explaining
        ...
        Kratos::shared_ptr<Epetra_FEVector > IDs_overlap(new Epetra_FEVector(*pmy_ov_map,1,false));
        ...
        Kratos::shared_ptr<Epetra_FEVector > Partition_overlap(new Epetra_FEVector(*pmy_ov_map,1,false));
        ...
        Kratos::shared_ptr<Epetra_FECrsMatrix>& used_nodes_matrix)
    {
        ...
        Kratos::shared_ptr<Epetra_FECrsMatrix> pB = Kratos::shared_ptr<Epetra_FECrsMatrix > (new Epetra_FECrsMatrix(Copy, *mp_overlapping_map, guess_row_size));
        pB->PutScalar(0.0);
    ...
    void FirstLoop(ModelPart& this_model_part, Kratos::shared_ptr<Epetra_FECrsMatrix>& p_edge_ids,
                   Kratos::shared_ptr<Epetra_FECrsMatrix>& p_partition_ids, array_1d<double, 3 > versor,
