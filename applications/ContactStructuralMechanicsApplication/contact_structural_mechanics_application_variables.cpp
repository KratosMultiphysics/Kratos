...
/* The complementary values */ // NOTE: This will be eventually not necessary 
...
KRATOS_CREATE_VARIABLE( double, REFERENCE_NORM )                                  // This value will be used to compute a consistent scale factor
