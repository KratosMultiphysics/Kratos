...
// KRATOS_CREATE_VARIABLE( Variable<double>, SCALAR_VARIABLE )                       // The scale factor for the mesh tying 
// KRATOS_CREATE_VARIABLE( Variable<Vector3>, COMPONENTS_VARIABLE )                  // The vector factor for the mesh tying
}
