...
void  AddCustomUtilitiesToPython()
{
    ...
    .def("HardClearScalarMortarConditions",&TreeContactSearch::HardClearScalarMortarConditions)
    .def("HardClearComponentsMortarConditions",&TreeContactSearch::HardClearComponentsMortarConditions)
    .def("HardClearALMFrictionlessMortarConditions",&TreeContactSearch::HardClearALMFrictionlessMortarConditions)
