...
//         ThisColocationIntegration.Initialize(mIntegrationOrder);
//         const GeometryType::IntegrationPointsArrayType& ThisIntegrationPoints = ThisColocationIntegration.IntegrationPoints( ); 
//             
//         // Calculating the proportion between the integrated area and segment area
//         for ( unsigned int PointNumber = 0; PointNumber < ThisIntegrationPoints.size(); PointNumber++ )
//         {    
//             Vector N_Slave;
//             GetGeometry().ShapeFunctionsValues( N_Slave, ThisIntegrationPoints[PointNumber].Coordinates());
//             
//             GeometryType& master_seg = pCond->GetGeometry( );
// 
//             PointType projected_gp_global;
//         //     const array_1d<double,3> normal = this->GetValue(NORMAL);
//             const array_1d<double,3> normal = ContactUtilities::GaussPointNormal(N_Slave, GetGeometry());
//             
//             GeometryType::CoordinatesArrayType slave_gp_global;
//             double aux_dist = 0.0;
//             this->GetGeometry( ).GlobalCoordinates( slave_gp_global, ThisIntegrationPoints[PointNumber].Coordinates() );
...
//             if (inside == true)
//             {   
//                 const double xi = ThisIntegrationPoints[PointNumber].Coordinate(1);
//                 const double eta = ThisIntegrationPoints[PointNumber].Coordinate(2);
//                 const double IntegrationWeight = ThisIntegrationPoints[PointNumber].Weight();
//                 IntegrationPointsSlave.push_back(IntegrationPoint<2>( xi, eta, IntegrationWeight));
//             }
//         }
//         
//         const bool IsInside = (IntegrationPointsSlave.size() > 0) ? true: false;
...
//     const VectorType Phi = rVariables.Phi_LagrangeMultipliers;
    const VectorType Phi = rVariables.N_Slave; // TODO: Restore this later
    ...
    )
{
    ...
    const double clhs0 =     -DOperator(0,0);
    const double clhs1 =     -DOperator(1,0);
    const double clhs2 =     -DOperator(0,1);
    const double clhs3 =     -DOperator(1,1);

    lhs(0,0)=0;
    lhs(0,1)=0;
    lhs(0,2)=0;
    lhs(0,3)=0;
    lhs(0,4)=MOperator(0,0);
    lhs(0,5)=MOperator(1,0);
    lhs(1,0)=0;
    lhs(1,1)=0;
    lhs(1,2)=0;
    lhs(1,3)=0;
    lhs(1,4)=MOperator(0,1);
    lhs(1,5)=MOperator(1,1);
    lhs(2,0)=0;
    lhs(2,1)=0;
    lhs(2,2)=0;
    lhs(2,3)=0;
    ...
    lhs(3,4)=clhs2;
    lhs(3,5)=clhs3;
    lhs(4,0)=MOperator(0,0);
    lhs(4,1)=MOperator(0,1);
    lhs(4,2)=clhs0;
    lhs(4,3)=clhs2;
    lhs(4,4)=0;
    lhs(4,5)=0;
    lhs(5,0)=MOperator(1,0);
    lhs(5,1)=MOperator(1,1);
    lhs(5,2)=clhs1;
    lhs(5,3)=clhs3;
    lhs(5,4)=0;
    lhs(5,5)=0;
    ...
    )
{
    ...
    lhs(0,6)=0;
    lhs(0,7)=0;
    lhs(0,8)=MOperator(0,0);
    lhs(0,9)=0;
    lhs(0,10)=MOperator(1,0);
    lhs(0,11)=0;
    lhs(1,0)=0;
    lhs(1,1)=0;
    lhs(1,2)=0;
    ...
    lhs(1,7)=0;
    lhs(1,8)=0;
    lhs(1,9)=MOperator(0,0);
    lhs(1,10)=0;
    lhs(1,11)=MOperator(1,0);
    lhs(2,0)=0;
    lhs(2,1)=0;
    lhs(2,2)=0;
    lhs(2,3)=0;
    ...
    lhs(2,6)=0;
    lhs(2,7)=0;
    lhs(2,8)=MOperator(0,1);
    lhs(2,9)=0;
    lhs(2,10)=MOperator(1,1);
    lhs(2,11)=0;
    lhs(3,0)=0;
    lhs(3,1)=0;
    lhs(3,2)=0;
    ...
    lhs(3,7)=0;
    lhs(3,8)=0;
    lhs(3,9)=MOperator(0,1);
    lhs(3,10)=0;
    lhs(3,11)=MOperator(1,1);
    lhs(4,0)=0;
    lhs(4,1)=0;
    lhs(4,2)=0;
    lhs(4,3)=0;
    ...
    lhs(7,10)=0;
    lhs(7,11)=clhs3;
    lhs(8,0)=MOperator(0,0);
    lhs(8,1)=0;
    lhs(8,2)=MOperator(0,1);
    lhs(8,3)=0;
    lhs(8,4)=clhs0;
    lhs(8,5)=0;
    lhs(8,6)=clhs2;
    ...
    lhs(8,11)=0;
    lhs(9,0)=0;
    lhs(9,1)=MOperator(0,0);
    lhs(9,2)=0;
    lhs(9,3)=MOperator(0,1);
    lhs(9,4)=0;
    lhs(9,5)=clhs0;
    lhs(9,6)=0;
    lhs(9,7)=clhs2;
    ...
    lhs(9,10)=0;
    lhs(9,11)=0;
    lhs(10,0)=MOperator(1,0);
    lhs(10,1)=0;
    lhs(10,2)=MOperator(1,1);
    lhs(10,3)=0;
    lhs(10,4)=clhs1;
    lhs(10,5)=0;
    lhs(10,6)=clhs3;
    ...
    lhs(10,11)=0;
    lhs(11,0)=0;
    lhs(11,1)=MOperator(1,0);
    lhs(11,2)=0;
    lhs(11,3)=MOperator(1,1);
    lhs(11,4)=0;
    lhs(11,5)=clhs1;
    lhs(11,6)=0;
    lhs(11,7)=clhs3;
    ...
    )
{
    ...
    const double clhs0 =     -DOperator(0,0);
    const double clhs1 =     -DOperator(1,0);
    const double clhs2 =     -DOperator(2,0);
    const double clhs3 =     -DOperator(0,1);
    const double clhs4 =     -DOperator(1,1);
    const double clhs5 =     -DOperator(2,1);
    const double clhs6 =     -DOperator(0,2);
    const double clhs7 =     -DOperator(1,2);
    const double clhs8 =     -DOperator(2,2);
    ...
    lhs(0,4)=0;
    lhs(0,5)=0;
    lhs(0,6)=MOperator(0,0);
    lhs(0,7)=MOperator(1,0);
    lhs(0,8)=MOperator(2,0);
    lhs(1,0)=0;
    lhs(1,1)=0;
    lhs(1,2)=0;
    lhs(1,3)=0;
    lhs(1,4)=0;
    lhs(1,5)=0;
    lhs(1,6)=MOperator(0,1);
    lhs(1,7)=MOperator(1,1);
    lhs(1,8)=MOperator(2,1);
    lhs(2,0)=0;
    lhs(2,1)=0;
    lhs(2,2)=0;
    lhs(2,3)=0;
    lhs(2,4)=0;
    lhs(2,5)=0;
    lhs(2,6)=MOperator(0,2);
    lhs(2,7)=MOperator(1,2);
    lhs(2,8)=MOperator(2,2);
    lhs(3,0)=0;
    lhs(3,1)=0;
    lhs(3,2)=0;
    lhs(3,3)=0;
    ...
    lhs(5,7)=clhs7;
    lhs(5,8)=clhs8;
    lhs(6,0)=MOperator(0,0);
    lhs(6,1)=MOperator(0,1);
    lhs(6,2)=MOperator(0,2);
    lhs(6,3)=clhs0;
    lhs(6,4)=clhs3;
    lhs(6,5)=clhs6;
    lhs(6,6)=0;
    lhs(6,7)=0;
    lhs(6,8)=0;
    lhs(7,0)=MOperator(1,0);
    lhs(7,1)=MOperator(1,1);
    lhs(7,2)=MOperator(1,2);
    lhs(7,3)=clhs1;
    lhs(7,4)=clhs4;
    lhs(7,5)=clhs7;
    lhs(7,6)=0;
    lhs(7,7)=0;
    lhs(7,8)=0;
    lhs(8,0)=MOperator(2,0);
    lhs(8,1)=MOperator(2,1);
    lhs(8,2)=MOperator(2,2);
    lhs(8,3)=clhs2;
    lhs(8,4)=clhs5;
    lhs(8,5)=clhs8;
    lhs(8,6)=0;
    ...
    )
{
    ...
    lhs(0,16)=0;
    lhs(0,17)=0;
    lhs(0,18)=MOperator(0,0);
    lhs(0,19)=0;
    lhs(0,20)=0;
    lhs(0,21)=MOperator(1,0);
    lhs(0,22)=0;
    lhs(0,23)=0;
    lhs(0,24)=MOperator(2,0);
    lhs(0,25)=0;
    lhs(0,26)=0;
    lhs(1,0)=0;
    lhs(1,1)=0;
    ...
    lhs(1,17)=0;
    lhs(1,18)=0;
    lhs(1,19)=MOperator(0,0);
    lhs(1,20)=0;
    lhs(1,21)=0;
    lhs(1,22)=MOperator(1,0);
    lhs(1,23)=0;
    lhs(1,24)=0;
    lhs(1,25)=MOperator(2,0);
    lhs(1,26)=0;
    lhs(2,0)=0;
    lhs(2,1)=0;
    lhs(2,2)=0;
    ...
    lhs(2,18)=0;
    lhs(2,19)=0;
    lhs(2,20)=MOperator(0,0);
    lhs(2,21)=0;
    lhs(2,22)=0;
    lhs(2,23)=MOperator(1,0);
    lhs(2,24)=0;
    lhs(2,25)=0;
    lhs(2,26)=MOperator(2,0);
    lhs(3,0)=0;
    lhs(3,1)=0;
    lhs(3,2)=0;
    lhs(3,3)=0;
    ...
    lhs(3,16)=0;
    lhs(3,17)=0;
    lhs(3,18)=MOperator(0,1);
    lhs(3,19)=0;
    lhs(3,20)=0;
    lhs(3,21)=MOperator(1,1);
    lhs(3,22)=0;
    lhs(3,23)=0;
    lhs(3,24)=MOperator(2,1);
    lhs(3,25)=0;
    lhs(3,26)=0;
    lhs(4,0)=0;
    lhs(4,1)=0;
    ...
    lhs(4,17)=0;
    lhs(4,18)=0;
    lhs(4,19)=MOperator(0,1);
    lhs(4,20)=0;
    lhs(4,21)=0;
    lhs(4,22)=MOperator(1,1);
    lhs(4,23)=0;
    lhs(4,24)=0;
    lhs(4,25)=MOperator(2,1);
    lhs(4,26)=0;
    lhs(5,0)=0;
    lhs(5,1)=0;
    lhs(5,2)=0;
    ...
    lhs(5,18)=0;
    lhs(5,19)=0;
    lhs(5,20)=MOperator(0,1);
    lhs(5,21)=0;
    lhs(5,22)=0;
    lhs(5,23)=MOperator(1,1);
    lhs(5,24)=0;
    lhs(5,25)=0;
    lhs(5,26)=MOperator(2,1);
    lhs(6,0)=0;
    lhs(6,1)=0;
    lhs(6,2)=0;
    lhs(6,3)=0;
    ...
    lhs(6,16)=0;
    lhs(6,17)=0;
    lhs(6,18)=MOperator(0,2);
    lhs(6,19)=0;
    lhs(6,20)=0;
    lhs(6,21)=MOperator(1,2);
    lhs(6,22)=0;
    lhs(6,23)=0;
    lhs(6,24)=MOperator(2,2);
    lhs(6,25)=0;
    lhs(6,26)=0;
    lhs(7,0)=0;
    lhs(7,1)=0;
    ...
    lhs(7,17)=0;
    lhs(7,18)=0;
    lhs(7,19)=MOperator(0,2);
    lhs(7,20)=0;
    lhs(7,21)=0;
    lhs(7,22)=MOperator(1,2);
    lhs(7,23)=0;
    lhs(7,24)=0;
    lhs(7,25)=MOperator(2,2);
    lhs(7,26)=0;
    lhs(8,0)=0;
    lhs(8,1)=0;
    lhs(8,2)=0;
    ...
    lhs(8,18)=0;
    lhs(8,19)=0;
    lhs(8,20)=MOperator(0,2);
    lhs(8,21)=0;
    lhs(8,22)=0;
    lhs(8,23)=MOperator(1,2);
    lhs(8,24)=0;
    lhs(8,25)=0;
    lhs(8,26)=MOperator(2,2);
    lhs(9,0)=0;
    lhs(9,1)=0;
    lhs(9,2)=0;
    lhs(9,3)=0;
    ...
    lhs(17,25)=0;
    lhs(17,26)=clhs8;
    lhs(18,0)=MOperator(0,0);
    lhs(18,1)=0;
    lhs(18,2)=0;
    lhs(18,3)=MOperator(0,1);
    lhs(18,4)=0;
    lhs(18,5)=0;
    lhs(18,6)=MOperator(0,2);
    lhs(18,7)=0;
    lhs(18,8)=0;
    lhs(18,9)=clhs0;
    lhs(18,10)=0;
    ...
    lhs(18,26)=0;
    lhs(19,0)=0;
    lhs(19,1)=MOperator(0,0);
    lhs(19,2)=0;
    lhs(19,3)=0;
    lhs(19,4)=MOperator(0,1);
    lhs(19,5)=0;
    lhs(19,6)=0;
    lhs(19,7)=MOperator(0,2);
    lhs(19,8)=0;
    lhs(19,9)=0;
    lhs(19,10)=clhs0;
    lhs(19,11)=0;
    ...
    lhs(20,0)=0;
    lhs(20,1)=0;
    lhs(20,2)=MOperator(0,0);
    lhs(20,3)=0;
    lhs(20,4)=0;
    lhs(20,5)=MOperator(0,1);
    lhs(20,6)=0;
    lhs(20,7)=0;
    lhs(20,8)=MOperator(0,2);
    lhs(20,9)=0;
    lhs(20,10)=0;
    lhs(20,11)=clhs0;
    lhs(20,12)=0;
    ...
    lhs(20,25)=0;
    lhs(20,26)=0;
    lhs(21,0)=MOperator(1,0);
    lhs(21,1)=0;
    lhs(21,2)=0;
    lhs(21,3)=MOperator(1,1);
    lhs(21,4)=0;
    lhs(21,5)=0;
    lhs(21,6)=MOperator(1,2);
    lhs(21,7)=0;
    lhs(21,8)=0;
    lhs(21,9)=clhs1;
    lhs(21,10)=0;
    ...
    lhs(21,26)=0;
    lhs(22,0)=0;
    lhs(22,1)=MOperator(1,0);
    lhs(22,2)=0;
    lhs(22,3)=0;
    lhs(22,4)=MOperator(1,1);
    lhs(22,5)=0;
    lhs(22,6)=0;
    lhs(22,7)=MOperator(1,2);
    lhs(22,8)=0;
    lhs(22,9)=0;
    lhs(22,10)=clhs1;
    lhs(22,11)=0;
    ...
    lhs(23,0)=0;
    lhs(23,1)=0;
    lhs(23,2)=MOperator(1,0);
    lhs(23,3)=0;
    lhs(23,4)=0;
    lhs(23,5)=MOperator(1,1);
    lhs(23,6)=0;
    lhs(23,7)=0;
    lhs(23,8)=MOperator(1,2);
    lhs(23,9)=0;
    lhs(23,10)=0;
    lhs(23,11)=clhs1;
    lhs(23,12)=0;
    ...
    lhs(23,25)=0;
    lhs(23,26)=0;
    lhs(24,0)=MOperator(2,0);
    lhs(24,1)=0;
    lhs(24,2)=0;
    lhs(24,3)=MOperator(2,1);
    lhs(24,4)=0;
    lhs(24,5)=0;
    lhs(24,6)=MOperator(2,2);
    lhs(24,7)=0;
    lhs(24,8)=0;
    lhs(24,9)=clhs2;
    lhs(24,10)=0;
    ...
    lhs(24,26)=0;
    lhs(25,0)=0;
    lhs(25,1)=MOperator(2,0);
    lhs(25,2)=0;
    lhs(25,3)=0;
    lhs(25,4)=MOperator(2,1);
    lhs(25,5)=0;
    lhs(25,6)=0;
    lhs(25,7)=MOperator(2,2);
    lhs(25,8)=0;
    lhs(25,9)=0;
    lhs(25,10)=clhs2;
    lhs(25,11)=0;
    ...
    lhs(26,0)=0;
    lhs(26,1)=0;
    lhs(26,2)=MOperator(2,0);
    lhs(26,3)=0;
    lhs(26,4)=0;
    lhs(26,5)=MOperator(2,1);
    lhs(26,6)=0;
    lhs(26,7)=0;
    lhs(26,8)=MOperator(2,2);
    lhs(26,9)=0;
    lhs(26,10)=0;
    lhs(26,11)=clhs2;
    lhs(26,12)=0;
...
template< >
template< >
boost::numeric::ublas::bounded_matrix<double, 12, 12> MeshTyingMortarCondition<3,6,ScalarValue>::CalculateLocalLHS<12>(
    const MortarConditionMatrices& rMortarConditionMatrices,
    DofData& rDofData,
    const unsigned int& rMasterElementIndex,
    const ProcessInfo& rCurrentProcessInfo
    )
{
    ...
    const double clhs1 =     -DOperator(1,0);
    const double clhs2 =     -DOperator(2,0);
    const double clhs3 =     -DOperator(3,0);
    const double clhs4 =     -DOperator(0,1);
    const double clhs5 =     -DOperator(1,1);
    const double clhs6 =     -DOperator(2,1);
    const double clhs7 =     -DOperator(3,1);
    const double clhs8 =     -DOperator(0,2);
    const double clhs9 =     -DOperator(1,2);
    const double clhs10 =     -DOperator(2,2);
    const double clhs11 =     -DOperator(3,2);
    const double clhs12 =     -DOperator(0,3);
    const double clhs13 =     -DOperator(1,3);
    const double clhs14 =     -DOperator(2,3);
    const double clhs15 =     -DOperator(3,3);
    ...
    lhs(0,7)=0;
    lhs(0,8)=MOperator(0,0);
    lhs(0,9)=MOperator(1,0);
    lhs(0,10)=MOperator(2,0);
    lhs(0,11)=MOperator(3,0);
    lhs(1,0)=0;
    lhs(1,1)=0;
    lhs(1,2)=0;
    lhs(1,3)=0;
    ...
    lhs(1,6)=0;
    lhs(1,7)=0;
    lhs(1,8)=MOperator(0,1);
    lhs(1,9)=MOperator(1,1);
    lhs(1,10)=MOperator(2,1);
    lhs(1,11)=MOperator(3,1);
    lhs(2,0)=0;
    lhs(2,1)=0;
    lhs(2,2)=0;
    lhs(2,3)=0;
    ...
    lhs(2,6)=0;
    lhs(2,7)=0;
    lhs(2,8)=MOperator(0,2);
    lhs(2,9)=MOperator(1,2);
    lhs(2,10)=MOperator(2,2);
    lhs(2,11)=MOperator(3,2);
    lhs(3,0)=0;
    lhs(3,1)=0;
    lhs(3,2)=0;
    lhs(3,3)=0;
    ...
    lhs(3,6)=0;
    lhs(3,7)=0;
    lhs(3,8)=MOperator(0,3);
    lhs(3,9)=MOperator(1,3);
    lhs(3,10)=MOperator(2,3);
    lhs(3,11)=MOperator(3,3);
    lhs(4,0)=0;
    lhs(4,1)=0;
    lhs(4,2)=0;
    lhs(4,3)=0;
    ...
    lhs(7,11)=clhs15;
    lhs(8,0)=MOperator(0,0);
    lhs(8,1)=MOperator(0,1);
    lhs(8,2)=MOperator(0,2);
    lhs(8,3)=MOperator(0,3);
    lhs(8,4)=clhs0;
    lhs(8,5)=clhs4;
    lhs(8,6)=clhs8;
    lhs(8,7)=clhs12;
    ...
    lhs(8,10)=0;
    lhs(8,11)=0;
    lhs(9,0)=MOperator(1,0);
    lhs(9,1)=MOperator(1,1);
    lhs(9,2)=MOperator(1,2);
    lhs(9,3)=MOperator(1,3);
    lhs(9,4)=clhs1;
    lhs(9,5)=clhs5;
    lhs(9,6)=clhs9;
    lhs(9,7)=clhs13;
    ...
    lhs(9,10)=0;
    lhs(9,11)=0;
    lhs(10,0)=MOperator(2,0);
    lhs(10,1)=MOperator(2,1);
    lhs(10,2)=MOperator(2,2);
    lhs(10,3)=MOperator(2,3);
    lhs(10,4)=clhs2;
    lhs(10,5)=clhs6;
    lhs(10,6)=clhs10;
    lhs(10,7)=clhs14;
    ...
    lhs(10,10)=0;
    lhs(10,11)=0;
    lhs(11,0)=MOperator(3,0);
    lhs(11,1)=MOperator(3,1);
    lhs(11,2)=MOperator(3,2);
    lhs(11,3)=MOperator(3,3);
    lhs(11,4)=clhs3;
    lhs(11,5)=clhs7;
    lhs(11,6)=clhs11;
    lhs(11,7)=clhs15;
...
template< >
template< >
boost::numeric::ublas::bounded_matrix<double, 36, 36> MeshTyingMortarCondition<3,6,Vector3DValue>::CalculateLocalLHS<36>(
    const MortarConditionMatrices& rMortarConditionMatrices,
    DofData& rDofData,
    const unsigned int& rMasterElementIndex,
    const ProcessInfo& rCurrentProcessInfo
    )
{
    ...
    lhs(0,22)=0;
    lhs(0,23)=0;
    lhs(0,24)=MOperator(0,0);
    lhs(0,25)=0;
    lhs(0,26)=0;
    lhs(0,27)=MOperator(1,0);
    lhs(0,28)=0;
    lhs(0,29)=0;
    lhs(0,30)=MOperator(2,0);
    lhs(0,31)=0;
    lhs(0,32)=0;
    lhs(0,33)=MOperator(3,0);
    lhs(0,34)=0;
    lhs(0,35)=0;
    lhs(1,0)=0;
    lhs(1,1)=0;
    ...
    lhs(1,23)=0;
    lhs(1,24)=0;
    lhs(1,25)=MOperator(0,0);
    lhs(1,26)=0;
    lhs(1,27)=0;
    lhs(1,28)=MOperator(1,0);
    lhs(1,29)=0;
    lhs(1,30)=0;
    lhs(1,31)=MOperator(2,0);
    lhs(1,32)=0;
    lhs(1,33)=0;
    lhs(1,34)=MOperator(3,0);
    lhs(1,35)=0;
    lhs(2,0)=0;
    lhs(2,1)=0;
    lhs(2,2)=0;
    ...
    lhs(2,24)=0;
    lhs(2,25)=0;
    lhs(2,26)=MOperator(0,0);
    lhs(2,27)=0;
    lhs(2,28)=0;
    lhs(2,29)=MOperator(1,0);
    lhs(2,30)=0;
    lhs(2,31)=0;
    lhs(2,32)=MOperator(2,0);
    lhs(2,33)=0;
    lhs(2,34)=0;
    lhs(2,35)=MOperator(3,0);
    lhs(3,0)=0;
    lhs(3,1)=0;
    lhs(3,2)=0;
    lhs(3,3)=0;
    ...
    lhs(3,22)=0;
    lhs(3,23)=0;
    lhs(3,24)=MOperator(0,1);
    lhs(3,25)=0;
    lhs(3,26)=0;
    lhs(3,27)=MOperator(1,1);
    lhs(3,28)=0;
    lhs(3,29)=0;
    lhs(3,30)=MOperator(2,1);
    lhs(3,31)=0;
    lhs(3,32)=0;
    lhs(3,33)=MOperator(3,1);
    lhs(3,34)=0;
    lhs(3,35)=0;
    lhs(4,0)=0;
    lhs(4,1)=0;
    ...
    lhs(4,23)=0;
    lhs(4,24)=0;
    lhs(4,25)=MOperator(0,1);
    lhs(4,26)=0;
    lhs(4,27)=0;
    lhs(4,28)=MOperator(1,1);
    lhs(4,29)=0;
    lhs(4,30)=0;
    lhs(4,31)=MOperator(2,1);
    lhs(4,32)=0;
    lhs(4,33)=0;
    lhs(4,34)=MOperator(3,1);
    lhs(4,35)=0;
    lhs(5,0)=0;
    lhs(5,1)=0;
    lhs(5,2)=0;
    ...
    lhs(5,24)=0;
    lhs(5,25)=0;
    lhs(5,26)=MOperator(0,1);
    lhs(5,27)=0;
    lhs(5,28)=0;
    lhs(5,29)=MOperator(1,1);
    lhs(5,30)=0;
    lhs(5,31)=0;
    lhs(5,32)=MOperator(2,1);
    lhs(5,33)=0;
    lhs(5,34)=0;
    lhs(5,35)=MOperator(3,1);
    lhs(6,0)=0;
    lhs(6,1)=0;
    lhs(6,2)=0;
    lhs(6,3)=0;
    ...
    lhs(6,22)=0;
    lhs(6,23)=0;
    lhs(6,24)=MOperator(0,2);
    lhs(6,25)=0;
    lhs(6,26)=0;
    lhs(6,27)=MOperator(1,2);
    lhs(6,28)=0;
    lhs(6,29)=0;
    lhs(6,30)=MOperator(2,2);
    lhs(6,31)=0;
    lhs(6,32)=0;
    lhs(6,33)=MOperator(3,2);
    lhs(6,34)=0;
    lhs(6,35)=0;
    lhs(7,0)=0;
    lhs(7,1)=0;
    ...
    lhs(7,23)=0;
    lhs(7,24)=0;
    lhs(7,25)=MOperator(0,2);
    lhs(7,26)=0;
    lhs(7,27)=0;
    lhs(7,28)=MOperator(1,2);
    lhs(7,29)=0;
    lhs(7,30)=0;
    lhs(7,31)=MOperator(2,2);
    lhs(7,32)=0;
    lhs(7,33)=0;
    lhs(7,34)=MOperator(3,2);
    lhs(7,35)=0;
    lhs(8,0)=0;
    lhs(8,1)=0;
    lhs(8,2)=0;
    ...
    lhs(8,24)=0;
    lhs(8,25)=0;
    lhs(8,26)=MOperator(0,2);
    lhs(8,27)=0;
    lhs(8,28)=0;
    lhs(8,29)=MOperator(1,2);
    lhs(8,30)=0;
    lhs(8,31)=0;
    lhs(8,32)=MOperator(2,2);
    lhs(8,33)=0;
    lhs(8,34)=0;
    lhs(8,35)=MOperator(3,2);
    lhs(9,0)=0;
    lhs(9,1)=0;
    lhs(9,2)=0;
    lhs(9,3)=0;
    ...
    lhs(9,22)=0;
    lhs(9,23)=0;
    lhs(9,24)=MOperator(0,3);
    lhs(9,25)=0;
    lhs(9,26)=0;
    lhs(9,27)=MOperator(1,3);
    lhs(9,28)=0;
    lhs(9,29)=0;
    lhs(9,30)=MOperator(2,3);
    lhs(9,31)=0;
    lhs(9,32)=0;
    lhs(9,33)=MOperator(3,3);
    lhs(9,34)=0;
    lhs(9,35)=0;
    lhs(10,0)=0;
    lhs(10,1)=0;
    ...
    lhs(10,23)=0;
    lhs(10,24)=0;
    lhs(10,25)=MOperator(0,3);
    lhs(10,26)=0;
    lhs(10,27)=0;
    lhs(10,28)=MOperator(1,3);
    lhs(10,29)=0;
    lhs(10,30)=0;
    lhs(10,31)=MOperator(2,3);
    lhs(10,32)=0;
    lhs(10,33)=0;
    lhs(10,34)=MOperator(3,3);
    lhs(10,35)=0;
    lhs(11,0)=0;
    lhs(11,1)=0;
    lhs(11,2)=0;
    ...
    lhs(11,24)=0;
    lhs(11,25)=0;
    lhs(11,26)=MOperator(0,3);
    lhs(11,27)=0;
    lhs(11,28)=0;
    lhs(11,29)=MOperator(1,3);
    lhs(11,30)=0;
    lhs(11,31)=0;
    lhs(11,32)=MOperator(2,3);
    lhs(11,33)=0;
    lhs(11,34)=0;
    lhs(11,35)=MOperator(3,3);
    lhs(12,0)=0;
    lhs(12,1)=0;
    lhs(12,2)=0;
    lhs(12,3)=0;
    ...
    lhs(23,34)=0;
    lhs(23,35)=clhs15;
    lhs(24,0)=MOperator(0,0);
    lhs(24,1)=0;
    lhs(24,2)=0;
    lhs(24,3)=MOperator(0,1);
    lhs(24,4)=0;
    lhs(24,5)=0;
    lhs(24,6)=MOperator(0,2);
    lhs(24,7)=0;
    lhs(24,8)=0;
    lhs(24,9)=MOperator(0,3);
    lhs(24,10)=0;
    lhs(24,11)=0;
    lhs(24,12)=clhs0;
    lhs(24,13)=0;
    ...
    lhs(24,35)=0;
    lhs(25,0)=0;
    lhs(25,1)=MOperator(0,0);
    lhs(25,2)=0;
    lhs(25,3)=0;
    lhs(25,4)=MOperator(0,1);
    lhs(25,5)=0;
    lhs(25,6)=0;
    lhs(25,7)=MOperator(0,2);
    lhs(25,8)=0;
    lhs(25,9)=0;
    lhs(25,10)=MOperator(0,3);
    lhs(25,11)=0;
    lhs(25,12)=0;
    lhs(25,13)=clhs0;
    lhs(25,14)=0;
    ...
    lhs(26,0)=0;
    lhs(26,1)=0;
    lhs(26,2)=MOperator(0,0);
    lhs(26,3)=0;
    lhs(26,4)=0;
    lhs(26,5)=MOperator(0,1);
    lhs(26,6)=0;
    lhs(26,7)=0;
    lhs(26,8)=MOperator(0,2);
    lhs(26,9)=0;
    lhs(26,10)=0;
    lhs(26,11)=MOperator(0,3);
    lhs(26,12)=0;
    lhs(26,13)=0;
    lhs(26,14)=clhs0;
    lhs(26,15)=0;
    ...
    lhs(26,34)=0;
    lhs(26,35)=0;
    lhs(27,0)=MOperator(1,0);
    lhs(27,1)=0;
    lhs(27,2)=0;
    lhs(27,3)=MOperator(1,1);
    lhs(27,4)=0;
    lhs(27,5)=0;
    lhs(27,6)=MOperator(1,2);
    lhs(27,7)=0;
    lhs(27,8)=0;
    lhs(27,9)=MOperator(1,3);
    lhs(27,10)=0;
    lhs(27,11)=0;
    lhs(27,12)=clhs1;
    lhs(27,13)=0;
    ...
    lhs(27,35)=0;
    lhs(28,0)=0;
    lhs(28,1)=MOperator(1,0);
    lhs(28,2)=0;
    lhs(28,3)=0;
    lhs(28,4)=MOperator(1,1);
    lhs(28,5)=0;
    lhs(28,6)=0;
    lhs(28,7)=MOperator(1,2);
    lhs(28,8)=0;
    lhs(28,9)=0;
    lhs(28,10)=MOperator(1,3);
    lhs(28,11)=0;
    lhs(28,12)=0;
    lhs(28,13)=clhs1;
    lhs(28,14)=0;
    ...
    lhs(29,0)=0;
    lhs(29,1)=0;
    lhs(29,2)=MOperator(1,0);
    lhs(29,3)=0;
    lhs(29,4)=0;
    lhs(29,5)=MOperator(1,1);
    lhs(29,6)=0;
    lhs(29,7)=0;
    lhs(29,8)=MOperator(1,2);
    lhs(29,9)=0;
    lhs(29,10)=0;
    lhs(29,11)=MOperator(1,3);
    lhs(29,12)=0;
    lhs(29,13)=0;
    lhs(29,14)=clhs1;
    lhs(29,15)=0;
    ...
    lhs(29,34)=0;
    lhs(29,35)=0;
    lhs(30,0)=MOperator(2,0);
    lhs(30,1)=0;
    lhs(30,2)=0;
    lhs(30,3)=MOperator(2,1);
    lhs(30,4)=0;
    lhs(30,5)=0;
    lhs(30,6)=MOperator(2,2);
    lhs(30,7)=0;
    lhs(30,8)=0;
    lhs(30,9)=MOperator(2,3);
    lhs(30,10)=0;
    lhs(30,11)=0;
    lhs(30,12)=clhs2;
    lhs(30,13)=0;
    ...
    lhs(30,35)=0;
    lhs(31,0)=0;
    lhs(31,1)=MOperator(2,0);
    lhs(31,2)=0;
    lhs(31,3)=0;
    lhs(31,4)=MOperator(2,1);
    lhs(31,5)=0;
    lhs(31,6)=0;
    lhs(31,7)=MOperator(2,2);
    lhs(31,8)=0;
    lhs(31,9)=0;
    lhs(31,10)=MOperator(2,3);
    lhs(31,11)=0;
    lhs(31,12)=0;
    lhs(31,13)=clhs2;
    lhs(31,14)=0;
    ...
    lhs(32,0)=0;
    lhs(32,1)=0;
    lhs(32,2)=MOperator(2,0);
    lhs(32,3)=0;
    lhs(32,4)=0;
    lhs(32,5)=MOperator(2,1);
    lhs(32,6)=0;
    lhs(32,7)=0;
    lhs(32,8)=MOperator(2,2);
    lhs(32,9)=0;
    lhs(32,10)=0;
    lhs(32,11)=MOperator(2,3);
    lhs(32,12)=0;
    lhs(32,13)=0;
    lhs(32,14)=clhs2;
    lhs(32,15)=0;
    ...
    lhs(32,34)=0;
    lhs(32,35)=0;
    lhs(33,0)=MOperator(3,0);
    lhs(33,1)=0;
    lhs(33,2)=0;
    lhs(33,3)=MOperator(3,1);
    lhs(33,4)=0;
    lhs(33,5)=0;
    lhs(33,6)=MOperator(3,2);
    lhs(33,7)=0;
    lhs(33,8)=0;
    lhs(33,9)=MOperator(3,3);
    lhs(33,10)=0;
    lhs(33,11)=0;
    lhs(33,12)=clhs3;
    lhs(33,13)=0;
    ...
    lhs(33,35)=0;
    lhs(34,0)=0;
    lhs(34,1)=MOperator(3,0);
    lhs(34,2)=0;
    lhs(34,3)=0;
    lhs(34,4)=MOperator(3,1);
    lhs(34,5)=0;
    lhs(34,6)=0;
    lhs(34,7)=MOperator(3,2);
    lhs(34,8)=0;
    lhs(34,9)=0;
    lhs(34,10)=MOperator(3,3);
    lhs(34,11)=0;
    lhs(34,12)=0;
    lhs(34,13)=clhs3;
    lhs(34,14)=0;
    ...
    lhs(35,0)=0;
    lhs(35,1)=0;
    lhs(35,2)=MOperator(3,0);
    lhs(35,3)=0;
    lhs(35,4)=0;
    lhs(35,5)=MOperator(3,1);
    lhs(35,6)=0;
    lhs(35,7)=0;
    lhs(35,8)=MOperator(3,2);
    lhs(35,9)=0;
    lhs(35,10)=0;
    lhs(35,11)=MOperator(3,3);
    lhs(35,12)=0;
    lhs(35,13)=0;
    lhs(35,14)=clhs3;
    lhs(35,15)=0;
...
template<>
template<>
array_1d<double, 12> MeshTyingMortarCondition<3,6,ScalarValue>::CalculateLocalRHS<12>(
    const MortarConditionMatrices& rMortarConditionMatrices,
    DofData& rDofData,
    const unsigned int& rMasterElementIndex,
    const ProcessInfo& rCurrentProcessInfo
...
template<>
template<>
array_1d<double, 36> MeshTyingMortarCondition<3,6,Vector3DValue>::CalculateLocalRHS<36>(
    const MortarConditionMatrices& rMortarConditionMatrices,
    DofData& rDofData,
    const unsigned int& rMasterElementIndex,
    const ProcessInfo& rCurrentProcessInfo
