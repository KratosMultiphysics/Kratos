...
public:
    ...
    array_1d<double, TNumNodes > NormalLagrangeMultipliers;
            ...
            )
    {
        ...
        // The current Lagrange Multipliers
        NormalLagrangeMultipliers = ZeroVector(TNumNodes);
...
//             DPhi_De_NormalLagrangeMultipliers  = ZeroMatrix(TNumNodes, TDim - 1);
        ...
        void print( )
        {
            ...
            KRATOS_WATCH( Phi_NormalLagrangeMultipliers );
    ...
    */
    ...
    public:
        ...
        */
        ...
        std::vector<bounded_matrix<double, TNumNodes, TNumNodes>> DeltaDOperator;
        std::vector<bounded_matrix<double, TNumNodes, TNumNodes>> DeltaMOperator;
        ...
        */
        ...
        void Initialize()
        {
            ...
            DeltaDOperator.resize(TNumNodes * TDim); // TODO: Dependency?¿
            DeltaMOperator.resize(2 * TNumNodes * TDim);
            for (unsigned int i = 0; i < TNumNodes * TDim; i++)
            {
...
//         const GeometryType::IntegrationPointsArrayType& integration_points,
     ...
     */
    template<unsigned int TMatrixSize, unsigned int TActiveInactive>
    bounded_matrix<double, TMatrixSize, TMatrixSize> CalculateLocalLHS(
        const MortarConditionMatrices<TDim, TNumNodes>& rMortarConditionMatrices,
        const unsigned int& rMasterElementIndex
        );
     ...
     */
    template<unsigned int TMatrixSize, std::bitset TActiveInactive>
     ...
     */
    void CalculateDeltaNormalSlave(ContactData<TDim, TNumNodes>& rContactData);
