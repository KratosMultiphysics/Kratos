...
public:
    ...
    using BaseType = MortarContactCondition<TDim, TNumNodes, FrictionalCase::FRICTIONLESS_COMPONENTS, TNormalVariation, TNumNodesMaster>;
    ...
    /// Type for the geometry
    using GeometryType = Geometry<Node>; 

    /// Type for the integration points
