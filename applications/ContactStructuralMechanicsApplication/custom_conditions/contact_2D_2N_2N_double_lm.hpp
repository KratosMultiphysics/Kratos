...
//     const double Dt              = rContactData.Dt;
    ...
    const double epsilon_tangent = rContactData.epsilon_normal;
...
//substitute_constants_derivatives_variables_active 
    ...
    lhs(7,15) = lhs(7,11);
    lhs(15,7) = lhs(11,7);
    lhs(12,8) = -epsilon_normal;
    lhs(8,12) = -epsilon_normal;
    lhs(12,12) = epsilon_normal;
    lhs(8,9)=0;
    lhs(12,9)=0;
    lhs(8,13)=0;
    lhs(12,13)=0;
    ...
    lhs(9,12)=0;
    lhs(13,12)=0;
    lhs(13,9) = -epsilon_normal;
    lhs(9,13) = -epsilon_normal;
    lhs(13,13) = epsilon_normal;
    lhs(9,10)=0;
    lhs(13,10)=0;
    lhs(9,14)=0;
    lhs(13,14)=0;
    ...
    lhs(10,13)=0;
    lhs(14,13)=0;
    lhs(14,10) = -epsilon_tangent;
    lhs(10,14) = -epsilon_tangent;
    lhs(14,14) = epsilon_tangent;
    lhs(10,11)=0;
    lhs(14,11)=0;
    lhs(10,15)=0;
    lhs(14,15)=0;
    ...
    lhs(11,14)=0;
    lhs(15,14)=0;
    lhs(15,11) = -epsilon_tangent;
    lhs(11,15) = -epsilon_tangent;
    lhs(15,15) = epsilon_tangent;
