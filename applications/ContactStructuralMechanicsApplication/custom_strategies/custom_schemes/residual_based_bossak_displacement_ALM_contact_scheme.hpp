...
#define  KRATOS_RESIDUAL_BASED_BOSSAK_DISPLACEMENT_ALM_CONTACT_SCHEME
...
class ResidualBasedBossakDisplacementALMContactScheme :
    public ResidualBasedBossakDisplacementScheme< TSparseSpace, TDenseSpace >
{
public:
    KRATOS_CLASS_POINTER_DEFINITION( ResidualBasedBossakDisplacementALMContactScheme );
    ...
    ResidualBasedBossakDisplacementALMContactScheme(double rAlpham = 0.0)
...
#endif /* KRATOS_RESIDUAL_BASED_BOSSAK_DISPLACEMENT_ALM_CONTACT_SCHEME defined */
