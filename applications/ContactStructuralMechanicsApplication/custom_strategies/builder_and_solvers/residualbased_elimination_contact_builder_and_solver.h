...
#if !defined(KRATOS_RESIDUAL_BASED_ELIMINATION_CONTACT_BUILDER_AND_SOLVER )
#define  KRATOS_RESIDUAL_BASED_ELIMINATION_CONTACT_BUILDER_AND_SOLVER
...
template<class TSparseSpace,
         ...
         >
class ResidualBasedEliminationContactBuilderAndSolver
    : public ResidualBasedEliminationBuilderAndSolver< TSparseSpace, TDenseSpace, TLinearSolver >
{
public:
    ///@name Type Definitions */
    ///@{
    KRATOS_CLASS_POINTER_DEFINITION(ResidualBasedEliminationContactBuilderAndSolver);
    ...
    /** Constructor.
     */
    ResidualBasedEliminationContactBuilderAndSolver(typename TLinearSolver::Pointer pNewLinearSystemSolver)
...
//         std::cout << "Using the standard builder and solver " << std::endl; 
    ...
    /** Destructor.
     */
    ~ResidualBasedEliminationContactBuilderAndSolver() override
    {
    }
...
#endif /* KRATOS_RESIDUAL_BASED_ELIMINATION_CONTACT_BUILDER_AND_SOLVER  defined */
