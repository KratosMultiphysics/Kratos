...
\begin{axis}[grid=both, 
            ...
            yticklabel pos=left, 
            ylabel style={font=\Large},
            zlabel={$C_j(\mathbf{d}, \boldsymbol{\lambda}_n)$},
            zticklabel pos=left, 
            zlabel style={font=\huge},
            after end axis/.code={
