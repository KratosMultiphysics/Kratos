...
protected:
        ...
        )
    {
        ...
        IndexPartition<std::size_t>(master_size).for_each([&](std::size_t i) {
            ...
            // Get access to master_auxKSAN data
            if (master_auxKSAN.nnz() > 0 && other_dof_size > 0) {
                SparseMatrixMultiplicationUtility::ComputeAuxiliaryValuesBlocks(master_auxKSAN, aux_index2_K_disp_modified_aux2, aux_val_K_disp_modified_aux2, i, row_end, other_dof_initial_index);
            }
            // Get access to master_auxKSAM data
            if (master_auxKSAM.nnz() > 0) {
                SparseMatrixMultiplicationUtility::ComputeAuxiliaryValuesBlocks(master_auxKSAM, aux_index2_K_disp_modified_aux2, aux_val_K_disp_modified_aux2, i, row_end, master_dof_initial_index);
            }
            // Get access to master_auxKSASI data
            if (master_auxKSASI.nnz() > 0 && slave_inactive_size > 0) {
                SparseMatrixMultiplicationUtility::ComputeAuxiliaryValuesBlocks(master_auxKSASI, aux_index2_K_disp_modified_aux2, aux_val_K_disp_modified_aux2, i, row_end, slave_inactive_dof_initial_index);
            }
            // Get access to master_auxKSASA data
            if (master_auxKSASA.nnz() > 0 && slave_active_size > 0) {
                SparseMatrixMultiplicationUtility::ComputeAuxiliaryValuesBlocks(master_auxKSASA, aux_index2_K_disp_modified_aux2, aux_val_K_disp_modified_aux2, i, row_end, assembling_slave_dof_initial_index);
            }
        });
        ...
        IndexPartition<std::size_t>(slave_active_size).for_each([&](std::size_t i) {
            ...
            // Get access to aslave_auxKSAN data
            if (aslave_auxKSAN.nnz() > 0 && other_dof_size > 0) {
                SparseMatrixMultiplicationUtility::ComputeAuxiliaryValuesBlocks(aslave_auxKSAN, aux_index2_K_disp_modified_aux2, aux_val_K_disp_modified_aux2, i, row_end, other_dof_initial_index);
            }
            // Get access to aslave_auxKSAM data
            if (aslave_auxKSAM.nnz() > 0 && master_size > 0) {
                SparseMatrixMultiplicationUtility::ComputeAuxiliaryValuesBlocks(aslave_auxKSAM, aux_index2_K_disp_modified_aux2, aux_val_K_disp_modified_aux2, i, row_end, master_dof_initial_index);
            }
            // Get access to aslave_auxKSASI data
            if (aslave_auxKSASI.nnz() > 0 && slave_inactive_size > 0) {
                SparseMatrixMultiplicationUtility::ComputeAuxiliaryValuesBlocks(aslave_auxKSASI, aux_index2_K_disp_modified_aux2, aux_val_K_disp_modified_aux2, i, row_end, slave_inactive_dof_initial_index);
            }
            // Get access to aslave_auxKSASA data
            if (aslave_auxKSASA.nnz() > 0) {
                SparseMatrixMultiplicationUtility::ComputeAuxiliaryValuesBlocks(aslave_auxKSASA, aux_index2_K_disp_modified_aux2, aux_val_K_disp_modified_aux2, i, row_end, assembling_slave_dof_initial_index);
            }
        });
