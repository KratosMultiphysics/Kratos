    ...
    )
{
    ...
    octree_parameters["intersecting_model_part_name"].SetString(slave_model_part_name);
    octree_parameters["intersected_model_part_name"].SetString(master_model_part_name);
