...
//         }
            ...
            )
        {
            ...
            id_node++;
            NodeType::Pointer p_node_1 = rModelPart.CreateNewNode(id_node, 0.0 , 1.0e-3 , 0.0);
            r_slave_model_part.AddNode(p_node_1);
            p_node_1->Set(SLAVE, true);
            p_node_1->Set(MASTER, false);
            p_node_1->Set(ACTIVE, true);
            id_node++;
            NodeType::Pointer p_node_2 = rModelPart.CreateNewNode(id_node, 1.0 , 1.0e-3 , 0.0);
            ...
            )
        {
            ...
            p_node_2->Set(ACTIVE, true);
            id_node++;
            NodeType::Pointer p_node_3 = rModelPart.CreateNewNode(id_node, 0.0 , 1.0e-3 , 1.0);
            r_slave_model_part.AddNode(p_node_3);
            p_node_3->Set(SLAVE, true);
            p_node_3->Set(MASTER, false);
            p_node_3->Set(ACTIVE, true);
            id_node++;
            NodeType::Pointer p_node_4 = rModelPart.CreateNewNode(id_node, 1.0 , 1.0e-3 , 1.0);
            ...
            id_node++;
            NodeType::Pointer p_node_5 = rModelPart.CreateNewNode(id_node, 0.0 , 0.0 , 0.0);
            r_masterModelPart.AddNode(p_node_5);
            p_node_5->Set(SLAVE, false);
            p_node_5->Set(MASTER, true);
            p_node_5->Set(ACTIVE, true);
            id_node++;
            NodeType::Pointer p_node_6 = rModelPart.CreateNewNode(id_node, 1.0 , 0.0 , 0.0);
            r_masterModelPart.AddNode(p_node_6);
            p_node_6->Set(SLAVE, false);
            p_node_6->Set(MASTER, true);
            p_node_6->Set(ACTIVE, true);
            id_node++;
            NodeType::Pointer p_node_7 = rModelPart.CreateNewNode(id_node, 0.0 , 0.0 , 1.0);
            r_masterModelPart.AddNode(p_node_7);
            p_node_7->Set(SLAVE, false);
            p_node_7->Set(MASTER, true);
            p_node_7->Set(ACTIVE, true);
            id_node++;
            NodeType::Pointer p_node_8 = rModelPart.CreateNewNode(id_node, 1.0 , 0.0 , 1.0);
            r_masterModelPart.AddNode(p_node_8);
            p_node_8->Set(SLAVE, false);
            p_node_8->Set(MASTER, true);
            p_node_8->Set(ACTIVE, true);

            id_node++;
            NodeType::Pointer p_node_9 = rModelPart.CreateNewNode(id_node, 2.0 , 0.0 , 0.0);
            r_masterModelPart.AddNode(p_node_9);
            p_node_9->Set(SLAVE, false);
            p_node_9->Set(MASTER, true);
            p_node_9->Set(ACTIVE, true);
            id_node++;
            NodeType::Pointer p_node_10 = rModelPart.CreateNewNode(id_node, 2.0 , 0.0 , 1.0);
            r_masterModelPart.AddNode(p_node_10);
            ...
            id_cond++;
            this_set.AddId(id_cond);
            Condition::Pointer pcond1 = r_masterModelPart.CreateNewCondition("SurfaceCondition3D4N", id_cond, {{6, 5, 7, 8}}, p_cond_prop_1);
            r_masterModelPart.AddCondition(pcond1);
            pcond1->Set(SLAVE, false);
            pcond1->Set(MASTER, true);
            master_conds.push_back(pcond1);
            ...
            id_cond++;
            this_set.AddId(id_cond);
            Condition::Pointer pcond2 = r_masterModelPart.CreateNewCondition("SurfaceCondition3D4N", id_cond, {{6, 8, 10, 9}}, p_cond_prop_1);
            r_masterModelPart.AddCondition(pcond2);
            pcond2->Set(SLAVE, false);
            pcond2->Set(MASTER, true);
            master_conds.push_back(pcond2);
