...
class TestDoubleCurvatureIntegration(KratosUnittest.TestCase):
    ...
    def __base_test_integration(self, input_filename, num_nodes):
        ...
        """)
        if (num_nodes == 3):
            contact_search = ContactStructuralMechanicsApplication.AdvancedContactSearchProcess3D3N(self.main_model_part, search_parameters)
        else:
            contact_search = ContactStructuralMechanicsApplication.AdvancedContactSearchProcess3D4N(self.main_model_part, search_parameters)
