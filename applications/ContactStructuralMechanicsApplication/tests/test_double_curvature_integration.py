...
class TestDoubleCurvatureIntegration(KratosUnittest.TestCase):
    ...
    def test_double_curvature_integration_triangle(self):
        input_filename = os.path.dirname(os.path.realpath(__file__)) + "/auxiliary_files_for_python_unittest/integration_tests/test_double_curvature_integration_triangle"
    ...
    def test_double_curvature_integration_quad(self):
        input_filename = os.path.dirname(os.path.realpath(__file__)) + "/auxiliary_files_for_python_unittest/integration_tests/test_double_curvature_integration_quadrilateral"
    ...
    def test_moving_mesh_integration_quad(self):
        input_filename = os.path.dirname(os.path.realpath(__file__)) + "/auxiliary_files_for_python_unittest/integration_tests/quadrilaterals_moving_nodes"

        self._moving_nodes_tests(input_filename, 4)

    def test_integration_quad_non_matching(self):
        input_filename = os.path.dirname(os.path.realpath(__file__)) + "/auxiliary_files_for_python_unittest/integration_tests/quadrilaterals_non_matching"
