  ...
  namespace kernels
  {
   ...
   struct matrix_row<double, 1>
   {
    ...
    static void init()
    {
      ...
      {
        std::string source;
        source.append(viennacl::tools::make_double_kernel(matrix_row_align1_trans_lower_triangular_substitute_inplace));
        source.append(viennacl::tools::make_double_kernel(matrix_row_align1_trans_unit_upper_triangular_substitute_inplace));
        source.append(viennacl::tools::make_double_kernel(matrix_row_align1_rank1_update));
        source.append(viennacl::tools::make_double_kernel(matrix_row_align1_lower_triangular_substitute_inplace));
        source.append(viennacl::tools::make_double_kernel(matrix_row_align1_lu_factorize));
        source.append(viennacl::tools::make_double_kernel(matrix_row_align1_trans_vec_mul));
        source.append(viennacl::tools::make_double_kernel(matrix_row_align1_clear));
        source.append(viennacl::tools::make_double_kernel(matrix_row_align1_scaled_rank1_update));
        source.append(viennacl::tools::make_double_kernel(matrix_row_align1_vec_mul));
        source.append(viennacl::tools::make_double_kernel(matrix_row_align1_unit_upper_triangular_substitute_inplace));
        source.append(viennacl::tools::make_double_kernel(matrix_row_align1_trans_unit_lower_triangular_substitute_inplace));
        source.append(viennacl::tools::make_double_kernel(matrix_row_align1_unit_lower_triangular_substitute_inplace));
        source.append(viennacl::tools::make_double_kernel(matrix_row_align1_trans_upper_triangular_substitute_inplace));
        source.append(viennacl::tools::make_double_kernel(matrix_row_align1_upper_triangular_substitute_inplace));
        std::string prog_name = program_name();
        #ifdef VIENNACL_BUILD_INFO
        std::cout << "Creating program " << prog_name << std::endl;
        #endif
