   ...
   struct matrix_col<double, 16>
   {
    ...
    static void init()
    {
      ...
      if (!init_done[context_.handle()])
      {
        ...
        source.append(viennacl::tools::make_double_kernel(matrix_col_align1_lu_factorize, pf_info));
        source.append(viennacl::tools::make_double_kernel(matrix_col_align1_upper_triangular_substitute_inplace, pf_info));
        source.append(viennacl::tools::make_double_kernel(matrix_col_align1_trans_vec_mul, pf_info));
        source.append(viennacl::tools::make_double_kernel(matrix_col_align1_unit_lower_triangular_substitute_inplace, pf_info));
        source.append(viennacl::tools::make_double_kernel(matrix_col_align1_trans_lower_triangular_substitute_inplace, pf_info));
        source.append(viennacl::tools::make_double_kernel(matrix_col_align1_trans_unit_upper_triangular_substitute_inplace, pf_info));
        source.append(viennacl::tools::make_double_kernel(matrix_col_align1_trans_unit_lower_triangular_substitute_inplace, pf_info));
        source.append(viennacl::tools::make_double_kernel(matrix_col_align1_unit_upper_triangular_substitute_inplace, pf_info));
        source.append(viennacl::tools::make_double_kernel(matrix_col_align1_rank1_update, pf_info));
        source.append(viennacl::tools::make_double_kernel(matrix_col_align1_clear, pf_info));
        source.append(viennacl::tools::make_double_kernel(matrix_col_align1_scaled_rank1_update, pf_info));
        source.append(viennacl::tools::make_double_kernel(matrix_col_align1_trans_upper_triangular_substitute_inplace, pf_info));
        source.append(viennacl::tools::make_double_kernel(matrix_col_align1_lower_triangular_substitute_inplace, pf_info));
        source.append(viennacl::tools::make_double_kernel(matrix_col_align1_vec_mul, pf_info));
        std::string prog_name = program_name();
        #ifdef VIENNACL_BUILD_INFO
        std::cout << "Creating program " << prog_name << std::endl;
        #endif
