...
namespace viennacl
{
  namespace linalg
  {
    ...
    */
                   ...
                   unsigned int NUM_THREADS = 0)
    {
      ...
      if (NUM_THREADS == 0)
        ...
        viennacl::linalg::kernels::compressed_matrix<TYPE, ALIGNMENT>::vec_mul.start1D(viennacl::ocl::device().work_groups() * NUM_THREADS, NUM_THREADS);
    }
    ...
    */
    ...
    {
      unsigned int threads = viennacl::ocl::device().work_items_per_group();
      ...
      viennacl::linalg::kernels::compressed_matrix<SCALARTYPE,MAT_ALIGNMENT>::lu_forward.setLocalBuffer(pos++, sizeof(int) * (threads+1));
      viennacl::linalg::kernels::compressed_matrix<SCALARTYPE,MAT_ALIGNMENT>::lu_forward.setLocalBuffer(pos++, sizeof(SCALARTYPE) * threads);
    ...
    */
    ...
    {
      //unsigned int threads = viennacl::ocl::DEFAULT_THREADS;
      ...
      viennacl::linalg::kernels::compressed_matrix<SCALARTYPE,MAT_ALIGNMENT>::lu_backward.setLocalBuffer(pos++, sizeof(int) * (threads+2));
      viennacl::linalg::kernels::compressed_matrix<SCALARTYPE,MAT_ALIGNMENT>::lu_backward.setLocalBuffer(pos++, sizeof(SCALARTYPE) * (threads+2));
