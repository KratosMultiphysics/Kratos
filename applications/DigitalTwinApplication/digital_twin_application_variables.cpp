...
namespace Kratos
{
    ...
    KRATOS_CREATE_VARIABLE(int, SENSOR_GROUP_ID)
    KRATOS_CREATE_VARIABLE(Vector, SENSOR_NEIGHBOUR_IDS)
    KRATOS_CREATE_VARIABLE(double, SENSOR_LOCATION_ROBUSTNESS)
    ...
    KRATOS_CREATE_VARIABLE(double, SENSOR_COVERAGE)
