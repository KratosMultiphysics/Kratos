...
from KratosMultiphysics.DigitalTwinApplication.responses.sensor_distance_boltzmann_operator_response import SensorDistanceBoltzmannOperatorResponse
...
class TestSensorDistanceBoltzmannOperatorResponseUtils(UnitTest.TestCase):
    ...
    def test_CalculateGradient(self):
        ...
        for i, node in enumerate(self.model_part.Nodes):
            ...
            print(fd_gradient, analytical_gradient[i], 5)

# class TestSensorDistanceBoltzmannOperatorResponse(UnitTest.TestCase):
#     @classmethod
#     def setUpClass(cls) -> None:
#         """
#           (0,0)
