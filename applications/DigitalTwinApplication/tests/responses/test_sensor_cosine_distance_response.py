...
from KratosMultiphysics.DigitalTwinApplication.responses.sensor_cosine_distance_response import SensorCosineDistanceResponse
from KratosMultiphysics.OptimizationApplication.utilities.optimization_problem import OptimizationProblem
from KratosMultiphysics.OptimizationApplication.utilities.component_data_view import ComponentDataView

class TestSensorCosineDistanceResponse(UnitTest.TestCase):
    @classmethod
    def setUpClass(cls) -> None:
        ...
        cls.response = SensorCosineDistanceResponse("test", cls.model, params, cls.optimization_problem)
        cls.response.Initialize()

    def test_CalculateValue(self):
        self.assertAlmostEqual(self.response.CalculateValue(), 0.5991954317321075)
