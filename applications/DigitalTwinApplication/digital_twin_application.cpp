...
void KratosDigitalTwinApplication::Register()
{
    ...
    KRATOS_REGISTER_VARIABLE(SENSOR_GROUP_ID)
    KRATOS_REGISTER_VARIABLE(SENSOR_NEIGHBOUR_IDS)
    KRATOS_REGISTER_VARIABLE(SENSOR_LOCATION_ROBUSTNESS)
    ...
    KRATOS_REGISTER_VARIABLE(SENSOR_COVERAGE)
