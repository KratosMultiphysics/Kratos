...
def GetContainerExpression(model_part: Kratos.ModelPart, data_location: Kratos.Globals.DataLocation, variable: typing.Any) -> 'typing.Union[Kratos.Expression.NodalExpression, Kratos.Expression.ConditionExpression, Kratos.Expression.ElementExpression]':
