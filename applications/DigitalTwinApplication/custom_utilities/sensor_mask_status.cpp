...
template class SensorMaskStatus<ModelPart::NodesContainerType>;
template class SensorMaskStatus<ModelPart::ConditionsContainerType>;
template class SensorMaskStatus<ModelPart::ElementsContainerType>;
