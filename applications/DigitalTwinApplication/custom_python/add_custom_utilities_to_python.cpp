...
void AddCustomUtilitiesToPython(pybind11::module& m)
{
    ...
    sensor_utils.def("Min", &SensorUtils::Min<ModelPart::NodesContainerType>, py::arg("nodal_expression"));
    sensor_utils.def("Min", &SensorUtils::Min<ModelPart::ConditionsContainerType>, py::arg("condition_expression"));
    sensor_utils.def("Min", &SensorUtils::Min<ModelPart::ElementsContainerType>, py::arg("element_expression"));
    sensor_utils.def("Max", &SensorUtils::Max<ModelPart::NodesContainerType>, py::arg("nodal_expression"));
    sensor_utils.def("Max", &SensorUtils::Max<ModelPart::ConditionsContainerType>, py::arg("condition_expression"));
    sensor_utils.def("Max", &SensorUtils::Max<ModelPart::ElementsContainerType>, py::arg("element_expression"));
    sensor_utils.def("Sum", &SensorUtils::Sum<ModelPart::NodesContainerType>, py::arg("nodal_expression"));
    sensor_utils.def("Sum", &SensorUtils::Sum<ModelPart::ConditionsContainerType>, py::arg("condition_expression"));
    sensor_utils.def("Sum", &SensorUtils::Sum<ModelPart::ElementsContainerType>, py::arg("element_expression"));
