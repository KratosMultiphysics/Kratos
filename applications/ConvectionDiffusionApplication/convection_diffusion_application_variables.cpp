...
KRATOS_CREATE_VARIABLE(double, STEP_SOLUTION)
KRATOS_CREATE_VARIABLE(double, TRUNC_SOLUTION)
KRATOS_CREATE_VARIABLE(double, STEP_SOLUTION_ERROR)
KRATOS_CREATE_VARIABLE(double, TRUNC_SOLUTION_ERROR)

KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(CONVECTION_VELOCITY)
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(REFERENCE_VELOCITY)
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(GENERIC_3D_VARIABLE)
