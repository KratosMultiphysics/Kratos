...
KRATOS_CREATE_VARIABLE(double, STABILIZATION_FACTOR_1)
KRATOS_CREATE_VARIABLE(double, STABILIZATION_FACTOR_2)
KRATOS_CREATE_VARIABLE(double, STABILIZATION_FACTOR_DYNAMIC)
