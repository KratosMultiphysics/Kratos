...
KRATOS_CREATE_VARIABLE(double, KAMAL_SOUROUR_A_1)
KRATOS_CREATE_VARIABLE(double, KAMAL_SOUROUR_A_2)
KRATOS_CREATE_VARIABLE(double, KAMAL_SOUROUR_E_1)
KRATOS_CREATE_VARIABLE(double, KAMAL_SOUROUR_E_2)
KRATOS_CREATE_VARIABLE(double, KAMAL_SOUROUR_M_FACTOR)
KRATOS_CREATE_VARIABLE(double, KAMAL_SOUROUR_N_FACTOR)
...
KRATOS_CREATE_VARIABLE(double, ADJUSTED_STIFFNESS)
