...
KRATOS_CREATE_VARIABLE(double, CONCENTRATION_PROJECTED)
KRATOS_CREATE_VARIABLE(double, SCALAR_STAT_ERROR)
KRATOS_CREATE_VARIABLE(double, SCALAR_MESH_ERROR)
...
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(VECTORIAL_STAT_ERROR)
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(VECTORIAL_MESH_ERROR)
