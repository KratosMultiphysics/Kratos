...
KRATOS_CREATE_VARIABLE(double, PDE_FILTER_RESULT )
KRATOS_CREATE_VARIABLE(double, PDE_FILTER_FORCING )
KRATOS_CREATE_VARIABLE(double, PDE_FILTER_FLUX )
KRATOS_CREATE_VARIABLE(double, PDE_FILTER_DIFFUSION )
KRATOS_CREATE_VARIABLE(double, PDE_FILTER_REACTION )
KRATOS_CREATE_VARIABLE(int, TRANSPORT_TOP_OPT_PROBLEM_STAGE)
KRATOS_CREATE_VARIABLE(double, DECAY)
KRATOS_CREATE_VARIABLE(double, OPTIMIZATION_TEMPERATURE)
KRATOS_CREATE_VARIABLE(double, HEAT_FLUX_ADJ)
KRATOS_CREATE_VARIABLE(double, FACE_HEAT_FLUX_ADJ)
KRATOS_CREATE_VARIABLE(int, TRANSPORT_TOP_OPT_T_STEP)
KRATOS_CREATE_VARIABLE(int, TRANSPORT_TOP_OPT_ADJ_T_STEP)
