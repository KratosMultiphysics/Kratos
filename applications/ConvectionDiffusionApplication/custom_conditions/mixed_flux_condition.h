...
#if !defined(KRATOS_MIXED_FLUX_CONDITION_H_INCLUDED)
#define  KRATOS_MIXED_FLUX_CONDITION_H_INCLUDED
...
// namespace MixedFluxConditionInternals
// {
...
class MixedFluxCondition: public Condition
{
public:
    ///@name Type Definitions
    ///@{

    /// Pointer definition of MixedFluxCondition
    KRATOS_CLASS_INTRUSIVE_POINTER_DEFINITION(MixedFluxCondition);
    ...
    /// Copy constructor.
    MixedFluxCondition(MixedFluxCondition const& rOther) = delete;

    /// Destructor.
    ~MixedFluxCondition() override;
...
private:
    ...
    /// Assignment operator.
    MixedFluxCondition& operator=(MixedFluxCondition const& rOther);

    ///@}
}; // Class MixedFluxCondition

///@}
///@} addtogroup block
}  // namespace Kratos.

#endif // KRATOS_MIXED_FLUX_CONDITION_H_INCLUDED defined
