...
if __name__ == "__main__":
    ...
    CHT_tool = CHTWorkflow("/fluid_cutting", "/solid_prism")
    #CHT_tool.RefineSolid(0.0002)
    CHT_tool.RefineBeforeCut(0.015)
    #CHT_tool.DistancetoSolidSkin(True)
    CHT_tool.CutFluidMesh(0.015, 0.01, 0.03, 0.001)
    #CHT_tool.RefineAfterCut(2.5)
    CHT_tool.RectifyModelPart()
    CHT_tool.VTKFileOutput("fluid_prism")
    CHT_tool.CreateGIDOutput("fluid_prism")
