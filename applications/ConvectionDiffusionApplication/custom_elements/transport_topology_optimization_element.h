...
#ifndef KRATOS_TRANSPORT_TOP_OPT_ELEMENT_H
#define KRATOS_TRANSPORT_TOP_OPT_ELEMENT_H
...
class TransportTopologyOptimizationElement : public Element
{
public:
    ///@name Type Definitions
    ///@{

    /// Pointer definition of TransportTopologyOptimizationElement
    KRATOS_CLASS_INTRUSIVE_POINTER_DEFINITION(TransportTopologyOptimizationElement);
     ...
     */
    TransportTopologyOptimizationElement(IndexType NewId = 0);
     ...
     */
    TransportTopologyOptimizationElement(IndexType NewId, const NodesArrayType& ThisNodes);
     ...
     */
    TransportTopologyOptimizationElement(IndexType NewId, GeometryType::Pointer pGeometry);
     ...
     */
    TransportTopologyOptimizationElement(IndexType NewId, GeometryType::Pointer pGeometry, Properties::Pointer pProperties);

    /// Destructor.
    virtual ~TransportTopologyOptimizationElement();
    ...
    /**
     * Returns a pointer to a new TransportTopologyOptimizationElement element, created using given input
    ...
    /** For TransportTopologyOptimizationElement, this initializes the constitutive law using the data in the element's properties.
     */
...
private:
    ...
    /// Assignment operator.
    TransportTopologyOptimizationElement& operator=(TransportTopologyOptimizationElement const& rOther);

    /// Copy constructor.
    TransportTopologyOptimizationElement(TransportTopologyOptimizationElement const& rOther);

    ///@}


}; // Class TransportTopologyOptimizationElement
...
inline std::istream& operator >>(std::istream& rIStream,
                                 TransportTopologyOptimizationElement<TElementData>& rThis)
{
    return rIStream;
}
...
inline std::ostream& operator <<(std::ostream& rOStream,
                                 const TransportTopologyOptimizationElement<TElementData>& rThis)
{
...
#endif // KRATOS_TRANSPORT_TOP_OPT_ELEMENT_H