...
#ifndef KRATOS_EMBEDDED_LAPLACIAN_BCSF_ELEMENT_H_INCLUDED
#define  KRATOS_EMBEDDED_LAPLACIAN_BCSF_ELEMENT_H_INCLUDED
...
namespace EmbeddedLaplacianBCSFInternals {
    ...
    public:
        ...
        ShapeFunctionsGradientsType PositiveSideDNDX_unc;
...
template<std::size_t TDim>
class EmbeddedLaplacianBCSFElement : public LaplacianElement
{
public:
    ///@name Type Definitions
    ///@{

    /// Counted pointer of EmbeddedLaplacianBCSFElement
    KRATOS_CLASS_INTRUSIVE_POINTER_DEFINITION(EmbeddedLaplacianBCSFElement);
    ...
    /// Destructor.
    virtual ~EmbeddedLaplacianBCSFElement();
...
protected:
    ...
    EmbeddedLaplacianBCSFElement() : LaplacianElement()
    {
    }
...
private:
    ...
    /// Assignment operator.
    //EmbeddedLaplacianBCSFElement& operator=(const EmbeddedLaplacianBCSFElement& rOther);

    /// Copy constructor.
    //EmbeddedLaplacianBCSFElement(const EmbeddedLaplacianBCSFElement& rOther);

    ///@}

}; // Class EmbeddedLaplacianBCSFElement
...
/*  inline std::istream& operator >> (std::istream& rIStream,
				    EmbeddedLaplacianBCSFElement& rThis);
*/
/// output stream function
/*  inline std::ostream& operator << (std::ostream& rOStream,
				    const EmbeddedLaplacianBCSFElement& rThis)
    {
...
#endif // KRATOS_EMBEDDED_LAPLACIAN_BCSF_ELEMENT_H_INCLUDED  defined
