    ...
    MatrixType& rLHS)
{
    ...
    const double crLHS0 = gauss_weight*(D[0]*N[0] + D[1]*N[1] + D[2]*N[2]);
const double crLHS1 = crLHS0*(DN(0,0)*DN(1,0) + DN(0,1)*DN(1,1));
const double crLHS2 = crLHS0*(DN(0,0)*DN(2,0) + DN(0,1)*DN(2,1));
const double crLHS3 = crLHS0*(DN(1,0)*DN(2,0) + DN(1,1)*DN(2,1));
rLHS(0,0)+=crLHS0*(pow(DN(0,0), 2) + pow(DN(0,1), 2));
rLHS(0,1)+=crLHS1;
rLHS(0,2)+=crLHS2;
rLHS(1,0)+=crLHS1;
rLHS(1,1)+=crLHS0*(pow(DN(1,0), 2) + pow(DN(1,1), 2));
rLHS(1,2)+=crLHS3;
rLHS(2,0)+=crLHS2;
rLHS(2,1)+=crLHS3;
rLHS(2,2)+=crLHS0*(pow(DN(2,0), 2) + pow(DN(2,1), 2));
    ...
    MatrixType& rLHS)
{
    ...
    // TRANSPORT ELEMENTAL LHS MATRIX
    const double crLHS0 = gauss_weight*(D[0]*N[0] + D[1]*N[1] + D[2]*N[2] + D[3]*N[3]);
const double crLHS1 = crLHS0*(DN(0,0)*DN(1,0) + DN(0,1)*DN(1,1));
const double crLHS2 = crLHS0*(DN(0,0)*DN(2,0) + DN(0,1)*DN(2,1));
const double crLHS3 = crLHS0*(DN(0,0)*DN(3,0) + DN(0,1)*DN(3,1));
const double crLHS4 = crLHS0*(DN(1,0)*DN(2,0) + DN(1,1)*DN(2,1));
const double crLHS5 = crLHS0*(DN(1,0)*DN(3,0) + DN(1,1)*DN(3,1));
const double crLHS6 = crLHS0*(DN(2,0)*DN(3,0) + DN(2,1)*DN(3,1));
rLHS(0,0)+=crLHS0*(pow(DN(0,0), 2) + pow(DN(0,1), 2));
rLHS(0,1)+=crLHS1;
rLHS(0,2)+=crLHS2;
rLHS(0,3)+=crLHS3;
...
rLHS(3,1)+=crLHS5;
rLHS(3,2)+=crLHS6;
rLHS(3,3)+=crLHS0*(pow(DN(3,0), 2) + pow(DN(3,1), 2));
    ...
    MatrixType& rLHS)
{
    ...
    // TRANSPORT ELEMENTAL LHS MATRIX
    const double crLHS0 = gauss_weight*(D[0]*N[0] + D[1]*N[1] + D[2]*N[2] + D[3]*N[3]);
const double crLHS1 = crLHS0*(DN(0,0)*DN(1,0) + DN(0,1)*DN(1,1) + DN(0,2)*DN(1,2));
const double crLHS2 = crLHS0*(DN(0,0)*DN(2,0) + DN(0,1)*DN(2,1) + DN(0,2)*DN(2,2));
const double crLHS3 = crLHS0*(DN(0,0)*DN(3,0) + DN(0,1)*DN(3,1) + DN(0,2)*DN(3,2));
const double crLHS4 = crLHS0*(DN(1,0)*DN(2,0) + DN(1,1)*DN(2,1) + DN(1,2)*DN(2,2));
const double crLHS5 = crLHS0*(DN(1,0)*DN(3,0) + DN(1,1)*DN(3,1) + DN(1,2)*DN(3,2));
const double crLHS6 = crLHS0*(DN(2,0)*DN(3,0) + DN(2,1)*DN(3,1) + DN(2,2)*DN(3,2));
rLHS(0,0)+=crLHS0*(pow(DN(0,0), 2) + pow(DN(0,1), 2) + pow(DN(0,2), 2));
rLHS(0,1)+=crLHS1;
rLHS(0,2)+=crLHS2;
rLHS(0,3)+=crLHS3;
rLHS(1,0)+=crLHS1;
rLHS(1,1)+=crLHS0*(pow(DN(1,0), 2) + pow(DN(1,1), 2) + pow(DN(1,2), 2));
rLHS(1,2)+=crLHS4;
rLHS(1,3)+=crLHS5;
rLHS(2,0)+=crLHS2;
rLHS(2,1)+=crLHS4;
rLHS(2,2)+=crLHS0*(pow(DN(2,0), 2) + pow(DN(2,1), 2) + pow(DN(2,2), 2));
rLHS(2,3)+=crLHS6;
rLHS(3,0)+=crLHS3;
rLHS(3,1)+=crLHS5;
rLHS(3,2)+=crLHS6;
rLHS(3,3)+=crLHS0*(pow(DN(3,0), 2) + pow(DN(3,1), 2) + pow(DN(3,2), 2));
...
const double crRHS1 = D[0]*N[0] + D[1]*N[1] + D[2]*N[2];
const double crRHS2 = DN(0,0)*t[0] + DN(1,0)*t[1] + DN(2,0)*t[2];
const double crRHS3 = DN(0,1)*t[0] + DN(1,1)*t[1] + DN(2,1)*t[2];
rRHS[0]+=gauss_weight*(N[0]*crRHS0 - crRHS1*(DN(0,0)*crRHS2 + DN(0,1)*crRHS3));
rRHS[1]+=gauss_weight*(N[1]*crRHS0 - crRHS1*(DN(1,0)*crRHS2 + DN(1,1)*crRHS3));
rRHS[2]+=gauss_weight*(N[2]*crRHS0 - crRHS1*(DN(2,0)*crRHS2 + DN(2,1)*crRHS3));
...
const double crRHS1 = D[0]*N[0] + D[1]*N[1] + D[2]*N[2] + D[3]*N[3];
...
rRHS[1]+=gauss_weight*(N[1]*crRHS0 - crRHS1*(DN(1,0)*crRHS2 + DN(1,1)*crRHS3));
rRHS[2]+=gauss_weight*(N[2]*crRHS0 - crRHS1*(DN(2,0)*crRHS2 + DN(2,1)*crRHS3));
rRHS[3]+=gauss_weight*(N[3]*crRHS0 - crRHS1*(DN(3,0)*crRHS2 + DN(3,1)*crRHS3));
...
rRHS[0]+=gauss_weight*(N[0]*crRHS0 - crRHS1*(DN(0,0)*crRHS2 + DN(0,1)*crRHS3 + DN(0,2)*crRHS4));
rRHS[1]+=gauss_weight*(N[1]*crRHS0 - crRHS1*(DN(1,0)*crRHS2 + DN(1,1)*crRHS3 + DN(1,2)*crRHS4));
rRHS[2]+=gauss_weight*(N[2]*crRHS0 - crRHS1*(DN(2,0)*crRHS2 + DN(2,1)*crRHS3 + DN(2,2)*crRHS4));
rRHS[3]+=gauss_weight*(N[3]*crRHS0 - crRHS1*(DN(3,0)*crRHS2 + DN(3,1)*crRHS3 + DN(3,2)*crRHS4));
...
const double crLHS2 = N[0]*crLHS0;
const double crLHS3 = gauss_weight*(N[1]*crLHS2 + crLHS1*(DN(0,0)*DN(1,0) + DN(0,1)*DN(1,1)));
const double crLHS4 = gauss_weight*(N[2]*crLHS2 + crLHS1*(DN(0,0)*DN(2,0) + DN(0,1)*DN(2,1)));
const double crLHS5 = gauss_weight*(N[1]*N[2]*crLHS0 + crLHS1*(DN(1,0)*DN(2,0) + DN(1,1)*DN(2,1)));
rLHS(0,0)+=gauss_weight*(pow(N[0], 2)*crLHS0 + crLHS1*(pow(DN(0,0), 2) + pow(DN(0,1), 2)));
rLHS(0,1)+=crLHS3;
rLHS(0,2)+=crLHS4;
rLHS(1,0)+=crLHS3;
rLHS(1,1)+=gauss_weight*(pow(N[1], 2)*crLHS0 + crLHS1*(pow(DN(1,0), 2) + pow(DN(1,1), 2)));
rLHS(1,2)+=crLHS5;
rLHS(2,0)+=crLHS4;
rLHS(2,1)+=crLHS5;
rLHS(2,2)+=gauss_weight*(pow(N[2], 2)*crLHS0 + crLHS1*(pow(DN(2,0), 2) + pow(DN(2,1), 2)));
...
const double crLHS3 = gauss_weight*(N[1]*crLHS2 + crLHS1*(DN(0,0)*DN(1,0) + DN(0,1)*DN(1,1)));
const double crLHS4 = gauss_weight*(N[2]*crLHS2 + crLHS1*(DN(0,0)*DN(2,0) + DN(0,1)*DN(2,1)));
const double crLHS5 = gauss_weight*(N[3]*crLHS2 + crLHS1*(DN(0,0)*DN(3,0) + DN(0,1)*DN(3,1)));
const double crLHS6 = N[1]*crLHS0;
const double crLHS7 = gauss_weight*(N[2]*crLHS6 + crLHS1*(DN(1,0)*DN(2,0) + DN(1,1)*DN(2,1)));
const double crLHS8 = gauss_weight*(N[3]*crLHS6 + crLHS1*(DN(1,0)*DN(3,0) + DN(1,1)*DN(3,1)));
const double crLHS9 = gauss_weight*(N[2]*N[3]*crLHS0 + crLHS1*(DN(2,0)*DN(3,0) + DN(2,1)*DN(3,1)));
rLHS(0,0)+=gauss_weight*(pow(N[0], 2)*crLHS0 + crLHS1*(pow(DN(0,0), 2) + pow(DN(0,1), 2)));
rLHS(0,1)+=crLHS3;
rLHS(0,2)+=crLHS4;
rLHS(0,3)+=crLHS5;
...
rLHS(3,1)+=crLHS8;
rLHS(3,2)+=crLHS9;
rLHS(3,3)+=gauss_weight*(pow(N[3], 2)*crLHS0 + crLHS1*(pow(DN(3,0), 2) + pow(DN(3,1), 2)));
...
const double crLHS1 = D[0]*N[0] + D[1]*N[1] + D[2]*N[2] + D[3]*N[3];
const double crLHS2 = N[0]*crLHS0;
const double crLHS3 = gauss_weight*(N[1]*crLHS2 + crLHS1*(DN(0,0)*DN(1,0) + DN(0,1)*DN(1,1) + DN(0,2)*DN(1,2)));
const double crLHS4 = gauss_weight*(N[2]*crLHS2 + crLHS1*(DN(0,0)*DN(2,0) + DN(0,1)*DN(2,1) + DN(0,2)*DN(2,2)));
const double crLHS5 = gauss_weight*(N[3]*crLHS2 + crLHS1*(DN(0,0)*DN(3,0) + DN(0,1)*DN(3,1) + DN(0,2)*DN(3,2)));
const double crLHS6 = N[1]*crLHS0;
const double crLHS7 = gauss_weight*(N[2]*crLHS6 + crLHS1*(DN(1,0)*DN(2,0) + DN(1,1)*DN(2,1) + DN(1,2)*DN(2,2)));
const double crLHS8 = gauss_weight*(N[3]*crLHS6 + crLHS1*(DN(1,0)*DN(3,0) + DN(1,1)*DN(3,1) + DN(1,2)*DN(3,2)));
const double crLHS9 = gauss_weight*(N[2]*N[3]*crLHS0 + crLHS1*(DN(2,0)*DN(3,0) + DN(2,1)*DN(3,1) + DN(2,2)*DN(3,2)));
rLHS(0,0)+=gauss_weight*(pow(N[0], 2)*crLHS0 + crLHS1*(pow(DN(0,0), 2) + pow(DN(0,1), 2) + pow(DN(0,2), 2)));
rLHS(0,1)+=crLHS3;
rLHS(0,2)+=crLHS4;
rLHS(0,3)+=crLHS5;
rLHS(1,0)+=crLHS3;
rLHS(1,1)+=gauss_weight*(pow(N[1], 2)*crLHS0 + crLHS1*(pow(DN(1,0), 2) + pow(DN(1,1), 2) + pow(DN(1,2), 2)));
rLHS(1,2)+=crLHS7;
rLHS(1,3)+=crLHS8;
rLHS(2,0)+=crLHS4;
rLHS(2,1)+=crLHS7;
rLHS(2,2)+=gauss_weight*(pow(N[2], 2)*crLHS0 + crLHS1*(pow(DN(2,0), 2) + pow(DN(2,1), 2) + pow(DN(2,2), 2)));
rLHS(2,3)+=crLHS9;
rLHS(3,0)+=crLHS5;
rLHS(3,1)+=crLHS8;
rLHS(3,2)+=crLHS9;
rLHS(3,3)+=gauss_weight*(pow(N[3], 2)*crLHS0 + crLHS1*(pow(DN(3,0), 2) + pow(DN(3,1), 2) + pow(DN(3,2), 2)));
    ...
    VectorType& rRHS)
{
    ...
    const double crRHS0 = 2.0*N[0];
const double crRHS1 = functional_weights[4]*(N[0]*opt_t[0] + N[1]*opt_t[1] + N[2]*opt_t[2]);
...
const double crRHS6 = crRHS3*crRHS5*functional_weights[7];
...
const double crRHS15 = crRHS10*crRHS13 + crRHS11*crRHS14;
const double crRHS16 = functional_weights[6]*(N[0]*c[0] + N[1]*c[1] + N[2]*c[2]);
const double crRHS17 = 2.0*crRHS1;
const double crRHS18 = 2.0*crRHS6;
rRHS[0]+=-gauss_weight*(-N[0]*crRHS2 + N[0]*crRHS4 + crRHS0*crRHS1 + crRHS0*crRHS6 + crRHS12*(DN(0,0)*crRHS10 + DN(0,1)*crRHS11) + crRHS16*(N[0]*crRHS15 + crRHS5*(DN(0,0)*crRHS13 + DN(0,1)*crRHS14)) + crRHS7*(DN(0,0)*crRHS8 + DN(0,1)*crRHS9));
rRHS[1]+=-gauss_weight*(N[1]*crRHS17 + N[1]*crRHS18 - N[1]*crRHS2 + N[1]*crRHS4 + crRHS12*(DN(1,0)*crRHS10 + DN(1,1)*crRHS11) + crRHS16*(N[1]*crRHS15 + crRHS5*(DN(1,0)*crRHS13 + DN(1,1)*crRHS14)) + crRHS7*(DN(1,0)*crRHS8 + DN(1,1)*crRHS9));
rRHS[2]+=-gauss_weight*(N[2]*crRHS17 + N[2]*crRHS18 - N[2]*crRHS2 + N[2]*crRHS4 + crRHS12*(DN(2,0)*crRHS10 + DN(2,1)*crRHS11) + crRHS16*(N[2]*crRHS15 + crRHS5*(DN(2,0)*crRHS13 + DN(2,1)*crRHS14)) + crRHS7*(DN(2,0)*crRHS8 + DN(2,1)*crRHS9));
    ...
    VectorType& rRHS)
{
    ...
    // ADJOINT TRANSPORT ELEMENTAL RHS VECTOR
    const double crRHS0 = 2.0*N[0];
const double crRHS1 = functional_weights[4]*(N[0]*opt_t[0] + N[1]*opt_t[1] + N[2]*opt_t[2] + N[3]*opt_t[3]);
...
const double crRHS15 = crRHS10*crRHS13 + crRHS11*crRHS14;
const double crRHS16 = functional_weights[6]*(N[0]*c[0] + N[1]*c[1] + N[2]*c[2] + N[3]*c[3]);
const double crRHS17 = 2.0*crRHS1;
const double crRHS18 = 2.0*crRHS6;
rRHS[0]+=-gauss_weight*(-N[0]*crRHS2 + N[0]*crRHS4 + crRHS0*crRHS1 + crRHS0*crRHS6 + crRHS12*(DN(0,0)*crRHS10 + DN(0,1)*crRHS11) + crRHS16*(N[0]*crRHS15 + crRHS5*(DN(0,0)*crRHS13 + DN(0,1)*crRHS14)) + crRHS7*(DN(0,0)*crRHS8 + DN(0,1)*crRHS9));
rRHS[1]+=-gauss_weight*(N[1]*crRHS17 + N[1]*crRHS18 - N[1]*crRHS2 + N[1]*crRHS4 + crRHS12*(DN(1,0)*crRHS10 + DN(1,1)*crRHS11) + crRHS16*(N[1]*crRHS15 + crRHS5*(DN(1,0)*crRHS13 + DN(1,1)*crRHS14)) + crRHS7*(DN(1,0)*crRHS8 + DN(1,1)*crRHS9));
rRHS[2]+=-gauss_weight*(N[2]*crRHS17 + N[2]*crRHS18 - N[2]*crRHS2 + N[2]*crRHS4 + crRHS12*(DN(2,0)*crRHS10 + DN(2,1)*crRHS11) + crRHS16*(N[2]*crRHS15 + crRHS5*(DN(2,0)*crRHS13 + DN(2,1)*crRHS14)) + crRHS7*(DN(2,0)*crRHS8 + DN(2,1)*crRHS9));
rRHS[3]+=-gauss_weight*(N[3]*crRHS17 + N[3]*crRHS18 - N[3]*crRHS2 + N[3]*crRHS4 + crRHS12*(DN(3,0)*crRHS10 + DN(3,1)*crRHS11) + crRHS16*(N[3]*crRHS15 + crRHS5*(DN(3,0)*crRHS13 + DN(3,1)*crRHS14)) + crRHS7*(DN(3,0)*crRHS8 + DN(3,1)*crRHS9));
...
const double crRHS18 = crRHS11*crRHS15 + crRHS12*crRHS16 + crRHS13*crRHS17;
const double crRHS19 = functional_weights[6]*(N[0]*c[0] + N[1]*c[1] + N[2]*c[2] + N[3]*c[3]);
const double crRHS20 = 2.0*crRHS1;
const double crRHS21 = 2.0*crRHS6;
rRHS[0]+=-gauss_weight*(-N[0]*crRHS2 + N[0]*crRHS4 + crRHS0*crRHS1 + crRHS0*crRHS6 + crRHS14*(DN(0,0)*crRHS11 + DN(0,1)*crRHS12 + DN(0,2)*crRHS13) + crRHS19*(N[0]*crRHS18 + crRHS5*(DN(0,0)*crRHS15 + DN(0,1)*crRHS16 + DN(0,2)*crRHS17)) + crRHS7*(DN(0,0)*crRHS8 + DN(0,1)*crRHS9 + DN(0,2)*crRHS10));
rRHS[1]+=-gauss_weight*(-N[1]*crRHS2 + N[1]*crRHS20 + N[1]*crRHS21 + N[1]*crRHS4 + crRHS14*(DN(1,0)*crRHS11 + DN(1,1)*crRHS12 + DN(1,2)*crRHS13) + crRHS19*(N[1]*crRHS18 + crRHS5*(DN(1,0)*crRHS15 + DN(1,1)*crRHS16 + DN(1,2)*crRHS17)) + crRHS7*(DN(1,0)*crRHS8 + DN(1,1)*crRHS9 + DN(1,2)*crRHS10));
rRHS[2]+=-gauss_weight*(-N[2]*crRHS2 + N[2]*crRHS20 + N[2]*crRHS21 + N[2]*crRHS4 + crRHS14*(DN(2,0)*crRHS11 + DN(2,1)*crRHS12 + DN(2,2)*crRHS13) + crRHS19*(N[2]*crRHS18 + crRHS5*(DN(2,0)*crRHS15 + DN(2,1)*crRHS16 + DN(2,2)*crRHS17)) + crRHS7*(DN(2,0)*crRHS8 + DN(2,1)*crRHS9 + DN(2,2)*crRHS10));
rRHS[3]+=-gauss_weight*(-N[3]*crRHS2 + N[3]*crRHS20 + N[3]*crRHS21 + N[3]*crRHS4 + crRHS14*(DN(3,0)*crRHS11 + DN(3,1)*crRHS12 + DN(3,2)*crRHS13) + crRHS19*(N[3]*crRHS18 + crRHS5*(DN(3,0)*crRHS15 + DN(3,1)*crRHS16 + DN(3,2)*crRHS17)) + crRHS7*(DN(3,0)*crRHS8 + DN(3,1)*crRHS9 + DN(3,2)*crRHS10));
