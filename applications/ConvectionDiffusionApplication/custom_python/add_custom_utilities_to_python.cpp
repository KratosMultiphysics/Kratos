...
void  AddCustomUtilitiesToPython(pybind11::module& m)
{
    ...
    .def("TransferLagrangianToEulerianImp",&MoveParticleUtilityScalarTransport<2>::TransferLagrangianToEulerianImp)
    ...
    .def("TransferLagrangianToEulerianImp",&MoveParticleUtilityScalarTransport<3>::TransferLagrangianToEulerianImp)
