...
void  AddCustomUtilitiesToPython(pybind11::module& m)
{
    ...
    .def("MountBinWithCellSize", &MoveParticleUtilityScalarTransport<2>::MountBinWithCellSize)
    ...
    .def("MountBinWithCellSize", &MoveParticleUtilityScalarTransport<3>::MountBinWithCellSize)
