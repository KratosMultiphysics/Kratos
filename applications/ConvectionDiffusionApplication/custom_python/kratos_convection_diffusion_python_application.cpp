...
PYBIND11_MODULE(KratosConvectionDiffusionApplication,m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, STABILIZATION_FACTOR_1)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, STABILIZATION_FACTOR_2)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, STABILIZATION_FACTOR_DYNAMIC)
