...
PYBIND11_MODULE(KratosConvectionDiffusionApplication,m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, PDE_FILTER_RESULT )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, PDE_FILTER_FORCING )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, PDE_FILTER_FLUX )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, PDE_FILTER_DIFFUSION )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, PDE_FILTER_REACTION )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, TRANSPORT_TOP_OPT_PROBLEM_STAGE )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, DECAY )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, OPTIMIZATION_TEMPERATURE )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, HEAT_FLUX_ADJ )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, FACE_HEAT_FLUX_ADJ )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, TRANSPORT_TOP_OPT_T_STEP )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, TRANSPORT_TOP_OPT_ADJ_T_STEP )
}
