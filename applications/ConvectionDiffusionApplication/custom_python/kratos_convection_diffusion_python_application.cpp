...
PYBIND11_MODULE(KratosConvectionDiffusionApplication,m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, DEGREE_OF_CURE)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, KAMAL_SOUROUR_A_1)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, KAMAL_SOUROUR_A_2)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, KAMAL_SOUROUR_E_1)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, KAMAL_SOUROUR_E_2)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, KAMAL_SOUROUR_M_FACTOR)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, KAMAL_SOUROUR_N_FACTOR)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, GLASS_TRANSITION_TEMPERATURE)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, GLASS_TRANSITION_TEMPERATURE_0)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, GLASS_TRANSITION_TEMPERATURE_INF)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, GLASS_TRANSITION_TEMPERATURE_LAMBDA)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, HEAT_OF_REACTION)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, PRE_STRAIN_FACTOR)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, SPECIFIC_HEAT_CAPACITY)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, THERMAL_CONDUCTIVITY)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, ADJUSTED_DENSITY)
