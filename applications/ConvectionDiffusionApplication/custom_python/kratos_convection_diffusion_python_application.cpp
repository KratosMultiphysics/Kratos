...
PYBIND11_MODULE(KratosConvectionDiffusionApplication,m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, CONDUCTIVITY_SENSITIVITY)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, CONVECTION_COEFFICIENT_SENSITIVITY)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, EMISSIVITY_SENSITIVITY)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, AMBIENT_TEMPERATURE_SENSITIVITY)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, PSEUDO_THERMAL_FACE_CONVECTION_COEFFICIENT)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, PSEUDO_THERMAL_FACE_EMISSIVITY)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, PSEUDO_THERMAL_FACE_AMBIENT_TEMPERATURE)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, CONVECTION_COEFFICIENT_GP_SENSITIVITY)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, EMISSIVITY_GP_SENSITIVITY)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, AMBIENT_TEMPERATURE_GP_SENSITIVITY)

    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m,CONVECTION_VELOCITY)
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m,HEAT_FLOW)
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m,ADJOINT_HEAT_FLOW)
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m,PSEUDO_HEAT_FLOW)
}
