...
PYBIND11_MODULE(KratosConvectionDiffusionApplication,m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, CONCENTRATION_PROJECTED)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, SCALAR_STAT_ERROR)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, SCALAR_MESH_ERROR)
    ...
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, VECTORIAL_STAT_ERROR)
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, VECTORIAL_MESH_ERROR)
