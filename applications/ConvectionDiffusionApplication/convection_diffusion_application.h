...
#include "custom_conditions/adjoint_thermal_face_condition.h"
...
private:
    ...
    const AdjointThermalFaceCondition<ThermalFace> mAdjointThermalFaceCondition2D2N;
    const AdjointThermalFaceCondition<ThermalFace> mAdjointThermalFaceCondition3D3N;
