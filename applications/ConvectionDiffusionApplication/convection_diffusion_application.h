...
#include "custom_conditions/mixed_flux_condition.h"
...
private:
    ...
    const MixedFluxCondition<2,2>  mMixedFluxCondition2D2N;
    const MixedFluxCondition<3,3>  mMixedFluxCondition3D3N;
