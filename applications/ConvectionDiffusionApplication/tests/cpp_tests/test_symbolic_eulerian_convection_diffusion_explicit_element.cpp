...
namespace Testing
{
    void SetSymbolicEulerianConvectionDiffusionExplicitTestModelPart(ModelPart &rModelPart)
    {
        // Set buffer size
    ...
    KRATOS_TEST_CASE_IN_SUITE(SymbolicEulerianConvectionDiffusionExplicit2D3N, KratosConvectionDiffusionFastSuite)
    {
        // Create the test element
        Model model;
        auto &r_test_model_part = model.CreateModelPart("TestModelPart");
        SetSymbolicEulerianConvectionDiffusionExplicitTestModelPart(r_test_model_part);
        ...
        r_test_model_part.CreateNewElement("SymbolicEulerianConvectionDiffusionExplicit2D3N", 1, elem_nodes, r_test_model_part.pGetProperties(0));
    ...
    KRATOS_TEST_CASE_IN_SUITE(SymbolicEulerianConvectionDiffusionExplicit3D4N, KratosConvectionDiffusionFastSuite)
    {
        // Create the test element
        Model model;
        auto &r_test_model_part = model.CreateModelPart("TestModelPart");
        ...
        r_test_model_part.CreateNewElement("SymbolicEulerianConvectionDiffusionExplicit3D4N", 1, elem_nodes, r_test_model_part.pGetProperties(0));
