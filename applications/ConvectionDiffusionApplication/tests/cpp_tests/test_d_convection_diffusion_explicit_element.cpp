...
namespace Testing
{
    ...
    KRATOS_TEST_CASE_IN_SUITE(DConvectionDiffusionExplicit2D3N, KratosConvectionDiffusionFastSuite)
    {
        ...
        r_test_model_part.CreateNewElement("DConvectionDiffusionExplicit2D3N", 1, elem_nodes, r_test_model_part.pGetProperties(0));
    ...
    KRATOS_TEST_CASE_IN_SUITE(DConvectionDiffusionExplicitOSS2D3N, KratosConvectionDiffusionFastSuite)
    {
        // Create the test element
        Model model;
        auto &r_test_model_part = model.CreateModelPart("TestModelPart");
    ...
    KRATOS_TEST_CASE_IN_SUITE(DConvectionDiffusionExplicit3D4N, KratosConvectionDiffusionFastSuite)
    {
        // Create the test element
        Model model;
        auto &r_test_model_part = model.CreateModelPart("TestModelPart");
        ...
        r_test_model_part.CreateNewElement("DConvectionDiffusionExplicit3D4N", 1, elem_nodes, r_test_model_part.pGetProperties(0));
    ...
    KRATOS_TEST_CASE_IN_SUITE(DConvectionDiffusionExplicitOSS3D4N, KratosConvectionDiffusionFastSuite)
    {
        // Create the test element
        Model model;
        auto &r_test_model_part = model.CreateModelPart("TestModelPart");
