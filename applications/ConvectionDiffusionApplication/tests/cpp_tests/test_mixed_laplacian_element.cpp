...
KRATOS_TEST_CASE_IN_SUITE(MixedLaplacianElement3D4N, KratosConvectionDiffusionFastSuite)
{
    ...
    std::vector<double> expected_RHS = {0.04583333333, 0.005047557202, 0.005047557202, 0.02004755732, 0.04166666667, -0.005047557202, 0, 0.007499999962, 0.04166666667, 0, -0.005047557202, 0.007499999962, 0.0375, 0, 0, 0.00245244276};
