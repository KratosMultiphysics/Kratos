...
have_eigen_solvers_dependencies = kratos_utilities.CheckIfApplicationsAvailable("LinearSolversApplication")
...
@KratosUnittest.skipUnless(have_eigen_solvers_dependencies,"Missing required application: LinearSolversApplication")
