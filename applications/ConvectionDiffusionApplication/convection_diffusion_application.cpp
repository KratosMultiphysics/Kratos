...
void KratosConvectionDiffusionApplication::Register() {
    ...
    KRATOS_REGISTER_VARIABLE(KAMAL_SOUROUR_A_1)
    KRATOS_REGISTER_VARIABLE(KAMAL_SOUROUR_A_2)
    KRATOS_REGISTER_VARIABLE(KAMAL_SOUROUR_E_1)
    KRATOS_REGISTER_VARIABLE(KAMAL_SOUROUR_E_2)
    KRATOS_REGISTER_VARIABLE(KAMAL_SOUROUR_M_FACTOR)
    KRATOS_REGISTER_VARIABLE(KAMAL_SOUROUR_N_FACTOR)
    KRATOS_REGISTER_VARIABLE(GLASS_TRANSITION_TEMPERATURE)
    KRATOS_REGISTER_VARIABLE(GLASS_TRANSITION_TEMPERATURE_0)
    KRATOS_REGISTER_VARIABLE(GLASS_TRANSITION_TEMPERATURE_INF)
    KRATOS_REGISTER_VARIABLE(GLASS_TRANSITION_TEMPERATURE_LAMBDA)
    KRATOS_REGISTER_VARIABLE(HEAT_OF_REACTION)
    KRATOS_REGISTER_VARIABLE(PRE_STRAIN_FACTOR)
    KRATOS_REGISTER_VARIABLE(SPECIFIC_HEAT_CAPACITY)
    KRATOS_REGISTER_VARIABLE(THERMAL_CONDUCTIVITY)
    KRATOS_REGISTER_VARIABLE(ADJUSTED_DENSITY)
    KRATOS_REGISTER_VARIABLE(ADJUSTED_STIFFNESS)
