...
KratosConvectionDiffusionApplication::KratosConvectionDiffusionApplication()
    : KratosApplication("ConvectionDiffusionApplication"),
      ...
      mEulerianDiffusion2D3N(0, Element::GeometryType::Pointer(new Triangle2D3<Node<3> >(Element::GeometryType::PointsArrayType(3)))),
      mEulerianDiffusion3D4N(0, Element::GeometryType::Pointer(new Tetrahedra3D4<Node<3> >(Element::GeometryType::PointsArrayType(4)))),
...
void KratosConvectionDiffusionApplication::Register() {
    ...
    KRATOS_REGISTER_VARIABLE(CONDUCTIVITY_SENSITIVITY)
    KRATOS_REGISTER_VARIABLE(CONVECTION_COEFFICIENT_SENSITIVITY)
    KRATOS_REGISTER_VARIABLE(EMISSIVITY_SENSITIVITY)
    KRATOS_REGISTER_VARIABLE(AMBIENT_TEMPERATURE_SENSITIVITY)
    KRATOS_REGISTER_VARIABLE(PSEUDO_THERMAL_FACE_CONVECTION_COEFFICIENT)
    KRATOS_REGISTER_VARIABLE(PSEUDO_THERMAL_FACE_EMISSIVITY)
    KRATOS_REGISTER_VARIABLE(PSEUDO_THERMAL_FACE_AMBIENT_TEMPERATURE)
    KRATOS_REGISTER_VARIABLE(CONVECTION_COEFFICIENT_GP_SENSITIVITY)
    KRATOS_REGISTER_VARIABLE(EMISSIVITY_GP_SENSITIVITY)
    KRATOS_REGISTER_VARIABLE(AMBIENT_TEMPERATURE_GP_SENSITIVITY)

    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(CONVECTION_VELOCITY)
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(HEAT_FLOW)
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(ADJOINT_HEAT_FLOW)
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(PSEUDO_HEAT_FLOW)
