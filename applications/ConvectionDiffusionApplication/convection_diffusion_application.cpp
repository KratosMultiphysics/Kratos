...
void KratosConvectionDiffusionApplication::Register() {
    ...
    KRATOS_REGISTER_VARIABLE(CONCENTRATION_PROJECTED)
    KRATOS_REGISTER_VARIABLE(SCALAR_STAT_ERROR)
    KRATOS_REGISTER_VARIABLE(SCALAR_MESH_ERROR)


    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(CONVECTION_VELOCITY)
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(VELOCITY_PROJECTED)
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(VECTORIAL_STAT_ERROR)
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(VECTORIAL_MESH_ERROR)
