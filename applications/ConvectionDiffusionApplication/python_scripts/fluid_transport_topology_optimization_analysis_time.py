...
class FluidTransportTopologyOptimizationAnalysisTime(TransportTopologyOptimizationAnalysis):
    ...
    def _InitializeAdjointPhysicsSolutionStepFunctionalDerivativeAdjointTemperature(self):
        functional_derivative_adjoint_transport_scalar = self.adjoint_transport_scalar_solutions[self.n_time_steps-self.time_step_counter,:].copy()
        self._GetAdjointSolver()._UpdateFunctionalDerivativeVelocityVariable(functional_derivative_adjoint_transport_scalar)
