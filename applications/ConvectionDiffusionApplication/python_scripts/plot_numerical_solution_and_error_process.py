...
class PlotNumericalSolutionAndErrorProcess(KM.Process):
    ...
    def ExecuteFinalize(self):
        ...
        self.intersected_elements = self.background_model_part.GetSubModelPart("intersected_elements")
        ...
        for sub_model in [self.active_elements, self.intersected_elements]:
            for element in sub_model.Elements:
                ...
                for gp_index in range(len(integration_points)):
                    ...
                    error = (self.analytical_solution_evaluation(x, y, t) - numerical_solution) 
