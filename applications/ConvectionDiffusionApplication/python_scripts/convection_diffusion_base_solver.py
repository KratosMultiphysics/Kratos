...
class ConvectionDiffusionBaseSolver(PythonSolver):
    ...
    def _get_element_condition_replace_settings(self):
        ...
        elif element_name in ("LaplacianElement","AdjointHeatDiffusionElement","SymbolicQuasiStaticEulerianConvectionDiffusionExplicit","SymbolicDynamicEulerianConvectionDiffusionExplicit"):
