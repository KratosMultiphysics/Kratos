...
KRATOS_DEFINE_APPLICATION_VARIABLE(CONVECTION_DIFFUSION_APPLICATION, double, PDE_FILTER_RESULT )
KRATOS_DEFINE_APPLICATION_VARIABLE(CONVECTION_DIFFUSION_APPLICATION, double, PDE_FILTER_FORCING )
KRATOS_DEFINE_APPLICATION_VARIABLE(CONVECTION_DIFFUSION_APPLICATION, double, PDE_FILTER_FLUX )
KRATOS_DEFINE_APPLICATION_VARIABLE(CONVECTION_DIFFUSION_APPLICATION, double, PDE_FILTER_DIFFUSION )
KRATOS_DEFINE_APPLICATION_VARIABLE(CONVECTION_DIFFUSION_APPLICATION, double, PDE_FILTER_REACTION )
...
KRATOS_DEFINE_APPLICATION_VARIABLE(CONVECTION_DIFFUSION_APPLICATION, double, OPTIMIZATION_TEMPERATURE)
