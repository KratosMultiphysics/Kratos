...
void  AddCustomMeshersToPython(pybind11::module& m)
{
  ...
  py::class_<Mesher, typename Mesher::Pointer>(m,"Mesher")
      ...
      .def("SetPreMeshingProcessFirstMesh",&Mesher::SetPreMeshingProcessFirstMesh)
      .def("SetPostMeshingProcessFirstMesh",&Mesher::SetPostMeshingProcessFirstMesh)
      .def("SetPreMeshingProcessSecondMesh",&Mesher::SetPreMeshingProcessSecondMesh)
      .def("SetPostMeshingProcessSecondMesh",&Mesher::SetPostMeshingProcessSecondMesh)
      ...
      .def("ExecuteMeshingTwice",&Mesher::ExecuteMeshingTwice)
      ;
