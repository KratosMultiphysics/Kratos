...
void  AddCustomUtilitiesToPython(pybind11::module& m)
{
  ...
  py::class_< MesherUtilities::MeshingParameters, typename MesherUtilities::MeshingParameters::Pointer>
      ...
      .def("SetRefiningBoxMinExternalPoint",&MesherUtilities::MeshingParameters::SetRefiningBoxMinExternalPoint)
      .def("SetRefiningBoxMinInternalPoint",&MesherUtilities::MeshingParameters::SetRefiningBoxMinInternalPoint)
      .def("SetRefiningBoxMaximumPoint",&MesherUtilities::MeshingParameters::SetRefiningBoxMaximumPoint)
      .def("SetRefiningBoxMaxExternalPoint",&MesherUtilities::MeshingParameters::SetRefiningBoxMaxExternalPoint)
      .def("SetRefiningBoxMaxInternalPoint",&MesherUtilities::MeshingParameters::SetRefiningBoxMaxInternalPoint)
