...
#if !defined(KRATOS_TRANSFER_ENTITIES_BETWEEN_PFEM_MODEL_PARTS_PROCESS_H_INCLUDED)
#define  KRATOS_TRANSFER_ENTITIES_BETWEEN_PFEM_MODEL_PARTS_PROCESS_H_INCLUDED
...
*/
class TransferEntitiesBetweenPfemModelPartsProcess : public Process
{
public:
    ///@name Type Definitions
    ///@{

    /// Pointer definition of TransferEntitiesBetweenPfemModelPartsProcess
    KRATOS_CLASS_POINTER_DEFINITION(TransferEntitiesBetweenPfemModelPartsProcess);

    ///@}
    ///@name Life Cycle
    ///@{

    TransferEntitiesBetweenPfemModelPartsProcess(ModelPart& rDestinationModelPart,
    ...
    /// Destructor.
    ~TransferEntitiesBetweenPfemModelPartsProcess() override {}
    ...
    /// Execute method is used to execute the TransferEntitiesBetweenPfemModelPartsProcess algorithms.
    ...
    {
        return "TransferEntitiesBetweenPfemModelPartsProcess";
    }

    /// Print information about this object.
    void PrintInfo(std::ostream& rOStream) const override
    {
        rOStream << "TransferEntitiesBetweenPfemModelPartsProcess";
    }
...
protected:
    ...
    /// Copy constructor.
    TransferEntitiesBetweenPfemModelPartsProcess(TransferEntitiesBetweenPfemModelPartsProcess const& rOther);
...
private:
    ...
    /// Assignment operator.
    TransferEntitiesBetweenPfemModelPartsProcess& operator=(TransferEntitiesBetweenPfemModelPartsProcess const& rOther);
...
}; // Class TransferEntitiesBetweenPfemModelPartsProcess
...
inline std::istream& operator >> (std::istream& rIStream,
                                  TransferEntitiesBetweenPfemModelPartsProcess& rThis);

/// output stream function
inline std::ostream& operator << (std::ostream& rOStream,
                                  const TransferEntitiesBetweenPfemModelPartsProcess& rThis)
{
...
#endif // KRATOS_TRANSFER_ENTITIES_BETWEEN_PFEM_MODEL_PARTS_PROCESS_H_INCLUDED  defined
