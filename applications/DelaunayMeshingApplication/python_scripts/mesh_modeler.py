...
class MeshModeler(object):
    ...
    def Initialize(self, dimension):
        ...
        # set mesh modeler
        if(self.dimension == 2):
            self.mesher = KratosDelaunay.TriangularMesh2DModeler()
        elif(self.dimension == 3):
            self.mesher = KratosDelaunay.TetrahedralMesh3DModeler()
    ...
    def InitializeMeshing(self):
        ...
        execution_options.Set(KratosDelaunay.ModelerUtilities.TRANSFER_KRATOS_NODES_TO_MESHER, False)
        ...
        execution_options.Set(KratosDelaunay.ModelerUtilities.SELECT_TESSELLATION_ELEMENTS, False)
    ...
    def SetPostMeshingProcesses(self):
        ...
        #rebuild elements
        rebuild_mesh_elements = KratosDelaunay.BuildMeshElements(self.model_part, self.MeshingParameters, self.echo_level)
        self.mesher.SetPostMeshingProcess(rebuild_mesh_elements)

        #rebuild boundary
        rebuild_mesh_boundary = KratosDelaunay.BuildMeshBoundary(self.model_part, self.MeshingParameters, self.echo_level)
