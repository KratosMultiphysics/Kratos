...
class TransferModeler(mesh_modeler.MeshModeler):
    ...
    def InitializeMeshing(self):
        ...
        execution_options.Set(KratosDelaunay.ModelerUtilities.TRANSFER_KRATOS_ELEMENTS_TO_MESHER, True)
        execution_options.Set(KratosDelaunay.ModelerUtilities.TRANSFER_KRATOS_NEIGHBOURS_TO_MESHER, True)
   ...
   #
    def SetPostMeshingProcesses(self):
        ...
        #rebuild boundary
        rebuild_mesh_boundary = KratosDelaunay.ReconstructMeshBoundary(self.model_part, self.MeshingParameters, self.echo_level)
