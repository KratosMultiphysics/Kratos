...
namespace Kratos
{
    ...
    KRATOS_DEFINE_APPLICATION_VARIABLE( MPM_APPLICATION, int, PARTICLES_PER_ELEMENT )
    ...
    KRATOS_DEFINE_APPLICATION_VARIABLE( MPM_APPLICATION, int, PARTICLES_PER_CONDITION )
