...
#if !defined(PARTICLE_MECHANICS_CONSTITUTIVE_LAW_UTILITIES)
#define PARTICLE_MECHANICS_CONSTITUTIVE_LAW_UTILITIES
...
class KRATOS_API(PARTICLE_MECHANICS_APPLICATION) ConstitutiveLawUtilities
{
  public:
    ///@name Type definitions
    ///@{
...
#endif /* PARTICLE_MECHANICS_CONSTITUTIVE_LAW_UTILITIES defined */
