...
namespace Kratos
{
    namespace PQMPMPartitionUtilities
    {
        ...
        Boost2DPolygonType Create2DPolygonBoundingSquareFromPointsFast(const std::vector<array_1d<double, 3>>& rPoints,
        ...
        Boost2DPolygonType Create2DPolygonFromGeometryFast(const GeometryType& rGeom,
            const bool XActive, const bool YActive, const bool ZActive)
        {
            KRATOS_TRY
        ...
        void CheckPQMPM(IntegrationPointsArrayType& rIntergrationSubPoints, const double Tolerance, Matrix& rN, const DenseVector<Matrix>& rDN_De)
        {
            KRATOS_TRY
        ...
        bool DetermineIfDomainOverlapsBoundaryConditions(std::vector<GeometryType*>& IntersectedGeometries,
        ...
        bool IntersectionCheckWithBoundingBox(const GeometryType& rGeom, const array_1d<double, 3>& rCoord, const double SideHalfLength)
        {
        ...
        void RecursivePQMPMNeighbourSearch(const ModelPart& rBackgroundGridModelPart,
        ...
        bool CheckFixedNodesWithinBoundingBox(const PointerVector<Node<3>>& rNodesList,
        ...
        GeometryNodePointerType CreateCustomQuadraturePoint(
