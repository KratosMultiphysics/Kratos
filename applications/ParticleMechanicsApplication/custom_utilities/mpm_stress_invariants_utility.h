...
#ifndef KRATOS_MPM_STRESS_INVARIANTS_UTILITY
#define KRATOS_MPM_STRESS_INVARIANTS_UTILITY
...
namespace Kratos
{
   ...
   class MPMStressInvariantsUtility
   {
   ...
   }; // end Class MPMStressInvariantsUtility

} // end namespace Kratos

#endif // KRATOS_MPM_STRESS_INVARIANTS_UTILITY
