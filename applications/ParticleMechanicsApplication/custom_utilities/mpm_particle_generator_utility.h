...
namespace MPMParticleGeneratorUtility
{
    ...
    void KRATOS_API(PARTICLE_MECHANICS_APPLICATION) DetermineConditionIntegrationMethodAndShapeFunctionValues(const GeometryType& rGeom, const SizeType ParticlesPerElement,
        IntegrationMethod& rIntegrationMethod, Matrix& rN, bool& IsEqualVolumes);
