...
#if !defined(KRATOS_QUADRATURE_POINT_PARTIONED_GEOMETRY_H_INCLUDED )
#define  KRATOS_QUADRATURE_POINT_PARTIONED_GEOMETRY_H_INCLUDED
...
#endif // KRATOS_QUADRATURE_POINT_PARTIONED_GEOMETRY_H_INCLUDED  defined
