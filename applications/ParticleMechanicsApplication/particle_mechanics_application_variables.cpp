...
namespace Kratos
{
    ...
    KRATOS_CREATE_VARIABLE( Kratos::shared_ptr<typename Kratos::Geometry<typename Kratos::GeometricalObject::NodeType>>, MPC_GEOMETRY )
    KRATOS_CREATE_VARIABLE( Vector, MPC_SHAPEFUNCTIONS )
