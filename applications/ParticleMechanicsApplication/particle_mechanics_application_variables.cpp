...
namespace Kratos
{
    ...
    KRATOS_CREATE_VARIABLE( double, MP_COMPACTION_RATIO)
    ...
    // CL: RHT Concrete
    KRATOS_CREATE_VARIABLE( double, REFERENCE_DENSITY)
    KRATOS_CREATE_VARIABLE( double, RHT_A)
    KRATOS_CREATE_VARIABLE( double, RHT_N)
    KRATOS_CREATE_VARIABLE( double, RHT_COMPRESSIVE_STRENGTH)
    KRATOS_CREATE_VARIABLE( double, RHT_RELATIVE_SHEAR_STRENGTH)
    KRATOS_CREATE_VARIABLE( double, RHT_RELATIVE_TENSILE_STRENGTH)
    KRATOS_CREATE_VARIABLE( double, RHT_Q0)
    KRATOS_CREATE_VARIABLE( double, RHT_B)
    KRATOS_CREATE_VARIABLE( double, REFERENCE_TENSION_STRAIN_RATE)
    KRATOS_CREATE_VARIABLE( double, REFERENCE_COMPRESSION_STRAIN_RATE)
    KRATOS_CREATE_VARIABLE( double, RHT_GC_STAR)
    KRATOS_CREATE_VARIABLE( double, RHT_GT_STAR)
    KRATOS_CREATE_VARIABLE( double, RHT_SHEAR_MOD_REDUCTION_FACTOR)
    KRATOS_CREATE_VARIABLE( double, RHT_D1)
    KRATOS_CREATE_VARIABLE( double, RHT_D2)
    KRATOS_CREATE_VARIABLE( double, RHT_MIN_DAMAGED_RESIDUAL_STRAIN)
    KRATOS_CREATE_VARIABLE( double, RHT_AF)
    KRATOS_CREATE_VARIABLE( double, RHT_NF)
    KRATOS_CREATE_VARIABLE( double, RHT_EOS_A1)
    KRATOS_CREATE_VARIABLE( double, RHT_EOS_A2)
    KRATOS_CREATE_VARIABLE( double, RHT_EOS_A3)
    KRATOS_CREATE_VARIABLE( double, RHT_EOS_B0)
    KRATOS_CREATE_VARIABLE( double, RHT_EOS_B1)
    KRATOS_CREATE_VARIABLE( double, RHT_EOS_T1)
    KRATOS_CREATE_VARIABLE( double, RHT_EOS_T2)
    KRATOS_CREATE_VARIABLE( double, RHT_EOS_ALPHA0)
    KRATOS_CREATE_VARIABLE( double, RHT_EOS_NP)
    KRATOS_CREATE_VARIABLE( double, RHT_CRUSH_PRESSURE)
    KRATOS_CREATE_VARIABLE( double, RHT_COMPACTION_PRESSURE)
