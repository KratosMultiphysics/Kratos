...
namespace Kratos
{
    ...
    KRATOS_CREATE_VARIABLE( int, IS_TRANSFERRED_TO_CONTACT_MP)
    ...
    KRATOS_CREATE_VARIABLE(int, IS_STEEL_FIBRE_REINFORCED_CONCRETE)
    ...
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(MP_TOTAL_DISPLACEMENT)
    ...
    KRATOS_CREATE_VARIABLE(bool, IS_DEFORM_MESH)
    KRATOS_CREATE_VARIABLE(bool, IS_PQMPM)
    KRATOS_CREATE_VARIABLE(bool, IS_MAKE_NORMAL_MP_IF_PQMPM_FAILS)
    KRATOS_CREATE_VARIABLE(bool, PQMPM_IS_MAKE_NORMAL_MP_ON_BC)
