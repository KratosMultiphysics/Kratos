...
namespace Kratos
{
    ...
    KRATOS_CREATE_VARIABLE( double, INTERNAL_FRICTION_ANGLE_PEAK )
    KRATOS_CREATE_VARIABLE( double, INTERNAL_FRICTION_ANGLE_RESIDUAL )
    KRATOS_CREATE_VARIABLE( double, COHESION_PEAK )
    KRATOS_CREATE_VARIABLE( double, COHESION_RESIDUAL )
    KRATOS_CREATE_VARIABLE( double, INTERNAL_DILATANCY_ANGLE_PEAK )
