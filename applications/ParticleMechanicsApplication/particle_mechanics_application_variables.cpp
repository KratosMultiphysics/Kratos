...
namespace Kratos
{
    ...
    KRATOS_CREATE_VARIABLE( int, MPC_CORRESPONDING_CONDITION_ID )
    ...
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS( MPC_ID_LIST )
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS( MPC_AREA_LIST )
