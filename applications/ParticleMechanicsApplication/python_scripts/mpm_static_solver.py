...
class MPMStaticSolver(MPMSolver):
    ...
    def __init__(self, model, custom_settings):
        ...
        KratosMultiphysics.Logger.PrintInfo("::[MPMStaticSolver]:: ", "Solver is constructed correctly.")
    ...
    def AddVariables(self):
        ...
        KratosMultiphysics.Logger.PrintInfo("::[MPMStaticSolver]:: ", "Variables are added.")

    def ImportModelPart(self):
        # Read model part
        self._model_part_reading()

        KratosMultiphysics.Logger.PrintInfo("::[MPMStaticSolver]:: ","Models are imported.")
    ...
    def PrepareModelPart(self):
        ...
        KratosMultiphysics.Logger.PrintInfo("::[MPMStaticSolver]:: ", "ModelPart prepared for Solver.")
    ...
    def AddDofs(self):
        ...
        KratosMultiphysics.Logger.PrintInfo("::[MPMStaticSolver]:: ","DOFs are added.")
    ...
    def Initialize(self):
        ...
        KratosMultiphysics.Logger.PrintInfo("::[MPMStaticSolver]:: ","Solver is initialized correctly.")
    ...
    def _execute_check_and_prepare(self):
        ...
        for node in self.grid_model_part.Nodes:
            if (node.Is(KratosMultiphysics.ACTIVE)):
                KratosMultiphysics.Logger.PrintInfo("::[MPMStaticSolver]:: ","WARNING: This grid node have been set active: ", node.Id)
        ...
        if materials_imported:
            KratosMultiphysics.Logger.PrintInfo("::[MPMStaticSolver]:: ","Constitutive law was successfully imported.")
        else:
            KratosMultiphysics.Logger.PrintWarning("::[MPMStaticSolver]:: ","Constitutive law was not imported.")
