...
class MPMQuasiStaticSolver(MPMSolver):
    ...
    def __init__(self, model, custom_settings):
        ...
        KratosMultiphysics.Logger.PrintInfo("::[MPMQuasiStaticSolver]:: ", "Solver is constructed correctly.")
    ...
    def GetDefaultSettings(cls):
        ...
        this_defaults.AddMissingParameters(super(MPMQuasiStaticSolver, cls).GetDefaultSettings())
    ...
    def AddVariables(self):
        ...
        KratosMultiphysics.Logger.PrintInfo("::[MPMQuasiStaticSolver]:: ", "Variables are added.")

    def ImportModelPart(self):
        # Read model part
        self._model_part_reading()

        KratosMultiphysics.Logger.PrintInfo("::[MPMQuasiStaticSolver]:: ","Models are imported.")
    ...
    def PrepareModelPart(self):
        ...
        KratosMultiphysics.Logger.PrintInfo("::[MPMQuasiStaticSolver]:: ", "ModelPart prepared for Solver.")
    ...
    def AddDofs(self):
        ...
        KratosMultiphysics.Logger.PrintInfo("::[MPMQuasiStaticSolver]:: ","DOFs are added.")
    ...
    def Initialize(self):
        ...
        KratosMultiphysics.Logger.PrintInfo("::[MPMQuasiStaticSolver]:: ","Solver is initialized correctly.")
    ...
    def _execute_check_and_prepare(self):
        ...
        for node in self.grid_model_part.Nodes:
            if (node.Is(KratosMultiphysics.ACTIVE)):
                KratosMultiphysics.Logger.PrintInfo("::[MPMQuasiStaticSolver]:: ","WARNING: This grid node have been set active: ", node.Id)
        ...
        if materials_imported:
            KratosMultiphysics.Logger.PrintInfo("::[MPMQuasiStaticSolver]:: ","Constitutive law was successfully imported.")
        else:
            KratosMultiphysics.Logger.PrintWarning("::[MPMQuasiStaticSolver]:: ","Constitutive law was not imported.")
