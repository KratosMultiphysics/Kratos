...
def Factory(settings, Model):
    ...
    return ParticleConditionVTKOutputProcess(model_part, parameters)

class ParticleConditionVTKOutputProcess(KratosMultiphysics.Process):
    ...
    def _get_attribute(self, my_string, function_pointer, attribute_type):
        ...
        Examples:
        variable = self._get_attribute("MPC_DISPLACEMENT",
    ...
    def _get_variable(self, my_string):
        ...
        Examples:
        recommended usage:
        variable = self._get_variable("MPC_VELOCITY")
        deprecated:
        variable = self._get_variables("KratosMultiphysics.ParticleMechanicsApplication.MPC_VELOCITY")
        """
