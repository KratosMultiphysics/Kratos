...
//***********************************************************************************
//***********************************************************************************
MPMLineLoad3DCondition::MPMLineLoad3DCondition(IndexType NewId, GeometryType::Pointer pGeometry)
...
//***********************************************************************************
//***********************************************************************************
MPMLineLoad3DCondition::MPMLineLoad3DCondition(IndexType NewId, GeometryType::Pointer pGeometry, PropertiesType::Pointer pProperties)
...
//************************************************************************************
//************************************************************************************
MPMLineLoad3DCondition::MPMLineLoad3DCondition( MPMLineLoad3DCondition const& rOther )
...
//***********************************************************************************
//***********************************************************************************
Condition::Pointer MPMLineLoad3DCondition::Create(IndexType NewId, NodesArrayType const& ThisNodes, PropertiesType::Pointer pProperties) const
{
    return Condition::Pointer(new MPMLineLoad3DCondition(NewId, GetGeometry().Create(ThisNodes), pProperties));
}


//************************************CLONE*******************************************
//************************************************************************************
Condition::Pointer MPMLineLoad3DCondition::Clone( IndexType NewId, NodesArrayType const& rThisNodes ) const
{
  MPMLineLoad3DCondition NewCondition( NewId, GetGeometry().Create( rThisNodes ), pGetProperties() );

  NewCondition.SetData(this->GetData());
  NewCondition.SetFlags(this->GetFlags());

  //-----------//      
  return Condition::Pointer( new MPMLineLoad3DCondition(NewCondition) );
}


//***********************************************************************************
//***********************************************************************************
MPMLineLoad3DCondition::~MPMLineLoad3DCondition()
{
}
...
void MPMLineLoad3DCondition::InitializeGeneralVariables(GeneralVariables& rVariables, const ProcessInfo& rCurrentProcessInfo)
{

  ForceLoadCondition::InitializeGeneralVariables(rVariables, rCurrentProcessInfo);

  
  //Calculate Total Delta Position !!ATTENTION: I changed the sign of the displacement..so j can be correctly evaluated
...
Matrix& MPMLineLoad3DCondition::CalculateDeltaPosition(Matrix & rDeltaPosition)
{
    KRATOS_TRY
...
Matrix& MPMLineLoad3DCondition::CalculateTotalDeltaPosition(Matrix & rDeltaPosition)
{
    KRATOS_TRY
...
void MPMLineLoad3DCondition::CalculateKinematics(GeneralVariables& rVariables,
...
Vector& MPMLineLoad3DCondition::CalculateVectorForce(Vector& rVectorForce, GeneralVariables& rVariables)
{
...
int MPMLineLoad3DCondition::Check( const ProcessInfo& rCurrentProcessInfo )
{
    return 0;
}
...
void MPMLineLoad3DCondition::save( Serializer& rSerializer ) const
{
    KRATOS_SERIALIZE_SAVE_BASE_CLASS( rSerializer, ForceLoadCondition )
}

void MPMLineLoad3DCondition::load( Serializer& rSerializer )
{
