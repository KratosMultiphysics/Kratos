...
#if !defined(KRATOS_MPM_LINE_LOAD_3D_CONDITION_H_INCLUDED )
#define  KRATOS_MPM_LINE_LOAD_3D_CONDITION_H_INCLUDED
 ...
 */
class KRATOS_API(PARTICLE_MECHANICS_APPLICATION) MPMLineLoad3DCondition
...
public:
    ...
    KRATOS_CLASS_POINTER_DEFINITION( MPMLineLoad3DCondition );
    ///@}
    ...
    /// Default constructor.
    MPMLineLoad3DCondition( IndexType NewId, GeometryType::Pointer pGeometry );

    MPMLineLoad3DCondition( IndexType NewId, GeometryType::Pointer pGeometry, PropertiesType::Pointer pProperties );

    /// Copy constructor
    MPMLineLoad3DCondition( MPMLineLoad3DCondition const& rOther);

    /// Destructor
    virtual ~MPMLineLoad3DCondition();
