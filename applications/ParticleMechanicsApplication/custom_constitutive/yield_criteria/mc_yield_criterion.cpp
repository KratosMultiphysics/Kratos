...
double& MCYieldCriterion::CalculateYieldCondition(double& rStateFunction, const Vector& rStressVector, const double& rAlpha)
{
    ...
    //std::cout<<" rStateFunction "<<rStateFunction<<std::endl;
    //std::cout<<" FrictionAngle "<<FrictionAngle<<std::endl;
    //std::cout<<" rStressVector(0) "<<rStressVector(0)<<std::endl;
    //std::cout<<" rStressVector(2) "<<rStressVector(2)<<std::endl;
...
//double& MCYieldCriterion::CalculateNormYieldFunctionDerivative(double& rNormStateFunctionDerivative)
//{
////double Cohesion = this->GetHardeningLaw().GetProperties()[COHESION];
//double FrictionAngle = this->GetHardeningLaw().GetProperties()[INTERNAL_FRICTION_ANGLE];
//double DilatancyAngle = this->GetHardeningLaw().GetProperties()[INTERNAL_DILATANCY_ANGLE];
...
//{
//rNormStateFunctionDerivative = sqrt(1 + FrictionCoefficient * FrictionCoefficient);
//}
//else //I am using a non-associative flow rule
//{
//rNormStateFunctionDerivative = sqrt(1 + DilatancyCoefficient * DilatancyCoefficient);
//}

//return rNormStateFunctionDerivative;

//}
//************************* YIELD FUNCTION DERIVATIVE ******************
//**********************************************************************
//void MCYieldCriterion::CalculateYieldFunctionDerivative(const Vector& rStressVector, Vector& rYieldFunctionD, const double& rAlpha)
//{
...
//void MCYieldCriterion::CalculateSmoothingConstants( MohrCoulombSmoothingConstants& rSmoothingConstants, const MohrCoulombStressInvariants& rStressInvariants)
//{
...
//void MCYieldCriterion::CalculateStressInvariants( const Vector& rStressVector, MohrCoulombStressInvariants& rStressInvariants)
//{
