...
#if !defined (KRATOS_HENCKY_MC_PLASTIC_PLANE_STRAIN_UP_2D_LAW_H_INCLUDED)
#define       KRATOS_HENCKY_MC_PLASTIC_PLANE_STRAIN_UP_2D_LAW_H_INCLUDED
...
class KRATOS_API(MPM_MECHANICS_APPLICATION) HenckyMCPlasticPlaneStrainUP2DLaw
...
public:
    ...
    KRATOS_CLASS_POINTER_DEFINITION( HenckyMCPlasticPlaneStrainUP2DLaw );
    ...
    HenckyMCPlasticPlaneStrainUP2DLaw(MPMFlowRulePointer pMPMFlowRule, YieldCriterionPointer pYieldCriterion, HardeningLawPointer pHardeningLaw);

    /**
     * Copy constructor.
     */
    HenckyMCPlasticPlaneStrainUP2DLaw (const HenckyMCPlasticPlaneStrainUP2DLaw& rOther);
     ...
     * Destructor.
     */
    ~HenckyMCPlasticPlaneStrainUP2DLaw() override;
...
private:
    ...
    {
        KRATOS_SERIALIZE_SAVE_BASE_CLASS( rSerializer, HenckyElasticPlasticPlaneStrainUP2DLaw )
    }

    void load(Serializer& rSerializer) override
    {
        KRATOS_SERIALIZE_LOAD_BASE_CLASS( rSerializer, HenckyElasticPlasticPlaneStrainUP2DLaw )
    }
