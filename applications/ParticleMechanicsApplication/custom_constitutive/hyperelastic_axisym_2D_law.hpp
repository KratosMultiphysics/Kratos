...
//
//  References:      This class is adapted from applications/SolidMechanicsApplication/custom_constitutive/hyperelastic_axisym_2D_law.hpp
...
class KRATOS_API(MPM_MECHANICS_APPLICATION) HyperElasticAxisym2DLaw : public HyperElastic3DLaw
{
public:
    /**
     * Type Definitions
