...
//
//  References:      This class is adapted from applications/SolidMechanicsApplication/custom_constitutive/linear_elastic_3D_law.hpp
...
class KRATOS_API(MPM_MECHANICS_APPLICATION) LinearElastic3DLaw : public HyperElastic3DLaw
{
public:
    /**
     * Type Definitions
