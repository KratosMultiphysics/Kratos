...
ParticleFlowRule::Pointer NonLinearAssociativePlasticFlowRule::Clone() const
{
	ParticleFlowRule::Pointer p_clone(new NonLinearAssociativePlasticFlowRule(*this));
	return p_clone;
}
...
void NonLinearAssociativePlasticFlowRule::SetCriterionParameters( RadialReturnVariables& rReturnMappingVariables, InternalVariables& rPlasticVariables, ParticleYieldCriterion::Parameters& rCriterionParameters )
{
...
bool NonLinearAssociativePlasticFlowRule::CalculateConsistencyCondition( RadialReturnVariables& rReturnMappingVariables, InternalVariables& rPlasticVariables, ParticleYieldCriterion::Parameters& rCriterionParameters )
{
...
void NonLinearAssociativePlasticFlowRule::CalculateImplexReturnMapping( RadialReturnVariables& rReturnMappingVariables, InternalVariables& rPlasticVariables, ParticleYieldCriterion::Parameters& rCriterionParameters, Matrix& rIsoStressMatrix )
{


        //1.-Computation of the plastic Multiplier
        rReturnMappingVariables.DeltaGamma = std::sqrt(3.0/2.0) * ( rPlasticVariables.EquivalentPlasticStrain - rPlasticVariables.EquivalentPlasticStrainOld );
...
void NonLinearAssociativePlasticFlowRule::CalculateThermalDissipation(ParticleYieldCriterion::Parameters& rCriterionParameters, ThermalVariables& rThermalVariables )
{
...
void NonLinearAssociativePlasticFlowRule::CalculateImplexThermalDissipation(ParticleYieldCriterion::Parameters& rCriterionParameters )
{
