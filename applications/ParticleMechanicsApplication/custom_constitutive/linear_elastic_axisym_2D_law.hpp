...
//
//  References:      This class is adapted from applications/SolidMechanicsApplication/custom_constitutive/linear_elastic_axisym_2D_law.cpp
...
class KRATOS_API(PARTICLE_MECHANICS_APPLICATION) LinearElasticAxisym2DLaw : public LinearElastic3DLaw
{
public:
    /**
     * Type Definitions
     ...
     * Destructor.
     */
    ~LinearElasticAxisym2DLaw() override;
