...
HyperElasticViscoplastic3DLaw::HyperElasticViscoplastic3DLaw()
    : HyperElastic3DLaw()
{
...
HyperElasticViscoplastic3DLaw::HyperElasticViscoplastic3DLaw(FlowRulePointer pFlowRule, YieldCriterionPointer pYieldCriterion, HardeningLawPointer pHardeningLaw)
    : HyperElastic3DLaw()
{
...
HyperElasticViscoplastic3DLaw::HyperElasticViscoplastic3DLaw(const HyperElasticViscoplastic3DLaw& rOther)
...
ConstitutiveLaw::Pointer HyperElasticViscoplastic3DLaw::Clone() const
{
    ConstitutiveLaw::Pointer p_clone(new HyperElasticViscoplastic3DLaw(*this));
    return p_clone;
}
...
bool HyperElasticViscoplastic3DLaw::Has( const Variable<double>& rThisVariable )
{
    return false;
}

bool HyperElasticViscoplastic3DLaw::Has( const Variable<Vector>& rThisVariable )
{
    return false;
}

bool HyperElasticViscoplastic3DLaw::Has( const Variable<Matrix>& rThisVariable )
{
    return false;
}
...
double& HyperElasticViscoplastic3DLaw::GetValue( const Variable<double>& rThisVariable, double& rValue )
{
...
Vector& HyperElasticViscoplastic3DLaw::GetValue( const Variable<Vector>& rThisVariable, Vector& rValue )
{
    return( rValue );
}

Matrix& HyperElasticViscoplastic3DLaw::GetValue( const Variable<Matrix>& rThisVariable, Matrix& rValue )
{
    return( rValue );
}
...
void HyperElasticViscoplastic3DLaw::SetValue( const Variable<double>& rThisVariable, const double& rValue,
...
void HyperElasticViscoplastic3DLaw::SetValue( const Variable<Vector>& rThisVariable, const Vector& rValue,
        const ProcessInfo& rCurrentProcessInfo )
{

}

void HyperElasticViscoplastic3DLaw::SetValue( const Variable<Matrix>& rThisVariable, const Matrix& rValue,
        const ProcessInfo& rCurrentProcessInfo )
{
...
void HyperElasticViscoplastic3DLaw::InitializeMaterial( const Properties& rMaterialProperties,
...
void HyperElasticViscoplastic3DLaw::InitializeSolutionStep( const Properties& rMaterialProperties,
...
void HyperElasticViscoplastic3DLaw::FinalizeSolutionStep( const Properties& rMaterialProperties,
        const GeometryType& rElementGeometry, //this is just to give the array of nodes
        const Vector& rShapeFunctionsValues,
        const ProcessInfo& rCurrentProcessInfo)
{
...
void  HyperElasticViscoplastic3DLaw::CalculateMaterialResponsePK2 (Parameters& rValues)
{
...
void HyperElasticViscoplastic3DLaw::CalculateMaterialResponseKirchhoff (Parameters& rValues)
{
    ...
    if( Options.Is( ConstitutiveLaw::COMPUTE_STRESS ) )
    {
        ...
        //ReturnMappingVariables.NormIsochoricStress = mpFlowRule->CalculateStressNorm( IsochoricStressMatrix, rReturnMappingVariables.NormIsochoricStress );
...
void HyperElasticViscoplastic3DLaw::CalculatePlasticIsochoricStress( MaterialResponseVariables & rElasticVariables,
...
void HyperElasticViscoplastic3DLaw::CalculatePlasticConstitutiveMatrix (const MaterialResponseVariables & rElasticVariables,
        FlowRule::RadialReturnVariables & rReturnMappingVariables,
...
double& HyperElasticViscoplastic3DLaw::PlasticConstitutiveComponent(double & rCabcd,
...
void HyperElasticViscoplastic3DLaw::GetLawFeatures(Features& rFeatures)
{
    //Set the type of law
...
bool HyperElasticViscoplastic3DLaw::CheckParameters(Parameters& rValues)
{
...
int HyperElasticViscoplastic3DLaw::Check(const Properties& rMaterialProperties,
        const GeometryType& rElementGeometry,
        const ProcessInfo& rCurrentProcessInfo)
{
