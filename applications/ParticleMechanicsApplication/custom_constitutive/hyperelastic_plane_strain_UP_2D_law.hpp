...
//
//  References:      This class is adapted from applications/SolidMechanicsApplication/custom_constitutive/hyperelastic_U_P_plane_strain_2D_law.cpp


#if !defined (KRATOS_HYPERELASTIC_PLANE_STRAIN_UP_2D_LAW_H_INCLUDED)
#define       KRATOS_HYPERELASTIC_PLANE_STRAIN_UP_2D_LAW_H_INCLUDED
...
class KRATOS_API(MPM_MECHANICS_APPLICATION) HyperElasticPlaneStrainUP2DLaw : public HyperElasticUP3DLaw
{
public:
    /**
     * Type Definitions
