...
//
//  References:      This class is adapted from applications/SolidMechanicsApplication/custom_constitutive/linear_elastic_plane_stress_2D_law.hpp
...
class KRATOS_API(PARTICLE_MECHANICS_APPLICATION) LinearElasticPlaneStress2DLaw : public LinearElasticPlaneStrain2DLaw
{
public:
    /**
     * Type Definitions
