...
class TestGenerateMPMParticleCondition(KratosUnittest.TestCase):
    ...
    def test_GenerateMPMParticleConditionTriangle3D16P(self):
        current_model = KratosMultiphysics.Model()
        self._generate_particle_condition_and_check(current_model, dimension=3, geometry_element="Triangle", num_particle=16, expected_num_particle=16)

    def test_GenerateMPMParticleConditionTriangle3D33P(self):
        current_model = KratosMultiphysics.Model()
        self._generate_particle_condition_and_check(current_model, dimension=3, geometry_element="Triangle", num_particle=33, expected_num_particle=33)
...
def test_GenerateMPMParticleConditionQuadrilateral3D1N(self):
        current_model = KratosMultiphysics.Model()
        self._generate_particle_condition_and_check(current_model, dimension=3, geometry_element="Quadrilateral", num_particle=1, expected_num_particle=1)
    ...
    def test_GenerateMPMParticleConditionQuadrilateral3D5N(self):
        current_model = KratosMultiphysics.Model()
        self._generate_particle_condition_and_check(current_model, dimension=3, geometry_element="Quadrilateral", num_particle=5, expected_num_particle=1)
