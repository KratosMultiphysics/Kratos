...
import KratosMultiphysics.ParticleMechanicsApplication as KratosMechanics
from KratosMultiphysics.ParticleMechanicsApplication import python_solvers_wrapper_particle
