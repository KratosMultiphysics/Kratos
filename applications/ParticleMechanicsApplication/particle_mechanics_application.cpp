...
namespace Kratos
{
    ...
    void KratosParticleMechanicsApplication::Register()
    {
        ...
        KRATOS_REGISTER_VARIABLE( MP_COMPACTION_RATIO)
        ...
        // CL: RHT Concrete
        KRATOS_REGISTER_VARIABLE(RHT_A)
        KRATOS_REGISTER_VARIABLE(RHT_N)
        KRATOS_REGISTER_VARIABLE(RHT_COMPRESSIVE_STRENGTH)
        KRATOS_REGISTER_VARIABLE(RHT_RELATIVE_SHEAR_STRENGTH)
        KRATOS_REGISTER_VARIABLE(RHT_RELATIVE_TENSILE_STRENGTH)
        KRATOS_REGISTER_VARIABLE(RHT_Q0)
        KRATOS_REGISTER_VARIABLE(RHT_B)
        KRATOS_REGISTER_VARIABLE(REFERENCE_TENSION_STRAIN_RATE)
        KRATOS_REGISTER_VARIABLE(REFERENCE_COMPRESSION_STRAIN_RATE)
        KRATOS_REGISTER_VARIABLE(RHT_GC_STAR)
        KRATOS_REGISTER_VARIABLE(RHT_GT_STAR)
        KRATOS_REGISTER_VARIABLE(RHT_SHEAR_MOD_REDUCTION_FACTOR)
        KRATOS_REGISTER_VARIABLE(RHT_D1)
        KRATOS_REGISTER_VARIABLE(RHT_D2)
        KRATOS_REGISTER_VARIABLE(RHT_MIN_DAMAGED_RESIDUAL_STRAIN)
        KRATOS_REGISTER_VARIABLE(RHT_AF)
        KRATOS_REGISTER_VARIABLE(RHT_NF)
        KRATOS_REGISTER_VARIABLE(RHT_EOS_A1)
        KRATOS_REGISTER_VARIABLE(RHT_EOS_A2)
        KRATOS_REGISTER_VARIABLE(RHT_EOS_A3)
        KRATOS_REGISTER_VARIABLE(RHT_EOS_B0)
        KRATOS_REGISTER_VARIABLE(RHT_EOS_B1)
        KRATOS_REGISTER_VARIABLE(RHT_EOS_T1)
        KRATOS_REGISTER_VARIABLE(RHT_EOS_T2)
        KRATOS_REGISTER_VARIABLE(RHT_EOS_ALPHA0)
        KRATOS_REGISTER_VARIABLE(RHT_EOS_NP)
        KRATOS_REGISTER_VARIABLE(RHT_CRUSH_PRESSURE)
        KRATOS_REGISTER_VARIABLE(RHT_COMPACTION_PRESSURE)
        ...
        // CL: RHT Concrete
        KRATOS_REGISTER_CONSTITUTIVE_LAW("RHTConcrete3DLaw", mRHTConcrete3DLaw);
        KRATOS_REGISTER_CONSTITUTIVE_LAW("RHTConcretePlaneStrain2DLaw", mRHTConcretePlaneStrain2DLaw);
        KRATOS_REGISTER_CONSTITUTIVE_LAW("RHTConcreteAxisym2DLaw", mRHTConcreteAxisym2DLaw);
