...
namespace Kratos
{
    ...
    void KratosParticleMechanicsApplication::Register()
    {
        ...
        KRATOS_REGISTER_VARIABLE( MP_RADIUS )
        ...
        KRATOS_REGISTER_VARIABLE( MP_DAMAGE )
        KRATOS_REGISTER_VARIABLE( IS_TRANSFERRED_TO_CONTACT_MP )
        ...
        KRATOS_REGISTER_VARIABLE( FRACTURE_TOUGHNESS)
        KRATOS_REGISTER_VARIABLE( JC_D1)
        KRATOS_REGISTER_VARIABLE( JC_D2)
        KRATOS_REGISTER_VARIABLE( JC_D3)
        KRATOS_REGISTER_VARIABLE( JC_D4)
        KRATOS_REGISTER_VARIABLE( JC_D5)
        // CL: d+/d- Damage
        KRATOS_REGISTER_VARIABLE(DAMAGE_TENSION)
        KRATOS_REGISTER_VARIABLE(UNIAXIAL_STRESS_TENSION)
        KRATOS_REGISTER_VARIABLE(UNIAXIAL_STRAIN_TENSION)
        KRATOS_REGISTER_VARIABLE(UNIAXIAL_DAMAGED_STRESS_TENSION)
        ...
        KRATOS_REGISTER_VARIABLE(UNIAXIAL_STRAIN_COMPRESSION)
        KRATOS_REGISTER_VARIABLE(UNIAXIAL_DAMAGED_STRESS_COMPRESSION)
        ...
        KRATOS_REGISTER_VARIABLE(BEZIER_CONTROLLER_S1)
        KRATOS_REGISTER_VARIABLE(BEZIER_CONTROLLER_EP1)
        KRATOS_REGISTER_VARIABLE(BEZIER_CONTROLLER_EP2)
        KRATOS_REGISTER_VARIABLE(BEZIER_CONTROLLER_EP3)
        KRATOS_REGISTER_VARIABLE(BEZIER_CONTROLLER_EP4)
        KRATOS_REGISTER_VARIABLE(SHEAR_COMPRESSION_REDUCTOR)
        KRATOS_REGISTER_VARIABLE(STRAIN_RATE_FACTOR_C1_TENSION)
        KRATOS_REGISTER_VARIABLE(STRAIN_RATE_FACTOR_C2_TENSION)
        KRATOS_REGISTER_VARIABLE(STRAIN_RATE_FACTOR_C1_COMPRESSION)
        KRATOS_REGISTER_VARIABLE(STRAIN_RATE_FACTOR_C2_COMPRESSION)
        KRATOS_REGISTER_VARIABLE(STRAIN_RATE_FACTOR_C1_YOUNGS_MOD)
        KRATOS_REGISTER_VARIABLE(STRAIN_RATE_FACTOR_C2_YOUNGS_MOD)
        KRATOS_REGISTER_VARIABLE(TENSION_YIELD_MODEL)
        KRATOS_REGISTER_VARIABLE(PLASTICITY_FACTOR_B_MINUS)
        KRATOS_REGISTER_VARIABLE(IS_STEEL_FIBRE_REINFORCED_CONCRETE)
        ...
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS( MP_TOTAL_DISPLACEMENT )
        ...
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(AUX_MOMENTA)
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(AUX_INERTIA)
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(AUX_RESIDUAL)
        KRATOS_REGISTER_VARIABLE(AUX_MASS)
        ...
        KRATOS_REGISTER_VARIABLE(EXPLICIT_CONTACT_RELEASE)
        KRATOS_REGISTER_VARIABLE(EXPLICIT_CONTACT_RELEASE_MODEL_PART)
        ...
        KRATOS_REGISTER_VARIABLE(PQMPM_IS_MAKE_NORMAL_MP_ON_BC)

        // CoSim coupling variables
        KRATOS_REGISTER_VARIABLE(INTERFACE_EQUATION_ID)
        KRATOS_REGISTER_VARIABLE(IS_COSIM_COUPLED)
    }
