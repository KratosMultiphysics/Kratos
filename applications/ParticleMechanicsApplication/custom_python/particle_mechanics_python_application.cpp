...
namespace Python{
    ...
    PYBIND11_MODULE(KratosParticleMechanicsApplication, m)
    {
        ...
        KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, MPC_CORRESPONDING_CONDITION_ID);
        ...
        KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, MPC_ID_LIST )
        KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, MPC_AREA_LIST )
