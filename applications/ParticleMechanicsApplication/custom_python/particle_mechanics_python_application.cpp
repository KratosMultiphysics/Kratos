...
namespace Python{
    ...
    PYBIND11_MODULE(KratosParticleMechanicsApplication, m)
    {
        ...
        KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, MP_RADIUS);
        ...
        KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, IS_TRANSFERRED_TO_CONTACT_MP);
        ...
        KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, IS_DEFORM_MESH);
        ...
        KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, MP_TOTAL_DISPLACEMENT);
        ...
        KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, PQMPM_IS_MAKE_NORMAL_MP_ON_BC);
        ...
        KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, EXPLICIT_CONTACT_RELEASE);
        KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, EXPLICIT_CONTACT_RELEASE_MODEL_PART);
        KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, AUX_MOMENTA);
        KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, AUX_INERTIA);
        KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, AUX_RESIDUAL);
        KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, AUX_MASS);
    }
