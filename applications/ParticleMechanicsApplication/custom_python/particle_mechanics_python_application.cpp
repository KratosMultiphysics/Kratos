...
namespace Python{
    ...
    PYBIND11_MODULE(KratosParticleMechanicsApplication, m)
    {
        ...
        KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, WEIGHTED_VECTOR_RESIDUAL );
        KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, STABILIZATION_LAGRANGE_MULTIPLIER);
        KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, AUGMENTATION_FACTOR);
