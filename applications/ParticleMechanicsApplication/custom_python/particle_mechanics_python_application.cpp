...
namespace Python{
    ...
    PYBIND11_MODULE(KratosParticleMechanicsApplication, m)
    {
        ...
        KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, PQMPM_SEARCH_FACTOR);
        KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, IS_PQMPM_FALLBACK_TO_MPM);
        KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, PQMPM_MIN_FRACTION);
