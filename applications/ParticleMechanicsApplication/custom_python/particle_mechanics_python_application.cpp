...
//	def("CreateUpdatedLagragianUP2D4N", &CreateUpdatedLagragianUP2D4N);
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, MP_DISPLACEMENT);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, MP_VELOCITY);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, MP_ACCELERATION);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, AUX_MP_VELOCITY);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, AUX_MP_ACCELERATION);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, MP_VOLUME_ACCELERATION);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, NODAL_INTERNAL_FORCE);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, DISPLACEMENT_AUX);
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, NODAL_MOMENTUM);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, NODAL_INERTIA);
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,  AUX_R_VEL )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,  AUX_T_VEL )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,  AUX_R_ACC )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,  AUX_T_ACC )
