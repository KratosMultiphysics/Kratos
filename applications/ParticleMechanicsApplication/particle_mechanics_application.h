...
private:
    ...
    const MPMParticleAxisymPenaltyDirichletCondition2D mMPMParticleAxisymPenaltyDirichletCondition2D3N;
    const MPMParticleAxisymPenaltyDirichletCondition2D mMPMParticleAxisymPenaltyDirichletCondition2D4N;
