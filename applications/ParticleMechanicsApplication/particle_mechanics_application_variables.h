...
namespace Kratos
{
    ...
    // For friction
    KRATOS_DEFINE_APPLICATION_VARIABLE(PARTICLE_MECHANICS_APPLICATION, double, NORMAL_REACTION)
    KRATOS_DEFINE_APPLICATION_VARIABLE(PARTICLE_MECHANICS_APPLICATION, double, MAX_TANGENT_FORCE)
