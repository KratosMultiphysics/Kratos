...
namespace Kratos
{
    ...
    KRATOS_DEFINE_APPLICATION_VARIABLE(PARTICLE_MECHANICS_APPLICATION, double, PQMPM_SEARCH_FACTOR)
    KRATOS_DEFINE_APPLICATION_VARIABLE(PARTICLE_MECHANICS_APPLICATION, bool, IS_PQMPM_FALLBACK_TO_MPM)
    KRATOS_DEFINE_APPLICATION_VARIABLE(PARTICLE_MECHANICS_APPLICATION, double, PQMPM_MIN_FRACTION)
