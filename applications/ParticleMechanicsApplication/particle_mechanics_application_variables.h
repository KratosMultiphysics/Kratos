...
namespace Kratos
{
    ...
    KRATOS_DEFINE_APPLICATION_VARIABLE(PARTICLE_MECHANICS_APPLICATION, bool, MUSL_VELOCITY_FIELD_IS_COMPUTED)
    ...
    KRATOS_DEFINE_APPLICATION_VARIABLE(PARTICLE_MECHANICS_APPLICATION, bool, IS_ACTIVE_MPM_EXPLICIT_NODE)
}
