...
class PureDiffusionSolver(PythonSolver):
    ...
    def __init__(self, model, custom_settings):  # Constructor of the class        
        ...
        self.element_name = "MyStochasticLaplacianElement"
    ...
    def Finalize(self):
        ...
        gid_io = KratosMultiphysics.GidIO("MonteCarloPoisson", gid_mode,multifile, deformed_mesh_flag, write_conditions)
    ...
    def _ValidateSettings(self, settings):
        ...
        "input_type"     : "mdpa",
        "input_filename" : "../tests/FirstTestFinerMesh/FirstTestFinerMesh"
        },
        "model_part_name" : "StochasticLaplacianModelPart",
        "buffer_size"     : 2,
        "domain_size"     : 2,
        "echo_level"                         : 1,
	...
	"move_mesh_flag"             	     : false,
        ...
        "processes_sub_model_part_list"      : ["PointLoad2D_Domain"],
