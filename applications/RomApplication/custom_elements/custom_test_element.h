...
#define KRATOS_CUSTOM_TEST_ELEMENT_H_INCLUDED
...
class CustomTestElement : public Element
{
public:
    ...
    /// Pointer definition of CustomTestElement
    KRATOS_CLASS_INTRUSIVE_POINTER_DEFINITION(CustomTestElement);
     ...
     * Constructor.
     */
    CustomTestElement(IndexType NewId = 0);

    /**
     * Constructor using an array of nodes
     */
    CustomTestElement(IndexType NewId, const NodesArrayType& ThisNodes);

    /**
     * Constructor using Geometry
     */
    CustomTestElement(IndexType NewId, GeometryType::Pointer pGeometry);

    /**
     * Constructor using Properties
     */
    CustomTestElement(IndexType NewId, GeometryType::Pointer pGeometry, PropertiesType::Pointer pProperties);

    /**
     * Copy Constructor
     */
    CustomTestElement(CustomTestElement const& rOther);

    /**
     * Destructor
     */
    ~CustomTestElement() override;
    ...
    /// Assignment operator.
    CustomTestElement & operator=(CustomTestElement const& rOther);
...
#endif // KRATOS_CUSTOM_TEST_ELEMENT_H_INCLUDED  defined
