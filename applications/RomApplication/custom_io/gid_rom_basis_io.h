...
class GidRomBasisIO : public GidIO<>
{
  public:
    ...
    /// Pointer definition of GidRomBasisIO
    KRATOS_CLASS_POINTER_DEFINITION(GidRomBasisIO);
    ...
    /// Default constructor.
    GidRomBasisIO( const std::string& rDatafilename,
                GiD_PostMode Mode,
    ...
    */
                            ...
                            const SizeType NumberOfAnimationStep )
    {
        ...
        GiD_fBeginResult( mResultFile, (char*)Label.c_str() , "RomBasis_Animation",
    ...
    */
    ...
    std::string Info() const override
    {
        ...
        buffer << "GidRomBasisIO" ;
        return buffer.str();
    }

    /// Print information about this object.
    void PrintInfo(std::ostream& rOStream) const override {rOStream << "GidRomBasisIO";}
...
#endif // KRATOS_GID_ROM_BASIS_IO_H_INCLUDED  defined
