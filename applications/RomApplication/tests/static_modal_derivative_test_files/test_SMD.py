...
try:
    import json
    from .MainKratosSMD import StructuralMechanicsModalDerivativeAnalysisMSConstraints
    json_available = True
except:
...
class TestStaticModalDerivative(KratosUnittest.TestCase):
    ...
    def test_structural_mechanics_static_modal_derivative(self):
