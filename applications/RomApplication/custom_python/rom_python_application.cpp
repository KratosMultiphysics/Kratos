...
PYBIND11_MODULE(KratosRomApplication,m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, ROM_CURRENT_NON_LINEAR_INCREMENT )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, ROM_LAST_SOLUTION_TOTAL )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, ROM_CURRENT_SOLUTION_TOTAL )
