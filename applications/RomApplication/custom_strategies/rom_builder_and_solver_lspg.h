...
#if !defined(KRATOS_ROM_BUILDER_AND_SOLVER_LSPG)
#define KRATOS_ROM_BUILDER_AND_SOLVER_LSPG
...
public:
    ...
    Parameters GetDefaultParameters() const override
    {
        ...
        {
            "name" : "rom_builder_and_solver_lspg",
            "nodal_unknowns" : [],
    ...
    {
        return "rom_builder_and_solver_lspg";
    }
...
#endif /* KRATOS_ROM_BUILDER_AND_SOLVER_LSPG  defined */
