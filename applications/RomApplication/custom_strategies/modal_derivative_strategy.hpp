...
public:
        ...
        mpBuilderAndSolver(pBuilderAndSolver)
    {
        ...
        if (mDerivativeType == DerivativeType::Static)   // Static derivatives wrt modal parameters are symmetric
            rModelPart.GetProcessInfo()[EIGENVALUE_VECTOR].resize(mNumberInitialBasis + mNumberInitialBasis * ( mNumberInitialBasis + 1 ) / 2, true);
        else    // Dynamic derivatives wrt modal parameters are unsymmetric
