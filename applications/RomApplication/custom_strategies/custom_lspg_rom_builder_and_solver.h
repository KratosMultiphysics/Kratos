...
/**
 * @class CustomLeastSquaresPetrovGalerkinROMBuilderAndSolver
 * @ingroup RomApplication
 * @brief Current class provides an implementation for CurrentLeastSquaresPetrovGalerkinROM builder and solving operations.
...
class CustomLeastSquaresPetrovGalerkinROMBuilderAndSolver : public CustomROMBuilderAndSolver<TSparseSpace, TDenseSpace, TLinearSolver>
{
public:
    ...
    KRATOS_CLASS_POINTER_DEFINITION(CustomLeastSquaresPetrovGalerkinROMBuilderAndSolver);
    ...
    typedef CustomLeastSquaresPetrovGalerkinROMBuilderAndSolver<TSparseSpace, TDenseSpace, TLinearSolver> ClassType;

    /// Definition of the classes from the base class
    typedef CustomROMBuilderAndSolver<TSparseSpace, TDenseSpace, TLinearSolver> BaseType;
    ...
    explicit CustomLeastSquaresPetrovGalerkinROMBuilderAndSolver(
    ...
    ~CustomLeastSquaresPetrovGalerkinROMBuilderAndSolver() = default;
        ...
        ModelPart &rModelPart) override
    {
        ...
        KRATOS_INFO_IF("CustomLeastSquaresPetrovGalerkinROMBuilderAndSolver", (this->GetEchoLevel() > 1)) << "Setting up the dofs" << std::endl;
        KRATOS_INFO_IF("CustomLeastSquaresPetrovGalerkinROMBuilderAndSolver", (this->GetEchoLevel() > 2)) << "Number of threads" << ParallelUtilities::GetNumThreads() << "\n" << std::endl;
        KRATOS_INFO_IF("CustomLeastSquaresPetrovGalerkinROMBuilderAndSolver", (this->GetEchoLevel() > 2)) << "Initializing element loop" << std::endl;
        ...
        KRATOS_INFO_IF("CustomLeastSquaresPetrovGalerkinROMBuilderAndSolver", (this->GetEchoLevel() > 2)) << "Initializing ordered array filling\n" << std::endl;
        ...
        KRATOS_INFO_IF("CustomLeastSquaresPetrovGalerkinROMBuilderAndSolver", (this->GetEchoLevel() > 2)) << "Number of degrees of freedom:" << BaseType::GetDofSet().size() << std::endl;
        KRATOS_INFO_IF("CustomLeastSquaresPetrovGalerkinROMBuilderAndSolver", (this->GetEchoLevel() > 2)) << "Finished setting up the dofs" << std::endl;
    ...
    Parameters GetDefaultParameters() const override
    {
        ...
        {
            "name" : "custom_lspg_rom_builder_and_solver",
            "nodal_unknowns" : [],
    ...
    {
        return "custom_lspg_rom_builder_and_solver";
    }
    ...
    {
        return "CustomLeastSquaresPetrovGalerkinROMBuilderAndSolver";
    }
...
protected:
    ...
    */
        ...
        LSPGSystemVectorType &rb) override
    {
        ...
        KRATOS_INFO_IF("CustomLeastSquaresPetrovGalerkinROMBuilderAndSolver", (this->GetEchoLevel() > 0)) << "Build time: " << assembling_timer.ElapsedSeconds() << std::endl;
        KRATOS_INFO_IF("CustomLeastSquaresPetrovGalerkinROMBuilderAndSolver", (this->GetEchoLevel() > 2)) << "Finished parallel building" << std::endl;
        ...
        TSystemVectorType &rDx) override
    {
        ...
        KRATOS_INFO_IF("CustomLeastSquaresPetrovGalerkinROMBuilderAndSolver", (this->GetEchoLevel() > 0)) << "Solve reduced system time: " << solving_timer.ElapsedSeconds() << std::endl;
        ...
        KRATOS_INFO_IF("CustomLeastSquaresPetrovGalerkinROMBuilderAndSolver", (this->GetEchoLevel() > 0)) << "Project to fine basis time: " << backward_projection_timer.ElapsedSeconds() << std::endl;
        ...
        LSPGSystemVectorType &rb) 
    {
        ...
        KRATOS_INFO_IF("CustomLeastSquaresPetrovGalerkinROMBuilderAndSolver", (this->GetEchoLevel() > 0)) << "Write residuals to train Petrov Galerkin time: " << residual_writing_timer.ElapsedSeconds() << std::endl;
        KRATOS_CATCH("")
    }
