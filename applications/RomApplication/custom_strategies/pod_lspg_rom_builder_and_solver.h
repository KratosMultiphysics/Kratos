...
/**
 * @class PODLeastSquaresPetrovGalerkinROMBuilderAndSolver
 * @ingroup RomApplication
 * @brief This class provides an implementation for the PODLeastSquaresPetrovGalerkinROM builder and solver operations.
 * This B&S now inherits from the PODGlobalROMBuilderAndSolver, which in turn inherits
...
class PODLeastSquaresPetrovGalerkinROMBuilderAndSolver : public PODGlobalROMBuilderAndSolver<TSparseSpace, TDenseSpace, TLinearSolver>
{
public:
    ...
    KRATOS_CLASS_POINTER_DEFINITION(PODLeastSquaresPetrovGalerkinROMBuilderAndSolver);
    ...
    using ClassType = PODLeastSquaresPetrovGalerkinROMBuilderAndSolver<TSparseSpace, TDenseSpace, TLinearSolver>;

    /// Definition of the classes from the base class
    using BaseBuilderAndSolverType = BuilderAndSolver<TSparseSpace, TDenseSpace, TLinearSolver>;
    using BaseType = PODGlobalROMBuilderAndSolver<TSparseSpace, TDenseSpace, TLinearSolver>;
    ...
    explicit PODLeastSquaresPetrovGalerkinROMBuilderAndSolver(
    ...
    ~PODLeastSquaresPetrovGalerkinROMBuilderAndSolver() = default;
        ...
        ModelPart &rModelPart) override
    {
        ...
        KRATOS_INFO_IF("PODGlobalLeastSquaresPetrovGalerkinROMBuilderAndSolver", (BaseType::GetEchoLevel() > 1)) << "Setting up the dofs" << std::endl;
        KRATOS_INFO_IF("PODGlobalLeastSquaresPetrovGalerkinROMBuilderAndSolver", (BaseType::GetEchoLevel() > 2)) << "Number of threads" << ParallelUtilities::GetNumThreads() << "\n" << std::endl;
        KRATOS_INFO_IF("PODGlobalLeastSquaresPetrovGalerkinROMBuilderAndSolver", (BaseType::GetEchoLevel() > 2)) << "Initializing element loop" << std::endl;
        ...
        KRATOS_INFO_IF("PODGlobalLeastSquaresPetrovGalerkinROMBuilderAndSolver", (BaseType::GetEchoLevel() > 2)) << "Initializing ordered array filling\n" << std::endl;
        ...
        KRATOS_INFO_IF("PODGlobalLeastSquaresPetrovGalerkinROMBuilderAndSolver", (BaseType::GetEchoLevel() > 2)) << "Number of degrees of freedom:" << BaseType::GetDofSet().size() << std::endl;
        KRATOS_INFO_IF("PODGlobalLeastSquaresPetrovGalerkinROMBuilderAndSolver", (BaseType::GetEchoLevel() > 2)) << "Finished setting up the dofs" << std::endl;
        ...
        TSystemVectorType &rDx) override
    {
        ...
        KRATOS_INFO_IF("PODLeastSquaresPetrovGalerkinROMBuilderAndSolver", (BaseType::GetEchoLevel() > 0)) << "Build and project time: " << time << std::endl;
    ...
    Parameters GetDefaultParameters() const override
    {
        ...
        {
            "name" : "pod_lspg_rom_builder_and_solver",
            "nodal_unknowns" : [],
    ...
    {
        return "pod_lspg_rom_builder_and_solver";
    }
    ...
    {
        return "PODLeastSquaresPetrovGalerkinROMBuilderAndSolver";
    }
