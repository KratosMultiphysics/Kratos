...
#if !defined(KRATOS_LOCAL_ROM_BUILDER_AND_SOLVER)
#define KRATOS_LOCAL_ROM_BUILDER_AND_SOLVER
...
class LocalROMBuilderAndSolver : public ROMBuilderAndSolver<TSparseSpace, TDenseSpace, TLinearSolver>
{
public:
    ...
    KRATOS_CLASS_POINTER_DEFINITION(LocalROMBuilderAndSolver);
    ...
    typedef LocalROMBuilderAndSolver<TSparseSpace, TDenseSpace, TLinearSolver> ClassType;
    ...
    explicit LocalROMBuilderAndSolver(
    ...
    ~LocalROMBuilderAndSolver() = default;
        ...
        ModelPart &rModelPart) override
    {
        ...
        KRATOS_INFO_IF("LocalROMBuilderAndSolver", (this->GetEchoLevel() > 1)) << "Setting up the dofs" << std::endl;
        KRATOS_INFO_IF("LocalROMBuilderAndSolver", (this->GetEchoLevel() > 2)) << "Number of threads" << ParallelUtilities::GetNumThreads() << "\n" << std::endl;
        KRATOS_INFO_IF("LocalROMBuilderAndSolver", (this->GetEchoLevel() > 2)) << "Initializing element loop" << std::endl;
        ...
        KRATOS_INFO_IF("LocalROMBuilderAndSolver", (this->GetEchoLevel() > 2)) << "Initializing ordered array filling\n" << std::endl;
        ...
        KRATOS_INFO_IF("LocalROMBuilderAndSolver", (this->GetEchoLevel() > 2)) << "Number of degrees of freedom:" << BaseType::GetDofSet().size() << std::endl;
        KRATOS_INFO_IF("LocalROMBuilderAndSolver", (this->GetEchoLevel() > 2)) << "Finished setting up the dofs" << std::endl;
    ...
    {
        return "LocalROMBuilderAndSolver";
    }
...
protected:
    ...
    */
        ...
        RomSystemVectorType &rb)
    {
        ...
        KRATOS_INFO_IF("LocalROMBuilderAndSolver", (this->GetEchoLevel() > 0)) << "Build time: " << assembling_timer.ElapsedSeconds() << std::endl;
        KRATOS_INFO_IF("LocalROMBuilderAndSolver", (this->GetEchoLevel() > 2)) << "Finished parallel building" << std::endl;
        ...
        TSystemVectorType &rDx)
    {
        ...
        // KRATOS_WATCH(dxrom)
        KRATOS_INFO_IF("LocalROMBuilderAndSolver", (this->GetEchoLevel() > 0)) << "Solve reduced system time: " << solving_timer.ElapsedSeconds() << std::endl;
        ...
        KRATOS_INFO_IF("LocalROMBuilderAndSolver", (this->GetEchoLevel() > 0)) << "Project to fine basis time: " << backward_projection_timer.ElapsedSeconds() << std::endl;
...
private:
    ...
    ///@}
}; /* Class LocalROMBuilderAndSolver */
...
#endif /* KRATOS_LOCAL_ROM_BUILDER_AND_SOLVER  defined */