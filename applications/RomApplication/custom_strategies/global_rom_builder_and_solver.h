...
public:
    ...
    //     Eigen::Map<EigenDynamicVector> eigen_rRomUnkowns(rRomUnkowns.data().begin(), rRomUnkowns.size());
    //     Eigen::Map<EigenDynamicMatrix> eigen_mPhiGlobal(mPhiGlobal.data().begin(), mPhiGlobal.size1(), mPhiGlobal.size2());

    //     // Compute the matrix multiplication
    //     eigen_rRomUnkowns += eigen_mPhiGlobal.transpose() * eigen_rDx; //TODO: Make it in parallel.
    // }
