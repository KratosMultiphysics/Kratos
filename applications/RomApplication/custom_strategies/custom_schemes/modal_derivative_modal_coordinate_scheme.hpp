...
protected:
         ...
         const ProcessInfo& rCurrentProcessInfo)
    {
        ...
        noalias(rElementMatrixDerivative) = (element_matrix_p_perturbed - element_matrix) / BaseType::mFiniteDifferenceStepSize;
         ...
         const ProcessInfo& rCurrentProcessInfo)
    {
        ...
        noalias(rElementMatrixDerivative) = (element_matrix_p_perturbed - element_matrix_n_perturbed) / (2.0 * BaseType::mFiniteDifferenceStepSize);
