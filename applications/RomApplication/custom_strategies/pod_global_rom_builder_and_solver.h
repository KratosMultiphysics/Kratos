...
public:
        ...
        TSystemVectorType &b) override
    {
        ...
        // EigenDynamicVector eigen_b_error = eigen_b - (mEigen_b_theor_last + eigen_A * eigen_Dx.transpose());
...
protected:
        ...
        TSystemVectorType &rDx)
    {
        ...
        KRATOS_INFO_IF("AnnPromGlobalROMBuilderAndSolver", (this->GetEchoLevel() >= 0)) << "SolveROM: xrom (fin)" << r_root_mp.GetValue(ROM_SOLUTION_INCREMENT) << std::endl;
