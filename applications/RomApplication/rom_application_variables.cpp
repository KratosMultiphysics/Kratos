...
namespace Kratos
{
    ...
    KRATOS_CREATE_VARIABLE( Vector, HROM_WEIGHT )
    ...
    KRATOS_CREATE_VARIABLE( Matrix, W_MAT )
    KRATOS_CREATE_VARIABLE( Matrix, CENTERS_MAT )
    KRATOS_CREATE_VARIABLE( IndexType, KERNEL_TYPE )
    KRATOS_CREATE_VARIABLE( double, KERNEL_EPS )
