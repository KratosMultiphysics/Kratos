...
namespace Kratos
{
    ...
    KRATOS_DEFINE_APPLICATION_VARIABLE( ROM_APPLICATION, unsigned int, DERIVATIVE_PARAMETER_TYPE )
    KRATOS_DEFINE_APPLICATION_VARIABLE( ROM_APPLICATION, double, MODAL_COORDINATE )
