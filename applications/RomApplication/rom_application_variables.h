...
namespace Kratos
{
    ...
    KRATOS_DEFINE_APPLICATION_VARIABLE( ROM_APPLICATION, Matrix, NODAL_ROM_BASIS )
    KRATOS_DEFINE_APPLICATION_VARIABLE( ROM_APPLICATION, Matrix, ELEMENTAL_ROM_BASIS )
}
