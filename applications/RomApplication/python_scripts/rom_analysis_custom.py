    ...
    class CustomRomAnalysis(cls):
        ...
        def _ConfigureEncoderDecoder(self):
            ...
            e.g. for POD: 
                          ...
                          self.phi=np.load('phi.npy')[:,:rom_dofs]
            """
        ...
        def ModifyAfterSolverInitialize(self):
            ...
            # Set the right nodal ROM basis --- THIS IS DONE LATER, AT INITIALIZE SOLUTION STEP
        ...
        def InitializeSolutionStep(self):
            ...
            ### Checking reconstruction error of u
            NSPredict_d = self._DecodeSnapshot(self._EncodeSnapshot(s))
            print("Shape of S:", s.shape)
            print("Shape of NSPredict_d:", NSPredict_d.shape)
            print("Shape of q:", q.shape)

            s__norm = np.linalg.norm(s)
            sp_norm = np.linalg.norm(NSPredict_d-s)
            ...
            nodal_modes_d = self._GetDecoderGradient(q)

            rom_dofs = nodal_modes_d.shape[1]
            ...
            self._GetSolver()._GetBuilderAndSolver().SetNumberOfROMModes(rom_dofs)
