...
class MeshioOutputProcess(KratosMultiphysics.OutputProcess):
    ...
    in this build with KratosMeshioPlusPlus.MeshioPlusPlusIO.GetSupportedWriteFormats().
    """
    ...
    def __init__(self, model: KratosMultiphysics.Model, settings: KratosMultiphysics.Parameters) -> None:
        ...
        for key in ("format", "file_format", "skin", "time_series", "output_control_type",
                    ...
                    "write_deformed_configuration", "write_ids", "write_mdpa_ids",
                    "provenance",
        ...
        self.meshio_io = KratosMeshioPlusPlus.MeshioPlusPlusIO(str(file_name), io_settings)
