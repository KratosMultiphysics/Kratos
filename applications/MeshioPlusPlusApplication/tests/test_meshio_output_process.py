...
from KratosMultiphysics.MeshioPlusPlusApplication.meshio_output_process import Factory as MeshioOutputProcessFactory
...
class TestMeshioOutputProcess(KratosUnittest.TestCase):
    ...
    def testProcessIsRegistered(self):
        self.assertTrue(KratosMultiphysics.Registry.HasItem("Processes.KratosMultiphysics.MeshioPlusPlusApplication.MeshioOutputProcess"))
