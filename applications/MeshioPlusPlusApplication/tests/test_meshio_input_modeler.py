...
from KratosMultiphysics.MeshioPlusPlusApplication.modelers.meshio_input_modeler import Factory as MeshioInputModelerFactory
...
class TestMeshioInputModeler(KratosUnittest.TestCase):
    ...
    def testModelerIsRegistered(self):
        self.assertTrue(KratosMultiphysics.Registry.HasItem("Modelers.KratosMultiphysics.MeshioPlusPlusApplication.MeshioInputModeler"))
