...
class TransferModeler(mesh_modeler.MeshModeler):
    ...
    def InitializeMeshing(self):
        ...
        execution_options.Set(KratosPfem.ModelerUtilities.TRANSFER_KRATOS_ELEMENTS_TO_MESHER, True)
        execution_options.Set(KratosPfem.ModelerUtilities.TRANSFER_KRATOS_NEIGHBOURS_TO_MESHER, True)
   ...
   #
    def SetPostMeshingProcesses(self):
        ...
        #rebuild boundary
        rebuild_mesh_boundary = KratosPfem.ReconstructMeshBoundary(self.model_part, self.MeshingParameters, self.echo_level)
