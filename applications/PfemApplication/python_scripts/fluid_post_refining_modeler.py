...
class PostRefiningModeler(mesh_modeler.MeshModeler):
    ...
    def SetPreMeshingProcesses(self):
        ...
        #remove_mesh_nodes = KratosPfem.RemoveMeshNodesForFluids(self.main_model_part, self.MeshingParameters, self.echo_level)
        #self.mesher.SetPreMeshingProcess(remove_mesh_nodes)
        # no process to start
         #generate_new_nodes  = KratosPfem.GenerateNewNodesBeforeMeshing(self.main_model_part, self.MeshingParameters, self.echo_level)
   ...
   #
    def SetPostMeshingProcesses(self):
        ...
        #generate_particles  = KratosDelaunay.GenerateNewNodes(self.main_model_part, self.MeshingParameters, self.echo_level)
        ...
        select_mesh_elements  = KratosPfem.SelectMeshElementsForFluids(self.main_model_part, self.MeshingParameters, self.echo_level)
        self.mesher.SetPostMeshingProcess(select_mesh_elements)
        ...
        #rebuild boundary
        rebuild_mesh_boundary = KratosDelaunay.ReconstructMeshBoundary(self.main_model_part, self.MeshingParameters, self.echo_level)
    ...
    def FinalizeMeshing(self):
        ...
        execution_options.Set(KratosDelaunay.ModelerUtilities.TRANSFER_KRATOS_ELEMENTS_TO_MESHER, False)
        execution_options.Set(KratosDelaunay.ModelerUtilities.TRANSFER_KRATOS_NEIGHBOURS_TO_MESHER, False)
        execution_options.Set(KratosDelaunay.ModelerUtilities.TRANSFER_KRATOS_FACES_TO_MESHER, False)
