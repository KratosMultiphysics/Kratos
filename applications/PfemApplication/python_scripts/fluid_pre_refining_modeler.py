...
class PreRefiningModeler(mesh_modeler.MeshModeler):
    ...
    def SetPreMeshingProcesses(self):
        ...
        remove_mesh_nodes = KratosPfem.RemoveMeshNodesForFluids(self.model_part, self.MeshingParameters, self.echo_level)
        ...
        if( refining_options.Is(KratosDelaunay.ModelerUtilities.REFINE_INSERT_NODES) ):
            generate_new_nodes  = KratosPfem.GenerateNewNodesBeforeMeshing(self.model_part, self.MeshingParameters, self.echo_level)
    ...
    def SetPostMeshingProcesses(self):
        ...
        select_mesh_elements  = KratosPfem.SelectMeshElementsForFluids(self.model_part, self.MeshingParameters, self.echo_level)
