...
#if !defined(KRATOS_RECOVER_VOLUME_LOSSES_MESHER_PROCESS_H_INCLUDED )
#define  KRATOS_RECOVER_VOLUME_LOSSES_MESHER_PROCESS_H_INCLUDED
...
class RecoverVolumeLossesMesherProcess
    : public MesherProcess
{
 public:
  ...
  KRATOS_CLASS_POINTER_DEFINITION( RecoverVolumeLossesMesherProcess );
  ...
  /// Destructor.
  virtual ~RecoverVolumeLossesMesherProcess() {}
  ...
  {
    return "RecoverVolumeLossesMesherProcess";
  }

  /// Print information about this object.
  void PrintInfo(std::ostream& rOStream) const override
  {
    rOStream << "RecoverVolumeLossesMesherProcess";
  }
 ...
 private:
  ...
  /// Assignment operator.
  RecoverVolumeLossesMesherProcess& operator=(RecoverVolumeLossesMesherProcess const& rOther);
...
inline std::istream& operator >> (std::istream& rIStream,
                                  RecoverVolumeLossesMesherProcess& rThis);

/// output stream function
inline std::ostream& operator << (std::ostream& rOStream,
                                  const RecoverVolumeLossesMesherProcess& rThis)
{
