...
base_model_part.AddNodalSolutionStepVariable(ERROR_1) ##needed to compute the normal
...
base_model_part.SetBufferSize(3)
...
bfecc_utility = BFECCLimiterConvection2D(locator)
