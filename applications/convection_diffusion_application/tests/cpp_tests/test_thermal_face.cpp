...
namespace Testing
{
    ...
    KRATOS_TEST_CASE_IN_SUITE(ThermalFace2D, KratosConvectionDiffusionFastSuite)
    {
        ...
        std::vector<double> expected_LHS = {17.2576, 0.0,
                                            0.0, 17.2576};
    ...
    KRATOS_TEST_CASE_IN_SUITE(ThermalFace3D, KratosConvectionDiffusionFastSuite)
    {
        // Create the test condition
        Model model;
        ModelPart &test_model_part = model.CreateModelPart("TestModelPart");
        ...
        test_model_part.CreateNewCondition("ThermalFace3D", 1, cond_nodes, p_cond_prop);
        ...
        std::vector<double> expected_LHS = {5.75253, 0.0, 0.0,
                                            0.0, 5.75253, 0.0,
                                            0.0, 0.0, 5.75253};
