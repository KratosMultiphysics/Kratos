...
void  AddCustomUtilitiesToPython(pybind11::module& m)
{
    ...
    py::class_<BFECCConvection<2>, BFECCConvection<2>::Pointer > (m,"BFECCConvection2D").def(py::init< BinBasedFastPointLocator < 2 >::Pointer >())
    ...
    py::class_<BFECCConvection<3>, BFECCConvection<3>::Pointer > (m,"BFECCConvection3D").def(py::init< BinBasedFastPointLocator < 3 >::Pointer >())
