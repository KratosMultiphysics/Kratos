...
//     KRATOS_REGISTER_IN_PYTHON_VARIABLE( m,SOLID_FRACTION_GRADIENT );
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,ETA_NAVIER_SLIP_TRIPLE_PONT);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,BETA_NAVIER_SLIP_STRUCT);
	...
	KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, LAGRANGE_MULTIPLIER_SECOND_TANGENT_VELOCITY )
	KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, LAGRANGE_MULTIPLIER_NORMAL_VELOCITY)
