...
namespace Kratos
{
     ...
     KRATOS_DEFINE_APPLICATION_VARIABLE(ULF_APPLICATION, double, DISSIPATIVE_FORCE_COEFF_JM_X)
     KRATOS_DEFINE_APPLICATION_VARIABLE(ULF_APPLICATION, double, DISSIPATIVE_FORCE_COEFF_BM_X)
     KRATOS_DEFINE_APPLICATION_VARIABLE(ULF_APPLICATION, double, DISSIPATIVE_FORCE_COEFF_SM_X)
     
     KRATOS_DEFINE_APPLICATION_VARIABLE(ULF_APPLICATION, double, DISSIPATIVE_FORCE_COEFF_JM_Y)
     KRATOS_DEFINE_APPLICATION_VARIABLE(ULF_APPLICATION, double, DISSIPATIVE_FORCE_COEFF_BM_Y)
     KRATOS_DEFINE_APPLICATION_VARIABLE(ULF_APPLICATION, double, DISSIPATIVE_FORCE_COEFF_SM_Y)
     
     KRATOS_DEFINE_APPLICATION_VARIABLE(ULF_APPLICATION, double, DISSIPATIVE_FORCE_COEFF_JM_Z)
     KRATOS_DEFINE_APPLICATION_VARIABLE(ULF_APPLICATION, double, DISSIPATIVE_FORCE_COEFF_BM_Z)
     KRATOS_DEFINE_APPLICATION_VARIABLE(ULF_APPLICATION, double, DISSIPATIVE_FORCE_COEFF_SM_Z)
     
     KRATOS_DEFINE_APPLICATION_VARIABLE(ULF_APPLICATION, double, TESTFACTA)
     KRATOS_DEFINE_APPLICATION_VARIABLE(ULF_APPLICATION, double, TESTFACTB)
     KRATOS_DEFINE_APPLICATION_VARIABLE(ULF_APPLICATION, double, TESTFACTC)
     KRATOS_DEFINE_APPLICATION_VARIABLE(ULF_APPLICATION, double, TESTFACTD)
     KRATOS_DEFINE_APPLICATION_VARIABLE(ULF_APPLICATION, double, TESTFACTE)
