...
namespace Kratos
{
     ...
     KRATOS_DEFINE_APPLICATION_VARIABLE(ULF_APPLICATION, double, ETA_NAVIER_SLIP_TRIPLE_PONT)
     KRATOS_DEFINE_APPLICATION_VARIABLE(ULF_APPLICATION, double, BETA_NAVIER_SLIP_STRUCT)
...
//      KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS(ULF_APPLICATION, SOLID_FRACTION_GRADIENT)
	...
	KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS( ULF_APPLICATION, REYNOLDS_STRESS_2D)
	//KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS( ULF_APPLICATION, BOUNDARY_TILDA_TILDA_STRESS_2D)
	KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS( ULF_APPLICATION, LAGRANGE_MULTIPLIER_VELOCITY)
	//KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS( ULF_APPLICATION, LAGRANGE_MULTIPLIER_VELOCITY_GRADIENTS)

	KRATOS_DEFINE_APPLICATION_VARIABLE( ULF_APPLICATION, int,  NODE_PAIR_X_COMPONENT)
	KRATOS_DEFINE_APPLICATION_VARIABLE( ULF_APPLICATION, int,  NODE_PAIR_Y_COMPONENT)
	KRATOS_DEFINE_APPLICATION_VARIABLE( ULF_APPLICATION, int,  NODE_PAIR_Z_COMPONENT)

	KRATOS_DEFINE_APPLICATION_VARIABLE( ULF_APPLICATION, int,  NODE_PAIR_PRESSURE)

	KRATOS_DEFINE_APPLICATION_VARIABLE( ULF_APPLICATION, int,  NODE_PAIR_X_COMPONENT_ANTIPERIODIC)
	KRATOS_DEFINE_APPLICATION_VARIABLE( ULF_APPLICATION, int,  NODE_PAIR_Y_COMPONENT_ANTIPERIODIC)
	KRATOS_DEFINE_APPLICATION_VARIABLE( ULF_APPLICATION, int,  NODE_PAIR_Z_COMPONENT_ANTIPERIODIC)

	KRATOS_DEFINE_APPLICATION_VARIABLE( ULF_APPLICATION, double,  LAGRANGE_MULTIPLIER_TANGENT_VELOCITY)
        KRATOS_DEFINE_APPLICATION_VARIABLE( ULF_APPLICATION, double,  LAGRANGE_MULTIPLIER_SECOND_TANGENT_VELOCITY)

	KRATOS_DEFINE_APPLICATION_VARIABLE( ULF_APPLICATION, double, LAGRANGE_MULTIPLIER_NORMAL_VELOCITY)

        KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS(ULF_APPLICATION, AUX_VECTOR)
