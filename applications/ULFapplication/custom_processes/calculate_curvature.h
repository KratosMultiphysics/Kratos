...
// 		bounded_matrix<double, 3, 3> LHSmat = ZeroMatrix(3,3);
// 		array_1d<double,3> RHSvec = ZeroVector(3);
		bounded_matrix<double, 2, 2> LHSmat = ZeroMatrix(2,2);
		array_1d<double,2> RHSvec = ZeroVector(2);		
		bounded_matrix<double, 2, 2> B = ZeroMatrix(2,2);
...
//       if (norm_a*norm_b > -1.0e-20 && norm_a*norm_b < 1.0e-20)
    ...
    {
      bounded_matrix<double, 2, 2> mat_syst;
      bounded_matrix<double, 2, 2> mat_dx;
      bounded_matrix<double, 2, 2> mat_dy;
      int num_case = 0;
    ...
    void SolveSys2x2(double& a, double& b,bounded_matrix<double, 2, 2>& LHSmat,
		     array_1d<double,2>& RHSvec)
    {
      bounded_matrix<double, 2, 2> mat_syst = ZeroMatrix(2,2);
      bounded_matrix<double, 2, 2> mat_dx = ZeroMatrix(2,2);
      bounded_matrix<double, 2, 2> mat_dy = ZeroMatrix(2,2);
    ...
    void SolveSys3x3(double& a, double& b, double& c,bounded_matrix<double, 3, 3>& LHSmat,
		     array_1d<double,3>& RHSvec)
    {
      bounded_matrix<double, 3, 3> mat_syst = ZeroMatrix(3,3);
      bounded_matrix<double, 3, 3> mat_dx = ZeroMatrix(3,3);
      bounded_matrix<double, 3, 3> mat_dy = ZeroMatrix(3,3);
      bounded_matrix<double, 3, 3> mat_dz = ZeroMatrix(3,3);
...
// 		       bounded_matrix<double, 3, 3>& LHSmat, array_1d<double,3>& RHSvec)
    void AddTermsToSys(double& kappaN_ij, double& kappa_H, double& alfa, double& beta, int& num_neighbs,
		       bounded_matrix<double, 2, 2>& LHSmat, array_1d<double,2>& RHSvec, const int& option)
    {
    ...
    */
    ...
    double Det2x2(bounded_matrix<double, 2, 2>& input)
    {
      return (input(0,0)*input(1,1) - input(0,1)*input(1,0));
    }
    
    double Det3x3(bounded_matrix<double, 3, 3>& input)
    {
      return (input(0,0)*input(1,1) - input(0,1)*input(1,0));
    }
    ...
    void CopyMatrix3x3(bounded_matrix<double, 3, 3>& input,
		       bounded_matrix<double, 3, 3>& output)
    {
    ...
    void CopyMatrix2x2(bounded_matrix<double, 2, 2>& input,
		       bounded_matrix<double, 2, 2>& output)
    {
