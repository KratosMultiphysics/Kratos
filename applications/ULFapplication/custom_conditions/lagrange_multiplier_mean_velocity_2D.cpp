...
namespace Kratos
{
	...
	void MeanVelocityLagrangeMultiplierCondition2D::CalculateRightHandSide(VectorType& rRightHandSideVector, ProcessInfo& rCurrentProcessInfo)
	{
		...
		*/
		//KRATOS_THROW_ERROR(std::logic_error,  "method not implemented" , "");
		KRATOS_WATCH("Calculate RHS not implemented for this condition")
	...
	{
		KRATOS_TRY
		//KRATOS_WATCH("Calculating the CalculateLocalVelocityContribution of mean velocity lag mult condition!")
		...
		//{
			...
			//KRATOS_WATCH("HEREEEEEEeeeeeeeeeeeeee")

			//KRATOS_WATCH(GetGeometry()[0].GetSolutionStepValue(NODAL_AREA))
			//KRATOS_WATCH("HEREEEEEEeeeeeeeeeeeeee passed......................................")
	...
	void MeanVelocityLagrangeMultiplierCondition2D::EquationIdVector(EquationIdVectorType& rResult, ProcessInfo& rCurrentProcessInfo)
	{
		...
		//{
			...
			//KRATOS_WATCH(this->GetValue(NEIGHBOUR_NODES)[0])
