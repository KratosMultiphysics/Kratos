...
#include "custom_conditions/normal_velocity_periodic_condition_2D.h"
...
namespace Kratos
{
	//************************************************************************************
	//************************************************************************************
	NormalVelocityPeriodicCondition2D2N::NormalVelocityPeriodicCondition2D2N(IndexType NewId, GeometryType::Pointer pGeometry)
	...
	//************************************************************************************
	//************************************************************************************
	NormalVelocityPeriodicCondition2D2N::NormalVelocityPeriodicCondition2D2N(IndexType NewId, GeometryType::Pointer pGeometry,  PropertiesType::Pointer pProperties)
		: Condition(NewId, pGeometry, pProperties)
	{
	}
	Condition::Pointer NormalVelocityPeriodicCondition2D2N::Create(IndexType NewId, NodesArrayType const& ThisNodes,  PropertiesType::Pointer pProperties) const
	{
		return Condition::Pointer(new NormalVelocityPeriodicCondition2D2N(NewId, GetGeometry().Create(ThisNodes), pProperties));
	}

	NormalVelocityPeriodicCondition2D2N::~NormalVelocityPeriodicCondition2D2N()
	{
	}

	//************************************************************************************
	//************************************************************************************
	void NormalVelocityPeriodicCondition2D2N::CalculateRightHandSide(VectorType& rRightHandSideVector, ProcessInfo& rCurrentProcessInfo)
	{
		KRATOS_TRY
		/*
	...
	//************************************************************************************
	/*
	void NormalVelocityPeriodicCondition2D2N::CalculateLocalVelocityContribution(MatrixType& rLeftHandSideMatrix, VectorType& rRightHandSideVector, ProcessInfo& rCurrentProcessInfo)
	...
	*/
...

	{
		...
		temp_vector[2]=GetGeometry()[0].GetSolutionStepValue(LAGRANGE_MULTIPLIER_NORMAL_VELOCITY,0);		
	...
	void NormalVelocityPeriodicCondition2D2N::CalculateLocalSystem(MatrixType& rLeftHandSideMatrix, VectorType& rRightHandSideVector, ProcessInfo& rCurrentProcessInfo)
	...
	//************************************************************************************
	//************************************************************************************
	void NormalVelocityPeriodicCondition2D2N::EquationIdVector(EquationIdVectorType& rResult, ProcessInfo& rCurrentProcessInfo)
	{
		 if (rResult.size()!=(3))
			    rResult.resize(3);
		 ...
		 { 
			 ...
			 rResult[LocalIndex++] = GetGeometry()[0].GetDof(LAGRANGE_MULTIPLIER_NORMAL_VELOCITY).EquationId();
		 }
	...
	//************************************************************************************
	//************************************************************************************
	  void NormalVelocityPeriodicCondition2D2N::GetDofList(DofsVectorType& ConditionalDofList,ProcessInfo& rCurrentProcessInfo)
	{
		 ...
		 { 
			 ...
			 ConditionalDofList[LocalIndex++] = GetGeometry()[0].pGetDof(LAGRANGE_MULTIPLIER_NORMAL_VELOCITY);
		 }
		 else if(fabs(GetGeometry()[0].Y()-GetGeometry()[1].Y())<0.00001 )// && GetGeometry()[0].GetSolutionStepValue(NODE_PAIR_Y_COMPONENT)!=0 ) //then this is the condition relating left and right nodes that needs that is not in the corner.
		 {
			 for (unsigned int iNode = 0; iNode < 2; ++iNode)
