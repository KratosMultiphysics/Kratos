...
namespace Kratos
{
///@name Specialized implementation of SurfaceTension for functions that depend on TDim
///@{

/**
 * @see SurfaceTension::EquationIdVector
 */
template <>
void SurfaceTension<2>::EquationIdVector(EquationIdVectorType& rResult,
 ...
 */
template <>
void SurfaceTension<3>::EquationIdVector(EquationIdVectorType& rResult,
                              ProcessInfo& rCurrentProcessInfo)
{
...
/**
 * @see SurfaceTension::GetDofList
 */
template <>
void SurfaceTension<2>::GetDofList(DofsVectorType& rElementalDofList,
                        ProcessInfo& rCurrentProcessInfo)
{
    const unsigned int NumNodes(3),LocalSize(9);
 ...
 */
template <>
void SurfaceTension<3>::GetDofList(DofsVectorType& rElementalDofList,
                        ProcessInfo& rCurrentProcessInfo)
{
    const unsigned int NumNodes(4),LocalSize(16);
    if (rElementalDofList.size() != LocalSize)
...
/**
 * @see SurfaceTension::GetFirstDerivativesVector
 */
template <>
void SurfaceTension<2>::GetFirstDerivativesVector(Vector& Values, int Step)
{
    const unsigned int NumNodes(3),LocalSize(9);
    unsigned int LocalIndex = 0;
 ...
 */
template <>
void SurfaceTension<3>::GetFirstDerivativesVector(Vector& Values, int Step)
{
    const unsigned int NumNodes(4),LocalSize(16);
    unsigned int LocalIndex = 0;
...
/**
 * @see SurfaceTension::GetSecondDerivativesVector
 */
template <>
void SurfaceTension<2>::GetSecondDerivativesVector(Vector& Values, int Step)
{
    const unsigned int NumNodes(3),LocalSize(9);
    unsigned int LocalIndex = 0;
 ...
 */
template <>
void SurfaceTension<3>::GetSecondDerivativesVector(Vector& Values, int Step)
{
    const unsigned int NumNodes(4),LocalSize(16);
    unsigned int LocalIndex = 0;
 ...
 * Area = Pi * (h/2)^2
 * @see SurfaceTension::ElementSize
 */
template <>
double SurfaceTension<2,3>::ElementSize(const double Area)
{
 ...
 */
template <>
double SurfaceTension<3,4>::ElementSize(const double Volume)
{
...
/**
 * @see SurfaceTension::GetValueOnIntegrationPoints
 */
template <>
void SurfaceTension<2>::GetValueOnIntegrationPoints( const Variable<array_1d<double,3> >& rVariable,
        ...
        const ProcessInfo& rCurrentProcessInfo)
{
    ...
    else // Default behaviour (returns elemental data)
    {
        ...
        /*
         ...
         goes out of scope.
         */
        const SurfaceTension<Dim,NumNodes>* const_this = static_cast< const SurfaceTension<Dim,NumNodes>* >(this);
 ...
 */
template <>
void SurfaceTension<3>::GetValueOnIntegrationPoints( const Variable<array_1d<double,3> >& rVariable,
        std::vector<array_1d<double,3> >& rOutput,
        const ProcessInfo& rCurrentProcessInfo)
{
...
template <>
double SurfaceTension<2,3>::EquivalentStrainRate(const bounded_matrix<double,3,2> &rDN_DX) const
{
...
template <>
double SurfaceTension<3,4>::EquivalentStrainRate(const bounded_matrix<double,4,3> &rDN_DX) const
{
    const GeometryType& rGeom = this->GetGeometry();
 ...
 */
template <>
void SurfaceTension<2,3>::CalculateB( bounded_matrix<double, 3, 6 >& rB,
 ...
 */
template <>
void SurfaceTension<3,4>::CalculateB( bounded_matrix<double, 6, 12 >& rB,
 ...
 */
template <>
void SurfaceTension<2,3>::CalculateC(bounded_matrix<double, 3, 3 > & rC,
 ...
 */
template <>
void SurfaceTension<3,4>::CalculateC(bounded_matrix<double, 6,6 > & rC,
                          const double Viscosity)
{
...
/**
 * @see SurfaceTension::AddViscousTerm
 */
template <>
...
template<>
double SurfaceTension<2,3>::ConsistentMassCoef(const double Area)
{
...
template<>
double SurfaceTension<3,4>::ConsistentMassCoef(const double Volume)
{
