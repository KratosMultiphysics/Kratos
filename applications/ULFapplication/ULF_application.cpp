...
void KratosULFApplication::Register()
{
    ...
    KRATOS_REGISTER_VARIABLE(DISSIPATIVE_FORCE_COEFF_JM_X)
    KRATOS_REGISTER_VARIABLE(DISSIPATIVE_FORCE_COEFF_BM_X)
    KRATOS_REGISTER_VARIABLE(DISSIPATIVE_FORCE_COEFF_SM_X)
    
    KRATOS_REGISTER_VARIABLE(DISSIPATIVE_FORCE_COEFF_JM_Y)
    KRATOS_REGISTER_VARIABLE(DISSIPATIVE_FORCE_COEFF_BM_Y)
    KRATOS_REGISTER_VARIABLE(DISSIPATIVE_FORCE_COEFF_SM_Y)
    
    KRATOS_REGISTER_VARIABLE(DISSIPATIVE_FORCE_COEFF_JM_Z)
    KRATOS_REGISTER_VARIABLE(DISSIPATIVE_FORCE_COEFF_BM_Z)
    KRATOS_REGISTER_VARIABLE(DISSIPATIVE_FORCE_COEFF_SM_Z)
    
    KRATOS_REGISTER_VARIABLE(TESTFACTA)
    KRATOS_REGISTER_VARIABLE(TESTFACTB)
    KRATOS_REGISTER_VARIABLE(TESTFACTC)
    KRATOS_REGISTER_VARIABLE(TESTFACTE)
    KRATOS_REGISTER_VARIABLE(TESTFACTD)
