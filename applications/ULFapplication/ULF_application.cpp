...
KRATOS_CREATE_VARIABLE(double, SYMMETRY_CUT)
KRATOS_CREATE_VARIABLE(double, FIXED_WALL)
KRATOS_CREATE_VARIABLE(double, CENTER_LINE)
...
void KratosULFApplication::Register()
{
    ...
    */
    ...
    KRATOS_REGISTER_VARIABLE(SYMMETRY_CUT)
    KRATOS_REGISTER_VARIABLE(FIXED_WALL)
    KRATOS_REGISTER_VARIABLE(CENTER_LINE)
