...
KratosULFApplication::KratosULFApplication():
    ...
    //mUlfFrac2DSwimming(0, Element::GeometryType::Pointer(new Triangle2D3<Node<3> >(Element::GeometryType::PointsArrayType(3)))),
    //mUlfFrac3DSwimming(0, Element::GeometryType::Pointer(new Tetrahedra3D4 <Node<3> >(Element::GeometryType::PointsArrayType(4)))),
