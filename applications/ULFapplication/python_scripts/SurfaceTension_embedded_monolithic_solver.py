...
def AddVariables(model_part, config=None):
    ...
    model_part.AddNodalSolutionStepVariable(DISABLE) 
...
# print "Initialization monolithic solver finished"
    ...
    def Solve(self):   
        ...
        AssignPointNeumannConditionsEmbedded().AssignPointNeumannConditions3D(self.model_part)
    ...
    def Remesh(self):
        ...
        #elif (self.domain_size == 3):
            #(self.Mesher).ReGenerateMesh("VMS3D","Condition3D", self.model_part, self.node_erase_process, True, False, self.alpha_shape, h_factor)            
