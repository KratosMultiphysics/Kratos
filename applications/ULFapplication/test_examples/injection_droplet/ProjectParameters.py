...
SolverType = "monolithic_solver_eulerian" # "monolithic_solver_eulerian" | "FractionalStep"

class FluidSolverConfiguration:
    solver_type =  "SurfaceTension_monolithic_injection_solver" # "vms_monolithic_solver" | "monolithic_embedded_solver"
    domain_size = 2
...
nodal_results=["VELOCITY","PRESSURE","VISCOUS_STRESSX","VISCOUS_STRESSY", "IS_INTERFACE", "DISTANCE", "AUX_VEL"]
...
problem_name= "injection-channel"
#problem_name= "berk_channel_6.5mm"
