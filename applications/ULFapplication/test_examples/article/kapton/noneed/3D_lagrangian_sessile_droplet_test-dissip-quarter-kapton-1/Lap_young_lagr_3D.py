...
zeta_dissapative_JM_x = 1.0*(math.cos(contact_angle*0.0174533)+1.0) *2.2 
zeta_dissapative_JM_y = 1.0*(math.cos(contact_angle*0.0174533)+1.0) *2.0
zeta_dissapative_JM_z = 1.0*(math.cos(contact_angle*0.0174533)+1.0) *2.0
