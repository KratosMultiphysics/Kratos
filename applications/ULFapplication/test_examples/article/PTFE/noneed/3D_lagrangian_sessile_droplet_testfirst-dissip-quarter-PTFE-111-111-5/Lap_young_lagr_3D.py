...
zeta_dissapative_SM_x = (math.cos(contact_angle*0.0174533)+1.0)
zeta_dissapative_SM_y = (math.cos(contact_angle*0.0174533)+1.0)
zeta_dissapative_SM_z = (math.cos(contact_angle*0.0174533)+1.0)
