...
import SurfaceTension_monolithic_solver_kapton2 as solver_lagr
...
contact_angle = 74.0	#contact angle [deg]
...
for node in lagrangian_model_part.Nodes:
  ...
  if (node.GetSolutionStepValue(IS_BOUNDARY) != 0.0 and node.GetSolutionStepValue(IS_WALL) != 1.0):
...
##################################################
    ...
    if(output_time <= out):
        ...
        gid_io.WriteNodalResults(IS_WALL,lagrangian_model_part.Nodes,time,0)
