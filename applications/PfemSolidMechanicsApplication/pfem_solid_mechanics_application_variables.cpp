...
namespace Kratos
{
  ...
  KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS( WATER_VELOCITY_REACTION )
  KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS( WATER_ACCELERATION_REACTION )
  KRATOS_CREATE_VARIABLE(double, WATER_PRESSURE_VELOCITY )
  KRATOS_CREATE_VARIABLE(double, WATER_PRESSURE_VELOCITY_REACTION )
  KRATOS_CREATE_VARIABLE(double, WATER_PRESSURE_ACCELERATION_REACTION )
  ...
  KRATOS_CREATE_VARIABLE(bool, 		ANISOTROPIC_PERMEABILITY )
  KRATOS_CREATE_VARIABLE(double, 	VERTICAL_PERMEABILITY )
  KRATOS_CREATE_VARIABLE(double, 	HORIZONTAL_PERMEABILITY )
  KRATOS_CREATE_VARIABLE(Matrix, 	PERMEABILITY_TENSOR )
  KRATOS_CREATE_VARIABLE(bool, 		TRANSFORM_PERMEABILITY_TENSOR )
  ...
  KRATOS_CREATE_VARIABLE(Matrix, TOTAL_DEFORMATION_GRADIENT )
  ...
  KRATOS_CREATE_VARIABLE(double, INCR_VOL_PLASTIC )
  KRATOS_CREATE_VARIABLE(double, CRITICAL_STATE_M )

  KRATOS_CREATE_VARIABLE(double, M_MODULUS )
  KRATOS_CREATE_VARIABLE(double, EXCESS_WATER_PRESSURE )
