...
public:
    ...
    typedef RigidWallContactCalculationUtilities<TSparseSpace, TDenseSpace> TWallSchemeType;
    typedef typename TWallSchemeType::Pointer  TWallSchemePointerType;
   ...
   double ExecuteLineSearch( TBuilderAndSolverPointerType pBuilderAndSolver,
			     ...
			     TWallSchemePointerType pWallScheme,
			     ...
			     double rPreviousAlpha )
    {
      ...
      //alpha = LineSearchA(pBuilderAndSolver,pScheme,pWallScheme,r_model_part,A,Dx,b,rCurrentAlpha,rPreviousAlpha);

      //line-search version Bonet and Wood
      //alpha = LineSearchB(pBuilderAndSolver,pScheme,pWallScheme,r_model_part,A,Dx,b,rCurrentAlpha,rPreviousAlpha);

      //line-search secant
      alpha = LineSearchC(pBuilderAndSolver,pScheme,pWallScheme,r_model_part,A,Dx,b,rCurrentAlpha,rPreviousAlpha);
   ...
   double LineSearchA( TBuilderAndSolverPointerType pBuilderAndSolver,
		       ...
		       double rPreviousAlpha)
    {
   	...
   	Dx = ReferenceDx *1;
	     ...
	     pWallScheme->BuildRHS(r_model_part,b);
