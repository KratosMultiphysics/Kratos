...
namespace Kratos
{
   ...
   void UpdatedLagrangianUJwPElement::CalculateAndAddLHS(LocalSystemComponents& rLocalSystem, GeneralVariables& rVariables, double& rIntegrationWeight)
   {
      ...
      rLeftHandSideMatrix = WaterUtility.CalculateAndAddHydroProblemLHS( rLeftHandSideMatrix, LocalLeftHandSideMatrix, VolumeForce, number_of_variables, GetGeometry(), GetProperties(), rVariables.B, rVariables.DN_DX, rVariables.N, rVariables.detF0, mTimeStep, TotalF, rIntegrationWeight);
   ...
   void UpdatedLagrangianUJwPElement::CalculateMassMatrix( MatrixType& rMassMatrix, ProcessInfo& rCurrentProcessInfo )
   {
      KRATOS_TRY
