...
#if !defined(KRATOS_AXISYM_UPDATED_LAGRANGIAN_U_P_wP_ELEMENT_H_INCLUDED )
#define  KRATOS_AXISYM_UPDATED_LAGRANGIAN_U_P_wP_ELEMENT_H_INCLUDED
...
namespace Kratos
{
   ...
   class KRATOS_API(PFEM_SOLID_MECHANICS_APPLICATION) AxisymUpdatedLagrangianUPwPElement
      : public AxisymUpdatedLagrangianUPressureElement
   {
      public:
         ...
         KRATOS_CLASS_INTRUSSIVE_POINTER_DEFINITION( AxisymUpdatedLagrangianUPwPElement );
         ///@}
         ...
         AxisymUpdatedLagrangianUPwPElement();

         /// Default constructors
         AxisymUpdatedLagrangianUPwPElement(IndexType NewId, GeometryType::Pointer pGeometry);

         AxisymUpdatedLagrangianUPwPElement(IndexType NewId, GeometryType::Pointer pGeometry, PropertiesType::Pointer pProperties);

         ///Copy constructor
         AxisymUpdatedLagrangianUPwPElement(AxisymUpdatedLagrangianUPwPElement const& rOther);


         /// Destructor.
         virtual ~AxisymUpdatedLagrangianUPwPElement();
         ...
         /// Assignment operator.
         AxisymUpdatedLagrangianUPwPElement& operator=(AxisymUpdatedLagrangianUPwPElement const& rOther);
