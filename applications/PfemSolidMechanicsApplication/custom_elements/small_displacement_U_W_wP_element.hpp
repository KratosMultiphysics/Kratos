...
#if !defined(KRATOS_SMALL_DISPLACEMENT_U_W_WP_ELEMENT_H_INCLUDED )
#define  KRATOS_SMALL_DISPLACEMENT_U_W_WP_ELEMENT_H_INCLUDED
...
class KRATOS_API(PFEM_SOLID_MECHANICS_APPLICATION) SmallDisplacementUWwPElement
...
public:
    ...
    KRATOS_CLASS_INTRUSSIVE_POINTER_DEFINITION( SmallDisplacementUWwPElement );
    ///@}
    ...
    SmallDisplacementUWwPElement();

    /// Default constructors
    SmallDisplacementUWwPElement(IndexType NewId, GeometryType::Pointer pGeometry);

    SmallDisplacementUWwPElement(IndexType NewId, GeometryType::Pointer pGeometry, PropertiesType::Pointer pProperties);

    ///Copy constructor
    SmallDisplacementUWwPElement(SmallDisplacementUWwPElement const& rOther);


    /// Destructor.
    virtual ~SmallDisplacementUWwPElement();
    ...
    /// Assignment operator.
    SmallDisplacementUWwPElement& operator=(SmallDisplacementUWwPElement const& rOther);
...
#endif // KRATOS_SMALL_DISPLACEMENT_U_W_wP_ELEMENT_H_INCLUDED
