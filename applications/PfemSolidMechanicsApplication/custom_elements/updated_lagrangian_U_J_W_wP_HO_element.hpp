...
#if !defined(KRATOS_UPDATED_LAGRANGIAN_U_J_W_WP_HO_ELEMENT_H_INCLUDED )
#define  KRATOS_UPDATED_LAGRANGIAN_U_J_W_WP_HO_ELEMENT_H_INCLUDED
...
public:
    ...
    KRATOS_CLASS_INTRUSSIVE_POINTER_DEFINITION( UpdatedLagrangianUJWwPHOElement );
    ///@}
    ...
    UpdatedLagrangianUJWwPHOElement();

    /// Default constructors
    UpdatedLagrangianUJWwPHOElement(IndexType NewId, GeometryType::Pointer pGeometry);

    UpdatedLagrangianUJWwPHOElement(IndexType NewId, GeometryType::Pointer pGeometry, PropertiesType::Pointer pProperties);

    ///Copy constructor
    UpdatedLagrangianUJWwPHOElement(UpdatedLagrangianUJWwPHOElement const& rOther);


    /// Destructor.
    virtual ~UpdatedLagrangianUJWwPHOElement();
    ...
    /// Assignment operator.
    UpdatedLagrangianUJWwPHOElement& operator=(UpdatedLagrangianUJWwPHOElement const& rOther);
...
#endif // KRATOS_UPDATED_LAGRANGIAN_U_J_W_wP_HO_ELEMENT_H_INCLUDED
