...
class KRATOS_API(PFEM_SOLID_MECHANICS_APPLICATION) UpdatedLagrangianUJWwPDMEElement
...
public:
    ...
    KRATOS_CLASS_INTRUSSIVE_POINTER_DEFINITION( UpdatedLagrangianUJWwPDMEElement );
    ///@}
