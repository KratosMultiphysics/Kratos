...
#if !defined(KRATOS_AXISYM_CONTACT_DOMAIN_2D_CONDITION_H_INCLUDED )
#define  KRATOS_AXISYM_CONTACT_DOMAIN_2D_CONDITION_H_INCLUDED
...
class AxisymContactDomain2DCondition
    : public Condition
{
protected:
...
public:
    ...
    /// Counted pointer of AxisymContactDomain2DCondition
    KRATOS_CLASS_POINTER_DEFINITION(AxisymContactDomain2DCondition);
    ...
    AxisymContactDomain2DCondition() : Condition() {};

    AxisymContactDomain2DCondition(IndexType NewId, GeometryType::Pointer pGeometry);
    AxisymContactDomain2DCondition(IndexType NewId, GeometryType::Pointer pGeometry, PropertiesType::Pointer pProperties);

    ///Copy constructor
    AxisymContactDomain2DCondition(AxisymContactDomain2DCondition const& rOther);


    /// Destructor.
    virtual ~AxisymContactDomain2DCondition();
    ...
    /// Assignment operator.
    AxisymContactDomain2DCondition& operator=(AxisymContactDomain2DCondition const& rOther);
...
/*  inline std::istream& operator >> (std::istream& rIStream,
    AxisymContactDomain2DCondition& rThis);
*/
/// output stream function
/*  inline std::ostream& operator << (std::ostream& rOStream,
    const AxisymContactDomain2DCondition& rThis)
    {
...
#endif // KRATOS_AXISYM_CONTACT_DOMAIN_2D_CONDITION_H_INCLUDED  defined 
