...
#if !defined (KRATOS_BORJA_HENCKY_CASM_PLASTIC_AXISYM_2D_LAW_H_INCLUDED)
#define       KRATOS_BORJA_HENCKY_CASM_PLASTIC_AXISYM_2D_LAW_H_INCLUDED
...
class BorjaHenckyCasmPlasticAxisym2DLaw 
...
public:
    ...
    KRATOS_CLASS_POINTER_DEFINITION( BorjaHenckyCasmPlasticAxisym2DLaw );
    ...
    BorjaHenckyCasmPlasticAxisym2DLaw(FlowRulePointer pFlowRule, YieldCriterionPointer pYieldCriterion, HardeningLawPointer pHardeningLaw); 

    /**
     * Copy constructor.
     */
    BorjaHenckyCasmPlasticAxisym2DLaw (const BorjaHenckyCasmPlasticAxisym2DLaw& rOther);
     ...
     * Destructor.
     */
    virtual ~BorjaHenckyCasmPlasticAxisym2DLaw();
