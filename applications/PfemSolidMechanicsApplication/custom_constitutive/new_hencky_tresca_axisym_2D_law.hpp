...
#if !defined (KRATOS_NEW_HENCKY_TRESCA_AXISYM_STRAIN_2D_LAW_H_INCLUDED)
#define       KRATOS_NEW_HENCKY_TRESCA_AXISYM_STRAIN_2D_LAW_H_INCLUDED
...
class KRATOS_API(PFEM_SOLID_MECHANICS_APPLICATION) NewHenckyTrescaPlasticAxisym2DLaw 
...
public:
     ...
     * Default constructor.
     */
    NewHenckyTrescaPlasticAxisym2DLaw();


    NewHenckyTrescaPlasticAxisym2DLaw(FlowRulePointer pFlowRule, YieldCriterionPointer pYieldCriterion, HardeningLawPointer pHardeningLaw); 

    /**
     * Copy constructor.
     */
    NewHenckyTrescaPlasticAxisym2DLaw (const NewHenckyTrescaPlasticAxisym2DLaw& rOther);
     ...
     * Destructor.
     */
    virtual ~NewHenckyTrescaPlasticAxisym2DLaw();
