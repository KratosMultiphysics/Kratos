...
std::cout<<"   CASM cemented 2D axisym constructed"<<std::endl;
	...
	void BorjaHenckyCasmCemPlasticAxisym2DLaw::GetHardeningParameters ( double& rPreconPressure, double& rBonding)
	{
	...
	const double BorjaHenckyCasmCemPlasticAxisym2DLaw::GetPreconPressure()
	{
		return mpFlowRule->GetPlasticVariables().PreconsolidationPressure;
	}

	void BorjaHenckyCasmCemPlasticAxisym2DLaw::SetValue(const Variable<Vector>& rThisVariable, const Vector& rValue, const ProcessInfo& rCurrentProcessInfo)
	{
