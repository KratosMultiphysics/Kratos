...
#if !defined(KRATOS_CASM_HARDENING_LAW_H_INCLUDED )
#define  KRATOS_CASM_HARDENING_LAW_H_INCLUDED
...
public:
    ...
    /// Pointer definition of CasmHardeningLaw
    KRATOS_CLASS_POINTER_DEFINITION( CasmHardeningLaw );
    ...
    /// Copy constructor.
    CasmHardeningLaw(CasmHardeningLaw const& rOther);

    /// Assignment operator.
    CasmHardeningLaw& operator=(CasmHardeningLaw const& rOther);
...
#endif // KRATOS_CASM_HARDENING_LAW_H_INCLUDED defined
