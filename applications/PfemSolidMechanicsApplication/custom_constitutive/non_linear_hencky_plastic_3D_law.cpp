...
namespace Kratos
{
   ...
   double& NonLinearHenckyElasticPlastic3DLaw::GetValue(const Variable<double>& rThisVariable, double& rValue)
   {
      ...
      // POST-PROCESS LOTS OF VARIABLES. ONLY IF DEFINED IN THE APPROPRIATE FILE
   ...
   int NonLinearHenckyElasticPlastic3DLaw::Check( const Properties& rMaterialProperties, const GeometryType& rElementGeometry, const ProcessInfo& rCurrentProcessInfo) const
   {
