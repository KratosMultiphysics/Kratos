...
#if !defined (KRATOS_NON_LINEAR_HENCKY_PLASTIC_U_P_PLANE_STRAIN_2D_LAW_H_INCLUDED)
#define       KRATOS_NON_LINEAR_HENCKY_PLASTIC_U_P_PLANE_STRAIN_2D_LAW_H_INCLUDED
...
class KRATOS_API(PFEM_SOLID_MECHANICS_APPLICATION) NonLinearHenckyElasticPlasticUPPlaneStrain2DLaw: public NonLinearHenckyElasticPlasticUP3DLaw
{
...
public:
    ...
    KRATOS_CLASS_POINTER_DEFINITION(NonLinearHenckyElasticPlasticUPPlaneStrain2DLaw);
    ...
    NonLinearHenckyElasticPlasticUPPlaneStrain2DLaw(FlowRulePointer pFlowRule, YieldCriterionPointer pYieldCriterion, HardeningLawPointer pHardeningLaw);

    /**
     * Copy constructor.
     */
    NonLinearHenckyElasticPlasticUPPlaneStrain2DLaw (const NonLinearHenckyElasticPlasticUPPlaneStrain2DLaw& rOther)  ;
     ...
     * Destructor.
     */
    virtual ~NonLinearHenckyElasticPlasticUPPlaneStrain2DLaw();
...
//    HardeningLawPointer   mpHardeningLaw;
    ...
    // NOT NEDEED, the base class is ok
