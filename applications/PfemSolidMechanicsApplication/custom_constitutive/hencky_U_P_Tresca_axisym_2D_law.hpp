...
#if !defined (KRATOS_HENCKY_U_P_TRESCA_AXISYM_2D_LAW_H_INCLUDED)
#define       KRATOS_HENCKY_U_P_TRESCA_AXISYM_2D_LAW_H_INCLUDED
...
class KRATOS_API(PFEM_SOLID_MECHANICS_APPLICATION) HenckyPlasticUPTrescaAxisym2DLaw 
  : public NonLinearHenckyElasticPlasticUPAxisym2DLaw
...
public:
    ...
    KRATOS_CLASS_POINTER_DEFINITION( HenckyPlasticUPTrescaAxisym2DLaw );
    ...
    HenckyPlasticUPTrescaAxisym2DLaw(FlowRulePointer pFlowRule, YieldCriterionPointer pYieldCriterion, HardeningLawPointer pHardeningLaw); 

    /**
     * Copy constructor.
     */
    HenckyPlasticUPTrescaAxisym2DLaw (const HenckyPlasticUPTrescaAxisym2DLaw& rOther);
     ...
     * Destructor.
     */
    virtual ~HenckyPlasticUPTrescaAxisym2DLaw();
...
private:
    ...
    {
        KRATOS_SERIALIZE_SAVE_BASE_CLASS( rSerializer, NonLinearHenckyElasticPlasticUPAxisym2DLaw )
    }

    void load(Serializer& rSerializer) override
    {
        KRATOS_SERIALIZE_LOAD_BASE_CLASS( rSerializer, NonLinearHenckyElasticPlasticUPAxisym2DLaw )
    }
