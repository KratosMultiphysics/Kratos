...
#if !defined (KRATOS_NON_LINEAR_HENCKY_PLASTIC_PLANE_STRAIN_2D_LAW_H_INCLUDED)
#define KRATOS_NON_LINEAR_HENCKY_PLASTIC_PLANE_STRAIN_2D_LAW_H_INCLUDED
...
class KRATOS_API(PFEM_SOLID_MECHANICS_APPLICATION) NonLinearHenckyElasticPlasticPlaneStrain2DLaw: public NonLinearHenckyElasticPlastic3DLaw
{
...
public:
    ...
    NonLinearHenckyElasticPlasticPlaneStrain2DLaw(FlowRulePointer pFlowRule, YieldCriterionPointer pYieldCriterion, HardeningLawPointer pHardeningLaw);

    /**
     * Copy constructor.
     */
    NonLinearHenckyElasticPlasticPlaneStrain2DLaw (const NonLinearHenckyElasticPlasticPlaneStrain2DLaw& rOther)  ;
     ...
     * Destructor.
     */
    virtual ~NonLinearHenckyElasticPlasticPlaneStrain2DLaw();
