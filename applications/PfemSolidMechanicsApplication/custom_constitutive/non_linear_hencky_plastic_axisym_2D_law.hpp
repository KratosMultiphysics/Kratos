...
#if !defined (KRATOS_NON_LINEAR_HENCKY_PLASTIC_AXISYM_2D_LAW_H_INCLUDED)
#define       KRATOS_NON_LINEAR_HENCKY_PLASTIC_AXISYM_2D_LAW_H_INCLUDED
...
class KRATOS_API(PFEM_SOLID_MECHANICS_APPLICATION) NonLinearHenckyElasticPlasticAxisym2DLaw: public NonLinearHenckyElasticPlastic3DLaw
{
...
public:
    ...
    NonLinearHenckyElasticPlasticAxisym2DLaw(FlowRulePointer pFlowRule, YieldCriterionPointer pYieldCriterion, HardeningLawPointer pHardeningLaw);

    /**
     * Copy constructor.
     */
    NonLinearHenckyElasticPlasticAxisym2DLaw (const NonLinearHenckyElasticPlasticAxisym2DLaw& rOther)  ;
     ...
     * Destructor.
     */
    virtual ~NonLinearHenckyElasticPlasticAxisym2DLaw();
