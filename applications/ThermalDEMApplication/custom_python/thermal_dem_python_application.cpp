...
namespace Kratos
{
  namespace Python
  {
    ...
    PYBIND11_MODULE(KratosThermalDEMApplication, m)
    {
        ...
        KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, DEM_THERMAL_INTEGRATION_SCHEME_POINTER)
        KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, DEM_THERMAL_INTEGRATION_SCHEME_NAME)
        KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, DEM_NUMERICAL_INTEGRATION_METHOD_POINTER)
        KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, DEM_NUMERICAL_INTEGRATION_METHOD_NAME)
        ...
        KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, POROSITY_METHOD)
        ...
        //KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, HEATFLUX)             // defined in DEMApp
        //KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, THERMAL_CONDUCTIVITY) // defined in DEMApp
