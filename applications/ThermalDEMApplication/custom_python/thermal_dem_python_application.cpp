...
namespace Kratos
{
  namespace Python
  {
    ...
    PYBIND11_MODULE(KratosThermalDEMApplication, m)
    {
        ...
        KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, DEM_DIRECT_CONDUCTION_MODEL_POINTER)
        KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, DEM_INDIRECT_CONDUCTION_MODEL_POINTER)
        KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, DEM_CONVECTION_MODEL_POINTER)
        KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, DEM_RADIATION_MODEL_POINTER)
        KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, DEM_FRICTION_MODEL_POINTER)
        ...
        KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, FRICTION_MODEL)
