...
#if !defined(NUSSELT_NUMBER_LI_MASON_H_INCLUDED)
#define NUSSELT_NUMBER_LI_MASON_H_INCLUDED
...
namespace Kratos
{
  class KRATOS_API(THERMAL_DEM_APPLICATION) NusseltLiMason : public ConvectionModel
  {
    public:
      ...
      // Pointer definition of NusseltLiMason
    ...
    private:
      ...
      // Assignment operator
      NusseltLiMason& operator=(NusseltLiMason const& rOther) {
        return *this;
      }

      // Copy constructor
      NusseltLiMason(NusseltLiMason const& rOther) {
        *this = rOther;
      }
...
#endif // NUSSELT_NUMBER_LI_MASON_H_INCLUDED
