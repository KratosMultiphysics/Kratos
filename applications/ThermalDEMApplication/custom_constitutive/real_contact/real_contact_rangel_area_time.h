...
#if !defined(REAL_CONTACT_MODEL_RANGEL_AREA_TIME_H_INCLUDED)
#define REAL_CONTACT_MODEL_RANGEL_AREA_TIME_H_INCLUDED
...
#endif // REAL_CONTACT_MODEL_RANGEL_AREA_TIME_H_INCLUDED
