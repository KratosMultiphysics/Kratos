...
#if !defined(INDIRECT_CONDUCTION_MODEL_VORONOI_B_H_INCLUDED)
...
namespace Kratos
{
  class KRATOS_API(THERMAL_DEM_APPLICATION) IndirectConductionVoronoiB : public IndirectConductionModel
  {
    public:
      ...
      // Pointer definition of IndirectConductionVoronoiB
...
#endif // INDIRECT_CONDUCTION_MODEL_VORONOI_B_H_INCLUDED
