...
namespace Kratos
{
  class KRATOS_API(THERMAL_DEM_APPLICATION) IndirectConductionModel : public HeatExchangeMechanism
  {
    public:
      ...
      // Pointer definition of IndirectConductionModel
    ...
    private:
      ...
      // Assignment operator
      IndirectConductionModel& operator=(IndirectConductionModel const& rOther) {
        return *this;
      }

      // Copy constructor
      IndirectConductionModel(IndirectConductionModel const& rOther) {
        *this = rOther;
      }
