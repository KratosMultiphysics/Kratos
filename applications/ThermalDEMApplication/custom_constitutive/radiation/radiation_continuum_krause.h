...
namespace Kratos
{
  class KRATOS_API(THERMAL_DEM_APPLICATION) RadiationContinuumKrause : public RadiationModel
  {
    public:
      ...
      // Pointer definition of RadiationContinuumKrause
    ...
    private:
      ...
      // Assignment operator
      RadiationContinuumKrause& operator=(RadiationContinuumKrause const& rOther) {
        return *this;
      }

      // Copy constructor
      RadiationContinuumKrause(RadiationContinuumKrause const& rOther) {
        *this = rOther;
      }
