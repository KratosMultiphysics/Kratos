...
namespace Kratos
{
  ...
  void KratosThermalDEMApplication::Register()
  {
    ...
    KRATOS_REGISTER_VARIABLE(FORCES_OPTION)
    ...
    KRATOS_REGISTER_VARIABLE(DEFORMATION_RATE)
    KRATOS_REGISTER_VARIABLE(DEFORMATION_RATE_START_TIME)
    KRATOS_REGISTER_VARIABLE(DEFORMATION_RATE_STOP_TIME)
