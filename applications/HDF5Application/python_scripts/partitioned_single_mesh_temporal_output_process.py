...
def FactoryHelper(settings, Model):
    """Return objects needed for constructing a partitioned temporal output process."""
...
def Factory(settings, Model):
    """Return a process for writing partitioned simulation results for a single mesh to HDF5."""
