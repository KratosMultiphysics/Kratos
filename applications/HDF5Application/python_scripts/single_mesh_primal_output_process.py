...
def CreateCoreSettings(user_settings):
    ...
    core_settings[0]["list_of_operations"] = [
        ...
        CreateOperationSettings("element_integration_point_output", user_settings["element_integration_point_value_settings"]),
        ...
        CreateOperationSettings("condition_integration_point_output", user_settings["condition_integration_point_value_settings"])
    ]
