...
class FactoryHelper:
    ...
    def Execute(self, settings, Model):
        ...
        element_data_value_output = self.ElementDataValueOutput(settings["element_data_value_settings"])
        nodal_data_value_output = self.NodalDataValueOutput(settings["nodal_data_value_settings"])
...
class ResultsFactory:
    ...
    def ElementDataValueOutput(self, element_data_value_settings):
        return hdf5_io.ElementDataValueOutput(element_data_value_settings)

    def NodalDataValueOutput(self, nodal_data_value_settings):
        return hdf5_io.NodalDataValueOutput(nodal_data_value_settings)
