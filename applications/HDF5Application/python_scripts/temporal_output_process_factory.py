...
class FactoryHelper:
    ...
    def Execute(self, settings, Model):
        ...
        temporal_output_process = hdf5_io.TemporalOutputProcess(
            model_part, hdf5_file_factory, settings["output_time_settings"], [model_part_output, nodal_results_output, element_results_output, historical_non_solution_step_nodal_results_output])
        return (temporal_output_process, model_part_output, [nodal_results_output, element_results_output, historical_non_solution_step_nodal_results_output])
