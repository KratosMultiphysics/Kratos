...
class TestNDDataIO(UnitTest.TestCase):
    ...
    def test_BoolNDData(self):
        numpy_array = np.random.random((self.data_communicator.Rank() + 10, self.data_communicator.Rank() + 10, self.data_communicator.Rank() + 10)) > 0.5
    ...
    def test_UIntNDData(self):
        numpy_array = (np.random.random((self.data_communicator.Rank() + 10, self.data_communicator.Rank() + 10, self.data_communicator.Rank() + 10)) * 255.0).astype(np.uint8)
    ...
    def test_IntNDData(self):
        numpy_array = (np.random.random((self.data_communicator.Rank() + 10, self.data_communicator.Rank() + 10, self.data_communicator.Rank() + 10)) * 1000).astype(np.int32)
    ...
    def test_FloatNDData(self):
        numpy_array = (np.random.random((self.data_communicator.Rank() + 10, self.data_communicator.Rank() + 10, self.data_communicator.Rank() + 10)) * 1000).astype(np.float64)
