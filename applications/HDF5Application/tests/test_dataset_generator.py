...
class TestDatasetGenerator(KratosUnittest.TestCase):
    ...
    def testSingleMeshMultiFileSameDatasetsGenerator(self):
        ...
        with KratosUnittest.WorkFolderScope("auxiliar_files/xdmf", __file__):
            ...
            generator = SingleMeshMultiFileSameDatasetGenerator("test-<time>.h5")
        ...
        with self.assertRaises(RuntimeError):
            generator = SingleMeshMultiFileSameDatasetGenerator("test-1.h5")

        with self.assertRaises(RuntimeError):
            generator = SingleMeshMultiFileSameDatasetGenerator("test-1:/ModelData<step>.h5")

        with self.assertRaises(RuntimeError):
            generator = SingleMeshMultiFileSameDatasetGenerator("test-<step>:/ModelData<step>.h5")
    ...
    def testSingleFileDatasetsGenerator1(self):
        ...
        with KratosUnittest.WorkFolderScope("auxiliar_files/xdmf", __file__):
            ...
            generator = GenericDatasetGenerator("test.h5:/Results-<time>")
    ...
    def testSingleFileDatasetsGenerator2(self):
        ...
        with KratosUnittest.WorkFolderScope("auxiliar_files/xdmf", __file__):
            ...
            generator = GenericDatasetGenerator("test.h5:/Results-<step>")
    ...
    def testMultiFileDatasetsGenerator1(self):
        ...
        with KratosUnittest.WorkFolderScope("auxiliar_files/xdmf", __file__):
            ...
            generator = GenericDatasetGenerator("test-<time>.h5")
    ...
    def testMultiFileDatasetsGenerator2(self):
        ...
        with KratosUnittest.WorkFolderScope("auxiliar_files/xdmf", __file__):
            ...
            generator = GenericDatasetGenerator("test-<step>.h5")
    ...
    def testGenericDatasetsGenerator(self):
        ...
        with KratosUnittest.WorkFolderScope("auxiliar_files/xdmf", __file__):
            ...
            generator = GenericDatasetGenerator("test-<step>.h5:/ResultsData_<time>", 1)
