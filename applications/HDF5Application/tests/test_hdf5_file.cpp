...
KRATOS_TEST_CASE_IN_SUITE(HDF5Test1, KratosHDF5TestSuite)
{
    ...
    HDF5File::Vector<int> write_data_1(5);
    ...
    HDF5File::Vector<array_1d<double, 3>> write_data_2(2);
    write_data_2[0] = x1;
    write_data_2[1] = x2;
    ...
    HDF5File::Vector<int> read_data_1;
    HDF5File::Vector<array_1d<double, 3>> read_data_2;
