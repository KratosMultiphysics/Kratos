...
namespace Kratos
{
    ...
    KRATOS_CREATE_VARIABLE(double, HEAT_FIELD);
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(HEAT_GRADIENT);
    KRATOS_CREATE_VARIABLE(double, HEAT_DISTANCE);
    ...
    {}
 	...
 	void KratosShapeOptimizationApplication::Register()
 	{
        ...
        // for centerline mapping
        KRATOS_REGISTER_VARIABLE(HEAT_FIELD);
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(HEAT_GRADIENT);
        KRATOS_REGISTER_VARIABLE(HEAT_DISTANCE);
 	}
