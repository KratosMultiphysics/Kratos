...
namespace Kratos
{
    ...
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(INITIAL_NORMALIZED_SURFACE_NORMAL);
    ...
    KRATOS_CREATE_VARIABLE(double, DF1DT_ACTIVE);
    ...
    {}
 	...
 	void KratosShapeOptimizationApplication::Register()
 	{
        ...
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(INITIAL_NORMALIZED_SURFACE_NORMAL);
        ...
        KRATOS_REGISTER_VARIABLE(DF1DT_ACTIVE);
