...
namespace Kratos
{
    ...
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(TOTAL_CONTROL_POINT_UPDATE);
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(SUMMED_CONTROL_POINT_UPDATE);
    ...
    {}
 	...
 	void KratosShapeOptimizationApplication::Register()
 	{
        ...
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(PROJECTION);
        
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(TOTAL_CONTROL_POINT_UPDATE);
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(SUMMED_CONTROL_POINT_UPDATE);
