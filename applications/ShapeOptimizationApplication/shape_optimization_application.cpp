...
namespace Kratos
{
    ...
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(DF1DX_RAW);

    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(DF1DX_MAPPED);
    KRATOS_CREATE_VARIABLE(double, DF1DX_MAPPED_N);
    ...
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(DC1DX_RAW);
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(DC2DX_RAW);
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(DC3DX_RAW);
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(DC4DX_RAW);
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(DC5DX_RAW);
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(DC6DX_RAW);
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(DC7DX_RAW);
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(DC8DX_RAW);
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(DC9DX_RAW);
    ...
    KRATOS_CREATE_VARIABLE(double, DC1DX_MAPPED_N);
    KRATOS_CREATE_VARIABLE(double, DC2DX_MAPPED_N);
    KRATOS_CREATE_VARIABLE(double, DC3DX_MAPPED_N);
    KRATOS_CREATE_VARIABLE(double, DC4DX_MAPPED_N);
    KRATOS_CREATE_VARIABLE(double, DC5DX_MAPPED_N);
    KRATOS_CREATE_VARIABLE(double, DC6DX_MAPPED_N);
    KRATOS_CREATE_VARIABLE(double, DC7DX_MAPPED_N);
    KRATOS_CREATE_VARIABLE(double, DC8DX_MAPPED_N);
    KRATOS_CREATE_VARIABLE(double, DC9DX_MAPPED_N);
    ...
    KRATOS_CREATE_VARIABLE(double, SEARCH_DIRECTION_N);
    KRATOS_CREATE_VARIABLE(double, CORRECTION_N);
    KRATOS_CREATE_VARIABLE(double, CONTROL_POINT_UPDATE_N);
    KRATOS_CREATE_VARIABLE(double, CONTROL_POINT_CHANGE_N);
    ...
    {}
 	...
 	void KratosShapeOptimizationApplication::Register()
 	{
        ...
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(DF1DX_RAW);

        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(DF1DX_MAPPED);
        KRATOS_REGISTER_VARIABLE(DF1DX_MAPPED_N);
        ...
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(DC1DX_RAW);
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(DC2DX_RAW);
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(DC3DX_RAW);
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(DC4DX_RAW);
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(DC5DX_RAW);
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(DC6DX_RAW);
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(DC7DX_RAW);
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(DC8DX_RAW);
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(DC9DX_RAW);
        ...
        KRATOS_REGISTER_VARIABLE(DC1DX_MAPPED_N);
        KRATOS_REGISTER_VARIABLE(DC2DX_MAPPED_N);
        KRATOS_REGISTER_VARIABLE(DC3DX_MAPPED_N);
        KRATOS_REGISTER_VARIABLE(DC4DX_MAPPED_N);
        KRATOS_REGISTER_VARIABLE(DC5DX_MAPPED_N);
        KRATOS_REGISTER_VARIABLE(DC6DX_MAPPED_N);
        KRATOS_REGISTER_VARIABLE(DC7DX_MAPPED_N);
        KRATOS_REGISTER_VARIABLE(DC8DX_MAPPED_N);
        KRATOS_REGISTER_VARIABLE(DC9DX_MAPPED_N);
        ...
        KRATOS_REGISTER_VARIABLE(SEARCH_DIRECTION_N);
        KRATOS_REGISTER_VARIABLE(CORRECTION_N);
        KRATOS_REGISTER_VARIABLE(CONTROL_POINT_UPDATE_N);
        KRATOS_REGISTER_VARIABLE(CONTROL_POINT_CHANGE_N);
