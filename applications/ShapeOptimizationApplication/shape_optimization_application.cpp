...
namespace Kratos
{
    ...
    KRATOS_CREATE_VARIABLE(double, SENS_HEATMAP_DESIGN_1D);
	KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(SENS_HEATMAP_DESIGN_3D);
    KRATOS_CREATE_VARIABLE(double, SENS_HEATMAP_CONTROL_1D);
	KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(SENS_HEATMAP_CONTROL_3D);

    KRATOS_CREATE_VARIABLE(double, HESSIAN_DF1DX);
    KRATOS_CREATE_VARIABLE(double, HESSIAN_DC1DX);
    KRATOS_CREATE_VARIABLE(double, HESSIAN_DF1DX_MAPPED);
    KRATOS_CREATE_VARIABLE(double, HESSIAN_DC1DX_MAPPED);
    KRATOS_CREATE_VARIABLE(double, HESSIAN_S);

    KRATOS_CREATE_VARIABLE(double, INV_HESSIAN_DF1DX);
    KRATOS_CREATE_VARIABLE(double, INV_HESSIAN_DC1DX);
    KRATOS_CREATE_VARIABLE(double, INV_HESSIAN_DF1DX_MAPPED);
    KRATOS_CREATE_VARIABLE(double, INV_HESSIAN_DC1DX_MAPPED);
    KRATOS_CREATE_VARIABLE(double, INV_HESSIAN_S);

    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(HEATMAP_DF1DX);
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(HEATMAP_DF1DX_MAPPED);
	...
	KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(HEATMAP_DC1DX_MAPPED);
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(HEATMAP_DC2DX_MAPPED);
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(HEATMAP_DC3DX_MAPPED);
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(HEATMAP_DC4DX_MAPPED);
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(HEATMAP_DC5DX_MAPPED);
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(HEATMAP_DC6DX_MAPPED);
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(HEATMAP_DC7DX_MAPPED);
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(HEATMAP_DC8DX_MAPPED);
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(HEATMAP_DC9DX_MAPPED);


    KRATOS_CREATE_VARIABLE(double, HEATMAP_BB_MAX_RELAXED);

    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(HEATMAP_S);

    KRATOS_CREATE_VARIABLE(double, HEATMAP_MAX);
    KRATOS_CREATE_VARIABLE(double, HEATMAP_MAX_RELAXED);
    KRATOS_CREATE_VARIABLE(double, HEATMAP_MAX_MAPPED);
    KRATOS_CREATE_VARIABLE(double, HEATMAP_MAX_MAPPED_RELAXED);

    KRATOS_CREATE_VARIABLE(double, HEATMAP_VALUE);
    KRATOS_CREATE_VARIABLE(double, HEATMAP_VALUE_RELAXED);
    KRATOS_CREATE_VARIABLE(double, HEATMAP_VALUE_MAPPED);
    KRATOS_CREATE_VARIABLE(double, HEATMAP_VALUE_MAPPED_RELAXED);

    KRATOS_CREATE_VARIABLE(double, HEATMAP_L2);
    KRATOS_CREATE_VARIABLE(double, HEATMAP_L2_RELAXED);
    KRATOS_CREATE_VARIABLE(double, HEATMAP_L2_MAPPED);
    KRATOS_CREATE_VARIABLE(double, HEATMAP_L2_MAPPED_RELAXED);

    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(DF1DX_NORMALIZED);
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(DC1DX_NORMALIZED);
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(DF1DX_MAPPED_NORMALIZED);
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(DC1DX_MAPPED_NORMALIZED);
    ...
    {}
 	...
 	void KratosShapeOptimizationApplication::Register()
 	{
	    ...
	    // For sensitivity heatmap
        KRATOS_REGISTER_VARIABLE(SENS_HEATMAP_DESIGN_1D);
	    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(SENS_HEATMAP_DESIGN_3D);
        KRATOS_REGISTER_VARIABLE(SENS_HEATMAP_CONTROL_1D);
	    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(SENS_HEATMAP_CONTROL_3D);

        KRATOS_REGISTER_VARIABLE(HESSIAN_DF1DX);
        KRATOS_REGISTER_VARIABLE(HESSIAN_DC1DX);
        KRATOS_REGISTER_VARIABLE(HESSIAN_DF1DX_MAPPED);
        KRATOS_REGISTER_VARIABLE(HESSIAN_DC1DX_MAPPED);
        KRATOS_REGISTER_VARIABLE(HESSIAN_S);

        KRATOS_REGISTER_VARIABLE(INV_HESSIAN_DF1DX);
        KRATOS_REGISTER_VARIABLE(INV_HESSIAN_DC1DX);
        KRATOS_REGISTER_VARIABLE(INV_HESSIAN_DF1DX_MAPPED);
        KRATOS_REGISTER_VARIABLE(INV_HESSIAN_DC1DX_MAPPED);
        KRATOS_REGISTER_VARIABLE(INV_HESSIAN_S);

        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(HEATMAP_DF1DX);

        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(HEATMAP_DF1DX_MAPPED);
        ...
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(HEATMAP_DC1DX_MAPPED);
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(HEATMAP_DC2DX_MAPPED);
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(HEATMAP_DC3DX_MAPPED);
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(HEATMAP_DC4DX_MAPPED);
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(HEATMAP_DC5DX_MAPPED);
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(HEATMAP_DC6DX_MAPPED);
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(HEATMAP_DC7DX_MAPPED);
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(HEATMAP_DC8DX_MAPPED);
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(HEATMAP_DC9DX_MAPPED);

        KRATOS_REGISTER_VARIABLE(HEATMAP_BB_MAX_RELAXED);
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(HEATMAP_S);

        KRATOS_REGISTER_VARIABLE(HEATMAP_MAX);
        KRATOS_REGISTER_VARIABLE(HEATMAP_MAX_RELAXED);
        KRATOS_REGISTER_VARIABLE(HEATMAP_MAX_MAPPED);
        KRATOS_REGISTER_VARIABLE(HEATMAP_MAX_MAPPED_RELAXED);

        KRATOS_REGISTER_VARIABLE(HEATMAP_VALUE);
        KRATOS_REGISTER_VARIABLE(HEATMAP_VALUE_RELAXED);
        KRATOS_REGISTER_VARIABLE(HEATMAP_VALUE_MAPPED);
        KRATOS_REGISTER_VARIABLE(HEATMAP_VALUE_MAPPED_RELAXED);

        KRATOS_REGISTER_VARIABLE(HEATMAP_L2);
        KRATOS_REGISTER_VARIABLE(HEATMAP_L2_RELAXED);
        KRATOS_REGISTER_VARIABLE(HEATMAP_L2_MAPPED);
        KRATOS_REGISTER_VARIABLE(HEATMAP_L2_MAPPED_RELAXED);

        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(DF1DX_NORMALIZED);
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(DC1DX_NORMALIZED);
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(DF1DX_MAPPED_NORMALIZED);
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(DC1DX_MAPPED_NORMALIZED);
