...
namespace Kratos
{
    ...
    KRATOS_CREATE_VARIABLE(double, IY_SENSITIVITY_1);
    KRATOS_CREATE_VARIABLE(double, IY_SENSITIVITY_2);
    KRATOS_CREATE_VARIABLE(double, IZ_SENSITIVITY_1);
    KRATOS_CREATE_VARIABLE(double, IZ_SENSITIVITY_2);
    ...
    {}
 	...
 	void KratosShapeOptimizationApplication::Register()
 	{
        ...
        KRATOS_REGISTER_VARIABLE(IY_SENSITIVITY_1);
        KRATOS_REGISTER_VARIABLE(IY_SENSITIVITY_2);
        KRATOS_REGISTER_VARIABLE(IZ_SENSITIVITY_1);
        KRATOS_REGISTER_VARIABLE(IZ_SENSITIVITY_2);
