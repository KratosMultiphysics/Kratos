...
namespace Kratos
{
    ...
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(DFDX_MAPPED);
    ...
    KRATOS_CREATE_VARIABLE(double,DFDALPHA);
    KRATOS_CREATE_VARIABLE(double,DFDALPHA_MAPPED);
    ...
    {}
 	...
 	void KratosShapeOptimizationApplication::Register()
 	{
        ...
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(DFDX_MAPPED);
        ...
        KRATOS_REGISTER_VARIABLE(DFDALPHA);
        KRATOS_REGISTER_VARIABLE(DFDALPHA_MAPPED);
