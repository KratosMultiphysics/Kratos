...
#if !defined( KRATOS_SHAPE_STRUCTURAL_MECHANICS_ELEMENT_UTILITIES_H_INCLUDED )
#define  KRATOS_SHAPE_STRUCTURAL_MECHANICS_ELEMENT_UTILITIES_H_INCLUDED
 ...
 */
void KRATOS_API(SHAPE_OPTIMIZATION_APPLICATION) CalculateRayleighDampingMatrix(
    Element& rElement,
 ...
 */
double KRATOS_API(SHAPE_OPTIMIZATION_APPLICATION) CalculateReferenceLength2D2N(const Element& rElement);
 ...
 */
double KRATOS_API(SHAPE_OPTIMIZATION_APPLICATION) CalculateCurrentLength2D2N(const Element& rElement);
 ...
 * @return reference length
 */
double KRATOS_API(SHAPE_OPTIMIZATION_APPLICATION) CalculateReferenceLength3D2N(const Element& rElement);
 ...
 * @return current length
 */
double KRATOS_API(SHAPE_OPTIMIZATION_APPLICATION) CalculateCurrentLength3D2N(const Element& rElement);
...
#endif // KRATOS_SHAPE_ShapeStructural_MECHANICS_ELEMENT_UTILITIES_H_INCLUDED  defined
