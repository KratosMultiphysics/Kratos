...
#if !defined(SHAPE_EICR_H_INCLUDED )
#define  SHAPE_EICR_H_INCLUDED

namespace Kratos
{
/** \brief SHAPE_EICR Element Independent CoRotational formulation
*
...
public:
    ...
    * @param rH the Axial Vector Jacobian Matrix computed with a previous call to SHAPE_EICR::Compute_H(rDisplacements)
    * @return the L matrix
    */
