...
#if !defined(KRATOS_SHAPE_STRUCTURAL_MECHANICS_MATH_UTILITIES)
#define KRATOS_SHAPE_STRUCTURAL_MECHANICS_MATH_UTILITIES
...
class ShapeStructuralMechanicsMathUtilities
{
public:
...
#endif /* KRATOS_SHAPE_STRUCTURAL_MECHANICS_MATH_UTILITIES defined */
