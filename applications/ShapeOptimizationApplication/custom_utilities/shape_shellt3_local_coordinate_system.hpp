...
//
#if !defined(KRATOS_SHAPE_SHELLT3_LOCAL_COORDINATE_SYSTEM_H_INCLUDED )
#define  KRATOS_SHAPE_SHELLT3_LOCAL_COORDINATE_SYSTEM_H_INCLUDED
...
namespace Kratos
{
/** \brief ShapeShellT3_LocalCoordinateSystem
*
* This class represent the local coordinate system of any element whose geometry
* is a TRIANGLE 3 in 3D space
*/
class ShapeShellT3_LocalCoordinateSystem
{

public:

    KRATOS_CLASS_POINTER_DEFINITION(ShapeShellT3_LocalCoordinateSystem);
...
public:
    ...
    ShapeShellT3_LocalCoordinateSystem(const Vector3Type& P1global,
...
#endif // KRATOS_SHAPE_SHELLT3_LOCAL_COORDINATE_SYSTEM_H_INCLUDED
