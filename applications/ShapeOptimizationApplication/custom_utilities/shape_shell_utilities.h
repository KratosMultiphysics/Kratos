...
#if !defined(KRATOS_SHAPE_SHELL_UTILITIES_H_INCLUDED )
#define  KRATOS_SHAPE_SHELL_UTILITIES_H_INCLUDED
...
class ShapeShellQ4_LocalCoordinateSystem; // forward declare to avoid circular includes

namespace ShapeShellUtilities {
...
public:
    ...
    void Calculate(const ShapeShellQ4_LocalCoordinateSystem& CS, const Matrix& dN);
...
}  // namespace ShapeShell Utilities.

}  // namespace Kratos.

#endif // KRATOS_SHAPE_SHELL_UTILITIES_H_INCLUDED  defined
