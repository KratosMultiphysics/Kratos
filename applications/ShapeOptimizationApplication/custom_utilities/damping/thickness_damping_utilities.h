...
#ifndef THICKNESS_DAMPING_UTILITIES_H
#define THICKNESS_DAMPING_UTILITIES_H
...
class KRATOS_API(SHAPE_OPTIMIZATION_APPLICATION) ThicknessDampingUtilities
{
public:
    ///@name Type Definitions
    ///@{
    ...
    /// Pointer definition of ThicknessDampingUtilities
    KRATOS_CLASS_POINTER_DEFINITION(ThicknessDampingUtilities);
    ...
    /// Default constructor.
    ThicknessDampingUtilities( ModelPart& modelPartToDamp, Parameters DampingSettings );

    /// Destructor.
    virtual ~ThicknessDampingUtilities()
    {
    }
    ...
    // --------------------------------------------------------------------------
    void DampNodalVariable( const Variable<double> &rNodalVariable );
    ...
    {
        return "ThicknessDampingUtilities";
    }

    /// Print information about this object.
    virtual void PrintInfo(std::ostream& rOStream) const
    {
        rOStream << "ThicknessDampingUtilities";
    }
...
private:
    ...
    /// Assignment operator.
//      ThicknessDampingUtilities& operator=(ThicknessDampingUtilities const& rOther);

    /// Copy constructor.
//      ThicknessDampingUtilities(ThicknessDampingUtilities const& rOther);


    ///@}

}; // Class ThicknessDampingUtilities
...
#endif // THICKNESS_DAMPING_UTILITIES_H
