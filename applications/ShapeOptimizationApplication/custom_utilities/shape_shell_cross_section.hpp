...
#if !defined(SHAPE_SHELL_CROSS_SECTION_H_INCLUDED)
#define SHAPE_SHELL_CROSS_SECTION_H_INCLUDED
...
#include "shape_shell_utilities.h"
#include "containers/flags.h"

namespace Kratos {

/** \brief ShapeShellCrossSection
*
* ShapeShellCrossSection is the base class for all shape_shell cross sections.
* This object is meant to be used by shape_shell elements to obtain the material response
...
*
*/
class KRATOS_API(STRUCTURAL_MECHANICS_APPLICATION) ShapeShellCrossSection : public Flags
{
...
public:
    ...
    KRATOS_CLASS_POINTER_DEFINITION(ShapeShellCrossSection);
    ...
    *
    * SectionParameters is an accessibility class for shape_shells using the
    * ShapeShellCrossSection class. It allows one to set and get vectors and matrices
    * associated with the shape_shell cross section, such as strains, stresses and the
    * constitutive matrix.
    *
    * An example application is taken from shape_shell_thick_3D4N.cpp, before it's
    ...
    */
    ...
    public:
        ...
        {
            return ShapeShellUtilities::GetThickness(rProps, mPlyIndex);
        }
        ...
        inline double GetLocation(const Properties& rProps) const
        {
            ...
            double current_location = ShapeShellUtilities::GetThickness(rProps) * 0.5;
        ...
        * @note this is different from what the ShapeShellCrossSection returns
        */
        inline double GetOrientationAngle(const Properties& rProps) const
        {
            return ShapeShellUtilities::GetOrientationAngle(rProps, mPlyIndex);
        }

        inline double GetOffset(const Properties& rProps) const
        {
            return ShapeShellUtilities::GetOffset(rProps);
        }
        ...
        {
            return ShapeShellUtilities::GetDensity(rProps, mPlyIndex) * GetThickness(rProps);
        }
...
public:
    ...
    * Default constructor
    */
    ShapeShellCrossSection();

    /**
    * Copy constructor
    * @param other the other cross section
    */
    ShapeShellCrossSection(const ShapeShellCrossSection& other);

    /**
    * Destructor
    */
    ~ShapeShellCrossSection() override;
    ...
    * @param other the other cross section
    */
    ShapeShellCrossSection& operator = (const ShapeShellCrossSection& other);
    ...
    */
    virtual ShapeShellCrossSection::Pointer Clone()const;
    ...
    */
    ...
    /**
    * Computes the transformations matrix for shape_shell generalized strains, given an orientation angle in radians.
    ...
    */
    ...
    /**
    * Computes the transformations matrix for shape_shell generalized stresses, given an orientation angle in radians.
    * @param radians the input angle in radians
    * @param T the output transformation matrix
    * @return
    */
...
public:
    ...
    * The default value is Zero (i.e. the center of the cross section coincides with the shape_shell mid-surface).
    * @return the offset
    */
    inline double GetOffset(const Properties& rProps) const
    {
    ...
    */
    ...
    /**
     * Returns the stiffness value to be used for the drilling part of the shape_shell formulation
    ...
    /**
    * Parses the shape_shell orthotropic material data from properties
    */
...
private:
    ...
    */
    void PrivateCopy(const ShapeShellCrossSection& other);
...
inline std::istream& operator >> (std::istream& rIStream, ShapeShellCrossSection& rThis);

inline std::ostream& operator << (std::ostream& rOStream, ShapeShellCrossSection& rThis)
{
...
#endif // SHAPE_SHELL_CROSS_SECTION_H_INCLUDED