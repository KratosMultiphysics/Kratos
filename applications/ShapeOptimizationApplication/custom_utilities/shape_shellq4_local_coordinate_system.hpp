...
#if !defined(KRATOS_SHAPE_SHELLQ4_LOCAL_COORDINATE_SYSTEM_H_INCLUDED )
#define  KRATOS_SHAPE_SHELLQ4_LOCAL_COORDINATE_SYSTEM_H_INCLUDED
...
namespace Kratos
{
/** \brief ShapeShellQ4_LocalCoordinateSystem
*
* This class represent the local coordinate system of any element whose geometry
* is a QUAD 4 in 3D space
*/
class ShapeShellQ4_LocalCoordinateSystem
{

public:

    KRATOS_CLASS_POINTER_DEFINITION(ShapeShellQ4_LocalCoordinateSystem);
...
public:
    ...
    ShapeShellQ4_LocalCoordinateSystem(const Vector3Type& P1global,
...
#endif // KRATOS_SHAPE_SHELLQ4_LOCAL_COORDINATE_SYSTEM_H_INCLUDED
