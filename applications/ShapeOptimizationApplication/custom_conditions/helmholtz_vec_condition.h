...
//
// ==============================================================================
#if !defined(KRATOS_HELMHOLTZ_VEC_CONDITION_3D_H_INCLUDED )
#define  KRATOS_HELMHOLTZ_VEC_CONDITION_3D_H_INCLUDED
 ...
 */
class KRATOS_API(SHAPE_OPTIMIZATION_APPLICATION)  HelmholtzVecCondition
    : public Condition
{
public:
    ...
    // Counted pointer of HelmholtzVecCondition
    KRATOS_CLASS_INTRUSIVE_POINTER_DEFINITION( HelmholtzVecCondition );
    ...
    // Constructor void
    HelmholtzVecCondition()
    {};

    // Constructor using an array of nodes
    HelmholtzVecCondition( IndexType NewId, GeometryType::Pointer pGeometry ):Condition(NewId,pGeometry)
    {};

    // Constructor using an array of nodes with properties
    HelmholtzVecCondition( IndexType NewId, GeometryType::Pointer pGeometry, PropertiesType::Pointer pProperties ):Condition(NewId,pGeometry,pProperties)
    {};

    ///Copy constructor
    HelmholtzVecCondition(HelmholtzVecCondition const& rOther);

    // Destructor
    ~HelmholtzVecCondition() override
    {};
    ...
    /// Assignment operator.
    HelmholtzVecCondition& operator=(HelmholtzVecCondition const& rOther);
...
private:
    ...
    MatrixType SetAndModifyConstitutiveLaw(const double detJ0) const;
    MatrixType CalculateBMatrix(const MatrixType& rDN_DX) const;    
...
#endif // KRATOS_HELMHOLTZ_VEC_CONDITION_3D_H_INCLUDED  defined
