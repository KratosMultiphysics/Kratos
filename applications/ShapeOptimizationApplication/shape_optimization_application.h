...
namespace Kratos
{
	...
	KRATOS_DEFINE_3D_VARIABLE_WITH_COMPONENTS(DFDX);

	KRATOS_DEFINE_3D_VARIABLE_WITH_COMPONENTS(DFDX_MAPPED);
    ...
    KRATOS_DEFINE_VARIABLE(double,DFDALPHA);
    KRATOS_DEFINE_VARIABLE(double,DFDALPHA_MAPPED);
