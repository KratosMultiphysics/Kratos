...
namespace Kratos
{
	...
	KRATOS_DEFINE_VARIABLE(double, DF1DX_MAPPED_N);
	...
	KRATOS_DEFINE_VARIABLE(double, DC1DX_MAPPED_N);
	KRATOS_DEFINE_VARIABLE(double, DC2DX_MAPPED_N);
	KRATOS_DEFINE_VARIABLE(double, DC3DX_MAPPED_N);
	KRATOS_DEFINE_VARIABLE(double, DC4DX_MAPPED_N);
	KRATOS_DEFINE_VARIABLE(double, DC5DX_MAPPED_N);
	KRATOS_DEFINE_VARIABLE(double, DC6DX_MAPPED_N);
	KRATOS_DEFINE_VARIABLE(double, DC7DX_MAPPED_N);
	KRATOS_DEFINE_VARIABLE(double, DC8DX_MAPPED_N);
	KRATOS_DEFINE_VARIABLE(double, DC9DX_MAPPED_N);
    ...
    KRATOS_DEFINE_VARIABLE(double, SEARCH_DIRECTION_N);
    KRATOS_DEFINE_VARIABLE(double, CORRECTION_N);
    KRATOS_DEFINE_VARIABLE(double, CONTROL_POINT_UPDATE_N);
    KRATOS_DEFINE_VARIABLE(double, CONTROL_POINT_CHANGE_N);
