...
namespace Kratos
{
	...
	KRATOS_DEFINE_3D_VARIABLE_WITH_COMPONENTS(CFD_GRADIENT);
	KRATOS_DEFINE_3D_VARIABLE_WITH_COMPONENTS(CSM_GRADIENT);
	KRATOS_DEFINE_3D_VARIABLE_WITH_COMPONENTS(CFD_GRADIENT_MAPPED);
	KRATOS_DEFINE_3D_VARIABLE_WITH_COMPONENTS(CSM_GRADIENT_MAPPED);      
