...
# Define controlled execution scope
...
@KratosUnittest.skipUnless(has_csm_app,"Missing required application: StructuralMechanicsApplication")
class opt_process_shell_test(ShapeOptimizationTestFactory):
    execution_directory = "opt_process_shell_test"
    execution_file = "run_test"

@KratosUnittest.skipUnless(has_csm_app and has_mesh_moving_app,"Missing (one or all) required applications: StructuralMechanicsApplication, MeshMovingApplication")
class opt_process_solid_test(ShapeOptimizationTestFactory):
    execution_directory = "opt_process_solid_test"
    execution_file = "run_test"

@KratosUnittest.skipUnless(has_csm_app and has_eigen_app,"Missing (one or all) required applications: StructuralMechanicsApplication, EigenSolversApplication")
