...
class mesh_packaging_test(ShapeOptimizationTestFactory):
    execution_directory = "mesh_packaging_test"
    execution_file = "run_test"

class plane_packaging_test(ShapeOptimizationTestFactory):
    execution_directory = "plane_packaging_test"
    execution_file = "run_test"
