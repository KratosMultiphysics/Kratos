...
from shape_optimization_test_factory import mesh_packaging_test
from shape_optimization_test_factory import plane_packaging_test
...
def AssembleTestSuites():
    ...
    smallSuite.addTest(mesh_packaging_test('test_execution'))
    smallSuite.addTest(plane_packaging_test('test_execution'))
