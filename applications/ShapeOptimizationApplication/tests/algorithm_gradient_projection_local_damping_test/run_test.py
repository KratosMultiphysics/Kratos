...
with open(os.path.join(output_directory, optimization_log_filename), 'r') as csvfile:
    ...
    TestCase().assertAlmostEqual(f, 6.19489E+01, 4)
    TestCase().assertAlmostEqual(c1, -9.98964E-01, 4)
    TestCase().assertAlmostEqual(c2, 1.95776E+00, 4)
    TestCase().assertAlmostEqual(c3, 1.00108E+00, 4)
