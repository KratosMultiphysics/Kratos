...
#if !defined(KRATOS_OUTPUT_SENSITIVITY_PROCESS_H_INCLUDED )
#define KRATOS_OUTPUT_SENSITIVITY_PROCESS_H_INCLUDED
 ...
 */
class OutputSensitivityProcess : public Process
{
public:
    ///@name Type Definitions
    ///@{

    KRATOS_CLASS_POINTER_DEFINITION(OutputSensitivityProcess);
    ...
    /// Constructor.
    OutputSensitivityProcess(ModelPart& rModelPart, Parameters& rParameters)
    ...
    /// Destructor.
    ~OutputSensitivityProcess() override {}
    ...
    {
        return "InputSensitivityProcess";
    }
...
private:
    ...
    ///@}
}; /* Class OutputSensitivityProcess */
...
inline std::istream& operator >> (std::istream& rIStream,
    OutputSensitivityProcess& rThis)
{
    return rIStream;
}
...
inline std::ostream& operator << (std::ostream& rOStream,
                                  const OutputSensitivityProcess& rThis)
{
...
#endif /* KRATOS_OUTPUT_SENSITIVITY_PROCESS_H_INCLUDED defined */
