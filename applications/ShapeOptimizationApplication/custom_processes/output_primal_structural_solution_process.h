...
#if !defined(KRATOS_OUTPUT_PRIMAL_STRUCTURAL_SOLUTION_PROCESS_H_INCLUDED )
#define KRATOS_OUTPUT_PRIMAL_STRUCTURAL_SOLUTION_PROCESS_H_INCLUDED
 ...
 */
class OutputPrimalStructuralSolutionProcess : public Process
{
public:
    ///@name Type Definitions
    ///@{

    KRATOS_CLASS_POINTER_DEFINITION(OutputPrimalStructuralSolutionProcess);
    ...
    /// Constructor.
    OutputPrimalStructuralSolutionProcess(ModelPart& rModelPart, Parameters& rParameters)
    ...
    /// Destructor.
    ~OutputPrimalStructuralSolutionProcess() override {}
    ...
    void ExecuteFinalizeSolutionStep() override
    {
        ...
        for (unsigned int i = 0; i < mVariables.size(); i++)
        {
            ...
            else if (KratosComponents< Variable<Vector> >::Has(mVariables[i])) //A.Kayis
            {
                ...
                for (auto it = std::begin(mrModelPart.Nodes()); it != std::end(mrModelPart.Nodes()); it++)
                {
                    const Vector& rData = it->FastGetSolutionStepValue(rVariable);
    ...
    {
        return "OutputPrimalStructuralSolutionProcess";
    }
...
private:
    ...
    ///@}
}; /* Class OutputPrimalStructuralSolutionProcess */
...
inline std::istream& operator >> (std::istream& rIStream,
                                  OutputPrimalStructuralSolutionProcess& rThis)
{
    return rIStream;
}
...
inline std::ostream& operator << (std::ostream& rOStream,
                                  const OutputPrimalStructuralSolutionProcess& rThis)
{
...
#endif /* KRATOS_OUTPUT_PRIMAL_STRUCTURAL_SOLUTION_PROCESS_H_INCLUDED defined */
