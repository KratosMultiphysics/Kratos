...
optimizer = optimizer_factory.CreateOptimizer( main_model_part, optimizationSettings )
...
responseFunctionSolver = response_function_factory.CreateSolver( main_model_part, optimizationSettings )
...
class kratosCSMAnalyzer( optimizer_factory.analyzerBaseClass ):
    def analyzeDesignAndReportToCommunicator( self, currentDesign, optimizationIteration, communicator ):
        ...
        if(communicator.isRequestingGradientOf("strain_energy")): 
            ...
            # computeAndAddMeshDerivativesToGradient(gradientOnDesignSurface, gradientForCompleteModelPart)                 

            communicator.reportGradient("strain_energy", gradientOnDesignSurface)         

# --------------------------------------------------------------------------
def iterateTimeStepInMainModelPart( optimizationIteration ):
    main_model_part.CloneTimeStep( optimizationIteration )

# --------------------------------------------------------------------------
def updateMeshOfMainModelPart():
...
# --------------------------------------------------------------------------
def computeAndAddMeshDerivativesToGradient(gradientOnDesignSurface, gradientForCompleteModelPart):
