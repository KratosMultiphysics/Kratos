...
class CustomAnalyzer(AnalyzerBaseClass):
    ...
    def __init__(self):
        ...
        self.load_mapper_settings = km.Parameters("""
        {
    ...
    def __RunCSM(self, opt_itr, new_mesh, displacements):
        ...
        if displacements == {}:
            ...
            cfd_to_csm_mapper = kma.MapperFactory.CreateMapper(csm_interface_part, self.cfd_interface_part, self.load_mapper_settings.Clone())
