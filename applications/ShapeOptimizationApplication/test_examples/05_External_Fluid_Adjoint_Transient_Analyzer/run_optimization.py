...
from analyzer_external_transient import KratosExternalTransientAnalyzer
...
external_analyzer = KratosExternalTransientAnalyzer(parameters, optimization_model_part)
optimizer = optimizer_factory.CreateOptimizer(parameters, optimization_model_part, external_analyzer)
optimizer.Optimize()
