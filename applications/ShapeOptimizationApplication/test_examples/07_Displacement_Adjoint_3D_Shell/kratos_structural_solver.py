...
##
## This is a copy of applications/StructuralMechanicsApplication/tests/Kratos_Execute_Structural_Test.py
## Adapted for the needs of the first optimization with adjoint solvers
##
