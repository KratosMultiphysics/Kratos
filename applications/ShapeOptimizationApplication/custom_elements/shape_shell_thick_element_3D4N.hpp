...
#if !defined(SHAPE_SHELL_THICK_ELEMENT_3D4N_H_INCLUDED )
#define  SHAPE_SHELL_THICK_ELEMENT_3D4N_H_INCLUDED
...
#include "custom_utilities/shape_shellq4_corotational_coordinate_transformation.hpp"
#include "custom_utilities/shape_shellq4_local_coordinate_system.hpp"
...
/** \brief ShapeShellThickElement3D4N
 *
 * This element represents a 4-node bilinear ShapeShell element
...
class KRATOS_API(STRUCTURAL_MECHANICS_APPLICATION) ShapeShellThickElement3D4N :
    public BaseShapeShellElement<typename std::conditional<TKinematics==ShapeShellKinematics::NONLINEAR_COROTATIONAL,
        ShapeShellQ4_CorotationalCoordinateTransformation,
        ShapeShellQ4_CoordinateTransformation>::type>
{
public:
    ...
    KRATOS_CLASS_INTRUSIVE_POINTER_DEFINITION(ShapeShellThickElement3D4N);
     ...
     *
     * References:
     * -   Dvorkin,Bathe, "A continuum mechanics based four node shape_shell
    ...
    struct MITC4Params {
        ...
        MITC4Params(const ShapeShellQ4_LocalCoordinateSystem& LCS);
    ...
    public:
         ...
         * Constructor
         */
        EASOperator(const ShapeShellQ4_LocalCoordinateSystem& LCS, EASOperatorStorage& storage);
    ...
    public:
         ...
         */
        inline void GaussPointComputation_Step1(double xi, double eta, const ShapeShellUtilities::JacobianOperator& jac,
         ...
         * by the integration weight, and their size is assumed to be those of a standard shape_shell element
    ...
    ShapeShellThickElement3D4N(IndexType NewId,
    ...
    ~ShapeShellThickElement3D4N() override = default;
...
protected:
     ...
     */
    ShapeShellThickElement3D4N() : BaseType()
    {
    }
...
private:
    ...
    void CalculateLaminaStrains(ShapeShellCrossSection::Pointer& section, const Vector& generalizedStrains, std::vector<VectorType>& rlaminateStrains);

    void CalculateLaminaStresses(ShapeShellCrossSection::Pointer& section, ShapeShellCrossSection::SectionParameters parameters, const std::vector<VectorType>& rlaminateStrains, std::vector<VectorType>& rlaminateStresses);
    ...
    double CalculateStenbergShearStabilization(const ShapeShellQ4_LocalCoordinateSystem& refCoordinateSystem, const double& meanThickness);

    void CalculateBMatrix(double xi, double eta,
                          const ShapeShellUtilities::JacobianOperator& Jac, const MITC4Params& params,
                          const Vector& N,
...
#endif // SHAPE_SHELL_THICK_ELEMENT_3D4N_H_INCLUDED
