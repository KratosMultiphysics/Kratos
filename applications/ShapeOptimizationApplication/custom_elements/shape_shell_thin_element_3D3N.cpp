...
#include "shape_shell_thin_element_3D3N.hpp"
#include "custom_utilities/shape_shell_utilities.h"
...
#define OPT_INTERPOLATE_RESULTS_TO_STANDARD_GAUSS_POINTS(X)
#else
#define OPT_INTERPOLATE_RESULTS_TO_STANDARD_GAUSS_POINTS(X) ShapeShellUtilities::InterpToStandardGaussPoints(X)
...
ShapeShellThinElement3D3N<TKinematics>::CalculationData::CalculationData(const CoordinateTransformationPointerType& pCoordinateTransformation,
...
// =====================================================================================
//
// Class ShapeShellThinElement3D3N
//
// =====================================================================================

template <ShapeShellKinematics TKinematics>
ShapeShellThinElement3D3N<TKinematics>::ShapeShellThinElement3D3N(IndexType NewId,
...
template <ShapeShellKinematics TKinematics>
Element::Pointer ShapeShellThinElement3D3N<TKinematics>::Create(IndexType NewId, NodesArrayType const& ThisNodes, PropertiesType::Pointer pProperties) const
{
    GeometryType::Pointer newGeom(GetGeometry().Create(ThisNodes));
    return Kratos::make_intrusive< ShapeShellThinElement3D3N >(NewId, newGeom, pProperties);
}

template <ShapeShellKinematics TKinematics>
Element::Pointer ShapeShellThinElement3D3N<TKinematics>::Create(IndexType NewId,  GeometryType::Pointer pGeom, PropertiesType::Pointer pProperties) const
{
    return Kratos::make_intrusive< ShapeShellThinElement3D3N >(NewId, pGeom, pProperties);
}

// =====================================================================================
//
// Class ShapeShellThinElement3D3N - Results on Gauss Points
//
// =====================================================================================

template <ShapeShellKinematics TKinematics>
void ShapeShellThinElement3D3N<TKinematics>::CalculateOnIntegrationPoints(const Variable<double>& rVariable,
        ...
        const ProcessInfo& rCurrentProcessInfo)
{
    ...
    if (!rCurrentProcessInfo.Has(NL_ITERATION_NUMBER)) {
        KRATOS_WARNING_ONCE("ShapeShellThinElement3D3N") << "Warning: Gauss point results have "
...
template <ShapeShellKinematics TKinematics>
void ShapeShellThinElement3D3N<TKinematics>::CalculateOnIntegrationPoints(const Variable<Matrix>& rVariable,
...
template <ShapeShellKinematics TKinematics>
int ShapeShellThinElement3D3N<TKinematics>::Check(const ProcessInfo& rCurrentProcessInfo) const
{
    KRATOS_TRY;
    ...
    KRATOS_ERROR_IF_NOT(points_number == 3) <<"ShapeShellThinElement3D3N - Wrong number of nodes" << points_number << std::endl;
...
// =====================================================================================
//
// Class ShapeShellThinElement3D3N - Private methods
//
// =====================================================================================

template <ShapeShellKinematics TKinematics>
void ShapeShellThinElement3D3N<TKinematics>::CheckGeneralizedStressOrStrainOutput(const Variable<Matrix>& rVariable, int& ijob, bool& bGlobal)
{
...
template <ShapeShellKinematics TKinematics>
void ShapeShellThinElement3D3N<TKinematics>::CalculateStressesFromForceResultants(VectorType& rstresses, const double& rthickness)
{
...
template <ShapeShellKinematics TKinematics>
void ShapeShellThinElement3D3N<TKinematics>::CalculateLaminaStrains(CalculationData& data)
{
...
template <ShapeShellKinematics TKinematics>
void ShapeShellThinElement3D3N<TKinematics>::CalculateLaminaStresses(CalculationData& data)
{
    ShapeShellCrossSection::Pointer& section = this->mSections[data.gpIndex];
...
template <ShapeShellKinematics TKinematics>
double ShapeShellThinElement3D3N<TKinematics>::CalculateTsaiWuPlaneStress(const CalculationData& data, const Matrix& rLamina_Strengths, const unsigned int& rPly)
{
...
template <ShapeShellKinematics TKinematics>
void ShapeShellThinElement3D3N<TKinematics>::CalculateVonMisesStress(const CalculationData& data, const Variable<double>& rVariable, double& rVon_Mises_Result)
{
...
template <ShapeShellKinematics TKinematics>
void ShapeShellThinElement3D3N<TKinematics>::InitializeCalculationData(CalculationData& data)
{
    //-------------------------------------
...
template <ShapeShellKinematics TKinematics>
void ShapeShellThinElement3D3N<TKinematics>::CalculateBMatrix(CalculationData& data)
{
    //---------------------------------------------
    // geom data
...
template <ShapeShellKinematics TKinematics>
void ShapeShellThinElement3D3N<TKinematics>::CalculateBeta0(CalculationData& data)
{
    data.beta0 = 1.0; // to be changed!
}

template <ShapeShellKinematics TKinematics>
void ShapeShellThinElement3D3N<TKinematics>::CalculateSectionResponse(CalculationData& data)
{
#ifdef OPT_USES_INTERIOR_GAUSS_POINTS
...
template <ShapeShellKinematics TKinematics>
void ShapeShellThinElement3D3N<TKinematics>::CalculateGaussPointContribution(CalculationData& data, MatrixType& LHS, VectorType& RHS)
{
    // calculate beta0
    CalculateBeta0(data);
...
template <ShapeShellKinematics TKinematics>
void ShapeShellThinElement3D3N<TKinematics>::ApplyCorrectionToRHS(CalculationData& data, VectorType& RHS)
{
    Vector3Type meanS;
    meanS.clear();
    for (int i = 0; i < 3; i++) {
...
template <ShapeShellKinematics TKinematics>
void ShapeShellThinElement3D3N<TKinematics>::AddBodyForces(CalculationData& data, VectorType& rRightHandSideVector)
{
...
template <ShapeShellKinematics TKinematics>
void ShapeShellThinElement3D3N<TKinematics>::CalculateAll(MatrixType& rLeftHandSideMatrix,
                                        ...
                                        const bool CalculateResidualVectorFlag)
{
    ...
    MatrixType M = ZeroMatrix(18, 18);
    MatrixType A = ZeroMatrix(18, 18);
    MatrixType K = ZeroMatrix(18, 18);

    // Gauss Loop.
    for (SizeType i = 0; i < this->GetNumberOfGPs(); ++i) {
        data.gpIndex = i;
        CalculateGaussPointContribution(data, A, rRightHandSideVector);
    }
    ...
    BaseType::CalculateMassMatrix(M,rCurrentProcessInfo);
    ...
    Vector nodal_vals = ZeroVector(18);
    const GeometryType& r_geometry = GetGeometry();
    for(unsigned int node_element = 0; node_element<3; node_element++)
    {
    ...
    //apply drichlet BC
    Vector temp;
    BaseType::GetValuesVector(temp,0);    
    noalias(rRightHandSideVector) -= prod(rLeftHandSideMatrix,temp);     

}

template <ShapeShellKinematics TKinematics>
bool ShapeShellThinElement3D3N<TKinematics>::TryCalculateOnIntegrationPoints_GeneralizedStrainsOrStresses(const Variable<Matrix>& rVariable,
        std::vector<Matrix>& rValues,
        const ProcessInfo& rCurrentProcessInfo)
{
...
template <ShapeShellKinematics TKinematics>
ShapeShellCrossSection::SectionBehaviorType ShapeShellThinElement3D3N<TKinematics>::GetSectionBehavior() const
{
...
// =====================================================================================
//
// Class ShapeShellThinElement3D3N - Serialization
//
// =====================================================================================

template <ShapeShellKinematics TKinematics>
void ShapeShellThinElement3D3N<TKinematics>::save(Serializer& rSerializer) const
{
    KRATOS_SERIALIZE_SAVE_BASE_CLASS(rSerializer, BaseType);
}

template <ShapeShellKinematics TKinematics>
void ShapeShellThinElement3D3N<TKinematics>::load(Serializer& rSerializer)
{
    KRATOS_SERIALIZE_LOAD_BASE_CLASS(rSerializer, BaseType);
}

template class ShapeShellThinElement3D3N<ShapeShellKinematics::LINEAR>;
template class ShapeShellThinElement3D3N<ShapeShellKinematics::NONLINEAR_COROTATIONAL>;
