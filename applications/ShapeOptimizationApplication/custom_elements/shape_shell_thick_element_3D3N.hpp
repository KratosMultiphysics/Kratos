...
#if !defined(SHAPE_SHELL_THICK_ELEMENT_3D3N_H_INCLUDED )
#define  SHAPE_SHELL_THICK_ELEMENT_3D3N_H_INCLUDED
...
/** \brief ShapeShellThickElement3D3N
*
...
/*
ShapeShell formulation reference:
...
public:
    ...
    KRATOS_CLASS_INTRUSIVE_POINTER_DEFINITION(ShapeShellThickElement3D3N);
    ...
    ShapeShellThickElement3D3N(IndexType NewId,
    ...
    ~ShapeShellThickElement3D3N() override = default;
...
protected:
    ...
    */
    ShapeShellThickElement3D3N() : BaseType()
    {
    }
...
#endif // SHAPE_SHELL_THICK_ELEMENT_3D3N_H_INCLUDED
