...
#if !defined(KRATOS_SMALL_DISPLACEMENT_BEAM_ELEMENT_3D2N_4_SENSITIVTY_ANALYSIS_H_INCLUDED )
#define  KRATOS_SMALL_DISPLACEMENT_BEAM_ELEMENT_3D2N_4_SENSITIVTY_ANALYSIS_H_INCLUDED 
...
class SmallDisplacementBeamElement3D2N4SensitivityAnalysis
    :public Element
{
public:
    ...
    /// Counted pointer of SmallDisplacementBeamElement3D2N4SensitivityAnalysis
    KRATOS_CLASS_POINTER_DEFINITION( SmallDisplacementBeamElement3D2N4SensitivityAnalysis );
...
public:
    ...
    SmallDisplacementBeamElement3D2N4SensitivityAnalysis(IndexType NewId, GeometryType::Pointer pGeometry);

    SmallDisplacementBeamElement3D2N4SensitivityAnalysis(IndexType NewId, GeometryType::Pointer pGeometry,  PropertiesType::Pointer pProperties);

    ///Copy constructor
    SmallDisplacementBeamElement3D2N4SensitivityAnalysis(SmallDisplacementBeamElement3D2N4SensitivityAnalysis const& rOther);

    /// Destructor.
    ~SmallDisplacementBeamElement3D2N4SensitivityAnalysis() override;
...
protected:
    ...
    ///@{
    SmallDisplacementBeamElement3D2N4SensitivityAnalysis() {};
...
}; // Class SmallDisplacementBeamElement3D2N4SensitivityAnalysis      public SmallDisplacementBeamElement3D2N4SensitivityAnalysis


} // namespace Kratos.
#endif // KRATOS_SMALL_DISPLACEMENT_BEAM_ELEMENT_3D2N_4_SENSITIVTY_ANALYSIS_H_INCLUDED   defined
