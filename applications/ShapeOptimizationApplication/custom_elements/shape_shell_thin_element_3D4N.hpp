...
#if !defined(SHAPE_SHELL_THIN_ELEMENT_3D4N_H_INCLUDED )
#define  SHAPE_SHELL_THIN_ELEMENT_3D4N_H_INCLUDED
...
///@name Kratos Classes
///@{
/** \brief ShapeShellThinElement3D4N
*
...
class KRATOS_API(STRUCTURAL_MECHANICS_APPLICATION) ShapeShellThinElement3D4N : public
...
public:
    ...
    ///@name Type Definitions
    ///@{
    KRATOS_CLASS_INTRUSIVE_POINTER_DEFINITION(ShapeShellThinElement3D4N);
    ...
    ///@name Life Cycle
    ///@{
    ShapeShellThinElement3D4N(IndexType NewId,
    ...
    ~ShapeShellThinElement3D4N() override = default;
...
protected:
    ...
    */
    ShapeShellThinElement3D4N() : BaseType()
    {
    }
...
private:
    ...
    public:
        ...
        ShapeShellQ4_LocalCoordinateSystem LCS;  /*!< current coordinate system */
        ShapeShellQ4_LocalCoordinateSystem LCS0; /*!< reference coordinate system */
    ...
    public:
        ...
        CalculationData(const ShapeShellQ4_LocalCoordinateSystem& localcoordsys,
    ...
    void CalculateShapeShellElementEnergy(const CalculationData& data, const Variable<double>& rVariable, double& rEnergy_Result);
...
#endif // SHAPE_SHELL_THIN_ELEMENT_3D4N_H_INCLUDED
