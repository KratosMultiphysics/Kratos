...
#include "shape_shell_thick_element_3D3N.hpp"
...
1.    Bletzinger, K.U., Bischoff, M. and Ramm, E., 2000. A unified approach for
    shear-locking-free triangular and rectangular shape_shell finite elements.
    Computers & Structures, 75(3), pp.321-334.
2.    Rama, G.,  Marinkovic, D.,  Zehn, M., 2016. Efficient co-rotational
    3-node shape_shell element. American Journal of Engineering and Applied Sciences,
...
ShapeShellThickElement3D3N<TKinematics>::CalculationData::CalculationData
...
// =========================================================================
//
// Class ShapeShellThickElement3D3N
//
// =========================================================================

template <ShapeShellKinematics TKinematics>
ShapeShellThickElement3D3N<TKinematics>::ShapeShellThickElement3D3N(IndexType NewId,
...
template <ShapeShellKinematics TKinematics>
Element::Pointer ShapeShellThickElement3D3N<TKinematics>::Create(IndexType NewId,
        NodesArrayType const& ThisNodes,
        PropertiesType::Pointer pProperties) const
{
    GeometryType::Pointer newGeom(GetGeometry().Create(ThisNodes));
    return Kratos::make_intrusive< ShapeShellThickElement3D3N >(NewId, newGeom, pProperties);
}
...
Element::Pointer ShapeShellThickElement3D3N<TKinematics>::Create(IndexType NewId,
        ...
        PropertiesType::Pointer pProperties) const
{
    return Kratos::make_intrusive< ShapeShellThickElement3D3N >(NewId, pGeom, pProperties);
}


// =====================================================================================
//
// Class ShapeShellThickElement3D3N - Results on Gauss Points
//
// =====================================================================================

template <ShapeShellKinematics TKinematics>
void ShapeShellThickElement3D3N<TKinematics>::CalculateOnIntegrationPoints(const Variable<double>& rVariable,
        ...
        const ProcessInfo& rCurrentProcessInfo)
{
    ...
    if (caseId > 19) { // calculate stresses
        ...
        ShapeShellT3_LocalCoordinateSystem referenceCoordinateSystem(
...
template <ShapeShellKinematics TKinematics>
void ShapeShellThickElement3D3N<TKinematics>::CalculateOnIntegrationPoints(const Variable<Matrix>& rVariable,
...
template <ShapeShellKinematics TKinematics>
int ShapeShellThickElement3D3N<TKinematics>::Check(const ProcessInfo& rCurrentProcessInfo) const
{
    KRATOS_TRY;
    ...
    KRATOS_ERROR_IF_NOT(points_number == 3) <<"ShapeShellThickElement3D3N - Wrong number of nodes" << points_number << std::endl;
...
// =====================================================================================
//
// Class ShapeShellThickElement3D3N - Private methods
//
// =====================================================================================

template <ShapeShellKinematics TKinematics>
void ShapeShellThickElement3D3N<TKinematics>::CalculateStressesFromForceResultants
...
template <ShapeShellKinematics TKinematics>
void ShapeShellThickElement3D3N<TKinematics>::CalculateLaminaStrains(CalculationData& data)
{
...
template <ShapeShellKinematics TKinematics>
void ShapeShellThickElement3D3N<TKinematics>::CalculateLaminaStresses(CalculationData& data)
{
    ShapeShellCrossSection::Pointer& section = this->mSections[data.gpIndex];
...
template <ShapeShellKinematics TKinematics>
double ShapeShellThickElement3D3N<TKinematics>::CalculateTsaiWuPlaneStress(const CalculationData& data, const Matrix& rLamina_Strengths, const unsigned int& rPly)
{
...
template <ShapeShellKinematics TKinematics>
void ShapeShellThickElement3D3N<TKinematics>::CalculateVonMisesStress(const CalculationData& data, const Variable<double>& rVariable, double& rVon_Mises_Result)
{
...
template <ShapeShellKinematics TKinematics>
void ShapeShellThickElement3D3N<TKinematics>::CalculateShapeShellElementEnergy(const CalculationData& data, const Variable<double>& rVariable, double& rEnergy_Result)
{
    // Energy calcs - these haven't been verified or tested yet.
...
template <ShapeShellKinematics TKinematics>
void ShapeShellThickElement3D3N<TKinematics>::CheckGeneralizedStressOrStrainOutput(const Variable<Matrix>& rVariable, int& ijob, bool& bGlobal)
{
...
template <ShapeShellKinematics TKinematics>
void ShapeShellThickElement3D3N<TKinematics>::CalculateSectionResponse(CalculationData& data)
{
...
template <ShapeShellKinematics TKinematics>
void ShapeShellThickElement3D3N<TKinematics>::InitializeCalculationData(CalculationData& data)
{
    //-------------------------------------
    ...
    // ---------------------------------------------------------------------
    // Total Formulation:
    //        as per Efficient Co-Rotational 3-Node ShapeShell Element paper (2016)
    // ---------------------------------------------------------------------
...
template <ShapeShellKinematics TKinematics>
void ShapeShellThickElement3D3N<TKinematics>::CalculateDSGc3Contribution(CalculationData& data, MatrixType& rLeftHandSideMatrix)
{
...
template <ShapeShellKinematics TKinematics>
void ShapeShellThickElement3D3N<TKinematics>::CalculateSmoothedDSGBMatrix(CalculationData& data)
{
    // Use smoothed DSG formulation according to [Nguyen-Thoi et al., 2013]
    //
...
template <ShapeShellKinematics TKinematics>
void ShapeShellThickElement3D3N<TKinematics>::CalculateDSGShearBMatrix(Matrix& shearBMatrix,const double& a, const double& b, const double& c, const double& d, const double& A)
{
    //node 1
...
template <ShapeShellKinematics TKinematics>
void ShapeShellThickElement3D3N<TKinematics>::AddBodyForces(CalculationData& data, VectorType& rRightHandSideVector)
{
...
template <ShapeShellKinematics TKinematics>
void ShapeShellThickElement3D3N<TKinematics>::CalculateAll(MatrixType& rLeftHandSideMatrix,
        ...
        const bool CalculateResidualVectorFlag)
{
    ...
    noalias(A) += prod(BTD, data.B);
    if (data.specialDSGc3) {
        CalculateDSGc3Contribution(data, A);
    }
...
template <ShapeShellKinematics TKinematics>
bool ShapeShellThickElement3D3N<TKinematics>::TryCalculateOnIntegrationPoints_GeneralizedStrainsOrStresses(const Variable<Matrix>& rVariable,
        std::vector<Matrix>& rValues,
        const ProcessInfo& rCurrentProcessInfo)
{
...
template <ShapeShellKinematics TKinematics>
ShapeShellCrossSection::SectionBehaviorType ShapeShellThickElement3D3N<TKinematics>::GetSectionBehavior() const
{
...
// =====================================================================================
//
// Class ShapeShellThickElement3D3N - Serialization
//
// =====================================================================================

template <ShapeShellKinematics TKinematics>
void ShapeShellThickElement3D3N<TKinematics>::save(Serializer& rSerializer) const
{
    KRATOS_SERIALIZE_SAVE_BASE_CLASS(rSerializer, BaseType);
}

template <ShapeShellKinematics TKinematics>
void ShapeShellThickElement3D3N<TKinematics>::load(Serializer& rSerializer)
{
    KRATOS_SERIALIZE_LOAD_BASE_CLASS(rSerializer, BaseType);
}

template class ShapeShellThickElement3D3N<ShapeShellKinematics::NONLINEAR_COROTATIONAL>;
