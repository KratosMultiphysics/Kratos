...
#if !defined(SHAPE_SHELL_THIN_ELEMENT_3D3N_H_INCLUDED )
#define  SHAPE_SHELL_THIN_ELEMENT_3D3N_H_INCLUDED
...
// Project includes
#include "custom_elements/base_shape_shell_element.h"
#include "custom_utilities/shape_shellt3_corotational_coordinate_transformation.hpp"
#include "custom_utilities/shape_shellt3_local_coordinate_system.hpp"
...
/** \brief ShapeShellThinElement3D3N
 *
 * This element represents a 3-node ShapeShell element
...
class KRATOS_API(STRUCTURAL_MECHANICS_APPLICATION) ShapeShellThinElement3D3N : public
    BaseShapeShellElement<typename std::conditional<TKinematics==ShapeShellKinematics::NONLINEAR_COROTATIONAL,
        ShapeShellT3_CorotationalCoordinateTransformation,
        ShapeShellT3_CoordinateTransformation>::type>
{
public:
    ...
    KRATOS_CLASS_INTRUSIVE_POINTER_DEFINITION(ShapeShellThinElement3D3N);

    using BaseType = BaseShapeShellElement<typename std::conditional<TKinematics==ShapeShellKinematics::NONLINEAR_COROTATIONAL,
        ShapeShellT3_CorotationalCoordinateTransformation,
        ShapeShellT3_CoordinateTransformation>::type>;
    ...
    ShapeShellThinElement3D3N(IndexType NewId,
    ...
    ~ShapeShellThinElement3D3N() override = default;
...
protected:
     ...
     */
    ShapeShellThinElement3D3N() : BaseType()
    {
    }
...
private:
    ...
    public:
        ...
        ShapeShellT3_LocalCoordinateSystem LCS0; /*!< reference coordinate system */
        ShapeShellT3_LocalCoordinateSystem LCS;  /*!< current coordinate system */
        ...
        ShapeShellCrossSection::SectionParameters SectionParameters; /*!< parameters for cross section calculations */
    ...
    /**
    * Returns the behavior of this shape_shell (thin/thick)
    * @return the shape_shell behavior
    */
    ShapeShellCrossSection::SectionBehaviorType GetSectionBehavior() const override;
...
#endif // SHAPE_SHELL_THIN_ELEMENT_3D3N_H_INCLUDED
