...
#if !defined(KRATOS_BASE_SHAPE_SHELL_ELEMENT_H_INCLUDED)
#define KRATOS_BASE_SHAPE_SHELL_ELEMENT_H_INCLUDED
...
#include "custom_utilities/shape_shell_cross_section.hpp"
...
enum class ShapeShellKinematics
{
    LINEAR,
...
class KRATOS_API(STRUCTURAL_MECHANICS_APPLICATION) BaseShapeShellElement
    : public Element
{
public:
    ///@name Type Definitions
    ...
    /// Pointer definition of BaseShapeShellElement
    KRATOS_CLASS_INTRUSIVE_POINTER_DEFINITION(BaseShapeShellElement);

    typedef std::vector< ShapeShellCrossSection::Pointer > CrossSectionContainerType;
    ...
    */
    BaseShapeShellElement(IndexType NewId,
    ...
    * Destructor
    */
    ~BaseShapeShellElement() override = default;
    ...
    */
    ...
    void SetCrossSectionsOnIntegrationPoints(std::vector< ShapeShellCrossSection::Pointer >& crossSections);
...
protected:
    ...
    */
    virtual ShapeShellCrossSection::SectionBehaviorType GetSectionBehavior() const;
...
#endif // KRATOS_BASE_SHAPE_SHELL_ELEMENT_H_INCLUDED  defined
