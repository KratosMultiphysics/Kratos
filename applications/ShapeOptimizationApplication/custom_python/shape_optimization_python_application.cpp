...
PYBIND11_MODULE(KratosShapeOptimizationApplication, m)
{
    ...
    // For coupled sensitivity analysis
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, CFD_GRADIENT);
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, CSM_GRADIENT);
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, CFD_GRADIENT_MAPPED);
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, CSM_GRADIENT_MAPPED);       
  }
