...
PYBIND11_MODULE(KratosShapeOptimizationApplication, m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, SENS_HEATMAP_DESIGN_1D);
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, SENS_HEATMAP_DESIGN_3D);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, SENS_HEATMAP_CONTROL_1D);
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, SENS_HEATMAP_CONTROL_3D);
  }
