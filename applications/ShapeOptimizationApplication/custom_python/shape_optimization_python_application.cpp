...
PYBIND11_MODULE(KratosShapeOptimizationApplication, m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, DF1DX_RAW);

    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, DF1DX_MAPPED);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, DF1DX_MAPPED_N);
    ...
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, DC1DX_RAW);
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, DC2DX_RAW);
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, DC3DX_RAW);
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, DC4DX_RAW);
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, DC5DX_RAW);
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, DC6DX_RAW);
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, DC7DX_RAW);
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, DC8DX_RAW);
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, DC9DX_RAW);
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, DC1DX_MAPPED_N);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, DC2DX_MAPPED_N);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, DC3DX_MAPPED_N);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, DC4DX_MAPPED_N);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, DC5DX_MAPPED_N);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, DC6DX_MAPPED_N);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, DC7DX_MAPPED_N);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, DC8DX_MAPPED_N);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, DC9DX_MAPPED_N);
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, SEARCH_DIRECTION_N);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, CORRECTION_N);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, CONTROL_POINT_UPDATE_N);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, CONTROL_POINT_CHANGE_N);
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, VARIABLE_SCALING_FACTOR);
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, LUMPED_AREA);
  }
