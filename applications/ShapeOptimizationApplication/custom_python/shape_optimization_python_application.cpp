...
PYBIND11_MODULE(KratosShapeOptimizationApplication, m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,COMPUTE_CONTROL_POINTS);
    ...
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m,HELMHOLTZ_ROTS);
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m,HELMHOLTZ_ROTS_SOURCE);    
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m,CONTROL_POINT);
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m,CONTROL_CURV);
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, NODAL_THICKNESS); 
