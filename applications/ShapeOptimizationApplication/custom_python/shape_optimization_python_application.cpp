...
namespace Python
{
  ...
  AddCustomProcessesToPython();
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(CROSS_AREA); //fusseder
    ...
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(ADJOINT_DISPLACEMENT_1);
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(ADJOINT_DISPLACEMENT_2);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(IY_SENSITIVITY_1);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(IY_SENSITIVITY_2);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(IZ_SENSITIVITY_1);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(IZ_SENSITIVITY_2);
