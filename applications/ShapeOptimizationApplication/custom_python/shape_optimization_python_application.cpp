...
PYBIND11_MODULE(KratosShapeOptimizationApplication, m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, DF1DT_PROJECTED);
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, THICKNESS_CONTROL_PROJECTED_UPDATE);
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, WATER_LEVEL);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, WATER_VOLUMES);
