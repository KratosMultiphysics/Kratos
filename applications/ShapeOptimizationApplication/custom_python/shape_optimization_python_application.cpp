...
PYBIND11_MODULE(KratosShapeOptimizationApplication, m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, HEAT_FIELD);
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, HEAT_GRADIENT);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, HEAT_DISTANCE);
  }
