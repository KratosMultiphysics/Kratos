...
PYBIND11_MODULE(KratosShapeOptimizationApplication, m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, HESSIAN_DF1DX);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, HESSIAN_DC1DX);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, HESSIAN_DF1DX_MAPPED);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, HESSIAN_DC1DX_MAPPED);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, HESSIAN_S);

    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, INV_HESSIAN_DF1DX);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, INV_HESSIAN_DC1DX);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, INV_HESSIAN_DF1DX_MAPPED);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, INV_HESSIAN_DC1DX_MAPPED);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, INV_HESSIAN_S);
    ...
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, HEATMAP_DF1DX_MAPPED);
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, HEATMAP_DC1DX_MAPPED);
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, HEATMAP_S);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, HEATMAP_BB_MAX_RELAXED);

    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, HEATMAP_MAX);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, HEATMAP_MAX_RELAXED);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, HEATMAP_MAX_MAPPED);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, HEATMAP_MAX_MAPPED_RELAXED);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, HEATMAP_VALUE);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, HEATMAP_VALUE_RELAXED);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, HEATMAP_VALUE_MAPPED);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, HEATMAP_VALUE_MAPPED_RELAXED);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, HEATMAP_L2);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, HEATMAP_L2_RELAXED);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, HEATMAP_L2_MAPPED);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, HEATMAP_L2_MAPPED_RELAXED);

    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, DF1DX_NORMALIZED);
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, DC1DX_NORMALIZED);
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, DF1DX_MAPPED_NORMALIZED);
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, DC1DX_MAPPED_NORMALIZED);
  }
