...
PYBIND11_MODULE(KratosShapeOptimizationApplication, m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, DFDX);

    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, DFDX_MAPPED);
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, DFDALPHA);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, DFDALPHA_MAPPED);
