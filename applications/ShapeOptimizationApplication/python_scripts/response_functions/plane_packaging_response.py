...
class PlanePackagingResponse(PackagingResponseBase):
    """
    A class for plane packaging response function. The plane is defined by an origin point and a normal vector.
    By default the normal of the plane indicates the feasible side of the plane (see setting 'infeasible_side')
    """
