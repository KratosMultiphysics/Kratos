...
def CreateOptimizationAlgorithm(optimization_settings, analyzer, communicator, model_part_controller):
    ...
    if algorithm_name == "steepest_descent":
        ...
        return AlgorithmShapeFractionOptimization(optimization_settings,
                                         ...
                                         communicator,
                                         model_part_controller)
    elif algorithm_name == "free_thickness_optimization":
        ...
        return AlgorithmFreeThicknessOptimization(optimization_settings,
                                                  ...
                                                  communicator,
                                                  model_part_controller)
    elif algorithm_name == "free_thickness_optimization_v2":
        from .algorithm_free_thickness_optimization_v2 import AlgorithmFreeThicknessOptimizationv2
        return AlgorithmFreeThicknessOptimizationv2(optimization_settings,
                                                  analyzer,
                                                  communicator,
                                                  model_part_controller)

    elif algorithm_name == "free_thickness_optimization_v2_rgp":
        from .algorithm_free_thickness_optimization_v2_rgp import AlgorithmFreeThicknessOptimizationv2RGP
        return AlgorithmFreeThicknessOptimizationv2RGP(optimization_settings,
                                                       analyzer,
                                                       communicator,
                                                       model_part_controller)
        ...
        return AlgorithmFreeThicknessRelaxedGradientProjection(optimization_settings,
                                                               ...
                                                               communicator,
                                                               model_part_controller)
    elif algorithm_name == "thickness_optimization":
