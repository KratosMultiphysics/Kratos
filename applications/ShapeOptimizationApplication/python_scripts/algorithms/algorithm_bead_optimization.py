        ...
        for outer_iteration in range(1,self.max_outer_iterations+1):
            for inner_iteration in range(1,self.max_inner_iterations+1):
                ...
                if self.data_logger.SensitivityHeatmapLogging():
                    ComputeSensitivityHeatmap(self.design_surface, self.objectives, self.constraints, None, total_iteration, design_variable_name="ALPHA", design_variable_dimension=1)
