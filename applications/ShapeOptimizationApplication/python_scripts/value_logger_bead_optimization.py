...
class ValueLoggerBeadOptimization( ValueLogger ):
    ...
    def InitializeLogging( self ):
        with open(self.complete_log_file_name, 'w') as csvfile:
            ...
            row.append("{:>12s}".format("lambda_p"))
            row.append("{:>13s}".format("p"))
            row.append("{:>13s}".format("scaling_p"))
    ...
    def _WriteCurrentValuesToFile( self ):
        with open(self.complete_log_file_name, 'a') as csvfile:
            ...
            row.append("{:>12f}".format(self.value_history["lagrange_value_relative_change"][self.current_iteration]*100))
            ...
            row.append("{:>12f}".format(self.value_history["penalty_lambda"][self.current_iteration]))
