...
from .value_logger_relaxed_gradient_projection import ValueLoggerRelaxedGradientProjection
from .value_logger_sequential_quadratic_programming import ValueLoggerSequentialQuadraticProgramming
from .value_logger_sequential_quadratic_programming_with_line_search import ValueLoggerSequentialQuadraticProgrammingWithLineSearch
...
class DataLogger():
    ...
    def __CreateValueLogger( self ):
        ...
        elif AlgorithmName == "sequential_quadratic_programming":
            LineSearch = self.OptimizationSettings["optimization_algorithm"]["line_search"]["line_search_type"].GetString()
            if LineSearch == "quadratic_approximation":
                return ValueLoggerSequentialQuadraticProgrammingWithLineSearch( self.Communicator, self.OptimizationSettings )
            else:
                return ValueLoggerSequentialQuadraticProgramming( self.Communicator, self.OptimizationSettings )
        else:
