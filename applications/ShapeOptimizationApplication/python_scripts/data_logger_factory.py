...
from .value_logger_gradient_descent_akin import ValueLoggerGradientDescentAkin
...
class DataLogger():
    ...
    def __CreateValueLogger( self ):
        ...
        elif AlgorithmName == "gradient_descent_akin":
            return ValueLoggerGradientDescentAkin( self.Communicator, self.OptimizationSettings )
        else:
