...
class KratosInternalAnalyzer( AnalyzerBaseClass ):
    ...
    def __CreateResponseFunctions( specified_responses, model ):
        ...
        csm_response_functions = ["strain_energy", "mass", "eigenfrequency", "adjoint_local_stress", "adjoint_max_stress", "adjoint_gauss_point_kreisselmeier_aggregation", "adjoint_KS_max_stress"]
