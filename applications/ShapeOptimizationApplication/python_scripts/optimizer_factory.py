...
class Optimizer:
    ...
    def __AddVariablesToBeUsedByAllAlgorithms(self):
        ...
        model_part.AddNodalSolutionStepVariable(KSO.INITIAL_NORMALIZED_SURFACE_NORMAL)
        ...
        model_part.AddNodalSolutionStepVariable(nodal_variable)
        nodal_variable = KM.KratosGlobals.GetVariable("DF1DT_ACTIVE")
        model_part.AddNodalSolutionStepVariable(nodal_variable)
        ...
        for itr in range(1,number_of_constraints+1):
            ...
            model_part.AddNodalSolutionStepVariable(nodal_variable)
            nodal_variable = KM.KratosGlobals.GetVariable(f"DC{(itr)}DT_ACTIVE")
            model_part.AddNodalSolutionStepVariable(nodal_variable)
