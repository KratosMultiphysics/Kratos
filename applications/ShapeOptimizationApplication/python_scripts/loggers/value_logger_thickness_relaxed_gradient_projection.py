...
# ==============================================================================
class ValueLoggerThicknessRelaxedGradientProjection( ValueLogger ):
    # --------------------------------------------------------------------------
    def InitializeLogging( self ):
        with open(self.complete_log_file_name, 'w') as csvfile:
            ...
            row.append("{:>13s}".format("t_lower_bound"))
            row.append("{:>13s}".format("t_upper_bound"))

            row.append("{:>13s}".format("t_lower_bound_buffer_value"))
            row.append("{:>13s}".format("t_lower_bound_buffer_size"))
            row.append("{:>13s}".format("t_lower_bound_buffer_size_factor"))
            row.append("{:>13s}".format("t_lower_bound_central_buffer_value"))
            row.append("{:>13s}".format("t_lower_bound_lower_buffer_value"))
            row.append("{:>13s}".format("t_lower_bound_upper_buffer_value"))

            row.append("{:>13s}".format("t_upper_bound_buffer_value"))
            row.append("{:>13s}".format("t_upper_bound_buffer_size"))
            row.append("{:>13s}".format("t_upper_bound_buffer_size_factor"))
            row.append("{:>13s}".format("t_upper_bound_central_buffer_value"))
            row.append("{:>13s}".format("t_upper_bound_lower_buffer_value"))
            row.append("{:>13s}".format("t_upper_bound_upper_buffer_value"))
    ...
    def _WriteCurrentValuesToFile( self ):
        with open(self.complete_log_file_name, 'a') as csvfile:
            ...
            row.append(" {:> .5E}".format(self.history["t_lower_bound"][self.current_index]))
            row.append(" {:> .5E}".format(self.history["t_upper_bound"][self.current_index]))

            row.append(" {:> .5E}".format(self.history["t_lower_bound_buffer_value"][self.current_index]))
            row.append(" {:> .5E}".format(self.history["t_lower_bound_buffer_size"][self.current_index]))
            row.append(" {:> .5E}".format(self.history["t_lower_bound_buffer_size_factor"][self.current_index]))
            row.append(" {:> .5E}".format(self.history["t_lower_bound_central_buffer_value"][self.current_index] + 0))
            row.append(" {:> .5E}".format(self.history["t_lower_bound_lower_buffer_value"][self.current_index] + 0))
            row.append(" {:> .5E}".format(self.history["t_lower_bound_upper_buffer_value"][self.current_index] + 0))

            row.append(" {:> .5E}".format(self.history["t_upper_bound_buffer_value"][self.current_index]))
            row.append(" {:> .5E}".format(self.history["t_upper_bound_buffer_size"][self.current_index]))
            row.append(" {:> .5E}".format(self.history["t_upper_bound_buffer_size_factor"][self.current_index]))
            row.append(" {:> .5E}".format(self.history["t_upper_bound_central_buffer_value"][self.current_index] + 0))
            row.append(" {:> .5E}".format(self.history["t_upper_bound_lower_buffer_value"][self.current_index] + 0))
            row.append(" {:> .5E}".format(self.history["t_upper_bound_upper_buffer_value"][self.current_index] + 0))
