...
from .mapping import in_plane_vertex_morphing_mapper, sliding_edge_vertex_morphing_mapper
...
def CreateMapper(origin_model_part, destination_model_part, mapper_settings):
    default_settings = KM.Parameters("""
    {
        ...
        "sliding_edge_morphing"      : false,
        "sliding_edge_morphing_settings" : {},
    ...
    elif mapper_settings["sliding_edge_morphing"].GetBool():
        return sliding_edge_vertex_morphing_mapper.SlidingEdgeVertexMorphingMapper(origin_model_part, destination_model_part, mapper_settings)
