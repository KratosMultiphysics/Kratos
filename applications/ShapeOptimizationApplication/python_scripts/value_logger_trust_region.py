...
class ValueLoggerTrustRegion( ValueLogger ):
    ...
    def _WriteCurrentValuesToConsole( self ):
        ...
        KM.Logger.PrintInfo("\nShapeOpt", "Current value of objective = ", round(self.history["response_value"][objective_id][self.current_index],12))
        ...
        KM.Logger.PrintInfo("\nShapeOpt", "NormInf3D of dX = ", round(self.history["norm_dX"][self.current_index],6))

        KM.Logger.PrintInfo("\nShapeOpt", "len_bar_obj = ", round(self.history["len_bar_obj"][self.current_index],6))
        KM.Logger.PrintInfo("ShapeOpt", "adj_len_bar_obj = ", round(self.history["adj_len_bar_obj"][self.current_index],6))

        KM.Logger.PrintInfo("\nShapeOpt", "len_bar_cons = ", [round(entry, 6) for entry in self.history["len_bar_cons"][self.current_index]])
