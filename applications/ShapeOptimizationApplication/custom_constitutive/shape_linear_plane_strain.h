...
#if !defined (KRATOS_SHAPE_LINEAR_PLANE_STRAIN_LAW_H_INCLUDED)
#define  KRATOS_SHAPE_LINEAR_PLANE_STRAIN_LAW_H_INCLUDED
 ...
 */
class KRATOS_API(SHAPE_OPTIMIZATION_APPLICATION) ShapeLinearPlaneStrain
...
public:
    ...
    /// Counted pointer of ShapeLinearPlaneStrain
    KRATOS_CLASS_POINTER_DEFINITION( ShapeLinearPlaneStrain );
     ...
     * Copy constructor.
     */
    ShapeLinearPlaneStrain (const ShapeLinearPlaneStrain& rOther);


    /**
     * @brief Destructor.
     */
    ~ShapeLinearPlaneStrain() override;
...
#endif // KRATOS_SHAPE_LINEAR_PLANE_STRAIN_LAW_H_INCLUDED  defined
