...
#if !defined (KRATOS_SHAPE_ELASTIC_ISOTROPIC_3D_LAW_H_INCLUDED)
#define  KRATOS_SHAPE_ELASTIC_ISOTROPIC_3D_LAW_H_INCLUDED
 ...
 */
class KRATOS_API(SHAPE_OPTIMIZATION_APPLICATION) ShapeElasticIsotropic3D
...
public:
    ...
    /// Counted pointer of ShapeElasticIsotropic3D
    KRATOS_CLASS_POINTER_DEFINITION( ShapeElasticIsotropic3D );
     ...
     * Copy constructor.
     */
    ShapeElasticIsotropic3D (const ShapeElasticIsotropic3D& rOther);

    /**
     * @brief Destructor.
     */
    ~ShapeElasticIsotropic3D() override;
...
}; // Class ShapeElasticIsotropic3D
}  // namespace Kratos.
#endif // KRATOS_SHAPE_ELASTIC_ISOTROPIC_3D_LAW_H_INCLUDED  defined
