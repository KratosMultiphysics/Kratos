...
namespace Kratos
{
    ...
    KRATOS_CREATE_VARIABLE( double, ELEMENT_SIZE)
    KRATOS_CREATE_VARIABLE( double, STRUCTURE_VOLUME)
    ...
    void KratosTopologyOptimizationApplication::Register()
    {
        ...
        KRATOS_REGISTER_VARIABLE( ELEMENT_SIZE )
        KRATOS_REGISTER_VARIABLE( STRUCTURE_VOLUME )
