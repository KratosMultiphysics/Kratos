...
template<class TSparseSpace,
         ...
         class TLinearSolver
         >
class SpalartAllmarasTurbulenceModelForChimera : public Process
{
public:
    ///@name Type Definitions
    ///@{

    /// Pointer definition of SpalartAllmarasTurbulenceModelForChimera
    KRATOS_CLASS_POINTER_DEFINITION(SpalartAllmarasTurbulenceModelForChimera);
...
//         SchemePointerType pScheme = SchemePointerType( new ResidualBasedIncrementalUpdateStaticScheme< TSparseSpace, TDenseSpace > () );
    ...
    ~SpalartAllmarasTurbulenceModelForChimera() override
    {
    }
...
/*
    ...
    std::string Info() const override
    {
        ...
        buffer << "SpalartAllmarasTurbulenceModelForChimera";
        return buffer.str();
    }
    ...
    {
        rOStream << "SpalartAllmarasTurbulenceModelForChimera";
    }
...
protected:
    ...
    SpalartAllmarasTurbulenceModelForChimera(ModelPart& rModelPart)
        :
        Process(),
...
//            return dT_norm;
    ...
    SpalartAllmarasTurbulenceModelForChimera & operator=(SpalartAllmarasTurbulenceModelForChimera const& rOther)
    {
        return *this;
    }
    ...
    SpalartAllmarasTurbulenceModelForChimera(SpalartAllmarasTurbulenceModelForChimera const& rOther)
...
}; // Class SpalartAllmarasTurbulenceModelForChimera
...
inline std::istream & operator >>(std::istream& rIStream,
                                  SpalartAllmarasTurbulenceModelForChimera<TSparseSpace, TDenseSpace, TLinearSolver>& rThis)
{
    return rIStream;
}
...
inline std::ostream & operator <<(std::ostream& rOStream,
                                  const SpalartAllmarasTurbulenceModelForChimera<TSparseSpace, TDenseSpace, TLinearSolver>& rThis)
{
