...
#include "custom_utilities/helper_classes_for_constraint_builder_for_chimera.h"
    ...
    : public ResidualBasedBlockBuilderAndSolver<TSparseSpace, TDenseSpace, TLinearSolver>
{
  public:
        ...
        ) override
    {
        ...
        KRATOS_INFO_IF("ResidualBasedBlockBuilderAndSolverWithConstraintsForChimera", ( this->GetEchoLevel() > 1 && rModelPart.GetCommunicator().MyPID() == 0)) << "Setting up the dofs" << std::endl;
        ...
        KRATOS_INFO_IF("ResidualBasedBlockBuilderAndSolverWithConstraintsForChimera", ( this->GetEchoLevel() > 2)) << "Number of threads" << nthreads << "\n" << std::endl;
...
//             dofs_aux_list[i] = set_type( allocators[i]);
        ...
        KRATOS_INFO_IF("ResidualBasedBlockBuilderAndSolverWithConstraintsForChimera", ( this->GetEchoLevel() > 2)) << "Initializing element loop" << std::endl;
        ...
        #pragma omp parallel firstprivate(nelements, ElementalDofList, AuxiliarDofList)
        {
            ...
            KRATOS_INFO_IF("ResidualBasedBlockBuilderAndSolverWithConstraintsForChimera", ( this->GetEchoLevel() > 2)) << "Initializing condition loop" << std::endl;
        ...
        KRATOS_INFO_IF("ResidualBasedBlockBuilderAndSolverWithConstraintsForChimera", ( this->GetEchoLevel() > 2)) << "Initializing tree reduction\n" << std::endl;
        ...
        KRATOS_INFO_IF("ResidualBasedBlockBuilderAndSolverWithConstraintsForChimera", ( this->GetEchoLevel() > 2)) << "Initializing ordered array filling\n" << std::endl;
        ...
        KRATOS_INFO_IF("ResidualBasedBlockBuilderAndSolverWithConstraintsForChimera", ( this->GetEchoLevel() > 2)) << "Number of degrees of freedom:" << BaseType::mDofSet.size() << std::endl;

        BaseType::mDofSetIsInitialized = true;

        KRATOS_INFO_IF("ResidualBasedBlockBuilderAndSolverWithConstraintsForChimera", ( this->GetEchoLevel() > 2 && rModelPart.GetCommunicator().MyPID() == 0)) << "Finished setting up the dofs" << std::endl;

        KRATOS_INFO_IF("ResidualBasedBlockBuilderAndSolverWithConstraintsForChimera", ( this->GetEchoLevel() > 2)) << "Initializing lock array" << std::endl;
        ...
        KRATOS_INFO_IF("ResidualBasedBlockBuilderAndSolverWithConstraintsForChimera", ( this->GetEchoLevel() > 2)) << "End of setup dof set\n" << std::endl;
...
#pragma omp parallel for schedule(guided, 512) firstprivate(n_constraints, constraints_begin)
        ...
        KRATOS_CATCH("ResidualBasedBlockBuilderAndSolverWithConstraintsForChimera failed to initialize solution step.")
    }
...
#pragma omp parallel for schedule(guided, 512) firstprivate(n_constraints, constraints_begin)
        ...
        KRATOS_CATCH("ResidualBasedBlockBuilderAndSolverWithConstraintsForChimera failed to finalize solution step.")
    }
  ...
  protected:
        ...
        TSystemVectorType &b)
    {
        ...
        KRATOS_INFO_IF("ResidualBasedBlockBuilderAndSolverWithConstraintsForChimera", (this->GetEchoLevel() >= 1 && rModelPart.GetCommunicator().MyPID() == 0)) << "Constraints update time : " << stop_update_constraints - start_update_constraints << std::endl;
        ...
        KRATOS_INFO_IF("ResidualBasedBlockBuilderAndSolverWithConstraintsForChimera", (this->GetEchoLevel() == 3)) << "Before the solution of the system"
        ...
        KRATOS_INFO_IF("ResidualBasedBlockBuilderAndSolverWithConstraintsForChimera", (this->GetEchoLevel() >= 1 && rModelPart.GetCommunicator().MyPID() == 0)) << "Reconstruct slaves time: " << stop_reconstruct_slaves - start_reconstruct_slaves << std::endl;


        KRATOS_INFO_IF("ResidualBasedBlockBuilderAndSolverWithConstraintsForChimera", (this->GetEchoLevel() >= 1 && rModelPart.GetCommunicator().MyPID() == 0)) << "System solve time: " << stop_solve - start_solve << std::endl;

        KRATOS_INFO_IF("ResidualBasedBlockBuilderAndSolverWithConstraintsForChimera", (this->GetEchoLevel() == 3)) << "After the solution of the system"
                                                                                                         << "\nSystem Matrix = " << A << "\nUnknowns vector = " << Dx << "\nRHS vector = " << b << std::endl;
...
#pragma omp for schedule(guided, 512)
        ...
        KRATOS_INFO_IF("ResidualBasedBlockBuilderAndSolverWithConstraintsForChimera", (this->GetEchoLevel() >= 1 && rModelPart.GetCommunicator().MyPID() == 0)) << "Build time: " << stop_build - start_build << std::endl;

        //for (int i = 0; i < A_size; i++)
        //    omp_destroy_lock(&lock_array[i]);
        KRATOS_INFO_IF("ResidualBasedBlockBuilderAndSolverWithConstraintsForChimera", (this->GetEchoLevel() > 2 && rModelPart.GetCommunicator().MyPID() == 0)) << "Finished parallel building" << std::endl;
...
#pragma omp parallel for schedule(guided, 512)
        ...
        KRATOS_INFO_IF("ResidualBasedBlockBuilderAndSolverWithConstraintsForChimera", (this->GetEchoLevel() >= 1 && rModelPart.GetCommunicator().MyPID() == 0)) << "Formulate global constraints time: " << stop_formulate - start_formulate << std::endl;

        KRATOS_CATCH("ResidualBasedBlockBuilderAndSolverWithConstraintsForChimera::FormulateGlobalMasterSlaveRelations failed ..");
    }
    ...
    void ResetConstraintRelations()
    {
        ...
        KRATOS_CATCH("ResidualBasedBlockBuilderAndSolverWithConstraintsForChimera::ResetConstraintRelations failed to reset constraint relations..");
    }
...
#pragma omp parallel for schedule(guided, 512)
        ...
        KRATOS_CATCH("ResidualBasedBlockBuilderAndSolverWithConstraintsForChimera::UpdateConstraintsForBuilding failed ..");
    }
    ...
    void UpdateMasterSlaveConstraint(ModelPart::MasterSlaveConstraintType& rMasterSlaveConstraint, ProcessInfo& rCurrentProcessInfo)
    {
        ...
        KRATOS_CATCH("ResidualBasedBlockBuilderAndSolverWithConstraintsForChimera::UpdateMasterSlaveConstraint failed ..");
    }
...
#pragma omp parallel for schedule(guided, 512) firstprivate(slave_equation_id, master_equation_ids, master_weights_vector, constant)
        ...
        KRATOS_CATCH("ResidualBasedBlockBuilderAndSolverWithConstraintsForChimera::ReconstructSlaveSolutionAfterSolve failed ..");
    }
