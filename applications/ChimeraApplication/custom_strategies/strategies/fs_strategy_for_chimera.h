...
public:
        ...
        mrPeriodicIdVar(Kratos::Variable<int>::StaticObject())
    {
        ...
        BuilderSolverTypePointer vel_build = BuilderSolverTypePointer(new ResidualBasedBlockBuilderAndSolverWithConstraintsForChimera<TSparseSpace, TDenseSpace, TLinearSolver > (pVelocityLinearSolver));
        ...
        BuilderSolverTypePointer pressure_build = BuilderSolverTypePointer(
                new ResidualBasedBlockBuilderAndSolverWithConstraintsForChimera<TSparseSpace, TDenseSpace, TLinearSolver >(pPressureLinearSolver));
