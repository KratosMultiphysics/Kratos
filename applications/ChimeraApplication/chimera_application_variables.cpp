...
KRATOS_CREATE_LOCAL_FLAG(FS_CHIMERA_VELOCITY_CONSTRAINT, 10);
KRATOS_CREATE_LOCAL_FLAG(FS_CHIMERA_PRESSURE_CONSTRAINT, 11);
KRATOS_CREATE_LOCAL_FLAG(CHIMERA_INTERNAL_BOUNDARY, 12);
