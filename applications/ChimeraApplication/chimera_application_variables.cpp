...
KRATOS_CREATE_LOCAL_FLAG(CHIMERA_APPLICATION, FS_CHIMERA_VELOCITY_CONSTRAINT, 10);
KRATOS_CREATE_LOCAL_FLAG(CHIMERA_APPLICATION, FS_CHIMERA_PRESSURE_CONSTRAINT, 11);
KRATOS_CREATE_LOCAL_FLAG(CHIMERA_APPLICATION, CHIMERA_INTERNAL_BOUNDARY, 12);
