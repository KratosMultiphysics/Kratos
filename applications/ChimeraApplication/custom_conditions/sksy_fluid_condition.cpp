...
SkSyFluidCondition<TDim,TNumNodes>::SkSyFluidCondition(SkSyFluidCondition::IndexType NewId):
    Condition(NewId)
{}

template<unsigned int TDim, unsigned int TNumNodes>
SkSyFluidCondition<TDim,TNumNodes>::SkSyFluidCondition(SkSyFluidCondition::IndexType NewId,
                 const SkSyFluidCondition::NodesArrayType &ThisNodes):
...
template<unsigned int TDim, unsigned int TNumNodes>
SkSyFluidCondition<TDim,TNumNodes>::SkSyFluidCondition(const SkSyFluidCondition &rOther):
    Condition(rOther)
{
}

template<unsigned int TDim, unsigned int TNumNodes>
SkSyFluidCondition<TDim,TNumNodes>::~SkSyFluidCondition()
{
}
...
template<unsigned int TDim, unsigned int TNumNodes>
SkSyFluidCondition<TDim,TNumNodes>& SkSyFluidCondition<TDim,TNumNodes>::operator=(const Kratos::SkSyFluidCondition<TDim,TNumNodes> &rOther)
{
...
template<unsigned int TDim, unsigned int TNumNodes>
Condition::Pointer SkSyFluidCondition<TDim,TNumNodes>::Create(IndexType NewId,
                                                   NodesArrayType const& ThisNodes,
                                                   PropertiesType::Pointer pProperties) const
{
    return Condition::Pointer(new SkSyFluidCondition(NewId, GetGeometry().Create(ThisNodes), pProperties));
}



template<unsigned int TDim, unsigned int TNumNodes>
void SkSyFluidCondition<TDim,TNumNodes>::CalculateLeftHandSide(MatrixType& rLeftHandSideMatrix,
...
template<unsigned int TDim, unsigned int TNumNodes>
void SkSyFluidCondition<TDim,TNumNodes>::CalculateLocalSystem(MatrixType& rLeftHandSideMatrix,
...
template< unsigned int TDim, unsigned int TNumNodes>
void SkSyFluidCondition<TDim,TNumNodes>::CalculateLocalVelocityContribution(MatrixType& rDampMatrix,
                                                                 VectorType& rRightHandSideVector,
                                                                 ProcessInfo& rCurrentProcessInfo)
{
    // Initialize local contributions
...
template<unsigned int TDim, unsigned int TNumNodes>
int SkSyFluidCondition<TDim,TNumNodes>::Check(const ProcessInfo& rCurrentProcessInfo)
{
    KRATOS_TRY;
...
template <>
void SkSyFluidCondition<2,2>::EquationIdVector(EquationIdVectorType& rResult,
                                    ProcessInfo& rCurrentProcessInfo)
{
...
template <>
void SkSyFluidCondition<3,3>::EquationIdVector(EquationIdVectorType& rResult,
                                    ProcessInfo& rCurrentProcessInfo)
{
    GeometryType& rGeom = this->GetGeometry();
...
template <>
void SkSyFluidCondition<3,4>::EquationIdVector(EquationIdVectorType& rResult,
                                    ProcessInfo& rCurrentProcessInfo)
{
    GeometryType& rGeom = this->GetGeometry();
...
template <>
void SkSyFluidCondition<2,2>::GetDofList(DofsVectorType& rElementalDofList,
                              ProcessInfo& rCurrentProcessInfo)
{
    GeometryType& rGeom = this->GetGeometry();
...
template <>
void SkSyFluidCondition<3,3>::GetDofList(DofsVectorType& rElementalDofList,
                              ProcessInfo& rCurrentProcessInfo)
{
    GeometryType& rGeom = this->GetGeometry();
...
template <>
void SkSyFluidCondition<3,4>::GetDofList(DofsVectorType& rElementalDofList,
                              ProcessInfo& rCurrentProcessInfo)
{
    GeometryType& rGeom = this->GetGeometry();
...
template<unsigned int TDim, unsigned int TNumNodes>
void SkSyFluidCondition<TDim,TNumNodes>::GetValuesVector(Vector& Values,
                                              int Step)
{
...
template<unsigned int TDim, unsigned int TNumNodes>
void SkSyFluidCondition<TDim,TNumNodes>::GetValueOnIntegrationPoints(const Variable<array_1d<double,3> > &rVariable,
                                                          ...
                                                          const ProcessInfo &rCurrentProcessInfo)
{
    ...
    else
    {
         ...
         * goes out of scope.
         */
        const SkSyFluidCondition* const_this = static_cast< const SkSyFluidCondition* >(this);
        rValues[0] = const_this->GetValue(rVariable);
    }
}

template<unsigned int TDim, unsigned int TNumNodes>
void SkSyFluidCondition<TDim,TNumNodes>::GetValueOnIntegrationPoints(const Variable<double>& rVariable,
...
template<unsigned int TDim, unsigned int TNumNodes>
void SkSyFluidCondition<TDim,TNumNodes>::GetValueOnIntegrationPoints(const Variable<array_1d<double, 6 > >& rVariable,
...
template<unsigned int TDim, unsigned int TNumNodes>
void SkSyFluidCondition<TDim,TNumNodes>::GetValueOnIntegrationPoints(const Variable<Vector>& rVariable,
...
template<unsigned int TDim, unsigned int TNumNodes>
void SkSyFluidCondition<TDim,TNumNodes>::GetValueOnIntegrationPoints(const Variable<Matrix>& rVariable,
...
template<unsigned int TDim, unsigned int TNumNodes>
std::string SkSyFluidCondition<TDim,TNumNodes>::Info() const
{
    std::stringstream buffer;
    buffer << "SkSyFluidCondition" << TDim << "D";
    return buffer.str();
}

template<unsigned int TDim, unsigned int TNumNodes>
void SkSyFluidCondition<TDim,TNumNodes>::PrintInfo(std::ostream &rOStream) const
{
    rOStream << "SkSyFluidCondition";
}


template<unsigned int TDim, unsigned int TNumNodes>
void SkSyFluidCondition<TDim,TNumNodes>::PrintData(std::ostream &rOStream) const
{
...
template <>
void SkSyFluidCondition<2,2>::CalculateNormal(array_1d<double,3>& An)
{
...
template <>
void SkSyFluidCondition<3,3>::CalculateNormal(array_1d<double,3>& An )
{
    Geometry<Node<3> >& pGeometry = this->GetGeometry();
...
template <>
void SkSyFluidCondition<3,4>::CalculateNormal(array_1d<double,3>& An )
{
    Geometry<Node<3> >& pGeometry = this->GetGeometry();
...
template <>
double SkSyFluidCondition<2,2>::CalculateJacobian(double Area) const
{
    return 0.5*Area;
}

template <>
double SkSyFluidCondition<3,3>::CalculateJacobian(double Area) const
{
    return 2.0*Area;
}

template <>
double SkSyFluidCondition<3,4>::CalculateJacobian(double Area) const
{
    return 0.25*Area;
}
...
template<unsigned int TDim, unsigned int TNumNodes>
void SkSyFluidCondition<TDim,TNumNodes>::AddBoundaryTerms(MatrixType& rLocalMatrix,
...
template< unsigned int TDim, unsigned int TNumNodes >
void SkSyFluidCondition<TDim,TNumNodes>::ResolvedConvectiveVelocity(array_1d<double,3> &rConvVel, const ShapeFunctionsType &rN)
{
    GeometryType& rGeom = this->GetGeometry();
...
template<unsigned int TDim, unsigned int TNumNodes>
void SkSyFluidCondition<TDim,TNumNodes>::save(Serializer& rSerializer) const
{
    KRATOS_SERIALIZE_SAVE_BASE_CLASS(rSerializer, Condition );
}

template<unsigned int TDim, unsigned int TNumNodes>
void SkSyFluidCondition<TDim,TNumNodes>::load(Serializer& rSerializer)
{
...
///////////////////////////////////////////////////////////////////////////////////////////////////
template class SkSyFluidCondition<2,2>;
template class SkSyFluidCondition<3,3>;
template class SkSyFluidCondition<3,4>;
