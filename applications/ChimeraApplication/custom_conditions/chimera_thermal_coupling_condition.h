...
#ifndef KRATOS_CHIMERA_THERMAL_COUPLING_CONDITION_H
#define KRATOS_CHIMERA_THERMAL_COUPLING_CONDITION_H
...
class ChimeraThermalCouplingCondition : public Condition
{
public:
    ///@name Type Definitions
    ///@{

    /// Pointer definition of ChimeraThermalCouplingCondition
    KRATOS_CLASS_POINTER_DEFINITION(ChimeraThermalCouplingCondition);
    ...
    /** Admits an Id as a parameter.
      ...
      */
    ChimeraThermalCouplingCondition(IndexType NewId = 0);
     ...
     */
    ChimeraThermalCouplingCondition(IndexType NewId,
    ...
    /// Copy constructor.
    ChimeraThermalCouplingCondition(ChimeraThermalCouplingCondition const& rOther);

    /// Destructor.
    virtual ~ChimeraThermalCouplingCondition();
    ...
    /// Assignment operator
    ChimeraThermalCouplingCondition & operator=(ChimeraThermalCouplingCondition const& rOther);

    ///@}
    ///@name Operations
    ///@{

    /// Create a new ChimeraThermalCouplingCondition object.
    /**
      @param NewId Index of the new condition
      @param ThisNodes An array containing the nodes of the new condition
      @param pProperties Pointer to the element's properties
...
protected:
    ...
    void ImposeFlux(MatrixType &rLocalMatrix, VectorType &rLocalVector);
...
}; // Class ChimeraThermalCouplingCondition
...
inline std::istream& operator >> (std::istream& rIStream,
                                  ChimeraThermalCouplingCondition<TDim>& rThis)
{
    return rIStream;
}
...
inline std::ostream& operator << (std::ostream& rOStream,
                                  const ChimeraThermalCouplingCondition<TDim>& rThis)
{
...
#endif // KRATOS_CHIMERA_THERMAL_COUPLING_CONDITION_H
