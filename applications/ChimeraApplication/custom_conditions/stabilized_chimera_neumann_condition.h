...
#if !defined(KRATOS_STABILIZED_CHIMERA_NEUMANN_CONDITION_H_INCLUDED )
#define KRATOS_STABILIZED_CHIMERA_NEUMANN_CONDITION_H_INCLUDED
...
class StabilizedChimeraNeumannCondition : public Condition {
public:
  ...
  /// Pointer definition of StabilizedChimeraNeumannCondition
  KRATOS_CLASS_POINTER_DEFINITION(StabilizedChimeraNeumannCondition);
   ...
   * Constructor.
   */
  StabilizedChimeraNeumannCondition(IndexType NewId = 0);

  /**
   * Constructor using an array of nodes
   */
  StabilizedChimeraNeumannCondition(IndexType NewId, const NodesArrayType& ThisNodes);

  /**
   * Constructor using Geometry
   */
  StabilizedChimeraNeumannCondition(IndexType NewId, GeometryType::Pointer pGeometry);

  /**
   * Constructor using Properties
   */
  StabilizedChimeraNeumannCondition(IndexType NewId, GeometryType::Pointer pGeometry, PropertiesType::Pointer pProperties);

  /**
   * Copy Constructor
   */
  StabilizedChimeraNeumannCondition(StabilizedChimeraNeumannCondition const& rOther);

  /**
   * Destructor
   */
  virtual ~StabilizedChimeraNeumannCondition();
  ...
  /// Assignment operator.
  StabilizedChimeraNeumannCondition & operator=(StabilizedChimeraNeumannCondition const& rOther);
...
}; // Class StabilizedChimeraNeumannCondition
...
#endif // KRATOS_STABILIZED_CHIMERA_NEUMANN_CONDITION_H_INCLUDED  defined
