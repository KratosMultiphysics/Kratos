...
def CreateSolver(main_model_part, custom_settings):
    return NavierStokesSolver_VMSMonolithic_Chimera(main_model_part, custom_settings)

class NavierStokesSolver_VMSMonolithic_Chimera(navier_stokes_base_solver.NavierStokesBaseSolver):
    ...
    def __init__(self, main_model_part, custom_settings):
        ...
        {
            "solver_type": "navier_stokes_solver_vmsmonolithic_chimera",
        ...
        print("Construction of NavierStokesSolver_VMSMonolithic_Chimera finished")


    def AddVariables(self):
        ## Add base class variables
        #super(NavierStokesSolver_VMSMonolithic_Chimera, self).AddVariables()
...
##                    node.SetSolutionStepValue(VELOCITY,i,vel)
    ...
    def _ExecuteAfterReading(self):
        super(NavierStokesSolver_VMSMonolithic_Chimera, self)._ExecuteAfterReading()
