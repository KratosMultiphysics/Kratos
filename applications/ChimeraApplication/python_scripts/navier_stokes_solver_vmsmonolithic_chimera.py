...
class NavierStokesSolverMonolithicChimera(navier_stokes_base_solver.NavierStokesBaseSolver):
    ...
    def __init__(self, main_model_part, custom_settings):
        ...
        KratosMultiphysics.Logger.PrintInfo("NavierStokesSolverMonolithicChimera", "Construction of NavierStokesSolverMonolithicChimera finished.")
