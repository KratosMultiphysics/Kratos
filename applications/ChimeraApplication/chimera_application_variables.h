...
KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS( CHIMERA_APPLICATION, EMBEDDED_WET_VELOCITY)

KRATOS_DEFINE_APPLICATION_VARIABLE( CHIMERA_APPLICATION, bool, FS_CHIMERA_VEL_CONSTRAINT);
KRATOS_DEFINE_APPLICATION_VARIABLE( CHIMERA_APPLICATION, bool, FS_CHIMERA_PRE_CONSTRAINT);
