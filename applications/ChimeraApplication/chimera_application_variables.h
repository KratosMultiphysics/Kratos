...
KRATOS_DEFINE_APPLICATION_VARIABLE(double, CHIMERA_DISTANCE);
KRATOS_DEFINE_APPLICATION_VARIABLE(double, ROTATIONAL_ANGLE);
KRATOS_DEFINE_APPLICATION_VARIABLE(double, ROTATIONAL_VELOCITY);
...
KRATOS_DEFINE_LOCAL_FLAG( FS_CHIMERA_VELOCITY_CONSTRAINT);
KRATOS_DEFINE_LOCAL_FLAG( FS_CHIMERA_PRESSURE_CONSTRAINT);
KRATOS_DEFINE_LOCAL_FLAG( CHIMERA_INTERNAL_BOUNDARY);
}
