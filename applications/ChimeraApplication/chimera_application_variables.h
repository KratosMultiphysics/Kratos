...
class ChimeraFlags {
public:
    KRATOS_DEFINE_LOCAL_APPLICATION_FLAG(CHIMERA_APPLICATION, FS_CHIMERA_VELOCITY_CONSTRAINT);
    KRATOS_DEFINE_LOCAL_APPLICATION_FLAG(CHIMERA_APPLICATION, FS_CHIMERA_PRESSURE_CONSTRAINT);
    KRATOS_DEFINE_LOCAL_APPLICATION_FLAG(CHIMERA_APPLICATION, CHIMERA_INTERNAL_BOUNDARY);
};
}
