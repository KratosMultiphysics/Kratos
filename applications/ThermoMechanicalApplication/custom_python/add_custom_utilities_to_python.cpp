...
//     typedef LinearSolver<SparseSpaceType, LocalSpaceType > LinearSolverType;
    ...
    ;
    class_<EstimateTimeStep < 3 > > (m, "EstimateTimeStep3D")
    .def(init<>())
    ...
    class_<ParticleLevelSetUtils < 2 > >(m, "ParticleLevelSetUtils2D")
    .def(init<>())
    ...
    class_<ParticleLevelSetUtils < 3 > >(m, "ParticleLevelSetUtils3D")
    .def(init<>())
    ...
    ;
    class_<BiphasicFillingUtilities > (m, "BiphasicFillingUtilities")
    .def(init<>())
