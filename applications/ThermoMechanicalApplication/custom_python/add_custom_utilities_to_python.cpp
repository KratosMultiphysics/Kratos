...
//     typedef LinearSolver<SparseSpaceType, LocalSpaceType > LinearSolverType;
    ...
    class_<AssignEnvironmentCondition > (m, "AssignEnvironmentCondition")
    .def(init<>())
    .def("AssignCondition", &AssignEnvironmentCondition::AssignCondition)
    ;
    class_<EstimateTimeStep < 3 >, typename EstimateTimeStep < 3 >::Pointer > (m, "EstimateTimeStep3D")
    .def(init<>())
    ...
    class_<ParticleLevelSetUtils < 2 >, typename ParticleLevelSetUtils < 2 >::Pointer >(m, "ParticleLevelSetUtils2D")
    .def(init<>())
    ...
    class_<ParticleLevelSetUtils < 3 >, typename ParticleLevelSetUtils < 3 >::Pointer >(m, "ParticleLevelSetUtils3D")
    .def(init<>())
    ...
    ;
    class_<BiphasicFillingUtilities, BiphasicFillingUtilities::Pointer > (m, "BiphasicFillingUtilities")
    .def(init<>())
