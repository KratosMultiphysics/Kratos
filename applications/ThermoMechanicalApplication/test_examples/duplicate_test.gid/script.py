...
if(SolverType == "FractionalStep"):
    ...
    thermo_monolithic_solver_eulerian.AddVariables(fluid_model_part)
...
if(SolverType == "FractionalStep"):
    ...
    thermo_monolithic_solver_eulerian.AddDofs(fluid_model_part)
elif(SolverType == "monolithic_solver_eulerian_compressible"):
...
if(SolverType == "FractionalStep"):
    ...
    fluid_solver = thermo_monolithic_solver_eulerian.MonolithicSolver(fluid_model_part,domain_size)
