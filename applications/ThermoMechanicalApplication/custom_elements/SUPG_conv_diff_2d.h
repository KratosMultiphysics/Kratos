...
#if !defined(KRATOS_SUPG_CONV_DIFF_2D_INCLUDED )
#define  KRATOS_SUPG_CONV_DIFF_2D_INCLUDED
...
public:
    ...
    KRATOS_CLASS_POINTER_DEFINITION(SUPGConvDiff2D);
    ...
    SUPGConvDiff2D(IndexType NewId, GeometryType::Pointer pGeometry);
    SUPGConvDiff2D(IndexType NewId, GeometryType::Pointer pGeometry,  PropertiesType::Pointer pProperties);

    /// Destructor.
    virtual ~SUPGConvDiff2D();
