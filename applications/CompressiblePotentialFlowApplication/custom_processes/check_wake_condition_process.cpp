...
// Constructor for CheckWakeConditionProcess Process
// template <int Dim>
// CheckWakeConditionProcess<Dim>::CheckWakeConditionProcess(ModelPart& rWakeModelPart,
//                                                      const double Tolerance,
//                                                      const int EchoLevel)
//     : Process(), mrWakeModelPart(rWakeModelPart), mTolerance(Tolerance), mEchoLevel(EchoLevel)
// {}
