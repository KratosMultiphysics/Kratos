...
/**
 * @class ComputePotentialHessianSolMetricProcess
 ...
 */
class KRATOS_API(MESHING_APPLICATION) ComputePotentialHessianSolMetricProcess
    : public Process
{
public:
    ...
    /// Pointer definition of ComputePotentialHessianSolMetricProcess
    KRATOS_CLASS_POINTER_DEFINITION(ComputePotentialHessianSolMetricProcess);
    ...
    /// Destructor.
    ~ComputePotentialHessianSolMetricProcess() override = default;
    ...
    {
        return "ComputePotentialHessianSolMetricProcess";
    }

    /// Print information about this object.
    void PrintInfo(std::ostream& rOStream) const override
    {
        rOStream << "ComputePotentialHessianSolMetricProcess";
    }
...
private:
    ...
    /// Assignment operator.
    ComputePotentialHessianSolMetricProcess& operator=(ComputePotentialHessianSolMetricProcess const& rOther);

    /// Copy constructor.
    //ComputePotentialHessianSolMetricProcess(ComputePotentialHessianSolMetricProcess const& rOther);
...
inline std::istream& operator >> (std::istream& rIStream,
                                  ComputePotentialHessianSolMetricProcess& rThis);

/// output stream function
inline std::ostream& operator << (std::ostream& rOStream,
                                  const ComputePotentialHessianSolMetricProcess& rThis)
{
