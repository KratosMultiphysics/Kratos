...
class ComputeGradientNumerical: public Process
{
public:
    ...
    KRATOS_CLASS_POINTER_DEFINITION(ComputeGradientNumerical);
    ...
    /// Constructor for ComputeGradientNumerical Process
//     ComputeGradientNumerical(ModelPart& rModelPart,
...
//     }
    ...
    /// Destructor.
    ~ComputeGradientNumerical() override {}
    ...
    {
        KRATOS_TRY;
        std::cout<<"Compute Gradient Numerical Process Start"<< std::endl;
        double Cl,Cd,Rz;
    ...
    {
        return "ComputeGradientNumerical";
    }

    /// Print information about this object.
    void PrintInfo(std::ostream& rOStream) const override
    {
        rOStream << "ComputeGradientNumerical";
    }
...
private:
    ...
    /// Assignment operator.
    ComputeGradientNumerical& operator=(ComputeGradientNumerical const& rOther);

    /// Copy constructor.
    ComputeGradientNumerical(ComputeGradientNumerical const& rOther);
...
inline std::istream& operator >> (std::istream& rIStream,
                                  ComputeGradientNumerical& rThis);

/// output stream function
inline std::ostream& operator << (std::ostream& rOStream,
                                  const ComputeGradientNumerical& rThis)
{
