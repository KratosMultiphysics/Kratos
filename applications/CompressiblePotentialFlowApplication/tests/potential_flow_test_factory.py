...
class PotentialFlowTests(UnitTest.TestCase):
    ...
    def test_EmbeddedCircle(self):
        ...
        with WorkFolderScope(work_folder):
            ...
            self._check_results(self.main_model_part.ProcessInfo[CPFApp.LIFT_COEFFICIENT], 0.335148469635325, 0.0, 1e-6)
            self._check_results(self.main_model_part.ProcessInfo[CPFApp.LIFT_COEFFICIENT_JUMP], 0.4519557627261811, 0.0, 1e-6)
            self._check_results(self.main_model_part.ProcessInfo[CPFApp.LIFT_COEFFICIENT_FAR_FIELD], 0.41487242806480074, 0.0, 1e-6)
