...
// Flags
class PotentialFlowFlags
  {
  public:
    KRATOS_DEFINE_LOCAL_APPLICATION_FLAG(COMPRESSIBLE_POTENTIAL_FLOW_APPLICATION, WAKE_ELEMENT);
    KRATOS_DEFINE_LOCAL_APPLICATION_FLAG(COMPRESSIBLE_POTENTIAL_FLOW_APPLICATION, KUTTA_ELEMENT);
    KRATOS_DEFINE_LOCAL_APPLICATION_FLAG(COMPRESSIBLE_POTENTIAL_FLOW_APPLICATION, TRAILING_EDGE_ELEMENT);
  };
