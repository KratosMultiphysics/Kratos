...
KratosCompressiblePotentialFlowApplication::KratosCompressiblePotentialFlowApplication():
    ...
    mIncompressiblePotentialFlowPressureElement2D3N(0, Element::GeometryType::Pointer(new Triangle2D3<Node<3> >(Element::GeometryType::PointsArrayType(3)))),
    mIncompressiblePotentialFlowPressureElement3D4N(0, Element::GeometryType::Pointer(new Tetrahedra3D4<Node<3> >(Element::GeometryType::PointsArrayType(4)))),
...
void KratosCompressiblePotentialFlowApplication::Register()
{
  ...
  KRATOS_REGISTER_VARIABLE(PSI);

  // Lagrange multipliers
  KRATOS_REGISTER_VARIABLE(LAGRANGE_MULTIPLIER_0);
  ...
  KRATOS_REGISTER_VARIABLE(LAGRANGE_MULTIPLIER_7);
  KRATOS_REGISTER_VARIABLE(LAGRANGE_MULTIPLIER_8);
  KRATOS_REGISTER_VARIABLE(LAGRANGE_MULTIPLIER_9);
  KRATOS_REGISTER_VARIABLE(LAGRANGE_MULTIPLIER_10);
  KRATOS_REGISTER_VARIABLE(LAGRANGE_MULTIPLIER_11);
  KRATOS_REGISTER_VARIABLE(LAGRANGE_MULTIPLIER_12);
  KRATOS_REGISTER_VARIABLE(LAGRANGE_MULTIPLIER_13);
  KRATOS_REGISTER_VARIABLE(LAGRANGE_MULTIPLIER_14);
  KRATOS_REGISTER_VARIABLE(LAGRANGE_MULTIPLIER_15);
  KRATOS_REGISTER_VARIABLE(LAGRANGE_MULTIPLIER_16);
  KRATOS_REGISTER_VARIABLE(LAGRANGE_MULTIPLIER_17);
  KRATOS_REGISTER_VARIABLE(LAGRANGE_MULTIPLIER_18);
  KRATOS_REGISTER_VARIABLE(LAGRANGE_MULTIPLIER_19);
  ...
  KRATOS_REGISTER_VARIABLE(FREE_NODES);
  KRATOS_REGISTER_VARIABLE(TE_ELEMENT_COUNTER);
  ...
  KRATOS_REGISTER_VARIABLE(WING_TIP_ELEMENT);
  ...
  KRATOS_REGISTER_ELEMENT("IncompressiblePotentialFlowPressureElement2D3N", mIncompressiblePotentialFlowPressureElement2D3N);
  KRATOS_REGISTER_ELEMENT("IncompressiblePotentialFlowPressureElement3D4N", mIncompressiblePotentialFlowPressureElement3D4N);
