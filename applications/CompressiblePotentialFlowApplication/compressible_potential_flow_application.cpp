...
void KratosCompressiblePotentialFlowApplication::Register()
{
  ...
  // Reaction variables (Adjoint)
  KRATOS_REGISTER_VARIABLE(REACTION_ADJOINT_VELOCITY_POTENTIAL);
  KRATOS_REGISTER_VARIABLE(REACTION_ADJOINT_AUXILIARY_VELOCITY_POTENTIAL);
