...
void KratosCompressiblePotentialFlowApplication::Register()
{
  ...
  KRATOS_REGISTER_SYMMETRIC_2D_TENSOR_VARIABLE_WITH_COMPONENTS(POTENTIAL_METRIC_TENSOR_2D); // A 3D metric vector
  KRATOS_REGISTER_SYMMETRIC_3D_TENSOR_VARIABLE_WITH_COMPONENTS(POTENTIAL_METRIC_TENSOR_3D); // A 3D metric vector
  ...
  KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(LOG_ADJOINT_VELOCITY);
