    ...
    const ProcessInfo& rCurrentProcessInfo)
{
    ...
    const double sq_local_mach_number = std::pow(localMachNumber, 2);
    ...
    const double sq_local_velocity = ComputeClampedVelocitySquared<Dim, NumNodes>(rVelocity, rCurrentProcessInfo);
...
template double ComputeLocalMachSquaredDerivative<2, 3>(const array_1d<double, 2>& rVelocity, const double localMachNumber, const ProcessInfo& rCurrentProcessInfo);
...
template double ComputeLocalMachSquaredDerivative<3, 4>(const array_1d<double, 3>& rVelocity, const double localMachNumber, const ProcessInfo& rCurrentProcessInfo);
