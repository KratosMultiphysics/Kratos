...
/** \brief AdjointLiftResponseFunction
*
...
*/
class KRATOS_API(STRUCTURAL_MECHANICS_APPLICATION) AdjointLiftResponseFunction : public AdjointStructuralResponseFunction
{
public:
    ///@name Type Definitions
    ///@{
    ...
    /// Pointer definition of AdjointLiftResponseFunction
    KRATOS_CLASS_POINTER_DEFINITION(AdjointLiftResponseFunction);
    ...
    /// Default constructor.
    AdjointLiftResponseFunction(ModelPart& rModelPart, Parameters ResponseSettings);

    /// Destructor.
    ~AdjointLiftResponseFunction() override;
...
}; // Class AdjointLiftResponseFunction
