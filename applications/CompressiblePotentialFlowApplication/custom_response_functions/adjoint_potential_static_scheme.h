...
#if !defined(KRATOS_ADJOINT_POTENTIAL_STATIC_SCHEME)
#define KRATOS_ADJOINT_POTENTIAL_STATIC_SCHEME
...
class AdjointPotentialStaticScheme : public Scheme<TSparseSpace, TDenseSpace>
{
public:
    ///@name Type Definitions
    ///@{

    KRATOS_CLASS_POINTER_DEFINITION(AdjointPotentialStaticScheme);
    ...
    /// Constructor.
    AdjointPotentialStaticScheme(Parameters rParameters, AdjointResponseFunction::Pointer pResponseFunction)
    ...
    /// Destructor.
    ~AdjointPotentialStaticScheme() override
    {
    }
