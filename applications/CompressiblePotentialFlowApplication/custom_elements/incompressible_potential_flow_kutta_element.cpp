...
template <int Dim, int NumNodes>
void IncompressiblePotentialFlowKuttaElement<Dim, NumNodes>::GetWakeDistances(array_1d<double, NumNodes>& distances) const
{
    noalias(distances) = GetValue(ELEMENTAL_DISTANCES);
}

template <int Dim, int NumNodes>
void IncompressiblePotentialFlowKuttaElement<Dim, NumNodes>::GetEquationIdVectorNormalElement(EquationIdVectorType& rResult) const
{
...
template <int Dim, int NumNodes>
void IncompressiblePotentialFlowKuttaElement<Dim, NumNodes>::GetEquationIdVectorKuttaElement(EquationIdVectorType& rResult) const
{
...
template <int Dim, int NumNodes>
void IncompressiblePotentialFlowKuttaElement<Dim, NumNodes>::GetEquationIdVectorWakeElement(EquationIdVectorType& rResult) const
{
...
template <int Dim, int NumNodes>
void IncompressiblePotentialFlowKuttaElement<Dim, NumNodes>::GetDofListNormalElement(DofsVectorType& rElementalDofList) const
{
    for (unsigned int i = 0; i < NumNodes; i++)
...
template <int Dim, int NumNodes>
void IncompressiblePotentialFlowKuttaElement<Dim, NumNodes>::GetDofListKuttaElement(DofsVectorType& rElementalDofList) const
{
    // Kutta elements have only negative part
    for (unsigned int i = 0; i < NumNodes; i++)
    {
...
template <int Dim, int NumNodes>
void IncompressiblePotentialFlowKuttaElement<Dim, NumNodes>::GetDofListWakeElement(DofsVectorType& rElementalDofList) const
{
    array_1d<double, NumNodes> distances;
    GetWakeDistances(distances);
...
template <int Dim, int NumNodes>
void IncompressiblePotentialFlowKuttaElement<Dim, NumNodes>::CalculateLocalSystemNormalElement(
...
template <int Dim, int NumNodes>
void IncompressiblePotentialFlowKuttaElement<Dim, NumNodes>::CalculateLocalSystemWakeElement(
    MatrixType& rLeftHandSideMatrix, VectorType& rRightHandSideVector)
{
...
template <int Dim, int NumNodes>
void IncompressiblePotentialFlowKuttaElement<Dim, NumNodes>::CalculateLocalSystemSubdividedElement(
...
template <int Dim, int NumNodes>
void IncompressiblePotentialFlowKuttaElement<Dim, NumNodes>::AssignLocalSystemSubdividedElement(
...
template <int Dim, int NumNodes>
void IncompressiblePotentialFlowKuttaElement<Dim, NumNodes>::AssignLocalSystemWakeElement(
...
template <int Dim, int NumNodes>
void IncompressiblePotentialFlowKuttaElement<Dim, NumNodes>::AssignLocalSystemWakeNode(
    MatrixType& rLeftHandSideMatrix,
    Matrix& lhs_total,
...
template <int Dim, int NumNodes>
void IncompressiblePotentialFlowKuttaElement<Dim, NumNodes>::CheckWakeCondition() const
{
...
template <int Dim, int NumNodes>
void IncompressiblePotentialFlowKuttaElement<Dim, NumNodes>::ComputePotentialJump(ProcessInfo& rCurrentProcessInfo)
{
...
template <int Dim, int NumNodes>
void IncompressiblePotentialFlowKuttaElement<Dim, NumNodes>::GetPotentialOnNormalElement(
...
template <int Dim, int NumNodes>
void IncompressiblePotentialFlowKuttaElement<Dim, NumNodes>::GetPotentialOnWakeElement(
...
template <int Dim, int NumNodes>
void IncompressiblePotentialFlowKuttaElement<Dim, NumNodes>::GetPotentialOnUpperWakeElement(
...
template <int Dim, int NumNodes>
void IncompressiblePotentialFlowKuttaElement<Dim, NumNodes>::GetPotentialOnLowerWakeElement(
...
template <int Dim, int NumNodes>
void IncompressiblePotentialFlowKuttaElement<Dim, NumNodes>::ComputeVelocityUpper(array_1d<double, Dim>& velocity) const
{
    velocity.clear();
...
template <int Dim, int NumNodes>
void IncompressiblePotentialFlowKuttaElement<Dim, NumNodes>::ComputeVelocityLower(array_1d<double, Dim>& velocity) const
{
    velocity.clear();
...
template <int Dim, int NumNodes>
void IncompressiblePotentialFlowKuttaElement<Dim, NumNodes>::ComputeVelocityNormalElement(
...
template <int Dim, int NumNodes>
void IncompressiblePotentialFlowKuttaElement<Dim, NumNodes>::ComputeVelocityUpperWakeElement(
    array_1d<double, Dim>& velocity) const
{
    ElementalData<NumNodes, Dim> data;
...
template <int Dim, int NumNodes>
void IncompressiblePotentialFlowKuttaElement<Dim, NumNodes>::ComputeVelocityLowerWakeElement(
    array_1d<double, Dim>& velocity) const
{
    ElementalData<NumNodes, Dim> data;
...
template <int Dim, int NumNodes>
double IncompressiblePotentialFlowKuttaElement<Dim, NumNodes>::ComputePressureUpper(const ProcessInfo& rCurrentProcessInfo) const
{
    const IncompressiblePotentialFlowKuttaElement& r_this = *this;
    const int wake = r_this.GetValue(WAKE);
...
template <int Dim, int NumNodes>
double IncompressiblePotentialFlowKuttaElement<Dim, NumNodes>::ComputePressureLower(const ProcessInfo& rCurrentProcessInfo) const
{
    const IncompressiblePotentialFlowKuttaElement& r_this = *this;
    const int wake = r_this.GetValue(WAKE);
...
template <int Dim, int NumNodes>
double IncompressiblePotentialFlowKuttaElement<Dim, NumNodes>::ComputePressureNormalElement(const ProcessInfo& rCurrentProcessInfo) const
{
    const array_1d<double, 3> vinfinity = rCurrentProcessInfo[VELOCITY_INFINITY];
...
template <int Dim, int NumNodes>
double IncompressiblePotentialFlowKuttaElement<Dim, NumNodes>::ComputePressureUpperWakeElement(
...
template <int Dim, int NumNodes>
double IncompressiblePotentialFlowKuttaElement<Dim, NumNodes>::ComputePressureLowerWakeElement(
    const ProcessInfo& rCurrentProcessInfo) const
{
    const array_1d<double, 3> vinfinity = rCurrentProcessInfo[VELOCITY_INFINITY];
    const double vinfinity_norm2 = inner_prod(vinfinity, vinfinity);
