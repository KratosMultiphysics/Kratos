...
PYBIND11_MODULE(KratosCompressiblePotentialFlowApplication, m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_SYMMETRIC_2D_TENSOR_VARIABLE_WITH_COMPONENTS(m, POTENTIAL_METRIC_TENSOR_2D)
    KRATOS_REGISTER_IN_PYTHON_SYMMETRIC_3D_TENSOR_VARIABLE_WITH_COMPONENTS(m, POTENTIAL_METRIC_TENSOR_3D) // A 3D metric vector
