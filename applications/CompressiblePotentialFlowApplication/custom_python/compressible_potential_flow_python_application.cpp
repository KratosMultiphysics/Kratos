...
PYBIND11_MODULE(KratosCompressiblePotentialFlowApplication, m)
{
    ...
    // Flags
    m.attr("WAKE_ELEMENT") = PotentialFlowFlags::WAKE_ELEMENT;
    m.attr("NOT_WAKE_ELEMENT") = PotentialFlowFlags::NOT_WAKE_ELEMENT;

    m.attr("KUTTA_ELEMENT") = PotentialFlowFlags::WAKE_ELEMENT;
    m.attr("NOT_KUTTA_ELEMENT") = PotentialFlowFlags::WAKE_ELEMENT;

    m.attr("TRAILING_EDGE_ELEMENT") = PotentialFlowFlags::WAKE_ELEMENT;
    m.attr("NOT_TRAILING_EDGE_ELEMENT") = PotentialFlowFlags::WAKE_ELEMENT;
