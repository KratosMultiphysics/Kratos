...
PYBIND11_MODULE(KratosCompressiblePotentialFlowApplication, m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, VECTOR_TO_DOWNWIND_ELEMENT);
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, UPWIND_CONTRIBUTION);
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, ID_DOWNWIND_ELEMENT);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, DOWNWIND_ELEMENT);
