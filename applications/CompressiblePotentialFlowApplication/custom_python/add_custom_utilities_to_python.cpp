...
void  AddCustomUtilitiesToPython(pybind11::module& m)
{
    ...
    mod_potential_flow_utilities.def("ComputePerturbationCompressiblePressureCoefficient",&PotentialFlowUtilities::ComputePerturbationCompressiblePressureCoefficient<2,3>);
}
