...
KRATOS_CREATE_VARIABLE(double, LAGRANGE_MULTIPLIER_10)
KRATOS_CREATE_VARIABLE(double, LAGRANGE_MULTIPLIER_11)
KRATOS_CREATE_VARIABLE(double, LAGRANGE_MULTIPLIER_12)
KRATOS_CREATE_VARIABLE(double, LAGRANGE_MULTIPLIER_13)
KRATOS_CREATE_VARIABLE(double, LAGRANGE_MULTIPLIER_14)
KRATOS_CREATE_VARIABLE(double, LAGRANGE_MULTIPLIER_15)
KRATOS_CREATE_VARIABLE(double, LAGRANGE_MULTIPLIER_16)
KRATOS_CREATE_VARIABLE(double, LAGRANGE_MULTIPLIER_17)
KRATOS_CREATE_VARIABLE(double, LAGRANGE_MULTIPLIER_18)
KRATOS_CREATE_VARIABLE(double, LAGRANGE_MULTIPLIER_19)
...
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(FREE_STREAM_VELOCITY_DIRECTION)
...
KRATOS_CREATE_VARIABLE(double, VELOCITY_SQUARED_LIMIT)
KRATOS_CREATE_VARIABLE(double, CRITICAL_MACH)
KRATOS_CREATE_VARIABLE(double, UPWIND_FACTOR_CONSTANT)

// Markers
KRATOS_CREATE_VARIABLE(int, WAKE)
KRATOS_CREATE_VARIABLE(int, KUTTA)
KRATOS_CREATE_VARIABLE(int, NORMAL_ELEMENT)
KRATOS_CREATE_VARIABLE(int, WING_TIP)
KRATOS_CREATE_VARIABLE(int, WING_TIP_ELEMENT)
