...
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(UPSTREAM_ELEMENT_POSITION_VECTOR)
...
KRATOS_CREATE_VARIABLE(double, UPWINDING_FACTOR_CONSTANT)
...
KRATOS_CREATE_VARIABLE(bool, INLET_ELEMENT)
