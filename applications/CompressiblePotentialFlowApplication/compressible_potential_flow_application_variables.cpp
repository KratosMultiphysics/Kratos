...
// Flags
KRATOS_CREATE_LOCAL_FLAG(PotentialFlowFlags, WAKE_ELEMENT, 5);
KRATOS_CREATE_LOCAL_FLAG(PotentialFlowFlags, KUTTA_ELEMENT, 15);
KRATOS_CREATE_LOCAL_FLAG(PotentialFlowFlags, TRAILING_EDGE_ELEMENT, 25);
