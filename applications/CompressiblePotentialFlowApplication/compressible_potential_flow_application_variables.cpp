...
KRATOS_CREATE_VARIABLE(double, REACTION_VELOCITY_POTENTIAL)
KRATOS_CREATE_VARIABLE(double, REACTION_AUXILIARY_VELOCITY_POTENTIAL)
...
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(VECTOR_TO_DOWNWIND_ELEMENT);
...
KRATOS_CREATE_VARIABLE(Matrix, UPWIND_CONTRIBUTION)
...
KRATOS_CREATE_VARIABLE(int, WING_ROOT)
...
KRATOS_CREATE_VARIABLE(int, FAR_FIELD)
KRATOS_CREATE_VARIABLE(int, ID_DOWNWIND_ELEMENT)
KRATOS_CREATE_VARIABLE(int, DOWNWIND_ELEMENT)
KRATOS_CREATE_VARIABLE(int, UPWIND_ELEMENT)
