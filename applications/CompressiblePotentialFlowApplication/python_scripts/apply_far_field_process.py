...
class ApplyFarFieldProcess(KratosMultiphysics.Process):
    def __init__(self, Model, settings ):
        ...
        self.free_stream_velocity_direction = KratosMultiphysics.Vector(3)
        ...
        if self.domain_size == 2:
            ...
            self.free_stream_velocity_direction[0] = round(math.cos(self.angle_of_attack),8)
            self.free_stream_velocity_direction[1] = round(math.sin(self.angle_of_attack),8)
            self.free_stream_velocity_direction[2] = 0.0
            ...
            self.free_stream_velocity_direction[0] = round(math.cos(self.angle_of_attack),8)
            self.free_stream_velocity_direction[1] = 0.0
            self.free_stream_velocity_direction[2] = round(math.sin(self.angle_of_attack),8)

        self.free_stream_velocity = self.u_inf * self.free_stream_velocity_direction
