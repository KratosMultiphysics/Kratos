...
class ApplyFarFieldProcess(KratosMultiphysics.Process):
    def __init__(self, Model, settings ):
        ...
        self.upwind_mach_factor = settings["upwind_mach_factor"].GetDouble()
        ...
        self.fluid_model_part.ProcessInfo.SetValue(CPFApp.UPWIND_MACH_FACTOR,self.upwind_mach_factor)
