...
class DefineWakeProcess3D(KratosMultiphysics.Process):
    ...
    #     metric_tensor_3d = KratosMultiphysics.Vector(6)
    #     for node in self.fluid_model_part.Nodes:
    #         nodal_h = node.GetValue(KratosMultiphysics.NODAL_H)
    #         metric_tensor_3d[0] = 1.0/(nodal_h*nodal_h)
    #         metric_tensor_3d[1] = 1.0/(nodal_h*nodal_h)
    #         metric_tensor_3d[2] = 1.0/(nodal_h*nodal_h)
    #         node.SetValue(KratosMeshing.METRIC_TENSOR_3D,metric_tensor_3d)

    #     for element in self.wake_sub_model_part.Elements:
    ...
    #     MmgProcess = KratosMeshing.MmgProcess3D(self.fluid_model_part, self.mmg_parameters)
    #     MmgProcess.Execute()
