...
KratosMultiphysics.CheckRegisteredApplications("MonteCarloApplication")
KratosMultiphysics.CheckRegisteredApplications("ConvectionDiffusionApplication")

# Import applications
#import KratosMultiphysics.ExternalSolversApplication
import KratosMultiphysics.MonteCarloApplication as Poisson
...
class PureDiffusionSolver(PythonSolver):
    ...
    def __init__(self, model, custom_settings):  # Constructor of the class
        ...
        self.element_name = "LaplacianElement2D3N"
    ...
    def _ValidateSettings(self, settings):
	    ...
	    "model_part_name" : "MCLaplacianModelPart",
	    "buffer_size"     : 2,
	    "domain_size"     : 2,
        "echo_level"                         : 1,
