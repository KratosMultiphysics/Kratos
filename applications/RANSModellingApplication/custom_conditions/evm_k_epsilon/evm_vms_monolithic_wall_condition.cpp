...
#include "evm_vms_monolithic_wall_condition.h"
...
/**
 * @see EVMVMSMonolithicWallCondition::EquationIdVector
 */
template <>
void EVMVMSMonolithicWallCondition<2,2>::EquationIdVector(EquationIdVectorType& rResult,
 ...
 */
template <>
void EVMVMSMonolithicWallCondition<3,3>::EquationIdVector(EquationIdVectorType& rResult,
        ProcessInfo& rCurrentProcessInfo)
{
...
/**
 * @see EVMVMSMonolithicWallCondition::GetDofList
 */
template <>
void EVMVMSMonolithicWallCondition<2,2>::GetDofList(DofsVectorType& rElementalDofList,
        ProcessInfo& rCurrentProcessInfo)
{
 ...
 */
template <>
void EVMVMSMonolithicWallCondition<3,3>::GetDofList(DofsVectorType& rElementalDofList,
        ProcessInfo& rCurrentProcessInfo)
{
    const SizeType NumNodes = 3;
    const SizeType LocalSize = 12;
...
void EVMVMSMonolithicWallCondition<TDim,TNumNodes>::CalculateLocalVelocityContribution(MatrixType &rDampMatrix,
...
template<unsigned int TDim, unsigned int TNumNodes>
void EVMVMSMonolithicWallCondition<TDim,TNumNodes>::GetValueOnIntegrationPoints(const Variable<array_1d<double,3> > &rVariable,
                                                                          ...
                                                                          const ProcessInfo &rCurrentProcessInfo)
{
    ...
    else
    {
         ...
         * goes out of scope.
         */
        const EVMVMSMonolithicWallCondition* const_this = static_cast< const EVMVMSMonolithicWallCondition* >(this);
        rValues[0] = const_this->GetValue(rVariable);
    }
}

template<unsigned int TDim, unsigned int TNumNodes>
void EVMVMSMonolithicWallCondition<TDim,TNumNodes>::GetValueOnIntegrationPoints(const Variable<double>& rVariable,
...
template<unsigned int TDim, unsigned int TNumNodes>
void EVMVMSMonolithicWallCondition<TDim,TNumNodes>::GetValueOnIntegrationPoints(const Variable<array_1d<double, 6 > >& rVariable,
...
template<unsigned int TDim, unsigned int TNumNodes>
void EVMVMSMonolithicWallCondition<TDim,TNumNodes>::GetValueOnIntegrationPoints(const Variable<Vector>& rVariable,
...
template<unsigned int TDim, unsigned int TNumNodes>
void EVMVMSMonolithicWallCondition<TDim,TNumNodes>::GetValueOnIntegrationPoints(const Variable<Matrix>& rVariable,
...
template <>
void EVMVMSMonolithicWallCondition<2,2>::CalculateNormal(array_1d<double,3>& An)
{
...
template <>
void EVMVMSMonolithicWallCondition<3,3>::CalculateNormal(array_1d<double,3>& An )
{
    Geometry<Node<3> >& pGeometry = this->GetGeometry();
...
template<unsigned int TDim, unsigned int TNumNodes>
void EVMVMSMonolithicWallCondition<TDim,TNumNodes>::ApplyNeumannCondition(MatrixType &rLocalMatrix, VectorType &rLocalVector)
{
    // const EVMVMSMonolithicWallCondition<TDim,TNumNodes>& rConstThis = *this;
...
template class EVMVMSMonolithicWallCondition<2,2>;
template class EVMVMSMonolithicWallCondition<3,3>;
