...
#if !defined(KRATOS_MY_CONDITION_H_INCLUDED )
#define KRATOS_MY_CONDITION_H_INCLUDED
...
public:
    ...
    /// Pointer definition of MyCondition
    KRATOS_CLASS_POINTER_DEFINITION(MyCondition);
     ...
     * Constructor.
     */
    MyCondition(IndexType NewId = 0);

    /**
     * Constructor using an array of nodes
     */
    MyCondition(IndexType NewId, const NodesArrayType& ThisNodes);

    /**
     * Constructor using Geometry
     */
    MyCondition(IndexType NewId, GeometryType::Pointer pGeometry);

    /**
     * Constructor using Properties
     */
    MyCondition(IndexType NewId, GeometryType::Pointer pGeometry, PropertiesType::Pointer pProperties);

    /**
     * Copy Constructor
     */
    MyCondition(MyCondition const& rOther);

    /**
     * Destructor
     */
    ~MyCondition() override;
    ...
    /// Assignment operator.
    MyCondition & operator=(MyCondition const& rOther);
...
#endif // KRATOS_MY_CONDITION_H_INCLUDED  defined
