...
void KratosRANSModellingApplication::Register()
{
    ...
    KRATOS_REGISTER_VARIABLE(RANS_PROCESS_Y_PLUS_MODEL)
    KRATOS_REGISTER_VARIABLE(RANS_PROCESS_WALL_DISTANCE)
    KRATOS_REGISTER_VARIABLE(RANS_PROCESS_WALL_VELOCITY)
