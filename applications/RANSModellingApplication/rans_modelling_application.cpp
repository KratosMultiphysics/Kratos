...
void KratosRANSModellingApplication::Register()
{
    ...
    KRATOS_REGISTER_CONDITION("RANSEVMVMSMonolithicWallCondition2D2N", mRansEVMVMSMonolithicWallCondition2D2N);
    KRATOS_REGISTER_CONDITION("RANSEVMVMSMonolithicWallCondition3D3N", mRansEVMVMSMonolithicWallCondition3D3N);
}
} // namespace Kratos.
