...
if (IsDistributedRun()):
    ...
    from KratosMultiphysics.RANSModellingApplication.adjoint_fluid_solver_no_replace import AdjointFluidSolverNoReplace as adjoint_fluid_solver_no_replace
