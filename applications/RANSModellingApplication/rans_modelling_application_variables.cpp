...
KRATOS_CREATE_VARIABLE( Process::Pointer, RANS_PROCESS_Y_PLUS_MODEL )
KRATOS_CREATE_VARIABLE( Process::Pointer, RANS_PROCESS_WALL_DISTANCE )
KRATOS_CREATE_VARIABLE( Process::Pointer, RANS_PROCESS_WALL_VELOCITY )
