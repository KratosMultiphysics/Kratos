...
#if !defined(KRATOS_MY_ELEMENT_H_INCLUDED )
#define KRATOS_MY_ELEMENT_H_INCLUDED
...
public:
    ...
    /// Pointer definition of MyElement
    KRATOS_CLASS_POINTER_DEFINITION(MyElement);
     ...
     * Constructor.
     */
    MyElement(IndexType NewId = 0);

    /**
     * Constructor using an array of nodes
     */
    MyElement(IndexType NewId, const NodesArrayType& ThisNodes);

    /**
     * Constructor using Geometry
     */
    MyElement(IndexType NewId, GeometryType::Pointer pGeometry);

    /**
     * Constructor using Properties
     */
    MyElement(IndexType NewId, GeometryType::Pointer pGeometry, PropertiesType::Pointer pProperties);

    /**
     * Copy Constructor
     */
    MyElement(MyElement const& rOther);
    ...
    /// Assignment operator.
    MyElement & operator=(MyElement const& rOther);
...
#endif // KRATOS_MY_ELEMENT_H_INCLUDED  defined
