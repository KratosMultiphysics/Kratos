...
namespace Testing
{
KRATOS_TEST_CASE_IN_SUITE(EVMKAdjointElement2D3N_CalculateFirstDerivativesLHS,
                          RANSModellingApplicationInterfaces)
{
    Model primal_model;
    ModelPart& r_primal_model_part =
        primal_model.CreateModelPart("test");
...
KRATOS_TEST_CASE_IN_SUITE(EVMKAdjointElement2D3N_Calculate_RANS_TURBULENT_ENERGY_DISSIPATION_RATE_PARTIAL_DERIVATIVE,
                          RANSModellingApplicationInterfaces)
{
    Model primal_model;
    ModelPart& r_primal_model_part =
...
KRATOS_TEST_CASE_IN_SUITE(EVMKAdjointElement2D3N_CalculateSecondDerivativesLHS,
                          RANSModellingApplicationInterfaces)
{
    Model primal_model;
    ModelPart& r_primal_model_part =
...
KRATOS_TEST_CASE_IN_SUITE(EVMKAdjointElement2D3N_Calculate_RANS_VELOCITY_PRESSURE_PARTIAL_DERIVATIVE,
                          RANSModellingApplicationInterfaces)
{
    Model primal_model;
    ModelPart& r_primal_model_part =
...
KRATOS_TEST_CASE_IN_SUITE(EVMKAdjointElement2D3N_CalculateSensitivityMatrix, RANSModellingApplicationInterfaces)
{
    Model primal_model;
    ModelPart& r_primal_model_part =
        primal_model.CreateModelPart("test");
