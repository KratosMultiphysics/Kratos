...
KRATOS_TEST_CASE_IN_SUITE(EVMKEpsilonVMSAdjointElement2D3N_CalculateFirstDerivativesLHS_VELOCITY,
...
KRATOS_TEST_CASE_IN_SUITE(EVMKEpsilonVMSAdjointElement2D3N_CalculateSensitivityMatrix,
                          RANSModellingApplicationInterfaces)
{
    Model primal_model;
    ModelPart& r_primal_model_part = primal_model.CreateModelPart("test");
...
KRATOS_TEST_CASE_IN_SUITE(EVMKEpsilonVMSAdjointElement2D3N_Calculate_RANS_TURBULENT_KINETIC_ENERGY_PARTIAL_DERIVATIVE,
                          RANSModellingApplicationInterfaces)
{
    Model primal_model;
    ModelPart& r_primal_model_part = primal_model.CreateModelPart("test");
...
KRATOS_TEST_CASE_IN_SUITE(EVMKEpsilonVMSAdjointElement2D3N_Calculate_RANS_TURBULENT_ENERGY_DISSIPATION_RATE_PARTIAL_DERIVATIVE,
                          RANSModellingApplicationInterfaces)
{
    Model primal_model;
    ModelPart& r_primal_model_part = primal_model.CreateModelPart("test");
