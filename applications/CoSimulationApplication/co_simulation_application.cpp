...
void KratosCoSimulationApplication::Register()
{
    ...
    KRATOS_REGISTER_VARIABLE(DISPLACEMENT_VECTOR)
    KRATOS_REGISTER_VARIABLE(ROOT_POINT_DISPLACEMENT_VECTOR)
    KRATOS_REGISTER_VARIABLE(REACTION_VECTOR)
    KRATOS_REGISTER_VARIABLE(VOLUME_WEIGHT_VECTOR)
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(FORCE)
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(MOMENT)
    KRATOS_REGISTER_VARIABLE(FORCE_VECTOR)
