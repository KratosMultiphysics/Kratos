...
void KratosCoSimulationApplication::Register()
{
    ...
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(ROOT_POINT_DISPLACEMENT)
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(ROOT_POINT_ROTATION)
    ...
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(PRESCRIBED_FORCE)
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(PRESCRIBED_MOMENT)
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(PRESCRIBED_DISPLACEMENT)
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(PRESCRIBED_ROTATION)
