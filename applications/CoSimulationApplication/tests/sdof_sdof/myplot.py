...
file2read = "sdof_sdof/results_sdof_structure.dat" # file name of the drag results
...
plt.savefig('sdof_sdof/myfig_structure.png')
#plt.show()

file2read = "sdof_sdof/results_sdof_controller.dat" # file name of the drag results
...
subplots_adjust(hspace=.35) # increase the space between the subplots
plt.savefig('sdof_sdof/myfig_controller.png')
#plt.show()