...
class CoSimulationBaseExtrapolator(object):
    ...
    def InitializeNonLinearIteration(self):
        raise NotImplementedError(tools.bcolors.FAIL + "CoSimulationBaseExtrapolator : Calling InitializeNonLinearIteration function !" + tools.bcolors.ENDC)
    ...
    def FinalizeNonLinearIteration(self):
        raise NotImplementedError(tools.bcolors.FAIL + "CoSimulationBaseExtrapolator : Calling FinalizeNonLinearIteration function !" + tools.bcolors.ENDC)
    ...
    def ComputeUpdate(self):
        raise NotImplementedError(tools.bcolors.FAIL + "CoSimulationBaseExtrapolator : Calling ComputeUpdate function !" + tools.bcolors.ENDC)

    ## PrintInfo : Function to print the information of the   extrapolator
    #
    #  @param self            The object pointer.
    def PrintInfo(self):
        raise NotImplementedError(tools.bcolors.FAIL + "CoSimulationBaseExtrapolator : Calling PrintInfo function !" + tools.bcolors.ENDC)
    ...
    #  @param self            The object pointer.
    def Check(self):
        raise NotImplementedError(tools.bcolors.FAIL + "CoSimulationBaseExtrapolator : Calling Check function !" + tools.bcolors.ENDC)

    ## _Name : Function to get the name of the   extrapolator
    #
    #  @param self            The object pointer.
    def _Name(self):
        raise NotImplementedError(tools.bcolors.FAIL + "CoSimulationBaseExtrapolator : Calling _Name function !" + tools.bcolors.ENDC)
