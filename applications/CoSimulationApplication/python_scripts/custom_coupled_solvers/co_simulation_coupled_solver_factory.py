...
available_coupled_solvers = {
    "gauss_seidel_strong_coupling"  : "gauss_seidel_strong_coupled_solver",
    "gauss_seidel_loose_coupling"   : "gauss_seidel_loose_coupled_solver",
}
...
def CreateCoupledSolver(settings):
    ...
    if coupled_solver_type.GetString() in available_coupled_solvers:
        ...
        module_full = 'KratosMultiphysics.CoSimulationApplication.custom_coupled_solvers.'+module_name
