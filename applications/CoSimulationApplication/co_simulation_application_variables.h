...
KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS( CO_SIMULATION_APPLICATION, IMPOSED_FORCE);
KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS( CO_SIMULATION_APPLICATION, IMPOSED_MOMENT);
KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS( CO_SIMULATION_APPLICATION, IMPOSED_DISPLACEMENT);
KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS( CO_SIMULATION_APPLICATION, IMPOSED_ROTATION);
