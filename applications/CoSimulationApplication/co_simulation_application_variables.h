...
KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS( CO_SIMULATION_APPLICATION, ROOT_POINT_DISPLACEMENT)
KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS( CO_SIMULATION_APPLICATION, ROOT_POINT_ROTATION)

KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS( CO_SIMULATION_APPLICATION, RESULTANT_FORCE)
KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS( CO_SIMULATION_APPLICATION, RESULTANT_MOMENT)
KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS( CO_SIMULATION_APPLICATION, GLOBAL_DISPLACEMENT)
KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS( CO_SIMULATION_APPLICATION, GLOBAL_ROTATION)
KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS( CO_SIMULATION_APPLICATION, PRESCRIBED_FORCE)
KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS( CO_SIMULATION_APPLICATION, PRESCRIBED_MOMENT)
KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS( CO_SIMULATION_APPLICATION, PRESCRIBED_DISPLACEMENT)
KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS( CO_SIMULATION_APPLICATION, PRESCRIBED_ROTATION)
