...
KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS( CO_SIMULATION_APPLICATION, DISPLACEMENT )
KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS( CO_SIMULATION_APPLICATION, ROOT_POINT_DISPLACEMENT )
KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS( CO_SIMULATION_APPLICATION, REACTION )
...
KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS( CO_SIMULATION_APPLICATION, VOLUME_ACCELERATION )
