...
KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS( CO_SIMULATION_APPLICATION, EFFECTIVE_FORCE);
KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS( CO_SIMULATION_APPLICATION, EFFECTIVE_MOMENT);
