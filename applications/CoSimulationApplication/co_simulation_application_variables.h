...
KRATOS_DEFINE_APPLICATION_VARIABLE( CO_SIMULATION_APPLICATION, Vector, DISPLACEMENT_VECTOR)
KRATOS_DEFINE_APPLICATION_VARIABLE( CO_SIMULATION_APPLICATION, Vector, ROOT_POINT_DISPLACEMENT_VECTOR)
KRATOS_DEFINE_APPLICATION_VARIABLE( CO_SIMULATION_APPLICATION, Vector, REACTION_VECTOR)
KRATOS_DEFINE_APPLICATION_VARIABLE( CO_SIMULATION_APPLICATION, Vector, VOLUME_WEIGHT_VECTOR)
KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS( CO_SIMULATION_APPLICATION, FORCE)
KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS( CO_SIMULATION_APPLICATION, MOMENT)
KRATOS_DEFINE_APPLICATION_VARIABLE( CO_SIMULATION_APPLICATION, Vector, FORCE_VECTOR)
...
KRATOS_DEFINE_APPLICATION_VARIABLE( CO_SIMULATION_APPLICATION, Vector, RESULTANT_FORCE_MOMENT)
