    ...
    const DataLocation DataLoc)
{
    ...
    if (DataLoc == DataLocation::NodeHistorical && rModelPart.Has(NODES_ID_INDEX_MAP)) {
        ...
        AuxiliaryModelPartUtilities(rModelPart).GetScalarData<double>(rVariable, DataLoc, rData);
    }
    ...
    const DataLocation DataLoc)
{
    ...
    if (DataLoc == DataLocation::NodeHistorical && rModelPart.Has(NODES_ID_INDEX_MAP)) {
        ...
        AuxiliaryModelPartUtilities(rModelPart).SetScalarData<double>(rVariable, DataLoc, rData);
    }
    ...
    const DataLocation DataLoc)
{
    ...
    if (DataLoc == DataLocation::NodeHistorical && rModelPart.Has(NODES_ID_INDEX_MAP)) {
        ...
        AuxiliaryModelPartUtilities(rModelPart).GetVectorData< array_1d<double, 3> >(rVariable, DataLoc, rData);
    }
    ...
    const DataLocation DataLoc)
{
    ...
    if (DataLoc == DataLocation::NodeHistorical && rModelPart.Has(NODES_ID_INDEX_MAP)) {
        ...
        AuxiliaryModelPartUtilities(rModelPart).SetVectorData< array_1d<double, 3> >(rVariable, DataLoc, rData);
    }
