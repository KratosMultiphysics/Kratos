...
PYBIND11_MODULE(KratosCoSimulationApplication,m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, DISPLACEMENT );
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, ROOT_POINT_DISPLACEMENT );
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, REACTION );
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, FORCE );
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, MOMENT );
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, VOLUME_ACCELERATION );
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,RESULTANT_FORCE_MOMENT);
}
