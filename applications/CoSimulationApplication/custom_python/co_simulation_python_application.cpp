...
PYBIND11_MODULE(KratosCoSimulationApplication,m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, DISPLACEMENT_VECTOR);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, ROOT_POINT_DISPLACEMENT_VECTOR);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, REACTION_VECTOR);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, VOLUME_WEIGHT_VECTOR);
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,FORCE_VECTOR);
