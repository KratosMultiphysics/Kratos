...
CFDfolder = "CFD/"
CSMfolder = "CSM/"
Tangofolder = "/cfdfile2/data/fm/nicolas/Tango/cases/Data_Tube2D_linear/"
...
plt.figure(3)
plt.plot(CA_lp[:, 1], CA_load[:, 2], '--', label=f"CoCo_p{it}", marker='o')
plt.plot(CF_lp[:, 0], CF_load[:, 0], label=f"CoCo_pt{it}", marker='o')
plt.ylabel("axial shear")
plt.title("axial shear")

plt.figure(4)
plt.plot(CA_lp[:, 1], CA_load[:, 1], '--', label=f"CoCo_p{it}", marker='o')
plt.plot(CF_lp[:, 0], CF_load[:, 1], label=f"CoCo_pt{it}", marker='o')
...
if True:
    ...
    plt.figure(3)
    plt.plot(TA_lp[:, 0], TA_load[:, 1], ':', label=f"Tango_p{it}", marker='o')
    plt.plot(TF_lp[:, 0], TF_load[:, 1], ':', label=f"Tango_pt{it}", marker='o')
    plt.legend()

    plt.figure(4)
    plt.plot(TA_lp[:, 0], TA_load[:, 2], ':', label=f"Tango_p{it}", marker='o')
    plt.plot(TF_lp[:, 0], TF_load[:, 2], ':', label=f"Tango_pt{it}", marker='o')
    plt.legend()
