...
plot 'hole_coords_l_s=0.0006_F_th=0.003_H_ev=400000.0_l_th=0.00025_alpha_ion=0.95_structured_finer.txt' u 2:(-$1) w l lw 2 lc rgb 'red' t 'Kratos fine mesh', \
     ...
     'hole_coords_l_s=0.0006_F_th=0.003_H_ev=400000.0_l_th=0.00025_alpha_ion=0.95_structured_finest.txt' u 2:(-$1) w l lw 2 lc rgb 'blue' t 'Kratos finest mesh', \
