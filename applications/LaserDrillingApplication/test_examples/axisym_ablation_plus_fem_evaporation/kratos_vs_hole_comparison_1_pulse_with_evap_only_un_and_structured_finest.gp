...
set output "laser_hole_un_and_structured_finest.png"
plot 'hole_coords_l_s=0.0006_F_th=0.003_H_ev=400000.0_l_th=0.00025_alpha_ion=0.95_unstructured_finest.txt' u 2:(-$1) w l lw 2 lc rgb 'red' t 'Kratos unstructured finest', \
     'hole_coords_l_s=0.0006_F_th=0.003_H_ev=400000.0_l_th=0.00025_alpha_ion=0.95_unstructured_finest.txt' u (-$2):(-$1) w l lw 2 lc rgb 'red' t '', \
