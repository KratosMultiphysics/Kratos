...
#define  KRATOS_SIMPLE_PRISM_3D_6_H_INCLUDED
...
{
/**
 * An 6 node prism geometry with linear shape functions
 */

template<class TPointType> class SimplePrism3D6 : public Geometry<TPointType>
{
public:
    /**
     * Type Definitions
    ...
    /**
     * Pointer definition of SimplePrism3D6
     */
    KRATOS_CLASS_POINTER_DEFINITION( SimplePrism3D6 );
    ...
    */
    ...
    SimplePrism3D6( const PointType& Point1, const PointType& Point2,
    ...
    SimplePrism3D6( typename PointType::Pointer pPoint1,
    ...
    SimplePrism3D6( const PointsArrayType& ThisPoints )
     ...
     */
    SimplePrism3D6( SimplePrism3D6 const& rOther )
        : BaseType( rOther )
    {
    }
     ...
     * source geometry's points too.
     */
    template<class TOtherPointType> SimplePrism3D6( SimplePrism3D6<TOtherPointType> const& rOther )
        : BaseType( rOther )
    {
    }

    /// Destructor. Does nothing!!!
    virtual ~SimplePrism3D6() {}
     ...
     * @see ClonePoints
     */
    SimplePrism3D6& operator=( const SimplePrism3D6& rOther )
    {
    ...
    SimplePrism3D6& operator=( SimplePrism3D6<TOtherPointType> const & rOther )
    {
        BaseType::operator=( rOther );
    ...
    {
        return typename BaseType::Pointer( new SimplePrism3D6( ThisPoints ) );
    }
        ...
        virtual Geometry< Point<3> >::Pointer Clone() const
    {
        ...
        Geometry< Point<3> >::Pointer p_clone( new SimplePrism3D6< Point<3> >( NewPoints ) );
...
private:
    ...
    SimplePrism3D6(): BaseType( PointsArrayType(), &msGeometryData ) {}
    ...
    static const IntegrationPointsContainerType AllIntegrationPoints()
    {
        ...
        {
            {
                /* Simple point in the plane */
                Quadrature < PrismGaussLegendreIntegrationPointsSimple1,
                3, IntegrationPoint<3> >::GenerateIntegrationPoints(),
                Quadrature < PrismGaussLegendreIntegrationPointsSimple2,
                3, IntegrationPoint<3> >::GenerateIntegrationPoints(),
                Quadrature < PrismGaussLegendreIntegrationPointsSimple3,
                3, IntegrationPoint<3> >::GenerateIntegrationPoints(),
                Quadrature < PrismGaussLegendreIntegrationPointsSimple4,
                3, IntegrationPoint<3> >::GenerateIntegrationPoints(),
                Quadrature < PrismGaussLegendreIntegrationPointsSimple5,
                3, IntegrationPoint<3> >::GenerateIntegrationPoints(),
            }
        };
    ...
    static const ShapeFunctionsValuesContainerType AllShapeFunctionsValues()
    {
        ...
        {
            {
                SimplePrism3D6<TPointType>::CalculateShapeFunctionsIntegrationPointsValues(
    ...
    AllShapeFunctionsLocalGradients()
    {
        ...
        {
            {
                SimplePrism3D6<TPointType>::CalculateShapeFunctionsIntegrationPointsLocalGradients(
                    GeometryData::GI_GAUSS_1 ),
                SimplePrism3D6<TPointType>::CalculateShapeFunctionsIntegrationPointsLocalGradients(
                    GeometryData::GI_GAUSS_2 ),
                SimplePrism3D6<TPointType>::CalculateShapeFunctionsIntegrationPointsLocalGradients(
    ...
    template<class TOtherPointType> friend class SimplePrism3D6;
...
template<class TPointType> inline std::istream& operator >> (
    std::istream& rIStream, SimplePrism3D6<TPointType>& rThis );

/**
 * output stream function
 */
template<class TPointType> inline std::ostream& operator << (
    std::ostream& rOStream, const SimplePrism3D6<TPointType>& rThis )
{
...
#endif // KRATOS_SIMPLE_PRISM_3D_6_H_INCLUDED  defined 
