...
//     typedef BaseSolvingStrategyType::Pointer BaseSolvingStrategyPointer;
    ...
    py::class_< PrebucklingStrategyType, typename PrebucklingStrategyType::Pointer,BaseSolvingStrategyType >(m,"PrebucklingStrategy")
        ...
        .def("GetNorm1", &PrebucklingStrategyType::GetNorm1)
        .def("GetNorm2", &PrebucklingStrategyType::GetNorm2)
        .def("GetEigenvalue", &PrebucklingStrategyType::GetEigenvalue)
        .def("GetNormStep1", &PrebucklingStrategyType::GetNormStep1)
        .def("GetNormStep2", &PrebucklingStrategyType::GetNormStep2)
        ;
