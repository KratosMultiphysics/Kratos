...
#include "custom_response_functions/response_utilities/adjoint_eigenfrequency_response_function.h"
...
void  AddCustomResponseFunctionUtilitiesToPython(pybind11::module& m)
{
    ...
    py::class_<AdjointEigenfrequencyResponseFunction, AdjointEigenfrequencyResponseFunction::Pointer, AdjointResponseFunction>
        (m, "AdjointEigenfrequencyResponseFunction")
        .def(py::init<ModelPart&, Parameters>());
}
