...
#include "custom_response_functions/response_utilities/adjoint_nodal_displacement_aggregation_response_function.h"
...
void  AddCustomResponseFunctionUtilitiesToPython(pybind11::module& m)
{
    ...
    py::class_<AdjointNodalDisplacementAggregationResponseFunction, AdjointNodalDisplacementAggregationResponseFunction::Pointer, AdjointResponseFunction>
        (m, "AdjointNodalDisplacementAggregationResponseFunction")
        .def(py::init<ModelPart&, Parameters>());
}
