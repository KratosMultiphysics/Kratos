...
#include "custom_response_functions/response_utilities/adjoint_min_stress_response_function.h"
...
void  AddCustomResponseFunctionUtilitiesToPython(pybind11::module& m)
{
    ...
    py::class_<AdjointMinStressResponseFunction, AdjointMinStressResponseFunction::Pointer, AdjointResponseFunction>
        (m, "AdjointMinStressResponseFunction")
        .def(py::init<ModelPart&, Parameters>());
