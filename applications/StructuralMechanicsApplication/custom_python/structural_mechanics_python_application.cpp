...
BOOST_PYTHON_MODULE(KratosStructuralMechanicsApplication)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(MIDDLE_ANGULAR_VELOCITY)
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(NODAL_INERTIA)
    ...
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(ADJOINT_ROTATION)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(DISTURBANCE_MEASURE)
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE( IS_ADJOINT );
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(STRESS_DESIGN_DERIVATIVE_ON_NODE);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(STRESS_DESIGN_DERIVATIVE_ON_GP);
