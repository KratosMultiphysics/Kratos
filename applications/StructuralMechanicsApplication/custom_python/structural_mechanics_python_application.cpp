...
PYBIND11_MODULE(KratosStructuralMechanicsApplication,m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, ADJOINT_DIRECTED_STRAIN );
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, I22_SENSITIVITY_ANALYTIC );
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, CROSS_AREA_SENSITIVITY_ANALYTIC);
    ...
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, YOUNG_MODULUS_PSEUDO_FORCE );
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, YOUNG_MODULUS_PSEUDO_MOMENT );
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, I22_PSEUDO_LOAD );
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, I22_PSEUDO_MOMENT );
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, BEAM_BENDING_MODES );
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, YOUNG_MODULUS_SENSITIVITY_ANALYTIC );
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, SHELL_PSEUDO_STRESSES )
