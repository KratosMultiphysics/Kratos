...
PYBIND11_MODULE(KratosStructuralMechanicsApplication,m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,PHASE_FIELD);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,DAMAGE_DRIVING_FORCE);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,UNDAMAGED_ELASTIC_ENERGY);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,PHASE_FIELD_LENGTH);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,CRITICAL_ENERGY_RELEASE_RATE);    
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,WELL_COND_PARAM);    
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,COUPLE_U_PHI);    
