...
PYBIND11_MODULE(KratosStructuralMechanicsApplication,m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, ELASTIC_UNIAXIAL_STRENGTH_TENSION)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, ELASTIC_UNIAXIAL_STRENGTH_COMPRESSION)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, ELASTIC_BIAXIAL_STRENGTH_COMPRESSION)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, PLASTIC_STRAIN_RATE_BETA)
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, STRAIN_REFERENCE)
