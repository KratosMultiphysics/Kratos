...
BOOST_PYTHON_MODULE(KratosStructuralMechanicsApplication)
{
	...
	//ROCO NET
	KRATOS_REGISTER_IN_PYTHON_VARIABLE(KB_ROCCO)
	KRATOS_REGISTER_IN_PYTHON_VARIABLE(KT_MULT_ROCCO)
	KRATOS_REGISTER_IN_PYTHON_VARIABLE(DIAMETER_ROCCO)
	KRATOS_REGISTER_IN_PYTHON_VARIABLE(WIRE_THICKNESS_ROCCO)
	KRATOS_REGISTER_IN_PYTHON_VARIABLE(WIRE_WINDINGS_ROCCO)
	KRATOS_REGISTER_IN_PYTHON_VARIABLE(NODAL_MASS_ROCCO)
