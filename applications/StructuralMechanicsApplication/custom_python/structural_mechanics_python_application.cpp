...
PYBIND11_MODULE(KratosStructuralMechanicsApplication,m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, ADJOINT_PARTICULAR_CURVATURE);
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, ADJOINT_PARTICULAR_STRAIN);
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, ADJOINT_WORK_FORCE_CONTRIBUTION);
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, ADJOINT_WORK_MOMENT_CONTRIBUTION);
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, SECTION_HEIGTH );
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, SECTION_WIDTH );
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, SECTION_HEIGTH_SENSITIVITY );
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, SECTION_WIDTH_SENSITIVITY );
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, TORSIONAL_INERTIA_SENSITIVITY);
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, VARIATIONAL_SENSITIVITY);
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, PSEUDO_FORCE);
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, PSEUDO_MOMENT);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, YOUNG_MODULUS_DERIVED );
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, CROSS_AREA_DERIVED );
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, I22_DERIVED );
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, I33_DERIVED );
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, AREA_EFFECTIVE_Y_DERIVED);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, AREA_EFFECTIVE_Z_DERIVED);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, TORSIONAL_INERTIA_DERIVED);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, POISSON_RATIO_DERIVED);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, DENSITY_DERIVED );
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, RESPONSE_PREFACTOR_MOMENT_DERIVED);
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, RESPONSE_PREFACTOR_FORCE_DERIVED);
