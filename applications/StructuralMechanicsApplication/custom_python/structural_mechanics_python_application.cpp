...
BOOST_PYTHON_MODULE(KratosStructuralMechanicsApplication)
{
    ...
    /* Contact */
    /* Mortar contact */
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(MASTER_SLAVE)
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS( CONTACT_MESH_TYING_FORCE ) // The "force" resulting from contact
