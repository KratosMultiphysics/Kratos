...
PYBIND11_MODULE(KratosStructuralMechanicsApplication,m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_SYMMETRIC_3D_TENSOR_VARIABLE_WITH_COMPONENTS(m, REACTION_STRAIN_VECTOR )
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, TEMPERATURE_SENSITIVITY);
    ...
    KRATOS_REGISTER_IN_PYTHON_SYMMETRIC_2D_TENSOR_VARIABLE_WITH_COMPONENTS(m, PRE_STRESS);
    KRATOS_REGISTER_IN_PYTHON_SYMMETRIC_2D_TENSOR_VARIABLE_WITH_COMPONENTS(m, PRE_STRESS_SENSITIVITY);
...
//    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENT
    //KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, PRESTRESS_VECTOR_SENSITIVITY );
