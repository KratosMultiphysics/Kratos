...
PYBIND11_MODULE(KratosStructuralMechanicsApplication,m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, SHEAR_MODULUS_XZ_SENSITIVITY);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, SHEAR_MODULUS_YZ_SENSITIVITY);
    ...
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, PRESCRIBED_DISPLACEMENT_SENSITIVITY );
