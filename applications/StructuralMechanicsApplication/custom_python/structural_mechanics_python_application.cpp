...
PYBIND11_MODULE(KratosStructuralMechanicsApplication,m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, BEAM_INITIAL_INTERNAL_FORCES )
    ...
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, LINE_LOAD_SENSITIVITY );
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, SURFACE_LOAD_SENSITIVITY );
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, SURFACE_LOAD_SENSITIVITY_INCREMENT );
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, ADJOINT_DISPLACEMENT_INCREMENT );
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, PRESSURE_SENSITIVITY );
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, POSITIVE_FACE_PRESSURE_SENSITIVITY );
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, NEGATIVE_FACE_PRESSURE_SENSITIVITY );
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, YOUNG_MODULUS_VAR_SENSITIVITY);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, YOUNG_MODULUS_PARTIAL_SENSITIVITY);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, ISOTROPIC_PRESTRESS_VAR_SENSITIVITY);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, POISSON_RATIO_PARTIAL_SENSITIVITY);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, POISSON_RATIO_VAR_SENSITIVITY);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, ISOTROPIC_PRESTRESS_PARTIAL_SENSITIVITY);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, YOUNG_MODULUS_X_SENSITIVITY);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, YOUNG_MODULUS_Y_SENSITIVITY);
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, TRUSS_PRESTRESS_PK2_SENSITIVITY);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, PRESTRESS_VECTOR_X_SENSITIVITY);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, PRESTRESS_VECTOR_Y_SENSITIVITY);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, PRESTRESS_VECTOR_ISOTROPIC_XY_SENSITIVITY);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, SHEAR_MODULUS_XY_SENSITIVITY);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, POISSON_RATIO_XY_SENSITIVITY);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, POISSON_RATIO_SENSITIVITY);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, YIELD_STRESS_SENSITIVITY);
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, GREEN_LAGRANGE_STRAIN_DERIVATIVE_MATRIX);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, ADJOINT_GREEN_LAGRANGE_STRAIN_VECTOR);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, YOUNG_MODULUS_PSEUDO_NORMAL_FORCE_VECTOR);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, POISSON_RATIO_PSEUDO_NORMAL_FORCE_VECTOR);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, ISOTROPIC_PRESTRESS_PSEUDO_NORMAL_FORCE_VECTOR);
