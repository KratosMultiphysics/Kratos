...
PYBIND11_MODULE(KratosStructuralMechanicsApplication,m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, EULER_ANGLE_PHI)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, EULER_ANGLE_THETA)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, EULER_ANGLE_HI)
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, ISOTROPIC_ANISOTROPIC_YIELD_RATIO_X );
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, ISOTROPIC_ANISOTROPIC_YIELD_RATIO_Y );
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, ISOTROPIC_ANISOTROPIC_YIELD_RATIO_Z );
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, ISOTROPIC_ANISOTROPIC_YIELD_RATIO_XY );
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, ISOTROPIC_ANISOTROPIC_YIELD_RATIO_XZ );
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, ISOTROPIC_ANISOTROPIC_YIELD_RATIO_YZ );
}
