...
PYBIND11_MODULE(KratosStructuralMechanicsApplication,m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, SHELL_SHEAR_FORMULATION )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, SHELL_DRILLING_STIFFNESS_MULTIPLIER )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, SBM_CONSTRAINED_DOFS )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, SBM_FORMULATION_TYPE )
