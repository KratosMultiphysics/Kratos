...
PYBIND11_MODULE(KratosStructuralMechanicsApplication,m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, ELASTIC_LIMIT_STRESS_COMPRESSION)
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, YIELD_STRESS_SHEAR_12)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, YIELD_STRESS_SHEAR_21)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, YIELD_STRESS_SHEAR_12_MINUS)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, YIELD_STRESS_SHEAR_21_MINUS)
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, YOUNG_MODULUS_2)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, POISSON_RATIO_12)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, YOUNG_MODULUS_1)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, POISSON_RATIO_21)
}
