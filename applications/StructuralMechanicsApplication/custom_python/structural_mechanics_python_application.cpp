...
PYBIND11_MODULE(KratosStructuralMechanicsApplication,m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, DISPLACEMENT_NL_SENSITIVITY);
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, DISPLACEMENT_NL_SENSITIVITY_FIRST_ORDER);
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, DISPLACEMENT_NL_SENSITIVITY_SECOND_ORDER);
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, FORCE_NL_SENSITIVITY);
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, FORCE_NL_SENSITIVITY_FIRST_ORDER);
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, FORCE_NL_SENSITIVITY_SECOND_ORDER);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, SHELL_MOMENT_GLOBAL_NL_SENSITIVITY);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, SHELL_MOMENT_GLOBAL_NL_SENSITIVITY_FIRST_ORDER);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, SHELL_MOMENT_GLOBAL_NL_SENSITIVITY_SECOND_ORDER);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, VON_MISES_STRESS_NL_SENSITIVITY);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, VON_MISES_STRESS_NL_SENSITIVITY_FIRST_ORDER);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, VON_MISES_STRESS_NL_SENSITIVITY_SECOND_ORDER);
