...
BOOST_PYTHON_MODULE(KratosStructuralMechanicsApplication)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(QUATERNION_VECTOR)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(QUATERNION_SCALAR_VECTOR)

    //Total nodal variables
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(TOTAL_NODAL_DEFORMATION)
