...
PYBIND11_MODULE(KratosStructuralMechanicsApplication,m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, SEMI_RIGID_NODE_IDS)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, SEMI_RIGID_ROTATIONAL_STIFFNESS_VECTOR_AXIS_2)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, SEMI_RIGID_ROTATIONAL_STIFFNESS_VECTOR_AXIS_3)
