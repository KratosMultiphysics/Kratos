...
PYBIND11_MODULE(KratosStructuralMechanicsApplication,m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, ADJOINT_ES_STRAIN_VECTOR)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, ADJOINT_GL_STRAIN_VECTOR)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, ADJOINT_EA_STRAIN_VECTOR)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, YOUNG_MODULUS_PSEUDO_PK2_STRESS_VECTOR)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, TRUSS_PRESTRESS_PK2_PSEUDO_PK2_STRESS_VECTOR)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, CROSS_AREA_PSEUDO_PK2_STRESS_VECTOR)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, CROSS_AREA_PSEUDO_CAUCHY_STRESS_VECTOR)
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, CROSS_AREA_PSEUDO_FORCE );

    // Variables for output of sensitivities
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, YOUNG_MODULUS_VARIATIONAL_SENSITIVITY);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, TRUSS_PRESTRESS_PK2_VARIATIONAL_SENSITIVITY);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, CROSS_AREA_VARIATIONAL_SENSITIVITY);
