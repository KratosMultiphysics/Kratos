...
PYBIND11_MODULE(KratosStructuralMechanicsApplication,m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, SCALING_TRANSLATION_MASS)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, SCALING_ROTATION_MASS)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, STABILIZED_CONTROL_POINT)
