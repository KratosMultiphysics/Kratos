...
PYBIND11_MODULE(KratosStructuralMechanicsApplication,m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,CHARACTERISTIC_INTERNAL_LENGTH)
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, NON_LOCAL_VARIABLE );
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, NON_LOCAL_VARIABLE_NAME );
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, EQUIVALENCE_PRINCIPLE_TYPE );
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, NON_LOCAL_EQUIVALENT_STRAIN_TENSION );
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, NON_LOCAL_EQUIVALENT_STRAIN_COMPRESSION );
}
