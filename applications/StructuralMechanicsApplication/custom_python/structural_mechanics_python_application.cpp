...
PYBIND11_MODULE(KratosStructuralMechanicsApplication,m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,CROSS_SECTION_TYPE)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,DIM1)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,DIM2)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,DIM3)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,DIM4)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,DIM5)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,DIM6)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,DIM7)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,DIM8)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,DIM9)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,DIM10)
