...
BOOST_PYTHON_MODULE(KratosStructuralMechanicsApplication)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE( PRESTRESS_VECTOR )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE( PRESTRESS_AXIS_1_GLOBAL )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE( PRESTRESS_AXIS_2_GLOBAL )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE( PRESTRESS_AXIS_1 )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE( PRESTRESS_AXIS_2 )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE( PROJECTION_TYPE_COMBO )

    //Formfinding
    KRATOS_REGISTER_IN_PYTHON_VARIABLE( LAMBDA_MAX )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE( IS_FORMFINDING )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE( BASE_REF_1 )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE( BASE_REF_2 )
