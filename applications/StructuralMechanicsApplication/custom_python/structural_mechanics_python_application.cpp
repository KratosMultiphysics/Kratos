...
PYBIND11_MODULE(KratosStructuralMechanicsApplication,m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, DISPLACEMENT_NL1_SENSITIVITY);
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, DISPLACEMENT_NL2_SENSITIVITY);
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, FORCE_NL1_SENSITIVITY);
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, FORCE_NL2_SENSITIVITY);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, SHELL_MOMENT_GLOBAL_NL1_SENSITIVITY);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, SHELL_MOMENT_GLOBAL_NL2_SENSITIVITY);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, VON_MISES_STRESS_NL1_SENSITIVITY);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, VON_MISES_STRESS_NL2_SENSITIVITY);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, PK2_STRESS_VECTOR_NL1_SENSITIVITY);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, PK2_STRESS_VECTOR_NL2_SENSITIVITY);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, PRINCIPAL_PK2_STRESS_VECTOR_NL1_SENSITIVITY);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, PRINCIPAL_PK2_STRESS_VECTOR_NL2_SENSITIVITY);
