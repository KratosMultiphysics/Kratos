...
PYBIND11_MODULE(KratosStructuralMechanicsApplication,m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, INITIAL_PRESTRESS )
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,  FREE_SURFACE_NORMAL )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,  FREE_SURFACE_CENTRE )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,  FREE_SURFACE_AREA )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,  CURRENT_FLUID_VOLUME )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,  FREE_SURFACE_RADIUS )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,  FLUID_VOLUME )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,  SPECIFIC_WEIGHT )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,  USE_HYDROSTATIC_MATRIX )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,  ADD_RHS_FOR_RANK_ONE_UPDATE )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,  DO_UPDATE_FROM_DEL_VOL )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,  WET_MODEL_PART )
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, PRINCIPAL_STRESS_3)
