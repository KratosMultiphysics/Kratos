...
#ifndef ADJOINT_TEST_RESPONSE_FUNCTION_H
#define ADJOINT_TEST_RESPONSE_FUNCTION_H
...
/** \brief AdjointTestResponseFunction
*
...
*/
class KRATOS_API(STRUCTURAL_MECHANICS_APPLICATION) AdjointTestResponseFunction : public AdjointStructuralResponseFunction
{
public:
    ///@name Type Definitions
    ///@{
    ...
    /// Pointer definition of AdjointTestResponseFunction
    KRATOS_CLASS_POINTER_DEFINITION(AdjointTestResponseFunction);
    ...
    /// Default constructor.
    AdjointTestResponseFunction(ModelPart& rModelPart, Parameters ResponseSettings);

    /// Destructor.
    ~AdjointTestResponseFunction() override;
...
}; // Class AdjointTestResponseFunction
...
#endif // ADJOINT_TEST_RESPONSE_FUNCTION_H_INCLUDED
