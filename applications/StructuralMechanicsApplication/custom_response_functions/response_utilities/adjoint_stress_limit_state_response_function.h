...
#ifndef ADJOINT_STRESS_LIMIT_STATE_RESPONSE_FUNCTION_H
#define ADJOINT_STRESS_LIMIT_STATE_RESPONSE_FUNCTION_H
...
/** \brief AdjointStressLimitStateResponseFunction
 *
 ...
 */
class KRATOS_API(STRUCTURAL_MECHANICS_APPLICATION) AdjointStressLimitStateResponseFunction : public AdjointStructuralResponseFunction
{
public:
    ///@name Type Definitions
    ///@{
    ...
    /// Pointer definition of AdjointStressLimitStateResponseFunction
    KRATOS_CLASS_POINTER_DEFINITION(AdjointStressLimitStateResponseFunction);
    ...
    /// Default constructor.
    AdjointStressLimitStateResponseFunction(ModelPart& rModelPart, Parameters ResponseSettings);

    /// Destructor.
    ~AdjointStressLimitStateResponseFunction() override;
...
}; // Class AdjointStressLimitStateResponseFunction
...
#endif // ADJOINT_STRESS_LIMIT_STATE_RESPONSE_FUNCTION_H_INCLUDED
