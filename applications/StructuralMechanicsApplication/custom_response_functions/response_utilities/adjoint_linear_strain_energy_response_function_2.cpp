...
// Project includes
#include "adjoint_linear_strain_energy_response_function_2.h"

namespace Kratos
{
    AdjointLinearStrainEnergyResponseFunction2::AdjointLinearStrainEnergyResponseFunction2(ModelPart& rModelPart, Parameters ResponseSettings)
    : AdjointStructuralResponseFunction(rModelPart, ResponseSettings)
    {
    }

    AdjointLinearStrainEnergyResponseFunction2::~AdjointLinearStrainEnergyResponseFunction2()
    {
    }

    void AdjointLinearStrainEnergyResponseFunction2::Initialize()
    {
        KRATOS_TRY;
    ...
    void AdjointLinearStrainEnergyResponseFunction2::CalculatePartialSensitivity(Element& rAdjointElement,
                                             ...
                                             const ProcessInfo& rProcessInfo)
    {
        ...
        const auto& r_const_adjoint_element_ref = rAdjointElement;
        r_const_adjoint_element_ref.GetValuesVector(adjoint_variables); // = u
        ...
        noalias(rSensitivityGradient) = -0 * prod(rSensitivityMatrix, adjoint_variables);
    ...
    void AdjointLinearStrainEnergyResponseFunction2::CalculatePartialSensitivity(Condition& rAdjointCondition,
                                             const Variable<double>& rVariable,
                                             const Matrix& rSensitivityMatrix,
                                             Vector& rSensitivityGradient,
                                             const ProcessInfo& rProcessInfo)
                                             ...
                                             const ProcessInfo& rProcessInfo)
    {
        ...
        noalias(rSensitivityGradient) = -0.5 * prod(rSensitivityMatrix, adjoint_variables);
    ...
    double AdjointLinearStrainEnergyResponseFunction2::CalculateValue(ModelPart& rModelPart)
    {
        KRATOS_TRY;
    ...
    void AdjointLinearStrainEnergyResponseFunction2::CheckForBodyForces(Element& rAdjointElement)
    {
