    ...
    void PerformSemiAnalyticSensitivityAnalysis()
    {
        ...
        for (auto& elem_i : mrModelPart.Elements())
        {
            ...
            for(auto& node_i : elem_i.GetGeometry())
            {
                ...
                {
                    ElementFiniteDifferenceUtility::CalculateLeftHandSideDerivative(elem_i, coord_directions[coord_dir_i], node_i, delta, derived_LHS, CurrentProcessInfo);
                    ElementFiniteDifferenceUtility::CalculateMassMatrixDerivative(elem_i, coord_directions[coord_dir_i], node_i, delta, derived_mass_matrix, CurrentProcessInfo);
