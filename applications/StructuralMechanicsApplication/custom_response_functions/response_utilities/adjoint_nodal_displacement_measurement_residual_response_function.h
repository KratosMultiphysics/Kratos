...
namespace Kratos
{
    ...
    /** \brief AdjointNodalDisplacementMeasurementResidualResponseFunction
     *
     ...
     */
    class KRATOS_API(STRUCTURAL_MECHANICS_APPLICATION) AdjointNodalDisplacementMeasurementResidualResponseFunction : public AdjointStructuralResponseFunction
    {
    public:
        ///@name Type Definitions
        ///@{
        ...
        /// Pointer definition of AdjointNodalDisplacementMeasurementResidualResponseFunction
        KRATOS_CLASS_POINTER_DEFINITION(AdjointNodalDisplacementMeasurementResidualResponseFunction);
        ...
        /// Default constructor.
        AdjointNodalDisplacementMeasurementResidualResponseFunction(ModelPart &rModelPart, Parameters ResponseSettings);

        /// Destructor.
        ~AdjointNodalDisplacementMeasurementResidualResponseFunction() override;
    ...
    }; // Class AdjointNodalDisplacementMeasurementResidualResponseFunction
