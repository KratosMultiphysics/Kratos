...
#ifndef ADJOINT_MIN_STRESS_RESPONSE_FUNCTION_H
#define ADJOINT_MIN_STRESS_RESPONSE_FUNCTION_H
...
/** \brief AdjointMINStressResponseFunction
 *
 ...
 */
class KRATOS_API(STRUCTURAL_MECHANICS_APPLICATION) AdjointMinStressResponseFunction : public AdjointStructuralResponseFunction
{
public:
    ///@name Type Definitions
    ///@{
    ...
    /// Pointer definition of AdjointMinStressResponseFunction
    KRATOS_CLASS_POINTER_DEFINITION(AdjointMinStressResponseFunction);
    ...
    /// Default constructor.
    AdjointMinStressResponseFunction(ModelPart& rModelPart, Parameters ResponseSettings);

    /// Destructor.
    ~AdjointMinStressResponseFunction() override;
...
}; // Class AdjointMinStressResponseFunction
...
#endif // ADJOINT_MIN_STRESS_RESPONSE_FUNCTION_H_INCLUDED
