...
// System includes
#if !defined(ADJOINT_SEMI_ANALYTIC_POINT_MOMENT_CONDITION )
#define  ADJOINT_SEMI_ANALYTIC_POINT_MOMENT_CONDITION
...
class AdjointSemiAnalyticPointMomentCondition
...
public:
    ...
    /// Counted pointer of AdjointSemiAnalyticPointMomentCondition
    KRATOS_CLASS_POINTER_DEFINITION( AdjointSemiAnalyticPointMomentCondition );

    ///@}
    ///@name Life Cycle
    ///@{

    AdjointSemiAnalyticPointMomentCondition(IndexType NewId = 0)
    : AdjointSemiAnalyticBaseCondition<TPrimalCondition>(NewId)
    {
    }

    AdjointSemiAnalyticPointMomentCondition(IndexType NewId, typename GeometryType::Pointer pGeometry)
    : AdjointSemiAnalyticBaseCondition<TPrimalCondition>(NewId, pGeometry)
    {
    }

    AdjointSemiAnalyticPointMomentCondition(IndexType NewId,
    ...
    {
        return Kratos::make_intrusive<AdjointSemiAnalyticPointMomentCondition<TPrimalCondition>>(
...
#endif // ADJOINT_SEMI_ANALYTIC_POINT_MOMENT_CONDITION  defined
