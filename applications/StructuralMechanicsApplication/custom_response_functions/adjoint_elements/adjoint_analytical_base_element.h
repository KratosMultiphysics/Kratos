...
#if !defined(ADJOINT_ANALYTICAL_BASE_ELEMENT_H_INCLUDED )
#define  ADJOINT_ANALYTICAL_BASE_ELEMENT_H_INCLUDED
...
/** \brief AdjointAnalyticalBaseElement
 *
 * This element a wrapper for a primal element to calculate element derivatives using
 * analytical approach. It is designed to be used in adjoint
 * sensitivity analysis
 */
template <typename TPrimalElement>
class AdjointAnalyticalBaseElement : public Element
{
public:
    ...
    KRATOS_CLASS_INTRUSIVE_POINTER_DEFINITION(AdjointAnalyticalBaseElement);
    ///@}
    ...
    AdjointAnalyticalBaseElement(IndexType NewId = 0,
    ...
    AdjointAnalyticalBaseElement(IndexType NewId,
    ...
    {
        return Kratos::make_intrusive<AdjointAnalyticalBaseElement<TPrimalElement>>(
...
#endif // ADJOINT_ANALYTICAL_BASE_ELEMENT_H_INCLUDED
