...
void AdjointFiniteDifferencingShellElement::CalculateSensitivityMatrix(const Variable<double>& rDesignVariable, Matrix& rOutput,
                                            const ProcessInfo& rCurrentProcessInfo)
{
    KRATOS_TRY;
...
void AdjointFiniteDifferencingShellElement::CalculateSensitivityMatrix(const Variable<array_1d<double,3>>& rDesignVariable, Matrix& rOutput,
                                            const ProcessInfo& rCurrentProcessInfo)
{
    KRATOS_TRY;
...
void AdjointFiniteDifferencingShellElement::CalculateStressDisplacementDerivative(const Variable<Vector>& rStressVariable,
...
void AdjointFiniteDifferencingShellElement::CalculateStressDesignVariableDerivative(const Variable<double>& rDesignVariable,
...
void AdjointFiniteDifferencingShellElement::CalculateStressDesignVariableDerivative(const Variable<array_1d<double,3>>& rDesignVariable,
