...
AdjointFiniteDifferencingShellElement<TPrimalElement>::ThisExtensions::ThisExtensions(Element* pElement)
    : mpElement{pElement}
{
}

template <class TPrimalElement>
void AdjointFiniteDifferencingShellElement<TPrimalElement>::ThisExtensions::GetFirstDerivativesVector(
...
template <class TPrimalElement>
void AdjointFiniteDifferencingShellElement<TPrimalElement>::ThisExtensions::GetSecondDerivativesVector(
    std::size_t NodeId, std::vector<IndirectScalar<double>>& rVector, std::size_t Step)
{
    auto& r_node = mpElement->GetGeometry()[NodeId];
...
template <class TPrimalElement>
void AdjointFiniteDifferencingShellElement<TPrimalElement>::ThisExtensions::GetAuxiliaryVector(
    std::size_t NodeId, std::vector<IndirectScalar<double>>& rVector, std::size_t Step)
{
    auto& r_node = mpElement->GetGeometry()[NodeId];
...
template <class TPrimalElement>
void AdjointFiniteDifferencingShellElement<TPrimalElement>::ThisExtensions::GetFirstDerivativesVariables(
...
template <class TPrimalElement>
void AdjointFiniteDifferencingShellElement<TPrimalElement>::ThisExtensions::GetSecondDerivativesVariables(
    std::vector<VariableData const*>& rVariables) const
{
    rVariables.resize(2);
...
template <class TPrimalElement>
void AdjointFiniteDifferencingShellElement<TPrimalElement>::ThisExtensions::GetAuxiliaryVariables(
    std::vector<VariableData const*>& rVariables) const
{
    rVariables.resize(2);
