...
namespace Kratos
{
    ...
    KRATOS_CREATE_VARIABLE(double, DAMAGE_DRIVING_FORCE);
    KRATOS_CREATE_VARIABLE(double, UNDAMAGED_ELASTIC_ENERGY);
    KRATOS_CREATE_VARIABLE(double, PHASE_FIELD_LENGTH);
    KRATOS_CREATE_VARIABLE(double, CRITICAL_ENERGY_RELEASE_RATE);
    KRATOS_CREATE_VARIABLE(double, WELL_COND_PARAM);
    KRATOS_CREATE_VARIABLE(bool, COUPLE_U_PHI);    
