...
KRATOS_CREATE_VARIABLE( std::string, TRACED_STRESS_TYPE ); 
KRATOS_CREATE_VARIABLE( Matrix, STRESS_DISP_DERIV_ON_NODE); 
KRATOS_CREATE_VARIABLE( Matrix, STRESS_DISP_DERIV_ON_GP ); 
KRATOS_CREATE_VARIABLE( Matrix, STRESS_DV_DERIV_ON_NODE); 
KRATOS_CREATE_VARIABLE( Matrix, STRESS_DV_DERIV_ON_GP ); 
...
//KRATOS_CREATE_VARIABLE( FiniteDifferencesUtilities::Pointer, FINITE_DIFFERENCE_INFORMATION );
