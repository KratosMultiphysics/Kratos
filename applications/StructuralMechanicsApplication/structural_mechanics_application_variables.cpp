...
KRATOS_CREATE_VARIABLE(Vector, PRIMAL_VALUES_VECTOR)
...
KRATOS_CREATE_VARIABLE(double, SHEAR_MODULUS_XZ_SENSITIVITY );
KRATOS_CREATE_VARIABLE(double, SHEAR_MODULUS_YZ_SENSITIVITY );
...
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(PRESCRIBED_DISPLACEMENT_SENSITIVITY);
