...
KRATOS_CREATE_VARIABLE(Vector, ADJOINT_ES_STRAIN_VECTOR)
KRATOS_CREATE_VARIABLE(Vector, ADJOINT_GL_STRAIN_VECTOR)
KRATOS_CREATE_VARIABLE(Vector, ADJOINT_EA_STRAIN_VECTOR)
KRATOS_CREATE_VARIABLE(Vector, YOUNG_MODULUS_PSEUDO_PK2_STRESS_VECTOR)
KRATOS_CREATE_VARIABLE(Vector, TRUSS_PRESTRESS_PK2_PSEUDO_PK2_STRESS_VECTOR)
KRATOS_CREATE_VARIABLE(Vector, CROSS_AREA_PSEUDO_PK2_STRESS_VECTOR)
KRATOS_CREATE_VARIABLE(Vector, CROSS_AREA_PSEUDO_CAUCHY_STRESS_VECTOR)
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS( CROSS_AREA_PSEUDO_FORCE );

// Variables for output of sensitivities
KRATOS_CREATE_VARIABLE( double, YOUNG_MODULUS_VARIATIONAL_SENSITIVITY );
KRATOS_CREATE_VARIABLE( double, TRUSS_PRESTRESS_PK2_VARIATIONAL_SENSITIVITY );
KRATOS_CREATE_VARIABLE( double, CROSS_AREA_VARIATIONAL_SENSITIVITY );
