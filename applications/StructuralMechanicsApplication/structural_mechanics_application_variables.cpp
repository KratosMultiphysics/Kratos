...
KRATOS_CREATE_VARIABLE(ConstitutiveLaw::VoigtSizeMatrixType, ELASTICITY_TENSOR)
...
KRATOS_CREATE_VARIABLE(ConstitutiveLaw::VoigtSizeVectorType, HENCKY_STRAIN_VECTOR);
KRATOS_CREATE_VARIABLE(ConstitutiveLaw::DeformationGradientMatrixType, HENCKY_STRAIN_TENSOR);

KRATOS_CREATE_VARIABLE(double, VON_MISES_STRESS)

KRATOS_CREATE_VARIABLE(ConstitutiveLaw::DeformationGradientMatrixType, REFERENCE_DEFORMATION_GRADIENT);
...
KRATOS_CREATE_VARIABLE( ConstitutiveLaw::VoigtSizeVectorType, STRESS_ON_GP );
KRATOS_CREATE_VARIABLE( ConstitutiveLaw::VoigtSizeVectorType, STRESS_ON_NODE );
