...
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS( ADJOINT_DIRECTED_STRAIN );
...
KRATOS_CREATE_VARIABLE(double, I22_SENSITIVITY_ANALYTIC );
...
KRATOS_CREATE_VARIABLE(double, CROSS_AREA_SENSITIVITY_ANALYTIC );
KRATOS_CREATE_VARIABLE(bool, IS_ADJOINT );
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS( CROSS_AREA_PSEUDO_FORCE );
KRATOS_CREATE_VARIABLE(double,  I22_PSEUDO_LOAD );
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS( I22_PSEUDO_MOMENT );
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS( BEAM_BENDING_MODES );
KRATOS_CREATE_VARIABLE(double, YOUNG_MODULUS_SENSITIVITY_ANALYTIC );
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS( YOUNG_MODULUS_PSEUDO_MOMENT );
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS( YOUNG_MODULUS_PSEUDO_FORCE );
KRATOS_CREATE_VARIABLE(Matrix, SHELL_PSEUDO_STRESSES);
