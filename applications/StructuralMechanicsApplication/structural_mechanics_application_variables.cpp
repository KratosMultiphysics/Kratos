...
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS( EIGENVECTOR_DERIVATIVE_DISPLACEMENT )
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS( EIGENVECTOR_DERIVATIVE_ROTATION )
