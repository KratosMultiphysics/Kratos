...
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(DISPLACEMENT_NL1_SENSITIVITY)
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(DISPLACEMENT_NL2_SENSITIVITY)
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(FORCE_NL1_SENSITIVITY)
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(FORCE_NL2_SENSITIVITY)
KRATOS_CREATE_VARIABLE(Matrix, SHELL_MOMENT_GLOBAL_NL1_SENSITIVITY)
KRATOS_CREATE_VARIABLE(Matrix, SHELL_MOMENT_GLOBAL_NL2_SENSITIVITY)
KRATOS_CREATE_VARIABLE(double, VON_MISES_STRESS_NL1_SENSITIVITY)
KRATOS_CREATE_VARIABLE(double, VON_MISES_STRESS_NL2_SENSITIVITY)
KRATOS_CREATE_VARIABLE(Vector, PK2_STRESS_VECTOR_NL1_SENSITIVITY);
KRATOS_CREATE_VARIABLE(Vector, PK2_STRESS_VECTOR_NL2_SENSITIVITY);
KRATOS_CREATE_VARIABLE(Vector, PRINCIPAL_PK2_STRESS_VECTOR_NL1_SENSITIVITY);
KRATOS_CREATE_VARIABLE(Vector, PRINCIPAL_PK2_STRESS_VECTOR_NL2_SENSITIVITY);
