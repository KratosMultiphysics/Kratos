...
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS( FORCE_SENSITIVITY );
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS( MOMENT_SENSITIVITY );
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS( DISPLACEMENT_SENSITIVITY );
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS( ROTATION_SENSITIVITY );
...
KRATOS_CREATE_VARIABLE(Matrix, SHELL_FORCE_GLOBAL_SENSITIVITY)
KRATOS_CREATE_VARIABLE(Matrix, SHELL_MOMENT_GLOBAL_SENSITIVITY)
