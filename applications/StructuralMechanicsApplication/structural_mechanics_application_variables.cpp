...
KRATOS_CREATE_VARIABLE(int, NUMBER_FIBERS_Y)
KRATOS_CREATE_VARIABLE(int, NUMBER_FIBERS_Z)
...
KRATOS_CREATE_VARIABLE(double, CONCRETE_CONFINEMENT_FACTOR)
KRATOS_CREATE_VARIABLE(double, CONCRETE_SOFTENING_SLOPE)
