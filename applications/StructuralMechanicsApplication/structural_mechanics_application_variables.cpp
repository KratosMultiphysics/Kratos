...
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS( ADJOINT_PARTICULAR_CURVATURE );
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS( ADJOINT_PARTICULAR_STRAIN );
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS( ADJOINT_WORK_FORCE_CONTRIBUTION );
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS( ADJOINT_WORK_MOMENT_CONTRIBUTION );
...
KRATOS_CREATE_VARIABLE(double, SECTION_HEIGTH_SENSITIVITY );
KRATOS_CREATE_VARIABLE(double, SECTION_WIDTH_SENSITIVITY );
KRATOS_CREATE_VARIABLE(double, SECTION_HEIGTH );
...
KRATOS_CREATE_VARIABLE( double, TORSIONAL_INERTIA_SENSITIVITY );
...
KRATOS_CREATE_VARIABLE( double, VARIATIONAL_SENSITIVITY );
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS( PSEUDO_FORCE );
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS( PSEUDO_MOMENT );
KRATOS_CREATE_VARIABLE(double, YOUNG_MODULUS_DERIVED );
KRATOS_CREATE_VARIABLE(double, CROSS_AREA_DERIVED );
KRATOS_CREATE_VARIABLE(double, I22_DERIVED );
KRATOS_CREATE_VARIABLE(double, I33_DERIVED );
KRATOS_CREATE_VARIABLE(double, AREA_EFFECTIVE_Y_DERIVED);
KRATOS_CREATE_VARIABLE(double, AREA_EFFECTIVE_Z_DERIVED);
KRATOS_CREATE_VARIABLE(double, TORSIONAL_INERTIA_DERIVED);
KRATOS_CREATE_VARIABLE(double, POISSON_RATIO_DERIVED);
KRATOS_CREATE_VARIABLE(double, DENSITY_DERIVED );
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS( RESPONSE_PREFACTOR_MOMENT_DERIVED );
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS( RESPONSE_PREFACTOR_FORCE_DERIVED );
KRATOS_CREATE_VARIABLE(GeneralizedInfluenceFunctionsExtension::Pointer, INFLUENCE_FUNCTIONS_EXTENSIONS)
