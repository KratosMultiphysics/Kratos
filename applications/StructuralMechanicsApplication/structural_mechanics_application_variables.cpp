...
KRATOS_CREATE_VARIABLE(Vector, SEMI_RIGID_NODE_IDS)
KRATOS_CREATE_VARIABLE(Vector, SEMI_RIGID_ROTATIONAL_STIFFNESS_VECTOR_AXIS_2)
KRATOS_CREATE_VARIABLE(Vector, SEMI_RIGID_ROTATIONAL_STIFFNESS_VECTOR_AXIS_3)
