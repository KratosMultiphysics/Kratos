...
KRATOS_CREATE_VARIABLE(Matrix, SECANT_CONSTITUTIVE_MATRIX)
...
KRATOS_CREATE_SYMMETRIC_3D_TENSOR_VARIABLE_WITH_COMPONENTS(NODAL_STRAIN_VECTOR)
KRATOS_CREATE_SYMMETRIC_3D_TENSOR_VARIABLE_WITH_COMPONENTS(REACTION_NODAL_STRAIN_VECTOR)
