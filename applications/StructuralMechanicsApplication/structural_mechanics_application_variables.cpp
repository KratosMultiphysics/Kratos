...
KRATOS_CREATE_VARIABLE(Vector, QUATERNION_VECTOR)
KRATOS_CREATE_VARIABLE(Vector, QUATERNION_SCALAR_VECTOR)

//Total nodal variables
KRATOS_CREATE_VARIABLE(Vector, TOTAL_NODAL_DEFORMATION)
