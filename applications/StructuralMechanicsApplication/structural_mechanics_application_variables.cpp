...
KRATOS_CREATE_VARIABLE(double, EULER_ANGLE_PHI)
KRATOS_CREATE_VARIABLE(double, EULER_ANGLE_THETA)
KRATOS_CREATE_VARIABLE(double, EULER_ANGLE_HI)
...
KRATOS_CREATE_VARIABLE( double, ISOTROPIC_ANISOTROPIC_YIELD_RATIO_X );
KRATOS_CREATE_VARIABLE( double, ISOTROPIC_ANISOTROPIC_YIELD_RATIO_Y );
KRATOS_CREATE_VARIABLE( double, ISOTROPIC_ANISOTROPIC_YIELD_RATIO_Z );
KRATOS_CREATE_VARIABLE( double, ISOTROPIC_ANISOTROPIC_YIELD_RATIO_XY );
KRATOS_CREATE_VARIABLE( double, ISOTROPIC_ANISOTROPIC_YIELD_RATIO_XZ );
KRATOS_CREATE_VARIABLE( double, ISOTROPIC_ANISOTROPIC_YIELD_RATIO_YZ );
