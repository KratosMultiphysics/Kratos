...
KRATOS_CREATE_VARIABLE(std::string, CROSS_SECTION_TYPE)
KRATOS_CREATE_VARIABLE(double, DIM1)
KRATOS_CREATE_VARIABLE(double, DIM2)
KRATOS_CREATE_VARIABLE(double, DIM3)
KRATOS_CREATE_VARIABLE(double, DIM4)
KRATOS_CREATE_VARIABLE(double, DIM5)
KRATOS_CREATE_VARIABLE(double, DIM6)
KRATOS_CREATE_VARIABLE(double, DIM7)
KRATOS_CREATE_VARIABLE(double, DIM8)
KRATOS_CREATE_VARIABLE(double, DIM9)
KRATOS_CREATE_VARIABLE(double, DIM10)
...
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(POINT_LOAD_IMAGINARY)
...
KRATOS_CREATE_VARIABLE(std::string, MOTION_TYPE)
