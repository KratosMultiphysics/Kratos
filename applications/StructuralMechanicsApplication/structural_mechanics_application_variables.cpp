...
KRATOS_CREATE_VARIABLE(double, SHEAR_FORCE_Y)
KRATOS_CREATE_VARIABLE(double, SHEAR_FORCE_Z)
KRATOS_CREATE_VARIABLE(double, BENDING_MOMENT_X)
KRATOS_CREATE_VARIABLE(double, BENDING_MOMENT_Y)
KRATOS_CREATE_VARIABLE(double, BENDING_MOMENT_Z)
KRATOS_CREATE_VARIABLE(double, SHEAR_STRAIN_Y)
KRATOS_CREATE_VARIABLE(double, SHEAR_STRAIN_Z)
KRATOS_CREATE_VARIABLE(double, BENDING_STRAIN_X)
KRATOS_CREATE_VARIABLE(double, BENDING_STRAIN_Y)
KRATOS_CREATE_VARIABLE(double, BENDING_STRAIN_Z)
...
KRATOS_CREATE_SYMMETRIC_3D_TENSOR_VARIABLE_WITH_COMPONENTS(REACTION_STRAIN_VECTOR)
...
KRATOS_CREATE_VARIABLE(double, TEMPERATURE_SENSITIVITY );
KRATOS_CREATE_VARIABLE(double, PRESSURE_SENSITIVITY );
KRATOS_CREATE_VARIABLE(double, TRUSS_PRESTRESS_PK2_SENSITIVITY );
KRATOS_CREATE_SYMMETRIC_2D_TENSOR_VARIABLE_WITH_COMPONENTS(PRE_STRESS);
KRATOS_CREATE_SYMMETRIC_2D_TENSOR_VARIABLE_WITH_COMPONENTS(PRE_STRESS_SENSITIVITY);
...
//KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS( PRESTRESS_VECTOR_SENSITIVITY );
