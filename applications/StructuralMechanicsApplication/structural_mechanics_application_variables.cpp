...
//ROCO NET
KRATOS_CREATE_VARIABLE(double, KB_RING)
KRATOS_CREATE_VARIABLE(double, DIAMETER_RING)
KRATOS_CREATE_VARIABLE(double, WIRE_THICKNESS_RING)
KRATOS_CREATE_VARIABLE(int, WIRE_WINDINGS_RING)
KRATOS_CREATE_VARIABLE(double, NODAL_MASS_RING)
KRATOS_CREATE_VARIABLE(double, KT_RING)
