...
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(ANGULAR_ADJOINT_VECTOR_2)
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(ANGULAR_ADJOINT_VECTOR_3)
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(ANGULAR_AUX_ADJOINT_VECTOR_1)
...
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(BOSSAK_ACCELERATION);
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(ANGULAR_BOSSAK_ACCELERATION);
