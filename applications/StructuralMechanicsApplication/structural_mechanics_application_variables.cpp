...
KRATOS_CREATE_VARIABLE(double, SCALING_TRANSLATION_MASS)
KRATOS_CREATE_VARIABLE(double, SCALING_ROTATION_MASS)
KRATOS_CREATE_VARIABLE(bool, STABILIZED_CONTROL_POINT)
