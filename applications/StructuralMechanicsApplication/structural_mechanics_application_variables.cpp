...
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(DISPLACEMENT_NL_SENSITIVITY)
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(DISPLACEMENT_NL_SENSITIVITY_FIRST_ORDER)
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(DISPLACEMENT_NL_SENSITIVITY_SECOND_ORDER)
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(FORCE_NL_SENSITIVITY)
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(FORCE_NL_SENSITIVITY_FIRST_ORDER)
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(FORCE_NL_SENSITIVITY_SECOND_ORDER)
KRATOS_CREATE_VARIABLE(Matrix, SHELL_MOMENT_GLOBAL_NL_SENSITIVITY)
KRATOS_CREATE_VARIABLE(Matrix, SHELL_MOMENT_GLOBAL_NL_SENSITIVITY_FIRST_ORDER)
KRATOS_CREATE_VARIABLE(Matrix, SHELL_MOMENT_GLOBAL_NL_SENSITIVITY_SECOND_ORDER)
KRATOS_CREATE_VARIABLE(double, VON_MISES_STRESS_NL_SENSITIVITY)
KRATOS_CREATE_VARIABLE(double, VON_MISES_STRESS_NL_SENSITIVITY_FIRST_ORDER)
KRATOS_CREATE_VARIABLE(double, VON_MISES_STRESS_NL_SENSITIVITY_SECOND_ORDER)
