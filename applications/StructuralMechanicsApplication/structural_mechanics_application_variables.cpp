...
KRATOS_CREATE_VARIABLE(double, INITIAL_PRESTRESS)
...
//for hydrostatic application
KRATOS_CREATE_VARIABLE(double, SPECIFIC_WEIGHT)      //nav
KRATOS_CREATE_VARIABLE(double, FREE_SURFACE_AREA)    //nav
KRATOS_CREATE_VARIABLE(double, CURRENT_FLUID_VOLUME) //nav
KRATOS_CREATE_VARIABLE(double, FREE_SURFACE_RADIUS)  //nav
KRATOS_CREATE_VARIABLE(double, FLUID_VOLUME)         //nav
KRATOS_CREATE_VARIABLE(Vector, FREE_SURFACE_NORMAL)  //nav
KRATOS_CREATE_VARIABLE(Vector, FREE_SURFACE_CENTRE)  //nav
KRATOS_CREATE_VARIABLE(WeakPointerVector<Condition>, MASTER_CONDITIONS) //nav
KRATOS_CREATE_VARIABLE(WeakPointerVector<Node<3>>, MASTER_NODES) //nav
KRATOS_CREATE_VARIABLE(std::string, WET_MODEL_PART) //nav
KRATOS_CREATE_VARIABLE(bool, USE_HYDROSTATIC_MATRIX) //nav
KRATOS_CREATE_VARIABLE(bool, ADD_RHS_FOR_RANK_ONE_UPDATE) //nav
KRATOS_CREATE_VARIABLE(bool, DO_UPDATE_FROM_DEL_VOL) //nav
...
KRATOS_CREATE_VARIABLE(double, PRINCIPAL_STRESS_3)
