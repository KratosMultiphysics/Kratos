...
KRATOS_CREATE_VARIABLE(double, CHARACTERISTIC_INTERNAL_LENGTH)
...
// non_local variable
KRATOS_CREATE_VARIABLE(double, NON_LOCAL_VARIABLE );
KRATOS_CREATE_VARIABLE(std::string, NON_LOCAL_VARIABLE_NAME );
KRATOS_CREATE_VARIABLE(std::string, EQUIVALENCE_PRINCIPLE_TYPE );
KRATOS_CREATE_VARIABLE(double, NON_LOCAL_EQUIVALENT_STRAIN_TENSION );
KRATOS_CREATE_VARIABLE(double, NON_LOCAL_EQUIVALENT_STRAIN_COMPRESSION );
}
