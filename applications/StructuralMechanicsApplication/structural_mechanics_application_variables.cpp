...
KRATOS_CREATE_VARIABLE(double, ELASTIC_UNIAXIAL_STRENGTH_TENSION)
KRATOS_CREATE_VARIABLE(double, ELASTIC_UNIAXIAL_STRENGTH_COMPRESSION)
KRATOS_CREATE_VARIABLE(double, ELASTIC_BIAXIAL_STRENGTH_COMPRESSION)
KRATOS_CREATE_VARIABLE(double, PLASTIC_STRAIN_RATE_BETA)
...
KRATOS_CREATE_VARIABLE(double, STRAIN_REFERENCE)
