...
KRATOS_CREATE_VARIABLE(int, SHELL_SHEAR_FORMULATION)
KRATOS_CREATE_VARIABLE(double, SHELL_DRILLING_STIFFNESS_MULTIPLIER)
KRATOS_CREATE_VARIABLE(Vector, SBM_CONSTRAINED_DOFS)
KRATOS_CREATE_VARIABLE(int, SBM_FORMULATION_TYPE)
