...
KRATOS_CREATE_VARIABLE(Vector, BEAM_INITIAL_INTERNAL_FORCES)
...
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS( SURFACE_LOAD_SENSITIVITY );
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS( SURFACE_LOAD_SENSITIVITY_INCREMENT );
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS( ADJOINT_DISPLACEMENT_INCREMENT );
KRATOS_CREATE_VARIABLE(double, PRESSURE_SENSITIVITY );
KRATOS_CREATE_VARIABLE(double, POSITIVE_FACE_PRESSURE_SENSITIVITY );
KRATOS_CREATE_VARIABLE(double, NEGATIVE_FACE_PRESSURE_SENSITIVITY );
...
KRATOS_CREATE_VARIABLE(double, YOUNG_MODULUS_VAR_SENSITIVITY );
KRATOS_CREATE_VARIABLE(double, YOUNG_MODULUS_PARTIAL_SENSITIVITY );
KRATOS_CREATE_VARIABLE(double, ISOTROPIC_PRESTRESS_VAR_SENSITIVITY );
KRATOS_CREATE_VARIABLE(double, ISOTROPIC_PRESTRESS_PARTIAL_SENSITIVITY );
KRATOS_CREATE_VARIABLE(double, POISSON_RATIO_VAR_SENSITIVITY );
KRATOS_CREATE_VARIABLE(double, POISSON_RATIO_PARTIAL_SENSITIVITY );
KRATOS_CREATE_VARIABLE(double, YOUNG_MODULUS_X_SENSITIVITY );
KRATOS_CREATE_VARIABLE(double, YOUNG_MODULUS_Y_SENSITIVITY );
...
KRATOS_CREATE_VARIABLE( double, TRUSS_PRESTRESS_PK2_SENSITIVITY );
KRATOS_CREATE_VARIABLE(double, PRESTRESS_VECTOR_X_SENSITIVITY );
KRATOS_CREATE_VARIABLE(double, PRESTRESS_VECTOR_Y_SENSITIVITY );
KRATOS_CREATE_VARIABLE(double, PRESTRESS_VECTOR_ISOTROPIC_XY_SENSITIVITY );
KRATOS_CREATE_VARIABLE(double, SHEAR_MODULUS_XY_SENSITIVITY );
KRATOS_CREATE_VARIABLE(double, POISSON_RATIO_XY_SENSITIVITY );
KRATOS_CREATE_VARIABLE(double, POISSON_RATIO_SENSITIVITY );
KRATOS_CREATE_VARIABLE(double, YIELD_STRESS_SENSITIVITY );
...
KRATOS_CREATE_VARIABLE( Matrix, GREEN_LAGRANGE_STRAIN_DERIVATIVE_MATRIX );
KRATOS_CREATE_VARIABLE( Vector, ADJOINT_GREEN_LAGRANGE_STRAIN_VECTOR );
KRATOS_CREATE_VARIABLE( Vector, YOUNG_MODULUS_PSEUDO_NORMAL_FORCE_VECTOR );
KRATOS_CREATE_VARIABLE( Vector, POISSON_RATIO_PSEUDO_NORMAL_FORCE_VECTOR );
KRATOS_CREATE_VARIABLE( Vector, ISOTROPIC_PRESTRESS_PSEUDO_NORMAL_FORCE_VECTOR );
