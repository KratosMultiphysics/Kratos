...
class ImposeRigidMovementProcess(KratosMultiphysics.Process):
    ...
    def __init__(self, Model, settings ):
        ...
        rigid_parameters.AddValue("slave_node_id", settings["slave_node_id"])
        self.rigid_movement_process = StructuralMechanicsApplication.ImposeRBE3RigidMovementProcess(self.main_model_part, rigid_parameters)
