...
class CheckAndPrepareModelProcess(KratosMultiphysics.Process):
    ...
    def Execute(self):
        ...
        #temporarily we call it "structural_computational_model_part"
        self.main_model_part.CreateSubModelPart("structural_computational_model_part")
        structural_computational_model_part = self.main_model_part.GetSubModelPart("structural_computational_model_part")
