...
# ==============================================================================
class StrainEnergyResponseFunctionCustomAnalysis(ResponseFunctionBase):
    """ CUSTOM ANALYSIS
    ...
    def __init__(self, identifier, response_settings, model, analysis):
        ...
        self.primal_analysis = analysis(model, ProjectParametersPrimal)
