...
class StructuralMechanicsAdjointStaticSolver(MechanicalSolver):
    ...
    def AddVariables(self):
        ...
        self.main_model_part.AddNodalSolutionStepVariable(StructuralMechanicsApplication.PRESCRIBED_DISPLACEMENT_SENSITIVITY)
        ...
        replacement_settings = KratosMultiphysics.Parameters("""
            {
                "element_name_table" :
                {
                    ...
                    "ShellThickElement3D4N"          : "AdjointFiniteDifferencingShellThickElement3D4N",
