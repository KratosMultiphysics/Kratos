...
class StructuralMechanicsAdjointStaticSolver(MechanicalSolver):
    ...
    def Initialize(self):
        ...
        if response_type == "adjoint_local_stress":
            ...
            self.response_function = StructuralMechanicsApplication.AdjointNodalDisplacementAggregationResponseFunction(self.main_model_part, self.settings["response_function_settings"])
        else:
