...
class StructuralMechanicsAdjointStaticSolver(MechanicalSolver):
    ...
    def PrepareModelPart(self):
        ...
        if not (process_info.Has(StructuralMechanicsApplication.IS_ADJOINT) and
            process_info.GetValue(StructuralMechanicsApplication.IS_ADJOINT)):
            # Currently, disabled this error to allow multiple adjoint model parts i.e., combined responses
            # TODO: Find a better way during adjoint redesign
