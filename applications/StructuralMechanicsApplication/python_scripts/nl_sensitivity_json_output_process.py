...
def Factory(settings, Model):
    ...
    return NlSensitivityJsonOutputProcess(Model, settings["Parameters"])

# All the processes python processes should be derived from "Process"

class NlSensitivityJsonOutputProcess(KratosMultiphysics.Process):
