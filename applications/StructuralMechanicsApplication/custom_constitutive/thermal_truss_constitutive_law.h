...
/**
 * @namespace ThermalTrussConstitutiveLaw
 *
...
class KRATOS_API(STRUCTURAL_MECHANICS_APPLICATION) ThermalTrussConstitutiveLaw : public ConstitutiveLaw
{
public:
    /**
     * Type Definitions
    ...
    /**
     * Counted pointer of ThermalTrussConstitutiveLaw
     */

    KRATOS_CLASS_POINTER_DEFINITION( ThermalTrussConstitutiveLaw );
     ...
     * Copy constructor.
     */
    ThermalTrussConstitutiveLaw (const ThermalTrussConstitutiveLaw& rOther);


    /**
     * Destructor.
     */
    ~ThermalTrussConstitutiveLaw() override;
...
}; // Class ThermalTrussConstitutiveLaw
}  // namespace Kratos.
