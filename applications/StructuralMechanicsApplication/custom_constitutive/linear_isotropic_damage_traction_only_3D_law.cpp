...
LinearIsotropicDamageTractionOnly3D::LinearIsotropicDamageTractionOnly3D(const LinearIsotropicDamageTractionOnly3D &rOther)
...
bool LinearIsotropicDamageTractionOnly3D::Has(const Variable<bool>& rThisVariable)
{
...
bool& LinearIsotropicDamageTractionOnly3D::GetValue(
...
void LinearIsotropicDamageTractionOnly3D::InitializeMaterial(
...
void LinearIsotropicDamageTractionOnly3D::InitializeMaterialResponseCauchy(ConstitutiveLaw::Parameters& rValues)
{
}
...
void LinearIsotropicDamageTractionOnly3D::InitializeMaterialResponsePK1(ConstitutiveLaw::Parameters& rValues)
{
...
void LinearIsotropicDamageTractionOnly3D::InitializeMaterialResponsePK2(ConstitutiveLaw::Parameters& rValues)
{
    // In small deformation is the same as compute Cauchy
    InitializeMaterialResponseCauchy(rValues);
}
...
void LinearIsotropicDamageTractionOnly3D::InitializeMaterialResponseKirchhoff(ConstitutiveLaw::Parameters& rValues)
{
    // In small deformation is the same as compute Cauchy
    InitializeMaterialResponseCauchy(rValues);
}
...
void LinearIsotropicDamageTractionOnly3D::FinalizeMaterialResponseCauchy(Parameters& rValues)
{
...
void LinearIsotropicDamageTractionOnly3D::FinalizeMaterialResponsePK1(Parameters& rValues)
{
    // In small deformation is the same as compute Cauchy
...
void LinearIsotropicDamageTractionOnly3D::FinalizeMaterialResponsePK2(Parameters& rValues)
{
    // In small deformation is the same as compute Cauchy
    FinalizeMaterialResponseCauchy(rValues);
}
...
void LinearIsotropicDamageTractionOnly3D::FinalizeMaterialResponseKirchhoff(Parameters& rValues)
{
    // In small deformation is the same as compute Cauchy
    FinalizeMaterialResponseCauchy(rValues);
}
...
void LinearIsotropicDamageTractionOnly3D::CalculateMaterialResponsePK1(Parameters& rValues)
{
...
void LinearIsotropicDamageTractionOnly3D::CalculateMaterialResponsePK2(Parameters& rValues)
{
    CalculateMaterialResponseCauchy(rValues);
}
...
void LinearIsotropicDamageTractionOnly3D::CalculateMaterialResponseKirchhoff(Parameters& rValues)
{
    CalculateMaterialResponseCauchy(rValues);
}
...
void LinearIsotropicDamageTractionOnly3D::CalculateMaterialResponseCauchy(Parameters& rValues)
{
    double strain_variable;
    this->CalculateStressResponse(rValues, strain_variable);
}
...
void LinearIsotropicDamageTractionOnly3D::CalculateStressResponse(
    Parameters& rValues,
...
double& LinearIsotropicDamageTractionOnly3D::CalculateValue(
    Parameters& rValues,
...
double LinearIsotropicDamageTractionOnly3D::EvaluateHardeningLaw(
...
void LinearIsotropicDamageTractionOnly3D::CalculateElasticMatrix(
...
void LinearIsotropicDamageTractionOnly3D::GetLawFeatures(Features& rFeatures)
{
...
int LinearIsotropicDamageTractionOnly3D::Check(
    const Properties& rMaterialProperties,
    const GeometryType& rElementGeometry,
