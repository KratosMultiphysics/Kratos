...
#if !defined (KRATOS_ELASTIC_ISOTROPIC_FRACTURE_3D_LAW_H_INCLUDED)
#define  KRATOS_ELASTIC_ISOTROPIC_FRACTURE_3D_LAW_H_INCLUDED
 ...
 * @brief This class defines a small deformation linear elastic constitutive model with phase-field-based fracture modelling for 3D cases
 * @details This class derives from the base constitutive law
 * @author Reza Najian Asl
 * @author Shahed Rezaei
 */
class KRATOS_API(STRUCTURAL_MECHANICS_APPLICATION) ElasticIsotropicFracture3D
...
public:
    ...
    /// Counted pointer of ElasticIsotropicFracture3D
    KRATOS_CLASS_POINTER_DEFINITION( ElasticIsotropicFracture3D );
     ...
     * Copy constructor.
     */
    ElasticIsotropicFracture3D (const ElasticIsotropicFracture3D& rOther);

    /**
     * @brief Destructor.
     */
    ~ElasticIsotropicFracture3D() override;
...
}; // Class ElasticIsotropicFracture3D
}  // namespace Kratos.
#endif // KRATOS_ELASTIC_ISOTROPIC_FRACTURE_3D_LAW_H_INCLUDED  defined
