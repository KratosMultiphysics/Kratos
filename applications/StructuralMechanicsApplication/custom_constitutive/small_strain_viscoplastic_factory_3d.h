...
#if !defined (KRATOS_SMALL_STRAIN_VISCOPLASTIC_FACTORY_3D_H_INCLUDED)
#define  KRATOS_SMALL_STRAIN_VISCOPLASTIC_FACTORY_3D_H_INCLUDED
...
#include "custom_constitutive/generic_small_strain_viscoplastic_3d.h"
