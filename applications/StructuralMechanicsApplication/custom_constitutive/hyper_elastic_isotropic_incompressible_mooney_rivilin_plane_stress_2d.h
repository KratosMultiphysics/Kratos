...
#if !defined (KRATOS_HYPER_ELASTIC_ISOTROPIC_INCOMPRESSIBLE_PLANE_STRESS_LAW_H_INCLUDED)
#define  KRATOS_HYPER_ELASTIC_ISOTROPIC_INCOMPRESSIBLE_PLANE_STRESS_LAW_H_INCLUDED
...
///@{
/**
 * @class HyperElasticIsotropicIncompressibleMooneyRivlinPlaneStress2D
 ...
 */
class KRATOS_API(STRUCTURAL_MECHANICS_APPLICATION) HyperElasticIsotropicIncompressibleMooneyRivlinPlaneStress2D
...
public:
    ...
    /// Pointer definition of HyperElasticIsotropicIncompressibleMooneyRivlinPlaneStress2D
    KRATOS_CLASS_POINTER_DEFINITION( HyperElasticIsotropicIncompressibleMooneyRivlinPlaneStress2D );
     ...
     */
    HyperElasticIsotropicIncompressibleMooneyRivlinPlaneStress2D();

    /**
     * @brief Copy constructor.
     */
    HyperElasticIsotropicIncompressibleMooneyRivlinPlaneStress2D (const HyperElasticIsotropicIncompressibleMooneyRivlinPlaneStress2D& rOther);

    /**
     * @brief Destructor.
     */
    ~HyperElasticIsotropicIncompressibleMooneyRivlinPlaneStress2D() override;
...
private:
     ...
     * @param c01 Second Lame parameter
     */
