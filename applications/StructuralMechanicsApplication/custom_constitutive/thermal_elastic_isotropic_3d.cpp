...
ThermalElasticIsotropic3D::ThermalElasticIsotropic3D()
    : ElasticIsotropic3D()
{
}
...
ConstitutiveLaw::Pointer ThermalElasticIsotropic3D::Clone() const
{
...
{
    ConstitutiveLawUtilities<6>::SubstractThermalStrain(rStrainVector, ReferenceTemperature, rParameters);
}
