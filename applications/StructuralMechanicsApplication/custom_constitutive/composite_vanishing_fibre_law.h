...
#if !defined (KRATOS_COMPOSITE_VANISHING_FIBRE_LAW_H_INCLUDED)  // COMPOSITE_VANISHING_FIBRE_LAW
#define  KRATOS_COMPOSITE_VANISHING_FIBRE_LAW_H_INCLUDED
...
///@{
/**
 * @class CompositeVanishingFibreLaw
 * @ingroup StructuralMechanicsApplication
 * @brief This law defines the Vanishing Fibre Diametre Composite model (fiber contributes only in fibre direction)
 * @details The constitutive law should have defined two subproperties in order to work properly
 * This composite law combines fiber and matrix CLs considering the following principles:
 *  - Both materials have the same strain.
 *  - In fiber direction:
 *    - The total stress is the addition of the stresses in each material multiplied by volume fraction content.
 *    - The constitutive tensor is the addition of the constitutive tensor in each material multiplied by volume fraction content.
 *  - In transversal directions:
 *    - The fiber does not contribute in transversal directions. (Vanishing Fibre Diametre)
 *    - So, the fiber does not contribute to the stresses nor to the constitutive tensor.
 * @author Fernando Rastellini
 * @author Tommaso Tudisco
 */
class KRATOS_API(STRUCTURAL_MECHANICS_APPLICATION) CompositeVanishingFibreLaw
...
public:
    ...
    /// Pointer definition of CompositeVanishingFibreLaw
    KRATOS_CLASS_POINTER_DEFINITION( CompositeVanishingFibreLaw );
     ...
     */
    CompositeVanishingFibreLaw();

    /**
     * @brief Constructor with combination factor values
     * @param rCombinationFactors The list of subproperties combination factors
     */
    CompositeVanishingFibreLaw(const std::vector<double>& rCombinationFactors);

    /**
     * @brief Copy constructor.
     */
    CompositeVanishingFibreLaw (const CompositeVanishingFibreLaw& rOther);

    /**
     * @brief Destructor.
     */
    ~CompositeVanishingFibreLaw() override;
...
#endif // KRATOS_COMPOSITE_VANISHING_FIBRE_LAW_H_INCLUDED  defined
