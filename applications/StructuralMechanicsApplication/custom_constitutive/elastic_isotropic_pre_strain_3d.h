...
#if !defined (KRATOS_ELASTIC_ISOTROPIC_PRE_STRAIN_3D_LAW_H_INCLUDED)
#define  KRATOS_ELASTIC_ISOTROPIC_PRE_STRAIN_3D_LAW_H_INCLUDED
 ...
 */
class KRATOS_API(STRUCTURAL_MECHANICS_APPLICATION) ElasticIsotropicPrestrain3D
...
public:
    ...
    /// Counted pointer of ElasticIsotropicPrestrain3D
    KRATOS_CLASS_POINTER_DEFINITION( ElasticIsotropicPrestrain3D );
     ...
     * Copy constructor.
     */
    ElasticIsotropicPrestrain3D (const ElasticIsotropicPrestrain3D& rOther);

    /**
     * @brief Destructor.
     */
    ~ElasticIsotropicPrestrain3D() override;
...
}; // Class ElasticIsotropicPrestrain3D
}  // namespace Kratos.
