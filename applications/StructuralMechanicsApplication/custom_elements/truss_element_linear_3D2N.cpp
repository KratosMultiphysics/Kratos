...
namespace Kratos
{
	...
	Element::Pointer TrussElementLinear3D2N::Create(IndexType NewId,
	...
	TrussElement3D2N::msLocalSize> TrussElementLinear3D2N::CreateElementStiffnessMatrix(
	...
	void TrussElementLinear3D2N::CalculateLocalSystem(MatrixType& rLeftHandSideMatrix,
	...
	void TrussElementLinear3D2N::AddPrestressLinear(VectorType& rRightHandSideVector)
	{
		KRATOS_TRY;
	...
	void TrussElementLinear3D2N::CalculateRightHandSide(VectorType& rRightHandSideVector,
											ProcessInfo& rCurrentProcessInfo){
	...
	void TrussElementLinear3D2N::CalculateLeftHandSide(MatrixType& rLeftHandSideMatrix,
										ProcessInfo& rCurrentProcessInfo){
	...
	void TrussElementLinear3D2N::WriteTransformationCoordinates(
		bounded_vector<double,TrussElement3D2N::msLocalSize>& rReferenceCoordinates)
	{
		KRATOS_TRY;
