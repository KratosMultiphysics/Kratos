...
#if !defined(KRATOS_BASE_PHASE_FIELD_FRACTURE_SOLID_ELEMENT_H_INCLUDED )
#define  KRATOS_BASE_PHASE_FIELD_FRACTURE_SOLID_ELEMENT_H_INCLUDED
...
/**
 * @class BasePhaseFieldFractureSolidElement
 * @ingroup StructuralMechanicsApplication
 * @brief This is base class used to define the phase field fracture solid elements
 * @details The elements derived from this class are the small displacement element with fracture modelled with phase field method
 * @author Reza Najian Asl
 * @author Shahed Rezaei
 */
class KRATOS_API(STRUCTURAL_MECHANICS_APPLICATION) BasePhaseFieldFractureSolidElement
    : public Element
{
protected:
    /**
    ...
    struct KinematicVariables
    {
            ...
            )
        {
            ...
            PhaseField = ZeroVector(NumberOfNodes);
        }
    };
    ...
    struct ConstitutiveVariables
    {
        ...
        Vector StressVector;
        Matrix D;
        double UndamagedElasticEnergy;
        double MaxUndamagedElasticEnergy;
        ...
        ConstitutiveVariables(const SizeType StrainSize)
        {
            ...
            UndamagedElasticEnergy = 0.0;
            MaxUndamagedElasticEnergy = 0.0;
        }
    };
public:
    ...
    // Counted pointer of BasePhaseFieldFractureSolidElement
    KRATOS_CLASS_INTRUSIVE_POINTER_DEFINITION( BasePhaseFieldFractureSolidElement );
    ...
    // Constructor void
    BasePhaseFieldFractureSolidElement()
    {};

    // Constructor using an array of nodes
    BasePhaseFieldFractureSolidElement( IndexType NewId, GeometryType::Pointer pGeometry ):Element(NewId,pGeometry)
    {};

    // Constructor using an array of nodes with properties
    BasePhaseFieldFractureSolidElement( IndexType NewId, GeometryType::Pointer pGeometry, PropertiesType::Pointer pProperties ):Element(NewId,pGeometry,pProperties)
    {};

    // Copy constructor
    BasePhaseFieldFractureSolidElement(BasePhaseFieldFractureSolidElement const& rOther)
        :BaseType(rOther)
        ,mThisIntegrationMethod(rOther.mThisIntegrationMethod)
    {};

    // Destructor
    ~BasePhaseFieldFractureSolidElement() override
    {};
    ...
    /**
     * @brief Sets on rValues the nodal displacements and phase field
     * @param rValues The values of displacements and phase field
    ...
    /**
     * @brief Sets on rValues the nodal phase field
     * @param rValues The values of phase field
     * @param Step The step to be computed
     */
    void GetPhaseFieldValuesVector(
        Vector& rValues,
        int Step = 0
        ) const;                  
    ...
    std::string Info() const override
    {
        ...
        buffer << "Base Phase Field Fracture Solid Element #" << Id() << "\nConstitutive law: " << mConstitutiveLawVector[0]->Info();
        return buffer.str();
    }
    ...
    {
        rOStream << "Base Phase Field Fracture Solid Element #" << Id() << "\nConstitutive law: " << mConstitutiveLawVector[0]->Info();
    }
...
protected:
    ...
    {
       mHisVarVector[PointNumber] = MaximumStrainEnergy;
    }
...
#endif // KRATOS_BASE_PHASE_FIELD_FRACTURE_SOLID_ELEMENT_H_INCLUDED  defined
