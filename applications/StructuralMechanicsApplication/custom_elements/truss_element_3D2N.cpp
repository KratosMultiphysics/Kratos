...
void TrussElement3D2N::InitializeNonLinearIteration(const ProcessInfo& rCurrentProcessInfo)
{
  KRATOS_TRY;
...
void TrussElement3D2N::FinalizeNonLinearIteration(const ProcessInfo& rCurrentProcessInfo)
{
  KRATOS_TRY;
