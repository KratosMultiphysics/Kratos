...
class ShellThinShiftedBoundaryElement3D3N : public ShellThinElement3D3N<TKinematics>
{
public:
    ///@name Type Definitions
    ///@{

    /// Counted pointer of ShellThinShiftedBoundaryElement3D3N
    KRATOS_CLASS_INTRUSIVE_POINTER_DEFINITION(ShellThinShiftedBoundaryElement3D3N);

    typedef ShellThinElement3D3N<TKinematics> BaseType;
    ...
    ShellThinShiftedBoundaryElement3D3N(
        IndexType NewId,
    ...
    /// Destructor.
    virtual ~ShellThinShiftedBoundaryElement3D3N() = default;

    /// Copy constructor.
    ShellThinShiftedBoundaryElement3D3N(const ShellThinShiftedBoundaryElement3D3N& rOther) = delete;
    ...
    /// Assignment operator.
    ShellThinShiftedBoundaryElement3D3N& operator=(const ShellThinShiftedBoundaryElement3D3N& rOther) = delete;
    ...
    {
        return Kratos::make_intrusive<ShellThinShiftedBoundaryElement3D3N<TKinematics>>(NewId, this->GetGeometry().Create(ThisNodes), pProperties);
    }
    ...
    Element::Pointer Create(
        ...
        typename PropertiesType::Pointer pProperties) const override
    {
        return Kratos::make_intrusive<ShellThinShiftedBoundaryElement3D3N<TKinematics>>(NewId, pGeom, pProperties);
    }
...
protected:
    ...
    ShellThinShiftedBoundaryElement3D3N() : ShellThinElement3D3N<TKinematics>()
    {
    }
...
private:
    ...
    {
        KRATOS_SERIALIZE_SAVE_BASE_CLASS(rSerializer, ShellThinElement3D3N<TKinematics>);
    }

    void load(Serializer& rSerializer) override
    {
        KRATOS_SERIALIZE_LOAD_BASE_CLASS(rSerializer, ShellThinElement3D3N<TKinematics>);
    }
    ...
    ///@}
}; // Class ShellThinShiftedBoundaryElement3D3N
...
/*  inline std::istream& operator >> (std::istream& rIStream,
				    ShellThinShiftedBoundaryElement3D3N& rThis);
*/
/// output stream function
/*  inline std::ostream& operator << (std::ostream& rOStream,
				    const ShellThinShiftedBoundaryElement3D3N& rThis)
    {
