...
#include "shell_thin_shifted_boundary_element_3D3N.hpp"
...
ShellThinShiftedBoundaryElement3D3N<TKinematics>::ShellThinShiftedBoundaryElement3D3N(
    IndexType NewId,
...
template <ShellKinematics TKinematics>
void ShellThinShiftedBoundaryElement3D3N<TKinematics>::CalculateLocalSystem(
...
template <ShellKinematics TKinematics>
void ShellThinShiftedBoundaryElement3D3N<TKinematics>::CalculateLeftHandSide(
    MatrixType& rLeftHandSideMatrix,
    const ProcessInfo& rCurrentProcessInfo)
{
    KRATOS_TRY
...
template <ShellKinematics TKinematics>
void ShellThinShiftedBoundaryElement3D3N<TKinematics>::CalculateRightHandSide(
    VectorType& rRightHandSideVector,
    const ProcessInfo& rCurrentProcessInfo)
{
    KRATOS_TRY
...
template <ShellKinematics TKinematics>
void ShellThinShiftedBoundaryElement3D3N<TKinematics>::CalculateKinematicVariables(
...
template <ShellKinematics TKinematics>
int ShellThinShiftedBoundaryElement3D3N<TKinematics>::Check(const ProcessInfo& rCurrentProcessInfo) const
{
    ...
    //     "ShellThinShiftedBoundaryElement3D3N only supports simplicial geometries (linear triangles and tetrahedra)." << std::endl;
...
template <ShellKinematics TKinematics>
std::vector<std::size_t> ShellThinShiftedBoundaryElement3D3N<TKinematics>::GetSurrogateFacesIds()
{
...
template <ShellKinematics TKinematics>
void ShellThinShiftedBoundaryElement3D3N<TKinematics>::CalculateCauchyTractionVector(
...
template <ShellKinematics TKinematics>
void ShellThinShiftedBoundaryElement3D3N<TKinematics>::CalculateCBProjectionLinearisation(
    const Matrix& rC,
...
template class ShellThinShiftedBoundaryElement3D3N<ShellKinematics::LINEAR>;
template class ShellThinShiftedBoundaryElement3D3N<ShellKinematics::NONLINEAR_COROTATIONAL>;
