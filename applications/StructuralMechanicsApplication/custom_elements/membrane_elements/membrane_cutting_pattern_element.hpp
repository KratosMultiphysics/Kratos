...
namespace Kratos
{
  ...
  class KRATOS_API(STRUCTURAL_MECHANICS_APPLICATION) MembraneCuttingPatternElement
    : public Element
  {
  public:

    // Counted pointer of MembraneCuttingPatternElement
    KRATOS_CLASS_INTRUSIVE_POINTER_DEFINITION(MembraneCuttingPatternElement);

    // Constructor using an array of nodes
    MembraneCuttingPatternElement(IndexType NewId, GeometryType::Pointer pGeometry);

    // Constructor using an array of nodes with properties
    MembraneCuttingPatternElement(IndexType NewId, GeometryType::Pointer pGeometry, PropertiesType::Pointer pProperties);

    // Destructor
    ~MembraneCuttingPatternElement() = default;
  ...
  };	// class MembraneCuttingPatternElement.
