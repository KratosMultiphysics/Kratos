...
//************************************************************************************
                                                                       ...
                                                                       const ProcessInfo& rCurrentProcessInfo)
    {
        ...
        if (rVariable == REDUCED_MODES_MATRIX)
        {
                 ...
                 point_number < mConstitutiveLawVector.size(); point_number++)
            {
                ...
                CalculateKinematicVariablesBbar(this_kinematic_variables, point_number,
                                            integration_points);
        ...
        else if ( rVariable == CONSTITUTIVE_MATRIX )
        {
            ...
            for ( unsigned int point_number = 0; point_number < mConstitutiveLawVector.size(); point_number++ )
            {
                ...
                CalculateConstitutiveVariables(this_kinematic_variables, this_constitutive_variables,
                                               ...
                                               GetStressMeasure(), displacements);
    ...
    void SmallDisplacementBbar::CalculateOnIntegrationPoints(const Variable<double>& rVariable,
        ...
        else if ( rVariable == CAUCHY_STRESS_VECTOR || rVariable == PK2_STRESS_VECTOR )
        {
            ...
            for ( unsigned int point_number = 0; point_number < integration_points.size(); point_number++ )
            {
                ...
                if( rVariable == CAUCHY_STRESS_VECTOR)
                {
                    ...
                    CalculateConstitutiveVariables(this_kinematic_variables, this_constitutive_variables,
                                                   Values, point_number, integration_points,
                                                   ConstitutiveLaw::StressMeasure_Cauchy, displacements);
                }
                else
                {
                    // Compute material reponse
                    CalculateConstitutiveVariables(this_kinematic_variables, this_constitutive_variables,
                                                   Values, point_number, integration_points,
                                                   ConstitutiveLaw::StressMeasure_PK2, displacements);
                }
...
//************************************************************************************
    ...
    )
    {
        ...
        rThisKinematicVariables.detJ0 = CalculateDerivativesOnReferenceConfiguration(rThisKinematicVariables.J0,
                                                                                     rThisKinematicVariables.InvJ0,
                                                                                     rThisKinematicVariables.DN_DX,
                                                                                     PointNumber, GetGeometry().GetDefaultIntegrationMethod());
...
//************************************************************************************
    ...
    )
    {
        ...
        // Compute Bbar
        CalculateMatrixBbar( rThisKinematicVariables.B, rThisKinematicVariables.Bh, rThisKinematicVariables.DN_DX, IntegrationPoints, PointNumber );

    }

//************************************************************************************
//************************************************************************************
    void SmallDisplacementBbar::CalculateMatrixBbar(Matrix& rB,
            Vector& rBh,
