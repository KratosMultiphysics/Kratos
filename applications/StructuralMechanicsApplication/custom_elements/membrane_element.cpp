...

{
    ...
    SizeType DFZintIndex = 2;   // z-row index from DFintDU
    SizeType rowIndex = 0;      // row index of DFextDu to fill
    for (SizeType i = 0; i < number_of_nodes; i++)
    {
        Matrix DFextDU_i = ZeroMatrix(number_of_nodes, system_size);
