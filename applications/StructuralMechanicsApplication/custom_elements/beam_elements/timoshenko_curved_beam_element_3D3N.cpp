...
BoundedMatrix<double, 2, 2> LinearTimoshenkoCurvedBeamElement3D3N::GetFrenetSerretMatrix(
    const double xi,
    const array_3& rt,
    const array_3& rn
    ) const
...
void LinearTimoshenkoCurvedBeamElement3D3N::GetShapeFunctionsValuesGlobalVectors(
