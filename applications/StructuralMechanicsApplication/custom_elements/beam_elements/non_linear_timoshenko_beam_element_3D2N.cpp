...
void NonLinearTimoshenkoBeamElement3D2N::CalculateB(
    ...
    BeamElementData &rData)
{
    noalias(row(rData.B, 0)) = -rData.Ntheta_y * (rData.dv * rData.sy * rData.sz + rData.dw * rData.cy + (rData.du + 1.0) * rData.sy * rData.cz) + rData.Ntheta_z * (rData.dv * rData.cz - (rData.du + 1.0) * rData.sz) * rData.cy + rData.dNu * rData.cy * rData.cz + rData.dNv * rData.sz * rData.cy - rData.dNw * rData.sy;

    noalias(row(rData.B, 1)) = rData.Ntheta_x * (-rData.dv * (rData.sx * rData.cz - rData.sy * rData.sz * rData.cx) + rData.dw * rData.cx * rData.cy + (rData.du + 1.0) * (rData.sx * rData.sz + rData.sy * rData.cx * rData.cz)) + rData.Ntheta_y * (rData.dv * rData.sz * rData.cy - rData.dw * rData.sy + (rData.du + 1.0) * rData.cy * rData.cz) * rData.sx + rData.Ntheta_z * (rData.dv * (rData.sx * rData.sy * rData.cz - rData.sz * rData.cx) - (rData.du + 1.0) * (rData.sx * rData.sy * rData.sz + rData.cx * rData.cz)) + rData.dNu * (rData.sx * rData.sy * rData.cz - rData.sz * rData.cx) + rData.dNv * (rData.sx * rData.sy * rData.sz + rData.cx * rData.cz) + rData.dNw * rData.sx * rData.cy;

    noalias(row(rData.B, 2)) = -rData.Ntheta_x * (rData.dv * (rData.sx * rData.sy * rData.sz + rData.cx * rData.cz) + rData.dw * rData.sx * rData.cy + (rData.du + 1.0) * (rData.sx * rData.sy * rData.cz - rData.sz * rData.cx)) + rData.Ntheta_y * (rData.dv * rData.sz * rData.cy - rData.dw * rData.sy + (rData.du + 1.0) * rData.cy * rData.cz) * rData.cx + rData.Ntheta_z * (rData.dv * (rData.sx * rData.sz + rData.sy * rData.cx * rData.cz) + (rData.du + 1.0) * (rData.sx * rData.cz - rData.sy * rData.sz * rData.cx)) + rData.dNu * (rData.sx * rData.sz + rData.sy * rData.cx * rData.cz) - rData.dNv * (rData.sx * rData.cz - rData.sy * rData.sz * rData.cx) + rData.dNw * rData.cx * rData.cy;
