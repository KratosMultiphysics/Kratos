...
void NonLinearTimoshenkoBeamElement3D2N::CalculateB(
    ...
    BeamElementData &rData)
{
    noalias(row(rData.B, 0)) =  -rData.Ntheta_y*(rData.dv*std::sin(rData.theta_y)*std::sin(rData.theta_z) + rData.dw*std::cos(rData.theta_y) + (rData.du + 1)*std::sin(rData.theta_y)*std::cos(rData.theta_z)) + rData.Ntheta_z*(rData.dv*std::cos(rData.theta_z) - (rData.du + 1)*std::sin(rData.theta_z))*std::cos(rData.theta_y) + rData.dNu*std::cos(rData.theta_y)*std::cos(rData.theta_z) + rData.dNv*std::sin(rData.theta_z)*std::cos(rData.theta_y) - rData.dNw*std::sin(rData.theta_y) ;

    noalias(row(rData.B, 1)) =  rData.Ntheta_x*(-rData.dv*(std::sin(rData.theta_x)*std::cos(rData.theta_z) - std::sin(rData.theta_y)*std::sin(rData.theta_z)*std::cos(rData.theta_x)) + rData.dw*std::cos(rData.theta_x)*std::cos(rData.theta_y) + (rData.du + 1)*(std::sin(rData.theta_x)*std::sin(rData.theta_z) + std::sin(rData.theta_y)*std::cos(rData.theta_x)*std::cos(rData.theta_z))) + rData.Ntheta_y*(rData.dv*std::sin(rData.theta_z)*std::cos(rData.theta_y) - rData.dw*std::sin(rData.theta_y) + (rData.du + 1)*std::cos(rData.theta_y)*std::cos(rData.theta_z))*std::sin(rData.theta_x) + rData.Ntheta_z*(rData.dv*(std::sin(rData.theta_x)*std::sin(rData.theta_y)*std::cos(rData.theta_z) - std::sin(rData.theta_z)*std::cos(rData.theta_x)) - (rData.du + 1)*(std::sin(rData.theta_x)*std::sin(rData.theta_y)*std::sin(rData.theta_z) + std::cos(rData.theta_x)*std::cos(rData.theta_z))) + rData.dNu*(std::sin(rData.theta_x)*std::sin(rData.theta_y)*std::cos(rData.theta_z) - std::sin(rData.theta_z)*std::cos(rData.theta_x)) + rData.dNv*(std::sin(rData.theta_x)*std::sin(rData.theta_y)*std::sin(rData.theta_z) + std::cos(rData.theta_x)*std::cos(rData.theta_z)) + rData.dNw*std::sin(rData.theta_x)*std::cos(rData.theta_y) ;

    noalias(row(rData.B, 2)) =  -rData.Ntheta_x*(rData.dv*(std::sin(rData.theta_x)*std::sin(rData.theta_y)*std::sin(rData.theta_z) + std::cos(rData.theta_x)*std::cos(rData.theta_z)) + rData.dw*std::sin(rData.theta_x)*std::cos(rData.theta_y) + (rData.du + 1)*(std::sin(rData.theta_x)*std::sin(rData.theta_y)*std::cos(rData.theta_z) - std::sin(rData.theta_z)*std::cos(rData.theta_x))) + rData.Ntheta_y*(rData.dv*std::sin(rData.theta_z)*std::cos(rData.theta_y) - rData.dw*std::sin(rData.theta_y) + (rData.du + 1)*std::cos(rData.theta_y)*std::cos(rData.theta_z))*std::cos(rData.theta_x) + rData.Ntheta_z*(rData.dv*(std::sin(rData.theta_x)*std::sin(rData.theta_z) + std::sin(rData.theta_y)*std::cos(rData.theta_x)*std::cos(rData.theta_z)) + (rData.du + 1)*(std::sin(rData.theta_x)*std::cos(rData.theta_z) - std::sin(rData.theta_y)*std::sin(rData.theta_z)*std::cos(rData.theta_x))) + rData.dNu*(std::sin(rData.theta_x)*std::sin(rData.theta_z) + std::sin(rData.theta_y)*std::cos(rData.theta_x)*std::cos(rData.theta_z)) - rData.dNv*(std::sin(rData.theta_x)*std::cos(rData.theta_z) - std::sin(rData.theta_y)*std::sin(rData.theta_z)*std::cos(rData.theta_x)) + rData.dNw*std::cos(rData.theta_x)*std::cos(rData.theta_y) ;

    noalias(row(rData.B, 3)) =  rData.Ntheta_y*rData.dtheta_z*std::cos(rData.theta_y) + rData.dNtheta_x + rData.dNtheta_z*std::sin(rData.theta_y) ;

    noalias(row(rData.B, 4)) =  -rData.Ntheta_x*(rData.dtheta_y*std::sin(rData.theta_x) + rData.dtheta_z*std::cos(rData.theta_x)*std::cos(rData.theta_y)) + rData.Ntheta_y*rData.dtheta_z*std::sin(rData.theta_x)*std::sin(rData.theta_y) + rData.dNtheta_y*std::cos(rData.theta_x) - rData.dNtheta_z*std::sin(rData.theta_x)*std::cos(rData.theta_y) ;

    noalias(row(rData.B, 5)) =  rData.Ntheta_x*(rData.dtheta_y*std::cos(rData.theta_x) - rData.dtheta_z*std::sin(rData.theta_x)*std::cos(rData.theta_y)) - rData.Ntheta_y*rData.dtheta_z*std::sin(rData.theta_y)*std::cos(rData.theta_x) + rData.dNtheta_y*std::sin(rData.theta_x) + rData.dNtheta_z*std::cos(rData.theta_x)*std::cos(rData.theta_y) ;
