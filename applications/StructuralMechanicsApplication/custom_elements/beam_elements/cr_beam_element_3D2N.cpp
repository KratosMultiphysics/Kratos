...
void CrBeamElement3D2N::CalculateFirstDerivativesContributions(MatrixType& rLeftHandSideMatrix,
                                                    VectorType& rRightHandSideVector,
                                                    const ProcessInfo& rCurrentProcessInfo)
{
    const SizeType num_dofs = msNumberOfNodes * msDimension * 2;
...
void CrBeamElement3D2N::CalculateFirstDerivativesLHS(MatrixType& rLeftHandSideMatrix,
                                            const ProcessInfo& rCurrentProcessInfo)
{
    const SizeType num_dofs = msNumberOfNodes * msDimension * 2;
...
void CrBeamElement3D2N::CalculateFirstDerivativesRHS(VectorType& rRightHandSideVector,
                                            const ProcessInfo& rCurrentProcessInfo)
{
    const SizeType num_dofs = msNumberOfNodes * msDimension * 2;
...
void CrBeamElement3D2N::CalculateSecondDerivativesContributions(MatrixType& rLeftHandSideMatrix,
                                                        VectorType& rRightHandSideVector,
                                                        const ProcessInfo& rCurrentProcessInfo)
{
    const SizeType num_dofs = msNumberOfNodes * msDimension * 2;
...
void CrBeamElement3D2N::CalculateSecondDerivativesLHS(MatrixType& rLeftHandSideMatrix,
                                            const ProcessInfo& rCurrentProcessInfo)
{
    const SizeType num_dofs = msNumberOfNodes * msDimension * 2;
...
void CrBeamElement3D2N::CalculateSecondDerivativesRHS(VectorType& rRightHandSideVector,
                                            const ProcessInfo& rCurrentProcessInfo)
{
    const SizeType num_dofs = msNumberOfNodes * msDimension * 2;
