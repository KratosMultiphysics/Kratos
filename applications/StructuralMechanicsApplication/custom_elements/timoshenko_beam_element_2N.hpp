...
class KRATOS_API(STRUCTURAL_MECHANICS_APPLICATION) TimoshenkoBeamElement2N : public Element
{
protected:
    //const values
...
public:
    KRATOS_CLASS_INTRUSIVE_POINTER_DEFINITION(TimoshenkoBeamElement2N);
    ...
    TimoshenkoBeamElement2N() {};
    TimoshenkoBeamElement2N(IndexType NewId, GeometryType::Pointer pGeometry);
    TimoshenkoBeamElement2N(IndexType NewId, GeometryType::Pointer pGeometry,
                      PropertiesType::Pointer pProperties);


    ~TimoshenkoBeamElement2N() override;
    ...
    */
    ...
    void CalculateTranslationalMassMatrix(
        MatrixType& rMassMatrix,
        const ProcessInfo& rCurrentProcessInfo) const;

    void CalculateRotationalMassMatrix(
        MatrixType& rMassMatrix,
        const ProcessInfo& rCurrentProcessInfo) const;
