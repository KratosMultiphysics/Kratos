 ...
 */
void BaseSolidElement::CalculateFirstDerivativesContributions(MatrixType& rLeftHandSideMatrix,
                                                    VectorType& rRightHandSideVector,
                                                    const ProcessInfo& rCurrentProcessInfo)
{
 ...
 * @param rCurrentProcessInfo the current process info instance
 */
void BaseSolidElement::CalculateFirstDerivativesLHS(MatrixType& rLeftHandSideMatrix,
                                            const ProcessInfo& rCurrentProcessInfo)
{
    const SizeType num_dofs = GetNumberOfDofs();
 ...
 * @param rCurrentProcessInfo the current process info instance
 */
void BaseSolidElement::CalculateFirstDerivativesRHS(VectorType& rRightHandSideVector,
                                            const ProcessInfo& rCurrentProcessInfo)
{
    const SizeType num_dofs = GetNumberOfDofs();
 ...
 * @param rCurrentProcessInfo the current process info instance
 */
void BaseSolidElement::CalculateSecondDerivativesContributions(MatrixType& rLeftHandSideMatrix,
                                                        VectorType& rRightHandSideVector,
                                                        const ProcessInfo& rCurrentProcessInfo)
{
    const SizeType num_dofs = GetNumberOfDofs();
 ...
 * @param rCurrentProcessInfo the current process info instance
 */
void BaseSolidElement::CalculateSecondDerivativesLHS(MatrixType& rLeftHandSideMatrix,
                                            const ProcessInfo& rCurrentProcessInfo)
{
    const SizeType num_dofs = GetNumberOfDofs();
 ...
 * @param rCurrentProcessInfo the current process info instance
 */
void BaseSolidElement::CalculateSecondDerivativesRHS(VectorType& rRightHandSideVector,
                                            const ProcessInfo& rCurrentProcessInfo)
{
    const SizeType num_dofs = GetNumberOfDofs();
...
SizeType BaseSolidElement::GetNumberOfDofs() const
{
    return (3 * GetGeometry().PointsNumber());   // 3 dofs per node
}
