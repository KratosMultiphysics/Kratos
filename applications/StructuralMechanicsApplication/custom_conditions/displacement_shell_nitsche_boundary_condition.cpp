...
#include "displacement_shell_nitsche_boundary_condition.h"
...
DisplacementShellNitscheBoundaryCondition::DisplacementShellNitscheBoundaryCondition(
    IndexType NewId,
...
Condition::Pointer DisplacementShellNitscheBoundaryCondition::Create(
    IndexType NewId,
    NodesArrayType const& ThisNodes,
    Properties::Pointer pProperties) const
{
    return Kratos::make_intrusive<DisplacementShellNitscheBoundaryCondition>(NewId, GetGeometry().Create(ThisNodes), pProperties);
}
...
Condition::Pointer DisplacementShellNitscheBoundaryCondition::Create(
    ...
    Properties::Pointer pProperties) const
{
    return Kratos::make_intrusive<DisplacementShellNitscheBoundaryCondition>(NewId, pGeom, pProperties);
}

void DisplacementShellNitscheBoundaryCondition::EquationIdVector(
...
void DisplacementShellNitscheBoundaryCondition::GetDofList(
...
void DisplacementShellNitscheBoundaryCondition::Initialize(const ProcessInfo &rCurrentProcessInfo)
{
...
void DisplacementShellNitscheBoundaryCondition::CalculateLocalSystem(
...
void DisplacementShellNitscheBoundaryCondition::CalculateLeftHandSide(
    MatrixType& rLeftHandSideMatrix,
    const ProcessInfo& rCurrentProcessInfo)
{
    KRATOS_TRY
...
void DisplacementShellNitscheBoundaryCondition::CalculateRightHandSide(
    VectorType& rRightHandSideVector,
    const ProcessInfo& rCurrentProcessInfo)
{
    KRATOS_TRY
...
int DisplacementShellNitscheBoundaryCondition::Check(const ProcessInfo& rCurrentProcessInfo) const
{
    KRATOS_TRY
...
void DisplacementShellNitscheBoundaryCondition::CalculateBtransCProjectionLinearisation(
    const Matrix& rC,
    const Matrix& rB,
...
void DisplacementShellNitscheBoundaryCondition::CalculateAuxShapeFunctionsMatrix(
    const Vector& rN,
    Matrix& rAuxMat)
{
...
std::string DisplacementShellNitscheBoundaryCondition::Info() const
{
    std::stringstream buffer;
    buffer << "DisplacementShellNitscheBoundaryCondition #" << Id();
    return buffer.str();
}

void DisplacementShellNitscheBoundaryCondition::PrintInfo(std::ostream& rOStream) const
{
    rOStream << "DisplacementShellNitscheBoundaryCondition #" << Id();
}

void DisplacementShellNitscheBoundaryCondition::PrintData(std::ostream& rOStream) const
{
    rOStream << "DisplacementShellNitscheBoundaryCondition #" << Id() << std::endl;
...
void DisplacementShellNitscheBoundaryCondition::save(Serializer& rSerializer) const
{
    KRATOS_SERIALIZE_SAVE_BASE_CLASS(rSerializer, Condition);
}

void DisplacementShellNitscheBoundaryCondition::load(Serializer& rSerializer)
{
