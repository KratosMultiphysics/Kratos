...
namespace Kratos
{
    ...
    {
        return boost::make_shared<PointContactCondition>(NewId, pGeom, pProperties);
    }
    ...
    {
        return boost::make_shared<PointContactCondition>( NewId, GetGeometry().Create( ThisNodes ), pProperties );
    }
