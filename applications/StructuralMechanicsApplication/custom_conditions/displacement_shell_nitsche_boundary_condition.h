...
class KRATOS_API(STRUCTURAL_MECHANICS_APPLICATION) DisplacementShellNitscheBoundaryCondition: public Condition
{
public:
    ...
    /// Pointer definition of DisplacementShellNitscheBoundaryCondition
    KRATOS_CLASS_INTRUSIVE_POINTER_DEFINITION(DisplacementShellNitscheBoundaryCondition);
    ...
    DisplacementShellNitscheBoundaryCondition(
        IndexType NewId,
    ...
    /// Copy constructor
    DisplacementShellNitscheBoundaryCondition(DisplacementShellNitscheBoundaryCondition const& rOther) = delete;

    /// Destructor
    ~DisplacementShellNitscheBoundaryCondition() override;
    ...
    /// Assignment operator
    DisplacementShellNitscheBoundaryCondition& operator=(DisplacementShellNitscheBoundaryCondition const& rOther) = delete;
...
private:
    ...
    ///@}
}; // Class DisplacementShellNitscheBoundaryCondition
