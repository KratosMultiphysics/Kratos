 ...
 */
class KRATOS_API(STRUCTURAL_MECHANICS_APPLICATION) ElasticOrthotropic3D
...
public:
    ...
    /// Counted pointer of ElasticOrthotropic3D
    KRATOS_CLASS_POINTER_DEFINITION( ElasticOrthotropic3D );
     ...
     * Copy constructor.
     */
    ElasticOrthotropic3D (const ElasticOrthotropic3D& rOther);

    /**
     * @brief Destructor.
     */
    ~ElasticOrthotropic3D() override;
