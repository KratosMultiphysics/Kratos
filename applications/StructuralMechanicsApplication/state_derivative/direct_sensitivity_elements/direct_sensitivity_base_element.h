...
#if !defined(DIRECT_SENSITIVITY_BASE_ELEMENT_H_INCLUDED )
#define  DIRECT_SENSITIVITY_BASE_ELEMENT_H_INCLUDED
...
/** \brief DirectSensitivityBaseElement
 *
 * This element a wrapper for a primal element to calculate element derivatives using
 * finite differencing. It is designed to be used in direct sensitivity analysis
 */
class DirectSensitivityBaseElement : public Element
{
public:
    ...
    KRATOS_CLASS_POINTER_DEFINITION(DirectSensitivityBaseElement);
    ///@}
    ...
    ///@name Life Cycle
    ///@{
    //DirectSensitivityBaseElement() : Element()
    //{}

    DirectSensitivityBaseElement(Element::Pointer pPrimalElement, DirectSensitivityVariable& rDirectSensitivityVariable);

    DirectSensitivityBaseElement(Element::Pointer pPrimalElement, bool HasRotationDofs, DirectSensitivityVariable& rDirectSensitivityVariable);

    ~DirectSensitivityBaseElement() override;
    ...
    void CalculateOnIntegrationPoints(const Variable<bool>& rVariable,
					      ...
					      const ProcessInfo& rCurrentProcessInfo) override
    {
        KRATOS_ERROR << "CalculateOnIntegrationPoints of the direct sensitivity base condition is called!" << std::endl;
    }
    ...
    void AssembleStressDisplacementDerivativeMatrix(const Variable<Vector>& rStressVariable,  
    ...
    void CalculateStressDesignVariableDerivative( const Variable<Vector>& rStressVariable,
                                                std::vector<TracedStressType>& TracedStressTypeVector, 
                                                Matrix& rOutput,
                                                const ProcessInfo& rCurrentProcessInfo);
...
private:
    ...
    ///@{
    void GetListOfTracedStressTypes(std::vector<TracedStressType>& TracedStressTypeVector);
...
#endif // DIRECT_SENSITIVITY_BASE_ELEMENT_H_INCLUDED
