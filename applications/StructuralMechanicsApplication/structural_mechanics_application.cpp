...
KratosStructuralMechanicsApplication::KratosStructuralMechanicsApplication()
    : KratosApplication("StructuralMechanicsApplication"),
     ...
     // Adding the mass elements
      ...
      mAdjointFiniteDifferenceNodalConcentratedDampedElement3D1N(0, Element::GeometryType::Pointer(new Point3D<NodeType >(Element::GeometryType::PointsArrayType(1)))),
...
void KratosStructuralMechanicsApplication::Register() {
    ...
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(ANGULAR_ADJOINT_VECTOR_2)
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(ANGULAR_ADJOINT_VECTOR_3)
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(ANGULAR_AUX_ADJOINT_VECTOR_1)
    ...
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(NODAL_DAMPING_RATIO_SENSITIVITY);
    ...
    KRATOS_REGISTER_ELEMENT("AdjointFiniteDifferenceNodalConcentratedDampedElement3D1N", mAdjointFiniteDifferenceNodalConcentratedDampedElement3D1N)
