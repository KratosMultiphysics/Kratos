...
void KratosStructuralMechanicsApplication::Register() {
    ...
    KRATOS_REGISTER_VARIABLE(ELASTIC_UNIAXIAL_STRENGTH_TENSION)
    KRATOS_REGISTER_VARIABLE(ELASTIC_UNIAXIAL_STRENGTH_COMPRESSION)
    KRATOS_REGISTER_VARIABLE(ELASTIC_BIAXIAL_STRENGTH_COMPRESSION)
    KRATOS_REGISTER_VARIABLE(PLASTIC_STRAIN_RATE_BETA)
    ...
    KRATOS_REGISTER_VARIABLE(STRAIN_REFERENCE)
    ...
    KRATOS_REGISTER_CONSTITUTIVE_LAW("TCPlasticDamage3DLaw", mTCPlasticDamage3DLaw);
