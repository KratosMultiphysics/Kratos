...
void KratosStructuralMechanicsApplication::Register() {
    ...
    KRATOS_REGISTER_VARIABLE(BEAM_INITIAL_INTERNAL_FORCES)
    ...
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS( SURFACE_LOAD_SENSITIVITY_INCREMENT );
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS( ADJOINT_DISPLACEMENT_INCREMENT );
    ...
    KRATOS_REGISTER_VARIABLE( YOUNG_MODULUS_VAR_SENSITIVITY );
    KRATOS_REGISTER_VARIABLE( YOUNG_MODULUS_PARTIAL_SENSITIVITY );
    KRATOS_REGISTER_VARIABLE( ISOTROPIC_PRESTRESS_VAR_SENSITIVITY );
    KRATOS_REGISTER_VARIABLE( ISOTROPIC_PRESTRESS_PARTIAL_SENSITIVITY );
    KRATOS_REGISTER_VARIABLE( POISSON_RATIO_VAR_SENSITIVITY );
    KRATOS_REGISTER_VARIABLE( POISSON_RATIO_PARTIAL_SENSITIVITY );
    ...
    KRATOS_REGISTER_VARIABLE( YIELD_STRESS_SENSITIVITY );
    ...
    KRATOS_REGISTER_VARIABLE( GREEN_LAGRANGE_STRAIN_DERIVATIVE_MATRIX);
    KRATOS_REGISTER_VARIABLE( ADJOINT_GREEN_LAGRANGE_STRAIN_VECTOR  );
    KRATOS_REGISTER_VARIABLE( YOUNG_MODULUS_PSEUDO_NORMAL_FORCE_VECTOR );
    KRATOS_REGISTER_VARIABLE( POISSON_RATIO_PSEUDO_NORMAL_FORCE_VECTOR );
    KRATOS_REGISTER_VARIABLE( ISOTROPIC_PRESTRESS_PSEUDO_NORMAL_FORCE_VECTOR );
