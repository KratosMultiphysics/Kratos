...
void KratosStructuralMechanicsApplication::Register() {
    ...
    KRATOS_REGISTER_CONSTITUTIVE_LAW("HyperElasticIsotropicNeoHookean3DVonMisesMohrCoulomb", mHyperElasticIsotropicNeoHookean3DVonMisesMohrCoulomb);
    KRATOS_REGISTER_CONSTITUTIVE_LAW("HyperElasticIsotropicNeoHookean3DMohrCoulombVonMises", mHyperElasticIsotropicNeoHookean3DMohrCoulombVonMises);
    KRATOS_REGISTER_CONSTITUTIVE_LAW("HyperElasticIsotropicNeoHookean3DMohrCoulombMohrCoulomb", mHyperElasticIsotropicNeoHookean3DMohrCoulombMohrCoulomb);
    KRATOS_REGISTER_CONSTITUTIVE_LAW("HyperElasticIsotropicNeoHookean3DMohrCoulombDruckerPrager", mHyperElasticIsotropicNeoHookean3DMohrCoulombDruckerPrager);
    KRATOS_REGISTER_CONSTITUTIVE_LAW("HyperElasticIsotropicNeoHookean3DMohrCoulombTresca", mHyperElasticIsotropicNeoHookean3DMohrCoulombTresca);
    KRATOS_REGISTER_CONSTITUTIVE_LAW("HyperElasticIsotropicNeoHookean3DTrescaMohrCoulomb", mHyperElasticIsotropicNeoHookean3DTrescaMohrCoulomb);
    KRATOS_REGISTER_CONSTITUTIVE_LAW("HyperElasticIsotropicNeoHookean3DDruckerPragerMohrCoulomb", mHyperElasticIsotropicNeoHookean3DDruckerPragerMohrCoulomb);
