...
void KratosStructuralMechanicsApplication::Register() {
    ...
    KRATOS_REGISTER_VARIABLE(ELASTIC_LIMIT_STRESS_COMPRESSION)
    ...
    KRATOS_REGISTER_VARIABLE(YIELD_STRESS_SHEAR_12)
    KRATOS_REGISTER_VARIABLE(YIELD_STRESS_SHEAR_21)
    KRATOS_REGISTER_VARIABLE(YIELD_STRESS_SHEAR_12_MINUS)
    KRATOS_REGISTER_VARIABLE(YIELD_STRESS_SHEAR_21_MINUS)

    // D+D- Damage Constitutive laws variables for orthotropic, additional Masonry 2D & 3D
    KRATOS_REGISTER_VARIABLE(YOUNG_MODULUS_1)
    KRATOS_REGISTER_VARIABLE(YOUNG_MODULUS_2)
    KRATOS_REGISTER_VARIABLE(POISSON_RATIO_12)
    KRATOS_REGISTER_VARIABLE(POISSON_RATIO_21)

    KRATOS_REGISTER_VARIABLE(YIELD_STRESS_TENSION_2)
    KRATOS_REGISTER_VARIABLE(FRACTURE_ENERGY_TENSION_2)
    KRATOS_REGISTER_VARIABLE(ELASTIC_LIMIT_STRESS_COMPRESSION_2)
    KRATOS_REGISTER_VARIABLE(YIELD_STRESS_COMPRESSION_2)
    KRATOS_REGISTER_VARIABLE(YIELD_STRAIN_COMPRESSION_2)
    KRATOS_REGISTER_VARIABLE(RESIDUAL_STRESS_COMPRESSION_2)
    KRATOS_REGISTER_VARIABLE(FRACTURE_ENERGY_COMPRESSION_2)
    KRATOS_REGISTER_VARIABLE(BEZIER_CONTROLLER_C1_2)
    KRATOS_REGISTER_VARIABLE(BEZIER_CONTROLLER_C2_2)
    KRATOS_REGISTER_VARIABLE(BEZIER_CONTROLLER_C3_2)
