...
KratosStructuralMechanicsApplication::KratosStructuralMechanicsApplication()
    ...
    mNonLinearTimoshenkoBeamElement2D2N(0, Element::GeometryType::Pointer(new Line2D2<NodeType >(Element::GeometryType::PointsArrayType(2)))),
    ...
    mNonLinearTimoshenkoBeamElement3D2N(0, Element::GeometryType::Pointer(new Line3D2<NodeType >(Element::GeometryType::PointsArrayType(2)))),
...
void KratosStructuralMechanicsApplication::Register() {
    ...
    KRATOS_REGISTER_ELEMENT("NonLinearTimoshenkoBeamElement2D2N", mNonLinearTimoshenkoBeamElement2D2N)
    KRATOS_REGISTER_ELEMENT("LinearTimoshenkoBeamElement3D2N", mLinearTimoshenkoBeamElement3D2N)
    KRATOS_REGISTER_ELEMENT("NonLinearTimoshenkoBeamElement3D2N", mNonLinearTimoshenkoBeamElement3D2N)
