...
KratosStructuralMechanicsApplication::KratosStructuralMechanicsApplication()
    : KratosApplication("StructuralMechanicsApplication"),
      ...
      mAdjointSemiAnalyticPointMomentCondition3D1N(0, Condition::GeometryType::Pointer(new Point3D<NodeType >(Condition::GeometryType::PointsArrayType(1)))),
...
void KratosStructuralMechanicsApplication::Register() {
    ...
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS( FORCE_SENSITIVITY );
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS( MOMENT_SENSITIVITY );
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS( DISPLACEMENT_SENSITIVITY );
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS( ROTATION_SENSITIVITY );
    ...
    KRATOS_REGISTER_CONDITION("AdjointSemiAnalyticPointMomentCondition3D1N", mAdjointSemiAnalyticPointMomentCondition3D1N )
