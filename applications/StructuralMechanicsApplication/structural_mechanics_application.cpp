...
void KratosStructuralMechanicsApplication::Register() {
    ...
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(DISPLACEMENT_NL1_SENSITIVITY)
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(DISPLACEMENT_NL2_SENSITIVITY)
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(FORCE_NL1_SENSITIVITY)
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(FORCE_NL2_SENSITIVITY)
    KRATOS_REGISTER_VARIABLE( SHELL_MOMENT_GLOBAL_NL1_SENSITIVITY)
    KRATOS_REGISTER_VARIABLE( SHELL_MOMENT_GLOBAL_NL2_SENSITIVITY)
    KRATOS_REGISTER_VARIABLE( VON_MISES_STRESS_NL1_SENSITIVITY)
    KRATOS_REGISTER_VARIABLE( VON_MISES_STRESS_NL2_SENSITIVITY)
    KRATOS_REGISTER_VARIABLE( PK2_STRESS_VECTOR_NL1_SENSITIVITY)
    KRATOS_REGISTER_VARIABLE( PK2_STRESS_VECTOR_NL2_SENSITIVITY)
    KRATOS_REGISTER_VARIABLE( PRINCIPAL_PK2_STRESS_VECTOR_NL1_SENSITIVITY)
    KRATOS_REGISTER_VARIABLE( PRINCIPAL_PK2_STRESS_VECTOR_NL2_SENSITIVITY)
