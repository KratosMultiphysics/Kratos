...
void KratosStructuralMechanicsApplication::Register() {
    ...
    KRATOS_REGISTER_VARIABLE(PLASTIC_DEFORMATION_GRADIENT)
    ...
    KRATOS_REGISTER_CONSTITUTIVE_LAW("FiniteStrainIsotropicPlasticityFactory", mFiniteStrainIsotropicPlasticityFactory);
