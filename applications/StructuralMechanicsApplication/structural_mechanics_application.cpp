...
void KratosStructuralMechanicsApplication::Register() {
    ...
    KRATOS_REGISTER_VARIABLE(CROSS_SECTION_TYPE)
    KRATOS_REGISTER_VARIABLE(DIM1)
    KRATOS_REGISTER_VARIABLE(DIM2)
    KRATOS_REGISTER_VARIABLE(DIM3)
    KRATOS_REGISTER_VARIABLE(DIM4)
    KRATOS_REGISTER_VARIABLE(DIM5)
    KRATOS_REGISTER_VARIABLE(DIM6)
    KRATOS_REGISTER_VARIABLE(DIM7)
    KRATOS_REGISTER_VARIABLE(DIM8)
    KRATOS_REGISTER_VARIABLE(DIM9)
    KRATOS_REGISTER_VARIABLE(DIM10)
