...
void KratosStructuralMechanicsApplication::Register() {
    ...
    KRATOS_REGISTER_CONSTITUTIVE_LAW("UserProvidedLinearElasticLaw2D", mUserProvidedLinearElasticLaw2D);
    KRATOS_REGISTER_CONSTITUTIVE_LAW("UserProvidedLinearElasticLaw3D", mUserProvidedLinearElasticLaw3D);
