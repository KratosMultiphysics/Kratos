...
void KratosStructuralMechanicsApplication::Register() {
    ...
    // Bossak Acceleration Variables
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(BOSSAK_ACCELERATION)
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(ANGULAR_BOSSAK_ACCELERATION)
