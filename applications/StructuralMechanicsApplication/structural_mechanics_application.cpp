...
KratosStructuralMechanicsApplication::KratosStructuralMechanicsApplication()
    : KratosApplication("StructuralMechanicsApplication"),
      ...
      mTimoshenkoBeamElement2N(0, Element::GeometryType::Pointer(new Line3D2<NodeType >(Element::GeometryType::PointsArrayType(2)))),
...
void KratosStructuralMechanicsApplication::Register() {
    ...
    KRATOS_REGISTER_VARIABLE(TIMOSHENKO_SHEAR_COEFFICIENT)
	...
	KRATOS_REGISTER_ELEMENT("TimoshenkoBeamElement2N", mTimoshenkoBeamElement2N)
