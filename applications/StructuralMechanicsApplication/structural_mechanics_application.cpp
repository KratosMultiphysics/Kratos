...
void KratosStructuralMechanicsApplication::Register() {
    ...
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS( ADJOINT_DIRECTED_STRAIN );
    ...
    KRATOS_REGISTER_VARIABLE( I22_SENSITIVITY_ANALYTIC );
    ...
    KRATOS_REGISTER_VARIABLE( CROSS_AREA_SENSITIVITY_ANALYTIC );
    KRATOS_REGISTER_VARIABLE( IS_ADJOINT );
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(  CROSS_AREA_PSEUDO_FORCE );
    KRATOS_REGISTER_VARIABLE( I22_PSEUDO_LOAD );
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(  I22_PSEUDO_MOMENT );
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS( BEAM_BENDING_MODES );
    KRATOS_REGISTER_VARIABLE( YOUNG_MODULUS_SENSITIVITY_ANALYTIC );
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(  YOUNG_MODULUS_PSEUDO_MOMENT );
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(  YOUNG_MODULUS_PSEUDO_FORCE );
     KRATOS_REGISTER_VARIABLE(SHELL_PSEUDO_STRESSES)
