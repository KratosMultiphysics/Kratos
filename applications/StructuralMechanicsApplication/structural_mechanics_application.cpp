...
void KratosStructuralMechanicsApplication::Register() {
    ...
    KRATOS_REGISTER_VARIABLE(SEMI_RIGID_NODE_IDS)
    KRATOS_REGISTER_VARIABLE(SEMI_RIGID_ROTATIONAL_STIFFNESS_VECTOR_AXIS_2)
    KRATOS_REGISTER_VARIABLE(SEMI_RIGID_ROTATIONAL_STIFFNESS_VECTOR_AXIS_3)
