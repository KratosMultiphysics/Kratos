...
KratosStructuralMechanicsApplication::KratosStructuralMechanicsApplication()
    : KratosApplication("StructuralMechanicsApplication"),
      ...
      mMembraneCuttingPatternElement3D4N(0, Element::GeometryType::Pointer(new Quadrilateral3D4<NodeType >(Element::GeometryType::PointsArrayType(4)))),
      mMembraneCuttingPatternElement3D3N(0, Element::GeometryType::Pointer(new Triangle3D3<NodeType >(Element::GeometryType::PointsArrayType(3)))),
...
void KratosStructuralMechanicsApplication::Register() {
    ...
    KRATOS_REGISTER_ELEMENT("MembraneCuttingPatternElement3D4N", mMembraneCuttingPatternElement3D4N)
    KRATOS_REGISTER_ELEMENT("MembraneCuttingPatternElement3D3N", mMembraneCuttingPatternElement3D3N)
