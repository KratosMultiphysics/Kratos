...
void KratosStructuralMechanicsApplication::Register() {
    ...
    KRATOS_REGISTER_VARIABLE(ADJOINT_ES_STRAIN_VECTOR)
    KRATOS_REGISTER_VARIABLE(ADJOINT_GL_STRAIN_VECTOR)
    KRATOS_REGISTER_VARIABLE(ADJOINT_EA_STRAIN_VECTOR)
    KRATOS_REGISTER_VARIABLE(YOUNG_MODULUS_PSEUDO_PK2_STRESS_VECTOR)
    KRATOS_REGISTER_VARIABLE(TRUSS_PRESTRESS_PK2_PSEUDO_PK2_STRESS_VECTOR)
    KRATOS_REGISTER_VARIABLE(CROSS_AREA_PSEUDO_PK2_STRESS_VECTOR)
    KRATOS_REGISTER_VARIABLE(CROSS_AREA_PSEUDO_CAUCHY_STRESS_VECTOR)
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(CROSS_AREA_PSEUDO_FORCE)

    // Variables for output of sensitivities
    KRATOS_REGISTER_VARIABLE( YOUNG_MODULUS_VARIATIONAL_SENSITIVITY );
    KRATOS_REGISTER_VARIABLE( TRUSS_PRESTRESS_PK2_VARIATIONAL_SENSITIVITY );
    KRATOS_REGISTER_VARIABLE( CROSS_AREA_VARIATIONAL_SENSITIVITY );
