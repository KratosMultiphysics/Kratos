...
KratosStructuralMechanicsApplication::KratosStructuralMechanicsApplication()
    : KratosApplication("StructuralMechanicsApplication"),
      ...
      mAdjointFiniteDifferencingShellThickElement3D4N(0, Element::GeometryType::Pointer(new Quadrilateral3D4<NodeType >(Element::GeometryType::PointsArrayType(4)))),
...
void KratosStructuralMechanicsApplication::Register() {
    ...
    KRATOS_REGISTER_VARIABLE(PRIMAL_VALUES_VECTOR)
    ...
    KRATOS_REGISTER_VARIABLE( SHEAR_MODULUS_XZ_SENSITIVITY );
    KRATOS_REGISTER_VARIABLE( SHEAR_MODULUS_YZ_SENSITIVITY );
    ...
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(PRESCRIBED_DISPLACEMENT_SENSITIVITY);
    ...
    KRATOS_REGISTER_ELEMENT("AdjointFiniteDifferencingShellThickElement3D4N", mAdjointFiniteDifferencingShellThickElement3D4N )
