...
void KratosStructuralMechanicsApplication::Register() {
    ...
    // For phase field fracture method
    KRATOS_REGISTER_VARIABLE(PHASE_FIELD);
    KRATOS_REGISTER_VARIABLE(DAMAGE_DRIVING_FORCE);
    KRATOS_REGISTER_VARIABLE(UNDAMAGED_ELASTIC_ENERGY);
    KRATOS_REGISTER_VARIABLE(PHASE_FIELD_LENGTH);
    KRATOS_REGISTER_VARIABLE(CRITICAL_ENERGY_RELEASE_RATE); 
    KRATOS_REGISTER_VARIABLE(WELL_COND_PARAM);    
    KRATOS_REGISTER_VARIABLE(COUPLE_U_PHI);           
    ...
    KRATOS_REGISTER_CONSTITUTIVE_LAW("LinearElasticFracture3DLaw", mElasticIsotropicFracture3D);
