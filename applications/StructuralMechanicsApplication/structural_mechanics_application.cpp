...
void KratosStructuralMechanicsApplication::Register() {
    ...
    KRATOS_REGISTER_VARIABLE(SHELL_SHEAR_FORMULATION)
    KRATOS_REGISTER_VARIABLE(SHELL_DRILLING_STIFFNESS_MULTIPLIER)
    KRATOS_REGISTER_VARIABLE(SBM_CONSTRAINED_DOFS)
    KRATOS_REGISTER_VARIABLE(SBM_FORMULATION_TYPE)
