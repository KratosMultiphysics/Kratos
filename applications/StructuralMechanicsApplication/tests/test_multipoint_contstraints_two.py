...
class TestMultipointConstraints(KratosUnittest.TestCase):
    ...
    def _apply_mpc_constraints(self,mp,cm):
        ...
        cm.AddMasterSlaveRelation(mp.Nodes[16],KratosMultiphysics.DISPLACEMENT_X, mp.Nodes[7], KratosMultiphysics.DISPLACEMENT_X,  0.5)
        cm.AddMasterSlaveRelation(mp.Nodes[18],KratosMultiphysics.DISPLACEMENT_X, mp.Nodes[7], KratosMultiphysics.DISPLACEMENT_X,  0.5)
        cm.AddMasterSlaveRelation(mp.Nodes[16],KratosMultiphysics.DISPLACEMENT_Y, mp.Nodes[7], KratosMultiphysics.DISPLACEMENT_Y,  0.5) 
        cm.AddMasterSlaveRelation(mp.Nodes[18],KratosMultiphysics.DISPLACEMENT_Y, mp.Nodes[7], KratosMultiphysics.DISPLACEMENT_Y,  0.5)
