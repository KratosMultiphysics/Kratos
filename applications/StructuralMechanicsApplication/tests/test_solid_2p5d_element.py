...
class TestSolid2p5DElement(KratosUnittest.TestCase):
    def setUp(self):
        self.print_output = False
        self.print_results = False

    def test_solid_2p5d(self):
        results_filename = "solid_2p5d_test/solid_2p5d_results.json"
        parameters_filename = "solid_2p5d_test/solid_2p5d_parameters.json"
