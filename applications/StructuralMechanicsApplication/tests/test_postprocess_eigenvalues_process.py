...
class TestPostprocessEigenvaluesProcess(KratosUnittest.TestCase):
    ...
    def test_PostprocessEigenvaluesProcess_GiD(self):
        ...
        """ % ((GetFilePath("eigen_postprocess_ref_files/test_postprocess_eigenvalues_process.post.res.ref"), "EigenResults/Structure_EigenResults_15_0.post.res").replace("\\", "\\\\")) )
    ...
    def test_PostprocessEigenvaluesProcess_Vtk(self):
        ...
        for i in range(num_animation_steps):
            ...
            """ % ((GetFilePath("eigen_postprocess_ref_files/Structure_EigenResults_15_{}.vtk.ref".format(i)), "EigenResults/Structure_EigenResults_15_{}.vtk".format(i)).replace("\\", "\\\\")) )
            CompareTwoFilesCheckProcess(settings_check_process).Execute()
