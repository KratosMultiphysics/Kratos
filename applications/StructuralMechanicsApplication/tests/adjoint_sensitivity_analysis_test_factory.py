...
class AdjointSensitivityAnalysisTestFactory(KratosUnittest.TestCase):
    ...
    #def setUpClass(cls):
        ...
        #    cls.model_primal = KratosMultiphysics.Model()
        #    cls.primal_analysis = structural_mechanics_analysis.StructuralMechanicsAnalysis(model_primal, self.primal_parameters)
        #    cls.primal_analysis.Run()
#
...
class TestAdjointSensitivityAnalysisBeamStructureLocalStress(AdjointSensitivityAnalysisTestFactory):
    ...
    def test_execution(self):
        ...
        for element_id in element_list:
            sensitivities_to_check.append(self.adjoint_analysis.model.GetModelPart(self.model_part_name).Elements[element_id].GetValue(StructuralMechanicsApplication.I22_SENSITIVITY))
        sensitivities_to_check.append(self.adjoint_analysis.model.GetModelPart(self.model_part_name).Conditions[1].GetValue(StructuralMechanicsApplication.POINT_LOAD_SENSITIVITY)[2])
...
class TestAdjointSensitivityAnalysisBeamStructureNodalReaction(AdjointSensitivityAnalysisTestFactory):
    ...
    def test_execution(self):
        ...
        sensitivities_to_check = []
        sensitivities_to_check.append(self.adjoint_analysis.model.GetModelPart(self.model_part_name).Conditions[1].GetValue(StructuralMechanicsApplication.POINT_LOAD_SENSITIVITY)[2])
        sensitivities_to_check.append(self.adjoint_analysis.model.GetModelPart(self.model_part_name).Elements[10].GetValue(StructuralMechanicsApplication.I22_SENSITIVITY))
