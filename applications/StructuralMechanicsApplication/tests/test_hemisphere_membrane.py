...
class TestHemisphereMembrane(KratosUnittest.TestCase):
    def setUp(self):
        self.print_output = False
        self.print_results = False

    def test_shell_membrane(self):
        results_filename = "hemisphere_membrane_test/hemisphere_membrane_results.json"
        parameters_filename = "hemisphere_membrane_test/ProjectParameters.json"
