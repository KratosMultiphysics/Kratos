...
typedef ResidualBasedBlockBuilderAndSolverWithConstraintsElementWise< SparseSpaceType, LocalSpaceType, LinearSolverType > ResidualBasedBlockBuilderAndSolverType;
...
KRATOS_TEST_CASE_IN_SUITE(PatchTestMPCPlateTensionWithElementWiseBuilderAndSolver, KratosStructuralMechanicsFastSuite)
{
    Model current_model;
