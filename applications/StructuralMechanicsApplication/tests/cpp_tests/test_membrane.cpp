...
namespace Testing
{
    ...
    KRATOS_TEST_CASE_IN_SUITE(MembraneElement3D3N, KratosStructuralMechanicsFastSuite)
    {
        ...
        Vector expected_relative_error(number_of_dofs*number_of_dofs);
        ...
        KRATOS_EXPECT_VECTOR_RELATIVE_NEAR(relative_error, expected_relative_error, tolerance)
    }
