...
class Kratos_Execute_Test:
    ...
    def __init__(self, ProjectParameters):
        ...
        if (ProjectParameters.Has("formfinding_IO_process") == True): 
            self.list_of_processes += process_factory.KratosProcessFactory(self.Model).ConstructListOfProcesses(self.ProjectParameters["formfinding_IO_process"]) 
    ...
    def Solve(self):
        ...
        #self.main_model_io = KratosMultiphysics.ModelPartIO("formfinding_output", KratosMultiphysics.IO.WRITE)
        #self.main_model_io.WriteModelPart(self.main_model_part)
