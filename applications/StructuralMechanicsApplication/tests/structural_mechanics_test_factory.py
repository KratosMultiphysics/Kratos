...
class LinearTruss2D3NTest(StructuralMechanicsTestFactory):
    file_name = "LinearTruss2D/2D3N/linear_truss_2d3N_test"
...
class Simple3D2NBeamCrDynamicPseudoStepTest(StructuralMechanicsTestFactory):
    ...
    analysis_type = StructuralMechanicsLoadSteppingAnalysis
