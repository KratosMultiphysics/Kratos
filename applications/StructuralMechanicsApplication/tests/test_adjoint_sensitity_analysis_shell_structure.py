...
class TestCase(KratosUnittest.TestCase):
    ...
    def _solve_primal_problem(self):
        with open("./adjoint_sensitivity_test_martin/adjoint_shell_structure/linear_shell_test_parameters.json",'r') as parameter_file:
    ...
    def test_local_stress_response(self): 
        ...
        self._solve_primal_problem()
        with open("./adjoint_sensitivity_test_martin/adjoint_shell_structure/linear_shell_test_local_stress_adjoint_parameters.json",'r') as parameter_file:
    ...
    def test_nodal_displacement_response(self):           
        # Create the adjoint solver
        with open("./adjoint_sensitivity_test_martin/adjoint_shell_structure/linear_shell_test_nodal_disp_adjoint_parameters.json",'r') as parameter_file:
            ProjectParametersAdjoint = Parameters( parameter_file.read())
        adjoint_analysis = structural_mechanics_analysis.StructuralMechanicsAnalysis(ProjectParametersAdjoint)
        adjoint_analysis.Run()
    ...
    def test_strain_energy_response(self):           
        # Create the adjoint solver
        with open("./adjoint_sensitivity_test_martin/adjoint_shell_structure/linear_shell_test_strain_energy_adjoint_parameters.json",'r') as parameter_file:
            ProjectParametersAdjoint = Parameters( parameter_file.read())
        adjoint_analysis = structural_mechanics_analysis.StructuralMechanicsAnalysis(ProjectParametersAdjoint)
        adjoint_analysis.Run()
        ...
        self._remove_file("./adjoint_sensitivity_test_martin/adjoint_shell_structure/rectangular_plate_0.h5")
        self._remove_file("./adjoint_sensitivity_test_martin/adjoint_shell_structure/rectangular_plate.time")
