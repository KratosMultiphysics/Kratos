...
class TestPatchTestLargeStrain(KratosUnittest.TestCase):
    ...
    def _define_movement(self,dim):
        if(dim == 2):
            ...
            A = KratosMultiphysics.Matrix(3,3)
            A[0,0] = 1.0;  A[0,1] = 2.0; A[0,2] = 0.0
            A[1,0] = 0.5;  A[1,1] = 0.7; A[1,2] = 0.1
            A[2,1] = -0.2;  A[2,1] = 0.0; A[2,2] = -0.3
    ...
    def _test_TL_2D_quadrilateral(self):
        dim = 2
        mp = KratosMultiphysics.ModelPart("solid_part")
        self._add_variables(mp)
        self._apply_material_properties(mp,dim)
    ...
    def _test_TL_3D_tetra(self): 
        ...
        #create Element
        mp.CreateNewElement("TotalLagrangianElement3D4N", 1,[12,10,3,15], mp.GetProperties()[1]) 
        mp.CreateNewElement("TotalLagrangianElement3D4N", 2,[15,8,3,12], mp.GetProperties()[1]) 
        mp.CreateNewElement("TotalLagrangianElement3D4N", 3,[6,3,8,12], mp.GetProperties()[1]) 
        mp.CreateNewElement("TotalLagrangianElement3D4N", 4,[12,6,14,8], mp.GetProperties()[1]) 
        mp.CreateNewElement("TotalLagrangianElement3D4N", 5,[12,16,15,8], mp.GetProperties()[1]) 
        mp.CreateNewElement("TotalLagrangianElement3D4N", 6,[16,14,8,12], mp.GetProperties()[1]) 
        mp.CreateNewElement("TotalLagrangianElement3D4N", 7,[13,7,4,16], mp.GetProperties()[1]) 
        mp.CreateNewElement("TotalLagrangianElement3D4N", 8,[16,13,11,4], mp.GetProperties()[1]) 
        mp.CreateNewElement("TotalLagrangianElement3D4N", 9,[14,8,4,16], mp.GetProperties()[1]) 
        mp.CreateNewElement("TotalLagrangianElement3D4N", 10,[16,15,8,4], mp.GetProperties()[1]) 
        mp.CreateNewElement("TotalLagrangianElement3D4N", 11,[16,14,7,4], mp.GetProperties()[1]) 
        mp.CreateNewElement("TotalLagrangianElement3D4N", 12,[15,11,4,16], mp.GetProperties()[1]) 
        mp.CreateNewElement("TotalLagrangianElement3D4N", 13,[5,1,2,13], mp.GetProperties()[1]) 
        mp.CreateNewElement("TotalLagrangianElement3D4N", 14,[13,5,9,2], mp.GetProperties()[1]) 
        mp.CreateNewElement("TotalLagrangianElement3D4N", 15,[7,4,2,13], mp.GetProperties()[1]) 
        mp.CreateNewElement("TotalLagrangianElement3D4N", 16,[13,11,4,2], mp.GetProperties()[1]) 
        mp.CreateNewElement("TotalLagrangianElement3D4N", 17,[13,7,1,2], mp.GetProperties()[1]) 
        mp.CreateNewElement("TotalLagrangianElement3D4N", 18,[11,9,2,13], mp.GetProperties()[1]) 
        mp.CreateNewElement("TotalLagrangianElement3D4N", 19,[11,4,2,15], mp.GetProperties()[1]) 
        mp.CreateNewElement("TotalLagrangianElement3D4N", 20,[15,11,9,2], mp.GetProperties()[1]) 
        mp.CreateNewElement("TotalLagrangianElement3D4N", 21,[8,3,2,15], mp.GetProperties()[1]) 
        mp.CreateNewElement("TotalLagrangianElement3D4N", 22,[15,10,3,2], mp.GetProperties()[1]) 
        mp.CreateNewElement("TotalLagrangianElement3D4N", 23,[15,8,4,2], mp.GetProperties()[1]) 
        mp.CreateNewElement("TotalLagrangianElement3D4N", 24,[10,9,2,15], mp.GetProperties()[1]) 
        mp.CreateNewElement("TotalLagrangianElement3D4N", 25,[10,3,2,12], mp.GetProperties()[1]) 
        mp.CreateNewElement("TotalLagrangianElement3D4N", 26,[12,10,9,2], mp.GetProperties()[1]) 
        mp.CreateNewElement("TotalLagrangianElement3D4N", 27,[6,1,2,12], mp.GetProperties()[1]) 
        mp.CreateNewElement("TotalLagrangianElement3D4N", 28,[12,5,1,2], mp.GetProperties()[1]) 
        mp.CreateNewElement("TotalLagrangianElement3D4N", 29,[12,6,3,2], mp.GetProperties()[1]) 
        mp.CreateNewElement("TotalLagrangianElement3D4N", 30,[5,9,2,12], mp.GetProperties()[1]) 
    ...
    def test_execution(self):
        ...
        self._test_TL_2D_quadrilateral()
        #self._test_TL_3D_tetra()
