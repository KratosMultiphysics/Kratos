...
class TestMultipointConstraints(KratosUnittest.TestCase):
    ...
    def _setup_solver(self, mp):
        ...
        self.builder_and_solver = KratosMultiphysics.ResidualBasedBlockBuilderAndSolverWithMpc(self.linear_solver)
...
class TestMultipointConstraintsTwo(TestMultipointConstraints):
    def _check_results(self, mp):
        disp1 = mp.Nodes[16].GetSolutionStepValue(KratosMultiphysics.DISPLACEMENT_X, 0)
        disp2 = mp.Nodes[6].GetSolutionStepValue(KratosMultiphysics.DISPLACEMENT_X, 0)
        self.assertAlmostEqual(disp1, disp2, 5)
        ...
        disp1 = 0.5*( mp.Nodes[16].GetSolutionStepValue(KratosMultiphysics.DISPLACEMENT_X, 0) + mp.Nodes[18].GetSolutionStepValue(KratosMultiphysics.DISPLACEMENT_X, 0) )
        disp2 = mp.Nodes[7].GetSolutionStepValue(KratosMultiphysics.DISPLACEMENT_X, 0)
        self.assertAlmostEqual(disp1, disp2, 5)

        disp1 = 0.5*( mp.Nodes[16].GetSolutionStepValue(KratosMultiphysics.DISPLACEMENT_Y, 0) + mp.Nodes[18].GetSolutionStepValue(KratosMultiphysics.DISPLACEMENT_Y, 0) )
        disp2 = mp.Nodes[7].GetSolutionStepValue(KratosMultiphysics.DISPLACEMENT_Y, 0)
        self.assertAlmostEqual(disp1, disp2, 5)
    ...
    def _setup_model_part(self,mp):
        ...
        #create Element
        mp.CreateNewElement("SmallDisplacementElement2D4N", 2, [  13,         10,         12,         15], mp.GetProperties()[1] )
        mp.CreateNewElement("SmallDisplacementElement2D4N", 4, [  10,         16,         18,         12], mp.GetProperties()[1] ) 
        mp.CreateNewElement("SmallDisplacementElement2D4N", 5, [  2 ,         4 ,         3 ,         1], mp.GetProperties()[1] ) 
        mp.CreateNewElement("SmallDisplacementElement2D4N", 6, [  5 ,         8 ,         4 ,         2], mp.GetProperties()[1] ) 
        mp.CreateNewElement("SmallDisplacementElement2D4N", 7, [  4 ,         7 ,         6 ,         3], mp.GetProperties()[1] ) 
        mp.CreateNewElement("SmallDisplacementElement2D4N", 8, [  8 ,         9 ,         7 ,         4], mp.GetProperties()[1] )
    ...
    def _apply_mpc_constraints(self,mp,cm):
        ...
        cm.AddMasterSlaveRelation(mp.Nodes[16],KratosMultiphysics.DISPLACEMENT_X, mp.Nodes[7], KratosMultiphysics.DISPLACEMENT_X,  0.5,0)
        cm.AddMasterSlaveRelation(mp.Nodes[18],KratosMultiphysics.DISPLACEMENT_X, mp.Nodes[7], KratosMultiphysics.DISPLACEMENT_X,  0.5,0)
        cm.AddMasterSlaveRelation(mp.Nodes[16],KratosMultiphysics.DISPLACEMENT_Y, mp.Nodes[7], KratosMultiphysics.DISPLACEMENT_Y,  0.5,0) 
        cm.AddMasterSlaveRelation(mp.Nodes[18],KratosMultiphysics.DISPLACEMENT_Y, mp.Nodes[7], KratosMultiphysics.DISPLACEMENT_Y,  0.5,0)
