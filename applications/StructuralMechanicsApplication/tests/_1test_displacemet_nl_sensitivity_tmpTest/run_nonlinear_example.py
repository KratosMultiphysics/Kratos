...
#    print("")
#    print("first order sen x = ", node.GetValue(DISPLACEMENT_NL_SENSITIVITY_FIRST_ORDER_X))
#    print("first order sen y = ", node.GetValue(DISPLACEMENT_NL_SENSITIVITY_FIRST_ORDER_Y))
#    print("first order sen z = ", node.GetValue(DISPLACEMENT_NL_SENSITIVITY_FIRST_ORDER_Z))
#    print("")
#    print("second order sen x = ", node.GetValue(DISPLACEMENT_NL_SENSITIVITY_SECOND_ORDER_X))
#    print("second order sen y = ", node.GetValue(DISPLACEMENT_NL_SENSITIVITY_SECOND_ORDER_Y))
#    print("second order sen z = ", node.GetValue(DISPLACEMENT_NL_SENSITIVITY_SECOND_ORDER_Z))
#    print("")
#    print("********************************************")
#    print("")
