...
#for node in model_part_adjoint.Nodes:
#    print("adjoint displacement" , node.GetSolutionStepValue(KratosMultiphysics.StructuralMechanicsApplication.ADJOINT_DISPLACEMENT))
