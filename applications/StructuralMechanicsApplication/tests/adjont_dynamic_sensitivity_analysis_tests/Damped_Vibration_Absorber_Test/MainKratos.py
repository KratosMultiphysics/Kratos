...
with controlledExecutionScope(_get_test_working_dir()):
    ...
    sensitivity = adjoint_model_part.Elements[2].GetValue(KratosMultiphysics.StructuralMechanicsApplication.NODAL_DISPLACEMENT_STIFFNESS_SENSITIVITY)
    print("\n sensitivity:", sensitivity[0])     
    print("\n ** finished computations ** \n")


    # Remove .h5 files after computation
