...
public:
    ...
    KRATOS_CLASS_POINTER_DEFINITION(CuttingPatternStrategy);
...
private:
    ...
    void PrintVtkFiles(const int rIterationNumber)
    {
        ...
        VtkOutput(BaseType::GetModelPart(), vtk_params).PrintOutput("cuttingpattern_"+postfix.str());
    }
