...
///@{
    ...
    // KRATOS_DEFINE_APPLICATION_VARIABLE(STRUCTURAL_MECHANICS_APPLICATION, int, NUMBER_FIBERS_Y)
    // KRATOS_DEFINE_APPLICATION_VARIABLE(STRUCTURAL_MECHANICS_APPLICATION, int, NUMBER_FIBERS_Z)
