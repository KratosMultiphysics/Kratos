...
typedef std::vector<MpcDataPointerType>
    *MpcDataPointerVectorType;
    ...
    KRATOS_DEFINE_APPLICATION_VARIABLE(STRUCTURAL_MECHANICS_APPLICATION, Vector, QUATERNION_VECTOR)
    KRATOS_DEFINE_APPLICATION_VARIABLE(STRUCTURAL_MECHANICS_APPLICATION, Vector, QUATERNION_SCALAR_VECTOR)

    //Total nodal variables
    KRATOS_DEFINE_APPLICATION_VARIABLE(STRUCTURAL_MECHANICS_APPLICATION, Vector, TOTAL_NODAL_DEFORMATION)
