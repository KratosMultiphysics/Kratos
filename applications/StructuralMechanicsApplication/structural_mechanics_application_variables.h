...
///@{
    ...
    KRATOS_DEFINE_APPLICATION_VARIABLE( STRUCTURAL_MECHANICS_APPLICATION, double, CHARACTERISTIC_INTERNAL_LENGTH)
    ...
    // non_local variable
    KRATOS_DEFINE_APPLICATION_VARIABLE(STRUCTURAL_MECHANICS_APPLICATION, double, NON_LOCAL_VARIABLE );
    KRATOS_DEFINE_APPLICATION_VARIABLE(STRUCTURAL_MECHANICS_APPLICATION, std::string, NON_LOCAL_VARIABLE_NAME );
    KRATOS_DEFINE_APPLICATION_VARIABLE(STRUCTURAL_MECHANICS_APPLICATION, std::string, EQUIVALENCE_PRINCIPLE_TYPE );
    KRATOS_DEFINE_APPLICATION_VARIABLE(STRUCTURAL_MECHANICS_APPLICATION, double, NON_LOCAL_EQUIVALENT_STRAIN_TENSION );
    KRATOS_DEFINE_APPLICATION_VARIABLE(STRUCTURAL_MECHANICS_APPLICATION, double, NON_LOCAL_EQUIVALENT_STRAIN_COMPRESSION );
}
