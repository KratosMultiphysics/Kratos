...
typedef std::vector<MpcDataPointerType>
    *MpcDataPointerVectorType;
    ...
    KRATOS_DEFINE_APPLICATION_VARIABLE( STRUCTURAL_MECHANICS_APPLICATION, Matrix , GEOMETRIC_STIFFNESS )
	  ...
	  KRATOS_DEFINE_APPLICATION_VARIABLE(STRUCTURAL_MECHANICS_APPLICATION,Vector, MATERIAL_ORIENTATION_VECTOR_1)
    ...
    KRATOS_DEFINE_APPLICATION_VARIABLE( STRUCTURAL_MECHANICS_APPLICATION, bool, STENBERG_STABILIZATION_SUITABLE )
