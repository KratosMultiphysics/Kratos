...
///@{
    ...
    KRATOS_DEFINE_APPLICATION_VARIABLE(STRUCTURAL_MECHANICS_APPLICATION, double, EULER_ANGLE_PHI)
    KRATOS_DEFINE_APPLICATION_VARIABLE(STRUCTURAL_MECHANICS_APPLICATION, double, EULER_ANGLE_THETA)
    KRATOS_DEFINE_APPLICATION_VARIABLE(STRUCTURAL_MECHANICS_APPLICATION, double, EULER_ANGLE_HI)
    ...
    KRATOS_DEFINE_APPLICATION_VARIABLE(STRUCTURAL_MECHANICS_APPLICATION, double, ISOTROPIC_ANISOTROPIC_YIELD_RATIO_X );
    KRATOS_DEFINE_APPLICATION_VARIABLE(STRUCTURAL_MECHANICS_APPLICATION, double, ISOTROPIC_ANISOTROPIC_YIELD_RATIO_Y );
    KRATOS_DEFINE_APPLICATION_VARIABLE(STRUCTURAL_MECHANICS_APPLICATION, double, ISOTROPIC_ANISOTROPIC_YIELD_RATIO_Z );
    KRATOS_DEFINE_APPLICATION_VARIABLE(STRUCTURAL_MECHANICS_APPLICATION, double, ISOTROPIC_ANISOTROPIC_YIELD_RATIO_XY );
    KRATOS_DEFINE_APPLICATION_VARIABLE(STRUCTURAL_MECHANICS_APPLICATION, double, ISOTROPIC_ANISOTROPIC_YIELD_RATIO_XZ );
    KRATOS_DEFINE_APPLICATION_VARIABLE(STRUCTURAL_MECHANICS_APPLICATION, double, ISOTROPIC_ANISOTROPIC_YIELD_RATIO_YZ );
}
