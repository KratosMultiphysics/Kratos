...
///@{
    ...
    KRATOS_DEFINE_APPLICATION_VARIABLE(STRUCTURAL_MECHANICS_APPLICATION, Vector, SEMI_RIGID_NODE_IDS)
    KRATOS_DEFINE_APPLICATION_VARIABLE(STRUCTURAL_MECHANICS_APPLICATION, Vector, SEMI_RIGID_ROTATIONAL_STIFFNESS_VECTOR_AXIS_2)
    KRATOS_DEFINE_APPLICATION_VARIABLE(STRUCTURAL_MECHANICS_APPLICATION, Vector, SEMI_RIGID_ROTATIONAL_STIFFNESS_VECTOR_AXIS_3)
