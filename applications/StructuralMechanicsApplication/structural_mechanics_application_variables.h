...
///@{
    ...
    KRATOS_DEFINE_APPLICATION_VARIABLE( STRUCTURAL_MECHANICS_APPLICATION, ConstitutiveLaw::VoigtSizeMatrixType, ELASTICITY_TENSOR )
    ...
    KRATOS_DEFINE_APPLICATION_VARIABLE(STRUCTURAL_MECHANICS_APPLICATION, ConstitutiveLaw::VoigtSizeVectorType, MEMBRANE_PRESTRESS)
    KRATOS_DEFINE_APPLICATION_VARIABLE(STRUCTURAL_MECHANICS_APPLICATION, ConstitutiveLaw::VoigtSizeVectorType, PRESTRESS_VECTOR)
    ...
    KRATOS_DEFINE_APPLICATION_VARIABLE( STRUCTURAL_MECHANICS_APPLICATION, ConstitutiveLaw::VoigtSizeVectorType, HENCKY_STRAIN_VECTOR);
    KRATOS_DEFINE_APPLICATION_VARIABLE( STRUCTURAL_MECHANICS_APPLICATION, ConstitutiveLaw::DeformationGradientMatrixType, HENCKY_STRAIN_TENSOR);

    KRATOS_DEFINE_APPLICATION_VARIABLE( STRUCTURAL_MECHANICS_APPLICATION, double, VON_MISES_STRESS )

    KRATOS_DEFINE_APPLICATION_VARIABLE( STRUCTURAL_MECHANICS_APPLICATION, ConstitutiveLaw::DeformationGradientMatrixType, REFERENCE_DEFORMATION_GRADIENT);
    ...
    KRATOS_DEFINE_APPLICATION_VARIABLE(STRUCTURAL_MECHANICS_APPLICATION, ConstitutiveLaw::VoigtSizeVectorType, STRESS_ON_GP );
    KRATOS_DEFINE_APPLICATION_VARIABLE(STRUCTURAL_MECHANICS_APPLICATION, ConstitutiveLaw::VoigtSizeVectorType, STRESS_ON_NODE );
