...
//ROCO NET
KRATOS_DEFINE_VARIABLE(double, KB_ROCCO)
KRATOS_DEFINE_VARIABLE(double, DIAMETER_ROCCO)
KRATOS_DEFINE_VARIABLE(double, WIRE_THICKNESS_ROCCO)
KRATOS_DEFINE_VARIABLE(int, WIRE_WINDINGS_ROCCO)
KRATOS_DEFINE_VARIABLE(double, NODAL_MASS_ROCCO)
KRATOS_DEFINE_VARIABLE(int, KT_MULT_ROCCO)
