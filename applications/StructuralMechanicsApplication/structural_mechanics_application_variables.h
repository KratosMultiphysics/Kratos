...
typedef std::vector<MpcDataPointerType>
    *MpcDataPointerVectorType;
	...
	KRATOS_DEFINE_APPLICATION_VARIABLE(STRUCTURAL_MECHANICS_APPLICATION, std::string, TRACED_STRESS_TYPE); 
	...
	KRATOS_DEFINE_APPLICATION_VARIABLE(STRUCTURAL_MECHANICS_APPLICATION, Matrix, STRESS_DV_DERIV_ON_NODE); 
	KRATOS_DEFINE_APPLICATION_VARIABLE(STRUCTURAL_MECHANICS_APPLICATION, Matrix, STRESS_DV_DERIV_ON_GP); 
