...
import KratosMultiphysics.PfemMeltingApplication as PfemMelting

class FluidSolverCustomized(KratosMultiphysics.FluidDynamicsApplication.navier_stokes_solver_vmsmonolithic.NavierStokesSolverMonolithic):
        ...
        # Cases in which a time scheme manages the time integration
            ...
            if self.settings["time_scheme"].GetString() == "bossak":
                if self.settings["consider_periodic_conditions"].GetBool() == True:
                    scheme = PfemMelting.ResidualBasedPredictorCorrectorVelocityBossakSchemeTurbulentWithNoNodeDisplacement(
