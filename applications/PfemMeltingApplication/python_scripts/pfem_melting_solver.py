...
import KratosMultiphysics.PfemMeltingApplication.check_and_prepare_model_process_convection_diffusion as check_and_prepare_model_process

# Importing the base class
from KratosMultiphysics.python_solver import PythonSolver

def CreateSolver(model, custom_settings):
    return PfemMeltingSolver(model, custom_settings)

class PfemMeltingSolver(PythonSolver):
    ...
    def __init__(self, model, custom_settings):
        ...
        self._PfemMeltingVariablesCheck(custom_settings)
        kjkjkjkj
