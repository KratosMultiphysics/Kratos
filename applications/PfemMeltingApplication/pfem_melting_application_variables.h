...
KRATOS_DEFINE_APPLICATION_VARIABLE( PFEM_MELTING_APPLICATION, double, SCALARVELOCITY_X)
KRATOS_DEFINE_APPLICATION_VARIABLE( PFEM_MELTING_APPLICATION, double, SCALARVELOCITY_Y)
KRATOS_DEFINE_APPLICATION_VARIABLE( PFEM_MELTING_APPLICATION, double, SCALARVELOCITY_Z)
