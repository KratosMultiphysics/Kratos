 ...
 */
template <>
void QFLUID<2>::EquationIdVector(EquationIdVectorType& rResult,
...
/**
 * @see QFLUID::EquationIdVector
 */
template <>
void QFLUID<3>::EquationIdVector(EquationIdVectorType& rResult,
                              const ProcessInfo& rCurrentProcessInfo) const
{
...
/**
 * @see QFLUID::GetDofList
 */
template <>
void QFLUID<2>::GetDofList(DofsVectorType& rElementalDofList,
                        const ProcessInfo& rCurrentProcessInfo) const
{
    const unsigned int NumNodes(3),LocalSize(6);
 ...
 */
template <>
void QFLUID<3>::GetDofList(DofsVectorType& rElementalDofList,
                        const ProcessInfo& rCurrentProcessInfo) const
{
    const unsigned int NumNodes(4),LocalSize(12);
    if (rElementalDofList.size() != LocalSize)
...
/**
 * @see QFLUID::GetFirstDerivativesVector
 */
template <>
void QFLUID<2>::GetFirstDerivativesVector(Vector& Values, int Step) const
{
    const unsigned int NumNodes(3),LocalSize(6);
    unsigned int LocalIndex = 0;
 ...
 */
template <>
void QFLUID<3>::GetFirstDerivativesVector(Vector& Values, int Step) const
{
    const unsigned int NumNodes(4),LocalSize(12);
    unsigned int LocalIndex = 0;
...
/**
 * @see QFLUID::GetSecondDerivativesVector
 */
template <>
void QFLUID<2>::GetSecondDerivativesVector(Vector& Values, int Step) const
{
    const unsigned int NumNodes(3),LocalSize(6);
    unsigned int LocalIndex = 0;
 ...
 */
template <>
void QFLUID<3>::GetSecondDerivativesVector(Vector& Values, int Step) const
{
    const unsigned int NumNodes(4),LocalSize(12);
    unsigned int LocalIndex = 0;
 ...
 * Area = Pi * (h/2)^2
 * @see QFLUID::ElementSize
 */
template <>
double QFLUID<2,3>::ElementSize(const double Area)
{
 ...
 */
template <>
double QFLUID<3,4>::ElementSize(const double Volume)
{
...
/**
 * @see QFLUID::CalculateOnIntegrationPoints
 */
template <>
void QFLUID<2>::CalculateOnIntegrationPoints(
 ...
 */
template <>
void QFLUID<3>::CalculateOnIntegrationPoints(
    const Variable<array_1d<double,3> >& rVariable,
    std::vector<array_1d<double,3> >& rOutput,
    const ProcessInfo& rCurrentProcessInfo)
{}
...
template<>
double QFLUID<2,3>::ConsistentMassCoef(const double Area)
{
...
template<>
double QFLUID<3,4>::ConsistentMassCoef(const double Volume)
{
