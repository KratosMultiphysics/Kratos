...
void AddCustomUtilitiesToPython(pybind11::module &m)
{
    ...
    py::class_<PartitionedFSIUtilities<TSpace,double,2>, PartitionedFSIUtilities<TSpace,double,2>::Pointer>(m,"PartitionedFSIUtilitiesDouble2D")
        ...
        .def("UpdateInterfaceValues",&PartitionedFSIUtilities<TSpace,double,2>::UpdateInterfaceValuesArray)
        .def("UpdateInterfaceValues",&PartitionedFSIUtilities<TSpace,double,2>::UpdateInterfaceValuesDouble)
        .def("ComputeInterfaceResidualVector",&PartitionedFSIUtilities<TSpace,double,2>::ComputeInterfaceResidualVector)
        .def("ComputeFluidInterfaceMeshVelocityResidualNorm",&PartitionedFSIUtilities<TSpace,double,2>::ComputeFluidInterfaceMeshVelocityResidualNorm)
    ...
    py::class_<PartitionedFSIUtilities<TSpace,double,3>, PartitionedFSIUtilities<TSpace,double,3>::Pointer>(m,"PartitionedFSIUtilitiesDouble3D")
        ...
        .def("UpdateInterfaceValues", &PartitionedFSIUtilities<TSpace, double,3>::UpdateInterfaceValuesArray)
        .def("UpdateInterfaceValues", &PartitionedFSIUtilities<TSpace, double,3>::UpdateInterfaceValuesDouble)
        .def("ComputeInterfaceResidual", &PartitionedFSIUtilities<TSpace, double,3>::ComputeInterfaceResidualVector)
        .def("ComputeFluidInterfaceMeshVelocityResidualNorm", &PartitionedFSIUtilities<TSpace, double,3>::ComputeFluidInterfaceMeshVelocityResidualNorm)
