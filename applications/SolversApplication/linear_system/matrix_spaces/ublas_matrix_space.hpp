...
#if !defined(KRATOS_UBLAS_MATRIX_SPACE_H_INCLUDED )
#define  KRATOS_UBLAS_MATRIX_SPACE_H_INCLUDED
...
class UBlasSpace
{
 public:
  ...
  typedef SolutionUpdater< UBlasSpace<TDataType,TMatrixType,TVectorType> > SolutionUpdaterType;
  typedef typename SolutionUpdaterType::UniquePointer               SolutionUpdaterPointerType;
...
#pragma omp parallel for firstprivate(size)
  ...
  static SolutionUpdaterPointerType CreateSolutionUpdater()
  {
    SolutionUpdaterType tmp;
    return tmp.Create();
  }
...
#endif // KRATOS_UBLAS_MATRIX_SPACE_H_INCLUDED  defined
