...
#if !defined(KRATOS_SYSTEM_BUILDER_AND_SOLVER_H_INCLUDED)
#define KRATOS_SYSTEM_BUILDER_AND_SOLVER_H_INCLUDED
...
#endif // KRATOS_SYSTEM_BUILDER_AND_SOLVER_H_INCLUDED defined
