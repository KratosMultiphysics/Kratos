...
/** @brief Explicit System Builder and Solver base class
...
template<class TSparseSpace,
         ...
         >
class ExplicitBuilderAndSolver : public SystemBuilderAndSolver< TSparseSpace, TDenseSpace, TLinearSolver >
{
 public:
