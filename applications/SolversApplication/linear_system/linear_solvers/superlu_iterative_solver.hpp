...
#if !defined(KRATOS_SUPERLU_GMRES_ITERATIVE_SOLVER_H_INCLUDED )
#define  KRATOS_SUPERLU_GMRES_ITERATIVE_SOLVER_H_INCLUDED
...
class SuperLUIterativeSolver : public DirectSolver< TSparseSpaceType, TDenseSpaceType, TReordererType>
{
 public:
  /**
...
#endif // KRATOS_SUPERLU_GMRES_ITERATIVE_SOLVER_H_INCLUDED  defined
