...
class EigenSolver(BaseSolver.MonolithicSolver):
    ...
    def _create_solution_scheme(self):
        ...
        if self.settings["time_integration_settings"]["solution_type"].GetString() == "Dynamic":
            solution_scheme = KratosSolver.EigensolverScheme()
        else:
    ...
    def _create_linear_solver(self):
        ...
        """
        if self.eigensolver_settings["solver_type"].GetString() == "ks_feast_eigen":
            ...
            if feast_system_solver_settings["solver_type"].GetString() == "complex_skyline_lu_solver":
                ...
                linear_solver = KratosSolver.ks_feast_eigen(self.eigensolver_settings)
                ...
                linear_solver = KratosSolver.ks_feast_eigen(self.eigensolver_settings,feast_system_solver)
            else:
