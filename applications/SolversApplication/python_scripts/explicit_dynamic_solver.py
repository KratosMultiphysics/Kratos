...
class ExplicitMonolithicSolver(BaseSolver.MonolithicSolver):
    ...
    def _create_solution_scheme(self):
        ...
        options.Set(KratosSolver.SolverLocalFlags.RAYLEIGH_DAMPING, self.settings["solving_strategy_settings"]["rayleigh_damping"].GetBool())

        if(integration_method == "CentralDifferences"):
            solution_scheme = KratosSolver.ExplicitCentralDifferencesScheme(options,
    ...
    def _create_explicit_strategy(self):
        ...
        return KratosSolver.ExplicitStrategy(self.model_part, solution_scheme, options)


        #return KratosSolver.ExplicitStrategy(self.model_part,
        #                                     solution_scheme,
        #                                     linear_solver,
