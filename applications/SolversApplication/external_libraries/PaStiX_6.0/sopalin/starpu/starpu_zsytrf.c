 ...
 ******************************************************************************/
void
starpu_zsytrf_sp1dplus( sopalin_data_t              *sopalin_data,
                        starpu_sparse_matrix_desc_t *desc )
{
    ...
    for (k=0; k<solvmtx->cblknbr; k++, cblk++){
        ...
        starpu_task_cblk_zsytrfsp1d_panel( sopalin_data, cblk,
                                           cblknbr - k );
 ...
 ******************************************************************************/
void
starpu_zsytrf_sp2d( sopalin_data_t              *sopalin_data,
                    starpu_sparse_matrix_desc_t *desc )
{
    const SolverMatrix *solvmtx = sopalin_data->solvmtx;
    SolverCblk         *cblk, *fcblk;
    ...
    for (k=solvmtx->cblkmin2d; k<solvmtx->cblknbr; k++, cblk++, cblkhandle++){
        ...
        if ( !(cblk->cblktype & CBLK_IN_SCHUR) )
        {
            starpu_task_blok_zsytrf( sopalin_data, cblk,
                                     cblknbr - k );
            ...
            for(blokA=cblk->fblokptr + 1, m=0; blokA<lblk; blokA++, m++) {
                ...
                starpu_task_blok_zscalo( PastixTrans,
                                         cblk, blokA, sopalin_data,
                                         cblknbr - k );
               ...
               sopalin_data_t *sopalin_data )
{
    ...
    {
        starpu_zsytrf_sp2d( sopalin_data, sdesc );
    }
    else
    {
        starpu_zsytrf_sp1dplus( sopalin_data, sdesc );
    }
