...
!!!!!!!!!!!!! ALLOCATE VARIABLE 
  ...
  allocate(XL(1:n,1:M0)) ! Eigenvectors
  allocate(resr(1:M0))   ! Residual (if needed)
  allocate(resl(1:M0))   ! Residual (if needed)

!!!!!!!!!!!!!  FEAST
 
  call zfeast_sbevx(UPLO,N,kl,A,LDA,feastparam,epsout,loop,Emid,r,M0,E,XR,M,resr,info,Zne,Wne)
  !call zfeast_gbevx(UPLO,N,kl,A,LDA,feastparam,epsout,loop,Emid,r,M0,E,XR,XL,M,resr,resl,info,Zne,Wne)
