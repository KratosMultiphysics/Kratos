...
class TemporalRootMeanSquareMethodTests(KratosUnittest.TestCase):
    def setUp(self):
    ...
    def testRootMeanSquareHistoricalHistoricalValueMethod(self):
        norm_type = "none"
        settings = TemporalRootMeanSquareMethodTests.__GetDefaultSettings(
    ...
    def testRootMeanSquareHistoricalNonHistoricalValueMethod(self):
        norm_type = "none"
        settings = TemporalRootMeanSquareMethodTests.__GetDefaultSettings(
    ...
    def testRootMeanSquareHistoricalHistoricalNormMethod(self):
        norm_type = "magnitude"
        settings = TemporalRootMeanSquareMethodTests.__GetDefaultSettings(
            norm_type, "nodal_historical_historical")
        self.__TestMethod(norm_type, settings, self.model_part.Nodes,
    ...
    def testRootMeanSquareHistoricalNonHistoricalNormMethod(self):
        norm_type = "magnitude"
        settings = TemporalRootMeanSquareMethodTests.__GetDefaultSettings(
            norm_type, "nodal_historical_non_historical")
        self.__TestMethod(norm_type, settings, self.model_part.Nodes,
    ...
    def testRootMeanSquareNodalNonHistoricalValueMethod(self):
        norm_type = "none"
        settings = TemporalRootMeanSquareMethodTests.__GetDefaultSettings(
    ...
    def testRootMeanSquareNodalNonHistoricalNormMethod(self):
        norm_type = "magnitude"
        settings = TemporalRootMeanSquareMethodTests.__GetDefaultSettings(
            norm_type, "nodal_non_historical")
        self.__TestMethod(norm_type, settings, self.model_part.Nodes,
    ...
    def testRootMeanSquareConditionNonHistoricalValueMethod(self):
        norm_type = "none"
        settings = TemporalRootMeanSquareMethodTests.__GetDefaultSettings(
    ...
    def testRootMeanSquareConditionNonHistoricalNormMethod(self):
        norm_type = "magnitude"
        settings = TemporalRootMeanSquareMethodTests.__GetDefaultSettings(
            norm_type, "condition_non_historical")
        self.__TestMethod(norm_type, settings, self.model_part.Conditions,
    ...
    def testRootMeanSquareElementNonHistoricalValueMethod(self):
        norm_type = "none"
        settings = TemporalRootMeanSquareMethodTests.__GetDefaultSettings(
    ...
    def testRootMeanSquareElementNonHistoricalNormMethod(self):
        norm_type = "magnitude"
        settings = TemporalRootMeanSquareMethodTests.__GetDefaultSettings(
            norm_type, "element_non_historical")
        self.__TestMethod(norm_type, settings, self.model_part.Elements,
    ...
    def __TestMethod(self, norm_type, settings, container, input_method,
        ...
        for step in range(0, 12, 2):
            ...
            for index, item in enumerate(container):
                ...
                analytical_method_scalar = TemporalRootMeanSquareMethodTests.__AnalyticalMethod(
                    norm_type, Kratos.PRESSURE, scalar_list[index])
                analytical_method_vec_3d = TemporalRootMeanSquareMethodTests.__AnalyticalMethod(
                    norm_type, Kratos.VELOCITY, vec_3d_list[index])
                analytical_method_vec = TemporalRootMeanSquareMethodTests.__AnalyticalMethod(
                    norm_type, Kratos.LOAD_MESHES, vec_list[index])
                analytical_method_mat = TemporalRootMeanSquareMethodTests.__AnalyticalMethod(
