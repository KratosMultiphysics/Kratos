...
class NormTests(KratosUnittest.TestCase):
    ...
    def testVector3DNorms(self):
        ...
        norm_method = MethodUtilities.GetNormMethod(variable, norm_type)
        method_value = norm_method(value)
        analytical_value = pow(pow(value[0], 2) + pow(value[1], 2) + pow(value[2], 2), 0.5)
        self.assertAlmostEqual(method_value, analytical_value, 8)
        ...
        norm_method = MethodUtilities.GetNormMethod(variable, norm_type)
        method_value = norm_method(value)
        analytical_value = max(fabs(value[0]), max(fabs(value[1]), fabs(value[2])))
        self.assertAlmostEqual(method_value, analytical_value, 8)

        norm_type = "pnorm_2.5"
        norm_method = MethodUtilities.GetNormMethod(variable, norm_type)
        method_value = norm_method(value)
        analytical_value = pow(pow(fabs(value[0]), 2.5) + pow(fabs(value[1]), 2.5) + pow(fabs(value[2]), 2.5), 1/2.5)
        self.assertAlmostEqual(method_value, analytical_value, 8)
    ...
    def testVectorNorms(self):
        ...
        norm_method = MethodUtilities.GetNormMethod(variable, norm_type)
        method_value = norm_method(value)
        analytical_value = pow(pow(value[0], 2) + pow(value[1], 2) + pow(value[2], 2) + pow(value[3], 2), 0.5)
        self.assertAlmostEqual(method_value, analytical_value, 8)

        norm_type = "infinity"
        norm_method = MethodUtilities.GetNormMethod(variable, norm_type)
        method_value = norm_method(value)
        analytical_value = max(fabs(value[0]), max(fabs(value[1]), max(fabs(value[2]), fabs(value[3]))))
        self.assertAlmostEqual(method_value, analytical_value, 8)
        ...
        norm_method = MethodUtilities.GetNormMethod(variable, norm_type)
        method_value = norm_method(value)
        analytical_value = pow(pow(fabs(value[0]), 2.5) + pow(fabs(value[1]), 2.5) + pow(fabs(value[2]), 2.5) + pow(fabs(value[3]), 2.5), 1/2.5)
        self.assertAlmostEqual(method_value, analytical_value, 8)
    ...
    def testMatrixNorms(self):
        ...
        norm_method = MethodUtilities.GetNormMethod(variable, norm_type)
        method_value = norm_method(value)
        analytical_value = pow(pow(value[0,0], 2) + pow(value[0,1], 2) + pow(value[1,0], 2) + pow(value[1,1], 2), 0.5)
        self.assertAlmostEqual(method_value, analytical_value, 8)
        ...
        norm_method = MethodUtilities.GetNormMethod(variable, norm_type)
        method_value = norm_method(value)
        analytical_value = max(fabs(value[0,0]) + fabs(value[0,1]),fabs(value[1,0]) + fabs(value[1,1]))
        self.assertAlmostEqual(method_value, analytical_value, 8)
        ...
        norm_method = MethodUtilities.GetNormMethod(variable, norm_type)
        method_value = norm_method(value)
        analytical_value = pow(pow(fabs(value[0,0]), 2.5) + pow(fabs(value[0,1]), 2.5) + pow(fabs(value[1,0]), 2.5) + pow(fabs(value[1,1]), 2.5), 1/2.5)
        self.assertAlmostEqual(method_value, analytical_value, 8)
        ...
        analytical_value = pow(
                pow(
                    pow(fabs(value[0,0]), 2.5) +
                    pow(fabs(value[1,0]), 2.5),
                    2.1/2.5) +
                pow(
                    pow(fabs(value[0,1]), 2.5) +
                    pow(fabs(value[1,1]), 2.5),
                    2.1/2.5),
                1/2.1)
        self.assertAlmostEqual(method_value, analytical_value, 8)
