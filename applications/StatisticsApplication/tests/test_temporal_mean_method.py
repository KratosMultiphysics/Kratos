...
class TemporalMeanMethodTests(KratosUnittest.TestCase):
    ...
    def __TestMethod(self, norm_type, settings, container, input_method, output_method):
        ...
        scalar_list, vec_3d_list, vec_list, mat_list = InitializeContainerArrays(container)
    ...
    def __AddNodalSolutionStepVariables(self):
        ...
        self.model_part.AddNodalSolutionStepVariable(Kratos.GREEN_LAGRANGE_STRAIN_TENSOR)
        ...
        self.model_part.AddNodalSolutionStepVariable(Kratos.MATERIAL_PARAMETERS)
        self.model_part.AddNodalSolutionStepVariable(Kratos.CAUCHY_STRESS_TENSOR)
