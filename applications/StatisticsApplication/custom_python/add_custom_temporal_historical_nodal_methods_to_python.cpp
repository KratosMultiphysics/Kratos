...
{
    auto container_module = m.def_submodule("HistoricalOutput");

    auto value_module = container_module.def_submodule("ValueMethods");
    {
        auto method_module = value_module.def_submodule("Sum");
        using current_method = TemporalMethods::HistoricalInputHistoricalOutputTemporalMethods::SumMethod;
    ...
    }
    {
        ...
        using current_method = TemporalMethods::HistoricalInputHistoricalOutputTemporalMethods::MeanMethod;
        py::class_<current_method::ValueMethod<type_double>, current_method::ValueMethod<type_double>::Pointer,
                   TemporalMethods::TemporalMethod>(method_module, "Double")
            .def(py::init<ModelPart&, const std::string&, const Variable<type_double>&,
                          const Variable<type_double>&>());
    ...
    }
    {
        ...
        using current_method = TemporalMethods::HistoricalInputHistoricalOutputTemporalMethods::VarianceMethod;
        py::class_<current_method::ValueMethod<type_double>, current_method::ValueMethod<type_double>::Pointer,
                   TemporalMethods::TemporalMethod>(method_module, "Double")
            .def(py::init<ModelPart&, const std::string&, const Variable<type_double>&,
    ...
    }
    {
        ...
        using current_method = TemporalMethods::HistoricalInputHistoricalOutputTemporalMethods::MaxMethod;
        py::class_<current_method::NormMethod<type_double>, current_method::NormMethod<type_double>::Pointer,
                   TemporalMethods::TemporalMethod>(method_module, "Double")
            .def(py::init<ModelPart&, const std::string&, const Variable<type_double>&,
                          const Variable<double>&, const Variable<double>&>());
    ...
    }
    {
        ...
        using current_method = TemporalMethods::HistoricalInputHistoricalOutputTemporalMethods::MinMethod;
        py::class_<current_method::NormMethod<type_double>, current_method::NormMethod<type_double>::Pointer,
                   TemporalMethods::TemporalMethod>(method_module, "Double")
            .def(py::init<ModelPart&, const std::string&, const Variable<type_double>&,
                          const Variable<double>&, const Variable<double>&>());
...
{
    auto container_module = m.def_submodule("NonHistoricalOutput");

    auto value_module = container_module.def_submodule("ValueMethods");
    {
        auto method_module = value_module.def_submodule("Sum");
        using current_method = TemporalMethods::HistoricalInputNonHistoricalOutputTemporalMethods::SumMethod;
        py::class_<current_method::ValueMethod<type_double>, current_method::ValueMethod<type_double>::Pointer,
                   TemporalMethods::TemporalMethod>(method_module, "Double")
            .def(py::init<ModelPart&, const std::string&, const Variable<type_double>&,
                          const Variable<type_double>&>());
    ...
    {
        auto method_module = value_module.def_submodule("Mean");
        using current_method = TemporalMethods::HistoricalInputNonHistoricalOutputTemporalMethods::MeanMethod;
        py::class_<current_method::ValueMethod<type_double>, current_method::ValueMethod<type_double>::Pointer,
                   TemporalMethods::TemporalMethod>(method_module, "Double")
            .def(py::init<ModelPart&, const std::string&, const Variable<type_double>&,
                          const Variable<type_double>&>());
    ...
    {
        auto method_module = value_module.def_submodule("Variance");
        using current_method = TemporalMethods::HistoricalInputNonHistoricalOutputTemporalMethods::VarianceMethod;
        py::class_<current_method::ValueMethod<type_double>, current_method::ValueMethod<type_double>::Pointer,
                   TemporalMethods::TemporalMethod>(method_module, "Double")
            .def(py::init<ModelPart&, const std::string&, const Variable<type_double>&,
                          const Variable<type_double>&, const Variable<type_double>&>());
    ...
    {
        auto method_module = norm_module.def_submodule("Max");
        using current_method = TemporalMethods::HistoricalInputNonHistoricalOutputTemporalMethods::MaxMethod;
        py::class_<current_method::NormMethod<type_double>, current_method::NormMethod<type_double>::Pointer,
                   TemporalMethods::TemporalMethod>(method_module, "Double")
            .def(py::init<ModelPart&, const std::string&, const Variable<type_double>&,
                          const Variable<double>&, const Variable<double>&>());
    ...
    {
        auto method_module = norm_module.def_submodule("Min");
        using current_method = TemporalMethods::HistoricalInputNonHistoricalOutputTemporalMethods::MinMethod;
        py::class_<current_method::NormMethod<type_double>, current_method::NormMethod<type_double>::Pointer,
                   TemporalMethods::TemporalMethod>(method_module, "Double")
            .def(py::init<ModelPart&, const std::string&, const Variable<type_double>&,
                          const Variable<double>&, const Variable<double>&>());
