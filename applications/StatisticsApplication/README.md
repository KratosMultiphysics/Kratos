...
<a href="https://www.codecogs.com/eqnedit.php?latex=\color{White}{\underline{r}&space;=&space;\sum_{i=1}^N{\underline{x}_i}}" target="_blank"><img src="https://latex.codecogs.com/svg.latex?\color{White}{\underline{r}&space;=&space;\sum_{i=1}^N{\underline{x}_i}}" title="\color{White}{\underline{r} = \sum_{i=1}^N{\underline{x}_i}}" /></a>
...
<a href="https://www.codecogs.com/eqnedit.php?latex=\color{White}{\underline{r}&space;=&space;\sum_{i=1}^{n}{\underline{x}\Delta&space;t_i}&space;\quad&space;where&space;\quad&space;\Delta&space;t_i&space;=&space;T_{i}&space;-&space;T_{i-1}&space;\quad&space;\forall&space;T_i&space;\in&space;\left\lbrace&space;T_{initial},&space;...,&space;T_{end}&space;\right\rbrace}" target="_blank"><img src="https://latex.codecogs.com/svg.latex?\color{White}{\underline{r}&space;=&space;\sum_{i=1}^{n}{\underline{x}\Delta&space;t_i}&space;\quad&space;where&space;\quad&space;\Delta&space;t_i&space;=&space;T_{i}&space;-&space;T_{i-1}&space;\quad&space;\forall&space;T_i&space;\in&space;\left\lbrace&space;T_{initial},&space;...,&space;T_{end}&space;\right\rbrace}" title="\color{White}{\underline{r} = \sum_{i=1}^{n}{\underline{x}\Delta t_i} \quad where \quad \Delta t_i = T_{i} - T_{i-1} \quad \forall T_i \in \left\lbrace T_{initial}, ..., T_{end} \right\rbrace}" /></a>
...
<a href="https://www.codecogs.com/eqnedit.php?latex=\color{White}{\underline{r}&space;=&space;\frac{1}{N}\sum_{i=1}^{N}\underline{x}_i}" target="_blank"><img src="https://latex.codecogs.com/svg.latex?\color{White}{\underline{r}&space;=&space;\frac{1}{N}\sum_{i=1}^{N}\underline{x}_i}" title="\color{White}{\underline{r} = \frac{1}{N}\sum_{i=1}^{N}\underline{x}_i}" /></a>
...
<a href="https://www.codecogs.com/eqnedit.php?latex=\color{White}{\underline{r}&space;=&space;\sqrt{\frac{1}{N}\sum_{i=1}^{N}{\underline{x}^2_i}&space;}}" target="_blank"><img src="https://latex.codecogs.com/svg.latex?\color{White}{\underline{r}&space;=&space;\sqrt{\frac{1}{N}\sum_{i=1}^{N}{\underline{x}^2_i}&space;}}" title="\color{White}{\underline{r} = \sqrt{\frac{1}{N}\sum_{i=1}^{N}{\underline{x}^2_i} }}" /></a>
