...
{                                                                                                                                       \
    py::module spatial_module = (py::module) python_application_module.attr("SpatialMethods"); \
    py::module historical_module = (py::module) spatial_module.attr("Historical"); \
    py::module historical_value_module = (py::module) historical_module.attr("ValueMethods"); \
    py::module non_historical_module = (py::module) spatial_module.attr("NonHistorical"); \
    ...
    ADD_KRATOS_STATISTICS_SPATIAL_CONTAINER_VALUE_METHOD_PYTHON_INTERFACE(method, method_name, historical_value_module, HistoricalSpatialMethods) \
    ADD_KRATOS_STATISTICS_SPATIAL_CONTAINER_VALUE_METHOD_PYTHON_INTERFACE(method, method_name, non_historical_nodal_value_module, NodalNonHistoricalSpatialMethods) \
    ADD_KRATOS_STATISTICS_SPATIAL_CONTAINER_VALUE_METHOD_PYTHON_INTERFACE(method, method_name, non_historical_condition_value_module, ConditionNonHistoricalSpatialMethods) \
    ADD_KRATOS_STATISTICS_SPATIAL_CONTAINER_VALUE_METHOD_PYTHON_INTERFACE(method, method_name, non_historical_element_value_module, ElementNonHistoricalSpatialMethods) \
}
#endif
...
{                                                                                                                                       \
    py::module spatial_module = (py::module) python_application_module.attr("SpatialMethods"); \
    py::module historical_module = (py::module) spatial_module.attr("Historical"); \
    py::module historical_norm_module = (py::module) historical_module.attr("NormMethods"); \
    py::module non_historical_module = (py::module) spatial_module.attr("NonHistorical"); \
    py::module non_historical_nodal_module = (py::module) non_historical_module.attr("Nodes"); \
    py::module non_historical_nodal_norm_module = (py::module) non_historical_nodal_module.attr("NormMethods"); \
    py::module non_historical_condition_module = (py::module) non_historical_module.attr("Conditions"); \
    py::module non_historical_condition_norm_module = (py::module) non_historical_condition_module.attr("NormMethods"); \
    py::module non_historical_element_module = (py::module) non_historical_module.attr("Elements"); \
    py::module non_historical_element_norm_module = (py::module) non_historical_element_module.attr("NormMethods"); \
    ADD_KRATOS_STATISTICS_SPATIAL_CONTAINER_NORM_METHOD_PYTHON_INTERFACE(method, method_name, historical_norm_module, HistoricalSpatialMethods) \
    ADD_KRATOS_STATISTICS_SPATIAL_CONTAINER_NORM_METHOD_PYTHON_INTERFACE(method, method_name, non_historical_nodal_norm_module, NodalNonHistoricalSpatialMethods) \
    ADD_KRATOS_STATISTICS_SPATIAL_CONTAINER_NORM_METHOD_PYTHON_INTERFACE(method, method_name, non_historical_condition_norm_module, ConditionNonHistoricalSpatialMethods) \
    ADD_KRATOS_STATISTICS_SPATIAL_CONTAINER_NORM_METHOD_PYTHON_INTERFACE(method, method_name, non_historical_element_norm_module, ElementNonHistoricalSpatialMethods) \
}
#endif
