...
class TemporalMaxMethod : public TemporalMethod
{
public:
    using BaseType = TemporalMethod;

    KRATOS_CLASS_POINTER_DEFINITION(TemporalMaxMethod);

    TemporalMaxMethod(ModelPart& rModelPart) : BaseType(rModelPart)
    {
    }
