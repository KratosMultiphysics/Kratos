...
plotter.plot(range(0,number_of_sectors*30,30), fraction, label="DEM")
plotter.plot(range(0,number_of_sectors*30,30), fraction_exp_300,label="experiment, 300 rpm")
plotter.plot(range(0,number_of_sectors*30,30), fraction_exp_500,label="experiment, 500 rpm")
plotter.plot(range(0,number_of_sectors*30,30), fraction_exp_650,label="experiment, 650 rpm")
