...
class Solution(object):
    ...
    def __init__(self):
        ...
        [self.post_path, self.data_and_results, self.graphs_path, MPI_results] = self.procedures.CreateDirectories(str(self.main_path), str(self.DEM_parameters["problem_name"].GetString()))
    ...
    def Initialize(self):
        ...
        self.dt = min(self.DEM_parameters["MaxTimeStep"].GetDouble(), self.spheres_model_part.ProcessInfo.GetValue(DELTA_TIME)) # under revision. linked to automatic timestep? Possible modifications of DELTA_TIME
        ...
        self.report.total_steps_expected = int(self.DEM_parameters["FinalTime"].GetDouble() / self.dt)
    ...
    def ReadModelParts(self, max_node_Id = 0, max_elem_Id = 0, max_cond_Id = 0):
        ...
        rigidFace_mp_filename = self.DEM_parameters["problem_name"].GetString() + "DEM_FEM_boundary"
        ...
        clusters_mp_filename = self.DEM_parameters["problem_name"].GetString() + "DEM_Clusters"
        ...
        DEM_Inlet_filename = self.DEM_parameters["problem_name"].GetString() + "DEM_Inlet"
    ...
    def RunMainTemporalLoop(self):
        ...
        while self.time < self.DEM_parameters["FinalTime"].GetDouble():
