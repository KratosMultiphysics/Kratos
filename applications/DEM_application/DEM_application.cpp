...
KRATOS_CREATE_VARIABLE(int, FIXED_BOUNDARY)
KRATOS_CREATE_VARIABLE(int, IMPOSED_BODY_MOTION)
KRATOS_CREATE_VARIABLE(int, FREE_BODY_MOTION)
KRATOS_CREATE_VARIABLE(int, FIXED_MESH_OPTION)
KRATOS_CREATE_VARIABLE(int, PARTICLE_NO_DISPLACEMENT)
...
#undef ____CONVERT_TO_STRING
    ...
    KRATOS_REGISTER_VARIABLE(FIXED_BOUNDARY)
    KRATOS_REGISTER_VARIABLE(IMPOSED_BODY_MOTION)
    KRATOS_REGISTER_VARIABLE(FREE_BODY_MOTION)
    KRATOS_REGISTER_VARIABLE(FIXED_MESH_OPTION)
    KRATOS_REGISTER_VARIABLE(PARTICLE_NO_DISPLACEMENT)
