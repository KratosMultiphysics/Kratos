...
namespace Kratos
{
  ...
  KRATOS_CREATE_VARIABLE(double, SURFACE_FRICC_1)
  KRATOS_CREATE_VARIABLE(double, SURFACE_FRICC_2)
  KRATOS_CREATE_VARIABLE(double, SURFACE_FRICC_3)
  KRATOS_CREATE_VARIABLE(double, SURFACE_FRICC_4)
  KRATOS_CREATE_VARIABLE(double, SURFACE_FRICC_5)
  KRATOS_CREATE_VARIABLE(double, CYLINDER_FRICC_1)
  KRATOS_CREATE_VARIABLE(double, CYLINDER_FRICC_2)
  KRATOS_CREATE_VARIABLE(double, CYLINDER_FRICC_3)  
  KRATOS_CREATE_VARIABLE(double, CYLINDER_FRICC_4)
  KRATOS_CREATE_VARIABLE(double, CYLINDER_FRICC_5)
 ...
 //KRATOS_CREATE_VARIABLE(int, PARTICLE_FAILURE_ID)
  ...
  KRATOS_CREATE_VARIABLE(double, CYLINDER_VELOCITY)
  KRATOS_CREATE_VARIABLE(double, CYLINDER_ANGULAR_VELOCITY)
  KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(INITIAL_BASE_CYLINDER_CENTRE)   
  KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(CYLINDER_AXIS_DIR)     
  ...
  KRATOS_CREATE_VARIABLE(int, INT_DUMMY_10)
  ...
  void KratosDEMApplication::Register()
  {
    ...
    KRATOS_REGISTER_VARIABLE(SURFACE_FRICC_1)
    KRATOS_REGISTER_VARIABLE(SURFACE_FRICC_2)
    KRATOS_REGISTER_VARIABLE(SURFACE_FRICC_3)
    KRATOS_REGISTER_VARIABLE(SURFACE_FRICC_4)
    KRATOS_REGISTER_VARIABLE(SURFACE_FRICC_5)    
    KRATOS_REGISTER_VARIABLE(CYLINDER_FRICC_1)
    KRATOS_REGISTER_VARIABLE(CYLINDER_FRICC_2)    
    KRATOS_REGISTER_VARIABLE(CYLINDER_FRICC_3)
    KRATOS_REGISTER_VARIABLE(CYLINDER_FRICC_4)        
    KRATOS_REGISTER_VARIABLE(CYLINDER_FRICC_5)    
    ...
    KRATOS_REGISTER_VARIABLE(CYLINDER_VELOCITY)
    KRATOS_REGISTER_VARIABLE(CYLINDER_ANGULAR_VELOCITY)    
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(INITIAL_BASE_CYLINDER_CENTRE)
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(CYLINDER_AXIS_DIR)       
    ...
    KRATOS_REGISTER_VARIABLE(INT_DUMMY_10)
