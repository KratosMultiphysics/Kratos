...
KRATOS_CREATE_VARIABLE(int, TABLE_NUMBER_VELOCITY_X)
KRATOS_CREATE_VARIABLE(int, TABLE_NUMBER_VELOCITY_Y)
KRATOS_CREATE_VARIABLE(int, TABLE_NUMBER_VELOCITY_Z)
KRATOS_CREATE_VARIABLE(int, TABLE_NUMBER_ANGULAR_VELOCITY_X)
KRATOS_CREATE_VARIABLE(int, TABLE_NUMBER_ANGULAR_VELOCITY_Y)
KRATOS_CREATE_VARIABLE(int, TABLE_NUMBER_ANGULAR_VELOCITY_Z)
KRATOS_CREATE_VARIABLE(int, TABLE_NUMBER_FORCE_X)
KRATOS_CREATE_VARIABLE(int, TABLE_NUMBER_FORCE_Y)
KRATOS_CREATE_VARIABLE(int, TABLE_NUMBER_FORCE_Z)
KRATOS_CREATE_VARIABLE(int, TABLE_NUMBER_MOMENT_X)
KRATOS_CREATE_VARIABLE(int, TABLE_NUMBER_MOMENT_Y)
KRATOS_CREATE_VARIABLE(int, TABLE_NUMBER_MOMENT_Z)
...
void KratosDEMApplication::Register() {
    ...
    KRATOS_REGISTER_VARIABLE(TABLE_NUMBER_VELOCITY_X)
    KRATOS_REGISTER_VARIABLE(TABLE_NUMBER_VELOCITY_Y)
    KRATOS_REGISTER_VARIABLE(TABLE_NUMBER_VELOCITY_Z)
    KRATOS_REGISTER_VARIABLE(TABLE_NUMBER_ANGULAR_VELOCITY_X)
    KRATOS_REGISTER_VARIABLE(TABLE_NUMBER_ANGULAR_VELOCITY_Y)
    KRATOS_REGISTER_VARIABLE(TABLE_NUMBER_ANGULAR_VELOCITY_Z)
    KRATOS_REGISTER_VARIABLE(TABLE_NUMBER_FORCE_X)
    KRATOS_REGISTER_VARIABLE(TABLE_NUMBER_FORCE_Y)
    KRATOS_REGISTER_VARIABLE(TABLE_NUMBER_FORCE_Z)
    KRATOS_REGISTER_VARIABLE(TABLE_NUMBER_MOMENT_X)
    KRATOS_REGISTER_VARIABLE(TABLE_NUMBER_MOMENT_Y)
    KRATOS_REGISTER_VARIABLE(TABLE_NUMBER_MOMENT_Z)
