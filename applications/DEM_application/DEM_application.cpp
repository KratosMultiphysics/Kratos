...
namespace Kratos
{
 ...
 //KRATOS_CREATE_VARIABLE(int, PARTICLE_FAILURE_ID)
  ...
  KRATOS_CREATE_VARIABLE(double, MAX_BTB_INDENTATION)
  KRATOS_CREATE_VARIABLE(double, MAX_BTF_INDENTATION)
...
//  KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS( EXTERNAL_FORCE )
  ...
  void KratosDEMApplication::Register()
  {
    ...
    KRATOS_REGISTER_VARIABLE(MAX_BTB_INDENTATION)
    KRATOS_REGISTER_VARIABLE(MAX_BTF_INDENTATION)
