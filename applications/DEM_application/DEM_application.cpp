...
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(DELTA_ROTA_DISPLACEMENT) 
    ...
    KRATOS_CREATE_VARIABLE(double, RESTITUTION_COEF)
  ...
  void KratosDEMApplication::Register()
  {
    ...
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS( EULER_ANGLES )
            //KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS( VECTOR_ARROW_X )
    //KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS( VECTOR_ARROW_Y )
    //KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS( VECTOR_ARROW_Z )
