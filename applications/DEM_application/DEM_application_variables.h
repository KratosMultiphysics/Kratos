...
#define DEM_DETERMINANT_3x3(a0, a1, a2)            (a0[0] * (a1[1] * a2[2] - a1[2] * a2[1]) - a0[1] * (a1[0] * a2[2] - a1[2] * a2[0]) + a0[2] * (a1[0] * a2[1] - a1[1] * a2[0]))
  ...
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, vector<int>, SEARCH_CONTROL_VECTOR)
  ...
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, Vector, COORDINATES)

  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, std::vector<Condition*>, WALL_POINT_CONDITION_POINTERS)
  ...
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, boost::numeric::ublas::vector<int>,  NEIGHBOUR_IDS)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, Vector,  NEIGHBOURS_CONTACT_AREAS)
  // *************** Continuum only END ***************
  
      KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double, MAX_RADIUS)
      KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double, MIN_RADIUS)
