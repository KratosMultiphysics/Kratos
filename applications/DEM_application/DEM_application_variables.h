...
#define DEM_DETERMINANT_3x3(a0, a1, a2)            (a0[0] * (a1[1] * a2[2] - a1[2] * a2[1]) - a0[1] * (a1[0] * a2[2] - a1[2] * a2[0]) + a0[2] * (a1[0] * a2[1] - a1[1] * a2[0]))
  ...
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, int, TABLE_NUMBER_VELOCITY_X)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, int, TABLE_NUMBER_VELOCITY_Y)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, int, TABLE_NUMBER_VELOCITY_Z)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, int, TABLE_NUMBER_ANGULAR_VELOCITY_X)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, int, TABLE_NUMBER_ANGULAR_VELOCITY_Y)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, int, TABLE_NUMBER_ANGULAR_VELOCITY_Z)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, int, TABLE_NUMBER_FORCE_X)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, int, TABLE_NUMBER_FORCE_Y)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, int, TABLE_NUMBER_FORCE_Z)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, int, TABLE_NUMBER_MOMENT_X)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, int, TABLE_NUMBER_MOMENT_Y)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, int, TABLE_NUMBER_MOMENT_Z)
