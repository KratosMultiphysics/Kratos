...
#define DEM_DETERMINANT_3x3(a0, a1, a2)            (a0[0] * (a1[1] * a2[2] - a1[2] * a2[1]) - a0[1] * (a1[0] * a2[2] - a1[2] * a2[0]) + a0[2] * (a1[0] * a2[1] - a1[1] * a2[0]))
  ...
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, int, FIXED_BOUNDARY)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, int, IMPOSED_BODY_MOTION)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, int, FREE_BODY_MOTION)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, int, FIXED_MESH_OPTION)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, int, PARTICLE_NO_DISPLACEMENT)
