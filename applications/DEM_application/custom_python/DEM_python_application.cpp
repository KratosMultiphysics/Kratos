...
PYBIND11_MODULE(KratosDEMApplication,m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(FRICTION)
    ...
    //SLS DEM-FEM
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(FRICTION)        
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(PARTICLE_FRICTION) //deprecated since April 11th, 2018
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(WALL_FRICTION) //deprecated since April 11th, 2018
