...
PYBIND11_MODULE(KratosDEMApplication,m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, FIXED_BOUNDARY)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, IMPOSED_BODY_MOTION)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, FREE_BODY_MOTION)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, FIXED_MESH_OPTION)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, PARTICLE_NO_DISPLACEMENT)
