...
#if !defined(KRATOS_CORN3CLUSTER3D_H_INCLUDED )
#define  KRATOS_CORN3CLUSTER3D_H_INCLUDED
...
namespace Kratos
{
  ...
  */
    class Corn3Cluster3D : public Cluster3D
    {
    public:
      ...
      /// Pointer definition of Cluster3D
        KRATOS_CLASS_POINTER_DEFINITION(Corn3Cluster3D);
...
//         
        Corn3Cluster3D( );
        Corn3Cluster3D( IndexType NewId, GeometryType::Pointer pGeometry );
        Corn3Cluster3D( IndexType NewId, NodesArrayType const& ThisNodes);
        Corn3Cluster3D( IndexType NewId, GeometryType::Pointer pGeometry,  PropertiesType::Pointer pProperties );
...
//        }
  ...
  /// input stream function
    inline std::istream& operator >> (std::istream& rIStream, 
                    Corn3Cluster3D& rThis);

  /// output stream function
    inline std::ostream& operator << (std::ostream& rOStream, 
                    const Corn3Cluster3D& rThis)
    {
...
#endif // KRATOS_CORN3CLUSTER3D_INCLUDED  defined
