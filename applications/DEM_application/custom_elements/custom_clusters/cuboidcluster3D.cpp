...
//                    pow(pow(sin(u), 6) * (pow(sin(v), 6) + pow(cos(v), 6)) + pow(cos(u), 6), 0.166666667);
    ...
    void CuboidCluster3D::InitializeSolutionStep(const ProcessInfo& r_process_info) {
    ...
    void CuboidCluster3D::FinalizeSolutionStep(const ProcessInfo& r_process_info) {}
