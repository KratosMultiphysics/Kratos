...
namespace Kratos {
    ...
    void CapsuleCluster3D::InitializeSolutionStep(const ProcessInfo& r_process_info) {
    ...
    void CapsuleCluster3D::FinalizeSolutionStep(const ProcessInfo& r_process_info) {}
