...
namespace Kratos {
    ...
    void Ballast6Cluster3D::InitializeSolutionStep(const ProcessInfo& r_process_info) {
    ...
    void Ballast6Cluster3D::FinalizeSolutionStep(const ProcessInfo& r_process_info) {}
