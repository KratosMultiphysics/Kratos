...
namespace Kratos {
    ...
    void Ballast3Cluster3D::InitializeSolutionStep(const ProcessInfo& r_process_info) {
    ...
    void Ballast3Cluster3D::FinalizeSolutionStep(const ProcessInfo& r_process_info) {}
