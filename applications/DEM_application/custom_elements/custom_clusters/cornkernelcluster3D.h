...
#if !defined(KRATOS_CORNKERNELCLUSTER3D_H_INCLUDED )
#define  KRATOS_CORNKERNELCLUSTER3D_H_INCLUDED
...
namespace Kratos
{
    ...
    class CornKernelCluster3D : public Cluster3D
    {
    public:
      ...
      /// Pointer definition of Cluster3D
        KRATOS_CLASS_POINTER_DEFINITION(CornKernelCluster3D);
...
//         
        CornKernelCluster3D( );
        CornKernelCluster3D( IndexType NewId, GeometryType::Pointer pGeometry );
        CornKernelCluster3D( IndexType NewId, NodesArrayType const& ThisNodes);
        CornKernelCluster3D( IndexType NewId, GeometryType::Pointer pGeometry,  PropertiesType::Pointer pProperties );
...
//        }
  ...
  /// input stream function
    inline std::istream& operator >> (std::istream& rIStream, 
                    CornKernelCluster3D& rThis){
        return rIStream;
    }

  /// output stream function
    inline std::ostream& operator << (std::ostream& rOStream, 
                    const CornKernelCluster3D& rThis)
    {
...
#endif // KRATOS_CORNKERNELCLUSTER3D_INCLUDED  defined
