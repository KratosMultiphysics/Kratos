...
#if !defined(KRATOS_ROCK2CLUSTER3D_H_INCLUDED )
#define  KRATOS_ROCK2CLUSTER3D_H_INCLUDED
...
namespace Kratos
{
    ...
    class Rock2Cluster3D : public Cluster3D
    {
    public:
      ...
      /// Pointer definition of Cluster3D
        KRATOS_CLASS_POINTER_DEFINITION(Rock2Cluster3D);
...
//         
        Rock2Cluster3D( );
        Rock2Cluster3D( IndexType NewId, GeometryType::Pointer pGeometry );
        Rock2Cluster3D( IndexType NewId, NodesArrayType const& ThisNodes);
        Rock2Cluster3D( IndexType NewId, GeometryType::Pointer pGeometry,  PropertiesType::Pointer pProperties );
...
//        }
  ...
  /// input stream function
    inline std::istream& operator >> (std::istream& rIStream, 
                    Rock2Cluster3D& rThis){
        return rIStream;
    }

  /// output stream function
    inline std::ostream& operator << (std::ostream& rOStream, 
                    const Rock2Cluster3D& rThis)
    {
...
#endif // KRATOS_ROCK2CLUSTER3D_INCLUDED  defined
