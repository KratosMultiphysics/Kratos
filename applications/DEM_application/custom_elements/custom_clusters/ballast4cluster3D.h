...
#if !defined(KRATOS_BALLAST4CLUSTER3D_H_INCLUDED )
#define  KRATOS_BALLAST4CLUSTER3D_H_INCLUDED
...
namespace Kratos
{
  ...
  */
    class Ballast4Cluster3D : public Cluster3D
    {
    public:
      ...
      /// Pointer definition of Cluster3D
        KRATOS_CLASS_POINTER_DEFINITION(Ballast4Cluster3D);
...
//         
        Ballast4Cluster3D( );
        Ballast4Cluster3D( IndexType NewId, GeometryType::Pointer pGeometry );
        Ballast4Cluster3D( IndexType NewId, NodesArrayType const& ThisNodes);
        Ballast4Cluster3D( IndexType NewId, GeometryType::Pointer pGeometry,  PropertiesType::Pointer pProperties );
...
//        }
  ...
  /// input stream function
    inline std::istream& operator >> (std::istream& rIStream, 
                    Ballast4Cluster3D& rThis);

  /// output stream function
    inline std::ostream& operator << (std::ostream& rOStream, 
                    const Ballast4Cluster3D& rThis)
    {
...
#endif // KRATOS_BALLAST4CLUSTER3D_INCLUDED  defined
