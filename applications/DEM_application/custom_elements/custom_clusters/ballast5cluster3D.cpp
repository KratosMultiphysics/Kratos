...
namespace Kratos {
    ...
    void Ballast5Cluster3D::InitializeSolutionStep(const ProcessInfo& r_process_info) {
    ...
    void Ballast5Cluster3D::FinalizeSolutionStep(const ProcessInfo& r_process_info) {}
