...
namespace Kratos {
    ...
    void EllipsoidCluster3D::InitializeSolutionStep(const ProcessInfo& r_process_info) {
    ...
    void EllipsoidCluster3D::FinalizeSolutionStep(const ProcessInfo& r_process_info) {}
