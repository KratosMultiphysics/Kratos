...
#if !defined(KRATOS_RINGCLUSTER3D_H_INCLUDED )
#define  KRATOS_RINGCLUSTER3D_H_INCLUDED
...
namespace Kratos
{
    ...
    class RingCluster3D : public Cluster3D
    {
    public:
      ...
      /// Pointer definition of Cluster3D
        KRATOS_CLASS_POINTER_DEFINITION(RingCluster3D);
...
//         
        RingCluster3D( );
        RingCluster3D( IndexType NewId, GeometryType::Pointer pGeometry );
        RingCluster3D( IndexType NewId, NodesArrayType const& ThisNodes);
        RingCluster3D( IndexType NewId, GeometryType::Pointer pGeometry,  PropertiesType::Pointer pProperties );
...
#endif // KRATOS_RINGCLUSTER3D_INCLUDED  defined
