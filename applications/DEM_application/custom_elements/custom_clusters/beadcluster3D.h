...
namespace Kratos
{
    ...
    class BeadCluster3D : public Cluster3D
    {
    public:
      ...
      /// Pointer definition of Cluster3D
        KRATOS_CLASS_POINTER_DEFINITION(BeadCluster3D);
...
//         
        BeadCluster3D( );
        BeadCluster3D( IndexType NewId, GeometryType::Pointer pGeometry );
        BeadCluster3D( IndexType NewId, NodesArrayType const& ThisNodes);
        BeadCluster3D( IndexType NewId, GeometryType::Pointer pGeometry,  PropertiesType::Pointer pProperties );
