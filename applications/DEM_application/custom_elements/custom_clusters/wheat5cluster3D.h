...
#if !defined(KRATOS_WHEAT5CLUSTER3D_H_INCLUDED )
#define  KRATOS_WHEAT5CLUSTER3D_H_INCLUDED
...
namespace Kratos
{
    ...
    class Wheat5Cluster3D : public Cluster3D
    {
    public:
      ...
      /// Pointer definition of Cluster3D
        KRATOS_CLASS_POINTER_DEFINITION(Wheat5Cluster3D);
...
//         
        Wheat5Cluster3D( );
        Wheat5Cluster3D( IndexType NewId, GeometryType::Pointer pGeometry );
        Wheat5Cluster3D( IndexType NewId, NodesArrayType const& ThisNodes);
        Wheat5Cluster3D( IndexType NewId, GeometryType::Pointer pGeometry,  PropertiesType::Pointer pProperties );
...
//        }
  ...
  /// input stream function
    inline std::istream& operator >> (std::istream& rIStream, 
                    Wheat5Cluster3D& rThis){
        return rIStream;
    }

  /// output stream function
    inline std::ostream& operator << (std::ostream& rOStream, 
                    const Wheat5Cluster3D& rThis)
    {
...
#endif // KRATOS_WHEAT5CLUSTER3D_INCLUDED  defined
