...
namespace Kratos {
    ...
    void SoyBeanCluster3D::InitializeSolutionStep(const ProcessInfo& r_process_info) {
    ...
    void SoyBeanCluster3D::FinalizeSolutionStep(const ProcessInfo& r_process_info) {}
