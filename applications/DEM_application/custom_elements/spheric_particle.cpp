...
//           }
    ...
    //**************************************************************************************************************************************************
      ...
      void SphericParticle::CalculateRightHandSide(VectorType& rRightHandSideVector, ProcessInfo& rCurrentProcessInfo)
      {
          ...
          rRightHandSideVector[0] = contact_force[0] + mRealMass * gravity[0];
          rRightHandSideVector[1] = contact_force[1] + mRealMass * gravity[1];
          rRightHandSideVector[2] = contact_force[2] + mRealMass * gravity[2];
    ...
    //**************************************************************************************************************************************************
      ...
      void SphericParticle::ComputeBallToBallContactForce(array_1d<double, 3>& rContactForce, array_1d<double, 3>& rContactMoment, ProcessInfo& rCurrentProcessInfo)
      {
          ...
          if (mRotationOption == 1){
              ...
              MaxRotaMoment[0] = InitialRotaMoment[0] = RotaAcc[0] * mMomentOfInertia;
              MaxRotaMoment[1] = InitialRotaMoment[1] = RotaAcc[1] * mMomentOfInertia;
              MaxRotaMoment[2] = InitialRotaMoment[2] = RotaAcc[2] * mMomentOfInertia;
          }
