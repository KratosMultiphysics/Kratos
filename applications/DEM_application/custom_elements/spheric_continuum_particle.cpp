                                                                 ...
                                                                 double& RollingResistance)
    {
        ...
        for (unsigned int i = 0; i < mNeighbourElements.size(); i++) {
            ...
            if (this->Is(DEMFlags::HAS_ROTATION)) {
                ...
                RelativeDisplacementAndVelocityOfContactPointDueToRotationQuat(indentation, DeltDisp, RelVel, OldLocalCoordSystem, other_radius, data_buffer.mDt, ang_vel, neighbour_iterator);
            }
    ...
    */
    ...
    void SphericContinuumParticle::FinalizeSolutionStep(ProcessInfo& r_process_info) {
        ...
        if (this->Is(DEMFlags::HAS_ROTATION) ){
            ...
            GetGeometry()[0].FastGetSolutionStepValue(PRINCIPAL_MOMENTS_OF_INERTIA)[0] = GetGeometry()[0].FastGetSolutionStepValue(PRINCIPAL_MOMENTS_OF_INERTIA)[1] = GetGeometry()[0].FastGetSolutionStepValue(PRINCIPAL_MOMENTS_OF_INERTIA)[2] = CalculateMomentOfInertia();
        }
