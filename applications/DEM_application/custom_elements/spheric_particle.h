...
int    SlowGetParticleMaterial();
    ...
    protected:
        ...
        virtual void ComputeBallToRigidFaceContactForce(
        ...
        virtual void ComputeBallToBallContactForce(
                ParticleDataBuffer & data_buffer,
                ProcessInfo& r_process_info,
                array_1d<double, 3>& rElasticForce,
                array_1d<double, 3>& rContactForce,
        ...
        virtual void EvaluateDeltaDisplacement(
                ParticleDataBuffer & data_buffer,
                double DeltDisp[3],
                double RelVel[3],
        ...
        virtual void RelativeDisplacementAndVelocityOfContactPointDueToRotation(
        ...
        virtual void RelativeDisplacementAndVelocityOfContactPointDueToOtherReasons(
        ...
        virtual void RelativeDisplacementAndVelocityOfContactPointDueToRotationMatrix(
                double DeltDisp[3],
                double RelVel[3],
                const double OldLocalCoordSystem[3][3],
                const double& other_radius,
        ...
        virtual void EvaluateBallToBallForcesForPositiveIndentiations(
        ...
        virtual void AddUpForcesAndProject(
        ...
        virtual void AddUpFEMForcesAndProject(
                double LocalCoordSystem[3][3],
                double LocalContactForce[3],
                double LocalElasticContactForce[3],
                double GlobalContactForce[3],
        ...
        virtual void AddUpMomentsAndProject(
                double LocalCoordSystem[3][3],
        ...
        virtual void ComputeWear(
                ...
                double tangential_vel[3],
                double mTimeStep, bool sliding,
        ...
        virtual void AddNeighbourContributionToStressTensor(
        ...
        virtual void AddWallContributionToStressTensor(
                const double GlobalElasticContactForce[3],
                const double other_to_me_vect[3],
                const double distance,
    ...
    inline std::istream& operator >> (std::istream& rIStream, SphericParticle& rThis) { return rIStream; }
