...
namespace Kratos {
    ...
    void Cluster3D::UpdatePositionOfSpheres() {
        ...
        for (unsigned int i = 0; i < mListOfCoordinates.size(); i++) {
            ...
            noalias(sphere_node.FastGetSolutionStepValue(EULER_ANGLES)) = cluster_euler_angles; //If we don't do this, the Euler Angles of spheres belonging to clusters will be printed but always 0
        }                        
    }
