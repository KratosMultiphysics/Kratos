...
class PFEM2Solver:
    ...
    def Initialize(self):
        ...
        #maximum_number_of_particles= 10*3*self.domain_size
        maximum_number_of_particles= 10*5*self.domain_size
        ...
        if self.domain_size==2:
             self.moveparticles = MoveParticleUtilityPFEM2Modified2D(self.model_part,maximum_number_of_particles)
        else:
             self.moveparticles = MoveParticleUtilityPFEM2Modified3D(self.model_part,maximum_number_of_particles)
        #raw_input()
