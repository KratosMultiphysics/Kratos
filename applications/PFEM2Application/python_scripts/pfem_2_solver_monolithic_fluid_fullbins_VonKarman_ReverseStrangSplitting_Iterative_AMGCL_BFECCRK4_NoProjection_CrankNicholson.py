...
class PFEM2Solver:
    ...
    def Solve(self):
        ...
        (self.VariableUtils).CopyScalarVar(ISFOUNDA,ISFOUNDAFIRST,self.model_part.Nodes)
        (self.VariableUtils).CopyScalarVar(ISFOUNDB,ISFOUNDBFIRST,self.model_part.Nodes)
        (self.VariableUtils).CopyScalarVar(ISFOUNDRK4A,ISFOUNDRK4AFIRST,self.model_part.Nodes)
        (self.VariableUtils).CopyScalarVar(ISFOUNDRK4B,ISFOUNDRK4BFIRST,self.model_part.Nodes)
        (self.VariableUtils).CopyScalarVar(ISFOUNDSUBA,ISFOUNDSUBAFIRST,self.model_part.Nodes)
        (self.VariableUtils).CopyScalarVar(ISFOUNDSUBB,ISFOUNDSUBBFIRST,self.model_part.Nodes)
        (self.VariableUtils).CopyScalarVar(ISFOUNDSUB2A,ISFOUNDSUB2AFIRST,self.model_part.Nodes)
        (self.VariableUtils).CopyScalarVar(ISFOUNDSUB2B,ISFOUNDSUB2BFIRST,self.model_part.Nodes)
        print("SECOND")
        bfecc_utility.BFECCconvectRK4(self.model_part,SCALARPROJECTEDVEL_Y,VELOCITY)
        (self.VariableUtils).CopyScalarVar(ISFOUNDA,ISFOUNDASECOND,self.model_part.Nodes)
        (self.VariableUtils).CopyScalarVar(ISFOUNDB,ISFOUNDBSECOND,self.model_part.Nodes)
        (self.VariableUtils).CopyScalarVar(ISFOUNDRK4A,ISFOUNDRK4ASECOND,self.model_part.Nodes)
        (self.VariableUtils).CopyScalarVar(ISFOUNDRK4B,ISFOUNDRK4BSECOND,self.model_part.Nodes)
        (self.VariableUtils).CopyScalarVar(ISFOUNDSUBA,ISFOUNDSUBASECOND,self.model_part.Nodes)
        (self.VariableUtils).CopyScalarVar(ISFOUNDSUBB,ISFOUNDSUBBSECOND,self.model_part.Nodes)
        (self.VariableUtils).CopyScalarVar(ISFOUNDSUB2A,ISFOUNDSUB2ASECOND,self.model_part.Nodes)
        (self.VariableUtils).CopyScalarVar(ISFOUNDSUB2B,ISFOUNDSUB2BSECOND,self.model_part.Nodes)
        ...
        #for node in (self.model_part.Nodes):
        # if node.X>17.9999999:
        #  if (node.GetSolutionStepValue(VELOCITY_X,0)<0.0):
        #   node.SetSolutionStepValue(VELOCITY_X,0,0.000001)
        ...
        print("THIRD")
        bfecc_utility.BFECCconvectRK4(self.model_part,SCALARPROJECTEDVEL_X,VELOCITY) 
        (self.VariableUtils).CopyScalarVar(ISFOUNDA,ISFOUNDATHIRD,self.model_part.Nodes)
        (self.VariableUtils).CopyScalarVar(ISFOUNDB,ISFOUNDBTHIRD,self.model_part.Nodes)
        (self.VariableUtils).CopyScalarVar(ISFOUNDRK4A,ISFOUNDRK4ATHIRD,self.model_part.Nodes)
        (self.VariableUtils).CopyScalarVar(ISFOUNDRK4B,ISFOUNDRK4BTHIRD,self.model_part.Nodes)
        (self.VariableUtils).CopyScalarVar(ISFOUNDSUBA,ISFOUNDSUBATHIRD,self.model_part.Nodes)
        (self.VariableUtils).CopyScalarVar(ISFOUNDSUBB,ISFOUNDSUBBTHIRD,self.model_part.Nodes)
        (self.VariableUtils).CopyScalarVar(ISFOUNDSUB2A,ISFOUNDSUB2ATHIRD,self.model_part.Nodes)
        (self.VariableUtils).CopyScalarVar(ISFOUNDSUB2B,ISFOUNDSUB2BTHIRD,self.model_part.Nodes)
        print("FOURTH")
        bfecc_utility.BFECCconvectRK4(self.model_part,SCALARPROJECTEDVEL_Y,VELOCITY)
        (self.VariableUtils).CopyScalarVar(ISFOUNDA,ISFOUNDAFOURTH,self.model_part.Nodes)
        (self.VariableUtils).CopyScalarVar(ISFOUNDB,ISFOUNDBFOURTH,self.model_part.Nodes)
        (self.VariableUtils).CopyScalarVar(ISFOUNDRK4A,ISFOUNDRK4AFOURTH,self.model_part.Nodes)
        (self.VariableUtils).CopyScalarVar(ISFOUNDRK4B,ISFOUNDRK4BFOURTH,self.model_part.Nodes)
        (self.VariableUtils).CopyScalarVar(ISFOUNDSUBA,ISFOUNDSUBAFOURTH,self.model_part.Nodes)
        (self.VariableUtils).CopyScalarVar(ISFOUNDSUBB,ISFOUNDSUBBFOURTH,self.model_part.Nodes)
        (self.VariableUtils).CopyScalarVar(ISFOUNDSUB2A,ISFOUNDSUB2AFOURTH,self.model_part.Nodes)
        (self.VariableUtils).CopyScalarVar(ISFOUNDSUB2B,ISFOUNDSUB2BFOURTH,self.model_part.Nodes)
