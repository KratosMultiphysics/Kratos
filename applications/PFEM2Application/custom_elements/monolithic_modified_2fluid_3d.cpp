...
#include "custom_elements/monolithic_modified_2fluid_3d.h"
...
namespace Kratos
{
	...
	//************************************************************************************
	//************************************************************************************
	MonolithicModifiedPFEM23D::MonolithicModifiedPFEM23D(IndexType NewId, GeometryType::Pointer pGeometry)
		: Element(NewId, pGeometry)
	{}

	//************************************************************************************
	//************************************************************************************
	MonolithicModifiedPFEM23D::MonolithicModifiedPFEM23D(IndexType NewId, GeometryType::Pointer pGeometry,  PropertiesType::Pointer pProperties)
		: Element(NewId, pGeometry, pProperties)
	{}

	Element::Pointer MonolithicModifiedPFEM23D::Create(IndexType NewId, NodesArrayType const& ThisNodes,  PropertiesType::Pointer pProperties) const
	{
		return Element::Pointer(new MonolithicModifiedPFEM23D(NewId, GetGeometry().Create(ThisNodes), pProperties));
	}

    Element::Pointer MonolithicModifiedPFEM23D::Create(IndexType NewId, GeometryType::Pointer pGeometry, PropertiesType::Pointer pProperties) const
    {
        return Element::Pointer(new MonolithicModifiedPFEM23D(NewId, pGeometry, pProperties));
    }

	MonolithicModifiedPFEM23D::~MonolithicModifiedPFEM23D()
	{
	}
	...
	void MonolithicModifiedPFEM23D::AddExplicitContribution(const ProcessInfo& rCurrentProcessInfo)
	{
		KRATOS_TRY;
	...
	void MonolithicModifiedPFEM23D::CalculateLocalSystem(MatrixType& rLeftHandSideMatrix, VectorType& rRightHandSideVector, const ProcessInfo& rCurrentProcessInfo)
	{
		KRATOS_TRY
	...
	void MonolithicModifiedPFEM23D::InitializeSolutionStep(const ProcessInfo& CurrentProcessInfo)
	{
		KRATOS_TRY
	...
	void MonolithicModifiedPFEM23D::EquationIdVector(EquationIdVectorType& rResult, const ProcessInfo& CurrentProcessInfo) const
	{
		const int TDim = 3;
	...
	void MonolithicModifiedPFEM23D::GetDofList(DofsVectorType& ElementalDofList,const ProcessInfo& CurrentProcessInfo) const
	{
		const int TDim = 3;
	...
	void MonolithicModifiedPFEM23D::CalculatePressureProjection(const ProcessInfo& CurrentProcessInfo)
	{
			KRATOS_TRY
	...
	void MonolithicModifiedPFEM23D::AddViscousTerm(BoundedMatrix<double, 21, 21 > & output,
	...
	void MonolithicModifiedPFEM23D::AddViscousTerm(MatrixType& rDampMatrix,
	...
	template<class T>
	bool MonolithicModifiedPFEM23D::InvertMatrix(const T& input, T& inverse)
	{
