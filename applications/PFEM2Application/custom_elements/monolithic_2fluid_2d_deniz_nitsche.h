...
#if !defined(KRATOS_MONOLITHIC_PFEM2_2D_DENIZ_NITSCHE_H_INCLUDED )
#define  KRATOS_MONOLITHIC_PFEM2_2D_DENIZ_NITSCHE_H_INCLUDED
...
namespace Kratos
{
  ...
  class MonolithicPFEM22DDenizNitsche
      : public Element
   {
   public:

     /// Counted pointer of PFEM22D
    KRATOS_CLASS_POINTER_DEFINITION(MonolithicPFEM22DDenizNitsche);
    ...
    /// Default constructor.
    MonolithicPFEM22DDenizNitsche(IndexType NewId = 0) :
        Element(NewId)
    {}
    MonolithicPFEM22DDenizNitsche(IndexType NewId, const NodesArrayType& ThisNodes) :
        Element(NewId, ThisNodes)
    {}

    MonolithicPFEM22DDenizNitsche(IndexType NewId, GeometryType::Pointer pGeometry);
    MonolithicPFEM22DDenizNitsche(IndexType NewId, GeometryType::Pointer pGeometry,  PropertiesType::Pointer pProperties);

     /// Destructor.
     virtual ~ MonolithicPFEM22DDenizNitsche() override;
...
private:
    ...
    array_1d<double,(2)> utilde_n = ZeroVector(2); //u tilde at the previous time step

    MonolithicPFEM22DDenizNitsche & operator=(MonolithicPFEM22DDenizNitsche const& rOther);

    /// Copy constructor.
    MonolithicPFEM22DDenizNitsche(MonolithicPFEM22DDenizNitsche const& rOther);
...
#endif // KRATOS_MONOLITHIC_PFEM2_2D_DENIZ_NITSCHE_H_INCLUDED  defined 
