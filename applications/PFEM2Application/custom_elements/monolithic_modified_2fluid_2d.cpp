...
namespace Kratos
{
    ...
    Element::Pointer MonolithicModifiedPFEM22D::Create(IndexType NewId, GeometryType::Pointer pGeometry, PropertiesType::Pointer pProperties) const
    {
        return Element::Pointer(new MonolithicModifiedPFEM22D(NewId, pGeometry, pProperties));
    }
	...
	void MonolithicModifiedPFEM22D::AddExplicitContribution(const ProcessInfo& rCurrentProcessInfo)
	{
		KRATOS_TRY;
	...
	void MonolithicModifiedPFEM22D::InitializeSolutionStep(const ProcessInfo& CurrentProcessInfo)
	{
		KRATOS_TRY
	...
	void MonolithicModifiedPFEM22D::CalculatePressureProjection(const ProcessInfo& CurrentProcessInfo)
	{
		KRATOS_TRY
	...
	void MonolithicModifiedPFEM22D::AddViscousTerm(BoundedMatrix<double, 13, 13 > & output,
    ...
    void MonolithicModifiedPFEM22D::AddViscousTerm(BoundedMatrix<double, 12, 12 > & output,
                                        BoundedMatrix<double, (3), 2 >& rShapeDeriv,
                                        array_1d<double,3>&  distances,
                                        std::vector< Matrix >& gauss_gradients,
                                        array_1d<double,3>&  viscosities,
	...
	void MonolithicModifiedPFEM22D::AddViscousTerm(MatrixType& rDampMatrix,
