...
class PFEM2Solver:
	...
	self.monolitic_linear_solver =  AMGCLSolver(AMGCLSmoother.ILU0,AMGCLIterativeSolverType.CG,tol,5000,verbosity,gmres_size)      #BICGSTABSolver(1e-7, 5000) # SkylineLUFactorizationSolver() 
    ...
    def Solve(self):
		...
		pre_minimum_number_of_particles=self.domain_size*2;
		...
		post_minimum_number_of_particles=self.domain_size*4;
