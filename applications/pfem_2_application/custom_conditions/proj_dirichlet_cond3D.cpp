    ...
    : Condition(NewId, pGeometry, pProperties)
{
    ...
    for (unsigned int i=0; i<GetGeometry().size(); i++)
    {
        ...
        if (GetGeometry()[i].FastGetSolutionStepValue(IS_INTERFACE)==0.0)
        {
            ...
            {
                GetGeometry()[i].FastGetSolutionStepValue(EMBEDDED_VELOCITY_X)=GetGeometry()[i].FastGetSolutionStepValue(VELOCITY_X,1);
                GetGeometry()[i].FastGetSolutionStepValue(EMBEDDED_VELOCITY_Y)=GetGeometry()[i].FastGetSolutionStepValue(VELOCITY_Y,1);
                GetGeometry()[i].FastGetSolutionStepValue(EMBEDDED_VELOCITY_Z)=GetGeometry()[i].FastGetSolutionStepValue(VELOCITY_Z,1);
            }            
	    else
	    {
                GetGeometry()[i].FastGetSolutionStepValue(EMBEDDED_VELOCITY)=mVel;
                //GetGeometry()[i].FastGetSolutionStepValue(EMBEDDED_VELOCITY_X)=0.33333333*(mVel1[0]+mVel2[0]+mVel3[0]);
                //GetGeometry()[i].FastGetSolutionStepValue(EMBEDDED_VELOCITY_Y)=0.33333333*(mVel1[1]+mVel2[1]+mVel3[1]);
                //GetGeometry()[i].FastGetSolutionStepValue(EMBEDDED_VELOCITY_Z)=0.33333333*(mVel1[2]+mVel2[2]+mVel3[2]);
            }

            GetGeometry()[i].Fix(EMBEDDED_VELOCITY_X);
            GetGeometry()[i].Fix(EMBEDDED_VELOCITY_Y);
            GetGeometry()[i].Fix(EMBEDDED_VELOCITY_Z);
        }
	...
	//else if (GetGeometry()[i].FastGetSolutionStepValue(IS_INTERFACE)==1.0)
		...
		//if (i!=bad_vertex_index1 && i!=bad_vertex_index2 && i!=bad_vertex_index3)
		//{
		GetGeometry()[i].FastGetSolutionStepValue(EMBEDDED_VELOCITY_X)=0.0;
		GetGeometry()[i].FastGetSolutionStepValue(EMBEDDED_VELOCITY_Y)=0.0;
		GetGeometry()[i].FastGetSolutionStepValue(EMBEDDED_VELOCITY_Z)=0.0;
		...
		GetGeometry()[i].Free(EMBEDDED_VELOCITY_X);
		GetGeometry()[i].Free(EMBEDDED_VELOCITY_Y);
		GetGeometry()[i].Free(EMBEDDED_VELOCITY_Z);
		//}

		/*
		else 
		{
		GetGeometry()[i].FastGetSolutionStepValue(EMBEDDED_VELOCITY_X)=0.33333*(mVel3[0]+mVel2[0]+mVel1[0]);
		GetGeometry()[i].FastGetSolutionStepValue(EMBEDDED_VELOCITY_Y)=0.33333*(mVel3[1]+mVel2[1]+mVel1[1]);
		GetGeometry()[i].FastGetSolutionStepValue(EMBEDDED_VELOCITY_Z)=0.33333*(mVel3[2]+mVel2[2]+mVel1[2]);
    ...
    : Condition(NewId, pGeometry, pProperties)
{
    ...
    for (unsigned int i=0; i<GetGeometry().size(); i++)
    {
        ...
        if (GetGeometry()[i].FastGetSolutionStepValue(IS_INTERFACE)==0.0)
        {
            ...
            {
                GetGeometry()[i].FastGetSolutionStepValue(EMBEDDED_VELOCITY_X)=GetGeometry()[i].FastGetSolutionStepValue(VELOCITY_X);
                GetGeometry()[i].FastGetSolutionStepValue(EMBEDDED_VELOCITY_Y)=GetGeometry()[i].FastGetSolutionStepValue(VELOCITY_Y);
                GetGeometry()[i].FastGetSolutionStepValue(EMBEDDED_VELOCITY_Z)=GetGeometry()[i].FastGetSolutionStepValue(VELOCITY_Z);
            }
            else
	    {                
		GetGeometry()[i].FastGetSolutionStepValue(EMBEDDED_VELOCITY)=mVel;                
		//GetGeometry()[i].FastGetSolutionStepValue(EMBEDDED_VELOCITY_X)=0.25*(mVel1[0]+mVel2[0]+mVel3[0]+mVel4[0]);
                //GetGeometry()[i].FastGetSolutionStepValue(EMBEDDED_VELOCITY_Y)=0.25*(mVel1[1]+mVel2[1]+mVel3[1]+mVel4[1]);
                //GetGeometry()[i].FastGetSolutionStepValue(EMBEDDED_VELOCITY_Z)=0.25*(mVel1[2]+mVel2[2]+mVel3[2]+mVel4[2]);
            }
		...
		{
		GetGeometry()[i].FastGetSolutionStepValue(EMBEDDED_VELOCITY_X)=0.25*(mVel3[0]+mVel2[0]+mVel1[0]+mVel4[0]);
		GetGeometry()[i].FastGetSolutionStepValue(EMBEDDED_VELOCITY_Y)=0.25*(mVel3[1]+mVel2[1]+mVel1[1]+mVel4[1]);
		GetGeometry()[i].FastGetSolutionStepValue(EMBEDDED_VELOCITY_Z)=0.25*(mVel3[2]+mVel2[2]+mVel1[2]+mVel4[2]);
...
void ProjDirichletCond3D::CalculateLocalSystem(MatrixType& rLeftHandSideMatrix, VectorType& rRightHandSideVector, ProcessInfo& rCurrentProcessInfo)
{
    ...
    for (int i=0; i<4; i++)
    {
        Vel_VEC[3*i]=GetGeometry()[i].FastGetSolutionStepValue(EMBEDDED_VELOCITY_X);
        Vel_VEC[3*i+1]=GetGeometry()[i].FastGetSolutionStepValue(EMBEDDED_VELOCITY_Y);
        Vel_VEC[3*i+2]=GetGeometry()[i].FastGetSolutionStepValue(EMBEDDED_VELOCITY_Z);
    }
...
void ProjDirichletCond3D::EquationIdVector(EquationIdVectorType& rResult, ProcessInfo& CurrentProcessInfo)
{
    ...
    rResult[0] = (GetGeometry()[0].GetDof(EMBEDDED_VELOCITY_X)).EquationId();
    rResult[1] = (GetGeometry()[0].GetDof(EMBEDDED_VELOCITY_Y)).EquationId();
    rResult[2] = (GetGeometry()[0].GetDof(EMBEDDED_VELOCITY_Z)).EquationId();

    rResult[3] = (GetGeometry()[1].GetDof(EMBEDDED_VELOCITY_X)).EquationId();
    rResult[4] = (GetGeometry()[1].GetDof(EMBEDDED_VELOCITY_Y)).EquationId();
    rResult[5] = (GetGeometry()[1].GetDof(EMBEDDED_VELOCITY_Z)).EquationId();

    rResult[6] = (GetGeometry()[2].GetDof(EMBEDDED_VELOCITY_X)).EquationId();
    rResult[7] = (GetGeometry()[2].GetDof(EMBEDDED_VELOCITY_Y)).EquationId();
    rResult[8] = (GetGeometry()[2].GetDof(EMBEDDED_VELOCITY_Z)).EquationId();

    rResult[9] = (GetGeometry()[3].GetDof(EMBEDDED_VELOCITY_X)).EquationId();
    rResult[10] = (GetGeometry()[3].GetDof(EMBEDDED_VELOCITY_Y)).EquationId();
    rResult[11] = (GetGeometry()[3].GetDof(EMBEDDED_VELOCITY_Z)).EquationId();
...
void ProjDirichletCond3D::GetDofList(DofsVectorType& ConditionalDofList,ProcessInfo& CurrentProcessInfo)
{
    ...
    ConditionalDofList[0] = (GetGeometry()[0].pGetDof(EMBEDDED_VELOCITY_X));
    ConditionalDofList[1] = (GetGeometry()[0].pGetDof(EMBEDDED_VELOCITY_Y));
    ConditionalDofList[2] = (GetGeometry()[0].pGetDof(EMBEDDED_VELOCITY_Z));

    ConditionalDofList[3] = (GetGeometry()[1].pGetDof(EMBEDDED_VELOCITY_X));
    ConditionalDofList[4] = (GetGeometry()[1].pGetDof(EMBEDDED_VELOCITY_Y));
    ConditionalDofList[5] = (GetGeometry()[1].pGetDof(EMBEDDED_VELOCITY_Z));

    ConditionalDofList[6] = (GetGeometry()[2].pGetDof(EMBEDDED_VELOCITY_X));
    ConditionalDofList[7] = (GetGeometry()[2].pGetDof(EMBEDDED_VELOCITY_Y));
    ConditionalDofList[8] = (GetGeometry()[2].pGetDof(EMBEDDED_VELOCITY_Z));

    ConditionalDofList[9] = (GetGeometry()[3].pGetDof(EMBEDDED_VELOCITY_X));
    ConditionalDofList[10] = (GetGeometry()[3].pGetDof(EMBEDDED_VELOCITY_Y));
    ConditionalDofList[11] = (GetGeometry()[3].pGetDof(EMBEDDED_VELOCITY_Z));
