...
namespace Kratos
{
	...
	void MonolithicAutoSlipPFEM23D::AddViscousTerm(bounded_matrix<double, 21, 21 > & output,
	...
	void MonolithicAutoSlipPFEM23D::ComputeBoundaryIntegral(const bounded_matrix<double, 4, 3 >& coords,
