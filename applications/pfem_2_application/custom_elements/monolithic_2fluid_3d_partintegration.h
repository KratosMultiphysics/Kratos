  ...
  class MonolithicAutoSlipPFEM23D
   ...
   public:
    ...
    /// Default constructor.
     ...
     /// Destructor.
     virtual ~ MonolithicAutoSlipPFEM23D();
   ...
   protected:
       ...
       void AddViscousTerm(bounded_matrix<double, 21, 21 > & output,
		...
		void ComputeBoundaryIntegral(const bounded_matrix<double, 4, 3 >& coords,
