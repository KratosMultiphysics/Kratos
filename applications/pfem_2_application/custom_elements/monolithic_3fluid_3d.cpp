...
namespace Kratos
{
	...
	void Monolithic3FluidPFEM23D::CalculateLocalSystem(MatrixType& rLeftHandSideMatrix, VectorType& rRightHandSideVector, ProcessInfo& rCurrentProcessInfo)
	{
		...
		else //split element:
		{
			...
			boost::numeric::ublas::bounded_matrix<double,(TDim-1)*3, 2> Nenriched;
	...
	void Monolithic3FluidPFEM23D::AddViscousTerm(boost::numeric::ublas::bounded_matrix<double, 21, 21 > & output,
