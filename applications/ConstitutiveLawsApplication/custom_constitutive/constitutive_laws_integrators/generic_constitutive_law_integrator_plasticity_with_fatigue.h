...
class GenericConstitutiveLawIntegratorPlasticityWithFatigue
{
  public:
        ...
        )
    {
        ...
        while (is_converged == false && iteration <= max_iter) {
            ...
            F = CalculatePlasticParameters(rPredictiveStressVector, rStrainVector, rUniaxialStress, rThreshold,
                                        ...
                                        rConstitutiveMatrix, rValues, CharacteristicLength, rPlasticStrain, FatigueReductionFactor);
        ...
        )
    {
        ...
        CalculatePlasticDissipation(rPredictiveStressVector, tensile_indicator_factor,compression_indicator_factor, rPlasticStrainIncrement,rPlasticDissipation, h_capa, rValues, CharacteristicLength, FatigueReductionFactor);
        ...
        CalculateEquivalentStressThreshold(rPlasticDissipation, tensile_indicator_factor,compression_indicator_factor, rThreshold, slope, rValues, equivalent_plastic_strain, CharacteristicLength, FatigueReductionFactor);
        ...
        )
    {
        ...
        double fracture_energy_tension = r_material_properties[FRACTURE_ENERGY]; // Frac energy in tension
        fracture_energy_tension *=  FatigueReductionFactor * FatigueReductionFactor;
    ...
    static void GetInitialUniaxialThreshold(ConstitutiveLaw::Parameters& rValues, double& rThreshold, const double FatigueReductionFactor)
    {
        ...
        rThreshold *= FatigueReductionFactor;
    }
     ...
     * @param FatigueReductionFactor Fatigue reduction factor
     */
    static void EquivalencyPlasticDissipationUniaxialPlasticStrain(
        double& rEquivalentPlasticStrain,
        ConstitutiveLaw::Parameters& rValues,
        const double PlasticDissipation,
        const double FatigueReductionFactor,
