...
#include "generic_small_strain_high_cycle_fatigue_plane_stress_law.h"
...
Matrix& GenericSmallStrainHighCycleFatiguePlaneStressLaw<TConstLawIntegratorType>::CalculateValue(
...
template class GenericSmallStrainHighCycleFatiguePlaneStressLaw <GenericConstitutiveLawIntegratorDamage<VonMisesYieldSurface<VonMisesPlasticPotential<3>>>>;
template class GenericSmallStrainHighCycleFatiguePlaneStressLaw <GenericConstitutiveLawIntegratorDamage<ModifiedMohrCoulombYieldSurface<ModifiedMohrCoulombPlasticPotential<3>>>>;
template class GenericSmallStrainHighCycleFatiguePlaneStressLaw <GenericConstitutiveLawIntegratorDamage<TrescaYieldSurface<TrescaPlasticPotential<3>>>>;
template class GenericSmallStrainHighCycleFatiguePlaneStressLaw <GenericConstitutiveLawIntegratorDamage<DruckerPragerYieldSurface<DruckerPragerPlasticPotential<3>>>>;
template class GenericSmallStrainHighCycleFatiguePlaneStressLaw <GenericConstitutiveLawIntegratorDamage<RankineYieldSurface<RankinePlasticPotential<3>>>>;
template class GenericSmallStrainHighCycleFatiguePlaneStressLaw <GenericConstitutiveLawIntegratorDamage<SimoJuYieldSurface<VonMisesPlasticPotential<3>>>>;
template class GenericSmallStrainHighCycleFatiguePlaneStressLaw <GenericConstitutiveLawIntegratorDamage<MohrCoulombYieldSurface<MohrCoulombPlasticPotential<3>>>>;
