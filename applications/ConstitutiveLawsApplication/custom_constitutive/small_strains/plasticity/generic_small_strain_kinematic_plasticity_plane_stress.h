...
///@}GenericSmallStrainKinematicPlasticityPlaneStress
///@name Kratos Classes
///@{
/**
 * @class GenericSmallStrainKinematicPlasticityPlaneStress
...
class KRATOS_API(CONSTITUTIVE_LAWS_APPLICATION) GenericSmallStrainKinematicPlasticityPlaneStress
...
public:
    ...
    using BaseType = GenericSmallStrainKinematicPlasticity<TConstLawIntegratorType>;

    ///@}
    ///@name Life Cycle
    ///@{
    /// Counted pointer of GenericYieldSurface
    KRATOS_CLASS_POINTER_DEFINITION(GenericSmallStrainKinematicPlasticityPlaneStress);
    ...
    */
    ...
    {
        return Kratos::make_shared<GenericSmallStrainKinematicPlasticityPlaneStress<TConstLawIntegratorType>>(*this);
    }

    /**
    * Copy constructor.
    */
    GenericSmallStrainKinematicPlasticityPlaneStress(const GenericSmallStrainKinematicPlasticityPlaneStress &rOther)
        : BaseType(rOther)
    {
    }
    ...
    * Destructor.
    */
    ~GenericSmallStrainKinematicPlasticityPlaneStress() override
    {
    }
