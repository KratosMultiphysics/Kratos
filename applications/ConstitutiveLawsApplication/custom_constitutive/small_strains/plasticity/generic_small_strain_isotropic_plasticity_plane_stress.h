...
///@}GenericSmallStrainIsotropicPlasticityPlaneStress
///@name Kratos Classes
///@{
/**
 * @class GenericSmallStrainIsotropicPlasticityPlaneStress
...
class KRATOS_API(CONSTITUTIVE_LAWS_APPLICATION) GenericSmallStrainIsotropicPlasticityPlaneStress
...
public:
    ...
    KRATOS_CLASS_POINTER_DEFINITION(GenericSmallStrainIsotropicPlasticityPlaneStress);
    ...
    */
    ...
    {
        return Kratos::make_shared<GenericSmallStrainIsotropicPlasticityPlaneStress<TConstLawIntegratorType>>(*this);
    }

    /**
    * Copy constructor.
    */
    GenericSmallStrainIsotropicPlasticityPlaneStress(const GenericSmallStrainIsotropicPlasticityPlaneStress &rOther)
        : BaseType(rOther)
    {
    }
    ...
    * Destructor.
    */
    ~GenericSmallStrainIsotropicPlasticityPlaneStress() override
    {
    }
