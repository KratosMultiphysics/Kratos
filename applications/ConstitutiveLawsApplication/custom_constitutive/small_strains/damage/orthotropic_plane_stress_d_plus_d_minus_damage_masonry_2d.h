...
//  
//
#if !defined(KRATOS_ORTHOTROPIC_PLANE_STRESS_D_PLUS_D_MINUS_DAMAGE_MASONRY_2D_H_INCLUDED )
#define  KRATOS_ORTHOTROPIC_PLANE_STRESS_D_PLUS_D_MINUS_DAMAGE_MASONRY_2D_H_INCLUDED
...
{
/**
* @class OrthotropicDamageDPlusDMinusMasonry2DLaw 
* @ingroup StructuralMechanicsApplication
*/
class KRATOS_API(STRUCTURAL_MECHANICS_APPLICATION) OrthotropicDamageDPlusDMinusMasonry2DLaw 
	: public ConstitutiveLaw
{
public:

	KRATOS_CLASS_POINTER_DEFINITION(OrthotropicDamageDPlusDMinusMasonry2DLaw);
	...
	* Default Constructor.
	*/
	OrthotropicDamageDPlusDMinusMasonry2DLaw();

	/**
	* Destructor.
	*/
	~OrthotropicDamageDPlusDMinusMasonry2DLaw() override
	{
	}
...
#endif // KRATOS_ORTHOTROPIC_PLANE_STRESS_D_PLUS_D_MINUS_DAMAGE_MASONRY_2D_H_INCLUDED  defined 
