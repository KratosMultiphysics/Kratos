...
#include "custom_constitutive/orthotropic_plane_stress_d_plus_d_minus_damage_masonry_2d_advanced.h"
...
/***********************************************************************************/
/***********************************************************************************/
OrthotropicDamageDPlusDMinusMasonry2DLawAdvanced::OrthotropicDamageDPlusDMinusMasonry2DLawAdvanced()
	: ConstitutiveLaw()
{
}
/***********************************************************************************/
/***********************************************************************************/
ConstitutiveLaw::Pointer OrthotropicDamageDPlusDMinusMasonry2DLawAdvanced::Clone() const
{
	return ConstitutiveLaw::Pointer( new OrthotropicDamageDPlusDMinusMasonry2DLawAdvanced() );
}
/***********************************************************************************/
/***********************************************************************************/
bool OrthotropicDamageDPlusDMinusMasonry2DLawAdvanced::Has(
...
/***********************************************************************************/
/***********************************************************************************/
double& OrthotropicDamageDPlusDMinusMasonry2DLawAdvanced::GetValue(
	const Variable<double>& rThisVariable,
	double& rValue)
{
	rValue = 0.0;
...
/***********************************************************************************/
/***********************************************************************************/
Vector& OrthotropicDamageDPlusDMinusMasonry2DLawAdvanced::GetValue(
	const Variable<Vector>& rThisVariable,
	Vector& rValue)
{
	return rValue;
...
/***********************************************************************************/
/***********************************************************************************/
Matrix& OrthotropicDamageDPlusDMinusMasonry2DLawAdvanced::GetValue(
	const Variable<Matrix>& rThisVariable,
	Matrix& rValue)
{
	return rValue;
...
/***********************************************************************************/
/***********************************************************************************/
array_1d<double, 3 > & OrthotropicDamageDPlusDMinusMasonry2DLawAdvanced::GetValue(
...
/***********************************************************************************/
/***********************************************************************************/
array_1d<double, 6 > & OrthotropicDamageDPlusDMinusMasonry2DLawAdvanced::GetValue(
...
/***********************************************************************************/
/***********************************************************************************/
void OrthotropicDamageDPlusDMinusMasonry2DLawAdvanced::SetValue(
...
/***********************************************************************************/
/***********************************************************************************/
bool OrthotropicDamageDPlusDMinusMasonry2DLawAdvanced::ValidateInput(
	const Properties& rMaterialProperties)
{
	...
	if( !rMaterialProperties.Has(DAMAGE_ONSET_STRESS_TENSION) ) 			return false;		//new
	if( !rMaterialProperties.Has(YIELD_STRESS_TENSION) ) 					return false;
	if( !rMaterialProperties.Has(RESIDUAL_STRESS_TENSION) )	 				return false;		//new
	if( !rMaterialProperties.Has(YIELD_STRAIN_TENSION) ) 					return false;		//new
...
/***********************************************************************************/
/***********************************************************************************/
OrthotropicDamageDPlusDMinusMasonry2DLawAdvanced::StrainMeasure OrthotropicDamageDPlusDMinusMasonry2DLawAdvanced::GetStrainMeasure()
{
	return ConstitutiveLaw::StrainMeasure_Infinitesimal;
}
/***********************************************************************************/
/***********************************************************************************/
OrthotropicDamageDPlusDMinusMasonry2DLawAdvanced::StressMeasure OrthotropicDamageDPlusDMinusMasonry2DLawAdvanced::GetStressMeasure()
{
	return ConstitutiveLaw::StressMeasure_Cauchy;
}
/***********************************************************************************/
/***********************************************************************************/
bool OrthotropicDamageDPlusDMinusMasonry2DLawAdvanced::IsIncremental()
{
	return false;
}
/***********************************************************************************/
/***********************************************************************************/
void OrthotropicDamageDPlusDMinusMasonry2DLawAdvanced::InitializeMaterial(
	const Properties& rMaterialProperties,
	const GeometryType& rElementGeometry,
	const Vector& rShapeFunctionsValues)
{
	if(!InitializeDamageLaw){
		ThresholdTension            	= rMaterialProperties[DAMAGE_ONSET_STRESS_TENSION]; 	//new
		//ThresholdTension            	= rMaterialProperties[YIELD_STRESS_TENSION]; 			//old
...
/***********************************************************************************/
/***********************************************************************************/
void OrthotropicDamageDPlusDMinusMasonry2DLawAdvanced::InitializeMaterialResponsePK2 (
	Parameters& rValues)
{
}
/***********************************************************************************/
/***********************************************************************************/
void OrthotropicDamageDPlusDMinusMasonry2DLawAdvanced::InitializeSolutionStep(
	const Properties& rMaterialProperties,
	const GeometryType& rElementGeometry,
	const Vector& rShapeFunctionsValues,
	const ProcessInfo& rCurrentProcessInfo)
...
/***********************************************************************************/
/***********************************************************************************/
void OrthotropicDamageDPlusDMinusMasonry2DLawAdvanced::FinalizeSolutionStep(
	const Properties& rMaterialProperties,
	const GeometryType& rElementGeometry,
	const Vector& rShapeFunctionsValues,
	const ProcessInfo& rCurrentProcessInfo)
...
/***********************************************************************************/
/***********************************************************************************/	
void OrthotropicDamageDPlusDMinusMasonry2DLawAdvanced::CalculateMaterialResponsePK1 (
	Parameters& rValues)
{
...
/***********************************************************************************/
/***********************************************************************************/
void OrthotropicDamageDPlusDMinusMasonry2DLawAdvanced::CalculateMaterialResponsePK2 (
	Parameters& rValues)
{
	CalculateMaterialResponseCauchy(rValues);
}
/***********************************************************************************/
/***********************************************************************************/
void OrthotropicDamageDPlusDMinusMasonry2DLawAdvanced::CalculateMaterialResponseKirchhoff (
	Parameters& rValues)
{
	CalculateMaterialResponseCauchy(rValues);
}
/***********************************************************************************/
/***********************************************************************************/
void OrthotropicDamageDPlusDMinusMasonry2DLawAdvanced::CalculateMaterialResponseCauchy (
	Parameters& rValues)
{
...
/***********************************************************************************/
/***********************************************************************************/
void OrthotropicDamageDPlusDMinusMasonry2DLawAdvanced::FinalizeMaterialResponsePK1 (
	Parameters& rValues)
{
...
/***********************************************************************************/
/***********************************************************************************/
void OrthotropicDamageDPlusDMinusMasonry2DLawAdvanced::FinalizeMaterialResponsePK2 (
	Parameters& rValues)
{
	FinalizeMaterialResponseCauchy(rValues);
}
/***********************************************************************************/
/***********************************************************************************/
void OrthotropicDamageDPlusDMinusMasonry2DLawAdvanced::FinalizeMaterialResponseKirchhoff (
	Parameters& rValues)
{
	FinalizeMaterialResponseCauchy(rValues);
}
/***********************************************************************************/
/***********************************************************************************/
void OrthotropicDamageDPlusDMinusMasonry2DLawAdvanced::FinalizeMaterialResponseCauchy (
	Parameters& rValues)
{
}
/***********************************************************************************/
/***********************************************************************************/
void OrthotropicDamageDPlusDMinusMasonry2DLawAdvanced::ResetMaterial(
	const Properties& rMaterialProperties,
	const GeometryType& rElementGeometry,
	const Vector& rShapeFunctionsValues)
{
...
/***********************************************************************************/
/***********************************************************************************/
void OrthotropicDamageDPlusDMinusMasonry2DLawAdvanced::GetLawFeatures(
	Features& rFeatures)
{
	//Set the type of law
	...
	const ProcessInfo& rCurrentProcessInfo)
{
	...
	if( !rMaterialProperties.Has(DAMAGE_ONSET_STRESS_TENSION) )
		KRATOS_THROW_ERROR(std::logic_error, "Missing variable: DAMAGE_ONSET_STRESS_TENSION", "");			//new

	if( !rMaterialProperties.Has(YIELD_STRESS_TENSION) )
		KRATOS_THROW_ERROR(std::logic_error, "Missing variable: YIELD_STRESS_TENSION", "");

	if( !rMaterialProperties.Has(RESIDUAL_STRESS_TENSION) )
		KRATOS_THROW_ERROR(std::logic_error, "Missing variable: RESIDUAL_STRESS_TENSION", "");				//new

	if( !rMaterialProperties.Has(YIELD_STRAIN_TENSION) )
		KRATOS_THROW_ERROR(std::logic_error, "Missing variable: YIELD_STRAIN_TENSION", "");					//new

    //if( !rMaterialProperties.Has(SPECIFIC_FRACTURE_ENERGY_TENSION) )
	//	KRATOS_THROW_ERROR(std::logic_error, "Missing variable: SPECIFIC_FRACTURE_ENERGY_TENSION", "");		//old
...
/***********************************************************************************/
/***********************************************************************************/
void OrthotropicDamageDPlusDMinusMasonry2DLawAdvanced::CalculateMaterialResponse(const Vector& StrainVector,
...
/***********************************************************************************/
/***********************************************************************************/
void OrthotropicDamageDPlusDMinusMasonry2DLawAdvanced::InitializeCalculationData(
	...
	CalculationData& data)
{
	...
	data.DamageOnsetStressTension		= props[DAMAGE_ONSET_STRESS_TENSION];															//new
	data.YieldStressTension				= props[YIELD_STRESS_TENSION];																	//new
	data.ResidualStressTension	 		= props[RESIDUAL_STRESS_TENSION];															//new
	data.YieldStrainTension 	 		= props[YIELD_STRAIN_TENSION];																//new
	data.BezierControllerTensionC1		= props.Has(BEZIER_CONTROLLER_TENSION_C1) ? props[BEZIER_CONTROLLER_TENSION_C1] : 0.65;			//new
	data.BezierControllerTensionC2		= props.Has(BEZIER_CONTROLLER_TENSION_C2) ? props[BEZIER_CONTROLLER_TENSION_C2] : 0.50;			//new
	data.BezierControllerTensionC3		= props.Has(BEZIER_CONTROLLER_TENSION_C3) ? props[BEZIER_CONTROLLER_TENSION_C3] : 1.50;			//new
	//data.SpecificFractureEnergyTension	= props[SPECIFIC_FRACTURE_ENERGY_TENSION];													//old
...
/***********************************************************************************/
/***********************************************************************************/
void OrthotropicDamageDPlusDMinusMasonry2DLawAdvanced::CalculateElasticityMatrix( 
	CalculationData& data)
{
...
/***********************************************************************************/
/***********************************************************************************/
//void OrthotropicDamageDPlusDMinusMasonry2DLawAdvanced::CalculateOrthotropicElasticityMatrix(
//	CalculationData& data)
//{
...
/***********************************************************************************/
/***********************************************************************************/
void OrthotropicDamageDPlusDMinusMasonry2DLawAdvanced::AssambleTransformationMatrix(
	CalculationData& data)
{
...
void OrthotropicDamageDPlusDMinusMasonry2DLawAdvanced::TensionCompressionSplit(
	CalculationData& data)
{
...
/***********************************************************************************/
/***********************************************************************************/
void OrthotropicDamageDPlusDMinusMasonry2DLawAdvanced::ConstructProjectionTensors(
	CalculationData& data)
{
...
/***********************************************************************************/
/***********************************************************************************/
void OrthotropicDamageDPlusDMinusMasonry2DLawAdvanced::CalculateEquivalentStressTension(CalculationData& data, double& UniaxialStressTension)
{
	UniaxialStressTension = 0.0;
	if(data.PrincipalStressVector(0) > 0.0){
		if (data.TensionYieldModel == 0) {
			// Lubliner Yield Criteria 
			const double onset_compression 			= 	data.DamageOnsetStressCompression;										//new
			const double onset_tension 				=   data.DamageOnsetStressTension;											//new
			...
			//const double beta 	= onset_compression / onset_tension * (1.0 - alpha) - (1.0 + alpha);
			...
			//UniaxialStressTension = 1.0 / (1.0-alpha) * (alpha * I1 + std::sqrt(3.0 * J2) + beta * smax) / 
			//						onset_compression * onset_tension;
		}
...
/***********************************************************************************/
/***********************************************************************************/
void OrthotropicDamageDPlusDMinusMasonry2DLawAdvanced::CalculateEquivalentStressCompression(CalculationData& data, double& UniaxialStressCompression)
{
	UniaxialStressCompression = 0.0;
	if(data.PrincipalStressVector(1) < 0.0){
		...
		const double beta = (onset_compression / yield_tension) * (1.0 - alpha) - (1.0 + alpha);
		const double smax = std::max(std::max(data.PrincipalStressVector(0), data.PrincipalStressVector(1)),0.0);
...
/***********************************************************************************/
/***********************************************************************************/
void OrthotropicDamageDPlusDMinusMasonry2DLawAdvanced::CalculateDamageTension(
	CalculationData& data, 
	double internal_variable, 
	double& rDamage)
{
	//if(internal_variable <= data.YieldStressTension) {																		//old
	if(internal_variable <= data.DamageOnsetStressTension) {																	//new
		rDamage = 0.0;
	}
	else { 
		// extract material parameters
		const double young_modulus  = data.YoungModulus;
		const double ft_0 			= data.DamageOnsetStressTension;
		const double ft_p 			= data.YieldStressTension;
		const double ft_r 			= data.ResidualStressTension;
		const double et_p 			= data.YieldStrainTension;
		const double c1_ten 		= data.BezierControllerTensionC1;
		const double c2_ten 		= data.BezierControllerTensionC2;
		const double c3_ten 		= data.BezierControllerTensionC3;
		...
		const double ft_k    	= ft_r + (ft_p - ft_r) * c1_ten;
		const double et_0    	= ft_0 / young_modulus;
		const double et_i 		= ft_p / young_modulus;
		const double alpha_ten  = 2.0 * (et_p - ft_p / young_modulus);
		double et_j    			= et_p + alpha_ten * c2_ten;
		double et_k   			= et_j + alpha_ten * (1 - c2_ten);
		double et_r    			= (et_k - et_j) / (ft_p - ft_k) * (ft_p - ft_r) + et_j;
		double et_u    			= et_r * c3_ten;
		...
		if(strain_like_counterpart <= et_p){
			this->EvaluateBezierCurve(damage_variable, strain_like_counterpart, et_0, et_i, et_p, ft_0, ft_p, ft_p);
		}
		else if(strain_like_counterpart <= et_k){
			this->EvaluateBezierCurve(damage_variable, strain_like_counterpart, et_p, et_j, et_k, ft_p, ft_p, ft_k);
		}
		else if(strain_like_counterpart <= et_u){
			this->EvaluateBezierCurve(damage_variable, strain_like_counterpart, et_k, et_r, et_u, ft_k, ft_r, ft_r);
		}
		else {
			damage_variable = ft_r;
		}
...
/***********************************************************************************/
/***********************************************************************************/
void OrthotropicDamageDPlusDMinusMasonry2DLawAdvanced::CalculateDamageCompression(
	CalculationData& data, 
	double internal_variable, 
	double& rDamage)
{
...
/***********************************************************************************/
/***********************************************************************************/
void OrthotropicDamageDPlusDMinusMasonry2DLawAdvanced::ComputeBezierEnergy(double& rBezierEnergy, double& rBezierEnergy1, 
...
/***********************************************************************************/
/***********************************************************************************/
double OrthotropicDamageDPlusDMinusMasonry2DLawAdvanced::EvaluateBezierArea(
...
/***********************************************************************************/
/***********************************************************************************/
void OrthotropicDamageDPlusDMinusMasonry2DLawAdvanced::ApplyBezierStretcherToStrains(
...
/***********************************************************************************/
/***********************************************************************************/
void OrthotropicDamageDPlusDMinusMasonry2DLawAdvanced::EvaluateBezierCurve(
...
/***********************************************************************************/
/***********************************************************************************/
void OrthotropicDamageDPlusDMinusMasonry2DLawAdvanced::ComputeCharacteristicLength(
    const GeometryType& geom,
...
/***********************************************************************************/
/***********************************************************************************/
void OrthotropicDamageDPlusDMinusMasonry2DLawAdvanced::CalculateMaterialResponseInternal(
...
/***********************************************************************************/
/***********************************************************************************/
void OrthotropicDamageDPlusDMinusMasonry2DLawAdvanced::CheckDamageLoadingUnloading(
...
/***********************************************************************************/
/***********************************************************************************/
void OrthotropicDamageDPlusDMinusMasonry2DLawAdvanced::CalculateTangentTensor(
	Parameters& rValues, 
	Vector StrainVector,
	Vector PredictiveStressVector,
	CalculationData& data,
...
/***********************************************************************************/
/***********************************************************************************/
void OrthotropicDamageDPlusDMinusMasonry2DLawAdvanced::CalculateSecantTensor(
	Parameters& rValues,
	CalculationData& data)
{
	Matrix& constitutive_matrix = rValues.GetConstitutiveMatrix();
