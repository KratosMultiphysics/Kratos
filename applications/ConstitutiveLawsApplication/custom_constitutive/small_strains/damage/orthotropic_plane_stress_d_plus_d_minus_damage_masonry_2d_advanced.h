...
//  
//
#if !defined(KRATOS_ORTHOTROPIC_PLANE_STRESS_D_PLUS_D_MINUS_DAMAGE_MASONRY_2D_ADVANCED_H_INCLUDED )
#define  KRATOS_ORTHOTROPIC_PLANE_STRESS_D_PLUS_D_MINUS_DAMAGE_MASONRY_2D_ADVANCED_H_INCLUDED
...
public:
	...
	KRATOS_CLASS_POINTER_DEFINITION(OrthotropicDamageDPlusDMinusMasonry2DLawAdvanced);
	...
	* Default Constructor.
	*/
	OrthotropicDamageDPlusDMinusMasonry2DLawAdvanced();

	/**
	* Destructor.
	*/
	~OrthotropicDamageDPlusDMinusMasonry2DLawAdvanced() override
	{
	}
	...
	*/
	...
	struct CalculationData{
		...
		double DamageOnsetStressTension;					double YieldStressTension;	
		double ResidualStressTension;						double YieldStrainTension;
		double BezierControllerTensionC1;					double BezierControllerTensionC2;
		double BezierControllerTensionC3;						
		//double FractureEnergyTension;
		//double SpecificFractureEnergyTension;
...
#endif // KRATOS_ORTHOTROPIC_PLANE_STRESS_D_PLUS_D_MINUS_DAMAGE_MASONRY_2D_ADVANCED_H_INCLUDED  defined 
