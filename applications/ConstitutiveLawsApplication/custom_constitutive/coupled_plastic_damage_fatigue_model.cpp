...
ConstitutiveLaw::Pointer CoupledPlasticDamageFatigueModel<TYieldSurfaceType>::Clone() const
{
    return Kratos::make_shared<CoupledPlasticDamageFatigueModel>(*this);
}
...
template<class TYieldSurfaceType>
void CoupledPlasticDamageFatigueModel<TYieldSurfaceType>::CalculateMaterialResponseCauchy(
...
template<class TYieldSurfaceType>
void CoupledPlasticDamageFatigueModel<TYieldSurfaceType>::FinalizeMaterialResponseCauchy(
    ConstitutiveLaw::Parameters& rValues
    )
{
    // Auxiliar values
...
template<class TYieldSurfaceType>
double CoupledPlasticDamageFatigueModel<TYieldSurfaceType>::CalculateVolumetricFractureEnergy( // g_F
...
template<class TYieldSurfaceType>
void CoupledPlasticDamageFatigueModel<TYieldSurfaceType>::CalculatePlasticDissipationIncrement(
    const Properties &rMaterialProperties,
    PlasticDamageParameters &rParam
    )
{
...
template<class TYieldSurfaceType>
void CoupledPlasticDamageFatigueModel<TYieldSurfaceType>::CalculateDamageDissipationIncrement(
    const Properties &rMaterialProperties,
    PlasticDamageParameters &rParam
    )
{
...
/***********************************************************************************/
template<class TYieldSurfaceType>
typename CoupledPlasticDamageFatigueModel<TYieldSurfaceType>::ResidualFunctionType
CoupledPlasticDamageFatigueModel<TYieldSurfaceType>::ExponentialSofteningImplicitFunction(
    )
{
...
template<class TYieldSurfaceType>
typename CoupledPlasticDamageFatigueModel<TYieldSurfaceType>::ResidualFunctionType
CoupledPlasticDamageFatigueModel<TYieldSurfaceType>::ExponentialSofteningImplicitFunctionDerivative(
    )
{
...
template<class TYieldSurfaceType>
typename CoupledPlasticDamageFatigueModel<TYieldSurfaceType>::ResidualFunctionType
CoupledPlasticDamageFatigueModel<TYieldSurfaceType>::ExponentialHardeningImplicitFunction(
    )
{
    ResidualFunctionType implicit_function = [](const double Dissipation, const double Threshold, ConstitutiveLaw::Parameters &rValues, PlasticDamageParameters &rPDParameters)
    {
...
template<class TYieldSurfaceType>
typename CoupledPlasticDamageFatigueModel<TYieldSurfaceType>::ResidualFunctionType
CoupledPlasticDamageFatigueModel<TYieldSurfaceType>::ExponentialHardeningImplicitFunctionDerivative(
    )
{
    ResidualFunctionType function_derivative = [](const double Dissipation, const double Threshold, ConstitutiveLaw::Parameters &rValues, PlasticDamageParameters &rPDParameters)
    {
...
template<class TYieldSurfaceType>
typename CoupledPlasticDamageFatigueModel<TYieldSurfaceType>::ResidualFunctionType
CoupledPlasticDamageFatigueModel<TYieldSurfaceType>::CurveByPointsHardeningImplicitFunction(
    )
{
    ResidualFunctionType implicit_function = [](const double Dissipation, const double Threshold, ConstitutiveLaw::Parameters &rValues, PlasticDamageParameters &rPDParameters)
    {
...
template<class TYieldSurfaceType>
typename CoupledPlasticDamageFatigueModel<TYieldSurfaceType>::ResidualFunctionType
CoupledPlasticDamageFatigueModel<TYieldSurfaceType>::CurveByPointsHardeningImplicitFunctionDerivative(
    )
{
    ResidualFunctionType function_derivative = [](const double Dissipation, const double Threshold, ConstitutiveLaw::Parameters &rValues, PlasticDamageParameters &rPDParameters)
    {
...
/***********************************************************************************/
template<class TYieldSurfaceType>
double CoupledPlasticDamageFatigueModel<TYieldSurfaceType>::CalculateThresholdImplicitExpression(
...
)
{
    ...
    KRATOS_WARNING_IF("CoupledPlasticDamageFatigueModel", iteration == max_iter) << "Inner Newton-Raphson to find an updated threshold did not converge..." << " Tolerance achieved: " << residual << std::endl;
...
/***********************************************************************************/
template<class TYieldSurfaceType>
double CoupledPlasticDamageFatigueModel<TYieldSurfaceType>::CalculateSlopeFiniteDifferences(
    ResidualFunctionType& rF,
    ResidualFunctionType& rdF_dk,
    ConstitutiveLaw::Parameters& rValues,
    PlasticDamageParameters &rPDParameters,
...
template<class TYieldSurfaceType>
void CoupledPlasticDamageFatigueModel<TYieldSurfaceType>::CalculatePlasticStrainIncrement(
    ConstitutiveLaw::Parameters& rValues,
    PlasticDamageParameters &rPDParameters
    )
{
...
template<class TYieldSurfaceType>
void CoupledPlasticDamageFatigueModel<TYieldSurfaceType>::CalculateComplianceMatrixIncrement(
    ConstitutiveLaw::Parameters& rValues,
    PlasticDamageParameters &rPDParameters
    )
{
...
template<class TYieldSurfaceType>
void CoupledPlasticDamageFatigueModel<TYieldSurfaceType>::CalculateConstitutiveMatrix(
    ConstitutiveLaw::Parameters& rValues,
    PlasticDamageParameters &rPDParameters
    )
{
...
template<class TYieldSurfaceType>
void CoupledPlasticDamageFatigueModel<TYieldSurfaceType>::UpdateInternalVariables(
    PlasticDamageParameters &rPDParameters
    )
{
...
template<class TYieldSurfaceType>
void CoupledPlasticDamageFatigueModel<TYieldSurfaceType>::CheckMinimumFractureEnergy(
    ConstitutiveLaw::Parameters& rValues,
    PlasticDamageParameters &rPDParameters
    )
{
...
template<class TYieldSurfaceType>
void CoupledPlasticDamageFatigueModel<TYieldSurfaceType>::CalculateElasticComplianceMatrix(
...
template<class TYieldSurfaceType>
Vector& CoupledPlasticDamageFatigueModel<TYieldSurfaceType>::GetValue(
    const Variable<Vector>& rThisVariable,
    Vector& rValue
    )
{
...
template<class TYieldSurfaceType>
double& CoupledPlasticDamageFatigueModel<TYieldSurfaceType>::CalculateValue(
...
template<class TYieldSurfaceType>
void CoupledPlasticDamageFatigueModel<TYieldSurfaceType>::InitializeMaterial(
    const Properties& rMaterialProperties,
...
template<class TYieldSurfaceType>
void CoupledPlasticDamageFatigueModel<TYieldSurfaceType>::CalculateMaterialResponsePK1(
    ConstitutiveLaw::Parameters& rValues
    )
{
...
template<class TYieldSurfaceType>
void  CoupledPlasticDamageFatigueModel<TYieldSurfaceType>::CalculateMaterialResponsePK2(
    ConstitutiveLaw::Parameters& rValues
    )
{
    this->CalculateMaterialResponseCauchy(rValues);
...
template<class TYieldSurfaceType>
void CoupledPlasticDamageFatigueModel<TYieldSurfaceType>::CalculateMaterialResponseKirchhoff(
    ConstitutiveLaw::Parameters& rValues
    )
{
    this->CalculateMaterialResponseCauchy(rValues);
...
template<class TYieldSurfaceType>
void CoupledPlasticDamageFatigueModel<TYieldSurfaceType>::InitializeMaterialResponsePK1(
    ConstitutiveLaw::Parameters& rValues
    )
{
...
template<class TYieldSurfaceType>
void CoupledPlasticDamageFatigueModel<TYieldSurfaceType>::InitializeMaterialResponsePK2(
    ConstitutiveLaw::Parameters& rValues
    )
{
    InitializeMaterialResponseCauchy(rValues);
...
template<class TYieldSurfaceType>
void CoupledPlasticDamageFatigueModel<TYieldSurfaceType>::InitializeMaterialResponseKirchhoff(
    ConstitutiveLaw::Parameters& rValues
    )
{
    InitializeMaterialResponseCauchy(rValues);
...
template<class TYieldSurfaceType>
void CoupledPlasticDamageFatigueModel<TYieldSurfaceType>::InitializeMaterialResponseCauchy(
    ConstitutiveLaw::Parameters& rValues
    )
{
...
/***********************************************************************************/
template<class TYieldSurfaceType>
double CoupledPlasticDamageFatigueModel<TYieldSurfaceType>::UltimateStressCalculation(
    const Properties& rMaterialProperties
)
{
    double ultimate_stress = rMaterialProperties.Has(YIELD_STRESS) ? rMaterialProperties[YIELD_STRESS] : rMaterialProperties[YIELD_STRESS_TENSION];
    const int softening_type = rMaterialProperties[HARDENING_CURVE];
    const int curve_by_points = static_cast<int>(GenericConstitutiveLawIntegratorPlasticity<TYieldSurfaceType>::HardeningCurveType::CurveDefinedByPoints);
    if (softening_type == curve_by_points) {
        const Vector& stress_curve = rMaterialProperties[EQUIVALENT_STRESS_VECTOR_PLASTICITY_POINT_CURVE]; //Integrated_stress points of the fitting curve
        const SizeType curve_points = stress_curve.size() - 1;

        ultimate_stress = 0.0;
        for (IndexType i = 0; i <= curve_points; ++i) {
            ultimate_stress = std::max(ultimate_stress, stress_curve[i]);
        }
    }
...
template<class TYieldSurfaceType>
void CoupledPlasticDamageFatigueModel<TYieldSurfaceType>::FinalizeMaterialResponsePK1(
    ConstitutiveLaw::Parameters& rValues
    )
{
...
void CoupledPlasticDamageFatigueModel<TYieldSurfaceType>::FinalizeMaterialResponsePK2(
    ConstitutiveLaw::Parameters& rValues
    )
{
    FinalizeMaterialResponseCauchy(rValues);
...
template<class TYieldSurfaceType>
void CoupledPlasticDamageFatigueModel<TYieldSurfaceType>::FinalizeMaterialResponseKirchhoff(
    ConstitutiveLaw::Parameters& rValues
    )
{
    FinalizeMaterialResponseCauchy(rValues);
...
template<class TYieldSurfaceType>
int CoupledPlasticDamageFatigueModel<TYieldSurfaceType>::Check(
    const Properties& rMaterialProperties,
    const GeometryType& rElementGeometry,
    const ProcessInfo& rCurrentProcessInfo
    ) const
...
template<class TYieldSurfaceType>
void CoupledPlasticDamageFatigueModel<TYieldSurfaceType>::CalculateTangentTensor(
    ConstitutiveLaw::Parameters& rValues,
...
template class CoupledPlasticDamageFatigueModel<VonMisesYieldSurface<VonMisesPlasticPotential<6>>>;
template class CoupledPlasticDamageFatigueModel<DruckerPragerYieldSurface<DruckerPragerPlasticPotential<6>>>;
template class CoupledPlasticDamageFatigueModel<ModifiedMohrCoulombYieldSurface<ModifiedMohrCoulombPlasticPotential<6>>>;
template class CoupledPlasticDamageFatigueModel<RankineYieldSurface<RankinePlasticPotential<6>>>;
