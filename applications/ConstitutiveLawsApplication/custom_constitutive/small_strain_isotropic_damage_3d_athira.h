...
#if !defined(KRATOS_SMALL_STRAIN_ISOTROPIC_DAMAGE_3D_LAW_ATHIRA_H_INCLUDED)
#define KRATOS_SMALL_STRAIN_ISOTROPIC_DAMAGE_3D_LAW_ATHIRA_H_INCLUDED
...
/**
 * @class SmallStrainIsotropicDamageAthira3D
 ...
 */
class KRATOS_API(CONSTITUTIVE_LAWS_APPLICATION) SmallStrainIsotropicDamageAthira3D
...
public:
    ...
    // Counted pointer
    KRATOS_CLASS_POINTER_DEFINITION(SmallStrainIsotropicDamageAthira3D);
     ...
     */
    SmallStrainIsotropicDamageAthira3D();

    /**
     * @brief Copy constructor.
     */
    SmallStrainIsotropicDamageAthira3D(const SmallStrainIsotropicDamageAthira3D& rOther);

    /**
     * @brief Destructor.
     */
    ~SmallStrainIsotropicDamageAthira3D() override;
