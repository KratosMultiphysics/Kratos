...
#if !defined(KRATOS_SMALL_STRAIN_ISOTROPIC_DAMAGE_3D_MAZARS_LAW_H_INCLUDED)
#define KRATOS_SMALL_STRAIN_ISOTROPIC_DAMAGE_3D_MAZARS_LAW_H_INCLUDED
...
/**
 * @class SmallStrainIsotropicDamage3DMazars
 ...
 */
class KRATOS_API(CONSTITUTIVE_LAWS_APPLICATION) SmallStrainIsotropicDamage3DMazars
...
public:
    ...
    // Counted pointer
    KRATOS_CLASS_POINTER_DEFINITION(SmallStrainIsotropicDamage3DMazars);
     ...
     */
    SmallStrainIsotropicDamage3DMazars();

    /**
     * @brief Copy constructor.
     */
    SmallStrainIsotropicDamage3DMazars(const SmallStrainIsotropicDamage3DMazars& rOther);

    /**
     * @brief Destructor.
     */
    ~SmallStrainIsotropicDamage3DMazars() override;
