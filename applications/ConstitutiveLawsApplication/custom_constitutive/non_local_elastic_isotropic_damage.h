...
#define KRATOS_NON_LOCAL_ELASTIC_ISOTROPIC_DAMAGE_H_INCLUDED
...
/**
 * @class NonLocalElasticIsotropicDamage
 ...
 */
class KRATOS_API(CONSTITUTIVE_LAWS_APPLICATION) NonLocalElasticIsotropicDamage
...
public:
    ...
    // Counted pointer
    KRATOS_CLASS_POINTER_DEFINITION(NonLocalElasticIsotropicDamage);
     ...
     */
    NonLocalElasticIsotropicDamage();

    /**
     * @brief Copy constructor.
     */
    NonLocalElasticIsotropicDamage(const NonLocalElasticIsotropicDamage& rOther);

    /**
     * @brief Destructor.
     */
    ~NonLocalElasticIsotropicDamage() override;
