    ...
    const double Mu)
{
    ...
    const double crConstitutiveMatrix0 = pow(rStrain[4], 2);
    ...
    const double crConstitutiveMatrix6 = pow(rStrain[5], 2);
    const double crConstitutiveMatrix7 = 2*rStrain[1];
    const double crConstitutiveMatrix8 = pow(rStrain[3], 2);
    ...
    const double crConstitutiveMatrix23 = pow(crConstitutiveMatrix22, 7.0/3.0);
    ...
    const double crConstitutiveMatrix26 = Kappa*cbrt(crConstitutiveMatrix22);
    ...
    const double crConstitutiveMatrix35 = pow(crConstitutiveMatrix22, 4.0/3.0);
    ...
    const double crConstitutiveMatrix52 = crConstitutiveMatrix24*(crConstitutiveMatrix27*crConstitutiveMatrix50 + crConstitutiveMatrix44*(crConstitutiveMatrix38*crConstitutiveMatrix50 - crConstitutiveMatrix43*(crConstitutiveMatrix17 + crConstitutiveMatrix18 + pow(crConstitutiveMatrix41, 2) + crConstitutiveMatrix42 + crConstitutiveMatrix5 + crConstitutiveMatrix51)) + crConstitutiveMatrix47 - crConstitutiveMatrix48);
    ...
    const double crConstitutiveMatrix94 = pow(crConstitutiveMatrix89, 2);
    ...
    const double crConstitutiveMatrix100 = pow(crConstitutiveMatrix62, 2);
    ...
    const double crConstitutiveMatrix103 = pow(crConstitutiveMatrix82, 2);
    ...
    const double Mu)
{
    ...
    const double crStressVector3 = pow(rStrain[4], 2);
    ...
    const double crStressVector8 = pow(rStrain[5], 2);
    const double crStressVector9 = pow(rStrain[3], 2);
    ...
    const double crStressVector22 = crStressVector21/cbrt(crStressVector16);
    ...
    const double crStressVector27 = (1.0/6.0)*crStressVector17*crStressVector18 - 1.0/6.0*crStressVector18 + (1.0/6.0)*crStressVector21*(crStressVector12 + crStressVector7 + 3)/pow(crStressVector16, 4.0/3.0);
