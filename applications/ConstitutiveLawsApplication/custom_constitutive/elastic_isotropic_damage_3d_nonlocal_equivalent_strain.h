...
#if !defined(KRATOS_ELASTIC_ISOTROPIC_DAMAGE_3D_NONLOCAL_EQUIVALENT_STRAIN_H_INCLUDED)
#define KRATOS_ELASTIC_ISOTROPIC_DAMAGE_3D_NONLOCAL_EQUIVALENT_STRAIN_H_INCLUDED
...
/**
 * @class ElasticIsotropicDamage3DNonLocalEquivalentStrain
 ...
 */
class KRATOS_API(CONSTITUTIVE_LAWS_APPLICATION) ElasticIsotropicDamage3DNonLocalEquivalentStrain
...
public:
    ...
    // Counted pointer
    KRATOS_CLASS_POINTER_DEFINITION(ElasticIsotropicDamage3DNonLocalEquivalentStrain);
     ...
     */
    ElasticIsotropicDamage3DNonLocalEquivalentStrain();

    /**
     * @brief Copy constructor.
     */
    ElasticIsotropicDamage3DNonLocalEquivalentStrain(const ElasticIsotropicDamage3DNonLocalEquivalentStrain& rOther);

    /**
     * @brief Destructor.
     */
    ~ElasticIsotropicDamage3DNonLocalEquivalentStrain() override;
