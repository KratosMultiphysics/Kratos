...
void KratosConstitutiveLawsApplication::Register()
{
    ...
    KRATOS_REGISTER_CONSTITUTIVE_LAW("OrthotropicDamageDPlusDMinusPlaneStressMasonry2DLaw", mOrthotropicDamageDPlusDMinusPlaneStressMasonry2DLaw);
    KRATOS_REGISTER_CONSTITUTIVE_LAW("OrthotropicDamageDPlusDMinusPlaneStressMasonry2DLawAdvanced", mOrthotropicDamageDPlusDMinusPlaneStressMasonry2DLawAdvanced);

   // D+D- Damage Constitutive laws variables, additional Masonry 2D & 3D
    KRATOS_REGISTER_VARIABLE(DAMAGE_ONSET_STRESS_TENSION)
    KRATOS_REGISTER_VARIABLE(RESIDUAL_STRESS_TENSION)
    KRATOS_REGISTER_VARIABLE(BEZIER_CONTROLLER_TENSION_C1)
    KRATOS_REGISTER_VARIABLE(BEZIER_CONTROLLER_TENSION_C2)
    KRATOS_REGISTER_VARIABLE(BEZIER_CONTROLLER_TENSION_C3)
    KRATOS_REGISTER_VARIABLE(YIELD_STRAIN_TENSION)
    ...
    // Orthotropic D+D- Constitutive laws variables, additional Masonry 2D
    KRATOS_REGISTER_VARIABLE(SPECIFIC_FRACTURE_ENERGY_TENSION)
    KRATOS_REGISTER_VARIABLE(TRANSFORMATION_MATRIX_COMP_11)
    KRATOS_REGISTER_VARIABLE(TRANSFORMATION_MATRIX_COMP_12)
    KRATOS_REGISTER_VARIABLE(TRANSFORMATION_MATRIX_COMP_13)
    KRATOS_REGISTER_VARIABLE(TRANSFORMATION_MATRIX_COMP_21)
    KRATOS_REGISTER_VARIABLE(TRANSFORMATION_MATRIX_COMP_22)
    KRATOS_REGISTER_VARIABLE(TRANSFORMATION_MATRIX_COMP_23)
    KRATOS_REGISTER_VARIABLE(TRANSFORMATION_MATRIX_COMP_31)
    KRATOS_REGISTER_VARIABLE(TRANSFORMATION_MATRIX_COMP_32)
    KRATOS_REGISTER_VARIABLE(TRANSFORMATION_MATRIX_COMP_33)
