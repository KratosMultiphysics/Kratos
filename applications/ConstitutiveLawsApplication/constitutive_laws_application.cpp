...
void KratosConstitutiveLawsApplication::Register()
{
   ...
   /// Damage
    ...
    KRATOS_REGISTER_VARIABLE(REVERSION_FACTOR)
    ...
    KRATOS_REGISTER_VARIABLE(HOLE_DIAMETER);
    KRATOS_REGISTER_VARIABLE(SPECIMEN_WIDTH);
    KRATOS_REGISTER_VARIABLE(SURFACE_ROUGHNESS);
    KRATOS_REGISTER_VARIABLE(MATERIAL_PARAMETER_C1);
    KRATOS_REGISTER_VARIABLE(MATERIAL_PARAMETER_C2);
    KRATOS_REGISTER_VARIABLE(STRESS_RELAXATION_FACTOR);
    KRATOS_REGISTER_VARIABLE(DIRECTIONAL_FACTOR);
