...
void KratosConstitutiveLawsApplication::Register()
{
    ...
    KRATOS_REGISTER_VARIABLE(HIGH_CYCLE_FATIGUE_COEFFICIENTS_MODE_ONE)
    KRATOS_REGISTER_VARIABLE(HIGH_CYCLE_FATIGUE_COEFFICIENTS_MODE_TWO)
    ...
    KRATOS_REGISTER_VARIABLE(INCREMENT_IN_NUMBER_OF_CYCLES)
    ...
    KRATOS_REGISTER_VARIABLE(REFERENCE_DAMAGE)
    KRATOS_REGISTER_VARIABLE(PREVIOUS_CYCLE_DAMAGE)
    ...
    KRATOS_REGISTER_VARIABLE(AIT_CONTROL_PARAMETER);
    KRATOS_REGISTER_VARIABLE(CURRENT_LOAD_TYPE);
    KRATOS_REGISTER_VARIABLE(NEW_MODEL_PART);
    KRATOS_REGISTER_VARIABLE(AIT_CONTROL_COUNTER);
    ...
    KRATOS_REGISTER_VARIABLE(FATIGUE_REDUCTION_FACTOR_VECTOR_MODE_ONE)
    KRATOS_REGISTER_VARIABLE(FATIGUE_REDUCTION_FACTOR_VECTOR_MODE_TWO)
    KRATOS_REGISTER_VARIABLE(WOHLER_STRESS_VECTOR_MODE_ONE)
    KRATOS_REGISTER_VARIABLE(WOHLER_STRESS_VECTOR_MODE_TWO)
    KRATOS_REGISTER_VARIABLE(LOCAL_NUMBER_OF_CYCLES_MODE_ONE)
    KRATOS_REGISTER_VARIABLE(LOCAL_NUMBER_OF_CYCLES_MODE_TWO)
    KRATOS_REGISTER_VARIABLE(INTERFACIAL_NORMAL_STRENGTH_VECTOR)
    KRATOS_REGISTER_VARIABLE(INTERFACIAL_SHEAR_STRENGTH_VECTOR)
    KRATOS_REGISTER_VARIABLE(INTERFACIAL_STRESS_VECTOR)
    ...
    KRATOS_REGISTER_VARIABLE(MODE_ONE_UNIAXIAL_STRESS)
    KRATOS_REGISTER_VARIABLE(MODE_TWO_UNIAXIAL_STRESS)
    KRATOS_REGISTER_VARIABLE(DEFAULT_METHOD)
    KRATOS_REGISTER_VARIABLE(USER_DEFINED_METHOD)
