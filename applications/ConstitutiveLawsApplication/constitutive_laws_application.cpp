...
void KratosConstitutiveLawsApplication::Register()
{
    ...
    /* Small strain */
    KRATOS_REGISTER_CONSTITUTIVE_LAW("SmallStrainIsotropicViscoPlasticity3DVonMisesVonMises", mSmallStrainIsotropicViscoPlasticity3DVonMisesVonMises);
    KRATOS_REGISTER_CONSTITUTIVE_LAW("SmallStrainIsotropicViscoPlasticity3DVonMisesModifiedMohrCoulomb", mSmallStrainIsotropicViscoPlasticity3DVonMisesModifiedMohrCoulomb);
    KRATOS_REGISTER_CONSTITUTIVE_LAW("SmallStrainIsotropicViscoPlasticity3DVonMisesDruckerPrager", mSmallStrainIsotropicViscoPlasticity3DVonMisesDruckerPrager);
    KRATOS_REGISTER_CONSTITUTIVE_LAW("SmallStrainIsotropicViscoPlasticity3DVonMisesTresca", mSmallStrainIsotropicViscoPlasticity3DVonMisesTresca);
    KRATOS_REGISTER_CONSTITUTIVE_LAW("SmallStrainIsotropicViscoPlasticity3DModifiedMohrCoulombVonMises", mSmallStrainIsotropicViscoPlasticity3DModifiedMohrCoulombVonMises);
    KRATOS_REGISTER_CONSTITUTIVE_LAW("SmallStrainIsotropicViscoPlasticity3DModifiedMohrCoulombModifiedMohrCoulomb", mSmallStrainIsotropicViscoPlasticity3DModifiedMohrCoulombModifiedMohrCoulomb);
    KRATOS_REGISTER_CONSTITUTIVE_LAW("SmallStrainIsotropicViscoPlasticity3DModifiedMohrCoulombDruckerPrager", mSmallStrainIsotropicViscoPlasticity3DModifiedMohrCoulombDruckerPrager);
    KRATOS_REGISTER_CONSTITUTIVE_LAW("SmallStrainIsotropicViscoPlasticity3DModifiedMohrCoulombTresca", mSmallStrainIsotropicViscoPlasticity3DModifiedMohrCoulombTresca);
    KRATOS_REGISTER_CONSTITUTIVE_LAW("SmallStrainIsotropicViscoPlasticity3DTrescaVonMises", mSmallStrainIsotropicViscoPlasticity3DTrescaVonMises);
    KRATOS_REGISTER_CONSTITUTIVE_LAW("SmallStrainIsotropicViscoPlasticity3DTrescaModifiedMohrCoulomb", mSmallStrainIsotropicViscoPlasticity3DTrescaModifiedMohrCoulomb);
    KRATOS_REGISTER_CONSTITUTIVE_LAW("SmallStrainIsotropicViscoPlasticity3DTrescaDruckerPrager", mSmallStrainIsotropicViscoPlasticity3DTrescaDruckerPrager);
    KRATOS_REGISTER_CONSTITUTIVE_LAW("SmallStrainIsotropicViscoPlasticity3DTrescaTresca", mSmallStrainIsotropicViscoPlasticity3DTrescaTresca);
    KRATOS_REGISTER_CONSTITUTIVE_LAW("SmallStrainIsotropicViscoPlasticity3DDruckerPragerVonMises", mSmallStrainIsotropicViscoPlasticity3DDruckerPragerVonMises);
    KRATOS_REGISTER_CONSTITUTIVE_LAW("SmallStrainIsotropicViscoPlasticity3DDruckerPragerModifiedMohrCoulomb", mSmallStrainIsotropicViscoPlasticity3DDruckerPragerModifiedMohrCoulomb);
    KRATOS_REGISTER_CONSTITUTIVE_LAW("SmallStrainIsotropicViscoPlasticity3DDruckerPragerDruckerPrager", mSmallStrainIsotropicViscoPlasticity3DDruckerPragerDruckerPrager);
    KRATOS_REGISTER_CONSTITUTIVE_LAW("SmallStrainIsotropicViscoPlasticity3DDruckerPragerTresca", mSmallStrainIsotropicViscoPlasticity3DDruckerPragerTresca);
    KRATOS_REGISTER_CONSTITUTIVE_LAW("SmallStrainIsotropicViscoPlasticity3DVonMisesMohrCoulomb", mSmallStrainIsotropicViscoPlasticity3DVonMisesMohrCoulomb);
    KRATOS_REGISTER_CONSTITUTIVE_LAW("SmallStrainIsotropicViscoPlasticity3DMohrCoulombVonMises", mSmallStrainIsotropicViscoPlasticity3DMohrCoulombVonMises);
    KRATOS_REGISTER_CONSTITUTIVE_LAW("SmallStrainIsotropicViscoPlasticity3DMohrCoulombMohrCoulomb", mSmallStrainIsotropicViscoPlasticity3DMohrCoulombMohrCoulomb);
    KRATOS_REGISTER_CONSTITUTIVE_LAW("SmallStrainIsotropicViscoPlasticity3DMohrCoulombDruckerPrager", mSmallStrainIsotropicViscoPlasticity3DMohrCoulombDruckerPrager);
    KRATOS_REGISTER_CONSTITUTIVE_LAW("SmallStrainIsotropicViscoPlasticity3DMohrCoulombTresca", mSmallStrainIsotropicViscoPlasticity3DMohrCoulombTresca);
    KRATOS_REGISTER_CONSTITUTIVE_LAW("SmallStrainIsotropicViscoPlasticity3DTrescaMohrCoulomb", mSmallStrainIsotropicViscoPlasticity3DTrescaMohrCoulomb);
    KRATOS_REGISTER_CONSTITUTIVE_LAW("SmallStrainIsotropicViscoPlasticity3DDruckerPragerMohrCoulomb", mSmallStrainIsotropicViscoPlasticity3DDruckerPragerMohrCoulomb);

    KRATOS_REGISTER_CONSTITUTIVE_LAW("SmallStrainIsotropicViscoPlasticityPlaneStrainVonMisesVonMises", mSmallStrainIsotropicViscoPlasticityPlaneStrainVonMisesVonMises);
    KRATOS_REGISTER_CONSTITUTIVE_LAW("SmallStrainIsotropicViscoPlasticityPlaneStrainVonMisesModifiedMohrCoulomb", mSmallStrainIsotropicViscoPlasticityPlaneStrainVonMisesModifiedMohrCoulomb);
    KRATOS_REGISTER_CONSTITUTIVE_LAW("SmallStrainIsotropicViscoPlasticityPlaneStrainVonMisesDruckerPrager", mSmallStrainIsotropicViscoPlasticityPlaneStrainVonMisesDruckerPrager);
    KRATOS_REGISTER_CONSTITUTIVE_LAW("SmallStrainIsotropicViscoPlasticityPlaneStrainVonMisesTresca", mSmallStrainIsotropicViscoPlasticityPlaneStrainVonMisesTresca);
    KRATOS_REGISTER_CONSTITUTIVE_LAW("SmallStrainIsotropicViscoPlasticityPlaneStrainModifiedMohrCoulombVonMises", mSmallStrainIsotropicViscoPlasticityPlaneStrainModifiedMohrCoulombVonMises);
    KRATOS_REGISTER_CONSTITUTIVE_LAW("SmallStrainIsotropicViscoPlasticityPlaneStrainModifiedMohrCoulombModifiedMohrCoulomb", mSmallStrainIsotropicViscoPlasticityPlaneStrainModifiedMohrCoulombModifiedMohrCoulomb);
    KRATOS_REGISTER_CONSTITUTIVE_LAW("SmallStrainIsotropicViscoPlasticityPlaneStrainModifiedMohrCoulombDruckerPrager", mSmallStrainIsotropicViscoPlasticityPlaneStrainModifiedMohrCoulombDruckerPrager);
    KRATOS_REGISTER_CONSTITUTIVE_LAW("SmallStrainIsotropicViscoPlasticityPlaneStrainModifiedMohrCoulombTresca", mSmallStrainIsotropicViscoPlasticityPlaneStrainModifiedMohrCoulombTresca);
    KRATOS_REGISTER_CONSTITUTIVE_LAW("SmallStrainIsotropicViscoPlasticityPlaneStrainTrescaVonMises", mSmallStrainIsotropicViscoPlasticityPlaneStrainTrescaVonMises);
    KRATOS_REGISTER_CONSTITUTIVE_LAW("SmallStrainIsotropicViscoPlasticityPlaneStrainTrescaModifiedMohrCoulomb", mSmallStrainIsotropicViscoPlasticityPlaneStrainTrescaModifiedMohrCoulomb);
    KRATOS_REGISTER_CONSTITUTIVE_LAW("SmallStrainIsotropicViscoPlasticityPlaneStrainTrescaDruckerPrager", mSmallStrainIsotropicViscoPlasticityPlaneStrainTrescaDruckerPrager);
    KRATOS_REGISTER_CONSTITUTIVE_LAW("SmallStrainIsotropicViscoPlasticityPlaneStrainTrescaTresca", mSmallStrainIsotropicViscoPlasticityPlaneStrainTrescaTresca);
    KRATOS_REGISTER_CONSTITUTIVE_LAW("SmallStrainIsotropicViscoPlasticityPlaneStrainDruckerPragerVonMises", mSmallStrainIsotropicViscoPlasticityPlaneStrainDruckerPragerVonMises);
    KRATOS_REGISTER_CONSTITUTIVE_LAW("SmallStrainIsotropicViscoPlasticityPlaneStrainDruckerPragerModifiedMohrCoulomb", mSmallStrainIsotropicViscoPlasticityPlaneStrainDruckerPragerModifiedMohrCoulomb);
    KRATOS_REGISTER_CONSTITUTIVE_LAW("SmallStrainIsotropicViscoPlasticityPlaneStrainDruckerPragerDruckerPrager", mSmallStrainIsotropicViscoPlasticityPlaneStrainDruckerPragerDruckerPrager);
    KRATOS_REGISTER_CONSTITUTIVE_LAW("SmallStrainIsotropicViscoPlasticityPlaneStrainDruckerPragerTresca", mSmallStrainIsotropicViscoPlasticityPlaneStrainDruckerPragerTresca);
    KRATOS_REGISTER_CONSTITUTIVE_LAW("SmallStrainIsotropicViscoPlasticityPlaneStrainVonMisesMohrCoulomb", mSmallStrainIsotropicViscoPlasticityPlaneStrainVonMisesMohrCoulomb);
    KRATOS_REGISTER_CONSTITUTIVE_LAW("SmallStrainIsotropicViscoPlasticityPlaneStrainMohrCoulombVonMises", mSmallStrainIsotropicViscoPlasticityPlaneStrainMohrCoulombVonMises);
    KRATOS_REGISTER_CONSTITUTIVE_LAW("SmallStrainIsotropicViscoPlasticityPlaneStrainMohrCoulombMohrCoulomb", mSmallStrainIsotropicViscoPlasticityPlaneStrainMohrCoulombMohrCoulomb);
    KRATOS_REGISTER_CONSTITUTIVE_LAW("SmallStrainIsotropicViscoPlasticityPlaneStrainMohrCoulombDruckerPrager", mSmallStrainIsotropicViscoPlasticityPlaneStrainMohrCoulombDruckerPrager);
    KRATOS_REGISTER_CONSTITUTIVE_LAW("SmallStrainIsotropicViscoPlasticityPlaneStrainMohrCoulombTresca", mSmallStrainIsotropicViscoPlasticityPlaneStrainMohrCoulombTresca);
    KRATOS_REGISTER_CONSTITUTIVE_LAW("SmallStrainIsotropicViscoPlasticityPlaneStrainTrescaMohrCoulomb", mSmallStrainIsotropicViscoPlasticityPlaneStrainTrescaMohrCoulomb);
    ...
    KRATOS_REGISTER_CONSTITUTIVE_LAW("SmallStrainIsotropicPlasticityPlaneStressVonMisesVonMises", mSmallStrainIsotropicPlasticityPlaneStressVonMisesVonMises);
    ...
    KRATOS_REGISTER_CONSTITUTIVE_LAW("SmallStrainKinematicPlasticityPlaneStressVonMisesVonMises", mSmallStrainKinematicPlasticityPlaneStressVonMisesVonMises);
    ...
    KRATOS_REGISTER_CONSTITUTIVE_LAW("FiniteStrainIsotropicPlasticityPlaneStressVonMisesVonMises", mFiniteStrainIsotropicPlasticityPlaneStressVonMisesVonMises);
    ...
    KRATOS_REGISTER_CONSTITUTIVE_LAW("FiniteStrainKinematicPlasticityPlaneStressVonMisesVonMises", mFiniteStrainKinematicPlasticityPlaneStressVonMisesVonMises);
   ...
   /// Damage
    ...
    KRATOS_REGISTER_VARIABLE(PLASTIC_STRAIN_VECTOR_TOP_SURFACE)
    KRATOS_REGISTER_VARIABLE(PLASTIC_STRAIN_VECTOR_MIDDLE_SURFACE)
    KRATOS_REGISTER_VARIABLE(PLASTIC_STRAIN_VECTOR_BOTTOM_SURFACE)
    ...
    KRATOS_REGISTER_VARIABLE(VISCOUS_ALPHA)
    KRATOS_REGISTER_VARIABLE(VISCOUS_BETA)
    KRATOS_REGISTER_VARIABLE(TIME_REGULARIZATION)
