...
void KratosConstitutiveLawsApplication::Register()
{
   ...
   /// Damage
    ...
    KRATOS_REGISTER_VARIABLE(STRESS_VECTOR_COMP_1)
    KRATOS_REGISTER_VARIABLE(STRESS_VECTOR_COMP_2)
    KRATOS_REGISTER_VARIABLE(STRESS_VECTOR_COMP_3)
    KRATOS_REGISTER_VARIABLE(STRESS_VECTOR_COMP_4)
