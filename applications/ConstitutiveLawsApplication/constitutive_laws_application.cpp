...
void KratosConstitutiveLawsApplication::Register()
{
    ...
    KRATOS_REGISTER_CONSTITUTIVE_LAW("SmallStrainKinematicPlasticitypePlaneStressVonMisesVonMises", mSmallStrainKinematicPlasticityPlaneStressVonMisesVonMises);
