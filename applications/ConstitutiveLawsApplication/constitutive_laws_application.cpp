...
void KratosConstitutiveLawsApplication::Register()
{
    ...
    //Faituge variables
<<<<<<< HEAD
    KRATOS_REGISTER_VARIABLE(STRESS_VECTOR_COMP1)
    KRATOS_REGISTER_VARIABLE(STRESS_VECTOR_COMP2)
    KRATOS_REGISTER_VARIABLE(STRESS_VECTOR_COMP3)
    KRATOS_REGISTER_VARIABLE(STRESS_VECTOR_COMP4)
    KRATOS_REGISTER_VARIABLE(STRESS_VECTOR_COMP5)
    KRATOS_REGISTER_VARIABLE(STRESS_VECTOR_COMP6)
=======
