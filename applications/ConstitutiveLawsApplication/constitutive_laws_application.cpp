...
void KratosConstitutiveLawsApplication::Register()
{
    ...
    // Constitutive laws variables
    KRATOS_REGISTER_VARIABLE(PLASTIC_DISSIPATION_FIBER)
    KRATOS_REGISTER_VARIABLE(PLASTIC_DISSIPATION_MATRIX)
    ...
    // For printing pursposes in Rule of Mixtures...
    KRATOS_REGISTER_VARIABLE(CAUCHY_STRESS_VECTOR_LAYER_1)
    KRATOS_REGISTER_VARIABLE(CAUCHY_STRESS_VECTOR_LAYER_2)
    KRATOS_REGISTER_VARIABLE(CAUCHY_STRESS_VECTOR_LAYER_3)
    KRATOS_REGISTER_VARIABLE(CAUCHY_STRESS_VECTOR_LAYER_4)
    KRATOS_REGISTER_VARIABLE(CAUCHY_STRESS_VECTOR_LAYER_5)
    KRATOS_REGISTER_VARIABLE(DAMAGE_LAYER_1)
    KRATOS_REGISTER_VARIABLE(DAMAGE_LAYER_2)
    KRATOS_REGISTER_VARIABLE(DAMAGE_LAYER_3)
    KRATOS_REGISTER_VARIABLE(DAMAGE_LAYER_4)
    KRATOS_REGISTER_VARIABLE(DAMAGE_LAYER_5)
    KRATOS_REGISTER_VARIABLE(PLASTIC_STRAIN_VECTOR_LAYER_1)
    KRATOS_REGISTER_VARIABLE(PLASTIC_STRAIN_VECTOR_LAYER_2)
    KRATOS_REGISTER_VARIABLE(PLASTIC_STRAIN_VECTOR_LAYER_3)
    KRATOS_REGISTER_VARIABLE(PLASTIC_STRAIN_VECTOR_LAYER_4)
    KRATOS_REGISTER_VARIABLE(PLASTIC_STRAIN_VECTOR_LAYER_5)
    KRATOS_REGISTER_VARIABLE(UNIAXIAL_STRESS_LAYER_1)
    KRATOS_REGISTER_VARIABLE(UNIAXIAL_STRESS_LAYER_2)
    KRATOS_REGISTER_VARIABLE(UNIAXIAL_STRESS_LAYER_3)
    KRATOS_REGISTER_VARIABLE(UNIAXIAL_STRESS_LAYER_4)
    KRATOS_REGISTER_VARIABLE(UNIAXIAL_STRESS_LAYER_5)
    KRATOS_REGISTER_VARIABLE(PLASTIC_DISSIPATION_LAYER_1)
    KRATOS_REGISTER_VARIABLE(PLASTIC_DISSIPATION_LAYER_2)
    KRATOS_REGISTER_VARIABLE(PLASTIC_DISSIPATION_LAYER_3)
    KRATOS_REGISTER_VARIABLE(PLASTIC_DISSIPATION_LAYER_4)
    KRATOS_REGISTER_VARIABLE(PLASTIC_DISSIPATION_LAYER_5)
