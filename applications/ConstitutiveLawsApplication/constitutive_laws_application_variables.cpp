...
<<<<<<< HEAD
KRATOS_CREATE_VARIABLE(Vector, STRESS_VECTOR_COMP1)
KRATOS_CREATE_VARIABLE(Vector, STRESS_VECTOR_COMP2)
KRATOS_CREATE_VARIABLE(Vector, STRESS_VECTOR_COMP3)
KRATOS_CREATE_VARIABLE(Vector, STRESS_VECTOR_COMP4)
KRATOS_CREATE_VARIABLE(Vector, STRESS_VECTOR_COMP5)
KRATOS_CREATE_VARIABLE(Vector, STRESS_VECTOR_COMP6)
=======
...
KRATOS_CREATE_VARIABLE(Vector, HIGH_CYCLE_FATIGUE_COEFFICIENTS_MODE_ONE)
KRATOS_CREATE_VARIABLE(Vector, HIGH_CYCLE_FATIGUE_COEFFICIENTS_MODE_TWO)
...
KRATOS_CREATE_VARIABLE(int, INCREMENT_IN_NUMBER_OF_CYCLES)
...
KRATOS_CREATE_VARIABLE(double, REFERENCE_DAMAGE)
...
KRATOS_CREATE_VARIABLE(bool, AIT_CONTROL_PARAMETER);
KRATOS_CREATE_VARIABLE(bool, CURRENT_LOAD_TYPE);
KRATOS_CREATE_VARIABLE(bool, NEW_MODEL_PART);
KRATOS_CREATE_VARIABLE(int, AIT_CONTROL_COUNTER);
...
KRATOS_CREATE_VARIABLE(Vector, FATIGUE_REDUCTION_FACTOR_VECTOR_MODE_ONE)
KRATOS_CREATE_VARIABLE(Vector, FATIGUE_REDUCTION_FACTOR_VECTOR_MODE_TWO)
KRATOS_CREATE_VARIABLE(Vector, WOHLER_STRESS_VECTOR_MODE_ONE)
KRATOS_CREATE_VARIABLE(Vector, WOHLER_STRESS_VECTOR_MODE_TWO)
KRATOS_CREATE_VARIABLE(Vector, LOCAL_NUMBER_OF_CYCLES_MODE_ONE)
KRATOS_CREATE_VARIABLE(Vector, LOCAL_NUMBER_OF_CYCLES_MODE_TWO)
...
KRATOS_CREATE_VARIABLE(Vector, INTERFACIAL_STRESS_VECTOR)
...
KRATOS_CREATE_VARIABLE(double, MODE_ONE_UNIAXIAL_STRESS)
KRATOS_CREATE_VARIABLE(double, MODE_TWO_UNIAXIAL_STRESS)
KRATOS_CREATE_VARIABLE(bool, DEFAULT_METHOD)
KRATOS_CREATE_VARIABLE(bool, USER_DEFINED_METHOD)
