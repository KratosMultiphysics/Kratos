...
KRATOS_CREATE_VARIABLE(Vector, PLASTIC_STRAIN_VECTOR_TOP_SURFACE)
KRATOS_CREATE_VARIABLE(Vector, PLASTIC_STRAIN_VECTOR_MIDDLE_SURFACE)
KRATOS_CREATE_VARIABLE(Vector, PLASTIC_STRAIN_VECTOR_BOTTOM_SURFACE)
...
KRATOS_CREATE_VARIABLE(double, VISCOUS_ALPHA)
KRATOS_CREATE_VARIABLE(double, VISCOUS_BETA)
KRATOS_CREATE_VARIABLE(double, TIME_REGULARIZATION)
