...
KRATOS_CREATE_VARIABLE(int, PROJECTION_OPERATOR)
KRATOS_CREATE_VARIABLE(double, YIELD_STRESS_SHEAR_TENSION)
KRATOS_CREATE_VARIABLE(double, YIELD_STRESS_SHEAR_COMPRESSION)
