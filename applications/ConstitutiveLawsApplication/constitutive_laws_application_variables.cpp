...
KRATOS_CREATE_VARIABLE(double, PLASTIC_DISSIPATION_FIBER)
KRATOS_CREATE_VARIABLE(double, PLASTIC_DISSIPATION_MATRIX)
...
KRATOS_CREATE_VARIABLE(Vector, CAUCHY_STRESS_VECTOR_LAYER_1)
KRATOS_CREATE_VARIABLE(Vector, CAUCHY_STRESS_VECTOR_LAYER_2)
KRATOS_CREATE_VARIABLE(Vector, CAUCHY_STRESS_VECTOR_LAYER_3)
KRATOS_CREATE_VARIABLE(Vector, CAUCHY_STRESS_VECTOR_LAYER_4)
KRATOS_CREATE_VARIABLE(Vector, CAUCHY_STRESS_VECTOR_LAYER_5)
KRATOS_CREATE_VARIABLE(double, DAMAGE_LAYER_1)
KRATOS_CREATE_VARIABLE(double, DAMAGE_LAYER_2)
KRATOS_CREATE_VARIABLE(double, DAMAGE_LAYER_3)
KRATOS_CREATE_VARIABLE(double, DAMAGE_LAYER_4)
KRATOS_CREATE_VARIABLE(double, DAMAGE_LAYER_5)
KRATOS_CREATE_VARIABLE(Vector, PLASTIC_STRAIN_VECTOR_LAYER_1)
KRATOS_CREATE_VARIABLE(Vector, PLASTIC_STRAIN_VECTOR_LAYER_2)
KRATOS_CREATE_VARIABLE(Vector, PLASTIC_STRAIN_VECTOR_LAYER_3)
KRATOS_CREATE_VARIABLE(Vector, PLASTIC_STRAIN_VECTOR_LAYER_4)
KRATOS_CREATE_VARIABLE(Vector, PLASTIC_STRAIN_VECTOR_LAYER_5)
KRATOS_CREATE_VARIABLE(double, UNIAXIAL_STRESS_LAYER_1)
KRATOS_CREATE_VARIABLE(double, UNIAXIAL_STRESS_LAYER_2)
KRATOS_CREATE_VARIABLE(double, UNIAXIAL_STRESS_LAYER_3)
KRATOS_CREATE_VARIABLE(double, UNIAXIAL_STRESS_LAYER_4)
KRATOS_CREATE_VARIABLE(double, UNIAXIAL_STRESS_LAYER_5)
KRATOS_CREATE_VARIABLE(double, PLASTIC_DISSIPATION_LAYER_1)
KRATOS_CREATE_VARIABLE(double, PLASTIC_DISSIPATION_LAYER_2)
KRATOS_CREATE_VARIABLE(double, PLASTIC_DISSIPATION_LAYER_3)
KRATOS_CREATE_VARIABLE(double, PLASTIC_DISSIPATION_LAYER_4)
KRATOS_CREATE_VARIABLE(double, PLASTIC_DISSIPATION_LAYER_5)
