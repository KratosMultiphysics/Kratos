...
KRATOS_CREATE_VARIABLE(Vector, DELAMINATION_DAMAGE_VECTOR)
...
KRATOS_CREATE_VARIABLE(double, BK_COEFFICIENT)
KRATOS_CREATE_VARIABLE(double, TENSILE_INTERAFCE_MODULUS)
KRATOS_CREATE_VARIABLE(double, SHEAR_INTERAFCE_MODULUS)
