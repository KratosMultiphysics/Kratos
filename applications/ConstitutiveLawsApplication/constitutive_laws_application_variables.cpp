...
// KRATOS_CREATE_VARIABLE(double, DAMAGE_ONSET_STRESS_TENSION)
// KRATOS_CREATE_VARIABLE(double, RESIDUAL_STRESS_TENSION)
// KRATOS_CREATE_VARIABLE(double, BEZIER_CONTROLLER_TENSION_C1)
// KRATOS_CREATE_VARIABLE(double, BEZIER_CONTROLLER_TENSION_C2)
// KRATOS_CREATE_VARIABLE(double, BEZIER_CONTROLLER_TENSION_C3)
// KRATOS_CREATE_VARIABLE(double, YIELD_STRAIN_TENSION)
...
KRATOS_CREATE_VARIABLE(double, SPECIFIC_FRACTURE_ENERGY_TENSION)
KRATOS_CREATE_VARIABLE(double, TRANSFORMATION_MATRIX_COMP_11)
KRATOS_CREATE_VARIABLE(double, TRANSFORMATION_MATRIX_COMP_12)
KRATOS_CREATE_VARIABLE(double, TRANSFORMATION_MATRIX_COMP_13)
KRATOS_CREATE_VARIABLE(double, TRANSFORMATION_MATRIX_COMP_21)
KRATOS_CREATE_VARIABLE(double, TRANSFORMATION_MATRIX_COMP_22)
KRATOS_CREATE_VARIABLE(double, TRANSFORMATION_MATRIX_COMP_23)
KRATOS_CREATE_VARIABLE(double, TRANSFORMATION_MATRIX_COMP_31)
KRATOS_CREATE_VARIABLE(double, TRANSFORMATION_MATRIX_COMP_32)
KRATOS_CREATE_VARIABLE(double, TRANSFORMATION_MATRIX_COMP_33)
