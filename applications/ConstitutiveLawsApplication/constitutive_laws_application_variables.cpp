...
KRATOS_CREATE_VARIABLE(double, REVERSION_FACTOR)
...
KRATOS_CREATE_VARIABLE(int, LOAD_INCREMENTS_PER_CYCLE);
KRATOS_CREATE_VARIABLE(bool, NEW_MODEL_PART);
KRATOS_CREATE_VARIABLE(double, NEW_MODEL_PART_START_TIME);
KRATOS_CREATE_VARIABLE(double, HOLE_DIAMETER);
KRATOS_CREATE_VARIABLE(double, SPECIMEN_WIDTH);
KRATOS_CREATE_VARIABLE(double, SURFACE_ROUGHNESS);
KRATOS_CREATE_VARIABLE(double, MATERIAL_PARAMETER_C1);
KRATOS_CREATE_VARIABLE(double, MATERIAL_PARAMETER_C2);
KRATOS_CREATE_VARIABLE(double, STRESS_RELAXATION_FACTOR);
KRATOS_CREATE_VARIABLE(double, DIRECTIONAL_FACTOR);
