...
KRATOS_CREATE_VARIABLE(double, UNIAXIAL_STRESS_HCF)
KRATOS_CREATE_VARIABLE(double, UNIAXIAL_STRESS_ULCF)
...
KRATOS_CREATE_VARIABLE(Vector, VOLUMETRIC_PART)
KRATOS_CREATE_VARIABLE(double, VOLUMETRIC_PARTICIPATION)
KRATOS_CREATE_VARIABLE(bool, THRESHOLD_XI_DEPENDENCE)
