...
KRATOS_CREATE_VARIABLE(double, HARDENING_MODULUS_COMPRESSION)
KRATOS_CREATE_VARIABLE(double, HARDENING_MODULUS_TENSION)
...
//damage model variables - Athira Vadakkekkara
KRATOS_CREATE_VARIABLE(Matrix, DAMAGE_TENSOR)
KRATOS_CREATE_VARIABLE(Vector, DAMAGE_VECTOR)
KRATOS_CREATE_VARIABLE(Vector, DAMAGE_VECTOR_VOIGT)
KRATOS_CREATE_VARIABLE(Vector, STRAIN_HISTORY_VARIABLES_TENSION)
KRATOS_CREATE_VARIABLE(Vector, STRAIN_HISTORY_VARIABLES_COMPRESSION)
KRATOS_CREATE_VARIABLE(Vector, STRAIN_HISTORY_VARIABLES)
KRATOS_CREATE_VARIABLE(Vector, EQUIVALENT_STRAINS_TC)
KRATOS_CREATE_VARIABLE(double, DAMAGE_THRESHOLD_COMPRESSION)
KRATOS_CREATE_VARIABLE(double, DAMAGE_THRESHOLD_TENSION)
KRATOS_CREATE_VARIABLE(double, DAMAGE_MODEL_PARAMETER_BETA1_TENSION)
KRATOS_CREATE_VARIABLE(double, DAMAGE_MODEL_PARAMETER_BETA2_TENSION)
KRATOS_CREATE_VARIABLE(double, DAMAGE_MODEL_PARAMETER_BETA1_COMPRESSION)
KRATOS_CREATE_VARIABLE(double, DAMAGE_MODEL_PARAMETER_BETA2_COMPRESSION)
