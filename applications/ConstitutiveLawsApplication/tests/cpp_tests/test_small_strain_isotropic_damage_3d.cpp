...
KRATOS_TEST_CASE_IN_SUITE(_ConstitutiveLaw_SmallStrainIsotropicDamage3D_0, KratosConstitutiveLawsFastSuite)
{
    ...
    cl.CalculateValue(cl_parameters, INITIAL_STRAIN_VECTOR, value_vector);  // from Elastic CL
    ...
    //
    //Matrix ref_C = ZeroMatrix(6, 6);
    //ref_C(0,0) =  3.4144  ; ref_C(0,1) =  0.372331; ref_C(0,2) =  0.904191; ref_C(0,3) = -0.255822; ref_C(0,4) = -0.00298958; ref_C(0,5) = 0.156217 ;
    //ref_C(1,0) =  0.372331; ref_C(1,1) =  0.717543; ref_C(1,2) = -0.240483; ref_C(1,3) = -0.626171; ref_C(1,4) = -0.00731753; ref_C(1,5) = 0.38237  ;
    //ref_C(2,0) =  0.904191; ref_C(2,1) = -0.240483; ref_C(2,2) =  2.79767 ; ref_C(2,3) = -0.374359; ref_C(2,4) = -0.00437481; ref_C(2,5) = 0.228601 ;
    //ref_C(3,0) = -0.255822; ref_C(3,1) = -0.626171; ref_C(3,2) = -0.374359; ref_C(3,3) =  1.0088  ; ref_C(3,4) = -0.00141543; ref_C(3,5) = 0.0739619;
    //ref_C(4,0) = -0.002990; ref_C(4,1) = -0.007318; ref_C(4,2) = -0.004375; ref_C(4,3) = -0.001415; ref_C(4,4) =  1.12991   ; ref_C(4,5) = 0.0008643;
    //ref_C(5,0) =  0.156217; ref_C(5,1) =  0.38237 ; ref_C(5,2) =  0.228601; ref_C(5,3) =  0.073962; ref_C(5,4) =  0.00086432; ref_C(5,5) = 1.08476  ;
    //KRATOS_CHECK_MATRIX_NEAR(const_matrix, ref_C, tolerance);
    ...
    //
    // WARNING: CalculateValue below *modifies* the stress vector and contitutive tensor
    // (indeed, the checks commented below pass). Investigate why.
    //
...
KRATOS_TEST_CASE_IN_SUITE(_ConstitutiveLaw_SmallStrainIsotropicDamage3D_1, KratosConstitutiveLawsFastSuite)
{
    ...
    ref_stress(2) = -1.6814;
    ref_stress(3) = -0.544001;
    ref_stress(4) = -0.006357;
    ref_stress(5) =  0.332193;
    KRATOS_CHECK_VECTOR_NEAR(stress_vector, ref_stress, tolerance);
