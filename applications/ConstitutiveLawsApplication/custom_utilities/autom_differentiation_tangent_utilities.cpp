  ...
  )
{
  ...
  const double cr_Ct6 = fabs(cr_Ct5*threshold*(sin_phi + 3.0));
  const double cr_Ct7 = cr_Ct3*cr_Ct4*cr_Ct6;
  const double cr_Ct8 = cr_Ct0*cr_Ct7;
  const double cr_Ct9 = 1.0/(Gf*Young/(characteristic_length*pow(threshold, 2)) - 0.5);
  ...
  const double cr_Ct25 = -cr_Ct23 - 0.49999999999999994*cr_Ct24;
  const double cr_Ct26 = cr_Ct15 + cr_Ct18 + cr_Ct20 - 0.49999999999999994*cr_Ct21 + cr_Ct25;
  const double cr_Ct27 = cr_Ct10 - 0.99999999999999989;
  const double cr_Ct28 = pow(nu - 0.5, -2);
  ...
  const double cr_Ct33 = 0.99999999999999989*cr_Ct16;
  const double cr_Ct34 = -0.49999999999999994*cr_Ct15 + cr_Ct21 + cr_Ct25 + cr_Ct32 + cr_Ct33;
  const double cr_Ct35 = -cr_Ct29*cr_Ct34;
  const double cr_Ct36 = 4.0*nu;
  const double cr_Ct37 = cr_Ct36 - 2.0;
  const double cr_Ct38 = -nu;
  const double cr_Ct39 = pow(cr_Ct38 + 0.5, -2);
  const double cr_Ct40 = 0.99999999999999989*cr_Ct22;
  const double cr_Ct41 = cr_Ct38 + 1.0;
  const double cr_Ct42 = cr_Ct41*r_strain[0];
  const double cr_Ct43 = cr_Ct41*r_strain[1];
  const double cr_Ct44 = 0.49999999999999994*cr_Ct43;
  const double cr_Ct45 = cr_Ct41*r_strain[2];
  const double cr_Ct46 = 0.49999999999999994*cr_Ct45;
  ...
  const double cr_Ct50 = pow(r_strain[3], 2);
  const double cr_Ct51 = pow(r_strain[4], 2);
  const double cr_Ct52 = pow(r_strain[5], 2);
  const double cr_Ct53 = cr_Ct50 + cr_Ct51 + cr_Ct52;
  const double cr_Ct54 = nu + 1.0;
  const double cr_Ct55 = pow(Young, 2)/pow(cr_Ct54, 2);
  const double cr_Ct56 = sqrt(cr_Ct55*(pow(cr_Ct26, 2)*cr_Ct49 + pow(cr_Ct34, 2)*cr_Ct49 + pow(cr_Ct47, 2)*cr_Ct48 + cr_Ct53));
  ...
  const double cr_Ct72 = cr_Ct23 - 0.49999999999999994*cr_Ct42;
  ...
  const double cr_Ct77 = sqrt(cr_Ct55*(cr_Ct48*pow(cr_Ct71, 2) + cr_Ct48*pow(cr_Ct73, 2) + cr_Ct48*pow(cr_Ct75, 2) + cr_Ct53));
  ...
  const double cr_Ct85 = cr_Ct82*exp(-1.0*cr_Ct9*(cr_Ct2*cr_Ct5*(cr_Ct58*cr_Ct66*(2.0*cr_Ct42 + 2.0*cr_Ct43 + 2.0*cr_Ct45 + cr_Ct79 + cr_Ct80 + cr_Ct81) + 0.5*cr_Ct77)/cr_Ct6 - 1));
  ...
  const double cr_Ct98 = pow(Young, 3)*(cr_Ct83 + cr_Ct9)/pow(cr_Ct54, 3);
