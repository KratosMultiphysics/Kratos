...
const double cr_Ct0 = nu - 1.0;
const double cr_Ct1 = sin(0.017453292519938889*phi);
const double cr_Ct2 = 1.7320508075688772*cr_Ct1;
const double cr_Ct3 = cr_Ct2 - 5.196152422706632;
const double cr_Ct4 = 1.0/cr_Ct3;
const double cr_Ct5 = cr_Ct1 - 1;
const double cr_Ct6 = cr_Ct4*cr_Ct5*threshold;
const double cr_Ct7 = 3.0*cr_Ct6;
const double cr_Ct8 = cr_Ct0*cr_Ct7;
const double cr_Ct9 = 2.0*nu;
const double cr_Ct10 = -cr_Ct9;
const double cr_Ct11 = 1.0/(cr_Ct9 - 1.0);
const double cr_Ct12 = cr_Ct1*cr_Ct11*cr_Ct4;
const double cr_Ct13 = cr_Ct12*(cr_Ct10 - 2.0);
...
const double cr_Ct20 = 0.99999999999999989*cr_Ct19;
const double cr_Ct21 = cr_Ct0*r_strain[1];
const double cr_Ct22 = 0.49999999999999994*cr_Ct21;
const double cr_Ct23 = nu*r_strain[0];
const double cr_Ct24 = 0.5*cr_Ct23;
const double cr_Ct25 = cr_Ct0*r_strain[0];
const double cr_Ct26 = 0.49999999999999994*cr_Ct25;
const double cr_Ct27 = -cr_Ct24 - cr_Ct26;
const double cr_Ct28 = cr_Ct15 + cr_Ct18 + cr_Ct20 - cr_Ct22 + cr_Ct27;
const double cr_Ct29 = cr_Ct9 - 0.99999999999999989;
const double cr_Ct30 = pow(nu - 0.5, -2);
const double cr_Ct31 = 0.25*cr_Ct29*cr_Ct30;
const double cr_Ct32 = -cr_Ct28*cr_Ct31;
const double cr_Ct33 = 0.5*cr_Ct19;
const double cr_Ct34 = -cr_Ct33;
const double cr_Ct35 = 0.99999999999999989*cr_Ct16;
const double cr_Ct36 = 0.49999999999999994*cr_Ct15;
const double cr_Ct37 = cr_Ct21 + cr_Ct27 + cr_Ct34 + cr_Ct35 - cr_Ct36;
const double cr_Ct38 = -cr_Ct31*cr_Ct37;
const double cr_Ct39 = 4.0*nu;
const double cr_Ct40 = cr_Ct39 - 2.0;
const double cr_Ct41 = -nu;
const double cr_Ct42 = pow(cr_Ct41 + 0.5, -2);
const double cr_Ct43 = 0.99999999999999989*cr_Ct23;
const double cr_Ct44 = cr_Ct41 + 1.0;
const double cr_Ct45 = cr_Ct44*r_strain[0];
const double cr_Ct46 = cr_Ct44*r_strain[1];
const double cr_Ct47 = 0.49999999999999994*cr_Ct46;
const double cr_Ct48 = cr_Ct44*r_strain[2];
const double cr_Ct49 = 0.49999999999999994*cr_Ct48;
const double cr_Ct50 = cr_Ct18 + cr_Ct34 + cr_Ct43 - cr_Ct45 + cr_Ct47 + cr_Ct49;
const double cr_Ct51 = cr_Ct32 + cr_Ct38 + 0.25*cr_Ct40*cr_Ct42*cr_Ct50;
const double cr_Ct52 = 0.22222222222222227*cr_Ct42;
const double cr_Ct53 = 0.22222222222222227*cr_Ct30;
const double cr_Ct54 = pow(r_strain[3], 2);
const double cr_Ct55 = pow(r_strain[4], 2);
const double cr_Ct56 = pow(r_strain[5], 2);
const double cr_Ct57 = cr_Ct54 + cr_Ct55 + cr_Ct56;
const double cr_Ct58 = nu + 1.0;
const double cr_Ct59 = pow(Young, 2)/pow(cr_Ct58, 2);
const double cr_Ct60 = sqrt(cr_Ct59*(pow(cr_Ct28, 2)*cr_Ct53 + pow(cr_Ct37, 2)*cr_Ct53 + pow(cr_Ct50, 2)*cr_Ct52 + cr_Ct57));
const double cr_Ct61 = 1.0/cr_Ct60;
const double cr_Ct62 = Young/cr_Ct58;
const double cr_Ct63 = cr_Ct61*cr_Ct62;
const double cr_Ct64 = 0.22222222222222227*cr_Ct63;
const double cr_Ct65 = cr_Ct14 + cr_Ct51*cr_Ct64;
const double cr_Ct66 = -cr_Ct16;
const double cr_Ct67 = -cr_Ct19;
const double cr_Ct68 = cr_Ct25 + cr_Ct66 + cr_Ct67;
const double cr_Ct69 = 1.0/(Gf*Young/(characteristic_length*pow(threshold, 2)) - 0.5);
const double cr_Ct70 = 1.0*cr_Ct69;
const double cr_Ct71 = cr_Ct62*cr_Ct70;
const double cr_Ct72 = cr_Ct68*cr_Ct71;
const double cr_Ct73 = 1.0/(cr_Ct10 + 1.0);
const double cr_Ct74 = cr_Ct1*cr_Ct73*(cr_Ct9 + 2.0)/(5.196152422706632 - cr_Ct2);
const double cr_Ct75 = 2.0 - cr_Ct39;
const double cr_Ct76 = -cr_Ct43;
const double cr_Ct77 = cr_Ct33 - cr_Ct49;
const double cr_Ct78 = cr_Ct17 - cr_Ct47;
const double cr_Ct79 = cr_Ct45 + cr_Ct76 + cr_Ct77 + cr_Ct78;
const double cr_Ct80 = -cr_Ct35;
const double cr_Ct81 = cr_Ct24 - 0.49999999999999994*cr_Ct45;
const double cr_Ct82 = cr_Ct46 + cr_Ct77 + cr_Ct80 + cr_Ct81;
const double cr_Ct83 = cr_Ct29*cr_Ct82;
const double cr_Ct84 = -cr_Ct20;
const double cr_Ct85 = cr_Ct48 + cr_Ct78 + cr_Ct81 + cr_Ct84;
const double cr_Ct86 = cr_Ct29*cr_Ct85;
const double cr_Ct87 = 0.055555555555555566*cr_Ct42*cr_Ct62/sqrt(cr_Ct59*(cr_Ct52*pow(cr_Ct79, 2) + cr_Ct52*pow(cr_Ct82, 2) + cr_Ct52*pow(cr_Ct85, 2) + cr_Ct57));
const double cr_Ct88 = cr_Ct74 + cr_Ct87*(cr_Ct75*cr_Ct79 + cr_Ct83 + cr_Ct86);
const double cr_Ct89 = cr_Ct39*r_strain[0];
const double cr_Ct90 = cr_Ct39*r_strain[1];
const double cr_Ct91 = cr_Ct39*r_strain[2];
const double cr_Ct92 = 2.0*cr_Ct25;
const double cr_Ct93 = 2.0*cr_Ct21;
const double cr_Ct94 = 2.0*cr_Ct15;
const double cr_Ct95 = cr_Ct12*cr_Ct62;
const double cr_Ct96 = 0.5*cr_Ct60 - cr_Ct95*(-cr_Ct89 - cr_Ct90 - cr_Ct91 + cr_Ct92 + cr_Ct93 + cr_Ct94);
const double cr_Ct97 = 1.0/cr_Ct96;
const double cr_Ct98 = cr_Ct62*cr_Ct7*cr_Ct97;
const double cr_Ct99 = cr_Ct68*cr_Ct98;
const double cr_Ct100 = 0.33333333333333331*cr_Ct3/(cr_Ct5*threshold);
const double cr_Ct101 = cr_Ct97*exp(cr_Ct70*(-cr_Ct100*cr_Ct96 + 1.0));
const double cr_Ct102 = cr_Ct101*cr_Ct62;
const double cr_Ct103 = cr_Ct102*cr_Ct11;
const double cr_Ct104 = cr_Ct7*nu;
const double cr_Ct105 = cr_Ct11*cr_Ct73;
const double cr_Ct106 = cr_Ct105*cr_Ct40;
const double cr_Ct107 = cr_Ct105*cr_Ct29*cr_Ct50;
const double cr_Ct108 = -cr_Ct106*cr_Ct37 + cr_Ct107 + cr_Ct32;
const double cr_Ct109 = cr_Ct108*cr_Ct64;
const double cr_Ct110 = cr_Ct109 + cr_Ct14;
const double cr_Ct111 = cr_Ct29*cr_Ct79;
const double cr_Ct112 = cr_Ct74 + cr_Ct87*(cr_Ct111 + cr_Ct75*cr_Ct82 + cr_Ct86);
const double cr_Ct113 = -cr_Ct106*cr_Ct28 + cr_Ct107 + cr_Ct38;
const double cr_Ct114 = cr_Ct113*cr_Ct64;
const double cr_Ct115 = cr_Ct114 + cr_Ct14;
const double cr_Ct116 = cr_Ct74 + cr_Ct87*(cr_Ct111 + cr_Ct75*cr_Ct85 + cr_Ct83);
const double cr_Ct117 = pow(Young, 3)*cr_Ct101*cr_Ct61/pow(cr_Ct58, 3);
const double cr_Ct118 = cr_Ct117*r_strain[3];
const double cr_Ct119 = 1.5*cr_Ct6;
const double cr_Ct120 = cr_Ct119*cr_Ct97;
const double cr_Ct121 = cr_Ct11*(cr_Ct120 + 0.5*cr_Ct69);
const double cr_Ct122 = cr_Ct121*cr_Ct68;
const double cr_Ct123 = cr_Ct117*r_strain[4];
const double cr_Ct124 = cr_Ct117*r_strain[5];
const double cr_Ct125 = -cr_Ct23;
const double cr_Ct126 = cr_Ct125 + cr_Ct21 + cr_Ct67;
const double cr_Ct127 = cr_Ct126*cr_Ct71;
const double cr_Ct128 = cr_Ct126*cr_Ct98;
const double cr_Ct129 = -cr_Ct21;
const double cr_Ct130 = cr_Ct129 + cr_Ct19 + cr_Ct23;
const double cr_Ct131 = cr_Ct33 + cr_Ct36;
const double cr_Ct132 = cr_Ct17 + cr_Ct22;
const double cr_Ct133 = cr_Ct24 + cr_Ct26;
const double cr_Ct134 = -cr_Ct15;
const double cr_Ct135 = cr_Ct95*(cr_Ct89 + cr_Ct90 + cr_Ct91 - cr_Ct92 - cr_Ct93 - cr_Ct94) + 0.5*sqrt(cr_Ct59*(cr_Ct53*pow(cr_Ct129 + cr_Ct131 + cr_Ct133 + cr_Ct80, 2) + cr_Ct53*pow(cr_Ct131 + cr_Ct132 - cr_Ct25 + cr_Ct76, 2) + cr_Ct53*pow(cr_Ct132 + cr_Ct133 + cr_Ct134 + cr_Ct84, 2) + cr_Ct57));
const double cr_Ct136 = cr_Ct62/cr_Ct135;
const double cr_Ct137 = cr_Ct136*cr_Ct7;
const double cr_Ct138 = cr_Ct11*cr_Ct136*exp(cr_Ct70*(-cr_Ct100*cr_Ct135 + 1.0));
const double cr_Ct139 = cr_Ct121*cr_Ct126;
const double cr_Ct140 = cr_Ct125 + cr_Ct15 + cr_Ct66;
const double cr_Ct141 = cr_Ct140*cr_Ct71;
const double cr_Ct142 = cr_Ct140*cr_Ct98;
const double cr_Ct143 = cr_Ct134 + cr_Ct16 + cr_Ct23;
const double cr_Ct144 = cr_Ct121*cr_Ct140;
const double cr_Ct145 = -0.5*cr_Ct13;
const double cr_Ct146 = 0.11111111111111113*cr_Ct63;
const double cr_Ct147 = cr_Ct120*cr_Ct88 + cr_Ct69*(cr_Ct145 + cr_Ct146*cr_Ct51);
const double cr_Ct148 = cr_Ct101*cr_Ct59;
const double cr_Ct149 = cr_Ct148*r_strain[3];
const double cr_Ct150 = cr_Ct112*cr_Ct120 + cr_Ct69*(cr_Ct108*cr_Ct146 + cr_Ct145);
const double cr_Ct151 = cr_Ct116*cr_Ct120 + cr_Ct69*(cr_Ct113*cr_Ct146 + cr_Ct145);
const double cr_Ct152 = 0.25*cr_Ct69;
const double cr_Ct153 = cr_Ct59*cr_Ct61;
const double cr_Ct154 = cr_Ct152*cr_Ct153;
const double cr_Ct155 = 0.75*cr_Ct6*cr_Ct97;
const double cr_Ct156 = cr_Ct153*cr_Ct155;
const double cr_Ct157 = cr_Ct152 + cr_Ct155;
const double cr_Ct158 = cr_Ct118*cr_Ct157;
const double cr_Ct159 = -cr_Ct158*r_strain[4];
const double cr_Ct160 = -cr_Ct158*r_strain[5];
const double cr_Ct161 = cr_Ct148*r_strain[4];
const double cr_Ct162 = -cr_Ct123*cr_Ct157*r_strain[5];
const double cr_Ct163 = cr_Ct148*r_strain[5];
r_Ct(0,0)=cr_Ct103*(-cr_Ct65*cr_Ct72 + cr_Ct8 - cr_Ct88*cr_Ct99);
r_Ct(0,1)=-cr_Ct103*(cr_Ct104 + cr_Ct110*cr_Ct72 + cr_Ct112*cr_Ct99);
r_Ct(0,2)=-cr_Ct103*(cr_Ct104 + cr_Ct115*cr_Ct72 + cr_Ct116*cr_Ct99);
r_Ct(0,3)=-cr_Ct118*cr_Ct122;
r_Ct(0,4)=-cr_Ct122*cr_Ct123;
r_Ct(0,5)=-cr_Ct122*cr_Ct124;
r_Ct(1,0)=-cr_Ct103*(cr_Ct104 + cr_Ct127*cr_Ct65 + cr_Ct128*cr_Ct88);
r_Ct(1,1)=cr_Ct138*(cr_Ct110*cr_Ct130*cr_Ct137 - cr_Ct130*cr_Ct71*(-cr_Ct109 + cr_Ct13) + cr_Ct8);
r_Ct(1,2)=-cr_Ct103*(cr_Ct104 + cr_Ct115*cr_Ct127 + cr_Ct116*cr_Ct128);
r_Ct(1,3)=-cr_Ct118*cr_Ct139;
r_Ct(1,4)=-cr_Ct123*cr_Ct139;
r_Ct(1,5)=-cr_Ct124*cr_Ct139;
r_Ct(2,0)=-cr_Ct103*(cr_Ct104 + cr_Ct141*cr_Ct65 + cr_Ct142*cr_Ct88);
r_Ct(2,1)=-cr_Ct103*(cr_Ct104 + cr_Ct110*cr_Ct141 + cr_Ct112*cr_Ct142);
r_Ct(2,2)=cr_Ct138*(cr_Ct115*cr_Ct137*cr_Ct143 - cr_Ct143*cr_Ct71*(-cr_Ct114 + cr_Ct13) + cr_Ct8);
r_Ct(2,3)=-cr_Ct118*cr_Ct144;
r_Ct(2,4)=-cr_Ct123*cr_Ct144;
r_Ct(2,5)=-cr_Ct124*cr_Ct144;
r_Ct(3,0)=-cr_Ct147*cr_Ct149;
r_Ct(3,1)=-cr_Ct149*cr_Ct150;
r_Ct(3,2)=-cr_Ct149*cr_Ct151;
r_Ct(3,3)=cr_Ct102*(cr_Ct119 - cr_Ct154*cr_Ct54 - cr_Ct156*cr_Ct54);
r_Ct(3,4)=cr_Ct159;
r_Ct(3,5)=cr_Ct160;
r_Ct(4,0)=-cr_Ct147*cr_Ct161;
r_Ct(4,1)=-cr_Ct150*cr_Ct161;
r_Ct(4,2)=-cr_Ct151*cr_Ct161;
r_Ct(4,3)=cr_Ct159;
r_Ct(4,4)=cr_Ct102*(cr_Ct119 - cr_Ct154*cr_Ct55 - cr_Ct156*cr_Ct55);
r_Ct(4,5)=cr_Ct162;
r_Ct(5,0)=-cr_Ct147*cr_Ct163;
r_Ct(5,1)=-cr_Ct150*cr_Ct163;
r_Ct(5,2)=-cr_Ct151*cr_Ct163;
r_Ct(5,3)=cr_Ct160;
r_Ct(5,4)=cr_Ct162;
r_Ct(5,5)=cr_Ct102*(cr_Ct119 - cr_Ct154*cr_Ct56 - cr_Ct156*cr_Ct56);
