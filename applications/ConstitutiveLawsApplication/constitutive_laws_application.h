...
private:
    ...
    // New custom viscoplasticity
    const GenericSmallStrainIsotropicCornejoViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<VonMisesYieldSurface<VonMisesPlasticPotential<6>>>> mSmallStrainIsotropicCornejoViscoPlasticity3DVonMisesVonMises;


    const GenericSmallStrainIsotropicPerzynaViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<VonMisesYieldSurface<VonMisesPlasticPotential<3>>>> mSmallStrainIsotropicViscoPlasticityPlaneStrainVonMisesVonMises;
    const GenericSmallStrainIsotropicPerzynaViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<VonMisesYieldSurface<ModifiedMohrCoulombPlasticPotential<3>>>> mSmallStrainIsotropicViscoPlasticityPlaneStrainVonMisesModifiedMohrCoulomb;
    const GenericSmallStrainIsotropicPerzynaViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<VonMisesYieldSurface<DruckerPragerPlasticPotential<3>>>> mSmallStrainIsotropicViscoPlasticityPlaneStrainVonMisesDruckerPrager;
    const GenericSmallStrainIsotropicPerzynaViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<VonMisesYieldSurface<TrescaPlasticPotential<3>>>> mSmallStrainIsotropicViscoPlasticityPlaneStrainVonMisesTresca;
    const GenericSmallStrainIsotropicPerzynaViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<ModifiedMohrCoulombYieldSurface<VonMisesPlasticPotential<3>>>> mSmallStrainIsotropicViscoPlasticityPlaneStrainModifiedMohrCoulombVonMises;
    const GenericSmallStrainIsotropicPerzynaViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<ModifiedMohrCoulombYieldSurface<ModifiedMohrCoulombPlasticPotential<3>>>> mSmallStrainIsotropicViscoPlasticityPlaneStrainModifiedMohrCoulombModifiedMohrCoulomb;
    const GenericSmallStrainIsotropicPerzynaViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<ModifiedMohrCoulombYieldSurface<DruckerPragerPlasticPotential<3>>>> mSmallStrainIsotropicViscoPlasticityPlaneStrainModifiedMohrCoulombDruckerPrager;
    const GenericSmallStrainIsotropicPerzynaViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<ModifiedMohrCoulombYieldSurface<TrescaPlasticPotential<3>>>> mSmallStrainIsotropicViscoPlasticityPlaneStrainModifiedMohrCoulombTresca;
    const GenericSmallStrainIsotropicPerzynaViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<TrescaYieldSurface<VonMisesPlasticPotential<3>>>> mSmallStrainIsotropicViscoPlasticityPlaneStrainTrescaVonMises;
    const GenericSmallStrainIsotropicPerzynaViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<TrescaYieldSurface<ModifiedMohrCoulombPlasticPotential<3>>>> mSmallStrainIsotropicViscoPlasticityPlaneStrainTrescaModifiedMohrCoulomb;
    const GenericSmallStrainIsotropicPerzynaViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<TrescaYieldSurface<DruckerPragerPlasticPotential<3>>>> mSmallStrainIsotropicViscoPlasticityPlaneStrainTrescaDruckerPrager;
    const GenericSmallStrainIsotropicPerzynaViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<TrescaYieldSurface<TrescaPlasticPotential<3>>>> mSmallStrainIsotropicViscoPlasticityPlaneStrainTrescaTresca;
    const GenericSmallStrainIsotropicPerzynaViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<DruckerPragerYieldSurface<VonMisesPlasticPotential<3>>>> mSmallStrainIsotropicViscoPlasticityPlaneStrainDruckerPragerVonMises;
    const GenericSmallStrainIsotropicPerzynaViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<DruckerPragerYieldSurface<ModifiedMohrCoulombPlasticPotential<3>>>> mSmallStrainIsotropicViscoPlasticityPlaneStrainDruckerPragerModifiedMohrCoulomb;
    const GenericSmallStrainIsotropicPerzynaViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<DruckerPragerYieldSurface<DruckerPragerPlasticPotential<3>>>> mSmallStrainIsotropicViscoPlasticityPlaneStrainDruckerPragerDruckerPrager;
    const GenericSmallStrainIsotropicPerzynaViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<DruckerPragerYieldSurface<TrescaPlasticPotential<3>>>> mSmallStrainIsotropicViscoPlasticityPlaneStrainDruckerPragerTresca;
    const GenericSmallStrainIsotropicPerzynaViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<VonMisesYieldSurface<MohrCoulombPlasticPotential<3>>>> mSmallStrainIsotropicViscoPlasticityPlaneStrainVonMisesMohrCoulomb;
    const GenericSmallStrainIsotropicPerzynaViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<MohrCoulombYieldSurface<VonMisesPlasticPotential<3>>>> mSmallStrainIsotropicViscoPlasticityPlaneStrainMohrCoulombVonMises;
    const GenericSmallStrainIsotropicPerzynaViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<MohrCoulombYieldSurface<MohrCoulombPlasticPotential<3>>>> mSmallStrainIsotropicViscoPlasticityPlaneStrainMohrCoulombMohrCoulomb;
    const GenericSmallStrainIsotropicPerzynaViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<MohrCoulombYieldSurface<DruckerPragerPlasticPotential<3>>>> mSmallStrainIsotropicViscoPlasticityPlaneStrainMohrCoulombDruckerPrager;
    const GenericSmallStrainIsotropicPerzynaViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<MohrCoulombYieldSurface<TrescaPlasticPotential<3>>>> mSmallStrainIsotropicViscoPlasticityPlaneStrainMohrCoulombTresca;
    const GenericSmallStrainIsotropicPerzynaViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<TrescaYieldSurface<MohrCoulombPlasticPotential<3>>>> mSmallStrainIsotropicViscoPlasticityPlaneStrainTrescaMohrCoulomb;
    const GenericSmallStrainIsotropicPerzynaViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<DruckerPragerYieldSurface<MohrCoulombPlasticPotential<3>>>> mSmallStrainIsotropicViscoPlasticityPlaneStrainDruckerPragerMohrCoulomb;

    const GenericSmallStrainIsotropicPerzynaViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<VonMisesYieldSurface<VonMisesPlasticPotential<6>>>> mSmallStrainIsotropicViscoPlasticity3DVonMisesVonMises;
    const GenericSmallStrainIsotropicPerzynaViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<VonMisesYieldSurface<ModifiedMohrCoulombPlasticPotential<6>>>> mSmallStrainIsotropicViscoPlasticity3DVonMisesModifiedMohrCoulomb;
    const GenericSmallStrainIsotropicPerzynaViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<VonMisesYieldSurface<DruckerPragerPlasticPotential<6>>>> mSmallStrainIsotropicViscoPlasticity3DVonMisesDruckerPrager;
    const GenericSmallStrainIsotropicPerzynaViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<VonMisesYieldSurface<TrescaPlasticPotential<6>>>> mSmallStrainIsotropicViscoPlasticity3DVonMisesTresca;
    const GenericSmallStrainIsotropicPerzynaViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<ModifiedMohrCoulombYieldSurface<VonMisesPlasticPotential<6>>>> mSmallStrainIsotropicViscoPlasticity3DModifiedMohrCoulombVonMises;
    const GenericSmallStrainIsotropicPerzynaViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<ModifiedMohrCoulombYieldSurface<ModifiedMohrCoulombPlasticPotential<6>>>> mSmallStrainIsotropicViscoPlasticity3DModifiedMohrCoulombModifiedMohrCoulomb;
    const GenericSmallStrainIsotropicPerzynaViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<ModifiedMohrCoulombYieldSurface<DruckerPragerPlasticPotential<6>>>> mSmallStrainIsotropicViscoPlasticity3DModifiedMohrCoulombDruckerPrager;
    const GenericSmallStrainIsotropicPerzynaViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<ModifiedMohrCoulombYieldSurface<TrescaPlasticPotential<6>>>> mSmallStrainIsotropicViscoPlasticity3DModifiedMohrCoulombTresca;
    const GenericSmallStrainIsotropicPerzynaViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<TrescaYieldSurface<VonMisesPlasticPotential<6>>>> mSmallStrainIsotropicViscoPlasticity3DTrescaVonMises;
    const GenericSmallStrainIsotropicPerzynaViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<TrescaYieldSurface<ModifiedMohrCoulombPlasticPotential<6>>>> mSmallStrainIsotropicViscoPlasticity3DTrescaModifiedMohrCoulomb;
    const GenericSmallStrainIsotropicPerzynaViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<TrescaYieldSurface<DruckerPragerPlasticPotential<6>>>> mSmallStrainIsotropicViscoPlasticity3DTrescaDruckerPrager;
    const GenericSmallStrainIsotropicPerzynaViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<TrescaYieldSurface<TrescaPlasticPotential<6>>>> mSmallStrainIsotropicViscoPlasticity3DTrescaTresca;
    const GenericSmallStrainIsotropicPerzynaViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<DruckerPragerYieldSurface<VonMisesPlasticPotential<6>>>> mSmallStrainIsotropicViscoPlasticity3DDruckerPragerVonMises;
    const GenericSmallStrainIsotropicPerzynaViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<DruckerPragerYieldSurface<ModifiedMohrCoulombPlasticPotential<6>>>> mSmallStrainIsotropicViscoPlasticity3DDruckerPragerModifiedMohrCoulomb;
    const GenericSmallStrainIsotropicPerzynaViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<DruckerPragerYieldSurface<DruckerPragerPlasticPotential<6>>>> mSmallStrainIsotropicViscoPlasticity3DDruckerPragerDruckerPrager;
    const GenericSmallStrainIsotropicPerzynaViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<DruckerPragerYieldSurface<TrescaPlasticPotential<6>>>> mSmallStrainIsotropicViscoPlasticity3DDruckerPragerTresca;
    const GenericSmallStrainIsotropicPerzynaViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<VonMisesYieldSurface<MohrCoulombPlasticPotential<6>>>> mSmallStrainIsotropicViscoPlasticity3DVonMisesMohrCoulomb;
    const GenericSmallStrainIsotropicPerzynaViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<MohrCoulombYieldSurface<VonMisesPlasticPotential<6>>>> mSmallStrainIsotropicViscoPlasticity3DMohrCoulombVonMises;
    const GenericSmallStrainIsotropicPerzynaViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<MohrCoulombYieldSurface<MohrCoulombPlasticPotential<6>>>> mSmallStrainIsotropicViscoPlasticity3DMohrCoulombMohrCoulomb;
    const GenericSmallStrainIsotropicPerzynaViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<MohrCoulombYieldSurface<DruckerPragerPlasticPotential<6>>>> mSmallStrainIsotropicViscoPlasticity3DMohrCoulombDruckerPrager;
    const GenericSmallStrainIsotropicPerzynaViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<MohrCoulombYieldSurface<TrescaPlasticPotential<6>>>> mSmallStrainIsotropicViscoPlasticity3DMohrCoulombTresca;
    const GenericSmallStrainIsotropicPerzynaViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<TrescaYieldSurface<MohrCoulombPlasticPotential<6>>>> mSmallStrainIsotropicViscoPlasticity3DTrescaMohrCoulomb;
    const GenericSmallStrainIsotropicPerzynaViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<DruckerPragerYieldSurface<MohrCoulombPlasticPotential<6>>>> mSmallStrainIsotropicViscoPlasticity3DDruckerPragerMohrCoulomb;

    const GenericSmallStrainKinematicPlasticityPlaneStress <GenericConstitutiveLawIntegratorKinematicPlasticity<PlaneStressVonMisesYieldSurface<PlaneStressVonMisesPlasticPotential<3>>>> mSmallStrainKinematicPlasticityPlaneStressVonMisesVonMises;
    ...
    const GenericFiniteStrainIsotropicPlasticityPlaneStress<GenericConstitutiveLawIntegratorPlasticity<PlaneStressVonMisesYieldSurface<PlaneStressVonMisesPlasticPotential<3>>>> mFiniteStrainIsotropicPlasticityPlaneStressVonMisesVonMises;
    ...
    const GenericFiniteStrainKinematicPlasticityPlaneStress<GenericConstitutiveLawIntegratorKinematicPlasticity<PlaneStressVonMisesYieldSurface<PlaneStressVonMisesPlasticPotential<3>>>> mFiniteStrainKinematicPlasticityPlaneStressVonMisesVonMises;
