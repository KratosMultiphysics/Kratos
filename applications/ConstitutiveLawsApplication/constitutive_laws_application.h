...
private:
    ...
    const GenericSmallStrainIsotropicViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<VonMisesYieldSurface<VonMisesPlasticPotential<3>>>> mSmallStrainIsotropicViscoPlasticityPlaneStrainVonMisesVonMises;
    const GenericSmallStrainIsotropicViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<VonMisesYieldSurface<ModifiedMohrCoulombPlasticPotential<3>>>> mSmallStrainIsotropicViscoPlasticityPlaneStrainVonMisesModifiedMohrCoulomb;
    const GenericSmallStrainIsotropicViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<VonMisesYieldSurface<DruckerPragerPlasticPotential<3>>>> mSmallStrainIsotropicViscoPlasticityPlaneStrainVonMisesDruckerPrager;
    const GenericSmallStrainIsotropicViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<VonMisesYieldSurface<TrescaPlasticPotential<3>>>> mSmallStrainIsotropicViscoPlasticityPlaneStrainVonMisesTresca;
    const GenericSmallStrainIsotropicViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<ModifiedMohrCoulombYieldSurface<VonMisesPlasticPotential<3>>>> mSmallStrainIsotropicViscoPlasticityPlaneStrainModifiedMohrCoulombVonMises;
    const GenericSmallStrainIsotropicViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<ModifiedMohrCoulombYieldSurface<ModifiedMohrCoulombPlasticPotential<3>>>> mSmallStrainIsotropicViscoPlasticityPlaneStrainModifiedMohrCoulombModifiedMohrCoulomb;
    const GenericSmallStrainIsotropicViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<ModifiedMohrCoulombYieldSurface<DruckerPragerPlasticPotential<3>>>> mSmallStrainIsotropicViscoPlasticityPlaneStrainModifiedMohrCoulombDruckerPrager;
    const GenericSmallStrainIsotropicViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<ModifiedMohrCoulombYieldSurface<TrescaPlasticPotential<3>>>> mSmallStrainIsotropicViscoPlasticityPlaneStrainModifiedMohrCoulombTresca;
    const GenericSmallStrainIsotropicViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<TrescaYieldSurface<VonMisesPlasticPotential<3>>>> mSmallStrainIsotropicViscoPlasticityPlaneStrainTrescaVonMises;
    const GenericSmallStrainIsotropicViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<TrescaYieldSurface<ModifiedMohrCoulombPlasticPotential<3>>>> mSmallStrainIsotropicViscoPlasticityPlaneStrainTrescaModifiedMohrCoulomb;
    const GenericSmallStrainIsotropicViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<TrescaYieldSurface<DruckerPragerPlasticPotential<3>>>> mSmallStrainIsotropicViscoPlasticityPlaneStrainTrescaDruckerPrager;
    const GenericSmallStrainIsotropicViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<TrescaYieldSurface<TrescaPlasticPotential<3>>>> mSmallStrainIsotropicViscoPlasticityPlaneStrainTrescaTresca;
    const GenericSmallStrainIsotropicViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<DruckerPragerYieldSurface<VonMisesPlasticPotential<3>>>> mSmallStrainIsotropicViscoPlasticityPlaneStrainDruckerPragerVonMises;
    const GenericSmallStrainIsotropicViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<DruckerPragerYieldSurface<ModifiedMohrCoulombPlasticPotential<3>>>> mSmallStrainIsotropicViscoPlasticityPlaneStrainDruckerPragerModifiedMohrCoulomb;
    const GenericSmallStrainIsotropicViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<DruckerPragerYieldSurface<DruckerPragerPlasticPotential<3>>>> mSmallStrainIsotropicViscoPlasticityPlaneStrainDruckerPragerDruckerPrager;
    const GenericSmallStrainIsotropicViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<DruckerPragerYieldSurface<TrescaPlasticPotential<3>>>> mSmallStrainIsotropicViscoPlasticityPlaneStrainDruckerPragerTresca;
    const GenericSmallStrainIsotropicViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<VonMisesYieldSurface<MohrCoulombPlasticPotential<3>>>> mSmallStrainIsotropicViscoPlasticityPlaneStrainVonMisesMohrCoulomb;
    const GenericSmallStrainIsotropicViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<MohrCoulombYieldSurface<VonMisesPlasticPotential<3>>>> mSmallStrainIsotropicViscoPlasticityPlaneStrainMohrCoulombVonMises;
    const GenericSmallStrainIsotropicViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<MohrCoulombYieldSurface<MohrCoulombPlasticPotential<3>>>> mSmallStrainIsotropicViscoPlasticityPlaneStrainMohrCoulombMohrCoulomb;
    const GenericSmallStrainIsotropicViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<MohrCoulombYieldSurface<DruckerPragerPlasticPotential<3>>>> mSmallStrainIsotropicViscoPlasticityPlaneStrainMohrCoulombDruckerPrager;
    const GenericSmallStrainIsotropicViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<MohrCoulombYieldSurface<TrescaPlasticPotential<3>>>> mSmallStrainIsotropicViscoPlasticityPlaneStrainMohrCoulombTresca;
    const GenericSmallStrainIsotropicViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<TrescaYieldSurface<MohrCoulombPlasticPotential<3>>>> mSmallStrainIsotropicViscoPlasticityPlaneStrainTrescaMohrCoulomb;
    const GenericSmallStrainIsotropicViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<DruckerPragerYieldSurface<MohrCoulombPlasticPotential<3>>>> mSmallStrainIsotropicViscoPlasticityPlaneStrainDruckerPragerMohrCoulomb;

    const GenericSmallStrainIsotropicViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<VonMisesYieldSurface<VonMisesPlasticPotential<6>>>> mSmallStrainIsotropicViscoPlasticity3DVonMisesVonMises;
    const GenericSmallStrainIsotropicViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<VonMisesYieldSurface<ModifiedMohrCoulombPlasticPotential<6>>>> mSmallStrainIsotropicViscoPlasticity3DVonMisesModifiedMohrCoulomb;
    const GenericSmallStrainIsotropicViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<VonMisesYieldSurface<DruckerPragerPlasticPotential<6>>>> mSmallStrainIsotropicViscoPlasticity3DVonMisesDruckerPrager;
    const GenericSmallStrainIsotropicViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<VonMisesYieldSurface<TrescaPlasticPotential<6>>>> mSmallStrainIsotropicViscoPlasticity3DVonMisesTresca;
    const GenericSmallStrainIsotropicViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<ModifiedMohrCoulombYieldSurface<VonMisesPlasticPotential<6>>>> mSmallStrainIsotropicViscoPlasticity3DModifiedMohrCoulombVonMises;
    const GenericSmallStrainIsotropicViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<ModifiedMohrCoulombYieldSurface<ModifiedMohrCoulombPlasticPotential<6>>>> mSmallStrainIsotropicViscoPlasticity3DModifiedMohrCoulombModifiedMohrCoulomb;
    const GenericSmallStrainIsotropicViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<ModifiedMohrCoulombYieldSurface<DruckerPragerPlasticPotential<6>>>> mSmallStrainIsotropicViscoPlasticity3DModifiedMohrCoulombDruckerPrager;
    const GenericSmallStrainIsotropicViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<ModifiedMohrCoulombYieldSurface<TrescaPlasticPotential<6>>>> mSmallStrainIsotropicViscoPlasticity3DModifiedMohrCoulombTresca;
    const GenericSmallStrainIsotropicViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<TrescaYieldSurface<VonMisesPlasticPotential<6>>>> mSmallStrainIsotropicViscoPlasticity3DTrescaVonMises;
    const GenericSmallStrainIsotropicViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<TrescaYieldSurface<ModifiedMohrCoulombPlasticPotential<6>>>> mSmallStrainIsotropicViscoPlasticity3DTrescaModifiedMohrCoulomb;
    const GenericSmallStrainIsotropicViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<TrescaYieldSurface<DruckerPragerPlasticPotential<6>>>> mSmallStrainIsotropicViscoPlasticity3DTrescaDruckerPrager;
    const GenericSmallStrainIsotropicViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<TrescaYieldSurface<TrescaPlasticPotential<6>>>> mSmallStrainIsotropicViscoPlasticity3DTrescaTresca;
    const GenericSmallStrainIsotropicViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<DruckerPragerYieldSurface<VonMisesPlasticPotential<6>>>> mSmallStrainIsotropicViscoPlasticity3DDruckerPragerVonMises;
    const GenericSmallStrainIsotropicViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<DruckerPragerYieldSurface<ModifiedMohrCoulombPlasticPotential<6>>>> mSmallStrainIsotropicViscoPlasticity3DDruckerPragerModifiedMohrCoulomb;
    const GenericSmallStrainIsotropicViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<DruckerPragerYieldSurface<DruckerPragerPlasticPotential<6>>>> mSmallStrainIsotropicViscoPlasticity3DDruckerPragerDruckerPrager;
    const GenericSmallStrainIsotropicViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<DruckerPragerYieldSurface<TrescaPlasticPotential<6>>>> mSmallStrainIsotropicViscoPlasticity3DDruckerPragerTresca;
    const GenericSmallStrainIsotropicViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<VonMisesYieldSurface<MohrCoulombPlasticPotential<6>>>> mSmallStrainIsotropicViscoPlasticity3DVonMisesMohrCoulomb;
    const GenericSmallStrainIsotropicViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<MohrCoulombYieldSurface<VonMisesPlasticPotential<6>>>> mSmallStrainIsotropicViscoPlasticity3DMohrCoulombVonMises;
    const GenericSmallStrainIsotropicViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<MohrCoulombYieldSurface<MohrCoulombPlasticPotential<6>>>> mSmallStrainIsotropicViscoPlasticity3DMohrCoulombMohrCoulomb;
    const GenericSmallStrainIsotropicViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<MohrCoulombYieldSurface<DruckerPragerPlasticPotential<6>>>> mSmallStrainIsotropicViscoPlasticity3DMohrCoulombDruckerPrager;
    const GenericSmallStrainIsotropicViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<MohrCoulombYieldSurface<TrescaPlasticPotential<6>>>> mSmallStrainIsotropicViscoPlasticity3DMohrCoulombTresca;
    const GenericSmallStrainIsotropicViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<TrescaYieldSurface<MohrCoulombPlasticPotential<6>>>> mSmallStrainIsotropicViscoPlasticity3DTrescaMohrCoulomb;
    const GenericSmallStrainIsotropicViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<DruckerPragerYieldSurface<MohrCoulombPlasticPotential<6>>>> mSmallStrainIsotropicViscoPlasticity3DDruckerPragerMohrCoulomb;
