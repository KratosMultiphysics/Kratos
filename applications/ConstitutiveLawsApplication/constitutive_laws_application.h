...
private:
    ...
    const GenericSmallStrainIsotropicViscoPlasticity <GenericConstitutiveLawIntegratorPlasticity<VonMisesYieldSurface<VonMisesPlasticPotential<6>>>> mSmallStrainIsotropicViscoPlasticityPlasticity3DVonMisesVonMises;
