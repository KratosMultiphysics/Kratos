...
PYBIND11_MODULE(KratosConstitutiveLawsApplication,m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, FATIGUE_REDUCTION_FACTOR_VECTOR_MODE_ONE)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, FATIGUE_REDUCTION_FACTOR_VECTOR_MODE_TWO)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, WOHLER_STRESS_VECTOR_MODE_ONE)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, WOHLER_STRESS_VECTOR_MODE_TWO)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, LOCAL_NUMBER_OF_CYCLES_MODE_ONE)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, LOCAL_NUMBER_OF_CYCLES_MODE_TWO)
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, INTERFACIAL_STRESS_VECTOR)
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, STRESS_VECTOR_COMP_1)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, STRESS_VECTOR_COMP_2)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, STRESS_VECTOR_COMP_3)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, STRESS_VECTOR_COMP_4)
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, HIGH_CYCLE_FATIGUE_COEFFICIENTS)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, HIGH_CYCLE_FATIGUE_COEFFICIENTS_MODE_ONE)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, HIGH_CYCLE_FATIGUE_COEFFICIENTS_MODE_TWO)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, STRESS_LIMITS)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, HARDENING_PARAMETERS)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, FATIGUE_REDUCTION_FACTOR)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, LOCAL_NUMBER_OF_CYCLES)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, INCREMENT_IN_NUMBER_OF_CYCLES)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, WOHLER_STRESS)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, REVERSION_FACTOR_RELATIVE_ERROR)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, MAX_STRESS_RELATIVE_ERROR)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, MAX_STRESS)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, REFERENCE_DAMAGE)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, PREVIOUS_CYCLE_DAMAGE)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, THRESHOLD_STRESS)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, CYCLE_INDICATOR)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, CYCLES_TO_FAILURE)
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, CYCLE_PERIOD)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, ADVANCE_STRATEGY_APPLIED)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, AIT_CONTROL_PARAMETER)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, AIT_CONTROL_COUNTER)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, CURRENT_LOAD_TYPE)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, NEW_MODEL_PART)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, SYMMETRIZE_TANGENT_OPERATOR)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, MODE_ONE_UNIAXIAL_STRESS)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, MODE_TWO_UNIAXIAL_STRESS)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, DEFAULT_METHOD)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, USER_DEFINED_METHOD)
