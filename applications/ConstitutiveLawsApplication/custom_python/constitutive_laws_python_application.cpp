...
PYBIND11_MODULE(KratosConstitutiveLawsApplication,m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, PLASTIC_STRAIN_VECTOR_TOP_SURFACE)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, PLASTIC_STRAIN_VECTOR_MIDDLE_SURFACE)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, PLASTIC_STRAIN_VECTOR_BOTTOM_SURFACE)
