...
PYBIND11_MODULE(KratosConstitutiveLawsApplication,m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, REVERSION_FACTOR)
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, LOAD_INCREMENTS_PER_CYCLE)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, NEW_MODEL_PART)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, NEW_MODEL_PART_START_TIME)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, HOLE_DIAMETER)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, SPECIMEN_WIDTH)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, SURFACE_ROUGHNESS)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, MATERIAL_PARAMETER_C1)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, MATERIAL_PARAMETER_C2)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, STRESS_RELAXATION_FACTOR)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, DIRECTIONAL_FACTOR)
