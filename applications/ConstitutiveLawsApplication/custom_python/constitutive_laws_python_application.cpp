...
PYBIND11_MODULE(KratosConstitutiveLawsApplication,m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, DAMAGE_VECTOR)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, DAMAGE_TENSOR)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, EQUIVALENT_STRAINS_TC)
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, DAMAGE_THRESHOLD_COMPRESSION)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, DAMAGE_THRESHOLD_TENSION)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, DAMAGE_MODEL_PARAMETER_BETA1_TENSION)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, DAMAGE_MODEL_PARAMETER_BETA2_TENSION)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, DAMAGE_MODEL_PARAMETER_BETA1_COMPRESSION)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, DAMAGE_MODEL_PARAMETER_BETA2_COMPRESSION)
