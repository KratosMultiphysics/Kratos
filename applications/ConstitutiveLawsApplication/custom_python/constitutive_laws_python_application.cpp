...
PYBIND11_MODULE(KratosConstitutiveLawsApplication,m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, UNIAXIAL_STRESS_HCF)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, UNIAXIAL_STRESS_ULCF)
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, VOLUMETRIC_PART)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, VOLUMETRIC_PARTICIPATION)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, THRESHOLD_XI_DEPENDENCE)
