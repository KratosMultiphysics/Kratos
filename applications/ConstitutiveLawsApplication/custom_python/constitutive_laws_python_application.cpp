...
PYBIND11_MODULE(KratosConstitutiveLawsApplication,m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, PLASTIC_DISSIPATION_FIBER)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, PLASTIC_DISSIPATION_MATRIX)
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, CAUCHY_STRESS_VECTOR_LAYER_1)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, CAUCHY_STRESS_VECTOR_LAYER_2)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, CAUCHY_STRESS_VECTOR_LAYER_3)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, CAUCHY_STRESS_VECTOR_LAYER_4)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, CAUCHY_STRESS_VECTOR_LAYER_5)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, DAMAGE_LAYER_1)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, DAMAGE_LAYER_2)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, DAMAGE_LAYER_3)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, DAMAGE_LAYER_4)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, DAMAGE_LAYER_5)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, PLASTIC_STRAIN_VECTOR_LAYER_1)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, PLASTIC_STRAIN_VECTOR_LAYER_2)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, PLASTIC_STRAIN_VECTOR_LAYER_3)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, PLASTIC_STRAIN_VECTOR_LAYER_4)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, PLASTIC_STRAIN_VECTOR_LAYER_5)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, UNIAXIAL_STRESS_LAYER_1)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, UNIAXIAL_STRESS_LAYER_2)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, UNIAXIAL_STRESS_LAYER_3)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, UNIAXIAL_STRESS_LAYER_4)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, UNIAXIAL_STRESS_LAYER_5)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, PLASTIC_DISSIPATION_LAYER_1)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, PLASTIC_DISSIPATION_LAYER_2)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, PLASTIC_DISSIPATION_LAYER_3)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, PLASTIC_DISSIPATION_LAYER_4)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, PLASTIC_DISSIPATION_LAYER_5)
