            ...
            for elem in self.main_model_part.Elements:
                if elem.Id == id_for_print:
                    ...
                    if first_code_line == True:
                        ...
                        plot_file.write("    " + "self.time".rjust(20) + "    " + "N_c GLOBAL".rjust(20) + "    " + "N_c LOCAL".rjust(20) + "    " + "uniaxial_stresses".rjust(20) + "    " + "damage".rjust(20) + "    " + "f_red".rjust(20) + "    " + "wohler_stress".rjust(20) + "    " + "c_factor".rjust(20) + "    " + "stress_ratio".rjust(20) + "    " + "strain_XX_component".rjust(20) + "    " + "stress_XX_component".rjust(20) + "    " + "normalized_stress_XX".rjust(20)+ "    " + "normalized_uniaxial_stress".rjust(20) + "\n")
