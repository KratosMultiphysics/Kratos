...
def Factory(settings):
    ...
    return AveragePooling1DLayer(settings)

class AveragePooling1DLayer(NeuralNetworkLayerClass):
    """This class generates a base class for an AveragePooling1D layer.
    ...
    def Build(self, hp = None):
        ...
        self.layer = layers.AveragePooling1D(pool_size=self.pool_size, strides=self.strides, padding=self.padding, 
