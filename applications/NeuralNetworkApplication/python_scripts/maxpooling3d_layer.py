...
def Factory(settings):
    ...
    return MaxPooling3DLayer(settings)

class MaxPooling3DLayer(NeuralNetworkLayerClass):
    ...
    def Build(self, hp = None):
        ...
        self.layer = layers.MaxPooling3D(pool_size=self.pool_size, strides=self.strides, padding=self.padding, 
