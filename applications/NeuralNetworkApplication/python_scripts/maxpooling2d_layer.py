...
def Factory(settings):
    ...
    return MaxPooling2DLayer(settings)

class MaxPooling2DLayer(NeuralNetworkLayerClass):
    ...
    def Build(self, hp = None):
        ...
        self.layer = layers.MaxPooling2D(pool_size=self.pool_size, strides=self.strides, padding=self.padding, 
