...
KRATOS_CREATE_VARIABLE( double, LATERAL_FORCE_COEFFICIENT )
KRATOS_CREATE_VARIABLE( double, ROLLING_MOMENT_COEFFICIENT )
KRATOS_CREATE_VARIABLE( double, PITCHING_MOMENT_COEFFICIENT )
KRATOS_CREATE_VARIABLE( double, YAWING_MOMENT_COEFFICIENT )
}
