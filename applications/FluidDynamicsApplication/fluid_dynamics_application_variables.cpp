...
KRATOS_CREATE_VARIABLE(double,A_JWL)
KRATOS_CREATE_VARIABLE(double,B_JWL)
KRATOS_CREATE_VARIABLE(double,R1)
KRATOS_CREATE_VARIABLE(double,R2)
KRATOS_CREATE_VARIABLE(double,E0)
KRATOS_CREATE_VARIABLE(double,omega)
KRATOS_CREATE_VARIABLE(double,rho_0)
...
// SBM variables
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(MOMENTUM_X_GRADIENT)
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(MOMENTUM_Y_GRADIENT)
