...
KRATOS_CREATE_VARIABLE(double, SOLID_MATERIAL_DENSITY)
KRATOS_CREATE_VARIABLE(double, SOLID_MATERIAL_SPECIFIC_HEAT)
...
KRATOS_CREATE_VARIABLE(double, DENSITY_SOLID_PROJECTION)
