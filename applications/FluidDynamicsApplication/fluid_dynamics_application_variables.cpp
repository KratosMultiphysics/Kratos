...
KRATOS_CREATE_VARIABLE(double, DENSITY_SHOCK_SENSOR)
KRATOS_CREATE_VARIABLE(double, MOMENTUM_SHOCK_SENSOR)
KRATOS_CREATE_VARIABLE(double, TOTAL_ENERGY_SHOCK_SENSOR)
...
KRATOS_CREATE_VARIABLE(Matrix, MOMENTUM_GRADIENT)
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(PRESSURE_GRADIENT)
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(TOTAL_ENERGY_GRADIENT)
...
KRATOS_CREATE_VARIABLE(double, SMOOTHED_DENSITY)
KRATOS_CREATE_VARIABLE(double, SMOOTHED_TOTAL_ENERGY)
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(SMOOTHED_MOMENTUM)
