...
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(FRACTIONAL_VELOCITY)
KRATOS_CREATE_VARIABLE(double,WATER_VOLUME_ERROR)
KRATOS_CREATE_VARIABLE(double,AIR_VOLUME_ERROR)
...
KRATOS_CREATE_VARIABLE(double, THERMODYNAMIC_PRESSURE)
KRATOS_CREATE_VARIABLE(double, THERMODYNAMIC_PRESSURE_DERIVATIVE)
...
KRATOS_CREATE_VARIABLE( Matrix, PRIMAL_STEADY_RESIDUAL_FIRST_DERIVATIVES )
