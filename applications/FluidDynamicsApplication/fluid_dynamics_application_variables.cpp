...
KRATOS_CREATE_VARIABLE(int, TOP_OPT_PROBLEM_STAGE)
// Fluid Topology Optimization Variables
KRATOS_CREATE_VARIABLE(int, FLUID_TOP_OPT_PROBLEM_STAGE)
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(VELOCITY_ADJ)
KRATOS_CREATE_VARIABLE(double, PRESSURE_ADJ)
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(ACCELERATION_ADJ)
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(MESH_VELOCITY_ADJ)
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(BODY_FORCE_ADJ)
KRATOS_CREATE_VARIABLE(int, FLUID_TOP_OPT_NS_STEP)
KRATOS_CREATE_VARIABLE(int, FLUID_TOP_OPT_ADJ_NS_STEP)
KRATOS_CREATE_VARIABLE(Vector, FUNCTIONAL_WEIGHTS)
KRATOS_CREATE_VARIABLE(double, DESIGN_PARAMETER)
KRATOS_CREATE_VARIABLE(double, FUNCTIONAL_DERIVATIVE)
