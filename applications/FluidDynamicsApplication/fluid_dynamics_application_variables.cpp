...
KRATOS_CREATE_VARIABLE(bool, APPLY_NITSCHE_BOUNDARY_IMPOSITION)
KRATOS_CREATE_VARIABLE(bool, APPLY_EMBEDDED_CONSTRAINTS)
KRATOS_CREATE_VARIABLE(std::vector<Node::Pointer>, EMBEDDED_CONSTRAINT_MASTERS)
KRATOS_CREATE_VARIABLE(Matrix, EMBEDDED_CONSTRAINT_MASTER_WEIGHTS)
