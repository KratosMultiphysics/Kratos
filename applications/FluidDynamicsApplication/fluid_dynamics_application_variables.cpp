...
KRATOS_CREATE_VARIABLE(Vector3, AUXILIAR_GRADIENT_X)
KRATOS_CREATE_VARIABLE(Vector3, AUXILIAR_GRADIENT_Y)
KRATOS_CREATE_VARIABLE(Vector3, AUXILIAR_GRADIENT_Z)
