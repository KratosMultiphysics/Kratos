...
KRATOS_CREATE_VARIABLE(double, ZERO_SHEAR_VISCOSITY )
KRATOS_CREATE_VARIABLE(double, INFINITE_SHEAR_VISCOSITY )
KRATOS_CREATE_VARIABLE(double, SHEAR_THINNING_INDEX )
KRATOS_CREATE_VARIABLE(double, CARREAU_TRANSITION_SHARPNESS )
