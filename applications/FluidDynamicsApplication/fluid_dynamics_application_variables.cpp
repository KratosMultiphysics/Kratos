...
// Adjoint variables
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS( RESPONSE_FUNCTION_INTERPOLATION_ERROR_AUX_ADJOINT_FLUID_VECTOR_1 )
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS_WITH_TIME_DERIVATIVE(AUX_ADJOINT_FLUID_VECTOR_1, RESPONSE_FUNCTION_INTERPOLATION_ERROR_AUX_ADJOINT_FLUID_VECTOR_1);
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS_WITH_TIME_DERIVATIVE(ADJOINT_FLUID_VECTOR_3, AUX_ADJOINT_FLUID_VECTOR_1);
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS_WITH_TIME_DERIVATIVE(ADJOINT_FLUID_VECTOR_2, ADJOINT_FLUID_VECTOR_3);
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS_WITH_TIME_DERIVATIVE(ADJOINT_FLUID_VECTOR_1, ADJOINT_FLUID_VECTOR_2);
...
KRATOS_CREATE_VARIABLE( double, RESPONSE_FUNCTION_INTERPOLATION_ERROR_AUXILIARY_1_EXTREMUM )
KRATOS_CREATE_VARIABLE( double, RESPONSE_FUNCTION_INTERPOLATION_ERROR_AUXILIARY_2_EXTREMUM )
KRATOS_CREATE_VARIABLE( bool, COMPUTE_RESPONSE_FUNCTION_INTERPOLATION_ERROR )

// Variables required only for LSS
KRATOS_CREATE_VARIABLE(double, TIME_STEP_SENSITIVITY )
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS( LSS_VELOCITY )
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS( LSS_ACCELERATION )
KRATOS_CREATE_VARIABLE( double, LSS_PRESSURE )
KRATOS_CREATE_VARIABLE( double, LSS_PRESSURE_RATE )
KRATOS_CREATE_VARIABLE( double, ADJOINT_FLUID_SCALAR_3 )
