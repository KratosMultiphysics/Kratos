...
namespace Kratos
{
    ...
    class CompressibleNavierStokesJWLExplicit : public Element
    {
    public:
        ///@name Type Definitions
        ///@{
        ...
        /// Counted pointer of
        KRATOS_CLASS_INTRUSIVE_POINTER_DEFINITION(CompressibleNavierStokesJWLExplicit);
        ...
        /// Default constructor.
        CompressibleNavierStokesJWLExplicit(
            IndexType NewId,
        ...
        /// Destructor.
        ~CompressibleNavierStokesJWLExplicit() override = default;
        ...
        {
            KRATOS_TRY
            return Kratos::make_intrusive<CompressibleNavierStokesJWLExplicit<TDim, TNumNodes>>(NewId, this->GetGeometry().Create(rThisNodes), pProperties);
            KRATOS_CATCH("");
        }
        ...
        {
            KRATOS_TRY
            return Kratos::make_intrusive<CompressibleNavierStokesJWLExplicit<TDim, TNumNodes>>(NewId, pGeom, pProperties);
            KRATOS_CATCH("");
        }
        ...
        {
            return "CompressibleNavierStokesJWLExplicit #";
        }
    ...
    protected:
        ...
        CompressibleNavierStokesJWLExplicit() = default;
    ...
    template <unsigned int TDim, unsigned int TNumNodes>
    int CompressibleNavierStokesJWLExplicit<TDim, TNumNodes>::Check(const ProcessInfo &rCurrentProcessInfo) const
    {
        KRATOS_TRY
    ...
    template <unsigned int TDim, unsigned int TNumNodes>
    void CompressibleNavierStokesJWLExplicit<TDim, TNumNodes>::Calculate(
        const Variable<double> &rVariable,
        double &Output,
        const ProcessInfo &rCurrentProcessInfo)
    {
    ...
    template <unsigned int TDim, unsigned int TNumNodes>
    void CompressibleNavierStokesJWLExplicit<TDim, TNumNodes>::CalculateOnIntegrationPoints(
        const Variable<double> &rVariable,
        std::vector<double> &rOutput,
        const ProcessInfo &rCurrentProcessInfo)
    {
     ...
     */
    namespace CompressibleNavierStokesJWLExplicitInternal
    {
        template <unsigned int TDim, unsigned int TNumNodes>
        using ElementDataStruct = typename CompressibleNavierStokesJWLExplicit<TDim, TNumNodes>::ElementDataStruct;
    ...
    template <unsigned int TDim, unsigned int TNumNodes>
    void CompressibleNavierStokesJWLExplicit<TDim, TNumNodes>::FillElementData(
        ElementDataStruct &rData,
        const ProcessInfo &rCurrentProcessInfo)
    {
        ...
        CompressibleNavierStokesJWLExplicitInternal::ComputeGeometryData<TDim, TNumNodes>(r_geometry, rData);
    ...
    template <unsigned int TDim, unsigned int TNumNodes>
    array_1d<double, 3> CompressibleNavierStokesJWLExplicit<TDim, TNumNodes>::CalculateMidPointDensityGradient() const
    {
        // Get geometry data
    ...
    template <unsigned int TDim, unsigned int TNumNodes>
    array_1d<double, 3> CompressibleNavierStokesJWLExplicit<TDim, TNumNodes>::CalculateMidPointTemperatureGradient() const
    {
        // Get geometry data
        const auto &r_geom = GetGeometry();
        const unsigned int NumNodes = r_geom.PointsNumber();
    ...
    template <unsigned int TDim, unsigned int TNumNodes>
    double CompressibleNavierStokesJWLExplicit<TDim, TNumNodes>::CalculateMidPointSoundVelocity() const
    {
        // Get geometry data
        const auto &r_geom = GetGeometry();
        const unsigned int NumNodes = r_geom.PointsNumber();
    ...
    template <unsigned int TDim, unsigned int TNumNodes>
    double CompressibleNavierStokesJWLExplicit<TDim, TNumNodes>::CalculateMidPointVelocityDivergence() const
    {
        // Get geometry data
        const auto &r_geom = GetGeometry();
        const unsigned int NumNodes = r_geom.PointsNumber();
    ...
    template <unsigned int TDim, unsigned int TNumNodes>
    void CompressibleNavierStokesJWLExplicit<TDim, TNumNodes>::CalculateLumpedMassVector(
        VectorType &rLumpedMassVector,
    ...
    template <unsigned int TDim, unsigned int TNumNodes>
    void CompressibleNavierStokesJWLExplicit<TDim, TNumNodes>::AddExplicitContribution(const ProcessInfo &rCurrentProcessInfo)
    {
    ...
    template <unsigned int TDim, unsigned int TNumNodes>
    const Parameters CompressibleNavierStokesJWLExplicit<TDim, TNumNodes>::GetSpecifications() const
    {
