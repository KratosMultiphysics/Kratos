...
#ifndef KRATOS_FLUID_TOP_OPT_ELEMENT_H
#define KRATOS_FLUID_TOP_OPT_ELEMENT_H
...
class FluidTopologyOptimizationElement : public Element
{
public:
    ///@name Type Definitions
    ///@{

    /// Pointer definition of FluidTopologyOptimizationElement
    KRATOS_CLASS_INTRUSIVE_POINTER_DEFINITION(FluidTopologyOptimizationElement);
     ...
     */
    FluidTopologyOptimizationElement(IndexType NewId = 0);
     ...
     */
    FluidTopologyOptimizationElement(IndexType NewId, const NodesArrayType& ThisNodes);
     ...
     */
    FluidTopologyOptimizationElement(IndexType NewId, GeometryType::Pointer pGeometry);
     ...
     */
    FluidTopologyOptimizationElement(IndexType NewId, GeometryType::Pointer pGeometry, Properties::Pointer pProperties);

    /// Destructor.
    virtual ~FluidTopologyOptimizationElement();
    ...
    /**
     * Returns a pointer to a new FluidTopologyOptimizationElement element, created using given input
    ...
    /** For FluidTopologyOptimizationElement, this initializes the constitutive law using the data in the element's properties.
     */
...
protected:
    ...
    void AddTimeIntegratedSystemAdjoint(
        TElementData& rData,
        MatrixType& rLHS,
        VectorType& rRHS);

    void AddTimeIntegratedLHSAdjoint(
        TElementData& rData,
        MatrixType& rLHS);

    void AddTimeIntegratedRHSAdjoint(
        TElementData& rData,
        VectorType& rRHS);
    ...
    void ComputeGaussPointLHSContributionAdjoint(
        TElementData& rData,
        MatrixType& rLHS);

    void ComputeGaussPointRHSContributionAdjoint(
        TElementData& rData,
        VectorType& rRHS);
...
private:
    ...
    /// Assignment operator.
    FluidTopologyOptimizationElement& operator=(FluidTopologyOptimizationElement const& rOther);

    /// Copy constructor.
    FluidTopologyOptimizationElement(FluidTopologyOptimizationElement const& rOther);

    ///@}


}; // Class FluidTopologyOptimizationElement
...
inline std::istream& operator >>(std::istream& rIStream,
                                 FluidTopologyOptimizationElement<TElementData>& rThis)
{
    return rIStream;
}
...
inline std::ostream& operator <<(std::ostream& rOStream,
                                 const FluidTopologyOptimizationElement<TElementData>& rThis)
{
