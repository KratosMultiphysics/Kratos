...
///@{
    ...
    public:
         ...
         */
        TwoFluidNavierStokesFractional(IndexType NewId, const NodesArrayType &ThisNodes);
         ...
         */
        TwoFluidNavierStokesFractional(IndexType NewId, GeometryType::Pointer pGeometry);
         ...
         */
        TwoFluidNavierStokesFractional(IndexType NewId, GeometryType::Pointer pGeometry, Properties::Pointer pProperties);
