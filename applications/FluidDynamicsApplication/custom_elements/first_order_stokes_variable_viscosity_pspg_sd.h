...
class FirstOrderStokesVariableViscosityPspgSd : public Element
{
public:
    ///@name Type Definitions
    ///@{
    ...
    KRATOS_CLASS_INTRUSIVE_POINTER_DEFINITION(FirstOrderStokesVariableViscosityPspgSd);
     ...
     */
    FirstOrderStokesVariableViscosityPspgSd(IndexType NewId = 0);
     ...
     */
    FirstOrderStokesVariableViscosityPspgSd(
        IndexType NewId,
    ...
    /// Destructor.
    virtual ~FirstOrderStokesVariableViscosityPspgSd();

    /// Copy constructor.
    FirstOrderStokesVariableViscosityPspgSd(FirstOrderStokesVariableViscosityPspgSd const &rOther) = delete;
    ...
    /// Assignment operator.
    FirstOrderStokesVariableViscosityPspgSd &operator=(FirstOrderStokesVariableViscosityPspgSd const &rOther) = delete;
...
private:
    ...
    ///@}
}; // Class FirstOrderStokesVariableViscosityPspgSd
...
inline std::istream& operator >>(
    ...
    FirstOrderStokesVariableViscosityPspgSd<TDim>& rThis)
{
    return rIStream;
}
...
inline std::ostream& operator <<(
    ...
    const FirstOrderStokesVariableViscosityPspgSd<TDim>& rThis)
{
