...
const double crLHS16 = 1.0/(h*h);
const double crLHS17 = 1.0/(crLHS16*crLHS4 + crLHS16*mu*stab_c1 + crLHS5*dyn_tau*1.0/dt + crLHS8*1.0/h);
...
const double crLHS19 = 1.0/(h*h);
const double crLHS20 = 1.0/(crLHS11*1.0/h + crLHS19*crLHS6 + crLHS19*mu*stab_c1 + crLHS7*dyn_tau*1.0/dt);
...
const double crRHS24 = 1.0/(h*h);
const double crRHS25 = 1.0*1.0/(crRHS1*dyn_tau*1.0/dt + crRHS16*crRHS24 + crRHS17*1.0/h + crRHS24*mu*stab_c1);
...
const double crRHS28 = 1.0/(h*h);
const double crRHS29 = 1.0*1.0/(crRHS1*dyn_tau*1.0/dt + crRHS19*crRHS28 + crRHS20*1.0/h + crRHS28*mu*stab_c1);
