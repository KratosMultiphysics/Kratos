...
const double crLHS19 = stab_c3*sqrt(crLHS13*crLHS13 + crLHS17*crLHS17 + crLHS18*crLHS18 + crLHS9*crLHS9);
...
const double crLHS21 = stab_c3*sqrt(crLHS12*crLHS12 + crLHS13*crLHS13 + crLHS14*crLHS14 + crLHS15*crLHS15 + crLHS16*crLHS16 + crLHS17*crLHS17 + crLHS18*crLHS18 + crLHS19*crLHS19 + crLHS20*crLHS20);
...
const double crRHS34 = stab_c3*sqrt(crRHS11*crRHS11 + crRHS18*crRHS18 + crRHS20*crRHS20 + crRHS33*crRHS33);
...
const double crRHS56 = stab_c3*sqrt(crRHS18*crRHS18 + crRHS24*crRHS24 + crRHS27*crRHS27 + crRHS29*crRHS29 + crRHS31*crRHS31 + crRHS48*crRHS48 + crRHS49*crRHS49 + crRHS54*crRHS54 + crRHS55*crRHS55);
