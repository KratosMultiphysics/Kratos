...
class FluidTransportTopologyOptimizationElement: public Element
{
public:
    ///@name Type Definitions
    ///@{
    ...
    /// Counted pointer of
    KRATOS_CLASS_INTRUSIVE_POINTER_DEFINITION(FluidTransportTopologyOptimizationElement);
     ...
     */
    FluidTransportTopologyOptimizationElement(IndexType NewId = 0);
     ...
     */
    FluidTransportTopologyOptimizationElement(
        IndexType NewId,
    ...
    /// Destructor.
    virtual ~FluidTransportTopologyOptimizationElement();
    ...
    ///@{
    /**
     @brief Returns a pointer to a new FluidTransportTopologyOptimizationElement element, created using given input.
    ...
    {
        return "FluidTransportTopologyOptimizationElement #";
    }
