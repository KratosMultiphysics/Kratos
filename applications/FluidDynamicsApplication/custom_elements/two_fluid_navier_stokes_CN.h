...
#if !defined(KRATOS_TWO_FLUID_NAVIER_STOKES_CN)
#define  KRATOS_TWO_FLUID_NAVIER_STOKES_CN
...
/*The "TwoFluidNavierStokesCN" element is an element based on the Variational Multiscale Stabilization technique (VMS)
...
class TwoFluidNavierStokesCN : public FluidElement<TElementData>
{
public:

    /// Counted pointer of
    KRATOS_CLASS_INTRUSIVE_POINTER_DEFINITION(TwoFluidNavierStokesCN);
    ...
    */
    TwoFluidNavierStokesCN(IndexType NewId = 0);
    ...
    */
    TwoFluidNavierStokesCN(IndexType NewId, const NodesArrayType& ThisNodes);
    ...
    */
    TwoFluidNavierStokesCN(IndexType NewId, GeometryType::Pointer pGeometry);
    ...
    */
    TwoFluidNavierStokesCN(IndexType NewId, GeometryType::Pointer pGeometry, Properties::Pointer pProperties);

    /// Destructor.
    virtual ~TwoFluidNavierStokesCN();
    ...
    /**
    * Returns a pointer to a new TwoFluidNavierStokesCN element, created using given input.
...
private:
    ...
    /// Assignment operator.
    TwoFluidNavierStokesCN& operator=(TwoFluidNavierStokesCN const& rOther);

    /// Copy constructor.
    TwoFluidNavierStokesCN(TwoFluidNavierStokesCN const& rOther);

    ///@}

}; // Class TwoFluidNavierStokesCN
///@name Type Definitions
///@{
...
inline std::istream& operator >> (std::istream& rIStream,
    TwoFluidNavierStokesCN<TElementData>& rThis)
{
    return rIStream;
}
...
inline std::ostream& operator <<(std::ostream& rOStream,
    const TwoFluidNavierStokesCN<TElementData>& rThis)
{
...
#endif // KRATOS_TWO_FLUID_NAVIER_STOKES_CN