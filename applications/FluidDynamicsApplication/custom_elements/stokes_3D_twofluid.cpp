...
void Stokes3DTwoFluid::ComputeGaussPointRHSContribution(array_1d<double,16>& rhs, const element_data<4,3>& data)
    {
        ...
        const double C_1_1 = C(1,1); const double C_1_2 = C(1,2); const double C_1_3 = C(1,3);
        const double C_1_4 = C(1,4); const double C_1_5 = C(1,5); const double C_2_5 = C(2,5);
        const double C_3_3 = C(3,3); const double C_4_4 = C(4,4); const double C_5_5 = C(5,5);
        const double C_2_3 = C(2,3); const double C_2_2 = C(2,2); const double C_0_3 = C(0,3);
        const double C_2_4 = C(2,4); const double C_4_5 = C(4,5); const double C_3_4 = C(3,4);
         const double C_3_5 = C(3,5);
...
const double crhs61 =             C_3_5*DN_3_0;
            rhs[0]=DN_0_0*crhs2 + DN_0_0*pgauss - DN_0_0*stress[0] - DN_0_1*stress[3] - DN_0_2*stress[5] - N_0*crhs0 - crhs13*(C_0_1*DN_0_0 + C_1_5*DN_0_2 + crhs8) - crhs19*(C_0_2*DN_0_0 + C_2_3*DN_0_1 + crhs14) - crhs21*(C_3_3*DN_0_1 + C_3_5*DN_0_2 + crhs20) - crhs24*(C_0_4*DN_0_0 + crhs22 + crhs23) - crhs26*(C_3_5*DN_0_1 + C_5_5*DN_0_2 + crhs25) - crhs7*(C_0_0*DN_0_0 + C_0_3*DN_0_1 + C_0_5*DN_0_2);
            rhs[1]=-DN_0_0*stress[3] + DN_0_1*crhs2 + DN_0_1*pgauss - DN_0_1*stress[1] - DN_0_2*stress[4] - N_0*crhs27 - crhs13*(C_1_1*DN_0_1 + C_1_3*DN_0_0 + C_1_4*DN_0_2) - crhs19*(C_1_2*DN_0_1 + C_2_3*DN_0_0 + crhs28) - crhs21*(C_3_3*DN_0_0 + C_3_4*DN_0_2 + crhs8) - crhs24*(C_3_4*DN_0_0 + C_4_4*DN_0_2 + crhs29) - crhs26*(C_1_5*DN_0_1 + crhs23 + crhs30) - crhs7*(C_0_1*DN_0_1 + C_0_4*DN_0_2 + crhs20);
            rhs[2]=-DN_0_0*stress[5] - DN_0_1*stress[4] + DN_0_2*crhs2 + DN_0_2*pgauss - DN_0_2*stress[2] - N_0*crhs31 - crhs13*(C_1_2*DN_0_2 + C_1_5*DN_0_0 + crhs29) - crhs19*(C_2_2*DN_0_2 + C_2_4*DN_0_1 + C_2_5*DN_0_0) - crhs21*(C_2_3*DN_0_2 + crhs22 + crhs30) - crhs24*(C_4_4*DN_0_1 + C_4_5*DN_0_0 + crhs28) - crhs26*(C_4_5*DN_0_1 + C_5_5*DN_0_0 + crhs14) - crhs7*(C_0_2*DN_0_2 + C_0_4*DN_0_1 + crhs25);
            rhs[3]=-DN_0_0*crhs32 - DN_0_1*crhs33 - DN_0_2*crhs34 - N_0*crhs1;
            rhs[4]=DN_1_0*crhs2 + DN_1_0*pgauss - DN_1_0*stress[0] - DN_1_1*stress[3] - DN_1_2*stress[5] - N_1*crhs0 - crhs13*(C_0_1*DN_1_0 + C_1_5*DN_1_2 + crhs35) - crhs19*(C_0_2*DN_1_0 + C_2_3*DN_1_1 + crhs36) - crhs21*(C_3_3*DN_1_1 + C_3_5*DN_1_2 + crhs37) - crhs24*(C_0_4*DN_1_0 + crhs38 + crhs39) - crhs26*(C_3_5*DN_1_1 + C_5_5*DN_1_2 + crhs40) - crhs7*(C_0_0*DN_1_0 + C_0_3*DN_1_1 + C_0_5*DN_1_2);
            rhs[5]=-DN_1_0*stress[3] + DN_1_1*crhs2 + DN_1_1*pgauss - DN_1_1*stress[1] - DN_1_2*stress[4] - N_1*crhs27 - crhs13*(C_1_1*DN_1_1 + C_1_3*DN_1_0 + C_1_4*DN_1_2) - crhs19*(C_1_2*DN_1_1 + C_2_3*DN_1_0 + crhs41) - crhs21*(C_3_3*DN_1_0 + C_3_4*DN_1_2 + crhs35) - crhs24*(C_3_4*DN_1_0 + C_4_4*DN_1_2 + crhs42) - crhs26*(C_1_5*DN_1_1 + crhs39 + crhs43) - crhs7*(C_0_1*DN_1_1 + C_0_4*DN_1_2 + crhs37);
            rhs[6]=-DN_1_0*stress[5] - DN_1_1*stress[4] + DN_1_2*crhs2 + DN_1_2*pgauss - DN_1_2*stress[2] - N_1*crhs31 - crhs13*(C_1_2*DN_1_2 + C_1_5*DN_1_0 + crhs42) - crhs19*(C_2_2*DN_1_2 + C_2_4*DN_1_1 + C_2_5*DN_1_0) - crhs21*(C_2_3*DN_1_2 + crhs38 + crhs43) - crhs24*(C_4_4*DN_1_1 + C_4_5*DN_1_0 + crhs41) - crhs26*(C_4_5*DN_1_1 + C_5_5*DN_1_0 + crhs36) - crhs7*(C_0_2*DN_1_2 + C_0_4*DN_1_1 + crhs40);
            rhs[7]=-DN_1_0*crhs32 - DN_1_1*crhs33 - DN_1_2*crhs34 - N_1*crhs1;
            rhs[8]=DN_2_0*crhs2 + DN_2_0*pgauss - DN_2_0*stress[0] - DN_2_1*stress[3] - DN_2_2*stress[5] - N_2*crhs0 - crhs13*(C_0_1*DN_2_0 + C_1_5*DN_2_2 + crhs44) - crhs19*(C_0_2*DN_2_0 + C_2_3*DN_2_1 + crhs45) - crhs21*(C_3_3*DN_2_1 + C_3_5*DN_2_2 + crhs46) - crhs24*(C_0_4*DN_2_0 + crhs47 + crhs48) - crhs26*(C_3_5*DN_2_1 + C_5_5*DN_2_2 + crhs49) - crhs7*(C_0_0*DN_2_0 + C_0_3*DN_2_1 + C_0_5*DN_2_2);
            rhs[9]=-DN_2_0*stress[3] + DN_2_1*crhs2 + DN_2_1*pgauss - DN_2_1*stress[1] - DN_2_2*stress[4] - N_2*crhs27 - crhs13*(C_1_1*DN_2_1 + C_1_3*DN_2_0 + C_1_4*DN_2_2) - crhs19*(C_1_2*DN_2_1 + C_2_3*DN_2_0 + crhs50) - crhs21*(C_3_3*DN_2_0 + C_3_4*DN_2_2 + crhs44) - crhs24*(C_3_4*DN_2_0 + C_4_4*DN_2_2 + crhs51) - crhs26*(C_1_5*DN_2_1 + crhs48 + crhs52) - crhs7*(C_0_1*DN_2_1 + C_0_4*DN_2_2 + crhs46);
            rhs[10]=-DN_2_0*stress[5] - DN_2_1*stress[4] + DN_2_2*crhs2 + DN_2_2*pgauss - DN_2_2*stress[2] - N_2*crhs31 - crhs13*(C_1_2*DN_2_2 + C_1_5*DN_2_0 + crhs51) - crhs19*(C_2_2*DN_2_2 + C_2_4*DN_2_1 + C_2_5*DN_2_0) - crhs21*(C_2_3*DN_2_2 + crhs47 + crhs52) - crhs24*(C_4_4*DN_2_1 + C_4_5*DN_2_0 + crhs50) - crhs26*(C_4_5*DN_2_1 + C_5_5*DN_2_0 + crhs45) - crhs7*(C_0_2*DN_2_2 + C_0_4*DN_2_1 + crhs49);
            rhs[11]=-DN_2_0*crhs32 - DN_2_1*crhs33 - DN_2_2*crhs34 - N_2*crhs1;
            rhs[12]=DN_3_0*crhs2 + DN_3_0*pgauss - DN_3_0*stress[0] - DN_3_1*stress[3] - DN_3_2*stress[5] - N_3*crhs0 - crhs13*(C_0_1*DN_3_0 + C_1_5*DN_3_2 + crhs53) - crhs19*(C_0_2*DN_3_0 + C_2_3*DN_3_1 + crhs54) - crhs21*(C_3_3*DN_3_1 + C_3_5*DN_3_2 + crhs55) - crhs24*(C_0_4*DN_3_0 + crhs56 + crhs57) - crhs26*(C_3_5*DN_3_1 + C_5_5*DN_3_2 + crhs58) - crhs7*(C_0_0*DN_3_0 + C_0_3*DN_3_1 + C_0_5*DN_3_2);
            rhs[13]=-DN_3_0*stress[3] + DN_3_1*crhs2 + DN_3_1*pgauss - DN_3_1*stress[1] - DN_3_2*stress[4] - N_3*crhs27 - crhs13*(C_1_1*DN_3_1 + C_1_3*DN_3_0 + C_1_4*DN_3_2) - crhs19*(C_1_2*DN_3_1 + C_2_3*DN_3_0 + crhs59) - crhs21*(C_3_3*DN_3_0 + C_3_4*DN_3_2 + crhs53) - crhs24*(C_3_4*DN_3_0 + C_4_4*DN_3_2 + crhs60) - crhs26*(C_1_5*DN_3_1 + crhs57 + crhs61) - crhs7*(C_0_1*DN_3_1 + C_0_4*DN_3_2 + crhs55);
            rhs[14]=-DN_3_0*stress[5] - DN_3_1*stress[4] + DN_3_2*crhs2 + DN_3_2*pgauss - DN_3_2*stress[2] - N_3*crhs31 - crhs13*(C_1_2*DN_3_2 + C_1_5*DN_3_0 + crhs60) - crhs19*(C_2_2*DN_3_2 + C_2_4*DN_3_1 + C_2_5*DN_3_0) - crhs21*(C_2_3*DN_3_2 + crhs56 + crhs61) - crhs24*(C_4_4*DN_3_1 + C_4_5*DN_3_0 + crhs59) - crhs26*(C_4_5*DN_3_1 + C_5_5*DN_3_0 + crhs54) - crhs7*(C_0_2*DN_3_2 + C_0_4*DN_3_1 + crhs58);
