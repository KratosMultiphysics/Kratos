...
#ifndef KRATOS_NEW_SYMBOLIC_NAVIER_STOKES_H
#define KRATOS_NEW_SYMBOLIC_NAVIER_STOKES_H
...
class NewSymbolicNavierStokes : public FluidElement<TElementData>
{
public:
    ///@name Type Definitions
    ///@{

    /// Pointer definition of NewSymbolicNavierStokes
    KRATOS_CLASS_INTRUSIVE_POINTER_DEFINITION(NewSymbolicNavierStokes);
     ...
     */
    NewSymbolicNavierStokes(IndexType NewId = 0);
     ...
     */
    NewSymbolicNavierStokes(IndexType NewId, const NodesArrayType& ThisNodes);
     ...
     */
    NewSymbolicNavierStokes(IndexType NewId, GeometryType::Pointer pGeometry);
     ...
     */
    NewSymbolicNavierStokes(IndexType NewId, GeometryType::Pointer pGeometry, Properties::Pointer pProperties);

    /// Destructor.
    virtual ~NewSymbolicNavierStokes();
    ...
    /**
     * Returns a pointer to a new NewSymbolicNavierStokes element, created using given input.
...
private:
    ...
    /// Assignment operator.
    NewSymbolicNavierStokes& operator=(NewSymbolicNavierStokes const& rOther);

    /// Copy constructor.
    NewSymbolicNavierStokes(NewSymbolicNavierStokes const& rOther);

    ///@}


}; // Class NewSymbolicNavierStokes
...
inline std::istream& operator >>(std::istream& rIStream,
                                 NewSymbolicNavierStokes<TElementData>& rThis)
{
    return rIStream;
}
...
inline std::ostream& operator <<(std::ostream& rOStream,
                                 const NewSymbolicNavierStokes<TElementData>& rThis)
{
