...
#include "two_fluid_navier_stokes_fractional_alpha_method.h"
...
TwoFluidNavierStokesFractionalAlphaMethod<TElementData>::TwoFluidNavierStokesFractionalAlphaMethod(IndexType NewId)
    : TwoFluidNavierStokesFractional<TElementData>(NewId) {}

template <class TElementData>
TwoFluidNavierStokesFractionalAlphaMethod<TElementData>::TwoFluidNavierStokesFractionalAlphaMethod(
    IndexType NewId, const NodesArrayType &ThisNodes)
    : TwoFluidNavierStokesFractional<TElementData>(NewId, ThisNodes) {}

template <class TElementData>
TwoFluidNavierStokesFractionalAlphaMethod<TElementData>::TwoFluidNavierStokesFractionalAlphaMethod(
    IndexType NewId, GeometryType::Pointer pGeometry)
    : TwoFluidNavierStokesFractional<TElementData>(NewId, pGeometry) {}

template <class TElementData>
TwoFluidNavierStokesFractionalAlphaMethod<TElementData>::TwoFluidNavierStokesFractionalAlphaMethod(
    IndexType NewId, GeometryType::Pointer pGeometry, Properties::Pointer pProperties)
    : TwoFluidNavierStokesFractional<TElementData>(NewId, pGeometry, pProperties) {}
...
template <class TElementData>
Element::Pointer TwoFluidNavierStokesFractionalAlphaMethod<TElementData>::Create(
    IndexType NewId,
    NodesArrayType const &ThisNodes,
    Properties::Pointer pProperties) const
{
    return Kratos::make_intrusive<TwoFluidNavierStokesFractionalAlphaMethod>(NewId, this->GetGeometry().Create(ThisNodes), pProperties);
}
...
Element::Pointer TwoFluidNavierStokesFractionalAlphaMethod<TElementData>::Create(
    ...
    Properties::Pointer pProperties) const
{
    return Kratos::make_intrusive<TwoFluidNavierStokesFractionalAlphaMethod>(NewId, pGeom, pProperties);
}

template <class TElementData>
void TwoFluidNavierStokesFractionalAlphaMethod<TElementData>::CalculateOnIntegrationPoints(
...
template <class TElementData>
void TwoFluidNavierStokesFractionalAlphaMethod<TElementData>::Calculate(
    const Variable<double> &rVariable,
    double &rOutput,
    const ProcessInfo &rCurrentProcessInfo)
{
...
template <>
double TwoFluidNavierStokesFractionalAlphaMethod<TwoFluidNavierStokesFractionalAlphaMethodData<2, 3>>::CalculateArtificialDynamicViscositySpecialization(TwoFluidNavierStokesFractionalAlphaMethodData<2, 3> &rData) const
{
...
template <>
double TwoFluidNavierStokesFractionalAlphaMethod<TwoFluidNavierStokesFractionalAlphaMethodData<3, 4>>::CalculateArtificialDynamicViscositySpecialization(TwoFluidNavierStokesFractionalAlphaMethodData<3, 4> &rData) const
{
    // Variables for artificial viscosity calculation
    double artificial_mu = 0.0;
    const double rho = rData.Density;
...
template <>
void TwoFluidNavierStokesFractionalAlphaMethod<TwoFluidNavierStokesFractionalAlphaMethodData<2, 3>>::CalculateStrainRate(TwoFluidNavierStokesFractionalAlphaMethodData<2, 3>& rData) const
{
...
template <>
void TwoFluidNavierStokesFractionalAlphaMethod<TwoFluidNavierStokesFractionalAlphaMethodData<3, 4>>::CalculateStrainRate(TwoFluidNavierStokesFractionalAlphaMethodData<3, 4>& rData) const
{
    const double alpha_f = 1/(1+rData.MaxSpectralRadius);
...
template <>
void TwoFluidNavierStokesFractionalAlphaMethod<TwoFluidNavierStokesFractionalAlphaMethodData<2, 3>>::ComputeGaussPointLHSContribution(
...
template <>
void TwoFluidNavierStokesFractionalAlphaMethod<TwoFluidNavierStokesFractionalAlphaMethodData<3, 4>>::ComputeGaussPointLHSContribution(
...
template <>
void TwoFluidNavierStokesFractionalAlphaMethod<TwoFluidNavierStokesFractionalAlphaMethodData<2, 3>>::ComputeGaussPointRHSContribution(
    TwoFluidNavierStokesFractionalAlphaMethodData<2, 3> &rData,
    VectorType &rRHS)
{
    const double rho = rData.Density;
...
template <>
void TwoFluidNavierStokesFractionalAlphaMethod<TwoFluidNavierStokesFractionalAlphaMethodData<3, 4>>::ComputeGaussPointRHSContribution(
    TwoFluidNavierStokesFractionalAlphaMethodData<3, 4> &rData,
    VectorType &rRHS)
{
    const double rho = rData.Density;
...
template <>
void TwoFluidNavierStokesFractionalAlphaMethod<TwoFluidNavierStokesFractionalAlphaMethodData<2, 3>>::ComputeGaussPointEnrichmentContributions(
    TwoFluidNavierStokesFractionalAlphaMethodData<2, 3> &rData,
    MatrixType &rV,
    MatrixType &rH,
    MatrixType &rKee,
...
template <>
void TwoFluidNavierStokesFractionalAlphaMethod<TwoFluidNavierStokesFractionalAlphaMethodData<3, 4>>::ComputeGaussPointEnrichmentContributions(
    TwoFluidNavierStokesFractionalAlphaMethodData<3, 4> &rData,
    MatrixType &rV,
    MatrixType &rH,
    MatrixType &rKee,
...
template <class TElementData>
void TwoFluidNavierStokesFractionalAlphaMethod<TElementData>::PressureGradientStabilization(
...
template <class TElementData>
void TwoFluidNavierStokesFractionalAlphaMethod<TElementData>::save(Serializer &rSerializer) const
{
...
template <class TElementData>
void TwoFluidNavierStokesFractionalAlphaMethod<TElementData>::load(Serializer &rSerializer)
{
    using BaseType = TwoFluidNavierStokesFractional<TElementData>;
...
template class TwoFluidNavierStokesFractionalAlphaMethod<TwoFluidNavierStokesFractionalAlphaMethodData<2, 3>>;
template class TwoFluidNavierStokesFractionalAlphaMethod<TwoFluidNavierStokesFractionalAlphaMethodData<3, 4>>;
