...
#if !defined(KRATOS_WEAKLY_COMPRESSIBLE_STOKES_ELEMENT_SYMBOLIC_3D_INCLUDED )
#define  KRATOS_WEAKLY_COMPRESSIBLE_STOKES_ELEMENT_SYMBOLIC_3D_INCLUDED
...
/**this element is a weakly compressible stokes element.
*/
class Stokes3DWeaklyCompressible
    : public Element
{
public:
    ///@name Type Definitions
    ...
    /// Counted pointer of
    KRATOS_CLASS_POINTER_DEFINITION(Stokes3DWeaklyCompressible);

    template <unsigned int TNumNodes, unsigned int TDim>
    struct element_data
    {
        bounded_matrix<double,TNumNodes, TDim> v, vn, vnn, f;
        array_1d<double,TNumNodes> p, pn, pnn, r, rn, rnn;
    ...
    Stokes3DWeaklyCompressible(IndexType NewId, GeometryType::Pointer pGeometry)
        : Element(NewId, pGeometry)
    {}

    Stokes3DWeaklyCompressible(IndexType NewId, GeometryType::Pointer pGeometry, PropertiesType::Pointer pProperties)
        : Element(NewId, pGeometry, pProperties)
    {}

    /// Destructor.
    ~Stokes3DWeaklyCompressible() override {};
    ...
    {
        KRATOS_TRY
        return Kratos::make_shared< Stokes3DWeaklyCompressible >(NewId, GetGeometry().Create(ThisNodes), pProperties);
        KRATOS_CATCH("");
    }
    ...
    {
        return Kratos::make_shared< Stokes3DWeaklyCompressible >(NewId, pGeom, pProperties);
    }
...
//             Values.SetConstitutiveMatrix(data.C);      //this is an ouput parameter
    ...
    {
        return "Stokes3DWeaklyCompressible #";
    }
...
protected:
    ...
    Stokes3DWeaklyCompressible() : Element()
    {
    }
...
#endif // KRATOS_WEAKLY_COMPRESSIBLE_STOKES_ELEMENT_SYMBOLIC_3D_INCLUDED  defined 
