...
template<>
void VMSAdjointElement<2>::GetDofArray(
    ...
    const ProcessInfo& rProcessInfo) const
{
    ...
    for (IndexType i_node = 0; i_node < TNumNodes; ++i_node) {
        ...
        rElementalDofList[local_index++] = r_node.pGetDof(ADJOINT_FLUID_VECTOR_1_X);
        rElementalDofList[local_index++] = r_node.pGetDof(ADJOINT_FLUID_VECTOR_1_Y);
        rElementalDofList[local_index++] = r_node.pGetDof(ADJOINT_FLUID_SCALAR_1);
    }
}

template<>
void VMSAdjointElement<3>::GetDofArray(
    DofsArrayType& rElementalDofList,
    const ProcessInfo& rProcessInfo) const
{
    IndexType local_index = 0;
    for (IndexType i_node = 0; i_node < TNumNodes; ++i_node) {
        ...
        rElementalDofList[local_index++] = r_node.pGetDof(ADJOINT_FLUID_VECTOR_1_X);
        rElementalDofList[local_index++] = r_node.pGetDof(ADJOINT_FLUID_VECTOR_1_Y);
        rElementalDofList[local_index++] = r_node.pGetDof(ADJOINT_FLUID_VECTOR_1_Z);
        rElementalDofList[local_index++] = r_node.pGetDof(ADJOINT_FLUID_SCALAR_1);
    }
}

template <>
void VMSAdjointElement<2>::EquationIdArray(
...
template <>
void VMSAdjointElement<3>::EquationIdArray(
    EquationIdArrayType& rResult,
    const ProcessInfo& rProcessInfo) const
{
    IndexType local_index = 0;
...
template<>
double VMSAdjointElement<2>::CalculateElementSize(
...
template<>
double VMSAdjointElement<3>::CalculateElementSize(
...
void VMSAdjointElement<2>::CalculateDeterminantOfJacobianDerivatives(
    array_1d< double, 6 >& rDetJDerivatives) const
{
...
void VMSAdjointElement<3>::CalculateDeterminantOfJacobianDerivatives(
    array_1d< double, 12 >& rDetJDerivatives) const
{
