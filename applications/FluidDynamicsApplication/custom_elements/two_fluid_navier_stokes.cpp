...
const double cV2 =             1.0*rho/(rho*stab_c2*sqrt(pow(cV0, 2) + pow(cV1, 2))/h + mu*stab_c1/pow(h, 2) + dyn_tau*rho/dt);
const double cV3 =             cV2*(DN(0,0)*DNenr(0,0) + DN(0,1)*DNenr(0,1));
const double cV4 =             cV2*(DN(0,0)*DNenr(1,0) + DN(0,1)*DNenr(1,1));
const double cV5 =             cV2*(DN(0,0)*DNenr(2,0) + DN(0,1)*DNenr(2,1));
const double cV6 =             cV2*(DN(1,0)*DNenr(0,0) + DN(1,1)*DNenr(0,1));
const double cV7 =             cV2*(DN(1,0)*DNenr(1,0) + DN(1,1)*DNenr(1,1));
const double cV8 =             cV2*(DN(1,0)*DNenr(2,0) + DN(1,1)*DNenr(2,1));
const double cV9 =             cV2*(DN(2,0)*DNenr(0,0) + DN(2,1)*DNenr(0,1));
const double cV10 =             cV2*(DN(2,0)*DNenr(1,0) + DN(2,1)*DNenr(1,1));
const double cV11 =             cV2*(DN(2,0)*DNenr(2,0) + DN(2,1)*DNenr(2,1));
            V(0,0)=-DN(0,0)*Nenr[0] + cV0*cV3;
            V(0,1)=-DN(0,0)*Nenr[1] + cV0*cV4;
            V(0,2)=-DN(0,0)*Nenr[2] + cV0*cV5;
            V(1,0)=-DN(0,1)*Nenr[0] + cV1*cV3;
            V(1,1)=-DN(0,1)*Nenr[1] + cV1*cV4;
            V(1,2)=-DN(0,1)*Nenr[2] + cV1*cV5;
            V(2,0)=cV3;
            V(2,1)=cV4;
            V(2,2)=cV5;
            V(3,0)=-DN(1,0)*Nenr[0] + cV0*cV6;
            V(3,1)=-DN(1,0)*Nenr[1] + cV0*cV7;
            V(3,2)=-DN(1,0)*Nenr[2] + cV0*cV8;
            V(4,0)=-DN(1,1)*Nenr[0] + cV1*cV6;
            V(4,1)=-DN(1,1)*Nenr[1] + cV1*cV7;
            V(4,2)=-DN(1,1)*Nenr[2] + cV1*cV8;
            V(5,0)=cV6;
            V(5,1)=cV7;
            V(5,2)=cV8;
            V(6,0)=-DN(2,0)*Nenr[0] + cV0*cV9;
            V(6,1)=-DN(2,0)*Nenr[1] + cV0*cV10;
            V(6,2)=-DN(2,0)*Nenr[2] + cV0*cV11;
            V(7,0)=-DN(2,1)*Nenr[0] + cV1*cV9;
            V(7,1)=-DN(2,1)*Nenr[1] + cV1*cV10;
            V(7,2)=-DN(2,1)*Nenr[2] + cV1*cV11;
            V(8,0)=cV9;
            V(8,1)=cV10;
            V(8,2)=cV11;
...
const double cV3 =             1.0*rho/(rho*stab_c2*sqrt(pow(cV0, 2) + pow(cV1, 2) + pow(cV2, 2))/h + mu*stab_c1/pow(h, 2) + dyn_tau*rho/dt);
const double cV4 =             cV3*(DN(0,0)*DNenr(0,0) + DN(0,1)*DNenr(0,1) + DN(0,2)*DNenr(0,2));
const double cV5 =             cV3*(DN(0,0)*DNenr(1,0) + DN(0,1)*DNenr(1,1) + DN(0,2)*DNenr(1,2));
const double cV6 =             cV3*(DN(0,0)*DNenr(2,0) + DN(0,1)*DNenr(2,1) + DN(0,2)*DNenr(2,2));
const double cV7 =             cV3*(DN(0,0)*DNenr(3,0) + DN(0,1)*DNenr(3,1) + DN(0,2)*DNenr(3,2));
const double cV8 =             cV3*(DN(1,0)*DNenr(0,0) + DN(1,1)*DNenr(0,1) + DN(1,2)*DNenr(0,2));
const double cV9 =             cV3*(DN(1,0)*DNenr(1,0) + DN(1,1)*DNenr(1,1) + DN(1,2)*DNenr(1,2));
const double cV10 =             cV3*(DN(1,0)*DNenr(2,0) + DN(1,1)*DNenr(2,1) + DN(1,2)*DNenr(2,2));
const double cV11 =             cV3*(DN(1,0)*DNenr(3,0) + DN(1,1)*DNenr(3,1) + DN(1,2)*DNenr(3,2));
const double cV12 =             cV3*(DN(2,0)*DNenr(0,0) + DN(2,1)*DNenr(0,1) + DN(2,2)*DNenr(0,2));
const double cV13 =             cV3*(DN(2,0)*DNenr(1,0) + DN(2,1)*DNenr(1,1) + DN(2,2)*DNenr(1,2));
const double cV14 =             cV3*(DN(2,0)*DNenr(2,0) + DN(2,1)*DNenr(2,1) + DN(2,2)*DNenr(2,2));
const double cV15 =             cV3*(DN(2,0)*DNenr(3,0) + DN(2,1)*DNenr(3,1) + DN(2,2)*DNenr(3,2));
const double cV16 =             cV3*(DN(3,0)*DNenr(0,0) + DN(3,1)*DNenr(0,1) + DN(3,2)*DNenr(0,2));
const double cV17 =             cV3*(DN(3,0)*DNenr(1,0) + DN(3,1)*DNenr(1,1) + DN(3,2)*DNenr(1,2));
const double cV18 =             cV3*(DN(3,0)*DNenr(2,0) + DN(3,1)*DNenr(2,1) + DN(3,2)*DNenr(2,2));
const double cV19 =             cV3*(DN(3,0)*DNenr(3,0) + DN(3,1)*DNenr(3,1) + DN(3,2)*DNenr(3,2));
            V(0,0)=-DN(0,0)*Nenr[0] + cV0*cV4;
            V(0,1)=-DN(0,0)*Nenr[1] + cV0*cV5;
            V(0,2)=-DN(0,0)*Nenr[2] + cV0*cV6;
            V(0,3)=-DN(0,0)*Nenr[3] + cV0*cV7;
            V(1,0)=-DN(0,1)*Nenr[0] + cV1*cV4;
            V(1,1)=-DN(0,1)*Nenr[1] + cV1*cV5;
            V(1,2)=-DN(0,1)*Nenr[2] + cV1*cV6;
            V(1,3)=-DN(0,1)*Nenr[3] + cV1*cV7;
            V(2,0)=-DN(0,2)*Nenr[0] + cV2*cV4;
            V(2,1)=-DN(0,2)*Nenr[1] + cV2*cV5;
            V(2,2)=-DN(0,2)*Nenr[2] + cV2*cV6;
            V(2,3)=-DN(0,2)*Nenr[3] + cV2*cV7;
            V(3,0)=cV4;
            V(3,1)=cV5;
            V(3,2)=cV6;
            V(3,3)=cV7;
            V(4,0)=-DN(1,0)*Nenr[0] + cV0*cV8;
            V(4,1)=-DN(1,0)*Nenr[1] + cV0*cV9;
            V(4,2)=-DN(1,0)*Nenr[2] + cV0*cV10;
            V(4,3)=-DN(1,0)*Nenr[3] + cV0*cV11;
            V(5,0)=-DN(1,1)*Nenr[0] + cV1*cV8;
            V(5,1)=-DN(1,1)*Nenr[1] + cV1*cV9;
            V(5,2)=-DN(1,1)*Nenr[2] + cV1*cV10;
            V(5,3)=-DN(1,1)*Nenr[3] + cV1*cV11;
            V(6,0)=-DN(1,2)*Nenr[0] + cV2*cV8;
            V(6,1)=-DN(1,2)*Nenr[1] + cV2*cV9;
            V(6,2)=-DN(1,2)*Nenr[2] + cV10*cV2;
            V(6,3)=-DN(1,2)*Nenr[3] + cV11*cV2;
            V(7,0)=cV8;
            V(7,1)=cV9;
            V(7,2)=cV10;
            V(7,3)=cV11;
            V(8,0)=-DN(2,0)*Nenr[0] + cV0*cV12;
            V(8,1)=-DN(2,0)*Nenr[1] + cV0*cV13;
            V(8,2)=-DN(2,0)*Nenr[2] + cV0*cV14;
            V(8,3)=-DN(2,0)*Nenr[3] + cV0*cV15;
            V(9,0)=-DN(2,1)*Nenr[0] + cV1*cV12;
            V(9,1)=-DN(2,1)*Nenr[1] + cV1*cV13;
            V(9,2)=-DN(2,1)*Nenr[2] + cV1*cV14;
            V(9,3)=-DN(2,1)*Nenr[3] + cV1*cV15;
            V(10,0)=-DN(2,2)*Nenr[0] + cV12*cV2;
            V(10,1)=-DN(2,2)*Nenr[1] + cV13*cV2;
            V(10,2)=-DN(2,2)*Nenr[2] + cV14*cV2;
            V(10,3)=-DN(2,2)*Nenr[3] + cV15*cV2;
            V(11,0)=cV12;
            V(11,1)=cV13;
            V(11,2)=cV14;
            V(11,3)=cV15;
            V(12,0)=-DN(3,0)*Nenr[0] + cV0*cV16;
            V(12,1)=-DN(3,0)*Nenr[1] + cV0*cV17;
            V(12,2)=-DN(3,0)*Nenr[2] + cV0*cV18;
            V(12,3)=-DN(3,0)*Nenr[3] + cV0*cV19;
            V(13,0)=-DN(3,1)*Nenr[0] + cV1*cV16;
            V(13,1)=-DN(3,1)*Nenr[1] + cV1*cV17;
            V(13,2)=-DN(3,1)*Nenr[2] + cV1*cV18;
            V(13,3)=-DN(3,1)*Nenr[3] + cV1*cV19;
            V(14,0)=-DN(3,2)*Nenr[0] + cV16*cV2;
            V(14,1)=-DN(3,2)*Nenr[1] + cV17*cV2;
            V(14,2)=-DN(3,2)*Nenr[2] + cV18*cV2;
            V(14,3)=-DN(3,2)*Nenr[3] + cV19*cV2;
            V(15,0)=cV16;
            V(15,1)=cV17;
            V(15,2)=cV18;
            V(15,3)=cV19;
