...
#ifndef KRATOS_EMBEDDED_BCSF_FLUID_ELEMENT_H
#define KRATOS_EMBEDDED_BCSF_FLUID_ELEMENT_H
...
class EmbeddedBCSFFluidElement : public TBaseElement
{
public:
    ///@name Type Definitions
    ///@{

    /// Pointer definition of EmbeddedBCSFFluidElement
    KRATOS_CLASS_INTRUSIVE_POINTER_DEFINITION(EmbeddedBCSFFluidElement);
     ...
     */
    EmbeddedBCSFFluidElement(IndexType NewId = 0);
     ...
     */
    EmbeddedBCSFFluidElement(IndexType NewId, const NodesArrayType& ThisNodes);
     ...
     */
    EmbeddedBCSFFluidElement(IndexType NewId, Geometry<NodeType>::Pointer pGeometry);
     ...
     */
    EmbeddedBCSFFluidElement(IndexType NewId, Geometry<NodeType>::Pointer pGeometry, Properties::Pointer pProperties);

    /// Destructor.
    ~EmbeddedBCSFFluidElement() override;
    ...
    /**
     * Returns a pointer to a new EmbeddedBCSFFluidElement element, created using given input
    ...
    /** For EmbeddedBCSFFluidElement, this initializes the discontinuous
...
protected:
    ...
    void AddCondensedTimeIntegratedSystem(
...
private:
    ...
    /// Assignment operator.
    EmbeddedBCSFFluidElement& operator=(EmbeddedBCSFFluidElement const& rOther);

    /// Copy constructor.
    EmbeddedBCSFFluidElement(EmbeddedBCSFFluidElement const& rOther);

    ///@}


}; // Class EmbeddedBCSFFluidElement
...
inline std::istream& operator >>(
    ...
    EmbeddedBCSFFluidElement<TElementData>& rThis)
{
    return rIStream;
}
...
inline std::ostream& operator <<(
    ...
    const EmbeddedBCSFFluidElement<TElementData>& rThis)
{
...
#endif // KRATOS_EMBEDDED_BCSF_FLUID_ELEMENT_H
