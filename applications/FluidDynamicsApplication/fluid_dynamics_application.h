...
// #Test Condition:
#include "custom_conditions/test_condition.h"
...
namespace Kratos
{
    ...
    private:
        ...
        /// Test Condition
        const TestCondition<2, 2> mTestCondition2D2N;
        const TestCondition<3, 3> mTestCondition3D3N;
        ...
        /// Compressible Navier-Stokes JWL symbolic element
        const CompressibleNavierStokesJWLExplicit<2, 3> mCompressibleNavierStokesJWLExplicit2D3N;
