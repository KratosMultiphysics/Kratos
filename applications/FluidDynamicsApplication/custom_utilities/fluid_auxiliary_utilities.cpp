...
bool FluidAuxiliaryUtilities::IsSplit(const Vector& rNodalDistances)
{
    std::size_t n_pos(0);
    std::size_t n_neg(0);
    const std::size_t pts_number = rNodalDistances.size();
...
bool FluidAuxiliaryUtilities::IsPositive(const Vector& rNodalDistances)
{
    std::size_t n_pos (0);
    const std::size_t pts_number = rNodalDistances.size();
    for (std::size_t i_node = 0; i_node < pts_number; ++i_node){
...
bool FluidAuxiliaryUtilities::IsNegative(const Vector& rNodalDistances)
{
