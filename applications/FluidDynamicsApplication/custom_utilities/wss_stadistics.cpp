...
#include "wss_stadistics.h"
#include "fluid_dynamics_application_variables.h"

namespace Kratos {

void WssUtilities::CalculateWSS(ModelPart &rModelPart)
{
...
void WssUtilities::CalculateTWSS(ModelPart &rModelPart, int Step){
...
void WssUtilities::CalculateOSI(ModelPart &rModelPart, int Step){
