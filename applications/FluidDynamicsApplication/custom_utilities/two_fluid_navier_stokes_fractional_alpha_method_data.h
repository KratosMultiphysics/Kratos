...
#if !defined(KRATOS_TWO_FLUID_NAVIER_STOKES_FRACTIONAL_DATA_ALPHA_METHOD_H)
#define KRATOS_TWO_FLUID_NAVIER_STOKES_FRACTIONAL_DATA_ALPHA_METHOD_H
...
class TwoFluidNavierStokesFractionalAlphaMethodData : public FluidElementData<TDim,TNumNodes, true>
{
public:
