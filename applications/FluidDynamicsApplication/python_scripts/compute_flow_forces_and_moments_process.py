...
class ComputeFlowForcesAndMomentsProcess(KratosMultiphysics.Process):
    ...
    def ExecuteInitialize(self):
        ...
        self.print_flow_forces_and_moments_to_screen = self.params["print_to_screen"].GetBool()
        self.write_flow_forces_output_file = self.params["write_forces_output_file"].GetBool()
        self.write_flow_moments_output_file = self.params["write_moments_output_file"].GetBool()
