...
class NavierStokesTwoFluidsSolver(FluidSolver):
    ...
    def Initialize(self):
        ...
        self.accelerationLimitationUtility = KratosCFD.AccelerationLimitationUtilities( self.computing_model_part, 1.0e4 )
        ...
        with open("Distance.log", "w") as DistanceLogFile:
            DistanceLogFile.write( "node.Id" + "\t" + "node.X" + "\t" + "node.Y" + "\t" + "node.Z" + "\t" + "distance" + "\n" )
        
        with open("DistanceGradient.log", "w") as DistanceGradLogFile:
    ...
    def InitializeSolutionStep(self):
        ...
        if self._TimeBufferIsInitialized():
            ...
            # # Evaluating the average nodal contact angle: Second location
