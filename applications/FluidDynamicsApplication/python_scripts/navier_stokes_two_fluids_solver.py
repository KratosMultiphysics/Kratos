...
class NavierStokesTwoFluidsSolver(FluidSolver):
    ...
    def __init__(self, model, custom_settings):
        ...
        self.energy_preserving_momentum_term = True
        if self.settings["formulation"].Has("energy_preserving_momentum_term"):
            print("hola")
            self.energy_preserving_momentum_term = self.settings["formulation"]["energy_preserving_momentum_term"].GetBool()
        self.main_model_part.ProcessInfo.SetValue(KratosCFD.ENERGY_PRESERVING_MOMENTUM_TERM, self.energy_preserving_momentum_term)
