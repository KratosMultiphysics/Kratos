...
def CreateSolver(model, custom_settings):
    return NSCompressibleExplicitSolver(model, custom_settings)

class NSCompressibleExplicitSolver(NavierStokesCompressibleSolver):
    ...
    def GetDefaultSettings(cls):
        ...
        default_settings.AddMissingParameters(super(NSCompressibleExplicitSolver, cls).GetDefaultSettings())
        return default_settings

    def __init__(self, model, custom_settings):
        self._validate_settings_in_baseclass=True # To be removed eventually
        super(NSCompressibleExplicitSolver,self).__init__(model,custom_settings)

##        self.element_name = "CompressibleNavierStokes"
        self.element_name = "CompressibleNSExplicit"
        ...
        print("Construction of NSExplicitSolver finished.")
