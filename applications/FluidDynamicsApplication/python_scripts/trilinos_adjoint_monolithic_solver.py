    ...
    def _CreateBuilderAndSolver(self):
        ...
        if self.settings["consider_periodic_conditions"].GetBool():
            ...
            if self.settings["builder_and_solver_settings"]["use_block_builder"].GetBool():
                ...
                builder_and_solver = TrilinosApplication.TrilinosBlockBuilderAndSolver(epetra_communicator, trilinos_linear_solver, bs_params)
            else:
                ...
                builder_and_solver = TrilinosApplication.TrilinosEliminationBuilderAndSolver(epetra_communicator, guess_row_size, trilinos_linear_solver)
