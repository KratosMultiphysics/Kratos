...
class NavierStokesTwoFluidsHydraulicSolver(FluidSolver):
    ...
    def __init__(self, model, custom_settings):
        ...
        self.shock_capturing = self.settings["shock_capturing"].GetBool()
        self._reinitialization_type = self.settings["distance_reinitialization"].GetString()

        # TODO: FM.ALE VIRTUAL MODEL PART
    ...
    def AdvanceInTime(self, current_time):
        ...
        new_time = super(NavierStokesTwoFluidsHydraulicSolver, self).AdvanceInTime(current_time)
    ...
    def Initialize(self):
        ...
        # TODO: INITIALIZE FM-ALE UTILITY
    ...
    def SolveSolutionStep(self):
        ...
        is_converged = super(NavierStokesTwoFluidsHydraulicSolver,self).SolveSolutionStep()
    ...
    def FinalizeSolutionStep(self):
        ...
        if self.shock_capturing:
            # TODO: User defined variable in ProjectParameters.
            max_factor = 1000.0
            properties_1 = self.main_model_part.Properties[1]
            water_dynamic_viscosity_max = max_factor * properties_1.GetValue(KratosMultiphysics.DYNAMIC_VISCOSITY)
            for element in self.GetComputingModelPart().Elements:
    ...
    def _PerformLevelSetConvection(self):
        ...
        self.GetComputingModelPart().SetValue(KratosMultiphysics.CROSS_WIND_STABILIZATION_FACTOR,1.0)
    ...
    def __CreateFmAleUtility(self):
        ...
        if (mesh_movement == "implicit"):
            ...
            raise Exception("FM-ALE mesh_movement set to \'" + mesh_movement +
