...
class FluidDynamicsAnalysis(AnalysisStage):
    ...
    def __init__(self,model,parameters):
        ...
        #print("@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@")
        #print("@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@")
        #print("solver_settings", parameters["solver_settings"])
        #jkdlfkjgdflkjgldfj
