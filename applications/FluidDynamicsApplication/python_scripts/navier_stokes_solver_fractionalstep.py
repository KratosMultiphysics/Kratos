...
class NavierStokesSolverFractionalStep(FluidSolver):
    ...
    def __init__(self, model, custom_settings):
        ...
        if custom_settings["formulation"]["element_type"].GetString() not in ["FractionalStep","QSNavierStokesSemiExplicit"]:
            raise Exception("NavierStokesFractionalStepSolver only accepts FractionalStep or QSNavierStokesSemiExplicit as the \"element_type\" in \"formulation\"")
