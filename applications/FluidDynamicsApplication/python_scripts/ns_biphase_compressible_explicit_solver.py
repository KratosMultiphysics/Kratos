...
def CreateSolver(model, custom_settings):
    return NSBiphaseCompressibleExplicitSolver(model, custom_settings)
...
class NSBiphaseCompressibleExplicitSolver(FluidSolver):
    def __init__(self, model, custom_settings):
        ...
        KratosMultiphysics.Logger.PrintInfo("::[NSBiphaseCompressibleExplicitSolver]:: ","Construction of NSBiphaseCompressibleExplicitSolver finished.")
    ...
    def AddVariables(self):
        ...
        self.main_model_part.AddNodalSolutionStepVariable(KratosFluid.DENSITY_SOLID) # Density DOF
