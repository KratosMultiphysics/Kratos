...
from KratosMultiphysics.FluidDynamicsApplication import trilinos_fluid_topology_optimization_solver_time
from KratosMultiphysics.FluidDynamicsApplication import fluid_topology_optimization_solver_time
