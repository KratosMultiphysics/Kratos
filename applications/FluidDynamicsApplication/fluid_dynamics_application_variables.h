...
KRATOS_DEFINE_APPLICATION_VARIABLE( FLUID_DYNAMICS_APPLICATION, bool, APPLY_NITSCHE_BOUNDARY_IMPOSITION)
KRATOS_DEFINE_APPLICATION_VARIABLE( FLUID_DYNAMICS_APPLICATION, bool, APPLY_EMBEDDED_CONSTRAINTS)
KRATOS_DEFINE_APPLICATION_VARIABLE( FLUID_DYNAMICS_APPLICATION, std::vector<Node::Pointer>, EMBEDDED_CONSTRAINT_MASTERS)
KRATOS_DEFINE_APPLICATION_VARIABLE( FLUID_DYNAMICS_APPLICATION, Matrix, EMBEDDED_CONSTRAINT_MASTER_WEIGHTS)
