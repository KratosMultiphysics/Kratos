...
KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS( FLUID_DYNAMICS_APPLICATION, AUXILIAR_GRADIENT_X); // An auxiliar gradient needed to compute the metric
KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS( FLUID_DYNAMICS_APPLICATION, AUXILIAR_GRADIENT_Y); // An auxiliar gradient needed to compute the metric
KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS( FLUID_DYNAMICS_APPLICATION, AUXILIAR_GRADIENT_Z); // An auxiliar gradient needed to compute the metric
