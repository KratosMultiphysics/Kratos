...
KRATOS_DEFINE_APPLICATION_VARIABLE( FLUID_DYNAMICS_APPLICATION, Vector3, AUXILIAR_GRADIENT_X); // An auxiliar gradient needed to compute the metric
KRATOS_DEFINE_APPLICATION_VARIABLE( FLUID_DYNAMICS_APPLICATION, Vector3, AUXILIAR_GRADIENT_Y); // An auxiliar gradient needed to compute the metric
KRATOS_DEFINE_APPLICATION_VARIABLE( FLUID_DYNAMICS_APPLICATION, Vector3, AUXILIAR_GRADIENT_Z); // An auxiliar gradient needed to compute the metric
