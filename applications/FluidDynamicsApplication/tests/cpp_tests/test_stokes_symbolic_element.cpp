...
namespace Kratos {
	namespace Testing {
        ...
        void PrepareModelPart2D3N(ModelPart & rModelPart)
        {
            ...
            rModelPart.CreateNewElement("SymbolicStokes2D3N", 1, elem_nodes, p_elem_prop);
        ...
        KRATOS_TEST_CASE_IN_SUITE(ElementSymbolicStokes2D3N, FluidDynamicsApplicationFastSuite)
        {
            ...
            PrepareModelPart2D3N(r_model_part);
            ...
            KRATOS_EXPECT_VECTOR_NEAR(RHS, RHS_expected, 1.0e-2);
            KRATOS_EXPECT_VECTOR_NEAR(row(LHS,0), LHS_row_0_expected, 1.0e-2);
        }

        /** Checks the SymbolicStokes2D3N Calculate method.
         */
        KRATOS_TEST_CASE_IN_SUITE(ElementSymbolicStokes2D3NCalculate, FluidDynamicsApplicationFastSuite)
        {
            Model model;
            ModelPart& r_model_part = model.CreateModelPart("Main", 3);
            PrepareModelPart2D3N(r_model_part);
            ...
            KRATOS_EXPECT_NEAR(shear_heat_flux, 1.3e-06, 1.0e-2);
            KRATOS_EXPECT_NEAR(eq_strain_rate, 0.0, TOLERANCE);
            KRATOS_EXPECT_NEAR(effective_visc, 0.0, TOLERANCE);
        }

        void PrepareModelPart2D3NStationary(ModelPart & rModelPart)
        {
            // Variables addition
            rModelPart.AddNodalSolutionStepVariable(BODY_FORCE);
            rModelPart.AddNodalSolutionStepVariable(PRESSURE);
            ...
            // Set the element properties
            Properties::Pointer p_elem_prop = rModelPart.CreateNewProperties(1);
            ...
            for (NodeIteratorType it_node=rModelPart.NodesBegin(); it_node<rModelPart.NodesEnd(); ++it_node){
        ...
        KRATOS_TEST_CASE_IN_SUITE(ElementSymbolicStokes2D3NStationary, FluidDynamicsApplicationFastSuite)
        {
            Model model;
            ModelPart& r_model_part = model.CreateModelPart("Main", 3);
            PrepareModelPart2D3NStationary(r_model_part);
            ...
            KRATOS_EXPECT_NEAR(sum_RHS, 0.0, TOLERANCE);
        ...
        /** Checks the SymbolicStokes2D3N element.
         * Checks the Calculate method for stationary solid rigid movements.
         */
        KRATOS_TEST_CASE_IN_SUITE(ElementSymbolicStokes2D3NStationaryCalculate, FluidDynamicsApplicationFastSuite)
        {
            Model model;
            ModelPart& r_model_part = model.CreateModelPart("Main", 3);
            PrepareModelPart2D3NStationary(r_model_part);
            ...
            p_element->Calculate(EQ_STRAIN_RATE, eq_strain_rate, r_process_info);
            p_element->Calculate(EFFECTIVE_VISCOSITY, effective_visc, r_process_info);
            KRATOS_EXPECT_NEAR(shear_heat_flux, 0.0, TOLERANCE);
            KRATOS_EXPECT_NEAR(eq_strain_rate, 0.0, TOLERANCE);
            KRATOS_EXPECT_NEAR(effective_visc, 0.0, TOLERANCE);
        }


        void PrepareModelPart2D4N(ModelPart & rModelPart)
        {
            // Variables addition
            rModelPart.AddNodalSolutionStepVariable(BODY_FORCE);
            rModelPart.AddNodalSolutionStepVariable(PRESSURE);
            ...
            rModelPart.CreateNewElement("SymbolicStokes2D4N", 1, elem_nodes, p_elem_prop);
        ...
        KRATOS_TEST_CASE_IN_SUITE(ElementSymbolicStokes2D4N, FluidDynamicsApplicationFastSuite)
        {
            Model model;
            ModelPart &r_model_part = model.CreateModelPart("Main", 3);
            PrepareModelPart2D4N(r_model_part);
            ...
            // Check values
            std::vector<double> RHS_expected({348.75,385.521,-0.115115,-151.25,310.417,-0.0589479,23.125,59.8958,0.0524583,297.812,-15.2083,-0.0283958});
        ...
        /** Checks the SymbolicStokes2D4N element Calculate method.
         */
        KRATOS_TEST_CASE_IN_SUITE(ElementSymbolicStokes2D4NCalculate, FluidDynamicsApplicationFastSuite)
        {
            Model model;
            ModelPart &r_model_part = model.CreateModelPart("Main", 3);
            PrepareModelPart2D4N(r_model_part);
            ...
            p_element->Calculate(EQ_STRAIN_RATE, eq_strain_rate, r_process_info);
            p_element->Calculate(EFFECTIVE_VISCOSITY, effective_visc, r_process_info);
            KRATOS_EXPECT_NEAR(shear_heat_flux, 2.3328e-06, 1e-02);
            KRATOS_EXPECT_NEAR(eq_strain_rate, 0.0, TOLERANCE);
            KRATOS_EXPECT_NEAR(effective_visc, 0.0, TOLERANCE);
        }

        void PrepareModelPart2D4NStationary(ModelPart & rModelPart)
        {
            // Variables addition
            rModelPart.AddNodalSolutionStepVariable(BODY_FORCE);
            rModelPart.AddNodalSolutionStepVariable(PRESSURE);
        ...
        KRATOS_TEST_CASE_IN_SUITE(ElementSymbolicStokes2D4NStationary, FluidDynamicsApplicationFastSuite)
        {
            Model model;
            ModelPart &r_model_part = model.CreateModelPart("Main", 3);
            PrepareModelPart2D4NStationary(r_model_part);
        ...
        /** Checks the SymbolicStokes2D4N element Calculate method.
         */
        KRATOS_TEST_CASE_IN_SUITE(ElementSymbolicStokes2D4NStationaryCalculate, FluidDynamicsApplicationFastSuite)
        {
            Model model;
            ModelPart &r_model_part = model.CreateModelPart("Main", 3);
            PrepareModelPart2D4NStationary(r_model_part);
        ...
        void PrepareModelPart3D4N(ModelPart & rModelPart)
        {
            // Variables addition
            rModelPart.AddNodalSolutionStepVariable(BODY_FORCE);
            rModelPart.AddNodalSolutionStepVariable(PRESSURE);
            ...
            std::vector<ModelPart::IndexType> elem_nodes {1, 2, 3, 4};
            rModelPart.CreateNewElement("SymbolicStokes3D4N", 1, elem_nodes, p_elem_prop);
        ...
        KRATOS_TEST_CASE_IN_SUITE(ElementSymbolicStokes3D4N, FluidDynamicsApplicationFastSuite)
        {
            Model model;
            ModelPart& r_model_part = model.CreateModelPart("Main", 3);
            PrepareModelPart3D4N(r_model_part);
            // Compute RHS and LHS
        ...
        // /** Checks the SymbolicStokes3D4N element Calculate method.
        //  */
        KRATOS_TEST_CASE_IN_SUITE(ElementSymbolicStokes3D4NCalculate, FluidDynamicsApplicationFastSuite)
        {
            Model model;
            ModelPart& r_model_part = model.CreateModelPart("Main", 3);
            PrepareModelPart3D4N(r_model_part);
            ...
            p_element->Calculate(EQ_STRAIN_RATE, eq_strain_rate, r_process_info);
            p_element->Calculate(EFFECTIVE_VISCOSITY, effective_visc, r_process_info);
            KRATOS_EXPECT_NEAR(shear_heat_flux, 5.4e-06, 1.0e-2);
            KRATOS_EXPECT_NEAR(eq_strain_rate, 0.0, TOLERANCE);
            KRATOS_EXPECT_NEAR(effective_visc, 0.0, TOLERANCE);
        }

        void PrepareModelPart3D4NStationary(ModelPart & rModelPart)
        {
            // Variables addition
            rModelPart.AddNodalSolutionStepVariable(BODY_FORCE);
            rModelPart.AddNodalSolutionStepVariable(PRESSURE);
            ...
            double delta_time = 0.1;
            rModelPart.GetProcessInfo().SetValue(DYNAMIC_TAU, 1.0);
            rModelPart.GetProcessInfo().SetValue(SOUND_VELOCITY, 1.0e+03);
            rModelPart.GetProcessInfo().SetValue(DELTA_TIME, delta_time);
            Vector bdf_coefs(3);
            bdf_coefs[0] = 0.0;
            bdf_coefs[1] = 0.0;
        ...
        KRATOS_TEST_CASE_IN_SUITE(ElementSymbolicStokes3D4NStationary, FluidDynamicsApplicationFastSuite)
        {
            Model model;
            ModelPart& r_model_part = model.CreateModelPart("Main", 3);
            PrepareModelPart3D4NStationary(r_model_part);
        ...
        KRATOS_TEST_CASE_IN_SUITE(ElementSymbolicStokes3D4NStationaryCalculate, FluidDynamicsApplicationFastSuite)
        {
            Model model;
            ModelPart& r_model_part = model.CreateModelPart("Main", 3);
            PrepareModelPart3D4NStationary(r_model_part);
        ...
        void PrepareModelPart3D6N(ModelPart & rModelPart)
        {
            // Variables addition
            rModelPart.AddNodalSolutionStepVariable(BODY_FORCE);
            rModelPart.AddNodalSolutionStepVariable(PRESSURE);
            ...
            rModelPart.CreateNewNode(3, 0.0, 1.0, 0.0);
            rModelPart.CreateNewNode(4, 0.0, 0.0, 1.0);
            rModelPart.CreateNewNode(5, 1.0, 0.0, 1.0);
            rModelPart.CreateNewNode(6, 0.0, 1.0, 1.0);
            std::vector<ModelPart::IndexType> elem_nodes{1, 2, 3, 4, 5, 6};
            rModelPart.CreateNewElement("SymbolicStokes3D6N", 1, elem_nodes, p_elem_prop);
        ...
        KRATOS_TEST_CASE_IN_SUITE(ElementSymbolicStokes3D6N, FluidDynamicsApplicationFastSuite)
        {
            Model model;
            ModelPart &r_model_part = model.CreateModelPart("Main", 3);
            PrepareModelPart3D6N(r_model_part);
        ...
        void PrepareModelPart3D6NStationary(ModelPart & rModelPart)
        {
            // Variables addition
            rModelPart.AddNodalSolutionStepVariable(BODY_FORCE);
            rModelPart.AddNodalSolutionStepVariable(PRESSURE);
        ...
        KRATOS_TEST_CASE_IN_SUITE(ElementSymbolicStokes3D6NStationary, FluidDynamicsApplicationFastSuite)
        {
            Model model;
            ModelPart &r_model_part = model.CreateModelPart("Main", 3);
            PrepareModelPart3D6NStationary(r_model_part);
        ...
        KRATOS_TEST_CASE_IN_SUITE(ElementSymbolicStokes3D6NStationaryCalculate, FluidDynamicsApplicationFastSuite)
        {
            Model model;
            ModelPart &r_model_part = model.CreateModelPart("Main", 3);
            PrepareModelPart3D6NStationary(r_model_part);
        ...
        void PrepareModelPart3D8N(ModelPart & rModelPart)
        {
            // Variables addition
            rModelPart.AddNodalSolutionStepVariable(BODY_FORCE);
            rModelPart.AddNodalSolutionStepVariable(PRESSURE);
            ...
            rModelPart.CreateNewNode(2, 1.0, 0.0, 0.0);
            rModelPart.CreateNewNode(3, 1.0, 1.0, 0.0);
            rModelPart.CreateNewNode(4, 0.0, 1.0, 1.0);
            ...
            rModelPart.CreateNewElement("SymbolicStokes3D8N", 1, elem_nodes, p_elem_prop);
        ...
        KRATOS_TEST_CASE_IN_SUITE(ElementSymbolicStokes3D8N, FluidDynamicsApplicationFastSuite)
        {
            Model model;
            ModelPart &r_model_part = model.CreateModelPart("Main", 3);
            PrepareModelPart3D8N(r_model_part);
            // Compute RHS and LHS
        ...
        // /** Checks the SymbolicStokes3D8N element Calculate method.
        //  */
        KRATOS_TEST_CASE_IN_SUITE(ElementSymbolicStokes3D8NCalculate, FluidDynamicsApplicationFastSuite)
        {
            Model model;
            ModelPart &r_model_part = model.CreateModelPart("Main", 3);
            PrepareModelPart3D8N(r_model_part);
            ...
            p_element->Calculate(EQ_STRAIN_RATE, eq_strain_rate, r_process_info);
            p_element->Calculate(EFFECTIVE_VISCOSITY, effective_visc, r_process_info);
            KRATOS_EXPECT_NEAR(shear_heat_flux, 8.64054e-06, 1.0e-2);
            KRATOS_EXPECT_NEAR(eq_strain_rate, 0.0, TOLERANCE);
            KRATOS_EXPECT_NEAR(effective_visc, 0.0, TOLERANCE);
        }

        void PrepareModelPart3D8NStationary(ModelPart & rModelPart)
        {
            // Variables addition
            rModelPart.AddNodalSolutionStepVariable(BODY_FORCE);
            rModelPart.AddNodalSolutionStepVariable(PRESSURE);
        ...
        KRATOS_TEST_CASE_IN_SUITE(ElementSymbolicStokes3D8NStationary, FluidDynamicsApplicationFastSuite)
        {
            Model model;
            ModelPart &r_model_part = model.CreateModelPart("Main", 3);
            PrepareModelPart3D8NStationary(r_model_part);
        ...
        KRATOS_TEST_CASE_IN_SUITE(ElementSymbolicStokes3D8NStationaryCalculate, FluidDynamicsApplicationFastSuite)
        {
            Model model;
            ModelPart &r_model_part = model.CreateModelPart("Main", 3);
            PrepareModelPart3D8NStationary(r_model_part);
