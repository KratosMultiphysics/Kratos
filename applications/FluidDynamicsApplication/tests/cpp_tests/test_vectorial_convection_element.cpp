...
// namespace Testing
// {
//     KRATOS_TEST_CASE_IN_SUITE(VectorialConvectionElement2D, FluidDynamicsApplicationFastSuite)
//     {
//         Model current_model;
...
//         model_part.AddNodalSolutionStepVariable(FRACTIONAL_VELOCITY);
...
//         auto p_element = model_part.CreateNewElement("VectorialConvectionFractionalElement", 1, elemNodes, pElemProp);
...
//                 p_element->GetGeometry()[i].FastGetSolutionStepValue(FRACTIONAL_VELOCITY)[k]    = vel_original(i,k);
