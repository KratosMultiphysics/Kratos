...
namespace Kratos {
	namespace Testing {
	    ...
	    KRATOS_TEST_CASE_IN_SUITE(ElementEmbeddedNavierStokes3D4N, FluidDynamicsApplicationFastSuite)
		{
			...
			KRATOS_CHECK_NEAR(RHS(4), 963.399, 1e-3);
			KRATOS_CHECK_NEAR(RHS(5), 1963.88, 1e-2);
			KRATOS_CHECK_NEAR(RHS(6), 2964.36, 1e-2);
			...
			KRATOS_CHECK_NEAR(RHS(12), 927.396, 1e-3);
			KRATOS_CHECK_NEAR(RHS(13), 1928.26, 1e-2);
			KRATOS_CHECK_NEAR(RHS(14), 2929.12, 1e-2);
