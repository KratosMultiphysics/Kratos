...
KRATOS_TEST_CASE_IN_SUITE(AxisymmetricNavierStokes2D3N, FluidDynamicsApplicationFastSuite)
{
    Model model;
    ...
    auto p_elem = r_model_part.CreateNewElement("AxisymmetricNavierStokes2D3N", 1, element_nodes, p_properties);
