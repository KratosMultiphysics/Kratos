...
KRATOS_TEST_CASE_IN_SUITE(ElementTwoFluidNavierStokesFractionalCut3D4NError, FluidDynamicsApplicationFastSuite)
{
	...
	pElemProp->SetValue(DYNAMIC_VISCOSITY, 1.0e-02);
	NewtonianTwoFluid3DLaw::Pointer pConsLaw(new NewtonianTwoFluid3DLaw());
	pElemProp->SetValue(CONSTITUTIVE_LAW, pConsLaw);
	...
	reference_RHS[0] = 3885.7277179;
	reference_RHS[1] = 2853.21656651;
	reference_RHS[2] = 3702.08261768;
	reference_RHS[3] = -5.3352875285;
	reference_RHS[4] = -4028.70584416;
	reference_RHS[5] = 302.05648046;
	reference_RHS[6] = -945.708093278;
	reference_RHS[7] = -3.93555167259;
	reference_RHS[8] = 47.4447861701;
	reference_RHS[9] = -3601.6349217;
	reference_RHS[10] = -666.475460772;
	reference_RHS[11] = -3.04929648043;
	reference_RHS[12] = -176.79766346;
	reference_RHS[13] = 455.783986472;
	reference_RHS[14] = -4803.81765472;
	reference_RHS[15] = -4.44653098515;

	KRATOS_EXPECT_VECTOR_NEAR(reference_RHS, RHS, 1e-10);
}
