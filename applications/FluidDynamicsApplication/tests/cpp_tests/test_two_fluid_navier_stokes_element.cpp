...
namespace Kratos {
	namespace Testing {
	     ...
	     */
	    KRATOS_TEST_CASE_IN_SUITE(TwoFluidNavierStokes2D3N, FluidDynamicsApplicationFastSuite)
		{
		 ...
		 */
	    KRATOS_TEST_CASE_IN_SUITE(TwoFluidNavierStokes2D3NStationary, FluidDynamicsApplicationFastSuite)
		{
	    ...
	    //  * Checks the LHS and RHS computation using a small perturbation.
	    //  */
	    KRATOS_TEST_CASE_IN_SUITE(TwoFluidNavierStokes3D4N, FluidDynamicsApplicationFastSuite)
		{
