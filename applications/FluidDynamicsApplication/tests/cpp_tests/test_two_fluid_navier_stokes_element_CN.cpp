...
namespace Kratos {
    namespace Testing {
       ...
       // /** Checks the TwoFluidNavierStokesCN3D4N element
        ...
        /** Includes the TwoFluidNavierStokesCN2D3N element with the BEHR2004 slip boundary condition in a hydrostatic case.
         ...
         */
        KRATOS_TEST_CASE_IN_SUITE(ElementTwoFluidNavierStokesCN2D3NHydrostaticBehr, FluidDynamicsApplicationFastSuite){
        ...
        /** Includes 3 elements of TwoFluidNavierStokesCN3D4N element
         ...
         *  Checks the computation of the RHS for components in tangential direction
         */
        KRATOS_TEST_CASE_IN_SUITE(ElementTwoFluidNavierStokesCN3D4NHydrostaticBehr, FluidDynamicsApplicationFastSuite){
         ...
         *  Checks the computation of the RHS for components in tangential direction
         */
        KRATOS_TEST_CASE_IN_SUITE(ElementTwoFluidNavierStokesCN2D3NStressBehr, FluidDynamicsApplicationFastSuite){
