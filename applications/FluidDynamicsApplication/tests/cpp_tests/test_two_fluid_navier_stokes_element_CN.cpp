...
namespace Kratos {
    namespace Testing {
        ...
        /** Checks the TwoFluidNavierStokesCN2D3N element.
        ...
        //  */
        KRATOS_TEST_CASE_IN_SUITE(ElementTwoFluidNavierStokesCutCN3D4N, FluidDynamicsApplicationFastSuite)
        {
            Model current_model;
            ModelPart& modelPart = current_model.CreateModelPart("Main");
            modelPart.SetBufferSize(2);
            ...
            // Check the RHS values (the RHS is computed as the LHS x previous_solution,
            // hence, it is assumed that if the RHS is correct, the LHS is correct as well)
            KRATOS_CHECK_NEAR(RHS(0),-58.19647448, 1e-7);
            KRATOS_CHECK_NEAR(RHS(1), 20.0842686, 1e-7);
            KRATOS_CHECK_NEAR(RHS(2), -184.765251, 1e-7);
            KRATOS_CHECK_NEAR(RHS(3), -0.01268202394, 1e-7);
            KRATOS_CHECK_NEAR(RHS(4), -33.6492926, 1e-7);
            KRATOS_CHECK_NEAR(RHS(5), -22.2956891, 1e-7);
            KRATOS_CHECK_NEAR(RHS(6), -312.8534787, 1e-7);
            KRATOS_CHECK_NEAR(RHS(7), 0.08272585084, 1e-7);
            KRATOS_CHECK_NEAR(RHS(8), 8.830446805, 1e-7);
            KRATOS_CHECK_NEAR(RHS(9), -58.2919022, 1e-7);
            KRATOS_CHECK_NEAR(RHS(10), -319.8415121, 1e-7);
            KRATOS_CHECK_NEAR(RHS(11), -0.03347348465, 1e-7);
            KRATOS_CHECK_NEAR(RHS(12), 17.56985234, 1e-7);
            KRATOS_CHECK_NEAR(RHS(13), -26.75306774, 1e-7);
            KRATOS_CHECK_NEAR(RHS(14), -361.4328205, 1e-7);
            KRATOS_CHECK_NEAR(RHS(15), -0.1315703422, 1e-7);

        }
                // /** Checks the TwoFluidNavierStokesCN3D4N element
        //  * Checks the LHS and RHS for a cut element with surface tension
        //  */
        KRATOS_TEST_CASE_IN_SUITE(ElementTwoFluidNavierStokesSurfaceTensionCN3D4N, FluidDynamicsApplicationFastSuite)
        {
            Model current_model;
            ModelPart& modelPart = current_model.CreateModelPart("Main");
            modelPart.SetBufferSize(2);
            ...
            reference_RHS[0] = -152.4409323;
            reference_RHS[1] = 24.13957068;
            reference_RHS[2]= -122.7772019;
            reference_RHS[3]= 0.01144281442;
            reference_RHS[4]= -4.120860807;
            reference_RHS[5]= -26.20551725;
            reference_RHS[6]= -326.9465205;
            reference_RHS[7]= 0.2064979391;
            reference_RHS[8]= 35.18428562;
            reference_RHS[9]= -49.68837532;
            reference_RHS[10]= -345.5651756;
            reference_RHS[11]=-0.05894281442;
            reference_RHS[12]= 55.68203954;
            reference_RHS[13]= -35.50206855;
            reference_RHS[14]= -383.8541644;
            reference_RHS[15]= -0.2539979398;
       ...
       // /** Checks the TwoFluidNavierStokesCN3D4N element
        ...
        //  */
        KRATOS_TEST_CASE_IN_SUITE(ElementTwoFluidNavierStokesNegativeSideCN3D4N, FluidDynamicsApplicationFastSuite)
        {
            Model current_model;
            ModelPart& modelPart = current_model.CreateModelPart("Main");
            modelPart.SetBufferSize(2);
            ...
            KRATOS_CHECK_NEAR(RHS(0), 23.46575083, 1e-7);
            KRATOS_CHECK_NEAR(RHS(1), 24.05147249, 1e-7);
            KRATOS_CHECK_NEAR(RHS(2), 53.36681839, 1e-7);
            KRATOS_CHECK_NEAR(RHS(3), 0.5241232306, 1e-7);
            KRATOS_CHECK_NEAR(RHS(4), -38.30464038, 1e-7);
            KRATOS_CHECK_NEAR(RHS(5), -26.19611063, 1e-7);
            KRATOS_CHECK_NEAR(RHS(6), -361.0502482, 1e-7);
            KRATOS_CHECK_NEAR(RHS(7), -0.04985560165, 1e-7);
            KRATOS_CHECK_NEAR(RHS(8), -23.383483, 1e-7);
            KRATOS_CHECK_NEAR(RHS(9), -49.63973437, 1e-7);
            KRATOS_CHECK_NEAR(RHS(10), -404.0801259, 1e-7);
            KRATOS_CHECK_NEAR(RHS(11), -0.05887685862, 1e-7);
            KRATOS_CHECK_NEAR(RHS(12), -27.22865372, 1e-7);
            KRATOS_CHECK_NEAR(RHS(13), -35.47543691, 1e-7);
            KRATOS_CHECK_NEAR(RHS(14), -467.0258502, 1e-7);
            KRATOS_CHECK_NEAR(RHS(15), -0.5103907704, 1e-7);
        ...
        KRATOS_TEST_CASE_IN_SUITE(ElementTwoFluidNavierStokesPositiveSideCN3D4N, FluidDynamicsApplicationFastSuite)
        {
            ...
            KRATOS_CHECK_NEAR(RHS(0), 23.46575083, 1e-7);
            KRATOS_CHECK_NEAR(RHS(1), 24.05147249, 1e-7);
            KRATOS_CHECK_NEAR(RHS(2), 82.09644262, 1e-7);
            KRATOS_CHECK_NEAR(RHS(3),0.9666158854, 1e-7);
            KRATOS_CHECK_NEAR(RHS(4), -38.30464038, 1e-7);
            KRATOS_CHECK_NEAR(RHS(5), -26.19611063, 1e-7);
            KRATOS_CHECK_NEAR(RHS(6), -689.2139932, 1e-7);
            KRATOS_CHECK_NEAR(RHS(7), -0.04985560165, 1e-7);
            KRATOS_CHECK_NEAR(RHS(8), -23.383483, 1e-7);
            KRATOS_CHECK_NEAR(RHS(9), -49.63973437, 1e-7);
            KRATOS_CHECK_NEAR(RHS(10), -769.8621105, 1e-7);
            KRATOS_CHECK_NEAR(RHS(11), -0.05887685862, 1e-7);
            KRATOS_CHECK_NEAR(RHS(12), -27.22865372, 1e-7);
            KRATOS_CHECK_NEAR(RHS(13), -35.47543691, 1e-7);
            KRATOS_CHECK_NEAR(RHS(14), -871.5305579, 1e-7);
            KRATOS_CHECK_NEAR(RHS(15), -0.9528834251, 1e-7);

        }

        /** Checks the TwoFluidNavierStokesCN2D3N element in a hydrostatic case.
         *  Checks the computation of the RHS
         */
        KRATOS_TEST_CASE_IN_SUITE(ElementTwoFluidNavierStokesCN2D3NHydrostatic, FluidDynamicsApplicationFastSuite)
        {
            ...
            modelPart.CreateNewElement("TwoFluidNavierStokesCN2D3N", 1, elemNodes1, pElemProp);
            ...
            KRATOS_CHECK_NEAR(RHS(1), -12.49438793, 1e-7); 	// U_y at node 1
            KRATOS_CHECK_NEAR(RHS(2), -0.8241127784, 1e-7);		// P   at node 1

            KRATOS_CHECK_NEAR(RHS(3), 7.49438793, 1e-7);		// U_x at node 2
            KRATOS_CHECK_NEAR(RHS(4), 3.74438793, 1e-7);		// U_y at node 2
            KRATOS_CHECK_NEAR(RHS(5), 0.6182185664, 1e-7);		// P   at node 2

            KRATOS_CHECK_NEAR(RHS(6), -7.49438793, 1e-7);		// U_x at node 3
            KRATOS_CHECK_NEAR(RHS(7), -3.75, 1e-7);		// U_y at node 3
            KRATOS_CHECK_NEAR(RHS(8), 0.205894212, 1e-7);		// P   at node 3
        }


        KRATOS_TEST_CASE_IN_SUITE(ElementTwoFluidNavierStokesDarcyCN3D4N, FluidDynamicsApplicationFastSuite)
        {
            Model current_model;
            ModelPart& modelPart = current_model.CreateModelPart("Main");
            modelPart.SetBufferSize(2);
        ...
        KRATOS_TEST_CASE_IN_SUITE(ElementTwoFluidNavierStokesCN2D3NNavierSlip, FluidDynamicsApplicationFastSuite){
            ...
            modelPart.CreateNewElement("TwoFluidNavierStokesCN2D3N", 1, elemNodes1, pElemProp);
            modelPart.CreateNewElement("TwoFluidNavierStokesCN2D3N", 2, elemNodes2, pElemProp);
            modelPart.CreateNewElement("TwoFluidNavierStokesCN2D3N", 3, elemNodes3, pElemProp);
        ...
        KRATOS_TEST_CASE_IN_SUITE(ElementTwoFluidNavierStokesCN3D4NNavierSlip, FluidDynamicsApplicationFastSuite){
            ...
            modelPart.CreateNewElement("TwoFluidNavierStokesCN3D4N", 1, elemNodes1, pElemProp);
            modelPart.CreateNewElement("TwoFluidNavierStokesCN3D4N", 2, elemNodes2, pElemProp);
            modelPart.CreateNewElement("TwoFluidNavierStokesCN3D4N", 3, elemNodes3, pElemProp);
        ...
        // /** Checks the TwoFluidNavierStokesCN2D3N element with a source term in mass conservation equation
        //  * Checks the LHS and RHS for a cut element
        //  */

        KRATOS_TEST_CASE_IN_SUITE(ElementTwoFluidNavierStokesCN2D3NError, FluidDynamicsApplicationFastSuite)
        {
             Model current_model;
            ModelPart& modelPart = current_model.CreateModelPart("Main");
            modelPart.SetBufferSize(2);
        ...
        // /** Checks the TwoFluidNavierStokesCN3D4N element with a source term in mass conservation equation
        //  * Checks the LHS and RHS for a cut element
        //  */
