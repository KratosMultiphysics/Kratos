...
from KratosMultiphysics.FluidDynamicsApplication.finite_difference_sensitivity_utilities import RemoveH5Files
...
class AdjointVMSSensitivity2D(KratosUnittest.TestCase):
    ...
    def testOneElement(self):
        with KratosUnittest.WorkFolderScope('.', __file__):
            ...
            adjoint_sensitivities = ComputeAdjointSensitivity(node_ids, adjoint_parameters)
