...
from compute_aerodynamic_coefficients_process_test import ComputeAerodynamicCoefficientsProcessTest
...
def AssembleTestSuites():
    ...
    smallSuite.addTests(KratosUnittest.TestLoader().loadTestsFromTestCases([ComputeAerodynamicCoefficientsProcessTest]))
