...
def AssambleTestSuites():
    ...
    smallSuite.addTest(FluidElementTest('testCavityQSASGS'))
    smallSuite.addTest(FluidElementTest('testCavityQSOSS'))
    smallSuite.addTest(FluidElementTest('testCavityDASGS'))
    smallSuite.addTest(FluidElementTest('testCavityDOSS'))
