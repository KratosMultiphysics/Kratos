...
from mass_conservation_check_process_test import MassConservationUtility
...
def AssembleTestSuites():
    ...
    smallSuite.addTests(KratosUnittest.TestLoader().loadTestsFromTestCases([MassConservationUtility]))
