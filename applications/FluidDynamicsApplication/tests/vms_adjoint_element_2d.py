...
class VMSAdjointElement2D(UnitTest.TestCase):
...
if __name__ == '__main__':
    test_case = VMSAdjointElement2D()
    test_case.setUp()
    test_case.testCalculateSecondDerivativesLHS()
    test_case.testCalculateFirstDerivativesLHS1()
    test_case.testCalculateFirstDerivativesLHS2()
    test_case.testCalculateSensitivityMatrix()
    test_case.tearDown()
