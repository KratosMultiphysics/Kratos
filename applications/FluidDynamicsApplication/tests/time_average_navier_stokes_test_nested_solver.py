...
class TimeAveragedNavierStokesTest(UnitTest.TestCase):
    ...
    def testCylinderFlow2DWater(self):
        ...
        self.settings = "cylinder_2d_water_nested_solver.json"
    ...
    def setUpProblem(self):
        ...
        ## Initialize Monolithic Solver
        self.solver.InitializeSolutionFromMonolithicSolver()
    ...
    def runTest(self):
        ...
        while(time <= end_time):
            ...
            # if step== 10:
            #     self.InitializeSolutionFromMonolithicSolver()
