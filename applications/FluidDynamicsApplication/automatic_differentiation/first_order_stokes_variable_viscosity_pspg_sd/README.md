# Stokes Formulation to be used as first-order Elements, via PSPG stabilizaton and SD momentum equation form 
...
Specifically, it uses the form in Equations 6 and 7 of the paper. That means that the momentum equation in its Stress-Divergence (SD) form and the stabilization used is the Pressure-Stabilised Petrov–Galerkin(PSPG) method.
