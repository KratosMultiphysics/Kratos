...
from KratosMultiphysics.FluidDynamicsApplication.compressible_navier_stokes.src import generate_convective_flux
from KratosMultiphysics.FluidDynamicsApplication.compressible_navier_stokes.src import generate_diffusive_flux
from KratosMultiphysics.FluidDynamicsApplication.compressible_navier_stokes.src import generate_source_term
from KratosMultiphysics.FluidDynamicsApplication.compressible_navier_stokes.src import generate_stabilization_matrix

from KratosMultiphysics.FluidDynamicsApplication.compressible_navier_stokes.src \
