...
int ShiftedBoundaryWallCondition<TDim,TNumNodes,TWallModel...>::Check(const ProcessInfo& rCurrentProcessInfo) const
{
    KRATOS_TRY;
...
template class ShiftedBoundaryWallCondition<2,2>;
template class ShiftedBoundaryWallCondition<3,3>;
