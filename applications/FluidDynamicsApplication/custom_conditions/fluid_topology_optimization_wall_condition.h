...
class KRATOS_API(FLUID_DYNAMICS_APPLICATION) FluidTopologyOptimizationWallCondition : public Condition
{
public:
    ///@name Type Definitions
    ///@{

    /// Pointer definition of FluidTopologyOptimizationWallCondition
    KRATOS_CLASS_INTRUSIVE_POINTER_DEFINITION(FluidTopologyOptimizationWallCondition);
    ...
    /** Admits an Id as a parameter.
      ...
      */
    FluidTopologyOptimizationWallCondition(IndexType NewId = 0):Condition(NewId)
    {
    }
     ...
     */
    FluidTopologyOptimizationWallCondition(IndexType NewId, const NodesArrayType& ThisNodes):
     ...
     */
    FluidTopologyOptimizationWallCondition(IndexType NewId, GeometryType::Pointer pGeometry):
     ...
     */
    FluidTopologyOptimizationWallCondition(IndexType NewId, GeometryType::Pointer pGeometry, PropertiesType::Pointer pProperties):
        Condition(NewId,pGeometry,pProperties)
    {
    }

    /// Copy constructor.
    FluidTopologyOptimizationWallCondition(FluidTopologyOptimizationWallCondition const& rOther):
        Condition(rOther)
    {
    }

    /// Destructor.
    ~FluidTopologyOptimizationWallCondition() override {}
    ...
    /// Assignment operator
    FluidTopologyOptimizationWallCondition & operator=(FluidTopologyOptimizationWallCondition const& rOther)
    {
    ...
    /// Create a new FluidTopologyOptimizationWallCondition object.
    /**
      @param NewId Index of the new condition
      @param ThisNodes An array containing the nodes of the new condition
      @param pProperties Pointer to the element's properties
    ...
    {
        return Kratos::make_intrusive<FluidTopologyOptimizationWallCondition>(NewId, GetGeometry().Create(ThisNodes), pProperties);
    }
    ...
    {
        return Kratos::make_intrusive< FluidTopologyOptimizationWallCondition >(NewId, pGeom, pProperties);
    }
    ...
    std::string Info() const override
    {
        ...
        buffer << "FluidTopologyOptimizationWallCondition" << TDim << "D";
        return buffer.str();
    }
    ...
    {
        rOStream << "FluidTopologyOptimizationWallCondition";
    }
...
protected:
     ...
     * database within the EXTERNAL_PRESSURE variable for NS and EXTERNAL_PRESSURE_ADJ variable for ADJ_NS.
    ...
    void ComputeRHSNeumannContributionAdjoint(
        array_1d<double,LocalSize>& rRHS,
        const ConditionDataStruct& data);
    ...
    void ComputeRHSOutletInflowContribution(
        ...
        const ConditionDataStruct& rData,
        const ProcessInfo& rProcessInfo);
    void ComputeRHSOutletInflowContributionAdjoint(
        array_1d<double, LocalSize>& rRHS,
        const ConditionDataStruct& rData,
        const ProcessInfo& rProcessInfo);
...
private:
    ...
    void CalculateGaussPointSlipTangentialCorrectionRHSContribution(
        ...
        const ConditionDataStruct& rDataStruct);
    void CalculateGaussPointSlipTangentialCorrectionRHSContributionAdjoint(
        array_1d<double,LocalSize>& rRightHandSideVector,
        const ConditionDataStruct& rDataStruct);
...
}; // Class FluidTopologyOptimizationWallCondition
...
template< unsigned int TDim, unsigned int TNumNodes, class TWallModel >
inline std::istream& operator >> (std::istream& rIStream, FluidTopologyOptimizationWallCondition<TDim,TNumNodes,TWallModel>& rThis)
{
    return rIStream;
}
...
template< unsigned int TDim, unsigned int TNumNodes, class TWallModel >
inline std::ostream& operator << (std::ostream& rOStream, const FluidTopologyOptimizationWallCondition<TDim,TNumNodes,TWallModel>& rThis)
{
