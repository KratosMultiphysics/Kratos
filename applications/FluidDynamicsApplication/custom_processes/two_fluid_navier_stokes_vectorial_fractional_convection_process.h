...
namespace Kratos
{
    ...
    class TwoFluidNavierStokesVectorialFractionalConvectionProcess
        : public Process
    {
    private:
        ///@name Type Definitions
    ...
    public:
        ...
        /// Pointer definition of TwoFluidNavierStokesVectorialFractionalConvectionProcess
        KRATOS_CLASS_POINTER_DEFINITION(TwoFluidNavierStokesVectorialFractionalConvectionProcess);
        ///@}
        ///@name Life Cycle
        ///@{
        ...
        /// Copy constructor.
        TwoFluidNavierStokesVectorialFractionalConvectionProcess(TwoFluidNavierStokesVectorialFractionalConvectionProcess const &rOther) = delete;

        /// Destructor.
        ~TwoFluidNavierStokesVectorialFractionalConvectionProcess() override
        {
        ...
        {
            return "TwoFluidNavierStokesVectorialFractionalConvectionProcess";
        }

        /// Print information about this object.
        void PrintInfo(std::ostream &rOStream) const override
        {
            rOStream << "TwoFluidNavierStokesVectorialFractionalConvectionProcess";
        }
    ...
    private:
        ...
        /// Assignment operator.
        TwoFluidNavierStokesVectorialFractionalConvectionProcess &operator=(TwoFluidNavierStokesVectorialFractionalConvectionProcess const &rOther);
    ...
    inline std::istream &operator>>(
        ...
        TwoFluidNavierStokesVectorialFractionalConvectionProcess<TDim, TSparseSpace, TDenseSpace, TLinearSolver> &rThis);

    /// Output stream function
    template <unsigned int TDim, class TSparseSpace, class TDenseSpace, class TLinearSolver>
    inline std::ostream &operator<<(
        std::ostream &rOStream,
        const TwoFluidNavierStokesVectorialFractionalConvectionProcess<TDim, TSparseSpace, TDenseSpace, TLinearSolver> &rThis)
    {
