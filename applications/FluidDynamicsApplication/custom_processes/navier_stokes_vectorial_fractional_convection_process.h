...
namespace Kratos
{
    ...
    public:
        ...
        /// Pointer definition of NavierStokesVectorialFractionalConvectionProcess
        KRATOS_CLASS_POINTER_DEFINITION(NavierStokesVectorialFractionalConvectionProcess);
        ///@}
        ///@name Life Cycle
        ///@{
         ...
         */
        NavierStokesVectorialFractionalConvectionProcess(
            Model &rModel,
        ...
        /// Copy constructor.
        NavierStokesVectorialFractionalConvectionProcess(NavierStokesVectorialFractionalConvectionProcess const &rOther) = delete;

        /// Destructor.
        ~NavierStokesVectorialFractionalConvectionProcess() override
        {
        ...
        {
            return "NavierStokesVectorialFractionalConvectionProcess";
        }

        /// Print information about this object.
        void PrintInfo(std::ostream &rOStream) const override
        {
            rOStream << "NavierStokesVectorialFractionalConvectionProcess";
        }
    ...
    private:
        ...
        /// Assignment operator.
        NavierStokesVectorialFractionalConvectionProcess &operator=(NavierStokesVectorialFractionalConvectionProcess const &rOther);
    ...
    inline std::istream &operator>>(
        ...
        NavierStokesVectorialFractionalConvectionProcess<TDim, TSparseSpace, TDenseSpace, TLinearSolver> &rThis);

    /// Output stream function
    template <unsigned int TDim, class TSparseSpace, class TDenseSpace, class TLinearSolver>
    inline std::ostream &operator<<(
        std::ostream &rOStream,
        const NavierStokesVectorialFractionalConvectionProcess<TDim, TSparseSpace, TDenseSpace, TLinearSolver> &rThis)
    {
