...
#ifndef KRATOS_MASS_CONSERVATION_CORRECTION_H
#define KRATOS_MASS_CONSERVATION_CORRECTION_H
...
/// Utility to correct the lost mass based on the curvature

class KRATOS_API(FLUID_DYNAMICS_APPLICATION) MassConservationCorrection : public Process
{
public:
    ///@name Type Definitions
    ///@{
     ...
     */
    MassConservationCorrection(
        ModelPart& rModelPart,
        const bool WriteToLogFile,
        const std::string LogFileName);

    /// Destructor.
    ~MassConservationCorrection() override {}
    ...
    std::string Info() const override
    {
        ...
        buffer << "MassConservationCorrection";
        return buffer.str();
    }

    /// Print information about this object.
    void PrintInfo(std::ostream& rOStream) const override {rOStream << "MassConservationCorrection";}
...
#endif // KRATOS_MASS_CONSERVATION_CORRECTION_H
