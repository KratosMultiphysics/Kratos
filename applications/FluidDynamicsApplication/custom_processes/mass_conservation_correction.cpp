...
#include "mass_conservation_correction.h"
...
/// constructor
MassConservationCorrection::MassConservationCorrection(
...
std::string MassConservationCorrection::Initialize(){
...
std::string MassConservationCorrection::ExecuteInTimeStep(){
...
void MassConservationCorrection::ComputeVolumesAndInterface( double& positiveVolume, double& negativeVolume, double& interfaceArea ){
...
double MassConservationCorrection::ComputeFlowOverBoundary( const Kratos::Flags boundaryFlag ){
...
void MassConservationCorrection::CalculateNormal2D(array_1d<double,3>& An, const Geometry<Node<3> >& pGeometry){
...
void MassConservationCorrection::CalculateNormal3D(array_1d<double,3>& An, const Geometry<Node<3> >& pGeometry){
...
Triangle2D3<Node<3>>::Pointer MassConservationCorrection::GenerateAuxTriangle( const Geometry<Node<3> >& rGeom ){
...
void MassConservationCorrection::GenerateAuxLine( const Geometry<Node<3> >& rGeom,
