...
Artificial compressiblity: If set to true, the time derivative of the density is introduced
                           ...
                           dp/drho=c^2 (being c the sound velocity). These assumptions add some extra
                           ...
                           of "c", meaning that if this value is large enough the artificial 
			   compressibility terms vanish.
