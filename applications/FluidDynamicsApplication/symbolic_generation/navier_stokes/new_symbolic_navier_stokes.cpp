...
const double clhs21 =             N[0]*clhs10 + clhs11*clhs12 + clhs14*clhs17 + clhs14*clhs20;
...
const double clhs30 =             N[0]*clhs4;
const double clhs31 =             clhs10*clhs15;
const double clhs32 =             -N[0] + clhs15*clhs18*clhs30 + clhs29 + clhs31;
const double clhs33 =             C(0,0)*DN(1,0) + C(0,2)*DN(1,1);
const double clhs34 =             C(0,2)*DN(1,0);
const double clhs35 =             C(2,2)*DN(1,1) + clhs34;
const double clhs36 =             N[1]*clhs4;
const double clhs37 =             clhs13*clhs36;
const double clhs38 =             DN(1,0)*clhs25 + clhs37;
const double clhs39 =             DN(1,0)*clhs5 + DN(1,1)*clhs6;
const double clhs40 =             N[1]*bdf0;
const double clhs41 =             clhs39 + clhs40;
const double clhs42 =             clhs17*clhs41 + clhs20*clhs41 + clhs30*clhs39;
const double clhs43 =             C(0,1)*DN(1,1) + clhs34;
const double clhs44 =             C(1,2)*DN(1,1);
const double clhs45 =             C(2,2)*DN(1,0) + clhs44;
const double clhs46 =             DN(1,1)*clhs25;
const double clhs47 =             DN(0,0)*N[1];
const double clhs48 =             clhs27*clhs40;
const double clhs49 =             DN(1,0)*N[0];
const double clhs50 =             clhs15*clhs4;
const double clhs51 =             clhs18*clhs50;
...
const double clhs61 =             clhs17*clhs60 + clhs20*clhs60 + clhs30*clhs58;
...
const double clhs85 =             clhs14*clhs50;
const double clhs86 =             N[0] + clhs85;
const double clhs87 =             bdf0*clhs27;
const double clhs88 =             clhs41*clhs50;
...
const double clhs92 =             clhs50*clhs60;
const double clhs93 =             DN(2,0)*clhs89 + DN(2,1)*clhs90 + N[2]*clhs28;
const double clhs94 =             clhs16*clhs39;
const double clhs95 =             N[1]*clhs19;
const double clhs96 =             N[1]*clhs10 + clhs14*clhs94 + clhs14*clhs95;
const double clhs97 =             DN(1,0)*clhs8;
const double clhs98 =             clhs39*clhs50;
const double clhs99 =             pow(DN(1,0), 2);
const double clhs100 =             pow(N[1], 2);
const double clhs101 =             clhs100*clhs12 + clhs36*clhs39 + clhs41*clhs94 + clhs41*clhs95;
const double clhs102 =             DN(1,1)*clhs97;
const double clhs103 =             clhs48*clhs8;
const double clhs104 =             N[1]*clhs51 - N[1] + clhs103 + clhs98;
const double clhs105 =             clhs40*clhs55;
const double clhs106 =             DN(2,0)*clhs97 + clhs105;
const double clhs107 =             clhs36*clhs58 + clhs60*clhs94 + clhs60*clhs95;
...
const double clhs118 =             DN(1,0)*DN(2,0)*clhs15 + DN(1,1)*DN(2,1)*clhs15 + N[2]*clhs48;
const double clhs119 =             clhs16*clhs58;
const double clhs120 =             N[2]*clhs19;
const double clhs121 =             N[2]*clhs10 + clhs119*clhs14 + clhs120*clhs14;
const double clhs122 =             DN(2,0)*clhs8;
const double clhs123 =             clhs50*clhs58;
const double clhs124 =             clhs119*clhs41 + clhs120*clhs41 + clhs39*clhs55;
...
const double clhs129 =             N[2]*clhs51 - N[2] + clhs123 + clhs67*clhs8;
...
const double clhs131 =             N[2] + clhs92;
            ...
            lhs(0,3)=DN(0,0)*clhs33 + DN(0,1)*clhs35 + clhs38 + clhs42;
            lhs(0,4)=DN(0,0)*clhs43 + DN(0,1)*clhs45 + clhs46;
            lhs(0,5)=DN(1,0)*clhs31 + clhs25*clhs48 - clhs47 + clhs49*clhs51;
            lhs(0,6)=DN(0,0)*clhs52 + DN(0,1)*clhs54 + clhs57 + clhs61;
            lhs(0,7)=DN(0,0)*clhs62 + DN(0,1)*clhs64 + clhs65;
            lhs(0,8)=DN(2,0)*clhs31 + clhs25*clhs67 + clhs51*clhs68 - clhs66;
            lhs(1,0)=DN(0,0)*clhs2 + DN(0,1)*clhs69 + clhs26;
            lhs(1,1)=DN(0,0)*clhs24 + DN(0,1)*clhs70 + clhs21 + clhs71*clhs8;
            lhs(1,2)=DN(0,1)*clhs32;
            lhs(1,3)=DN(0,0)*clhs35 + DN(0,1)*clhs72 + clhs74;
            lhs(1,4)=DN(0,0)*clhs45 + DN(0,1)*clhs75 + clhs42 + clhs76;
            lhs(1,5)=DN(1,1)*clhs31 + clhs48*clhs73 + clhs51*clhs78 - clhs77;
            lhs(1,6)=DN(0,0)*clhs54 + DN(0,1)*clhs79 + clhs80;
            lhs(1,7)=DN(0,0)*clhs64 + DN(0,1)*clhs81 + clhs61 + clhs82;
            lhs(1,8)=DN(2,1)*clhs31 + clhs51*clhs84 + clhs67*clhs73 - clhs83;
            lhs(2,0)=DN(0,0)*clhs86;
            lhs(2,1)=DN(0,1)*clhs86;
            lhs(2,2)=clhs11*clhs87 + clhs15*clhs3 + clhs15*clhs71;
            lhs(2,3)=DN(0,0)*clhs88 + clhs49;
            lhs(2,4)=DN(0,1)*clhs88 + clhs78;
            lhs(2,5)=clhs91;
            lhs(2,6)=DN(0,0)*clhs92 + clhs68;
            lhs(2,7)=DN(0,1)*clhs92 + clhs84;
            lhs(2,8)=clhs93;
            lhs(3,0)=DN(1,0)*clhs0 + DN(1,1)*clhs2 + clhs38 + clhs96;
            lhs(3,1)=DN(1,0)*clhs22 + DN(1,1)*clhs24 + clhs74;
            lhs(3,2)=DN(0,0)*clhs98 + clhs28*clhs97 + clhs47*clhs51 - clhs49;
            lhs(3,3)=DN(1,0)*clhs33 + DN(1,1)*clhs35 + clhs101 + clhs8*clhs99;
            lhs(3,4)=DN(1,0)*clhs43 + DN(1,1)*clhs45 + clhs102;
            ...
            lhs(4,0)=DN(1,0)*clhs2 + DN(1,1)*clhs69 + clhs46;
            lhs(4,1)=DN(1,0)*clhs24 + DN(1,1)*clhs70 + clhs76 + clhs96;
            lhs(4,2)=DN(0,1)*clhs98 + clhs111*clhs28 + clhs51*clhs77 - clhs78;
            lhs(4,3)=DN(1,0)*clhs35 + DN(1,1)*clhs72 + clhs102;
            lhs(4,4)=DN(1,0)*clhs45 + DN(1,1)*clhs75 + clhs101 + clhs112*clhs8;
            ...
            lhs(6,3)=DN(2,0)*clhs33 + DN(2,1)*clhs35 + clhs106 + clhs124;
            lhs(6,4)=DN(2,0)*clhs43 + DN(2,1)*clhs45 + clhs113;
            lhs(6,5)=DN(1,0)*clhs123 + clhs109*clhs51 - clhs110 + clhs122*clhs48;
            ...
            lhs(7,3)=DN(2,0)*clhs35 + DN(2,1)*clhs72 + clhs108;
            lhs(7,4)=DN(2,0)*clhs45 + DN(2,1)*clhs75 + clhs114 + clhs124;
...
const double clhs13 =             clhs12*clhs6;
...
const double clhs24 =             N[0]*clhs13 + clhs14*clhs15 + clhs17*clhs20 + clhs17*clhs23;
...
const double clhs42 =             N[0]*clhs6;
const double clhs43 =             clhs13*clhs18;
const double clhs44 =             -N[0] + clhs18*clhs21*clhs42 + clhs41 + clhs43;
...
const double clhs50 =             N[1]*clhs6;
const double clhs51 =             clhs16*clhs50;
const double clhs52 =             DN(1,0)*clhs31 + clhs51;
const double clhs53 =             DN(1,0)*clhs7 + DN(1,1)*clhs8 + DN(1,2)*clhs9;
const double clhs54 =             N[1]*bdf0;
const double clhs55 =             clhs53 + clhs54;
const double clhs56 =             clhs20*clhs55 + clhs23*clhs55 + clhs42*clhs53;
...
const double clhs63 =             DN(1,1)*clhs31;
...
const double clhs69 =             DN(1,2)*clhs31;
const double clhs70 =             DN(0,0)*N[1];
const double clhs71 =             clhs39*clhs54;
const double clhs72 =             DN(1,0)*N[0];
const double clhs73 =             clhs18*clhs6;
const double clhs74 =             clhs21*clhs73;
...
const double clhs86 =             clhs20*clhs85 + clhs23*clhs85 + clhs42*clhs83;
...
const double clhs114 =             clhs111*clhs42 + clhs113*clhs20 + clhs113*clhs23;
...
const double clhs142 =             C(0,1)*DN(1,0) + C(1,5)*DN(1,2) + clhs58;
const double clhs143 =             C(0,4)*DN(1,0) + clhs61 + clhs65;
...
const double clhs149 =             clhs51 + clhs56;
...
const double clhs188 =             C(0,2)*DN(1,0) + C(2,3)*DN(1,1) + clhs67;
...
const double clhs213 =             clhs17*clhs73;
const double clhs214 =             N[0] + clhs213;
const double clhs215 =             bdf0*clhs39;
const double clhs216 =             clhs55*clhs73;
...
const double clhs221 =             clhs73*clhs85;
const double clhs222 =             DN(2,0)*clhs217 + DN(2,1)*clhs218 + DN(2,2)*clhs219 + N[2]*clhs40;
const double clhs223 =             clhs113*clhs73;
const double clhs224 =             DN(3,0)*clhs217 + DN(3,1)*clhs218 + DN(3,2)*clhs219 + N[3]*clhs40;
const double clhs225 =             clhs19*clhs53;
const double clhs226 =             N[1]*clhs22;
const double clhs227 =             N[1]*clhs13 + clhs17*clhs225 + clhs17*clhs226;
const double clhs228 =             DN(1,0)*clhs11;
const double clhs229 =             clhs53*clhs73;
const double clhs230 =             pow(DN(1,0), 2);
const double clhs231 =             pow(N[1], 2);
const double clhs232 =             clhs15*clhs231 + clhs225*clhs55 + clhs226*clhs55 + clhs50*clhs53;
const double clhs233 =             DN(1,1)*clhs228;
const double clhs234 =             DN(1,2)*clhs228;
const double clhs235 =             clhs11*clhs71;
const double clhs236 =             N[1]*clhs74 - N[1] + clhs229 + clhs235;
const double clhs237 =             clhs54*clhs80;
const double clhs238 =             DN(2,0)*clhs228 + clhs237;
const double clhs239 =             clhs225*clhs85 + clhs226*clhs85 + clhs50*clhs83;
...
const double clhs244 =             clhs108*clhs54;
const double clhs245 =             DN(3,0)*clhs228 + clhs244;
const double clhs246 =             clhs111*clhs50 + clhs113*clhs225 + clhs113*clhs226;
...
const double clhs251 =             clhs227 + clhs51;
...
const double clhs283 =             DN(2,0)*clhs280 + DN(2,1)*clhs281 + DN(2,2)*clhs282 + N[2]*clhs71;
const double clhs284 =             DN(3,0)*clhs280 + DN(3,1)*clhs281 + DN(3,2)*clhs282 + N[3]*clhs71;
const double clhs285 =             clhs19*clhs83;
const double clhs286 =             N[2]*clhs22;
const double clhs287 =             N[2]*clhs13 + clhs17*clhs285 + clhs17*clhs286;
const double clhs288 =             DN(2,0)*clhs11;
const double clhs289 =             clhs73*clhs83;
const double clhs290 =             clhs285*clhs55 + clhs286*clhs55 + clhs53*clhs80;
...
const double clhs297 =             N[2]*clhs74 - N[2] + clhs289 + clhs296;
...
const double clhs327 =             N[3]*clhs13 + clhs17*clhs325 + clhs17*clhs326;
const double clhs328 =             DN(3,0)*clhs11;
const double clhs329 =             clhs111*clhs73;
const double clhs330 =             clhs108*clhs53 + clhs325*clhs55 + clhs326*clhs55;
...
const double clhs337 =             N[3]*clhs74 - N[3] + clhs11*clhs129 + clhs329;
...
const double clhs345 =             N[3] + clhs223;
            ...
            lhs(0,4)=DN(0,0)*clhs45 + DN(0,1)*clhs47 + DN(0,2)*clhs49 + clhs52 + clhs56;
            lhs(0,5)=DN(0,0)*clhs57 + DN(0,1)*clhs59 + DN(0,2)*clhs62 + clhs63;
            lhs(0,6)=DN(0,0)*clhs64 + DN(0,1)*clhs66 + DN(0,2)*clhs68 + clhs69;
            lhs(0,7)=DN(1,0)*clhs43 + clhs31*clhs71 - clhs70 + clhs72*clhs74;
            ...
            lhs(0,11)=DN(2,0)*clhs43 - clhs100 + clhs101*clhs31 + clhs102*clhs74;
            ...
            lhs(0,15)=DN(3,0)*clhs43 - clhs128 + clhs129*clhs31 + clhs130*clhs74;
            ...
            lhs(1,4)=DN(0,0)*clhs47 + DN(0,1)*clhs142 + DN(0,2)*clhs143 + clhs144;
            lhs(1,5)=DN(0,0)*clhs59 + DN(0,1)*clhs145 + DN(0,2)*clhs147 + clhs148 + clhs149;
            lhs(1,6)=DN(0,0)*clhs66 + DN(0,1)*clhs150 + DN(0,2)*clhs152 + clhs153;
            lhs(1,7)=DN(1,1)*clhs43 + clhs140*clhs71 - clhs154 + clhs155*clhs74;
            ...
            lhs(1,11)=DN(2,1)*clhs43 + clhs101*clhs140 - clhs168 + clhs169*clhs74;
            ...
            lhs(1,15)=DN(3,1)*clhs43 + clhs129*clhs140 - clhs182 + clhs183*clhs74;
            ...
            lhs(2,4)=DN(0,0)*clhs49 + DN(0,1)*clhs143 + DN(0,2)*clhs188 + clhs190;
            lhs(2,5)=DN(0,0)*clhs62 + DN(0,1)*clhs147 + DN(0,2)*clhs191 + clhs192;
            lhs(2,6)=DN(0,0)*clhs68 + DN(0,1)*clhs152 + DN(0,2)*clhs193 + clhs149 + clhs194;
            lhs(2,7)=DN(1,2)*clhs43 + clhs189*clhs71 - clhs195 + clhs196*clhs74;
            ...
            lhs(2,11)=DN(2,2)*clhs43 + clhs101*clhs189 - clhs203 + clhs204*clhs74;
            ...
            lhs(2,15)=DN(3,2)*clhs43 + clhs129*clhs189 - clhs211 + clhs212*clhs74;
            ...
            lhs(3,15)=clhs224;
            lhs(4,0)=DN(1,0)*clhs0 + DN(1,1)*clhs2 + DN(1,2)*clhs4 + clhs227 + clhs52;
            lhs(4,1)=DN(1,0)*clhs25 + DN(1,1)*clhs27 + DN(1,2)*clhs30 + clhs144;
            lhs(4,2)=DN(1,0)*clhs33 + DN(1,1)*clhs35 + DN(1,2)*clhs37 + clhs190;
            lhs(4,3)=DN(0,0)*clhs229 + clhs228*clhs40 + clhs70*clhs74 - clhs72;
            lhs(4,4)=DN(1,0)*clhs45 + DN(1,1)*clhs47 + DN(1,2)*clhs49 + clhs11*clhs230 + clhs232;
            lhs(4,5)=DN(1,0)*clhs57 + DN(1,1)*clhs59 + DN(1,2)*clhs62 + clhs233;
            lhs(4,6)=DN(1,0)*clhs64 + DN(1,1)*clhs66 + DN(1,2)*clhs68 + clhs234;
            ...
            lhs(5,0)=DN(1,0)*clhs2 + DN(1,1)*clhs131 + DN(1,2)*clhs132 + clhs63;
            ...
            lhs(5,4)=DN(1,0)*clhs47 + DN(1,1)*clhs142 + DN(1,2)*clhs143 + clhs233;
            lhs(5,5)=DN(1,0)*clhs59 + DN(1,1)*clhs145 + DN(1,2)*clhs147 + clhs11*clhs253 + clhs232;
            lhs(5,6)=DN(1,0)*clhs66 + DN(1,1)*clhs150 + DN(1,2)*clhs152 + clhs254;
            ...
            lhs(6,0)=DN(1,0)*clhs4 + DN(1,1)*clhs132 + DN(1,2)*clhs184 + clhs69;
            ...
            lhs(6,4)=DN(1,0)*clhs49 + DN(1,1)*clhs143 + DN(1,2)*clhs188 + clhs234;
            lhs(6,5)=DN(1,0)*clhs62 + DN(1,1)*clhs147 + DN(1,2)*clhs191 + clhs254;
            lhs(6,6)=DN(1,0)*clhs68 + DN(1,1)*clhs152 + DN(1,2)*clhs193 + clhs11*clhs268 + clhs232;
            ...
            lhs(8,4)=DN(2,0)*clhs45 + DN(2,1)*clhs47 + DN(2,2)*clhs49 + clhs238 + clhs290;
            lhs(8,5)=DN(2,0)*clhs57 + DN(2,1)*clhs59 + DN(2,2)*clhs62 + clhs255;
            lhs(8,6)=DN(2,0)*clhs64 + DN(2,1)*clhs66 + DN(2,2)*clhs68 + clhs269;
            lhs(8,7)=DN(1,0)*clhs289 + clhs242*clhs74 - clhs243 + clhs288*clhs71;
            ...
            lhs(9,4)=DN(2,0)*clhs47 + DN(2,1)*clhs142 + DN(2,2)*clhs143 + clhs240;
            lhs(9,5)=DN(2,0)*clhs59 + DN(2,1)*clhs145 + DN(2,2)*clhs147 + clhs256 + clhs307;
            lhs(9,6)=DN(2,0)*clhs66 + DN(2,1)*clhs150 + DN(2,2)*clhs152 + clhs270;
            lhs(9,7)=DN(1,1)*clhs289 + clhs259*clhs74 - clhs260 + clhs306*clhs71;
            ...
            lhs(10,4)=DN(2,0)*clhs49 + DN(2,1)*clhs143 + DN(2,2)*clhs188 + clhs241;
            lhs(10,5)=DN(2,0)*clhs62 + DN(2,1)*clhs147 + DN(2,2)*clhs191 + clhs258;
            lhs(10,6)=DN(2,0)*clhs68 + DN(2,1)*clhs152 + DN(2,2)*clhs193 + clhs271 + clhs307;
            lhs(10,7)=DN(1,2)*clhs289 + clhs272*clhs74 - clhs273 + clhs316*clhs71;
            ...
            lhs(12,4)=DN(3,0)*clhs45 + DN(3,1)*clhs47 + DN(3,2)*clhs49 + clhs245 + clhs330;
            lhs(12,5)=DN(3,0)*clhs57 + DN(3,1)*clhs59 + DN(3,2)*clhs62 + clhs261;
            lhs(12,6)=DN(3,0)*clhs64 + DN(3,1)*clhs66 + DN(3,2)*clhs68 + clhs274;
            lhs(12,7)=DN(1,0)*clhs329 + clhs249*clhs74 - clhs250 + clhs328*clhs71;
            ...
            lhs(13,4)=DN(3,0)*clhs47 + DN(3,1)*clhs142 + DN(3,2)*clhs143 + clhs247;
            lhs(13,5)=DN(3,0)*clhs59 + DN(3,1)*clhs145 + DN(3,2)*clhs147 + clhs262 + clhs340;
            lhs(13,6)=DN(3,0)*clhs66 + DN(3,1)*clhs150 + DN(3,2)*clhs152 + clhs275;
            lhs(13,7)=DN(1,1)*clhs329 + clhs265*clhs74 - clhs266 + clhs339*clhs71;
            ...
            lhs(14,4)=DN(3,0)*clhs49 + DN(3,1)*clhs143 + DN(3,2)*clhs188 + clhs248;
            lhs(14,5)=DN(3,0)*clhs62 + DN(3,1)*clhs147 + DN(3,2)*clhs191 + clhs264;
            lhs(14,6)=DN(3,0)*clhs68 + DN(3,1)*clhs152 + DN(3,2)*clhs193 + clhs276 + clhs340;
