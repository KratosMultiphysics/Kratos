...
void KratosFluidDynamicsApplication::Register() {
    ...
    KRATOS_REGISTER_VARIABLE(APPLY_NITSCHE_BOUNDARY_IMPOSITION)
    KRATOS_REGISTER_VARIABLE(APPLY_EMBEDDED_CONSTRAINTS)
    KRATOS_REGISTER_VARIABLE(EMBEDDED_CONSTRAINT_MASTERS)
    KRATOS_REGISTER_VARIABLE(EMBEDDED_CONSTRAINT_MASTER_WEIGHTS)
