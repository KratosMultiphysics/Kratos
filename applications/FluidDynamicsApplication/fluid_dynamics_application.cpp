...
void KratosFluidDynamicsApplication::Register() {
    ...
    KRATOS_REGISTER_VARIABLE( TOP_OPT_PROBLEM_STAGE )
    ...
    KRATOS_REGISTER_VARIABLE( FUNCTIONAL_WEIGHTS )
    KRATOS_REGISTER_VARIABLE( DESIGN_PARAMETER )
    KRATOS_REGISTER_VARIABLE( FUNCTIONAL_DERIVATIVE )
