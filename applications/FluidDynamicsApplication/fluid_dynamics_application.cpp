...
namespace Kratos
{
    ...
    KratosFluidDynamicsApplication::KratosFluidDynamicsApplication() : KratosApplication("FluidDynamicsApplication"),
                                                                       ...
                                                                       mAlternativeQSVMSDEMCoupled3D10N(0, Element::GeometryType::Pointer(new Tetrahedra3D10<Node>(Element::GeometryType::PointsArrayType(10)))),
                                                                       ...
                                                                       mAlternativeDVMSDEMCoupled3D10N(0, Element::GeometryType::Pointer(new Tetrahedra3D10<Node>(Element::GeometryType::PointsArrayType(10)))),
                                                                       ...
                                                                       // Compressible Navier-Stokes JWL symbolic elements
                                                                       mCompressibleNavierStokesJWLExplicit2D3N(0, Element::GeometryType::Pointer(new Triangle2D3<Node>(Element::GeometryType::PointsArrayType(3)))),
    ...
    void KratosFluidDynamicsApplication::Register()
    {
        ...
        KRATOS_REGISTER_VARIABLE(A_JWL);
        ...
        KRATOS_REGISTER_ELEMENT("AlternativeQSVMSDEMCoupled3D10N", mAlternativeQSVMSDEMCoupled3D10N);
        ...
        KRATOS_REGISTER_ELEMENT("AlternativeDVMSDEMCoupled3D10N", mAlternativeDVMSDEMCoupled3D10N);
        ...
        // Compressible Navier-Stokes JWL symbolic elements
        KRATOS_REGISTER_ELEMENT("CompressibleNavierStokesJWLExplicit2D3N", mCompressibleNavierStokesJWLExplicit2D3N);
