...
KratosFluidDynamicsApplication::KratosFluidDynamicsApplication():
    ...
    mCompressibleNSExplicit2D(0, Element::GeometryType::Pointer(new Triangle2D3<Node<3> >(Element::GeometryType::PointsArrayType(3)))),
    mCompressibleNSExplicit3D(0, Element::GeometryType::Pointer(new Tetrahedra3D4<Node<3> >(Element::GeometryType::PointsArrayType(4)))),
...
void KratosFluidDynamicsApplication::Register() {
    ...
    KRATOS_REGISTER_VARIABLE(SOLID_MATERIAL_DENSITY)
    KRATOS_REGISTER_VARIABLE(SOLID_MATERIAL_SPECIFIC_HEAT)
    ...
    KRATOS_REGISTER_VARIABLE(DENSITY_SOLID_PROJECTION)
