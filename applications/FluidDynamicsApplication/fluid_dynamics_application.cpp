...
void KratosFluidDynamicsApplication::Register() {
    ...
    KRATOS_REGISTER_VARIABLE(DENSITY_SHOCK_SENSOR)
    KRATOS_REGISTER_VARIABLE(MOMENTUM_SHOCK_SENSOR)
    KRATOS_REGISTER_VARIABLE(TOTAL_ENERGY_SHOCK_SENSOR)
    ...
    KRATOS_REGISTER_VARIABLE(MOMENTUM_GRADIENT)
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(PRESSURE_GRADIENT)
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(TOTAL_ENERGY_GRADIENT)
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(MOMENTUM_PROJECTION)

    KRATOS_REGISTER_VARIABLE(SMOOTHED_DENSITY)
    KRATOS_REGISTER_VARIABLE(SMOOTHED_TOTAL_ENERGY)
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(SMOOTHED_MOMENTUM)
