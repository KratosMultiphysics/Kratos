...
void KratosFluidDynamicsApplication::Register() {
    ...
    KRATOS_REGISTER_VARIABLE(ZERO_SHEAR_VISCOSITY);
    KRATOS_REGISTER_VARIABLE(INFINITE_SHEAR_VISCOSITY);
    KRATOS_REGISTER_VARIABLE(RELAXATION_TIME);
    KRATOS_REGISTER_VARIABLE(SHEAR_THINNING_INDEX);
    KRATOS_REGISTER_VARIABLE(CARREAU_TRANSITION_SHARPNESS);
    ...
    KRATOS_REGISTER_CONSTITUTIVE_LAW("Carreau2DLaw", mCarreau2DLaw);
