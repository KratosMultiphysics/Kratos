...
void  AddCustomUtilitiesToPython(pybind11::module& m)
{
    ...
    py::class_<FluidAuxiliaryUtilities>(m, "FluidAuxiliaryUtilities")
        ...
        .def_static("CalculateFluidCutElementNegativeVolume", &FluidAuxiliaryUtilities::CalculateFluidCutElementNegativeVolume)
        .def_static("CalculateFluidCutElementPositiveVolume", &FluidAuxiliaryUtilities::CalculateFluidCutElementPositiveVolume)
