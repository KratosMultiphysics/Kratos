...
void  AddCustomUtilitiesToPython(pybind11::module& m)
{
    ...
    py::class_<FluidAuxiliaryUtilities>(m, "FluidAuxiliaryUtilities")
        ...
        .def_static("CalculateFlowRatePositiveSkin", &FluidAuxiliaryUtilities::CalculateFlowRatePositiveSkin)
        .def_static("CalculateFlowRateNegativeSkin", &FluidAuxiliaryUtilities::CalculateFlowRateNegativeSkin)
