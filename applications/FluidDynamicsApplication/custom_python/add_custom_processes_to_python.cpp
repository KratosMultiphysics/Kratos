...
#include "custom_processes/divergence_calculation_process.h"
...
void AddCustomProcessesToPython(pybind11::module& m)
{
    ...
    py::class_<DivergenceCalculationProcess, DivergenceCalculationProcess::Pointer, Process >
        (m, "DivergenceCalculationProcess")
        .def(py::init<ModelPart&>())
    ;
}
