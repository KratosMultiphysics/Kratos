...
//        KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,C_SMAGORINSKY);
    ...
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, TIME_AVERAGED_VELOCITY)
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, TIME_AVERAGED_REACTION)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, TIME_AVERAGED_PRESSURE)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, AVERAGING_TIME_LENGTH)
}
