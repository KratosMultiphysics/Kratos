...
//        KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,C_SMAGORINSKY);
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,SOLID_MATERIAL_DENSITY);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,SOLID_MATERIAL_SPECIFIC_HEAT);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,DENSITY_MATERIAL);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,SPECIFIC_HEAT_MATERIAL);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,REACTION_DENSITY);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,REACTION_DENSITY_GAS);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,REACTION_DENSITY_SOLID);
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,NODAL_GAMMA);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,NODAL_CV);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,SOLID_CONCENTRATION);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,DYNAMIC_PRESSURE);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,EXTRA_PRESSURE);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,GAS_PRESSURE);
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,DENSITY_GAS);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,DENSITY_GAS_RK4);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,DENSITY_GAS_RHS);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,DENSITY_SOLID);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,DENSITY_SOLID_RK4);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,DENSITY_SOLID_RHS);
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,DENSITY_SOLID_PROJECTION);
