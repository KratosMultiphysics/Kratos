...
//        KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,C_SMAGORINSKY);
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,AUXILIAR_GRADIENT_X);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,AUXILIAR_GRADIENT_Y);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,AUXILIAR_GRADIENT_Z);
