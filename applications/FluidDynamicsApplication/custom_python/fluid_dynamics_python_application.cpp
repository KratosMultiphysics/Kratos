...
//        KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,C_SMAGORINSKY);
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,DENSITY_RK4);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,DENSITY_RHS);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,TOTAL_ENERGY_RK4);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,TOTAL_ENERGY_RHS);
}
