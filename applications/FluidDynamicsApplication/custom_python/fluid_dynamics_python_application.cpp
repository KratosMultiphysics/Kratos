...
PYBIND11_MODULE(KratosFluidDynamicsApplication,m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, LATERAL_FORCE_COEFFICIENT);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, ROLLING_MOMENT_COEFFICIENT);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, PITCHING_MOMENT_COEFFICIENT);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, YAWING_MOMENT_COEFFICIENT);
}
