...
//        KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,C_SMAGORINSKY);
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,NORMAL_VECTOR)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,TANGENT_VECTOR)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,CONTACT_VECTOR)
}
