...
namespace Kratos
{
    ...
    namespace Python
    {
        ...
        PYBIND11_MODULE(KratosFluidDynamicsApplication, m)
        {
            ...
            KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, A_JWL);
            KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, B_JWL);
            KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, R1);
            KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, R2);
            KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, E0);
            KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, omega);
            KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, rho_0);
            ...
            KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, FRACTIONAL_VELOCITY);
            KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, WATER_VOLUME_ERROR);
            KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, AIR_VOLUME_ERROR);
            ...
            KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, THERMODYNAMIC_PRESSURE)
            KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, THERMODYNAMIC_PRESSURE_DERIVATIVE)
            ...
            // SBM variables
            KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, MOMENTUM_X_GRADIENT);
            KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, MOMENTUM_Y_GRADIENT);
