...
PYBIND11_MODULE(KratosFluidDynamicsApplication,m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,ZERO_SHEAR_VISCOSITY);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,INFINITE_SHEAR_VISCOSITY);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,RELAXATION_TIME);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,SHEAR_THINNING_INDEX);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,CARREAU_TRANSITION_SHARPNESS);
