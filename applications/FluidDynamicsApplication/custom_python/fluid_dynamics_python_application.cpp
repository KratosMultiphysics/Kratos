...
//        KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,C_SMAGORINSKY);
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, DENSITY_FLUX)
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, MOMENTUM_FLUX)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, TOTAL_ENERGY_FLUX)
