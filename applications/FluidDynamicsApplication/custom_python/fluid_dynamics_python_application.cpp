...
PYBIND11_MODULE(KratosFluidDynamicsApplication,m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, TOP_OPT_PROBLEM_STAGE )
    // Fluid Topology Optimization Variables
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, FLUID_TOP_OPT_PROBLEM_STAGE )
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, VELOCITY_ADJ )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, PRESSURE_ADJ )
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, ACCELERATION_ADJ )
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, MESH_VELOCITY_ADJ )
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, BODY_FORCE_ADJ )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, FLUID_TOP_OPT_NS_STEP )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, FLUID_TOP_OPT_ADJ_NS_STEP )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, FUNCTIONAL_WEIGHTS )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, DESIGN_PARAMETER )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, FUNCTIONAL_DERIVATIVE )
}
