...
PYBIND11_MODULE(KratosFluidDynamicsApplication,m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,APPLY_NITSCHE_BOUNDARY_IMPOSITION);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,APPLY_EMBEDDED_CONSTRAINTS);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,EMBEDDED_CONSTRAINT_MASTERS);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,EMBEDDED_CONSTRAINT_MASTER_WEIGHTS);
