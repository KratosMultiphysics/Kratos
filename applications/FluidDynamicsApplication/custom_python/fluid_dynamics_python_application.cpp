...
//        KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,C_SMAGORINSKY);
    ...
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m,MOMENTUM_TIME_DERIVATIVE);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,TOTAL_ENERGY_TIME_DERIVATIVE);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,SHOCK_SENSOR);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,DENSITY_SHOCK_SENSOR);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,MOMENTUM_SHOCK_SENSOR);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,TOTAL_ENERGY_SHOCK_SENSOR);
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,MOMENTUM_GRADIENT);
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m,PRESSURE_GRADIENT);
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m,TOTAL_ENERGY_GRADIENT);
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,SMOOTHED_DENSITY);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,SMOOTHED_TOTAL_ENERGY);
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m,SMOOTHED_MOMENTUM);
}
