...
//        KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,C_SMAGORINSKY);
    ...
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, RESPONSE_FUNCTION_INTERPOLATION_ERROR_AUX_ADJOINT_FLUID_VECTOR_1)
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,RESPONSE_FUNCTION_INTERPOLATION_ERROR_AUXILIARY_1);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,RESPONSE_FUNCTION_INTERPOLATION_ERROR_AUXILIARY_2);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,COMPUTE_RESPONSE_FUNCTION_INTERPOLATION_ERROR);

    // Variables required only for LSS
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, TIME_STEP_SENSITIVITY);
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, LSS_VELOCITY );
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, LSS_ACCELERATION );
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, LSS_PRESSURE );
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, LSS_PRESSURE_RATE );
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, ADJOINT_FLUID_SCALAR_3 );
}
