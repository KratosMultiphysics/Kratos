...
class GlobalJointStressUtility
{
  ...
  public:
    ...
    void ComputingGlobalStress()
    {
        ...
        bounded_matrix<double, 3, 3> RotationPlane;
        ...
        for (int k = 0; k < nelements; k++)
        {
            ...
            bounded_matrix<double, 3, 3> RotationMatrix;
  ...
  protected:
    ...
    void CalculateRotationMatrix(bounded_matrix<double, 3, 3> &rRotationMatrix, array_1d<double, 3> &point_mid0, array_1d<double, 3> &point_mid1, array_1d<double, 3> &point_mid2)
    {
        KRATOS_TRY
