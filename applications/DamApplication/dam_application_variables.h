...
namespace Kratos
{
    ...
    // Joints
    KRATOS_DEFINE_APPLICATION_VARIABLE( DAM_APPLICATION, double, MAX_COMPRESSIVE_STRESS )
    KRATOS_DEFINE_APPLICATION_VARIABLE( DAM_APPLICATION, double, MAX_TENSILE_STRESS )
    KRATOS_DEFINE_APPLICATION_VARIABLE( DAM_APPLICATION, double, COHESION )
