...
construction_utilities.Initialize()
...
while( (time+tol) <= end_time ):
    ...
    # Execute initialize soluition
    construction_utilities.InitializeSolutionStep()
    ...
    #  After initialize soluition
    construction_utilities.AfterOutputStep()
