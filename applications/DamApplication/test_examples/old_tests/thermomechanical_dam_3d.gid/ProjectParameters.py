...
gauss_points_results=["GREEN_LAGRANGE_STRAIN_TENSOR","THERMAL_STRAIN_TENSOR","CAUCHY_STRESS_TENSOR","MECHANICAL_STRESS_TENSOR","THERMAL_STRESS_TENSOR","VON_MISES_STRESS","NO_RESULT"]
