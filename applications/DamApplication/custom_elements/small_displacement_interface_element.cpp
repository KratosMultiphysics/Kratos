...
void SmallDisplacementInterfaceElement<TDim,TNumNodes>::CalculateMassMatrix( MatrixType& rMassMatrix, ProcessInfo& rCurrentProcessInfo )
{
    ...
    bounded_matrix<double,TDim, TNumNodes*TDim> Nut = ZeroMatrix(TDim, TNumNodes*TDim);
...
template<>
void SmallDisplacementInterfaceElement<2,4>::CalculateRotationMatrix(bounded_matrix<double,2,2>& rRotationMatrix, const GeometryType& Geom)
{
    KRATOS_TRY
...
template<>
void SmallDisplacementInterfaceElement<3,6>::CalculateRotationMatrix(bounded_matrix<double,3,3>& rRotationMatrix, const GeometryType& Geom)
{
    KRATOS_TRY
...
template<>
void SmallDisplacementInterfaceElement<3,8>::CalculateRotationMatrix(bounded_matrix<double,3,3>& rRotationMatrix, const GeometryType& Geom)
{
    KRATOS_TRY
