...
namespace Kratos
{
    ...
    double& DamBilinearCohesive3DLaw::GetValue( const Variable<double>& rThisVariable, double& rValue )
    {
        KRATOS_TRY
...
//----------------------------------------------------------------------------------------
    ...
    void DamBilinearCohesive3DLaw::SetValue(const Variable<double>& rThisVariable, const double& rValue,
...
//----------------------------------------------------------------------------------------------------------
    ...
    void DamBilinearCohesive3DLaw::ComputeStressVector(Vector& rStressVector,
