...
private:
    ...
    {
        KRATOS_SERIALIZE_SAVE_BASE_CLASS( rSerializer, ThermalNonlocalDamagePlaneStress2DLaw )
    }

    void load(Serializer& rSerializer) override
    {
        KRATOS_SERIALIZE_LOAD_BASE_CLASS( rSerializer, ThermalNonlocalDamagePlaneStress2DLaw )
    }
