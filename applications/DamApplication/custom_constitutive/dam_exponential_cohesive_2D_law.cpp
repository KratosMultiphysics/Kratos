...
namespace Kratos
{
    ...
    double& DamExponentialCohesive2DLaw::GetValue( const Variable<double>& rThisVariable, double& rValue )
    {
        KRATOS_TRY
...
//----------------------------------------------------------------------------------------
    ...
    void DamExponentialCohesive2DLaw::SetValue(const Variable<double>& rThisVariable, const double& rValue,
...
//----------------------------------------------------------------------------------------------------------
    ...
    void DamExponentialCohesive2DLaw::ComputeStressVector(Vector& rStressVector,
