...
class GidPrintUtility(object):
    ...
    def __init__(self, gid_output_settings, file_name, starting_time, ending_time, delta_time, time_unit_converter):
        ...
        # set time frequency
        self.write_frequency = gid_output_settings.GiDWriteFrequency*time_unit_converter          # Is multiply by time converter to be in same units.
