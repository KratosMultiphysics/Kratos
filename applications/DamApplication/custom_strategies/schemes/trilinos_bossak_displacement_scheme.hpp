...
#if !defined(KRATOS_TRILINOS_BOSSAK_DISPLACEMENT_SCHEME )
#define  KRATOS_TRILINOS_BOSSAK_DISPLACEMENT_SCHEME
...
class TrilinosBossakDisplacementScheme : public BossakDisplacementSmoothingScheme<TSparseSpace,TDenseSpace>
{

public:

    KRATOS_CLASS_POINTER_DEFINITION( TrilinosBossakDisplacementScheme );
...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    ///Constructor
    TrilinosBossakDisplacementScheme(double rAlpham = 0.0, double rayleigh_m = 0.0, double rayleigh_k = 0.0)
        : BossakDisplacementSmoothingScheme<TSparseSpace,TDenseSpace>(rAlpham, rayleigh_m, rayleigh_k),
        mImporterIsInitialized(false) {}
    
    //------------------------------------------------------------------------------------
    
    ///Destructor
    virtual ~TrilinosBossakDisplacementScheme() {}
...
}; // Class TrilinosBossakDisplacementScheme
}  // namespace Kratos

#endif // KRATOS_TRILINOS_BOSSAK_DISPLACEMENT_SCHEME defined
