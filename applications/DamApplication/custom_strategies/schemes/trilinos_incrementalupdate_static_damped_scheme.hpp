...
class TrilinosIncrementalUpdateStaticDampedScheme : public IncrementalUpdateStaticDampedSmoothingScheme<TSparseSpace,TDenseSpace>
{
...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    ///Constructor
    TrilinosIncrementalUpdateStaticDampedScheme(double rayleigh_m, double rayleigh_k)
        : IncrementalUpdateStaticDampedSmoothingScheme<TSparseSpace,TDenseSpace>(rayleigh_m, rayleigh_k),
