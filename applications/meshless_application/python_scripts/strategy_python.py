...
class SolvingStrategyPython:
    ...
    def Solve(self):
        ...
        #(Gauss_Coordinates_Update_Utility(self.model_part)).UpdateGaussCoordinates()
        ...
        #(LocalRefineTriangleMesh(self.model_part)).LocalRefineMesh(True,True)
...
##            print "RHS = ", self.b
    ...
    def FinalizeSolutionStep(self,CalculateReactionsFlag):
        ...
        #(RecomputeNeighbours(self.model_part)).Recompute_Neighbours()
