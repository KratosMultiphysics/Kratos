    ...
    if(finest_level == 0):
        ...
        for lev in range(finest_level+1):
            ...
            if (lev < finest_level):
                ...
                model_refined = refinement.compute_refinement_hessian_metric(simulation,size_meshes[lev+1],1.0,current_settings_metric_refinement,current_settings_remesh_refinement)
    ...
    settings_metric_refinement = KratosMultiphysics.Parameters("""
        {
            ...
            "local_gradient_variable"           : "POSITIVE_POTENTIAL"
        }
    """)
