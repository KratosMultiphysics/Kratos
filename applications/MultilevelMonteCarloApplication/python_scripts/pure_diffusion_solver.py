...
KratosMultiphysics.CheckRegisteredApplications("MultilevelMonteCarloApplication")
...
class PureDiffusionSolver(PythonSolver):
    ...
    def __init__(self, model, custom_settings):  # Constructor of the class
        ...
        self.element_name = "LaplacianElement"
        ...
        if model_part_name == "":
            raise Exception('Provide the model part name as the "model_part_name" (string) parameter!')
        ...
        if domain_size == -1:
            raise Exception('Provide the domain size as the "domain_size" (int) parameter!')
    ...
    def _ValidateSettings(self, settings):
        ...
        "model_import_settings"              : {
            "input_type"     : "mdpa",
            "input_filename" : "../tests/Level0/Level0"
        },
