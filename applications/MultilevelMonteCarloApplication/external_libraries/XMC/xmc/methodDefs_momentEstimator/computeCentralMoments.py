...
computeCentralMomentsOrderOneDimensionZero_Task = ExaquteTask(returns=1)(computeCentralMomentsOrderOneDimensionZero)
...
computeCentralMomentsOrderTwoDimensionZero_Task = ExaquteTask(returns=1)(computeCentralMomentsOrderTwoDimensionZero)
...
computeCentralMomentsOrderThreeDimensionZero_Task = ExaquteTask(returns=1)(computeCentralMomentsOrderThreeDimensionZero)
...
computeCentralMomentsOrderFourDimensionZero_Task = ExaquteTask(returns=1)(computeCentralMomentsOrderFourDimensionZero)
...
computeCentralMomentsOrderTwoDimensionZeroBiased_Task = ExaquteTask(returns=1)(computeCentralMomentsOrderTwoDimensionZeroBiased)
