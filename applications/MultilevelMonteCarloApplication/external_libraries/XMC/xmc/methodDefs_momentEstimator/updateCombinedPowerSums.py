...
updatePowerSumsOrder1Dimension0_Task = ExaquteTask(samples={Type: COLLECTION_IN, Depth: 4},returns=1)(updatePowerSumsOrder1Dimension0)
...
updatePowerSumsOrder2Dimension0_Task = ExaquteTask(samples={Type: COLLECTION_IN, Depth: 4},returns=3)(updatePowerSumsOrder2Dimension0)
...
updatePowerSumsOrder10Dimension0_Task = ExaquteTask(samples={Type: COLLECTION_IN, Depth: 4},returns=11)(updatePowerSumsOrder10Dimension0)
...
updatePowerSumsOrder2Dimension1_Task = ExaquteTask(samples={Type: COLLECTION_IN, Depth: 4},returns=5)(updatePowerSumsOrder2Dimension1)