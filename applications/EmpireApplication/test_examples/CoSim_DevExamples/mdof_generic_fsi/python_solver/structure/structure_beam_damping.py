...
class Structure():
    ...
    def __init__(self, _project_parameters):
        ...
        self.file_name = self.properties.output_filename_Y
    ...
    def structure(self):
        ...
        target_frequency_x = 0.2
        target_frequency_y = 0.23
    ...
    def solver(self):
        ...
        solver_X = StructureMDoF(
            ...
            self.properties.disp_X, self.properties.vel_X, self.properties.acc_X, self.properties.output_filename_X)

        solver_Y = StructureMDoF(
            self.properties.dt, self.struct_Y.M, self.struct_Y.K, self.struct_Y.B, self.properties.rho_inf,
            self.properties.disp_Y, self.properties.vel_Y, self.properties.acc_Y, self.properties.output_filename_Y)

        solver_R = StructureMDoF(
            self.properties.dt, self.struct_R.M, self.struct_R.K, self.struct_R.B, self.properties.rho_inf,
            self.properties.disp_R, self.properties.vel_R, self.properties.acc_R, self.properties.output_filename_R)
    ...
    def update_solver(self, mode_shape):

        initial_disp = 100000 * mode_shape
        solver_X = StructureMDoF(
            self.properties.dt, self.struct_X.M, self.struct_X.K, self.struct_X.B, self.properties.rho_inf,
            self.properties.disp_X, self.properties.vel_X, self.properties.acc_X, self.properties.output_filename_X)
        ...
        solver_Y = StructureMDoF(
            self.properties.dt, self.struct_Y.M, self.struct_Y.K, self.struct_Y.B, self.properties.rho_inf,
            initial_disp, self.properties.vel_Y, self.properties.acc_Y, self.properties.output_filename_Y)
