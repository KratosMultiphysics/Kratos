...
def CreateSolver(model, custom_settings):
    return UPwPgSolver(model, custom_settings)

class UPwPgSolver(PythonSolver):
    ...
    def __init__(self, model, custom_settings):
        ...
        super(UPwPgSolver,self).__init__(model, custom_settings)
        ...
        KratosMultiphysics.Logger.PrintInfo("UPwPgSolver", "Construction of UPwPgSolver finished.")

    @classmethod
    def GetDefaultParameters(cls):
        this_defaults = KratosMultiphysics.Parameters("""{
            "solver_type": "poromechanics_U_Pw_Pg_solver",
        ...
        this_defaults.AddMissingParameters(super(UPwPgSolver, cls).GetDefaultParameters())
    ...
    def AddVariables(self):
        ...
        KratosMultiphysics.Logger.PrintInfo("UPwPgSolver", "Variables added correctly.")
    ...
    def PrepareModelPart(self):
        ...
        KratosMultiphysics.Logger.PrintInfo("UPwPgSolver", "Model reading finished.")
    ...
    def AddDofs(self):
        ...
        KratosMultiphysics.Logger.PrintInfo("UPwPgSolver", "DOFs added correctly.")
    ...
    def Initialize(self):
        ...
        KratosMultiphysics.Logger.PrintInfo("UPwPgSolver", "Solver initialization finished.")
    ...
    def Solve(self):
        message = "".join([
            "Calling UPwPgSolver.Solve() method, which is deprecated\n",
        ...
        KratosMultiphysics.Logger.PrintWarning("UPwPgSolver",message)
    ...
    def _ExecuteCheckAndPrepare(self):
        ...
        if materials_imported:
            KratosMultiphysics.Logger.PrintInfo("UPwPgSolver", "Constitutive law was successfully imported via json.")
        else:
            KratosMultiphysics.Logger.PrintInfo("UPwPgSolver", "Constitutive law was not successfully imported.")
    ...
    def _ConstructScheme(self, scheme_type, solution_type):
        ...
        if(scheme_type == "Newmark"):
            ...
            if self.settings["calculate_alpha_beta"].GetBool():
                ...
                KratosMultiphysics.Logger.PrintInfo("::[UPwPgSolver]:: Scheme Information")
                KratosMultiphysics.Logger.PrintInfo("::[UPwPgSolver]:: omega_1: ",omega_1)
                KratosMultiphysics.Logger.PrintInfo("::[UPwPgSolver]:: omega_n: ",omega_n)
                KratosMultiphysics.Logger.PrintInfo("::[UPwPgSolver]:: xi_1: ",xi_1)
                KratosMultiphysics.Logger.PrintInfo("::[UPwPgSolver]:: xi_n: ",xi_n)
                KratosMultiphysics.Logger.PrintInfo("::[UPwPgSolver]:: Alpha and Beta output")
                KratosMultiphysics.Logger.PrintInfo("::[UPwPgSolver]:: rayleigh_alpha: ",rayleigh_alpha)
                KratosMultiphysics.Logger.PrintInfo("::[UPwPgSolver]:: rayleigh_beta: ",rayleigh_beta)
            ...
            if(solution_type == "implicit_quasi_static"):
                if(rayleigh_alpha<1.0e-20 and rayleigh_beta<1.0e-20):
                    scheme = KratosPoro.PoroNewmarkQuasistaticUPwPgScheme(beta,gamma,theta)
                else:
                    scheme = KratosPoro.PoroNewmarkQuasistaticDampedUPwPgScheme(beta,gamma,theta)
            else:
                scheme = KratosPoro.PoroNewmarkDynamicUPwPgScheme(beta,gamma,theta)
        else:
