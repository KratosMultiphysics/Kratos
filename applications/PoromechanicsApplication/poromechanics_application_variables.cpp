...
KRATOS_CREATE_VARIABLE( double, DT_GAS_PRESSURE_COEFFICIENT )
...
KRATOS_CREATE_VARIABLE( double, DYNAMIC_VISCOSITY_GAS )
KRATOS_CREATE_VARIABLE( double, GAS_HENRY_SOLUBILITY_COEFF )
KRATOS_CREATE_VARIABLE( double, GAS_MOLAR_WEIGHT )
KRATOS_CREATE_VARIABLE( double, TORTUOSITY_COEFF )
KRATOS_CREATE_VARIABLE( double, GAS_DIFFUSION_COEFF )
KRATOS_CREATE_VARIABLE( double, LIQUID_DENSITY_REF_PRESSURE )
KRATOS_CREATE_VARIABLE( std::string, SATURATION_LAW_NAME )
KRATOS_CREATE_VARIABLE( double, RESIDUAL_LIQUID_SATURATION )
KRATOS_CREATE_VARIABLE( double, RESIDUAL_GAS_SATURATION )
KRATOS_CREATE_VARIABLE( double, GAS_ENTRY_PRESSURE )
...
KRATOS_CREATE_VARIABLE( double, BULK_MODULUS_GAS )
...
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS( GAS_FLUX_VECTOR )
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS( LOCAL_GAS_FLUX_VECTOR )
...
KRATOS_CREATE_VARIABLE( Matrix, LIQUID_PERMEABILITY_MATRIX )
KRATOS_CREATE_VARIABLE( Matrix, GAS_PERMEABILITY_MATRIX )
...
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS( GAS_PRESSURE_GRADIENT )
