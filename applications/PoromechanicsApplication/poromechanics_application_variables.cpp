...
KRATOS_CREATE_VARIABLE( double, VISCOSITY_LIQUID )
KRATOS_CREATE_VARIABLE( double, VISCOSITY_GAS )
...
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS( NODAL_LIQUID_PRESSURE_GRADIENT )
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS( GAS_PRESSURE_GRADIENT )
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS( NODAL_GAS_PRESSURE_GRADIENT )
