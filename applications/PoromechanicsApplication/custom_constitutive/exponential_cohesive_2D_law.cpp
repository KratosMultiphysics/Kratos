...
int ExponentialCohesive2DLaw::Check(const Properties& rMaterialProperties,const GeometryType& rElementGeometry,const ProcessInfo& rCurrentProcessInfo)
{
...
void ExponentialCohesive2DLaw::InitializeMaterial( const Properties& rMaterialProperties,const GeometryType& rElementGeometry,const Vector& rShapeFunctionsValues )
{
...
void ExponentialCohesive2DLaw::FinalizeMaterialResponseCauchy (Parameters& rValues)
{
...
double& ExponentialCohesive2DLaw::GetValue( const Variable<double>& rThisVariable, double& rValue )
{
...
double ExponentialCohesive2DLaw::MacaulayBrackets(const double& Value)
{
    if(Value > 0.0)
        return Value;
    else
...
void ExponentialCohesive2DLaw::ComputeDamageVariable(ConstitutiveLawVariables& rVariables,
                                                        Parameters& rValues)
{
...
void ExponentialCohesive2DLaw::ComputeStressVector(Vector& rStressVector,
                                                ConstitutiveLawVariables& rVariables,
                                                Parameters& rValues)
{
    const Vector& StrainVector = rValues.GetStrainVector();
