...
template< unsigned int TDim, unsigned int TNumNodes >
void UPlSmallStrainElement<TDim,TNumNodes>::SaveGPGradPressure(Matrix& rGradPressureContainer, const array_1d<double,TDim>& GradPressure, const unsigned int& GPoint)
{
...
template< >
void UPlSmallStrainElement<2,3>::ExtrapolateGPValues(const Matrix& GradPressureContainer, const Matrix& StressContainer, const unsigned int& VoigtSize)
{
    KRATOS_TRY
...
template< >
void UPlSmallStrainElement<2,4>::ExtrapolateGPValues(const Matrix& GradPressureContainer, const Matrix& StressContainer, const unsigned int& VoigtSize)
{
    KRATOS_TRY
...
template< >
void UPlSmallStrainElement<3,4>::ExtrapolateGPValues(const Matrix& GradPressureContainer, const Matrix& StressContainer, const unsigned int& VoigtSize)
{
    KRATOS_TRY
...
template< >
void UPlSmallStrainElement<3,8>::ExtrapolateGPValues(const Matrix& GradPressureContainer, const Matrix& StressContainer, const unsigned int& VoigtSize)
{
    KRATOS_TRY
