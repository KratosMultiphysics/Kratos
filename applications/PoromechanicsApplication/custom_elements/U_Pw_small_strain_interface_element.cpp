                                                                                ...
                                                                                std::vector<array_1d<double,3>>& rOutput, const ProcessInfo& rCurrentProcessInfo )
{
    ...
    if(rVariable == FLUID_FLUX_VECTOR)
    {
        ...
        for ( unsigned int GPoint = 0; GPoint < NumGPoints; GPoint++ )
        {
            ...
            this->CalculateShapeFunctionsGradients< bounded_matrix<double,TNumNodes,TDim> >(GradNpT,SFGradAuxVars,JContainer[GPoint],RotationMatrix,
...
template<>
void UPwSmallStrainInterfaceElement<2,4>::CalculateRotationMatrix(bounded_matrix<double,2,2>& rRotationMatrix, const GeometryType& Geom)
{
    KRATOS_TRY
...
template<>
void UPwSmallStrainInterfaceElement<3,6>::CalculateRotationMatrix(bounded_matrix<double,3,3>& rRotationMatrix, const GeometryType& Geom)
{
    KRATOS_TRY
...
template<>
void UPwSmallStrainInterfaceElement<3,8>::CalculateRotationMatrix(bounded_matrix<double,3,3>& rRotationMatrix, const GeometryType& Geom)
{
    KRATOS_TRY
...
void UPwSmallStrainInterfaceElement<2,4>::CalculateShapeFunctionsGradients(TMatrixType& rGradNpT,SFGradAuxVariables& rAuxVariables,
                                                    const Matrix& Jacobian,const bounded_matrix<double,2,2>& RotationMatrix,
...
void UPwSmallStrainInterfaceElement<3,6>::CalculateShapeFunctionsGradients(TMatrixType& rGradNpT,SFGradAuxVariables& rAuxVariables,
                                                    const Matrix& Jacobian,const bounded_matrix<double,3,3>& RotationMatrix,
                                                    const Matrix& DN_De,const Matrix& Ncontainer, const double& JointWidth,const unsigned int& GPoint)
{
...
void UPwSmallStrainInterfaceElement<TDim,TNumNodes>::CalculateAndAddStiffnessMatrix(MatrixType& rLeftHandSideMatrix, InterfaceElementVariables& rVariables)
{
    noalias(rVariables.DimMatrix) = prod(trans(rVariables.RotationMatrix),
                                        bounded_matrix<double,TDim,TDim>(prod(rVariables.ConstitutiveMatrix,
...
template void UPwSmallStrainInterfaceElement<2,4>::CalculateShapeFunctionsGradients< bounded_matrix<double,4,2> >
                                                    ( bounded_matrix<double,4,2>& rGradNpT, SFGradAuxVariables& rAuxVariables,
                                                    const Matrix& Jacobian,const bounded_matrix<double,2,2>& RotationMatrix,
                                                    const Matrix& DN_De,const Matrix& Ncontainer, const double& JointWidth,const unsigned int& GPoint );
template void UPwSmallStrainInterfaceElement<2,4>::CalculateShapeFunctionsGradients< Matrix >
                                                    ...
                                                    const Matrix& DN_De,const Matrix& Ncontainer, const double& JointWidth,const unsigned int& GPoint );
template void UPwSmallStrainInterfaceElement<3,6>::CalculateShapeFunctionsGradients< bounded_matrix<double,6,3> >
                                                    ( bounded_matrix<double,6,3>& rGradNpT, SFGradAuxVariables& rAuxVariables,
                                                    const Matrix& Jacobian,const bounded_matrix<double,3,3>& RotationMatrix,
                                                    const Matrix& DN_De,const Matrix& Ncontainer, const double& JointWidth,const unsigned int& GPoint );
template void UPwSmallStrainInterfaceElement<3,6>::CalculateShapeFunctionsGradients< Matrix >
                                                    ...
                                                    const Matrix& DN_De,const Matrix& Ncontainer, const double& JointWidth,const unsigned int& GPoint );
template void UPwSmallStrainInterfaceElement<3,8>::CalculateShapeFunctionsGradients< bounded_matrix<double,8,3> >
                                                    ( bounded_matrix<double,8,3>& rGradNpT, SFGradAuxVariables& rAuxVariables,
                                                    const Matrix& Jacobian,const bounded_matrix<double,3,3>& RotationMatrix,
                                                    const Matrix& DN_De,const Matrix& Ncontainer, const double& JointWidth,const unsigned int& GPoint );
