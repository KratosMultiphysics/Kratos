...
#if !defined(KRATOS_U_PL_PG_ELEMENT_H_INCLUDED )
#define  KRATOS_U_PL_PG_ELEMENT_H_INCLUDED
...
class KRATOS_API(POROMECHANICS_APPLICATION) UPlPgElement : public Element
{

public:

    KRATOS_CLASS_INTRUSIVE_POINTER_DEFINITION( UPlPgElement );

///----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

    /// Default Constructor
    UPlPgElement(IndexType NewId = 0) : Element( NewId ) {}

    /// Constructor using an array of nodes
    UPlPgElement(IndexType NewId, const NodesArrayType& ThisNodes) : Element(NewId, ThisNodes) {}

    /// Constructor using Geometry
    UPlPgElement(IndexType NewId, GeometryType::Pointer pGeometry) : Element( NewId, pGeometry ) {}

    /// Constructor using Properties
    UPlPgElement(IndexType NewId, GeometryType::Pointer pGeometry, PropertiesType::Pointer pProperties) : Element( NewId, pGeometry, pProperties )
    {
        mThisIntegrationMethod = this->GetIntegrationMethod();
    }

    /// Destructor
    virtual ~UPlPgElement() {}
...
private:
    ...
    /// Assignment operator.
    UPlPgElement & operator=(UPlPgElement const& rOther);

    /// Copy constructor.
    UPlPgElement(UPlPgElement const& rOther);
...
#endif // KRATOS_U_PL_PG_ELEMENT_H_INCLUDED  defined
