...
protected:
    ...
    struct SFGradAuxVariables
    {
        ...
        bounded_matrix<double,TNumNodes,TDim-1> ShapeFunctionsNaturalGradientsMatrix;
        bounded_matrix<double,TDim-1,TDim-1> LocalCoordinatesGradientsMatrix;
        bounded_matrix<double,TDim-1,TDim-1> LocalCoordinatesGradientsInvMatrix;
        bounded_matrix<double,TNumNodes,TDim-1> ShapeFunctionsGradientsMatrix;
    };
    ...
    {        
        ...
        bounded_matrix<double,TDim, TDim> LocalPermeabilityMatrix;
        ...
        bounded_matrix<double,TDim,TDim> DimMatrix;
        bounded_matrix<double,TNumNodes*TDim,TDim> UDimMatrix;
...
///----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    void CalculateRotationMatrix(bounded_matrix<double,TDim,TDim>& rRotationMatrix, const GeometryType& Geom);
