...
{   
    ...
    bounded_matrix<double,4,4> ExtrapolationMatrix;
    ElementUtilities::CalculateExtrapolationMatrix(ExtrapolationMatrix);
    
    bounded_matrix<double,4,3> AuxNodalStress;
...
{   
    ...
    bounded_matrix<double,8,8> ExtrapolationMatrix;
    ElementUtilities::CalculateExtrapolationMatrix(ExtrapolationMatrix);
    
    bounded_matrix<double,8,6> AuxNodalStress;
    noalias(AuxNodalStress) = prod(ExtrapolationMatrix,StressContainer);
...
void UPwSmallStrainElement<TDim,TNumNodes>::CalculateAndAddCompressibilityMatrix(MatrixType& rLeftHandSideMatrix, ElementVariables& rVariables)
{
    ...
    ElementUtilities::AssemblePBlockMatrix< bounded_matrix<double,TNumNodes,TNumNodes> >(rLeftHandSideMatrix,rVariables.PMatrix,TDim,TNumNodes);
}
