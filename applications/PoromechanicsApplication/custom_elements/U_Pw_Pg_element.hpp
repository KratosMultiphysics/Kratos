...
class KRATOS_API(POROMECHANICS_APPLICATION) UPwPgElement : public Element
{

public:

    KRATOS_CLASS_INTRUSIVE_POINTER_DEFINITION( UPwPgElement );

///----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

    /// Default Constructor
    UPwPgElement(IndexType NewId = 0) : Element( NewId ) {}

    /// Constructor using an array of nodes
    UPwPgElement(IndexType NewId, const NodesArrayType& ThisNodes) : Element(NewId, ThisNodes) {}

    /// Constructor using Geometry
    UPwPgElement(IndexType NewId, GeometryType::Pointer pGeometry) : Element( NewId, pGeometry ) {}

    /// Constructor using Properties
    UPwPgElement(IndexType NewId, GeometryType::Pointer pGeometry, PropertiesType::Pointer pProperties) : Element( NewId, pGeometry, pProperties )
    {
        mThisIntegrationMethod = this->GetIntegrationMethod();
    }

    /// Destructor
    virtual ~UPwPgElement() {}
...
private:
    ...
    /// Assignment operator.
    UPwPgElement & operator=(UPwPgElement const& rOther);

    /// Copy constructor.
    UPwPgElement(UPwPgElement const& rOther);
...
#endif // KRATOS_U_PW_PG_ELEMENT_H_INCLUDED  defined
