...
class KRATOS_API(POROMECHANICS_APPLICATION) LineNormalLoad2DDiffOrderCondition : public GeneralUPlDiffOrderCondition
{

public:

<<<<<<< HEAD:applications/PoromechanicsApplication/custom_conditions/line_normal_load_2D_diff_order_condition.hpp
...
>>>>>>> master:applications/PoromechanicsApplication/custom_conditions/one-phase_flow/line_normal_load_2D_diff_order_condition.hpp
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
