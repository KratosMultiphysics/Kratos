...
template< unsigned int TDim, unsigned int TNumNodes >
<<<<<<< HEAD:applications/PoromechanicsApplication/custom_conditions/U_Pw_normal_flux_condition.cpp
...
{        
>>>>>>> master:applications/PoromechanicsApplication/custom_conditions/one-phase_flow/U_Pl_normal_liquid_flux_condition.cpp
...
>>>>>>> master:applications/PoromechanicsApplication/custom_conditions/one-phase_flow/U_Pl_normal_liquid_flux_condition.cpp
        ...
        this->CalculateIntegrationCoefficient(Variables.IntegrationCoefficient, JContainer[GPoint], integration_points[GPoint].Weight(), CurrentProcessInfo );
