...
{        
    ...
    bounded_matrix<double,TDim, TNumNodes*TDim> Nu = ZeroMatrix(TDim, TNumNodes*TDim);
...
template< >
void UPwFaceLoadInterfaceCondition<2,2>::CheckJointWidth(double& rJointWidth, bool& rComputeJointWidth, bounded_matrix<double,2,2>& rRotationMatrix,
...
template< >
void UPwFaceLoadInterfaceCondition<3,4>::CheckJointWidth(double& rJointWidth, bool& rComputeJointWidth, bounded_matrix<double,3,3>& rRotationMatrix,
                                                            const double& MinimumJointWidth, const Element::GeometryType& Geom)
{
...
template< >
void UPwFaceLoadInterfaceCondition<2,2>::CalculateJointWidth( double& rJointWidth, const bounded_matrix<double,2,4>& Nu,
                                                                        const array_1d<double,4>& DisplacementVector, array_1d<double,2>& rRelDispVector,
                                                                        const bounded_matrix<double,2,2>& RotationMatrix,
...
template< >
void UPwFaceLoadInterfaceCondition<3,4>::CalculateJointWidth( double& rJointWidth, const bounded_matrix<double,3,12>& Nu,
                                                                        const array_1d<double,12>& DisplacementVector, array_1d<double,3>& rRelDispVector,
                                                                        const bounded_matrix<double,3,3>& RotationMatrix,
