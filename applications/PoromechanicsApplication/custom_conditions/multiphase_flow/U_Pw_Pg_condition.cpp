...
Condition::Pointer UPwPgCondition<TDim,TNumNodes>::Create(IndexType NewId,NodesArrayType const& ThisNodes,PropertiesType::Pointer pProperties) const
{
    return Condition::Pointer(new UPwPgCondition(NewId, GetGeometry().Create(ThisNodes), pProperties));
}

//----------------------------------------------------------------------------------------

template< >
void UPwPgCondition<2,1>::GetDofList(DofsVectorType& rConditionDofList, const ProcessInfo& rCurrentProcessInfo) const
{
    KRATOS_TRY

    const GeometryType& rGeom = GetGeometry();
    const unsigned int condition_size = 2 + 2;
...
template< >
void UPwPgCondition<2,2>::GetDofList(DofsVectorType& rConditionDofList, const ProcessInfo& rCurrentProcessInfo) const
{
    KRATOS_TRY

    const GeometryType& rGeom = GetGeometry();
    const unsigned int condition_size = 2 * (2 + 2);
    unsigned int index = 0;
...
template< >
void UPwPgCondition<3,1>::GetDofList(DofsVectorType& rConditionDofList, const ProcessInfo& rCurrentProcessInfo) const
{
    KRATOS_TRY

    const GeometryType& rGeom = GetGeometry();
    const unsigned int condition_size = 3 + 2;
    unsigned int index = 0;
...
template< >
void UPwPgCondition<3,3>::GetDofList(DofsVectorType& rConditionDofList, const ProcessInfo& rCurrentProcessInfo) const
{
    KRATOS_TRY
...
template< >
void UPwPgCondition<3,4>::GetDofList(DofsVectorType& rConditionDofList, const ProcessInfo& rCurrentProcessInfo) const
{
    KRATOS_TRY
...
template< unsigned int TDim, unsigned int TNumNodes >
void UPwPgCondition<TDim,TNumNodes>::CalculateLocalSystem( MatrixType& rLeftHandSideMatrix, VectorType& rRightHandSideVector, const ProcessInfo& rCurrentProcessInfo )
{
    KRATOS_TRY
...
template< unsigned int TDim, unsigned int TNumNodes >
void UPwPgCondition<TDim,TNumNodes>::CalculateLeftHandSide( MatrixType& rLeftHandSideMatrix, const ProcessInfo& rCurrentProcessInfo )
{
    KRATOS_TRY;

    KRATOS_THROW_ERROR(std::logic_error,"UPwPgCondition::CalculateLeftHandSide not implemented","");
...
template< unsigned int TDim, unsigned int TNumNodes >
void UPwPgCondition<TDim,TNumNodes>::CalculateRightHandSide( VectorType& rRightHandSideVector, const ProcessInfo& rCurrentProcessInfo )
{
    KRATOS_TRY
...
template< >
void UPwPgCondition<2,1>::EquationIdVector(EquationIdVectorType& rResult,const ProcessInfo& rCurrentProcessInfo) const
{
    KRATOS_TRY
...
template< >
void UPwPgCondition<2,2>::EquationIdVector(EquationIdVectorType& rResult,const ProcessInfo& rCurrentProcessInfo) const
{
    KRATOS_TRY
...
template< >
void UPwPgCondition<3,1>::EquationIdVector(EquationIdVectorType& rResult,const ProcessInfo& rCurrentProcessInfo) const
{
    KRATOS_TRY
...
template< >
void UPwPgCondition<3,3>::EquationIdVector(EquationIdVectorType& rResult,const ProcessInfo& rCurrentProcessInfo) const
{
    KRATOS_TRY
...
template< >
void UPwPgCondition<3,4>::EquationIdVector(EquationIdVectorType& rResult,const ProcessInfo& rCurrentProcessInfo) const
{
    KRATOS_TRY
...
template< unsigned int TDim, unsigned int TNumNodes >
void UPwPgCondition<TDim,TNumNodes>::CalculateAll( MatrixType& rLeftHandSideMatrix, VectorType& rRightHandSideVector, const ProcessInfo& rCurrentProcessInfo )
{
    this->CalculateRHS(rRightHandSideVector,rCurrentProcessInfo);
}
...
template< unsigned int TDim, unsigned int TNumNodes >
void UPwPgCondition<TDim,TNumNodes>::CalculateRHS( VectorType& rRightHandSideVector, const ProcessInfo& rCurrentProcessInfo )
{
    KRATOS_TRY
...
template class UPwPgCondition<2,1>;
template class UPwPgCondition<2,2>;
template class UPwPgCondition<3,1>;
template class UPwPgCondition<3,3>;
template class UPwPgCondition<3,4>;
