...
class KRATOS_API(POROMECHANICS_APPLICATION) UPlPgNormalGasFluxCondition : public UPlPgFaceLoadCondition<TDim,TNumNodes>
{

public:

    KRATOS_CLASS_POINTER_DEFINITION( UPlPgNormalGasFluxCondition );
...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    // Default constructor
    UPlPgNormalGasFluxCondition() : UPlPgFaceLoadCondition<TDim,TNumNodes>() {}
    
    // Constructor 1
    UPlPgNormalGasFluxCondition( IndexType NewId, GeometryType::Pointer pGeometry ) : UPlPgFaceLoadCondition<TDim,TNumNodes>(NewId, pGeometry) {}
    
    // Constructor 2
    UPlPgNormalGasFluxCondition( IndexType NewId, GeometryType::Pointer pGeometry, PropertiesType::Pointer pProperties ) : UPlPgFaceLoadCondition<TDim,TNumNodes>(NewId, pGeometry, pProperties) {}
