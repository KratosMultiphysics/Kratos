...
template< >
void UPlPgCondition<2,1>::GetDofList(DofsVectorType& rConditionDofList, const ProcessInfo& rCurrentProcessInfo) const
{
    KRATOS_TRY
...
template< >
void UPlPgCondition<2,2>::GetDofList(DofsVectorType& rConditionDofList, const ProcessInfo& rCurrentProcessInfo) const
{
    KRATOS_TRY
...
template< >
void UPlPgCondition<3,1>::GetDofList(DofsVectorType& rConditionDofList, const ProcessInfo& rCurrentProcessInfo) const
{
    KRATOS_TRY
...
template< >
void UPlPgCondition<3,3>::GetDofList(DofsVectorType& rConditionDofList, const ProcessInfo& rCurrentProcessInfo) const
{
    KRATOS_TRY
...
template< >
void UPlPgCondition<3,4>::GetDofList(DofsVectorType& rConditionDofList, const ProcessInfo& rCurrentProcessInfo) const
{
    KRATOS_TRY
...
// TODO
template< unsigned int TDim, unsigned int TNumNodes >
void UPlPgCondition<TDim,TNumNodes>::AddExplicitContribution(
