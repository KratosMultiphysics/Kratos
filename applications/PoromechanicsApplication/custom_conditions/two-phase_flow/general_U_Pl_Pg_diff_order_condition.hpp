...
#if !defined(KRATOS_GENERAL_U_PL_PG_DIFF_ORDER_CONDITION_H_INCLUDED )
#define  KRATOS_GENERAL_U_PL_PG_DIFF_ORDER_CONDITION_H_INCLUDED
...
class KRATOS_API(POROMECHANICS_APPLICATION) GeneralUPlPgDiffOrderCondition : public Condition
{

public:

    KRATOS_CLASS_POINTER_DEFINITION( GeneralUPlPgDiffOrderCondition );

//----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

    // Default constructor
    GeneralUPlPgDiffOrderCondition();

    // Constructor 1
    GeneralUPlPgDiffOrderCondition( IndexType NewId, GeometryType::Pointer pGeometry );

    // Constructor 2
    GeneralUPlPgDiffOrderCondition( IndexType NewId, GeometryType::Pointer pGeometry, PropertiesType::Pointer pProperties );

    // Destructor
    virtual ~GeneralUPlPgDiffOrderCondition();
...
}; // class GeneralUPlPgDiffOrderCondition.

} // namespace Kratos.

#endif // KRATOS_GENERAL_U_PL_PG_DIFF_ORDER_CONDITION_H_INCLUDED defined
