...
#if !defined(KRATOS_U_PL_PG_FACE_LOAD_INTERFACE_CONDITION_H_INCLUDED )
#define  KRATOS_U_PL_PG_FACE_LOAD_INTERFACE_CONDITION_H_INCLUDED
...
class KRATOS_API(POROMECHANICS_APPLICATION) UPlPgFaceLoadInterfaceCondition : public UPlPgCondition<TDim,TNumNodes>
{

public:

    KRATOS_CLASS_POINTER_DEFINITION( UPlPgFaceLoadInterfaceCondition );
...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    // Default constructor
    UPlPgFaceLoadInterfaceCondition() : UPlPgCondition<TDim,TNumNodes>() {}

    // Constructor 1
    UPlPgFaceLoadInterfaceCondition( IndexType NewId, GeometryType::Pointer pGeometry ) : UPlPgCondition<TDim,TNumNodes>(NewId, pGeometry) {}

    // Constructor 2
    UPlPgFaceLoadInterfaceCondition( IndexType NewId, GeometryType::Pointer pGeometry, PropertiesType::Pointer pProperties ) : UPlPgCondition<TDim,TNumNodes>(NewId, pGeometry, pProperties)
    {
    ...
    // Destructor
    ~UPlPgFaceLoadInterfaceCondition() override {}
...
}; // class UPlPgFaceLoadInterfaceCondition.

} // namespace Kratos.

#endif // KRATOS_U_PL_PG_FACE_LOAD_INTERFACE_CONDITION_H_INCLUDED defined
