...
#include "custom_conditions/two-phase_flow/multiphase_flow/U_Pl_Pg_face_load_condition.hpp"
...
public:
    ...
    KRATOS_CLASS_POINTER_DEFINITION( UPlPgNormalLiquidFluxCondition );
