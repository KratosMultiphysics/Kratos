...
class KRATOS_API(POROMECHANICS_APPLICATION) LineNormalGasFlux2DDiffOrderCondition : public GeneralUPlPgDiffOrderCondition
{
...
private:
    ...
    {
        KRATOS_SERIALIZE_SAVE_BASE_CLASS( rSerializer, GeneralUPlPgDiffOrderCondition )
    }

    void load(Serializer& rSerializer) override
    {
        KRATOS_SERIALIZE_LOAD_BASE_CLASS( rSerializer, GeneralUPlPgDiffOrderCondition )
    }
