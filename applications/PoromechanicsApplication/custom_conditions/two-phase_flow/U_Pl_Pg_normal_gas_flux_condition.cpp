...
#include "custom_conditions/two-phase_flow/multiphase_flow/U_Pl_Pg_normal_gas_flux_condition.hpp"
...
template< unsigned int TDim, unsigned int TNumNodes >
void UPlPgNormalGasFluxCondition<TDim,TNumNodes>::CalculateRHS( VectorType& rRightHandSideVector, const ProcessInfo& rCurrentProcessInfo )
{        
...
template< unsigned int TDim, unsigned int TNumNodes >
void UPlPgNormalGasFluxCondition<TDim,TNumNodes>::CalculateAndAddRHS(VectorType& rRightHandSideVector, NormalLiquidFluxVariables& rVariables)
{
