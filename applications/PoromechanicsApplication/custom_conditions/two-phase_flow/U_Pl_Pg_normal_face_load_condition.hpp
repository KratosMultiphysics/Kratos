...
#if !defined(KRATOS_U_PL_PG_NORMAL_FACE_LOAD_CONDITION_H_INCLUDED )
#define  KRATOS_U_PL_PG_NORMAL_FACE_LOAD_CONDITION_H_INCLUDED
...
class KRATOS_API(POROMECHANICS_APPLICATION) UPlPgNormalFaceLoadCondition : public UPlPgCondition<TDim,TNumNodes>
{

public:

    KRATOS_CLASS_INTRUSIVE_POINTER_DEFINITION( UPlPgNormalFaceLoadCondition );
...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    // Default constructor
    UPlPgNormalFaceLoadCondition() : UPlPgCondition<TDim,TNumNodes>() {}
    
    // Constructor 1
    UPlPgNormalFaceLoadCondition( IndexType NewId, GeometryType::Pointer pGeometry ) : UPlPgCondition<TDim,TNumNodes>(NewId, pGeometry) {}
    
    // Constructor 2
    UPlPgNormalFaceLoadCondition( IndexType NewId, GeometryType::Pointer pGeometry, PropertiesType::Pointer pProperties ) : UPlPgCondition<TDim,TNumNodes>(NewId, pGeometry, pProperties) {}

    // Destructor
    ~UPlPgNormalFaceLoadCondition() override {}
...
}; // class UPlPgNormalFaceLoadCondition.

} // namespace Kratos.

#endif // KRATOS_U_PL_PG_NORMAL_FACE_LOAD_CONDITION_H_INCLUDED defined 
