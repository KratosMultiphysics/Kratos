...
KRATOS_DEFINE_APPLICATION_VARIABLE( POROMECHANICS_APPLICATION, Vector, INITIAL_STRESS_VECTOR )
KRATOS_DEFINE_APPLICATION_VARIABLE( POROMECHANICS_APPLICATION, int, STEP_INITIAL_STRESS )
