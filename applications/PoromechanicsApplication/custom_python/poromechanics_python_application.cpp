...
PYBIND11_MODULE(KratosPoromechanicsApplication, m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE( m, DT_GAS_PRESSURE_COEFFICIENT )
    ...
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS( m, GAS_FLUX_VECTOR )
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS( m, LOCAL_GAS_FLUX_VECTOR )
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE( m, LIQUID_PERMEABILITY_MATRIX )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE( m, GAS_PERMEABILITY_MATRIX )
    ...
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS( m, GAS_PRESSURE_GRADIENT )
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE( m, NODAL_SLIP_TENDENCY )
