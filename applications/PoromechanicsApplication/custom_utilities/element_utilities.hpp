...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    static inline void CalculateNuMatrix(bounded_matrix<double,2,6>& rNu, const Matrix& Ncontainer, const unsigned int& GPoint)
    {
        //Triangle_2d_3
...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    static inline void CalculateNuElementMatrix(bounded_matrix<double,3,9>& rNut, const Matrix& Ncontainer, const unsigned int& GPoint)
    {
        //Triangle_2d_3
    ...
    static inline void CalculateNuElementMatrix(bounded_matrix<double,4,16>& rNut, const Matrix& Ncontainer, const unsigned int& GPoint)
    {
        //Tetrahedra_3d_4
...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    static inline void InvertMatrix2(bounded_matrix<double,2,2>& rInvertedMatrix,
                                    const bounded_matrix<double,2,2>& InputMatrix)
    {
...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    static inline void AssembleUBlockMatrix(Matrix& rLeftHandSideMatrix, const bounded_matrix<double,6,6>& UBlockMatrix)
    {        
        //Triangle_2d_3
    ...
    static inline void AssembleUBlockMatrix(Matrix& rLeftHandSideMatrix, const bounded_matrix<double,8,8>& UBlockMatrix)
    {        
        //Quadrilateral_2d_4
        unsigned int Global_i, Global_j, Local_i, Local_j;
    ...
    static inline void AssembleUBlockMatrix(Matrix& rLeftHandSideMatrix, const bounded_matrix<double,12,12>& UBlockMatrix)
    {
        //Tetrahedra_3d_4
        unsigned int Global_i, Global_j, Local_i, Local_j;
    ...
    static inline void AssembleUBlockMatrix(Matrix& rLeftHandSideMatrix, const bounded_matrix<double,18,18>& UBlockMatrix)
    {        
        //Prism_3d_6
        unsigned int Global_i, Global_j, Local_i, Local_j;
    ...
    static inline void AssembleUBlockMatrix(Matrix& rLeftHandSideMatrix, const bounded_matrix<double,24,24>& UBlockMatrix)
    {
        //Hexahedra_3d_8
        unsigned int Global_i, Global_j, Local_i, Local_j;
    ...
    static inline void AssembleUPBlockMatrix(Matrix& rLeftHandSideMatrix, const bounded_matrix<double,6,3>& UPBlockMatrix)
    {
        //Triangle_2d_3
    ...
    static inline void AssembleUPBlockMatrix(Matrix& rLeftHandSideMatrix, const bounded_matrix<double,8,4>& UPBlockMatrix)
    {        
        //Quadrilateral_2d_4
        unsigned int Global_i, Global_j, Local_i;
    ...
    static inline void AssembleUPBlockMatrix(Matrix& rLeftHandSideMatrix, const bounded_matrix<double,12,4>& UPBlockMatrix)
    {
        //Tetrahedra_3d_4
        unsigned int Global_i, Global_j, Local_i;
    ...
    static inline void AssembleUPBlockMatrix(Matrix& rLeftHandSideMatrix, const bounded_matrix<double,18,6>& UPBlockMatrix)
    {
        //Prism_3d_6
        unsigned int Global_i, Global_j, Local_i;
    ...
    static inline void AssembleUPBlockMatrix(Matrix& rLeftHandSideMatrix, const bounded_matrix<double,24,8>& UPBlockMatrix)
    {        
        //Hexahedra_3d_8
        unsigned int Global_i, Global_j, Local_i;
    ...
    static inline void AssemblePUBlockMatrix(Matrix& rLeftHandSideMatrix, const bounded_matrix<double,3,6>& PUBlockMatrix)
    {        
        //Triangle_2d_3
    ...
    static inline void AssemblePUBlockMatrix(Matrix& rLeftHandSideMatrix, const bounded_matrix<double,4,8>& PUBlockMatrix)
    {        
        //Quadrilateral_2d_4
        unsigned int Global_i, Global_j, Local_j;
    ...
    static inline void AssemblePUBlockMatrix(Matrix& rLeftHandSideMatrix, const bounded_matrix<double,4,12>& PUBlockMatrix)
    {
        //Tetrahedra_3d_4
        unsigned int Global_i, Global_j, Local_j;
    ...
    static inline void AssemblePUBlockMatrix(Matrix& rLeftHandSideMatrix, const bounded_matrix<double,6,18>& PUBlockMatrix)
    {
        //Prism_3d_6
        unsigned int Global_i, Global_j, Local_j;
    ...
    static inline void AssemblePUBlockMatrix(Matrix& rLeftHandSideMatrix, const bounded_matrix<double,8,24>& PUBlockMatrix)
    {        
        //Hexahedra_3d_8
        unsigned int Global_i, Global_j, Local_j;
...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    static inline void CalculateExtrapolationMatrix(bounded_matrix<double,4,4>& rExtrapolationMatrix)
    {
        //Quadrilateral_2d_4
        //GI_GAUSS_2
    ...
    static inline void CalculateExtrapolationMatrix(bounded_matrix<double,8,8>& rExtrapolationMatrix)
    {
        //Hexahedra_3d_8
        //GI_GAUSS_2
