...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    static inline void CalculateNuMatrix(bounded_matrix<double,2,4>& rNu, const Matrix& Ncontainer, const unsigned int& GPoint)
    {
        //Line_interface_2d_2
    ...
    static inline void CalculateNuMatrix(bounded_matrix<double,2,8>& rNu, const Matrix& Ncontainer, const unsigned int& GPoint)
    {
    ...
    static inline void CalculateNuMatrix(bounded_matrix<double,3,12>& rNu, const Matrix& Ncontainer, const unsigned int& GPoint)
    {
    ...
    static inline void CalculateNuMatrix(bounded_matrix<double,3,18>& rNu, const Matrix& Ncontainer, const unsigned int& GPoint)
    {
    ...
    static inline void CalculateNuMatrix(bounded_matrix<double,3,24>& rNu, const Matrix& Ncontainer, const unsigned int& GPoint)
    {
...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    static inline void CalculateNuElementMatrix(bounded_matrix<double,3,12>& rNut, const Matrix& Ncontainer, const unsigned int& GPoint)
    {
        //Quadrilateral_interface_2d_4
    ...
    static inline void CalculateNuElementMatrix(bounded_matrix<double,4,24>& rNut, const Matrix& Ncontainer, const unsigned int& GPoint)
    {
        //Prism_interface_3d_6
    ...
    static inline void CalculateNuElementMatrix(bounded_matrix<double,4,32>& rNut, const Matrix& Ncontainer, const unsigned int& GPoint)
    {
        //Hexahedral_interface_3d_8
...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    static inline void CalculatePermeabilityMatrix(bounded_matrix<double,2,2>& rPermeabilityMatrix,
    ...
    static inline void CalculatePermeabilityMatrix(bounded_matrix<double,3,3>& rPermeabilityMatrix,
                                                    const double& JointWidth, const double& Transversal_Permeability)
    {
...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    static inline void CalculateLinkPermeabilityMatrix(bounded_matrix<double,2,2>& rPermeabilityMatrix,
    ...
    static inline void CalculateLinkPermeabilityMatrix(bounded_matrix<double,3,3>& rPermeabilityMatrix,
                                                    const double& JointWidth)
    {
        //Prism_interface_3d_6 & Hexahedral_interface_3d_8
        rPermeabilityMatrix(0,0) = JointWidth*JointWidth/12.0;
