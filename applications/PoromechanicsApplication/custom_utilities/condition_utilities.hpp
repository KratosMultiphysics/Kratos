...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    static inline void CalculateNuMatrix(bounded_matrix<double,3,9>& rNu, const Matrix& Ncontainer, const unsigned int& GPoint)
    {
        //Triangle_3d_3
...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------   
	...
	static inline void AssembleUPMatrix(Matrix& rLeftHandSideMatrix, const bounded_matrix<double,4,2>& UPBlockMatrix)
    {        
        //Line_2d_2
...
//----------------------------------------------------------------------------------------
	...
	static inline void AssembleUPMatrix(Matrix& rLeftHandSideMatrix, const bounded_matrix<double,9,3>& UPBlockMatrix)
    {
        //Triangle_3d_3  
        unsigned int Global_i, Global_j, Local_i;
...
//----------------------------------------------------------------------------------------
	...
	static inline void AssembleUPMatrix(Matrix& rLeftHandSideMatrix, const bounded_matrix<double,12,4>& UPBlockMatrix)
    {
        //Quadrilateral_3d_4
        unsigned int Global_i, Global_j, Local_i;
...
//----------------------------------------------------------------------------------------
	...
	static inline void AssemblePUMatrix(Matrix& rLeftHandSideMatrix, const bounded_matrix<double,2,4>& PUBlockMatrix)
    {        
        //Line_2d_2
...
//----------------------------------------------------------------------------------------
	...
	static inline void AssemblePUMatrix(Matrix& rLeftHandSideMatrix, const bounded_matrix<double,3,9>& PUBlockMatrix)
    {
        //Triangle_3d_3 
        unsigned int Global_i, Global_j, Local_j;
...
//----------------------------------------------------------------------------------------
	...
	static inline void AssemblePUMatrix(Matrix& rLeftHandSideMatrix, const bounded_matrix<double,4,12>& PUBlockMatrix)
    {
        //Quadrilateral_3d_4
        unsigned int Global_i, Global_j, Local_j;
