...
#if !defined(KRATOS_TRILINOS_NEWMARK_DYNAMIC_U_PW_SCHEME )
#define  KRATOS_TRILINOS_NEWMARK_DYNAMIC_U_PW_SCHEME
...
class TrilinosNewmarkDynamicUPwScheme : public NewmarkDynamicUPwScheme<TSparseSpace,TDenseSpace>
{

public:

    KRATOS_CLASS_POINTER_DEFINITION( TrilinosNewmarkDynamicUPwScheme );
...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    ///Constructor
    TrilinosNewmarkDynamicUPwScheme(double beta, double gamma, double theta, double rayleigh_m, double rayleigh_k)
        : NewmarkDynamicUPwScheme<TSparseSpace,TDenseSpace>(beta, gamma, theta, rayleigh_m, rayleigh_k),
        mImporterIsInitialized(false) {}

    //------------------------------------------------------------------------------------
    
    ///Destructor
    ~TrilinosNewmarkDynamicUPwScheme() override {}
...
#endif // KRATOS_TRILINOS_NEWMARK_DYNAMIC_U_PW_SCHEME defined