...
#if !defined(KRATOS_PORO_NEWMARK_QUASISTATIC_U_PW_PG_SCHEME )
#define  KRATOS_PORO_NEWMARK_QUASISTATIC_U_PW_PG_SCHEME
...
class PoroNewmarkQuasistaticUPwPgScheme : public Scheme<TSparseSpace,TDenseSpace>
{

public:

    KRATOS_CLASS_POINTER_DEFINITION( PoroNewmarkQuasistaticUPwPgScheme );
...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    ///Constructor
    PoroNewmarkQuasistaticUPwPgScheme(double beta, double gamma, double theta) : Scheme<TSparseSpace,TDenseSpace>()
    {
        mBeta = beta;
        mGamma = gamma;
        mTheta = theta;
    ...
    ///Destructor
    ~PoroNewmarkQuasistaticUPwPgScheme() override {}
...
}; // Class PoroNewmarkQuasistaticUPwPgScheme
}  // namespace Kratos

#endif // KRATOS_PORO_NEWMARK_QUASISTATIC_U_PW_PG_SCHEME defined
