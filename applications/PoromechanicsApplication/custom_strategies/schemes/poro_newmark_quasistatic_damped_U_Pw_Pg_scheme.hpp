...
#if !defined(KRATOS_PORO_NEWMARK_QUASISTATIC_DAMPED_U_PW_PG_SCHEME )
#define  KRATOS_PORO_NEWMARK_QUASISTATIC_DAMPED_U_PW_PG_SCHEME
...
class PoroNewmarkQuasistaticDampedUPwPgScheme : public PoroNewmarkQuasistaticUPwPgScheme<TSparseSpace,TDenseSpace>
{

public:

    KRATOS_CLASS_POINTER_DEFINITION( PoroNewmarkQuasistaticDampedUPwPgScheme );
...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    ///Constructor
    PoroNewmarkQuasistaticDampedUPwPgScheme(double beta, double gamma, double theta)
    ...
    ///Destructor
    ~PoroNewmarkQuasistaticDampedUPwPgScheme() override {}
...
}; // Class PoroNewmarkQuasistaticDampedUPwPgScheme
}  // namespace Kratos

#endif // KRATOS_PORO_NEWMARK_QUASISTATIC_DAMPED_U_PW_PG_SCHEME defined
