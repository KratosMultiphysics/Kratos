...
public:
    ...
    using PoroNewmarkQuasistaticUPlPgScheme<TSparseSpace,TDenseSpace>::mTheta;

//----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

    ///Constructor
    PoroNewmarkDynamicUPlPgScheme(double beta, double gamma, double theta)
        : PoroNewmarkQuasistaticUPlPgScheme<TSparseSpace,TDenseSpace>(beta, gamma, theta)
    {
