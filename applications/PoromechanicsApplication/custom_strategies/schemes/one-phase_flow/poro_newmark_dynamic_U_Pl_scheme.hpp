...
public:
    ...
    using PoroNewmarkQuasistaticUPlScheme<TSparseSpace,TDenseSpace>::mTheta;

//----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

    ///Constructor
    PoroNewmarkDynamicUPlScheme(double beta, double gamma, double theta)
        : PoroNewmarkQuasistaticUPlScheme<TSparseSpace,TDenseSpace>(beta, gamma, theta)
    {
