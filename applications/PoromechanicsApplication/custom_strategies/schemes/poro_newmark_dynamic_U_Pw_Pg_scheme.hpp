...
#if !defined(KRATOS_PORO_NEWMARK_DYNAMIC_U_PW_PG_SCHEME )
#define  KRATOS_PORO_NEWMARK_DYNAMIC_U_PG_PW_SCHEME
...
class PoroNewmarkDynamicUPwPgScheme : public PoroNewmarkQuasistaticUPwPgScheme<TSparseSpace,TDenseSpace>
{

public:

    KRATOS_CLASS_POINTER_DEFINITION( PoroNewmarkDynamicUPwPgScheme );
    ...
    using PoroNewmarkQuasistaticUPwPgScheme<TSparseSpace,TDenseSpace>::mDeltaTime;
    using PoroNewmarkQuasistaticUPwPgScheme<TSparseSpace,TDenseSpace>::mBeta;
    using PoroNewmarkQuasistaticUPwPgScheme<TSparseSpace,TDenseSpace>::mGamma;
    using PoroNewmarkQuasistaticUPwPgScheme<TSparseSpace,TDenseSpace>::mTheta;

//----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

    ///Constructor
    PoroNewmarkDynamicUPwPgScheme(double beta, double gamma, double theta)
        : PoroNewmarkQuasistaticUPwPgScheme<TSparseSpace,TDenseSpace>(beta, gamma, theta)
    {
    ...
    ///Destructor
    ~PoroNewmarkDynamicUPwPgScheme() override {}
...
}; // Class PoroNewmarkDynamicUPwPgScheme
}  // namespace Kratos

#endif // KRATOS_PORO_NEWMARK_DYNAMIC_U_PW_PG_SCHEME defined
