...
#if !defined(KRATOS_CSHARP_WRAPPER_APPLICATION_VARIABLES_H_INCLUDED )
#define  KRATOS_CSHARP_WRAPPER_APPLICATION_VARIABLES_H_INCLUDED
...
#endif	/* KRATOS_CSHARP_WRAPPER_APPLICATION_VARIABLES_H_INCLUDED */
