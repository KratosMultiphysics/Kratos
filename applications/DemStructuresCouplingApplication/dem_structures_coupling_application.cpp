...
namespace Kratos {
    ...
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(DEM_SURFACE_LOAD_OLD)
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(DEM_SURFACE_LOAD_OLD2)
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(CURRENT_STRUCTURAL_VELOCITY)
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(CURRENT_STRUCTURAL_DISPLACEMENT)
    ...
    void KratosDemStructuresCouplingApplication::Register() {
        ...
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(DEM_SURFACE_LOAD_OLD)
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(DEM_SURFACE_LOAD_OLD2)
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(CURRENT_STRUCTURAL_VELOCITY)
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(CURRENT_STRUCTURAL_DISPLACEMENT)
