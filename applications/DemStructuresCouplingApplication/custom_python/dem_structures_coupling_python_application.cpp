...
PYBIND11_MODULE(KratosDemStructuresCouplingApplication, m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, DEM_SURFACE_LOAD_OLD)
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, DEM_SURFACE_LOAD_OLD2)
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, CURRENT_STRUCTURAL_VELOCITY)
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, CURRENT_STRUCTURAL_DISPLACEMENT)
}
