...
KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS( FLUID_RVE_LAGRANGE_MULTIPLIERS_APPLICATION, LAGRANGE_MULTIPLIER_NORMAL_VELOCITY)
KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS( FLUID_RVE_LAGRANGE_MULTIPLIERS_APPLICATION, REYNOLDS_STRESS_2D)
KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS( FLUID_RVE_LAGRANGE_MULTIPLIERS_APPLICATION, BOUNDARY_TILDA_TILDA_STRESS_2D)
KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS( FLUID_RVE_LAGRANGE_MULTIPLIERS_APPLICATION, LAGRANGE_MULTIPLIER_VELOCITY)
KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS( FLUID_RVE_LAGRANGE_MULTIPLIERS_APPLICATION, LAGRANGE_MULTIPLIER_VELOCITY_GRADIENTS)

	// Variables definition 

KRATOS_DEFINE_APPLICATION_VARIABLE( FLUID_RVE_LAGRANGE_MULTIPLIERS_APPLICATION, int,  NODE_PAIR_X_COMPONENT)
KRATOS_DEFINE_APPLICATION_VARIABLE( FLUID_RVE_LAGRANGE_MULTIPLIERS_APPLICATION, int,  NODE_PAIR_Y_COMPONENT)
KRATOS_DEFINE_APPLICATION_VARIABLE( FLUID_RVE_LAGRANGE_MULTIPLIERS_APPLICATION, int,  NODE_PAIR_Z_COMPONENT)

KRATOS_DEFINE_APPLICATION_VARIABLE( FLUID_RVE_LAGRANGE_MULTIPLIERS_APPLICATION, int,  NODE_PAIR_PRESSURE)

KRATOS_DEFINE_APPLICATION_VARIABLE( FLUID_RVE_LAGRANGE_MULTIPLIERS_APPLICATION, int,  NODE_PAIR_X_COMPONENT_ANTIPERIODIC)
KRATOS_DEFINE_APPLICATION_VARIABLE( FLUID_RVE_LAGRANGE_MULTIPLIERS_APPLICATION, int,  NODE_PAIR_Y_COMPONENT_ANTIPERIODIC)
KRATOS_DEFINE_APPLICATION_VARIABLE( FLUID_RVE_LAGRANGE_MULTIPLIERS_APPLICATION, int,  NODE_PAIR_Z_COMPONENT_ANTIPERIODIC)

KRATOS_DEFINE_APPLICATION_VARIABLE( FLUID_RVE_LAGRANGE_MULTIPLIERS_APPLICATION, double,  LAGRANGE_MULTIPLIER_TANGENT_VELOCITY)
