...
##        self.pressure_linear_solver =  BICGSTABSolver(1e-4, 5000,pILUPrecond)
        ...
        self.extrapolation_type = 1  #2 = implicit extrapolation -- #1 = explicit
    ...
    def Initialize(self):
        ...
        if( self.extrapolation_type == 2):
            ...
            laplacian_form = 3; #1 = laplacian, 2 = Discrete Laplacian
            predictor_corrector = True;
            self.extrapolation_solver = ResidualBasedFluidStrategy(self.extrapolation_model_part,self.velocity_linear_solver,self.pressure_linear_solver, CalculateReactions, ReformDofAtEachIteration, CalculateNormDxFlag, vel_toll, press_toll, max_vel_its, self.extrapolation_max_press_its, time_order, self.domain_size, laplacian_form, predictor_corrector)   
