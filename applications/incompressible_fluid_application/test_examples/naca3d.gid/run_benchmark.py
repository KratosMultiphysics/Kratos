...
if(SolverType == "fractional_step"):
    ...
    fluid_solver.pressure_linear_solver =  BICGSTABSolver(1e-9, 5000,pPrecond)
    fluid_solver.velocity_linear_solver =  BICGSTABSolver(1e-9, 5000,pPrecond)
    fluid_solver.max_vel_its = 10
...
full_Dt = Dt 
initial_Dt = 0.1 * full_Dt #0.05 #0.01
