 ...
 */
class MPMUpdatedLagrangianExplicit
    : public Element
{
public:
    ...
    KRATOS_CLASS_INTRUSIVE_POINTER_DEFINITION( MPMUpdatedLagrangianExplicit );
    ///@}
...
public:
    ...
    ///Copy constructor
    MPMUpdatedLagrangianExplicit(MPMUpdatedLagrangianExplicit const& rOther);

    /// Destructor.
    ~MPMUpdatedLagrangianExplicit() override;
    ...
    /// Assignment operator.
    MPMUpdatedLagrangianExplicit& operator=(MPMUpdatedLagrangianExplicit const& rOther);
