...
public:
    ...
    ///Copy constructor
    MPMUpdatedLagrangianUP(
        MPMUpdatedLagrangianUP const& rOther
    );
...
protected:
     ...
     */
    virtual void CalculateAndAddKup(
        MatrixType& rK,
        GeneralVariables & rVariables,
        const double& rIntegrationWeight
    );
     ...
     */
    virtual void CalculateAndAddKpu(
        MatrixType& rK,
        GeneralVariables & rVariables,
        const double& rIntegrationWeight
    );
     ...
     */
    virtual void CalculateAndAddKpp(
        MatrixType& rK,
        GeneralVariables & rVariables,
        const double& rIntegrationWeight
    );
     ...
     */
    virtual void CalculateAndAddKppStab(
        MatrixType& rK,
        GeneralVariables & rVariables,
        const double& rIntegrationWeight
    );
     ...
     */
    virtual void CalculateAndAddPressureForces(
        VectorType& rRightHandSideVector,
        GeneralVariables & rVariables,
        const double& rIntegrationWeight
    );
     ...
     * Calculation of the Internal Forces due to Pressure-Balance
     */
    virtual void CalculateAndAddStabilizedPressure(
        VectorType& rRightHandSideVector,
        GeneralVariables & rVariables,
        const double& rIntegrationWeight
    );
     ...
     */
    virtual double& CalculatePUCoefficient(
        double& rCoefficient,
        GeneralVariables & rVariables
    );
     ...
     */
    virtual double& CalculatePUDeltaCoefficient(
        double& rCoefficient,
        GeneralVariables & rVariables
    );
