...
namespace Python{
    ...
    PYBIND11_MODULE(KratosMPMApplication, m)
    {
        ...
        KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, IS_ADD_NUMERICAL_STIFFNESS);
        ...
        KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, TOTAL_MP_VOLUME);
        KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, VOLUME_RATIO_THRESHOLD);
    }
