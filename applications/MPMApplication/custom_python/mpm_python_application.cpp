...
namespace Python{
    ...
    PYBIND11_MODULE(KratosMPMApplication, m)
    {
        ...
        KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, IS_MIXED_VP);
        KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, CONSTANT1);
        KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, CONSTANT2);
        ...
        KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, RESPROJ_DISPL);
        KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, RESPROJ_PRESS);
        KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, NODAL_AREA);
        KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, NODAL_CAUCHY_STRESS_VECTOR);
