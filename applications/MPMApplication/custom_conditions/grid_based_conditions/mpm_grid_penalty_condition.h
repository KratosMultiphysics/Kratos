...
class KRATOS_API(PARTICLE_MECHANICS_APPLICATION) MPMGridPenaltyCondition : public Condition
{
public:
    ///@name Type Definitions
    ///@{

    /// Pointer definition of MPMGridPenaltyCondition
    KRATOS_CLASS_INTRUSIVE_POINTER_DEFINITION(MPMGridPenaltyCondition);
    ...
    /// Copy constructor.
    MPMGridPenaltyCondition(
        MPMGridPenaltyCondition const& rOther
        ):Condition(rOther)
    {
    }

    /// Destructor.
    ~MPMGridPenaltyCondition() override {}
    ...
    /// Assignment operator
    MPMGridPenaltyCondition & operator=(MPMGridPenaltyCondition const& rOther)
    {
    ...
    /// Create a new MPMGridPenaltyCondition object.
    /**
      @param NewId Index of the new condition
      @param ThisNodes An array containing the nodes of the new condition
      @param pProperties Pointer to the element's properties
    ...
    {
        return Kratos::make_intrusive<MPMGridPenaltyCondition>(NewId, GetGeometry().Create(ThisNodes), pProperties);
    }
    ...
    {
        return Kratos::make_intrusive<MPMGridPenaltyCondition>(NewId, pGeom, pProperties);
    }
