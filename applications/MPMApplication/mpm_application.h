...
private:
    ...
    const MPMGridNavierSlipFrictionCondition<2,2> mMPMGridNavierSlipFrictionCondition2D;
    const MPMGridNavierSlipFrictionCondition<3,3> mMPMGridNavierSlipFrictionCondition3D;
    // MPM Conditions:
