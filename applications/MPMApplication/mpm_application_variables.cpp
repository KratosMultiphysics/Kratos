...
namespace Kratos
{
    ...
    KRATOS_CREATE_VARIABLE(bool, IS_MIXED_VP)
    KRATOS_CREATE_VARIABLE(double, CONSTANT1)
    KRATOS_CREATE_VARIABLE(double, CONSTANT2)
    ...
    //OSGS stabilization
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS( RESPROJ_DISPL )
    KRATOS_CREATE_VARIABLE( double, RESPROJ_PRESS )
    ...
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS( NODAL_CAUCHY_STRESS_VECTOR )
