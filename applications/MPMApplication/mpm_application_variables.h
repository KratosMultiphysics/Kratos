...
namespace Kratos
{
    ...
    // Velocity gradient
    KRATOS_DEFINE_APPLICATION_VARIABLE( MPM_APPLICATION, Matrix, MP_VELOCITY_GRADIENT )
    // Acceleration gradient
    KRATOS_DEFINE_APPLICATION_VARIABLE( MPM_APPLICATION, Matrix, MP_ACCELERATION_GRADIENT )
