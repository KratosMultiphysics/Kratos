...
namespace Kratos
{
    ...
    KRATOS_DEFINE_APPLICATION_VARIABLE( MPM_APPLICATION, bool, IS_MIXED_VP )
    KRATOS_DEFINE_APPLICATION_VARIABLE( MPM_APPLICATION, double, CONSTANT1)
    KRATOS_DEFINE_APPLICATION_VARIABLE( MPM_APPLICATION, double, CONSTANT2)
    ...
    KRATOS_DEFINE_APPLICATION_VARIABLE(MPM_APPLICATION, bool, IS_DYNAMIC)
    KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS(MPM_APPLICATION, RESPROJ_DISPL)
    KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS(MPM_APPLICATION, NODAL_CAUCHY_STRESS_VECTOR)
    KRATOS_DEFINE_APPLICATION_VARIABLE(MPM_APPLICATION, double, RESPROJ_PRESS)
    KRATOS_DEFINE_APPLICATION_VARIABLE(MPM_APPLICATION, double, NODAL_AREA)
