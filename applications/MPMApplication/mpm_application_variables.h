...
namespace Kratos
{
    ...
    KRATOS_DEFINE_APPLICATION_VARIABLE(MPM_APPLICATION, bool, IS_PENETRATING)
    KRATOS_DEFINE_APPLICATION_VARIABLE(MPM_APPLICATION, double, PENETRATION)
    KRATOS_DEFINE_APPLICATION_VARIABLE(MPM_APPLICATION, bool, CONTACT_ACTIVE)
}
