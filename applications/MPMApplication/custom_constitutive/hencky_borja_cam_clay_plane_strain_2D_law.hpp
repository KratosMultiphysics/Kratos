...
#if !defined (KRATOS_HENCKY_BORJA_CAM_CLAY_PLASTIC_PLANE_STRAIN_2D_LAW_H_INCLUDED)
#define       KRATOS_HENCKY_BORJA_CAM_CLAY_PLASTIC_PLANE_STRAIN_2D_LAW_H_INCLUDED
...
class KRATOS_API(MPM_APPLICATION) HenckyBorjaCamClayPlasticPlaneStrain2DLaw
...
public:
     ...
     * Default constructor.
     */
    HenckyBorjaCamClayPlasticPlaneStrain2DLaw();


    HenckyBorjaCamClayPlasticPlaneStrain2DLaw(MPMFlowRulePointer pMPMFlowRule, YieldCriterionPointer pYieldCriterion, HardeningLawPointer pHardeningLaw);

    /**
     * Copy constructor.
     */
    HenckyBorjaCamClayPlasticPlaneStrain2DLaw (const HenckyBorjaCamClayPlasticPlaneStrain2DLaw& rOther);
     ...
     * Destructor.
     */
    ~HenckyBorjaCamClayPlasticPlaneStrain2DLaw() override;
...
#endif // KRATOS_HENCKY_BORJA_CAM_CLAY_PLASTIC_PLANE_STRAIN_2D_LAW_H_INCLUDED defined
