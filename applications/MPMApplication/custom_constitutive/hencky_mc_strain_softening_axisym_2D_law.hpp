...
#if !defined (KRATOS_HENCKY_MC_STRAIN_SOFTENING_PLASTIC_AXISYM_2D_LAW_H_INCLUDED)
#define       KRATOS_HENCKY_MC_STRAIN_SOFTENING_PLASTIC_AXISYM_2D_LAW_H_INCLUDED
...
class KRATOS_API(MPM_APPLICATION) HenckyMCStrainSofteningPlasticAxisym2DLaw
...
public:
     ...
     * Default constructor.
     */
    HenckyMCStrainSofteningPlasticAxisym2DLaw();


    HenckyMCStrainSofteningPlasticAxisym2DLaw(FlowRulePointer pMPMFlowRule, YieldCriterionPointer pYieldCriterion, HardeningLawPointer pHardeningLaw);

    /**
     * Copy constructor.
     */
    HenckyMCStrainSofteningPlasticAxisym2DLaw (const HenckyMCStrainSofteningPlasticAxisym2DLaw& rOther);
     ...
     * Destructor.
     */
    virtual ~HenckyMCStrainSofteningPlasticAxisym2DLaw();
...
#endif // KRATOS_HENCKY_MC_STRAIN_SOFTENING_PLASTIC_AXISYM_2D_LAW_H_INCLUDED defined
