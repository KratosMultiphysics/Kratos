...
from test_mpm_reaction_output_process       import TestMPMReactionOutputProcess       as TTestMPMReactionOutputProcess
...
def AssembleTestSuites():
    ...
    smallSuite.addTests(KratosUnittest.TestLoader().loadTestsFromTestCases([TTestMPMReactionOutputProcess]))
