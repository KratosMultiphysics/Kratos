...
void PrepareBackgroundModelPart(ModelPart& rBackgroundModelPart, const int caseIndex )
{
    ...
    else if (element == "Element3D4N")
    {
        ...
        // Grid elements
        rBackgroundModelPart.CreateNewElement(element,  1, { 2,  6,  8,  1}, nullptr);
        ...
        rBackgroundModelPart.CreateNewElement(element, 14, { 8,  7,  4, 11}, nullptr);
        rBackgroundModelPart.CreateNewElement(element, 15, {20, 15, 11,  8}, nullptr);
        rBackgroundModelPart.CreateNewElement(element, 16, { 8,  6, 15, 11}, nullptr);
        rBackgroundModelPart.CreateNewElement(element, 17, { 8, 20, 17, 11}, nullptr);
        ...
        rBackgroundModelPart.CreateNewElement(element, 20, { 8,  6, 14, 22}, nullptr);
        rBackgroundModelPart.CreateNewElement(element, 21, {20, 25, 22,  8}, nullptr);
        rBackgroundModelPart.CreateNewElement(element, 22, { 8, 18, 25, 22}, nullptr);
        rBackgroundModelPart.CreateNewElement(element, 23, { 8, 20, 15, 22}, nullptr);
        rBackgroundModelPart.CreateNewElement(element, 24, {18, 14, 22,  8}, nullptr);
        rBackgroundModelPart.CreateNewElement(element, 25, { 3,  7,  8, 10}, nullptr);
        rBackgroundModelPart.CreateNewElement(element, 26, {10,  3,  5,  8}, nullptr);
        rBackgroundModelPart.CreateNewElement(element, 27, {16, 19,  8, 10}, nullptr);
        ...
        rBackgroundModelPart.CreateNewElement(element, 30, {13,  5,  8, 10}, nullptr);
        rBackgroundModelPart.CreateNewElement(element, 31, {13, 19,  8, 21}, nullptr);
        rBackgroundModelPart.CreateNewElement(element, 32, {21, 13,  5,  8}, nullptr);
        rBackgroundModelPart.CreateNewElement(element, 33, {24, 18,  8, 21}, nullptr);
        ...
        rBackgroundModelPart.CreateNewElement(element, 36, {12,  5,  8, 21}, nullptr);
        rBackgroundModelPart.CreateNewElement(element, 37, {19, 26, 23,  8}, nullptr);
        rBackgroundModelPart.CreateNewElement(element, 38, { 8, 19, 16, 23}, nullptr);
        rBackgroundModelPart.CreateNewElement(element, 39, {20, 17, 23,  8}, nullptr);
        rBackgroundModelPart.CreateNewElement(element, 40, { 8,  7, 17, 23}, nullptr);
        rBackgroundModelPart.CreateNewElement(element, 41, { 8, 20, 26, 23}, nullptr);
        ...
        rBackgroundModelPart.CreateNewElement(element, 44, { 8, 18, 24, 27}, nullptr);
        rBackgroundModelPart.CreateNewElement(element, 45, {20, 26, 27,  8}, nullptr);
        rBackgroundModelPart.CreateNewElement(element, 46, { 8, 19, 26, 27}, nullptr);
        rBackgroundModelPart.CreateNewElement(element, 47, { 8, 20, 25, 27}, nullptr);
...
KRATOS_TEST_CASE_IN_SUITE(TestVolumeSumUtility3D4N, KratosMPMFastSuite)
{
    ...
    ModelPart& r_mpm_model_part = current_model.CreateModelPart("MPMModelPart");
    ModelPart& r_background_model_part = current_model.CreateModelPart("BackgroundModelPart");
    const IndexType grid_case = 30; //3D8N
    PrepareBackgroundModelPart(r_background_model_part, grid_case);
    
    auto initial_geometry1 = r_background_model_part.GetElement(1).pGetGeometry();
    auto initial_geometry2 = r_background_model_part.GetElement(2).pGetGeometry();
    auto initial_geometry3 = r_background_model_part.GetElement(3).pGetGeometry();
    auto initial_geometry4 = r_background_model_part.GetElement(4).pGetGeometry();
    auto rThisIntegrationMethod = GeometryData::IntegrationMethod::GI_GAUSS_1;

    r_mpm_model_part.CreateNewProperties(0);

    PrepareMPMModelPart(r_mpm_model_part, initial_geometry1, rThisIntegrationMethod);
    PrepareMPMModelPart(r_mpm_model_part, initial_geometry2, rThisIntegrationMethod);
    r_mpm_model_part.GetElement(1).SetValuesOnIntegrationPoints(MP_VOLUME, {1.5}, r_mpm_model_part.GetProcessInfo());
    PrepareMPMModelPart(r_mpm_model_part, initial_geometry3, rThisIntegrationMethod);
    PrepareMPMModelPart(r_mpm_model_part, initial_geometry4, rThisIntegrationMethod);
    r_mpm_model_part.GetElement(3).SetValuesOnIntegrationPoints(MP_VOLUME, {2.5}, r_mpm_model_part.GetProcessInfo());
    ...
    Vector ref_grid_volume_vector = ZeroVector(48);
    ref_grid_volume_vector[0] = 1.0;
    ref_grid_volume_vector[1] = 1.5;
    ref_grid_volume_vector[2] = 1.0;
    ref_grid_volume_vector[3] = 2.5;
    ...
    ref_grid_volume_vector = ZeroVector(48);
    ref_grid_volume_vector[12] = 3.5;
    ref_grid_volume_vector[13] = 0.0;
    ref_grid_volume_vector[14] = 0.0;
    ref_grid_volume_vector[15] = 2.5;

    KRATOS_EXPECT_VECTOR_EQ(grid_volume_vector, ref_grid_volume_vector);

    // Delete, search material points and recalculate mp volume at grid
    auto& mp_1 = r_mpm_model_part.GetElement(0);
    mp_1.GetGeometry().clear();
    mp_1.Reset(ACTIVE);
    mp_1.Set(TO_ERASE);
    auto& mp_4 = r_mpm_model_part.GetElement(3);
    mp_4.GetGeometry().clear();
    mp_4.Reset(ACTIVE);
    mp_4.Set(TO_ERASE);
    MaterialPointEraseProcess(r_mpm_model_part).Execute();
    ...
    ref_grid_volume_vector = ZeroVector(48);
    ref_grid_volume_vector[12] = 3.5-2.5;
    ref_grid_volume_vector[13] = 0.0;
    ref_grid_volume_vector[14] = 0.0;
    ref_grid_volume_vector[15] = 2.5-1.0;
