...
namespace Kratos::Testing
{
    ...
    */
    ...
    KRATOS_TEST_CASE_IN_SUITE(MPMPicParticleMappingUtilityOneGridElement2D, KratosMPMFastSuite)
    {
        KRATOS_TRY;
        // --------------------------------------------------------------------------------------- Model Creation --------------------------------------------------------------------------------------- //
        Model current_model;
        ...
        // ------------------------------------------------------------------------------------------ P2G Test ------------------------------------------------------------------------------------------ //
        // Initialize and run PIC mapping scheme
        unsigned int echo_level = 0;
        MPMPicParticleMappingUtility pic_mapping(r_mpm_model_part, r_grid_model_part, echo_level);
        pic_mapping.RunP2GMapping();
        ...
        // Check MP velocity
        array_1d<double, 3> ref_mp_velocity_1 {  1.321388684654994, -0.039893225374272, 0.0};
        array_1d<double, 3> ref_mp_velocity_2 {  0.334449787970006, -1.042740166250728, 0.0};
        array_1d<double, 3> ref_mp_velocity_3 { -0.179722017345006, -0.501773441374272, 0.0};
        array_1d<double, 3> ref_mp_velocity_4 {  0.348883544720006,  0.559406832999272, 0.0};
