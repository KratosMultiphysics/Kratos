...
class Plot_DamageHistory:
	...
	def Initialize(self, Model):
		...
		self.ofile = open(filename, "w+")
		if(self.Dim == 2):
			self.ofile.write("[" + "%10.4e"% (0.0000) + "]   " + "%10.4e"% (0.0000) + "  " + "%10.4e"% (0.0000) + "  " + "%10.4e"% (0.0000) + "    " + "%10.4e"% (0.0000) + "  " + "%10.4e"% (0.0000) + "  " + "%10.4e"% (0.0000) + '\n')
		else:
			self.ofile.write("[" + "%10.4e"% (0.0000) + "]   " + "%10.4e"% (0.0000) + "  " + "%10.4e"% (0.0000) + "  " + "%10.4e"% (0.0000) + "  " + "%10.4e"% (0.0000) + "  " +  "%10.4e"% (0.0000) + "  " +  "%10.4e"% (0.0000) + "    " + "%10.4e"% (0.0000) + "  " +  "%10.4e"% (0.0000) + "  " +  "%10.4e"% (0.0000) + "  " +  "%10.4e"% (0.0000) + "  " +  "%10.4e"% (0.0000) + "  " +  "%10.4e"% (0.0000) + '\n')
		# self.ofile.write(str(xx) + "   " + str(yy) + '\n')
		self.ofile.flush()
		self.Tn = Model.ProcessInfo[TIME]
	...
	def OnSolutionStepCompleted(self, Model):
		t = Model.ProcessInfo[TIME]
		if( (t == Model.ProcessInfo[END_TIME]) or (self.__check_write_freq(t)) ):
			damage = Model.Elements[self.ElementID].GetValuesOnIntegrationPoints(self.VarZ, Model.ProcessInfo)
			allx = Model.Elements[self.ElementID].GetValuesOnIntegrationPoints(self.VarX, Model.ProcessInfo)
			ally = Model.Elements[self.ElementID].GetValuesOnIntegrationPoints(self.VarY, Model.ProcessInfo)
			mx = allx[self.GpID]
			my = ally[self.GpID]
			...
			if self.ComponentY is None:
				...
				yy = my[self.ComponentY]
			if(self.Dim == 2):
				self.ofile.write(str(damage[0]) + "  " + "%10.4e"% (xx[0]) + "  " + "%10.4e"% (xx[3]) + "  " + "%10.4e"% (xx[1]) +"    " + "%10.4e"% (yy[0]) + "  " + "%10.4e"% (yy[3]) + "  " + "%10.4e"% (yy[1]) + '\n')
				#self.ofile.write(str(xx) + "   " + str(yy) + '\n')
				#self.ofile.write(str(xz) + "   " + str(yy) + '\n')
			else:
				self.ofile.write(str(damage[0]) + "  " + "%10.4e"% (xx[0]) + "  " + "%10.4e"% (xx[4]) + "  " + "%10.4e"% (xx[8]) + "  " + "%10.4e"% (xx[1]) + "  " + "%10.4e"% (xx[5]) + "  " + "%10.4e"% (xx[2]) +"    " + "%10.4e"% (yy[0]) + "  " + "%10.4e"% (yy[4]) + "  " + "%10.4e"% (yy[8]) +"  " + "%10.4e"% (yy[1]) + "  " + "%10.4e"% (yy[5]) + "  " + "%10.4e"% (yy[2]) + '\n')
			self.ofile.flush()
