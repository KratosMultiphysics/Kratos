...
#if !defined(SHELL_THICK_INTERFACE_ELEMENT_H_INCLUDED )
#define  SHELL_THICK_INTERFACE_ELEMENT_H_INCLUDED
...
namespace Kratos
{
  ...
  /** \brief ShellThickInterfaceElement
   *
   * Da aggiungere
   */
  class ShellThickInterfaceElement : public Element
  {
  public:
    ...
    KRATOS_CLASS_POINTER_DEFINITION(ShellThickInterfaceElement);
    ...
    ShellThickInterfaceElement(IndexType NewId, 
    ...
    virtual ~ShellThickInterfaceElement();
  ...
  protected:
     ...
     */
    ShellThickInterfaceElement() : Element()
    {
    }
  ...
  private:
	...
	void CalculateStrain(std::vector<Vector>& strain, const ProcessInfo& rCurrentProcessInfo, int mode);
	
	void CalculateStress(std::vector<Vector>& stress, const ProcessInfo& rCurrentProcessInfo, int mode);
...
#endif // SHELL_THICK_INTERFACE_ELEMENT_H_INCLUDED
