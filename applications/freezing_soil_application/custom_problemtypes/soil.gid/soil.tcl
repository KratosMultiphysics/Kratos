...
# 	GidAddUserDataOptions "Cut Model" CutModel 20
    ...
    GidAddUserDataOptions "---" "" 1   
    GidAddUserDataOptions "Initial Displacement" "GidOpenConditions Initial_Displacement" 2
    GidAddUserDataOptions "Initial Water Pressure" "GidOpenConditions Initial_Water_Pressure" 3
    GidAddUserDataOptions "Initial Temperature" "GidOpenConditions Initial_Temperature" 4
    GidAddUserDataOptions "---" "" 5   
    GidAddUserDataOptions "Fixed Displacement" "GidOpenConditions Fixed_Displacement" 6
    GidAddUserDataOptions "Fixed Water Pressure" "GidOpenConditions Fixed_Water_Pressure" 7
    GidAddUserDataOptions "Fixed Temperature" "GidOpenConditions Fixed_Temperature" 8
    GidAddUserDataOptions "---" "" 9
    GidAddUserDataOptions "Loads" "GidOpenConditions Loads" 10
    GidAddUserDataOptions "Face Water Flux" "GidOpenConditions Face_Water_Flux" 11	
    GidAddUserDataOptions "Face Heat Flux" "GidOpenConditions Face_Heat_Flux" 12
    GidAddUserDataOptions "---" "" 13
    GidAddUserDataOptions "Solids" "GidOpenMaterials Solids" 14
