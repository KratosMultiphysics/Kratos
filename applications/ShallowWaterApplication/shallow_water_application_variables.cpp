...
namespace Kratos
{
    ...
    // Auxiliary variables
    KRATOS_CREATE_VARIABLE(double, LUMPED_MASS_FACTOR)
    KRATOS_CREATE_VARIABLE(double, SHOCK_STABILIZATION_FACTOR)
    KRATOS_CREATE_VARIABLE(double, GROUND_IRREGULARITY)
    ...
    KRATOS_CREATE_VARIABLE(double, MAXIMUM_VALUE)
    KRATOS_CREATE_VARIABLE(double, MINIMUM_VALUE)
    KRATOS_CREATE_VARIABLE(double, POSITIVE_FLUX)
    KRATOS_CREATE_VARIABLE(double, NEGATIVE_FLUX)
    KRATOS_CREATE_VARIABLE(double, MAX_INCREMENT)
    KRATOS_CREATE_VARIABLE(double, MIN_DECREMENT)
    KRATOS_CREATE_VARIABLE(double, POSITIVE_RATIO)
    KRATOS_CREATE_VARIABLE(double, NEGATIVE_RATIO)
    KRATOS_CREATE_VARIABLE(double, ALGEBRAIC_CONTRIBUTION)
    KRATOS_CREATE_VARIABLE(bool, IS_MONOTONIC_CALCULATION)
