...
class AutomaticDirichletConditionsProcess(KM.Process):
    ...
    def ExecuteInitialize(self):
        ...
        skin_model_part.RemoveNodes((KM.INTERFACE).SetToFalse())
        ...
        if self.settings["allow_outwards_flow_on_land"].GetBool():
            ...
            skin_model_part.RemoveNodes((KM.SOLID).SetToFalse())
            skin_model_part.RemoveConditionsFromAllLevels((KM.SOLID).SetToFalse())
        else:
