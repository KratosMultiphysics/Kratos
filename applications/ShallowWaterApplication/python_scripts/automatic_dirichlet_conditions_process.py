...
class AutomaticDirichletConditionsProcess(KM.Process):
    ...
    def ExecuteInitialize(self):
        ...
        skin_model_part.RemoveNodes(KM.Flags.__unset__(KM.INTERFACE))
        ...
        if self.settings["allow_outwards_flow_on_land"].GetBool():
            ...
            skin_model_part.RemoveNodes(KM.Flags.__unset__(KM.SOLID))
            skin_model_part.RemoveConditionsFromAllLevels(KM.Flags.__unset__(KM.SOLID))
        else:
