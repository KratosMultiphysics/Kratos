...
void  AddCustomUtilitiesToPython(pybind11::module& m)
{
    ...
    py::class_< ShallowWaterUtilities > (m, "ShallowWaterUtilities")
        ...
        .def("SmoothHistoricalVariable", &ShallowWaterUtilities::SmoothTemporalVariable<double>)
        .def("SmoothHistoricalVariable", &ShallowWaterUtilities::SmoothTemporalVariable<array_1d<double,3>>)
