...
namespace Python
{
  ...
  PYBIND11_MODULE(KratosShallowWaterApplication, m)
  {
    ...
    // Auxiliary variables
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, LUMPED_MASS_FACTOR);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, SHOCK_STABILIZATION_FACTOR);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, GROUND_IRREGULARITY);
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,NUMBER_OF_PARTICLES)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,SUM_AREAS)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,PARTICLE_AREA)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,PARTICLE_WEIGHT)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,SUM_PARTICLES_WEIGHTS)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,MASS_WEIGHT)
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, MAXIMUM_VALUE)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, MINIMUM_VALUE)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, POSITIVE_FLUX)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, NEGATIVE_FLUX)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, MAX_INCREMENT)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, MIN_DECREMENT)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, POSITIVE_RATIO)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, NEGATIVE_RATIO)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, ALGEBRAIC_CONTRIBUTION)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, IS_MONOTONIC_CALCULATION)
