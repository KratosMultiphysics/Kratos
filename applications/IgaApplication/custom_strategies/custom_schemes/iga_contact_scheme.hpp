...
#if !defined(KRATOS_IGA_CONTACT_SCHEME )
#define  KRATOS_IGA_CONTACT_SCHEME
...
template<class TSparseSpace,
         class TDenseSpace
         >
class IgaContactScheme : public ResidualBasedIncrementalUpdateStaticScheme<TSparseSpace,TDenseSpace> //Scheme<TSparseSpace,TDenseSpace>
{
public:
    ///@name Type Definitions
    ///@{

    KRATOS_CLASS_POINTER_DEFINITION( IgaContactScheme );
    ...
    /// Constructor.
    // IgaContactScheme() : Scheme<TSparseSpace,TDenseSpace>() {

    // }

    IgaContactScheme() : ResidualBasedIncrementalUpdateStaticScheme<TSparseSpace,TDenseSpace>() {

    }

    /// Destructor.
    // ~IgaContactScheme() override {}
