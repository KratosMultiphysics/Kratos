...
#if !defined(KRATOS_EIGENSOLVER_NITSCHE_STRATEGY )
#define  KRATOS_EIGENSOLVER_NITSCHE_STRATEGY
...
template<class TSparseSpace,
         ...
         class TLinearSolver
         >
class EigensolverNitscheStrategy
...
public:
    ...
    KRATOS_CLASS_POINTER_DEFINITION(EigensolverNitscheStrategy);
    ...
    EigensolverNitscheStrategy(const EigensolverNitscheStrategy& Other) = delete;

    /// Destructor.
    ~EigensolverNitscheStrategy() override
    {
...
//         }
    ...
    void Initialize() override
    {
        ...
        KRATOS_INFO_IF("EigensolverNitscheStrategy", BaseType::GetEchoLevel() > 2 && rank == 0)
    ...
    bool SolveSolutionStep() override
    {
        ...
        double number_of_nodes_master = new_model_part_master.NumberOfNodes();
        ...
        double number_of_nodes_slave = new_model_part_slave.NumberOfNodes();
        ...
        for (auto& r_node : new_model_part_master.Nodes()) {
        ...
        IndexType i_slave = 0;
        for (auto& r_node : new_model_part_slave.Nodes()) {
        ...
        reduced_Stiffness = ZeroMatrix((number_of_nodes_master+number_of_nodes_slave)*3,(number_of_nodes_master+number_of_nodes_slave)*3);

        SparseMatrixType reduced_Q;
        reduced_Q = ZeroMatrix((number_of_nodes_master+number_of_nodes_slave)*3,(number_of_nodes_master+number_of_nodes_slave)*3);
...
#endif /* KRATOS_EIGENSOLVER_NITSCHE_STRATEGY  defined */
