...
KRATOS_INFO("") << "    KRATOS  _____ _____\n"
    ...
    KRATOS_REGISTER_VARIABLE(SNAKE_SBM_EXECUTION_TIME)
    KRATOS_REGISTER_VARIABLE(SNAKE_GAP_SBM_INITIALIZATION_TIME)
    KRATOS_REGISTER_VARIABLE(SNAKE_GAP_SBM_EXECUTION_TIME)
