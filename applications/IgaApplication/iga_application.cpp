...
KratosIgaApplication::KratosIgaApplication()
    ...
    , mShell3pMixedElement(0, Element::GeometryType::Pointer(
        new Geometry<Node>(Element::GeometryType::PointsArrayType(1))))
    , mShell3pMixedMembraneElement(0, Element::GeometryType::Pointer(
        new Geometry<Node>(Element::GeometryType::PointsArrayType(1))))
    , mShell5pHierarchicElement(0, Element::GeometryType::Pointer(
        new Geometry<Node>(Element::GeometryType::PointsArrayType(1))))
    , mShell5pElement(0, Element::GeometryType::Pointer(
        new Geometry<Node>(Element::GeometryType::PointsArrayType(1))))
    , mShell6pBbarElement(0, Element::GeometryType::Pointer(
        new Geometry<Node>(Element::GeometryType::PointsArrayType(1))))
    ...
    , mCouplingPenaltyCondition(0, Condition::GeometryType::Pointer(
        new Geometry<Node>(Condition::GeometryType::PointsArrayType(1))))
     , mCouplingPenaltyCondition6p(0, Condition::GeometryType::Pointer(
        new Geometry<Node>(Condition::GeometryType::PointsArrayType(1))))
...
KRATOS_INFO("") << "    KRATOS  _____ _____\n"
    ...
    KRATOS_REGISTER_ELEMENT("Shell3pMixedMembraneElement", mShell3pMixedMembraneElement)
    ...
    KRATOS_REGISTER_ELEMENT("Shell6pBbarElement", mShell6pBbarElement)
    ...
    KRATOS_REGISTER_CONDITION("CouplingPenaltyCondition6p", mCouplingPenaltyCondition6p)
    ...
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(MEMBRANE_STRAIN)
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(CURVATURE_DOF)
}
