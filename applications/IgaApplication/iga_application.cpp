...
KRATOS_INFO("") << "    KRATOS  _____ _____\n"
    ...
    KRATOS_REGISTER_VARIABLE(ACTUATION_KAPPA1)
    KRATOS_REGISTER_VARIABLE(ACTUATION_KAPPA2)

    KRATOS_REGISTER_VARIABLE(ACTUATION_E11)
    KRATOS_REGISTER_VARIABLE(ACTUATION_E12)
    KRATOS_REGISTER_VARIABLE(ACTUATION_E22)

    KRATOS_REGISTER_VARIABLE(ACTUATION_KAPPA11)
    KRATOS_REGISTER_VARIABLE(ACTUATION_KAPPA12)
    KRATOS_REGISTER_VARIABLE(ACTUATION_KAPPA22)
