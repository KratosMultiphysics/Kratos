...
KratosIgaApplication::KratosIgaApplication()
    ...
    , mCouplingSbmTaylorInterface6pCondition(0, Condition::GeometryType::Pointer(
        new Geometry<Node>(Condition::GeometryType::PointsArrayType(1))))
    , mSbmSurrogateConsistency6pCondition(0, Condition::GeometryType::Pointer(
        new Geometry<Node>(Condition::GeometryType::PointsArrayType(1))))
...
KRATOS_INFO("") << "    KRATOS  _____ _____\n"
    ...
    KRATOS_REGISTER_CONDITION("SbmSurrogateConsistency6pCondition", mSbmSurrogateConsistency6pCondition)
    ...
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(VECTOR_LAGRANGE_MULTIPLIER_ROTATION)

    KRATOS_REGISTER_VARIABLE(NITSCHE_STABILIZATION_FACTOR)
    KRATOS_REGISTER_VARIABLE(NITSCHE_STABILIZATION_ROTATION_FACTOR)
    ...
    KRATOS_REGISTER_VARIABLE(EIGENVALUE_NITSCHE_STABILIZATION_ROTATION_VECTOR)
    KRATOS_REGISTER_VARIABLE(BUILD_LEVEL)
    KRATOS_REGISTER_VARIABLE(STABILIZATION_METHOD)
    ...
    KRATOS_REGISTER_VARIABLE(SBM_MLS_ALL_DOF_NODES)
    KRATOS_REGISTER_VARIABLE(SBM_MLS_MASTER_WEIGHTS)
    KRATOS_REGISTER_VARIABLE(SBM_MLS_SLAVE_WEIGHTS)
    KRATOS_REGISTER_VARIABLE(SBM_MLS_MASTER_GRADIENT_WEIGHTS_XI)
    KRATOS_REGISTER_VARIABLE(SBM_MLS_MASTER_GRADIENT_WEIGHTS_ETA)
    KRATOS_REGISTER_VARIABLE(SBM_MLS_SLAVE_GRADIENT_WEIGHTS_XI)
    KRATOS_REGISTER_VARIABLE(SBM_MLS_SLAVE_GRADIENT_WEIGHTS_ETA)
    KRATOS_REGISTER_VARIABLE(SBM_SURROGATE_CONORMAL_SIGN)
    KRATOS_REGISTER_VARIABLE(SBM_SURROGATE_REFERENCE_DIRECTION)
    KRATOS_REGISTER_VARIABLE(SBM_TAYLOR_TARGET_POINT)
    KRATOS_REGISTER_VARIABLE(SBM_DIRICHLET_VALUE)
}
