...
KRATOS_INFO("") << "    KRATOS  _____ _____\n"
    ...
    KRATOS_REGISTER_ELEMENT("Shell5pElement", mShell3pElement)
    ...
    KRATOS_REGISTER_2D_VARIABLE_WITH_COMPONENTS(DIRECTORINC)
    KRATOS_REGISTER_2D_VARIABLE_WITH_COMPONENTS(MOMENTDIRECTORINC)
