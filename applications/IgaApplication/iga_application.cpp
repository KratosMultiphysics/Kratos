...
KratosIgaApplication::KratosIgaApplication()
    ...
    , mLaplacianIGAElement(0, Element::GeometryType::Pointer(
        new Geometry<Node>(Element::GeometryType::PointsArrayType(1))))
    , mActiveShell3pElement(0, Element::GeometryType::Pointer(
        new Geometry<Node>(Element::GeometryType::PointsArrayType(1))))
    , mActiveAdjointFiniteDifferenceBaseElement(0, Element::GeometryType::Pointer(
        new Geometry<Node>(Element::GeometryType::PointsArrayType(1))))
...
KRATOS_INFO("") << "    KRATOS  _____ _____\n"
    ...
    KRATOS_REGISTER_ELEMENT("ActiveAdjointFiniteDifferenceBaseElement", mActiveAdjointFiniteDifferenceBaseElement);
    ...
    //Actuation Variables
    KRATOS_REGISTER_SYMMETRIC_2D_TENSOR_VARIABLE_WITH_COMPONENTS( ACTUATION_STRAINS )
    KRATOS_REGISTER_SYMMETRIC_2D_TENSOR_VARIABLE_WITH_COMPONENTS( ACTUATION_STRAINS_REACTION )

    KRATOS_REGISTER_SYMMETRIC_2D_TENSOR_VARIABLE_WITH_COMPONENTS( ACTUATION_CURAVTURES )
    KRATOS_REGISTER_SYMMETRIC_2D_TENSOR_VARIABLE_WITH_COMPONENTS( ACTUATION_CURAVTURES_REACTION )

    // KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(ACTUATION_STRAINS)
    // KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(ACTUATION_STRAINS_REACTION)

    // KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(ACTUATION_CURAVTURES)
    // KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(ACTUATION_CURAVTURES_REACTION)

    // KRATOS_REGISTER_VARIABLE(ACTUATION_ALPHA)
    // KRATOS_REGISTER_VARIABLE(ACTUATION_ALPHA_REACTION)
    // KRATOS_REGISTER_VARIABLE(ACTUATION_BETA)
    // KRATOS_REGISTER_VARIABLE(ACTUATION_BETA_REACTION)
    // KRATOS_REGISTER_VARIABLE(ACTUATION_GAMMA)
    // KRATOS_REGISTER_VARIABLE(ACTUATION_GAMMA_REACTION)
    // KRATOS_REGISTER_VARIABLE(ACTUATION_KAPPA_1)
    // KRATOS_REGISTER_VARIABLE(ACTUATION_KAPPA_1_REACTION)
    // KRATOS_REGISTER_VARIABLE(ACTUATION_KAPPA_2)
    // KRATOS_REGISTER_VARIABLE(ACTUATION_KAPPA_2_REACTION)
    // KRATOS_REGISTER_VARIABLE(ACTUATION_KAPPA_12)
    // KRATOS_REGISTER_VARIABLE(ACTUATION_KAPPA_12_REACTION)
    ...
    //Actuation Variables
    KRATOS_REGISTER_VARIABLE(ACTIVE_SHELL_ALPHA)
    KRATOS_REGISTER_VARIABLE(ACTIVE_SHELL_BETA)
    KRATOS_REGISTER_VARIABLE(ACTIVE_SHELL_GAMMA)    
    KRATOS_REGISTER_VARIABLE(ACTIVE_SHELL_KAPPA_1)
    KRATOS_REGISTER_VARIABLE(ACTIVE_SHELL_KAPPA_2)
    KRATOS_REGISTER_VARIABLE(ACTIVE_SHELL_KAPPA_12) 
    
    KRATOS_REGISTER_VARIABLE(REACTION_ACTIVE_SHELL_ALPHA)
    KRATOS_REGISTER_VARIABLE(REACTION_ACTIVE_SHELL_BETA)
    KRATOS_REGISTER_VARIABLE(REACTION_ACTIVE_SHELL_GAMMA)
    KRATOS_REGISTER_VARIABLE(REACTION_ACTIVE_SHELL_KAPPA_1)
    KRATOS_REGISTER_VARIABLE(REACTION_ACTIVE_SHELL_KAPPA_2)
    KRATOS_REGISTER_VARIABLE(REACTION_ACTIVE_SHELL_KAPPA_12)

    KRATOS_REGISTER_VARIABLE(ACTIVE_SHELL_NODE_GP)

        // Adjoint Actuation Variables
    KRATOS_REGISTER_VARIABLE(ADJOINT_ACTIVE_SHELL_ALPHA)
    KRATOS_REGISTER_VARIABLE(ADJOINT_ACTIVE_SHELL_BETA)
    KRATOS_REGISTER_VARIABLE(ADJOINT_ACTIVE_SHELL_GAMMA)

    KRATOS_REGISTER_VARIABLE(ADJOINT_ACTIVE_SHELL_KAPPA_1)
    KRATOS_REGISTER_VARIABLE(ADJOINT_ACTIVE_SHELL_KAPPA_2)
    KRATOS_REGISTER_VARIABLE(ADJOINT_ACTIVE_SHELL_KAPPA_12)

    // Adjoint Reaction Actuation Variables
    KRATOS_REGISTER_VARIABLE(ADJOINT_REACTION_ACTIVE_SHELL_ALPHA)
    KRATOS_REGISTER_VARIABLE(ADJOINT_REACTION_ACTIVE_SHELL_BETA)
    KRATOS_REGISTER_VARIABLE(ADJOINT_REACTION_ACTIVE_SHELL_GAMMA)

    KRATOS_REGISTER_VARIABLE(ADJOINT_REACTION_ACTIVE_SHELL_KAPPA_1)
    KRATOS_REGISTER_VARIABLE(ADJOINT_REACTION_ACTIVE_SHELL_KAPPA_2)
    KRATOS_REGISTER_VARIABLE(ADJOINT_REACTION_ACTIVE_SHELL_KAPPA_12)
}
