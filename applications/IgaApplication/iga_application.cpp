...
KRATOS_INFO("") << "    KRATOS  _____ _____\n"
    ...
    KRATOS_REGISTER_VARIABLE(IS_ASSEMBLED)
    KRATOS_REGISTER_VARIABLE(PROJECTION_NODE_MASTER_ID)
    KRATOS_REGISTER_VARIABLE(PROJECTION_NODE_SLAVE_ID)
    KRATOS_REGISTER_VARIABLE(CURVATURE_PROJECTION_MASTER)
    KRATOS_REGISTER_VARIABLE(CURVATURE_PROJECTION_SLAVE)
    ...
    KRATOS_REGISTER_VARIABLE(RESULTS_ON_TRUE_BOUNDARY_MASTER)
    KRATOS_REGISTER_VARIABLE(RESULTS_ON_TRUE_BOUNDARY_SLAVE)
    KRATOS_REGISTER_VARIABLE(INTEGRATION_POINTS_MASTER)
    KRATOS_REGISTER_VARIABLE(INTEGRATION_POINTS_SLAVE)
    KRATOS_REGISTER_VARIABLE(INTEGRATION_WEIGHTS_MASTER)
    KRATOS_REGISTER_VARIABLE(INTEGRATION_WEIGHTS_SLAVE)
