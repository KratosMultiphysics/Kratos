...
KRATOS_INFO("") << "    KRATOS  _____ _____\n"
    ...
    //Actuation Variables
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(ACTUATION)
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(ACTUATION_REACTION)
    ...
    // KRATOS_REGISTER_VARIABLE(ACTUATION_E_11)
    // KRATOS_REGISTER_VARIABLE(ACTUATION_E_12)
    // KRATOS_REGISTER_VARIABLE(ACTUATION_E_22)

    // KRATOS_REGISTER_VARIABLE(ACTUATION_KAPPA_11)
    // KRATOS_REGISTER_VARIABLE(ACTUATION_KAPPA_12)
    // KRATOS_REGISTER_VARIABLE(ACTUATION_KAPPA_22)
