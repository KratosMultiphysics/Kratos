...
#if !defined(KRATOS_COUPLING_PENALTY_DIRECTOR_CONDITION_H_INCLUDED )
#define  KRATOS_COUPLING_PENALTY_DIRECTOR_CONDITION_H_INCLUDED
...
*/
class CouplingPenaltyDirectorCondition
    : public Condition
{
public:
    ...
    /// Counted pointer of CouplingPenaltyDirectirCondition
    KRATOS_CLASS_POINTER_DEFINITION(CouplingPenaltyDirectorCondition);
    ...
    CouplingPenaltyDirectorCondition(
        IndexType NewId,
    ...
    /// Destructor.
    virtual ~CouplingPenaltyDirectorCondition() = default;
    ...
    {
        return Kratos::make_intrusive<CouplingPenaltyDirectorCondition>(
    ...
    */
    ...
    std::string Info() const override
    {
        ...
        buffer << "\"CouplingPenaltyDirectorCondition\" #" << Id();
        return buffer.str();
    }
    ...
    {
        rOStream << "\"CouplingPenaltyDirectorCondition\" #" << Id();
    }
...
#endif // KRATOS_COUPLING_PENALTY_DIRECTOR_CONDITION_H_INCLUDED  defined