...
#if !defined(KRATOS_SUPPORT_PRESSURE_DIRICHLET_CONDITION_H_INCLUDED )
#define  KRATOS_SUPPORT_PRESSURE_DIRICHLET_CONDITION_H_INCLUDED
...
class SupportPressureDirichletCondition
    : public Condition
{
public:
    ...
    /// Counted pointer definition of SupportPressureDirichletCondition
    KRATOS_CLASS_INTRUSIVE_POINTER_DEFINITION(SupportPressureDirichletCondition);
    ...
    SupportPressureDirichletCondition(
        IndexType NewId,
    ...
    /// Default constructor
    SupportPressureDirichletCondition() : Condition()
    {};

    /// Destructor
    virtual ~SupportPressureDirichletCondition() override
    {};
    ...
    {
        return Kratos::make_intrusive<SupportPressureDirichletCondition>(
    ...
    */
    ...
    std::string Info() const override
    {
        ...
        buffer << "\"SupportPressureDirichletCondition\" #" << Id();
        return buffer.str();
    }
    ...
    {
        rOStream << "\"SupportPressureDirichletCondition\" #" << Id();
    }
