...
class KRATOS_API(IGA_APPLICATION) GapSbmLoadSolidCondition
    : public Condition
{
public:
    ...
    /// Counted pointer definition of GapSbmLoadSolidCondition
    KRATOS_CLASS_INTRUSIVE_POINTER_DEFINITION(GapSbmLoadSolidCondition);
    ...
    /// Default constructor
    GapSbmLoadSolidCondition() : Condition()
    {};

    /// Destructor
    virtual ~GapSbmLoadSolidCondition() override
    {};
    ...
    {
        return Kratos::make_intrusive<GapSbmLoadSolidCondition>(
    ...
    */
    ...
    std::string Info() const override
    {
        ...
        buffer << "\"GapSbmLoadSolidCondition\" #" << Id();
        return buffer.str();
    }
    ...
    {
        rOStream << "\"GapSbmLoadSolidCondition\" #" << Id();
    }
...
virtual const NodeType& GetProjectionNode() const
{
    return *GetBoundaryGeometry().GetValue(PROJECTION_NODE);
}
...
class KRATOS_API(IGA_APPLICATION) GapSbmLoadSolidConditionBatched
    : public GapSbmLoadSolidCondition
{
public:
    KRATOS_CLASS_INTRUSIVE_POINTER_DEFINITION(
        GapSbmLoadSolidConditionBatched);

    using BaseType = GapSbmLoadSolidCondition;
    ...
    ~GapSbmLoadSolidConditionBatched() override = default;
    ...
    std::string Info() const override
    {
        return "GapSbmLoadSolidConditionBatched #" +
            std::to_string(Id());
    }

protected:
    GapSbmLoadSolidConditionBatched() = default;
...
private:
    ...
    std::size_t mCurrentQuadraturePoint = 0;
    ...
    const NodeType& GetProjectionNode() const override;
