...
namespace Kratos
{
    ...
    void CouplingNonSymmetricNitscheCondition::CalculateKinematics(
    ...
    */
    void CouplingNonSymmetricNitscheCondition::CalculateTransformation(
    ...
    void CouplingNonSymmetricNitscheCondition::CalculateConstitutiveVariables(
        IndexType IntegrationPointIndex,
    ...
    void CouplingNonSymmetricNitscheCondition::CalculateTransformationPrestress(
    ...
    void CouplingNonSymmetricNitscheCondition::CalculateAll(
        ...
        const bool CalculateResidualVectorFlag)
    {
        ...
        const double stabilization_parameter = 0.0; //GetProperties()[NITSCHE_STABILIZATION_FACTOR];
        ...
        for (IndexType point_number = 0; point_number < integration_points.size(); point_number++)
        {
            ...
            // Collins, Lozinsky & Scovazzi innovation (Free-penalty approach)

            // Assembly
             if (CalculateStiffnessMatrixFlag) {

                noalias(rLeftHandSideMatrix) += prod(trans(H), first_variations_traction)
                    * integration_weight * determinant_jacobian * -gammaTilde;

                noalias(rLeftHandSideMatrix) += prod(trans(first_variations_traction), H)
                    * integration_weight * determinant_jacobian * gammaTilde;
    ...
    void CouplingNonSymmetricNitscheCondition::DeterminantOfJacobianInitial(
    ...
    void CouplingNonSymmetricNitscheCondition::CalculateNitscheStabilizationMatrix(
        MatrixType& rLeftHandSideMatrix,
        VectorType& rRightHandSideVector,
        const ProcessInfo& rCurrentProcessInfo)
    {
    ...
    void CouplingNonSymmetricNitscheCondition::CalculateTraction(
        IndexType IntegrationPointIndex,
    ...
    void CouplingNonSymmetricNitscheCondition::CalculateFirstVariationStressCovariant(
        IndexType IntegrationPointIndex,
    ...
    void CouplingNonSymmetricNitscheCondition::CalculateFirstVariationTraction(
        IndexType IntegrationPointIndex,
    ...
    void CouplingNonSymmetricNitscheCondition::CalculateSecondVariationTractionProduct(
        IndexType IntegrationPointIndex,
        Matrix& rPi,
        const KinematicVariables& rActualKinematic,
        ConstitutiveVariables& rThisConstitutiveVariablesMembrane, 
    ...
    void CouplingNonSymmetricNitscheCondition::CalculateSecondVariationTraction(
        IndexType IntegrationPointIndex,
    ...
    void CouplingNonSymmetricNitscheCondition::GetValuesVector(
        Vector& rValues,
        int Step) const
    {
        const auto& r_geometry_master = GetGeometry().GetGeometryPart(0);
    ...
    void CouplingNonSymmetricNitscheCondition::EquationIdVector(
    ...
    void CouplingNonSymmetricNitscheCondition::GetDofList(
