...
void ApplyConstitutiveLaw(
        ...
        ConstitutiveLaw::Pointer pConstitutiveLaw = nullptr);
...
///@{
    ...
    ConstitutiveLaw::Pointer mpConstitutiveLawOnTrue; /// Constitutive law evaluated on the true boundary
    // sbm variables
    ...
    double mCharacteristicGeometryLength = 0.0;
