...
class KRATOS_API(IGA_APPLICATION) GapSbmEnhancedLoadSolidCondition
    : public Condition
{
public:
    ...
    /// Counted pointer definition of GapSbmEnhancedLoadSolidCondition
    KRATOS_CLASS_INTRUSIVE_POINTER_DEFINITION(GapSbmEnhancedLoadSolidCondition);
    ...
    /// Default constructor
    GapSbmEnhancedLoadSolidCondition() : Condition()
    {};

    /// Destructor
    virtual ~GapSbmEnhancedLoadSolidCondition() override
    {};
    ...
    {
        return Kratos::make_intrusive<GapSbmEnhancedLoadSolidCondition>(
    ...
    */
    ...
    /**
     * @brief Get the solution coefficients at the previous time step.
     *
    ...
    std::string Info() const override
    {
        ...
        buffer << "\"GapSbmEnhancedLoadSolidCondition\" #" << Id();
        return buffer.str();
    }
    ...
    {
        rOStream << "\"GapSbmEnhancedLoadSolidCondition\" #" << Id();
    }
...
/**
 * @brief Calculate the strain-displacement matrix.
 * 
...
/**
 * @brief Calculate the traction associated with a stress vector and a normal.
 */
