...
//         // if ((master_old_displacement_x != 0 || slave_old_displacement_x != 0) && r_geometry_master.Center()[1] < 1.5001 && r_geometry_master.Center()[1] > 0.4999) m_contact_is_active = true;
