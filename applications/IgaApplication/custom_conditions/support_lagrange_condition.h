...
namespace Kratos
{
    ...
    */
    ...
    public:
        ...
        /// Counted pointer definition of SupportLagrangeCondition
        KRATOS_CLASS_INTRUSIVE_POINTER_DEFINITION(SupportLagrangeCondition);
        ...
        /// Default constructor
        SupportLagrangeCondition() : Condition()
        {};

        /// Destructor
        virtual ~SupportLagrangeCondition() override
        {};
