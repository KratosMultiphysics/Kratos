...
#if !defined(KRATOS_COUPLING_PENALTY_CONDITION_6P_H_INCLUDED )
#define  KRATOS_COUPLING_PENALTY_CONDITION_6P_H_INCLUDED
...
*/
class CouplingPenaltyCondition6p
    : public Condition
{
public:
    ...
    KRATOS_CLASS_POINTER_DEFINITION(CouplingPenaltyCondition6p);
    ...
    /// Destructor.
    virtual ~CouplingPenaltyCondition6p() = default;
    ...
    {
        return Kratos::make_intrusive<CouplingPenaltyCondition6p>(
...
#endif // KRATOS_COUPLING_PENALTY_CONDITION_6P_ H_INCLUDED  defined