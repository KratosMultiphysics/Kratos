...
#if !defined(KRATOS_COUPLING_PENALTY_RM_CONDITION_H_INCLUDED )
#define  KRATOS_COUPLING_PENALTY_RM_CONDITION_H_INCLUDED
...
*/
class CouplingPenaltyRMCondition
    : public Condition
{
public:
    ...
    /// Counted pointer of CouplingPenaltyRMCondition
    KRATOS_CLASS_POINTER_DEFINITION(CouplingPenaltyRMCondition);
    ...
    /// Destructor.
    virtual ~CouplingPenaltyRMCondition() = default;
    ...
    {
        return Kratos::make_intrusive<CouplingPenaltyRMCondition>(
    ...
    */
    ...
    std::string Info() const override
    {
        ...
        buffer << "\"CouplingPenaltyRMCondition\" #" << Id();
        return buffer.str();
    }
    ...
    {
        rOStream << "\"CouplingPenaltyRMCondition\" #" << Id();
    }
...
#endif // KRATOS_COUPLING_PENALTY_RM_CONDITION_H_INCLUDED  defined