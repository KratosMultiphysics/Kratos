...
#if !defined(KRATOS_COUPLING_NON_SYMMETRIC_NITSCHE_CONDITION_H_INCLUDED )
#define  KRATOS_COUPLING_NON_SYMMETRIC_NITSCHE_CONDITION_H_INCLUDED
...
*/
class CouplingNonSymmetricNitscheCondition
    : public Condition
{
protected:
...
public:
    ...
    /// Counted pointer of CouplingNonSymmetricNitscheCondition
    KRATOS_CLASS_POINTER_DEFINITION(CouplingNonSymmetricNitscheCondition);
    ...
    CouplingNonSymmetricNitscheCondition(
        IndexType NewId,
    ...
    /// Destructor.
    virtual ~CouplingNonSymmetricNitscheCondition() = default;
    ...
    {
        return Kratos::make_intrusive<CouplingNonSymmetricNitscheCondition>(
    ...
    */
    ...
    std::string Info() const override
    {
        ...
        buffer << "\"CouplingNonSymmetricNitscheCondition\" #" << Id();
        return buffer.str();
    }
    ...
    {
        rOStream << "\"CouplingNonSymmetricNitscheCondition\" #" << Id();
    }
