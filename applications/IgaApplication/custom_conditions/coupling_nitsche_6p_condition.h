...
#if !defined(KRATOS_COUPLING_NITSCHE_6P_CONDITION_H_INCLUDED )
#define  KRATOS_COUPLING_NITSCHE_6P_CONDITION_H_INCLUDED
...
#endif // KRATOS_COUPLING_NITSCHE_6P_CONDITION_H_INCLUDED  defined 
