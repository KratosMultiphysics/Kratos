...
class KRATOS_API(IGA_APPLICATION) GapSbmEnhancedSolidCondition
    : public Condition
{
public:
    ...
    /// Counted pointer definition of GapSbmEnhancedSolidCondition
    KRATOS_CLASS_INTRUSIVE_POINTER_DEFINITION(GapSbmEnhancedSolidCondition);
    ...
    /// Default constructor
    GapSbmEnhancedSolidCondition() : Condition()
    {};

    /// Destructor
    virtual ~GapSbmEnhancedSolidCondition() override
    {};
    ...
    {
        return Kratos::make_intrusive<GapSbmEnhancedSolidCondition>(
    ...
    */
    ...
    std::string Info() const override
    {
        ...
        buffer << "\"GapSbmEnhancedSolidCondition\" #" << Id();
        return buffer.str();
    }
    ...
    {
        rOStream << "\"GapSbmEnhancedSolidCondition\" #" << Id();
    }
