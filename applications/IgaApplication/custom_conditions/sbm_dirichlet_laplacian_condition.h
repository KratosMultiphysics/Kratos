...
class KRATOS_API(IGA_APPLICATION) SbmDirichletLaplacianCondition
    : public Condition
{
public:
    ...
    /// Counted pointer definition of SbmDirichletLaplacianCondition
    KRATOS_CLASS_INTRUSIVE_POINTER_DEFINITION(SbmDirichletLaplacianCondition);
    ...
    SbmDirichletLaplacianCondition(
        IndexType NewId,
    ...
    /// Default constructor
    SbmDirichletLaplacianCondition() : Condition()
    {};

    /// Destructor
    virtual ~SbmDirichletLaplacianCondition() override
    {};
    ...
    {
        return Kratos::make_intrusive<SbmDirichletLaplacianCondition>(
    ...
    */
    ...
    std::string Info() const override
    {
        ...
        buffer << "\"SbmDirichletLaplacianCondition\" #" << Id();
        return buffer.str();
    }
    ...
    {
        rOStream << "\"SbmDirichletLaplacianCondition\" #" << Id();
    }
...
}; // Class SbmDirichletLaplacianCondition
