...
#if !defined(KRATOS_STABILIZATION_PENALTY_CONDITION_H_INCLUDED )
#define  KRATOS_STABILIZATION_PENALTY_CONDITION_H_INCLUDED
...
namespace Kratos
{
    /// Condition for stabilization penalty condition
    class StabilizationPenaltyCondition
        : public Condition
    {
    public:
        ...
        /// Counted pointer definition of StabilizationPenaltyCondition
        KRATOS_CLASS_INTRUSIVE_POINTER_DEFINITION(StabilizationPenaltyCondition);
        ...
        /// Default constructor
        StabilizationPenaltyCondition() : Condition()
        {};

        /// Destructor
        virtual ~StabilizationPenaltyCondition() override
        {};
        ...
        {
            return Kratos::make_intrusive<StabilizationPenaltyCondition>(
        ...
        */
        ...
        {
            const SizeType mat_size = GetGeometry().size() * 6;
        ...
        */
        ...
        std::string Info() const override
        {
            ...
            buffer << "\"StabilizationPenaltyCondition\" #" << Id();
            return buffer.str();
        }
        ...
        {
            rOStream << "\"StabilizationPenaltyCondition\" #" << Id();
        }
...
#endif // KRATOS_STABILIZATION_PENALTY_CONDITION_H_INCLUDED  defined
