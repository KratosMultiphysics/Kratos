...
namespace Kratos
{
    ...
    class SupportPenalty6pCondition
        : public Condition
    {
    public:
        ...
        /// Default constructor
        SupportPenalty6pCondition() : Condition()
        {};

        /// Destructor
        virtual ~SupportPenalty6pCondition() override
        {};
        ...
        {
            return Kratos::make_intrusive<SupportPenalty6pCondition>(
        ...
        */
        ...
        std::string Info() const override
        {
            ...
            buffer << "\"SupportPenalty6pCondition\" #" << Id();
            return buffer.str();
        }
        ...
        {
            rOStream << "\"SupportPenalty6pCondition\" #" << Id();
        }
