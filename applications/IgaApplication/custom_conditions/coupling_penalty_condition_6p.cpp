...
namespace Kratos
{
    void CouplingPenaltyCondition6p::CalculateAll(
    ...
    void CouplingPenaltyCondition6p::DeterminantOfJacobianInitial(
    ...
    // void CouplingPenaltyCondition6p::CalculateRotationalShapeFunctions(
    ...
    // void CouplingPenaltyCondition6p::CalculateRotation(
    //     IndexType IntegrationPointIndex,
    ...
    int CouplingPenaltyCondition6p::Check(const ProcessInfo& rCurrentProcessInfo) const
    {
    ...
    void CouplingPenaltyCondition6p::EquationIdVector(
    ...
    void CouplingPenaltyCondition6p::GetDofList(
