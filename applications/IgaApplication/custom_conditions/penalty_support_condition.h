...
#if !defined(KRATOS_PENALTY_SUPPORT_CONDITION_H_INCLUDED )
#define  KRATOS_PENALTY_SUPPORT_CONDITION_H_INCLUDED
...
*/
class PenaltySupportCondition
    : public Condition
{
public:

    /// Counted pointer of PenaltySupportCondition
    KRATOS_CLASS_POINTER_DEFINITION(PenaltySupportCondition);

    /// Default constructor.
    PenaltySupportCondition(IndexType NewId, GeometryType::Pointer pGeometry)
        : Condition(NewId, pGeometry)
    {};

    PenaltySupportCondition(IndexType NewId, GeometryType::Pointer pGeometry, PropertiesType::Pointer pProperties)
    ...
    */
    ...
    {
        return Kratos::make_intrusive<PenaltySupportCondition>(
    ...
    /// Destructor.
    virtual ~PenaltySupportCondition() override
    {};
...
#endif // KRATOS_PENALTY_SUPPORT_CONDITION_H_INCLUDED  defined 
