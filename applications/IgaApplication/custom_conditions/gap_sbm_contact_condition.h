...
class KRATOS_API(IGA_APPLICATION) GapSbmContactCondition
    : public Condition
{
public:
    ...
    /// Counted pointer definition of GapSbmContactCondition
    KRATOS_CLASS_INTRUSIVE_POINTER_DEFINITION(GapSbmContactCondition);
    ...
    /// Default constructor
    GapSbmContactCondition() : Condition()
    {};

    /// Destructor
    virtual ~GapSbmContactCondition() override
    {};
    ...
    {
        return Kratos::make_intrusive<GapSbmContactCondition>(
    ...
    */
    ...
    const GeometryType& GetProjectionReferenceGeometry() const;
    ...
    std::string Info() const override
    {
        ...
        buffer << "\"GapSbmContactCondition\" #" << Id();
        return buffer.str();
    }
    ...
    {
        rOStream << "\"GapSbmContactCondition\" #" << Id();
    }
