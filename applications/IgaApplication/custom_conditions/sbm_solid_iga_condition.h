...
class KRATOS_API(IGA_APPLICATION) SbmSolidIGACondition
    : public Condition
{
public:
    ...
    /// Counted pointer definition of SbmSolidIGACondition
    KRATOS_CLASS_INTRUSIVE_POINTER_DEFINITION(SbmSolidIGACondition);
    ...
    /// Default constructor
    SbmSolidIGACondition() : Condition()
    {};

    /// Destructor
    virtual ~SbmSolidIGACondition() override
    {};
    ...
    {
        return Kratos::make_intrusive<SbmSolidIGACondition>(
    ...
    */
    ...
    std::string Info() const override
    {
        ...
        buffer << "\"SbmSolidIGACondition\" #" << Id();
        return buffer.str();
    }
    ...
    {
        rOStream << "\"SbmSolidIGACondition\" #" << Id();
    }
