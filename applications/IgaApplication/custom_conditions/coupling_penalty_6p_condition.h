...
*/
class CouplingPenalty6pCondition
    : public Condition
{
public:
    ...
    /// Destructor.
    virtual ~CouplingPenalty6pCondition() = default;
    ...
    {
        return Kratos::make_intrusive<CouplingPenalty6pCondition>(
    ...
    */
    ...
    std::string Info() const override
    {
        ...
        buffer << "\"CouplingPenalty6pCondition\" #" << Id();
        return buffer.str();
    }
    ...
    {
        rOStream << "\"CouplingPenalty6pCondition\" #" << Id();
    }
