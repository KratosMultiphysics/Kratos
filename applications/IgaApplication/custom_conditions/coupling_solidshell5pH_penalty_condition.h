...
#if !defined(KRATOS_COUPLING_SOLIDSHELL5PH_PENALTY_CONDITION_H_INCLUDED )
#define  KRATOS_COUPLING_SOLIDSHELL5PH_PENALTY_CONDITION_H_INCLUDED
...
*/
class CouplingSolidShell5pHPenaltyCondition
    : public Condition
{
public:
    ...
    /// Counted pointer of CouplingSolidShell5pHPenaltyCondition
    KRATOS_CLASS_POINTER_DEFINITION(CouplingSolidShell5pHPenaltyCondition);
    ...
    CouplingSolidShell5pHPenaltyCondition(
        IndexType NewId,
    ...
    /// Destructor.
    virtual ~CouplingSolidShell5pHPenaltyCondition() = default;
   ...
   {
       return Kratos::make_intrusive<CouplingSolidShell5pHPenaltyCondition>(
    ...
    */
    ...
    std::string Info() const override
    {
        ...
        buffer << "\"CouplingSolidShell5pHPenaltyCondition\" #" << Id();
        return buffer.str();
    }
    ...
    {
        rOStream << "\"CouplingSolidShell5pHPenaltyCondition\" #" << Id();
    }
