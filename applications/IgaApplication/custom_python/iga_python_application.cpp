...
PYBIND11_MODULE(KratosIgaApplication, m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, PRINCIPAL_STRESS_12)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, CABLE_STRESS)
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, PRINCIPAL_STRESSES)
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, PRINCIPAL_FORCES)
