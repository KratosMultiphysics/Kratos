...
PYBIND11_MODULE(KratosIgaApplication, m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, VECTOR_LAGRANGE_MULTIPLIER_ROTATION)

    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, NITSCHE_STABILIZATION_FACTOR)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, NITSCHE_STABILIZATION_ROTATION_FACTOR)
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, EIGENVALUE_NITSCHE_STABILIZATION_ROTATION_VECTOR)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, BUILD_LEVEL)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, STABILIZATION_METHOD)
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, SBM_MLS_MASTER_WEIGHTS)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, SBM_MLS_SLAVE_WEIGHTS)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, SBM_SURROGATE_CONORMAL_SIGN)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, SBM_SURROGATE_REFERENCE_DIRECTION)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, SBM_TAYLOR_TARGET_POINT)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, SBM_DIRICHLET_VALUE)
