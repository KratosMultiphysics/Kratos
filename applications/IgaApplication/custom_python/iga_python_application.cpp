...
PYBIND11_MODULE(KratosIgaApplication, m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, INTEGRATION_POINTS)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, INTEGRATION_WEIGHTS)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, INTEGRATION_NORMALS)
    ...
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, PROJECTION_NODE_COORDINATES)
