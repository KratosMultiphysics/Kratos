...
PYBIND11_MODULE(KratosIgaApplication, m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, DAMAGE_TENSION_VECTOR)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, DAMAGE_COMPRESSION_VECTOR)
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, ADD_SELF_WEIGHT)

    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, YIELD_STRESS_TENSION)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, YIELD_STRESS_COMPRESSION)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, BELOW_YIELD_STRESS)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, BELOW_YIELD_STRESS_TENSION)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, BELOW_YIELD_STRESS_COMPRESSION)

    KRATOS_REGISTER_IN_PYTHON_SYMMETRIC_2D_TENSOR_VARIABLE_WITH_COMPONENTS(m, GREEN_LAGRANGE_STRAIN)
    ...
    KRATOS_REGISTER_IN_PYTHON_SYMMETRIC_2D_TENSOR_VARIABLE_WITH_COMPONENTS(m, PRINCIPAL_CAUCHY_STRESS)
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, ZETA_STEEL)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, THICKNESS_STEEL)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, NUMBER_OF_THICKNESS_INTEGRATION_POINTS)

    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, PENALTY_FACTOR)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, PENALTY_FACTOR_NORMAL)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, PENALTY_FACTOR_TANGENT_1)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, PENALTY_FACTOR_TANGENT_2)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, PENALTY_FACTOR_MOMENT_1)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, PENALTY_FACTOR_MOMENT_2)
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, PENALTY_REACTION)
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, PENALTY_REACTION_FORCE)
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, VECTOR_LAGRANGE_MULTIPLIER_REACTION)
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, VECTOR_LAGRANGE_MULTIPLIER_FORCE)
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, REACTION_FORCE)
