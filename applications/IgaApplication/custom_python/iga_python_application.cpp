...
PYBIND11_MODULE(KratosIgaApplication, m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, SCALAR_LAGRANGE_MULTIPLIER_REACTION)
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, NITSCHE_CONTACT_PRESSURE)
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, PROJECTION_NODE_COORDINATES)
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, PROJECTION_NODE_MASTER_ID)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, PROJECTION_NODE_SLAVE_ID)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, CURVATURE_PROJECTION_MASTER)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, CURVATURE_PROJECTION_SLAVE)

    // CONTACT Variables
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, NORMAL_GAP )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, CONTACT_PRESSURE )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, GAP )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, RESULTS_ON_TRUE_BOUNDARY_MASTER)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, RESULTS_ON_TRUE_BOUNDARY_SLAVE)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, CONSTITUTIVE_MATRIX_MASTER )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, CONSTITUTIVE_MATRIX_SLAVE )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, NORMAL_STRESS_MASTER )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, NORMAL_STRESS_SLAVE )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, NORMAL_MASTER)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, NORMAL_SLAVE)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, NORMAL_SKIN_MASTER)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, NORMAL_SKIN_SLAVE)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, DISPLACEMENT_MASTER)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, DISPLACEMENT_SLAVE)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, STRESS_MASTER)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, STRESS_SLAVE)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, STRAIN_MASTER)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, STRAIN_SLAVE)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, SKIN_MASTER_COORDINATES)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, SKIN_SLAVE_COORDINATES)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, SURROGATE_MASTER_COORDINATES)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, SURROGATE_SLAVE_COORDINATES)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, GAMMA_CONTACT)

    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, CURVATURE)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, RESULTS_ON_TRUE_BOUNDARY)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, KNOT_SPAN_SIZES)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, PATCH_PARAMETER_SPACE_CORNERS)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, PROJECTION_NODE_COORDINATES)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, PROJECTION_NODE_ID)
