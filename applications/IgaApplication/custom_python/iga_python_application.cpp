...
PYBIND11_MODULE(KratosIgaApplication, m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, CROSS_SECTIONAL_ROTATION)
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, SNAKE_SBM_EXECUTION_TIME)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, SNAKE_GAP_SBM_INITIALIZATION_TIME)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, SNAKE_GAP_SBM_EXECUTION_TIME)
