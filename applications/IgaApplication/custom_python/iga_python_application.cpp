...
PYBIND11_MODULE(KratosIgaApplication, m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, STABILIZATION_TRANSLATION_FACTOR)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, STABILIZATION_ROTATION_FACTOR)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, INITIAL_DISTANCE_TO_FIRST_STABLE_POINT)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, INITIAL_DISTANCE_FIRST_TO_SECOND_STABLE_POINT)
