            ...
            for element in self.model_part.Elements:
                if not (element.Has(KratosIga.TANGENTS)):
                    if (self.output_geometry_elements):
                        #local_coords =element.GetGeometry().IntegtrationPoints()[0]
                        #output_geometry_integration_points += "[" + str(element.Id) + "," + str(element.GetValue(KratosIga.BREP_ID)) + ",[" + str(local_coords.X()) + "," + str(local_coords[1]) + "]],"
                        local_coords =element.GetGeometry().IntegtrationPoints()
                        output_geometry_integration_points += "[" + str(element.Id) + "," + ",[" + str(local_coords[0]) + "," + str(local_coords[1]) + "]],"
                else:
                    if (self.output_brep_elements):
                        local_coords = element.GetValue(KratosIga.COORDINATES)
                        ...
                        output_brep_integration_points += "[" + str(element.Id) + ","  + ",[" + str(local_coords[0]) + "," + str(local_coords[1]) + "]],"

            for condition in self.model_part.Conditions:
                if not (condition.Has(KratosIga.TANGENTS)):
                    if (self.output_geometry_conditions):
                        local_coords = condition.GetValue(KratosIga.COORDINATES)
                        ...
                        output_geometry_integration_points += "[" + str(condition.Id) + ","  + ",[" + str(local_coords[0]) + "," + str(local_coords[1]) + "]],"
                else:
                    if (self.output_brep_conditions):
                        ...
                        output_brep_integration_points += "[" + str(condition.Id) + "," + ",[" + str(local_coords[0]) + "," + str(local_coords[1]) + "]],"
            #Cut off last ","
