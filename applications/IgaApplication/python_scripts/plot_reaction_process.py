...
class OuputReactionProcess(KM.Process):
    ...
    def ExecuteFinalizeSolutionStep(self):
        ...
        with open(self.output_file_name, 'a') as output_file:
            ...
            output_file.write(str(x_reaction) + "\n")


        with open(self.output_damage_file_name, 'a') as output_file:
            output_file.write(str(time_step)  + "  " + str(self.model_part_root.GetElement(1).CalculateOnIntegrationPoints(SM.DAMAGE_COMPRESSION, self.model_part_root.ProcessInfo)[0]) + "\n")
