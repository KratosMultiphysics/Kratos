...
class IgaStaticSolver(structural_mechanics_static_solver.StaticMechanicalSolver):
    ...
    def AddVariables(self):
        super(IgaStaticSolver, self).AddVariables()

        self.main_model_part.AddNodalSolutionStepVariable(KratosMultiphysics.IgaApplication.W_BAR)
        self.main_model_part.AddNodalSolutionStepVariable(KratosMultiphysics.IgaApplication.W_BAR_REACTION)

    def AddDofs(self):
        super(IgaStaticSolver, self).AddDofs()

        KratosMultiphysics.VariableUtils().AddDof(KratosMultiphysics.IgaApplication.W_BAR, KratosMultiphysics.IgaApplication.W_BAR_REACTION, self.main_model_part)