...
/** Configuration file for BinsIgaObject.
 ...
 */
class BinsIgaConfigure
{
public:

    /// Pointer definition of BinsIgaConfigure
    KRATOS_CLASS_POINTER_DEFINITION(BinsIgaConfigure);
     ...
     */
    typedef BinsIgaObject                     ObjectType;
...
private:
    ...
    /// Assignment operator.
    BinsIgaConfigure& operator=(BinsIgaConfigure const& rOther);

    /// Copy constructor.
    BinsIgaConfigure(BinsIgaConfigure const& rOther);
...
inline std::istream& operator >> (std::istream& rIStream, BinsIgaConfigure& rThis)
{
    return rIStream;
}

/// output stream function
inline std::ostream& operator << (std::ostream& rOStream, const BinsIgaConfigure& rThis)
{
