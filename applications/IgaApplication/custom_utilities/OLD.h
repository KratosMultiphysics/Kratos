...
//         NodePointerType pMiddleControlNode;
...
//     {
//         NeighbourGeometriesVectorType NeighbourGeometries;
...
//         const std::size_t IntegrationOrder,
//         const std::size_t NumberOfShapeFunctionsDerivatives,
//         const std::size_t NumberOfType1PyramidVolumes,
//         const std::size_t NumberOfType1QuadraturePointGeometries);
...
//         const NurbsSurfaceType::Pointer& pTopSurfaceGeometry,
//         const std::size_t IntegrationOrder) const;
...
//         std::array<std::size_t, 3> LocalNodeIndices = {{0, 0, 0}};
