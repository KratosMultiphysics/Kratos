...
//                 } else if (mGapApproximationOrder == 3) {
...
//     std::vector<VolumetricElementBatch> volumetric_element_batches;
//     std::unordered_map<const Geometry<Node>*, std::size_t>
//         batch_index_by_neighbour;
//     std::size_t number_of_batched_quadrature_points = 0;

//     auto collect_gap_elements_from_volume_quadrature = [&](
...
//         KRATOS_ERROR_IF(rNeighbourGeometries.size() != 1)
//             << "[SnakeGapSbmProcess::CreateSbmExtendedGeometries3D] "
//             << "Type 2/3 volumetric batching requires exactly one "
//             << "NEIGHBOUR_GEOMETRIES entry per quadrature-point set, got "
//             << rNeighbourGeometries.size() << ".\n";
//         KRATOS_ERROR_IF_NOT(rNeighbourGeometries.front())
//             << "[SnakeGapSbmProcess::CreateSbmExtendedGeometries3D] "
//             << "Cannot batch Type 2/3 quadrature points with a null "
//             << "neighbour geometry.\n";

//         const Geometry<Node>* p_neighbour_key =
//             rNeighbourGeometries.front().get();
//         const auto insertion = batch_index_by_neighbour.emplace(
//             p_neighbour_key,
//             volumetric_element_batches.size());

//         if (insertion.second) {
//             VolumetricElementBatch batch;
//             batch.NeighbourGeometries = rNeighbourGeometries;
//             batch.CharacteristicLength = CharacteristicLength;
//             volumetric_element_batches.emplace_back(std::move(batch));
//         }

//         auto& r_batch =
//             volumetric_element_batches[insertion.first->second];
...
//             rVolumeQuadraturePointGeometries.size());
...
//              ++geometry_it) {
//             r_batch.QuadraturePointGeometries.push_back(*geometry_it);
//             ++number_of_batched_quadrature_points;
//         }
...
//         gap_volume_integration_order,
//         number_of_shape_functions_derivatives,
//         collect_gap_elements_from_volume_quadrature);

//     for (auto& r_batch : volumetric_element_batches) {
//         KRATOS_ERROR_IF(r_batch.QuadraturePointGeometries.empty())
//             << "[SnakeGapSbmProcess::CreateSbmExtendedGeometries3D] "
//             << "Encountered an empty Type 2/3 volumetric batch.\n";

//         auto p_batched_geometry =
//             Kratos::make_shared<CouplingGeometry<Node>>(
//                 std::move(r_batch.QuadraturePointGeometries));
...
//         << "Type 2/3 volumetric batching: "
//         << number_of_batched_quadrature_points
//         << " quadrature points grouped into "
//         << volumetric_element_batches.size()
//         << " GapSbmSolidElementVolumetric elements.\n";
...
//     //debug //FIXME:
//     const std::size_t gap_surface_integration_order = mGapInterpolationOrder*4+1;
...
//                                                     gap_surface_integration_order+2,
//                                                     number_of_shape_functions_derivatives);
