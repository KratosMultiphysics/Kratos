...
namespace Kratos
{
    ...
    void BrepModel::GetIntegrationDomainBrepCoupling(
        ModelPart& rModelPart, 
        int& brep_id,
        const std::string& rType,
        const std::string& rName,
        ...
        std::vector<std::string> rVariables)
    {
        ...
        //int number_of_points_per_knot_span = 0;

        //int id_1 = 1;
        //int trim_index_1 = 2;
        //BrepFace& face_1 = GetFace(id_1);
        //auto surface_1 = face_1.GetSurface();
        //auto curve_2d_1 = face_1.GetTrimCurve(trim_index_1);

        //int id_2 = 1;
        //int trim_index_2 = 2;
        //const BrepFace& face_2 = GetFace(id_2);
        //auto surface_2 = face_2.GetSurface();
        //auto curve_2d_2 = face_2.GetTrimCurve(trim_index_2);
        ...
        //    {
                ...
                //double parameter_t = integration_points[ip].t;
                ...
                ////SLAVE
                //Kratos::array_1d<double, 3> point_array;
                //point_array[0] = point_3d.X();
                //point_array[1] = point_3d.Y();
                //point_array[2] = point_3d.Z();
                //projection_1.Compute(point_array);
    ...
    //BrepFace& BrepModel::GetFaceNonConst(const int& brep_id)
    //{
    //    for (int i = 0; i < m_brep_faces.size(); ++i)
    //    {
    //        if (m_brep_faces[i].GetId() == brep_id)
