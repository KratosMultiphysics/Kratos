    ...
    void AssignIgaExternalConditionsProcess::Execute(){
        ...
        for (IndexType i = 0; i < numberOfEntities; i++) {
            ...
            if (iga_physics_parameters["element_condition_list"][i]["parameters"].Has("variables")) {
                auto parameters = iga_physics_parameters["element_condition_list"][i]["parameters"]["variables"];
