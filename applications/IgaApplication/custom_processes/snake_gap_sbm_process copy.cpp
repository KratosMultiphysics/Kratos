...
// {
//     // Create the bins for the radial search
//     PointVector point_list;
//     point_list.reserve(rSkinSubModelPart.NumberOfNodes());
//     for (auto& r_node : rSkinSubModelPart.Nodes()) {
//         PointTypePointer p_point(new PointType(r_node.Id(), r_node.X(), r_node.Y(), r_node.Z()));
//         point_list.push_back(p_point);
//     }
...
//     IndexType brep_curve_on_surface_id = (mpIgaModelPart->GeometriesEnd() - 1)->Id() + 1;
