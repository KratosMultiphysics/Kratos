...
KRATOS_DEFINE_VARIABLE(Kratos::array_1d<double, 2>, LOCAL_COORDINATES)
KRATOS_DEFINE_VARIABLE(Kratos::array_1d<double, 2>, TANGENTS)
KRATOS_DEFINE_VARIABLE(Kratos::array_1d<double, 2>, TANGENTS_SLAVE)
