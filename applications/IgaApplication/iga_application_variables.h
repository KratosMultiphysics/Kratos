...
KRATOS_DEFINE_VARIABLE(Vector, DIRECTOR) 
KRATOS_DEFINE_VARIABLE(Vector, DIRECTORINC) 
KRATOS_DEFINE_VARIABLE(Vector, MOMENTDIRECTORINC) 
KRATOS_DEFINE_VARIABLE(Matrix, DIRECTORTANGENTSPACE) 
