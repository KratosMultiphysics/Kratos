...
KRATOS_DEFINE_2D_APPLICATION_VARIABLE_WITH_COMPONENTS(IGA_APPLICATION, DIRECTORINC)
KRATOS_DEFINE_2D_APPLICATION_VARIABLE_WITH_COMPONENTS(IGA_APPLICATION, MOMENTDIRECTORINC)
