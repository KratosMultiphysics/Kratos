...
KRATOS_DEFINE_VARIABLE(double, CABLE_STRESS)
...
KRATOS_DEFINE_VARIABLE(double, PRINCIPAL_STRESS_1)
KRATOS_DEFINE_VARIABLE(double, PRINCIPAL_STRESS_2)
KRATOS_DEFINE_VARIABLE(double, PRINCIPAL_STRESS_12)
