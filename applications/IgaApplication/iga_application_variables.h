...
KRATOS_DEFINE_APPLICATION_VARIABLE(IGA_APPLICATION, Vector, LOCAL_TANGENTS_MASTER)
KRATOS_DEFINE_APPLICATION_VARIABLE(IGA_APPLICATION, Vector, LOCAL_TANGENTS_SLAVE)
...
KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS(IGA_APPLICATION, VECTOR_LAGRANGE_MULTIPLIER_VELOCITY)
KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS(IGA_APPLICATION, VECTOR_LAGRANGE_MULTIPLIER_ACCELERATION)
