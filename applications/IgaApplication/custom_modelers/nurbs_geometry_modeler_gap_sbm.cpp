...
{   
    ...
    NurbsGeometryModeler::CreateAndAddRegularGrid3D(rModelPart, rPointAXyz, rPointBXyz,
        rPointAUvw, rPointBUvw, OrderU, OrderV, OrderW, NumKnotSpansU, NumKnotSpansV, NumKnotSpansW, false);
    ...
    r_iga_model_part.SetValue(KNOT_SPAN_SIZES, knot_step_uvw);
    ...
    if (!(mParameters.Has("skin_model_part_inner_initial_name") || mParameters.Has("skin_model_part_outer_initial_name"))){
        ...
        CreateBrepsSbmUtilities.CreateSurrogateBoundary(mpVolume, rPointAXyz, rPointBXyz, rModelPart);
    ...
    breps_sbm_utilities.CreateSurrogateBoundary(
        mpVolume,
        surrogate_sub_model_part_inner,
        surrogate_sub_model_part_outer,
        rPointAUvw,
        rPointBUvw,
        r_iga_model_part);
