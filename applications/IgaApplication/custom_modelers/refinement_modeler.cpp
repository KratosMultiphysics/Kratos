            ...
            for (IndexType n = 0; n < geometry_list.size(); ++n) {
                ...
                if (rParameters["parameters"].Has("insert_degree_u")) {
                    ...
                    if (degree_u > 0) {
                        ...
                        NurbsSurfaceRefinementUtilities::DegreeElevationU(*(p_nurbs_surface.get()), degree_u,
                            PointsRefined, KnotsURefined, WeightsRefined);
                        ...
                        p_nurbs_surface->SetInternals(PointsRefined,
                            p_nurbs_surface->PolynomialDegreeU() + degree_u, p_nurbs_surface->PolynomialDegreeV(),
                            KnotsURefined, p_nurbs_surface->KnotsV(),
                            WeightsRefined);
                    } else {
                        KRATOS_INFO_IF("::[RefinementModeler]::ApplyRefinement", mEchoLevel > 1)
                ...
                if (rParameters["parameters"].Has("insert_degree_v")) {
                    ...
                    if (degree_v > 0) {
                        ...
                        NurbsSurfaceRefinementUtilities::DegreeElevationV(*(p_nurbs_surface.get()), degree_v,
                            PointsRefined, KnotsVRefined, WeightsRefined);
                        ...
                        p_nurbs_surface->SetInternals(PointsRefined,
                            p_nurbs_surface->PolynomialDegreeU(), p_nurbs_surface->PolynomialDegreeV() + degree_v,
                            p_nurbs_surface->KnotsU(), KnotsVRefined,
                            WeightsRefined);
                    } else {
                        KRATOS_INFO_IF("::[RefinementModeler]::ApplyRefinement", mEchoLevel > 1)
