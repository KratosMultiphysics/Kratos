...
namespace Kratos
{
    ...
    void IgaThbModeler::SetupModelPart()
    {
    ...
    void IgaThbModeler::CreateIntegrationDomain(
    ...
    void IgaThbModeler::CreateIntegrationDomainPerUnit(
        ModelPart& rCadModelPart,
        ModelPart& rModelPart,
        const Parameters rParameters) const
    {
    ...
    void IgaThbModeler::CreateQuadraturePointGeometries(
    ...
    void IgaThbModeler::GetCadGeometryList(
        GeometriesArrayType& rGeometryList,
        ModelPart& rModelPart,
        const Parameters rParameters) const
    {
    ...
    void IgaThbModeler::CreateElements(
    ...
    void IgaThbModeler::CreateConditions(
        typename GeometriesArrayType::ptr_iterator rGeometriesBegin,
        typename GeometriesArrayType::ptr_iterator rGeometriesEnd,
        ModelPart& rModelPart,
    ...
    Parameters IgaThbModeler::ReadParamatersFile(
    ...
    void IgaThbModeler::GetPointsAt(
        GeometriesArrayType& rGeometryList,
