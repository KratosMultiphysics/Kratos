...
// class KRATOS_API(IGA_APPLICATION) NurbsGeometryModelerCutSbm
//     : public NurbsGeometryModeler
// {
// public:
//     ///@name Type Definitions
//     ///@{
//     KRATOS_CLASS_POINTER_DEFINITION( NurbsGeometryModelerCutSbm );
...
//         KRATOS_ERROR_IF_NOT(mParameters.Has("cut_element_name"))
//             << "NurbsGeometryModelerCutSbm: Missing \"cut_element_name\" section." << std::endl;
        
//         KRATOS_ERROR_IF_NOT(mParameters["cut_interface_condition_name"].IsString())
//             << "NurbsGeometryModelerCutSbm: Missing \"cut_interface_condition_name\" section." << std::endl;
        
//     }

//     /// Destructor.
//     ~NurbsGeometryModelerCutSbm() = default;
...
//     {
//         return Kratos::make_shared<NurbsGeometryModelerCutSbm>(rModel, ModelParameters);
//     }
