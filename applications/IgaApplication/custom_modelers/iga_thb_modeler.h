...
#if !defined(KRATOS_IGA_THB_MODELER_H_INCLUDED )
#define  KRATOS_IGA_THB_MODELER_H_INCLUDED
...
*/
class KRATOS_API(IGA_APPLICATION) IgaThbModeler
    : public Modeler
{
public:
    ...
    KRATOS_CLASS_POINTER_DEFINITION(IgaThbModeler);
    ...
    /// Destructor.
    virtual ~IgaThbModeler() = default;

    /// Creates the Modeler Pointer
    Modeler::Pointer Create(Model& rModel, const Parameters ModelParameters) const override
    {
        return Kratos::make_shared<IgaThbModeler>(rModel, ModelParameters);
    }
...
#endif // KRATOS_IGA_THB_MODELER_H_INCLUDED  defined