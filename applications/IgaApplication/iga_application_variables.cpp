...
KRATOS_CREATE_VARIABLE(Vector, DAMAGE_TENSION_VECTOR)
KRATOS_CREATE_VARIABLE(double, DAMAGE_TENSION)
KRATOS_CREATE_VARIABLE(double, YIELD_STRESS_TENSION)
KRATOS_CREATE_VARIABLE(Vector, DAMAGE_COMPRESSION_VECTOR)
KRATOS_CREATE_VARIABLE(double, DAMAGE_COMPRESSION)
KRATOS_CREATE_VARIABLE(double, YIELD_STRESS_COMPRESSION)
KRATOS_CREATE_VARIABLE(bool, BELOW_YIELD_STRESS)
KRATOS_CREATE_VARIABLE(bool, BELOW_YIELD_STRESS_TENSION)
KRATOS_CREATE_VARIABLE(bool, BELOW_YIELD_STRESS_COMPRESSION)
...
KRATOS_CREATE_VARIABLE(bool, ADD_SELF_WEIGHT)

//Stress Recovery Variables
KRATOS_CREATE_SYMMETRIC_2D_TENSOR_VARIABLE_WITH_COMPONENTS(GREEN_LAGRANGE_STRAIN)
...
KRATOS_CREATE_SYMMETRIC_2D_TENSOR_VARIABLE_WITH_COMPONENTS(PRINCIPAL_CAUCHY_STRESS)
...
KRATOS_CREATE_VARIABLE(double, ZETA_STEEL)
KRATOS_CREATE_VARIABLE(double, THICKNESS_STEEL)
KRATOS_CREATE_VARIABLE(int, NUMBER_OF_THICKNESS_INTEGRATION_POINTS)

//Penalty Variables
KRATOS_CREATE_VARIABLE(double, PENALTY_FACTOR)
KRATOS_CREATE_VARIABLE(double, PENALTY_FACTOR_NORMAL)
KRATOS_CREATE_VARIABLE(double, PENALTY_FACTOR_TANGENT_1)
KRATOS_CREATE_VARIABLE(double, PENALTY_FACTOR_TANGENT_2)
KRATOS_CREATE_VARIABLE(double, PENALTY_FACTOR_MOMENT_1)
KRATOS_CREATE_VARIABLE(double, PENALTY_FACTOR_MOMENT_2)
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(PENALTY_REACTION)
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(PENALTY_REACTION_FORCE)
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(VECTOR_LAGRANGE_MULTIPLIER_REACTION)
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(VECTOR_LAGRANGE_MULTIPLIER_FORCE)
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(REACTION_FORCE)
...
// MPM VARIABLES
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(MPM_LOCATION)
KRATOS_CREATE_VARIABLE(double, MPM_WEIGHT)
} // namespace Kratos
