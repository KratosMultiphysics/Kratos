...
// KRATOS_CREATE_VARIABLE(double, MEMBRANE_STRESS_X)
// KRATOS_CREATE_VARIABLE(double, MEMBRANE_STRESS_Y)
// KRATOS_CREATE_VARIABLE(double, MEMBRANE_STRESS_Z)

// KRATOS_CREATE_VARIABLE(double, BENDING_STRESS_X)
// KRATOS_CREATE_VARIABLE(double, BENDING_STRESS_Y)
// KRATOS_CREATE_VARIABLE(double, BENDING_STRESS_Z)

KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(MEMBRANE_STRESS)
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(BENDING_STRESS)
