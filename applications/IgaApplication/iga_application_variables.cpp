...
//Actuation Variables
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(ACTUATION)
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(ACTUATION_REACTION)
...
// KRATOS_CREATE_VARIABLE(double, ACTUATION_E_11)
// KRATOS_CREATE_VARIABLE(double, ACTUATION_E_12)
// KRATOS_CREATE_VARIABLE(double, ACTUATION_E_22)

// KRATOS_CREATE_VARIABLE(double, ACTUATION_KAPPA_11)
// KRATOS_CREATE_VARIABLE(double, ACTUATION_KAPPA_12)
// KRATOS_CREATE_VARIABLE(double, ACTUATION_KAPPA_22)
