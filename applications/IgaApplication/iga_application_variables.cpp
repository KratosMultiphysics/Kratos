...
KRATOS_CREATE_VARIABLE(double, VON_MISES_STRESS_IGA)
...
KRATOS_CREATE_VARIABLE(double, SCALAR_LAGRANGE_MULTIPLIER_REACTION)
...
KRATOS_CREATE_VARIABLE(double, SNAKE_SBM_EXECUTION_TIME)
KRATOS_CREATE_VARIABLE(double, SNAKE_GAP_SBM_INITIALIZATION_TIME)
KRATOS_CREATE_VARIABLE(double, SNAKE_GAP_SBM_EXECUTION_TIME)
KRATOS_CREATE_VARIABLE(std::vector<std::size_t>, SURROGATE_REPEATED_VERTICES_ID)
KRATOS_CREATE_VARIABLE(IntArray3, SURROGATE_ENTERING_XYZ)
...
KRATOS_CREATE_VARIABLE(int, PROJECTION_SURFACE_ID)
...
KRATOS_CREATE_VARIABLE(std::vector<IndexType>, SURROGATE_SEGMENT_IDS)
KRATOS_CREATE_VARIABLE(std::vector<int>, SURROGATE_SEGMENT_ORIENTATIONS)
KRATOS_CREATE_VARIABLE(Vector, TEMP_INTERPOLATION_NODES_ID)
KRATOS_CREATE_VARIABLE(int, BREP_ID)
KRATOS_CREATE_VARIABLE(std::string, BREP_MODEL_PART_FULL_NAME)

KRATOS_CREATE_VARIABLE(Matrix, RESULTS_ON_TRUE_BOUNDARY)
KRATOS_CREATE_VARIABLE(std::vector<Vector>, INTEGRATION_POINTS)
KRATOS_CREATE_VARIABLE(std::vector<Vector>, INTEGRATION_POINTS_NORMAL)
KRATOS_CREATE_VARIABLE(std::vector<double>, INTEGRATION_WEIGHTS)
KRATOS_CREATE_VARIABLE(double, MODULUS)


// CONTACT Variables
KRATOS_CREATE_VARIABLE( double, NORMAL_GAP )
KRATOS_CREATE_VARIABLE( double, GAMMA_CONTACT )
KRATOS_CREATE_VARIABLE( double, CONTACT_PRESSURE )
KRATOS_CREATE_VARIABLE( Vector, GAP )
KRATOS_CREATE_VARIABLE( Matrix, RESULTS_ON_TRUE_BOUNDARY_MASTER )
KRATOS_CREATE_VARIABLE( Matrix, RESULTS_ON_TRUE_BOUNDARY_SLAVE )
KRATOS_CREATE_VARIABLE( std::vector<Vector>, INTEGRATION_POINTS_MASTER )
KRATOS_CREATE_VARIABLE( std::vector<Vector>, INTEGRATION_POINTS_SLAVE )
KRATOS_CREATE_VARIABLE( std::vector<double>, INTEGRATION_WEIGHTS_MASTER )
KRATOS_CREATE_VARIABLE( std::vector<double>, INTEGRATION_WEIGHTS_SLAVE )
KRATOS_CREATE_VARIABLE( Matrix, CONSTITUTIVE_MATRIX_MASTER )
KRATOS_CREATE_VARIABLE( Matrix, CONSTITUTIVE_MATRIX_SLAVE )
KRATOS_CREATE_VARIABLE( Vector, NORMAL_STRESS_MASTER )
KRATOS_CREATE_VARIABLE( Vector, NORMAL_STRESS_SLAVE )
KRATOS_CREATE_VARIABLE( Vector, NORMAL_MASTER)
KRATOS_CREATE_VARIABLE( Vector, NORMAL_SLAVE)
KRATOS_CREATE_VARIABLE( Vector, NORMAL_SKIN_MASTER)
KRATOS_CREATE_VARIABLE( Vector, NORMAL_SKIN_SLAVE)
KRATOS_CREATE_VARIABLE( Vector, DISPLACEMENT_MASTER)
KRATOS_CREATE_VARIABLE( Vector, DISPLACEMENT_SLAVE)
KRATOS_CREATE_VARIABLE( Vector, STRESS_MASTER)
KRATOS_CREATE_VARIABLE( Vector, STRESS_SLAVE)
KRATOS_CREATE_VARIABLE( Vector, STRAIN_MASTER)
KRATOS_CREATE_VARIABLE( Vector, STRAIN_SLAVE)
KRATOS_CREATE_VARIABLE( int, OLD_ACTIVATION_LEVEL)
KRATOS_CREATE_VARIABLE( double, YOUNG_MODULUS_MASTER)
KRATOS_CREATE_VARIABLE( double, YOUNG_MODULUS_SLAVE)
KRATOS_CREATE_VARIABLE( Vector, SKIN_MASTER_COORDINATES)
KRATOS_CREATE_VARIABLE( Vector, SKIN_SLAVE_COORDINATES)
KRATOS_CREATE_VARIABLE( Vector, SURROGATE_MASTER_COORDINATES)
KRATOS_CREATE_VARIABLE( Vector, SURROGATE_SLAVE_COORDINATES)
KRATOS_CREATE_VARIABLE( bool, IS_ASSEMBLED)

KRATOS_CREATE_VARIABLE(int, PROJECTION_NODE_MASTER_ID)
KRATOS_CREATE_VARIABLE(int, PROJECTION_NODE_SLAVE_ID)
KRATOS_CREATE_VARIABLE(double, CURVATURE_PROJECTION_MASTER)
KRATOS_CREATE_VARIABLE(double, CURVATURE_PROJECTION_SLAVE)
