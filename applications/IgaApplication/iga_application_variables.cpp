...
KRATOS_CREATE_VARIABLE(double, NITSCHE_CONTACT_PRESSURE)
...
KRATOS_CREATE_VARIABLE(std::string, ORIGINAL_SKIN_MODEL_PART_FULL_NAME)
KRATOS_CREATE_VARIABLE(bool, IS_LOCAL_REFINEMENT_FAKE_COUPLING)
