...
// Beam Variables
KRATOS_CREATE_VARIABLE(Vector, T_0)
KRATOS_CREATE_VARIABLE(Vector, N_0)
KRATOS_CREATE_VARIABLE(Matrix, LOCAL_AXIS_ORIENTATION)
KRATOS_CREATE_VARIABLE(std::string, BEAM_MASS_FORMULATION)
KRATOS_CREATE_VARIABLE(double, I_V)
KRATOS_CREATE_VARIABLE(double, I_N)
KRATOS_CREATE_VARIABLE(double, I_T)
KRATOS_CREATE_VARIABLE(double, HEIGHT)
KRATOS_CREATE_VARIABLE(double, WIDTH)
KRATOS_CREATE_VARIABLE(Vector, LOCAL_CS_N)
KRATOS_CREATE_VARIABLE(Vector, LOCAL_CS_n)
KRATOS_CREATE_VARIABLE(Vector, LOCAL_CS_V)
KRATOS_CREATE_VARIABLE(Vector, LOCAL_CS_v)
KRATOS_CREATE_VARIABLE(double, VON_MISES_STRESS)
KRATOS_CREATE_VARIABLE(bool, ROTATIONAL_DOF_ACTIVE)
