...
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(VECTOR_LAGRANGE_MULTIPLIER_ROTATION)

//Nitsche Variables
KRATOS_CREATE_VARIABLE(double, NITSCHE_STABILIZATION_FACTOR)
KRATOS_CREATE_VARIABLE(double, NITSCHE_STABILIZATION_ROTATION_FACTOR)
...
KRATOS_CREATE_VARIABLE(Vector, EIGENVALUE_NITSCHE_STABILIZATION_ROTATION_VECTOR)
KRATOS_CREATE_VARIABLE(int, BUILD_LEVEL)
KRATOS_CREATE_VARIABLE(int, STABILIZATION_METHOD)
...
KRATOS_CREATE_VARIABLE(Vector, UNIT_NORMAL)

// SBM-MLS coupling extension operator
KRATOS_CREATE_VARIABLE(std::vector<Node::Pointer>, SBM_MLS_ALL_DOF_NODES)
KRATOS_CREATE_VARIABLE(Matrix, SBM_MLS_MASTER_WEIGHTS)
KRATOS_CREATE_VARIABLE(Matrix, SBM_MLS_SLAVE_WEIGHTS)
KRATOS_CREATE_VARIABLE(Matrix, SBM_MLS_MASTER_GRADIENT_WEIGHTS_XI)
KRATOS_CREATE_VARIABLE(Matrix, SBM_MLS_MASTER_GRADIENT_WEIGHTS_ETA)
KRATOS_CREATE_VARIABLE(Matrix, SBM_MLS_SLAVE_GRADIENT_WEIGHTS_XI)
KRATOS_CREATE_VARIABLE(Matrix, SBM_MLS_SLAVE_GRADIENT_WEIGHTS_ETA)
KRATOS_CREATE_VARIABLE(double, SBM_SURROGATE_CONORMAL_SIGN)
KRATOS_CREATE_VARIABLE(Vector, SBM_SURROGATE_REFERENCE_DIRECTION)
KRATOS_CREATE_VARIABLE(Vector, SBM_TAYLOR_TARGET_POINT)
KRATOS_CREATE_VARIABLE(Vector, SBM_DIRICHLET_VALUE)
