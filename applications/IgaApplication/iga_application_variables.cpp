...
//Actuation Variables
KRATOS_CREATE_SYMMETRIC_2D_TENSOR_VARIABLE_WITH_COMPONENTS( ACTUATION_STRAINS )
KRATOS_CREATE_SYMMETRIC_2D_TENSOR_VARIABLE_WITH_COMPONENTS( ACTUATION_STRAINS_REACTION )

KRATOS_CREATE_SYMMETRIC_2D_TENSOR_VARIABLE_WITH_COMPONENTS( ACTUATION_CURAVTURES )
KRATOS_CREATE_SYMMETRIC_2D_TENSOR_VARIABLE_WITH_COMPONENTS( ACTUATION_CURAVTURES_REACTION )

// KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(ACTUATION_STRAINS)
// KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(ACTUATION_STRAINS_REACTION)

// KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(ACTUATION_CURAVTURES)
// KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(ACTUATION_CURAVTURES_REACTION)

// KRATOS_CREATE_VARIABLE(double, ACTUATION_ALPHA)
// KRATOS_CREATE_VARIABLE(double, ACTUATION_ALPHA_REACTION)
// KRATOS_CREATE_VARIABLE(double, ACTUATION_BETA)
// KRATOS_CREATE_VARIABLE(double, ACTUATION_BETA_REACTION)
// KRATOS_CREATE_VARIABLE(double, ACTUATION_GAMMA)
// KRATOS_CREATE_VARIABLE(double, ACTUATION_GAMMA_REACTION)
// KRATOS_CREATE_VARIABLE(double, ACTUATION_KAPPA_1)
// KRATOS_CREATE_VARIABLE(double, ACTUATION_KAPPA_1_REACTION)
// KRATOS_CREATE_VARIABLE(double, ACTUATION_KAPPA_2)
// KRATOS_CREATE_VARIABLE(double, ACTUATION_KAPPA_2_REACTION)
// KRATOS_CREATE_VARIABLE(double, ACTUATION_KAPPA_12)
// KRATOS_CREATE_VARIABLE(double, ACTUATION_KAPPA_12_REACTION)
...
//Actuation Variables
KRATOS_CREATE_VARIABLE(double, ACTIVE_SHELL_ALPHA)
KRATOS_CREATE_VARIABLE(double, REACTION_ACTIVE_SHELL_ALPHA)
KRATOS_CREATE_VARIABLE(double, ACTIVE_SHELL_BETA)
KRATOS_CREATE_VARIABLE(double, REACTION_ACTIVE_SHELL_BETA)
KRATOS_CREATE_VARIABLE(double, ACTIVE_SHELL_GAMMA)
KRATOS_CREATE_VARIABLE(double, REACTION_ACTIVE_SHELL_GAMMA)

KRATOS_CREATE_VARIABLE(double, ACTIVE_SHELL_KAPPA_1)
KRATOS_CREATE_VARIABLE(double, REACTION_ACTIVE_SHELL_KAPPA_1)
KRATOS_CREATE_VARIABLE(double, ACTIVE_SHELL_KAPPA_2)
KRATOS_CREATE_VARIABLE(double, REACTION_ACTIVE_SHELL_KAPPA_2)
KRATOS_CREATE_VARIABLE(double, ACTIVE_SHELL_KAPPA_12)
KRATOS_CREATE_VARIABLE(double, REACTION_ACTIVE_SHELL_KAPPA_12) 

KRATOS_CREATE_VARIABLE(GlobalPointersVector<Node>, ACTIVE_SHELL_NODE_GP)

// Adjoint Actuation Variables
KRATOS_CREATE_VARIABLE(double, ADJOINT_ACTIVE_SHELL_ALPHA)
KRATOS_CREATE_VARIABLE(double, ADJOINT_ACTIVE_SHELL_BETA)
KRATOS_CREATE_VARIABLE(double, ADJOINT_ACTIVE_SHELL_GAMMA)

KRATOS_CREATE_VARIABLE(double, ADJOINT_ACTIVE_SHELL_KAPPA_1)
KRATOS_CREATE_VARIABLE(double, ADJOINT_ACTIVE_SHELL_KAPPA_2)
KRATOS_CREATE_VARIABLE(double, ADJOINT_ACTIVE_SHELL_KAPPA_12)

// Adjoint Reaction Actuation Variables
KRATOS_CREATE_VARIABLE(double, ADJOINT_REACTION_ACTIVE_SHELL_ALPHA)
KRATOS_CREATE_VARIABLE(double, ADJOINT_REACTION_ACTIVE_SHELL_BETA)
KRATOS_CREATE_VARIABLE(double, ADJOINT_REACTION_ACTIVE_SHELL_GAMMA)

KRATOS_CREATE_VARIABLE(double, ADJOINT_REACTION_ACTIVE_SHELL_KAPPA_1)
KRATOS_CREATE_VARIABLE(double, ADJOINT_REACTION_ACTIVE_SHELL_KAPPA_2)
KRATOS_CREATE_VARIABLE(double, ADJOINT_REACTION_ACTIVE_SHELL_KAPPA_12)
} // namespace Kratos
