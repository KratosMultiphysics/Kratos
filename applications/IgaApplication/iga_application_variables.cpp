...
KRATOS_CREATE_VARIABLE(double, CABLE_STRESS)
...
KRATOS_CREATE_VARIABLE(double, PRINCIPAL_STRESS_12)
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(PRINCIPAL_STRESSES)
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(PRINCIPAL_FORCES)
