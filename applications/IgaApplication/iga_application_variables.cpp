...
KRATOS_CREATE_VARIABLE(double, STABILIZATION_TRANSLATION_FACTOR)
KRATOS_CREATE_VARIABLE(double, STABILIZATION_ROTATION_FACTOR)
KRATOS_CREATE_VARIABLE(double, INITIAL_DISTANCE_TO_FIRST_STABLE_POINT)
KRATOS_CREATE_VARIABLE(double, INITIAL_DISTANCE_FIRST_TO_SECOND_STABLE_POINT)
