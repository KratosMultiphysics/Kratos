...
namespace Testing
{
    ...
    typename Element::Pointer GetShell3pStressBasedElement(
        ...
        int NumberOfThicknessIntegrationPoints)
    {
        ...
        p_elem_prop->SetValue(NUMBER_OF_THICKNESS_INTEGRATION_POINTS, NumberOfThicknessIntegrationPoints);
        ...
        return Kratos::make_intrusive<Shell3pStressBasedElement>(1, p_quadrature_point, p_elem_prop);
    }

    // Tests the stiffness matrix of the Shell3pElement with a polynomial degree of p=3.
    KRATOS_TEST_CASE_IN_SUITE(IgaShell3pStressBasedElementP3, KratosIgaFastSuite)
    {
        Model current_model;
        ...
        auto p_shell_3p_element = GetShell3pStressBasedElement(r_model_part, 3, integration_point, 7);
    ...
    KRATOS_TEST_CASE_IN_SUITE(IgaShell3pStressBasedElementP4, KratosIgaFastSuite)
    {
        Model current_model;
        auto &r_model_part = current_model.CreateModelPart("ModelPart");
        r_model_part.GetProcessInfo().SetValue(DOMAIN_SIZE, 3);
        ...
        auto p_shell_3p_element = GetShell3pStressBasedElement(r_model_part, 4, integration_point, 3);
    ...
    KRATOS_TEST_CASE_IN_SUITE(IgaShell3pStressBasedElementP5, KratosIgaFastSuite)
    {
        Model current_model;
        auto &r_model_part = current_model.CreateModelPart("ModelPart");
        r_model_part.GetProcessInfo().SetValue(DOMAIN_SIZE, 3);
        ...
        auto p_shell_3p_element = GetShell3pStressBasedElement(r_model_part, 5, integration_point, 3);
    ...
    KRATOS_TEST_CASE_IN_SUITE(IgaShell3pStressBasedElementP3Disp, KratosIgaFastSuite)
    {
        Model current_model;
        auto &r_model_part = current_model.CreateModelPart("ModelPart");
        r_model_part.GetProcessInfo().SetValue(DOMAIN_SIZE, 3);
        ...
        IntegrationPoint<3> integration_point(0.0694318442029737, 0.211324865405187, 0.0, 0.086963711284364);
        auto p_shell_3p_element = GetShell3pStressBasedElement(r_model_part, 3, integration_point, 3);
    ...
    KRATOS_TEST_CASE_IN_SUITE(IgaShell3pStressBasedElementP4Disp, KratosIgaFastSuite)
    {
        Model current_model;
        auto &r_model_part = current_model.CreateModelPart("ModelPart");
        r_model_part.GetProcessInfo().SetValue(DOMAIN_SIZE, 3);
    ...
    KRATOS_TEST_CASE_IN_SUITE(IgaShell3pStressBasedElementP5Disp, KratosIgaFastSuite)
    {
        Model current_model;
        auto &r_model_part = current_model.CreateModelPart("ModelPart");
        r_model_part.GetProcessInfo().SetValue(DOMAIN_SIZE, 3);
