...
namespace Testing
{
    ...
    KRATOS_TEST_CASE_IN_SUITE(IgaShell5pElementP3, KratosIgaFast5PSuite)
    {
        ...
        std::cout << "===============IgaShell5pElementP3START===================" << std::endl;
        std::cout << left_hand_side_matrix << std::endl;
        std::cout << "==================================" << std::endl;
        std::cout << right_hand_side_vector << std::endl;
        std::cout << "=================IgaShell5pElementP3END=================" << std::endl;
    ...
    KRATOS_TEST_CASE_IN_SUITE(IgaShell5pElementP4, KratosIgaFast5PSuite)
    {
        ...
        //Check RHS and LHS results
        const double tolerance = 1.0e-8;
        std::cout << "===============IgaShell5pElementP4START===================" << std::endl;
        std::cout << left_hand_side_matrix << std::endl;
        std::cout << "==================================" << std::endl;
        std::cout << right_hand_side_vector << std::endl;
        std::cout << "=================IgaShell5pElementP4END=================" << std::endl;
    ...
    KRATOS_TEST_CASE_IN_SUITE(IgaShell5pElementP5, KratosIgaFast5PSuite)
    {
        ...
        //Check RHS and LHS results
        const double tolerance = 1.0e-8;
        std::cout << "===============IgaShell5pElementP5START===================" << std::endl;
        std::cout << left_hand_side_matrix << std::endl;
        std::cout << "==================================" << std::endl;
        std::cout << right_hand_side_vector << std::endl;
        std::cout << "=================IgaShell5pElementP5END=================" << std::endl;
    ...
    KRATOS_TEST_CASE_IN_SUITE(IgaShell5pElementP3Disp, KratosIgaFast5PSuite)
    {
        ...
        //Check RHS and LHS results
        const double tolerance = 1.0e-8;
        std::cout << "===============IgaShell5pElementP3DispSTART===================" << std::endl;
        std::cout << left_hand_side_matrix << std::endl;
        std::cout << "==================================" << std::endl;
        std::cout << right_hand_side_vector << std::endl;
        std::cout << "=================IgaShell5pElementP3DispEND=================" << std::endl;
    ...
    KRATOS_TEST_CASE_IN_SUITE(IgaShell5pElementP4Disp, KratosIgaFast5PSuite)
    {
        ...
        //Check RHS and LHS results
        const double tolerance = 1.0e-8;
        std::cout << "===============IgaShell5pElementP4DispSTART===================" << std::endl;
        std::cout << left_hand_side_matrix << std::endl;
        std::cout << "==================================" << std::endl;
        std::cout << right_hand_side_vector << std::endl;
        std::cout << "=================IgaShell5pElementP4DispEND=================" << std::endl;
    ...
    KRATOS_TEST_CASE_IN_SUITE(IgaShell5pElementP5Disp, KratosIgaFast5PSuite)
    {
        ...
        //Check RHS and LHS results
        const double tolerance = 1.0e-8;
        std::cout << "===============IgaShell5pElementP5DispSTART===================" << std::endl;
        std::cout << left_hand_side_matrix << std::endl;
        std::cout << "==================================" << std::endl;
        std::cout << right_hand_side_vector << std::endl;
        std::cout << "=================IgaShell5pElementP5DispEND=================" << std::endl;
