...
/** Reissner-Mindlin Shell. Optimized for Isogeometric Analysis 
*/
class ShellRMElement
    : public Element
{
protected:
...
public:
    ...
    /// Counted pointer of ShellRMElement
    KRATOS_CLASS_INTRUSIVE_POINTER_DEFINITION(ShellRMElement);
    ...
    {};
    /// Destructor.
    virtual ~ShellRMElement() = default;
    ...
    {
        return Kratos::make_intrusive<ShellRMElement>(
