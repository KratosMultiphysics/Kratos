#if !defined(KRATOS_SHELL_5p_HIERARCHIC_GRADIENT_ELEMENT_H_INCLUDED)
#define  KRATOS_SHELL_5p_HIERARCHIC_GRADIENT_ELEMENT_H_INCLUDED
...
class Shell5pHierarchicGradientElement
    : public Element
{
public:
    ...
    /// Counted pointer of Shell5pHierarchicGradientElement
    KRATOS_CLASS_INTRUSIVE_POINTER_DEFINITION(Shell5pHierarchicGradientElement);
    ...
    Shell5pHierarchicGradientElement(IndexType NewId, GeometryType::Pointer pGeometry)
        : Element(NewId, pGeometry)
    {};

    /// Constructor using an array of nodes with properties
    Shell5pHierarchicGradientElement(IndexType NewId, GeometryType::Pointer pGeometry, PropertiesType::Pointer pProperties)
        : Element(NewId, pGeometry, pProperties)
    {};

    /// default constructor
    Shell5pHierarchicGradientElement() : Element() {};

    /// Destructor.
    virtual ~Shell5pHierarchicGradientElement() override
    {};
    ...
    {
        return Kratos::make_intrusive<Shell5pHierarchicGradientElement>(
    ...
    {
        KRATOS_ERROR << "Can not construct Shell5pHierarchicGradientElement with NodesArrayType, because "
...
#endif // KRATOS_SHELL_5p_HIERARCHIC_GRADIENT_ELEMENT_H_INCLUDED  defined
