#if !defined(KRATOS_SHELL_3P_STRESS_BASED_ELEMENT_H_INCLUDED )
#define  KRATOS_SHELL_3P_STRESS_BASED_ELEMENT_H_INCLUDED
...
*/
class Shell3pStressBasedElement
    : public Element
{
protected:
...
public:
    ...
    /// Counted pointer of Shell3pStressBasedElement
    KRATOS_CLASS_INTRUSIVE_POINTER_DEFINITION(Shell3pStressBasedElement);
    ...
    /// Destructor.
    virtual ~Shell3pStressBasedElement() = default;
    ...
    {
        return Kratos::make_intrusive<Shell3pStressBasedElement>(
    ...
    */
    ...
    std::string Info() const override
    {
        ...
        buffer << "Kirchhoff-Love Shell3pStressBasedElement #" << Id();
        return buffer.str();
    }
    ...
    {
        rOStream << "Kirchhoff-Love Shell3pStressBasedElement #" << Id();
    }
...
private:
    ...
    */
    ...
    /// Thickness integration points are defined from -1 to 1.
