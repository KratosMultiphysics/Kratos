...
namespace Kratos
{
    void Shell5pHierarchicGradientElement::SetThicknessIntegrationPoints()
    {
    ...
    void Shell5pHierarchicGradientElement::Initialize(const ProcessInfo& rCurrentProcessInfo)
    {
    ...
    void Shell5pHierarchicGradientElement::InitializeMaterial()
    {
        KRATOS_TRY
    ...
    void Shell5pHierarchicGradientElement::CalculateAll(
    ...
    )
    {
        ...
        for (IndexType thickness_point_number = 0; thickness_point_number < mNumberOfThicknessIntegrationPoints; ++thickness_point_number)
        {
            ...
            double local_E = E * (pow(mZeta[thickness_point_number], 2) + 0.003);
            properties[YOUNG_MODULUS] = local_E;
            double local_G = G * (pow(mZeta[thickness_point_number], 2) + 0.003);
            properties[SHEAR_MODULUS] = local_G;
    ...
    void Shell5pHierarchicGradientElement::CalculateAndAddKm(
        MatrixType& rLeftHandSideMatrix,
        const Matrix& B,
        const Matrix& D,
    ...
    void Shell5pHierarchicGradientElement::CalculateAndAddNonlinearKm(
    ...
    void Shell5pHierarchicGradientElement::CalculateMetric(
    ...
    void Shell5pHierarchicGradientElement::CalculateTransformationMatrixInitialTransConToCar(
    ...
    void Shell5pHierarchicGradientElement::CalculateTransformationMatrixInitialTransCarToCov(Matrix& rInitialTransCarToCov)
    {
    ...
    void Shell5pHierarchicGradientElement::CalculateTransformationMatrixActualTransCovToCar(
    ...
    void Shell5pHierarchicGradientElement::CalculateShearDifferenceVector(
    ...
    void Shell5pHierarchicGradientElement::CalculateInitialBaseVectorsLinearised(
    ...
    void Shell5pHierarchicGradientElement::CalculateActualBaseVectorsLinearised(
        const MetricVariables& rActualMetric,
        const Vector& rw,
        const Vector& rDw_D1,
        const Vector& rDw_D2,
    ...
    void Shell5pHierarchicGradientElement::CalculateDeformationGradient(
    ...
    void Shell5pHierarchicGradientElement::CalculateConstitutiveVariables(
        const MetricVariables& rActualMetric,
        const Vector& rw,
        const Vector& rDw_D1,
        const Vector& rDw_D2,
    ...
    void Shell5pHierarchicGradientElement::CalculateStrain(
    ...
    void Shell5pHierarchicGradientElement::CalculateStrainReissnerMindlin(
    ...
    void Shell5pHierarchicGradientElement::TransformationCurvilinearStrainSize5ToCartesianStrainSize6(
    ...
    void Shell5pHierarchicGradientElement::CalculateB(
        Matrix& rB,
        const MetricVariables& rActualMetric,
        IndexType IntegrationPointIndex,
        double Zeta)
    ...
    void Shell5pHierarchicGradientElement::CalculateSecondVariations(
    ...
    void Shell5pHierarchicGradientElement::CalculateVariationsReissnerMindlin(
        Matrix& rB,
        SecondVariations& rSecondVariations,
        const Vector& rw,
        const Vector& rDw_D1,
    ...
    void Shell5pHierarchicGradientElement::CalculateOnIntegrationPoints(
    ...
    )
    {
        ...
        for (IndexType point_number = 0; point_number < r_integration_points.size(); ++point_number)
        {
            if (rVariable == CAUCHY_STRESS_TOP_XX) {
                ...
                KRATOS_WATCH("No results for desired variable available in Calculate of Shell5pHierarchicGradientElement.")
            }
        }
    ...
    void Shell5pHierarchicGradientElement::CalculateHessian(
        Matrix& Hessian,
    ...
    void Shell5pHierarchicGradientElement::EquationIdVector(
    ...
    void Shell5pHierarchicGradientElement::GetDofList(
    ...
    int Shell5pHierarchicGradientElement::Check(const ProcessInfo& rCurrentProcessInfo) const
    {
