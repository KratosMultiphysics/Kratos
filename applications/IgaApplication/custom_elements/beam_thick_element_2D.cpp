...
namespace Kratos
{
    ...
    ) const
    {
        ...
        for (IndexType point_number = 0; point_number < r_integration_points.size(); ++point_number) {
            ...
            CalculateBShear(point_number, BShear, kinematic_variables);
    ...
    ) const
    {
        ...
        rThisConstitutiveVariablesShear.StrainValue = shear;
        ...
        rThisConstitutiveVariablesShear.ConstitutiveValue = (E / (2.0 * (1 + nu)))* (5.0 / 6.0) * cross_area / (std::pow(rActualKinematic.dL, 2));
        ...
        const KinematicVariables& rActualKinematic) const
    {
        ...
        if (rB.size() != mat_size) rB.resize(mat_size);
