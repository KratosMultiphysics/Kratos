#if !defined(KRATOS_SHELL_3P_STRESS_BASED_GRADIENT_ELEMENT_H_INCLUDED )
#define  KRATOS_SHELL_3P_STRESS_BASED_GRADIENT_ELEMENT_H_INCLUDED
...
*/
class Shell3pStressBasedGradientElement
    : public Element
{
protected:
...
public:
    ...
    /// Counted pointer of Shell3pStressBasedGradientElement
    KRATOS_CLASS_INTRUSIVE_POINTER_DEFINITION(Shell3pStressBasedGradientElement);
    ...
    Shell3pStressBasedGradientElement(
        IndexType NewId,
    ...
    /// Destructor.
    virtual ~Shell3pStressBasedGradientElement() = default;
    ...
    {
        return Kratos::make_intrusive<Shell3pStressBasedGradientElement>(
    ...
    */
    ...
    std::string Info() const override
    {
        ...
        buffer << "Kirchhoff-Love Shell3pStressBasedGradientElement #" << Id();
        return buffer.str();
    }
    ...
    {
        rOStream << "Kirchhoff-Love Shell3pStressBasedGradientElement #" << Id();
    }
