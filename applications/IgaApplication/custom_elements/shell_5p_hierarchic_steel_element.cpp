...
namespace Kratos
{
    void Shell5pHierarchicSteelElement::SetThicknessIntegrationPoints()
    {
        ...
        mNumberOfThicknessIntegrationPoints = 1;
        mZeta.resize(1);
        mThicknessIntegrationWeights.resize(1);

        double zeta_value = GetProperties()[ZETA_STEEL];
        double thickness_steel = GetProperties()[THICKNESS_STEEL];
        //for (SizeType i = 0; i < number_integration_points; ++i)
        //{
            mZeta[0] = zeta_value;
            mThicknessIntegrationWeights[0] = thickness_steel;
        //}

        //KRATOS_WATCH(mThicknessIntegrationWeights[0])
        //KRATOS_WATCH(zeta_value)
    }

    void Shell5pHierarchicSteelElement::Initialize(const ProcessInfo& rCurrentProcessInfo)
    {
    ...
    void Shell5pHierarchicSteelElement::InitializeMaterial()
    {
        KRATOS_TRY
    ...
    void Shell5pHierarchicSteelElement::CalculateAll(
    ...
    void Shell5pHierarchicSteelElement::CalculateAndAddKm(
        MatrixType& rLeftHandSideMatrix,
        const Matrix& B,
        const Matrix& D,
    ...
    void Shell5pHierarchicSteelElement::CalculateAndAddNonlinearKm(
    ...
    void Shell5pHierarchicSteelElement::CalculateMetric(
    ...
    void Shell5pHierarchicSteelElement::CalculateTransformationMatrixInitialTransConToCar(
    ...
    void Shell5pHierarchicSteelElement::CalculateTransformationMatrixInitialTransCarToCov(Matrix& rInitialTransCarToCov)
    {
    ...
    void Shell5pHierarchicSteelElement::CalculateTransformationMatrixActualTransCovToCar(
    ...
    void Shell5pHierarchicSteelElement::CalculateShearDifferenceVector(
    ...
    void Shell5pHierarchicSteelElement::CalculateInitialBaseVectorsLinearised(
    ...
    void Shell5pHierarchicSteelElement::CalculateActualBaseVectorsLinearised(
        const MetricVariables& rActualMetric,
        const Vector& rw,
        const Vector& rDw_D1,
        const Vector& rDw_D2,
    ...
    void Shell5pHierarchicSteelElement::CalculateDeformationGradient(
    ...
    void Shell5pHierarchicSteelElement::CalculateConstitutiveVariables(
        const MetricVariables& rActualMetric,
        const Vector& rw,
        const Vector& rDw_D1,
        const Vector& rDw_D2,
    ...
    void Shell5pHierarchicSteelElement::CalculateStrain(
    ...
    void Shell5pHierarchicSteelElement::CalculateStrainReissnerMindlin(
    ...
    void Shell5pHierarchicSteelElement::TransformationCurvilinearStrainSize5ToCartesianStrainSize6(
    ...
    void Shell5pHierarchicSteelElement::CalculateB(
        Matrix& rB,
        const MetricVariables& rActualMetric,
        IndexType IntegrationPointIndex,
        double Zeta)
    ...
    void Shell5pHierarchicSteelElement::CalculateSecondVariations(
    ...
    void Shell5pHierarchicSteelElement::CalculateVariationsReissnerMindlin(
        Matrix& rB,
        SecondVariations& rSecondVariations,
        const Vector& rw,
        const Vector& rDw_D1,
    ...
    void Shell5pHierarchicSteelElement::CalculateOnIntegrationPoints(
    ...
    )
    {
        ...
        for (IndexType point_number = 0; point_number < r_integration_points.size(); ++point_number)
        {
            if (rVariable == CAUCHY_STRESS_TOP_XX) {
                ...
                KRATOS_WATCH("No results for desired variable available in Calculate of Shell5pHierarchicSteelElement.")
            }
        }
    ...
    void Shell5pHierarchicSteelElement::CalculateHessian(
        Matrix& Hessian,
    ...
    void Shell5pHierarchicSteelElement::EquationIdVector(
    ...
    void Shell5pHierarchicSteelElement::GetDofList(
    ...
    int Shell5pHierarchicSteelElement::Check(const ProcessInfo& rCurrentProcessInfo) const
    {
