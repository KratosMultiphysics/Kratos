...
///@name Kratos Classes
///@{
class KRATOS_API(IGA_APPLICATION) GapSbmNavierStokesElement : public Element
{
...
public:
    ...
    /// Counted pointer of GapSbmNavierStokesElement
    KRATOS_CLASS_INTRUSIVE_POINTER_DEFINITION(GapSbmNavierStokesElement);
    ...
    /// Destructor.
    virtual ~GapSbmNavierStokesElement();
    ...
    */
    ...
    GapSbmNavierStokesElement() : Element()
    {
    }
    ...
    std::string Info() const override
    {
        ...
        buffer << "GapSbmNavierStokesElement #" << Id();
        return buffer.str();
    }
...
}; // Class GapSbmNavierStokesElement
