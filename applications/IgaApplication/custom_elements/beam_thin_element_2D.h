#if !defined(KRATOS_BEAM_THIN_ELEMENT_2D_H_INCLUDED )
#define  KRATOS_BEAM_THIN_ELEMENT_2D_H_INCLUDED
...
/** Non-linear 2D Bernoulli Beam. Optimized for Isogeometric Analysis.
*/
class KRATOS_API(IGA_APPLICATION) BeamThinElement2D
    : public Element
{
protected:
...
public:
    ...
    /// Counted pointer of BeamThinElement2D
    KRATOS_CLASS_INTRUSIVE_POINTER_DEFINITION(BeamThinElement2D);
    ...
    /// Destructor.
    virtual ~BeamThinElement2D() = default;
    ...
    {
        return Kratos::make_intrusive<BeamThinElement2D>(
    ...
    */
    ...
    std::string Info() const override
    {
        ...
        buffer << "Kirchhoff-Love BeamThinElement2D #" << Id();
        return buffer.str();
    }
    ...
    {
        rOStream << "Kirchhoff-Love BeamThinElement2D #" << Id();
    }
...
};     // Class BeamThinElement2D
///@}

}  // namespace Kratos.

#endif // KRATOS__BEAM_THIN_ELEMENT_2D_H_INCLUDED  defined
