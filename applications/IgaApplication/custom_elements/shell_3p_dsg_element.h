#if !defined(KRATOS_SHELL_3P_DSG_ELEMENT_H_INCLUDED )
#define  KRATOS_SHELL_3P_DSG_ELEMENT_H_INCLUDED
...
*/
class KRATOS_API(IGA_APPLICATION) Shell3pDSGElement
    : public Element
{
protected:
...
public:
    ...
    /// Counted pointer of Shell3pDSGElement
    KRATOS_CLASS_INTRUSIVE_POINTER_DEFINITION(Shell3pDSGElement);
    ...
    /// Destructor.
    virtual ~Shell3pDSGElement() = default;
    ...
    {
        return Kratos::make_intrusive<Shell3pDSGElement>(
    ...
    */
    ...
    std::string Info() const override
    {
        ...
        buffer << "Kirchhoff-Love Shell3pDSGElement #" << Id();
        return buffer.str();
    }
    ...
    {
        rOStream << "Kirchhoff-Love Shell3pDSGElement #" << Id();
    }
...
private:
    ...
    // Determinant of the 1d Jacobian.
    Vector m_dL_xi_vector;
     // Determinant of the 1d Jacobian.
    Vector m_dL_eta_vector;
