#if !defined(KRATOS_SHELL_5p_HIERARCHIC_STEEL_ELEMENT_H_INCLUDED)
#define  KRATOS_SHELL_5p_HIERARCHIC_STEEL_ELEMENT_H_INCLUDED
...
class Shell5pHierarchicSteelElement
    : public Element
{
public:
    ...
    /// Counted pointer of Shell5pHierarchicSteelElement
    KRATOS_CLASS_INTRUSIVE_POINTER_DEFINITION(Shell5pHierarchicSteelElement);
    ...
    Shell5pHierarchicSteelElement(IndexType NewId, GeometryType::Pointer pGeometry)
        : Element(NewId, pGeometry)
    {};

    /// Constructor using an array of nodes with properties
    Shell5pHierarchicSteelElement(IndexType NewId, GeometryType::Pointer pGeometry, PropertiesType::Pointer pProperties)
        : Element(NewId, pGeometry, pProperties)
    {};

    /// default constructor
    Shell5pHierarchicSteelElement() : Element() {};

    /// Destructor.
    virtual ~Shell5pHierarchicSteelElement() override
    {};
    ...
    {
        return Kratos::make_intrusive<Shell5pHierarchicSteelElement>(
    ...
    {
        KRATOS_ERROR << "Can not construct Shell5pHierarchicSteelElement with NodesArrayType, because "
