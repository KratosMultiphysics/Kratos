#if !defined(KRATOS_SHELL_3P_MIXED_MEMBRANE_ELEMENT_H_INCLUDED )
#define  KRATOS_SHELL_3P_MIXED_MEMBRANE_ELEMENT_H_INCLUDED
...
*/
class KRATOS_API(IGA_APPLICATION) Shell3pMixedMembraneElement
    : public Element
{
protected:
...
public:
    ...
    /// Counted pointer of Shell3pMixedMembraneElement
    KRATOS_CLASS_INTRUSIVE_POINTER_DEFINITION(Shell3pMixedMembraneElement);
    ...
    /// Destructor.
    virtual ~Shell3pMixedMembraneElement() = default;
    ...
    {
        return Kratos::make_intrusive<Shell3pMixedMembraneElement>(
    ...
    */
    ...
    std::string Info() const override
    {
        ...
        buffer << "Kirchhoff-Love Shell3pMixedMembraneElement #" << Id();
        return buffer.str();
    }
    ...
    {
        rOStream << "Kirchhoff-Love Shell3pMixedMembraneElement #" << Id();
    }
...
};     // Class Shell3pMixedMembraneElement
///@}
