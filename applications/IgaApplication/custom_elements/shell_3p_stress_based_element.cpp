...
namespace Kratos
{
    ...
    void Shell3pStressBasedElement::SetThicknessIntegrationPoints()
    {
    ...
    void Shell3pStressBasedElement::Initialize(const ProcessInfo& rCurrentProcessInfo)
    {
        KRATOS_TRY
    ...
    void Shell3pStressBasedElement::InitializeMaterial()
    {
        KRATOS_TRY
    ...
    void Shell3pStressBasedElement::FinalizeSolutionStep(const ProcessInfo& rCurrentProcessInfo)
    {
    ...
    void Shell3pStressBasedElement::CalculateAll(
    ...
    void Shell3pStressBasedElement::CalculateDampingMatrix(
    ...
    void Shell3pStressBasedElement::CalculateMassMatrix(
    ...
    void Shell3pStressBasedElement::CalculateKinematics(
    ...
    */
    void Shell3pStressBasedElement::CalculateTransformation(
    ...
    *  the local cartesian basis.
    */
    void Shell3pStressBasedElement::CalculateTransformationFromCovariantToCartesian(
        const KinematicVariables& rKinematicVariables,
        Matrix& rTCovToCar
    ) const
    {
    ...
    void Shell3pStressBasedElement::CalculateConstitutiveVariables(
        const IndexType IntegrationPointIndex,
    ...
    void Shell3pStressBasedElement::CalculateB(
        const IndexType IntegrationPointIndex,
        Matrix& rB,
    ...
    void Shell3pStressBasedElement::CalculateSecondVariationStrain(
        const IndexType IntegrationPointIndex,
    ...
    inline void Shell3pStressBasedElement::CalculateAndAddKm(
        MatrixType& rLeftHandSideMatrix,
        const Matrix& rB,
        const Matrix& rD,
    ...
    inline void Shell3pStressBasedElement::CalculateAndAddNonlinearKm(
    ...
    void Shell3pStressBasedElement::CalculatePK2Stress(
        const IndexType IntegrationPointIndex,
    ...
    void Shell3pStressBasedElement::CalculateCauchyStress(
        const IndexType IntegrationPointIndex,
    ...
    void Shell3pStressBasedElement::CalculateShearForce(
        const IndexType IntegrationPointIndex,
    ...
    void Shell3pStressBasedElement::CalculateDerivativeOfCurvatureInitial(
        const IndexType IntegrationPointIndex,
    ...
    void Shell3pStressBasedElement::CalculateDerivativeOfCurvatureActual(
        const IndexType IntegrationPointIndex,
        array_1d<double, 3>& rDCurvature_D1,
        array_1d<double, 3>& rDCurvature_D2,
    ...
    void Shell3pStressBasedElement::CalculateDerivativeTransformationMatrices(
        const IndexType IntegrationPointIndex,
    ...
    void Shell3pStressBasedElement::GetValuesVector(
        Vector& rValues,
        int Step) const
    {
        const SizeType number_of_control_points = GetGeometry().size();
    ...
    void Shell3pStressBasedElement::GetFirstDerivativesVector(
        Vector& rValues,
        int Step) const
    {
        const SizeType number_of_control_points = GetGeometry().size();
    ...
    void Shell3pStressBasedElement::GetSecondDerivativesVector(
        Vector& rValues,
        int Step) const
    {
        const SizeType number_of_control_points = GetGeometry().size();
    ...
    void Shell3pStressBasedElement::EquationIdVector(
    ...
    void Shell3pStressBasedElement::GetDofList(
    ...
    int Shell3pStressBasedElement::Check(const ProcessInfo& rCurrentProcessInfo) const
    {
    ...
    void Shell3pStressBasedElement::CalculateHessian(
        Matrix& Hessian,
    ...
    void Shell3pStressBasedElement::CalculateSecondDerivativesOfBaseVectors(
