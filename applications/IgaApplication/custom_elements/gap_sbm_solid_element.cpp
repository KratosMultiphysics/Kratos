...
void GapSbmSolidElement::CalculateSpatialDerivatives(
...
double GapSbmSolidElement::GetCharacteristicGeometryLengthScalar() const
{
...
bool GapSbmSolidElement::CalculateConstitutiveValue(
    const Variable<double>& rVariable,
    double& rValue,
    const ProcessInfo& rCurrentProcessInfo)
{
...
void GapSbmSolidElement::ApplyConstitutiveLaw(SizeType matSize, Vector& rStrain, ConstitutiveLaw::Parameters& rValues,
