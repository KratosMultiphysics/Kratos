...
class KRATOS_API(IGA_APPLICATION) GapSbmSolidCondition
    : public Condition
{
public:
    ...
    /// Counted pointer definition of GapSbmSolidCondition
    ...
    /// Default constructor
    GapSbmSolidCondition() : Condition()
    {};

    /// Destructor
    virtual ~GapSbmSolidCondition() override
    {};
    ...
    {
        return Kratos::make_intrusive<GapSbmSolidCondition>(
    ...
    */
    ...
    std::string Info() const override
    {
        ...
        buffer << "\"GapSbmSolidCondition\" #" << Id();
        return buffer.str();
    }
    ...
    {
        rOStream << "\"GapSbmSolidCondition\" #" << Id();
    }
