...
namespace Kratos
{
    ...
    void Shell3pStressBasedGradientElement::SetThicknessIntegrationPoints()
    {
    ...
    void Shell3pStressBasedGradientElement::Initialize(const ProcessInfo& rCurrentProcessInfo)
    {
        KRATOS_TRY
    ...
    void Shell3pStressBasedGradientElement::InitializeMaterial()
    {
        KRATOS_TRY
        ...
        for (IndexType point_number = 0; point_number < r_number_of_integration_points; ++point_number) {
            ...
            for (IndexType thickness_point_number = 0; thickness_point_number < mNumberOfThicknessIntegrationPoints; ++thickness_point_number) {
                ...
                mConstitutiveLawVector[point_number][thickness_point_number] = properties[CONSTITUTIVE_LAW]->Clone();
                mConstitutiveLawVector[point_number][thickness_point_number]->InitializeMaterial(properties, r_geometry, row(r_N, point_number));
            }
        }
    ...
    void Shell3pStressBasedGradientElement::FinalizeSolutionStep(const ProcessInfo& rCurrentProcessInfo)
    {
        ...
        for (IndexType point_number = 0; point_number < mConstitutiveLawVector.size(); ++point_number) {
            for (IndexType thickness_point_number = 0; thickness_point_number < mNumberOfThicknessIntegrationPoints; ++thickness_point_number) {
                mConstitutiveLawVector[point_number][thickness_point_number]->FinalizeMaterialResponse(
    ...
    void Shell3pStressBasedGradientElement::CalculateOnIntegrationPoints(
    ...
    void Shell3pStressBasedGradientElement::CalculateAll(
    ...
    ) const
    {
        ...
        for (IndexType point_number = 0; point_number < r_integration_points.size(); ++point_number) {
            ...
            for (IndexType thickness_point_number = 0; thickness_point_number < mNumberOfThicknessIntegrationPoints; ++thickness_point_number) {
                double zeta_thickness_0_5 = mZeta(thickness_point_number) * thickness/2;
                ...
                double integration_weight =
                    ...
                    * mThicknessIntegrationWeights[thickness_point_number]
                    * (thickness / 2)
                ...
                if (CalculateResidualVectorFlag == true) //calculation of the matrix is required
                {
                    ...
                    (rRightHandSideVector) -= integration_weight * prod(trans(B), constitutive_variables.StressVector);
                }
            }
        }
        KRATOS_CATCH("");
    ...
    void Shell3pStressBasedGradientElement::CalculateDampingMatrix(
    ...
    void Shell3pStressBasedGradientElement::CalculateMassMatrix(
    ...
    void Shell3pStressBasedGradientElement::CalculateKinematics(
    ...
    */
    void Shell3pStressBasedGradientElement::CalculateTransformation(
    ...
    *  the local cartesian basis.
    */
    void Shell3pStressBasedGradientElement::CalculateTransformationFromCovariantToCartesian(
        const KinematicVariables& rKinematicVariables,
        Matrix& rTCovToCar
    ) const
    {
    ...
    void Shell3pStressBasedGradientElement::CalculateConstitutiveVariables(
        const IndexType IntegrationPointIndex,
        ...
        double Zeta) const
    {
        ...
        array_1d<double, 3> strain_vector = 0.5 * (rActualKinematic.a_ab_covariant - m_A_ab_covariant_vector[IntegrationPointIndex])
            - Zeta * (rActualKinematic.b_ab_covariant - m_B_ab_covariant_vector[IntegrationPointIndex]);
        (rThisConstitutiveVariables.StrainVector) = prod(m_T_vector[IntegrationPointIndex], strain_vector);
        ...
        mConstitutiveLawVector[IntegrationPointIndex][ThicknessIntegrationPoint]->CalculateMaterialResponse(rValues, ThisStressMeasure);
    ...
    void Shell3pStressBasedGradientElement::CalculateB(
        const IndexType IntegrationPointIndex,
        Matrix& rB,
        ...
        double Zeta) const
    {
        ...
        for (IndexType i = 0; i < number_of_control_points; i++)
        {
            ...
            b(0, index)     = 0 - Zeta * (r_DDN_DDe(i, 0) * rActualKinematic.a3[0] + H(0, 0) * dn(0, 0) + H(1, 0) * dn(0, 1) + H(2, 0) * dn(0, 2));
            b(0, index + 1) = 0 - Zeta * (r_DDN_DDe(i, 0) * rActualKinematic.a3[1] + H(0, 0) * dn(1, 0) + H(1, 0) * dn(1, 1) + H(2, 0) * dn(1, 2));
            b(0, index + 2) = 0 - Zeta * (r_DDN_DDe(i, 0) * rActualKinematic.a3[2] + H(0, 0) * dn(2, 0) + H(1, 0) * dn(2, 1) + H(2, 0) * dn(2, 2));

            //second line
            b(1, index)     = 0 - Zeta * (r_DDN_DDe(i, 2) * rActualKinematic.a3[0] + H(0, 1) * dn(0, 0) + H(1, 1) * dn(0, 1) + H(2, 1) * dn(0, 2));
            b(1, index + 1) = 0 - Zeta * (r_DDN_DDe(i, 2) * rActualKinematic.a3[1] + H(0, 1) * dn(1, 0) + H(1, 1) * dn(1, 1) + H(2, 1) * dn(1, 2));
            b(1, index + 2) = 0 - Zeta * (r_DDN_DDe(i, 2) * rActualKinematic.a3[2] + H(0, 1) * dn(2, 0) + H(1, 1) * dn(2, 1) + H(2, 1) * dn(2, 2));

            //third line
            b(2, index)     = 0 - Zeta * (r_DDN_DDe(i, 1) * rActualKinematic.a3[0] + H(0, 2) * dn(0, 0) + H(1, 2) * dn(0, 1) + H(2, 2) * dn(0, 2));
            b(2, index + 1) = 0 - Zeta * (r_DDN_DDe(i, 1) * rActualKinematic.a3[1] + H(0, 2) * dn(1, 0) + H(1, 2) * dn(1, 1) + H(2, 2) * dn(1, 2));
            b(2, index + 2) = 0 - Zeta * (r_DDN_DDe(i, 1) * rActualKinematic.a3[2] + H(0, 2) * dn(2, 0) + H(1, 2) * dn(2, 1) + H(2, 2) * dn(2, 2));
        }

        (rB) += prod(m_T_vector[IntegrationPointIndex], b);
    }

    void Shell3pStressBasedGradientElement::CalculateSecondVariationStrain(
        const IndexType IntegrationPointIndex,
        ...
        double Zeta) const
    {
        ...
        for (IndexType r = 0; r < mat_size; r++)
        {
            ...
            for (IndexType s = 0; s <= r; s++)
            {
                ...
                ddK_cu[0] = -Zeta * (r_DDN_DDe(kr, 0) * S_dn(dirr, s) + r_DDN_DDe(ks, 0) * S_dn(dirs, r)
                    + H(0, 0) * ddn[0] + H(1, 0) * ddn[1] + H(2, 0) * ddn[2]);
                ddK_cu[1] = -Zeta  * (r_DDN_DDe(kr, 2) * S_dn(dirr, s) + r_DDN_DDe(ks, 2) * S_dn(dirs, r)
                    + H(0, 1) * ddn[0] + H(1, 1) * ddn[1] + H(2, 1) * ddn[2]);
                ddK_cu[2] = -Zeta * (r_DDN_DDe(kr, 1) * S_dn(dirr, s) + r_DDN_DDe(ks, 1) * S_dn(dirs, r)
                    + H(0, 2) * ddn[0] + H(1, 2) * ddn[1] + H(2, 2) * ddn[2]);

                rSecondVariationsStrain.B11(r, s) += m_T_vector[IntegrationPointIndex](0, 0) * ddK_cu[0] + m_T_vector[IntegrationPointIndex](0, 1) * ddK_cu[1] + m_T_vector[IntegrationPointIndex](0, 2) * ddK_cu[2];
                rSecondVariationsStrain.B11(s, r) = rSecondVariationsStrain.B11(r, s);
                rSecondVariationsStrain.B22(r, s) += m_T_vector[IntegrationPointIndex](1, 0) * ddK_cu[0] + m_T_vector[IntegrationPointIndex](1, 1) * ddK_cu[1] + m_T_vector[IntegrationPointIndex](1, 2) * ddK_cu[2];
                rSecondVariationsStrain.B22(s, r) = rSecondVariationsStrain.B22(r, s);
                rSecondVariationsStrain.B12(r, s) += m_T_vector[IntegrationPointIndex](2, 0) * ddK_cu[0] + m_T_vector[IntegrationPointIndex](2, 1) * ddK_cu[1] + m_T_vector[IntegrationPointIndex](2, 2) * ddK_cu[2];
    ...
    inline void Shell3pStressBasedGradientElement::CalculateAndAddKm(
        MatrixType& rLeftHandSideMatrix,
        const Matrix& rB,
        const Matrix& rD,
    ...
    {
        (rLeftHandSideMatrix) += IntegrationWeight * prod(trans(rB), Matrix(prod(rD, rB)));
    }

    inline void Shell3pStressBasedGradientElement::CalculateAndAddNonlinearKm(
    ...
    void Shell3pStressBasedGradientElement::CalculatePK2Stress(
        const IndexType IntegrationPointIndex,
        ...
        const ProcessInfo& rCurrentProcessInfo) const
    {
        ...
        rPK2MembraneStressCartesian = constitutive_variables.StressVector;
        //rPK2BendingStressCartesian = -1.0 * constitutive_variables_curvature.StressVector / pow(thickness, 2) * 12;
    }
    
    void Shell3pStressBasedGradientElement::CalculateCauchyStress(
        const IndexType IntegrationPointIndex,
    ...
    void Shell3pStressBasedGradientElement::CalculateShearForce(
        const IndexType IntegrationPointIndex,
    ...
    void Shell3pStressBasedGradientElement::CalculateDerivativeOfCurvatureInitial(
        const IndexType IntegrationPointIndex,
    ...
    void Shell3pStressBasedGradientElement::CalculateDerivativeOfCurvatureActual(
        const IndexType IntegrationPointIndex,
        array_1d<double, 3>& rDCurvature_D1,
        array_1d<double, 3>& rDCurvature_D2,
    ...
    void Shell3pStressBasedGradientElement::CalculateDerivativeTransformationMatrices(
        const IndexType IntegrationPointIndex,
    ...
    void Shell3pStressBasedGradientElement::GetValuesVector(
        Vector& rValues,
        int Step) const
    {
        const SizeType number_of_control_points = GetGeometry().size();
    ...
    void Shell3pStressBasedGradientElement::GetFirstDerivativesVector(
        Vector& rValues,
        int Step) const
    {
        const SizeType number_of_control_points = GetGeometry().size();
    ...
    void Shell3pStressBasedGradientElement::GetSecondDerivativesVector(
        Vector& rValues,
        int Step) const
    {
        const SizeType number_of_control_points = GetGeometry().size();
    ...
    void Shell3pStressBasedGradientElement::EquationIdVector(
    ...
    void Shell3pStressBasedGradientElement::GetDofList(
    ...
    int Shell3pStressBasedGradientElement::Check(const ProcessInfo& rCurrentProcessInfo) const
    {
    ...
    void Shell3pStressBasedGradientElement::CalculateHessian(
        Matrix& Hessian,
    ...
    void Shell3pStressBasedGradientElement::CalculateSecondDerivativesOfBaseVectors(
