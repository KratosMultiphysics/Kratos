...
class NvidiaFlexPreUtilities
    ...
    bool CheckIfItsTimeToChangeGravity(ModelPart& rSpheresModelPart,
                                        double time_at_last_gravity_change,
        ...
        if(current_time < time_at_last_gravity_change + min_time_between_changes) return false;
        if(current_time > time_at_last_gravity_change + max_time_between_changes) {
            time_at_last_gravity_change = current_time;
            return true;
        }
