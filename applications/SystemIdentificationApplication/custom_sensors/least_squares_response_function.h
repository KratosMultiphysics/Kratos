...
class KRATOS_API(SYSTEM_IDENTIFICATION_APPLICATION) LeastSquaresResponseFunction : public AdjointResponseFunction
{
public:
    ...
    KRATOS_CLASS_POINTER_DEFINITION(LeastSquaresResponseFunction);
...
inline std::ostream& operator<<(
    ...
    const LeastSquaresResponseFunction& rThis)
{
