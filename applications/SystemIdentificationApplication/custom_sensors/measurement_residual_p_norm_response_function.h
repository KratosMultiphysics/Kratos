...
class KRATOS_API(DIGITAL_TWIN_APPLICATION) MeasurementResidualPNormResponseFunction : public AdjointResponseFunction
{
public:
    ...
    KRATOS_CLASS_POINTER_DEFINITION(MeasurementResidualPNormResponseFunction);
    ...
    /// Constructor.
    MeasurementResidualPNormResponseFunction(const double PCoeficient);

    /// Destructor.
    ~MeasurementResidualPNormResponseFunction() override = default;
...
inline std::ostream& operator<<(
    ...
    const MeasurementResidualPNormResponseFunction& rThis)
{
