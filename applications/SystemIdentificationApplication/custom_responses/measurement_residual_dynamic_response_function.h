...
class KRATOS_API(SYSTEM_IDENTIFICATION_APPLICATION) MeasurementResidualDynamicResponseFunction : public AdjointResponseFunction
{
public:
    ...
    KRATOS_CLASS_POINTER_DEFINITION(MeasurementResidualDynamicResponseFunction);
    ...
    /// Constructor.
    MeasurementResidualDynamicResponseFunction(const double PCoeficient);

    /// Destructor.
    ~MeasurementResidualDynamicResponseFunction() override = default;
...
inline std::ostream& operator<<(
    ...
    const MeasurementResidualDynamicResponseFunction& rThis)
{
