...
namespace Kratos
{
    ...
    KRATOS_DEFINE_APPLICATION_VARIABLE(DIGITAL_TWIN_APPLICATION, Matrix, COMPUTED_EIGENVECTOR_MATRIX)
    KRATOS_DEFINE_APPLICATION_VARIABLE(DIGITAL_TWIN_APPLICATION, Matrix, EIGENVECTOR_MATRIX)
    KRATOS_DEFINE_APPLICATION_VARIABLE(DIGITAL_TWIN_APPLICATION, Matrix, MEASURED_EIGENVECTOR_MATRIX)

    KRATOS_DEFINE_APPLICATION_VARIABLE(DIGITAL_TWIN_APPLICATION, Vector, COMPUTED_EIGENVALUE_VECTOR)
    KRATOS_DEFINE_APPLICATION_VARIABLE(DIGITAL_TWIN_APPLICATION, Vector, EIGENVALUE_VECTOR)
    KRATOS_DEFINE_APPLICATION_VARIABLE(DIGITAL_TWIN_APPLICATION, Vector, MEASURED_EIGENVALUE_VECTOR)

    KRATOS_DEFINE_APPLICATION_VARIABLE(DIGITAL_TWIN_APPLICATION, double, YOUNG_MODULUS_SENSITIVITY)
