...
namespace Kratos
{
    ...
    KRATOS_DEFINE_APPLICATION_VARIABLE(SYSTEM_IDENTIFICATION_APPLICATION, double, SENSOR_STATUS)
    KRATOS_DEFINE_APPLICATION_VARIABLE(SYSTEM_IDENTIFICATION_APPLICATION, double, CLUSTER_SIZE_RATIO)
