...
namespace Kratos
{
    ...
    KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS(SYSTEM_IDENTIFICATION_APPLICATION, ADJOINT_VELOCITY)
    KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS(SYSTEM_IDENTIFICATION_APPLICATION, ADJOINT_ACCELERATION)
    KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS(SYSTEM_IDENTIFICATION_APPLICATION, ADJOINT_ROTATION)
    KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS(SYSTEM_IDENTIFICATION_APPLICATION, ADJOINT_ANGULAR_VELOCITY)
    KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS(SYSTEM_IDENTIFICATION_APPLICATION, ADJOINT_ANGULAR_ACCELERATION)
