...
void KratosSystemIdentificationApplication::Register()
{
    ...
    KRATOS_REGISTER_VARIABLE(COMPUTED_EIGENVECTOR_MATRIX)
    KRATOS_REGISTER_VARIABLE(EIGENVECTOR_MATRIX)
    KRATOS_REGISTER_VARIABLE(MEASURED_EIGENVECTOR_MATRIX)

    KRATOS_REGISTER_VARIABLE(COMPUTED_EIGENVALUE_VECTOR)
    KRATOS_REGISTER_VARIABLE(EIGENVALUE_VECTOR)
    KRATOS_REGISTER_VARIABLE(MEASURED_EIGENVALUE_VECTOR)
