...
PYBIND11_MODULE(KratosSystemIdentificationApplication, m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, SENSOR_MEASURED_VALUE_VECTOR)
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, LHS_DESIGN_DERIVATIVE)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, MASS_DESIGN_DERIVATIVE)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, LHS_PRIMAL_ELEMENT)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, MASS_MATRIX_PRIMAL_ELEMENT)
}
