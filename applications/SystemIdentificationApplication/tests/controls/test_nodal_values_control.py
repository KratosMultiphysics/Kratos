...
from KratosMultiphysics.SystemIdentificationApplication.controls.nodal_values_control import NodalValuesControl

class TestNodalValuesControl(kratos_unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        ...
        cls.temperature_control = NodalValuesControl("test", cls.model, parameters, cls.optimization_problem)
