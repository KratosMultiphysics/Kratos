...
from KratosMultiphysics.SystemIdentificationApplication.responses.sensor_mac_response import SensorMACResponse
...
class TestSensorEigenClusterResponse(UnitTest.TestCase):
    ...
    def test_CalculateGradient(self):
        ...
        response = SensorMACResponse("test4", self.model, params, self.optimization_problem)
        ...
        for i, node in enumerate(self.sensor_model_part.Nodes):
            ...
            print(fd_sensitivity, analytical_gradient.data[i])
