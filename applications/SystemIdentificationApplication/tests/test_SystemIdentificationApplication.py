...
import test_system_identification_restart
...
def AssembleTestSuites():
    ...
    smallSuite.addTests(KratosUnittest.TestLoader().loadTestsFromTestCases([test_system_identification_restart.TestSystemIdentificationRestart]))
