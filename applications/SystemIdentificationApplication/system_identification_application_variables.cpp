...
namespace Kratos
{
    ...
    KRATOS_CREATE_VARIABLE(double, SENSOR_COMPUTED_VALUE)
    KRATOS_CREATE_VARIABLE(double, SENSOR_NORMALIZATION_FACTOR)
    KRATOS_CREATE_VARIABLE(double, SENSOR_ERROR)
    KRATOS_CREATE_VARIABLE(double, SENSOR_RELATIVE_ERROR)
