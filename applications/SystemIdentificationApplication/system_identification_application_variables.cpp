...
namespace Kratos
{
    ...
    KRATOS_CREATE_VARIABLE(Matrix, COMPUTED_EIGENVECTOR_MATRIX)
    KRATOS_CREATE_VARIABLE(Matrix, EIGENVECTOR_MATRIX)
    KRATOS_CREATE_VARIABLE(Matrix, MEASURED_EIGENVECTOR_MATRIX)

    KRATOS_CREATE_VARIABLE(Vector, COMPUTED_EIGENVALUE_VECTOR)
    KRATOS_CREATE_VARIABLE(Vector, EIGENVALUE_VECTOR)
    KRATOS_CREATE_VARIABLE(Vector, MEASURED_EIGENVALUE_VECTOR)
