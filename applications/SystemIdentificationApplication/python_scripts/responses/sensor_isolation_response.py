...
class SensorIsolationResponse(ResponseFunction):
    ...
    def CalculateGradient(self, physical_variable_collective_expressions: 'dict[SupportedSensitivityFieldVariableTypes, KratosOA.CollectiveExpression]') -> None:
        ...
        physical_variable_collective_expressions[KratosSI.SENSOR_STATUS].GetContainerExpressions()[0].SetExpression(KratosSI.Responses.SensorIsolationResponseUtils.CalculateGradient(self.model_part, self.isolation_radius, self.distance_matrix).GetExpression())
