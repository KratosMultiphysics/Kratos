...
PYBIND11_MODULE(KratosOptimizationApplication, m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, SCALAR_SEARCH_CORRECTION);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, SCALAR_CONTROL_UPDATE);

    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, VECTOR_SEARCH_DIRECTION);
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, VECTOR_SEARCH_CORRECTION);
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, VECTOR_CONTROL_UPDATE);
