...
PYBIND11_MODULE(KratosOptimizationApplication, m)
{
    ...
    // output variables
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, RAW_SCALAR_SENSITIVITY);
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, RAW_ARRAY3_SENSITIVITY);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, TRANSFORMED_SCALAR_SENSITIVITY);
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, TRANSFORMED_ARRAY3_SENSITIVITY);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, SCALAR_PROJECTION);
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, ARRAY3_PROJECTION);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, SCALAR_CORRECTION);
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, ARRAY3_CORRECTION);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, SCALAR_SEARCH_DIRECTION);
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, ARRAY3_SEARCH_DIRECTION);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, SCALAR_UPDATE);
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, ARRAY3_UPDATE);
  }
