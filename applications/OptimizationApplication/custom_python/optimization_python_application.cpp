...
PYBIND11_MODULE(KratosOptimizationApplication, m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, D_SELF_INTERSECT_D_X);
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, D_SELF_INTERSECT_D_CX);
    ...
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, D_X_BEFORE_MANIPULATION);
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, ACTIVE_POSITIVE_INTERSECTION_NORMAL);
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, FILTERED_ACTIVE_POSITIVE_INTERSECTION_NORMAL);
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, ACTIVE_NEGATIVE_INTERSECTION_NORMAL);
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, FILTERED_ACTIVE_NEGATIVE_INTERSECTION_NORMAL);
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, ACTIVE_BC_NORMAL);
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, FILTERED_ACTIVE_BC_NORMAL);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, ADJACENT_TRIANGLE_COUNT);
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, EMBEDDED_MESH)
  }
