    ...
    const std::string& rName)
{
    ...
    py::class_<ExplicitFilterUtils<TContainerType>, typename ExplicitFilterUtils<TContainerType>::Pointer>(m, rName.c_str())
        .def(py::init<const ModelPart&, const std::string&, const std::size_t, const std::size_t, bool>(), py::arg("model_part"), py::arg("kernel_function_type"), py::arg("max_items_in_bucket") = 10, py::arg("echo_level") = 0, py::arg("node_cloud_mesh") = false)
