...
void AddContainerVariableDataHolderTypeToPython(pybind11::module& m, const std::string& rName)
{
    ...
    py::class_<container_type, typename container_type::Pointer, ContainerVariableDataHolderBase<TContainerType>>(m, rName.c_str())
        ...
        .def(py::self /  float())
        .def(py::self /= float())
        .def("__pow__", [](container_type& rSelf, const container_type& rInput) { container_type result(rSelf.GetModelPart()); ContainerVariableDataHolderUtils::Pow(result, rSelf, rInput); return result; })
        .def("__ipow__", [](container_type& rSelf, const container_type& rInput) { ContainerVariableDataHolderUtils::Pow(rSelf, rSelf, rInput); return rSelf; })
        .def("__pow__", [](container_type& rSelf, const double Value) { container_type result(rSelf.GetModelPart()); ContainerVariableDataHolderUtils::Pow(result, rSelf, Value); return result; })
        .def("__ipow__", [](container_type& rSelf, const double Value) { ContainerVariableDataHolderUtils::Pow(rSelf, rSelf, Value); return rSelf; })
...
void  AddCustomUtilitiesToPython(pybind11::module& m)
{
    ...
    m.def_submodule("ContainerVariableDataHolderUtils")
        ...
        .def("ComputeNumberOfNeighbourConditions", &ContainerVariableDataHolderUtils::ComputeNumberOfNeighbourEntities<ModelPart::ConditionsContainerType>, py::arg("output_nodal_container_data"))
        .def("ComputeNumberOfNeighbourElements", &ContainerVariableDataHolderUtils::ComputeNumberOfNeighbourEntities<ModelPart::ElementsContainerType>, py::arg("output_nodal_container_data"))
