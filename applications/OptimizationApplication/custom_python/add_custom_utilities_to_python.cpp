...
void  AddCustomUtilitiesToPython(pybind11::module& m)
{
    ...
    m.def_submodule("ExpressionUtils")
        ...
        .def("Sum", &ContainerExpressionUtils::Sum<ModelPart::NodesContainerType>, py::arg("container_expression"))
        .def("Sum", &ContainerExpressionUtils::Sum<ModelPart::ConditionsContainerType>, py::arg("container_expression"))
        .def("Sum", &ContainerExpressionUtils::Sum<ModelPart::ElementsContainerType>, py::arg("container_expression"))
