...
void  AddCustomUtilitiesToPython(pybind11::module& m)
{
    ...
    m.def_submodule("ExpressionUtils")
        ...
        .def("HamilotinanUpdate", &ContainerExpressionUtils::HamilotinanUpdate, py::arg("input_nodal_container_expression_phi"), py::arg("input_nodal_container_expression_velocity"), py::arg("input_nodal_container_expression_gradient"))
        ;
