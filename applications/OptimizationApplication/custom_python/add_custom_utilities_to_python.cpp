...
void AddSpecializedContainerVariableDataToPython(pybind11::module& m, const std::string& rName)
{
    ...
    py::class_<container_type, typename container_type::Pointer, ContainerVariableData<TContainerType>>(m, rName.c_str())
        ...
        .def("SetDataToValue", &container_type::template SetDataToValue<double>, py::arg("scalar_value"))
        .def("SetDataToValue", &container_type::template SetDataToValue<array_1d<double, 3>>, py::arg("Array3_value"))
        .def("SetDataToVariableZeroValue", &container_type::template SetDataToVariableZeroValue<double>, py::arg("scalar_variable"))
        .def("SetDataToVariableZeroValue", &container_type::template SetDataToVariableZeroValue<array_1d<double, 3>>, py::arg("Array3_variable"))
