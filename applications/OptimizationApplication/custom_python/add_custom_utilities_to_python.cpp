...
void  AddCustomUtilitiesToPython(pybind11::module& m)
{
    ...
    m.def_submodule("ExpressionUtils")
        ...
        .def("Clamp", &ContainerExpressionUtils::Clamp<ModelPart::NodesContainerType>, py::arg("container_expression"), py::arg("lower_value"), py::arg("upper_value"))
        .def("Clamp", &ContainerExpressionUtils::Clamp<ModelPart::ConditionsContainerType>, py::arg("container_expression"), py::arg("lower_value"), py::arg("upper_value"))
        .def("Clamp", &ContainerExpressionUtils::Clamp<ModelPart::ElementsContainerType>, py::arg("container_expression"), py::arg("lower_value"), py::arg("upper_value"))
