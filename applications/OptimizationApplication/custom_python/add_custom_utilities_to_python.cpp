...
void  AddCustomUtilitiesToPython(pybind11::module& m)
{
    ...
    m.def_submodule("ContainerVariableDataHolderUtils")
        ...
        .def("ComputeNumberOfNeighbourEntities", &ContainerVariableDataHolderUtils::ComputeNumberOfNeighbourEntities<ModelPart::ConditionsContainerType>)
        .def("ComputeNumberOfNeighbourEntities", &ContainerVariableDataHolderUtils::ComputeNumberOfNeighbourEntities<ModelPart::ElementsContainerType>)
        .def("MapContainerVariableDataHolderToNodalVariableDataHolder", &ContainerVariableDataHolderUtils::MapContainerVariableDataHolderToNodalVariableDataHolder<ModelPart::ConditionsContainerType>)
        .def("MapContainerVariableDataHolderToNodalVariableDataHolder", &ContainerVariableDataHolderUtils::MapContainerVariableDataHolderToNodalVariableDataHolder<ModelPart::ElementsContainerType>)
        .def("MapNodalVariableDataHolderToContainerVariableDataHolder", &ContainerVariableDataHolderUtils::MapNodalVariableDataHolderToContainerVariableDataHolder<ModelPart::ConditionsContainerType>)
        .def("MapNodalVariableDataHolderToContainerVariableDataHolder", &ContainerVariableDataHolderUtils::MapNodalVariableDataHolderToContainerVariableDataHolder<ModelPart::ElementsContainerType>)
        .def("ComputeVariableDataHolderProductWithEntityMatrix", &ContainerVariableDataHolderUtils::ComputeVariableDataHolderProductWithEntityMatrix<ModelPart::ConditionsContainerType>)
        .def("ComputeVariableDataHolderProductWithEntityMatrix", &ContainerVariableDataHolderUtils::ComputeVariableDataHolderProductWithEntityMatrix<ModelPart::ElementsContainerType>)
        ;
}
