...
template KRATOS_API(OPTIMIZATION_APPLICATION) class HelmholtzElement<HelmholtzSurfaceDataContainer<3, 3, 1>>;
template KRATOS_API(OPTIMIZATION_APPLICATION) class HelmholtzElement<HelmholtzSurfaceDataContainer<3, 4, 1>>;

template KRATOS_API(OPTIMIZATION_APPLICATION) class HelmholtzElement<HelmholtzSurfaceDataContainer<3, 3, 3>>;
template KRATOS_API(OPTIMIZATION_APPLICATION) class HelmholtzElement<HelmholtzSurfaceDataContainer<3, 4, 3>>;

template KRATOS_API(OPTIMIZATION_APPLICATION) class HelmholtzElement<HelmholtzSolidDataContainer<3, 4, 1>>;
template KRATOS_API(OPTIMIZATION_APPLICATION) class HelmholtzElement<HelmholtzSolidDataContainer<3, 8, 1>>;

template KRATOS_API(OPTIMIZATION_APPLICATION) class HelmholtzElement<HelmholtzSolidDataContainer<3, 4, 3>>;
template KRATOS_API(OPTIMIZATION_APPLICATION) class HelmholtzElement<HelmholtzSolidDataContainer<3, 8, 3>>;

template KRATOS_API(OPTIMIZATION_APPLICATION) class HelmholtzElement<HelmholtzSolidShapeDataContainer<3, 4>>;
template KRATOS_API(OPTIMIZATION_APPLICATION) class HelmholtzElement<HelmholtzSolidShapeDataContainer<3, 8>>;
