...
*/
class KRATOS_API(OPTIMIZATION_APPLICATION) HelmholtzSurfThicknessElement
    : public Element
{
public:
    ///@name Type Definitions
    ...
    /// Default constructor.
    HelmholtzSurfThicknessElement(IndexType NewId, GeometryType::Pointer pGeometry);
    HelmholtzSurfThicknessElement(IndexType NewId, GeometryType::Pointer pGeometry,  PropertiesType::Pointer pProperties);

    /// Destructor.
    virtual ~HelmholtzSurfThicknessElement();
...
protected:
    ...
    HelmholtzSurfThicknessElement() : Element()
    {
    }
...
private:
    ...
    /// Assignment operator.
    //HelmholtzSurfThicknessElement& operator=(const HelmholtzSurfThicknessElement& rOther);

    /// Copy constructor.
    //HelmholtzSurfThicknessElement(const HelmholtzSurfThicknessElement& rOther);
...
/*  inline std::istream& operator >> (std::istream& rIStream,
				    HelmholtzSurfThicknessElement& rThis);
*/
/// output stream function
/*  inline std::ostream& operator << (std::ostream& rOStream,
				    const HelmholtzSurfThicknessElement& rThis)
    {
...
#endif // KRATOS_HELMHOLTZ_SURF_THICKNESS_ELEMENT_H_INCLUDED  defined
