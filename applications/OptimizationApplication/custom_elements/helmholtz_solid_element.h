 ...
 * @details Implements Helmholtz solid PDEs for filtering a scalar field over solid domains.
 * @author Reza Najian Asl
 */
class KRATOS_API(OPTIMIZATION_APPLICATION) HelmholtzSolidElement
    : public Element
{
public:
    ...
    /// Counted pointer of HelmholtzSolidElement
    KRATOS_CLASS_INTRUSIVE_POINTER_DEFINITION(HelmholtzSolidElement);
    ...
    /// Default constructor.
    HelmholtzSolidElement(IndexType NewId, GeometryType::Pointer pGeometry);
    HelmholtzSolidElement(IndexType NewId, GeometryType::Pointer pGeometry,  PropertiesType::Pointer pProperties);
