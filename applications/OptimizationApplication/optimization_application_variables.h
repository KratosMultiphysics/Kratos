...
namespace Kratos
{
    ...
    //KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS(OPTIMIZATION_APPLICATION, LINE_LOAD);
    KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS(OPTIMIZATION_APPLICATION, LINE_LOAD_SENSITIVITY);
    ...
    KRATOS_DEFINE_APPLICATION_VARIABLE(OPTIMIZATION_APPLICATION, int, NUMBER_OF_SOLVERS_USING_NODES);
