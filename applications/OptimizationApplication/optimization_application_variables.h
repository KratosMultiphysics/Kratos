...
namespace Kratos
{
    ...
    KRATOS_DEFINE_VARIABLE( bool, COMPUTE_HELMHOLTZ_INVERSE);
    KRATOS_DEFINE_VARIABLE( bool, HELMHOLTZ_INTEGRATED_FIELD);
    KRATOS_DEFINE_VARIABLE( double, HELMHOLTZ_RADIUS);
    KRATOS_DEFINE_VARIABLE( double, HELMHOLTZ_SCALAR);
    KRATOS_DEFINE_VARIABLE( double, HELMHOLTZ_SCALAR_SOURCE);
