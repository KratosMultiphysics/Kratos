...
class TestVertexMoprhingContainerVariableDataMapper(ABC):
    ...
    @abstractmethod
    def _GetMapper(self) -> Union[KratosOA.VertexMorphingNodalContainerVariableDataMapper, KratosOA.VertexMorphingConditionContainerVariableDataMapper, KratosOA.VertexMorphingElementContainerVariableDataMapper]:
        pass
...
class TestVertexMorphingConditionContainerVariableDataMapper(TestVertexMoprhingContainerVariableDataMapper, kratos_unittest.TestCase):
    ...
    def _GetMapper(self):
        return KratosOA.VertexMorphingConditionContainerVariableDataMapper(self.origin_model_part, self.destination_model_part, self.mapper_parameters.Clone())
...
class TestVertexMorphingElementContainerVariableDataMapper(TestVertexMoprhingContainerVariableDataMapper, kratos_unittest.TestCase):
    ...
    def _GetMapper(self):
        return KratosOA.VertexMorphingElementContainerVariableDataMapper(self.origin_model_part, self.destination_model_part, self.mapper_parameters.Clone())
