...
class TestMassResponseFunctionBase(kratos_unittest.TestCase, ABC):
    ...
    def _CheckSensitivity(self, response_function: MassResponseFunction, entities, sensitivity_method, update_method, ta_data, delta, precision):
        ...
        self.assertVectorAlmostEqual(list_of_sensitivities, ta_data, precision)
