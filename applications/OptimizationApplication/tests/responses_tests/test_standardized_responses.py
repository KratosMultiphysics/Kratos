...
class TestStandardizedComponent(kratos_unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        KratosOA.ContainerExpression.CollectiveExpressionIO.Read(cls.initial_configuration, KratosOA.ContainerExpression.CollectiveExpressionIO.PropertiesVariable(Kratos.DENSITY))
    ...
    def _CheckSensitivity(self, standardized_component: Union[StandardizedObjective, StandardizedConstraint], delta: float, precision: int):
        ...
        KratosOA.ContainerExpression.CollectiveExpressionIO.Write(gradients, KratosOA.ContainerExpression.CollectiveExpressionIO.PropertiesVariable(Kratos.YOUNG_MODULUS))
