...
class TestCollectiveVariableDataHolder(kratos_unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_IsCompatibleWith(self):
        ...
        a = KratosOA.HistoricalContainerVariableDataHolder(self.model_part)
        b = KratosOA.ElementPropertiesContainerVariableDataHolder(self.model_part)
        c = KratosOA.HistoricalContainerVariableDataHolder(additional_model_part)

        a.ReadDataFromContainerVariable(Kratos.VELOCITY)
        b.ReadDataFromContainerVariable(Kratos.PRESSURE)
        c.ReadDataFromContainerVariable(Kratos.VELOCITY)

        collective_1 = KratosOA.CollectiveVariableDataHolder([a, b])
        self.assertTrue(collective_1.IsCompatibleWith(KratosOA.CollectiveVariableDataHolder([a, b])))
        self.assertFalse(collective_1.IsCompatibleWith(KratosOA.CollectiveVariableDataHolder([a])))
        self.assertFalse(collective_1.IsCompatibleWith(KratosOA.CollectiveVariableDataHolder([b, a])))
        self.assertFalse(collective_1.IsCompatibleWith(KratosOA.CollectiveVariableDataHolder([c, b])))
