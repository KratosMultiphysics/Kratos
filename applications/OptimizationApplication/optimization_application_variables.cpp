...
namespace Kratos
{
	...
	KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(D_SELF_INTERSECT_D_X);
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(D_SELF_INTERSECT_D_CX);
    ...
    // treat self intersection of solids
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(D_X_BEFORE_MANIPULATION);
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(ACTIVE_POSITIVE_INTERSECTION_NORMAL);
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(FILTERED_ACTIVE_POSITIVE_INTERSECTION_NORMAL);
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(ACTIVE_NEGATIVE_INTERSECTION_NORMAL);
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(FILTERED_ACTIVE_NEGATIVE_INTERSECTION_NORMAL);
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(ACTIVE_BC_NORMAL);
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(FILTERED_ACTIVE_BC_NORMAL);
    KRATOS_CREATE_VARIABLE(int, ADJACENT_TRIANGLE_COUNT);
    ...
    KRATOS_CREATE_VARIABLE(Matrix, EMBEDDED_MESH)
}
