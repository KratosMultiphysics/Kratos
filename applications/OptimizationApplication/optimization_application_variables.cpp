...
namespace Kratos
{
    ...
    KRATOS_CREATE_VARIABLE(double, SCALAR_SEARCH_CORRECTION);
    KRATOS_CREATE_VARIABLE(double, SCALAR_CONTROL_UPDATE);

    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(VECTOR_SEARCH_DIRECTION);
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(VECTOR_SEARCH_CORRECTION);
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(VECTOR_CONTROL_UPDATE);
