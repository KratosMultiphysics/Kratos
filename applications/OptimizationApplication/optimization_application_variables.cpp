...
namespace Kratos
{
    ...
    // output variables
    KRATOS_CREATE_VARIABLE(double, RAW_SCALAR_SENSITIVITY);
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(RAW_ARRAY3_SENSITIVITY);
    KRATOS_CREATE_VARIABLE(double, TRANSFORMED_SCALAR_SENSITIVITY);
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(TRANSFORMED_ARRAY3_SENSITIVITY);
    KRATOS_CREATE_VARIABLE(double, SCALAR_PROJECTION);
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(ARRAY3_PROJECTION);
    KRATOS_CREATE_VARIABLE(double, SCALAR_CORRECTION);
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(ARRAY3_CORRECTION);
    KRATOS_CREATE_VARIABLE(double, SCALAR_SEARCH_DIRECTION);
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(ARRAY3_SEARCH_DIRECTION);
    KRATOS_CREATE_VARIABLE(double, SCALAR_UPDATE);
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(ARRAY3_UPDATE);
