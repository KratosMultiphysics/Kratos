...
CollectiveVariableDataHolder CollectiveVariableDataHolder::Clone()  const
{
...
void CollectiveVariableDataHolder::ClearVariableDataHolders()
{
    mContainerVariableDataHolderPointersList.clear();
}
