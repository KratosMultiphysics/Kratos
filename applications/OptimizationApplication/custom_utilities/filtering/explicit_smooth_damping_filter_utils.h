...
class KRATOS_API(OPTIMIZATION_APPLICATION) ExplicitSmoothDampingFilterUtils
{
public:
    ...
    KRATOS_CLASS_POINTER_DEFINITION(ExplicitSmoothDampingFilterUtils);

    ///@}
    ///@name LifeCycle
    ///@{

    ExplicitSmoothDampingFilterUtils(
...
inline std::ostream& operator<<(
    ...
    const ExplicitSmoothDampingFilterUtils<TContainerType>& rThis)
{
