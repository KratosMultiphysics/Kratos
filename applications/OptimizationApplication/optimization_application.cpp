...
namespace Kratos
{
    ...
    {}
 	...
 	void KratosOptimizationApplication::Register()
 	{
        ...
        KRATOS_REGISTER_VARIABLE(T_MIN);
        KRATOS_REGISTER_VARIABLE(T_MAX);
        KRATOS_REGISTER_VARIABLE(T_PR);
        KRATOS_REGISTER_VARIABLE(T_PE);
        ...
        KRATOS_REGISTER_VARIABLE(SCALAR_SEARCH_CORRECTION);
        KRATOS_REGISTER_VARIABLE(SCALAR_CONTROL_UPDATE);

        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(VECTOR_SEARCH_DIRECTION);
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(VECTOR_SEARCH_CORRECTION);
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(VECTOR_CONTROL_UPDATE);
