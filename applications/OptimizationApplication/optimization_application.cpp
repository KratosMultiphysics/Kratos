...
namespace Kratos
{
    ...
    {}
 	...
 	void KratosOptimizationApplication::Register()
 	{
        ...
        KRATOS_REGISTER_VARIABLE(D_STRAIN_ENERGY_1_D_PE);
        KRATOS_REGISTER_VARIABLE(D_STRAIN_ENERGY_1_D_CD);

        KRATOS_REGISTER_VARIABLE(D_STRAIN_ENERGY_2_D_PE);
        KRATOS_REGISTER_VARIABLE(D_STRAIN_ENERGY_2_D_CD);        

        KRATOS_REGISTER_VARIABLE(D_STRAIN_ENERGY_3_D_PE);
        KRATOS_REGISTER_VARIABLE(D_STRAIN_ENERGY_3_D_CD);        

        KRATOS_REGISTER_VARIABLE(D_STRAIN_ENERGY_1_D_PT);
        KRATOS_REGISTER_VARIABLE(D_STRAIN_ENERGY_1_D_CT);   

        KRATOS_REGISTER_VARIABLE(D_STRAIN_ENERGY_2_D_PT);
        KRATOS_REGISTER_VARIABLE(D_STRAIN_ENERGY_2_D_CT);  

        KRATOS_REGISTER_VARIABLE(D_STRAIN_ENERGY_3_D_PT);
