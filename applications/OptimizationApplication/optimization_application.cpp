...
namespace Kratos
{
    ...
    {}
 	...
 	void KratosOptimizationApplication::Register()
 	{
        ...
        // output variables
        KRATOS_REGISTER_VARIABLE(RAW_SCALAR_SENSITIVITY);
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(RAW_ARRAY3_SENSITIVITY);
        KRATOS_REGISTER_VARIABLE(TRANSFORMED_SCALAR_SENSITIVITY);
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(TRANSFORMED_ARRAY3_SENSITIVITY);
        KRATOS_REGISTER_VARIABLE(SCALAR_PROJECTION);
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(ARRAY3_PROJECTION);
        KRATOS_REGISTER_VARIABLE(SCALAR_CORRECTION);
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(ARRAY3_CORRECTION);
        KRATOS_REGISTER_VARIABLE(SCALAR_SEARCH_DIRECTION);
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(ARRAY3_SEARCH_DIRECTION);
        KRATOS_REGISTER_VARIABLE(SCALAR_UPDATE);
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(ARRAY3_UPDATE);
