...
namespace Kratos
{
    ...
    {}
 	...
 	void KratosOptimizationApplication::Register()
 	{
        ...
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(D_STRAIN_ENERGY_4_D_X);
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(D_STRAIN_ENERGY_4_D_CX);

        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(D_SELF_INTERSECT_D_X);
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(D_SELF_INTERSECT_D_CX);
        ...
        // Self intersection solid
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(D_X_BEFORE_MANIPULATION);
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(ACTIVE_POSITIVE_INTERSECTION_NORMAL);
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(FILTERED_ACTIVE_POSITIVE_INTERSECTION_NORMAL);
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(ACTIVE_NEGATIVE_INTERSECTION_NORMAL);
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(FILTERED_ACTIVE_NEGATIVE_INTERSECTION_NORMAL);
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(ACTIVE_BC_NORMAL);
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(FILTERED_ACTIVE_BC_NORMAL);
        KRATOS_REGISTER_VARIABLE(ADJACENT_TRIANGLE_COUNT);
