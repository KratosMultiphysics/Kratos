...
namespace Kratos
{
    ...
    {}
 	...
 	void KratosOptimizationApplication::Register()
 	{
        ...
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(D_STRAIN_ENERGY_5_D_X);
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(D_STRAIN_ENERGY_5_D_CX); 
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(D_STRAIN_ENERGY_6_D_X);
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(D_STRAIN_ENERGY_6_D_CX);                          
        ...
        KRATOS_REGISTER_VARIABLE(D_STRAIN_ENERGY_4_D_FT);
        KRATOS_REGISTER_VARIABLE(D_STRAIN_ENERGY_4_D_CT);   

        KRATOS_REGISTER_VARIABLE(D_STRAIN_ENERGY_5_D_FT);
        KRATOS_REGISTER_VARIABLE(D_STRAIN_ENERGY_5_D_CT);  

        KRATOS_REGISTER_VARIABLE(D_STRAIN_ENERGY_6_D_FT);
        KRATOS_REGISTER_VARIABLE(D_STRAIN_ENERGY_6_D_CT);        
        ...
        //stress
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(D_STRESS_1_D_X);
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(D_STRESS_1_D_CX);      
        KRATOS_REGISTER_VARIABLE(D_STRESS_1_D_FD);
        KRATOS_REGISTER_VARIABLE(D_STRESS_1_D_CD);  
        KRATOS_REGISTER_VARIABLE(D_STRESS_1_D_FT);
        KRATOS_REGISTER_VARIABLE(D_STRESS_1_D_CT); 
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(D_STRESS_2_D_X);
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(D_STRESS_2_D_CX);      
        KRATOS_REGISTER_VARIABLE(D_STRESS_2_D_FD);
        KRATOS_REGISTER_VARIABLE(D_STRESS_2_D_CD);  
        KRATOS_REGISTER_VARIABLE(D_STRESS_2_D_FT);
        KRATOS_REGISTER_VARIABLE(D_STRESS_2_D_CT);
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(D_STRESS_3_D_X);
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(D_STRESS_3_D_CX);      
        KRATOS_REGISTER_VARIABLE(D_STRESS_3_D_FD);
        KRATOS_REGISTER_VARIABLE(D_STRESS_3_D_CD);  
        KRATOS_REGISTER_VARIABLE(D_STRESS_3_D_FT);
        KRATOS_REGISTER_VARIABLE(D_STRESS_3_D_CT); 
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(D_STRESS_4_D_X);
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(D_STRESS_4_D_CX);      
        KRATOS_REGISTER_VARIABLE(D_STRESS_4_D_FD);
        KRATOS_REGISTER_VARIABLE(D_STRESS_4_D_CD);  
        KRATOS_REGISTER_VARIABLE(D_STRESS_4_D_FT);
        KRATOS_REGISTER_VARIABLE(D_STRESS_4_D_CT);
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(D_STRESS_5_D_X);
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(D_STRESS_5_D_CX);      
        KRATOS_REGISTER_VARIABLE(D_STRESS_5_D_FD);
        KRATOS_REGISTER_VARIABLE(D_STRESS_5_D_CD);  
        KRATOS_REGISTER_VARIABLE(D_STRESS_5_D_FT);
        KRATOS_REGISTER_VARIABLE(D_STRESS_5_D_CT);
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(D_STRESS_6_D_X);
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(D_STRESS_6_D_CX);      
        KRATOS_REGISTER_VARIABLE(D_STRESS_6_D_FD);
        KRATOS_REGISTER_VARIABLE(D_STRESS_6_D_CD);  
        KRATOS_REGISTER_VARIABLE(D_STRESS_6_D_FT);
        KRATOS_REGISTER_VARIABLE(D_STRESS_6_D_CT);                                                                      
