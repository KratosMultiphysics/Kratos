...
class OptimizationInfo:
    ...
    This class holds one private @ref OptimizationInfo.OptimizationData container
    ...
    class OptimizationData:
        ...
        __ClearStep can be used to clear all the data in the specified step_index.
        ...
        def __init__(self, buffer_size: int = 1):
            ...
            self.__sub_items: 'dict[str, OptimizationInfo.OptimizationData]' = {}
        ...
        def SetValue(self, key: str, value: Any, step_index: int = 0) -> None:
            ...
            if pos == -1:
                ...
                if isinstance(value, dict):
                    ...
                    sub_item = OptimizationInfo.OptimizationData(self.GetBufferSize())
                ...
                elif isinstance(value, OptimizationInfo.OptimizationData):
                    value.__parent = self
        ...
        def GetParent(self) -> OptimizationInfo.OptimizationData:
        ...
        def GetRoot(self) -> OptimizationInfo.OptimizationData:
        ...
        def __AdvanceStep(self, recursive = True) -> None:
            ...
            if recursive:
                ...
                for sub_item in self.__sub_items.values():
                    sub_item.__AdvanceStep(recursive)

        def __ClearStep(self, step_index: int = 0, recursive = True) -> None:
            ...
            if recursive:
                ...
                for sub_item in self.__sub_items.values():
                    sub_item.__ClearStep(step_index, recursive)
    ...
    def __init__(self) -> None:
        ...
        for the OptimizationInfo.OptimizationData container.

        """
        self.__optimization_data = OptimizationInfo.OptimizationData(1)

        # create the unbuffered optimization components data container
        self.__optimization_data["components"] = {}
        self.__components: OptimizationInfo.OptimizationData = self.__optimization_data["components"]

        # create the unbufferd optimization problem data container
        self.__optimization_data["problem_data"] = {}
        self.__problem_data: OptimizationInfo.OptimizationData = self.__optimization_data["problem_data"]
    ...
    def GetComponentsContainer(self) -> OptimizationInfo.OptimizationData:
        """Gets the components container

        Returns:
            OptimizationInfo.OptimizationData: Components container.
        """
    ...
    def AdvanceStep(self) -> None:
        ...
        self.__problem_data._OptimizationData__AdvanceStep()
        self.__problem_data._OptimizationData__ClearStep()
        self.__problem_data["step"] = current_step + 1

    def GetProblemDataContainer(self) -> OptimizationInfo.OptimizationData:
        """Gets the global problem data container.

        Returns:
            OptimizationInfo.OptimizationData: Global problem data container.
        """
        return self.__problem_data

    def GetComponentProblemDataContainer(self, component: Union[str, Any]) -> OptimizationInfo.OptimizationData:
        ...
        Returns:
            OptimizationInfo.OptimizationData: Optimization data for the specified component.
        """
