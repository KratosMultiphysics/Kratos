...
class KratosAnalysisExecutionPolicy(ExecutionPolicy):
    def __init__(self, name: str, model: Kratos.Model, parameters: Kratos.Parameters, optimization_problem: OptimizationProblem):
        ...
        self.element_properties_variables = KratosAnalysisExecutionPolicy.__GetVariablesList(analysis_output_settings["element_properties_variables"].GetStringArray())
        ...
        self.condition_properties_variables = KratosAnalysisExecutionPolicy.__GetVariablesList(analysis_output_settings["condition_properties_variables"].GetStringArray())
    ...
    def _OutputAnalysisData(self):
        ...
        for model_part in self.model_parts:
            ...
            for variable in self.element_properties_variables:
                elem_field = Kratos.Expression.ElementExpression(model_part)
            ...
            for variable in self.condition_properties_variables:
                cond_field = Kratos.Expression.ConditionExpression(model_part)
