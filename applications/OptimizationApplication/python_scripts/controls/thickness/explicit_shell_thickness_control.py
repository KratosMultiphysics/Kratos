...
class ExplicitShellThicknessControl(Control):
    ...
    def Update(self, new_control_field: ContainerExpressionTypes) -> bool:
        ...
        update = new_control_field - self.control_field
    ...
    def _UpdateAndOutputFields(self, update: ContainerExpressionTypes) -> None:
        ...
        filtered_thickness_field_update = self.filter.FilterField(update)
        self.control_field = Kratos.Expression.Utils.Collapse(self.control_field + filtered_thickness_field_update)
