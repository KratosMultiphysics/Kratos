...
class VertexMorphingShapeControl(Control):
    ...
    def __init__(self, name: str, model: Kratos.Model, parameters: Kratos.Parameters, optimization_problem: OptimizationProblem):
        ...
        self.use_mesh_motion_solver = self.parameters["use_mesh_motion_solver"].GetBool()
    ...
    def Initialize(self) -> None:
        ...
        if self.use_mesh_motion_solver:
            ...
            nodes_array = ModelPartOperation(self.model, ModelPartOperation.OperationType.UNION, f"control_{self.GetName()}_skin", self.parameters["skin_model_part_names"].GetStringArray(), False).GetModelPart().Nodes
            Kratos.VariableUtils().ApplyFixity(Kratos.MESH_DISPLACEMENT_X, True, nodes_array)
            Kratos.VariableUtils().ApplyFixity(Kratos.MESH_DISPLACEMENT_Y, True, nodes_array)
            Kratos.VariableUtils().ApplyFixity(Kratos.MESH_DISPLACEMENT_Z, True, nodes_array)
            Kratos.VariableUtils().SetHistoricalVariableToZero(Kratos.MESH_DISPLACEMENT)
