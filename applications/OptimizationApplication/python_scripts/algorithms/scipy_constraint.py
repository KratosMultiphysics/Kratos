...
class SciPyConstraint(ResponseRoutine):
    """Constraint response function interface to be used by scipy algorithms
    ...
    def CalculateStandardizedValue(self, control_field: numpy.ndarray, save_value: bool = True) -> float:
    ...
    def CalculateStandardizedGradient(self, control_field: numpy.ndarray, save_field: bool = True) -> KratosOA.ContainerExpression.CollectiveExpressions:
        gradient_collective_expression = self.CalculateGradient(control_field)
