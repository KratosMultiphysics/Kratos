...
class ResponseRoutine:
    ...
    def __init__(self, master_control: MasterControl, response: ResponseFunction) -> None:
        ...
        self.__required_physical_gradients: 'dict[SupportedSensitivityFieldVariableTypes, KratosOA.ContainerExpression.CollectiveExpression]' = {}
    ...
    def CalculateValue(self, control_field: KratosOA.ContainerExpression.CollectiveExpression) -> float:
        ...
        Args:
            control_field (KratosOA.ContainerExpression.CollectiveExpression): Control field of the new design.
    ...
    def CalculateGradient(self) -> KratosOA.ContainerExpression.CollectiveExpression:
        ...
        Returns:
            KratosOA.ContainerExpression.CollectiveExpression: Returns mapped gradients collective expression.
        """
    ...
    def GetRequiredPhysicalGradients(self) -> 'dict[SupportedSensitivityFieldVariableTypes, KratosOA.ContainerExpression.CollectiveExpression]':
        ...
        Returns:
            dict[SupportedSensitivityFieldVariableTypes, KratosOA.ContainerExpression.CollectiveExpression]: Required physical gradients.
        """
