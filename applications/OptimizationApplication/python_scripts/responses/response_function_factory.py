...
def CreateResponseFunction(response_type,response_settings, response_analysis,response_analysis_model_part,model):
    ...
    if response_type == "strain_energy": 
        return structural_response.StrainEnergyResponseFunction(response_settings,response_analysis,response_analysis_model_part,model)
