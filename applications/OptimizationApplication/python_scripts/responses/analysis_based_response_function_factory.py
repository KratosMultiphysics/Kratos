...
def CreateResponseFunction(response_name,response_type,response_settings, response_analysis,model):
    ...
    elif response_type == "embedded_strain_energy":
        return structural_responses.EmbeddedStrainEnergyResponseFunction(response_name,response_settings,response_analysis,model)
