...
class ResponseFunction(ABC):
    ...
    def CalculateGradient(self, physical_variable_collective_expressions: 'dict[SupportedSensitivityFieldVariableTypes, KratosOA.ContainerExpression.CollectiveExpression]') -> None:
        ...
        Args:
            physical_variable_collective_expressions (dict[SupportedSensitivityFieldVariableTypes, KratosOA.ContainerExpression.CollectiveExpression]): Output containing calculated sensitivities w.r.t. requested physical variables.
        """
        pass
