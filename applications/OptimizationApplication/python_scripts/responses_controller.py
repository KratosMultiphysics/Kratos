...
class ResponsesController:
    ...
    def __init__(self,reponses_settings,model,model_parts_controller,analyses_controller):
        ...
        structural_responses = ["strain_energy", "stress", "embedded_strain_energy"]
        analysis_based_responses.extend(structural_responses)

        analysis_free_responses = ["mass","self_intersection","embedded_mass","linear","plane_symmetry","interface","partition_mass","am_max_overhang_angle"]
