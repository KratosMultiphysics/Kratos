...
BOOST_PYTHON_MODULE(KratosSolidMechanicsApplication)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE( SOLID_BUILD_LEVEL )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE( SOLID_EIGENVALUE_VECTOR )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE( SOLID_EIGENVECTOR_MATRIX )
