...
PYBIND11_MODULE(KratosSolidMechanicsApplication,m)
{
  ...
  KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, TIME_INTEGRATION_METHODS )
  ...
  KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, LINE_MOMENT )
  KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, SURFACE_MOMENT )

  KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, POINT_STIFFNESS )
  KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, LINE_STIFFNESS )
  KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, SURFACE_STIFFNESS )
     
  KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, POINT_LOAD_VECTOR )  
  KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, LINE_LOAD_VECTOR )
  KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, SURFACE_LOAD_VECTOR )
  ...
  KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, POINT_MOMENT_VECTOR )  
  KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, LINE_MOMENT_VECTOR )
  KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, SURFACE_MOMENT_VECTOR )

  KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, POINT_STIFFNESS_VECTOR )  
  KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, LINE_STIFFNESS_VECTOR )
  KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, SURFACE_STIFFNESS_VECTOR )
