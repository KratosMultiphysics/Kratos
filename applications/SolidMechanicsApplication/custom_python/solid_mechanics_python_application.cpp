...
BOOST_PYTHON_MODULE(KratosSolidMechanicsApplication)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE( TIME_INTEGRATION_METHODS )
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE( BALLAST_COEFFICIENT )
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE( BALLAST_COEFFICIENT_VECTOR )
