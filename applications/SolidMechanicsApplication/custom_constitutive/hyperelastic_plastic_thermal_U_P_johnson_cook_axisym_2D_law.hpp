...
class HyperElasticPlasticThermalUPJohnsonCookAxisym2DLaw : public HyperElasticPlasticUPAxisym2DLaw
{
public:
    /**
     * Type Definitions
     ...
     * Destructor.
     */
    virtual ~HyperElasticPlasticThermalUPJohnsonCookAxisym2DLaw();
