...
class KRATOS_API(SOLID_MECHANICS_APPLICATION) HyperElasticPlasticPlaneStrain2DLaw : public HyperElasticPlastic3DLaw
{
public:
    /**
     * Type Definitions
     ...
     * Destructor.
     */
    ~HyperElasticPlasticPlaneStrain2DLaw() override;
