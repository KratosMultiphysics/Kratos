...
namespace Kratos
{
  ...
  HyperElasticPlasticThermalUPJ2PlaneStrain2DLaw::HyperElasticPlasticThermalUPJ2PlaneStrain2DLaw()
  ...
  HyperElasticPlasticThermalUPJ2PlaneStrain2DLaw::HyperElasticPlasticThermalUPJ2PlaneStrain2DLaw(FlowRulePointer pFlowRule, YieldCriterionPointer pYieldCriterion, HardeningLawPointer pHardeningLaw)
  {
  ...
  HyperElasticPlasticThermalUPJ2PlaneStrain2DLaw::HyperElasticPlasticThermalUPJ2PlaneStrain2DLaw(const HyperElasticPlasticThermalUPJ2PlaneStrain2DLaw& rOther)
  ...
  ConstitutiveLaw::Pointer HyperElasticPlasticThermalUPJ2PlaneStrain2DLaw::Clone() const
  {
    HyperElasticPlasticThermalUPJ2PlaneStrain2DLaw::Pointer p_clone(new HyperElasticPlasticThermalUPJ2PlaneStrain2DLaw(*this));
    return p_clone;
  }
  ...
  bool HyperElasticPlasticThermalUPJ2PlaneStrain2DLaw::Has( const Variable<double>& rThisVariable )
  {
  ...
  double& HyperElasticPlasticThermalUPJ2PlaneStrain2DLaw::GetValue( const Variable<double>& rThisVariable, double& rValue )
  {
