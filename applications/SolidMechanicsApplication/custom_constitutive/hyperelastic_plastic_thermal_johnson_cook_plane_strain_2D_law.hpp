...
class HyperElasticPlasticThermalJohnsonCookPlaneStrain2DLaw : public HyperElasticPlasticPlaneStrain2DLaw
{
public:
    /**
     * Type Definitions
     ...
     * Destructor.
     */
    virtual ~HyperElasticPlasticThermalJohnsonCookPlaneStrain2DLaw();
