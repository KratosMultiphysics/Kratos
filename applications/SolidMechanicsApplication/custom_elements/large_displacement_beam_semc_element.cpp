...
void LargeDisplacementBeamSEMCElement::CalculateStressResultants(GeneralVariables& rVariables, const unsigned int& rPointNumber, double alpha)
{
    KRATOS_TRY
...
void LargeDisplacementBeamSEMCElement::UpdateStrainVariables(GeneralVariables& rVariables, const unsigned int& rPointNumber)
{
    KRATOS_TRY
...
void LargeDisplacementBeamSEMCElement::CalculateStrainResultants(Vector& rStrainResultants, GeneralVariables& rVariables, double alpha)
{
    KRATOS_TRY
...
void LargeDisplacementBeamSEMCElement::CalculateStrainCouples(Vector& rStrainCouples, GeneralVariables& rVariables, double alpha)
{
    KRATOS_TRY
...
void LargeDisplacementBeamSEMCElement::CalculateCurrentCurvature(GeneralVariables& rVariables, const Variable<array_1d<double, 3 > >& rVariable)
{
    KRATOS_TRY
...
void LargeDisplacementBeamSEMCElement::CalculateStrainEnergy(GeneralVariables& rVariables, ProcessInfo& rCurrentProcessInfo, double& rIntegrationWeight)
{
    KRATOS_TRY
...
void LargeDisplacementBeamSEMCElement::CalculateAndAddInertiaLHS(MatrixType& rLeftHandSideMatrix, GeneralVariables& rVariables, ProcessInfo& rCurrentProcessInfo, double& rIntegrationWeight )
{
...
//Inertia in the SPATIAL configuration 
void LargeDisplacementBeamSEMCElement::CalculateAndAddInertiaRHS(VectorType& rRightHandSideVector, GeneralVariables& rVariables, ProcessInfo& rCurrentProcessInfo, double& rIntegrationWeight)
{
    KRATOS_TRY
