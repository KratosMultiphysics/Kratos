...
void LargeDisplacementBeamElement::MapToSpatialFrame(const ElementVariables& rVariables, Matrix& rVariable)
{
...
void LargeDisplacementBeamElement::InitializeElementVariables(ElementVariables& rVariables, const ProcessInfo& rCurrentProcessInfo)
{
    KRATOS_TRY
...
void LargeDisplacementBeamElement::CalculateKinematics(ElementVariables& rVariables, const unsigned int& rPointNumber)
{
    KRATOS_TRY
...
void LargeDisplacementBeamElement::UpdateStrainVariables(ElementVariables& rVariables, const unsigned int& rPointNumber)
{
    KRATOS_TRY
...
void LargeDisplacementBeamElement::GetMaterialConstitutiveMatrix(Matrix& rConstitutiveMatrix, ElementVariables& rVariables)
{
    KRATOS_TRY
...
void LargeDisplacementBeamElement::CalculateConstitutiveMatrix(ElementVariables& rVariables)
{
    KRATOS_TRY
...
void LargeDisplacementBeamElement::CalculateStressResultants(ElementVariables& rVariables, const unsigned int& rPointNumber, double alpha)
{
    KRATOS_TRY
...
//Strain Energy Calculation 
void LargeDisplacementBeamElement::CalculateStrainEnergy(ElementVariables& rVariables, ProcessInfo& rCurrentProcessInfo, double& rIntegrationWeight)
{
    KRATOS_TRY
...
void LargeDisplacementBeamElement::CalculateAndAddLHS(LocalSystemComponents& rLocalSystem, ElementVariables& rVariables, double& rIntegrationWeight)
{
    KRATOS_TRY
...
void LargeDisplacementBeamElement::CalculateAndAddRHS(LocalSystemComponents& rLocalSystem, ElementVariables& rVariables, Vector& rVolumeForce, double& rIntegrationWeight)
{
    KRATOS_TRY
...
void LargeDisplacementBeamElement::CalculateAndAddInertiaLHS(MatrixType& rLeftHandSideMatrix, ElementVariables& rVariables, ProcessInfo& rCurrentProcessInfo, double& rIntegrationWeight )
{
...
//Inertia in the SPATIAL configuration 
void LargeDisplacementBeamElement::CalculateAndAddInertiaRHS(VectorType& rRightHandSideVector, ElementVariables& rVariables, ProcessInfo& rCurrentProcessInfo, double& rIntegrationWeight)
{
    KRATOS_TRY
...
//Kinetic Energy Calculation 
void LargeDisplacementBeamElement::CalculateKineticEnergy(ElementVariables& rVariables, ProcessInfo& rCurrentProcessInfo, double& rIntegrationWeight)
{
    KRATOS_TRY
...
void LargeDisplacementBeamElement::CalculateMomentumRelations(ElementVariables& rVariables, ProcessInfo& rCurrentProcessInfo, double& rIntegrationWeight)
{
    KRATOS_TRY
