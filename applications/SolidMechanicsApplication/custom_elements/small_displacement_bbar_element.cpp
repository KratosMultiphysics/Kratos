...
void SmallDisplacementBbarElement::InitializeGeneralVariables(GeneralVariables& rVariables,
...
void SmallDisplacementBbarElement::CalculateKinematics(GeneralVariables& rVariables, const double& rPointNumber)
{
    KRATOS_TRY
