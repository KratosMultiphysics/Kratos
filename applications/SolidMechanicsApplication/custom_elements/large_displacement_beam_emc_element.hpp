...
protected:
     ...
     */    
    virtual void MapToSpatialFrame(const GeneralVariables& rVariables, Matrix& rVariable) override;
     ...
     */
    virtual void CalculateFrameMapping(GeneralVariables& rVariables,
				       const unsigned int& rPointNumber) override;
     ...
     */    
    virtual void UpdateRotationVariables(GeneralVariables& rVariables, 
					 const unsigned int& rPointNumber) override;
     ...
     */
    virtual void CalculateCurrentStrainResultantsVector(GeneralVariables& rVariables, 
     ...
     */
    virtual void CalculateCurrentCurvatureVector(GeneralVariables& rVariables, 
     ...
     */ 
    virtual void CalculateConstitutiveMatrix(GeneralVariables& rVariables) override;
     ...
     */ 
    virtual void CalculateStressResultants(GeneralVariables& rVariables, const unsigned int& rPointNumber, double alpha) override;
     ...
     */
    virtual void CalculateStrainEnergy(GeneralVariables& rVariables, ProcessInfo& rCurrentProcessInfo, double& rIntegrationWeight) override;
