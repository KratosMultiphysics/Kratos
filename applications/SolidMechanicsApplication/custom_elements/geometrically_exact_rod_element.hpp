...
protected:
    ...
    */
     ...
     */    
    void UpdateRotationVariables(GeneralVariables& rVariables, 
				 const unsigned int& rPointNumber) override;
     ...
     */ 
    void CalculateStrainResultants(Vector& rStrainResultants, GeneralVariables& rVariables, double alpha) override;

    /**   
     * Calculate Element Strain Couples
     */ 
    void CalculateStrainCouples(Vector& rStrainCouples, GeneralVariables& rVariables, double alpha) override;


    /**   
     * Calculate Element Stress Resultants and Couples
     */ 
    void CalculateStressResultants(GeneralVariables& rVariables, const unsigned int& rPointNumber, double alpha) override;


    /**
     * Calculation and addition of the matrices of the LHS
     */
    void CalculateAndAddLHS(LocalSystemComponents& rLocalSystem, GeneralVariables& rVariables, double& rIntegrationWeight) override;

    /**
     * Calculation and addition of the vectors of the RHS
     */
    void CalculateAndAddRHS(LocalSystemComponents& rLocalSystem, GeneralVariables& rVariables, Vector& VolumeForce, double& rIntegrationWeight) override;
     ...
     */
     ...
     void CalculateAlphaDirectors(Matrix& rDirectors, GeneralVariables& rVariables, const int& rNode, double alpha);


     void CalculateAlphaDirectorVector(Vector& rDirectorVector, GeneralVariables& rVariables, const int& rNode, const int& rDirection, double alpha);

     void CalculateAlphaDirectorSkewSymTensor(Matrix& rDirectorSkewSymTensor, GeneralVariables& rVariables, const int& rNode, const int& rDirection, double alpha);


    /**
     * Calculation Complementary Methods:
     */
    void CalculateAlphaDirectorVector(Vector& rDirectorVector, GeneralVariables& rVariables, const int& rDirection, double alpha);

    void CalculateAlphaDirectorSkewSymTensor(Matrix& rDirectorSkewSymTensor, GeneralVariables& rVariables, const int& rDirection, double alpha);

    /**
     * Calculation Complementary Methods:
     */
    void CalculateDirectorDerivativesVector(Vector& rDirectorDerivativesVector, GeneralVariables& rVariables, const int& rDirection, double alpha);

    void CalculateDirectorDerivativesSkewSymTensor(Matrix& rDirectorDerivativesSkewSymTensor, GeneralVariables& rVariables, const int& rDirection, double alpha);
