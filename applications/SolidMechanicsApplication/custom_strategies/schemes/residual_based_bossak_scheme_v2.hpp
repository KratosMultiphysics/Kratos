...
#if !defined(KRATOS_RESIDUAL_BASED_BOSSAK_SCHEME_V2 )
#define  KRATOS_RESIDUAL_BASED_BOSSAK_SCHEME_V2
...
class ResidualBasedBossakScheme_V2: public Scheme<TSparseSpace,TDenseSpace>
{
protected:
...
public:
    ...
    /*@{ */
    KRATOS_CLASS_POINTER_DEFINITION( ResidualBasedBossakScheme_V2 );
     ...
     * The bossak method
     */
    ResidualBasedBossakScheme_V2(double rAlpham=0,double rDynamic=1)
    ...
    /** Copy Constructor.
     */
    ResidualBasedBossakScheme_V2(ResidualBasedBossakScheme_V2& rOther)
      :BaseType(rOther)
    ...
    /** Destructor.
     */
    virtual ~ResidualBasedBossakScheme_V2
    () {}
   ...
   /*@} */
    ...
    {
      return BaseTypePointer( new ResidualBasedBossakScheme_V2(*this) );
    }
...
private:
    ...
    /*@{ */
}; /* Class ResidualBasedBossakScheme_V2 */
}  /* namespace Kratos.*/

#endif /* KRATOS_RESIDUAL_BASED_BOSSAK_SCHEME_V2 defined */
