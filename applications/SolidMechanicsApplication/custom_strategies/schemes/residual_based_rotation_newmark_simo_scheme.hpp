...
#if !defined(KRATOS_RESIDUAL_BASED_ROTATION_NEWMARK_SIMO_SCHEME )
#define  KRATOS_RESIDUAL_BASED_ROTATION_NEWMARK_SIMO_SCHEME
...
class ResidualBasedRotationNewmarkSimoScheme: public Scheme<TSparseSpace,TDenseSpace>
{
protected:
...
public:
    ...
    /*@{ */
    KRATOS_CLASS_POINTER_DEFINITION( ResidualBasedRotationNewmarkSimoScheme );
     ...
     * The bossak method
     */
    ResidualBasedRotationNewmarkSimoScheme(double rDynamic = 1, double mAlphaM = 0.0)
    ...
    /** Destructor.
     */
    virtual ~ResidualBasedRotationNewmarkSimoScheme
    () {}
...
#endif /* KRATOS_RESIDUAL_BASED_ROTATION_NEWMARK_SIMO_SCHEME  defined */
