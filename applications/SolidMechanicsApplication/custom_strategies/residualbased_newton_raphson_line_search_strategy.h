...
#if !defined(KRATOS_RESIDUALBASED_NEWTON_RAPHSON_LINE_SEARCH_STRATEGY )
#define  KRATOS_RESIDUALBASED_NEWTON_RAPHSON_LINE_SEARCH_STRATEGY
...
public:
    ...
    void LineSearchCalculation(double& rCurrentAlpha,
	...
	LineSearchCalculationUtilities LineSearch;

	double ComputedAlpha = LineSearch.ExecuteLineSearch(pBuilderAndSolver, pScheme, BaseType::GetModelPart(), mA, mDx, mb, rCurrentAlpha, rPreviousAlpha); 

	rPreviousAlpha = rCurrentAlpha;
	rCurrentAlpha  = ComputedAlpha;      

	print "LINE-SEARCH [alpha: ", rCurrentAlpha,"]"
