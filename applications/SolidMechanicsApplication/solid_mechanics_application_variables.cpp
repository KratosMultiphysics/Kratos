...
namespace Kratos
{
  ...
  KRATOS_CREATE_VARIABLE( double, PLANE_ROTATION )
  KRATOS_CREATE_VARIABLE( double, PLANE_ANGULAR_VELOCITY )
  KRATOS_CREATE_VARIABLE( double, PLANE_ANGULAR_ACCELERATION )
