...
proc InitGIDProject {dir} {
	...
	GiDMenu::Create "Kratos Solid Mechanics Application" PRE
	GiDMenu::InsertOption "Kratos Solid Mechanics Application" [list "Nodal Values"] 0 PRE "GidOpenConditions \"Nodal Values\"" "" ""
	GiDMenu::InsertOption "Kratos Solid Mechanics Application" [list "Small Displacement Elements"] 1 PRE "GidOpenConditions \"Small Displacement Elements\"" "" ""
	GiDMenu::InsertOption "Kratos Solid Mechanics Application" [list "Total Lagrangian Elements"] 2 PRE "GidOpenConditions \"Total Lagrangian Elements\"" "" ""
	...
	# GiDMenu::InsertOption "Kratos Solid Mechanics Application" [list "Data Units"] 4 PRE "GidOpenProblemData \"Data Units\"" "" ""
	GiDMenu::InsertOption "Kratos Solid Mechanics Application" [list "---"] 10 PRE "" "" ""
	GiDMenu::InsertOption "Kratos Solid Mechanics Application" [list "Model Status"] 11 PRE "cond_report" "" ""
	if { [string match "unix" $::tcl_platform(platform)] } {
		GiDMenu::InsertOption "Kratos Solid Mechanics Application" [list "Change Kratos Path"] 12 PRE "GetKratosPath" "" ""
	}
	GiDMenu::UpdateMenus
	# Custom Menu
}
...
proc BeforeMeshGeneration {elementsize} {
	...
	# check_elemtype LineLoad3DCondition line None
	# check_elemtype SurfaceLoad3DCondition3D3N surface None
	# check_elemtype SurfaceLoad3DCondition3D4N surface None
	# check_elemtype SurfaceLoad3DCondition3D6N surface None
	# check_elemtype SurfaceLoad3DCondition3D8N surface None
	# check_elemtype SurfaceLoad3DCondition3D9N surface None
	# check_elemtype SmallDisplacementElement2D3N surface Triangle
	# check_elemtype SmallDisplacementElement2D4N surface Quadrilateral
	# check_elemtype SmallDisplacementElement2D6N surface Triangle
	# check_elemtype SmallDisplacementElement2D8N surface Quadrilateral
	# check_elemtype SmallDisplacementElement3D4N volume Tetrahedra
	# check_elemtype SmallDisplacementElement3D6N volume Tetrahedra
	# check_elemtype SmallDisplacementElement3D8N volume Hexahedra
	# check_elemtype SmallDisplacementElement3D10N volume Tetrahedra
	# check_elemtype SmallDisplacementElement3D15N volume Tetrahedra
	# check_elemtype SmallDisplacementElement3D20N volume Hexahedra
	# check_elemtype SmallDisplacementElement3D27N volume Hexahedra
	# check_elemtype TotalLagrangianElement2D3N surface Triangle
	# check_elemtype TotalLagrangianElement2D4N surface Quadrilateral
	# check_elemtype TotalLagrangianElement2D6N surface Triangle
	# check_elemtype TotalLagrangianElement2D8N surface Quadrilateral
	# check_elemtype TotalLagrangianElement3D4N volume Tetrahedra
	# check_elemtype TotalLagrangianElement3D6N volume Tetrahedra
	# check_elemtype TotalLagrangianElement3D8N volume Hexahedra
	# check_elemtype TotalLagrangianElement3D10N volume Tetrahedra
	# check_elemtype TotalLagrangianElement3D15N volume Tetrahedra
	# check_elemtype TotalLagrangianElement3D20N volume Hexahedra
	# check_elemtype TotalLagrangianElement3D27N volume Hexahedra
	# check_elemtype UpdatedLagrangianElement2D3N surface Triangle
	# check_elemtype UpdatedLagrangianElement2D4N surface Quadrilateral
	# check_elemtype UpdatedLagrangianElement2D6N surface Triangle
	# check_elemtype UpdatedLagrangianElement2D8N surface Quadrilateral
	# check_elemtype UpdatedLagrangianElement3D4N volume Tetrahedra
	# check_elemtype UpdatedLagrangianElement3D6N volume Tetrahedra
	# check_elemtype UpdatedLagrangianElement3D8N volume Hexahedra
	# check_elemtype UpdatedLagrangianElement3D10N volume Tetrahedra
	# check_elemtype UpdatedLagrangianElement3D15N volume Tetrahedra
	# check_elemtype UpdatedLagrangianElement3D20N volume Hexahedra
	# check_elemtype UpdatedLagrangianElement3D27N volume Hexahedra
	# check_elemtype SpatialLagrangianElement2D3N surface Triangle
	# check_elemtype SpatialLagrangianElement2D4N surface Quadrilateral
	# check_elemtype SpatialLagrangianElement2D6N surface Triangle
	# check_elemtype SpatialLagrangianElement2D8N surface Quadrilateral
	# check_elemtype SpatialLagrangianElement3D4N volume Tetrahedra
	# check_elemtype SpatialLagrangianElement3D6N volume Tetrahedra
	# check_elemtype SpatialLagrangianElement3D8N volume Hexahedra
	# check_elemtype SpatialLagrangianElement3D10N volume Tetrahedra
	# check_elemtype SpatialLagrangianElement3D15N volume Tetrahedra
	# check_elemtype SpatialLagrangianElement3D20N volume Hexahedra
	# check_elemtype SpatialLagrangianElement3D27N volume Hexahedra
	# check_elemtype AxisymSmallDisplacementElement2D3N surface Triangle
	# check_elemtype AxisymSmallDisplacementElement2D4N surface Quadrilateral
	# check_elemtype AxisymSmallDisplacementElement2D6N surface Triangle
	# check_elemtype AxisymSmallDisplacementElement2D8N surface Quadrilateral
	# check_elemtype AxisymSpatialLagrangianElement2D3N surface Triangle
	# check_elemtype AxisymSpatialLagrangianElement2D4N surface Quadrilateral
	# check_elemtype AxisymSpatialLagrangianElement2D6N surface Triangle
	# check_elemtype AxisymSpatialLagrangianElement2D8N surface Quadrilateral
	...
	# meshtype LineLoad3DCondition line None
	# meshtype SurfaceLoad3DCondition3D3N surface None
	# meshtype SurfaceLoad3DCondition3D4N surface None
	# meshtype SurfaceLoad3DCondition3D6N surface None
	# meshtype SurfaceLoad3DCondition3D8N surface None
	# meshtype SurfaceLoad3DCondition3D9N surface None
	# meshtype SmallDisplacementElement2D3N surface Triangle
	# meshtype SmallDisplacementElement2D4N surface Quadrilateral
	# meshtype SmallDisplacementElement2D6N surface Triangle
	# meshtype SmallDisplacementElement2D8N surface Quadrilateral
	# meshtype SmallDisplacementElement3D4N volume Tetrahedra
	# meshtype SmallDisplacementElement3D6N volume Tetrahedra
	# meshtype SmallDisplacementElement3D8N volume Hexahedra
	# meshtype SmallDisplacementElement3D10N volume Tetrahedra
	# meshtype SmallDisplacementElement3D15N volume Tetrahedra
	# meshtype SmallDisplacementElement3D20N volume Hexahedra
	# meshtype SmallDisplacementElement3D27N volume Hexahedra
	# meshtype TotalLagrangianElement2D3N surface Triangle
	# meshtype TotalLagrangianElement2D4N surface Quadrilateral
	# meshtype TotalLagrangianElement2D6N surface Triangle
	# meshtype TotalLagrangianElement2D8N surface Quadrilateral
	# meshtype TotalLagrangianElement3D4N volume Tetrahedra
	# meshtype TotalLagrangianElement3D6N volume Tetrahedra
	# meshtype TotalLagrangianElement3D8N volume Hexahedra
	# meshtype TotalLagrangianElement3D10N volume Tetrahedra
	# meshtype TotalLagrangianElement3D15N volume Tetrahedra
	# meshtype TotalLagrangianElement3D20N volume Hexahedra
	# meshtype TotalLagrangianElement3D27N volume Hexahedra
	# meshtype UpdatedLagrangianElement2D3N surface Triangle
	# meshtype UpdatedLagrangianElement2D4N surface Quadrilateral
	# meshtype UpdatedLagrangianElement2D6N surface Triangle
	# meshtype UpdatedLagrangianElement2D8N surface Quadrilateral
	# meshtype UpdatedLagrangianElement3D4N volume Tetrahedra
	# meshtype UpdatedLagrangianElement3D6N volume Tetrahedra
	# meshtype UpdatedLagrangianElement3D8N volume Hexahedra
	# meshtype UpdatedLagrangianElement3D10N volume Tetrahedra
	# meshtype UpdatedLagrangianElement3D15N volume Tetrahedra
	# meshtype UpdatedLagrangianElement3D20N volume Hexahedra
	# meshtype UpdatedLagrangianElement3D27N volume Hexahedra
	# meshtype SpatialLagrangianElement2D3N surface Triangle
	# meshtype SpatialLagrangianElement2D4N surface Quadrilateral
	# meshtype SpatialLagrangianElement2D6N surface Triangle
	# meshtype SpatialLagrangianElement2D8N surface Quadrilateral
	# meshtype SpatialLagrangianElement3D4N volume Tetrahedra
	# meshtype SpatialLagrangianElement3D6N volume Tetrahedra
	# meshtype SpatialLagrangianElement3D8N volume Hexahedra
	# meshtype SpatialLagrangianElement3D10N volume Tetrahedra
	# meshtype SpatialLagrangianElement3D15N volume Tetrahedra
	# meshtype SpatialLagrangianElement3D20N volume Hexahedra
	# meshtype SpatialLagrangianElement3D27N volume Hexahedra
	# meshtype AxisymSmallDisplacementElement2D3N surface Triangle
	# meshtype AxisymSmallDisplacementElement2D4N surface Quadrilateral
	# meshtype AxisymSmallDisplacementElement2D6N surface Triangle
	# meshtype AxisymSmallDisplacementElement2D8N surface Quadrilateral
	# meshtype AxisymSpatialLagrangianElement2D3N surface Triangle
	# meshtype AxisymSpatialLagrangianElement2D4N surface Quadrilateral
	# meshtype AxisymSpatialLagrangianElement2D6N surface Triangle
	# meshtype AxisymSpatialLagrangianElement2D8N surface Quadrilateral
