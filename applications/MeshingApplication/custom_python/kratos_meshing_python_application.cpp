...
PYBIND11_MODULE(KratosMeshingApplication,m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, AUXILIAR_GRADIENT)                                    // An auxiliary gradient needed to compute the metric
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, AUXILIAR_HESSIAN)                                     // An auxiliary hessian needed to compute the metric
