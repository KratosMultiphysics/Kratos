...
PYBIND11_MODULE(KratosMeshingApplication,m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m,PRINCIPAL_DIRECTION_1) 
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m,PRINCIPAL_DIRECTION_2)
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m,NORMAL_GEOMETRIC)
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m,NORMAL_EQUILIBRIUM)
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m,NORMAL_CONTACT_LINE_EQUILIBRIUM)
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m,NORMAL_TRIPLE_POINT)
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m,NORMAL_CONTACT_LINE)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,MEAN_CURVATURE_3D)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,NODAL_LENGTH)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,INITIAL_MESH_SIZE)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,TESTFACTE)
