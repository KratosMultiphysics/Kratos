...
PYBIND11_MODULE(KratosMeshingApplication,m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_SYMMETRIC_3D_TENSOR_VARIABLE_WITH_COMPONENTS(m, AUX_METRIC_TENSOR_3D_1) // A 3D metric vector
    KRATOS_REGISTER_IN_PYTHON_SYMMETRIC_3D_TENSOR_VARIABLE_WITH_COMPONENTS(m, AUX_METRIC_TENSOR_3D_2) // A 3D metric vector
    KRATOS_REGISTER_IN_PYTHON_SYMMETRIC_3D_TENSOR_VARIABLE_WITH_COMPONENTS(m, AUX_METRIC_TENSOR_3D_3) // A 3D metric vector
