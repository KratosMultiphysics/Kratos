...
void  AddProcessesToPython(pybind11::module& m)
{
    ...
    .def(py::init<ModelPart&>())
    .def(py::init<ModelPart&, Parameters>())
    .def("OutputMdpa", &MmgProcess<MMGLibray::MMG2D>::OutputMdpa)
    ...
    .def(py::init<ModelPart&>())
    .def(py::init<ModelPart&, Parameters>())
    .def("OutputMdpa", &MmgProcess<MMGLibray::MMG3D>::OutputMdpa)
    ...
    .def(py::init<ModelPart&>())
    .def(py::init<ModelPart&, Parameters>())
    .def("OutputMdpa", &MmgProcess<MMGLibray::MMGS>::OutputMdpa)
