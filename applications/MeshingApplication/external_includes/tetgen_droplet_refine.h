...
{	
	...
	*/
	...
	public:
		...
		/// Pointer definition of TetGenDropletModeler
		...
		/// Destructor.
		virtual ~TetGenDropletModeler()= default;
			...
			double alpha_param = 1.4, double h_factor=0.5)
		{
			...
			KRATOS_WATCH(" ENTERED TETGENMESHSUITE DROPLET of Meshing Application")
			...
			for(ModelPart::ConditionsContainerType::iterator ic = ThisModelPart.ConditionsBegin() ;
				...
				if (n_tp == 2)
				{
				  mesh_size  = ic->GetGeometry()[0].FastGetSolutionStepValue(INITIAL_MESH_SIZE);
				  mesh_size += ic->GetGeometry()[1].FastGetSolutionStepValue(INITIAL_MESH_SIZE);
				  mesh_size += ic->GetGeometry()[2].FastGetSolutionStepValue(INITIAL_MESH_SIZE);
				  mesh_size *= 0.5;
				}
			      }
...
#endif // KRATOS_TETGEN_DROPLET_MODELER_H_INCLUDED  defined 
