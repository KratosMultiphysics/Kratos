...
//         performing the interpolation - all of the nodes in this list will be preserved
        ...
        if (rem_nodes==true)
        {
            ...
            RemoveCloseNodes2(ThisModelPart, nodes_tree1, node_erase, h_factor);
        }
...
private:
    ...
    //elaf 12/july/18
    void RemoveCloseNodes2(ModelPart& ThisModelPart, KdtreeType& nodes_tree1, NodeEraseProcess& node_erase, double& h_factor)
    {
        unsigned int bucket_size = 20;
        ...
        for(ModelPart::NodesContainerType::iterator in = ThisModelPart.NodesBegin(); in != ThisModelPart.NodesEnd(); in++)
        {
            ...
            radius=in->FastGetSolutionStepValue(NODAL_H);
