...
KRATOS_DEFINE_VARIABLE(double,MEAN_CURVATURE_3D)
KRATOS_DEFINE_VARIABLE(double, NODAL_LENGTH)
KRATOS_DEFINE_VARIABLE(double, INITIAL_MESH_SIZE)
KRATOS_DEFINE_VARIABLE(double, TESTFACTE)
...
KRATOS_DEFINE_3D_VARIABLE_WITH_COMPONENTS(NORMAL_EQUILIBRIUM)
KRATOS_DEFINE_3D_VARIABLE_WITH_COMPONENTS( NORMAL_CONTACT_LINE_EQUILIBRIUM)
KRATOS_DEFINE_3D_VARIABLE_WITH_COMPONENTS( NORMAL_TRIPLE_POINT)
KRATOS_DEFINE_3D_VARIABLE_WITH_COMPONENTS( NORMAL_CONTACT_LINE)
//      KRATOS_DEFINE_VARIABLE(Vector3, SOLID_FRACTION_GRADIENT)
//      KRATOS_DEFINE_VARIABLE(Vector3, SOLID_FRACTION_GRADIENT_PROJECTED)
