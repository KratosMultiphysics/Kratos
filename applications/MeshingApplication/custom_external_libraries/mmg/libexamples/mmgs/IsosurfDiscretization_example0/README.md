...
## I/ Implementation
  We read the mesh and level-set values at the mesh nodes in the **_teapot.mesh_** and **_teapot.sol_** files and then, we discretize the implicit function and optimize the mesh. we save results in the **_teapot.o.meshb/sol_** files.
