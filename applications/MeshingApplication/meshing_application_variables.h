...
///@{
    ...
    KRATOS_DEFINE_SYMMETRIC_3D_TENSOR_APPLICATION_VARIABLE_WITH_COMPONENTS(MESHING_APPLICATION, AUX_METRIC_TENSOR_3D_1); // A 3D metric vector
    KRATOS_DEFINE_SYMMETRIC_3D_TENSOR_APPLICATION_VARIABLE_WITH_COMPONENTS(MESHING_APPLICATION, AUX_METRIC_TENSOR_3D_2); // A 3D metric vector
    KRATOS_DEFINE_SYMMETRIC_3D_TENSOR_APPLICATION_VARIABLE_WITH_COMPONENTS(MESHING_APPLICATION, AUX_METRIC_TENSOR_3D_3); // A 3D metric vector
