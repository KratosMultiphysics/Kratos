...
// #include "../../StructuralMechanicsApplication/custom_geometries/simple_prism_3d_6.h" // TODO: Look how to make it work with simple prism
...
public:
    ...
    * @return interpolate_internal_variables: Boolean that defines if to interpolate or not the internal variables
    */
