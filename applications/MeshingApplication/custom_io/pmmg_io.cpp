...
/***********************************************************************************/
    ...
    void ParMmgIO<TPMMGLibrary>::ReadModelPart(ModelPart& rModelPart)
    {
        KRATOS_TRY;
            ...
            mParMmmgUtilities.WriteMeshDataToModelPart(rModelPart, colors, empty_dofs, mmg_mesh_info, ref_condition, ref_element);
...
/***********************************************************************************/
    ...
    template class ParMmgIO<PMMGLibrary::PMMG3D>;
