...
namespace Kratos
{
    ...
    {
        /**
        * Checks the correct work of the level set PMMG IO
        * Test tetrahedra
        */
        KRATOS_TEST_CASE_IN_SUITE(PMMGIO1, KratosMeshingApplicationFastSuite)
        {
            Model this_model;
            ...
            parmmg_io.ReadModelPart(r_aux_model_part);
