...
KRATOS_TEST_CASE_IN_SUITE(UniformRefineTrianglesUtility, KratosMeshingApplicationFastSuite)
{
    ...
    Node::Pointer p_node_3 = r_model_part.CreateNewNode(3, 2.0, 0.0, 0.0);
    Node::Pointer p_node_4 = r_model_part.CreateNewNode(4, 0.0, 1.0, 0.0);
    Node::Pointer p_node_5 = r_model_part.CreateNewNode(5, 1.0, 1.0, 0.0);
    Node::Pointer p_node_6 = r_model_part.CreateNewNode(6, 2.0, 1.0, 0.0);
...
KRATOS_TEST_CASE_IN_SUITE(UniformRefineHexahedronsUtility, KratosMeshingApplicationFastSuite)
{
    ...
    Node::Pointer p_node_1 = r_model_part.CreateNewNode(1, 0.0, 0.0, 0.0);
    Node::Pointer p_node_2 = r_model_part.CreateNewNode(2, 1.0, 0.0, 0.0);
    Node::Pointer p_node_3 = r_model_part.CreateNewNode(3, 1.0, 1.0, 0.0);
    Node::Pointer p_node_4 = r_model_part.CreateNewNode(4, 0.0, 1.0, 0.0);
    Node::Pointer p_node_5 = r_model_part.CreateNewNode(5, 0.0, 0.0, 1.0);
    Node::Pointer p_node_6 = r_model_part.CreateNewNode(6, 1.0, 0.0, 1.0);
    Node::Pointer p_node_7 = r_model_part.CreateNewNode(7, 1.0, 1.0, 1.0);
    Node::Pointer p_node_8 = r_model_part.CreateNewNode(8, 0.0, 1.0, 1.0);
