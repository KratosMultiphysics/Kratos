...
class TestConvertLinearTetrahedraToQuadraticModeler(KratosUnittest.TestCase):
    ...
    def setUp(self):
        ...
        mdpa_io = KM.ModelPartIO(work_dir / "cube_with_5_faces")
        mdpa_io.ReadModelPart(model_part)

    def make_modeler(self, parameters: KM.Parameters):
        registry_data = KM.Registry[
    ...
    def test_creation_from_registry(self):
        modeler = self.make_modeler(KM.Parameters('''{
