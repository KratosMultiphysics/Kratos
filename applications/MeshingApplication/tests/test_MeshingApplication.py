...
from meshing_application_test_factory import MeshingStructuralMechanicsTestFactory
...
def AssembleTestSuites():
    ...
    if hasattr(MeshingApplication,  "MmgProcess2D"):
        ...
        smallSuite.addTests(KratosUnittest.TestLoader().loadTestsFromTestCases([MeshingStructuralMechanicsTestFactory]))
    else:
