...
namespace Kratos {
  ...
  KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS(DEMFEM_VOLUME_COUPLING_APPLICATION, PENALIZE_DISPLACEMENT)
  KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS(DEMFEM_VOLUME_COUPLING_APPLICATION, PENALIZE_VELOCITY)
  KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS(DEMFEM_VOLUME_COUPLING_APPLICATION, VELOCITY_MULTIPLIED_MASS)
