...
namespace Kratos {
  ...
  KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(PENALIZE_DISPLACEMENT)
  KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(PENALIZE_VELOCITY)
  KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(VELOCITY_MULTIPLIED_MASS)
...
KratosDEMFEMVolumeCouplingApplication::KratosDEMFEMVolumeCouplingApplication()
  ...
  KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(PENALIZE_DISPLACEMENT)
  KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(PENALIZE_VELOCITY)
  KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(VELOCITY_MULTIPLIED_MASS)
