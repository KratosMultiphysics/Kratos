...
namespace Kratos
{
    ...
    KRATOS_DEFINE_3D_VARIABLE_WITH_COMPONENTS(OLD_RELAXED_VELOCITY)
    KRATOS_DEFINE_3D_VARIABLE_WITH_COMPONENTS(RELAXED_VELOCITY)
    ...
    KRATOS_DEFINE_VARIABLE(double, HARDENING_MODULUS)
    ...
    KRATOS_DEFINE_VARIABLE(double, COHESION_MC)
