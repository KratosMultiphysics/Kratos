...
namespace Kratos
{
    ...
    // KRATOS_DEFINE_APPLICATION_VARIABLE(FEM_TO_DEM_APPLICATION,double, THRESHOLD)
    ...
    // KRATOS_DEFINE_APPLICATION_VARIABLE(FEM_TO_DEM_APPLICATION,Vector, PLASTIC_STRAIN_VECTOR);
    ...
    // KRATOS_DEFINE_APPLICATION_VARIABLE(FEM_TO_DEM_APPLICATION,Vector, HENCKY_STRAIN_VECTOR);

    // KRATOS_DEFINE_APPLICATION_VARIABLE(FEM_TO_DEM_APPLICATION,Vector, GREEN_LAGRANGE_STRAIN_VECTOR);
    // KRATOS_DEFINE_APPLICATION_VARIABLE(FEM_TO_DEM_APPLICATION,Vector, BIOT_STRAIN_VECTOR);
    // KRATOS_DEFINE_APPLICATION_VARIABLE(FEM_TO_DEM_APPLICATION,Vector, ALMANSI_STRAIN_VECTOR);
    // KRATOS_DEFINE_APPLICATION_VARIABLE(FEM_TO_DEM_APPLICATION,Vector, KIRCHHOFF_STRESS_VECTOR);

    // KRATOS_DEFINE_APPLICATION_VARIABLE(FEM_TO_DEM_APPLICATION,Matrix, CONSTITUTIVE_MATRIX_PK2)
    // KRATOS_DEFINE_APPLICATION_VARIABLE(FEM_TO_DEM_APPLICATION,Matrix, CONSTITUTIVE_MATRIX_KIRCHHOFF)
    // KRATOS_DEFINE_APPLICATION_VARIABLE(FEM_TO_DEM_APPLICATION,Matrix, ALMANSI_STRAIN_TENSOR)

    // KRATOS_DEFINE_APPLICATION_VARIABLE(FEM_TO_DEM_APPLICATION,double, RAYLEIGH_ALPHA)
    // KRATOS_DEFINE_APPLICATION_VARIABLE(FEM_TO_DEM_APPLICATION,double, RAYLEIGH_BETA)
    // KRATOS_DEFINE_APPLICATION_VARIABLE(FEM_TO_DEM_APPLICATION,double, VON_MISES_STRESS)
    ...
    // KRATOS_DEFINE_APPLICATION_VARIABLE(FEM_TO_DEM_APPLICATION,double,MAXIMUM_STRESS);
    // KRATOS_DEFINE_APPLICATION_VARIABLE(FEM_TO_DEM_APPLICATION,double,MAXIMUM_STRESS_POSITION);
    ...
    // KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS(LINE_LOAD);
    // KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS(SURFACE_LOAD);
}
