...
building.SubtractBuildingMOD(0.5, 10.0, 0.1, "Linear", "ISOSURFACE", "true")			# interpolation = constant; disc_type = STANDARD; remove_internal_regions=false
...
building.CreateGidControlOutput("cfd_data/test_{}/gid_file/Ascii/09_Box_buildings_subtracted_3".format(num_test), "GiD_PostAscii")
building.CreateGidControlOutput("cfd_data/test_{}/gid_file/Binary/09_Box_buildings_subtracted_3".format(num_test), "GiD_PostBinary")
# writing file mdpa
