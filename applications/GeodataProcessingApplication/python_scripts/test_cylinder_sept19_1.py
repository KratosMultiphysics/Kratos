""" cylindrical domain
	...
	# edit:		19 September 2019 -> added all parameters in json and saving file into test_.../analysis_file
...
if import_terrain_mdpa:
	...
	# TODO: save only a portion of this "LateralModelPart" (more or less 1/6) into "Inlet" and a portion into "Outlet"
...
# TODO: move this lines into GeoModel (evaluate it)
