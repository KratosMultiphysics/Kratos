...
AxisymContactDomainLM2DCondition::AxisymContactDomainLM2DCondition( IndexType NewId, GeometryType::Pointer pGeometry )
...
AxisymContactDomainLM2DCondition::AxisymContactDomainLM2DCondition( IndexType NewId, GeometryType::Pointer pGeometry, PropertiesType::Pointer pProperties )
...
AxisymContactDomainLM2DCondition::AxisymContactDomainLM2DCondition( AxisymContactDomainLM2DCondition const& rOther)
...
AxisymContactDomainLM2DCondition::~AxisymContactDomainLM2DCondition()
{
}
...
void AxisymContactDomainLM2DCondition::save( Serializer& rSerializer ) const
{
    KRATOS_SERIALIZE_SAVE_BASE_CLASS( rSerializer, ContactDomainLM2DCondition )
}

void AxisymContactDomainLM2DCondition::load( Serializer& rSerializer )
{
