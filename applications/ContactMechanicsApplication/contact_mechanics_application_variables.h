...
namespace Kratos
{
   ...
   KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS( CONTACT_MECHANICS_APPLICATION, STEP_ROTATION )
   KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS( CONTACT_MECHANICS_APPLICATION, STEP_DISPLACEMENT )

   KRATOS_DEFINE_APPLICATION_VARIABLE( CONTACT_MECHANICS_APPLICATION, Vector, RESIDUAL_VECTOR )
   ...
   KRATOS_DEFINE_APPLICATION_VARIABLE( CONTACT_MECHANICS_APPLICATION, int, NUMBER_OF_SLIP_CONTACTS )
