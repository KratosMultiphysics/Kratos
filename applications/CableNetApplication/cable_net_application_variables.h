...
namespace Kratos
{
    KRATOS_DEFINE_APPLICATION_VARIABLE( CABLE_NET_APPLICATION, double, RING_TENSILE_STIFFNESS)
    KRATOS_DEFINE_APPLICATION_VARIABLE( CABLE_NET_APPLICATION, double, RING_REFERENCE_CIRCUMFERENCE)
    KRATOS_DEFINE_APPLICATION_VARIABLE( CABLE_NET_APPLICATION, Vector, SPRING_DEFORMATION_EMPIRICAL_POLYNOMIAL)
    KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS( CABLE_NET_APPLICATION, WALL_POSITION )
}
