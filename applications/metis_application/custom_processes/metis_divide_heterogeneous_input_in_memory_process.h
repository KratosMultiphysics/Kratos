...
class MetisDivideHeterogeneousInputInMemoryProcess : public MetisDivideInputToPartitionsProcess
{
public:
    ///@name Type Definitions
    ///@{
...
private:
    ...
    /// Assignment operator.
    MetisDivideHeterogeneousInputInMemoryProcess& operator=(MetisDivideHeterogeneousInputInMemoryProcess const& rOther);
...
inline std::istream& operator >> (std::istream& rIStream,
                                  MetisDivideHeterogeneousInputInMemoryProcess& rThis);

/// output stream function
inline std::ostream& operator << (std::ostream& rOStream,
                                  const MetisDivideHeterogeneousInputInMemoryProcess& rThis)
{
