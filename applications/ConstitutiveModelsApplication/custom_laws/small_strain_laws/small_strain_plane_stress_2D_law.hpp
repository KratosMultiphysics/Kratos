  ...
  */
  class KRATOS_API(CONSTITUTIVE_MODELS_APPLICATION) SmallStrainPlaneStress2DLaw : public SmallStrain3DLaw
    ...
    public:
      ...
      {
	return (SmallStrainPlaneStress2DLaw::Pointer(new SmallStrainPlaneStress2DLaw(*this)));
      }
    ...
    private:
      ...
      /// Assignment operator.
      SmallStrainPlaneStress2DLaw& operator=(SmallStrainPlaneStress2DLaw const& rOther){ return *this; }
