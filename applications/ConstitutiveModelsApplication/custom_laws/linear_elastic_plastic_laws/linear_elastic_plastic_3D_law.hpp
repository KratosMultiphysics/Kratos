...
// Project includes
#include "plasticity_models/linear_elastic_plastic_laws/hyperelastic_plastic_3D_law.hpp"
...
class KRATOS_API(CONSTITUTIVE_MODELS_APPLICATION) LinearElasticPlastic3DLaw : public HyperElasticPlastic3DLaw
{
public:
    /**
     * Type Definitions
