...
// Project includes
#include "plasticity_models/linear_elastic_plastic_laws/linear_elastic_plastic_3D_law.hpp"

namespace Kratos
{

class KRATOS_API(CONSTITUTIVE_MODELS_APPLICATION) LinearElasticPlasticPlaneStrain2DLaw : public LinearElasticPlastic3DLaw
{
public:
    /**
     * Type Definitions
