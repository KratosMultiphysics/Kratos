...
namespace Kratos
{
  ...
  public:
    ...
    /// Constructor.
    ModifiedMisesYieldCriterion(HardeningLawType::Pointer pHardeningLaw);
    ...
    virtual void PrintInfo(std::ostream& rOStream) const {rOStream << "ModifiedMissesYieldCriterion";}
