...
#if !defined(KRATOS_MOHR_COULOMB_V1_MODEL_H_INCLUDED )
#define  KRATOS_MOHR_COULOMB_V1_MODEL_H_INCLUDED
...
namespace Kratos
{
    ...
    */
   class KRATOS_API(CONSTITUTIVE_MODELS_APPLICATION) MohrCoulombV1Model : public NonAssociativePlasticityModel<HenckyLinearModel, MohrCoulombV1YieldSurface<MohrCoulombV1HardeningRule> >
   {
      public:
