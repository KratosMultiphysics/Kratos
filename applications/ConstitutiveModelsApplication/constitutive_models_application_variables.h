...
namespace Kratos
{
  //specific constitutive models variables must be DEFINED here
   KRATOS_DEFINE_APPLICATION_VARIABLE( CONSTITUTIVE_MODELS_APPLICATION, double, DILATANCY_ANGLE )
   ...
   KRATOS_DEFINE_APPLICATION_VARIABLE( CONSTITUTIVE_MODELS_APPLICATION, double, ELASTIC_JACOBIAN )
  ...
  KRATOS_DEFINE_APPLICATION_VARIABLE( CONSTITUTIVE_MODELS_APPLICATION, double, MAX_IMPLEX_PLASTIC_MULTIPLIER )
  KRATOS_DEFINE_APPLICATION_VARIABLE( CONSTITUTIVE_MODELS_APPLICATION, int, NORMALIZE_FLOW_RULE )
