...
namespace Kratos
{
  ...
  KRATOS_DEFINE_APPLICATION_VARIABLE( CONSTITUTIVE_MODELS_APPLICATION, TableKeyVariablesPointerType , TABLES_SCALAR_VARIABLES )
  KRATOS_DEFINE_APPLICATION_VARIABLE( CONSTITUTIVE_MODELS_APPLICATION, PropertiesLayoutPointerType, PROPERTIES_LAYOUT )
}
