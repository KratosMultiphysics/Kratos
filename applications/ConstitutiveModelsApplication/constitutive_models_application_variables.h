...
namespace Kratos
{
  //specific constitutive models variables must be DEFINED here
   ...
   KRATOS_DEFINE_APPLICATION_VARIABLE( CONSTITUTIVE_MODELS_APPLICATION, double, P0 )
   KRATOS_DEFINE_APPLICATION_VARIABLE( CONSTITUTIVE_MODELS_APPLICATION, double, PC )
   KRATOS_DEFINE_APPLICATION_VARIABLE( CONSTITUTIVE_MODELS_APPLICATION, double, BONDING )
   KRATOS_DEFINE_APPLICATION_VARIABLE( CONSTITUTIVE_MODELS_APPLICATION, double, INITIAL_BONDING )
   KRATOS_DEFINE_APPLICATION_VARIABLE( CONSTITUTIVE_MODELS_APPLICATION, double, DEGRADATION_THRESHOLD )
   KRATOS_DEFINE_APPLICATION_VARIABLE( CONSTITUTIVE_MODELS_APPLICATION, double, DEGRADATION_RATE_COMPRESSION )
   KRATOS_DEFINE_APPLICATION_VARIABLE( CONSTITUTIVE_MODELS_APPLICATION, double, DEGRADATION_RATE_SHEAR )
   KRATOS_DEFINE_APPLICATION_VARIABLE( CONSTITUTIVE_MODELS_APPLICATION, double, ALPHA_TENSILE )
   KRATOS_DEFINE_APPLICATION_VARIABLE( CONSTITUTIVE_MODELS_APPLICATION, double, PLASTIC_DEVIATORIC_STRAIN_HARDENING )
