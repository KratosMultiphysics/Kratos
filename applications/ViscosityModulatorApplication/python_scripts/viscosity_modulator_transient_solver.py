...
def CreateSolver(model, custom_settings):
    return ViscosityModulatorTransientSolver(model, custom_settings)

class ViscosityModulatorTransientSolver(viscosity_modulator_solver.ViscosityModulatorSolver):
