...
# Import applications
import KratosMultiphysics.ViscosityModulatorApplication as ConvectionDiffusionApplication

# Import base class file
from KratosMultiphysics.ViscosityModulatorApplication import convection_diffusion_stationary_solver
...
class ResidualBasedNewtonRaphsonStrategyPython():
    ...
    def __init__(self, main_model_part, scheme,
    ...
    def SolveSolutionStep(self):
        for k in range(self.NumberOfContinuationIterations):
            if k == self.NumberOfContinuationIterations - 1:
                self.main_model_part.ProcessInfo[ConvectionDiffusionApplication.SHOCK_CAPTURING_INTENSITY] = self.final_shock_capturing_constant
            else:
