...
class ConvectionDiffusionStationarySolver(convection_diffusion_solver.ConvectionDiffusionSolver):
    ...
    def __init__(self, main_model_part, custom_settings):
        ...
        buffer_2_elems = ["EulerianConvDiff","EulerianConvDiffShockCapturing","AxisymmetricEulerianConvectionDiffusion2D3N","AxisymmetricEulerianConvectionDiffusion2D4N"] #TODO: Find a better solution
