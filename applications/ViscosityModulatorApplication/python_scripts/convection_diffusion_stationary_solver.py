...
from KratosMultiphysics.ViscosityModulatorApplication import convection_diffusion_solver
from KratosMultiphysics.ViscosityModulatorApplication.continuation_newton_raphson_strategy_for_shock_capturing import ResidualBasedNewtonRaphsonStrategyPython
...
class ConvectionDiffusionStationarySolver(convection_diffusion_solver.ConvectionDiffusionSolver):
    ...
    def __init__(self, main_model_part, custom_settings):
        ...
        buffer_2_elems = ["EulerianConvDiff","VmEulerianConvDiffShockCapturing","AxisymmetricEulerianConvectionDiffusion2D3N","AxisymmetricEulerianConvectionDiffusion2D4N"] #TODO: Find a better solution
