...
#if !defined(KRATOS_BOUSSINESQ_MODULATOR_FIELD_PROCESS_H_INCLUDED )
#define  KRATOS_BOUSSINESQ_MODULATOR_FIELD_PROCESS_H_INCLUDED
...
namespace Kratos
{
   ...
   */
  class KRATOS_API(VISCOSITY_MODULATOR_APPLICATION) BoussinesqModulatorFieldProcess: public Process
  {
  public:
      ///@name Type Definitions
      ///@{

      /// Pointer definition of BoussinesqModulatorFieldProcess
      KRATOS_CLASS_POINTER_DEFINITION(BoussinesqModulatorFieldProcess);
      ...
      /// Constructor
      BoussinesqModulatorFieldProcess(ModelPart& rModelPart);
      BoussinesqModulatorFieldProcess(ModelPart& rModelPart, Parameters& rParameters);

      /// Destructor.
      ~BoussinesqModulatorFieldProcess() override;
    ...
    private:
      ...
      /// Assignment operator.
      BoussinesqModulatorFieldProcess& operator=(BoussinesqModulatorFieldProcess const& rOther);

      /// Copy constructor.
      BoussinesqModulatorFieldProcess(BoussinesqModulatorFieldProcess const& rOther);


      ///@}

    }; // Class BoussinesqModulatorFieldProcess
...
#endif // KRATOS_BOUSSINESQ_MODULATOR_FIELD_PROCESS_H_INCLUDED  defined
