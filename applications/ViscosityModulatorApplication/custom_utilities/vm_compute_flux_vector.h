...
#if !defined(KRATOS_VM_COMPUTE_FLUX_VECTOR_UTILITY_INCLUDED)
#define KRATOS_VM_COMPUTE_FLUX_VECTOR_UTILITY_INCLUDED
...
class VmComputeFluxUtility
{
public:
    KRATOS_CLASS_POINTER_DEFINITION(VmComputeFluxUtility);
...
#endif // KRATOS_VM_COMPUTE_FLUX_VECTOR_UTILITY_INCLUDED
