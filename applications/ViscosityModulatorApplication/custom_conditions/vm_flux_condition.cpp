...
VmFluxCondition<TNodeNumber>::VmFluxCondition(IndexType NewId, Geometry< Node >::Pointer pGeometry):
    Condition(NewId,pGeometry)
{
}

template< unsigned int TNodeNumber >
VmFluxCondition<TNodeNumber>::VmFluxCondition(
    IndexType NewId,
...
template< unsigned int TNodeNumber >
Condition::Pointer VmFluxCondition<TNodeNumber>::Create(
    IndexType NewId,
    NodesArrayType const& ThisNodes,
    Properties::Pointer pProperties) const
{
    return Kratos::make_intrusive<VmFluxCondition<TNodeNumber>>(NewId, GetGeometry().Create(ThisNodes), pProperties);
}
...
Condition::Pointer VmFluxCondition<TNodeNumber>::Create(
    ...
    Properties::Pointer pProperties) const
{
    return Kratos::make_intrusive<VmFluxCondition<TNodeNumber>>(NewId, pGeom, pProperties);
}

template< unsigned int TNodeNumber >
void VmFluxCondition<TNodeNumber>::CalculateLocalSystem(
...
template< unsigned int TNodeNumber >
void VmFluxCondition<TNodeNumber>::CalculateRightHandSide(
    VectorType& rRightHandSideVector,
    const ProcessInfo& rCurrentProcessInfo)
{
    KRATOS_TRY
    ...
    VmFluxConditionInternals::IntegrationData<TNodeNumber> Data(this->GetGeometry(), rFluxVar);
...
template< unsigned int TNodeNumber >
void VmFluxCondition<TNodeNumber>::EquationIdVector(
...
template< unsigned int TNodeNumber >
void VmFluxCondition<TNodeNumber>::GetDofList(
...
template< unsigned int TNodeNumber >
GeometryData::IntegrationMethod VmFluxCondition<TNodeNumber>::GetIntegrationMethod() const
{
    return GeometryData::IntegrationMethod::GI_GAUSS_2;
}

template< unsigned int TNodeNumber >
void VmFluxCondition<TNodeNumber>::CalculateOnIntegrationPoints(
    ...
    const ProcessInfo &rCurrentProcessInfo)
{
    ...
    {
        const VmFluxCondition* const_this = static_cast< const VmFluxCondition* >(this);
...
template< unsigned int TNodeNumber >
std::string VmFluxCondition<TNodeNumber>::Info() const
{
    std::stringstream buffer;
    buffer << "VmFluxCondition #" << Id();
    return buffer.str();
}

template< unsigned int TNodeNumber >
void VmFluxCondition<TNodeNumber>::PrintInfo(std::ostream& rOStream) const
{
    rOStream << "VmFluxCondition #" << Id();
}

template< unsigned int TNodeNumber >
void VmFluxCondition<TNodeNumber>::PrintData(std::ostream& rOStream) const
{
    rOStream << "VmFluxCondition #" << Id() << std::endl;
...
template< unsigned int TNodeNumber >
void VmFluxCondition<TNodeNumber>::AddIntegrationPointRHSContribution(
    VectorType& rRightHandSideVector,
...
template <>
void VmFluxCondition<2>::CalculateNormal(array_1d<double,3>& An)
{
...
template <>
void VmFluxCondition<3>::CalculateNormal(array_1d<double,3>& An )
{
    Geometry<Node >& pGeometry = this->GetGeometry();
...
template <>
void VmFluxCondition<4>::CalculateNormal(array_1d<double,3>& An )
{
...
template< unsigned int TNodeNumber >
void VmFluxCondition<TNodeNumber>::save(Serializer& rSerializer) const
{
    KRATOS_SERIALIZE_SAVE_BASE_CLASS(rSerializer, Condition);
}

template< unsigned int TNodeNumber >
void VmFluxCondition<TNodeNumber>::load(Serializer& rSerializer)
{
    KRATOS_SERIALIZE_LOAD_BASE_CLASS(rSerializer, Condition);
}

template class VmFluxCondition<2>;
template class VmFluxCondition<3>;
template class VmFluxCondition<4>;
