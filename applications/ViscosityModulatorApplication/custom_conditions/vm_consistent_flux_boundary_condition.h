...
#if !defined(KRATOS_VM_CONSISTENT_FLUX_BOUNDARY_CONDITION_H_INCLUDED)
#define KRATOS_VM_CONSISTENT_FLUX_BOUNDARY_CONDITION_H_INCLUDED
...
class KRATOS_API(VISCOSITY_MODULATOR_APPLICATION) VmConsistentFluxBoundaryCondition : public Condition
{
public:
    KRATOS_CLASS_INTRUSIVE_POINTER_DEFINITION(VmConsistentFluxBoundaryCondition);

    typedef Condition::MatrixType MatrixType;
    typedef Condition::VectorType VectorType;

    VmConsistentFluxBoundaryCondition(IndexType NewId, Geometry<Node>::Pointer pGeometry);
    ...
    ~VmConsistentFluxBoundaryCondition() override;
...
private:
    ...
    VmConsistentFluxBoundaryCondition& operator=(VmConsistentFluxBoundaryCondition const& rOther);

    VmConsistentFluxBoundaryCondition(VmConsistentFluxBoundaryCondition const& rOther);
};

} // namespace Kratos

#endif // KRATOS_VM_CONSISTENT_FLUX_BOUNDARY_CONDITION_H_INCLUDED
