...
For more details see https://software.intel.com/en-us/articles/installing-intel-free-libs-and-python-apt-repo.
...
*Hint: Available mkl versions are shown when typing only* `apt-get install intel-mkl`.
