...
class TestEigenDenseDirectSolver(KratosUnittest.TestCase):
    ...
    def _multi_rhs_eq_system(self):
        ...
        B = KratosMultiphysics.Matrix(3,3,0.)
        B[0,0] = 1
        B[1,1] = 1
        B[2,2] = 1
    ...
    def _execute_eigen_dense_direct_solver_multi_rhs_test(self, class_name, solver_type):
        # check if solver is available
        if (not hasattr(EigenSolversApplication, class_name)):
            self.skipTest(class_name + " is not included in the compilation of the EigenSolversApplication")
        ...
        A, B_act, X = self._multi_rhs_eq_system()
    ...
    def test_eigen_dense_colpivhouseholderqr_multi_rhs(self):
        self._execute_eigen_dense_direct_solver_multi_rhs_test('DenseColPivHouseholderQRSolver', 'dense_col_piv_householder_qr')
    ...
    def test_eigen_dense_householderqr_multi_rhs(self):
        self._execute_eigen_dense_direct_solver_multi_rhs_test('DenseHouseholderQRSolver', 'dense_householder_qr')
    ...
    def test_eigen_dense_llt_multi_rhs(self):
        self._execute_eigen_dense_direct_solver_multi_rhs_test('DenseLLTSolver', 'dense_llt')
    ...
    def test_eigen_dense_partialpivlu_multi_rhs(self):
        self._execute_eigen_dense_direct_solver_multi_rhs_test('DensePartialPivLUSolver', 'dense_partial_piv_lu')
