...
C
      INCLUDE 'ABA_PARAM.INC'
      DOUBLE PRECISION TABLE(1,1)
C
      SYIELD = TABLE(1,1)
C      write(*,*) table, ' hola ', SYIELD
      HARD = 0.0
      return;
C    SET YIELD STRESS TO LAST VALUE OF TABLE, HARDENING TO ZERO
C      SYIELD=TABLE(1,NVALUE)
C      SYIELD = TABLE(1,1) !MORE WORK REQUIRED
      HARD=0.0
C
...
C
      IF(NVALUE.GT.1) THEN
        DO 10 K1=1,NVALUE-1
C           EQPL1=TABLE(2,K1+1)  !MORE WORK REQUIRED
           IF(EQPLAS.LT.EQPL1) THEN
C             EQPL0=TABLE(2,K1)  !MORE WORK REQUIRED
...
C
 ...
 20         CONTINUE
      ENDIF
      WRITE(*,*) 'SYIELD ',SYIELD,' TABLE ',TABLE(1,NVALUE)
      WRITE(*,*) 'NVALUE ',NVALUE
      RETURN
      END
