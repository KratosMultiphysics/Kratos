...
namespace Kratos
{
   ...
   KRATOS_DEFINE_APPLICATION_VARIABLE( UMAT_APPLICATION, double, P_ATM  )
   KRATOS_DEFINE_APPLICATION_VARIABLE( UMAT_APPLICATION, double, E0 )
   KRATOS_DEFINE_APPLICATION_VARIABLE( UMAT_APPLICATION, double, LAMBDA_SANISAND )
   KRATOS_DEFINE_APPLICATION_VARIABLE( UMAT_APPLICATION, double, EPSI )
   KRATOS_DEFINE_APPLICATION_VARIABLE( UMAT_APPLICATION, double, MC )
   KRATOS_DEFINE_APPLICATION_VARIABLE( UMAT_APPLICATION, double, ME )
   KRATOS_DEFINE_APPLICATION_VARIABLE( UMAT_APPLICATION, double, M_SANISAND )
   KRATOS_DEFINE_APPLICATION_VARIABLE( UMAT_APPLICATION, double, G0_SANISAND )
   KRATOS_DEFINE_APPLICATION_VARIABLE( UMAT_APPLICATION, double, NU_SANISAND )
   KRATOS_DEFINE_APPLICATION_VARIABLE( UMAT_APPLICATION, double, H0 )
   KRATOS_DEFINE_APPLICATION_VARIABLE( UMAT_APPLICATION, double, CH )
   KRATOS_DEFINE_APPLICATION_VARIABLE( UMAT_APPLICATION, double, NB )
   KRATOS_DEFINE_APPLICATION_VARIABLE( UMAT_APPLICATION, double, A_SANISAND )
   KRATOS_DEFINE_APPLICATION_VARIABLE( UMAT_APPLICATION, double, ND )
   KRATOS_DEFINE_APPLICATION_VARIABLE( UMAT_APPLICATION, double, PTMULT )
