...
-DCMAKE_INSTALL_RPATH="/home/inigo/software/KratosMaster/Kratos/libs"  \
-DCMAKE_INSTALL_RPATH_USE_LINK_PATH=TRUE   \
-DCMAKE_CXX_COMPILER=/usr/bin/g++   \
-DCMAKE_CXX_FLAGS="${CMAKE_CXX_FLAGS} -D_GLIBCXX_DEBUG -msse3 -std=c++11 -Wno-unused-local-typedefs"   \
-DCMAKE_C_FLAGS="${CMAKE_C_FLAGS} -msse3 -Wno-unused-local-typedefs"  \
-DCMAKE_BUILD_TYPE=Debug   \
-DBOOST_ROOT="/home/inigo/software/boost_1_62_0/"  \
