...
namespace Clipper2Lib
{
  ...
  // Note: This is where we have the problem related to the line intersection! 
  ...
  {  
    ...
    std::cout<<"ln1a.x: "<<ln1a.x<<std::endl;
    std::cout<<"ln1a.y: "<<ln1a.y<<std::endl;
    std::cout<<"ln1b.x: "<<ln1b.x<<std::endl;
    std::cout<<"ln1b.y: "<<ln1b.y<<std::endl;

    std::cout<<"ln2a.x: "<<ln2a.x<<std::endl;
    std::cout<<"ln2a.y: "<<ln2a.y<<std::endl;
    std::cout<<"ln2b.x: "<<ln2b.x<<std::endl;
    std::cout<<"ln2b.y: "<<ln2b.y<<std::endl;
