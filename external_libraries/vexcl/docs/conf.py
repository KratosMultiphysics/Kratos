...
html_theme_options = {
        ...
        'navbar_links' : [
            ("GitHub", "https://github.com/ddemidov/vexcl", True)
            ]
        }
...
latex_documents = [
    (master_doc, 'VexCL.tex', 'VexCL Documentation',
...
man_pages = [
    (master_doc, 'vexcl', 'VexCL Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'VexCL', 'VexCL Documentation',
     author, 'VexCL', 'One line description of project.',
     'Miscellaneous'),
]
