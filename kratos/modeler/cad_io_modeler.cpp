...
namespace Kratos
{
    ...
    void CadIoModeler::SetupGeometryModel()
    {
        ...
        if (SBM_technique){
            ...
            CreateTheSnakeCoordinates(knot_vector_u, knot_vector_v, knot_step_u, knot_step_v, refinements_parameters, surrogate_model_part_inner, surrogate_model_part_outer);
