...
namespace Kratos
{
    ...
    void NurbsCouplingGeometry2D<TPointType, TSurfaceContainerPointType, TShiftedBoundary>::SpansLocalSpaceForParentIntegration(
        ...
        for (int i_brep_paired = 0; i_brep_paired < spans_paired_list.size(); i_brep_paired++) {
            for (int i = 0; i < spans_paired_list[i_brep_paired].size(); i++) {
                ...
                for (int i_brep_parent = 0; i_brep_parent < spans_parent_list.size(); i_brep_parent++) {
                    ...
                    bool hasFoundProjection = ProjectionNurbsContactUtilities<TPointType, TSurfaceContainerPointType, TShiftedBoundary>::
    ...
    template<class TPointType, class TSurfaceContainerPointType, bool TShiftedBoundary> 
    void NurbsCouplingGeometry2D<TPointType, TSurfaceContainerPointType, TShiftedBoundary>::FilterSpansForProjection(NurbsSurfaceTypePointer rpNurbsSurfaceParent,
        NurbsSurfaceTypePointer rpNurbsSurfacePaired,
        std::vector<std::vector<double>>& integration_edges_on_parameter_parent_list,
        ...
        BrepCurveOnSurfaceArrayType& rPairedGeometryList)
    {
        ...
        for (IndexType i_brep_parent = 0; i_brep_parent < rParentGeometryList.size(); i_brep_parent++)
        {
            for (IndexType i = 0; i < integration_edges_on_parameter_parent_list[i_brep_parent].size(); i++)
            {
                ...
                bool is_converged = ProjectionNurbsContactUtilities<TPointType, TSurfaceContainerPointType, TShiftedBoundary>::GetProjectionOnPairedGeometry(rpNurbsSurfaceParent,
     ...
     */
    template<class TPointType, class TSurfaceContainerPointType, bool TShiftedBoundary> 
    void NurbsCouplingGeometry2D<TPointType, TSurfaceContainerPointType, TShiftedBoundary>::CreateIntegrationPoints(
        NurbsSurfaceTypePointer rpNurbsSurfaceParent,
        NurbsSurfaceTypePointer rpNurbsSurfacePaired,
     ...
     */
    template<class TPointType, class TSurfaceContainerPointType, bool TShiftedBoundary> 
    void NurbsCouplingGeometry2D<TPointType, TSurfaceContainerPointType, TShiftedBoundary>::CreateQuadraturePointGeometries(
     ...
     */
    template<class TPointType, class TSurfaceContainerPointType, bool TShiftedBoundary> 
    void NurbsCouplingGeometry2D<TPointType, TSurfaceContainerPointType, TShiftedBoundary>::CreateQuadraturePointGeometriesOnParent(
        GeometriesArrayType& rResultGeometries,
        IndexType NumberOfShapeFunctionDerivatives,
        ...
        SizeType& quadraturePointId) 
    {
        ...
        for (IndexType i_brep_m = 0; i_brep_m < rIntegrationPoints.size(); i_brep_m++) {
            ...
            {  
                ...
                ProjectionNurbsContactUtilities<TPointType, TSurfaceContainerPointType, TShiftedBoundary>::
                ...
                ProjectionNurbsContactUtilities<TPointType, TSurfaceContainerPointType, TShiftedBoundary>::GetDisplacement(rpNurbsSurfaceParent, parameter_space_derivatives_master[0], displacement_on_projection);
                ...
                ProjectionNurbsContactUtilities<TPointType, TSurfaceContainerPointType, TShiftedBoundary>::GetDisplacement(rpNurbsSurfaceParent, master_quadrature_point_parameter, displacement_on_master_quadrature_point);
    ...
    template class NurbsCouplingGeometry2D<Kratos::Node, Kratos::PointerVector<Kratos::Node, Kratos::intrusive_ptr<Kratos::Node>, std::vector<Kratos::intrusive_ptr<Kratos::Node>, std::allocator<Kratos::intrusive_ptr<Kratos::Node>>>>, false>;

    template class NurbsCouplingGeometry2D<Kratos::Node, Kratos::PointerVector<Kratos::Node, Kratos::intrusive_ptr<Kratos::Node>, std::vector<Kratos::intrusive_ptr<Kratos::Node>, std::allocator<Kratos::intrusive_ptr<Kratos::Node>>>>, true>;
