...
//     }
    ...
    */
    ...
    typename BaseType::Pointer Create( PointsArrayType const& rThisPoints ) const override
    {
        ...
        return typename BaseType::Pointer( new Line3D3( rThisPoints ) );
    }
    ...
    {
        return typename BaseType::Pointer( new Line3D3( rNewGeometryName, rThisPoints));
    }
    ...
    {
        auto p_geometry = typename BaseType::Pointer( new Line3D3( pGeometry->Points() ) );
    ...
    {
        auto p_geometry = typename BaseType::Pointer( new Line3D3( NewGeometryId, pGeometry->Points() ) );
        p_geometry->SetData(pGeometry->GetData());
        return p_geometry;
    }
    ...
    {
        auto p_geometry = typename BaseType::Pointer( new Line3D3( rNewGeometryName, pGeometry->Points() ) );
        p_geometry->SetData(pGeometry->GetData());
        return p_geometry;
    }
