...
public:
    ...
    explicit THBBrepSurface(
        THBBrepSurface<TOtherContainerPointType, TShiftedBoundary, TOtherContainerPointEmbeddedType> const& rOther )
        : BaseType( rOther )
        , mpNurbsSurface(rOther.mpNurbsSurface)
        , mOuterLoopArray(rOther.mOuterLoopArray)
        , mInnerLoopArray(rOther.mInnerLoopArray)
    ...
    template<class TOtherContainerPointType, class TOtherContainerPointEmbeddedType>
    THBBrepSurface& operator=( THBBrepSurface<TOtherContainerPointType, TShiftedBoundary, TOtherContainerPointEmbeddedType> const & rOther )
    {
        BaseType::operator=( rOther );
        mpNurbsSurface = rOther.mpNurbsSurface;
        mOuterLoopArray = rOther.mOuterLoopArray;
    ...
    */
     ...
     *   - It calls `BrepTrimmingUtilities::CreateTHBBrepSurfaceTrimmingIntegrationPoints` 
        ...
        IntegrationInfo& rIntegrationInfo) const override
    {
        if (!mIsTrimmed) {
            ...
            if constexpr (TShiftedBoundary) {
                ...
                // Call  "BrepSBMUtilities::CreateTHBBrepSurfaceSBMIntegrationPoints"
                BrepSbmUtilitiesType::CreateTHBBrepSurfaceSbmIntegrationPoints(
                    spans_u, 
                    spans_v,
        ...
        else
        {
            ...
            BrepTrimmingUtilitiesType::CreateTHBBrepSurfaceTrimmingIntegrationPoints(
                rIntegrationPoints,
...
template<class TContainerPointType, bool TShiftedBoundary, class TContainerPointEmbeddedType = TContainerPointType> inline std::istream& operator >> (
    ...
    THBBrepSurface<TContainerPointType, TShiftedBoundary, TContainerPointEmbeddedType>& rThis );
...
template<class TContainerPointType, bool TShiftedBoundary, class TContainerPointEmbeddedType = TContainerPointType> inline std::ostream& operator << (
    ...
    const THBBrepSurface<TContainerPointType, TShiftedBoundary, TContainerPointEmbeddedType>& rThis )
{
...
GeometryData THBBrepSurface<TContainerPointType, TShiftedBoundary, TContainerPointEmbeddedType>::msGeometryData(
    &msGeometryDimension,
    GeometryData::IntegrationMethod::GI_GAUSS_1,
    {}, {}, {});

template<class TContainerPointType, bool TShiftedBoundary, class TContainerPointEmbeddedType>
const GeometryDimension THBBrepSurface<TContainerPointType, TShiftedBoundary, TContainerPointEmbeddedType>::msGeometryDimension(3, 2);
