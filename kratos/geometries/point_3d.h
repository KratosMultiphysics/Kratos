...
//     }
    ...
    */
    ...
    {
        return typename BaseType::Pointer(new Point3D(rThisPoints));
    }
    ...
    {
        return typename BaseType::Pointer( new Point3D( rNewGeometryName, rThisPoints ) );
    }
    ...
    {
        auto p_geometry = typename BaseType::Pointer( new Point3D( pGeometry->Points() ) );
    ...
    {
        auto p_geometry = typename BaseType::Pointer( new Point3D( NewGeometryId, pGeometry->Points() ) );
        p_geometry->SetData(pGeometry->GetData());
        return p_geometry;
    }
    ...
    {
        auto p_geometry = typename BaseType::Pointer( new Point3D( rNewGeometryName, pGeometry->Points() ) );
        p_geometry->SetData(pGeometry->GetData());
        return p_geometry;
    }
