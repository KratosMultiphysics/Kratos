 ...
 */
template<class TPointType, class TSurfaceContainerPointType, bool TShiftedBoundary> 
...
public:
    ...
    typedef BrepCurveOnSurface<ContainerNodeType, TShiftedBoundary, ContainerEmbeddedNodeType> BrepCurveOnSurfaceType;
    ...
    GeometriesArrayType& masterGeometryList)
{
    ...
    {
        return Kratos::make_shared<NurbsCouplingGeometry2D<TPointType, TSurfaceContainerPointType, TShiftedBoundary>>();
    }
...
template<class TPointType, class TSurfaceContainerPointType, bool TShiftedBoundary> inline std::istream& operator >> (
    std::istream& rIStream,
    NurbsCouplingGeometry2D<TPointType, TSurfaceContainerPointType, TShiftedBoundary>& rThis );
/**
 * output stream functions
 */
template<class TPointType, class TSurfaceContainerPointType, bool TShiftedBoundary> inline std::ostream& operator << (
    std::ostream& rOStream,
    const NurbsCouplingGeometry2D<TPointType, TSurfaceContainerPointType, TShiftedBoundary>& rThis )
{
