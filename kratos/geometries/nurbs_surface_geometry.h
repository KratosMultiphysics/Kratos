...
#include "utilities/knot_span_utility.h"
...
public:
        ...
        NurbsInterval KnotSpanV) const
    {
        ...
        IntegrationPointUtilities::IntegrationPoints2D(
            ...
            KnotSpanU.GetT0(), KnotSpanU.GetT1(),
            KnotSpanV.GetT0(), KnotSpanV.GetT1());
    }
            ...
            for (IndexType i_point = 0; i_point < num_points; ++i_point)
            {
                if (mIsRational) {
                    shape_function_container.ComputeNurbsShapeFunctionValues(
                        mKnotsU, mKnotsV, mWeights, rIntegrationPoints[i_point][0], rIntegrationPoints[i_point][1]);
                }
                else {
                    shape_function_container.ComputeBSplineShapeFunctionValues(
                        mKnotsU, mKnotsV, rIntegrationPoints[i_point][0], rIntegrationPoints[i_point][1]);
                }
    ...
    */
        ...
        const CoordinatesArrayType& rCoordinates) const override
    {
        ...
        if (mIsRational) {
            shape_function_container.ComputeNurbsShapeFunctionValues1(mKnotsU, mKnotsV, mWeights, rCoordinates[0], rCoordinates[1]);
        }
        else {
        ...
        const CoordinatesArrayType& rCoordinates) const override
    {
        ...
        if (mIsRational) {
            shape_function_container.ComputeNurbsShapeFunctionValues2(mKnotsU, mKnotsV, mWeights, rCoordinates[0], rCoordinates[1]);
        }
        else {
        ...
        const CoordinatesArrayType& rCoordinates) const override
    {
        ...
        if (mIsRational) {
            shape_function_container.ComputeNurbsShapeFunctionValuesAll(mKnotsU, mKnotsV, mWeights, rCoordinates[0], rCoordinates[1]);
        }
        else {
