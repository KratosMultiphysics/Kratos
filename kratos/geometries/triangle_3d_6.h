...
//     }
    ...
    {
        return typename BaseType::Pointer( new Triangle3D6( rNewGeometryName, rThisPoints ) );
    }
    ...
    {
        auto p_geometry = typename BaseType::Pointer( new Triangle3D6( rNewGeometryName, pGeometry->Points() ) );
        p_geometry->SetData(pGeometry->GetData());
        return p_geometry;
    }
