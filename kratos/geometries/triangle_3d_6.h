...
//     }
    ...
    {
        return typename BaseType::Pointer( new Triangle3D6( NewGeometryId, ThisPoints ) );
    }
    ...
    {
        return typename BaseType::Pointer( new Triangle3D6( NewGeometryName, ThisPoints ) );
    }
    ...
    {
        auto p_geometry = typename BaseType::Pointer( new Triangle3D6( pGeometry->Points() ) );
    ...
    {
        auto p_geometry = typename BaseType::Pointer( new Triangle3D6( NewGeometryId, pGeometry->Points() ) );
        p_geometry->SetData(pGeometry->GetData());
        return p_geometry;
    }
    ...
    {
        auto p_geometry = typename BaseType::Pointer( new Triangle3D6( NewGeometryName, pGeometry->Points() ) );
        p_geometry->SetData(pGeometry->GetData());
        return p_geometry;
    }
