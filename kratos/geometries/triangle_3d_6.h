...
public:
     ...
     */
    KRATOS_CLASS_INTRUSIVE_POINTER_DEFINITION( Triangle3D6 );
        ...
        {
            {
                ...
                Triangle3D6<TPointType>::CalculateShapeFunctionsIntegrationPointsLocalGradients( GeometryData::IntegrationMethod::GI_LOBATTO_1 )
            }
        };
