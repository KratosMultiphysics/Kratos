...
//     }
    ...
    {
        return typename BaseType::Pointer( new Quadrilateral2D4( rThisPoints ) );
    }
    ...
    {
        return typename BaseType::Pointer( new Quadrilateral2D4( rNewGeometryName, rThisPoints ) );
    }
    ...
    {
        auto p_geometry = typename BaseType::Pointer( new Quadrilateral2D4( pGeometry->Points() ) );
    ...
    {
        auto p_geometry = typename BaseType::Pointer( new Quadrilateral2D4( NewGeometryId, pGeometry->Points() ) );
        p_geometry->SetData(pGeometry->GetData());
        return p_geometry;
    }
    ...
    {
        auto p_geometry = typename BaseType::Pointer( new Quadrilateral2D4( rNewGeometryName, pGeometry->Points() ) );
        p_geometry->SetData(pGeometry->GetData());
        return p_geometry;
    }
