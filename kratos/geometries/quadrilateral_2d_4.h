...
//     }
    ...
    {
        return typename BaseType::Pointer( new Quadrilateral2D4( NewGeometryId, ThisPoints ) );
    }
    ...
    {
        auto p_geometry = typename BaseType::Pointer( new Quadrilateral2D4( NewGeometryName, pGeometry->Points() ) );
        p_geometry->SetData(pGeometry->GetData());
        return p_geometry;
    }
