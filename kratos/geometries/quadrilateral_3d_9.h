...
//     }
    ...
    {
        return typename BaseType::Pointer( new Quadrilateral3D9( rThisPoints ) );
    }
    ...
    {
        return typename BaseType::Pointer( new Quadrilateral3D9( rNewGeometryName, rThisPoints ) );
    }
    ...
    {
        auto p_geometry = typename BaseType::Pointer( new Quadrilateral3D9( pGeometry->Points() ) );
    ...
    {
        auto p_geometry = typename BaseType::Pointer( new Quadrilateral3D9( NewGeometryId, pGeometry->Points() ) );
        p_geometry->SetData(pGeometry->GetData());
        return p_geometry;
    }
    ...
    {
        auto p_geometry = typename BaseType::Pointer( new Quadrilateral3D9( rNewGeometryName, pGeometry->Points() ) );
        p_geometry->SetData(pGeometry->GetData());
        return p_geometry;
    }
