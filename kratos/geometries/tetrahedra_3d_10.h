...
//     }
    ...
    {
        return typename BaseType::Pointer( new Tetrahedra3D10( rNewGeometryName, rThisPoints ) );
    }
    ...
    {
        auto p_geometry = typename BaseType::Pointer( new Tetrahedra3D10( pGeometry->Points() ) );
    ...
    {
        auto p_geometry = typename BaseType::Pointer( new Tetrahedra3D10( NewGeometryId, pGeometry->Points() ) );
        p_geometry->SetData(pGeometry->GetData());
        return p_geometry;
    }
    ...
    {
        auto p_geometry = typename BaseType::Pointer( new Tetrahedra3D10( rNewGeometryName, pGeometry->Points() ) );
        p_geometry->SetData(pGeometry->GetData());
        return p_geometry;
    }
