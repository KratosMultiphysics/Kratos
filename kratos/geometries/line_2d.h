...
//     }
    ...
    KRATOS_DEPRECATED_TO_BE_REMOVED_IN_VERSION_MESSAGE("DEPRECATED: This implemenation of a 2D line duplicates the code of Line2D2. To avoid conflicts and future problems please replace line_2d.h for line2d_2.h. If any feature is missing, please communicate via GitHub and the feature will be implemented on line_2d_2.h", 6,1,0) Line2D(typename PointType::Pointer pFirstPoint, typename PointType::Pointer pSecondPoint)
        : BaseType(PointsArrayType(), &msGeometryData)
    {
    ...
    KRATOS_DEPRECATED_TO_BE_REMOVED_IN_VERSION_MESSAGE("DEPRECATED: This implemenation of a 2D line duplicates the code of Line2D2. To avoid conflicts and future problems please replace line_2d.h for line_2d_2.h. If any feature is missing, please communicate via GitHub and the feature will be implemented on line2d_2.h", 6,1,0) Line2D(const PointsArrayType& ThisPoints)
...
private:
    ...
    static const ShapeFunctionsValuesContainerType AllShapeFunctionsValues()
    {
        ShapeFunctionsValuesContainerType shape_functions_values = {{
                ...
                Line2D<TPointType>::CalculateShapeFunctionsIntegrationPointsValues(GeometryData::GI_GAUSS_4),
                Line2D<TPointType>::CalculateShapeFunctionsIntegrationPointsValues(GeometryData::GI_GAUSS_5)
            }
        };
    ...
    static const ShapeFunctionsLocalGradientsContainerType AllShapeFunctionsLocalGradients()
    {
        ShapeFunctionsLocalGradientsContainerType shape_functions_local_gradients = {{
                ...
                Line2D<TPointType>::CalculateShapeFunctionsIntegrationPointsLocalGradients(GeometryData::GI_GAUSS_4),
                Line2D<TPointType>::CalculateShapeFunctionsIntegrationPointsLocalGradients(GeometryData::GI_GAUSS_5)
            }
        };
...
inline std::istream& operator >> (std::istream& rIStream,
                                  Line2D<TPointType>& rThis);

/// output stream function
template<class TPointType>
inline std::ostream& operator << (std::ostream& rOStream,
                                  const Line2D<TPointType>& rThis)
{
