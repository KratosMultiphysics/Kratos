...
//     }
    ...
    {
        return typename BaseType::Pointer( new Triangle2D3( NewGeometryId, ThisPoints ) );
    }
    ...
    {
        return typename BaseType::Pointer( new Triangle2D3( NewGeometryName, ThisPoints ) );
    }
    ...
    {
        auto p_geometry = typename BaseType::Pointer( new Triangle2D3( pGeometry->Points() ) );
    ...
    {
        auto p_geometry = typename BaseType::Pointer( new Triangle2D3( NewGeometryId, pGeometry->Points() ) );
        p_geometry->SetData(pGeometry->GetData());
        return p_geometry;
    }
    ...
    {
        auto p_geometry = typename BaseType::Pointer( new Triangle2D3( NewGeometryName, pGeometry->Points() ) );
        p_geometry->SetData(pGeometry->GetData());
        return p_geometry;
    }
