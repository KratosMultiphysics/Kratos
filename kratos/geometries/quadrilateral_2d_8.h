...
public:
    ...
    */
    ...
    {
        return typename BaseType::Pointer( new Quadrilateral2D8( NewGeometryName, ThisPoints ) );
    }
    ...
    {
        auto p_geometry = typename BaseType::Pointer( new Quadrilateral2D8( NewGeometryName, pGeometry->Points() ) );
        p_geometry->SetData(pGeometry->GetData());
        return p_geometry;
    }
