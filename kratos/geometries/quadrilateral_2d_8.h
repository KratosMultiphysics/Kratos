...
public:
     ...
     */
    KRATOS_CLASS_INTRUSIVE_POINTER_DEFINITION( Quadrilateral2D8 );
    ...
    */
     ...
     * This method calculates the jacobian matrices in all
    ...
    GeometriesArrayType GenerateEdges() const override
    {
        ...
        edges.push_back( Kratos::make_intrusive<EdgeType>( this->pGetPoint( 0 ), this->pGetPoint( 1 ), this->pGetPoint( 4 ) ) );
        edges.push_back( Kratos::make_intrusive<EdgeType>( this->pGetPoint( 1 ), this->pGetPoint( 2 ), this->pGetPoint( 5 ) ) );
        edges.push_back( Kratos::make_intrusive<EdgeType>( this->pGetPoint( 2 ), this->pGetPoint( 3 ), this->pGetPoint( 6 ) ) );
        edges.push_back( Kratos::make_intrusive<EdgeType>( this->pGetPoint( 3 ), this->pGetPoint( 0 ), this->pGetPoint( 7 ) ) );
        return edges;
    }
