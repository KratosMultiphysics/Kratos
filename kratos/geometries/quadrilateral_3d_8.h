...
//     }
    ...
    {
        return typename BaseType::Pointer( new Quadrilateral3D8( rThisPoints ) );
    }
    ...
    {
        return typename BaseType::Pointer( new Quadrilateral3D8( rNewGeometryName, rThisPoints ) );
    }
    ...
    {
        auto p_geometry = typename BaseType::Pointer( new Quadrilateral3D8( rNewGeometryName, pGeometry->Points() ) );
        p_geometry->SetData(pGeometry->GetData());
        return p_geometry;
    }
