...
//     }
    ...
    {
        return typename BaseType::Pointer( new Quadrilateral3D8( NewGeometryId, ThisPoints ) );
    }
    ...
    {
        return typename BaseType::Pointer( new Quadrilateral3D8( NewGeometryName, ThisPoints ) );
    }
    ...
    {
        auto p_geometry = typename BaseType::Pointer( new Quadrilateral3D8( pGeometry->Points() ) );
    ...
    {
        auto p_geometry = typename BaseType::Pointer( new Quadrilateral3D8( NewGeometryId, pGeometry->Points() ) );
        p_geometry->SetData(pGeometry->GetData());
        return p_geometry;
    }
    ...
    {
        auto p_geometry = typename BaseType::Pointer( new Quadrilateral3D8( NewGeometryName, pGeometry->Points() ) );
        p_geometry->SetData(pGeometry->GetData());
        return p_geometry;
    }
