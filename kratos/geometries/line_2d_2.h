...
//     }
    ...
    */
    ...
    {
        return typename BaseType::Pointer( new Line2D2( rThisPoints ) );
    }
    ...
    {
        return typename BaseType::Pointer( new Line2D2( rNewGeometryName, rThisPoints));
    }
    ...
    {
        auto p_geometry = typename BaseType::Pointer( new Line2D2( pGeometry->Points() ) );
    ...
    {
        auto p_geometry = typename BaseType::Pointer( new Line2D2( NewGeometryId, pGeometry->Points() ) );
        p_geometry->SetData(pGeometry->GetData());
        return p_geometry;
    }
    ...
    {
        auto p_geometry = typename BaseType::Pointer( new Line2D2( rNewGeometryName, pGeometry->Points() ) );
        p_geometry->SetData(pGeometry->GetData());
        return p_geometry;
    }
