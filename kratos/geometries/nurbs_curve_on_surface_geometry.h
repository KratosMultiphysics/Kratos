...
public:
   ...
   ///@}
    ...
    /// Returns the NurbsCurve of this brep.
    typename NurbsCurveType::Pointer pGetCurve()
    {
        return mpNurbsCurve;
    }

    /// Returns the const NurbsCurve of this brep.
    const typename NurbsCurveType::Pointer pGetCurve() const
    {
        return mpNurbsCurve;
    }
