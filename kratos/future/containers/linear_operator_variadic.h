 ...
 *
 * It is conceptually equivalent to the Python `scipy.sparse.linalg.LinearOperatorVariadic`.
...
public:
    ...
    /// Pointer definition of LinearOperatorVariadic
    KRATOS_CLASS_POINTER_DEFINITION(LinearOperatorVariadic);
     ...
     * @details Creates an empty LinearOperatorVariadic with uninitialized function objects.
     */
    LinearOperatorVariadic() = default;
     ...
     */
    LinearOperatorVariadic(std::pair<std::size_t, std::size_t> Size) requires(kIsMatrixFree)
     ...
     */
    LinearOperatorVariadic(Parameters ThisParameters) requires(kIsMatrixFree)
    {
     ...
     * Constructs a LinearOperatorVariadic that wraps the provided CSR matrix.
     * Note that this constructor is only enabled when a CSR matrix type is provided.
     * @param rA Reference to the CSR matrix
     */
    LinearOperatorVariadic(Ts& ...rA) requires(!kIsMatrixFree)
    {
    ...
    LinearOperatorVariadic(const LinearOperatorVariadic& rOther) = delete;

    /// Defaulted move constructor
    LinearOperatorVariadic(LinearOperatorVariadic&& rOther) = default;
    ...
    LinearOperatorVariadic& operator=(const LinearOperatorVariadic& rOther) = delete;

    /// Defaulted move assignment operator
    LinearOperatorVariadic& operator=(LinearOperatorVariadic&& rOther) = default;
