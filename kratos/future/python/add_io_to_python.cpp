...
void  AddIOToPython(pybind11::module& m)
{
    ...
    vtu_output
        ...
        .def("UpdateTensorAdaptor", &VtuOutput::UpdateTensorAdaptor<TensorAdaptor<bool>::Pointer>, py::arg("tensor_adaptor_name"), py::arg("tensor_adaptor"))
        .def("UpdateTensorAdaptor", &VtuOutput::UpdateTensorAdaptor<TensorAdaptor<int>::Pointer>, py::arg("tensor_adaptor_name"), py::arg("tensor_adaptor"))
        .def("UpdateTensorAdaptor", &VtuOutput::UpdateTensorAdaptor<TensorAdaptor<double>::Pointer>, py::arg("tensor_adaptor_name"), py::arg("tensor_adaptor"))
