...
class BlockBuilder : public Builder<TThreadLocalStorage, TSparseMatrixType, TSparseVectorType, TSparseGraphType>
{
public:
    ...
    //         KRATOS_WARNING("BlockBuilder") << "Provided sparse graph is not empty and will be cleared." << std::endl;
    //         rSparseGraph.Clear();
    //     }
    ...
    //     TThreadLocalStorage& rTLS) override
    // {
    ...
    //     KRATOS_INFO_IF("BlockBuilder", mEchoLevel > 1) << "Element assembly function set." << std::endl;
    // }
    ...
    //     KRATOS_INFO_IF("BlockBuilder", mEchoLevel > 1) << "Condition assembly function set." << std::endl;
    // }
    ...
    //     KRATOS_INFO_IF("BlockBuilder", mEchoLevel > 1) << "Constraint assembly function set." << std::endl;
    // }
