...
class CadJsonInputSBM : public IO
{
    public:
    ...
    /// Pointer definition of CadJsonInputSBM
    KRATOS_CLASS_POINTER_DEFINITION(CadJsonInputSBM);
    ...
    Parameters GetCadJsonParameters() 
    {
        return mCadJsonParameters;
    }
