...
def Factory(settings, Model):
    ...
    return CompareTwoPointOutputFilesProcess(Model, settings["Parameters"])

class CompareTwoPointOutputFilesProcess(KratosMultiphysics.Process, KratosUnittest.TestCase):
