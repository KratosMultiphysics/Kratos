    ...
    def ExecuteInitialize(self):
        ...
        if not self.assign_mpcs_every_time_step:
            for variable in self.variables_list:
                self.assign_mpcs_utility.AssignMPCsToNodesParallel(self.slave_model_part.Nodes,self.search_radius,self.computing_model_part, variable, self.minimum_number_of_neighbouring_nodes)
