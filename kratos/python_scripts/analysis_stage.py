...
class AnalysisStage(object):
    ...
    def FinalizeSolutionStep(self):
        ...
        # for element in self._GetSolver().GetComputingModelPart().GetSubModelPart("Parts_Solid_interface").Elements:
        #     damage = element.CalculateOnIntegrationPoints(CLA.DELAMINATION_DAMAGE_VECTOR_MODE_TWO,self.main_model_part.ProcessInfo)
        ...
        #     if NUM_OF_FAILED_INTEGRATION_POINTS == 8:
