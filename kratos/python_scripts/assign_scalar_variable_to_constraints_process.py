...
def Factory(settings, Model):
    ...
    if settings["Parameters"].Has("mesh_id"):
        ...
        KratosMultiphysics.Logger.PrintWarning("AssignScalarVariableToConstraintsProcess", "mesh_id is a legacy setting. Please remove mesh_id from your parameters")
