...
class PointOutputProcess(KratosMultiphysics.Process):
    ...
    def __init__(self, model, params):
        ...
        default_settings = KratosMultiphysics.Parameters('''{
            "help"            : "This process writes results from a geometrical position (point) in the model to a file. It first searches the entity containing the requested output location and then interpolates the requested variable(s)
