...
def Factory(settings, Model):
    ...
    return AssignVectorVariableToNodeSbmProcess(Model, settings["Parameters"])

from KratosMultiphysics import assign_vector_variable_to_entities_process

## All the processes python should be derived from "Process"
class AssignVectorVariableToNodeSbmProcess(assign_vector_variable_to_entities_process.AssignVectorVariableToEntitiesProcess):
    ...
    def __init__(self, Model, settings ):
        ...
        super(AssignVectorVariableToNodeSbmProcess, self).__init__(Model, settings)
