...
def ConstructSolver(configuration):
    ...
    if KratosMultiphysics.ComplexLinearSolverFactoryBase().Has(configuration["solver_type"].GetString()):
        linear_solver = KratosMultiphysics.ComplexLinearSolverFactoryBase().CreateSolver(configuration)
    else:
        linear_solver = KratosMultiphysics.LinearSolverFactoryBase().CreateSolver(configuration)
