...
from KratosMultiphysics.operation_factory import KratosOperationFactory
...
class MultistageAnalysis(object):
    ...
    def __GetModelers(self):
        ...
        #TODO: To be changed to KratosOperationFactory
        factory = KratosModelerFactory()
        return factory.ConstructListOfModelers(self.model, execution_point_settings["modelers"])
    ...
    def __GetOperations(self, execution_point):
        ...
        factory = KratosOperationFactory(self.model)
        return factory.ConstructListOfOperations(execution_point_settings["operations"])
