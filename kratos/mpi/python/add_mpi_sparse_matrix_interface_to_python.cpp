...
void AddMPISparseMatricesToPython(pybind11::module& m)
{
    ...
    py::class_<DistributedNumbering<IndexType>,DistributedNumbering<IndexType>>(m,"DistributedNumbering")
        ...
        .def("pGetComm", &DistributedNumbering<IndexType>::pGetComm)
    ...
    py::class_<DistributedSparseGraph<IndexType>, DistributedSparseGraph<IndexType>::Pointer>(m,"DistributedSparseGraph")
        ...
        .def("pGetComm", &DistributedSparseGraph<IndexType>::pGetComm)
    ...
    py::class_<DistributedSystemVector<double,IndexType>,  DistributedSystemVector<double,IndexType>::Pointer>(m,"DistributedSystemVector")
        ...
        .def("pGetComm", &DistributedSystemVector<double,IndexType>::pGetComm)
    ...
    py::class_<DistributedCsrMatrix<double,IndexType>, DistributedCsrMatrix<double,IndexType>::Pointer>(m,"DistributedCsrMatrix")
        ...
        .def("pGetComm", &DistributedCsrMatrix<double,IndexType>::pGetComm)
