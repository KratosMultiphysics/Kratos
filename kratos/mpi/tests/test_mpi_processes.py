...
class TestMPIProcesses(KratosUnittest.TestCase):
    ...
    def testComputeNodalGradientProcess(self):
        ...
        input_filename = GetFilePath("auxiliary_files_for_python_unittest/mdpa_files/test_mpi_serializer")
        ...
        ## Read reference
        file_name = "auxiliary_files_for_python_unittest/reference_files/test_compute_nodal_gradient_process_results.json"
    ...
    def testDiscontinuousDistanceProcessCutOnEdge2D(self):
        ...
        input_filename = GetFilePath("auxiliary_files_for_python_unittest/mdpa_files/test_mpi_distance")
        ReadModelPart(input_filename, main_model_part)
