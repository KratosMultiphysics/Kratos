...
class TestDistributedImportModelPartUtility(KratosUnittest.TestCase):
    ...
    def __execute_test(self, in_memory, all_ranks):
        ...
        settings["model_import_settings"].AddEmptyValue("input_filename").SetString(GetFilePath("auxiliary_files_for_python_unittest/mdpa_files/test_mpi_communicator"))
