...
public:
     ...
     *      If @a TGhostNodesContainerType is const ModelPart::ContainerType, @a TApplyFunctor must be void(const Node& rGhostNode, const std::vector<double>& rGhostNodeValues)
     *      If @a TGhostNodesContainerType is ModelPart::ContainerType. @a TApplyFunctor must be void(Node& rGhostNode, const std::vector<double>& rGhostNodeValues)
     *
