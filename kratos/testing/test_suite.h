...
Kratos::Testing::Internals::AddThisTestToTestSuite KRATOS_TESTING_CREATE_DUMMY_VARIABLE_NAME(dummy,__LINE__)(TestName, TestSuiteName)
...
static const Kratos::Testing::Internals::AddThisTestToTestSuite mAnotherDummy; \
};
