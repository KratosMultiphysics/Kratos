...
bool Parameters::iterator_adaptor::operator==(const iterator_adaptor& rhs) const
{
...
Parameters::iterator_adaptor::value_iterator& Parameters::iterator_adaptor::base()
{
...
Parameters::iterator_adaptor::value_iterator const& Parameters::iterator_adaptor::base() const
{
    return mValueIterator;
}
...
bool Parameters::const_iterator_adaptor::operator==(const const_iterator_adaptor& rhs) const
{
    return mValueIterator == rhs.mValueIterator;
}
...
Parameters::const_iterator_adaptor::value_iterator& Parameters::const_iterator_adaptor::base()
{
    return mValueIterator;
}
...
Parameters::const_iterator_adaptor::value_iterator const& Parameters::const_iterator_adaptor::base() const
{
    return mValueIterator;
}
