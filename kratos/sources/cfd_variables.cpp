...
KRATOS_CREATE_VARIABLE( double, PRESSURE_RATE )
KRATOS_CREATE_VARIABLE( double, RELAXED_PRESSURE_RATE )
...
void KratosApplication::RegisterCFDVariables()
{
    ...
    KRATOS_REGISTER_VARIABLE( double, PRESSURE_RATE )
    KRATOS_REGISTER_VARIABLE( double, RELAXED_PRESSURE_RATE )
