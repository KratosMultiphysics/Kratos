...
template std::ostream& KRATOS_API(KRATOS_CORE) operator<<(std::ostream&, const Profiler<std::chrono::milliseconds>&);
...
template std::ostream& KRATOS_API(KRATOS_CORE) operator<<(std::ostream&, const Profiler<std::chrono::microseconds>&);
...
template std::ostream& KRATOS_API(KRATOS_CORE) operator<<(std::ostream&, const Profiler<std::chrono::nanoseconds>&);
