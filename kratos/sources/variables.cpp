...
KRATOS_CREATE_VARIABLE(double, VOLUMETRIC_STRAIN_SUBSCALE)
KRATOS_CREATE_VARIABLE(double, VOLUMETRIC_STRAIN_PROJECTION)
KRATOS_CREATE_VARIABLE(double, VOLUMETRIC_STRAIN_PROJECTION_REACTION)
...
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(DISPLACEMENT_SUBSCALE)
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(DISPLACEMENT_PROJECTION)
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(DISPLACEMENT_PROJECTION_REACTION)
...
KRATOS_CREATE_VARIABLE(double, EXTERNAL_PRESSURE_ADJ )
KRATOS_CREATE_VARIABLE(double, TEMPERATURE_ADJ )
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS( TEMPERATURE_ADJ_GRADIENT )
KRATOS_CREATE_VARIABLE(double, DESIGN_PARAMETER )
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS( DESIGN_PARAMETER_GRADIENT )
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS( FUNCTIONAL_DERIVATIVE_VELOCITY )
KRATOS_CREATE_VARIABLE(double, FUNCTIONAL_DERIVATIVE_TRANSPORT_SCALAR )
KRATOS_CREATE_VARIABLE(double, FUNCTIONAL_DERIVATIVE_TRANSPORT_SCALAR_ADJ )
KRATOS_CREATE_VARIABLE(double, FUNCTIONAL_DERIVATIVE )
KRATOS_CREATE_VARIABLE(Vector, FUNCTIONAL_WEIGHTS )
KRATOS_CREATE_VARIABLE(Vector, FUNCTIONAL_WEIGHTS_FLUID )
KRATOS_CREATE_VARIABLE(Vector, FUNCTIONAL_WEIGHTS_TRANSPORT )
KRATOS_CREATE_VARIABLE(Vector, FUNCTIONAL_DERIVATIVE_WEIGHTS )
KRATOS_CREATE_VARIABLE(Vector, FUNCTIONAL_DERIVATIVE_WEIGHTS_FLUID )
KRATOS_CREATE_VARIABLE(Vector, FUNCTIONAL_DERIVATIVE_WEIGHTS_TRANSPORT )
KRATOS_CREATE_VARIABLE(int, TOP_OPT_PROBLEM_STAGE )
KRATOS_CREATE_VARIABLE(double, TOP_OPT_TIME_COEFFICIENT )
...
void KratosApplication::RegisterVariables() {
    ...
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(DISPLACEMENT_SUBSCALE)
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(STEP_DISPLACEMENT)
    // Movement projections
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(DISPLACEMENT_PROJECTION)
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(DISPLACEMENT_PROJECTION_REACTION)
    // Reaction
    ...
    KRATOS_REGISTER_VARIABLE(VOLUMETRIC_STRAIN_SUBSCALE)
    KRATOS_REGISTER_VARIABLE(VOLUMETRIC_STRAIN_PROJECTION)
    KRATOS_REGISTER_VARIABLE(VOLUMETRIC_STRAIN_PROJECTION_REACTION)
    ...
    KRATOS_REGISTER_VARIABLE(EXTERNAL_PRESSURE_ADJ)
    KRATOS_REGISTER_VARIABLE(TEMPERATURE_ADJ)
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(TEMPERATURE_ADJ_GRADIENT)
    KRATOS_REGISTER_VARIABLE(DESIGN_PARAMETER)
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(DESIGN_PARAMETER_GRADIENT)
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(FUNCTIONAL_DERIVATIVE_VELOCITY)
    KRATOS_REGISTER_VARIABLE(FUNCTIONAL_DERIVATIVE_TRANSPORT_SCALAR)
    KRATOS_REGISTER_VARIABLE(FUNCTIONAL_DERIVATIVE_TRANSPORT_SCALAR_ADJ)
    KRATOS_REGISTER_VARIABLE(FUNCTIONAL_DERIVATIVE)
    KRATOS_REGISTER_VARIABLE(FUNCTIONAL_WEIGHTS)
    KRATOS_REGISTER_VARIABLE(FUNCTIONAL_WEIGHTS_FLUID)
    KRATOS_REGISTER_VARIABLE(FUNCTIONAL_WEIGHTS_TRANSPORT)
    KRATOS_REGISTER_VARIABLE(FUNCTIONAL_DERIVATIVE_WEIGHTS)
    KRATOS_REGISTER_VARIABLE(FUNCTIONAL_DERIVATIVE_WEIGHTS_FLUID)
    KRATOS_REGISTER_VARIABLE(FUNCTIONAL_DERIVATIVE_WEIGHTS_TRANSPORT)
    KRATOS_REGISTER_VARIABLE(TOP_OPT_PROBLEM_STAGE)
    KRATOS_REGISTER_VARIABLE(TOP_OPT_TIME_COEFFICIENT)
