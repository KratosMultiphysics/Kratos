...
KRATOS_CREATE_VARIABLE(double, PENALTY_COEFFICIENT_TANGENTIAL)
...
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(BODY_MOMENT)
...
//for SBM structure
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(POSITIVE_FACE_FLUID_VELOCITY)
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(NEGATIVE_FACE_FLUID_VELOCITY)
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(TRACTION_FROM_FLUID_PRESSURE)
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(TRACTION_FROM_FLUID_STRESS)
...
void KratosApplication::RegisterVariables() {
    ...
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(BODY_MOMENT)
    ...
    KRATOS_REGISTER_VARIABLE(SHAPE_FUNCTIONS_VECTOR)
    KRATOS_REGISTER_VARIABLE(SHAPE_FUNCTIONS_GRADIENT_MATRIX)
    ...
    KRATOS_REGISTER_VARIABLE(PENALTY_COEFFICIENT_TANGENTIAL)
    ...
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(TRACTION_FROM_FLUID_PRESSURE)
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(TRACTION_FROM_FLUID_STRESS)
