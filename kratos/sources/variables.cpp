...
KRATOS_CREATE_2D_TENSOR_VARIABLE_WITH_COMPONENTS( DEFORMATION_GRADIENT_2D_TENSOR )
KRATOS_CREATE_3D_TENSOR_VARIABLE_WITH_COMPONENTS( DEFORMATION_GRADIENT_3D_TENSOR )
...
void KratosApplication::RegisterVariables() {
    ...
    KRATOS_REGISTER_2D_TENSOR_VARIABLE_WITH_COMPONENTS( DEFORMATION_GRADIENT_2D_TENSOR )
    KRATOS_REGISTER_3D_TENSOR_VARIABLE_WITH_COMPONENTS( DEFORMATION_GRADIENT_3D_TENSOR )
}
}  // namespace Kratos.
