...
KRATOS_CREATE_VARIABLE(int, MATERIAL_ID)
...
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(INITIAL_COORDINATES)
...
void KratosApplication::RegisterVariables() {
    ...
    KRATOS_REGISTER_VARIABLE(INITIAL_COORDINATES)
    ...
    KRATOS_REGISTER_VARIABLE(MATERIAL_ID)
