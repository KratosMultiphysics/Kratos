...
// Adjoint Nonlinear
KRATOS_CREATE_VARIABLE( Matrix, ELEMENT_SENSITIVITY_MATRIX);
KRATOS_CREATE_VARIABLE( bool, IS_NONLINEAR);
KRATOS_CREATE_VARIABLE( double, ADJOINT_CORRECTION_FACTOR);
...
void KratosApplication::RegisterVariables() {
    ...
    KRATOS_REGISTER_VARIABLE(ELEMENT_SENSITIVITY_MATRIX)
    KRATOS_REGISTER_VARIABLE(IS_NONLINEAR)
    KRATOS_REGISTER_VARIABLE(ADJOINT_CORRECTION_FACTOR)
