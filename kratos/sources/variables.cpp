...
KRATOS_CREATE_VARIABLE(Vector, ELEMENTAL_EXTRAPOLATED_EDGE_DISTANCES)
KRATOS_CREATE_VARIABLE(Vector, ELEMENTAL_DISTANCES_WITH_EXTRAPOLATED)
...
void KratosApplication::RegisterVariables() {
    ...
    KRATOS_REGISTER_VARIABLE(ELEMENTAL_EXTRAPOLATED_EDGE_DISTANCES)
    KRATOS_REGISTER_VARIABLE(ELEMENTAL_DISTANCES_WITH_EXTRAPOLATED)
