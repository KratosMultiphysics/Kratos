...
KRATOS_CREATE_VARIABLE(int, COLOR)
...
KRATOS_CREATE_VARIABLE(Vector, RECTILINEAR_X_COORDINATES)
KRATOS_CREATE_VARIABLE(Vector, RECTILINEAR_Y_COORDINATES)
KRATOS_CREATE_VARIABLE(Vector, RECTILINEAR_Z_COORDINATES)
...
KRATOS_CREATE_VARIABLE(Vector, COLORS)
...
KRATOS_CREATE_VARIABLE(Matrix, VOXEL_FACE_COLORS)
...
void KratosApplication::RegisterVariables() {
    ...
    KRATOS_REGISTER_VARIABLE(COLOR)
    ...
    KRATOS_REGISTER_VARIABLE(RECTILINEAR_X_COORDINATES)
    KRATOS_REGISTER_VARIABLE(RECTILINEAR_Y_COORDINATES)
    KRATOS_REGISTER_VARIABLE(RECTILINEAR_Z_COORDINATES)
    ...
    KRATOS_REGISTER_VARIABLE(COLORS)
