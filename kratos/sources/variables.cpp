...
KRATOS_CREATE_VARIABLE(BoundedVector6, CAUCHY_STRESS_VECTOR)
KRATOS_CREATE_VARIABLE(BoundedVector6, PK2_STRESS_VECTOR)
...
KRATOS_CREATE_VARIABLE(BoundedVector6, INSITU_STRESS)
...
KRATOS_CREATE_VARIABLE(BoundedVector6, STRESSES)
KRATOS_CREATE_VARIABLE(BoundedVector6, STRAIN)
...
//for General kratos application:
KRATOS_CREATE_VARIABLE(BoundedMatrix3, GREEN_LAGRANGE_STRAIN_TENSOR)
KRATOS_CREATE_VARIABLE(BoundedMatrix3, PK2_STRESS_TENSOR)
KRATOS_CREATE_VARIABLE(BoundedMatrix3, CAUCHY_STRESS_TENSOR)
...
KRATOS_CREATE_VARIABLE(BoundedMatrix3, DEFORMATION_GRADIENT)
