...
KRATOS_CREATE_VARIABLE(Matrix, ADJOINT_STABILIZATION_DIFFUSION_MATRIX )
KRATOS_CREATE_VARIABLE(double, ADJOINT_STABILIZATION_COEFFICIENT )
...
void KratosApplication::RegisterVariables() {
    ...
    KRATOS_REGISTER_VARIABLE(ADJOINT_STABILIZATION_DIFFUSION_MATRIX)
    KRATOS_REGISTER_VARIABLE(ADJOINT_STABILIZATION_COEFFICIENT )
