...
void KratosApplication::RegisterVariables() {
    ...
    KRATOS_REGISTER_3D_VARIABLE_TIME_DERIVATIVE_WITH_COMPONENTS(DISPLACEMENT, VELOCITY)
    KRATOS_REGISTER_3D_VARIABLE_TIME_DERIVATIVE_WITH_COMPONENTS(VELOCITY, ACCELERATION)
    KRATOS_REGISTER_3D_VARIABLE_TIME_DERIVATIVE_WITH_COMPONENTS(ROTATION, ANGULAR_VELOCITY)
    KRATOS_REGISTER_3D_VARIABLE_TIME_DERIVATIVE_WITH_COMPONENTS(ANGULAR_VELOCITY, ANGULAR_ACCELERATION)

    // Register residual
    KRATOS_REGISTER_3D_VARIABLE_RESIDUAL_WITH_COMPONENTS(DISPLACEMENT, FORCE_RESIDUAL)
    KRATOS_REGISTER_3D_VARIABLE_RESIDUAL_WITH_COMPONENTS(ROTATION, MOMENT_RESIDUAL)
}
}  // namespace Kratos.
