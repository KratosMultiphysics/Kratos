...
namespace Kratos
{
    ...
    KRATOS_CREATE_VARIABLE( double, GRAIN_BOUNDARY_WIDTH )
    KRATOS_CREATE_VARIABLE( double, ENTHALPY_ACTIVATION )
    //
  ...
  void KratosApplication::RegisterDEMVariables()
  {
    ...
    KRATOS_REGISTER_VARIABLE( GRAIN_BOUNDARY_WIDTH )
    KRATOS_REGISTER_VARIABLE( ENTHALPY_ACTIVATION )
