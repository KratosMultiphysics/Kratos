...
namespace Kratos
{
    ...
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(AVERAGED_PARTICLE_VELOCITY)
    ...
    KRATOS_CREATE_VARIABLE( Vector, EXACT_VELOCITY )
    ...
    KRATOS_CREATE_VARIABLE( Matrix, EXACT_VELOCITY_GRADIENT )
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS( EXACT_PRESSURE_GRADIENT )
  ...
  void KratosApplication::RegisterDEMVariables()
  {
    ...
    KRATOS_REGISTER_VARIABLE( EXACT_VELOCITY_GRADIENT )
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS( EXACT_PRESSURE_GRADIENT )
    ...
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(AVERAGED_PARTICLE_VELOCITY)
