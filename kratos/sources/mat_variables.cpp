...
namespace Kratos
{
  ...
  KRATOS_CREATE_VARIABLE( BoundedVector6, INITIAL_STRAIN )
  KRATOS_CREATE_VARIABLE( BoundedVector6, INITIAL_STRAIN_VECTOR )
  KRATOS_CREATE_VARIABLE( BoundedVector6, INITIAL_STRESS_VECTOR )
  KRATOS_CREATE_VARIABLE( BoundedMatrix3, INITIAL_DEFORMATION_GRADIENT_MATRIX )

  KRATOS_CREATE_VARIABLE( BoundedVector6, GREEN_LAGRANGE_STRAIN_VECTOR )
  ...
  KRATOS_CREATE_VARIABLE( BoundedVector6, BIOT_STRAIN_VECTOR);
  KRATOS_CREATE_VARIABLE( BoundedMatrix3, BIOT_STRAIN_TENSOR);

  KRATOS_CREATE_VARIABLE( BoundedVector6, ALMANSI_STRAIN_VECTOR )
  KRATOS_CREATE_VARIABLE( BoundedMatrix3, ALMANSI_STRAIN_TENSOR )

  //stress
  KRATOS_CREATE_VARIABLE( BoundedVector6, KIRCHHOFF_STRESS_VECTOR )
  KRATOS_CREATE_VARIABLE( BoundedMatrix3, KIRCHHOFF_STRESS_TENSOR )
  ...
  KRATOS_CREATE_VARIABLE( BoundedMatrix6, LOCAL_CONSTITUTIVE_MATRIX )
  KRATOS_CREATE_VARIABLE( BoundedMatrix6, CONSTITUTIVE_MATRIX )
  KRATOS_CREATE_VARIABLE( BoundedMatrix6, CONSTITUTIVE_MATRIX_PK2 )
  KRATOS_CREATE_VARIABLE( BoundedMatrix6, CONSTITUTIVE_MATRIX_KIRCHHOFF )
  ...
  KRATOS_CREATE_VARIABLE( BoundedMatrix3, INVERSE_DEFORMATION_GRADIENT )
