...
public:
    ...
    */
    ...
    {
		array_1d< array_1d<double, 3>, 3 > pmid;
		pmid[0]= 0.5 * (BaseType::GetPoint( 0 ) + BaseType::GetPoint( 3 ));
		pmid[1]= 0.5 * (BaseType::GetPoint( 1 ) + BaseType::GetPoint( 4 ));
		pmid[2]= 0.5 * (BaseType::GetPoint( 2 ) + BaseType::GetPoint( 5 ));
    ...
    */
                                     ...
                                     IntegrationMethod ThisMethod ) const
    {
        ...
        jacobian( 0, 0 ) = -( p0[0] ) + ( p1[0] ); //on the Gauss points (J is constant at each element)
        jacobian( 1, 0 ) = -( p0[1] ) + ( p1[1] );
        jacobian( 2, 0 ) = -( p0[2] ) + ( p1[2] );
        jacobian( 0, 1 ) = -( p0[0] ) + ( p2[0] );
        jacobian( 1, 1 ) = -( p0[1] ) + ( p2[1] );
        jacobian( 2, 1 ) = -( p0[2] ) + ( p2[2] );
                     ...
                     Matrix & DeltaPosition ) const
    {
        ...
        Matrix jacobian( 3, 2 );
        jacobian( 0, 0 ) = -( p0[0] - deltaPosMid(0,0) ) + ( p1[0] - deltaPosMid(1,0) ); //on the Gauss points (J is constant at each element)
        jacobian( 1, 0 ) = -( p0[1] - deltaPosMid(0,1) ) + ( p1[1] - deltaPosMid(1,1) );
        jacobian( 2, 0 ) = -( p0[2] - deltaPosMid(0,2) ) + ( p1[2] - deltaPosMid(1,2) );
        jacobian( 0, 1 ) = -( p0[0] - deltaPosMid(0,0) ) + ( p2[0] - deltaPosMid(2,0) );
        jacobian( 1, 1 ) = -( p0[1] - deltaPosMid(0,1) ) + ( p2[1] - deltaPosMid(2,1) );
        jacobian( 2, 1 ) = -( p0[2] - deltaPosMid(0,2) ) + ( p2[2] - deltaPosMid(2,2) );
