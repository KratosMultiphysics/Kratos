...
void AddVariableUtilsToPython(pybind11::module &m)
{
    ...
    auto python_variable_utils = py::class_<VariableUtils>(m, "VariableUtils")
        ...
        .def_static("GetDofsListFromSpecifications", &VariableUtils::GetDofsListFromSpecifications)
        .def_static("GetDofsListFromElementsSpecifications", &VariableUtils::GetDofsListFromElementsSpecifications)
        .def_static("GetDofsListFromConditionsSpecifications", &VariableUtils::GetDofsListFromConditionsSpecifications)
