...
void AddVariableUtilsToPython(pybind11::module &m)
{
    ...
    py::class_<VariableUtils>(m, "VariableUtils")
        ...
        .def("DistributeConditionVariable", &VariableUtils::DistributeVariable<double, ModelPart::ConditionsContainerType>)
        .def("DistributeConditionVariable", &VariableUtils::DistributeVariable<array_1d<double, 3>, ModelPart::ConditionsContainerType>)
        .def("DistributeElementVariable", &VariableUtils::DistributeVariable<double, ModelPart::ElementsContainerType>)
        .def("DistributeElementVariable", &VariableUtils::DistributeVariable<array_1d<double, 3>, ModelPart::ElementsContainerType>)
