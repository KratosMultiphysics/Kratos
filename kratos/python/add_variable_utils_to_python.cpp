...
void AddVariableUtilsToPython(pybind11::module &m)
{
    ...
    auto python_variable_utils = py::class_<VariableUtils>(m, "VariableUtils")
        ...
        .def("SetNonHistoricalVariable", VariableUtilsSetNonHistoricalVariable<int, ModelPart::ConditionsContainerType>)
        ...
        .def("SetNonHistoricalVariable", VariableUtilsSetNonHistoricalVariable<int, ModelPart::ElementsContainerType>)
