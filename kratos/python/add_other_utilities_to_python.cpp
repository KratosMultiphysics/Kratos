...
void AddOtherUtilitiesToPython(pybind11::module &m)
{
    ...
    py::class_<AuxiliarModelPartUtilities, typename AuxiliarModelPartUtilities::Pointer>(m, "AuxiliarModelPartUtilities")
        .def(py::init<ModelPart&>())
        .def("AddElementWithNodesToSubModelParts", &AuxiliarModelPartUtilities::AddElementWithNodesToSubModelParts)
        .def("AddConditionWithNodesToSubModelParts", &AuxiliarModelPartUtilities::AddConditionWithNodesToSubModelParts)
