...
void AddOtherUtilitiesToPython(pybind11::module &m)
{
    ...
    py::class_< VariableRedistributionUtility >(m,"VariableRedistributionUtility")
        ...
        .def_static("DistributePointValuesFromNodalArea", [](ModelPart& rModelPart, const Variable<double>& rPointVariable, const Variable<double>& rDistributedVariable){VariableRedistributionUtility::DistributePointValuesFromNodalArea(rModelPart, rPointVariable, rDistributedVariable);})
