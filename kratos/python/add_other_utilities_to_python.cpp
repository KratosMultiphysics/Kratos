...
void AddOtherUtilitiesToPython(pybind11::module &m)
{
    ...
    py::class_<Timer >(m,"Timer")
        ...
        .def_static("SetOuputFile", static_cast<int (*)(std::string const&)>(&Timer::SetOuputFile))
        .def_static("SetOuputFile", static_cast<int (*)(std::wstring const&)>(&Timer::SetOuputFile))
