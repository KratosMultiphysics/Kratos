...
// Project includes
#include "python/add_other_utilities_to_python.h"  //this must be splited. How to declare them, it's called in many files
...
void AddOtherUtilitiesToPython(pybind11::module &m)  // This must change in all of the sub-instances
{
