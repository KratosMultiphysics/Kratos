...
void AddOtherUtilitiesToPython(pybind11::module &m)
{
    ...
    m.def_submodule("ModelPartOperationUtilities", "Free-floating utility functions for model part operations.")
        ...
        .def("Union", &ModelPartOperationUtilities::Union, py::arg("output_model_part_name"), py::arg("main_model_part"), py::arg("model_parts_to_merge"), py::arg("add_neighbours"), py::return_value_policy::reference_internal)
