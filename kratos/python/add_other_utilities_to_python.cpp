...
void AddOtherUtilitiesToPython(pybind11::module &m)
{
    ...
    py::class_<ModelPartUtils>(m, "ModelPartUtils", "Auxiliary utilities for model parts.")
        ...
        .def_static("GetModelPart", py::overload_cast<ModelPart&, const ModelPart::NodesContainerType&>(&ModelPartUtils::GetModelPart<ModelPart::NodesContainerType>), py::arg("model_part"), py::arg("container"))
        .def_static("GetModelPart", py::overload_cast<ModelPart&, const ModelPart::ConditionsContainerType&>(&ModelPartUtils::GetModelPart<ModelPart::ConditionsContainerType>), py::arg("model_part"), py::arg("container"))
        .def_static("GetModelPart", py::overload_cast<ModelPart&, const ModelPart::ElementsContainerType&>(&ModelPartUtils::GetModelPart<ModelPart::ElementsContainerType>), py::arg("model_part"), py::arg("container"))
        .def_static("GetModelPart", py::overload_cast<ModelPart&, const ModelPart::PropertiesContainerType&>(&ModelPartUtils::GetModelPart<ModelPart::PropertiesContainerType>), py::arg("model_part"), py::arg("container"))
        .def_static("GetModelPart", py::overload_cast<ModelPart&, const ModelPart::GeometryContainerType&>(&ModelPartUtils::GetModelPart<ModelPart::GeometryContainerType>), py::arg("model_part"), py::arg("container"))
        .def_static("GetModelPart", py::overload_cast<ModelPart&, const ModelPart::MasterSlaveConstraintContainerType&>(&ModelPartUtils::GetModelPart<ModelPart::MasterSlaveConstraintContainerType>), py::arg("model_part"), py::arg("container"))
        .def_static("GetModelPart", py::overload_cast<Model&, const ModelPart::NodesContainerType&>(&ModelPartUtils::GetModelPart<ModelPart::NodesContainerType>), py::arg("model"), py::arg("container"))
        .def_static("GetModelPart", py::overload_cast<Model&, const ModelPart::ConditionsContainerType&>(&ModelPartUtils::GetModelPart<ModelPart::ConditionsContainerType>), py::arg("model"), py::arg("container"))
        .def_static("GetModelPart", py::overload_cast<Model&, const ModelPart::ElementsContainerType&>(&ModelPartUtils::GetModelPart<ModelPart::ElementsContainerType>), py::arg("model"), py::arg("container"))
        .def_static("GetModelPart", py::overload_cast<Model&, const ModelPart::PropertiesContainerType&>(&ModelPartUtils::GetModelPart<ModelPart::PropertiesContainerType>), py::arg("model"), py::arg("container"))
        .def_static("GetModelPart", py::overload_cast<Model&, const ModelPart::GeometryContainerType&>(&ModelPartUtils::GetModelPart<ModelPart::GeometryContainerType>), py::arg("model"), py::arg("container"))
        .def_static("GetModelPart", py::overload_cast<Model&, const ModelPart::MasterSlaveConstraintContainerType&>(&ModelPartUtils::GetModelPart<ModelPart::MasterSlaveConstraintContainerType>), py::arg("model"), py::arg("container"))
        ;
    ;
}
