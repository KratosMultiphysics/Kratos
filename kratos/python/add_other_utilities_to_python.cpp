...
void AddOtherUtilitiesToPython(pybind11::module &m)
{
    ...
    py::class_<ParticlesUtilities>(m, "ParticlesUtilities")
        ...
        .def_static("InterpolateValuesAtPointsHistorical", &ParticlesUtilities::InterpolateValuesAtPoints<2,double,true>)
        .def_static("InterpolateValuesAtPointsHistorical", &ParticlesUtilities::InterpolateValuesAtPoints<3,double,true>)
        .def_static("InterpolateValuesAtPointsHistorical", &ParticlesUtilities::InterpolateValuesAtPoints<2,std::size_t,true>)
        .def_static("InterpolateValuesAtPointsHistorical", &ParticlesUtilities::InterpolateValuesAtPoints<3,std::size_t,true>)
        .def_static("InterpolateValuesAtPointsHistorical", &ParticlesUtilities::InterpolateValuesAtPoints<2,unsigned int,true>)
        .def_static("InterpolateValuesAtPointsHistorical", &ParticlesUtilities::InterpolateValuesAtPoints<3,unsigned int,true>)
        .def_static("InterpolateValuesAtPointsHistorical", &ParticlesUtilities::InterpolateValuesAtPoints<2,array_1d<double,3>,true>)
        .def_static("InterpolateValuesAtPointsHistorical", &ParticlesUtilities::InterpolateValuesAtPoints<3,array_1d<double,3>,true>)
        .def_static("InterpolateValuesAtPointsNonHistorical", &ParticlesUtilities::InterpolateValuesAtPoints<2,double,false>)
        .def_static("InterpolateValuesAtPointsNonHistorical", &ParticlesUtilities::InterpolateValuesAtPoints<3,double,false>)
        .def_static("InterpolateValuesAtPointsNonHistorical", &ParticlesUtilities::InterpolateValuesAtPoints<2,std::size_t,false>)
        .def_static("InterpolateValuesAtPointsNonHistorical", &ParticlesUtilities::InterpolateValuesAtPoints<3,std::size_t,false>)
        .def_static("InterpolateValuesAtPointsNonHistorical", &ParticlesUtilities::InterpolateValuesAtPoints<2,unsigned int,false>)
        .def_static("InterpolateValuesAtPointsNonHistorical", &ParticlesUtilities::InterpolateValuesAtPoints<3,unsigned int,false>)
        .def_static("InterpolateValuesAtPointsNonHistorical", &ParticlesUtilities::InterpolateValuesAtPoints<2,array_1d<double,3>,false>)
        .def_static("InterpolateValuesAtPointsNonHistorical", &ParticlesUtilities::InterpolateValuesAtPoints<3,array_1d<double,3>,false>)
