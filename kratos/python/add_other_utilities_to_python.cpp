...
void AddOtherUtilitiesToPython(pybind11::module &m)
{
    ...
    py::class_<FillCommunicator, FillCommunicator::Pointer>(m,"FillCommunicator")
        ...
        .def("GatherEntitiesFromOtherPartitions", &FillCommunicator::GatherEntitiesFromOtherPartitions)
        .def("GatherNodesFromOtherPartitions", &FillCommunicator::GatherNodesFromOtherPartitions)
        .def("GatherElementsFromOtherPartitions", &FillCommunicator::GatherElementsFromOtherPartitions)
        .def("GatherConditionsFromOtherPartitions", &FillCommunicator::GatherConditionsFromOtherPartitions)
