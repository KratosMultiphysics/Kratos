...
void AddKernelToPython(pybind11::module& m)
{
    ...
    py::class_<Kernel, Kernel::Pointer>(m,"Kernel")
        ...
        .def("HasFlag", [](Kernel& rKernel, const std::string& rFlagName){return KratosComponents<Flags>::Has(rFlagName);})
        .def("GetFlag", [](Kernel& rKernel, const std::string& rFlagName){return KratosComponents<Flags>::Get(rFlagName);}, py::return_value_policy::reference_internal)
        ...
        .def("HasConstitutiveLaw", [](Kernel& rKernel, const std::string& rConstitutiveLawName){return KratosComponents<ConstitutiveLaw>::Has(rConstitutiveLawName);})
        .def("GetConstitutiveLaw", [](Kernel& rKernel, const std::string& rConstitutiveLawName){return KratosComponents<ConstitutiveLaw>::Get(rConstitutiveLawName);}, py::return_value_policy::reference_internal)
        .def("HasModeler", [](Kernel& rKernel, const std::string& rModelerName){return KratosComponents<Modeler>::Has(rModelerName);})
        .def("GetModeler", [](Kernel& rKernel, const std::string& rModelerName){return KratosComponents<Modeler>::Get(rModelerName);}, py::return_value_policy::reference_internal)
        .def("HasGeometry", [](Kernel& rKernel, const std::string& rGeometryName){return KratosComponents<Geometry<Node<3>>>::Has(rGeometryName);})
        .def("GetGeometry", [](Kernel& rKernel, const std::string& rGeometryName){return KratosComponents<Geometry<Node<3>>>::Get(rGeometryName);}, py::return_value_policy::reference_internal)
        .def("HasCondition", [](Kernel& rKernel, const std::string& rConditionName){return KratosComponents<Condition>::Has(rConditionName);})
        .def("GetCondition", [](Kernel& rKernel, const std::string& rConditionName){return KratosComponents<Condition>::Get(rConditionName);}, py::return_value_policy::reference_internal)
        .def("HasElement", [](Kernel& rKernel, const std::string& rElementName){return KratosComponents<Element>::Has(rElementName);})
        .def("GetElement", [](Kernel& rKernel, const std::string& rElementName){return KratosComponents<Element>::Get(rElementName);}, py::return_value_policy::reference_internal)
        .def("HasMasterSlaveConstraint", [](Kernel& rKernel, const std::string& rMasterSlaveConstraintName){return KratosComponents<MasterSlaveConstraint>::Has(rMasterSlaveConstraintName);})
        .def("GetMasterSlaveConstraint", [](Kernel& rKernel, const std::string& rMasterSlaveConstraintName){return KratosComponents<MasterSlaveConstraint>::Get(rMasterSlaveConstraintName);}, py::return_value_policy::reference_internal)
