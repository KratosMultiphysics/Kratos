...
// Project includes
#include "python/add_variable_utilities_to_python.h"  //this must be splited. How to declare them, it's called in many files
...
// // One of its own?
#include "utilities/variable_utils.h" //This one is everywhere :/
...
// All of the partitions (Or Variable Utils?)
...
void AddVariableUtilitiesToPython(pybind11::module &m)  // This must change in all of the sub-instances
{
