    ...
    const std::string& rName)
{
    ...
    .def(pybind11::init<const typename combined_ta_type::TensorAdaptorVectorType&, const bool>(), pybind11::arg("list_of_tensor_adaptors"), pybind11::arg("collect_and_store_recursively") = false) // reveling ctor
        .def(pybind11::init<const typename combined_ta_type::TensorAdaptorVectorType&, const unsigned int, const bool>(), pybind11::arg("list_of_tensor_adaptors"), pybind11::arg("axis"), pybind11::arg("collect_and_store_recursively") = false) // axis based ctor
        .def(pybind11::init<const combined_ta_type&, const bool, const bool>(), pybind11::arg("list_of_tensor_adaptors"), pybind11::arg("collect_and_store_recursively") = false, pybind11::arg("copy") = true)
