...
void AddTensorAdaptorsToPython(pybind11::module &m) {
  ...
  py::class_<NodalNeighbourCountTensorAdaptor, NodalNeighbourCountTensorAdaptor::Pointer, NodalNeighbourCountTensorAdaptor::BaseType>(
      tensor_adaptor_sub_module, "NodalNeighbourCountTensorAdaptor")
      .def(py::init<const NodalNeighbourCountTensorAdaptor::BaseType&,
                    ModelPart::ConditionsContainerType::Pointer, const bool>(),
           py::arg("tensor_adaptor"), py::arg("entity_container"), py::arg("copy") = true)
      .def(py::init<const NodalNeighbourCountTensorAdaptor::BaseType&,
                    ModelPart::ElementsContainerType::Pointer, const bool>(),
           py::arg("tensor_adaptor"), py::arg("entity_container"), py::arg("copy") = true)
      .def(py::init<ModelPart::NodesContainerType::Pointer, ModelPart::ConditionsContainerType::Pointer>(),
           py::arg("nodes_container"), py::arg("entity_container"))
