...
void  AddContainersToPython(pybind11::module& m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, COLOR )
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, RECTILINEAR_X_COORDINATES )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, RECTILINEAR_Y_COORDINATES )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, RECTILINEAR_Z_COORDINATES )
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, COLORS )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, VOXEL_FACE_COLORS )
