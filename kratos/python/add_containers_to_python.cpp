...
void  AddContainersToPython(pybind11::module& m)
{
    ...
    .def("SetFirstStabilizationVariable",&ConvectionDiffusionSettings::SetFirstStabilizationVariable)
    .def("SetSecondStabilizationVariable",&ConvectionDiffusionSettings::SetSecondStabilizationVariable)
    .def("SetDynamicStabilizationVariable",&ConvectionDiffusionSettings::SetDynamicStabilizationVariable)
    ...
    .def("GetFirstStabilizationVariable",&ConvectionDiffusionSettings::GetFirstStabilizationVariable, py::return_value_policy::reference_internal )
    .def("GetSecondStabilizationVariable",&ConvectionDiffusionSettings::GetSecondStabilizationVariable, py::return_value_policy::reference_internal )
    .def("GetDynamicStabilizationVariable",&ConvectionDiffusionSettings::GetDynamicStabilizationVariable, py::return_value_policy::reference_internal )
    ...
    .def("IsDefinedFirstStabilizationVariable",&ConvectionDiffusionSettings::IsDefinedFirstStabilizationVariable)
    .def("IsDefinedSecondStabilizationVariable",&ConvectionDiffusionSettings::IsDefinedSecondStabilizationVariable)
    .def("IsDefinedDynamicStabilizationVariable",&ConvectionDiffusionSettings::IsDefinedDynamicStabilizationVariable)
    ;
