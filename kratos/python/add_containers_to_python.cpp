...
//     AddLegacyStructuralAppVarsToPython();
    ...
    .def("SetTemperatureGradientVariable",&ConvectionDiffusionSettings::SetTemperatureGradientVariable)
    .def("SetNodalErrorVariable",&ConvectionDiffusionSettings::SetNodalErrorVariable)
    ...
    .def("GetTemperatureGradientVariable",&ConvectionDiffusionSettings::GetTemperatureGradientVariable, py::return_value_policy::reference_internal )
    .def("GetNodalErrorVariable",&ConvectionDiffusionSettings::GetNodalErrorVariable, py::return_value_policy::reference_internal )
    ...
    .def("IsDefinedTemperatureGradientVariable",&ConvectionDiffusionSettings::IsDefinedTemperatureGradientVariable)
    .def("IsDefinedNodalErrorVariable",&ConvectionDiffusionSettings::IsDefinedNodalErrorVariable)
    ;
