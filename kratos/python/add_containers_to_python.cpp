...
void  AddContainersToPython(pybind11::module& m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_FLAG(m,SBM_BOUNDARY);
    KRATOS_REGISTER_IN_PYTHON_FLAG(m,SBM_INTERFACE);
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, PENALTY_COEFFICIENT_TANGENTIAL )
    ...
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, BODY_MOMENT )
    ...
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m,POSITIVE_FACE_FLUID_VELOCITY)
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m,NEGATIVE_FACE_FLUID_VELOCITY)
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m,TRACTION_FROM_FLUID_PRESSURE)
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m,TRACTION_FROM_FLUID_STRESS)
