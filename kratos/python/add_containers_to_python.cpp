...
void  AddContainersToPython(pybind11::module& m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, EXTERNAL_PRESSURE_ADJ)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, TEMPERATURE_ADJ)
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, TEMPERATURE_ADJ_GRADIENT)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, DESIGN_PARAMETER)
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, DESIGN_PARAMETER_GRADIENT)
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, FUNCTIONAL_DERIVATIVE_VELOCITY )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, FUNCTIONAL_DERIVATIVE_TRANSPORT_SCALAR )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, FUNCTIONAL_DERIVATIVE_TRANSPORT_SCALAR_ADJ )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, FUNCTIONAL_DERIVATIVE)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, FUNCTIONAL_WEIGHTS)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, FUNCTIONAL_WEIGHTS_FLUID)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, FUNCTIONAL_WEIGHTS_TRANSPORT)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, FUNCTIONAL_DERIVATIVE_WEIGHTS)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, FUNCTIONAL_DERIVATIVE_WEIGHTS_FLUID)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, FUNCTIONAL_DERIVATIVE_WEIGHTS_TRANSPORT)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, TOP_OPT_PROBLEM_STAGE)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, TOP_OPT_TIME_COEFFICIENT)
