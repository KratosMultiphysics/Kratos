...
//     RegisterInPythonVariables< Variable<std::string> >(m);
    ...
    //KRATOS_REGISTER_IN_PYTHON_FLAG(m,PRESSURE_BC); // Used for the new pressure boundary
...
//     AddLegacyStructuralAppVarsToPython();
    ...
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, NORMAL_VELOCITY_GRADIENT)
