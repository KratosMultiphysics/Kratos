...
// Project includes
#include "python/add_kernel_utilities_to_python.h"  //this must be splited. How to declare them, it's called in many files
...
void AddKernelUtilitiesToPython(pybind11::module &m)  // This must change in all of the sub-instances
{
