...
void  AddFSIVariablesToPython(pybind11::module& m)
{
  ...
  KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,RELAXED_SCALAR);
  KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,OLD_RELAXED_SCALAR);
  KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,RELAXED_SCALAR_TRACTION);
  KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,OLD_RELAXED_SCALAR_TRACTION);
  KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,SCALAR_TRACTION_INTERFACE_RESIDUAL);
  ...
  KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m,RELAXED_TRACTION);
  KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m,OLD_RELAXED_TRACTION);
  KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m,FSI_INTERFACE_RESIDUAL);
  KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m,TRACTION_INTERFACE_RESIDUAL);
