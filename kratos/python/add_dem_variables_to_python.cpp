...
void  AddDEMVariablesToPython(pybind11::module& m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, EXACT_VELOCITY )
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, EXACT_VELOCITY_GRADIENT )
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, EXACT_PRESSURE_GRADIENT )
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, AVERAGED_PARTICLE_VELOCITY )
