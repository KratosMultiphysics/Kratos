...
void AddStrategiesToPython(pybind11::module &m)
{
    ...
    py::class_<ResidualBasedIncrementalUpdateStaticScheme<SparseSpaceType, LocalSpaceType>,
               ...
               BaseSchemeType>(m, "ResidualBasedIncrementalUpdateStaticScheme")
        .def(py::init<>());
    ...
    py::class_<ResidualBasedIncrementalUpdateStaticSchemeSlip<SparseSpaceType, LocalSpaceType>,
               ...
               ResidualBasedIncrementalUpdateStaticScheme<SparseSpaceType, LocalSpaceType>>(m, "ResidualBasedIncrementalUpdateStaticSchemeSlip")
    ...
    py::class_<ResidualBasedBossakDisplacementSchemeType,
               ...
               BaseSchemeType>(m, "ResidualBasedBossakDisplacementScheme")
        .def(py::init<double>())
    ...
    py::class_<ResidualBasedAdjointStaticSchemeType, typename ResidualBasedAdjointStaticSchemeType::Pointer, BaseSchemeType>(m, "ResidualBasedAdjointStaticScheme")
    ...
    py::class_<ResidualBasedAdjointSteadySchemeType, typename ResidualBasedAdjointSteadySchemeType::Pointer, ResidualBasedAdjointStaticSchemeType>(m, "ResidualBasedAdjointSteadyScheme")
        .def(py::init<AdjointResponseFunction::Pointer>());
    ...
    py::class_<ResidualBasedAdjointBossakSchemeType, typename ResidualBasedAdjointBossakSchemeType::Pointer, BaseSchemeType>(m, "ResidualBasedAdjointBossakScheme")
    ...
    py::class_<DisplacementCriteria<SparseSpaceType, LocalSpaceType>,
               ...
               ConvergenceCriteriaType>(m, "DisplacementCriteria")
        .def(py::init<double, double>());
    ...
    py::class_<Or_Criteria<SparseSpaceType, LocalSpaceType>,
               ...
               ConvergenceCriteriaType>(m, "OrCriteria")
        .def(py::init<ConvergenceCriteriaPointerType, ConvergenceCriteriaPointerType>());
    ...
    py::class_<ResidualBasedLinearStrategyType, typename ResidualBasedLinearStrategyType::Pointer, BaseSolvingStrategyType>(m, "ResidualBasedLinearStrategy")
    ...
    py::class_<ResidualBasedNewtonRaphsonStrategyType, typename ResidualBasedNewtonRaphsonStrategyType::Pointer, BaseSolvingStrategyType>(m, "ResidualBasedNewtonRaphsonStrategy")
    ...
    py::class_<AdaptiveResidualBasedNewtonRaphsonStrategy<SparseSpaceType, LocalSpaceType, LinearSolverType>,
               ...
               BaseSolvingStrategyType>(m, "AdaptiveResidualBasedNewtonRaphsonStrategy")
    ...
    py::class_<LineSearchStrategy<SparseSpaceType, LocalSpaceType, LinearSolverType>,
               ...
               ResidualBasedNewtonRaphsonStrategyType>(m, "LineSearchStrategy")
        .def(py::init<ModelPart &, BaseSchemeType::Pointer, LinearSolverType::Pointer, ConvergenceCriteriaType::Pointer, int, bool, bool, bool>())
        .def(py::init<ModelPart &, BaseSchemeType::Pointer, LinearSolverType::Pointer, ConvergenceCriteriaType::Pointer, BuilderAndSolverType::Pointer, int, bool, bool, bool>())
        .def(py::init<ModelPart &, BaseSchemeType::Pointer, LinearSolverType::Pointer, ConvergenceCriteriaType::Pointer, Parameters>())
        .def(py::init<ModelPart &, BaseSchemeType::Pointer, LinearSolverType::Pointer, ConvergenceCriteriaType::Pointer, BuilderAndSolverType::Pointer, Parameters>());
