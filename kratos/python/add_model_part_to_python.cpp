...
void AddModelPartToPython(pybind11::module& m)
{
    ...
    py::class_<Communicator > (m,"Communicator")
        ...
        .def("SynchronizeVariable", CommunicatorSynchronizeVariable<bool> )
        ...
        .def("SynchronizeNonHistoricalVariable", CommunicatorSynchronizeNonHistoricalVariable<bool> )
        ...
        .def("AssembleCurrentData", CommunicatorAssembleCurrentData<bool> )
        ...
        .def("AssembleNonHistoricalData", CommunicatorAssembleNonHistoricalData<bool> )
