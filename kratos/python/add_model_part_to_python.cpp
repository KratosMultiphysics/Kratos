...
//         .def("GetProperties", ModelPartGetPropertiesById2) // NOTE: This method conflicts with the other GetProperties methods
        ...
        .def("AddNodalSolutionStepVariable", AddNodalSolutionStepVariable<array_1d<double, 4 > >)
        .def("AddNodalSolutionStepVariable", AddNodalSolutionStepVariable<array_1d<double, 6 > >)
        .def("AddNodalSolutionStepVariable", AddNodalSolutionStepVariable<array_1d<double, 9 > >)
        ...
        .def("HasNodalSolutionStepVariable", HasNodalSolutionStepVariable<array_1d<double, 4 > >)
        .def("HasNodalSolutionStepVariable", HasNodalSolutionStepVariable<array_1d<double, 6 > >)
        .def("HasNodalSolutionStepVariable", HasNodalSolutionStepVariable<array_1d<double, 9 > >)
