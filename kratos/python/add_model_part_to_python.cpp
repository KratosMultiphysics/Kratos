...
void AddModelPartToPython(pybind11::module& m)
{
    ...
    py::class_<ModelPart, Kratos::shared_ptr<ModelPart>, DataValueContainer, Flags >(m,"ModelPart")
        ...
        .def_property_readonly("Nodes", ModelPartGetNodes1)
        ...
        .def_property_readonly("Properties", ModelPartGetProperties1)
        ...
        .def_property_readonly("Elements", ModelPartGetElements1)
        ...
        .def_property_readonly("Conditions", ModelPartGetConditions1)
        ...
        .def_property_readonly("Geometries", [](ModelPart& self) { return self.Geometries(); })
        ...
        .def_property_readonly("SubModelParts",  [](ModelPart& self){ return self.SubModelParts(); })
