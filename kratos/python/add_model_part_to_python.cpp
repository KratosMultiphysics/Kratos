...
void AddModelPartToPython(pybind11::module& m)
{
    ...
    py::class_<ModelPart, Kratos::shared_ptr<ModelPart>, DataValueContainer, Flags>(m, "ModelPart")
        ...
        .def("NumberOfNodes", static_cast<ModelPart::SizeType (ModelPart::*)(ModelPart::IndexType) const>(&ModelPart::NumberOfNodes), py::arg("ThisIndex") = 0) // Default argument for mesh index 0
        .def("NumberOfNodes", static_cast<ModelPart::SizeType (ModelPart::*)() const>(&ModelPart::NumberOfNodes)) // Overload for current mesh
        .def("SetBufferSize", &ModelPart::SetBufferSize)
        .def("GetBufferSize", &ModelPart::GetBufferSize)
        // Similar to NumberOfNodes, using static_cast for direct member function binding
        .def("NumberOfElements", static_cast<ModelPart::SizeType (ModelPart::*)(ModelPart::IndexType) const>(&ModelPart::NumberOfElements), py::arg("ThisIndex") = 0)
        .def("NumberOfElements", static_cast<ModelPart::SizeType (ModelPart::*)() const>(&ModelPart::NumberOfElements))
        .def("NumberOfConditions", static_cast<ModelPart::SizeType (ModelPart::*)(ModelPart::IndexType) const>(&ModelPart::NumberOfConditions), py::arg("ThisIndex") = 0)
        .def("NumberOfConditions", static_cast<ModelPart::SizeType (ModelPart::*)() const>(&ModelPart::NumberOfConditions))
        .def("NumberOfGeometries", &ModelPart::NumberOfGeometries)
        .def("NumberOfMasterSlaveConstraints", static_cast<ModelPart::SizeType (ModelPart::*)(ModelPart::IndexType) const>(&ModelPart::NumberOfMasterSlaveConstraints), py::arg("ThisIndex") = 0)
        .def("NumberOfMasterSlaveConstraints", static_cast<ModelPart::SizeType (ModelPart::*)() const>(&ModelPart::NumberOfMasterSlaveConstraints))
