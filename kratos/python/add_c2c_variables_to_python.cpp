...
void  AddC2CVariablesToPython(pybind11::module& m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,  MOULD_AVERAGE_TEMPERATURE)

    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,   LAST_AIR)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,   PRESSURES)

    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,  MOULD_DENSITY)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,  MOULD_SPECIFIC_HEAT)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,  MOULD_THICKNESS)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,  MOULD_SFACT)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,  MOULD_VFACT)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,  MOULD_CONDUCTIVITY)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,  MOULD_HTC_ENVIRONMENT)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,  MOULD_TEMPERATURE)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,  MOULD_INNER_TEMPERATURE)
