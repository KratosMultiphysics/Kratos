...
namespace
{
        ...
        CsrMatrixType& rLeftHandSide)
    {
        ...
        KRATOS_ERROR_IF(static_cast<std::size_t>(rLeftHandSideElementContributions.shape(0)) != n_entities)   << "Number of entities do not match." << std::endl;
        KRATOS_ERROR_IF(static_cast<std::size_t>(rLeftHandSideElementContributions.shape(1)) != local_size_1) << "Local size 1 do not match." << std::endl;
        KRATOS_ERROR_IF(static_cast<std::size_t>(rLeftHandSideElementContributions.shape(2)) != local_size_2) << "Local size 2 do not match." << std::endl;
        ...
        CsrMatrixType& rLeftHandSide)
    {
        ...
        KRATOS_ERROR_IF(rLeftHandSideElementContributions.ndim() != 3) << "Input left hand side contributions must have shape (n_entities, local_size, local_size)" << std::endl;
        KRATOS_ERROR_IF(static_cast<std::size_t>(rLeftHandSideElementContributions.shape(0)) != n_entities) << "Number of entities do not match." << std::endl;
        KRATOS_ERROR_IF(static_cast<std::size_t>(rLeftHandSideElementContributions.shape(1)) != local_size) << "Local size 1 do not match." << std::endl;
        KRATOS_ERROR_IF(static_cast<std::size_t>(rLeftHandSideElementContributions.shape(2)) != local_size) << "Local size 2 do not match." << std::endl;
