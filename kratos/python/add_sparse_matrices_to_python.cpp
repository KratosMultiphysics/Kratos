...
void AddSparseMatricesToPython(pybind11::module& m)
{
    ...
    //************************************************************************************************************
    //************************************************************************************************************
    py::class_<SystemVector<double,IndexType>, SystemVector<double,IndexType>::Pointer >(m, "SystemVector")
    ...
    .def("BeginAssemble", &SystemVector<double,IndexType>::BeginAssemble)
    .def("Assemble", [](SystemVector<double,IndexType>& rV, 
                        Vector& values, 
                        std::vector<IndexType>& indices){
       rV.Assemble(values,indices);
    })
