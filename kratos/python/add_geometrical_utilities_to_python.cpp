...
void AddGeometricalUtilitiesToPython(pybind11::module &m)
{
    ...
    py::class_<AssignMPCsToNeighboursUtility>(m, "AssignMPCsToNeighboursUtility")
        ...
        .def("AssignMPCsToNodesParallelUtilities", [](AssignMPCsToNeighboursUtility& rAssignMPCsToNeighboursUtility, NodesContainerType pNodes, double const Radius, ModelPart& rComputingModelPart, const Variable<double>& rVariable, double const MinNumOfNeighNodes){
            return rAssignMPCsToNeighboursUtility.AssignMPCsToNodesParallelUtilities(pNodes, Radius, rComputingModelPart, rVariable, MinNumOfNeighNodes);})
        ;
}
