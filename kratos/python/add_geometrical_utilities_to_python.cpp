...
void AddGeometricalUtilitiesToPython(pybind11::module &m)
{
    ...
    py::class_<NormalCalculationUtils > (m,"NormalCalculationUtils")
        .def(py::init<>())
        .def("CalculateNormalsInConditions", &NormalCalculationUtils::CalculateNormalsInConditions)
        .def("CalculateNormalsInElements", &NormalCalculationUtils::CalculateNormalsInElements)
