...
void AddGeometricalUtilitiesToPython(pybind11::module &m)
{
    ...
    py::class_<AssignMasterSlaveConstraintsToNeighboursUtility>(m, "AssignMasterSlaveConstraintsToNeighboursUtility")
        ...
        .def("InterpolateVelocityToNodes", [](AssignMasterSlaveConstraintsToNeighboursUtility& rAssignMasterSlaveConstraintsToNeighboursUtility, NodesContainerType pNodes, double const Radius, const std::vector<std::reference_wrapper<const Kratos::Variable<double>>>& rVariableList, double const MinNumOfNeighNodes){
            return rAssignMasterSlaveConstraintsToNeighboursUtility.InterpolateVelocityToNodes(pNodes, Radius, rVariableList, MinNumOfNeighNodes);})
        ;
}
