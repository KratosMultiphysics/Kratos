...
void  AddGeometriesToPython(pybind11::module& m)
{
    ...
    .def("Normal", [](GeometryType& self)
        { CoordinatesArrayType LocalCoords; LocalCoords.clear(); return(self.Normal(LocalCoords)); })
    ...
    .def("UnitNormal", [](GeometryType& self)
        { CoordinatesArrayType LocalCoords; LocalCoords.clear(); return(self.UnitNormal(LocalCoords)); })
