...
void  AddKratosParametersToPython(pybind11::module& m)
{
    ...
    .def("__copy__", [](const Parameters& self, py::object memo) { Parameters a(self); return &a;})
    .def("__deepcopy__", [](const Parameters& self, py::object memo) { Parameters a = self; return &a;})
