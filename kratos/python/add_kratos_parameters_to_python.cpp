...
void  AddKratosParametersToPython(pybind11::module& m)
{
    ...
    .def("__copy__", [](const Parameters& self, py::object memo) {Parameters* a = new Parameters(self); return a;})
    .def("__deepcopy__", [](const Parameters& self, py::object memo) {Parameters* a = new Parameters(); Parameters& r_a = *a;r_a = self; return a;})
