...
void  AddKratosParametersToPython(pybind11::module& m)
{
    ...
    .def("ValidateAndAssignDefaultsSkipSubParameters", &Parameters::ValidateAndAssignDefaultsSkipSubParameters)
    ...
    .def("ValidateDefaultsSkipSubParameters", &Parameters::ValidateDefaultsSkipSubParameters)
