...
//             typedef MeshType::NodeType NodeType;
    ...
    .def("SetValueOnIntegrationPoints", SetValuesOnIntegrationPointsVector<Element>)
    .def("SetValueOnIntegrationPoints", SetValuesOnIntegrationPointsConstitutiveLaw)
    .def("SetValueOnIntegrationPoints", SetValuesOnIntegrationPointsDouble<Element>)
    .def("SetValueOnIntegrationPoints", SetValuesOnIntegrationPointsArray1d<Element>)
...
//     .def(SolutionStepVariableIndexingPython<Element, VariableComponent<VectorComponentAdaptor<array_1d<double, 3> > > >())
    ...
    // SetValueOnIntegrationPoints
    .def("SetValueOnIntegrationPoints", SetValuesOnIntegrationPointsVector<Condition>)
    .def("SetValueOnIntegrationPoints", SetValuesOnIntegrationPointsDouble<Condition>)
    .def("SetValueOnIntegrationPoints", SetValuesOnIntegrationPointsArray1d<Condition>)
