...
//             ;
    ...
    py::class_< GeometryTesterUtility>(m,"GeometryTesterUtility")
        ...
        .def("TestQuadrilateral2D4N", &GeometryTesterUtility::TestQuadrilateral2D4N)
        .def("TestQuadrilateral2D9N", &GeometryTesterUtility::TestQuadrilateral2D9N)
        ...
        .def("TestPrism3D6N", &GeometryTesterUtility::TestPrism3D6N)
