...
void AddUtilitiesToPython()
{
    ...
    .def("SetVectorVarNonHistorical", &VariableUtils::SetVectorVarNonHistorical)
    .def("SetScalarVarNonHistorical", &VariableUtils::SetScalarVarNonHistorical< Variable<double> >)
    .def("SetScalarVarNonHistorical", &VariableUtils::SetScalarVarNonHistorical< VariableComponent< VectorComponentAdaptor<array_1d<double, 3> > > >)
    ...
    .def("SetVariableNonHistorical", &VariableUtils::SetVariableNonHistorical< bool, ModelPart::NodesContainerType >)
    .def("SetVariableNonHistorical", &VariableUtils::SetVariableNonHistorical< double, ModelPart::NodesContainerType >)
    .def("SetVariableNonHistorical", &VariableUtils::SetVariableNonHistorical< array_1d<double, 3>, ModelPart::NodesContainerType >)
    .def("SetVariableNonHistorical", &VariableUtils::SetVariableNonHistorical< Vector, ModelPart::NodesContainerType >)
    .def("SetVariableNonHistorical", &VariableUtils::SetVariableNonHistorical< Matrix, ModelPart::NodesContainerType >)
    .def("SetVariableNonHistorical", &VariableUtils::SetVariableNonHistorical< bool, ModelPart::ConditionsContainerType >)
    .def("SetVariableNonHistorical", &VariableUtils::SetVariableNonHistorical< double, ModelPart::ConditionsContainerType >)
    .def("SetVariableNonHistorical", &VariableUtils::SetVariableNonHistorical< array_1d<double, 3>, ModelPart::ConditionsContainerType >)
    .def("SetVariableNonHistorical", &VariableUtils::SetVariableNonHistorical< Vector, ModelPart::ConditionsContainerType >)
    .def("SetVariableNonHistorical", &VariableUtils::SetVariableNonHistorical< Matrix, ModelPart::ConditionsContainerType >)
    .def("SetVariableNonHistorical", &VariableUtils::SetVariableNonHistorical< bool, ModelPart::ElementsContainerType >)
    .def("SetVariableNonHistorical", &VariableUtils::SetVariableNonHistorical< double, ModelPart::ElementsContainerType >)
    .def("SetVariableNonHistorical", &VariableUtils::SetVariableNonHistorical< array_1d<double, 3>, ModelPart::ElementsContainerType >)
    .def("SetVariableNonHistorical", &VariableUtils::SetVariableNonHistorical< Vector, ModelPart::ElementsContainerType >)
    .def("SetVariableNonHistorical", &VariableUtils::SetVariableNonHistorical< Matrix, ModelPart::ElementsContainerType >)
