...
void AddUtilitiesToPython(pybind11::module& m)
{
    ...
    class_<VariableUtils>(m, "VariableUtils")
        ...
        .def("SetNonHistoricalVectorVar", &VariableUtils::SetNonHistoricalVariable<Variable<array_1d<double, 3>>, ModelPart::NodesContainerType>)
        .def("SetNonHistoricalScalarVar", &VariableUtils::SetNonHistoricalVariable<Variable<double>, ModelPart::NodesContainerType>)
