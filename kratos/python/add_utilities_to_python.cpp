...
void AddUtilitiesToPython(pybind11::module &m)
{
    ...
    py::class_<VariableUtils>(m, "VariableUtils")
        ...
        .def("SetScalarVar", VariableUtilsSetVariableForFlag<Variable<double>>)
        .def("SetScalarVar", VariableUtilsSetVariableForFlag<VariableComponent<VectorComponentAdaptor<array_1d<double, 3>>>>)
        .def("SetScalarVar", VariableUtilsSetVariableForFlag<VariableComponent<VectorComponentAdaptor<array_1d<double, 4>>>>)
        .def("SetScalarVar", VariableUtilsSetVariableForFlag<VariableComponent<VectorComponentAdaptor<array_1d<double, 6>>>>)
        .def("SetScalarVar", VariableUtilsSetVariableForFlag<VariableComponent<VectorComponentAdaptor<array_1d<double, 9>>>>)
        ...
        .def("SetNonHistoricalVariableToZero", &VariableUtils::SetNonHistoricalVariableToZero<Quaternion<double>, ModelPart::NodesContainerType>)
        .def("SetNonHistoricalVariableToZero", &VariableUtils::SetNonHistoricalVariableToZero<Quaternion<double>, ModelPart::ElementsContainerType>)
        .def("SetNonHistoricalVariableToZero", &VariableUtils::SetNonHistoricalVariableToZero<Quaternion<double>, ModelPart::ConditionsContainerType>)
        .def("SetNonHistoricalVariableToZero", &VariableUtils::SetNonHistoricalVariableToZero<Quaternion<double>, ModelPart::MasterSlaveConstraintContainerType>)
        ...
        .def("SetNonHistoricalVariable", &VariableUtils::SetNonHistoricalVariable<Quaternion<double>, ModelPart::NodesContainerType>)
        ...
        .def("SetNonHistoricalVariable", &VariableUtils::SetNonHistoricalVariable<Quaternion<double>, ModelPart::ConditionsContainerType>)
        ...
        .def("SetNonHistoricalVariable", &VariableUtils::SetNonHistoricalVariable<Quaternion<double>, ModelPart::ElementsContainerType>)
        ...
        .def("SetNonHistoricalVariable", &VariableUtils::SetNonHistoricalVariableForFlag<Quaternion<double>, ModelPart::NodesContainerType>)
        ...
        .def("SetNonHistoricalVariable", &VariableUtils::SetNonHistoricalVariableForFlag<Quaternion<double>, ModelPart::ConditionsContainerType>)
        ...
        .def("SetNonHistoricalVariable", &VariableUtils::SetNonHistoricalVariableForFlag<Quaternion<double>, ModelPart::ElementsContainerType>)
