...
void AddUtilitiesToPython()
{
    ...
    .def("SaveVectorNonHistVar", &VariableUtils::SaveVectorNonHistVar)
    .def("SaveScalarNonHistVar", &VariableUtils::SaveScalarNonHistVar)
    ...
    .def("SetToZero_NonHistVectorVar", &VariableUtils::SetToZero_NonHistVectorVar)
    .def("SetToZero_NonHistScalarVar", &VariableUtils::SetToZero_NonHistScalarVar)
