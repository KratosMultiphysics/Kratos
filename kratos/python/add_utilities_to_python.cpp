...
void AddUtilitiesToPython(pybind11::module &m)
{
    ...
    py::class_<VariableUtils>(m, "VariableUtils")
        ...
        .def("SetVariable", &VariableUtils::SetVariable<double, VariableComponent<VectorComponentAdaptor<array_1d<double, 3>>>>)
        .def("SetVariable", &VariableUtils::SetVariable<double, VariableComponent<VectorComponentAdaptor<array_1d<double, 4>>>>)
        .def("SetVariable", &VariableUtils::SetVariable<double, VariableComponent<VectorComponentAdaptor<array_1d<double, 6>>>>)
        .def("SetVariable", &VariableUtils::SetVariable<double, VariableComponent<VectorComponentAdaptor<array_1d<double, 9>>>>)
