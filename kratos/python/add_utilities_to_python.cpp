...
void AddUtilitiesToPython(pybind11::module& m)
{
    ...
    py::class_<VariableUtils>(m, "VariableUtils")
        ...
        .def("ClearNonHistoricalValues", &VariableUtils::ClearNonHistoricalValues<ModelPart::NodesContainerType>)
        .def("ClearNonHistoricalValues", &VariableUtils::ClearNonHistoricalValues<ModelPart::ConditionsContainerType>)
        .def("ClearNonHistoricalValues", &VariableUtils::ClearNonHistoricalValues<ModelPart::ElementsContainerType>)
