...
void AddUtilitiesToPython(pybind11::module& m)
{
    ...
    py::class_<VariableUtils>(m, "VariableUtils")
        ...
        .def("SetNodalHistoricalVariableToZero", &VariableUtils::SetNodalHistoricalVariableToZero<double>)
        .def("SetNodalHistoricalVariableToZero", &VariableUtils::SetNodalHistoricalVariableToZero<array_1d<double, 3>>)
