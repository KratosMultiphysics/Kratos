...
py::class_< ConstitutiveLaw::Parameters, ConstitutiveLaw::Parameters::Pointer>(m,"ConstitutiveLawParameters")
    ...
    py::class_< ConstitutiveLaw, ConstitutiveLaw::Pointer , Flags >(m,"ConstitutiveLaw")
        .def(py::init<>())
        .def("Create", py::overload_cast<Kratos::Parameters>(&ConstitutiveLaw::Create, py::const_))
        .def("Create", py::overload_cast<Kratos::Parameters, const Properties&>(&ConstitutiveLaw::Create, py::const_))
        ...
        .def("Has", py::overload_cast<const Variable<bool>&>(&ConstitutiveLaw::Has))
        .def("Has", py::overload_cast<const Variable<int>&>(&ConstitutiveLaw::Has))
        .def("Has", py::overload_cast<const Variable<double>&>(&ConstitutiveLaw::Has))
        .def("Has", py::overload_cast<const Variable<array_1d<double, 3>>&>(&ConstitutiveLaw::Has))
        .def("Has", py::overload_cast<const Variable<Vector>&>(&ConstitutiveLaw::Has))
        .def("Has", py::overload_cast<const Variable<Matrix>&>(&ConstitutiveLaw::Has))
