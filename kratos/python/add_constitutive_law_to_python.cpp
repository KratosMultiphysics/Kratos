...
void AddConstitutiveLawToPython(pybind11::module& m)
{
    ...
    py::class_< ConstitutiveLaw::Parameters, ConstitutiveLaw::Parameters::Pointer>(m,"ConstitutiveLawParameters")
        ...
        .def("GetOptions", py::overload_cast<>(&ConstitutiveLaw::Parameters::GetOptions, py::const_), py::return_value_policy::reference_internal)
        .def("GetDeterminantF", py::overload_cast<>(&ConstitutiveLaw::Parameters::GetDeterminantF, py::const_))
    ...
    py::class_< ConstitutiveLaw, ConstitutiveLaw::Pointer , Flags >(m,"ConstitutiveLaw")
        ...
        .def("Has", static_cast<bool (ConstitutiveLaw::*)(const Variable<bool>&) const>(&ConstitutiveLaw::Has))
        .def("Has", static_cast<bool (ConstitutiveLaw::*)(const Variable<int>&) const>(&ConstitutiveLaw::Has))
        .def("Has", static_cast<bool (ConstitutiveLaw::*)(const Variable<double>&) const>(&ConstitutiveLaw::Has))
        .def("Has", static_cast<bool (ConstitutiveLaw::*)(const Variable<array_1d<double, 3>>&) const>(&ConstitutiveLaw::Has))
        .def("Has", static_cast<bool (ConstitutiveLaw::*)(const Variable<Vector>&) const>(&ConstitutiveLaw::Has))
        .def("Has", static_cast<bool (ConstitutiveLaw::*)(const Variable<Matrix>&) const>(&ConstitutiveLaw::Has))
