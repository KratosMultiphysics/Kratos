...
void AddConstitutiveLawToPython(pybind11::module& m)
{
    ...
    py::class_< ConstitutiveLaw::Parameters, ConstitutiveLaw::Parameters::Pointer>(m,"ConstitutiveLawParameters")
        ...
        .def("GetOptions", &ConstitutiveLaw::Parameters::GetOptions)
        .def("GetDeterminantF", &ConstitutiveLaw::Parameters::GetDeterminantF)
        .def("GetDeformationGradientF", py::overload_cast<>(&ConstitutiveLaw::Parameters::GetDeformationGradientF, py::const_), py::return_value_policy::reference_internal)
        .def("GetDeformationGradientF", py::overload_cast<ConstitutiveLaw::DeformationGradientMatrixType&>(&ConstitutiveLaw::Parameters::GetDeformationGradientF, py::const_))
        .def("GetStrainVector", py::overload_cast<>(&ConstitutiveLaw::Parameters::GetStrainVector, py::const_), py::return_value_policy::reference_internal)
        .def("GetStrainVector", py::overload_cast<ConstitutiveLaw::StrainVectorType&>(&ConstitutiveLaw::Parameters::GetStrainVector, py::const_))
        .def("GetStressVector", py::overload_cast<>(&ConstitutiveLaw::Parameters::GetStressVector, py::const_), py::return_value_policy::reference_internal)
        .def("GetStressVector", py::overload_cast<ConstitutiveLaw::StressVectorType&>(&ConstitutiveLaw::Parameters::GetStressVector, py::const_))
        .def("GetConstitutiveMatrix", py::overload_cast<>(&ConstitutiveLaw::Parameters::GetConstitutiveMatrix, py::const_), py::return_value_policy::reference_internal)
        .def("GetConstitutiveMatrix", py::overload_cast<ConstitutiveLaw::VoigtSizeMatrixType&>(&ConstitutiveLaw::Parameters::GetConstitutiveMatrix, py::const_))
        .def("GetShapeFunctionsValues", py::overload_cast<>(&ConstitutiveLaw::Parameters::GetShapeFunctionsValues, py::const_), py::return_value_policy::reference_internal)
        .def("GetProcessInfo", py::overload_cast<>(&ConstitutiveLaw::Parameters::GetProcessInfo, py::const_), py::return_value_policy::reference_internal)
        .def("GetMaterialProperties", py::overload_cast<>(&ConstitutiveLaw::Parameters::GetMaterialProperties, py::const_), py::return_value_policy::reference_internal)
        .def("GetElementGeometry", py::overload_cast<>(&ConstitutiveLaw::Parameters::GetElementGeometry, py::const_), py::return_value_policy::reference_internal)
    ;
    ...
    py::class_< ConstitutiveLaw, ConstitutiveLaw::Pointer , Flags >(m,"ConstitutiveLaw")
        ...
        .def("Has", py::overload_cast<const Variable<array_1d<double,3>>&>(&ConstitutiveLaw::Has, py::const_))
        .def("Has", py::overload_cast<const Variable<Vector>&>(&ConstitutiveLaw::Has, py::const_))
        .def("Has", py::overload_cast<const Variable<Matrix>&>(&ConstitutiveLaw::Has, py::const_))
        .def("GetValue", [](const ConstitutiveLaw& rCL, const Variable<bool>& rVar) { bool v; rCL.GetValue(rVar, v); return v; })
        .def("GetValue", [](const ConstitutiveLaw& rCL, const Variable<int>& rVar) { int v; rCL.GetValue(rVar, v); return v; })
        .def("GetValue", [](const ConstitutiveLaw& rCL, const Variable<double>& rVar) { double v; rCL.GetValue(rVar, v); return v; })
        .def("GetValue", [](const ConstitutiveLaw& rCL, const Variable<array_1d<double,3>>& rVar) { array_1d<double,3> v; rCL.GetValue(rVar, v); return v; })
        .def("GetValue", [](const ConstitutiveLaw& rCL, const Variable<Vector>& rVar) { Vector v; rCL.GetValue(rVar, v); return v; })
        .def("GetValue", [](const ConstitutiveLaw& rCL, const Variable<Matrix>& rVar) { Matrix v; rCL.GetValue(rVar, v); return v; })
