...
//     .def("ReadProperties",pointer_to_io_read_properties)
    ...
    vtu_output
        ...
        .def("GetUnstructuredGrids", &VtuOutput::GetUnstructuredGrids)
        .def("GetConnectivityData", &VtuOutput::GetConnectivityData<ModelPart::ConditionsContainerType::Pointer>, py::arg("nodes"), py::arg("conditions"))
        .def("GetConnectivityData", &VtuOutput::GetConnectivityData<ModelPart::ElementsContainerType::Pointer>, py::arg("nodes"), py::arg("elements"))
