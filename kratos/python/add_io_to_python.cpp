...
//     .def("ReadProperties",pointer_to_io_read_properties)
    ...
    vtu_output
        ...
        // .def("AddIntegrationPointVariable", &VtuOutput::AddContainerExpression, py::arg("variable"), py::arg("data_location"))
        ...
        // .def("AddIntegrationPointVariable", &VtuOutput::AddIntegrationPointVariable<int>, py::arg("int_variable"), py::arg("entity_flags"))
        // .def("AddIntegrationPointVariable", &VtuOutput::AddIntegrationPointVariable<double>, py::arg("double_variable"), py::arg("entity_flags"))
        // .def("AddIntegrationPointVariable", &VtuOutput::AddIntegrationPointVariable<array_1d<double, 3>>, py::arg("array3_variable"), py::arg("entity_flags"))
        // .def("AddIntegrationPointVariable", &VtuOutput::AddIntegrationPointVariable<array_1d<double, 4>>, py::arg("array4_variable"), py::arg("entity_flags"))
        // .def("AddIntegrationPointVariable", &VtuOutput::AddIntegrationPointVariable<array_1d<double, 6>>, py::arg("array6_variable"), py::arg("entity_flags"))
        // .def("AddIntegrationPointVariable", &VtuOutput::AddIntegrationPointVariable<array_1d<double, 9>>, py::arg("array9_variable"), py::arg("entity_flags"))
