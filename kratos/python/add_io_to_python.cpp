...
//     .def("ReadProperties",pointer_to_io_read_properties)
    ...
    vtu_output
        ...
        .def("AddContainerExpression", &VtuOutput::AddContainerExpression, py::arg("container_expression_name"), py::arg("container_expression"))
        .def("AddTensorAdaptor", &VtuOutput::AddTensorAdaptor, py::arg("tensor_adaptor_name"), py::arg("tensor_adaptor"))
        .def("UpdateContainerExpression", &VtuOutput::UpdateContainerExpression, py::arg("container_expression_name"), py::arg("container_expression"))
        .def("UpdateTensorAdaptor", &VtuOutput::UpdateTensorAdaptor, py::arg("tensor_adaptor_name"), py::arg("tensor_adaptor"))
        .def("EmplaceContainerExpression", &VtuOutput::EmplaceContainerExpression, py::arg("container_expression_name"), py::arg("container_expression"))
