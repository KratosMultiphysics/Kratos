...
#if !defined(KRATOS_RESIDUAL_BASED_SENSITIVITY_BUILDER_SCHEME_H_INCLUDED)
#define KRATOS_RESIDUAL_BASED_SENSITIVITY_BUILDER_SCHEME_H_INCLUDED
...
/**
 * @brief Residual based sensitivity builder scheme
 *
 ...
 *
 * @see SensitivityBuilderScheme
 * @see SensitivityBuilder
 *
 */
class ResidualBasedSensitivityBuilderScheme : public SensitivityBuilderScheme
{
public:
    ///@name Type Definitions
    ///@{

    KRATOS_CLASS_POINTER_DEFINITION(ResidualBasedSensitivityBuilderScheme);
    ...
    /// Constructor.
    ResidualBasedSensitivityBuilderScheme()
        : mRank(ParallelEnvironment::GetDefaultDataCommunicator().Rank())
    {
        ...
        // can not call ResidualBasedSensitivityBuilderScheme::Initialize
        // method.
    ...
    /// Destructor.
    ~ResidualBasedSensitivityBuilderScheme() = default;
    ...
    {
        return "ResidualBasedSensitivityBuilderScheme";
    }
...
}; /* Class ResidualBasedSensitivityBuilderScheme */

///@}

} /* namespace Kratos.*/

#endif /* KRATOS_RESIDUAL_BASED_SENSITIVITY_BUILDER_SCHEME_H_INCLUDED defined */
