...
public:
        ...
        : BaseType()
    {
        if (Settings.Has("residual_absolute_tolerance")) {
            ...
            KRATOS_WARNING("ResidualCriteria") << "residual_absolute_tolerance or absolute_tolerance not defined on settings. Using default 1.0e-9" << std::endl;
        ...
        if (Settings.Has("residual_relative_tolerance")) {
            ...
            KRATOS_WARNING("ResidualCriteria") << "residual_relative_tolerance or relative_tolerance not defined on settings. Using default 1.0e-4" << std::endl;
