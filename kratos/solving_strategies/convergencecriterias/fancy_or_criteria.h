...
#if !defined(KRATOS_FANCY_OR_CRITERIA_H)
#define  KRATOS_FANCY_OR_CRITERIA_H
...
template<class TSparseSpace,
         class TDenseSpace
         >
class FancyOrConvergenceCriteria : public Or_Criteria< TSparseSpace, TDenseSpace >
{
public:
    ///@name Type Definitions
    ///@{

    /** Counted pointer of FancyOrConvergenceCriteria */

    KRATOS_CLASS_POINTER_DEFINITION(FancyOrConvergenceCriteria );

    typedef Or_Criteria< TSparseSpace, TDenseSpace >         BaseType;
     ...
     * Copy constructor.
     */
    FancyOrConvergenceCriteria(FancyOrConvergenceCriteria const& rOther)
      :BaseType(rOther)
     {
    ...
    /** Destructor.
    */
    ~FancyOrConvergenceCriteria () override = default;
     ...
     * @param rDofSet Reference to the container of the problem's degrees of freedom (stored by the BuilderOrSolver)
...
}; /* Class FancyOrConvergenceCriteria */
...
#endif /* KRATOS_FANCY_OR_CRITERIA_H  defined */
