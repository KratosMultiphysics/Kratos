    ...
    )
{
    ...
    rModelPart.CreateNewCondition(rConditionName, initial_condition_id + 97, {{initial_node_id + 18,  initial_node_id + 33, initial_node_id + 41}}, p_prop);
    rModelPart.CreateNewCondition(rConditionName, initial_condition_id + 98, {{initial_node_id + 53,  initial_node_id + 31, initial_node_id + 21}}, p_prop);
    rModelPart.CreateNewCondition(rConditionName, initial_condition_id + 99, {{initial_node_id + 30,  initial_node_id + 43, initial_node_id + 35}}, p_prop);
    rModelPart.CreateNewCondition(rConditionName, initial_condition_id + 100, {{initial_node_id + 16,  initial_node_id + 6, initial_node_id + 18}}, p_prop);
