...
public:
    ...
    /*
    static int CalculateTriangleDiscontinuousShapeFunctions(bounded_matrix<double,(TDim+1), TDim >& rPoints, bounded_matrix<double, (TDim+1), TDim >& DN_DX,
            array_1d<double,(TDim+1)>& rDistances, array_1d<double,(3*(TDim-1))>& rVolumes, bounded_matrix<double, 3*(TDim-1), (TDim+1) >& rGPShapeFunctionValues,
            array_1d<double,(3*(TDim-1))>& rPartitionsSign, std::vector<TMatrixType>& rGradientsValue, bounded_matrix<double,3*(TDim-1), (TDim+1)>& NEnriched, //and information about the interfase:
            ...
            *
/*
    static int CalculateTriangleDiscontinuousShapeFunctions(bounded_matrix<double,(2+1), 2 >& rPoints, bounded_matrix<double, (2+1), 2 >& DN_DX,
            array_1d<double,(2+1)>& rDistances, array_1d<double,(3*(2-1))>& rVolumes, bounded_matrix<double, 3*(2-1), (2+1) >& rGPShapeFunctionValues,
            array_1d<double,(3*(2-1))>& rPartitionsSign, std::vector<Matrix>& rGradientsValue, bounded_matrix<double,3*(2-1), (2+1)>& NEnriched, //and information about the interfase:
            array_1d<double,(3)>& face_gauss_N, array_1d<double,(3)>& face_gauss_Nenriched, double& face_Area, array_1d<double,(3)>& face_n ,unsigned int& type_of_cut)   
