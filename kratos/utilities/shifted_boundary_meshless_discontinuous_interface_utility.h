...
private:
     ...
     * node BOUNDARY : nodes that belong to the surrogate boundary (surrounding the inactive BOUNDARY elements)
     ...
     * element BOUNDARY : intersected elements (TODO: and incised elements)
     * element INTERFACE : positive distance elements owning the surrogate boundary nodes (TODO: including incised elements)
     */
