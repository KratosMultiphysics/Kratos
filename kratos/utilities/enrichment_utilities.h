...
// 	    }
    ...
    //3d: (tetrahedrons)
    static int CalculateEnrichedShapeFuncions(bounded_matrix<double,4, 3 >& rPoints,
            bounded_matrix<double, 4, 3 >& DN_DX,
            array_1d<double,4>& rDistances,
            array_1d<double,6>& rVolumes,
            bounded_matrix<double, 6, 4 >& rShapeFunctionValues,
            array_1d<double,6>& rPartitionsSign,
            std::vector<Matrix>& rGradientsValue,
            bounded_matrix<double,6, 2>& NEnriched)
    {
        KRATOS_TRY
...
// 	    }
    ...
    static int CalculateEnrichedShapeFuncionsExtended(bounded_matrix<double,(2+1), 2 >& rPoints, bounded_matrix<double, (2+1), 2 >& DN_DX,
            array_1d<double,(2+1)>& rDistances, array_1d<double,(3*(2-1))>& rVolumes, bounded_matrix<double, 3*(2-1), (2+1) >& rGPShapeFunctionValues,
            array_1d<double,(3*(2-1))>& rPartitionsSign, std::vector<Matrix>& rGradientsValue, bounded_matrix<double,3*(2-1), (4)>& NEnriched)
    {
        KRATOS_TRY
    ...
    static int CalculateEnrichedShapeFuncions(bounded_matrix<double,(2+1), 2 >& rPoints, bounded_matrix<double, (2+1), 2 >& DN_DX,
            array_1d<double,(2+1)>& rDistances, array_1d<double,(3*(2-1))>& rVolumes, bounded_matrix<double, 3*(2-1), (2+1) >& rGPShapeFunctionValues,
            array_1d<double,(3*(2-1))>& rPartitionsSign, std::vector<Matrix>& rGradientsValue, bounded_matrix<double,3*(2-1), (2)>& NEnriched,
    ...
    //2D
    static int CalculateEnrichedShapeFuncionsInLocalAxis(bounded_matrix<double,(2+1), 2 >& rOriginalPoints, bounded_matrix<double, (2+1), 2 >& DN_DX_original,
            array_1d<double,(2+1)>& rDistances, array_1d<double,(3*(2-1))>& rVolumes, bounded_matrix<double, 3*(2-1), (2+1) >& rGPShapeFunctionValues,
            array_1d<double,(3*(2-1))>& rPartitionsSign, std::vector<Matrix>& rGradientsValue, bounded_matrix<double,3*(2-1), (2)>& NEnriched, bounded_matrix<double,(2), 2 >& rRotationMatrix, bounded_matrix<double, (2+1), 2 > & DN_DX_in_local_axis)

    {
        ...
        bounded_matrix<double,(2+1), 2 > rRotatedPoints;
