...
#define  KRATOS_SPATIAL_CONTAINERS_CONDITIONS_CONFIGURE_INCLUDED
...
class SpatialContainersConditionsConfigure
{
public:
    ///@name Type Definitions
    ///@{
...
//       typedef std::vector<ContactPairType>::iterator         IteraratorContactType;
    ...
    /// Pointer definition of SpatialContainersConditionsConfigure
    KRATOS_CLASS_POINTER_DEFINITION(SpatialContainersConditionsConfigure);
    ...
    /// Default constructor.
    SpatialContainersConditionsConfigure() {}

    /// Destructor.
    virtual ~SpatialContainersConditionsConfigure() {}
...
///******************************************************************************************************************
    ...
    {
        Condition::GeometryType& geom_1 = rObj_1->GetGeometry();
        Condition::GeometryType& geom_2 = rObj_2->GetGeometry();
...
private:
    ...
    /// Assignment operator.
    SpatialContainersConditionsConfigure& operator=(SpatialContainersConditionsConfigure const& rOther);

    /// Copy constructor.
    SpatialContainersConditionsConfigure(SpatialContainersConditionsConfigure const& rOther);
...
inline std::istream& operator >> (std::istream& rIStream,
                                  SpatialContainersConditionsConfigure<TDimension> & rThis)
{
    return rIStream;
}
...
inline std::ostream& operator << (std::ostream& rOStream,
                                  const SpatialContainersConditionsConfigure<TDimension>& rThis)
{
