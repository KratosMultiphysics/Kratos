...
public:
     ...
     * @param ThisIndex The index of the mesh where remove the entity
     */
    void RemoveElementAndBelongings(const Element::Pointer& pThisElement, const Flags& IdentifierFlag = TO_ERASE, IndexType ThisIndex = 0);
     ...
     * @param ThisIndex The index of the mesh where remove the entity
     */
    void RemoveElementAndBelongingsFromAllLevels(const Element::Pointer& pThisElement, const Flags& IdentifierFlag = TO_ERASE, IndexType ThisIndex = 0);
     ...
     * @param ThisIndex The index of the mesh where remove the entity
     */
    void RemoveConditionAndBelongings(const Condition::Pointer& pThisCondition, const Flags& IdentifierFlag = TO_ERASE, IndexType ThisIndex = 0);
     ...
     * @param ThisIndex The index of the mesh where remove the entity
     */
    void RemoveConditionAndBelongingsFromAllLevels(const Condition::Pointer& pThisCondition, const Flags& IdentifierFlag = TO_ERASE, IndexType ThisIndex = 0);
