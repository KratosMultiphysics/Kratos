...
bool ModelPartOperationUtilities::HasIntersection(const std::vector<ModelPart*>& rIntersectionModelParts)
{
    ...
    std::vector<ModelPart::NodeType::Pointer> output_nodes;
    std::vector<ModelPart::ConditionType::Pointer> output_conditions;
    std::vector<ModelPart::ElementType::Pointer> output_elements;
