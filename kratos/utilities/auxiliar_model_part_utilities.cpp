...
void AuxiliarModelPartUtilities::RemoveElementAndBelongings(const Element::Pointer& pThisElement, const Flags& IdentifierFlag, IndexType ThisIndex)
{
...
void AuxiliarModelPartUtilities::RemoveElementAndBelongingsFromAllLevels(const Element::Pointer& pThisElement, const Flags& IdentifierFlag, IndexType ThisIndex)
{
...
void AuxiliarModelPartUtilities::RemoveConditionAndBelongings(const Condition::Pointer& pThisCondition, const Flags& IdentifierFlag, IndexType ThisIndex)
{
...
void AuxiliarModelPartUtilities::RemoveConditionAndBelongingsFromAllLevels(const Condition::Pointer& pThisCondition, const Flags& IdentifierFlag, IndexType ThisIndex)
{
