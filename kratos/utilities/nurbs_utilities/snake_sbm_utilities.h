...
public:
     ...
     * @param numberOfInnerLoops Number of inner loops
     * @param lambdaInner Lambda for the inner surrogate boundary
     * @param lambdaOuter Lambda for the outer surrogate boundary
    */
...
private:
     ...
     * @param knotVectorU Knot vector in the U-direction.
     * @param knotVectorV Knot vector in the V-direction.
     * @param numberOLoops Number of loops
     * @param lambdar Lambda for the surrogate boundary
