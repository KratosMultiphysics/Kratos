    ...
    */
                                              ...
                                              ) 
    {
        ...
        for (IndexType i_brep_s = 0; i_brep_s < rPairedGeometryList.size(); i_brep_s++) {
            ...
            // isConverged = ProjectionNurbsContactUtilities<TPointType, TSurfaceContainerPointType, TShiftedBoundary>::GetProjection(rpNurbsSurfaceParent, rpNurbsSurfacePaired, 
            //                                         rParentPointLocal, 
            //                                         rParentGeometry, *rPairedGeometryList[i_brep_s],
            ...
            if (isConverged) {
                ...
                // NEW
                ProjectionNurbsContactUtilities<TPointType, TSurfaceContainerPointType, TShiftedBoundary>::GetDisplacement(rpNurbsSurfacePaired, point_projected_on_slave_parameter, displacement_on_projection);
