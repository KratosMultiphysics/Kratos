...
#if !defined(KRATOS_PROJECTION_THB_GEOMETRY_UTILITIES_H_INCLUDED)
#define KRATOS_PROJECTION_THB_GEOMETRY_UTILITIES_H_INCLUDED
...
namespace Kratos
{
template<int TDimension, class TPointType> class THBSurfaceGeometry;
class ProjectionTHBGeometryUtilities
{
public:
    ...
    */
    ...
    static bool NewtonRaphsonSurface(
        ...
        CoordinatesArrayType& rProjectedPointGlobalCoordinates,
        const THBSurfaceGeometry<TDimension, TPointType>& rNurbsSurface,
        const int MaxIterations = 20,
        const double Accuracy = 1e-6)
    {
...
#endif // KRATOS_PROJECTION_THB_GEOMETRY_UTILITIES_H_INCLUDED
