...
/// Default constructor
SafeAssignUniqueModelPartCollectionTagUtility::SafeAssignUniqueModelPartCollectionTagUtility(const ModelPart& rModelPart)
...
/// Destructor
SafeAssignUniqueModelPartCollectionTagUtility::~SafeAssignUniqueModelPartCollectionTagUtility() {};

/***********************************************************************************/
/***********************************************************************************/

/// Copmutes the collections and assign the tags
void SafeAssignUniqueModelPartCollectionTagUtility::ComputeTags(
    ...
    )
{
    ...
    for (IndexType i_sub_model_part = 0; i_sub_model_part < r_model_part_names.size(); ++i_sub_model_part) {
        ...
        if (tag > 0) {
            const ModelPart& r_sub_model_part = GetRecursiveSubModelPart(mrModelPart, r_model_part_names[i_sub_model_part]);
...
void SafeAssignUniqueModelPartCollectionTagUtility::SetParallelModelPartAndSubModelPartCollectionsAndCombinations(
                                            IndexStringMapType& rCollections,
...
Parameters SafeAssignUniqueModelPartCollectionTagUtility::ReadTagsFromJson(
...
Parameters SafeAssignUniqueModelPartCollectionTagUtility::WriteTagsToJson(
    const std::string& rFilename,
...
std::vector<std::string> SafeAssignUniqueModelPartCollectionTagUtility::GetRecursiveSubModelPartNames(
...
const ModelPart& SafeAssignUniqueModelPartCollectionTagUtility::GetRecursiveSubModelPart(
    const ModelPart& rThisModelPart,
...
const ModelPart& SafeAssignUniqueModelPartCollectionTagUtility::AuxGetSubModelPart(
    const ModelPart& rThisModelPart,
...
/// Debugging purpose
void SafeAssignUniqueModelPartCollectionTagUtility::DebugAssignUniqueModelPartCollectionTag()
{
