 ...
 */
class KRATOS_API(KRATOS_CORE) ShiftedBoundaryMeshlessInterfaceUtilityCopy2
{
public:
    ...
    /// Pointer definition of ShiftedBoundaryMeshlessInterfaceUtilityCopy2
    KRATOS_CLASS_POINTER_DEFINITION(ShiftedBoundaryMeshlessInterfaceUtilityCopy2);
    ...
    ShiftedBoundaryMeshlessInterfaceUtilityCopy2(
        Model& rModel,
        Parameters ThisParameters);

    /// Copy constructor.
    ShiftedBoundaryMeshlessInterfaceUtilityCopy2(ShiftedBoundaryMeshlessInterfaceUtilityCopy2 const& rOther) = delete;
    ...
    /// Assignment operator.
    ShiftedBoundaryMeshlessInterfaceUtilityCopy2& operator=(ShiftedBoundaryMeshlessInterfaceUtilityCopy2 const& rOther) = delete;
    ...
    {
        return "ShiftedBoundaryMeshlessInterfaceUtilityCopy2";
    }

    /// Print information about this object.
    void PrintInfo(std::ostream& rOStream) const
    {
        rOStream << "ShiftedBoundaryMeshlessInterfaceUtilityCopy2";
    }
    ...
    std::unordered_map<std::size_t, std::map<std::size_t, Vector>> NodalGradientWeightsForLonelyNodes();
    ///@}
private:
    ...
    ///@}
}; // Class ShiftedBoundaryMeshlessInterfaceUtilityCopy2
