...
#define  KRATOS_BINBASED_FAST_POINT_LOCATOR_ON_CONDITIONS_INCLUDED
...
#include "utilities/spatial_containers_conditions_configure.h"
...
/**
 * @class BinBasedFastPointLocatorOnConditions
 * @ingroup KratosCore
 ...
 */
template< SizeType TDim, class ConfigureType = SpatialContainersConditionsConfigure<TDim> >
class BinBasedFastPointLocatorOnConditions
{
public:
    ///@name Type Definitions
    ...
    /// Pointer definition of BinBasedFastPointLocatorOnConditions
    KRATOS_CLASS_POINTER_DEFINITION(BinBasedFastPointLocatorOnConditions);
     ...
     */
    BinBasedFastPointLocatorOnConditions(ModelPart& rModelPart)
        : mrModelPart(rModelPart)
    {
    }

    /// Destructor.
    virtual ~BinBasedFastPointLocatorOnConditions() = default;
