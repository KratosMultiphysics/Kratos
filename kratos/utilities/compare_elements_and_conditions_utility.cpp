...
namespace Kratos
{
void CompareElementsAndConditionsUtility::GetRegisteredName(const Geometry<Node<3>>& rGeometry, std::string& rName) {
    KRATOS_TRY;
...
void CompareElementsAndConditionsUtility::GetRegisteredName(const Condition& rCondition, std::string& rName) {
    KRATOS_TRY;
