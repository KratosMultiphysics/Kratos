 ...
 */
class KRATOS_API(KRATOS_CORE) ShiftedBoundaryMeshlessInterfaceUtilityCopy
{
public:
    ...
    /// Pointer definition of ShiftedBoundaryMeshlessInterfaceUtilityCopy
    KRATOS_CLASS_POINTER_DEFINITION(ShiftedBoundaryMeshlessInterfaceUtilityCopy);
    ...
    ShiftedBoundaryMeshlessInterfaceUtilityCopy(
        Model& rModel,
        Parameters ThisParameters);

    /// Copy constructor.
    ShiftedBoundaryMeshlessInterfaceUtilityCopy(ShiftedBoundaryMeshlessInterfaceUtilityCopy const& rOther) = delete;
    ...
    /// Assignment operator.
    ShiftedBoundaryMeshlessInterfaceUtilityCopy& operator=(ShiftedBoundaryMeshlessInterfaceUtilityCopy const& rOther) = delete;
    ...
    {
        return "ShiftedBoundaryMeshlessInterfaceUtilityCopy";
    }

    /// Print information about this object.
    void PrintInfo(std::ostream& rOStream) const
    {
        rOStream << "ShiftedBoundaryMeshlessInterfaceUtilityCopy";
    }
...
private:
    ...
    ///@}
}; // Class ShiftedBoundaryMeshlessInterfaceUtilityCopy
