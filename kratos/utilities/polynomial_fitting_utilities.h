...
//                   Ricky Aristio
//
#ifndef KRATOS_POLYNOMIAL_FITTING_UTILITIES_INCLUDE_H
#define KRATOS_POLYNOMIAL_FITTING_UTILITIES_INCLUDE_H
...
#endif // KRATOS_POLYNOMIAL_FITTING_UTILITIES_INCLUDE_H