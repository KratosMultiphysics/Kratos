...
namespace Kratos
{
	namespace Testing
	{
		...
		KRATOS_TEST_CASE_IN_SUITE(ModifiedShapeFunctionsTetrahedra3D4Horizontal, KratosCoreFastSuite)
		{
            ...
            KRATOS_CHECK_NEAR(positive_side_sh_func_gradients[0](0,3),  1.0, tolerance);
            ...
            KRATOS_CHECK_NEAR(positive_side_sh_func_gradients[0](1,3),  0.0, tolerance);
            ...
            KRATOS_CHECK_NEAR(positive_side_sh_func_gradients[0](2,3),  0.0, tolerance);
            ...
            KRATOS_CHECK_NEAR(negative_side_sh_func_gradients[0](0,3),  1.0, tolerance);
            ...
            KRATOS_CHECK_NEAR(negative_side_sh_func_gradients[0](1,3),  0.0, tolerance);
            ...
            KRATOS_CHECK_NEAR(negative_side_sh_func_gradients[0](2,3),  0.0, tolerance);
            ...
            KRATOS_CHECK_NEAR(negative_side_sh_func_gradients[1](0,3),  1.0, tolerance);
            ...
            KRATOS_CHECK_NEAR(negative_side_sh_func_gradients[1](1,3),  0.0, tolerance);
            ...
            KRATOS_CHECK_NEAR(negative_side_sh_func_gradients[1](2,3),  0.0, tolerance);
            ...
            KRATOS_CHECK_NEAR(negative_side_sh_func_gradients[2](0,3),  1.0, tolerance);
            ...
            KRATOS_CHECK_NEAR(negative_side_sh_func_gradients[2](1,3),  0.0, tolerance);
            ...
            KRATOS_CHECK_NEAR(negative_side_sh_func_gradients[2](2,3),  0.0, tolerance);
            ...
            KRATOS_CHECK_NEAR(positive_interface_side_sh_func_gradients[0](0,3),  1.0, tolerance);
            ...
            KRATOS_CHECK_NEAR(positive_interface_side_sh_func_gradients[0](1,3),  0.0, tolerance);
            ...
            KRATOS_CHECK_NEAR(positive_interface_side_sh_func_gradients[0](2,3),  0.0, tolerance);
            ...
            KRATOS_CHECK_NEAR(negative_interface_side_sh_func_gradients[0](0,3),  1.0, tolerance);
            ...
            KRATOS_CHECK_NEAR(negative_interface_side_sh_func_gradients[0](1,3),  0.0, tolerance);
            ...
            KRATOS_CHECK_NEAR(negative_interface_side_sh_func_gradients[0](2,3),  0.0, tolerance);
		...
		KRATOS_TEST_CASE_IN_SUITE(ModifiedShapeFunctionsTetrahedra3D4Oblique, KratosCoreFastSuite)
		{
            ...
            KRATOS_CHECK_NEAR(positive_side_sh_func_gradients[1](0,3),  1.0, tolerance);
            ...
            KRATOS_CHECK_NEAR(positive_side_sh_func_gradients[1](1,3),  0.0, tolerance);
            ...
            KRATOS_CHECK_NEAR(positive_side_sh_func_gradients[1](2,3),  0.0, tolerance);
            ...
            KRATOS_CHECK_NEAR(positive_side_sh_func_gradients[2](0,3),  1.0, tolerance);
            ...
            KRATOS_CHECK_NEAR(positive_side_sh_func_gradients[2](1,3),  0.0, tolerance);
            ...
            KRATOS_CHECK_NEAR(positive_side_sh_func_gradients[2](2,3),  0.0, tolerance);
            ...
            // Check interface Gauss pts. weights
			KRATOS_CHECK_NEAR(positive_interface_side_weights(0), 0.176777, 1e-5);
			KRATOS_CHECK_NEAR(positive_interface_side_weights(1), 0.176777, 1e-5);
			KRATOS_CHECK_NEAR(negative_interface_side_weights(0), 0.176777, 1e-5);
			KRATOS_CHECK_NEAR(negative_interface_side_weights(1), 0.176777, 1e-5);
            ...
            KRATOS_CHECK_NEAR(positive_interface_side_sh_func_gradients[1](0,3),  1.0, tolerance);
            ...
            KRATOS_CHECK_NEAR(positive_interface_side_sh_func_gradients[1](1,3),  0.0, tolerance);
            ...
            KRATOS_CHECK_NEAR(positive_interface_side_sh_func_gradients[1](2,3),  0.0, tolerance);
            ...
            KRATOS_CHECK_NEAR(negative_interface_side_sh_func_gradients[1](0,3),  1.0, tolerance);
            ...
            KRATOS_CHECK_NEAR(negative_interface_side_sh_func_gradients[1](1,3),  0.0, tolerance);
            ...
            KRATOS_CHECK_NEAR(negative_interface_side_sh_func_gradients[1](2,3),  0.0, tolerance);

			// Check Gauss pts. outwards unit normal values
			KRATOS_CHECK_NEAR(positive_side_unit_normals[0](0), -0.707107, 1e-5);
			KRATOS_CHECK_NEAR(positive_side_unit_normals[0](1),       0.0, 1e-5);
			KRATOS_CHECK_NEAR(positive_side_unit_normals[0](2), -0.707107, 1e-5);
			KRATOS_CHECK_NEAR(positive_side_unit_normals[1](0), -0.707107, 1e-5);
			KRATOS_CHECK_NEAR(positive_side_unit_normals[1](1),       0.0, 1e-5);
            KRATOS_CHECK_NEAR(positive_side_unit_normals[1](2), -0.707107, 1e-5);
            
			KRATOS_CHECK_NEAR(negative_side_unit_normals[0](0),  0.707107, 1e-5);
			KRATOS_CHECK_NEAR(negative_side_unit_normals[0](1),       0.0, 1e-5);
			KRATOS_CHECK_NEAR(negative_side_unit_normals[0](2),  0.707107, 1e-5);
			KRATOS_CHECK_NEAR(negative_side_unit_normals[1](0),  0.707107, 1e-5);
			KRATOS_CHECK_NEAR(negative_side_unit_normals[1](1),       0.0, 1e-5);
			KRATOS_CHECK_NEAR(negative_side_unit_normals[1](2),  0.707107, 1e-5);
		}
