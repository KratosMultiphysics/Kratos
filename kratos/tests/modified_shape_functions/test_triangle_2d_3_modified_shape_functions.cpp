...
namespace Kratos
{
	namespace Testing
	{
		...
		KRATOS_TEST_CASE_IN_SUITE(ModifiedShapeFunctionsTriangle2D3Horizontal, KratosCoreFastSuite)
		{
			...
			KRATOS_CHECK_NEAR(pos_ext_face_sh_func_1(0,1), 0.25, tolerance);
			...
			KRATOS_CHECK_NEAR(neg_ext_face_sh_func_1(0,1), 0.75, tolerance);
			...
			KRATOS_CHECK_NEAR(pos_ext_face_sh_func_2(0,2), 0.75, tolerance);
			...
			KRATOS_CHECK_NEAR(neg_ext_face_sh_func_2(0,2), 0.25, tolerance);
		...
		KRATOS_TEST_CASE_IN_SUITE(ModifiedShapeFunctionsTriangle2D3Vertical, KratosCoreFastSuite)
		{
			...
			// Check face 0 values
			KRATOS_CHECK_NEAR(pos_ext_face_sh_func_0(0,0), 0.25, tolerance);
			...
			KRATOS_CHECK_NEAR(neg_ext_face_sh_func_0(0,0), 0.75, tolerance);
			...
			// Check face 1 values
			KRATOS_CHECK_NEAR(pos_ext_face_sh_func_1(0,0),  0.0, tolerance);
			KRATOS_CHECK_NEAR(pos_ext_face_sh_func_1(0,1), 0.75, tolerance);
			KRATOS_CHECK_NEAR(pos_ext_face_sh_func_1(0,2), 0.25, tolerance);
			KRATOS_CHECK_NEAR(pos_ext_face_sh_func_gradients_1[0](0,0), -1.0, tolerance);
			KRATOS_CHECK_NEAR(pos_ext_face_sh_func_gradients_1[0](0,1), -1.0, tolerance);
			KRATOS_CHECK_NEAR(pos_ext_face_sh_func_gradients_1[0](1,0),  1.0, tolerance);
			KRATOS_CHECK_NEAR(pos_ext_face_sh_func_gradients_1[0](1,1),  0.0, tolerance);
			...
			KRATOS_CHECK_NEAR(neg_ext_face_sh_func_1(0,0),  0.0, tolerance);
			KRATOS_CHECK_NEAR(neg_ext_face_sh_func_1(0,1), 0.25, tolerance);
			KRATOS_CHECK_NEAR(neg_ext_face_sh_func_1(0,2), 0.75, tolerance);
			KRATOS_CHECK_NEAR(neg_ext_face_sh_func_gradients_1[0](0,0), -1.0, tolerance);
			KRATOS_CHECK_NEAR(neg_ext_face_sh_func_gradients_1[0](0,1), -1.0, tolerance);
			KRATOS_CHECK_NEAR(neg_ext_face_sh_func_gradients_1[0](1,0),  1.0, tolerance);
			KRATOS_CHECK_NEAR(neg_ext_face_sh_func_gradients_1[0](1,1),  0.0, tolerance);
