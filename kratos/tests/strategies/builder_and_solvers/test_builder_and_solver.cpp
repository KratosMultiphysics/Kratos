...
namespace Kratos 
{
    namespace Testing 
    {
         ...
         */
        KRATOS_TEST_CASE_IN_SUITE(DisplacementBlockBuilderAndSolver, KratosCoreFastSuite)
        {
...
//             DebugLHS(rA);
         ...
         */
        KRATOS_TEST_CASE_IN_SUITE(DisplacementBlockBuilderAndSolverWithConstraints, KratosCoreFastSuite)
        {
            if (!KratosComponents<Element>::Has("TrussElement3D2N")) {
                std::cout << "Please compile the StructuralMechanicsApplication in order to run this test" << std::endl;
                return void();
...
//             DebugLHS(rA);
         ...
         */
        KRATOS_TEST_CASE_IN_SUITE(DisplacementEliminationBuilderAndSolver, KratosCoreFastSuite)
        {
            if (!KratosComponents<Element>::Has("TrussElement3D2N")) {
                std::cout << "Please compile the StructuralMechanicsApplication in order to run this test" << std::endl;
                return void();
...
//             DebugLHS(rA);
            ...
            // The solution check
            constexpr double tolerance = 1e-4;
            KRATOS_CHECK(rA.size1() == 21);
            KRATOS_CHECK(rA.size2() == 21);
            ...
            KRATOS_CHECK_LESS_EQUAL(std::abs((rA(2,7) - -5.1725e+08)/rA(2,7)), tolerance);
            ...
            KRATOS_CHECK_LESS_EQUAL(std::abs((rA(4,7) - -3.97272e+08)/rA(4,7)), tolerance);
            KRATOS_CHECK_LESS_EQUAL(std::abs((rA(4,9) - -6.89667e+08)/rA(4,9)), tolerance);
            KRATOS_CHECK_LESS_EQUAL(std::abs((rA(4,11) - -1.85057e+08)/rA(4,11)), tolerance);
            KRATOS_CHECK_LESS_EQUAL(std::abs((rA(7,2) - -5.1725e+08)/rA(7,2)), tolerance);
            KRATOS_CHECK_LESS_EQUAL(std::abs((rA(7,4) - -3.97272e+08)/rA(7,4)), tolerance);
            KRATOS_CHECK_LESS_EQUAL(std::abs((rA(7,7) - 9.14522e+08)/rA(7,7)), tolerance);
            KRATOS_CHECK_LESS_EQUAL(std::abs((rA(9,4) - -6.89667e+08)/rA(9,4)), tolerance);
            KRATOS_CHECK_LESS_EQUAL(std::abs((rA(9,9) - 1.05542e+09)/rA(9,9)), tolerance);
            KRATOS_CHECK_LESS_EQUAL(std::abs((rA(9,11) - -3.65751e+08)/rA(9,11)), tolerance);
            KRATOS_CHECK_LESS_EQUAL(std::abs((rA(11,4) - -1.85057e+08)/rA(11,4)), tolerance);
            KRATOS_CHECK_LESS_EQUAL(std::abs((rA(11,9) - -3.65751e+08)/rA(11,9)), tolerance);
            KRATOS_CHECK_LESS_EQUAL(std::abs((rA(11,11) - 1.77036e+09)/rA(11,11)), tolerance);
            KRATOS_CHECK_LESS_EQUAL(std::abs((rA(11,13) - -1.0345e+09)/rA(11,13)), tolerance);
            KRATOS_CHECK_LESS_EQUAL(std::abs((rA(11,15) - -1.85057e+08)/rA(11,15)), tolerance);
            KRATOS_CHECK_LESS_EQUAL(std::abs((rA(13,11) - -1.0345e+09)/rA(13,11)), tolerance);
            KRATOS_CHECK_LESS_EQUAL(std::abs((rA(13,13) - 1.21956e+09)/rA(13,13)), tolerance);
            KRATOS_CHECK_LESS_EQUAL(std::abs((rA(13,15) - -1.85057e+08)/rA(13,15)), tolerance);
            KRATOS_CHECK_LESS_EQUAL(std::abs((rA(15,11) - -1.85057e+08)/rA(15,11)), tolerance);
            KRATOS_CHECK_LESS_EQUAL(std::abs((rA(15,13) - -1.85057e+08)/rA(15,13)), tolerance);
            KRATOS_CHECK_LESS_EQUAL(std::abs((rA(15,15) - 2.62417e+09)/rA(15,15)), tolerance);
            KRATOS_CHECK_LESS_EQUAL(std::abs((rA(15,17) - -2.069e+09)/rA(15,17)), tolerance);
            KRATOS_CHECK_LESS_EQUAL(std::abs((rA(15,19) - -1.85057e+08)/rA(15,19)), tolerance);
            KRATOS_CHECK_LESS_EQUAL(std::abs((rA(17,15) - -2.069e+09)/rA(17,15)), tolerance);
            KRATOS_CHECK_LESS_EQUAL(std::abs((rA(17,17) - 2.069e+09)/rA(17,17)), tolerance);
            KRATOS_CHECK_LESS_EQUAL(std::abs((rA(19,15) - -1.85057e+08)/rA(19,15)), tolerance);
            KRATOS_CHECK_LESS_EQUAL(std::abs((rA(19,19) - 1.85057e+08)/rA(19,19)), tolerance);
        }
