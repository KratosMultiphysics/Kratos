...
class TestRestart(KratosUnittest.TestCase):
    ...
    def __execute_restart_save(self, file_name, serializer_flag):
        ...
        model_part = ReadModelPart(GetFilePath("auxiliar_files/mdpa_files/test_model_part_io_read"), temporary_model)
    ...
    def test_save_restart_process(self):
        ...
        model_part = ReadModelPart(GetFilePath("auxiliar_files/mdpa_files/test_model_part_io_read"), model)
