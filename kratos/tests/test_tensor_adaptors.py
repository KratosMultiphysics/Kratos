...
class TensorAdaptors(KratosUnittest.TestCase):
    ...
    def test_CombinedTensorAdaptorAxis1(self):
        ...
        copy_combined_ta = Kratos.TensorAdaptors.DoubleCombinedTensorAdaptor(combined_ta, collect_and_store_recursively=False)
    ...
    def test_CombinedTensorAdaptorRavel(self):
        ...
        combined_ta = Kratos.TensorAdaptors.DoubleCombinedTensorAdaptor([u_nodes_ta, u_elems_ta], ravel=True)
        combined_ta.Check()
        combined_ta.CollectData()
