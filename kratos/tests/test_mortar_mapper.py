...
class TestMortarMapperCore(KratosUnittest.TestCase):
    ...
    def test_less_basic_mortar_mapping_triangle_pure_implicit(self):
        input_filename = os.path.dirname(os.path.realpath(__file__)) + "/auxiliary_files_for_python_unittest/mortar_mapper_python_tests/test_integration_several_triangles"
    ...
    def test_simple_curvature_mortar_mapping_triangle(self):
        input_filename = os.path.dirname(os.path.realpath(__file__)) + "/auxiliary_files_for_python_unittest/mortar_mapper_python_tests/test_simple_curvature"
        self._mapper_tests(input_filename, 3, 3, False, False, False, True, True, False)
        self._mapper_tests(input_filename, 3, 3, False, False, False, True, True, True)

    def test_mortar_mapping_triangle(self):
        input_filename = os.path.dirname(os.path.realpath(__file__)) + "/auxiliary_files_for_python_unittest/mortar_mapper_python_tests/test_double_curvature_integration_triangle"
        self._mapper_tests(input_filename, 3, 3, False, False, False, True, True, False)
        self._mapper_tests(input_filename, 3, 3, False, False, False, True, True, True)

    def test_mortar_mapping_triangle_discontinous_interface(self):
        input_filename = os.path.dirname(os.path.realpath(__file__)) + "/auxiliary_files_for_python_unittest/mortar_mapper_python_tests/test_double_curvature_integration_triangle_discontinous_interface"
    ...
    def test_mortar_mapping_quad(self):
        input_filename = os.path.dirname(os.path.realpath(__file__)) + "/auxiliary_files_for_python_unittest/mortar_mapper_python_tests/test_double_curvature_integration_quadrilateral"
    ...
    def test_mortar_mapping_quad_tri(self):
        input_filename = os.path.dirname(os.path.realpath(__file__)) + "/auxiliary_files_for_python_unittest/mortar_mapper_python_tests/test_double_curvature_integration_triangle_quadrilateral"
