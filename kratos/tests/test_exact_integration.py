...
class TestExactIntegration(KratosUnittest.TestCase):
    ...
    def test_line_exact_integration_1(self):
        ...
        self.assertAlmostEqual(matrix_solution[0,0], 0)
        self.assertAlmostEqual(matrix_solution[0,1], 2)
    ...
    def test_line_exact_integration_2(self):
        ...
        self.assertTrue(solution)
        self.assertAlmostEqual(matrix_solution[0,0], 0.5)
        self.assertAlmostEqual(matrix_solution[0,1], 1)
    ...
    def test_line_exact_integration_3(self):
        ...
        self.assertTrue(solution)
        self.assertAlmostEqual(matrix_solution[0,0], 0.5)
        self.assertAlmostEqual(matrix_solution[0,1], 2.0/(2.0**0.5))
