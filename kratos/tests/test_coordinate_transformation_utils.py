...
class TestCoordinateTransformationUtilitiesCoarseSphere(KratosUnittest.TestCase):
    @classmethod
    def setUpClass(cls):
        SetupModelPart(cls, "auxiliary_files_for_python_unittest/mdpa_files/coarse_sphere_with_conditions", 3)
...
class TestCoordinateTransformationUtilities2DSymmetricalSquare(KratosUnittest.TestCase):
    @classmethod
    def setUpClass(cls):
        SetupModelPart(cls, "auxiliary_files_for_python_unittest/mdpa_files/two_dim_symmetrical_square", 2)
