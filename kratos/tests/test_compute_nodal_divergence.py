...
class TestNodalDivergence(KratosUnittest.TestCase):
    ...
    def test_nodal_normal_divergence_2d_square(self):
        ...
        KratosMultiphysics.ModelPartIO(GetFilePath("auxiliary_files_for_python_unittest/mdpa_files/two_dim_symmetrical_square")).ReadModelPart(model_part)
    ...
    def test_nodal_normal_divergence_3d_cube(self):
        ...
        KratosMultiphysics.ModelPartIO(GetFilePath("auxiliary_files_for_python_unittest/mdpa_files/three_dim_symmetrical_cube")).ReadModelPart(model_part)
