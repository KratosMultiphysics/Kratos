...
class TimeAveragingProcessTests(UnitTest.TestCase):
    def testTimeAveragingNodalHistoricalProcess(self):
        self.__CreateModel()
    ...
    def testTimeAveragingNodalNonHistoricalProcess(self):
        self.__CreateModel()
    ...
    def testTimeAveragingElementalNonHistoricalProcess(self):
        self.__CreateModel()
