...
class TestInitialTime(KratosUnittest.TestCase):
    ...
    def testInitialTime(self):
        ...
        parameters_name = GetFilePath("auxiliary_files_for_python_unittest/parameters_files/test_initial_time.json")
    ...
    def _SetModelPartName(parameters, model_part_name):
        ...
        materials_pattern = "auxiliary_files_for_python_unittest/materials_files/initial_time_{}.json"
