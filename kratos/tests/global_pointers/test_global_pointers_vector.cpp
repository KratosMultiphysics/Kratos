...
#include "containers/global_pointers_container.h"
...
KRATOS_TEST_CASE_IN_SUITE(GlobalPointersContainerTest, KratosCoreFastSuite)
{
    ...
    GlobalPointersContainer<Node<3>> global_pointers_container;
    ...
    GlobalPointersContainer<Node<3>> new_global_pointers;
