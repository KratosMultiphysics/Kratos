...
class TestVtuOutputBase:
    ...
    def WriteVtu(self, output_format: Kratos.VtuOutput.WriterFormat, error_check = False):
        vtu_output = Kratos.VtuOutput(self.model_part, True, output_format, 9, echo_level=0, output_sub_model_parts=self.output_sub_model_parts, write_ids=True)
