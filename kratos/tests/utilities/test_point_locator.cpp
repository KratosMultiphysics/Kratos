...
namespace Kratos {
    namespace Testing {
        ...
        KRATOS_TEST_CASE_IN_SUITE(PointLocatorTriangleElement, KratosCoreFastSuite)
        {
        ...
        KRATOS_TEST_CASE_IN_SUITE(PointLocatorQuadrilateralElement, KratosCoreFastSuite)
        {
        ...
        KRATOS_TEST_CASE_IN_SUITE(PointLocatorTetrahedraElement, KratosCoreFastSuite)
        {
        ...
        KRATOS_TEST_CASE_IN_SUITE(PointLocatorHexahedraElement, KratosCoreFastSuite)
        {
        ...
        KRATOS_TEST_CASE_IN_SUITE(PointLocatorNode, KratosCoreFastSuite)
        {
        ...
        KRATOS_TEST_CASE_IN_SUITE(PointLocatorQuadrilateralCondition, KratosCoreFastSuite)
        {
			ModelPart model_part("Quadrilateral");
            model_part.GetProcessInfo().SetValue(DOMAIN_SIZE, 3);
