...
class TestSparseMatrixSum(KratosUnittest.TestCase):
    ...
    def __sparse_matrix_sum(self, file_name = "auxiliar_files_for_python_unnitest/sparse_matrix_files/A.mm"):
    ...
    def test_sparse_matrix_sum_small(self):
        self.__sparse_matrix_sum("auxiliar_files_for_python_unnitest/sparse_matrix_files/small_A.mm")
...
class TestSparseMatrixTranspose(KratosUnittest.TestCase):
    ...
    def __sparse_matrix_transpose(self, file_name = "auxiliar_files_for_python_unnitest/sparse_matrix_files/A.mm"):
        try:
            from scipy import sparse, io
            import numpy as np
            missing_scipy = False
    ...
    def test_sparse_matrix_transpose_small(self):
        self.__sparse_matrix_transpose("auxiliar_files_for_python_unnitest/sparse_matrix_files/small_A.mm")
...
class TestSparseMatrixMultiplication(KratosUnittest.TestCase):
    ...
    def __sparse_matrix_multiplication(self, problem = "saad", file_name = "auxiliar_files_for_python_unnitest/sparse_matrix_files/A.mm"):
        try:
            from scipy import sparse, io
            import numpy as np
            missing_scipy = False
    ...
    def test_sparse_matrix_multiplication_saad_small(self):
        self.__sparse_matrix_multiplication("saad", "auxiliar_files_for_python_unnitest/sparse_matrix_files/small_A.mm")

    def test_sparse_matrix_multiplication_rmerge_small(self):
        self.__sparse_matrix_multiplication("rmerge", "auxiliar_files_for_python_unnitest/sparse_matrix_files/small_A.mm")
