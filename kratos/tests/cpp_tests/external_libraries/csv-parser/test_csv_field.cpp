...
KRATOS_TEST_CASE_IN_SUITE(CSVFieldgetIntegerBoundaryValue, KratosExternalLibrariesFastSuite)
{
    ...
    // Microsoft/GCC/clang
    KRATOS_CHECK_EQUAL(CSVField("127").get<signed char>(), 127);
    KRATOS_CHECK_EQUAL(CSVField("32767").get<short>(), 32767);
    KRATOS_CHECK_EQUAL(CSVField("2147483647").get<int>(), 2147483647);

    KRATOS_CHECK_EQUAL(CSVField("255").get<unsigned char>(), 255);
    KRATOS_CHECK_EQUAL(CSVField("65535").get<unsigned short>(), 65535);
    KRATOS_CHECK_EQUAL(CSVField("4294967295").get<unsigned>(), 4294967295);
}
