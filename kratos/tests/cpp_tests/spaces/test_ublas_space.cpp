...
TEST(UblasSpaceNormSparseMatrix, KratosCoreFastSuite)
{
...
TEST(UblasSpaceNormDenseMatrix, KratosCoreFastSuite)
{
...
TEST(CheckAndCorrectZeroDiagonalValues, KratosCoreFastSuite)
{
...
TEST(GetScaleNorm, KratosCoreFastSuite)
{
    /// The sparse matrix type
    typedef UblasSpace<double, CompressedMatrix, Vector> SparseSpaceType;
    typedef typename SparseSpaceType::MatrixType SparseMatrixType;
