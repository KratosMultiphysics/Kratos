...
namespace Kratos
{
    namespace Testing
    {
        ...
        */
        TEST_F(KernelTest, AssignUniqueModelPartCollectionTagUtility)
        {
...
//             KRATOS_WATCH(first_model_part)
        ...
        */
        TEST_F(KernelTest, AssignUniqueModelPartCollectionTagUtilityWithSubLevels)
        {
        ...
        */
        TEST_F(KernelTest, GetRecursiveSubModelPart)
        {
            // Creating the reference model part and the relative submodelparts
            Model current_model;
        ...
        * Checks the correct work of the model parts collections utility static methods
        */
        TEST_F(KernelTest, ReadTagsFromJsonWriteTagsToJson)
        {
            // Creating the reference model part and the relative submodelparts
            Model current_model;
            ModelPart& r_model_part = current_model.CreateModelPart("Main");
