...
namespace Kratos
{
	namespace Testing
	{
		...
		TEST_F(KernelTest, DivideGeometryTriangle2D3Horizontal)
		{
			Model current_model;
		...
		TEST_F(KernelTest, DivideGeometryTriangle2D3Vertical)
		{
			Model current_model;
		...
		TEST_F(KernelTest, DivideGeometryTriangle2D3NoDivision)
		{
			Model current_model;
