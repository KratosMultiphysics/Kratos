...
TEST(GenericFunctionUtility1, KratosCoreFastSuite)
{
...
TEST(GenericFunctionUtility2, KratosCoreFastSuite)
{
...
TEST(FunctionParser, KratosCoreFastSuite)
{
...
TEST(FunctionParserHexNumbers, KratosCoreFastSuite)
{
