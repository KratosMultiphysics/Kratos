...
TEST_F(KernelTest, IsSame_Element_Element)
{
...
TEST_F(KernelTest, IsSame_Condition_Condition)
{
...
TEST_F(KernelTest, GetRegisteredNameElement)
{
    // Element name
    const Element& r_element_2d_3n = KratosComponents<Element>::Get("Element2D3N");
...
TEST_F(KernelTest, GetRegisteredNameCondition)
{
    // Condition name
    const Condition& r_condition_2d_3n = KratosComponents<Condition>::Get("LineCondition2D3N");
    std::string component_name;
