...
namespace Kratos
{
    namespace Testing
    {
        ...
        KRATOS_TEST_CASE_IN_SUITE(Hexahedra3D27MinimumElementSizeDerivatives, KratosCoreFastSuite)
        {
            ...
            nodes.push_back(NodeType::Pointer(new NodeType(13, 0.05, 0.05, 0.25)));
            ...
            nodes.push_back(NodeType::Pointer(new NodeType(18, 0.7, 0.45, 0.35)));
            nodes.push_back(NodeType::Pointer(new NodeType(19, 0.4, 0.8, 0.45)));
            nodes.push_back(NodeType::Pointer(new NodeType(20, 0.1, 0.45, 0.55)));
            nodes.push_back(NodeType::Pointer(new NodeType(21, 0.5, 0.55, 0.0)));
            nodes.push_back(NodeType::Pointer(new NodeType(22, 0.45, 0.05, 0.225)));
            nodes.push_back(NodeType::Pointer(new NodeType(23, 0.85, 0.5, 0.175)));
            nodes.push_back(NodeType::Pointer(new NodeType(24, 0.45, 0.95, 0.225)));
            nodes.push_back(NodeType::Pointer(new NodeType(25, 0.05, 0.5, 0.275)));
            nodes.push_back(NodeType::Pointer(new NodeType(26, 0.4, 0.45, 0.45)));
            nodes.push_back(NodeType::Pointer(new NodeType(27, 0.45, 0.5, 0.225)));
