...
namespace Kratos
{
    namespace Testing
    {
         ...
         * Checks if it calculates the SVD of a matrix 2x2
         */
        TEST(SVDUtilsjacobiSVD2x2Test, KratosCoreFastSuite)
        {
         ...
         * Checks if it calculates the SVD of a matrix 3x3
         */
        TEST(SVDUtilsJacobiSVD3x3Test, KratosCoreFastSuite)
        {
         ...
         * Checks if it calculates the condition number of a matrix
         */
        TEST(SVDUtilsConditionNumberTest, KratosCoreFastSuite)
        {
            constexpr double tolerance = 1e-4;
