...
namespace Testing {
    ...
    TEST(GeometryUtilsPointDistanceToTriangleOutOfPlane, KratosCoreFastSuite)
    {
    ...
    TEST(GeometryUtilsPointDistanceToTriangleInPlane, KratosCoreFastSuite)
    {
        // Triangle plane points
        Point triangle_point_1( 1.0,-1.0, 0.0);
        Point triangle_point_2( 1.0, 1.0, 0.0);
    ...
    TEST(GeometryUtilsCalculateGeometryDataTriangle, KratosCoreFastSuite)
    {
    ...
    TEST(GeometryUtilsCalculateGeometryDataTetrahedra, KratosCoreFastSuite)
    {
    ...
    TEST(GeometryUtilsCalculateGeometryDataLine, KratosCoreFastSuite)
    {
    ...
    TEST(GeometryUtilsSideLenghts2D, KratosCoreFastSuite)
    {
        Triangle2D3 <NodeType> triangle = GenerateExampleTriangle();
    ...
    TEST(GeometryUtilsCalculateTriangleDistances, KratosCoreFastSuite)
    {
...
//     TEST(GeometryUtilsCalculateTetrahedraIntersectionPoints, KratosCoreFastSuite)
//     {
//         Tetrahedra3D4 <NodeType> tetrahedra = GenerateExampleTetrahedra()
//         // Computing the info
...
//     }
    ...
    TEST(GeometryUtilsSeveralUtilities, KratosCoreFastSuite)
    {
        Triangle2D3 <NodeType> triangle = GenerateExampleTriangle();
    ...
    TEST(EvaluateHistoricalVariableValueAtGaussPointDouble, KratosCoreFastSuite)
    {
    ...
    TEST(EvaluateHistoricalVariableValueAtGaussPointArray, KratosCoreFastSuite)
    {
        VariablesList::Pointer current_variable_list = Kratos::make_intrusive<VariablesList>();
    ...
    TEST(EvaluateHistoricalVariableGradientAtGaussPointDouble, KratosCoreFastSuite)
    {
        VariablesList::Pointer current_variable_list = Kratos::make_intrusive<VariablesList>();
        current_variable_list->Add(PRESSURE);
    ...
    TEST(EvaluateHistoricalVariableGradientAtGaussPointArray, KratosCoreFastSuite)
    {
        VariablesList::Pointer current_variable_list = Kratos::make_intrusive<VariablesList>();
        current_variable_list->Add(VELOCITY);
    ...
    TEST(ProjectedIsInside, KratosCoreFastSuite)
    {
