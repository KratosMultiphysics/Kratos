...
namespace Kratos
{
	namespace Testing
	{
		...
		TEST_F(KernelTest, DivideGeometryTetrahedra3D4Horizontal)
		{
			Model current_model;
		...
		TEST_F(KernelTest, DivideGeometryTetrahedra3D4Oblique)
		{
			Model current_model;
		...
		TEST_F(KernelTest, DivideGeometryTetrahedra3D4NoDivision)
		{
			Model current_model;
		...
		TEST_F(KernelTest, DivideGeometryTetrahedra3D4ConformantFaces)
		{
			Model current_model;
