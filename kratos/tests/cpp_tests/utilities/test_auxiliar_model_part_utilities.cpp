...
TEST_F(KernelTest, AuxiliarModelPartUtilities_RemoveNodesFromSubModePartsWithoutCorrespondingEntities)
{
    Model current_model;
...
TEST_F(KernelTest, AuxiliarModelPartUtilities_CopySubModelPartStructure)
{
    Model current_model;
...
TEST_F(KernelTest, AuxiliarModelPartUtilities_DeepCopyModelPart)
{
    Model current_model;
...
TEST_F(KernelTest, AuxiliarModelPartUtilities_GetScalarData_Node_historical)
{
    Model current_model;
    ModelPart& this_model_part = current_model.CreateModelPart("Main");
    Initialize(this_model_part);
...
TEST_F(KernelTest, AuxiliarModelPartUtilities_GetScalarData_Node_historical_ublas_vector)
{
    Model current_model;
    ModelPart& this_model_part = current_model.CreateModelPart("Main");
    Initialize(this_model_part);
...
TEST_F(KernelTest, AuxiliarModelPartUtilities_GetScalarData_Node_Nonhistorical)
{
    Model current_model;
    ModelPart& this_model_part = current_model.CreateModelPart("Main");
    Initialize(this_model_part);
...
TEST_F(KernelTest, AuxiliarModelPartUtilities_GetScalarData_Element)
{
    Model current_model;
    ModelPart& this_model_part = current_model.CreateModelPart("Main");
    Initialize(this_model_part);
...
TEST_F(KernelTest, AuxiliarModelPartUtilities_GetScalarData_Condition)
{
    Model current_model;
    ModelPart& this_model_part = current_model.CreateModelPart("Main");
    Initialize(this_model_part);
...
TEST_F(KernelTest, AuxiliarModelPartUtilities_GetScalarData_ModelPart)
{
    Model current_model;
    ModelPart& this_model_part = current_model.CreateModelPart("Main");
    Initialize(this_model_part);
...
TEST_F(KernelTest, AuxiliarModelPartUtilities_GetScalarData_ProcessInfo)
{
    Model current_model;
    ModelPart& this_model_part = current_model.CreateModelPart("Main");
    Initialize(this_model_part);
...
TEST_F(KernelTest, AuxiliarModelPartUtilities_GetVectorData_Node_historical)
{
    Model current_model;
    ModelPart& this_model_part = current_model.CreateModelPart("Main");
    Initialize(this_model_part);
...
TEST_F(KernelTest, AuxiliarModelPartUtilities_GetVectorData_Node_historical_ublas_vector)
{
    Model current_model;
    ModelPart& this_model_part = current_model.CreateModelPart("Main");
    Initialize(this_model_part);
...
TEST_F(KernelTest, AuxiliarModelPartUtilities_GetVectorData_Node_Nonhistorical)
{
    Model current_model;
    ModelPart& this_model_part = current_model.CreateModelPart("Main");
    Initialize(this_model_part);
...
TEST_F(KernelTest, AuxiliarModelPartUtilities_GetVectorData_Element)
{
    Model current_model;
    ModelPart& this_model_part = current_model.CreateModelPart("Main");
    Initialize(this_model_part);
...
TEST_F(KernelTest, AuxiliarModelPartUtilities_GetVectorData_Condition)
{
    Model current_model;
    ModelPart& this_model_part = current_model.CreateModelPart("Main");
    Initialize(this_model_part);
...
TEST_F(KernelTest, AuxiliarModelPartUtilities_GetVectorData_ModelPart)
{
    Model current_model;
    ModelPart& this_model_part = current_model.CreateModelPart("Main");
    Initialize(this_model_part);
...
TEST_F(KernelTest, AuxiliarModelPartUtilities_GetVectorData_ProcessInfo)
{
    Model current_model;
    ModelPart& this_model_part = current_model.CreateModelPart("Main");
    Initialize(this_model_part);
...
TEST_F(KernelTest, AuxiliarModelPartUtilities_SetScalarData_Node_historical)
{
    Model current_model;
    ModelPart& this_model_part = current_model.CreateModelPart("Main");
    Initialize(this_model_part);
...
TEST_F(KernelTest, AuxiliarModelPartUtilities_SetScalarData_Node_historical_ublas_vector)
{
    Model current_model;
    ModelPart& this_model_part = current_model.CreateModelPart("Main");
    Initialize(this_model_part);
...
TEST_F(KernelTest, AuxiliarModelPartUtilities_SetScalarData_Node_Nonhistorical)
{
    Model current_model;
    ModelPart& this_model_part = current_model.CreateModelPart("Main");
    Initialize(this_model_part);
...
TEST_F(KernelTest, AuxiliarModelPartUtilities_SetScalarData_Element)
{
    Model current_model;
    ModelPart& this_model_part = current_model.CreateModelPart("Main");
    Initialize(this_model_part);
...
TEST_F(KernelTest, AuxiliarModelPartUtilities_SetScalarData_Condition)
{
    Model current_model;
    ModelPart& this_model_part = current_model.CreateModelPart("Main");
    Initialize(this_model_part);
...
TEST_F(KernelTest, AuxiliarModelPartUtilities_SetScalarData_ModelPart)
{
    Model current_model;
    ModelPart& this_model_part = current_model.CreateModelPart("Main");
    Initialize(this_model_part);
...
TEST_F(KernelTest, AuxiliarModelPartUtilities_SetScalarData_ProcessInfo)
{
    Model current_model;
    ModelPart& this_model_part = current_model.CreateModelPart("Main");
    Initialize(this_model_part);
...
TEST_F(KernelTest, AuxiliarModelPartUtilities_SetVectorData_Node_historical)
{
    Model current_model;
    ModelPart& this_model_part = current_model.CreateModelPart("Main");
    Initialize(this_model_part);
...
TEST_F(KernelTest, AuxiliarModelPartUtilities_SetVectorData_Node_historical_ublas_vector)
{
    Model current_model;
    ModelPart& this_model_part = current_model.CreateModelPart("Main");
    Initialize(this_model_part);
...
TEST_F(KernelTest, AuxiliarModelPartUtilities_SetVectorData_Node_Nonhistorical)
{
    Model current_model;
    ModelPart& this_model_part = current_model.CreateModelPart("Main");
    Initialize(this_model_part);
...
TEST_F(KernelTest, AuxiliarModelPartUtilities_SetVectorData_Element)
{
    Model current_model;
    ModelPart& this_model_part = current_model.CreateModelPart("Main");
    Initialize(this_model_part);
...
TEST_F(KernelTest, AuxiliarModelPartUtilities_SetVectorData_Condition)
{
    Model current_model;
    ModelPart& this_model_part = current_model.CreateModelPart("Main");
    Initialize(this_model_part);
...
TEST_F(KernelTest, AuxiliarModelPartUtilities_SetVectorData_ModelPart)
{
    Model current_model;
    ModelPart& this_model_part = current_model.CreateModelPart("Main");
    Initialize(this_model_part);
...
TEST_F(KernelTest, AuxiliarModelPartUtilities_SetVectorData_ProcessInfo)
{
    Model current_model;
    ModelPart& this_model_part = current_model.CreateModelPart("Main");
    Initialize(this_model_part);
