...
TEST(MetricTensorDataEquilateralTriangle, KratosCoreFastSuite)
{
...
TEST(MetricTensorDataUnitTriangle2D3N, KratosCoreFastSuite)
{
    // Set triangle geometry
    Geometry<Node<3>>::PointsArrayType nodes;
    nodes.push_back(Node<3>::Pointer(new Node<3>(1, 0.0, 0.0, 0.0)));
...
TEST(MetricTensorDataEquilateralTetrahedra3D4N, KratosCoreFastSuite)
{
    // Set triangle geometry
    Geometry<Node<3>>::PointsArrayType nodes;
    nodes.push_back(Node<3>::Pointer(new Node<3>(1, 0.0, 0.0, 0.0)));
...
TEST(MetricTensorDataUnitTetrahedra3D4N, KratosCoreFastSuite)
{
    // Set triangle geometry
    Geometry<Node<3>>::PointsArrayType nodes;
    nodes.push_back(Node<3>::Pointer(new Node<3>(1, 0.0, 0.0, 0.0)));
