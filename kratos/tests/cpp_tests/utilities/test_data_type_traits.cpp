...
KRATOS_TEST_CASE_IN_SUITE(DataTypeTraitsNestedZeroSize, KratosCoreFastSuite)
{
    ...
    KRATOS_EXPECT_EQ(data_type_4_trait::GetContiguousData(test_data_type_4), &test_data_type_4[0][0][0][0][0]);
    ...
    KRATOS_EXPECT_EQ(data_type_5_trait::GetContiguousData(test_data_type_5), &test_data_type_5(0,0)[0][0][0][0]);
