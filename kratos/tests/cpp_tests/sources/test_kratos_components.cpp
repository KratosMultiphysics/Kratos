...
TEST_F(KernelTest, KratosComponentsGetNonExistingElement)
{
...
TEST_F(KernelTest, KratosComponentsGetNonExistingVariable)
{
...
TEST_F(KernelTest, KratosComponentsAddDifferentObjectsSameName)
{
...
TEST_F(KernelTest, KratosComponentsRemove)
{
