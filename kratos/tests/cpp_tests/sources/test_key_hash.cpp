...
namespace Kratos {
     ...
     */
    TEST(VariableHasher, KratosCoreFastSuite)
    {
     ...
     */
    TEST(pVariableHasher, KratosCoreFastSuite)
    {
     ...
     */
    TEST(IndexedObjectHasher, KratosCoreFastSuite)
    {
        Model current_model;
     ...
     */
    TEST(IndexedObjectPointerHasher, KratosCoreFastSuite)
    {
        Model current_model;
        ModelPart& r_model_part = current_model.CreateModelPart("test");
        auto p_node = r_model_part.CreateNewNode(1, 1., 0, 0);
     ...
     */
    TEST(VectorIndexHasher, KratosCoreFastSuite)
    {
     ...
     */
    TEST(DofPointerHasher, KratosCoreFastSuite)
    {
        Model current_model;
        ModelPart& r_model_part = current_model.CreateModelPart("test");
     ...
     */
    TEST(PairHasher, KratosCoreFastSuite)
    {
     ...
     *  Here the VariableHasher is test
     */
    TEST(VariableComparator, KratosCoreFastSuite)
    {
     ...
     */
    TEST(pVariableComparator, KratosCoreFastSuite)
    {
     ...
     */
    TEST(IndexedObjectComparator, KratosCoreFastSuite)
    {
        Model current_model;
        ModelPart& r_model_part = current_model.CreateModelPart("test");
     ...
     */
    TEST(IndexedObjectPointerComparator, KratosCoreFastSuite)
    {
        Model current_model;
        ModelPart& r_model_part = current_model.CreateModelPart("test");
        auto p_node1 = r_model_part.CreateNewNode(1, 1., 0, 0);
     ...
     */
    TEST(SharedPointerComparator, KratosCoreFastSuite)
    {
        Model current_model;
        ModelPart& r_model_part = current_model.CreateModelPart("test");
        auto p_node1 = r_model_part.CreateNewNode(1, 1., 0, 0);
     ...
     */
    TEST(VectorIndexComparor, KratosCoreFastSuite)
    {
     ...
     */
    TEST(DofPointerComparor, KratosCoreFastSuite)
    {
        Model current_model;
        ModelPart& r_model_part = current_model.CreateModelPart("test");
        r_model_part.AddNodalSolutionStepVariable(DISPLACEMENT);
     ...
     */
    TEST(PairComparor, KratosCoreFastSuite)
    {
