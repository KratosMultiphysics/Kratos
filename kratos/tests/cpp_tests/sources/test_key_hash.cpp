...
KRATOS_TEST_CASE_IN_SUITE(HashCombine, KratosCoreFastSuite) 
{
  ...
  // Expected hash value calculated using online hash calculator
  HashType expected_hash =5577293601871571209;
...
KRATOS_TEST_CASE_IN_SUITE(HashRange, KratosCoreFastSuite) 
{
  ...
  HashType expected_hash = 46082543957171356;

  HashType actual_hash = HashRange(values.begin(), values.end());
