...
namespace Kratos::Testing {
    ...
    KRATOS_TEST_CASE_IN_SUITE(ModelPartSetProcessInfo, KratosCoreFastSuite)
    {
        Model current_model;
        // generate a tree of submodel parts
        // root1 and submodels
        ModelPart& r_root1 = current_model.CreateModelPart("root1");
        ModelPart& r_root1_sub1 = r_root1.CreateSubModelPart("root1_sub1");
        r_root1_sub1.CreateSubModelPart("root1_sub1_sub1");
        r_root1_sub1.CreateSubModelPart("root1_sub1_sub2");
        ModelPart& r_root1_sub2 = r_root1.CreateSubModelPart("root1_sub2");
        r_root1_sub2.CreateSubModelPart("root1_sub2_sub1");
        ModelPart& r_root1_sub2_sub2 = r_root1_sub2.CreateSubModelPart("root1_sub2_sub2");
        r_root1_sub2_sub2.CreateSubModelPart("root1_sub2_sub2_sub1");
        r_root1_sub2_sub2.CreateSubModelPart("root1_sub2_sub2_sub2");
        // root2 and submodels
        ModelPart& r_root2 = current_model.CreateModelPart("root2");
        r_root2.CreateSubModelPart("root2_sub1");
        ModelPart& r_root2_sub2 = r_root2.CreateSubModelPart("root2_sub2");
        r_root2_sub2.CreateSubModelPart("root2_sub2_sub1");
        r_root2_sub2.CreateSubModelPart("root2_sub2_sub2");
        r_root2_sub2.CreateSubModelPart("root2_sub2_sub3");
        // root3 and submodels
        ModelPart& r_root3 = current_model.CreateModelPart("root3");
        ModelPart& r_root3_sub1 = r_root3.CreateSubModelPart("root3_sub1");

        // set time
        r_root1.GetProcessInfo().SetCurrentTime(0.25);
        r_root2.GetProcessInfo().SetCurrentTime(0.5);
        r_root3.GetProcessInfo().SetCurrentTime(0.75);

        KRATOS_EXPECT_NE(r_root1.GetProcessInfo()[TIME], r_root2.GetProcessInfo()[TIME]);
        KRATOS_EXPECT_NE(r_root1.GetProcessInfo()[TIME], r_root3.GetProcessInfo()[TIME]);
        KRATOS_EXPECT_NE(r_root3.GetProcessInfo()[TIME], r_root2.GetProcessInfo()[TIME]);

        // set process info to r_root1_sub2_sub2
        r_root1_sub2_sub2.SetProcessInfo(r_root2.GetProcessInfo());
        // check process info
        CheckSubModelPartProcessInfo(r_root1, 0.5);
        CheckSubModelPartProcessInfo(r_root2, 0.5);
        CheckSubModelPartProcessInfo(r_root3, 0.75);


        // change time in the second root model part
        r_root2.GetProcessInfo().SetCurrentTime(1.5);
        CheckSubModelPartProcessInfo(r_root1, 0.5);
        CheckSubModelPartProcessInfo(r_root2, 1.5);
        CheckSubModelPartProcessInfo(r_root3, 0.75);

        // change time in r_root1_sub2
        r_root1_sub2.GetProcessInfo().SetCurrentTime(2.5);
        CheckSubModelPartProcessInfo(r_root1, 2.5);
        CheckSubModelPartProcessInfo(r_root2, 1.5);
        CheckSubModelPartProcessInfo(r_root3, 0.75);

        // create a new process info and assign it to r_root3_sub1
        ProcessInfo NewProcessInfo;
        NewProcessInfo.SetCurrentTime(4.75);
        r_root3_sub1.SetProcessInfo(NewProcessInfo);
        CheckSubModelPartProcessInfo(r_root1, 2.5);
        CheckSubModelPartProcessInfo(r_root2, 1.5);
        CheckSubModelPartProcessInfo(r_root3, 4.75);

        // also assign it to r_root2_sub2
        r_root3_sub1.GetProcessInfo().SetCurrentTime(5.5);
        r_root2_sub2.SetProcessInfo(NewProcessInfo);
        CheckSubModelPartProcessInfo(r_root1, 2.5);
        CheckSubModelPartProcessInfo(r_root2, 4.75);
        CheckSubModelPartProcessInfo(r_root3, 5.5);
    }
}  // namespace Kratos::Testing.
