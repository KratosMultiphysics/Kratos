...
namespace Kratos {
  namespace Testing {
    ...
    TEST_F(KernelTest, ModelPartDataValueContainer)
    {
        Model model;
    ...
    TEST_F(KernelTest, ModelPartFlag)
    {
        Model model;
        ModelPart& r_model_part = model.CreateModelPart("Main");
    ...
    TEST_F(KernelTest, ModelPartSubModelPartsIterator)
    {
        Model current_model;
    ...
    TEST_F(KernelTest, ModelPartAddNodalSolutionStepVariable)
    {
        Model current_model;
    ...
    TEST_F(KernelTest, ModelPartHasNodalSolutionStepVariable)
    {
        Model current_model;
        ModelPart& r_model_part = current_model.CreateModelPart("Main");
    ...
    TEST_F(KernelTest, ModelPartFullName)
    {
        Model current_model;
        ModelPart& r_model_part = current_model.CreateModelPart("Main");
    ...
    TEST_F(KernelTest, ModelPartEmptyName)
    {
        Model current_model;
    ...
    TEST_F(KernelTest, ModelPartBaseCreation)
    {
        Model current_model;
    ...
    TEST_F(KernelTest, ModelPartAddGeometries)
    {
        Model current_model;
    ...
    TEST_F(KernelTest, ModelPartTable)
    {
        Model current_model;
    ...
    TEST_F(KernelTest, ModelPartRemoveElements)
    {
        Model current_model;
    ...
    TEST_F(KernelTest, ModelPartRemoveElementsAndBelongings)
    {
        Model current_model;
    ...
    TEST_F(KernelTest, ModelPartRemoveConditions)
    {
        Model current_model;
    ...
    TEST_F(KernelTest, ModelPartRemoveConditionsAndBelongings)
    {
        Model current_model;
    ...
    TEST_F(KernelTest, ModelPartEnsureModelPartOwnsProperties)
    {
        Model current_model;
    ...
    TEST_F(KernelTest, ModelPartGetSubModelPart)
    {
        Model model;
    ...
    TEST_F(KernelTest, ModelPartHasSubModelPart)
    {
        Model model;
    ...
    TEST_F(KernelTest, ModelPartCreateSubModelPart)
    {
        Model model;
    ...
    TEST_F(KernelTest, ModelPartRemoveSubModelPart)
    {
        Model model;
