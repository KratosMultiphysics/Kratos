...
namespace Kratos {
	namespace Testing {
		...
		TEST(PropertiesAssignment, KratosCoreFastSuite)
		{
		...
		TEST(PropertiesHasTable, KratosCoreFastSuite)
		{
		...
		TEST(PropertiesHasVariables, KratosCoreFastSuite)
		{
		...
		TEST(PropertiesHasTables, KratosCoreFastSuite)
		{
			Properties property(0);
		...
		TEST(PropertiesIsEmpty, KratosCoreFastSuite)
		{
			Properties property(0);
