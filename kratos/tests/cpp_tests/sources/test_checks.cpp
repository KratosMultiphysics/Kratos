...
namespace Kratos {
	namespace Testing {
		...
		TEST(Checks, KratosCoreFastSuite)
		{
		...
		TEST(VariableChecks, KratosCoreFastSuite)
        {
            Model current_model;
        ...
        TEST(VectorChecks, KratosCoreFastSuite)
        {
        ...
        TEST(MatrixChecks, KratosCoreFastSuite)
        {
        ...
        TEST(NaNValuesCheck, KratosCoreFastSuite)
		{
