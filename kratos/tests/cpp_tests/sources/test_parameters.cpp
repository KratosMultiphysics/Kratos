...
namespace Kratos {
    namespace Testing {
        ...
        TEST(ParametersIterator, KratosCoreFastSuite)
        {
        ...
        TEST(Parameters_Constructor1, KratosCoreFastSuite)
        {
            Parameters p;
            KRATOS_EXPECT_EQ(p.WriteJsonString(), "{}");
        }

        TEST(Parameters_Swap1, KratosCoreFastSuite)
        {
        ...
        TEST(Parameters_Reset1, KratosCoreFastSuite)
        {
        ...
        TEST(Parameters_MoveConstructor1, KratosCoreFastSuite)
        {
        ...
        TEST(Parameters_MoveAssignment1, KratosCoreFastSuite)
        {
            Parameters p1{R"({"foo": {"bar": 1.0}})"};
            Parameters p2{};
            p2 = std::move(p1);
