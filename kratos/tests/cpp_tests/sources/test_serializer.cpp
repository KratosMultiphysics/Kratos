...
namespace Kratos {
    namespace Testing {
        ...
        /*********************************************************************/
        TEST(SerializerBool, KratosCoreFastSuite)
        {
        ...
        TEST(SerializerInt, KratosCoreFastSuite)
        {
        ...
        TEST(SerializerLong, KratosCoreFastSuite)
        {
        ...
        TEST(SerializerDouble, KratosCoreFastSuite)
        {
        ...
        TEST(SerializerUnsignedLong, KratosCoreFastSuite)
        {
        ...
        TEST(SerializerUnsignedInt, KratosCoreFastSuite)
        {
        ...
        TEST(SerializerStdString, KratosCoreFastSuite)
        {
        ...
        TEST(SerializerMatrix, KratosCoreFastSuite)
        {
        ...
        TEST(SerializerLongLong, KratosCoreFastSuite)
        {
        ...
        TEST(SerializerKratosSharedPtr, KratosCoreFastSuite)
        {
            StreamSerializer serializer;
        ...
        TEST(SerializerStdArray, KratosCoreFastSuite)
        {
        ...
        TEST(SerializerStdVector, KratosCoreFastSuite)
        {
        ...
        TEST(SerializerUblasVector, KratosCoreFastSuite)
        {
        ...
        TEST(SerializerMap, KratosCoreFastSuite)
        {
        ...
        TEST(SerializerUnorderedMap, KratosCoreFastSuite)
        {
        ...
        TEST(SerializerSet, KratosCoreFastSuite)
        {
        ...
        TEST(SerializerUnorderedSet, KratosCoreFastSuite)
        {
        ...
        TEST(SerializerArray1D, KratosCoreFastSuite)
        {
        ...
        TEST(SerializerPair, KratosCoreFastSuite)
        {
        ...
        TEST(SerializerBoundedVector, KratosCoreFastSuite)
        {
        ...
        TEST(SerializerBoundedMatrix, KratosCoreFastSuite)
        {
