...
TEST(RegistryItem, KratosCoreFastSuite)
{
    ...
    KRATOS_EXPECT_EQ(registry_item.ToJson(), item_json);
...
TEST(RegistryValue, KratosCoreFastSuite)
{
    double value = 3.14;
...
TEST(RegistryAddAndRemove, KratosCoreFastSuite)
{
...
TEST(RegistryIteration, KratosCoreFastSuite)
{
...
TEST(RegistryKeyIteration, KratosCoreFastSuite)
{
    Registry::AddItem<RegistryItem>("item_in_root_1");
    Registry::AddItem<RegistryItem>("item_in_root_1.subitem_1");
    Registry::AddItem<RegistryItem>("item_in_root_1.subitem_2");
...
TEST(RegistryParallelAddAndRemove, KratosCoreFastSuite)
{
