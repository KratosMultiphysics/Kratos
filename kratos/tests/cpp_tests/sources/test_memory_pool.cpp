...
namespace Kratos {
	namespace Testing {
		...
		TEST(ThreadFixedSizeMemoryPoolAllocationDeallocation, KratosCoreFastSuite)
		{
		...
		TEST(FixedSizeMemoryPoolConstruction, KratosCoreFastSuite)
		{
		...
		TEST(FixedSizeMemoryPoolAllocationDeallocation, KratosCoreFastSuite)
		{
		...
		//TEST(MemoryPool, KratosCoreFastSuite)
		//{
...
namespace{
		...
		TEST(PoolObjectParallelNewDelete, KratosCoreFastSuite)
		{
