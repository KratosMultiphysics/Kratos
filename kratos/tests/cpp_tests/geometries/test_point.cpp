 ...
 */
TEST(Constructors, KratosCoreGeometriesFastSuite)
{
    const Point point;
 ...
 */
TEST(Access, KratosCoreGeometriesFastSuite)
{
    Point point;
    point.X() = 1.0;
    point.Y() = 2.0;
 ...
 */
TEST(Info, KratosCoreGeometriesFastSuite)
{
    const Point point;
 ...
 */
TEST(Distance, KratosCoreGeometriesFastSuite)
{
    const Point point;
