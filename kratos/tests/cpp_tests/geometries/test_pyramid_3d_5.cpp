...
TEST(Pyramid3D5EdgesNumber, KratosCoreGeometriesFastSuite)
{
...
TEST(Pyramid3D5GenerateEdges, KratosCoreGeometriesFastSuite)
{
...
TEST(Pyramid3D5FacesNumber, KratosCoreGeometriesFastSuite)
{
    auto geomRegular = GenerateRegularPyramid3D5();
...
TEST(Pyramid3D5Volume, KratosCoreGeometriesFastSuite)
{
    auto geomRegular = GenerateRegularPyramid3D5();
...
TEST(Pyramid3D5Center, KratosCoreGeometriesFastSuite)
{
    auto geomRegular = GenerateRegularPyramid3D5();
...
*/
TEST(Pyramid3D5IsInside, KratosCoreGeometriesFastSuite)
{
    auto geom = GenerateRegularPyramid3D5();
...
* solution.
*/
TEST(Pyramid3D5PointLocalCoordinates, KratosCoreGeometriesFastSuite)
{
    auto geom = GenerateRegularPyramid3D5();
...
TEST(Pyramid3D5ShapeFunctionsValues, KratosCoreGeometriesFastSuite)
{
    auto geom = GenerateRegularPyramid3D5();
...
TEST(Pyramid3D5ShapeFunctionsLocalGradients, KratosCoreGeometriesFastSuite)
{
    auto geom = GenerateRegularPyramid3D5();
    Matrix gradient;
...
* Tests the area using 'GI_GAUSS_1' integration method.
*/
TEST(Pyramid3D5GaussPoint1, KratosCoreGeometriesFastSuite)
{
    auto geom = GenerateRegularPyramid3D5();
...
* Tests the area using 'GI_GAUSS_2' integration method.
*/
TEST(Pyramid3D5GaussPoint2, KratosCoreGeometriesFastSuite)
{
    auto geom = GenerateRegularPyramid3D5();
...
* Tests the area using 'GI_GAUSS_3' integration method.
*/
TEST(Pyramid3D5GaussPoint3, KratosCoreGeometriesFastSuite)
{
    auto geom = GenerateRegularPyramid3D5();
...
* Tests the area using 'GI_GAUSS_4' integration method.
*/
TEST(Pyramid3D5GaussPoint4, KratosCoreGeometriesFastSuite)
{
    auto geom = GenerateRegularPyramid3D5();
...
* Tests the area using 'GI_GAUSS_5' integration method.
*/
TEST(Pyramid3D5GaussPoint5, KratosCoreGeometriesFastSuite)
{
    auto geom = GenerateRegularPyramid3D5();
