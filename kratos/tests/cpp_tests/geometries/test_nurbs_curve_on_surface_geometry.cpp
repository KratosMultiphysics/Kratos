...
// namespace {
    ...
    ///// Tests
    // Ported from the ANurbs library (https://github.com/oberbichler/ANurbs)
    TEST(BSplineCurveOnSurfaceBSpline, KratosCoreNurbsGeometriesFastSuite)
    {
    ...
    TEST(NurbsCurveOnSurfaceNurbs, KratosCoreNurbsGeometriesFastSuite)
    {
    ...
    TEST(CurveOnSurfaceLineLength, KratosCoreNurbsGeometriesFastSuite)
    {
        // Create a Nurbs curve on a Nurbs surface
    ...
    TEST(NurbsCurveOnSurfaceIntersectionSpans, KratosCoreNurbsGeometriesFastSuite)
    {
        // Create a Nurbs curve on a Nurbs surface
    ...
    TEST(NurbsCurveOnSurfaceNonUniformKnotVectorsIntersectionSpans, KratosCoreNurbsGeometriesFastSuite)
    {
        // Create a Nurbs curve on a Nurbs surface
    ...
    TEST(NurbsCurveOnSurfaceCreateIntegrationPoints, KratosCoreNurbsGeometriesFastSuite)
    {
        // Create a Nurbs curve on a Nurbs surface
        auto curve_on_surface = GenerateReferenceNurbsCOS3dforKnotIntersections();
    ...
    TEST(NurbsCurveOnSurfaceCreateQuadraturePoints, KratosCoreNurbsGeometriesFastSuite)
    {
