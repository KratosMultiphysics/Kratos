...
namespace {
    ...
    * Checks if the number of edges is correct.
    */
    TEST(Line3D3EdgesNumber, KratosCoreGeometriesFastSuite) {
    ...
    * Checks if the number of faces is correct.
    */
    TEST(Line3D3FacesNumber, KratosCoreGeometriesFastSuite) {
        auto p_geometry = GeneratePointsUnitXDirectionLine3D3();
    ...
    * Checks if the length of the line is calculated correctly.
    */
    TEST(LengthLine3D3, KratosCoreGeometriesFastSuite) {
    ...
    * Checks if the bounding box of the line is calculated correctly.
    */
    TEST(BoundingBoxLine3D3, KratosCoreGeometriesFastSuite) {
    ...
    * Tests the Jacobian determinants using 'GI_GAUSS_1' integration method.
    */
    TEST(Line3D3DeterminantOfJacobianArray1, KratosCoreGeometriesFastSuite) {
        auto p_geometry = GeneratePointsUnitXDirectionLine3D3();
    ...
    * Tests the Jacobian determinants using 'GI_GAUSS_2' integration method.
    */
    TEST(Line3D3DeterminantOfJacobianArray2, KratosCoreGeometriesFastSuite) {
        auto p_geometry = GeneratePointsUnitXDirectionLine3D3();
        const double expected_jacobian = 0.5;
    ...
    * Tests the Jacobian determinants using 'GI_GAUSS_3' integration method.
    */
    TEST(Line3D3DeterminantOfJacobianArray3, KratosCoreGeometriesFastSuite) {
        auto p_geometry = GeneratePointsUnitXDirectionLine3D3();
        const double expected_jacobian = 0.5;
    ...
    * Tests the Jacobian determinants using 'GI_GAUSS_4' integration method.
    */
    TEST(Line3D3DeterminantOfJacobianArray4, KratosCoreGeometriesFastSuite) {
        auto p_geometry = GeneratePointsUnitXDirectionLine3D3();
        const double expected_jacobian = 0.5;
    ...
    * Tests the Jacobian determinants using 'GI_GAUSS_5' integration method.
    */
    TEST(Line3D3DeterminantOfJacobianArray5, KratosCoreGeometriesFastSuite) {
        auto p_geometry = GeneratePointsUnitXDirectionLine3D3();
        const double expected_jacobian = 0.5;
    ...
    * Tests the Jacobian determinants using 'GI_GAUSS_1' integration method.
    */
    TEST(Line3D3DeterminantOfJacobianIndex1, KratosCoreGeometriesFastSuite) {
        auto p_geometry = GeneratePointsUnitXDirectionLine3D3();
        const double expected_jacobian = 0.5;
    ...
    * Tests the Jacobian determinants using 'GI_GAUSS_2' integration method.
    */
    TEST(Line3D3DeterminantOfJacobianIndex2, KratosCoreGeometriesFastSuite) {
        auto p_geometry = GeneratePointsUnitXDirectionLine3D3();
    ...
    * Tests the Jacobian determinants using 'GI_GAUSS_3' integration method.
    */
    TEST(Line3D3DeterminantOfJacobianIndex3, KratosCoreGeometriesFastSuite) {
        auto p_geometry = GeneratePointsUnitXDirectionLine3D3();
        double jacobian_determinant = 0.0;
        const double expected_jacobian = 0.5;
    ...
    * Tests the Jacobian determinants using 'GI_GAUSS_4' integration method.
    */
    TEST(Line3D3DeterminantOfJacobianIndex4, KratosCoreGeometriesFastSuite) {
        auto p_geometry = GeneratePointsUnitXDirectionLine3D3();
        double jacobian_determinant = 0.0;
        const double expected_jacobian = 0.5;
    ...
    * Tests the Jacobian determinants using 'GI_GAUSS_5' integration method.
    */
    TEST(Line3D3DeterminantOfJacobianIndex5, KratosCoreGeometriesFastSuite) {
        auto p_geometry = GeneratePointsUnitXDirectionLine3D3();
        double jacobian_determinant = 0.0;
        const double expected_jacobian = 0.5;
    ...
    TEST(Line3D3ShapeFunctionsValues, KratosCoreGeometriesFastSuite) {
    ...
    TEST(Line3D3ShapeFunctionsValuesMatrix, KratosCoreGeometriesFastSuite) {
    ...
    TEST(Line3D3ShapeFunctionsLocalGradients, KratosCoreGeometriesFastSuite) {
        auto p_geometry = GeneratePointsParabolaLine3D3();
        auto& r_geom = *p_geometry;
        auto p_p_geom_nodes = Kratos::make_shared<Line3D3<Node<3>>>(
        Kratos::make_intrusive<Node<3>>(1, r_geom[0].X(), r_geom[0].Y(), r_geom[0].Z()),
