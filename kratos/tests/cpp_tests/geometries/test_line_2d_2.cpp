...
namespace Testing {
    ...
    * Checks if the number of edges is correct.
    */
    TEST(Line2D2EdgesNumber, KratosCoreGeometriesFastSuite) {
        auto geom = GeneratePointsUnitXDirectionLine2D2();
        KRATOS_EXPECT_EQ(geom->EdgesNumber(), 1);
    }

    /** Checks if the edges are correct.
    * Checks if the edges are correct.
    */
    TEST(Line2D2Edges, KratosCoreGeometriesFastSuite) {
    ...
    * Checks if the number of faces is correct.
    */
    TEST(Line2D2FacesNumber, KratosCoreGeometriesFastSuite) {
        auto geom = GeneratePointsUnitXDirectionLine2D2();
        KRATOS_EXPECT_EQ(geom->FacesNumber(), 0);
    }

    /** Checks if the length of the line is calculated correctly.
    * Checks if the length of the line is calculated correctly.
    */
    TEST(LengthLine2D2, KratosCoreGeometriesFastSuite) {
        auto geom = GeneratePointsDiagonalLine2D2();

        KRATOS_EXPECT_NEAR(geom->Length(), std::sqrt(2.0), TOLERANCE);
    }

    /** Checks if the bounding box of the line is calculated correctly.
    * Checks if the bounding box of the line is calculated correctly.
    */
    TEST(BoundingBoxLine2D2, KratosCoreGeometriesFastSuite) {
    ...
    * Checks the ProjectionPoint test for a given point respect to the line
    */
    TEST(Line2D2ProjectionPoint, KratosCoreGeometriesFastSuite) {
        auto geom = GeneratePointsDiagonalLine2D2();
        ...
        KRATOS_EXPECT_RELATIVE_NEAR(global_coords[0], point_projected[0], TOLERANCE);
        KRATOS_EXPECT_RELATIVE_NEAR(global_coords[1], point_projected[1], TOLERANCE);
        KRATOS_EXPECT_RELATIVE_NEAR(global_coords[2], point_projected[2], TOLERANCE);

        KRATOS_EXPECT_RELATIVE_NEAR(local_coords[0], 0.05, TOLERANCE);
        KRATOS_EXPECT_NEAR(local_coords[1], 0.0, TOLERANCE);
        KRATOS_EXPECT_NEAR(local_coords[2], 0.0, TOLERANCE);
    }
    ...
    */
    TEST(Line2D2IsInside, KratosCoreGeometriesFastSuite) {
        auto geom = GeneratePointsDiagonalLine2D2();
    ...
    * solution.
    */
    TEST(Line2D2PointLocalCoordinates, KratosCoreGeometriesFastSuite) {
        auto geom = GeneratePointsDiagonalLine2D2();
    ...
    */
    TEST(Line2D2PointLocalCoordinatesOutsidePoint1, KratosCoreGeometriesFastSuite)
    {
        ...
        KRATOS_EXPECT_NEAR(test_point_local_coords(0), 2.0, TOLERANCE);
    ...
    */
    TEST(Line2D2PointLocalCoordinatesOutsidePoint2, KratosCoreGeometriesFastSuite)
    {
        // Create the test line
        auto geom = GeneratePointsDiagonalLine2D2();
    ...
    */
    TEST(Line2D2PointLocalCoordinatesOutsidePoint3, KratosCoreGeometriesFastSuite)
    {
        // Create the test line
        auto geom = GeneratePointsDiagonalLine2D2();
        ...
        KRATOS_EXPECT_NEAR(test_point_local_coords(0), -1.5, TOLERANCE);
        KRATOS_EXPECT_NEAR(test_point_local_coords(1), 0.0, TOLERANCE);
        KRATOS_EXPECT_NEAR(test_point_local_coords(2), 0.0, TOLERANCE);
    }
    ...
    */
    TEST(Line2D2PointLocalCoordinatesOutsidePoint4, KratosCoreGeometriesFastSuite)
    {
        // Create the test line
        auto geom = GeneratePointsDiagonalLine2D2();
    ...
    * Tests the Jacobian determinants using 'GI_GAUSS_1' integration method.
    */
    TEST(Line2D2DeterminantOfJacobianArray1, KratosCoreGeometriesFastSuite) {
        auto geom = GeneratePointsUnitXDirectionLine2D2();
    ...
    * Tests the Jacobian determinants using 'GI_GAUSS_2' integration method.
    */
    TEST(Line2D2DeterminantOfJacobianArray2, KratosCoreGeometriesFastSuite) {
        auto geom = GeneratePointsUnitXDirectionLine2D2();
        const double ExpectedJacobian = 0.5;
    ...
    * Tests the Jacobian determinants using 'GI_GAUSS_3' integration method.
    */
    TEST(Line2D2DeterminantOfJacobianArray3, KratosCoreGeometriesFastSuite) {
        auto geom = GeneratePointsUnitXDirectionLine2D2();
        const double ExpectedJacobian = 0.5;
    ...
    * Tests the Jacobian determinants using 'GI_GAUSS_4' integration method.
    */
    TEST(Line2D2DeterminantOfJacobianArray4, KratosCoreGeometriesFastSuite) {
        auto geom = GeneratePointsUnitXDirectionLine2D2();
        const double ExpectedJacobian = 0.5;
    ...
    * Tests the Jacobian determinants using 'GI_GAUSS_5' integration method.
    */
    TEST(Line2D2DeterminantOfJacobianArray5, KratosCoreGeometriesFastSuite) {
        auto geom = GeneratePointsUnitXDirectionLine2D2();
        const double ExpectedJacobian = 0.5;
    ...
    * Tests the Jacobian determinants using 'GI_GAUSS_1' integration method.
    */
    TEST(Line2D2DeterminantOfJacobianIndex1, KratosCoreGeometriesFastSuite) {
        auto geom = GeneratePointsUnitXDirectionLine2D2();
        const double ExpectedJacobian = 0.5;
    ...
    * Tests the Jacobian determinants using 'GI_GAUSS_2' integration method.
    */
    TEST(Line2D2DeterminantOfJacobianIndex2, KratosCoreGeometriesFastSuite) {
        auto geom = GeneratePointsUnitXDirectionLine2D2();
    ...
    * Tests the Jacobian determinants using 'GI_GAUSS_3' integration method.
    */
    TEST(Line2D2DeterminantOfJacobianIndex3, KratosCoreGeometriesFastSuite) {
        auto geom = GeneratePointsUnitXDirectionLine2D2();
        double JacobianDeterminant = 0.0;
        const double ExpectedJacobian = 0.5;
    ...
    * Tests the Jacobian determinants using 'GI_GAUSS_4' integration method.
    */
    TEST(Line2D2DeterminantOfJacobianIndex4, KratosCoreGeometriesFastSuite) {
        auto geom = GeneratePointsUnitXDirectionLine2D2();
        double JacobianDeterminant = 0.0;
        const double ExpectedJacobian = 0.5;
    ...
    * Tests the Jacobian determinants using 'GI_GAUSS_4' integration method.
    */
    TEST(Line2D2DeterminantOfJacobianIndex5, KratosCoreGeometriesFastSuite) {
        auto geom = GeneratePointsUnitXDirectionLine2D2();
        double JacobianDeterminant = 0.0;
        const double ExpectedJacobian = 0.5;
    ...
    TEST(Line2D2ShapeFunctionsValues, KratosCoreGeometriesFastSuite) {
        auto geom = GeneratePointsDiagonalLine2D2();
    ...
    TEST(Line2D2ShapeFunctionsValuesMatrix, KratosCoreGeometriesFastSuite) {
    ...
    TEST(Line2D2ShapeFunctionsLocalGradients, KratosCoreGeometriesFastSuite) {
        auto geom = GeneratePointsDiagonalLine2D2();
        auto& r_geom = *geom;
        auto p_geom_nodes = Kratos::make_shared<Line2D2<Node<3>>>(
        Kratos::make_intrusive<Node<3>>(1, r_geom[0].X(), r_geom[0].Y(), r_geom[0].Z()),
     ...
     */
    TEST(Line2D2XIntersectionBoxSingleNodeInside, KratosCoreGeometriesFastSuite) {
        auto geom = GeneratePointsUnitXDirectionLine2D2();
        Point point_1(0.5, -0.1, 0.0);
        Point point_2(1.5, 0.1, 0.0);
        KRATOS_EXPECT_TRUE(geom->HasIntersection(point_1, point_2));
    }
    TEST(Line2D2YIntersectionBoxSingleNodeInside, KratosCoreGeometriesFastSuite) {
     ...
     */
    TEST(Line2D2XIntersectionBoxTwoNodesInside, KratosCoreGeometriesFastSuite) {
        auto geom = GeneratePointsUnitXDirectionLine2D2();
        Point point_1(-0.5, -0.1, 0.0);
        Point point_2(1.5, 0.1, 0.0);
        KRATOS_EXPECT_TRUE(geom->HasIntersection(point_1, point_2));
    }
    TEST(Line2D2YIntersectionBoxTwoNodesInside, KratosCoreGeometriesFastSuite) {
        auto geom = GeneratePointsUnitYDirectionLine2D2();
        Point point_1(-0.1, -0.5, 0.0);
        Point point_2(0.1, 1.5, 0.0);
        KRATOS_EXPECT_TRUE(geom->HasIntersection(point_1, point_2));
     ...
     */
    TEST(Line2D2IntersectionWithAnotherLine, KratosCoreGeometriesFastSuite) {
     ...
     */
    TEST(Line2D2IntersectionWithAnotherParallelLine, KratosCoreGeometriesFastSuite) {
        auto geom_1 = GeneratePointsUnitXDirectionLine2D2();
     ...
     */
    TEST(Line2D2IntersectionBoxInsideX, KratosCoreGeometriesFastSuite) {
        auto geom = GeneratePointsUnitXDirectionLine2D2();
     ...
     * Test a box inside a line HasIntersection
     */
    TEST(Line2D2IntersectionBoxInsideY, KratosCoreGeometriesFastSuite) {
        auto geom = GeneratePointsUnitYDirectionLine2D2();
     ...
     */
    TEST(Line2D2NoIntersectionBox, KratosCoreGeometriesFastSuite) {
        auto geom = GeneratePointsUnitXDirectionLine2D2();
