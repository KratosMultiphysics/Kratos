...
namespace Testing {
    ...
    TEST(NurbsVolumeGeometryIntegrationPoints1, KratosCoreNurbsGeometriesFastSuite) {
            NurbsVolumeGeometry<PointerVector<NodeType>> TruncatedPyramid = GenerateTruncatedPyramid();

            KRATOS_EXPECT_EQ(TruncatedPyramid.Dimension(), 3);
    ...
    TEST(NurbsVolumeGeometryEvaluation1, KratosCoreNurbsGeometriesFastSuite) {
        NurbsVolumeGeometry<PointerVector<NodeType>> TruncatedPyramid = GenerateTruncatedPyramid();
    ...
    TEST(NurbsVolumeGeometryIntegrationPoints2, KratosCoreNurbsGeometriesFastSuite) {
        ...
        KRATOS_EXPECT_EQ(DistortedCube.Dimension(), 3);
    ...
    TEST(NurbsVolumeGeometryEvaluation2, KratosCoreNurbsGeometriesFastSuite) {
        NurbsVolumeGeometry<PointerVector<Point>> DistortedCube = GenerateDistortedCube();
    ...
    TEST(NurbsVolumeQuadraturePointGeometries, KratosCoreNurbsGeometriesFastSuite) {
