...
TEST(Pyramid3D13GetGeometryType, KratosCoreGeometriesFastSuite)
{
...
TEST(Pyramid3D13EdgesNumber, KratosCoreGeometriesFastSuite)
{
    auto geomRegular = GenerateRegularPyramid3D13();
...
TEST(Pyramid3D13FacesNumber, KratosCoreGeometriesFastSuite)
{
    auto geomRegular = GenerateRegularPyramid3D13();
...
TEST(Pyramid3D13Volume, KratosCoreGeometriesFastSuite)
{
...
TEST(Pyramid3D13Center, KratosCoreGeometriesFastSuite)
{
    auto geomRegular = GenerateRegularPyramid3D13();
...
*/
TEST(Pyramid3D13IsInside, KratosCoreGeometriesFastSuite)
{
...
* solution.
*/
TEST(Pyramid3D13PointLocalCoordinates, KratosCoreGeometriesFastSuite)
{
    auto geom = GenerateRegularPyramid3D13();
...
TEST(Pyramid3D13ShapeFunctionsValues, KratosCoreGeometriesFastSuite)
{
    auto geom = GenerateRegularPyramid3D13();
...
TEST(Pyramid3D13ShapeFunctionsLocalGradients, KratosCoreGeometriesFastSuite)
{
    auto geom = GenerateRegularPyramid3D13();
    Matrix gradient;
...
* Tests the area using 'GI_GAUSS_1' integration method.
*/
TEST(Pyramid3D13GaussPoint1, KratosCoreGeometriesFastSuite)
{
    auto geom = GenerateRegularPyramid3D13();
...
* Tests the area using 'GI_GAUSS_2' integration method.
*/
TEST(Pyramid3D13GaussPoint2, KratosCoreGeometriesFastSuite)
{
    auto geom = GenerateRegularPyramid3D13();
...
* Tests the area using 'GI_GAUSS_3' integration method.
*/
TEST(Pyramid3D13GaussPoint3, KratosCoreGeometriesFastSuite)
{
    auto geom = GenerateRegularPyramid3D13();
...
* Tests the area using 'GI_GAUSS_4' integration method.
*/
TEST(Pyramid3D13GaussPoint4, KratosCoreGeometriesFastSuite)
{
    auto geom = GenerateRegularPyramid3D13();
...
* Tests the area using 'GI_GAUSS_5' integration method.
*/
TEST(Pyramid3D13GaussPoint5, KratosCoreGeometriesFastSuite)
{
    auto geom = GenerateRegularPyramid3D13();
