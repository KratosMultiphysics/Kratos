...
namespace{
  ...
  TEST(Tetrahedra3D10EdgesNumber, KratosCoreGeometriesFastSuite) {
    auto geom = GenerateReferenceTetrahedra3D10();
    KRATOS_EXPECT_EQ(geom->EdgesNumber(), 6);
  }

  TEST(Tetrahedra3D10FacesNumber, KratosCoreGeometriesFastSuite) {
    Geometry<NodeType>::Pointer geom = GenerateReferenceTetrahedra3D10();
    KRATOS_EXPECT_EQ(geom->FacesNumber(), 4);
  }

  TEST(Tetrahedra3D10Volume, KratosCoreGeometriesFastSuite) {
    auto geom = GenerateReferenceTetrahedra3D10();
    KRATOS_EXPECT_NEAR(geom->Volume(), 1.0 / 6.0, TOLERANCE);
  }

  TEST(Tetrahedra3D10MinEdgeLength, KratosCoreGeometriesFastSuite) {
    auto geom = GenerateReferenceTetrahedra3D10();
  ...
  TEST(Tetrahedra3D10MaxEdgeLength, KratosCoreGeometriesFastSuite) {
    auto geom = GenerateReferenceTetrahedra3D10();
  ...
  TEST(Tetrahedra3D10AverageEdgeLength, KratosCoreGeometriesFastSuite) {
    auto geom = GenerateReferenceTetrahedra3D10();
  ...
  TEST(Tetrahedra3D10DeterminantOfJacobianArray1, KratosCoreGeometriesFastSuite) {
    auto geom = GenerateReferenceTetrahedra3D10();
  ...
  TEST(Tetrahedra3D10IntegrationPointsNumber, KratosCoreGeometriesFastSuite) {
    auto geom = GenerateReferenceTetrahedra3D10();
    KRATOS_EXPECT_EQ(geom->IntegrationPointsNumber(), 4);
  }

  TEST(Tetrahedra3D10DeterminantOfJacobianIndex1, KratosCoreGeometriesFastSuite) {
    auto geom = GenerateReferenceTetrahedra3D10();
    for (unsigned g = 0; g < geom->IntegrationPointsNumber(); ++g)
      KRATOS_EXPECT_NEAR(geom->DeterminantOfJacobian(g), 1.0, TOLERANCE);
  }

  TEST(Tetrahedra3D10ShapeFunctionsValues, KratosCoreGeometriesFastSuite) {
    auto geom = GenerateReferenceTetrahedra3D10();
  ...
  TEST(Tetrahedra3D10ShapeFunctionsLocalGradients, KratosCoreGeometriesFastSuite) {
    auto geom = GenerateReferenceTetrahedra3D10();
