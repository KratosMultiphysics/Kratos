...
namespace Testing {
   ...
   * Checks if the number of edges is correct.
   */
  TEST(Triangle2D3EdgesNumber, KratosCoreGeometriesFastSuite) {
  ...
  * Checks if the edges are correct.
  */
  TEST(Triangle2D3Edges, KratosCoreGeometriesFastSuite) {
   ...
   * Checks if the number of faces is correct.
   */
  TEST(Triangle2D3FacesNumber, KratosCoreGeometriesFastSuite) {
    auto geom = GeneratePointsRightTriangle2D3();
   ...
   * Checks if the area of the triangle is calculated correctly.
   */
  TEST(Triangle2D3Area, KratosCoreGeometriesFastSuite) {
    auto geom = GeneratePointsRightTriangle2D3();
   ...
   */
  TEST(Triangle2D3AreaJaccobi, KratosCoreGeometriesFastSuite) {
   ...
   * Checks if the minimum edge length is calculated correctly.
   */
  TEST(Triangle2D3MinEdgeLength, KratosCoreGeometriesFastSuite) {
    auto geom = GeneratePointsRightTriangle2D3();
   ...
   * Checks if the maximum edge length is calculated correctly.
   */
  TEST(Triangle2D3MaxEdgeLength, KratosCoreGeometriesFastSuite) {
    auto geom = GeneratePointsRightTriangle2D3();
   ...
   * Checks if the average edge length is calculated correctly.
   */
  TEST(Triangle2D3AverageEdgeLength, KratosCoreGeometriesFastSuite) {
    auto geom = GeneratePointsRightTriangle2D3();
   ...
   * Checks if the circumradius is calculated correctly.
   */
  TEST(Triangle2D3Circumradius, KratosCoreGeometriesFastSuite) {
    auto geom = GeneratePointsRightTriangle2D3();
   ...
   * Checks if the inradius is calculated correctly.
   */
  TEST(Triangle2D3Inradius, KratosCoreGeometriesFastSuite) {
    auto geom = GeneratePointsRightTriangle2D3();
   ...
   */
  TEST(Triangle2D3IsInside, KratosCoreGeometriesFastSuite) {
    auto geom = GeneratePointsRightTriangle2D3();
   ...
   * solution.
   */
  TEST(Triangle2D3PointLocalCoordinates, KratosCoreGeometriesFastSuite) {
   ...
   * Tests the area using 'GI_GAUSS_1' integration method.
   */
  TEST(Triangle2D3GaussPoint1, KratosCoreGeometriesFastSuite) {
    auto geom = GenerateNodesRightTriangle2D3();
    ...
    KRATOS_EXPECT_NEAR(CalculateAreaByIntegration(*geom, GeometryData::IntegrationMethod::GI_GAUSS_1), ExpectedArea, TOLERANCE);
   ...
   * Tests the area using 'GI_GAUSS_2' integration method.
   */
  TEST(Triangle2D3GaussPoint2, KratosCoreGeometriesFastSuite) {
    auto geom = GenerateNodesRightTriangle2D3();
    ...
    KRATOS_EXPECT_NEAR(CalculateAreaByIntegration(*geom, GeometryData::IntegrationMethod::GI_GAUSS_2), ExpectedArea, TOLERANCE);
   ...
   * Tests the area using 'GI_GAUSS_3' integration method.
   */
  TEST(Triangle2D3GaussPoint3, KratosCoreGeometriesFastSuite) {
    auto geom = GenerateNodesRightTriangle2D3();
    ...
    KRATOS_EXPECT_NEAR(CalculateAreaByIntegration(*geom, GeometryData::IntegrationMethod::GI_GAUSS_3), ExpectedArea, TOLERANCE);
   ...
   * Tests the area using 'GI_GAUSS_4' integration method.
   */
  TEST(Triangle2D3GaussPoint4, KratosCoreGeometriesFastSuite) {
    auto geom = GenerateNodesRightTriangle2D3();
    ...
    KRATOS_EXPECT_NEAR(CalculateAreaByIntegration(*geom, GeometryData::IntegrationMethod::GI_GAUSS_4), ExpectedArea, TOLERANCE);
   ...
   * Tests the area using 'GI_GAUSS_5' integration method.
   */
  TEST(Triangle2D3GaussPoint5, KratosCoreGeometriesFastSuite) {
    auto geom = GenerateNodesRightTriangle2D3();
    ...
    KRATOS_EXPECT_NEAR(CalculateAreaByIntegration(*geom, GeometryData::IntegrationMethod::GI_GAUSS_5), ExpectedArea, TOLERANCE);
   ...
   * Tests the Jacobian determinants using 'GI_GAUSS_1' integration method.
   */
  TEST(Triangle2D3DeterminantOfJacobianArray1, KratosCoreGeometriesFastSuite) {
    auto geom = GeneratePointsRightTriangle2D3();
   ...
   * Tests the Jacobian determinants using 'GI_GAUSS_2' integration method.
   */
  TEST(Triangle2D3DeterminantOfJacobianArray2, KratosCoreGeometriesFastSuite) {
    auto geom = GeneratePointsRightTriangle2D3();
    const double ExpectedJacobian = 1.0;
   ...
   * Tests the Jacobian determinants using 'GI_GAUSS_3' integration method.
   */
  TEST(Triangle2D3DeterminantOfJacobianArray3, KratosCoreGeometriesFastSuite) {
    auto geom = GeneratePointsRightTriangle2D3();
    const double ExpectedJacobian = 1.0;
   ...
   * Tests the Jacobian determinants using 'GI_GAUSS_4' integration method.
   */
  TEST(Triangle2D3DeterminantOfJacobianArray4, KratosCoreGeometriesFastSuite) {
    auto geom = GeneratePointsRightTriangle2D3();
    const double ExpectedJacobian = 1.0;
   ...
   * Tests the Jacobian determinants using 'GI_GAUSS_5' integration method.
   */
  TEST(Triangle2D3DeterminantOfJacobianArray5, KratosCoreGeometriesFastSuite) {
    auto geom = GeneratePointsRightTriangle2D3();
    const double ExpectedJacobian = 1.0;
   ...
   * Tests the Jacobian determinants using 'GI_GAUSS_1' integration method.
   */
  TEST(Triangle2D3DeterminantOfJacobianIndex1, KratosCoreGeometriesFastSuite) {
    auto geom = GeneratePointsRightTriangle2D3();
    const double ExpectedJacobian = 1.0;
   ...
   * Tests the Jacobian determinants using 'GI_GAUSS_2' integration method.
   */
  TEST(Triangle2D3DeterminantOfJacobianIndex2, KratosCoreGeometriesFastSuite) {
    auto geom = GeneratePointsRightTriangle2D3();
   ...
   * Tests the Jacobian determinants using 'GI_GAUSS_3' integration method.
   */
  TEST(Triangle2D3DeterminantOfJacobianIndex3, KratosCoreGeometriesFastSuite) {
    auto geom = GeneratePointsRightTriangle2D3();
    double JacobianDeterminant = 0.0;
    const double ExpectedJacobian = 1.0;
   ...
   * Tests the Jacobian determinants using 'GI_GAUSS_4' integration method.
   */
  TEST(Triangle2D3DeterminantOfJacobianIndex4, KratosCoreGeometriesFastSuite) {
    auto geom = GeneratePointsRightTriangle2D3();
    double JacobianDeterminant = 0.0;
    const double ExpectedJacobian = 1.0;
   ...
   * Tests the Jacobian determinants using 'GI_GAUSS_4' integration method.
   */
  TEST(Triangle2D3DeterminantOfJacobianIndex5, KratosCoreGeometriesFastSuite) {
    auto geom = GeneratePointsRightTriangle2D3();
    double JacobianDeterminant = 0.0;
    const double ExpectedJacobian = 1.0;
     ...
     */
    TEST(Triangle2D3IntersectionBoxEdge, KratosCoreGeometriesFastSuite) {
        auto geom = GeneratePointsRightTriangle2D3();
     ...
     */
    TEST(Triangle2D3IntersectionBoxNode, KratosCoreGeometriesFastSuite) {
        auto geom = GeneratePointsRightTriangle2D3();
     ...
     */
    TEST(Triangle2D3IntersectionBoxInside, KratosCoreGeometriesFastSuite) {
        auto geom = GeneratePointsRightTriangle2D3();
        Point point_1( 0.1, 0.1, 0.0);
     ...
     */
    TEST(Triangle2D3IntersectionBoxNoIntersect, KratosCoreGeometriesFastSuite) {
        auto geom = GeneratePointsRightTriangle2D3();
     ...
     */
    TEST(Triangle2D3IntersectionBoxOutsidePlane, KratosCoreGeometriesFastSuite) {
        auto geom = GeneratePointsRightTriangle2D3();
    ...
    TEST(Triangle2D3ShapeFunctionsValues, KratosCoreGeometriesFastSuite) {
      auto geom = GenerateNodesRightTriangle2D3();
    ...
    TEST(Triangle2D3ShapeFunctionsLocalGradients, KratosCoreGeometriesFastSuite) {
      auto geom = GenerateNodesRightTriangle2D3();
      TestAllShapeFunctionsLocalGradients(*geom);
    }

    TEST(Triangle2D3Normal, KratosCoreGeometriesFastSuite) {
        ...
        KRATOS_EXPECT_NEAR(normal[0], 0.0, TOLERANCE);
        KRATOS_EXPECT_NEAR(normal[1], 0.0, TOLERANCE);
        KRATOS_EXPECT_NEAR(normal[2], 0.5, TOLERANCE);
