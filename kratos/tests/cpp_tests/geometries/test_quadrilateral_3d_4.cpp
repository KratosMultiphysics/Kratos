...
namespace Testing
{
    ...
    */
    KRATOS_TEST_CASE_IN_SUITE(Quadrilateral3D4Edges, KratosCoreGeometriesFastSuite)
    {
        ...
        KRATOS_CHECK_NEAR((p_geom->Edges()[2])[1].X(), (p_geom->pGetPoint(3))->X(), TOLERANCE);
        KRATOS_CHECK_NEAR((p_geom->Edges()[2])[1].Y(), (p_geom->pGetPoint(3))->Y(), TOLERANCE);
        KRATOS_CHECK_NEAR((p_geom->Edges()[2])[1].Z(), (p_geom->pGetPoint(3))->Z(), TOLERANCE);

        KRATOS_CHECK_NEAR((p_geom->Edges()[3])[0].X(), (p_geom->pGetPoint(3))->X(), TOLERANCE);
        KRATOS_CHECK_NEAR((p_geom->Edges()[3])[0].Y(), (p_geom->pGetPoint(3))->Y(), TOLERANCE);
        KRATOS_CHECK_NEAR((p_geom->Edges()[3])[0].Z(), (p_geom->pGetPoint(3))->Z(), TOLERANCE);

        KRATOS_CHECK_NEAR((p_geom->Edges()[3])[1].X(), (p_geom->pGetPoint(0))->X(), TOLERANCE);
        KRATOS_CHECK_NEAR((p_geom->Edges()[3])[1].Y(), (p_geom->pGetPoint(0))->Y(), TOLERANCE);
        KRATOS_CHECK_NEAR((p_geom->Edges()[3])[1].Z(), (p_geom->pGetPoint(0))->Z(), TOLERANCE);
    }
    ...
    */
    KRATOS_TEST_CASE_IN_SUITE(Quadrilateral3D4Faces, KratosCoreGeometriesFastSuite) {
        ...
        KRATOS_CHECK_NEAR((p_geom->Faces()[0])[3].X(), (p_geom->pGetPoint(3))->X(), TOLERANCE);
        KRATOS_CHECK_NEAR((p_geom->Faces()[0])[3].Y(), (p_geom->pGetPoint(3))->Y(), TOLERANCE);
        KRATOS_CHECK_NEAR((p_geom->Faces()[0])[3].Z(), (p_geom->pGetPoint(3))->Z(), TOLERANCE);

        KRATOS_CHECK_NEAR((p_geom->Faces()[1])[0].X(), (p_geom->pGetPoint(3))->X(), TOLERANCE);
        KRATOS_CHECK_NEAR((p_geom->Faces()[1])[0].Y(), (p_geom->pGetPoint(3))->Y(), TOLERANCE);
        KRATOS_CHECK_NEAR((p_geom->Faces()[1])[0].Z(), (p_geom->pGetPoint(3))->Z(), TOLERANCE);

        KRATOS_CHECK_NEAR((p_geom->Faces()[1])[1].X(), (p_geom->pGetPoint(2))->X(), TOLERANCE);
        KRATOS_CHECK_NEAR((p_geom->Faces()[1])[1].Y(), (p_geom->pGetPoint(2))->Y(), TOLERANCE);
        KRATOS_CHECK_NEAR((p_geom->Faces()[1])[1].Z(), (p_geom->pGetPoint(2))->Z(), TOLERANCE);

        KRATOS_CHECK_NEAR((p_geom->Faces()[1])[2].X(), (p_geom->pGetPoint(1))->X(), TOLERANCE);
        KRATOS_CHECK_NEAR((p_geom->Faces()[1])[2].Y(), (p_geom->pGetPoint(1))->Y(), TOLERANCE);
        KRATOS_CHECK_NEAR((p_geom->Faces()[1])[2].Z(), (p_geom->pGetPoint(1))->Z(), TOLERANCE);

        KRATOS_CHECK_NEAR((p_geom->Faces()[1])[3].X(), (p_geom->pGetPoint(0))->X(), TOLERANCE);
        KRATOS_CHECK_NEAR((p_geom->Faces()[1])[3].Y(), (p_geom->pGetPoint(0))->Y(), TOLERANCE);
        KRATOS_CHECK_NEAR((p_geom->Faces()[1])[3].Z(), (p_geom->pGetPoint(0))->Z(), TOLERANCE);
    }
