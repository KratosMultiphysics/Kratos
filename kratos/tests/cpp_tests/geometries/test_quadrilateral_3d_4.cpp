...
namespace Testing
{
    ...
    * Checks if the number of edges is correct.
    */
    TEST(Quadrilateral3D4EdgesNumber, KratosCoreGeometriesFastSuite)
    {
    ...
    * Checks if the number of edges is correct.
    */
    TEST(Quadrilateral3D4Edges, KratosCoreGeometriesFastSuite)
    {
    ...
    * Checks if the number of faces is correct.
    */
    TEST(Quadrilateral3D4FacesNumber, KratosCoreGeometriesFastSuite)
    {
        auto geom = GenerateRightQuadrilateral3D4<Node<3>>();
    ...
    * Checks if the faces are correct.
    */
    TEST(Quadrilateral3D4Faces, KratosCoreGeometriesFastSuite) {
        auto p_geom = GenerateRightQuadrilateral3D4<Node<3>>();
    ...
    */
     ...
     * Tests the PointLocalCoordinates for Quadrilateral2D4.
     */
    TEST(Quadrilateral3D4PointLocalCoordinates, KratosCoreGeometriesFastSuite) {
    ...
    TEST(Quadrilateral3D4ShapeFunctionsValues, KratosCoreGeometriesFastSuite) {
      auto geom = GenerateFlatQuadrilateral3D4<Node<3>>();
    ...
    TEST(Quadrilateral3D4ShapeFunctionsLocalGradients, KratosCoreGeometriesFastSuite) {
        auto geom = GenerateFlatQuadrilateral3D4<Node<3>>();
        TestAllShapeFunctionsLocalGradients(*geom);
    }

    TEST(Quadrilateral3D4CoplanarPointIntersection, KratosCoreGeometriesFastSuite) {
    ...
    TEST(Quadrilateral3D4EdgeIntersection, KratosCoreGeometriesFastSuite) {
        Quadrilateral3D4<Point > quadrilateral_1(
            std::make_shared<Point>(0.0, 0.0, 0.0),
            std::make_shared<Point>(10., 0.0, 2.0),
            std::make_shared<Point>(0.0, 1.0, 0.0),
    ...
    TEST(Quadrilateral3D4InsideIntersection, KratosCoreGeometriesFastSuite) {
        Quadrilateral3D4<Point > quadrilateral_1(
            std::make_shared<Point>(0.0, 0.0, 0.0),
    ...
    * Checks the ProjectionPoint test for a given point respect to the quadrilateral
    */
    TEST(Quadrilateral3D4ProjectionPoint, KratosCoreGeometriesFastSuite) {
...
//     */
//     TEST(Quadrilateral3D4Volume, KratosCoreGeometriesFastSuite)
//     {
//         auto geom = GenerateRightQuadrilateral3D4<Node<3>>();
//
...
//     */
//     TEST(Quadrilateral3D4IsInside, KratosCoreGeometriesFastSuite)
//     {
//         auto geom = GenerateRightQuadrilateral3D4<Node<3>>();
//
...
//     * Tests the Jacobian determinants using 'GI_GAUSS_1' integration method.
//     */
//     TEST(Quadrilateral3D4DeterminantOfJacobianArray1, KratosCoreGeometriesFastSuite)
//     {
//         auto geom = GenerateRightQuadrilateral3D4<Node<3>>();
...
//     * Tests the Jacobian determinants using 'GI_GAUSS_2' integration method.
//     */
//     TEST(Quadrilateral3D4DeterminantOfJacobianArray2, KratosCoreGeometriesFastSuite)
//     {
//         auto geom = GenerateRightQuadrilateral3D4<Node<3>>();
//         const double ExpectedJacobian = 1.0;
//
...
//     * Tests the Jacobian determinants using 'GI_GAUSS_3' integration method.
//     */
//     TEST(Quadrilateral3D4DeterminantOfJacobianArray3, KratosCoreGeometriesFastSuite)
//     {
//         auto geom = GenerateRightQuadrilateral3D4<Node<3>>();
//         const double ExpectedJacobian = 1.0;
//
...
//     * Tests the Jacobian determinants using 'GI_GAUSS_4' integration method.
//     */
//     TEST(Quadrilateral3D4DeterminantOfJacobianArray4, KratosCoreGeometriesFastSuite)
//     {
//         auto geom = GenerateRightQuadrilateral3D4<Node<3>>();
//         const double ExpectedJacobian = 1.0;
//
...
//     * Tests the Jacobian determinants using 'GI_GAUSS_5' integration method.
//     */
//     TEST(Quadrilateral3D4DeterminantOfJacobianArray5, KratosCoreGeometriesFastSuite)
//     {
//         auto geom = GenerateRightQuadrilateral3D4<Node<3>>();
//         const double ExpectedJacobian = 1.0;
//
...
//     * Tests the Jacobian determinants using 'GI_GAUSS_1' integration method.
//     */
//     TEST(Quadrilateral3D4DeterminantOfJacobianIndex1, KratosCoreGeometriesFastSuite)
//     {
//         auto geom = GenerateRightQuadrilateral3D4<Node<3>>();
//         const double ExpectedJacobian = 1.0;
//
...
//     * Tests the Jacobian determinants using 'GI_GAUSS_2' integration method.
//     */
//     TEST(Quadrilateral3D4DeterminantOfJacobianIndex2, KratosCoreGeometriesFastSuite)
//     {
//         auto geom = GenerateRightQuadrilateral3D4<Node<3>>();
...
//     * Tests the Jacobian determinants using 'GI_GAUSS_3' integration method.
//     */
//     TEST(Quadrilateral3D4DeterminantOfJacobianIndex3, KratosCoreGeometriesFastSuite)
//     {
//         auto geom = GenerateRightQuadrilateral3D4<Node<3>>();
//         double JacobianDeterminant = 0.0;
//         const double ExpectedJacobian = 1.0;
...
//     * Tests the Jacobian determinants using 'GI_GAUSS_4' integration method.
//     */
//     TEST(Quadrilateral3D4DeterminantOfJacobianIndex4, KratosCoreGeometriesFastSuite)
//     {
//         auto geom = GenerateRightQuadrilateral3D4<Node<3>>();
//         double JacobianDeterminant = 0.0;
//         const double ExpectedJacobian = 1.0;
...
//     * Tests the Jacobian determinants using 'GI_GAUSS_4' integration method.
//     */
//     TEST(Quadrilateral3D4DeterminantOfJacobianIndex5, KratosCoreGeometriesFastSuite)
//     {
//         auto geom = GenerateRightQuadrilateral3D4<Node<3>>();
//         double JacobianDeterminant = 0.0;
//         const double ExpectedJacobian = 1.0;
