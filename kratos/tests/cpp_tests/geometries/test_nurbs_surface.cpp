...
namespace Testing {
    ...
    ///// Tests
    TEST(NurbsSurfacePoint, KratosCoreNurbsGeometriesFastSuite) {
        auto surface = GenerateReferencePointSurface();

        // Check general information, input to ouput
        KRATOS_EXPECT_EQ(surface.Dimension(), 2);
    ...
    TEST(NurbsSurfaceCylinder, KratosCoreNurbsGeometriesFastSuite) {
    ...
    TEST(NurbsSurfaceNode, KratosCoreNurbsGeometriesFastSuite) {
    ...
    TEST(NurbsSurfaceCreateIntegrationPoints, KratosCoreNurbsGeometriesFastSuite) {
        auto surface = GenerateReferenceNodeSurface();
    ...
    TEST(NurbsSurfaceQuadraturePointGeometries, KratosCoreNurbsGeometriesFastSuite) {
        auto surface = GenerateReferenceNodeSurface();
    ...
    TEST(NurbsSurfaceRefinementU, KratosCoreNurbsGeometriesFastSuite) {
        auto surface = GenerateReferenceNodeSurface();
    ...
    TEST(NurbsSurfaceRefinementV, KratosCoreNurbsGeometriesFastSuite) {
        auto surface = GenerateReferenceNodeSurface();
    ...
    TEST(NurbsSurfaceDegreeElevationU, KratosCoreNurbsGeometriesFastSuite) {
        auto surface = GenerateReferenceNodeSurface();
    ...
    TEST(NurbsSurfaceDegreeElevationV, KratosCoreNurbsGeometriesFastSuite) {
        auto surface = GenerateReferenceNodeSurface();
    ...
    TEST(NurbsSurfaceQuarterSphere, KratosCoreNurbsGeometriesFastSuite) {
