...
namespace Testing {
    ...
    * Checks if the number of edges is correct.
    */
    TEST(Line3D2EdgesNumber, KratosCoreGeometriesFastSuite) {
    ...
    * Checks if the edges are correct.
    */
    TEST(Line3D2Edges, KratosCoreGeometriesFastSuite) {
    ...
    * Checks if the number of faces is correct.
    */
    TEST(Line3D2FacesNumber, KratosCoreGeometriesFastSuite) {
        Geometry<Point>::Pointer p_geom = GeneratePointsUnitXDirectionLine3D2();
    ...
    * Checks if the length of the line is calculated correctly.
    */
    TEST(LengthLine3D2, KratosCoreGeometriesFastSuite) {
    ...
    */
    TEST(Line3D2IsInside, KratosCoreGeometriesFastSuite) {
        Geometry<Point>::Pointer p_geom = GeneratePointsDiagonalLine3D2();
    ...
    * solution.
    */
    TEST(Line3D2PointLocalCoordinates, KratosCoreGeometriesFastSuite) {
        Geometry<Point>::Pointer p_geom = GeneratePointsDiagonalLine3D2();
    ...
    * Tests the Jacobian determinants using 'GI_GAUSS_1' integration method.
    */
    TEST(Line3D2DeterminantOfJacobianArray1, KratosCoreGeometriesFastSuite) {
        Geometry<Point>::Pointer p_geom = GeneratePointsUnitXDirectionLine3D2();
    ...
    * Tests the Jacobian determinants using 'GI_GAUSS_2' integration method.
    */
    TEST(Line3D2DeterminantOfJacobianArray2, KratosCoreGeometriesFastSuite) {
        Geometry<Point>::Pointer p_geom = GeneratePointsUnitXDirectionLine3D2();
        const double ExpectedJacobian = 0.5;
    ...
    * Tests the Jacobian determinants using 'GI_GAUSS_3' integration method.
    */
    TEST(Line3D2DeterminantOfJacobianArray3, KratosCoreGeometriesFastSuite) {
        Geometry<Point>::Pointer p_geom = GeneratePointsUnitXDirectionLine3D2();
        const double ExpectedJacobian = 0.5;
    ...
    * Tests the Jacobian determinants using 'GI_GAUSS_4' integration method.
    */
    TEST(Line3D2DeterminantOfJacobianArray4, KratosCoreGeometriesFastSuite) {
    ...
    * Tests the Jacobian determinants using 'GI_GAUSS_5' integration method.
    */
    TEST(Line3D2DeterminantOfJacobianArray5, KratosCoreGeometriesFastSuite) {
        Geometry<Point>::Pointer p_geom = GeneratePointsUnitXDirectionLine3D2();
        const double ExpectedJacobian = 0.5;
    ...
    * Tests the Jacobian determinants using 'GI_GAUSS_1' integration method.
    */
    TEST(Line3D2DeterminantOfJacobianIndex1, KratosCoreGeometriesFastSuite) {
        Geometry<Point>::Pointer p_geom = GeneratePointsUnitXDirectionLine3D2();
        const double ExpectedJacobian = 0.5;
    ...
    * Tests the Jacobian determinants using 'GI_GAUSS_2' integration method.
    */
    TEST(Line3D2DeterminantOfJacobianIndex2, KratosCoreGeometriesFastSuite) {
        Geometry<Point>::Pointer p_geom = GeneratePointsUnitXDirectionLine3D2();
    ...
    * Tests the Jacobian determinants using 'GI_GAUSS_3' integration method.
    */
    TEST(Line3D2DeterminantOfJacobianIndex3, KratosCoreGeometriesFastSuite) {
        Geometry<Point>::Pointer p_geom = GeneratePointsUnitXDirectionLine3D2();
        double JacobianDeterminant = 0.0;
        const double ExpectedJacobian = 0.5;
    ...
    * Tests the Jacobian determinants using 'GI_GAUSS_4' integration method.
    */
    TEST(Line3D2DeterminantOfJacobianIndex4, KratosCoreGeometriesFastSuite) {
        Geometry<Point>::Pointer p_geom = GeneratePointsUnitXDirectionLine3D2();
        double JacobianDeterminant = 0.0;
        const double ExpectedJacobian = 0.5;
    ...
    * Tests the Jacobian determinants using 'GI_GAUSS_4' integration method.
    */
    TEST(Line3D2DeterminantOfJacobianIndex5, KratosCoreGeometriesFastSuite) {
        Geometry<Point>::Pointer p_geom = GeneratePointsUnitXDirectionLine3D2();
        double JacobianDeterminant = 0.0;
        const double ExpectedJacobian = 0.5;
    ...
    TEST(Line3D2ShapeFunctionValue, KratosCoreGeometriesFastSuite) {
        Geometry<Point>::Pointer p_geom = GeneratePointsDiagonalLine3D2();
    ...
    TEST(Line3D2ShapeFunctionsValues, KratosCoreGeometriesFastSuite) {
        Geometry<Point>::Pointer p_geom = GeneratePointsDiagonalLine3D2();
        array_1d<double, 3> coord(3);
        coord[0] = 2.0/3.0;
        coord[1] = 2.0/3.0;
    ...
    TEST(Line3D2ShapeFunctionsValuesMatrix, KratosCoreGeometriesFastSuite) {
    ...
    TEST(Line3D2ShapeFunctionsLocalGradients, KratosCoreGeometriesFastSuite) {
        Geometry<Point>::Pointer p_geom = GeneratePointsDiagonalLine3D2();
        auto& r_geom = *p_geom;
        Geometry<Node<3>>::Pointer p_geom_nodes = Kratos::make_shared<Line3D2<Node<3>>>(
        Kratos::make_intrusive<Node<3>>(1, r_geom[0].X(), r_geom[0].Y(), r_geom[0].Z()),
