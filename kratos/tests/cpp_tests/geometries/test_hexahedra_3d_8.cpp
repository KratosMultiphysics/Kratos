...
namespace Kratos {
     ...
     * Checks if the number of edges is correct.
     */
    TEST(Hexahedra3D8EdgesNumber, KratosCoreGeometriesFastSuite) {
     ...
     * Checks if the number of faces is correct.
     */
    TEST(Hexahedra3D8FacesNumber, KratosCoreGeometriesFastSuite) {
      auto geomRegLen1 = GenerateOriginCenterLen1Hexahedra3D8();
      auto geomRegLen2 = GenerateOriginCenterLen2Hexahedra3D8();
     ...
     * Checks if the characteristic length of the hexahedra is calculated correctly.
     */
    TEST(Hexahedra3D8Length, KratosCoreGeometriesFastSuite) {
      auto geomRegLen1 = GenerateOriginCenterLen1Hexahedra3D8();
      auto geomRegLen2 = GenerateOriginCenterLen2Hexahedra3D8();
     ...
     * Checks if the area of the hexahedra is calculated correctly.
     */
    TEST(Hexahedra3D8Area, KratosCoreGeometriesFastSuite) {
      auto geomRegLen1 = GenerateOriginCenterLen1Hexahedra3D8();
      auto geomRegLen2 = GenerateOriginCenterLen2Hexahedra3D8();
     ...
     */
    TEST(Hexahedra3D8Volume, KratosCoreGeometriesFastSuite) {
      auto geomRegLen1 = GenerateOriginCenterLen1Hexahedra3D8();
      auto geomRegLen2 = GenerateOriginCenterLen2Hexahedra3D8();
     ...
     */
    TEST(Hexahedra3D8BoxIntersection, KratosCoreGeometriesFastSuite) {
    ...
    */
    TEST(Hexahedra3D8IsInside, KratosCoreGeometriesFastSuite) {
    ...
    * solution.
    */
    TEST(Hexahedra3D8PointLocalCoordinates, KratosCoreGeometriesFastSuite) {
  ...
  TEST(Hexahedra3D8ShapeFunctionsValues, KratosCoreGeometriesFastSuite) {
      auto geom = GenerateOriginCenterLen2Hexahedra3D8();
  ...
  TEST(Hexahedra3D8ShapeFunctionsLocalGradients, KratosCoreGeometriesFastSuite) {
      auto geom = GenerateOriginCenterLen2Hexahedra3D8();
