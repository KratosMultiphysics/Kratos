...
namespace Testing {
    ...
    * Checks if the number of edges is correct.
    */
    TEST(Line2D4EdgesNumber, KratosCoreGeometriesFastSuite) {
    ...
    * Checks if the number of faces is correct.
    */
    TEST(Line2D4FacesNumber, KratosCoreGeometriesFastSuite) {
        auto p_geometry = GeneratePointsUnitXDirectionLine2D4();
    ...
    * Checks if the length of the line is calculated correctly.
    */
    TEST(LengthLine2D4, KratosCoreGeometriesFastSuite) {
    ...
    * Checks if the bounding box of the line is calculated correctly.
    */
    TEST(BoundingBoxLine2D4, KratosCoreGeometriesFastSuite) {
    ...
    */
    TEST(Line2D4IsInside, KratosCoreGeometriesFastSuite) {
        auto p_geometry = GeneratePointsDiagonalLine2D4();
    ...
    * solution.
    */
    TEST(Line2D4PointLocalCoordinates, KratosCoreGeometriesFastSuite) {
        auto p_geometry = GeneratePointsDiagonalLine2D4();
    ...
    * Tests the Jacobian determinants using 'GI_GAUSS_1' integration method.
    */
    TEST(Line2D4DeterminantOfJacobianArray1, KratosCoreGeometriesFastSuite) {
        auto p_geometry = GeneratePointsUnitXDirectionLine2D4();
    ...
    * Tests the Jacobian determinants using 'GI_GAUSS_2' integration method.
    */
    TEST(Line2D4DeterminantOfJacobianArray2, KratosCoreGeometriesFastSuite) {
        auto p_geometry = GeneratePointsUnitXDirectionLine2D4();
        const double expected_jacobian = 0.5;
    ...
    * Tests the Jacobian determinants using 'GI_GAUSS_3' integration method.
    */
    TEST(Line2D4DeterminantOfJacobianArray3, KratosCoreGeometriesFastSuite) {
        auto p_geometry = GeneratePointsUnitXDirectionLine2D4();
        const double expected_jacobian = 0.5;
    ...
    * Tests the Jacobian determinants using 'GI_GAUSS_4' integration method.
    */
    TEST(Line2D4DeterminantOfJacobianArray4, KratosCoreGeometriesFastSuite) {
        auto p_geometry = GeneratePointsUnitXDirectionLine2D4();
        const double expected_jacobian = 0.5;
    ...
    * Tests the Jacobian determinants using 'GI_GAUSS_5' integration method.
    */
    TEST(Line2D4DeterminantOfJacobianArray5, KratosCoreGeometriesFastSuite) {
        auto p_geometry = GeneratePointsUnitXDirectionLine2D4();
        const double expected_jacobian = 0.5;
    ...
    * Tests the Jacobian determinants using 'GI_GAUSS_1' integration method.
    */
    TEST(Line2D4DeterminantOfJacobianIndex1, KratosCoreGeometriesFastSuite) {
        auto p_geometry = GeneratePointsUnitXDirectionLine2D4();
        const double expected_jacobian = 0.5;
    ...
    * Tests the Jacobian determinants using 'GI_GAUSS_2' integration method.
    */
    TEST(Line2D4DeterminantOfJacobianIndex2, KratosCoreGeometriesFastSuite) {
        auto p_geometry = GeneratePointsUnitXDirectionLine2D4();
    ...
    * Tests the Jacobian determinants using 'GI_GAUSS_3' integration method.
    */
    TEST(Line2D4DeterminantOfJacobianIndex3, KratosCoreGeometriesFastSuite) {
        auto p_geometry = GeneratePointsUnitXDirectionLine2D4();
        double jacobian_determinant = 0.0;
        const double expected_jacobian = 0.5;
    ...
    * Tests the Jacobian determinants using 'GI_GAUSS_4' integration method.
    */
    TEST(Line2D4DeterminantOfJacobianIndex4, KratosCoreGeometriesFastSuite) {
        auto p_geometry = GeneratePointsUnitXDirectionLine2D4();
        double jacobian_determinant = 0.0;
        const double expected_jacobian = 0.5;
    ...
    * Tests the Jacobian determinants using 'GI_GAUSS_4' integration method.
    */
    TEST(Line2D4DeterminantOfJacobianIndex5, KratosCoreGeometriesFastSuite) {
        auto p_geometry = GeneratePointsUnitXDirectionLine2D4();
        double jacobian_determinant = 0.0;
        const double expected_jacobian = 0.5;
    ...
    TEST(Line2D4ShapeFunctionsValues, KratosCoreGeometriesFastSuite) {
        auto p_geometry = GeneratePointsParabolaLine2D4();
        auto& r_geom = *p_geometry;
        auto p_p_geom_nodes = Kratos::make_shared<Line2D4<Node<3>>>(
    ...
    TEST(Line2D4ShapeFunctionsValuesMatrix, KratosCoreGeometriesFastSuite) {
    ...
    TEST(Line2D4ShapeFunctionsLocalGradients, KratosCoreGeometriesFastSuite) {
        auto p_geometry = GeneratePointsParabolaLine2D4();
        auto& r_geom = *p_geometry;
        auto p_p_geom_nodes = Kratos::make_shared<Line2D4<Node<3>>>(
        Kratos::make_intrusive<Node<3>>(1, r_geom[0].X(), r_geom[0].Y(), r_geom[0].Z()),
