...
namespace Testing {
    ...
    * Checks if the number of edges is correct.
    */
    TEST(Line2D5EdgesNumber, KratosCoreGeometriesFastSuite) {
    ...
    * Checks if the number of faces is correct.
    */
    TEST(Line2D5FacesNumber, KratosCoreGeometriesFastSuite) {
        auto p_geometry = GeneratePointsUnitXDirectionLine2D5();
    ...
    * Checks if the length of the line is calculated correctly.
    */
    TEST(LengthLine2D5, KratosCoreGeometriesFastSuite) {
    ...
    * Checks if the bounding box of the line is calculated correctly.
    */
    TEST(BoundingBoxLine2D5, KratosCoreGeometriesFastSuite) {
    ...
    */
    TEST(Line2D5IsInside, KratosCoreGeometriesFastSuite) {
        auto p_geometry = GeneratePointsDiagonalLine2D5();
    ...
    * solution.
    */
    TEST(Line2D5PointLocalCoordinates, KratosCoreGeometriesFastSuite) {
        auto p_geometry = GeneratePointsDiagonalLine2D5();
    ...
    * Tests the Jacobian determinants using 'GI_GAUSS_1' integration method.
    */
    TEST(Line2D5DeterminantOfJacobianArray1, KratosCoreGeometriesFastSuite) {
        auto p_geometry = GeneratePointsUnitXDirectionLine2D5();
    ...
    * Tests the Jacobian determinants using 'GI_GAUSS_2' integration method.
    */
    TEST(Line2D5DeterminantOfJacobianArray2, KratosCoreGeometriesFastSuite) {
        auto p_geometry = GeneratePointsUnitXDirectionLine2D5();
        const double expected_jacobian = 0.5;
    ...
    * Tests the Jacobian determinants using 'GI_GAUSS_3' integration method.
    */
    TEST(Line2D5DeterminantOfJacobianArray3, KratosCoreGeometriesFastSuite) {
        auto p_geometry = GeneratePointsUnitXDirectionLine2D5();
        const double expected_jacobian = 0.5;
    ...
    * Tests the Jacobian determinants using 'GI_GAUSS_4' integration method.
    */
    TEST(Line2D5DeterminantOfJacobianArray4, KratosCoreGeometriesFastSuite) {
        auto p_geometry = GeneratePointsUnitXDirectionLine2D5();
        const double expected_jacobian = 0.5;
    ...
    * Tests the Jacobian determinants using 'GI_GAUSS_5' integration method.
    */
    TEST(Line2D5DeterminantOfJacobianArray5, KratosCoreGeometriesFastSuite) {
        auto p_geometry = GeneratePointsUnitXDirectionLine2D5();
        const double expected_jacobian = 0.5;
    ...
    * Tests the Jacobian determinants using 'GI_GAUSS_1' integration method.
    */
    TEST(Line2D5DeterminantOfJacobianIndex1, KratosCoreGeometriesFastSuite) {
        auto p_geometry = GeneratePointsUnitXDirectionLine2D5();
        const double expected_jacobian = 0.5;
    ...
    * Tests the Jacobian determinants using 'GI_GAUSS_2' integration method.
    */
    TEST(Line2D5DeterminantOfJacobianIndex2, KratosCoreGeometriesFastSuite) {
        auto p_geometry = GeneratePointsUnitXDirectionLine2D5();
    ...
    * Tests the Jacobian determinants using 'GI_GAUSS_3' integration method.
    */
    TEST(Line2D5DeterminantOfJacobianIndex3, KratosCoreGeometriesFastSuite) {
        auto p_geometry = GeneratePointsUnitXDirectionLine2D5();
        double jacobian_determinant = 0.0;
        const double expected_jacobian = 0.5;
    ...
    * Tests the Jacobian determinants using 'GI_GAUSS_4' integration method.
    */
    TEST(Line2D5DeterminantOfJacobianIndex4, KratosCoreGeometriesFastSuite) {
        auto p_geometry = GeneratePointsUnitXDirectionLine2D5();
        double jacobian_determinant = 0.0;
        const double expected_jacobian = 0.5;
    ...
    * Tests the Jacobian determinants using 'GI_GAUSS_4' integration method.
    */
    TEST(Line2D5DeterminantOfJacobianIndex5, KratosCoreGeometriesFastSuite) {
        auto p_geometry = GeneratePointsUnitXDirectionLine2D5();
        double jacobian_determinant = 0.0;
        const double expected_jacobian = 0.5;
    ...
    TEST(Line2D5ShapeFunctionsValues, KratosCoreGeometriesFastSuite) {
    ...
    TEST(Line2D5ShapeFunctionsValuesMatrix, KratosCoreGeometriesFastSuite) {
        ...
        KRATOS_CHECK_NEAR(N_values_geom(0, 0),  0.05059353334, TOLERANCE);
        KRATOS_CHECK_NEAR(N_values_geom(0, 1), -0.01355649641, TOLERANCE);
        KRATOS_CHECK_NEAR(N_values_geom(0, 2),  1.10579283200, TOLERANCE);
        KRATOS_CHECK_NEAR(N_values_geom(0, 3), -0.22222222160, TOLERANCE);
        KRATOS_CHECK_NEAR(N_values_geom(0, 4),  0.07939235315, TOLERANCE);
        KRATOS_CHECK_NEAR(N_values_geom(1, 0), -0.01355649641, TOLERANCE);
        KRATOS_CHECK_NEAR(N_values_geom(1, 1),  0.05059353334, TOLERANCE);
        KRATOS_CHECK_NEAR(N_values_geom(1, 2),  0.07939235315, TOLERANCE);
        KRATOS_CHECK_NEAR(N_values_geom(1, 3), -0.22222222160, TOLERANCE);
        KRATOS_CHECK_NEAR(N_values_geom(1, 4),  1.10579283200, TOLERANCE);
    }

    TEST(Line2D5ShapeFunctionsLocalGradients, KratosCoreGeometriesFastSuite) {
        auto p_geometry = GeneratePointsParabolaLine2D5();
        auto& r_geom = *p_geometry;
        auto p_p_geom_nodes = Kratos::make_shared<Line2D5<Node<3>>>(
        Kratos::make_intrusive<Node<3>>(1, r_geom[0].X(), r_geom[0].Y(), r_geom[0].Z()),
