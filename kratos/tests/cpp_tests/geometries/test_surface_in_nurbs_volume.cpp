...
namespace Testing {
    ...
    // Tests
    TEST(SurfaceInVolumeGeometryTriangleInCubeTest, KratosCoreNurbsGeometriesFastSuite)
    {
        // Get nurbs cube
        ...
        KRATOS_EXPECT_EQ( surface_in_volume.Dimension(), 2 );
        KRATOS_EXPECT_EQ( quad_geometries[0].Dimension(), 2 );
    ...
    TEST(SurfaceInVolumeGeometryQuadInCubeTest, KratosCoreNurbsGeometriesFastSuite)
    {
        auto p_nurbs_cube = GenerateCubeNurbsVolume();
    ...
    TEST(SurfaceInVolumeGeometryQuadInCuboidTest, KratosCoreNurbsGeometriesFastSuite)
    {
