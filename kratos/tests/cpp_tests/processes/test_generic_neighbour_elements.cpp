...
TEST_F(KernelTest, HexasGenericFindElementsNeighbourProcessTest)
{
...
TEST_F(KernelTest, TetrahedraGenericFindElementsNeighbourProcessTest)
{
    using namespace Kratos;
...
TEST_F(KernelTest, TrianglesQuadilateralsGenericFindElementsNeighbourProcessTest)
{
    using namespace Kratos;
