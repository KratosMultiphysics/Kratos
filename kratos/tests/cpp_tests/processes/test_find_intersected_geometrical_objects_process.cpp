...
{
    Node::Pointer p_point1(new Node(1, 0.0, 0.0, 0.0));
    Node::Pointer p_point2(new Node(2, 0.0, 1.0, 0.0));
    Node::Pointer p_point3(new Node(3, 1.0, 1.0, 0.0));
    Node::Pointer p_point4(new Node(4, 1.0, 0.0, 0.0));
