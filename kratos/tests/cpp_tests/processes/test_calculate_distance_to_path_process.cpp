...
namespace Kratos::Testing
{
    ...
    KRATOS_TEST_CASE_IN_SUITE(FastMinimalDistanceOnLineWithRadius, KratosCoreFastSuite)
	{
        ...
        auto process = CalculateDistanceToPathProcess<true>(current_model, empty_parameters);
        ...
        auto distance_computed_type = process.FastMinimalDistanceOnLineWithRadius(distance, *line, point1, radius);
        ...
        distance_computed_type = process.FastMinimalDistanceOnLineWithRadius(distance, *line, point2, radius);
        ...
        distance_computed_type = process.FastMinimalDistanceOnLineWithRadius(distance, *line, point3, radius);
        ...
        distance_computed_type = process.FastMinimalDistanceOnLineWithRadius(distance, *line, point4, radius);
