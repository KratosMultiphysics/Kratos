...
namespace Kratos::Testing
{
    ...
    TEST(FastMinimalDistanceOnLineWithRadius, KratosCoreFastSuite)
	{
        double distance;
        double radius = 0.0;
        ...
        KRATOS_EXPECT_EQ(distance_computed_type, DistanceComputed::NO_RADIUS);
        ...
        KRATOS_EXPECT_EQ(distance_computed_type, DistanceComputed::RADIUS_PROJECTED);
        ...
        KRATOS_EXPECT_EQ(distance_computed_type, DistanceComputed::RADIUS_NOT_PROJECTED_OUTSIDE);
        ...
        KRATOS_EXPECT_EQ(distance_computed_type, DistanceComputed::RADIUS_NOT_PROJECTED_INSIDE);
    }
}