...
namespace Kratos {
	namespace Testing {
		...
		TEST_F(KernelTest, Structured2DMeshCoarseningProcess)
		{
			Model current_model;
		...
		TEST_F(KernelTest, PerturbedStructured2DMeshCoarseningProcess)
		{
			Model current_model;
		...
		TEST_F(KernelTest, RedistributedStructured2DMeshCoarseningProcess)
		{
			Model current_model;
		...
		TEST_F(KernelTest, Structured3DMeshCoarseningProcess)
		{
			Model current_model;
