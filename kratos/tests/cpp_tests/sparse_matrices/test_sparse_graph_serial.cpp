...
// Basic Type
TEST(GraphConstruction, KratosCoreFastSuite)
{
...
TEST(GraphContiguousRowConstruction, KratosCoreFastSuite)
{
    const auto connectivities = SparseTestingInternals::ElementConnectivities();
    auto reference_A_map = SparseTestingInternals::GetReferenceMatrixAsMap();
...
TEST(CSRConstruction, KratosCoreFastSuite)
{
...
// Basic Type
TEST(OpenMPGraphContiguousRowConstruction, KratosCoreFastSuite)
{
...
TEST(PerformanceBenchmarkSparseGraph, KratosCoreFastSuite)
{
...
TEST(PerformanceBenchmarkSparseContiguousRowGraph, KratosCoreFastSuite)
{
...
TEST(SystemVectorAssembly, KratosCoreFastSuite)
{
...
TEST(SystemVectorOperations, KratosCoreFastSuite)
{
...
TEST(ToAMGCLMatrix, KratosCoreFastSuite)
{
    const auto connectivities = SparseTestingInternals::ElementConnectivities();
    auto reference_A_map = SparseTestingInternals::GetReferenceMatrixAsMap();
...
TEST(SmallRectangularMatricMatrixMultiply, KratosCoreFastSuite)
{
    // matrix A
    //[[1,0,0,7,2],
    // [0,3,0,0,0],
...
TEST(RectangularMatrixConstruction, KratosCoreFastSuite)
{
