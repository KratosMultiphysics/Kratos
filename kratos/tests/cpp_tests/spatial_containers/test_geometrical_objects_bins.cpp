...
namespace Testing {
    ...
    */
    TEST_F(KernelTest, GeometricalObjectsBinsBoundingBox) {
    ...
    */
    TEST_F(KernelTest, GeometricalObjectsBinsCellSizes) {
        constexpr double tolerance = 1e-12;
    ...
    */
    TEST_F(KernelTest, GeometricalObjectsBinsAddObjectsToCells) {
        Model current_model;
    ...
    */
    TEST_F(KernelTest, GeometricalObjectsBinsSearchInRadius) {
        Model current_model;
    ...
    */
    TEST_F(KernelTest, GeometricalObjectsBinsSearchNearestInRadius) {
        constexpr double tolerance = 1e-12;
    ...
    /** Checks bins search nearest
    */
    TEST_F(KernelTest, GeometricalObjectsBinsSearchNearest) {
        constexpr double tolerance = 1e-12;
    ...
    */
    TEST_F(KernelTest, GeometricalObjectsBinsEmptySearchNearest) {
        Model current_model;
    ...
    */
    TEST_F(KernelTest, GeometricalObjectsBinsSearchIsInside) {
        constexpr double tolerance = 1e-12;
    ...
    */
    TEST_F(KernelTest, GeometricalObjectsBinsSearchIsNotInside) {
        Model current_model;
