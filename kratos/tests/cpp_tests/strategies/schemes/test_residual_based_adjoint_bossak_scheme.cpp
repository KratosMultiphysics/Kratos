...
TEST_F(KernelTest, ResidualBasedAdjointBossak_TwoMassSpringDamperSystem_Elements)
{
    Model current_model;
...
TEST_F(KernelTest, ResidualBasedAdjointBossak_TwoMassSpringDamperSystem_Conditions)
{
    Model current_model;
