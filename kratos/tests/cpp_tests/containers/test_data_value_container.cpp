...
TEST(DataValueContainerHas, KratosCoreFastSuite) {
...
TEST(DataValueContainerHasComponent, KratosCoreFastSuite) {
    DataValueContainer container;
...
TEST(DataValueContainerSetComponentCheck, KratosCoreFastSuite) {
    DataValueContainer container;
...
TEST(DataValueContainer, KratosCoreFastSuite) {
    DataValueContainer container;
...
TEST(DataValueContainerComponent, KratosCoreFastSuite) {
    DataValueContainer container;
...
TEST(DataValueContainerMerge, KratosCoreFastSuite) {
...
TEST(DataValueContainerMergeOverride, KratosCoreFastSuite) {
    DataValueContainer container_origin;
    DataValueContainer container_target;
