...
TEST(ModelGetModelPart, KratosCoreFastSuite)
{
    Model model;
...
TEST(ModelHasModelPart, KratosCoreFastSuite)
{
    Model model;
...
TEST(ModelDeleteModelPart, KratosCoreFastSuite)
{
    Model model;
...
TEST(ModelRenameModelPart, KratosCoreFastSuite)
{
    Model model;
...
TEST(ModelGetModel, KratosCoreFastSuite)
{
    Model model;
...
TEST(ModelGetModelPartNames, KratosCoreFastSuite)
{
    Model model;
...
TEST(ModelCreateModelPart, KratosCoreFastSuite)
{
    Model model;
