...
TEST(VariablesListDataValueContainerHas, KratosCoreFastSuite) {
...
TEST(VariablesListDataValueContainerHasComponent, KratosCoreFastSuite) {
    VariablesList::Pointer p_variables_list=Kratos::make_intrusive<VariablesList>();
...
TEST(VariablesListDataValueContainerGetValue, KratosCoreFastSuite) {
    VariablesList::Pointer p_variables_list=Kratos::make_intrusive<VariablesList>();
...
TEST(VariablesListDataValueContainerAddComponent, KratosCoreFastSuite) {
    VariablesList::Pointer p_variables_list=Kratos::make_intrusive<VariablesList>();
...
TEST(VariablesListDataValueContainerGetComponentValue, KratosCoreFastSuite) {
    VariablesList::Pointer p_variables_list=Kratos::make_intrusive<VariablesList>();
