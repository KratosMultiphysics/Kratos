...
namespace Kratos {
    namespace Testing {
        ...
        KRATOS_TEST_CASE_IN_SUITE(LoggerMessageStream, KratosCoreFastSuite)
        {
            ...
            if (DataCommunicator::GetDefault().Rank() == 0) KRATOS_CHECK_STRING_EQUAL(message.GetMessage(), "Test message with number 12e00");
            ...
            KRATOS_CHECK_STRING_EQUAL(message.GetMessage(), "Test message with number 12e00\n");
