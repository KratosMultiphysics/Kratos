    ...
    namespace Testing 
    {
        ...
        */
        ...
        KRATOS_TEST_CASE_IN_SUITE(TestNodalGradient1, KratosNodalGradientFastSuite)
        {
            ...
            Triangle2D3 <NodeType> triangle_0( Geometry<NodeType>::PointsArrayType{element_nodes_0} );
            ...
            Triangle2D3 <NodeType> triangle_1( Geometry<NodeType>::PointsArrayType{element_nodes_1} );
            ...
            Triangle2D3 <NodeType> triangle_2( Geometry<NodeType>::PointsArrayType{element_nodes_2} );
            ...
            Triangle2D3 <NodeType> triangle_3( Geometry<NodeType>::PointsArrayType{element_nodes_3} );
...
//             GiDIODebugGradient(this_model_part);
        ...
        */
        ...
        KRATOS_TEST_CASE_IN_SUITE(TestNodalGradient2, KratosNodalGradientFastSuite)
        {
            ...
            Tetrahedra3D4 <NodeType> tetrahedra_0( Geometry<NodeType>::PointsArrayType{element_nodes_0} );
            ...
            Tetrahedra3D4 <NodeType> tetrahedra_1( Geometry<NodeType>::PointsArrayType{element_nodes_1} );
            ...
            Tetrahedra3D4 <NodeType> tetrahedra_2( Geometry<NodeType>::PointsArrayType{element_nodes_2} );
            ...
            Tetrahedra3D4 <NodeType> tetrahedra_3( Geometry<NodeType>::PointsArrayType{element_nodes_3} );
            ...
            Tetrahedra3D4 <NodeType> tetrahedra_4( Geometry<NodeType>::PointsArrayType{element_nodes_4} );
            ...
            Tetrahedra3D4 <NodeType> tetrahedra_5( Geometry<NodeType>::PointsArrayType{element_nodes_5} );
            ...
            Tetrahedra3D4 <NodeType> tetrahedra_6( Geometry<NodeType>::PointsArrayType{element_nodes_6} );
            ...
            Tetrahedra3D4 <NodeType> tetrahedra_7( Geometry<NodeType>::PointsArrayType{element_nodes_7} );
            ...
            Tetrahedra3D4 <NodeType> tetrahedra_8( Geometry<NodeType>::PointsArrayType{element_nodes_8} );
            ...
            Tetrahedra3D4 <NodeType> tetrahedra_9( Geometry<NodeType>::PointsArrayType{element_nodes_9} );
            ...
            Tetrahedra3D4 <NodeType> tetrahedra_10( Geometry<NodeType>::PointsArrayType{element_nodes_10} );
            ...
            Tetrahedra3D4 <NodeType> tetrahedra_11( Geometry<NodeType>::PointsArrayType{element_nodes_11} );
