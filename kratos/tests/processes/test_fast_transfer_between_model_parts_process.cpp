...
namespace Kratos 
{
    namespace Testing 
    {
        ...
        */
        ...
        KRATOS_TEST_CASE_IN_SUITE(TestFastTransferBetweenModelPartsProcess3, KratosCoreFastTransferBetweenModelPartsProcessFastSuite)
        {
            ModelPart origin_model_part("Origin");
            ModelPart destination_model_part("Destination");
        ...
        */
        ...
        KRATOS_TEST_CASE_IN_SUITE(TestFastTransferBetweenModelPartsProcess4, KratosCoreFastTransferBetweenModelPartsProcessFastSuite)
        {
            ModelPart origin_model_part("Origin");
            ModelPart destination_model_part("Destination");
