...
class TestVariableUtils(KratosUnittest.TestCase):
    ...
    def test_UpdateCurrentToInitialConfiguration(self):
        ...
        ref_model_part_io = KratosMultiphysics.ModelPartIO(GetFilePath("auxiliary_files_for_python_unittest/mdpa_files/test_model_part_io_read"))
    ...
    def __test_copy_model_part_flagged_methods(
        ...
        if (add_origin_variables_to_solution_step_variables_list):
            ...
            origin_model_part.AddNodalSolutionStepVariable(KratosMultiphysics.VELOCITY)
        origin_model_part.SetBufferSize(2)
        model_part_io = KratosMultiphysics.ModelPartIO(GetFilePath("auxiliary_files_for_python_unittest/mdpa_files/test_model_part_io_read"), KratosMultiphysics.ModelPartIO.READ | KratosMultiphysics.ModelPartIO.IGNORE_VARIABLES_ERROR)
        model_part_io.ReadModelPart(origin_model_part)
