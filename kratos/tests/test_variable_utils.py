...
class TestVariableUtils(KratosUnittest.TestCase):
    ...
    def test_save_var(self):
        ...
        VariableUtils().SaveScalarNonHistoricalVar(VISCOSITY, DENSITY, model_part.Nodes)
        VariableUtils().SaveVectorNonHistoricalVar(DISPLACEMENT, VELOCITY, model_part.Nodes)
