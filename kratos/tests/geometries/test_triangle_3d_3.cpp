...
namespace Testing 
{
    ...
    */
    KRATOS_TEST_CASE_IN_SUITE(Triangle3D3ParallelNoIntersection, KratosCoreGeometriesFastSuite) {
        Triangle3D3<Point > triangle_1(
            ...
            Kratos::make_shared<Point>(10., 0.0, 2.0),
            Kratos::make_shared<Point>(0.0, 1.0, 0.0)
            );
        Triangle3D3<Point > triangle_2(
            Kratos::make_shared<Point>(0.0, 0.0, 0.01),
            Kratos::make_shared<Point>(10., 0.0, 2.01),
            Kratos::make_shared<Point>(0.0, 1.0, 0.01)
            );
    ...
    KRATOS_TEST_CASE_IN_SUITE(Triangle3D3ParallelNearIntersection, KratosCoreGeometriesFastSuite) {
        ...
        Triangle3D3<Point > triangle_2(
            Kratos::make_shared<Point>(0.0, 0.0, 0.00000001),
            Kratos::make_shared<Point>(10., 0.0, 2.00000001),
            Kratos::make_shared<Point>(0.0, 1.0, 0.00000001)
            );
    ...
    KRATOS_TEST_CASE_IN_SUITE(Triangle3D3CoplanarNoIntersection, KratosCoreGeometriesFastSuite) {
        ...
        Triangle3D3<Point > triangle_2(
            Kratos::make_shared<Point>(0.00000001, 0.00000001, 0.00000001),
            Kratos::make_shared<Point>(-10., 0.0, -2.0),
            Kratos::make_shared<Point>(0.0, -1.0, 0.00)
            );
    ...
    KRATOS_TEST_CASE_IN_SUITE(Triangle3D3InsideIntersection, KratosCoreGeometriesFastSuite) {
        Triangle3D3<Point > triangle_1(
            Kratos::make_shared<Point>(0.0, 0.0, 0.0),
            Kratos::make_shared<Point>(0.0, 0.0, 4.0),
            Kratos::make_shared<Point>(0.0, 4.0, 0.0)
            );
        Triangle3D3<Point > triangle_2(
            Kratos::make_shared<Point>(0.0, 1.0, 1.0),
            Kratos::make_shared<Point>(0.0, 1.0, 3.0),
            Kratos::make_shared<Point>(0.0, 3.0, 1.0)
            );
    ...
    */
    KRATOS_TEST_CASE_IN_SUITE(Triangle3D3AABoxIntersectionNonEquilaterElongXPlaneX, KratosCoreGeometriesFastSuite) {
        Triangle3D3<Point > triangle_1(
            Kratos::make_shared<Point>(0.55, -0.25, 0.25),
            Kratos::make_shared<Point>(0.50, -0.25, 0.75),
            Kratos::make_shared<Point>(0.50,  0.25, 0.25)
        );
    ...
    KRATOS_TEST_CASE_IN_SUITE(Triangle3D3AABoxIntersectionNonEquilaterElongXPlaneY, KratosCoreGeometriesFastSuite) {
        Triangle3D3<Point > triangle_1(
            Kratos::make_shared<Point>(-0.25, 0.50, 0.25),
            Kratos::make_shared<Point>(-0.25, 0.55, 0.75),
            Kratos::make_shared<Point>( 0.25, 0.50, 0.25)
        );
    ...
    KRATOS_TEST_CASE_IN_SUITE(Triangle3D3AABoxIntersectionNonEquilaterElongXPlaneZ, KratosCoreGeometriesFastSuite) {
        Triangle3D3<Point > triangle_1(
            Kratos::make_shared<Point>(-0.25, 0.25, 0.50),
            Kratos::make_shared<Point>(-0.25, 0.75, 0.50),
            Kratos::make_shared<Point>( 0.25, 0.25, 0.55)
        );
