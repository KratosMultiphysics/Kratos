...
class TestEigenSolvers(KratosUnittest.TestCase):
    ...
    def _RunParametrized(self, my_params_string, eigen_value_estimated = "lowest" ):
        ...
        for i in range(all_settings["test_list"].size()):
            ...
            self._auxiliary_test_function(settings, "test_files/sparse_matrix_files/A.mm", eigen_value_estimated)

    def _auxiliary_test_function(self, settings, matrix_name="test_files/sparse_matrix_files/A.mm", eigen_value_estimated = "lowest"):
