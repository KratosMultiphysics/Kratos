...
class TestGidIO(KratosUnittest.TestCase):
    ...
    def __InitialRead(self, current_model):
        ...
        KratosMultiphysics.ModelPartIO(GetFilePath("auxiliary_files_for_python_unittest/mdpa_files/test_model_part_io_read")).ReadModelPart(model_part)
    ...
    def test_gid_io_all(self):
        ...
        self.__Check("all_active_out_0.post.msh","auxiliary_files_for_python_unittest/reference_files/all_active_ref.ref")
    ...
    def test_gid_io_deactivation(self):
        ...
        self.__Check("deactivated_out_0.post.msh","auxiliary_files_for_python_unittest/reference_files/deactivated_ref.ref")
    ...
    def test_gid_io_results(self):
        ...
        self.__Check("results_out_0.post.res","auxiliary_files_for_python_unittest/reference_files/results_out_ref.ref")
