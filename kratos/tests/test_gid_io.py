...
class TestGidIO(KratosUnittest.TestCase):
    ...
    def test_gid_io_all(self):
        ...
        self.__Check("all_active_out.post.msh","auxiliary_files_for_python_unittest/reference_files/all_active_ref.ref")
    ...
    def test_gid_io_deactivation(self):
        ...
        self.__Check("deactivated_out.post.msh","auxiliary_files_for_python_unittest/reference_files/deactivated_ref.ref")
    ...
    def test_gid_io_results(self):
        ...
        self.__Check("results_out.post.res","auxiliary_files_for_python_unittest/reference_files/results_out_ref.ref")
