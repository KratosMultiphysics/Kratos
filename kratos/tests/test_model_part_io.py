...
class TestModelPartIO(KratosUnittest.TestCase):
    ...
    def test_model_part_io_read_model_part(self):
        ...
        model_part_io = KratosMultiphysics.ModelPartIO(GetFilePath(os.path.join("auxiliar_files_for_python_unnitest", "mdpa_files", "test_model_part_io_read")))
    ...
    def test_model_part_io_read_model_part_mesh_only(self):
        ...
        model_part = current_model.CreateModelPart("Main")
        model_part_io = KratosMultiphysics.ModelPartIO(GetFilePath(os.path.join("auxiliar_files_for_python_unnitest", "mdpa_files", "test_model_part_io_read")), KratosMultiphysics.IO.MESH_ONLY)
        model_part_io.ReadModelPart(model_part)
    ...
    def test_model_part_io_write_model_part_mesh_only(self):
        ...
        model_part = current_model.CreateModelPart("Main")
        model_part.AddNodalSolutionStepVariable(KratosMultiphysics.DISPLACEMENT)
        model_part_io = KratosMultiphysics.ModelPartIO(GetFilePath(os.path.join("auxiliar_files_for_python_unnitest", "mdpa_files", "test_model_part_io_write")))
        model_part_io.ReadModelPart(model_part)
    ...
    def test_model_part_io_write_model_part(self):
        ...
        import filecmp
        value = filecmp.cmp(GetFilePath(os.path.join("auxiliar_files_for_python_unnitest", "mdpa_files", "test_model_part_io_write_mesh_only.mdpa")), GetFilePath("test_model_part_io_write_mesh_only.out.mdpa"))
    ...
    def test_error_on_wrong_input(self):
        ...
        model_part = current_model.CreateModelPart("Main")
        model_part_io = KratosMultiphysics.ModelPartIO(GetFilePath(os.path.join("auxiliar_files_for_python_unnitest", "mdpa_files", "wrong_properties_input")))
