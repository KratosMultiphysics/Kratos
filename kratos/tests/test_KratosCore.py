...
import test_numpy_export_dense_matrix_no_copying
import test_numpy_export_dense_matrix_copying
...
def AssembleTestSuites():
    ...
    smallSuite.addTests(KratosUnittest.TestLoader().loadTestsFromTestCases([test_numpy_export_dense_matrix_copying.TestNumpyExportDenseMatrixCopying]))
    smallSuite.addTests(KratosUnittest.TestLoader().loadTestsFromTestCases([test_numpy_export_dense_matrix_no_copying.TestNumpyExportDenseMatrixNoCopying]))
