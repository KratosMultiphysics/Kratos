...
import test_nurbs_geometry_modeler
...
def AssembleTestSuites():
    ...
    smallSuite.addTests(KratosUnittest.TestLoader().loadTestsFromTestCases([test_nurbs_geometry_modeler.TestNurbsGeometryModeler]))
