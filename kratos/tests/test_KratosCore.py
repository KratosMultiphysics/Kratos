...
import test_calculate_nodal_distance_to_skin_process_process
...
def AssembleTestSuites():
    ...
    smallSuite.addTests(KratosUnittest.TestLoader().loadTestsFromTestCases([test_calculate_nodal_distance_to_skin_process_process.TestCalculateNodalDistanceToSkinProcessCoarseSphere]))
