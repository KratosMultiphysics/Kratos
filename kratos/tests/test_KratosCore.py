...
import test_linear_master_slave_contstraints
...
def AssembleTestSuites():
    ...
    smallSuite.addTests(KratosUnittest.TestLoader().loadTestsFromTestCases([test_linear_master_slave_contstraints.TestLinearMultipointConstraints]))
