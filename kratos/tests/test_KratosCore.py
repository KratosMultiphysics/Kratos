...
import test_geometry_ids_tensor_adaptor
...
def AssembleTestSuites():
    ...
    smallSuite.addTests(KratosUnittest.TestLoader().loadTestsFromTestCases([test_geometry_ids_tensor_adaptor.TestGeometryIdsTensorAdaptor]))
