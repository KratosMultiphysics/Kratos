...
import test_calculate_only_nodal_distance_to_skin_process
...
def AssembleTestSuites():
    ...
    smallSuite.addTests(KratosUnittest.TestLoader().loadTestsFromTestCases([test_calculate_only_nodal_distance_to_skin_process.TestCalculateOnlyNodalDistanceToSkinProcessCoarseSphere]))
