...
KRATOS_TEST_CASE_IN_SUITE(IsSame_Element_Element, KratosCoreFastSuite)
{
    ...
    KRATOS_CHECK(CompareElementsAndConditionsUtility::IsSame(r_custom_element_2d_3n_1, *p_custom_element_2d_3n_2));
    KRATOS_CHECK(CompareElementsAndConditionsUtility::IsSame(&r_custom_element_2d_3n_1, &(*p_custom_element_2d_3n_2)));
    KRATOS_CHECK(CompareElementsAndConditionsUtility::IsSame(*p_custom_element_2d_3n_2, r_custom_element_2d_3n_1));
    KRATOS_CHECK(CompareElementsAndConditionsUtility::IsSame(&(*p_custom_element_2d_3n_2), &r_custom_element_2d_3n_1));
    // different element type, same geometry type.
    const Element& r_element_2d_3n = KratosComponents<Element>::Get("Element2D3N");
    KRATOS_CHECK_IS_FALSE(CompareElementsAndConditionsUtility::IsSame(r_element_2d_3n, *p_custom_element_2d_3n_1));
    KRATOS_CHECK_IS_FALSE(CompareElementsAndConditionsUtility::IsSame(&r_element_2d_3n, &(*p_custom_element_2d_3n_1)));
    KRATOS_CHECK_IS_FALSE(CompareElementsAndConditionsUtility::IsSame(*p_custom_element_2d_3n_1, r_element_2d_3n));
    KRATOS_CHECK_IS_FALSE(CompareElementsAndConditionsUtility::IsSame(&(*p_custom_element_2d_3n_1), &r_element_2d_3n));
    ...
    KRATOS_CHECK_IS_FALSE(CompareElementsAndConditionsUtility::IsSame(r_custom_element_2d_3n_1, r_custom_element_2d_4n_3));
    KRATOS_CHECK_IS_FALSE(CompareElementsAndConditionsUtility::IsSame(&r_custom_element_2d_3n_1, &r_custom_element_2d_4n_3));
    KRATOS_CHECK_IS_FALSE(CompareElementsAndConditionsUtility::IsSame(r_custom_element_2d_4n_3, r_custom_element_2d_3n_1));
    KRATOS_CHECK_IS_FALSE(CompareElementsAndConditionsUtility::IsSame(&r_custom_element_2d_4n_3, &r_custom_element_2d_3n_1));
}
...
KRATOS_TEST_CASE_IN_SUITE(IsSame_Condition_Condition, KratosCoreFastSuite)
{
    ...
    KRATOS_CHECK(CompareElementsAndConditionsUtility::IsSame(r_custom_condition_2d_3n_1, *p_custom_condition_2d_3n_2));
    KRATOS_CHECK(CompareElementsAndConditionsUtility::IsSame(&r_custom_condition_2d_3n_1, &(*p_custom_condition_2d_3n_2)));
    KRATOS_CHECK(CompareElementsAndConditionsUtility::IsSame(*p_custom_condition_2d_3n_2, r_custom_condition_2d_3n_1));
    KRATOS_CHECK(CompareElementsAndConditionsUtility::IsSame(&(*p_custom_condition_2d_3n_2), &r_custom_condition_2d_3n_1));
    ...
    KRATOS_CHECK_IS_FALSE(CompareElementsAndConditionsUtility::IsSame(r_condition_2d_3n, *p_custom_condition_2d_3n_1));
    KRATOS_CHECK_IS_FALSE(CompareElementsAndConditionsUtility::IsSame(&r_condition_2d_3n, &(*p_custom_condition_2d_3n_1)));
    KRATOS_CHECK_IS_FALSE(CompareElementsAndConditionsUtility::IsSame(*p_custom_condition_2d_3n_1, r_condition_2d_3n));
    KRATOS_CHECK_IS_FALSE(CompareElementsAndConditionsUtility::IsSame(&(*p_custom_condition_2d_3n_1), &r_condition_2d_3n));
    ...
    KRATOS_CHECK_IS_FALSE(CompareElementsAndConditionsUtility::IsSame(r_custom_condition_2d_3n_1, r_custom_condition_2d_4n_3));
    KRATOS_CHECK_IS_FALSE(CompareElementsAndConditionsUtility::IsSame(&r_custom_condition_2d_3n_1, &r_custom_condition_2d_4n_3));
    KRATOS_CHECK_IS_FALSE(CompareElementsAndConditionsUtility::IsSame(r_custom_condition_2d_4n_3, r_custom_condition_2d_3n_1));
    KRATOS_CHECK_IS_FALSE(CompareElementsAndConditionsUtility::IsSame(&r_custom_condition_2d_4n_3, &r_custom_condition_2d_3n_1));
}
