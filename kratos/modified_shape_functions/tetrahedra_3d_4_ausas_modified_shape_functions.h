...
#if !defined(KRATOS_TETRAHEDRA_3D_4_AUSAS_MODIFIED_SHAPE_FUNCTIONS)
#define KRATOS_TETRAHEDRA_3D_4_AUSAS_MODIFIED_SHAPE_FUNCTIONS
...
class KRATOS_API(KRATOS_CORE) Tetrahedra3D4AusasModifiedShapeFunctions : public AusasModifiedShapeFunctions
{
public:
...
private:
    ...
    /// Assignment operator.
    Tetrahedra3D4AusasModifiedShapeFunctions& operator=(Tetrahedra3D4AusasModifiedShapeFunctions const& rOther);
...
#endif /* KRATOS_TETRAHEDRA_3D_4_AUSAS_MODIFIED_SHAPE_FUNCTIONS defined */
