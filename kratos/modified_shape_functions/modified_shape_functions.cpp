...
namespace Kratos
{
    ...
    void ModifiedShapeFunctions::GetShapeFunctionsAndGradientsValues(Matrix& rShapeFunctionsValues,
        ...
        const unsigned int n_edges_global =                                    // Number of edges in original geometry
        const unsigned int n_nodes_global =                                    // Number of nodes in original geometry
