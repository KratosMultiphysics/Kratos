...
namespace Kratos
{
  ...
  KRATOS_DEFINE_VARIABLE( BoundedVector<double, 6>, INITIAL_STRAIN_VECTOR )
  KRATOS_DEFINE_VARIABLE( BoundedVector<double, 6>, INITIAL_STRESS_VECTOR )
  KRATOS_DEFINE_VARIABLE( BoundedMatrix<double, 6, 6>, INITIAL_DEFORMATION_GRADIENT_MATRIX )

  KRATOS_DEFINE_VARIABLE( BoundedVector<double, 6>, GREEN_LAGRANGE_STRAIN_VECTOR )
  ...
  KRATOS_DEFINE_VARIABLE( BoundedVector<double, 6>, BIOT_STRAIN_VECTOR);
  KRATOS_DEFINE_VARIABLE( BoundedMatrix<double, 3, 3>, BIOT_STRAIN_TENSOR);

  KRATOS_DEFINE_VARIABLE( BoundedVector<double, 6>, ALMANSI_STRAIN_VECTOR )
  KRATOS_DEFINE_VARIABLE( BoundedMatrix<double, 3, 3>, ALMANSI_STRAIN_TENSOR )

  // Stress
  KRATOS_DEFINE_VARIABLE( BoundedVector<double, 6>, KIRCHHOFF_STRESS_VECTOR )
  KRATOS_DEFINE_VARIABLE( BoundedMatrix<double, 3, 3>, KIRCHHOFF_STRESS_TENSOR )
...
//   KRATOS_DEFINE_VARIABLE( Matrix, CONSTITUTIVE_MATRIX )
  KRATOS_DEFINE_VARIABLE( BoundedMatrix<double, 6, 6>, CONSTITUTIVE_MATRIX_PK2 )
  KRATOS_DEFINE_VARIABLE( BoundedMatrix<double, 6, 6>, CONSTITUTIVE_MATRIX_KIRCHHOFF )
  ...
  KRATOS_DEFINE_VARIABLE( BoundedMatrix<double, 3, 3>, INVERSE_DEFORMATION_GRADIENT )
}  // namespace Kratos.
