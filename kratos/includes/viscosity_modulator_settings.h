...
#if !defined(KRATOS_VISCOSITY_MODULATOR_SETTINGS_INCLUDED )
#define  KRATOS_VISCOSITY_MODULATOR_SETTINGS_INCLUDED
...
/// Viscosity modulator diffusion settings. This class contains information to be used by the convection diffusion solver, all the variables that will be needed by the solver.
...
*/
class KRATOS_API(KRATOS_CORE) ViscosityModulatorSettings
{
public:
    ///@name Type Definitions
    ///@{

    /// Pointer definition of ViscosityModulatorSettings
    KRATOS_CLASS_POINTER_DEFINITION(ViscosityModulatorSettings);
    ...
    /// Default constructor.
    ViscosityModulatorSettings() = default;

    ViscosityModulatorSettings(const ViscosityModulatorSettings& rOther):
    ...
    /// Destructor.
    virtual ~ViscosityModulatorSettings() {};
    ...
    ///@{
    /// Assignment operator.
    ViscosityModulatorSettings& operator=(ViscosityModulatorSettings const& rOther)
    {
        mpDensityVar = rOther.mpDensityVar;
        mpDiffusionVar = rOther.mpDiffusionVar;
        mpUnknownVar = rOther.mpUnknownVar;
    ...
    virtual std::string Info() const
    {
        ...
        buffer << "ViscosityModulatorSettings #" ;
        return buffer.str();
    }
    ...
    {
        rOStream << "ViscosityModulatorSettings #";
    }
...
}; // Class ViscosityModulatorSettings
...
inline std::istream& operator >> (std::istream& rIStream,
                                  ViscosityModulatorSettings& rThis)
{
    return rIStream;
}
...
inline std::ostream& operator << (std::ostream& rOStream,
                                  const ViscosityModulatorSettings& rThis)
{
...
KRATOS_DEFINE_VARIABLE(ViscosityModulatorSettings::Pointer, VISCOSITY_MODULATOR_SETTINGS)
...
#endif // KRATOS_VISCOSITY_MODULATOR_SETTINGS_INCLUDED  defined
