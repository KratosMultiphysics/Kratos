...
public:
    ...
    ModelPartIO(std::string const& Filename, const Flags Options = IO::READ|(~IO::IGNORE_VARIABLES_ERROR)|IO::SKIP_TIMER);

    /// Constructor with stream.
    ModelPartIO(Kratos::shared_ptr<std::iostream> Stream, const Flags Options = (~IO::IGNORE_VARIABLES_ERROR)|IO::SKIP_TIMER);
