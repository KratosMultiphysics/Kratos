...
namespace Kratos
{
    ...
    KRATOS_DEFINE_VARIABLE(double, ADAPT_PERTURBATION_SIZE)
    ...
    KRATOS_DEFINE_VARIABLE( double, VOLUMETRIC_STRAIN_SUBSCALE )
    KRATOS_DEFINE_VARIABLE( double, VOLUMETRIC_STRAIN_PROJECTION )
    KRATOS_DEFINE_VARIABLE( double, VOLUMETRIC_STRAIN_PROJECTION_REACTION )
    ...
    KRATOS_DEFINE_VARIABLE( double, PENALTY_COEFFICIENT )
    ...
    KRATOS_DEFINE_VARIABLE( double, AUX_DISTANCE )
    ...
    KRATOS_DEFINE_3D_VARIABLE_WITH_COMPONENTS( SHAPE )
    ...
    KRATOS_DEFINE_3D_VARIABLE_WITH_COMPONENTS( DISPLACEMENT_SUBSCALE )
    KRATOS_DEFINE_3D_VARIABLE_WITH_COMPONENTS( DISPLACEMENT_PROJECTION )
    KRATOS_DEFINE_3D_VARIABLE_WITH_COMPONENTS( DISPLACEMENT_PROJECTION_REACTION )
    KRATOS_DEFINE_3D_VARIABLE_WITH_COMPONENTS( REACTION )

    // Rotations, time derivatives and their adjoints.
    KRATOS_DEFINE_3D_VARIABLE_WITH_COMPONENTS(ADJOINT_ANGULAR_ACCELERATION)
    KRATOS_DEFINE_3D_VARIABLE_WITH_COMPONENTS_WITH_ADJOINTS(ANGULAR_ACCELERATION, ADJOINT_ANGULAR_ACCELERATION)
    KRATOS_DEFINE_3D_VARIABLE_WITH_COMPONENTS_WITH_TIME_DERIVATIVE(ADJOINT_ANGULAR_VELOCITY, ADJOINT_ANGULAR_ACCELERATION)
    KRATOS_DEFINE_3D_VARIABLE_WITH_COMPONENTS_WITH_TIME_DERIVATIVE_WITH_ADJOINTS(ANGULAR_VELOCITY, ANGULAR_ACCELERATION, ADJOINT_ANGULAR_VELOCITY, ADJOINT_ANGULAR_ACCELERATION)
    KRATOS_DEFINE_3D_VARIABLE_WITH_COMPONENTS_WITH_TIME_DERIVATIVE(ADJOINT_ROTATION, ADJOINT_ANGULAR_VELOCITY)
    KRATOS_DEFINE_3D_VARIABLE_WITH_COMPONENTS_WITH_TIME_DERIVATIVE_WITH_ADJOINTS(ROTATION, ANGULAR_VELOCITY, ADJOINT_ROTATION, ADJOINT_ANGULAR_VELOCITY)

    // Displacements, time derivatives and their adjoints.
    KRATOS_DEFINE_3D_VARIABLE_WITH_COMPONENTS(ADJOINT_ACCELERATION)
    KRATOS_DEFINE_3D_VARIABLE_WITH_COMPONENTS_WITH_ADJOINTS(ACCELERATION, ADJOINT_ACCELERATION)
    KRATOS_DEFINE_3D_VARIABLE_WITH_COMPONENTS_WITH_TIME_DERIVATIVE(ADJOINT_VELOCITY, ADJOINT_ACCELERATION)
    KRATOS_DEFINE_3D_VARIABLE_WITH_COMPONENTS_WITH_TIME_DERIVATIVE_WITH_ADJOINTS(VELOCITY, ACCELERATION, ADJOINT_VELOCITY, ADJOINT_ACCELERATION)
    KRATOS_DEFINE_3D_VARIABLE_WITH_COMPONENTS_WITH_TIME_DERIVATIVE(ADJOINT_DISPLACEMENT, ADJOINT_VELOCITY)
    KRATOS_DEFINE_3D_VARIABLE_WITH_COMPONENTS_WITH_TIME_DERIVATIVE_WITH_ADJOINTS(DISPLACEMENT, VELOCITY, ADJOINT_DISPLACEMENT, ADJOINT_VELOCITY)
    ...
    KRATOS_DEFINE_3D_VARIABLE_WITH_COMPONENTS( LOCAL_TANGENT )
    KRATOS_DEFINE_VARIABLE( Matrix, LOCAL_TANGENT_MATRIX )
    KRATOS_DEFINE_3D_VARIABLE_WITH_COMPONENTS( BODY_FORCE )
    KRATOS_DEFINE_3D_VARIABLE_WITH_COMPONENTS( BODY_MOMENT )
    ...
    KRATOS_DEFINE_VARIABLE( Vector, SHAPE_FUNCTIONS_VECTOR )

    //for Structural application:
    KRATOS_DEFINE_VARIABLE(  int, NUMBER_OF_CYCLES )
    ...
    KRATOS_DEFINE_VARIABLE( Vector, ELEMENTAL_EDGE_DISTANCES )
    KRATOS_DEFINE_VARIABLE( Vector, ELEMENTAL_EDGE_DISTANCES_EXTRAPOLATED )
    ...
    KRATOS_DEFINE_VARIABLE( Matrix, SHAPE_FUNCTIONS_GRADIENT_MATRIX)
