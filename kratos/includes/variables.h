...
namespace Kratos
{
    ...
    KRATOS_DEFINE_2D_TENSOR_VARIABLE_WITH_COMPONENTS( DEFORMATION_GRADIENT_2D_TENSOR )
    KRATOS_DEFINE_3D_TENSOR_VARIABLE_WITH_COMPONENTS( DEFORMATION_GRADIENT_3D_TENSOR )
