...
namespace Kratos
{
    ...
    KRATOS_DEFINE_3D_VARIABLE_WITH_COMPONENTS( VELOCITY_ADJ )
    KRATOS_DEFINE_VARIABLE(double, PRESSURE_ADJ )
    KRATOS_DEFINE_VARIABLE( double, EXTERNAL_PRESSURE_ADJ )
    KRATOS_DEFINE_VARIABLE(double, TEMPERATURE_ADJ )
    KRATOS_DEFINE_3D_VARIABLE_WITH_COMPONENTS( TEMPERATURE_ADJ_GRADIENT )
    KRATOS_DEFINE_VARIABLE(double, DESIGN_PARAMETER )
    KRATOS_DEFINE_3D_VARIABLE_WITH_COMPONENTS( DESIGN_PARAMETER_GRADIENT )
    KRATOS_DEFINE_3D_VARIABLE_WITH_COMPONENTS( FUNCTIONAL_DERIVATIVE_VELOCITY )
    KRATOS_DEFINE_VARIABLE(double, FUNCTIONAL_DERIVATIVE_TRANSPORT_SCALAR )
    KRATOS_DEFINE_VARIABLE(double, FUNCTIONAL_DERIVATIVE_TRANSPORT_SCALAR_ADJ )
    KRATOS_DEFINE_VARIABLE(double, FUNCTIONAL_DERIVATIVE )
    KRATOS_DEFINE_VARIABLE(Vector, FUNCTIONAL_WEIGHTS )
    KRATOS_DEFINE_VARIABLE(Vector, FUNCTIONAL_WEIGHTS_FLUID )
    KRATOS_DEFINE_VARIABLE(Vector, FUNCTIONAL_WEIGHTS_TRANSPORT)
    KRATOS_DEFINE_VARIABLE(Vector, FUNCTIONAL_DERIVATIVE_WEIGHTS )
    KRATOS_DEFINE_VARIABLE(Vector, FUNCTIONAL_DERIVATIVE_WEIGHTS_FLUID )
    KRATOS_DEFINE_VARIABLE(Vector, FUNCTIONAL_DERIVATIVE_WEIGHTS_TRANSPORT)
    KRATOS_DEFINE_VARIABLE(int, TOP_OPT_PROBLEM_STAGE )
    KRATOS_DEFINE_VARIABLE(double, TOP_OPT_TIME_COEFFICIENT )
