...
namespace Kratos
{
    ...
    KRATOS_DEFINE_VARIABLE(double, WINDOW_FUNCTION )
    KRATOS_DEFINE_3D_VARIABLE_WITH_COMPONENTS( DRAG_DIRECTION )
    KRATOS_DEFINE_VARIABLE( Matrix, MASS_MATRIX_0 )
    KRATOS_DEFINE_VARIABLE( Matrix, MASS_MATRIX_1 )
    KRATOS_DEFINE_VARIABLE( Matrix, ADJOINT_MATRIX_1 )
    KRATOS_DEFINE_VARIABLE( Matrix, ADJOINT_MATRIX_2 )
