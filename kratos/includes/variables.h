...
namespace Kratos
{
    ...
    KRATOS_DEFINE_VARIABLE( Kratos::BoundedVector<double, 6>, INITIAL_STRAIN )
    ...
    KRATOS_DEFINE_VARIABLE( BoundedMatrix<double, 6, 6>, CAUCHY_STRESS_VECTOR )
    KRATOS_DEFINE_VARIABLE( BoundedMatrix<double, 6, 6>, PK2_STRESS_VECTOR )
    ...
    KRATOS_DEFINE_VARIABLE( BoundedVector<double, 6>, STRAIN )
    ...
    //for General kratos application:
    KRATOS_DEFINE_VARIABLE( BoundedMatrix<double, 3, 3>, GREEN_LAGRANGE_STRAIN_TENSOR )
    KRATOS_DEFINE_VARIABLE( BoundedMatrix<double, 3, 3>, PK2_STRESS_TENSOR )
    KRATOS_DEFINE_VARIABLE( BoundedMatrix<double, 3, 3>, CAUCHY_STRESS_TENSOR )
    KRATOS_DEFINE_VARIABLE( Matrix, LOCAL_INERTIA_TENSOR )
    KRATOS_DEFINE_VARIABLE( Matrix, LOCAL_AXES_MATRIX )
    KRATOS_DEFINE_VARIABLE( BoundedVector<double, 6>, LOCAL_CONSTITUTIVE_MATRIX )
    KRATOS_DEFINE_VARIABLE( BoundedVector<double, 6>, CONSTITUTIVE_MATRIX )
    KRATOS_DEFINE_VARIABLE( BoundedMatrix<double, 3, 3>, DEFORMATION_GRADIENT )
