...
namespace Kratos
{
    ...
    KRATOS_DEFINE_VARIABLE( double, PENALTY_COEFFICIENT_TANGENTIAL )
    ...
    KRATOS_DEFINE_3D_VARIABLE_WITH_COMPONENTS_WITH_TIME_DERIVATIVE(ROTATION, ANGULAR_VELOCITY)
    ...
    KRATOS_DEFINE_3D_VARIABLE_WITH_COMPONENTS_WITH_TIME_DERIVATIVE(VELOCITY, ACCELERATION)
    KRATOS_DEFINE_3D_VARIABLE_WITH_COMPONENTS_WITH_TIME_DERIVATIVE(DISPLACEMENT, VELOCITY)
    ...
    KRATOS_DEFINE_3D_VARIABLE_WITH_COMPONENTS( POSITIVE_FACE_FLUID_VELOCITY )
    KRATOS_DEFINE_3D_VARIABLE_WITH_COMPONENTS( NEGATIVE_FACE_FLUID_VELOCITY )
    KRATOS_DEFINE_3D_VARIABLE_WITH_COMPONENTS( TRACTION_FROM_FLUID_PRESSURE )
    KRATOS_DEFINE_3D_VARIABLE_WITH_COMPONENTS( TRACTION_FROM_FLUID_STRESS )
