...
namespace Kratos
{
    ...
    KRATOS_DEFINE_VARIABLE(Vector, RESPONSE_FUNCTION_INTERPOLATION_ERROR )
    ...
    KRATOS_DEFINE_VARIABLE(Matrix, PRIMAL_STEADY_RESIDUAL_FIRST_DERIVATIVES )
    KRATOS_DEFINE_VARIABLE(Matrix, ADJOINT_STABILIZATION_DIFFUSION_MATRIX )
    KRATOS_DEFINE_VARIABLE(double, ADJOINT_STABILIZATION_COEFFICIENT )
