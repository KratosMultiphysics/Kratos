...
namespace Kratos
{
    ...
    KRATOS_DEFINE_VARIABLE( int, COLOR )
    ...
    KRATOS_DEFINE_VARIABLE( Vector, RECTILINEAR_X_COORDINATES )
    KRATOS_DEFINE_VARIABLE( Vector, RECTILINEAR_Y_COORDINATES )
    KRATOS_DEFINE_VARIABLE( Vector, RECTILINEAR_Z_COORDINATES )
    ...
    KRATOS_DEFINE_VARIABLE( Vector, COLORS )
    ...
    KRATOS_DEFINE_VARIABLE( Matrix, VOXEL_FACE_COLORS )
