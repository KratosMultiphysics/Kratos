...
public:
     ...
     * This collection of functions is used to convert variadic template arguments to a string representation.
     * The TypeNoType struct is used to differentiate between type and non-type template arguments. (classes and literal values)
     * The RegistryTemplateToString struct is used to iterate over the variadic template arguments and convert them to strings.
