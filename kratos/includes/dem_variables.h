...
namespace Kratos
{
    ...
    KRATOS_DEFINE_VARIABLE( double, EXACT_PRESSURE )
    ...
    KRATOS_DEFINE_VARIABLE( Vector, EXACT_VELOCITY )
    ...
    KRATOS_DEFINE_VARIABLE( Matrix, EXACT_VELOCITY_GRADIENT )
    KRATOS_DEFINE_3D_VARIABLE_WITH_COMPONENTS( EXACT_PRESSURE_GRADIENT )
    KRATOS_DEFINE_3D_VARIABLE_WITH_COMPONENTS( AVERAGED_PARTICLE_VELOCITY )
