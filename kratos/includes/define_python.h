...
#endif
#define KRATOS_REGISTER_IN_PYTHON_SYMMETRIC_2D_TENSOR_VARIABLE_WITH_COMPONENTS(name) \
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(name) \
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(name##_XX) \
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(name##_YY) \
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(name##_XY)
...
#endif
#define KRATOS_REGISTER_IN_PYTHON_SYMMETRIC_3D_TENSOR_VARIABLE_WITH_COMPONENTS(name) \
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(name) \
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(name##_XX) \
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(name##_YY) \
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(name##_ZZ) \
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(name##_XY) \
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(name##_YZ) \
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(name##_XZ)
...
#endif
#define KRATOS_REGISTER_IN_PYTHON_2D_TENSOR_VARIABLE_WITH_COMPONENTS(name) \
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(name) \
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(name##_XX) \
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(name##_XY) \
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(name##_YX) \
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(name##_YY)
...
#endif
#define KRATOS_REGISTER_IN_PYTHON_3D_TENSOR_VARIABLE_WITH_COMPONENTS(name) \
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(name) \
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(name##_XX) \
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(name##_XY) \
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(name##_XZ) \
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(name##_YY) \
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(name##_YZ) \
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(name##_ZX) \
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(name##_ZY) \
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(name##_ZZ)
