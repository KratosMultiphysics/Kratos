...
#ifdef KRATOS_REGISTER_IN_PYTHON_FLAG_NAME
#undef KRATOS_REGISTER_IN_PYTHON_FLAG_NAME
#endif
#define KRATOS_REGISTER_IN_PYTHON_FLAG_NAME(module,flag, name) \
    module.attr(name) = &flag;
