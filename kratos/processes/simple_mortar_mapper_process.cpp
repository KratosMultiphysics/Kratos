...
void SimpleMortarMapperProcess<TDim, TNumNodes, TVarType, THist>::AssemblyMortarOperators(
    ...
    const bounded_matrix<double, TNumNodes, TNumNodes> Ae
    )
{
...
template< int TDim, int TNumNodes, class TVarType, HistoricalValues THist> 
inline bounded_matrix<double, TNumNodes, TNumNodes> SimpleMortarMapperProcess<TDim, TNumNodes, TVarType, THist>::FastInverse(const bounded_matrix<double, TNumNodes, TNumNodes>& InputMatrix)
{
...
template< int TDim, int TNumNodes, class TVarType, HistoricalValues THist> 
inline void SimpleMortarMapperProcess<TDim, TNumNodes, TVarType, THist>::FastInverse(
...
template< int TDim, int TNumNodes, class TVarType, HistoricalValues THist> 
void SimpleMortarMapperProcess<TDim, TNumNodes, TVarType, THist>::LumpMatrix(bounded_matrix<double, TNumNodes, TNumNodes>& InputMatrix)
{        
    for (std::size_t i = 0; i < TNumNodes; ++i)
    {
