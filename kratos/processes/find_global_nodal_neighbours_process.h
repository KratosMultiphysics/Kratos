...
public:
    ...
    void Execute() override
    {
        ...
        else //mpi case!
        {
            ...
            GlobalPointerUtilities<ModelPart::NodesContainerType, Node<3> > gp_utility(mrComm);
            auto all_gps_map = gp_utility.RetrieveGlobalIndexedPointersMap(mr_model_part.Nodes(), all_ids);
