            ...
            i_fluid_element++)
        {
            ...
            if(is_split == true)
            {
                ...
                if(edge_points.size() == 3)
                {
                    ...
                    mrNewSkinModelPart.Conditions().insert(mrNewSkinModelPart.Conditions().end(), p_condition);
                }
                ...
                if(edge_points.size() == 4)
                {
                    ...
                    mrNewSkinModelPart.Conditions().insert(mrNewSkinModelPart.Conditions().end(), p_condition1);
                    mrNewSkinModelPart.Conditions().insert(mrNewSkinModelPart.Conditions().end(), p_condition2);
