...
namespace Kratos {
    ...
    public:
        ...
        void FirstLoop(ModelPart& this_model_part, boost::shared_ptr<Epetra_FECrsMatrix>& p_edge_ids,
                boost::shared_ptr<Epetra_FECrsMatrix>& p_partition_ids, Variable<double>& variable,
        ...
        void GenerateElements(
            ...
            for (ElementsArrayType::iterator it = it_begin_old; it != it_end_old; ++it) {
                ...
                { //to fix this we'll first create a plane. see below
                    ...
                    if (triangle_nodes!=4){ for (int counter = 0; counter != 4; ++counter) KRATOS_WATCH(TriangleNodesArray[counter]); KRATOS_ERROR(  std::logic_error, "ln 1289", "")}
                   ...
                   if (error_bool) {for (int counter = 0; counter != 4; ++counter) KRATOS_WATCH(TriangleNodesArray[counter]); 
                            ...
                            nodes_for_2triang[5] = TriangleNodesArray[0];} //finish 2nd triangle } //KRATOS_ERROR(std::logic_error, "ln 1349", "")  }
