...
#include "../ALEapplication/custom_elements/laplacian_componentwise_meshmoving_element_2d.h"
#include "../ALEapplication/custom_elements/laplacian_componentwise_meshmoving_element_3d.h"
...
template<class TSparseSpace,
         ...
         >
class TrilinosLaplacianComponentwiseMeshMovingStrategy
...
public:
    ...
    KRATOS_CLASS_POINTER_DEFINITION( TrilinosLaplacianComponentwiseMeshMovingStrategy );
    ...
    */
    ...
    /** Constructor.
    */
    TrilinosLaplacianComponentwiseMeshMovingStrategy(
        Epetra_MpiComm& Comm,
    ...
    /** Destructor.
    */
    virtual ~TrilinosLaplacianComponentwiseMeshMovingStrategy() {}
...
private:
    ...
    /** Copy constructor.
    */
    TrilinosLaplacianComponentwiseMeshMovingStrategy(const TrilinosLaplacianComponentwiseMeshMovingStrategy& Other);
