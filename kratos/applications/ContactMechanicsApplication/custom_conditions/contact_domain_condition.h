...
class KRATOS_API(CONTACT_MECHANICS_APPLICATION) ContactDomainCondition : public Condition {
public:
  ...
  /// Pointer definition of ContactDomainCondition
   ...
   * Constructor.
   */
  ContactDomainCondition(IndexType NewId = 0);

  /**
   * Constructor using an array of nodes
   */
  ContactDomainCondition(IndexType NewId, const NodesArrayType& ThisNodes);
