...
#if !defined(KRATOS_RIGID_CONTACT_CONDITION_H_INCLUDED )
#define KRATOS_RIGID_CONTACT_CONDITION_H_INCLUDED
...
public:
  ...
  /// Pointer definition of RigidContactCondition
  KRATOS_CLASS_POINTER_DEFINITION(RigidContactCondition);
   ...
   * Constructor.
   */
  RigidContactCondition(IndexType NewId = 0);

  /**
   * Constructor using an array of nodes
   */
  RigidContactCondition(IndexType NewId, const NodesArrayType& ThisNodes);

  /**
   * Constructor using Geometry
   */
  RigidContactCondition(IndexType NewId, GeometryType::Pointer pGeometry);

  /**
   * Constructor using Properties
   */
  RigidContactCondition(IndexType NewId, GeometryType::Pointer pGeometry, PropertiesType::Pointer pProperties);

  /**
   * Copy Constructor
   */
  RigidContactCondition(RigidContactCondition const& rOther);

  /**
   * Destructor
   */
  virtual ~RigidContactCondition();
  ...
  /// Assignment operator.
  RigidContactCondition & operator=(RigidContactCondition const& rOther);
...
#endif // KRATOS_RIGID_CONTACT_CONDITION_H_INCLUDED  defined
