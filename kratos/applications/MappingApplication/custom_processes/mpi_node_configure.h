...
#if !defined(KRATOS_MPI_NODE_CONFIGURE_INCLUDED)
#define  KRATOS_MPI_NODE_CONFIGURE_INCLUDED
 ...
 */
class MpiNodeConfigure : public NodeConfigure {
public:
  ...
  /// Base type
  typedef NodeConfigure BaseType;
  ...
  static inline void TransferObjects(Communicator * Communicator, TObjectType& SendObjects, TObjectType& RecvObjects) {
    MpiNodeConfigure::TransferObjects(SendObjects, RecvObjects);
  }
...
private:
  ...
  /// Assignment operator.
  MpiNodeConfigure& operator=(MpiNodeConfigure const& rOther);

  /// Copy constructor.
  MpiNodeConfigure(MpiNodeConfigure const& rOther);

  ///@}

}; // Class MpiNodeConfigure
...
inline std::istream& operator >> (std::istream& rIStream, MpiNodeConfigure& rThis){
  return rIStream;
}

/// output stream function
inline std::ostream& operator << (std::ostream& rOStream, const MpiNodeConfigure& rThis){
...
#endif /* KRATOS_MPI_NODE_CONFIGURE_INCLUDED */
