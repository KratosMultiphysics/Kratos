...
mesh_solver.AddVariables(main_model_part)
...
mesh_solver.AddDofs(main_model_part)
...
mesh_solver = mesh_solver.MeshSolverStructuralSimilarity(main_model_part,reform_dofs_at_each_step,compute_reactions)
