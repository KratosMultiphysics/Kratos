...
box_corner1[0]= -2.0; box_corner1[1]=-2.0; box_corner1[2]=-2.0;
box_corner2 = Vector(3); 
box_corner2[0]= 2.0; box_corner2[1]=2.0; box_corner2[2]=2.0;
...
fluid_model_part.Properties[2].SetValue(CONSTITUTIVE_LAW, Isotropic3D() )
