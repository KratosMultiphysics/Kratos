...
#if !defined(KRATOS_REFINE_MESH_BOUNDARY_PROCESS_FOR_FLUIDS_H_INCLUDED )
#define  KRATOS_REFINE_MESH_BOUNDARY_PROCESS_FOR_FLUIDS_H_INCLUDED
...
namespace Kratos
{
  ...
  */
  ...
  class RefineMeshBoundaryProcessForFluids
    : public Process
  {
  public:
    ...
    KRATOS_CLASS_POINTER_DEFINITION( RefineMeshBoundaryProcessForFluids );
    ...
    /// Default constructor.
    RefineMeshBoundaryProcessForFluids(ModelPart& rModelPart,
    ...
    /// Destructor.
    virtual ~RefineMeshBoundaryProcessForFluids() {}
    ...
    {
      return "RefineMeshBoundaryProcessForFluids";
    }

    /// Print information about this object.
    virtual void PrintInfo(std::ostream& rOStream) const
    {
      rOStream << "RefineMeshBoundaryProcessForFluids";
    }
  ...
  private:
    ...
    /// Assignment operator.
    RefineMeshBoundaryProcessForFluids& operator=(RefineMeshBoundaryProcessForFluids const& rOther);
  ...
  inline std::istream& operator >> (std::istream& rIStream,
				    RefineMeshBoundaryProcessForFluids& rThis);

  /// output stream function
  inline std::ostream& operator << (std::ostream& rOStream,
				    const RefineMeshBoundaryProcessForFluids& rThis)
  {
...
#endif // KRATOS_REFINE_MESH_BOUNDARY_PROCESS_FOR_FLUIDS_H_INCLUDED  defined 
