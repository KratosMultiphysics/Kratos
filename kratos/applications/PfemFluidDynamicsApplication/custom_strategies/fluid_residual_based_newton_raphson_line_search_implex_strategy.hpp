...
#if !defined(KRATOS_FLUID_RESIDUAL_BASED_NEWTON_RAPHSON_LINE_SEARCH_IMPLEX_STRATEGY )
#define  KRATOS_FLUID_RESIDUAL_BASED_NEWTON_RAPHSON_LINE_SEARCH_IMPLEX_STRATEGY
...
#include "../SolidMechanicsApplication/custom_utilities/line_search_calculation_utilities.hpp"  // is the solid mechanics and not the Pfem
// the function with this name exists twice

#include "../SolidMechanicsApplication/custom_strategies/residual_based_newton_raphson_line_search_strategy.hpp"
...
namespace Kratos
{
  ...
  */
  template<class TSparseSpace,
	   ...
	   >
  class FluidResidualBasedNewtonRaphsonLineSearchImplexStrategy
  ...
  public:
    ...
    KRATOS_CLASS_POINTER_DEFINITION( FluidResidualBasedNewtonRaphsonLineSearchImplexStrategy );
    ...
    /** Constructor.
     */
    FluidResidualBasedNewtonRaphsonLineSearchImplexStrategy(
    ...
    /** Destructor.
     */
    virtual ~FluidResidualBasedNewtonRaphsonLineSearchImplexStrategy()
    {
    }
    ...
    */
	...
	if (this->GetEchoLevel() > 1) 
      ...
      if (mCalculateReactionsFlag == true && mImplexFlag == false)
	{
  ...
  protected:
    ...
    */
    ...
    /** Copy constructor.
     */
    FluidResidualBasedNewtonRaphsonLineSearchImplexStrategy(const FluidResidualBasedNewtonRaphsonLineSearchImplexStrategy& Other)
    {
    };
  ...
  }; /* Class FluidResidualBasedNewtonRaphsonLineSearchStrategy */
...
#endif /* KRATOS_FLUID_RESIDUAL_BASED_NEWTON_RAPHSON_LINE_SEARCH_STRATEGY  defined */
