...
#if !defined(KRATOS_TEMPORARY_PREDICTOR_CORRECTOR_VELOCITY_BDF_TURBULENT_SCHEME )
#define  KRATOS_TEMPORARY_PREDICTOR_CORRECTOR_VELOCITY_BDF_TURBULENT_SCHEME
...
namespace Kratos {
    ...
    >
    class TemporaryPredictorCorrectorBDFSchemeTurbulent : public Scheme<TSparseSpace, TDenseSpace> {
    public:
        /**@name Type Definitions */
        /*@{ */

        //typedef boost::shared_ptr< TemporaryPredictorCorrectorBossakScheme<TSparseSpace,TDenseSpace> > Pointer;

        KRATOS_CLASS_POINTER_DEFINITION(TemporaryPredictorCorrectorBDFSchemeTurbulent);
         ...
         */
        TemporaryPredictorCorrectorBDFSchemeTurbulent(
        ...
        /** Destructor.
         */
        virtual ~TemporaryPredictorCorrectorBDFSchemeTurbulent() {
        }
