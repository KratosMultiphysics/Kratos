#include "two_step_werner_wengle_wall_condition.h"
 ...
 */
template<>
void TwoStepWernerWengleWallCondition<3, 3>::EquationIdVector(
		EquationIdVectorType& rResult, ProcessInfo& rCurrentProcessInfo)
{
        if (rCurrentProcessInfo[FRACTIONAL_STEP] == 1)
	{
...
/**
 * @see TwoStepWernerWengleWallCondition::GetDofList
 */
template<>
void TwoStepWernerWengleWallCondition<2, 2>::GetDofList(
 ...
 */
template<>
void TwoStepWernerWengleWallCondition<3, 3>::GetDofList(
		DofsVectorType& rConditionDofList, ProcessInfo& rCurrentProcessInfo)
{
        if (rCurrentProcessInfo[FRACTIONAL_STEP] == 1)
	{
...
/**
 * @see TwoStepWernerWengleWallCondition::CalculateWallParameters
 */
template<>
void TwoStepWernerWengleWallCondition<2, 2>::CalculateWallParameters(
 ...
 */
template<>
void TwoStepWernerWengleWallCondition<3, 3>::CalculateWallParameters(
		double& rWallHeight, array_1d<double, 3>& rWallVel, double& rArea)
{
	KRATOS_TRY;
