...
#ifndef KRATOS_TWO_STEP_GENERALIZED_WALL_CONDITION_H
#define KRATOS_TWO_STEP_GENERALIZED_WALL_CONDITION_H
...
class TwoStepGeneralizedWallCondition: public Condition
{
public:
	///@name Type Definitions
	///@{

	/// Pointer definition of TwoStepGeneralizedWallCondition
	KRATOS_CLASS_POINTER_DEFINITION(TwoStepGeneralizedWallCondition);
	 ...
	 */
	TwoStepGeneralizedWallCondition(IndexType NewId = 0) : Condition(NewId), mInitializeWasPerformed(false), mpElement()
	{
	}
	 ...
	 */
	TwoStepGeneralizedWallCondition(IndexType NewId, const NodesArrayType& ThisNodes)
	 ...
	 */
	TwoStepGeneralizedWallCondition(IndexType NewId, GeometryType::Pointer pGeometry)
	...
	/// Copy constructor.
	TwoStepGeneralizedWallCondition(TwoStepGeneralizedWallCondition const& rOther) : Condition(rOther),
	mInitializeWasPerformed(rOther.mInitializeWasPerformed), mpElement(rOther.mpElement)
	{
	}

	/// Destructor.
	virtual ~TwoStepGeneralizedWallCondition()
	{}
	...
	/// Copy constructor.
	TwoStepGeneralizedWallCondition& operator=(TwoStepGeneralizedWallCondition const& rOther)
	{
	...
	/// Create a new TwoStepGeneralizedWallCondition object.
	/**
	 @param NewId Index of the new condition
	 @param ThisNodes An array containing the nodes of the new condition
	 @param pProperties Pointer to the condition's properties
	...
	{
		return Condition::Pointer(new TwoStepGeneralizedWallCondition(NewId,
	...
	virtual std::string Info() const
	{
		...
		buffer << "TwoStepGeneralizedWallCondition" << TDim << "D";
		return buffer.str();
	}

	/// Print information about this object.
	virtual void PrintInfo(std::ostream& rOStream) const
	{	rOStream << "TwoStepGeneralizedWallCondition";}
...
}; // Class TwoStepGeneralizedWallCondition
...
inline std::istream& operator >>(std::istream& rIStream,
		TwoStepGeneralizedWallCondition<TDim, TNumNodes>& rThis)
{
	return rIStream;
}
...
inline std::ostream& operator <<(std::ostream& rOStream,
		const TwoStepGeneralizedWallCondition<TDim, TNumNodes>& rThis)
{
...
#endif // KRATOS_TWO_STEP_GENERALIZED_WALL_CONDITION_H
