...
#if !defined (KRATOS_HYPOELASTIC_PLASTIC_3D_LAW_H_INCLUDED)
#define  KRATOS_HYPOELASTIC_PLASTIC_3D_LAW_H_INCLUDED
...
class HypoElasticPlastic3DLaw : public HypoElastic3DLaw
{
protected:
...
public:
    ...
    /**
     * Counted pointer of HypoElasticPlastic3DLaw
     */

    KRATOS_CLASS_POINTER_DEFINITION( HypoElasticPlastic3DLaw );
     ...
     * Default constructor.
     */
    HypoElasticPlastic3DLaw();


    HypoElasticPlastic3DLaw(FlowRulePointer pFlowRule, YieldCriterionPointer pYieldCriterion, HardeningLawPointer pHardeningLaw); 

    /**
     * Copy constructor.
     */
    HypoElasticPlastic3DLaw (const HypoElasticPlastic3DLaw& rOther);
    ...
    //HypoElasticPlastic3DLaw& operator=(const HypoElasticPlastic3DLaw& rOther);
     ...
     * Destructor.
     */
    virtual ~HypoElasticPlastic3DLaw();
...
}; // Class HypoElasticPlastic3DLaw
}  // namespace Kratos.
#endif // KRATOS_HYPOELASTIC_PLASTIC_3D_LAW_H_INCLUDED defined
