...
namespace Python
{
  ...
  void  AddCustomModelersToPython()
  {
    ...
    class_<MeshModeler, MeshModeler::Pointer, boost::noncopyable >
      ...
      .def("SetPreRefiningProcess",&MeshModeler::SetPreRefiningProcess)
      .def("SetPostRefiningProcess",&MeshModeler::SetPostRefiningProcess)
      ...
      .def("SetPreRefiningProcessVector",&MeshModeler::SetPreRefiningProcessVector)
      .def("SetPostRefiningProcessVector",&MeshModeler::SetPostRefiningProcessVector)
