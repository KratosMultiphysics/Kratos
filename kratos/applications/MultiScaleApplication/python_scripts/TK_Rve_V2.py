...
class RVEModelerSolidPredictor:
	...
	def Initialize(self, Model):
		if(self.Initialized == False):
			...
			if(self.IsSecondary == False):
				print("self.HashTagFileName: ",self.HashTagFileName)
				for iHashFile in self.HashTagFileName:
					print("iHashFile: ",iHashFile)
					self.RvePredictorCalc = RvePredictorCalculator(iHashFile)
