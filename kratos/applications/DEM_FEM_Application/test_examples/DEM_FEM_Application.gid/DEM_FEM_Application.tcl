...
proc InitGIDProject {dir} {
	...
	GiDMenu::InsertOption "DEM_FEM Application" [list "---"] 5 PRE "" "" ""
	GiDMenu::InsertOption "DEM_FEM Application" [list "Model Status"] 6 PRE "cond_report" "" ""
        GiDMenu::InsertOption "DEM_FEM Application" [list "Change Kratos Path"] 7 PRE "GetKratosPath" "" ""
	GiDMenu::UpdateMenus
	# Custom Menu
}
...
proc AfterMeshGeneration {fail} {
	create_point_elems PointForce3D
	create_point_elems PointForce2D
