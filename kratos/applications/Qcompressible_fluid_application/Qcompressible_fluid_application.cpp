...
namespace Kratos
{
	...
	KratosR1QcompressibleFluidApplication::KratosR1QcompressibleFluidApplication():	
mQFluid3D(0, Element::GeometryType::Pointer(new Tetrahedra3D4<Node<3> >(Element::GeometryType::PointsArrayType(4, Node<3>())))),
	...
	void KratosR1QcompressibleFluidApplication::Register()
	{
		std::cout << "Initializing KratosR1QcompressibleFluidApplication... " << std::endl;
		// calling base class register to register Kratos components
		KratosApplication::Register();
		std::cout << "Initializing KratosR1QcompressibleFluidApplication...Register completed " << std::endl;
		...
		std::cout << "Initializing KratosR1QcompressibleFluidApplication...variables succesfully registered " << std::endl;
		...
		std::cout << "Initializing KratosR1QcompressibleFluidApplication...elements succesfully registered " << std::endl;
