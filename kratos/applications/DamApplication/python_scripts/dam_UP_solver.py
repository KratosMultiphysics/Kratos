...
class DamUPSolver:
    ...
    def __init__(self, model_part, custom_settings): 
        ...
        print("Construction of Dam UP Solver finished")
    ...
    def AddVariables(self):
        ...
        print("UP variables correctly added")
    ...
    def Initialize(self):
        ...
        print ("Initialization Dam UP Solver finished")
