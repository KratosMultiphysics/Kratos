...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    void Execute()
    {
        ...
        const TableContainerType& table_month = mr_model_part.pGetTable(1)->Data();          // Table with information about months, used for the computations of Bofang formulation
        ...
        const TableContainerType& table_outer_temp = mr_model_part.pGetTable(3)->Data();     // Table with information about outer temperature
        const TableContainerType& table_ref_temp = mr_model_part.pGetTable(4)->Data();       // Table with information about reference, temperature 
...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    void Uniform_conditions(TableContainerType const& table_outer_temp)
    {
        const double& outer_temp =  table_outer_temp[mlast_id].second[0];                           // Outer temperature
