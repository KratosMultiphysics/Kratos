...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    // Constructor
    InterpolationWaterEvolutionConditionsLoadProcess(ModelPart& r_model_part, double time_unit_converter) : mr_model_part(r_model_part)
    {
...
#endif /* KRATOS_INTERPOLATION_WATER_EVOLUTION_CONDITIONS_LOAD_PROCESS defined */
