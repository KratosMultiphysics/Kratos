...
#if !defined(KRATOS_DAM_NEWTON_RAPHSON_STRATEGY)
#define KRATOS_DAM_NEWTON_RAPHSON_STRATEGY
...
class DamNewtonRaphsonStrategy : public SolvingStrategy<TSparseSpace, TDenseSpace, TLinearSolver>
{

public:

    KRATOS_CLASS_POINTER_DEFINITION(DamNewtonRaphsonStrategy);
...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    //Constructor
    DamNewtonRaphsonStrategy(ModelPart& model_part,
    ...
    //Destructor
    virtual ~DamNewtonRaphsonStrategy() {}
...
}; // Class DamNewtonRaphsonStrategy

} // namespace Kratos

#endif // KRATOS_DAM_NEWTON_RAPHSON_STRATEGY  defined
