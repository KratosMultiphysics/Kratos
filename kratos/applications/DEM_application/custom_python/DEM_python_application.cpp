...
BOOST_PYTHON_MODULE(KratosDEMApplication)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(KT_FACTOR)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(ICE_OPTION)
    ...
    //KRATOS_REGISTER_IN_PYTHON_VARIABLE(ORIENTATION) //Dangerous. Requires adding Quaternions to python
