...
#if !defined(KRATOS_CUBOIDCLUSTER3D_H_INCLUDED )
#define  KRATOS_CUBOIDCLUSTER3D_H_INCLUDED
...
namespace Kratos
{
    ...
    class CuboidCluster3D : public Cluster3D
    {
    public:
      ...
      /// Pointer definition of Cluster3D
        KRATOS_CLASS_POINTER_DEFINITION(CuboidCluster3D);
...
//         
        CuboidCluster3D( );
        CuboidCluster3D( IndexType NewId, GeometryType::Pointer pGeometry );
        CuboidCluster3D( IndexType NewId, NodesArrayType const& ThisNodes);
        CuboidCluster3D( IndexType NewId, GeometryType::Pointer pGeometry,  PropertiesType::Pointer pProperties );
...
//        }
  ...
  /// input stream function
    inline std::istream& operator >> (std::istream& rIStream, 
                    CuboidCluster3D& rThis){
        return rIStream;
    }

  /// output stream function
    inline std::ostream& operator << (std::ostream& rOStream, 
                    const CuboidCluster3D& rThis)
    {
...
#endif // KRATOS_CUBOIDCLUSTER3D_INCLUDED  defined
