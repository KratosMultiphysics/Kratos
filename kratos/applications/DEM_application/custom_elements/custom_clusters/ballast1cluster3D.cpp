...
namespace Kratos {
    ...
    void Ballast1Cluster3D::InitializeSolutionStep(const ProcessInfo& r_process_info) {
    ...
    void Ballast1Cluster3D::FinalizeSolutionStep(const ProcessInfo& r_process_info) {}
