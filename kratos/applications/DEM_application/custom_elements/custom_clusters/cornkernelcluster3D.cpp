...
namespace Kratos {
    ...
    void CornKernelCluster3D::InitializeSolutionStep(const ProcessInfo& r_process_info) {
    ...
    void CornKernelCluster3D::FinalizeSolutionStep(const ProcessInfo& r_process_info) {}
