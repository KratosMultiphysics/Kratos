...
namespace Kratos {
    ...
    void Ballast2Cluster3D::InitializeSolutionStep(const ProcessInfo& r_process_info) {
    ...
    void Ballast2Cluster3D::FinalizeSolutionStep(const ProcessInfo& r_process_info) {}
