...
#if !defined(KRATOS_CUBECLUSTER3D_H_INCLUDED )
#define  KRATOS_CUBECLUSTER3D_H_INCLUDED
...
namespace Kratos
{
    ...
    class CubeCluster3D : public Cluster3D
    {
    public:
      ...
      /// Pointer definition of Cluster3D
        KRATOS_CLASS_POINTER_DEFINITION(CubeCluster3D);
...
//         
        CubeCluster3D( );
        CubeCluster3D( IndexType NewId, GeometryType::Pointer pGeometry );
        CubeCluster3D( IndexType NewId, NodesArrayType const& ThisNodes);
        CubeCluster3D( IndexType NewId, GeometryType::Pointer pGeometry,  PropertiesType::Pointer pProperties );
...
#endif // KRATOS_CUBECLUSTER3D_INCLUDED  defined
