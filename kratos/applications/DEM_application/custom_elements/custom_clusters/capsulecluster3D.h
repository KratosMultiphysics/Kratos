...
#if !defined(KRATOS_CAPSULECLUSTER3D_H_INCLUDED)
#define KRATOS_CAPSULECLUSTER3D_H_INCLUDED
...
namespace Kratos
{
    ...
    class CapsuleCluster3D : public Cluster3D
    {
    public:
      ...
      /// Pointer definition of Cluster3D
        KRATOS_CLASS_POINTER_DEFINITION(CapsuleCluster3D);
...
//         
        CapsuleCluster3D( );
        CapsuleCluster3D( IndexType NewId, GeometryType::Pointer pGeometry );
...
#endif // KRATOS_CAPSULECLUSTER3D_INCLUDED  defined
