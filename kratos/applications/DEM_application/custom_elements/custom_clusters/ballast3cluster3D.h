...
#if !defined(KRATOS_BALLAST3CLUSTER3D_H_INCLUDED )
#define  KRATOS_BALLAST3CLUSTER3D_H_INCLUDED
...
namespace Kratos
{
    ...
    public:
      ...
      /// Pointer definition of Cluster3D
        KRATOS_CLASS_POINTER_DEFINITION(Ballast3Cluster3D);
...
//         
        Ballast3Cluster3D( );
        Ballast3Cluster3D( IndexType NewId, GeometryType::Pointer pGeometry );
        Ballast3Cluster3D( IndexType NewId, NodesArrayType const& ThisNodes);
        Ballast3Cluster3D( IndexType NewId, GeometryType::Pointer pGeometry,  PropertiesType::Pointer pProperties );
...
//        }
  ...
  /// input stream function
    inline std::istream& operator >> (std::istream& rIStream, 
                    Ballast3Cluster3D& rThis){
        return rIStream;
    }

  /// output stream function
    inline std::ostream& operator << (std::ostream& rOStream, 
                    const Ballast3Cluster3D& rThis)
    {
...
#endif // KRATOS_BALLAST3CLUSTER3D_INCLUDED  defined
