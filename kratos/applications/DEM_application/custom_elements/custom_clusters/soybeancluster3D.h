...
#if !defined(KRATOS_SOYBEANCLUSTER3D_H_INCLUDED )
#define  KRATOS_SOYBEANCLUSTER3D_H_INCLUDED
...
namespace Kratos
{
    ...
    class SoyBeanCluster3D : public Cluster3D
    {
    public:
      ...
      /// Pointer definition of Cluster3D
        KRATOS_CLASS_POINTER_DEFINITION(SoyBeanCluster3D);
...
//         
        SoyBeanCluster3D( );
        SoyBeanCluster3D( IndexType NewId, GeometryType::Pointer pGeometry );
        SoyBeanCluster3D( IndexType NewId, NodesArrayType const& ThisNodes);
        SoyBeanCluster3D( IndexType NewId, GeometryType::Pointer pGeometry,  PropertiesType::Pointer pProperties );
...
//        }
  ...
  /// input stream function
    inline std::istream& operator >> (std::istream& rIStream, 
                    SoyBeanCluster3D& rThis);

  /// output stream function
    inline std::ostream& operator << (std::ostream& rOStream, 
                    const SoyBeanCluster3D& rThis)
    {
...
#endif // KRATOS_SOYBEANCLUSTER3D_INCLUDED  defined
