...
#if !defined(KRATOS_ELLIPSOIDCLUSTER3D_H_INCLUDED )
#define  KRATOS_ELLIPSOIDCLUSTER3D_H_INCLUDED
...
namespace Kratos
{
  ...
  */
    class EllipsoidCluster3D : public Cluster3D
    {
    public:
      ...
      /// Pointer definition of Cluster3D
        KRATOS_CLASS_POINTER_DEFINITION(EllipsoidCluster3D);
...
//         
        EllipsoidCluster3D( );
        EllipsoidCluster3D( IndexType NewId, GeometryType::Pointer pGeometry );
        EllipsoidCluster3D( IndexType NewId, NodesArrayType const& ThisNodes);
        EllipsoidCluster3D( IndexType NewId, GeometryType::Pointer pGeometry,  PropertiesType::Pointer pProperties );
...
//        }
  ...
  /// input stream function
    inline std::istream& operator >> (std::istream& rIStream, 
                    EllipsoidCluster3D& rThis);

  /// output stream function
    inline std::ostream& operator << (std::ostream& rOStream, 
                    const EllipsoidCluster3D& rThis)
    {
...
#endif // KRATOS_ELLIPSOIDCLUSTER3D_INCLUDED  defined
