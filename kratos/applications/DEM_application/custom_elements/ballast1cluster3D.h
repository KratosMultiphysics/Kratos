...
#if !defined(KRATOS_BALLAST1CLUSTER3D_H_INCLUDED )
#define  KRATOS_BALLAST1CLUSTER3D_H_INCLUDED
...
namespace Kratos
{
  ...
  */
    class Ballast1Cluster3D : public Cluster3D
    {
    public:
      ...
      /// Pointer definition of Cluster3D
        KRATOS_CLASS_POINTER_DEFINITION(Ballast1Cluster3D);
...
//         
        Ballast1Cluster3D( );
        Ballast1Cluster3D( IndexType NewId, GeometryType::Pointer pGeometry );
        Ballast1Cluster3D( IndexType NewId, NodesArrayType const& ThisNodes);
        Ballast1Cluster3D( IndexType NewId, GeometryType::Pointer pGeometry,  PropertiesType::Pointer pProperties );
...
//        }
  ...
  /// input stream function
    inline std::istream& operator >> (std::istream& rIStream, 
                    Ballast1Cluster3D& rThis);

  /// output stream function
    inline std::ostream& operator << (std::ostream& rOStream, 
                    const Ballast1Cluster3D& rThis)
    {
...
#endif // KRATOS_BALLAST1CLUSTER3D_INCLUDED  defined
