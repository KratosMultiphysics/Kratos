...
#if !defined(KRATOS_PILLCLUSTER3D_H_INCLUDED )
#define  KRATOS_PILLCLUSTER3D_H_INCLUDED
...
namespace Kratos
{
  ...
  */
    class PillCluster3D : public Cluster3D
    {
    public:
      ...
      /// Pointer definition of Cluster3D
        KRATOS_CLASS_POINTER_DEFINITION(PillCluster3D);
...
//         
        PillCluster3D( );
        PillCluster3D( IndexType NewId, GeometryType::Pointer pGeometry );
        PillCluster3D( IndexType NewId, NodesArrayType const& ThisNodes);
        PillCluster3D( IndexType NewId, GeometryType::Pointer pGeometry,  PropertiesType::Pointer pProperties );
...
#endif // KRATOS_PILLCLUSTER3D_INCLUDED  defined
