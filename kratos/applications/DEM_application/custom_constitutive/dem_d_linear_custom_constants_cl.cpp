...
namespace Kratos {
    ...
    void DEM_D_Linear_Custom_Constants::SetConstitutiveLawInProperties(Properties::Pointer pProp) const {
        std::cout << "Assigning DEM_D_Linear_Custom_Constants to Properties " << pProp->Id() << std::endl;
