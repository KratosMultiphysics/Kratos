...
namespace Kratos
{
  ...
  KRATOS_DEFINE_VARIABLE(int, SURFACE_FRICC_1)
  KRATOS_DEFINE_VARIABLE(int, SURFACE_FRICC_2)
  KRATOS_DEFINE_VARIABLE(int, SURFACE_FRICC_3)
  KRATOS_DEFINE_VARIABLE(int, SURFACE_FRICC_4)
  KRATOS_DEFINE_VARIABLE(int, SURFACE_FRICC_5)
  KRATOS_DEFINE_VARIABLE(int, CYLINDER_FRICC_1)
  KRATOS_DEFINE_VARIABLE(int, CYLINDER_FRICC_2)
  KRATOS_DEFINE_VARIABLE(int, CYLINDER_FRICC_3)
  KRATOS_DEFINE_VARIABLE(int, CYLINDER_FRICC_4)
  KRATOS_DEFINE_VARIABLE(int, CYLINDER_FRICC_5)
