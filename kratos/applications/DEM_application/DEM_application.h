...
namespace Kratos
{
  ...
  KRATOS_DEFINE_VARIABLE(int, CYLINDER_FRICC)
  ...
  KRATOS_DEFINE_VARIABLE(double, CYLINDER_VELOCITY)
  ...
  KRATOS_DEFINE_3D_VARIABLE_WITH_COMPONENTS(PARTICLE_CYLINDER_CONTACT_FORCES)
