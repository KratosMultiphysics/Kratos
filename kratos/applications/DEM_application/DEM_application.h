...
namespace Kratos
{
  ...
  KRATOS_DEFINE_VARIABLE(double, SURFACE_FRICC_1)
  KRATOS_DEFINE_VARIABLE(double, SURFACE_FRICC_2)
  KRATOS_DEFINE_VARIABLE(double, SURFACE_FRICC_3)
  KRATOS_DEFINE_VARIABLE(double, SURFACE_FRICC_4)
  KRATOS_DEFINE_VARIABLE(double, SURFACE_FRICC_5)
  KRATOS_DEFINE_VARIABLE(double, CYLINDER_FRICC_1)
  KRATOS_DEFINE_VARIABLE(double, CYLINDER_FRICC_2)
  KRATOS_DEFINE_VARIABLE(double, CYLINDER_FRICC_3)
  KRATOS_DEFINE_VARIABLE(double, CYLINDER_FRICC_4)
  KRATOS_DEFINE_VARIABLE(double, CYLINDER_FRICC_5)
  ...
  KRATOS_DEFINE_VARIABLE(double, CYLINDER_ANGULAR_VELOCITY)  
  KRATOS_DEFINE_3D_VARIABLE_WITH_COMPONENTS(INITIAL_BASE_CYLINDER_CENTRE)
  KRATOS_DEFINE_3D_VARIABLE_WITH_COMPONENTS(CYLINDER_AXIS_DIR)  
