...
namespace Kratos
{
  ...
  KRATOS_CREATE_VARIABLE(int, CYLINDER_FRICC)
 ...
 //KRATOS_CREATE_VARIABLE(int, PARTICLE_FAILURE_ID)
  ...
  KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(PARTICLE_CYLINDER_CONTACT_FORCES)
  ...
  void KratosDEMApplication::Register()
  {
    ...
    KRATOS_REGISTER_VARIABLE(CYLINDER_FRICC)
    ...
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(PARTICLE_CYLINDER_CONTACT_FORCES)
