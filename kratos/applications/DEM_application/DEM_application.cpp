...
namespace Kratos
{
   ...
   */
        ...
        KRATOS_CREATE_VARIABLE( double,  CONTACT_FAILURE_HIGH)
        KRATOS_CREATE_VARIABLE( double,  CONTACT_FAILURE_LOW)
	...
	void KratosDEMApplication::Register()
	{
		...
		std::cout << "Initializing KratosDEMApplication... " << std::endl;
                ...
                KRATOS_REGISTER_VARIABLE ( CONTACT_FAILURE_HIGH )
                KRATOS_REGISTER_VARIABLE ( CONTACT_FAILURE_LOW )
                ...
                KRATOS_REGISTER_VARIABLE( CONTACT_TAU_HIGH)
                KRATOS_REGISTER_VARIABLE( CONTACT_TAU_LOW)
                KRATOS_REGISTER_VARIABLE( CONTACT_TAU_MEAN)
