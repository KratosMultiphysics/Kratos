...
problem_name = 'rotating_ball_rolling_friction'
problem_path = '/home/cimne/kratos/applications/DEM_application/test_examples/rotating_ball_rolling_friction.gid'
