...
#if !defined(KRATOS_RIGID_FACE_CONFIGURE_INCLUDED)
#define  KRATOS_RIGID_FACE_CONFIGURE_INCLUDED
...
public:
    ...
    KRATOS_CLASS_POINTER_DEFINITION(RigidFaceConfigure);
    
	
	typedef SpatialSearch                                           SearchType;

    typedef SearchType::PointType                                   PointType;
    typedef SearchType::ConditionsContainerType::ContainerType      ContainerType;
    typedef SearchType::ConditionsContainerType                     ElementsContainerType;  // * Comentar -> Create_and_destroy.h
    
    typedef SearchType::ConditionType                               ElementType;
    typedef ContainerType::value_type                               PointerType;
    typedef ContainerType::iterator                                 IteratorType;
    
    typedef SearchType::ConditionsContainerType::ContainerType        ResultContainerType;
	...
	typedef PointerType  ElementPointerType; //// DEM
	typedef PointerType  ConditionPointerType; //// FEM
...
/////Cfeng: For Particle DEM
  static inline void CalculateBoundingBox(const ElementPointerType& rObject, PointType& rLowPoint, PointType& rHighPoint, const double& Radius)
    {
...
///Cfeng: For FEM conditions
	static inline void CalculateBoundingBox(const ConditionPointerType& rObject, PointType& rLowPoint, PointType& rHighPoint)
    {
	...
	*/
    ...
    static inline bool Intersection(const ElementPointerType& rObj_1, const ConditionPointerType& rObj_2,  const double& Radius)
     {
    ...
    //******************************************************************************************************************
     ...
     static inline bool  IntersectionBox(const ConditionPointerType& rObject,  const PointType& rLowPoint, const PointType& rHighPoint)
     {
...
private:
    ...
    /// Assignment operator.
    RigidFaceConfigure& operator=(RigidFaceConfigure const& rOther);

    /// Copy constructor.
    RigidFaceConfigure(RigidFaceConfigure const& rOther);
    ...
    template <std::size_t TDimension>
    inline std::istream& operator >> (std::istream& rIStream, RigidFaceConfigure<TDimension> & rThis){
        return rIStream;
        }

    /// output stream function
    template <std::size_t TDimension>
    inline std::ostream& operator << (std::ostream& rOStream, const RigidFaceConfigure<TDimension>& rThis){
