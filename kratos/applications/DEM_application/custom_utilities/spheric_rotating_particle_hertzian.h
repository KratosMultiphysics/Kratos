...
#ifndef _SPHERIC_ROTATING_PARTICLE_HERTZIAN_H
#define	_SPHERIC_ROTATING_PARTICLE_HERTZIAN_H
...
namespace Kratos{
  ...
  */
class SphericRotatingHertzianParticle: public IndexedObject{
...
public:
    ...
    /// Pointer definition of SphericRotatingHertzianParticle
    KRATOS_CLASS_POINTER_DEFINITION(SphericRotatingHertzianParticle);
    typedef WeakPointerVector<SphericRotatingHertzianParticle > ParticleWeakVectorType;
    typedef WeakPointerVector<SphericRotatingHertzianParticle >::iterator ParticleWeakIteratorType;
    ...
    /// Default constructor.
    SphericRotatingHertzianParticle():IndexedObject(0){
    ...
    SphericRotatingHertzianParticle(double tol, Node<3>::Pointer center):IndexedObject(center->Id()){ //CAL FICAR-HO DIRECTAMENT, NO DUPLICAR LA INFO.
        mpCenterNode = center;
        ...
        KRATOS_WATCH(mYoungStar);
        };

  /// Destructor.
    virtual ~SphericRotatingHertzianParticle(){};
  ...
  ///@{
    ...
    double operator()(SphericRotatingHertzianParticle const& p1, SphericRotatingHertzianParticle const& p2 ){
    ...
    virtual std::string Info() const{
        return "SphericRotatingHertzianParticle";
        }

    /// Print information about this object.
    virtual void PrintInfo(std::ostream& rOStream) const{
        rOStream << "SphericRotatingHertzianParticle";
        }
    ...
    SphericRotatingHertzianParticle(const SphericRotatingHertzianParticle& rOtherParticle){
...
private:
    ...
    /// Assignment operator.
    SphericRotatingHertzianParticle& operator=(const SphericRotatingHertzianParticle& rOtherParticle);
    // Copy constructor.
    ...
    inline std::istream& operator >> (std::istream& rIStream, SphericRotatingHertzianParticle& rThis);

    /// output stream function
    inline std::ostream& operator << (std::ostream& rOStream, const SphericRotatingHertzianParticle& rThis){
...
#endif	/* _SPHERIC_ROTATING_PARTICLE_HERTZIAN_H */
