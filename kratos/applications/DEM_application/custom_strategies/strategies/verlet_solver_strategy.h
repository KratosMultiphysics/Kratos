...
namespace Kratos
{
  ...
  class TDenseSpace,
  class TLinearSolver>
  class VerletVelocitySolverStrategy: public ExplicitSolverStrategy<TSparseSpace,TDenseSpace,TLinearSolver>
  {
      public:
      ...
      virtual double Solve()
      {
          ...
          IntegrationOfMotionStep1();
          BaseType::GetForce();
          IntegrationOfMotionStep2();
      ...
      void IntegrationOfMotionStep1()
      {

          BaseType::GetScheme()->CalculateStep1(BaseType::GetModelPart());
          //GetScheme()->CalculateStep1(*mpCluster_model_part);
      }

      void IntegrationOfMotionStep2()
      {
          BaseType::GetScheme()->Calculate(BaseType::GetModelPart());
          BaseType::GetScheme()->Calculate(*mpCluster_model_part);
      }
