...
#include "custom_elements/2fluid_discontinuousvelocity_2d.h" //including the file for the element
...
//	KRATOS_DEFINE_VARIABLE(double, NODAL_AREA)
	...
	*/
	...
	private:
		...
		const PFEM2DiscontinuousVelocity2D mPFEM2DiscontinuousVelocity2D;
