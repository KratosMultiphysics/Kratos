...
#if !defined(KRATOS_ASSIGN_VALUE_TO_SCALAR_VARIABLE_PROCESS_H_INCLUDED )
#define  KRATOS_ASSIGN_VALUE_TO_SCALAR_VARIABLE_PROCESS_H_INCLUDED
...
*/
class AssignValueToScalarVariableProcess : public Process
{
public:
    ///@name Type Definitions
    ///@{

    /// Pointer definition of AssignValueToScalarVariableProcess
    KRATOS_CLASS_POINTER_DEFINITION(AssignValueToScalarVariableProcess);

    ///@}
    ///@name Life Cycle
    ///@{
    AssignValueToScalarVariableProcess(ModelPart& model_part,
    ...
    /// Destructor.
    virtual ~AssignValueToScalarVariableProcess() {}
    ...
    /// Execute method is used to execute the AssignValueToScalarVariableProcess algorithms.
    ...
    {
        return "AssignValueToScalarVariableProcess";
    }

    /// Print information about this object.
    virtual void PrintInfo(std::ostream& rOStream) const
    {
        rOStream << "AssignValueToScalarVariableProcess";
    }
...
protected:
    ...
    /// Copy constructor.
    AssignValueToScalarVariableProcess(AssignValueToScalarVariableProcess const& rOther);
...
private:
    ...
    /// Assignment operator.
    AssignValueToScalarVariableProcess& operator=(AssignValueToScalarVariableProcess const& rOther);
...
}; // Class AssignValueToScalarVariableProcess
...
inline std::istream& operator >> (std::istream& rIStream,
                                  AssignValueToScalarVariableProcess& rThis);

/// output stream function
inline std::ostream& operator << (std::ostream& rOStream,
                                  const AssignValueToScalarVariableProcess& rThis)
{
...
#endif // KRATOS_ASSIGN_VALUE_TO_SCALAR_VARIABLE_PROCESS_H_INCLUDED  defined
