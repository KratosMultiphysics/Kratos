...
#if !defined(KRATOS_RESIDUAL_BASED_STATIC_SCHEME_V2 )
#define  KRATOS_RESIDUAL_BASED_STATIC_SCHEME_V2
...
template<class TSparseSpace,
         ...
         >
class ResidualBasedStaticScheme_V2 : public Scheme<TSparseSpace,TDenseSpace>
{
...
public:
    ...
    //typedef boost::shared_ptr< ResidualBasedStaticScheme_V2<TSparseSpace,TDenseSpace> > Pointer;
    KRATOS_CLASS_POINTER_DEFINITION( ResidualBasedStaticScheme_V2 );
    ...
    */
    ...
    /** Constructor.
    */
    ResidualBasedStaticScheme_V2()
        : Scheme<TSparseSpace,TDenseSpace>()
    {}

    /** Destructor.
    */
    virtual ~ResidualBasedStaticScheme_V2() {}
...
#endif /* KRATOS_RESIDUAL_BASED_STATIC_SCHEME_V2  defined */
