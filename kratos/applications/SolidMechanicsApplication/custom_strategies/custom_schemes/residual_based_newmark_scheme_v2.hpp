...
#if !defined(KRATOS_RESIDUAL_BASED_NEWMARK_SCHEME_V2 )
#define  KRATOS_RESIDUAL_BASED_NEWMARK_SCHEME_V2
...
class ResidualBasedNewmarkScheme_V2: public Scheme<TSparseSpace,TDenseSpace>
{
protected:
...
public:
    ...
    /*@{ */
    KRATOS_CLASS_POINTER_DEFINITION( ResidualBasedNewmarkScheme_V2 );
     ...
     * The bossak method
     */
    ResidualBasedNewmarkScheme_V2(double rDynamic=1)
    ...
    /** Destructor.
     */
    virtual ~ResidualBasedNewmarkScheme_V2
    () {}
...
protected:
        ...
        ProcessInfo& CurrentProcessInfo)
    {
        ...
        {
            noalias(LHS_Contribution) += M *  mNewmark.c0 * mNewmark.static_dynamic;
        ...
        {
            noalias(LHS_Contribution) += D * mNewmark.c1 * mNewmark.static_dynamic;
...
#endif /* KRATOS_RESIDUAL_BASED_NEWMARK_SCHEME_V2  defined */
