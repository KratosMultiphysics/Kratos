...
KRATOS_CREATE_VARIABLE( Vector, POINT_LOAD )
KRATOS_CREATE_VARIABLE( Vector, LINE_LOAD )
KRATOS_CREATE_VARIABLE( Vector, SURFACE_LOAD )

KRATOS_CREATE_VARIABLE( Vector, LOCAL_POINT_LOAD )
KRATOS_CREATE_VARIABLE( Vector, LOCAL_LINE_LOAD )
KRATOS_CREATE_VARIABLE( Vector, LOCAL_SURFACE_LOAD )
...
void KratosSolidMechanicsApplication::Register()
{
    ...
    KRATOS_REGISTER_VARIABLE( LOCAL_POINT_LOAD )
    KRATOS_REGISTER_VARIABLE( LOCAL_LINE_LOAD ) 
    KRATOS_REGISTER_VARIABLE( LOCAL_SURFACE_LOAD )
