...
proc ::KPlot::Plot { c points title xtext ytext } {    
    ...
    foreach margin {top bottom left right} size { 50 50 0 0 } {
    ...
    for {set serie 0} {$serie<$nseries} {incr serie} {
        $xyplot dataconfig $serie -colour [lindex $colors [expr {$serie%$ncolors}]] -type both -symbol plus        
