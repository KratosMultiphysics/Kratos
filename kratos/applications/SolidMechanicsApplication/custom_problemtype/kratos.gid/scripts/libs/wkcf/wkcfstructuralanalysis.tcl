...
proc ::wkcf::WriteLineLoad {AppId cloadtid} {
	...
	# wa "cgroupid:$cgroupid"
		...
		if {$useqelem=="1"} {
		    ...
		    set nodes [lrange [GiD_Mesh get element $elem_id] 2 end]
		    set N1 [lindex $nodes 0]
		    set N2 [lindex $nodes 1]
		    incr sa_icondid
...
proc ::wkcf::WriteStructuralProjectParameters {AppId fileid PDir} {
	...
	# Number of Steps
	set cxpath "$AppId//c.SolutionStrategy//c.Dynamic//i.NumberOfSteps"
	set NumberOfSteps [::xmlutils::setXml $cxpath $cproperty]
