...
BOOST_PYTHON_MODULE(KratosSolidMechanicsApplication)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE( POINT_LOAD );
    KRATOS_REGISTER_IN_PYTHON_VARIABLE( LINE_LOAD );
    KRATOS_REGISTER_IN_PYTHON_VARIABLE( SURFACE_LOAD );

    KRATOS_REGISTER_IN_PYTHON_VARIABLE( LOCAL_POINT_LOAD );
    KRATOS_REGISTER_IN_PYTHON_VARIABLE( LOCAL_LINE_LOAD );
    KRATOS_REGISTER_IN_PYTHON_VARIABLE( LOCAL_SURFACE_LOAD );
