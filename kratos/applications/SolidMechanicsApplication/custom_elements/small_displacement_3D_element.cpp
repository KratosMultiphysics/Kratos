...
namespace Kratos
{
  ...
  void SmallDisplacement3DElement::SetStandardParameters(Standard& rVariables,
  ...
  void SmallDisplacement3DElement::InitializeStandardVariables (Standard & rVariables, const ProcessInfo& rCurrentProcessInfo)
  {
 ...
 //************************************************************************************
  ...
  void SmallDisplacement3DElement::CalculateKinematics(Standard& rVariables,
