...
double TTetra::getSurface()
{
    return 0;
}
void TTetra::copyFrom(TValuedObject e ) {}
TTetra::TTetra(TObject* owner)
{
...
int TTetra::hasVertex(TTetra t1 )
{
    return 0;
}
bool TTetra::hasVertex(TVertex v0 )
{
    return 0;
}
TTetra* TTetra::getTetraNeighbour(int faceI ,TVertex v0,TVertex v1,TVertex v2, TList<TObject> *tl)
...
TList<TObject>* TTetra::getNeighbours(int depth)
{
    return NULL;
}
