...
#if !defined (KRATOS_HENCKY_U_P_J2_PLANE_STRAIN_2D_LAW_H_INCLUDED)
#define       KRATOS_HENCKY_U_P_J2_PLANE_STRAIN_2D_LAW_H_INCLUDED
...
public:
    ...
    KRATOS_CLASS_POINTER_DEFINITION( HenckyPlasticUPJ2PlaneStrain2DLaw );
    ...
    HenckyPlasticUPJ2PlaneStrain2DLaw(FlowRulePointer pFlowRule, YieldCriterionPointer pYieldCriterion, HardeningLawPointer pHardeningLaw); 

    /**
     * Copy constructor.
     */
    HenckyPlasticUPJ2PlaneStrain2DLaw (const HenckyPlasticUPJ2PlaneStrain2DLaw& rOther);
     ...
     * Destructor.
     */
    virtual ~HenckyPlasticUPJ2PlaneStrain2DLaw();
