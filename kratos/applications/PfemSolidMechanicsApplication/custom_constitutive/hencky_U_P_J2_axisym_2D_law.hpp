...
#if !defined (KRATOS_HENCKY_U_P_J2_AXISYM_2D_LAW_H_INCLUDED)
#define       KRATOS_HENCKY_U_P_J2_AXISYM_2D_LAW_H_INCLUDED
...
public:
    ...
    KRATOS_CLASS_POINTER_DEFINITION( HenckyPlasticUPJ2Axisym2DLaw );
    ...
    HenckyPlasticUPJ2Axisym2DLaw(FlowRulePointer pFlowRule, YieldCriterionPointer pYieldCriterion, HardeningLawPointer pHardeningLaw); 

    /**
     * Copy constructor.
     */
    HenckyPlasticUPJ2Axisym2DLaw (const HenckyPlasticUPJ2Axisym2DLaw& rOther);
     ...
     * Destructor.
     */
    virtual ~HenckyPlasticUPJ2Axisym2DLaw();
