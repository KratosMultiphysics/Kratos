...
#if !defined (KRATOS_NON_LINEAR_HENCKY_CAM_CLAY_PLASTIC_AXISYM_2D_LAW_H_INCLUDED)
#define       KRATOS_NON_LINEAR_HENCKY_CAM_CLAY_PLASTIC_AXISYM_2D_LAW_H_INCLUDED
...
class NonLinearHenckyCamClayPlasticAxisym2DLaw 
...
public:
    ...
    KRATOS_CLASS_POINTER_DEFINITION( NonLinearHenckyCamClayPlasticAxisym2DLaw );
    ...
    NonLinearHenckyCamClayPlasticAxisym2DLaw(FlowRulePointer pFlowRule, YieldCriterionPointer pYieldCriterion, HardeningLawPointer pHardeningLaw); 

    /**
     * Copy constructor.
     */
    NonLinearHenckyCamClayPlasticAxisym2DLaw (const NonLinearHenckyCamClayPlasticAxisym2DLaw& rOther);
     ...
     * Destructor.
     */
    virtual ~NonLinearHenckyCamClayPlasticAxisym2DLaw();
...
private:
    ...
    {
        KRATOS_SERIALIZE_SAVE_BASE_CLASS( rSerializer, NonLinearHenckyCamClayPlasticAxisym2DLaw )
    }

    virtual void load(Serializer& rSerializer)
    {
        KRATOS_SERIALIZE_LOAD_BASE_CLASS( rSerializer, NonLinearHenckyCamClayPlasticAxisym2DLaw )
    }
