...
#if !defined (KRATOS_BORJA_HENCKY_CAM_CLAY_PLASTIC_PLANE_STRAIN_2D_LAW_H_INCLUDED)
#define       KRATOS_BORJA_HENCKY_CAM_CLAY_PLASTIC_PLANE_STRAIN_2D_LAW_H_INCLUDED
...
public:
    ...
    BorjaHenckyCamClayPlasticPlaneStrain2DLaw(FlowRulePointer pFlowRule, YieldCriterionPointer pYieldCriterion, HardeningLawPointer pHardeningLaw); 

    /**
     * Copy constructor.
     */
    BorjaHenckyCamClayPlasticPlaneStrain2DLaw (const BorjaHenckyCamClayPlasticPlaneStrain2DLaw& rOther);
     ...
     * Destructor.
     */
    virtual ~BorjaHenckyCamClayPlasticPlaneStrain2DLaw();
