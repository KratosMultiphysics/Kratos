...
private:
   ...
   //METHODS CALLED AFTER TESSELLATION
    ...
    //Build boundary with conditions in model_part after the Delaunay Tesselation 
    //(identifying new boundary and create the model skin)
    void BuildMeshBoundary ( ModelPart& rModelPart, 
			     MeshingVariables& rMeshingVariables,
			     ModelPart::IndexType MeshId=0 );
    ...
    void RefineBoundary ( ModelPart& rModelPart,
			  MeshingVariables& rMeshingVariables,
			  ModelPart::IndexType MeshId=0 );
    
    void RemoveCloseNodes ( ModelPart& rModelPart, 
			    MeshingVariables& rMeshingVariables,
			    ModelPart::IndexType MeshId=0 );
