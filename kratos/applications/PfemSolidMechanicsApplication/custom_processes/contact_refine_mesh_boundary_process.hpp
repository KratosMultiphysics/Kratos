...
#if !defined(KRATOS_CONTACT_REFINE_MESH_BOUNDARY_PROCESS_H_INCLUDED )
#define  KRATOS_CONTACT_REFINE_MESH_BOUNDARY_PROCESS_H_INCLUDED
...
class ContactRefineMeshBoundaryProcess
  : public RefineMeshBoundaryProcess
{
public:
    ...
    KRATOS_CLASS_POINTER_DEFINITION( ContactRefineMeshBoundaryProcess );
    ...
    /// Destructor.
    virtual ~ContactRefineMeshBoundaryProcess() {}
    ...
    {
        return "ContactRefineMeshBoundaryProcess";
    }

    /// Print information about this object.
    virtual void PrintInfo(std::ostream& rOStream) const
    {
        rOStream << "ContactRefineMeshBoundaryProcess";
    }
...
private:
    ...
    /// Assignment operator.
    ContactRefineMeshBoundaryProcess& operator=(ContactRefineMeshBoundaryProcess const& rOther);
...
inline std::istream& operator >> (std::istream& rIStream,
                                  ContactRefineMeshBoundaryProcess& rThis);

/// output stream function
inline std::ostream& operator << (std::ostream& rOStream,
                                  const ContactRefineMeshBoundaryProcess& rThis)
{
...
#endif // KRATOS_CONTACT_REFINE_MESH_BOUNDARY_PROCESS_H_INCLUDED  defined 
