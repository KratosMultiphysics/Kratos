...
#if !defined(KRATOS_UPDATED_LAGRANGIAN_U_wP_SECOND_ELEMENT_H_INCLUDED )
#define  KRATOS_UPDATED_LAGRANGIAN_U_wP_SECOND_ELEMENT_H_INCLUDED
...
class UpdatedLagrangianUwPSecondElement
...
public:
    ...
    KRATOS_CLASS_POINTER_DEFINITION( UpdatedLagrangianUwPSecondElement );
    ///@}
    ...
    UpdatedLagrangianUwPSecondElement();

    /// Default constructors
    UpdatedLagrangianUwPSecondElement(IndexType NewId, GeometryType::Pointer pGeometry);

    UpdatedLagrangianUwPSecondElement(IndexType NewId, GeometryType::Pointer pGeometry, PropertiesType::Pointer pProperties);

    ///Copy constructor
    UpdatedLagrangianUwPSecondElement(UpdatedLagrangianUwPSecondElement const& rOther);


    /// Destructor.
    virtual ~UpdatedLagrangianUwPSecondElement();
    ...
    /// Assignment operator.
    UpdatedLagrangianUwPSecondElement& operator=(UpdatedLagrangianUwPSecondElement const& rOther);
