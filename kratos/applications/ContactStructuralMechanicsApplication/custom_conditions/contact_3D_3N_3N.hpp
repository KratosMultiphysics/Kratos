        ...
        )
{
    ...
    const double crhs3 =             N1[0]*v1(0,0) + N1[1]*v1(1,0) + N1[2]*v1(2,0) - N2[0]*v2(0,0) - N2[1]*v2(1,0) - N2[2]*v2(2,0);
    const double crhs4 =             N1[0]*v1(0,1) + N1[1]*v1(1,1) + N1[2]*v1(2,1) - N2[0]*v2(0,1) - N2[1]*v2(1,1) - N2[2]*v2(2,1);
    const double crhs5 =             N1[0]*v1(0,2) + N1[1]*v1(1,2) + N1[2]*v1(2,2) - N2[0]*v2(0,2) - N2[1]*v2(1,2) - N2[2]*v2(2,2);
