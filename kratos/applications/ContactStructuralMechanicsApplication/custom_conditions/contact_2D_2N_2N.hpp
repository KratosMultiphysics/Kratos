        ...
        )
{
 ...
 // TODO: Check which derivatives need
    ...
    const double clhs43 =     inner_prod(Gaps, N1); // GAPG(U1(0,0), U1(0,1), U1(1,0), U1(1,1), U2(0,0), U2(0,1), U2(1,0), U2(1,1))
...
//substitute_derivatives_variables_inactive // TODO: Check which derivatives need
        ...
        )
{
    ...
    const double crhs11 =     inner_prod(Gaps, N1); // GAPG(U1(0,0), U1(0,1), U1(1,0), U1(1,1), U2(0,0), U2(0,1), U2(1,0), U2(1,1))
