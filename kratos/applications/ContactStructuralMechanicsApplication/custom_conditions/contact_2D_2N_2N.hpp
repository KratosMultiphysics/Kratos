...
//     const double epsilon_tangent = rContactData.epsilon_tangent;
    ...
    const double Dnormalmaster11u211 =     DeltaNormalm[3](1,1);
    const double Dnormalmaster11u210 =     DeltaNormalm[2](1,1);
    const double Dnormalmaster11u201 =     DeltaNormalm[1](1,1);
    const double Dnormalmaster11u200 =     DeltaNormalm[0](1,1);
    const double Dnormalmaster10u211 =     DeltaNormalm[3](1,0);
    const double Dnormalmaster10u210 =     DeltaNormalm[2](1,0);
    const double Dnormalmaster10u201 =     DeltaNormalm[1](1,0);
    const double Dnormalmaster10u200 =     DeltaNormalm[0](1,0);
    const double Dnormalmaster01u211 =     DeltaNormalm[3](0,1);
    const double Dnormalmaster01u210 =     DeltaNormalm[2](0,1);
    const double Dnormalmaster01u201 =     DeltaNormalm[1](0,1);
    const double Dnormalmaster01u200 =     DeltaNormalm[0](0,1);
    const double Dnormalmaster00u211 =     DeltaNormalm[3](0,0);
    const double Dnormalmaster00u210 =     DeltaNormalm[2](0,0);
    const double Dnormalmaster00u201 =     DeltaNormalm[1](0,0);
    const double Dnormalmaster00u200 =     DeltaNormalm[0](0,0);
...
//     const std::vector<double> DeltaJs = rContactData.DeltaJ_s;
//     
//     const Vector DeltaNormalsu100 = prod(trans(rContactData.Delta_Normal_s[0]),N1);
//     const Vector DeltaNormalsu101 = prod(trans(rContactData.Delta_Normal_s[1]),N1);
//     const Vector DeltaNormalsu110 = prod(trans(rContactData.Delta_Normal_s[2]),N1);
//     const Vector DeltaNormalsu111 = prod(trans(rContactData.Delta_Normal_s[3]),N1);
//     
//     const Vector Deltatangentxisu100 = prod(trans(rContactData.Delta_Tangent_xi_s[0]),N1);
//     const Vector Deltatangentxisu101 = prod(trans(rContactData.Delta_Tangent_xi_s[1]),N1);
//     const Vector Deltatangentxisu110 = prod(trans(rContactData.Delta_Tangent_xi_s[2]),N1);
//     const Vector Deltatangentxisu111 = prod(trans(rContactData.Delta_Tangent_xi_s[3]),N1);
//     
//     const Vector DeltaNormalmu200 = prod(trans(rContactData.Delta_Normal_m[0]),N2);
//     const Vector DeltaNormalmu201 = prod(trans(rContactData.Delta_Normal_m[1]),N2);
//     const Vector DeltaNormalmu210 = prod(trans(rContactData.Delta_Normal_m[2]),N2);
//     const Vector DeltaNormalmu211 = prod(trans(rContactData.Delta_Normal_m[3]),N2);
//     
