        ...
        if (TDim == 2)
        {
            if (TNumNodes == 2)
            {
                if (i_dof == 0)
                {
                    ...
                    rContactData.DeltaN2[0][1] =  - rContactData.DeltaN2[0][0];
                }
                else if (i_dof == 1)
                {
                    ...
                    rContactData.DeltaN2[1][1] = - rContactData.DeltaN2[1][0];
                }
                else if (i_dof == 2)
                {
                    ...
                    rContactData.DeltaN2[2][1] = - rContactData.DeltaN2[2][0];
                }
                else if (i_dof == 3)
                {
                    ...
                    rContactData.DeltaN2[3][1] = - rContactData.DeltaN2[3][0];
                }
                else if (i_dof == 4)
                {
                    ...
                    rContactData.DeltaN2[4][1] = - rContactData.DeltaN2[4][0];
                }
                else if (i_dof == 5)
                {
                    ...
                    rContactData.DeltaN2[5][1] = - rContactData.DeltaN2[5][0];
                }
                else if (i_dof == 6)
                {
                   ...
                   rContactData.DeltaN2[6][1] = - rContactData.DeltaN2[6][0];
                }
                else if (i_dof == 7)
                {
                    ...
                    rContactData.DeltaN2[7][1] = - rContactData.DeltaN2[7][0];
                }
            }
        }
        else
