...
//         const unsigned int& local_dimension_master = current_master_element.LocalSpaceDimension( );
        ...
        if ( GetGeometry( ).PointsNumber( ) == 3 )
        {
            // LOG_GENERAL( LT_BLUE, "|_ Master : ", Variables.GetMasterElement( )[0].Id( ) << ", " << Variables.GetMasterElement( )[1].Id( ) << ", " << Variables.GetMasterElement( )[2].Id( ) )
            // LOG_GENERAL( LT_BLUE, "|_ Slave  : ",                GetGeometry( )[0].Id( ) << ", " <<                GetGeometry( )[1].Id( ) << ", " <<                GetGeometry( )[2].Id( ) )
        }
        else if ( GetGeometry( ).PointsNumber( ) == 4 )
        {
             LOG_GENERAL( LT_BLUE, "|_ Master : ", Variables.GetMasterElement( )[0].Id( ) << ", " << Variables.GetMasterElement( )[1].Id( ) << ", " << Variables.GetMasterElement( )[2].Id( ) << ", " << Variables.GetMasterElement( )[3].Id( ) )
             LOG_GENERAL( LT_BLUE, "|_ Slave  : ",                GetGeometry( )[0].Id( ) << ", " <<                GetGeometry( )[1].Id( ) << ", " <<                GetGeometry( )[2].Id( ) << ", " <<                GetGeometry( )[3].Id( ) )
        }
