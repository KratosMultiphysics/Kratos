...
def BenchmarkCheck(time, model_part):
    ...
    benchmarking.Output(bottom_right_node.GetSolutionStepValue(PRESSURE), "pressure on node 320 ", 0.00001)
    benchmarking.Output(bottom_right_node.GetSolutionStepValue(DISTANCE), "distance on node 320 ", 0.00001)
    benchmarking.Output(top_left_node.GetSolutionStepValue(DISTANCE), "distance on node 646 ", 0.00001)
