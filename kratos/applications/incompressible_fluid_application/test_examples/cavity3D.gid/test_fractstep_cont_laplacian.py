...
if(SolverType == "fractional_step"):
    ...
    fluid_solver.velocity_linear_solver =  ScalingSolver(BICGSTABSolver(1e-9, 5000), True)
    fluid_solver.pressure_linear_solver =  ScalingSolver(CGSolver(1e-9, 5000), True)
