...
applications_interface.Import_TrilinosApplication = True
...
elif(SolverType == "Monolithic"):
    import monolithic_solver_ALE
    monolithic_solver_ALE.AddVariables(fluid_model_part)
else:
...
if(SolverType == "FractionalStep"):
    ...
    monolithic_solver_ALE.AddDofs(fluid_model_part)
...
if(SolverType == "FractionalStep"):
    ...
    fluid_solver = monolithic_solver_ALE.MonolithicSolver(fluid_model_part,domain_size)
    fluid_solver.linear_solver = SuperLUSolver()
    fluid_solver.max_iter = 20   
    fluid_solver.Initialize()
