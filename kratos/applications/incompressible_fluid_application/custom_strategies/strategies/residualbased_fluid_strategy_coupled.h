...
#if !defined(KRATOS_RESIDUALBASED_FLUID_STRATEGY_COUPLED )
#define  KRATOS_RESIDUALBASED_FLUID_STRATEGY_COUPLED
...
namespace Kratos
{
	...
	*/
	...
	class TLinearSolver
	>
	class ResidualBasedFluidStrategyCoupled 
	...
	public:
		...
		typedef boost::shared_ptr< ResidualBasedFluidStrategyCoupled<TSparseSpace,TDenseSpace,TLinearSolver> > Pointer;
...
*/
				...
				i != BaseType::GetModelPart().NodesEnd() ; ++i)
			{
				...
				std::cout << "sono adesso qui" << std::endl;
		...
		/** Destructor.
		*/
		virtual ~ResidualBasedFluidStrategyCoupled() {}
...
/*				double p_norm = 0.0;
		...
		{	
			...
			normDx[0] = mfracvel_strategy->Solve();
			normDx[1] = normDx[0];
			normDx[2] = normDx[0];
...
// KRATOS_WATCH(elemental_stabilization); 
// noalias(elemental_stabilization) = ZeroVector(3);
	...
	private:
		...
		/** Copy constructor.
		*/
		ResidualBasedFluidStrategyCoupled(const ResidualBasedFluidStrategyCoupled& Other);
...
#endif /* KRATOS_RESIDUALBASED_FLUID_STRATEGY_COUPLED  defined */
