...
##        self.linear_solver = CGSolver(1e-6, 5000,pPrecond)
       ...
       # self.conv_criteria = UPCriteria(1e-12,1e-14,1e-15,1e-17)
        ...
        self.ChooseElement = ChooseElementProcess(model_part, 3, "ASGSCOMPPRDC3D", "ASGSCompressible3D")      
        #default settings
        self.echo_level = 1
	...
	self.MeshMover= MoveMeshProcess(self.model_part);
       ...
       # self.Mesher = TetGenPfemModeler()
        ...
        self.elem_neighbor_finder = FindElementalNeighboursProcess(model_part, 3, 20)
