...
##        pPrecond = ILU0Preconditioner()
	...
	#verbosity = 0
        ...
        self.tol = 1e-3
        self.verbosity = 0
        self.linear_solver = AMGCLSolver(AMGCLSmoother.ILU0,AMGCLIterativeSolverType.BICGSTAB_WITH_GMRES_FALLBACK,self.tol,self.iterations,self.verbosity,self.gmres_size)
