...
TestNode = FindNode(0.0, 0.25, fluid_model_part)
...
benchmarking.Output(TestNode.GetSolutionStepValue(SHAPE_SENSITIVITY_X), "Test SHAPE_SENSITIVITY_X", None, 0.001)
benchmarking.Output(TestNode.GetSolutionStepValue(SHAPE_SENSITIVITY_Y), "Test SHAPE_SENSITIVITY_Y", None, 0.001)
