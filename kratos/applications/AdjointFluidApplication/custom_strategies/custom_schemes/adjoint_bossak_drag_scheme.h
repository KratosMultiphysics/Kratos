 ...
 * \f[
 *  \frac{1}{\gamma - 1} (\dot{\lambda}^n - \dot{\lambda}^{n+1}) + (\partial_{\mathbf{w}^n}\mathbf{f}^{nT} - \partial_{\mathbf{w}^n}(\mathbf{M}\dot{\mathbf{w}}^{n-\alpha})) \lambda^n = -\partial_{\mathbf{w}^n}J^{nT}
 * \f]
 * \f[
