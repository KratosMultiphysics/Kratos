  ...
  namespace kernels
  {
   ...
   struct matrix_prod_col_row_row<double, 1>
   {
    ...
    static void init()
    {
      ...
      {
        std::string source;
        source.append(viennacl::tools::make_double_kernel(matrix_prod_col_row_row_align1_prod_TT));
        source.append(viennacl::tools::make_double_kernel(matrix_prod_col_row_row_align1_prod_AA));
        source.append(viennacl::tools::make_double_kernel(matrix_prod_col_row_row_align1_prod_AT));
        source.append(viennacl::tools::make_double_kernel(matrix_prod_col_row_row_align1_prod_TA));
        std::string prog_name = program_name();
        #ifdef VIENNACL_BUILD_INFO
        std::cout << "Creating program " << prog_name << std::endl;
        #endif
