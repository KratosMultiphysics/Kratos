  ...
  namespace kernels
  {
   ...
   struct matrix_solve_col_col<double, 1>
   {
    ...
    static void init()
    {
      ...
      {
        std::string source;
        source.append(viennacl::tools::make_double_kernel(matrix_solve_col_col_align1_unit_lower_solve));
        source.append(viennacl::tools::make_double_kernel(matrix_solve_col_col_align1_lower_solve));
        source.append(viennacl::tools::make_double_kernel(matrix_solve_col_col_align1_unit_upper_solve));
        source.append(viennacl::tools::make_double_kernel(matrix_solve_col_col_align1_trans_lower_trans_solve));
        source.append(viennacl::tools::make_double_kernel(matrix_solve_col_col_align1_trans_upper_trans_solve));
        source.append(viennacl::tools::make_double_kernel(matrix_solve_col_col_align1_trans_unit_lower_solve));
        source.append(viennacl::tools::make_double_kernel(matrix_solve_col_col_align1_upper_trans_solve));
        source.append(viennacl::tools::make_double_kernel(matrix_solve_col_col_align1_lower_trans_solve));
        source.append(viennacl::tools::make_double_kernel(matrix_solve_col_col_align1_unit_upper_trans_solve));
        source.append(viennacl::tools::make_double_kernel(matrix_solve_col_col_align1_trans_upper_solve));
        source.append(viennacl::tools::make_double_kernel(matrix_solve_col_col_align1_trans_unit_upper_solve));
        source.append(viennacl::tools::make_double_kernel(matrix_solve_col_col_align1_trans_unit_lower_trans_solve));
        source.append(viennacl::tools::make_double_kernel(matrix_solve_col_col_align1_trans_lower_solve));
        source.append(viennacl::tools::make_double_kernel(matrix_solve_col_col_align1_upper_solve));
        source.append(viennacl::tools::make_double_kernel(matrix_solve_col_col_align1_trans_unit_upper_trans_solve));
        source.append(viennacl::tools::make_double_kernel(matrix_solve_col_col_align1_unit_lower_trans_solve));
        std::string prog_name = program_name();
        #ifdef VIENNACL_BUILD_INFO
        std::cout << "Creating program " << prog_name << std::endl;
        #endif
