...
if(SolverType == "FractionalStep"):
    ...
    import monolithic_solver_eulerian_standard
    monolithic_solver_eulerian_standard.AddVariables(fluid_model_part)
...
if(SolverType == "FractionalStep"):
    ...
    monolithic_solver_eulerian_standard.AddDofs(fluid_model_part)
elif(SolverType == "monolithic_solver_eulerian_compressible"):
...
if(SolverType == "FractionalStep"):
    ...
    fluid_solver = monolithic_solver_eulerian_standard.MonolithicSolver(fluid_model_part,domain_size)
