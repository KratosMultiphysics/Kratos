...
class ExplicitSolver:
    ...
    def __init__(self, solver_id, Dt, search_radius, n_step_search, prox_tol, model_part):
        ...
        #data of the problem
        self.particle_destructor_and_constructor = Circles_Creator_Destructor()
	...
	self.step = 0;
        ...
        self.explicit_solver_object = Circles_Explicit_Solver(solver_id, search_radius, prox_tol, model_part)
