...
def BenchmarkCheck(time, node1):
    benchmarking.Output(time, "Time", 1.0, 1.0)
# print "IIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIII"
    benchmarking.Output(node1.GetSolutionStepValue(PRESSURE), "Node 1 pressure", 1.0, 1.0)
    benchmarking.Output(node1.GetSolutionStepValue(VELOCITY_Y), "Node 1 velocity_y", 0.1, 0.0001)
...
back_node = NodeFinder(fixed_model_part.Nodes, 0.2669, 0.2355, 0.0)
print(back_node)
