...
kratos_libs_path            = pfem_erosion_var.kratos_path + '/libs' ##kratos_root/libs
kratos_applications_path    = pfem_erosion_var.kratos_path + '/applications' ##kratos_root/applications
import sys
