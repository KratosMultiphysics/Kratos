...
#if !defined(KRATOS_COMPUTE_LAPLACIAN_SIMPLEX_ELEMENT_H_INCLUDED )
#define  KRATOS_COMPUTE_LAPLACIAN_SIMPLEX_ELEMENT_H_INCLUDED
...
public:
    ...
    /**
     * Returns a pointer to a new ComputeLaplacianSimplex element, created using given input
...
//    }
    ...
    {
        rOStream << "ComputeLaplacianSimplex" << TDim << "D";
    }
...
private:
   ...
   void AddIntegrationPointRHSContribution(VectorType& F,
    ...
    /// Assignment operator.
    ComputeLaplacianSimplex & operator=(ComputeLaplacianSimplex const& rOther);

    /// Copy constructor.
    ComputeLaplacianSimplex(ComputeLaplacianSimplex const& rOther);
...
#endif // KRATOS_COMPUTE_LAPLACIAN_SIMPLEX_ELEMENT_H_INCLUDED  defined
