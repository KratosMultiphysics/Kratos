...
if __name__ == "__main__":
    ...
    my_path        = './fluid_imposed_Post_Files_Imposed_Fluid/results_node_' + str(node_id) + '.txt'
    reference_path = './fluid_imposed_Post_Files_Exact_No_History/results_node_' + str(node_id) + '.txt'    
