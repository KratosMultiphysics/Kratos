...
class TestCheckNormals(KratosUnittest.TestCase):
    ...
    def test_check_normals(self):
        input_filename = os.path.dirname(os.path.realpath(__file__)) + "/auxiliary_files_for_python_unittest/inverted_normals"

        self._normal_check_process_tests(input_filename)

    def test_check_normals_quads(self):
        input_filename = os.path.dirname(os.path.realpath(__file__)) + "/auxiliary_files_for_python_unittest/inverted_normals_quads"
