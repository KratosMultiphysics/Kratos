...
#if !defined(KRATOS_COMPUTE_COMPONENT_GRADIENT_SIMPLEX_ELEMENT_H_INCLUDED )
#define  KRATOS_COMPUTE_COMPONENT_GRADIENT_SIMPLEX_ELEMENT_H_INCLUDED
...
private:
    ...
    /// Assignment operator.
    ComputeComponentGradientSimplex & operator=(ComputeComponentGradientSimplex const& rOther);

    /// Copy constructor.
    ComputeComponentGradientSimplex(ComputeComponentGradientSimplex const& rOther);
...
#endif // KRATOS_COMPUTE_COMPONENT_GRADIENT_SIMPLEX_ELEMENT_H_INCLUDED  defined
