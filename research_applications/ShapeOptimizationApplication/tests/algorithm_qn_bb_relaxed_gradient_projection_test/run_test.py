...
with open(os.path.join(output_directory, optimization_log_filename), 'r') as csvfile:
    ...
    TestCase().assertAlmostEqual(f, 187.682, 4)
    TestCase().assertAlmostEqual(c1, -1.00966, 4)
    TestCase().assertAlmostEqual(c2, 0.0398022, 4)
    TestCase().assertAlmostEqual(c3, 0.992343, 4)
