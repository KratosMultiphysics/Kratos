...
test_folder_name   = 'container_polydisperse_3d'
solution_file_name = 'reference_solutions.json'

class TestCases(KratosUnittest.TestCase):
    def ContainerPolydisperse3D_Mixed_01(self):
