...
test_folder_name   = 'container_monodisperse_3d'
solution_file_name = 'reference_solutions.json'

class TestCases(KratosUnittest.TestCase):
    def ContainerMonodisperse3D_Mixed_01(self):
