...
if __name__ == "__main__":
    ...
    h_min_max = [0.1, 0.5, 1.0]
    min_size = [0.5, 0.75, 1.5, 2.5]
    bl_distance = [0.5, 1.0, 2.0]
    mmg_test_tool = MMGParameterStudy("/mdpa_files/MMG_example")
    mmg_test_tool.CalculateDistanceAndGradient()
    mmg_test_tool.RemeshMetricProcess(h_min_max[0], min_size[0], bl_distance[0])
    mmg_test_tool.CalculateDistanceAndGradient()
    mmg_test_tool.CreateGIDOutput("output_01")
