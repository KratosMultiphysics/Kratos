...
KratosMultiphysics.ModelPartIO("remeshFreeConvection3").ReadModelPart(main_model_part)
...
for node in main_model_part.Nodes:
    distance = ((node.X-center_coordinates[0])**2+(node.Y-center_coordinates[1])**2)**0.5 - circle_radius
